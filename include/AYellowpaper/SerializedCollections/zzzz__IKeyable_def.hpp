...
// Write type traits
MARK_REF_T(::AYellowpaper::SerializedCollections::IKeyable*);
DEFINE_IL2CPP_CLASS(::AYellowpaper::SerializedCollections::IKeyable*, "AYellowpaper.SerializedCollections", "IKeyable");
// Dependencies
namespace AYellowpaper::SerializedCollections {
// Is value type: false
