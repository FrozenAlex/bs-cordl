...
// Write type traits
MARK_REF_T(::AYellowpaper::SerializedCollections::SerializedDictionaryAttribute*);
DEFINE_IL2CPP_CLASS(::AYellowpaper::SerializedCollections::SerializedDictionaryAttribute*, "AYellowpaper.SerializedCollections", "SerializedDictionaryAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3254514, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::AYellowpaper::SerializedCollections::SerializedDictionaryAttribute) == 0x20, "Size mismatch!");
