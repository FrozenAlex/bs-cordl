...
// Write type traits
MARK_GEN_REF_T_PTR(::AYellowpaper::SerializedCollections::SerializedDictionary_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::AYellowpaper::SerializedCollections::SerializedDictionary_2, "AYellowpaper.SerializedCollections", "SerializedDictionary`2");
