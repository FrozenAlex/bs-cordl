...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::StringW (::AddressablesInternalBridge::Runtime::CatalogLocationData::*)()>(
  ...
  constexpr static std::size_t addrs = 0x63085f0;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::AddressablesInternalBridge::Runtime::CatalogLocationData*>(), { "get_LocatorId", {}, {} })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::StringW (::AddressablesInternalBridge::Runtime::CatalogLocationData::*)()>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x63085f8;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::AddressablesInternalBridge::Runtime::CatalogLocationData*>(), { "get_LocalHash", {}, {} })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* (::AddressablesInternalBridge::Runtime::CatalogLocationData::*)()>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6308600;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::AddressablesInternalBridge::Runtime::CatalogLocationData*>(), { "get_CatalogLocation", {}, {} })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::AddressablesInternalBridge::Runtime::CatalogLocationData::*)(
  ...
  constexpr static std::size_t addrs = 0x6307fc0;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{},
                     (::i2c::find_method(
                         ::i2c::class_of<::AddressablesInternalBridge::Runtime::CatalogLocationData*>(),
                         { ".ctor", {}, { ::i2c::type_of<::StringW>(), ::i2c::type_of<::StringW>(), ::i2c::type_of<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*>() } })));
    return ___internal_method;
  }
};
...
inline ::StringW AddressablesInternalBridge::Runtime::CatalogLocationData::get_LocatorId() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::AddressablesInternalBridge::Runtime::CatalogLocationData*>(), { "get_LocatorId", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<::StringW>(this, ___internal_method);
}
inline ::StringW AddressablesInternalBridge::Runtime::CatalogLocationData::get_LocalHash() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::AddressablesInternalBridge::Runtime::CatalogLocationData*>(), { "get_LocalHash", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<::StringW>(this, ___internal_method);
}
...
inline void AddressablesInternalBridge::Runtime::CatalogLocationData::_ctor(::StringW locatorId, ::StringW localHash,
  ...
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{},
      (::i2c::find_method(::i2c::class_of<::AddressablesInternalBridge::Runtime::CatalogLocationData*>(),
                          { ".ctor", {}, { ::i2c::type_of<::StringW>(), ::i2c::type_of<::StringW>(), ::i2c::type_of<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, locatorId, localHash, resourceLocation);
}
...
AddressablesInternalBridge::Runtime::CatalogLocationData::New_ctor(::StringW locatorId, ::StringW localHash,
                                                                   ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* resourceLocation) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::AddressablesInternalBridge::Runtime::CatalogLocationData*>(locatorId, localHash, resourceLocation));
}
// Ctor Parameters []
