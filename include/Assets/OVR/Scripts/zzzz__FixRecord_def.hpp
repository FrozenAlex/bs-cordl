...
// Write type traits
MARK_REF_T(::Assets::OVR::Scripts::FixRecord*);
DEFINE_IL2CPP_CLASS(::Assets::OVR::Scripts::FixRecord*, "Assets.OVR.Scripts", "FixRecord");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_buttonNames, put = __cordl_internal_set_buttonNames)) ::ArrayW<::StringW> buttonNames;
  ...
  static inline ::Assets::OVR::Scripts::FixRecord* New_ctor(int32_t order, ::StringW cat, ::StringW msg, ::Assets::OVR::Scripts::FixMethodDelegate* fix, ::UnityEngine::Object* target,
                                                            bool editRequired, ::ArrayW<::StringW> buttons);

  constexpr ::ArrayW<::StringW> const& __cordl_internal_get_buttonNames() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get_buttonNames();
  ...
  constexpr void __cordl_internal_set_buttonNames(::ArrayW<::StringW> value);
  ...
  /// @brief Method .ctor, addr 0x5d0f9f0, size 0x1c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Assets::OVR::Scripts::FixRecord) == 0x48, "Size mismatch!");
