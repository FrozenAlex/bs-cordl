...
// Write type traits
MARK_REF_T(::Assets::OVR::Scripts::RangedRecord*);
DEFINE_IL2CPP_CLASS(::Assets::OVR::Scripts::RangedRecord*, "Assets.OVR.Scripts", "RangedRecord");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5d0f7f8, size 0x14, virtual false, abstract: false, final false
...
static_assert(sizeof(::Assets::OVR::Scripts::RangedRecord) == 0x38, "Size mismatch!");
