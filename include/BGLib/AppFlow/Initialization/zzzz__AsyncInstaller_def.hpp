...
MARK_REF_T(::BGLib::AppFlow::Initialization::AsyncInstaller_IInstallerRegistry*);
DEFINE_IL2CPP_CLASS(::BGLib::AppFlow::Initialization::AsyncInstaller*, "BGLib.AppFlow.Initialization", "AsyncInstaller");
DEFINE_IL2CPP_CLASS(::BGLib::AppFlow::Initialization::AsyncInstaller_IInstallerRegistry*, "BGLib.AppFlow.Initialization", "AsyncInstaller/IInstallerRegistry");
// Dependencies
namespace BGLib::AppFlow::Initialization {
// Is value type: false
...
// Non member Declarations
static_assert(sizeof(::BGLib::AppFlow::Initialization::AsyncInstaller) == 0x28, "Size mismatch!");
