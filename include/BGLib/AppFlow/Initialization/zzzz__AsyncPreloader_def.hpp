...
// Write type traits
MARK_REF_T(::BGLib::AppFlow::Initialization::AsyncPreloader*);
DEFINE_IL2CPP_CLASS(::BGLib::AppFlow::Initialization::AsyncPreloader*, "BGLib.AppFlow.Initialization", "AsyncPreloader");
...
static_assert(sizeof(::BGLib::AppFlow::Initialization::AsyncPreloader) == 0x28, "Size mismatch!");
