...
public:
  ...
  /// @brief Method .ctor, addr 0x330606c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_loadersQueue, addr 0x3306064, size 0x8, virtual false, abstract: false, final false
