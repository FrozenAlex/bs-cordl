...
// Write type traits
MARK_REF_T(::BGLib::AppFlow::Initialization::FeatureAsyncPreloader*);
MARK_REF_T(::BGLib::AppFlow::Initialization::FeatureAsyncPreloader___c*);
MARK_VAL_T(::BGLib::AppFlow::Initialization::FeatureAsyncPreloader__PreloadAsync_d__1);
DEFINE_IL2CPP_CLASS(::BGLib::AppFlow::Initialization::FeatureAsyncPreloader*, "BGLib.AppFlow.Initialization", "FeatureAsyncPreloader");
DEFINE_IL2CPP_CLASS(::BGLib::AppFlow::Initialization::FeatureAsyncPreloader___c*, "BGLib.AppFlow.Initialization", "FeatureAsyncPreloader/<>c");
DEFINE_IL2CPP_CLASS(::BGLib::AppFlow::Initialization::FeatureAsyncPreloader__PreloadAsync_d__1, "BGLib.AppFlow.Initialization", "FeatureAsyncPreloader/<PreloadAsync>d__1");
...
static_assert(sizeof(::BGLib::AppFlow::Initialization::FeatureAsyncPreloader___c) == 0x10, "Size mismatch!");
...
static_assert(sizeof(::BGLib::AppFlow::Initialization::FeatureAsyncPreloader__PreloadAsync_d__1) == 0x30, "Size mismatch!");
...
// Non member Declarations
static_assert(sizeof(::BGLib::AppFlow::Initialization::FeatureAsyncPreloader) == 0x28, "Size mismatch!");
