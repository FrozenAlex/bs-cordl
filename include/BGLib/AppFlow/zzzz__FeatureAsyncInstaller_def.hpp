...
// Write type traits
MARK_REF_T(::BGLib::AppFlow::FeatureAsyncInstaller*);
DEFINE_IL2CPP_CLASS(::BGLib::AppFlow::FeatureAsyncInstaller*, "BGLib.AppFlow", "FeatureAsyncInstaller");
...
static_assert(sizeof(::BGLib::AppFlow::FeatureAsyncInstaller) == 0x40, "Size mismatch!");
