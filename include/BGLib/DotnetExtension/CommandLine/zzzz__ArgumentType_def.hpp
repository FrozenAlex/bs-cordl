...
DEFINE_IL2CPP_CLASS(::BGLib::DotnetExtension::CommandLine::ArgumentType, "BGLib.DotnetExtension.CommandLine", "ArgumentType");
// Dependencies
namespace BGLib::DotnetExtension::CommandLine {
// Is value type: true
...
static_assert(sizeof(::BGLib::DotnetExtension::CommandLine::ArgumentType) == 0x4, "Size mismatch!");
