...
public:
  ...
  /// @brief Method <Contains>b__0, addr 0x3259ae0, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3259408, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x3259218, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_Item>b__0, addr 0x3259b50, size 0x2bc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Contains, addr 0x32592f4, size 0x114, virtual false, abstract: false, final false
  inline bool Contains(::StringW identifier);

  /// @brief Method Contains, addr 0x325921c, size 0xd8, virtual false, abstract: false, final false
  inline bool Contains(::BGLib::DotnetExtension::CommandLine::ArgumentOption option);

  /// @brief Method GetValueOrDefault, addr 0x3256bd8, size 0x70, virtual false, abstract: false, final false
  inline ::StringW GetValueOrDefault(::BGLib::DotnetExtension::CommandLine::ArgumentOption option);

  /// @brief Method ToString, addr 0x325940c, size 0x6d4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x32585cc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x3258dfc, size 0x41c, virtual false, abstract: false, final false
  inline ::StringW get_Item(::StringW identifier);

  /// @brief Method get_Item, addr 0x3258d24, size 0xd8, virtual false, abstract: false, final false
