...
MARK_REF_T(::BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0*);
...
DEFINE_IL2CPP_CLASS(::BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0*, "BGLib.DotnetExtension.CommandLine", "CommandLineParser/<>c__DisplayClass7_0");
...
public:
  ...
  /// @brief Method <ParseArgs>b__7_1, addr 0x3258c94, size 0x8, virtual false, abstract: false, final false
  inline ::StringW _ParseArgs_b__7_1(::BGLib::DotnetExtension::CommandLine::ArgumentOption option);

  /// @brief Method .ctor, addr 0x3258c90, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <ParseArgs>b__0, addr 0x3258c9c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3258b20, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method AddParsedOption, addr 0x3258b24, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateHint, addr 0x32585d8, size 0x548, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateOptionsMap, addr 0x3257104, size 0x828, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCommandLineArgs, addr 0x3256d24, size 0x78, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW> GetCommandLineArgs();

  /// @brief Method ParseArgs, addr 0x3257c98, size 0x934, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseCommandLine, addr 0x3256ddc, size 0x328, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseEnvironmentCommandLine, addr 0x3256d9c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method SelectRequiredOptions, addr 0x325792c, size 0x36c, virtual false, abstract: false, final false
