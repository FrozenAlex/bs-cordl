...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::BGLib::DotnetExtension::CommandLine::CommandLineParser___c::*)()>(
  ...
  constexpr static std::size_t addrs = 0x3258c90;
...
//  Writing Method size for method: ::BGLib::DotnetExtension::CommandLine::CommandLineParser___c._ParseArgs_b__7_1
template <>
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::StringW (::BGLib::DotnetExtension::CommandLine::CommandLineParser___c::*)(::BGLib::DotnetExtension::CommandLine::ArgumentOption)>(
    &::BGLib::DotnetExtension::CommandLine::CommandLineParser___c::_ParseArgs_b__7_1)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3258c94;
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BGLib::DotnetExtension::CommandLine::CommandLineParser___c*>(),
                                                                                           { "<ParseArgs>b__7_1", {}, { ::i2c::type_of<::BGLib::DotnetExtension::CommandLine::ArgumentOption>() } })));
    return ___internal_method;
  }
};
...
inline void BGLib::DotnetExtension::CommandLine::CommandLineParser___c::setStaticF___9__7_1(::System::Func_2<::BGLib::DotnetExtension::CommandLine::ArgumentOption, ::StringW>* value) {
  ::cordl_internals::setStaticField<::System::Func_2<::BGLib::DotnetExtension::CommandLine::ArgumentOption, ::StringW>*, "<>9__7_1", ::BGLib::DotnetExtension::CommandLine::CommandLineParser___c*>(
      std::forward<::System::Func_2<::BGLib::DotnetExtension::CommandLine::ArgumentOption, ::StringW>*>(value));
}
inline ::System::Func_2<::BGLib::DotnetExtension::CommandLine::ArgumentOption, ::StringW>* BGLib::DotnetExtension::CommandLine::CommandLineParser___c::getStaticF___9__7_1() {
...
inline ::StringW BGLib::DotnetExtension::CommandLine::CommandLineParser___c::_ParseArgs_b__7_1(::BGLib::DotnetExtension::CommandLine::ArgumentOption option) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BGLib::DotnetExtension::CommandLine::CommandLineParser___c*>(),
                                                                                         { "<ParseArgs>b__7_1", {}, { ::i2c::type_of<::BGLib::DotnetExtension::CommandLine::ArgumentOption>() } })));
...
//  Writing Method size for method: ::BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0._ctor
template <>

struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0::*)()>(
    &::BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x3258b20;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0*>(), { ".ctor", {}, {} })));
    return ___internal_method;
  }
};
//  Writing Method size for method: ::BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0._ParseArgs_b__0
template <>

struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0::*)(::BGLib::DotnetExtension::CommandLine::ArgumentOption)>(
    &::BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0::_ParseArgs_b__0)> {
  constexpr static std::size_t size = 0x88;
  constexpr static std::size_t addrs = 0x3258c9c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0*>(),
...
BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0::__cordl_internal_get_requiredFound() {
...
BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0::__cordl_internal_get_requiredFound() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___requiredFound;
}
constexpr void BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0::__cordl_internal_set_requiredFound(
    ::System::Collections::Generic::HashSet_1<::BGLib::DotnetExtension::CommandLine::ArgumentOption>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->___requiredFound = value;
}
inline void BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0::_ctor() {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0*>(), { ".ctor", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
inline bool BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0::_ParseArgs_b__0(::BGLib::DotnetExtension::CommandLine::ArgumentOption option) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0*>(),
                                                                                         { "<ParseArgs>b__0", {}, { ::i2c::type_of<::BGLib::DotnetExtension::CommandLine::ArgumentOption>() } })));
  return ::cordl_internals::RunMethodRethrow<bool>(this, ___internal_method, option);
}
inline ::BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0* BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0*>());
}
// Ctor Parameters []
constexpr ::BGLib::DotnetExtension::CommandLine::CommandLineParser___c__DisplayClass7_0::CommandLineParser___c__DisplayClass7_0() {}
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Collections::Generic::HashSet_1<
  ...
  constexpr static std::size_t addrs = 0x325792c;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Collections::Generic::Dictionary_2<
  ...
  constexpr static std::size_t addrs = 0x3257104;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (*)(
  ...
  constexpr static std::size_t addrs = 0x3257c98;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (*)(::System::Collections::Generic::Dictionary_2<::BGLib::DotnetExtension::CommandLine::ArgumentOption, ::StringW>*,
  ...
  constexpr static std::size_t addrs = 0x3258b24;
