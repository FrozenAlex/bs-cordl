...
public:
  ...
  __declspec(property(get = getStaticF_jsonConverters, put = setStaticF_jsonConverters)) ::ArrayW<::Newtonsoft::Json::JsonConverter*> jsonConverters;
  ...
  static inline ::ArrayW<::Newtonsoft::Json::JsonConverter*> getStaticF_jsonConverters();
  ...
  static inline void setStaticF_jsonConverters(::ArrayW<::Newtonsoft::Json::JsonConverter*> value);
...
static_assert(sizeof(::BGLib::JsonExtension::JsonSettings) == 0x10, "Size mismatch!");
