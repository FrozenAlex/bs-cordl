...
public:
  ...
  /// @brief Method ReadJson, addr 0x3312aa0, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteJson, addr 0x3312b5c, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3312c54, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
