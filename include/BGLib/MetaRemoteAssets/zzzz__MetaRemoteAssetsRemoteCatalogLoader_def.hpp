...
// Write type traits
MARK_REF_T(::BGLib::MetaRemoteAssets::MetaRemoteAssetsRemoteCatalogLoader*);
MARK_REF_T(::BGLib::MetaRemoteAssets::MetaRemoteAssetsRemoteCatalogLoader___c*);
MARK_VAL_T(::BGLib::MetaRemoteAssets::MetaRemoteAssetsRemoteCatalogLoader__LoadRemoteCatalogAsync_d__0);
DEFINE_IL2CPP_CLASS(::BGLib::MetaRemoteAssets::MetaRemoteAssetsRemoteCatalogLoader*, "BGLib.MetaRemoteAssets", "MetaRemoteAssetsRemoteCatalogLoader");
...
public:
  ...
  /// @brief Method <LoadRemoteCatalogAsync>b__0_0, addr 0x325fea4, size 0xdc, virtual false, abstract: false, final false
  inline bool _LoadRemoteCatalogAsync_b__0_0(::UnityEngine::AddressableAssets::ResourceLocators::IResourceLocator* locator);

  /// @brief Method .ctor, addr 0x325fea0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x325ff80, size 0x50c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x326048c, size 0x80, virtual true, abstract: false, final true
...
static_assert(sizeof(::BGLib::MetaRemoteAssets::MetaRemoteAssetsRemoteCatalogLoader__LoadRemoteCatalogAsync_d__0) == 0x28, "Size mismatch!");
...
public:
  ...
  /// @brief Method LoadRemoteCatalogAsync, addr 0x325fd70, size 0xd8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x325fe48, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::BGLib::MetaRemoteAssets::MetaRemoteAssetsRemoteCatalogLoader) == 0x10, "Size mismatch!");
