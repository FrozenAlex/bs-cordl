...
DEFINE_IL2CPP_CLASS(::BGLib::Polyglot::LanguageDirection, "BGLib.Polyglot", "LanguageDirection");
// Dependencies
namespace BGLib::Polyglot {
// Is value type: true
...
static_assert(sizeof(::BGLib::Polyglot::LanguageDirection) == 0x4, "Size mismatch!");
