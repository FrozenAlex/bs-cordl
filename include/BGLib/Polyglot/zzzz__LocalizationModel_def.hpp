...
public:
  ...
  /// @brief Method AddLocalizedString, addr 0x331d260, size 0x7c, virtual false, abstract: false, final false
  inline void AddLocalizedString(::StringW key, ::System::Collections::Generic::List_1<::StringW>* values);

  /// @brief Method AddOnLocalizeEvent, addr 0x3317e24, size 0x1b8, virtual false, abstract: false, final false
  inline void AddOnLocalizeEvent(::BGLib::Polyglot::ILocalize* localize);

  /// @brief Method ApplyLocalizationContent, addr 0x331d238, size 0x28, virtual false, abstract: false, final false
  inline void ApplyLocalizationContent(::UnityEngine::TextAsset* asset);

  /// @brief Method Get, addr 0x3318bc4, size 0xe4, virtual false, abstract: false, final false
  inline ::StringW Get(::StringW key);

  /// @brief Method GetCultureInfo, addr 0x331bf18, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Globalization::CultureInfo* GetCultureInfo(::BGLib::Polyglot::LocalizationLanguage language);

  /// @brief Method GetFormatOrKey, addr 0x331cacc, size 0x5c, virtual false, abstract: false, final false
  inline ::StringW GetFormatOrKey(::StringW key, ::ArrayW<::System::Object*> arguments);

  /// @brief Method GetKeys, addr 0x331d1c4, size 0x74, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* GetKeys();

  /// @brief Method GetLanguages, addr 0x331c9f0, size 0xb0, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* GetLanguages(::StringW key);

  /// @brief Method GetLanguages, addr 0x331bff0, size 0x4d0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLanguagesContains, addr 0x331ceb8, size 0x30c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLanguagesStartsWith, addr 0x331cbb4, size 0x304, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOrKey, addr 0x331c9c8, size 0x28, virtual false, abstract: false, final false
  inline ::StringW GetOrKey(::StringW key);

  /// @brief Method IsValueValid, addr 0x331caa0, size 0x2c, virtual false, abstract: false, final false
  static inline bool IsValueValid(::StringW currentString);

  /// @brief Method KeyExist, addr 0x331cb28, size 0x18, virtual false, abstract: false, final false
  inline bool KeyExist(::StringW key);

  /// @brief Method KeyExist, addr 0x331cb40, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveOnLocalizeEvent, addr 0x331c8e4, size 0xe4, virtual false, abstract: false, final false
  inline void RemoveOnLocalizeEvent(::BGLib::Polyglot::ILocalize* localize);

  /// @brief Method SelectLanguage, addr 0x331c800, size 0xe4, virtual false, abstract: false, final false
  inline void SelectLanguage(int32_t selected);

  /// @brief Method TryGet, addr 0x3318420, size 0x2c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x331c69c, size 0x164, virtual false, abstract: false, final false
  inline void _ctor(::BGLib::Polyglot::Localization* localization, ::BGLib::Polyglot::LocalizationLanguage language,
                    ::System::Collections::Generic::List_1<::BGLib::Polyglot::LocalizationAsset*>* inputFiles);

  /// @brief Method add__onChangeLanguage, addr 0x331c51c, size 0xc0, virtual false, abstract: false, final false
  inline void add__onChangeLanguage(::System::Action_1<::BGLib::Polyglot::LocalizationModel*>* value);

  /// @brief Method get_SelectedCultureInfo, addr 0x331bd38, size 0x8, virtual false, abstract: false, final false
  inline ::System::Globalization::CultureInfo* get_SelectedCultureInfo();

  /// @brief Method get_SelectedLanguage, addr 0x3318408, size 0x18, virtual false, abstract: false, final false
  inline ::BGLib::Polyglot::LocalizationLanguage get_SelectedLanguage();

  /// @brief Method get_englishLanguageNames, addr 0x3317fdc, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_englishLanguageNames();

  /// @brief Method get_fallbackLanguage, addr 0x331bd08, size 0x18, virtual false, abstract: false, final false
  inline ::BGLib::Polyglot::LocalizationLanguage get_fallbackLanguage();

  /// @brief Method get_inputFiles, addr 0x331bd30, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::BGLib::Polyglot::LocalizationAsset*>* get_inputFiles();

  /// @brief Method get_localizedLanguageNames, addr 0x331c4c0, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_localizedLanguageNames();

  /// @brief Method get_selectedLanguageDirection, addr 0x33186e8, size 0x24, virtual false, abstract: false, final false
  inline ::BGLib::Polyglot::LanguageDirection get_selectedLanguageDirection();

  /// @brief Method get_selectedLanguageIndex, addr 0x3318038, size 0x14, virtual false, abstract: false, final false
  inline int32_t get_selectedLanguageIndex();

  /// @brief Method get_supportedLanguages, addr 0x331bfd8, size 0x18, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::BGLib::Polyglot::LocalizationLanguage>* get_supportedLanguages();

  /// @brief Method remove__onChangeLanguage, addr 0x331c5dc, size 0xc0, virtual false, abstract: false, final false
  inline void remove__onChangeLanguage(::System::Action_1<::BGLib::Polyglot::LocalizationModel*>* value);

  /// @brief Method set_SelectedCultureInfo, addr 0x331bd40, size 0x90, virtual false, abstract: false, final false
  inline void set_SelectedCultureInfo(::System::Globalization::CultureInfo* value);

  /// @brief Method set_SelectedLanguage, addr 0x331bdd0, size 0x148, virtual false, abstract: false, final false
...
static_assert(sizeof(::BGLib::Polyglot::LocalizationModel) == 0x40, "Size mismatch!");
