...
public:
  // Declarations
  /// @brief Method IsAlignmentLeft, addr 0x3318aec, size 0x28, virtual false, abstract: false, final false
  static inline bool IsAlignmentLeft(::TMPro::TextAlignmentOptions alignment);

  /// @brief Method IsAlignmentRight, addr 0x3318ac4, size 0x28, virtual false, abstract: false, final false
  static inline bool IsAlignmentRight(::TMPro::TextAlignmentOptions alignment);

  /// @brief Method IsOppositeDirection, addr 0x3318a70, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method SetText, addr 0x3318958, size 0x28, virtual true, abstract: false, final false
  inline void SetText(::TMPro::TextMeshProUGUI* text, ::StringW value);

  /// @brief Method UpdateAlignment, addr 0x3318980, size 0xf0, virtual true, abstract: false, final false
  inline void UpdateAlignment(::TMPro::TextMeshProUGUI* text, ::BGLib::Polyglot::LanguageDirection direction);

  /// @brief Method .ctor, addr 0x3318b14, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
