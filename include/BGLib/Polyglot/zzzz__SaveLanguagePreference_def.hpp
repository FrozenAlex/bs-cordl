...
public:
  ...
  /// @brief Method OnLocalize, addr 0x331da18, size 0x28, virtual true, abstract: false, final true
  inline void OnLocalize(::BGLib::Polyglot::LocalizationModel* localization);

  /// @brief Method Start, addr 0x331d9d4, size 0x44, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x331da40, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
