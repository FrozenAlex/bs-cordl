...
DEFINE_IL2CPP_CLASS(::BGLib::UnityExtension::BezierCurves::CurveData, "BGLib.UnityExtension.BezierCurves", "CurveData");
...
static_assert(sizeof(::BGLib::UnityExtension::BezierCurves::CurveData) == 0x30, "Size mismatch!");
