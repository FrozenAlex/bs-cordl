...
// Write type traits
MARK_REF_T(::BGLib::UnityExtension::BezierCurves::GenericBezierCurveData*);
DEFINE_IL2CPP_CLASS(::BGLib::UnityExtension::BezierCurves::GenericBezierCurveData*, "BGLib.UnityExtension.BezierCurves", "GenericBezierCurveData");
...
public:
  ...
  /// @brief Method RotatePointAroundPivot, addr 0x332858c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method RotatePointsAroundPivot, addr 0x3328328, size 0x264, virtual false, abstract: false, final false
  ...
  /// @brief Method SetEndPoint, addr 0x332831c, size 0xc, virtual false, abstract: false, final false
  inline void SetEndPoint(::UnityEngine::Vector3 newValue);

  /// @brief Method SetStartPoint, addr 0x3328310, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33285dc, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_endPoint, addr 0x3328304, size 0xc, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector3 get_endPoint();

  /// @brief Method get_startPoint, addr 0x33282f8, size 0xc, virtual true, abstract: false, final false
...
static_assert(sizeof(::BGLib::UnityExtension::BezierCurves::GenericBezierCurveData) == 0x40, "Size mismatch!");
