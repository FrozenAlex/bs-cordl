...
// Write type traits
MARK_REF_T(::BGLib::UnityExtension::BezierCurves::ObjectBasedBezierCurve*);
DEFINE_IL2CPP_CLASS(::BGLib::UnityExtension::BezierCurves::ObjectBasedBezierCurve*, "BGLib.UnityExtension.BezierCurves", "ObjectBasedBezierCurve");
...
public:
  ...
  /// @brief Method GetBezierCurveData, addr 0x326dcb0, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method SetBezierCurveData, addr 0x326dda4, size 0x90, virtual true, abstract: false, final false
  inline void SetBezierCurveData(::BGLib::UnityExtension::BezierCurves::CurveData newValue);

  /// @brief Method .ctor, addr 0x326de34, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isReady, addr 0x326dc00, size 0x14, virtual true, abstract: false, final false
...
static_assert(sizeof(::BGLib::UnityExtension::BezierCurves::ObjectBasedBezierCurve) == 0x28, "Size mismatch!");
