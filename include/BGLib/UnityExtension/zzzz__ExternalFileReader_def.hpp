...
// Write type traits
MARK_REF_T(::BGLib::UnityExtension::ExternalFileReader*);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3324760, size 0x7c8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x33250c8, size 0x80, virtual true, abstract: false, final true
...
static_assert(sizeof(::BGLib::UnityExtension::ExternalFileReader__ExistsAsync_d__0) == 0x38, "Size mismatch!");
...
public:
  ...
  /// @brief Method ExistsAsync, addr 0x3324680, size 0xe0, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::BGLib::UnityExtension::ExternalFileReader) == 0x10, "Size mismatch!");
