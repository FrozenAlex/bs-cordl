...
// Write type traits
MARK_REF_T(::BGLib::UnityExtension::SerializableDictionaryBase*);
MARK_GEN_REF_T_PTR(::BGLib::UnityExtension::SerializableDictionaryBase_Dictionary_2);
MARK_REF_T(::BGLib::UnityExtension::SerializableDictionaryBase_Storage*);
DEFINE_IL2CPP_CLASS(::BGLib::UnityExtension::SerializableDictionaryBase*, "BGLib.UnityExtension", "SerializableDictionaryBase");
DEFINE_IL2CPP_GEN_CLASS_PTR(::BGLib::UnityExtension::SerializableDictionaryBase_Dictionary_2, "BGLib.UnityExtension", "SerializableDictionaryBase/Dictionary`2");
DEFINE_IL2CPP_CLASS(::BGLib::UnityExtension::SerializableDictionaryBase_Storage*, "BGLib.UnityExtension", "SerializableDictionaryBase/Storage");
...
public:
  ...
  /// @brief Method .ctor, addr 0x326c1c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BGLib::UnityExtension::SerializableDictionaryBase_Storage) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x326c1c4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::BGLib::UnityExtension::SerializableDictionaryBase) == 0x10, "Size mismatch!");
