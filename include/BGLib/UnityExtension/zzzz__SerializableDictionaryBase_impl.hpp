...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::BGLib::UnityExtension::SerializableDictionaryBase_Storage::*)()>(&::BGLib::UnityExtension::SerializableDictionaryBase_Storage::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x326c1c8;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BGLib::UnityExtension::SerializableDictionaryBase_Storage*>(), { ".ctor", {}, {} })));
...
inline ::BGLib::UnityExtension::SerializableDictionaryBase_Storage* BGLib::UnityExtension::SerializableDictionaryBase_Storage::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::BGLib::UnityExtension::SerializableDictionaryBase_Storage*>());
}
// Ctor Parameters []
...
template <typename TKey, typename TValue> inline void BGLib::UnityExtension::SerializableDictionaryBase_Dictionary_2<TKey, TValue>::_ctor() {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BGLib::UnityExtension::SerializableDictionaryBase_Dictionary_2<TKey, TValue>*>(), { ".ctor", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
...
inline void BGLib::UnityExtension::SerializableDictionaryBase_Dictionary_2<TKey, TValue>::_ctor(::System::Collections::Generic::IDictionary_2<TKey, TValue>* dict) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BGLib::UnityExtension::SerializableDictionaryBase_Dictionary_2<TKey, TValue>*>(),
...
inline void BGLib::UnityExtension::SerializableDictionaryBase_Dictionary_2<TKey, TValue>::_ctor(::System::Runtime::Serialization::SerializationInfo* info,
  ...
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{},
      (::i2c::find_method(::i2c::class_of<::BGLib::UnityExtension::SerializableDictionaryBase_Dictionary_2<TKey, TValue>*>(),
...
inline ::BGLib::UnityExtension::SerializableDictionaryBase_Dictionary_2<TKey, TValue>* BGLib::UnityExtension::SerializableDictionaryBase_Dictionary_2<TKey, TValue>::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::BGLib::UnityExtension::SerializableDictionaryBase_Dictionary_2<TKey, TValue>*>());
}
template <typename TKey, typename TValue>
...
BGLib::UnityExtension::SerializableDictionaryBase_Dictionary_2<TKey, TValue>::New_ctor(::System::Collections::Generic::IDictionary_2<TKey, TValue>* dict) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::BGLib::UnityExtension::SerializableDictionaryBase_Dictionary_2<TKey, TValue>*>(dict));
}
template <typename TKey, typename TValue>
inline ::BGLib::UnityExtension::SerializableDictionaryBase_Dictionary_2<TKey, TValue>*
BGLib::UnityExtension::SerializableDictionaryBase_Dictionary_2<TKey, TValue>::New_ctor(::System::Runtime::Serialization::SerializationInfo* info,
                                                                                       ::System::Runtime::Serialization::StreamingContext context) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::BGLib::UnityExtension::SerializableDictionaryBase_Dictionary_2<TKey, TValue>*>(info, context));
}
// Ctor Parameters []
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::BGLib::UnityExtension::SerializableDictionaryBase::*)()>(&::BGLib::UnityExtension::SerializableDictionaryBase::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x326c1c4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BGLib::UnityExtension::SerializableDictionaryBase*>(), { ".ctor", {}, {} })));
    return ___internal_method;
  }
};
...
inline ::BGLib::UnityExtension::SerializableDictionaryBase* BGLib::UnityExtension::SerializableDictionaryBase::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::BGLib::UnityExtension::SerializableDictionaryBase*>());
}
// Ctor Parameters []
