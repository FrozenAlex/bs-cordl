...
// Write type traits
MARK_GEN_REF_T_PTR(::BGLib::UnityExtension::SerializableDictionary_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::BGLib::UnityExtension::SerializableDictionary_2, "BGLib.UnityExtension", "SerializableDictionary`2");
...
public:
  ...
  inline TValue GetValue(::ArrayW<TValue> storage, int32_t i);
  ...
  inline void SetValue(::ArrayW<TValue> storage, int32_t i, TValue value);
