...
// Write type traits
MARK_REF_T(::BGLib::UnityExtension::SerializableDictionary*);
MARK_GEN_REF_T_PTR(::BGLib::UnityExtension::SerializableDictionary_Storage_1);
DEFINE_IL2CPP_CLASS(::BGLib::UnityExtension::SerializableDictionary*, "BGLib.UnityExtension", "SerializableDictionary");
DEFINE_IL2CPP_GEN_CLASS_PTR(::BGLib::UnityExtension::SerializableDictionary_Storage_1, "BGLib.UnityExtension", "SerializableDictionary/Storage`1");
...
// Non member Declarations
static_assert(sizeof(::BGLib::UnityExtension::SerializableDictionary) == 0x10, "Size mismatch!");
