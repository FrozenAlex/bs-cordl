...
// Write type traits
MARK_REF_T(::BGLib::UnityExtension::ShaderPropertyIDAttribute*);
DEFINE_IL2CPP_CLASS(::BGLib::UnityExtension::ShaderPropertyIDAttribute*, "BGLib.UnityExtension", "ShaderPropertyIDAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3326c60, size 0x6c, virtual false, abstract: false, final false
...
static_assert(sizeof(::BGLib::UnityExtension::ShaderPropertyIDAttribute) == 0x20, "Size mismatch!");
