...
// Write type traits
MARK_REF_T(::BGLib::UnityExtension::ShaderPropertyIDFromGameObjectAttribute*);
DEFINE_IL2CPP_CLASS(::BGLib::UnityExtension::ShaderPropertyIDFromGameObjectAttribute*, "BGLib.UnityExtension", "ShaderPropertyIDFromGameObjectAttribute");
...
public:
  // Declarations
  /// @brief Method GetTargetName, addr 0x326c250, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x326c24c, size 0x4, virtual false, abstract: false, final false
...
static_assert(sizeof(::BGLib::UnityExtension::ShaderPropertyIDFromGameObjectAttribute) == 0x20, "Size mismatch!");
