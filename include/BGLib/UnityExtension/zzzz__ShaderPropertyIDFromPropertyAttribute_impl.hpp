...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::BGLib::UnityExtension::ShaderPropertyIDFromPropertyAttribute::*)(
  ...
  constexpr static std::size_t addrs = 0x3326d48;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BGLib::UnityExtension::ShaderPropertyIDFromPropertyAttribute*>(),
                                                                                           { ".ctor",
                                                                                             {},
                                                                                             { ::i2c::type_of<::StringW>(), ::i2c::type_of<::StringW>(), ::i2c::type_of<::StringW>(),
                                                                                               ::i2c::type_of<::BGLib::UnityExtension::ShaderPropertyAttributeFilter_PropType>() } })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::StringW (::BGLib::UnityExtension::ShaderPropertyIDFromPropertyAttribute::*)()>(
    &::BGLib::UnityExtension::ShaderPropertyIDFromPropertyAttribute::GetTargetName)> {
  constexpr static std::size_t size = 0xe0;
  constexpr static std::size_t addrs = 0x3326d78;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::BGLib::UnityExtension::ShaderPropertyIDFromPropertyAttribute*>(),
                                                                                          { ::i2c::class_of<::BGLib::UnityExtension::ShaderPropertyIDFromPropertyAttribute*>(), 7 }));
    return ___internal_method;
  }
};
...
constexpr void BGLib::UnityExtension::ShaderPropertyIDFromPropertyAttribute::__cordl_internal_set_nestedPropertyName(::StringW value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->___nestedPropertyName = value;
}
inline void BGLib::UnityExtension::ShaderPropertyIDFromPropertyAttribute::_ctor(::StringW propertyName, ::StringW nestedPropertyName, ::StringW nameFilter,
  ...
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BGLib::UnityExtension::ShaderPropertyIDFromPropertyAttribute*>(),
                                                                                         { ".ctor",
                                                                                           ...
                                                                                           { ::i2c::type_of<::StringW>(), ::i2c::type_of<::StringW>(), ::i2c::type_of<::StringW>(),
                                                                                             ::i2c::type_of<::BGLib::UnityExtension::ShaderPropertyAttributeFilter_PropType>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, propertyName, nestedPropertyName, nameFilter, filterPropType);
}
inline ::StringW BGLib::UnityExtension::ShaderPropertyIDFromPropertyAttribute::GetTargetName() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::BGLib::UnityExtension::ShaderPropertyIDFromPropertyAttribute*>(), 7 })));
...
BGLib::UnityExtension::ShaderPropertyIDFromPropertyAttribute::New_ctor(::StringW propertyName, ::StringW nestedPropertyName, ::StringW nameFilter,
                                                                       ::BGLib::UnityExtension::ShaderPropertyAttributeFilter_PropType filterPropType) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::BGLib::UnityExtension::ShaderPropertyIDFromPropertyAttribute*>(propertyName, nestedPropertyName, nameFilter, filterPropType));
}
// Ctor Parameters []
