...
// Write type traits
MARK_REF_T(::BGLib::UnityExtension::ShaderPropertyIDFromRendererAttribute*);
DEFINE_IL2CPP_CLASS(::BGLib::UnityExtension::ShaderPropertyIDFromRendererAttribute*, "BGLib.UnityExtension", "ShaderPropertyIDFromRendererAttribute");
...
public:
  ...
  /// @brief Method GetTargetName, addr 0x326c2c0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x326c294, size 0x2c, virtual false, abstract: false, final false
...
static_assert(sizeof(::BGLib::UnityExtension::ShaderPropertyIDFromRendererAttribute) == 0x28, "Size mismatch!");
