...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x322af1c, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::BGNet::Core::GameLift::GetMultiplayerInstanceResponse) == 0x38, "Size mismatch!");
