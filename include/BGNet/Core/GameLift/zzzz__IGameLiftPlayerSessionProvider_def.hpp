...
// Write type traits
MARK_REF_T(::BGNet::Core::GameLift::IGameLiftPlayerSessionProvider*);
DEFINE_IL2CPP_CLASS(::BGNet::Core::GameLift::IGameLiftPlayerSessionProvider*, "BGNet.Core.GameLift", "IGameLiftPlayerSessionProvider");
// Dependencies
namespace BGNet::Core::GameLift {
// Is value type: false
