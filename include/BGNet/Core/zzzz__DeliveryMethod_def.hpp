...
DEFINE_IL2CPP_CLASS(::BGNet::Core::DeliveryMethod, "BGNet.Core", "DeliveryMethod");
// Dependencies
namespace BGNet::Core {
// Is value type: true
...
public:
  ...
  /// @brief Field ReliableOrdered value: U8(1)
...
static_assert(sizeof(::BGNet::Core::DeliveryMethod) == 0x1, "Size mismatch!");
