...
// Write type traits
MARK_REF_T(::BGNet::Logging::ConsoleLogger*);
DEFINE_IL2CPP_CLASS(::BGNet::Logging::ConsoleLogger*, "BGNet.Logging", "ConsoleLogger");
...
public:
  ...
  /// @brief Method LogError, addr 0x328533c, size 0x1e4, virtual true, abstract: false, final true
  inline void LogError(::StringW message);

  /// @brief Method LogException, addr 0x3285520, size 0x168, virtual true, abstract: false, final true
  inline void LogException(::System::Exception* exception, ::StringW message);

  /// @brief Method LogInfo, addr 0x3285230, size 0x10c, virtual true, abstract: false, final true
  inline void LogInfo(::StringW message);

  /// @brief Method LogWarning, addr 0x3285688, size 0x10c, virtual true, abstract: false, final true
  inline void LogWarning(::StringW message);

  static inline ::BGNet::Logging::ConsoleLogger* New_ctor();

  /// @brief Method .ctor, addr 0x3285794, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BGNet::Logging::ConsoleLogger) == 0x10, "Size mismatch!");
