...
// Write type traits
MARK_REF_T(::BeatGames::Analytics::Events::CommonFieldProviders*);
DEFINE_IL2CPP_CLASS(::BeatGames::Analytics::Events::CommonFieldProviders*, "BeatGames.Analytics.Events", "CommonFieldProviders");
...
static_assert(sizeof(::BeatGames::Analytics::Events::CommonFieldProviders) == 0x10, "Size mismatch!");
