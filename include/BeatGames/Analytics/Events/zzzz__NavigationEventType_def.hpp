...
public:
  ...
  /// @brief Method ToString, addr 0x325550c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3255424, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW value);

  /// @brief Method get_CancelDrag, addr 0x32554a4, size 0x68, virtual false, abstract: false, final false
  static inline ::BeatGames::Analytics::Events::NavigationEventType* get_CancelDrag();

  /// @brief Method get_Click, addr 0x32549e0, size 0x68, virtual false, abstract: false, final false
  static inline ::BeatGames::Analytics::Events::NavigationEventType* get_Click();

  /// @brief Method get_Drag, addr 0x325543c, size 0x68, virtual false, abstract: false, final false
  static inline ::BeatGames::Analytics::Events::NavigationEventType* get_Drag();

  /// @brief Method get_Impression, addr 0x3254878, size 0x68, virtual false, abstract: false, final false
  static inline ::BeatGames::Analytics::Events::NavigationEventType* get_Impression();

  /// @brief Method get_Value, addr 0x325542c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x3255434, size 0x8, virtual false, abstract: false, final false
