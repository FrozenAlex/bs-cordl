...
// Write type traits
MARK_REF_T(::BeatGames::Analytics::Events::SessionEventSender*);
DEFINE_IL2CPP_CLASS(::BeatGames::Analytics::Events::SessionEventSender*, "BeatGames.Analytics.Events", "SessionEventSender");
...
public:
  ...
  /// @brief Method SendSessionFinish, addr 0x325506c, size 0xcc, virtual false, abstract: false, final false
  inline void SendSessionFinish();

  /// @brief Method SendSessionStart, addr 0x3254fa0, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3254778, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatGames::Analytics::Events::SessionEventSender) == 0x18, "Size mismatch!");
