...
// Write type traits
MARK_REF_T(::BeatGames::Analytics::Events::SessionEvent*);
DEFINE_IL2CPP_CLASS(::BeatGames::Analytics::Events::SessionEvent*, "BeatGames.Analytics.Events", "SessionEvent");
...
public:
  ...
  /// @brief Method GetIDType, addr 0x31c5280, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::IDType GetIDType();

  static inline ::BeatGames::Analytics::Events::SessionEvent* New_ctor();

  /// @brief Method ReturnEventToPool, addr 0x31c5288, size 0x74, virtual true, abstract: false, final false
  inline void ReturnEventToPool();

  /// @brief Method ReturnedToPool, addr 0x31c52fc, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31c521c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BeatGames::Analytics::Events::SessionEvent) == 0x80, "Size mismatch!");
