...
// Write type traits
MARK_REF_T(::BeatGames::Analytics::Events::TelemetryEventSender*);
DEFINE_IL2CPP_CLASS(::BeatGames::Analytics::Events::TelemetryEventSender*, "BeatGames.Analytics.Events", "TelemetryEventSender");
...
public:
  ...
  /// @brief Method SendTelemetryEvent, addr 0x3255138, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3254780, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatGames::Analytics::Events::TelemetryEventSender) == 0x18, "Size mismatch!");
