...
// Write type traits
MARK_REF_T(::BeatGames::Analytics::Events::TelemetryEvent*);
DEFINE_IL2CPP_CLASS(::BeatGames::Analytics::Events::TelemetryEvent*, "BeatGames.Analytics.Events", "TelemetryEvent");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_tags, put = __cordl_internal_set_tags)) ::ArrayW<::StringW> tags;
  ...
  constexpr ::ArrayW<::StringW> const& __cordl_internal_get_tags() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get_tags();
  ...
  constexpr void __cordl_internal_set_tags(::ArrayW<::StringW> value);
...
static_assert(sizeof(::BeatGames::Analytics::Events::TelemetryEvent) == 0xa0, "Size mismatch!");
