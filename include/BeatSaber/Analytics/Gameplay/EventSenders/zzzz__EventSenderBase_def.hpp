...
// Write type traits
MARK_REF_T(::BeatSaber::Analytics::Gameplay::EventSenders::EventSenderBase*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Analytics::Gameplay::EventSenders::EventSenderBase*, "BeatSaber.Analytics.Gameplay.EventSenders", "EventSenderBase");
...
public:
  ...
  /// @brief Method GetSegmentName, addr 0x3260d40, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method SendEventsBatch, addr 0x3260e18, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3260a2c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::Analytics::Gameplay::EventSenders::EventSenderBase) == 0x18, "Size mismatch!");
