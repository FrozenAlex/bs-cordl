...
// Write type traits
MARK_REF_T(::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapAttemptEventData*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapAttemptEventData*, "BeatSaber.Analytics.Gameplay.EventSenders", "GameAnalyticsBeatmapAttemptEventData");
...
public:
  ...
  static inline ::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapAttemptEventData* New_ctor(::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData* levelData,
                                                                                                               bool isEndStateQuit, bool isEndStateRestart, bool isClear, int32_t rank,
                                                                                                               int32_t modifiedScore, int32_t score, bool isFullCombo, int32_t maxCombo,
                                                                                                               uint32_t duration, int32_t goodCuts, int32_t badCuts, int32_t misses, int32_t bombsHit);
  ...
  /// @brief Method .ctor, addr 0x32615b8, size 0x58, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapAttemptEventData) == 0x60, "Size mismatch!");
