...
// Write type traits
MARK_REF_T(::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsGameplayModifiers*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsGameplayModifiers*, "BeatSaber.Analytics.Gameplay.EventSenders", "GameAnalyticsGameplayModifiers");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3261624, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsGameplayModifiers) == 0x28, "Size mismatch!");
