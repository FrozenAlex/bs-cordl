...
// Write type traits
MARK_REF_T(::BeatSaber::Analytics::Gameplay::EventSenders::NoopBlockLevelGameplayEventSender*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Analytics::Gameplay::EventSenders::NoopBlockLevelGameplayEventSender*, "BeatSaber.Analytics.Gameplay.EventSenders", "NoopBlockLevelGameplayEventSender");
...
public:
  ...
  /// @brief Method SendBlockLevelGameplayEvent, addr 0x31d0d34, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x31ceeec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BeatSaber::Analytics::Gameplay::EventSenders::NoopBlockLevelGameplayEventSender) == 0x10, "Size mismatch!");
