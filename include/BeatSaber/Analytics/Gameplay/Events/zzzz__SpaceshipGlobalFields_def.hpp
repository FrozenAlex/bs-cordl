...
public:
  ...
  /// @brief Method SetGlobalAppID, addr 0x3261fe0, size 0x50, virtual false, abstract: false, final false
  static inline void SetGlobalAppID(uint64_t appId);

  static inline uint64_t getStaticF__appId();

  /// @brief Method get_appId, addr 0x3262084, size 0x4c, virtual false, abstract: false, final false
  static inline uint64_t get_appId();

  /// @brief Method get_buildVersion, addr 0x3262030, size 0x54, virtual false, abstract: false, final false
  static inline ::StringW get_buildVersion();

  /// @brief Method get_userType, addr 0x32620d0, size 0x44, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::Analytics::Gameplay::Events::SpaceshipGlobalFields) == 0x10, "Size mismatch!");
