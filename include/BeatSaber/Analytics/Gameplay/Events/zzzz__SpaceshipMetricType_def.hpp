...
// Write type traits
MARK_REF_T(::BeatSaber::Analytics::Gameplay::Events::SpaceshipMetricType*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Analytics::Gameplay::Events::SpaceshipMetricType*, "BeatSaber.Analytics.Gameplay.Events", "SpaceshipMetricType");
...
public:
  ...
  /// @brief Method ToString, addr 0x3262268, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3262260, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Value, addr 0x3262258, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::Analytics::Gameplay::Events::SpaceshipMetricType) == 0x18, "Size mismatch!");
