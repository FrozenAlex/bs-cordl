...
// Write type traits
MARK_REF_T(::BeatSaber::Analytics::Gameplay::SegmentState*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Analytics::Gameplay::SegmentState*, "BeatSaber.Analytics.Gameplay", "SegmentState");
...
public:
  ...
  /// @brief Method .ctor, addr 0x325fdb4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::Analytics::Gameplay::SegmentState) == 0x28, "Size mismatch!");
