...
// Write type traits
MARK_REF_T(::BeatSaber::AvatarCore::AbstractAdapterInstallerSO*);
DEFINE_IL2CPP_CLASS(::BeatSaber::AvatarCore::AbstractAdapterInstallerSO*, "BeatSaber.AvatarCore", "AbstractAdapterInstallerSO");
...
public:
  ...
  /// @brief Method .ctor, addr 0x31d1d70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BeatSaber::AvatarCore::AbstractAdapterInstallerSO) == 0x20, "Size mismatch!");
