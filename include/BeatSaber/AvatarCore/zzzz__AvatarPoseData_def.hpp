...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x3267d80, size 0x4c, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::AvatarCore::AvatarPoseData) == 0x54, "Size mismatch!");
