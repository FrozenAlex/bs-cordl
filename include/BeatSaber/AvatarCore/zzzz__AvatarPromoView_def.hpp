...
// Write type traits
MARK_REF_T(::BeatSaber::AvatarCore::AvatarPromoView*);
DEFINE_IL2CPP_CLASS(::BeatSaber::AvatarCore::AvatarPromoView*, "BeatSaber.AvatarCore", "AvatarPromoView");
...
public:
  ...
  /// @brief Method .ctor, addr 0x31d3604, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_rectTransform, addr 0x31d35fc, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::AvatarCore::AvatarPromoView) == 0x28, "Size mismatch!");
