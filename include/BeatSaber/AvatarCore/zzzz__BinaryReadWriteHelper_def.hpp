...
// Write type traits
MARK_REF_T(::BeatSaber::AvatarCore::BinaryReadWriteHelper*);
DEFINE_IL2CPP_CLASS(::BeatSaber::AvatarCore::BinaryReadWriteHelper*, "BeatSaber.AvatarCore", "BinaryReadWriteHelper");
...
public:
  // Declarations
  /// @brief Method ReadColor, addr 0x31d6984, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color ReadColor(::System::IO::BinaryReader* binaryReader);

  /// @brief Method Write, addr 0x31d68fc, size 0x88, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::AvatarCore::BinaryReadWriteHelper) == 0x10, "Size mismatch!");
