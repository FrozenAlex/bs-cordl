...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::BeatSaber::AvatarCore::AvatarPoseData (::BeatSaber::AvatarCore::ConnectedPlayerAvatarPoseDataProvider::*)()>(
  ...
  constexpr static std::size_t addrs = 0x31d6a14;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BeatSaber::AvatarCore::ConnectedPlayerAvatarPoseDataProvider*>(), { "get_currentPose", {}, {} })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::BeatSaber::AvatarCore::ConnectedPlayerAvatarPoseDataProvider::*)(::System::Action_1<::BeatSaber::AvatarCore::AvatarPoseData>*)>(
  ...
  constexpr static std::size_t addrs = 0x31d6a24;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BeatSaber::AvatarCore::ConnectedPlayerAvatarPoseDataProvider*>(),
                                                             { "add_poseDidChangeEvent", {}, { ::i2c::type_of<::System::Action_1<::BeatSaber::AvatarCore::AvatarPoseData>*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::BeatSaber::AvatarCore::ConnectedPlayerAvatarPoseDataProvider::*)(::System::Action_1<::BeatSaber::AvatarCore::AvatarPoseData>*)>(
  ...
  constexpr static std::size_t size = 0xc0;
  constexpr static std::size_t addrs = 0x31d6ae4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BeatSaber::AvatarCore::ConnectedPlayerAvatarPoseDataProvider*>(),
                                                             { "remove_poseDidChangeEvent", {}, { ::i2c::type_of<::System::Action_1<::BeatSaber::AvatarCore::AvatarPoseData>*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::BeatSaber::AvatarCore::ConnectedPlayerAvatarPoseDataProvider::*)(
  ...
  constexpr static std::size_t addrs = 0x31d6ba4;
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BeatSaber::AvatarCore::ConnectedPlayerAvatarPoseDataProvider*>(),
                                                             { ".ctor",
                                                               {},
                                                               { ::i2c::type_of<::GlobalNamespace::IBeatSaberConnectedPlayer*>(), ::i2c::type_of<::GlobalNamespace::INodePoseSyncStateManager*>(),
                                                                 ::i2c::type_of<::BeatSaber::AvatarCore::IAvatarPoseRestriction*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::BeatSaber::AvatarCore::ConnectedPlayerAvatarPoseDataProvider::*)()>(
  ...
  constexpr static std::size_t addrs = 0x31d6bb0;
...
constexpr void BeatSaber::AvatarCore::ConnectedPlayerAvatarPoseDataProvider::__cordl_internal_set_poseDidChangeEvent(::System::Action_1<::BeatSaber::AvatarCore::AvatarPoseData>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->___poseDidChangeEvent = value;
}
constexpr ::GlobalNamespace::IBeatSaberConnectedPlayer*& BeatSaber::AvatarCore::ConnectedPlayerAvatarPoseDataProvider::__cordl_internal_get__connectedPlayer() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____connectedPlayer;
}
constexpr ::GlobalNamespace::IBeatSaberConnectedPlayer* const& BeatSaber::AvatarCore::ConnectedPlayerAvatarPoseDataProvider::__cordl_internal_get__connectedPlayer() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____connectedPlayer;
}
constexpr void BeatSaber::AvatarCore::ConnectedPlayerAvatarPoseDataProvider::__cordl_internal_set__connectedPlayer(::GlobalNamespace::IBeatSaberConnectedPlayer* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline void BeatSaber::AvatarCore::ConnectedPlayerAvatarPoseDataProvider::_ctor(::GlobalNamespace::IBeatSaberConnectedPlayer* connectedPlayer,
  ...
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BeatSaber::AvatarCore::ConnectedPlayerAvatarPoseDataProvider*>(),
                                                           { ".ctor",
                                                             ...
                                                             { ::i2c::type_of<::GlobalNamespace::IBeatSaberConnectedPlayer*>(), ::i2c::type_of<::GlobalNamespace::INodePoseSyncStateManager*>(),
                                                               ::i2c::type_of<::BeatSaber::AvatarCore::IAvatarPoseRestriction*>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, connectedPlayer, nodePoseSyncStateManager, avatarPoseRestriction);
}
...
BeatSaber::AvatarCore::ConnectedPlayerAvatarPoseDataProvider::New_ctor(::GlobalNamespace::IBeatSaberConnectedPlayer* connectedPlayer,
                                                                       ::GlobalNamespace::INodePoseSyncStateManager* nodePoseSyncStateManager,
                                                                       ::BeatSaber::AvatarCore::IAvatarPoseRestriction* avatarPoseRestriction) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::BeatSaber::AvatarCore::ConnectedPlayerAvatarPoseDataProvider*>(connectedPlayer, nodePoseSyncStateManager, avatarPoseRestriction));
}
