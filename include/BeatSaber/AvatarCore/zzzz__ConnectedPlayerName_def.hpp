...
// Write type traits
MARK_REF_T(::BeatSaber::AvatarCore::ConnectedPlayerName*);
DEFINE_IL2CPP_CLASS(::BeatSaber::AvatarCore::ConnectedPlayerName*, "BeatSaber.AvatarCore", "ConnectedPlayerName");
...
public:
  ...
  /// @brief Method Start, addr 0x31d717c, size 0xc8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x31d7244, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BeatSaber::AvatarCore::ConnectedPlayerName) == 0x30, "Size mismatch!");
