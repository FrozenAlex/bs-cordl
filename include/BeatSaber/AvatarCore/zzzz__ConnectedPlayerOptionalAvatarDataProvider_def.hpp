...
public:
  ...
  /// @brief Method Dispose, addr 0x326cd60, size 0x94, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleOptionalAvatarDataSyncHandlerDidChangeOptionalAvatarDataSync, addr 0x326ceb8, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDisplayContext, addr 0x326ceb4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x326cbf4, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method add_dataDidChangeEvent, addr 0x326ca74, size 0xc0, virtual true, abstract: false, final true
  inline void add_dataDidChangeEvent(::System::Action_1<::BeatSaber::AvatarCore::OptionalAvatarData>* value);

  /// @brief Method get_currentData, addr 0x326c8a4, size 0x34, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::Dictionary_2<uint32_t, ::BeatSaber::AvatarCore::OptionalAvatarData>* get_currentData();

  /// @brief Method get_playbackDelayMs, addr 0x326c944, size 0x130, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_dataDidChangeEvent, addr 0x326cb34, size 0xc0, virtual true, abstract: false, final true
