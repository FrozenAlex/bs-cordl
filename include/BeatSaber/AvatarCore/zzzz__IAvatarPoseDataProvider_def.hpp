...
// Write type traits
MARK_REF_T(::BeatSaber::AvatarCore::IAvatarPoseDataProvider*);
DEFINE_IL2CPP_CLASS(::BeatSaber::AvatarCore::IAvatarPoseDataProvider*, "BeatSaber.AvatarCore", "IAvatarPoseDataProvider");
// Dependencies
namespace BeatSaber::AvatarCore {
// Is value type: false
