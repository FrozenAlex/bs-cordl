...
// Write type traits
MARK_REF_T(::BeatSaber::AvatarCore::IAvatarSystemMetadata*);
DEFINE_IL2CPP_CLASS(::BeatSaber::AvatarCore::IAvatarSystemMetadata*, "BeatSaber.AvatarCore", "IAvatarSystemMetadata");
// Dependencies
namespace BeatSaber::AvatarCore {
// Is value type: false
