...
// Write type traits
MARK_REF_T(::BeatSaber::AvatarCore::IOptionalAvatarDataProvider*);
DEFINE_IL2CPP_CLASS(::BeatSaber::AvatarCore::IOptionalAvatarDataProvider*, "BeatSaber.AvatarCore", "IOptionalAvatarDataProvider");
// Dependencies
namespace BeatSaber::AvatarCore {
// Is value type: false
