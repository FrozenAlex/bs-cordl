...
// Write type traits
MARK_REF_T(::BeatSaber::AvatarCore::LobbyAvatarInstaller*);
DEFINE_IL2CPP_CLASS(::BeatSaber::AvatarCore::LobbyAvatarInstaller*, "BeatSaber.AvatarCore", "LobbyAvatarInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x31d7524, size 0x300, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31d7824, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BeatSaber::AvatarCore::LobbyAvatarInstaller) == 0x30, "Size mismatch!");
