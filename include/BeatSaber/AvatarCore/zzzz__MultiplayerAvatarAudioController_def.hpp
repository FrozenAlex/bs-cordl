...
// Write type traits
MARK_REF_T(::BeatSaber::AvatarCore::MultiplayerAvatarAudioController*);
MARK_REF_T(::BeatSaber::AvatarCore::MultiplayerAvatarAudioController__Start_d__4*);
DEFINE_IL2CPP_CLASS(::BeatSaber::AvatarCore::MultiplayerAvatarAudioController*, "BeatSaber.AvatarCore", "MultiplayerAvatarAudioController");
DEFINE_IL2CPP_CLASS(::BeatSaber::AvatarCore::MultiplayerAvatarAudioController__Start_d__4*, "BeatSaber.AvatarCore", "MultiplayerAvatarAudioController/<Start>d__4");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x31d7894, size 0xd8, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::BeatSaber::AvatarCore::MultiplayerAvatarAudioController__Start_d__4* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x31d796c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x31d7974, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x31d79ac, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x31d7890, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x31d7884, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::AvatarCore::MultiplayerAvatarAudioController__Start_d__4) == 0x28, "Size mismatch!");
...
public:
  ...
  /// @brief Method Start, addr 0x31d7830, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31d788c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_connectedPlayer, addr 0x31d7828, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::AvatarCore::MultiplayerAvatarAudioController) == 0x30, "Size mismatch!");
