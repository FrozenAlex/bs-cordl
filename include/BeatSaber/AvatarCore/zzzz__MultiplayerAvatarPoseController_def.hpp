...
public:
  ...
  /// @brief Method Start, addr 0x326c00c, size 0x98, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x326c0a4, size 0x4f0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x326c594, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didUpdatePoseEvent, addr 0x3267a88, size 0xc0, virtual false, abstract: false, final false
  inline void add_didUpdatePoseEvent(::System::Action_1<::UnityEngine::Vector3>* value);

  /// @brief Method get_leftHandTransform, addr 0x326bff4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_leftHandTransform();

  /// @brief Method get_rightHandTransform, addr 0x326bffc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_rightHandTransform();

  /// @brief Method remove_didUpdatePoseEvent, addr 0x3267c58, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didUpdatePoseEvent(::System::Action_1<::UnityEngine::Vector3>* value);

  /// @brief Method set_connectedPlayer, addr 0x326c004, size 0x8, virtual false, abstract: false, final false
