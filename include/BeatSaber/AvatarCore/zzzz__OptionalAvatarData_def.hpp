...
DEFINE_IL2CPP_CLASS(::BeatSaber::AvatarCore::OptionalAvatarData, "BeatSaber.AvatarCore", "OptionalAvatarData");
// Dependencies
namespace BeatSaber::AvatarCore {
// Is value type: true
...
public:
  ...
  /// @brief Method Equals, addr 0x31d8954, size 0xbc, virtual true, abstract: false, final true
...
static_assert(sizeof(::BeatSaber::AvatarCore::OptionalAvatarData) == 0x10, "Size mismatch!");
