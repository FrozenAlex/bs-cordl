...
// Write type traits
MARK_REF_T(::BeatSaber::AvatarCore::StaticAvatarVisualDataProvider*);
DEFINE_IL2CPP_CLASS(::BeatSaber::AvatarCore::StaticAvatarVisualDataProvider*, "BeatSaber.AvatarCore", "StaticAvatarVisualDataProvider");
...
public:
  ...
  /// @brief Method .ctor, addr 0x326e1ec, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::MultiplayerAvatarsData avatarsData);

  /// @brief Method get_avatarsData, addr 0x326e1d8, size 0x14, virtual true, abstract: false, final true
...
static_assert(sizeof(::BeatSaber::AvatarCore::StaticAvatarVisualDataProvider) == 0x28, "Size mismatch!");
