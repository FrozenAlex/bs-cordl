...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x3271f48, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarHistorySnapshot) == 0x10, "Size mismatch!");
