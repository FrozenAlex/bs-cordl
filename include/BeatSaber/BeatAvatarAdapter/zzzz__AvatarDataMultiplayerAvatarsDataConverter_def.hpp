...
public:
  // Declarations
  /// @brief Method CreateAvatarData, addr 0x32707c8, size 0x584, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateMultiplayerAvatarsData, addr 0x327032c, size 0x49c, virtual false, abstract: false, final false
