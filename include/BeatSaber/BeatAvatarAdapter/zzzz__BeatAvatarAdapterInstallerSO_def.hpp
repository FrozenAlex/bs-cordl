...
// Write type traits
MARK_REF_T(::BeatSaber::BeatAvatarAdapter::BeatAvatarAdapterInstallerSO*);
DEFINE_IL2CPP_CLASS(::BeatSaber::BeatAvatarAdapter::BeatAvatarAdapterInstallerSO*, "BeatSaber.BeatAvatarAdapter", "BeatAvatarAdapterInstallerSO");
...
static_assert(sizeof(::BeatSaber::BeatAvatarAdapter::BeatAvatarAdapterInstallerSO) == 0x48, "Size mismatch!");
