...
// Write type traits
MARK_REF_T(::BeatSaber::BeatAvatarSDK::AvatarMeshPartSO*);
DEFINE_IL2CPP_CLASS(::BeatSaber::BeatAvatarSDK::AvatarMeshPartSO*, "BeatSaber.BeatAvatarSDK", "AvatarMeshPartSO");
...
public:
  ...
  /// @brief Method .ctor, addr 0x31e3c40, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mesh, addr 0x31e3bfc, size 0x44, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::BeatAvatarSDK::AvatarMeshPartSO) == 0x30, "Size mismatch!");
