...
DEFINE_IL2CPP_CLASS(::BeatSaber::BeatAvatarSDK::AvatarPart, "BeatSaber.BeatAvatarSDK", "AvatarPart");
// Dependencies
namespace BeatSaber::BeatAvatarSDK {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::BeatAvatarSDK::AvatarPart) == 0x4, "Size mismatch!");
