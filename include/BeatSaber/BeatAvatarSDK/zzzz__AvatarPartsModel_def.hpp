...
// Write type traits
MARK_REF_T(::BeatSaber::BeatAvatarSDK::AvatarPartsModel*);
DEFINE_IL2CPP_CLASS(::BeatSaber::BeatAvatarSDK::AvatarPartsModel*, "BeatSaber.BeatAvatarSDK", "AvatarPartsModel");
// Dependencies BeatSaber.BeatAvatarSDK.SkinColorSO, System.Object
namespace BeatSaber::BeatAvatarSDK {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__skinColors_k__BackingField, put = __cordl_internal_set__skinColors_k__BackingField)) ::ArrayW<::UnityW<::BeatSaber::BeatAvatarSDK::SkinColorSO>>
  ...
  /// @brief Method GetColorIndexById, addr 0x3278480, size 0x88, virtual false, abstract: false, final false
  inline int32_t GetColorIndexById(::StringW id);

  /// @brief Method GetRandomColor, addr 0x32775dc, size 0x68, virtual false, abstract: false, final false
  inline ::UnityW<::BeatSaber::BeatAvatarSDK::SkinColorSO> GetRandomColor();

  /// @brief Method GetSkinColorById, addr 0x3278508, size 0x34, virtual false, abstract: false, final false
  ...
  constexpr ::BeatSaber::BeatAvatarSDK::AvatarPartCollection_1<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarMeshPartSO>>* const& __cordl_internal_get__clothesCollection_k__BackingField() const;
  ...
  constexpr ::BeatSaber::BeatAvatarSDK::AvatarPartCollection_1<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarSpritePartSO>>* const& __cordl_internal_get__eyesCollection_k__BackingField() const;
  ...
  constexpr ::BeatSaber::BeatAvatarSDK::AvatarPartCollection_1<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarMeshPartSO>>* const& __cordl_internal_get__facialHairCollection_k__BackingField() const;
  ...
  constexpr ::BeatSaber::BeatAvatarSDK::AvatarPartCollection_1<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarMeshPartSO>>* const& __cordl_internal_get__glassesCollection_k__BackingField() const;
  ...
  constexpr ::BeatSaber::BeatAvatarSDK::AvatarPartCollection_1<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarMeshPartSO>>* const& __cordl_internal_get__handsCollection_k__BackingField() const;
  ...
  constexpr ::BeatSaber::BeatAvatarSDK::AvatarPartCollection_1<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarMeshPartSO>>* const& __cordl_internal_get__headTopCollection_k__BackingField() const;
  ...
  constexpr ::System::Collections::Generic::Dictionary_2<::StringW, int32_t>* const& __cordl_internal_get__indexById() const;

  constexpr ::System::Collections::Generic::Dictionary_2<::StringW, int32_t>*& __cordl_internal_get__indexById();

  constexpr ::BeatSaber::BeatAvatarSDK::AvatarPartCollection_1<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarSpritePartSO>>* const& __cordl_internal_get__mouthCollection_k__BackingField() const;
  ...
  constexpr ::ArrayW<::UnityW<::BeatSaber::BeatAvatarSDK::SkinColorSO>> const& __cordl_internal_get__skinColors_k__BackingField() const;

  constexpr ::ArrayW<::UnityW<::BeatSaber::BeatAvatarSDK::SkinColorSO>>& __cordl_internal_get__skinColors_k__BackingField();
  ...
  /// @brief Method .ctor, addr 0x3278208, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method get_clothesCollection, addr 0x32781f8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_eyesCollection, addr 0x32781d0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_facialHairCollection, addr 0x32781e8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_glassesCollection, addr 0x32781e0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_handsCollection, addr 0x32781f0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_headTopCollection, addr 0x32781c8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_mouthCollection, addr 0x32781d8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_skinColors, addr 0x3278200, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::BeatAvatarSDK::AvatarPartsModel) == 0x58, "Size mismatch!");
