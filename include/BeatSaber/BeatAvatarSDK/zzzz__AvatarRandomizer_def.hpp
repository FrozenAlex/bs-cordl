...
public:
  ...
  /// @brief Method RandomizeAll, addr 0x3277644, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method RandomizeColors, addr 0x3278fdc, size 0x2e0, virtual false, abstract: false, final false
  static inline void RandomizeColors(::BeatSaber::BeatAvatarSDK::AvatarData* avatarData);

  /// @brief Method RandomizeModels, addr 0x3278e48, size 0x194, virtual false, abstract: false, final false
