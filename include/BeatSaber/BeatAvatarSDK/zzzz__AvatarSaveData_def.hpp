...
// Write type traits
MARK_REF_T(::BeatSaber::BeatAvatarSDK::AvatarSaveData*);
DEFINE_IL2CPP_CLASS(::BeatSaber::BeatAvatarSDK::AvatarSaveData*, "BeatSaber.BeatAvatarSDK", "AvatarSaveData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x32780b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BeatSaber::BeatAvatarSDK::AvatarSaveData) == 0xd0, "Size mismatch!");
