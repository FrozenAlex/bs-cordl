...
// Write type traits
MARK_REF_T(::BeatSaber::BeatAvatarSDK::HeadBodyOffsetSO*);
DEFINE_IL2CPP_CLASS(::BeatSaber::BeatAvatarSDK::HeadBodyOffsetSO*, "BeatSaber.BeatAvatarSDK", "HeadBodyOffsetSO");
...
public:
  ...
  /// @brief Method .ctor, addr 0x327a514, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_headNeckOffset, addr 0x327a500, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_headNeckOffset();

  /// @brief Method get_verticalOffset, addr 0x327a50c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::BeatAvatarSDK::HeadBodyOffsetSO) == 0x28, "Size mismatch!");
