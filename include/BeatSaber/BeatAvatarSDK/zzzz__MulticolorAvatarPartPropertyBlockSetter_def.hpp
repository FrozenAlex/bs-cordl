...
// Write type traits
MARK_REF_T(::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter*);
MARK_REF_T(::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter_ColorData*);
MARK_REF_T(::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter___c*);
DEFINE_IL2CPP_CLASS(::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter*, "BeatSaber.BeatAvatarSDK", "MulticolorAvatarPartPropertyBlockSetter");
DEFINE_IL2CPP_CLASS(::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter_ColorData*, "BeatSaber.BeatAvatarSDK", "MulticolorAvatarPartPropertyBlockSetter/ColorData");
DEFINE_IL2CPP_CLASS(::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter___c*, "BeatSaber.BeatAvatarSDK", "MulticolorAvatarPartPropertyBlockSetter/<>c");
...
public:
  ...
  /// @brief Method .ctor, addr 0x327a92c, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_darkerColorMultiplier, addr 0x327a91c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_darkerColorMultiplier();

  /// @brief Method get_defaultColor, addr 0x327a910, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_defaultColor();

  /// @brief Method get_whiteBoost, addr 0x327a924, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <OnValidate>b__10_0, addr 0x327a99c, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Color _OnValidate_b__10_0(::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter_ColorData* x);

  /// @brief Method .ctor, addr 0x327a998, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter___c) == 0x10, "Size mismatch!");

} // namespace BeatSaber::BeatAvatarSDK
// Dependencies BeatSaber.BeatAvatarSDK.MulticolorAvatarPartPropertyBlockSetter::ColorData, UnityEngine.Color, UnityEngine.MonoBehaviour, UnityEngine.Vector4
namespace BeatSaber::BeatAvatarSDK {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__boostColors, put = __cordl_internal_set__boostColors)) ::ArrayW<::UnityEngine::Color> _boostColors;

  /// @brief Field _colorDataList, offset 0x20, size 0x8
  __declspec(property(get = __cordl_internal_get__colorDataList, put = __cordl_internal_set__colorDataList)) ::ArrayW<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter_ColorData*>
      _colorDataList;
  ...
  __declspec(property(get = __cordl_internal_get__rimLightColors, put = __cordl_internal_set__rimLightColors)) ::ArrayW<::UnityEngine::Vector4> _rimLightColors;
  ...
  /// @brief Method OnValidate, addr 0x327a528, size 0x1d8, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method SetColors, addr 0x327a128, size 0x208, virtual false, abstract: false, final false
  inline void SetColors(::ArrayW<::UnityEngine::Color> colors);

  /// @brief Method SetHighlight, addr 0x327a450, size 0xc, virtual false, abstract: false, final false
  inline void SetHighlight(bool highlighted, int32_t uvSegment);

  /// @brief Method UpdateRenderer, addr 0x327a700, size 0x1a0, virtual false, abstract: false, final false
  inline void UpdateRenderer();

  constexpr ::ArrayW<::UnityEngine::Color> const& __cordl_internal_get__boostColors() const;

  constexpr ::ArrayW<::UnityEngine::Color>& __cordl_internal_get__boostColors();

  constexpr ::ArrayW<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter_ColorData*> const& __cordl_internal_get__colorDataList() const;

  constexpr ::ArrayW<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter_ColorData*>& __cordl_internal_get__colorDataList();
  ...
  constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get__rimLightColors() const;

  constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get__rimLightColors();

  constexpr int32_t const& __cordl_internal_get__uvSegment() const;

  constexpr int32_t& __cordl_internal_get__uvSegment();

  constexpr void __cordl_internal_set__boostColors(::ArrayW<::UnityEngine::Color> value);

  constexpr void __cordl_internal_set__colorDataList(::ArrayW<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter_ColorData*> value);
  ...
  constexpr void __cordl_internal_set__rimLightColors(::ArrayW<::UnityEngine::Vector4> value);

  constexpr void __cordl_internal_set__uvSegment(int32_t value);

  /// @brief Method .ctor, addr 0x327a8a0, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::UnityEngine::Vector4> ____rimLightColors;

  /// @brief Field _boostColors, offset: 0x48, size: 0x8, def value: None
  ::ArrayW<::UnityEngine::Color> ____boostColors;
...
static_assert(sizeof(::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter) == 0x58, "Size mismatch!");
