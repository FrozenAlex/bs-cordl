...
// Write type traits
MARK_REF_T(::BeatSaber::BeatAvatarSDK::RandomizeAvatarColorMap*);
DEFINE_IL2CPP_CLASS(::BeatSaber::BeatAvatarSDK::RandomizeAvatarColorMap*, "BeatSaber.BeatAvatarSDK", "RandomizeAvatarColorMap");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__colorIndices_k__BackingField, put = __cordl_internal_set__colorIndices_k__BackingField)) ::ArrayW<int32_t> _colorIndices_k__BackingField;
  ...
  __declspec(property(get = get_colorIndices)) ::ArrayW<int32_t> colorIndices;
  ...
  constexpr ::ArrayW<int32_t> const& __cordl_internal_get__colorIndices_k__BackingField() const;

  constexpr ::ArrayW<int32_t>& __cordl_internal_get__colorIndices_k__BackingField();
  ...
  constexpr void __cordl_internal_set__colorIndices_k__BackingField(::ArrayW<int32_t> value);
...
static_assert(sizeof(::BeatSaber::BeatAvatarSDK::RandomizeAvatarColorMap) == 0x20, "Size mismatch!");
