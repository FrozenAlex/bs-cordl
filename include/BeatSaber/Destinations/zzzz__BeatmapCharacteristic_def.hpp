...
DEFINE_IL2CPP_CLASS(::BeatSaber::Destinations::BeatmapCharacteristic, "BeatSaber.Destinations", "BeatmapCharacteristic");
// Dependencies
namespace BeatSaber::Destinations {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::Destinations::BeatmapCharacteristic) == 0x4, "Size mismatch!");
