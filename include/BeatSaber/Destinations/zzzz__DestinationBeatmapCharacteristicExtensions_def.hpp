...
// Write type traits
MARK_REF_T(::BeatSaber::Destinations::DestinationBeatmapCharacteristicExtensions*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Destinations::DestinationBeatmapCharacteristicExtensions*, "BeatSaber.Destinations", "DestinationBeatmapCharacteristicExtensions");
...
static_assert(sizeof(::BeatSaber::Destinations::DestinationBeatmapCharacteristicExtensions) == 0x10, "Size mismatch!");
