...
DEFINE_IL2CPP_CLASS(::BeatSaber::Destinations::DestinationSource, "BeatSaber.Destinations", "DestinationSource");
// Dependencies
namespace BeatSaber::Destinations {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::Destinations::DestinationSource) == 0x4, "Size mismatch!");
