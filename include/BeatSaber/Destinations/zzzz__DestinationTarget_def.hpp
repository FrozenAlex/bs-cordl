...
DEFINE_IL2CPP_CLASS(::BeatSaber::Destinations::DestinationTarget, "BeatSaber.Destinations", "DestinationTarget");
// Dependencies
namespace BeatSaber::Destinations {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::Destinations::DestinationTarget) == 0x4, "Size mismatch!");
