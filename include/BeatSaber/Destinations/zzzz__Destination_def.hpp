...
public:
  ...
  /// @brief Method .ctor, addr 0x31e8f54, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(::BeatSaber::Destinations::DestinationTarget stage, ::BeatSaber::Destinations::LevelStartDestinationParameters* levelStartDestination, ::ArrayW<::StringW> arguments,
                    bool requiresHealthWarning, bool loadMenu);
...
static_assert(sizeof(::BeatSaber::Destinations::Destination) == 0x30, "Size mismatch!");
