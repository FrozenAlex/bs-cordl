...
DEFINE_IL2CPP_CLASS(::BeatSaber::Destinations::InitialDestinationController__InitializeInternalAsync_d__12, "BeatSaber.Destinations", "InitialDestinationController/<InitializeInternalAsync>d__12");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x31e9558, size 0x2cc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x31e9824, size 0x6c, virtual true, abstract: false, final true
...
static_assert(sizeof(::BeatSaber::Destinations::InitialDestinationController__InitializeInternalAsync_d__12) == 0x30, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetDestinationSourcePriority, addr 0x31e9104, size 0x4, virtual false, abstract: false, final false
  static inline int32_t GetDestinationSourcePriority(::BeatSaber::Destinations::DestinationSource destinationSource);

  /// @brief Method InitializeInternalAsync, addr 0x31e93b0, size 0xb0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* InitializeInternalAsync();

  /// @brief Method InitializeScenesAsync, addr 0x31e9348, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method OverrideDestination, addr 0x31e9108, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x31e94bc, size 0x10, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SetDestinationResolver, addr 0x31e9460, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31e94cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::BeatSaber::Destinations::Destination* getStaticF_kDefaultInitialDestination();

  /// @brief Method get_initialDestination, addr 0x31e909c, size 0x68, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::Destinations::InitialDestinationController) == 0x40, "Size mismatch!");
