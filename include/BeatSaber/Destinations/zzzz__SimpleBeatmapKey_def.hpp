...
// Write type traits
MARK_REF_T(::BeatSaber::Destinations::SimpleBeatmapKey*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Destinations::SimpleBeatmapKey*, "BeatSaber.Destinations", "SimpleBeatmapKey");
...
static_assert(sizeof(::BeatSaber::Destinations::SimpleBeatmapKey) == 0x20, "Size mismatch!");
