...
// Write type traits
MARK_REF_T(::GlobalNamespace::FeatureConfiguration_Hardcoded*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FeatureConfiguration_Hardcoded*, "BeatSaber.FeatureFlags", "FeatureConfiguration/Hardcoded");
...
public:
  ...
  /// @brief Method .ctor, addr 0x31f5bf0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::FeatureConfiguration_Hardcoded) == 0x18, "Size mismatch!");
