...
// Write type traits
MARK_REF_T(::GlobalNamespace::FeatureConfiguration_RemoteWithDependency*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FeatureConfiguration_RemoteWithDependency*, "BeatSaber.FeatureFlags", "FeatureConfiguration/RemoteWithDependency");
...
public:
  ...
  /// @brief Method .ctor, addr 0x32879f4, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::FeatureConfiguration_RemoteWithDependency) == 0x20, "Size mismatch!");
