...
// Write type traits
MARK_REF_T(::GlobalNamespace::FeatureConfiguration_Remote*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FeatureConfiguration_Remote*, "BeatSaber.FeatureFlags", "FeatureConfiguration/Remote");
...
static_assert(sizeof(::GlobalNamespace::FeatureConfiguration_Remote) == 0x20, "Size mismatch!");
