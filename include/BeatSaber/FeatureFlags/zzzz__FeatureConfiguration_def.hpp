...
// Write type traits
MARK_REF_T(::BeatSaber::FeatureFlags::FeatureConfiguration*);
DEFINE_IL2CPP_CLASS(::BeatSaber::FeatureFlags::FeatureConfiguration*, "BeatSaber.FeatureFlags", "FeatureConfiguration");
...
public:
  ...
  /// @brief Method .ctor, addr 0x31f5bec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BeatSaber::FeatureFlags::FeatureConfiguration) == 0x10, "Size mismatch!");
