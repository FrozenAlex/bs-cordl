...
public:
  // Declarations
  /// @brief Method CreateQuery, addr 0x31f81e4, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31f7c90, size 0x28, virtual false, abstract: false, final false
