...
// Write type traits
MARK_REF_T(::BeatSaber::FeatureFlags::FeatureFlags*);
DEFINE_IL2CPP_CLASS(::BeatSaber::FeatureFlags::FeatureFlags*, "BeatSaber.FeatureFlags", "FeatureFlags");
...
public:
  ...
  __declspec(property(
      get = __cordl_internal_get__configurations,
      put = __cordl_internal_set__configurations)) ::System::Collections::Generic::Dictionary_2<::BeatSaber::FeatureFlags::Feature, ::BeatSaber::FeatureFlags::FeatureConfiguration*>* _configurations;
  ...
  /// @brief Method GetConfiguration, addr 0x3287a04, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3287a0c, size 0x198, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BeatSaber::FeatureFlags::FeatureFlags) == 0x18, "Size mismatch!");
