...
CORDL_MODULE_EXPORT(MissingFeatureFlagException)
// Forward declare root types
namespace BeatSaber::FeatureFlags {
class MissingFeatureFlagException;
}
// Write type traits
MARK_REF_T(::BeatSaber::FeatureFlags::MissingFeatureFlagException*);
DEFINE_IL2CPP_CLASS(::BeatSaber::FeatureFlags::MissingFeatureFlagException*, "BeatSaber.FeatureFlags", "MissingFeatureFlagException");
...
static_assert(sizeof(::BeatSaber::FeatureFlags::MissingFeatureFlagException) == 0x90, "Size mismatch!");
