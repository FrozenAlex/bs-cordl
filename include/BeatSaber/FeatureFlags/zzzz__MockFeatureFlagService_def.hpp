...
// Write type traits
MARK_REF_T(::BeatSaber::FeatureFlags::MockFeatureFlagService*);
DEFINE_IL2CPP_CLASS(::BeatSaber::FeatureFlags::MockFeatureFlagService*, "BeatSaber.FeatureFlags", "MockFeatureFlagService");
...
public:
  ...
  /// @brief Method Initialize, addr 0x3289d50, size 0x28, virtual true, abstract: false, final true
  inline void Initialize();

  /// @brief Method IsFeatureEnabled, addr 0x3289df4, size 0x98, virtual true, abstract: false, final true
  inline ::System::Nullable_1<bool> IsFeatureEnabled(::BeatSaber::FeatureFlags::Feature feature);

  /// @brief Method IsFeatureEnabledAsync, addr 0x3289e8c, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method SetFeatureEnabled, addr 0x3289d78, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3289f40, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BeatSaber::FeatureFlags::MockFeatureFlagService) == 0x18, "Size mismatch!");
