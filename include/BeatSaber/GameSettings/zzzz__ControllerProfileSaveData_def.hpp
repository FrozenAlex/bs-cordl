...
// Write type traits
MARK_REF_T(::BeatSaber::GameSettings::ControllerProfileSaveData*);
DEFINE_IL2CPP_CLASS(::BeatSaber::GameSettings::ControllerProfileSaveData*, "BeatSaber.GameSettings", "ControllerProfileSaveData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x31fda64, size 0x28, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::GameSettings::ControllerProfileSaveData) == 0x48, "Size mismatch!");
