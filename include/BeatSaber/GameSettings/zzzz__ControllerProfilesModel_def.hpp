...
MARK_REF_T(::BeatSaber::GameSettings::ControllerProfilesModel__GetBuiltInProfiles_d__21*);
...
DEFINE_IL2CPP_CLASS(::BeatSaber::GameSettings::ControllerProfilesModel__GetBuiltInProfiles_d__21*, "BeatSaber.GameSettings", "ControllerProfilesModel/<GetBuiltInProfiles>d__21");
DEFINE_IL2CPP_CLASS(::BeatSaber::GameSettings::ControllerProfilesModel___c*, "BeatSaber.GameSettings", "ControllerProfilesModel/<>c");
DEFINE_IL2CPP_CLASS(::BeatSaber::GameSettings::ControllerProfilesModel__Initialize_d__16, "BeatSaber.GameSettings", "ControllerProfilesModel/<Initialize>d__16");
DEFINE_IL2CPP_CLASS(::BeatSaber::GameSettings::ControllerProfilesModel__LoadAsync_d__17, "BeatSaber.GameSettings", "ControllerProfilesModel/<LoadAsync>d__17");
...
public:
  ...
  /// @brief Method <GetControllerProfilesSaveData>b__23_0, addr 0x31fcdcc, size 0x14, virtual false, abstract: false, final false
  inline bool _GetControllerProfilesSaveData_b__23_0(::BeatSaber::GameSettings::ControllerProfile* profile);

  /// @brief Method <GetControllerProfilesSaveData>b__23_1, addr 0x31fcde0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31fcdc8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x31fce94, size 0x88, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::BeatSaber::GameSettings::ControllerProfilesModel__GetBuiltInProfiles_d__21* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<BeatSaber.GameSettings.ControllerProfile>.GetEnumerator, addr 0x31fcf64, size 0x8c, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<BeatSaber.GameSettings.ControllerProfile>.get_Current, addr 0x31fcf1c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x31fcff0, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x31fcf24, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x31fcf5c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x31fce90, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x31fca94, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::GameSettings::ControllerProfilesModel__GetBuiltInProfiles_d__21) == 0x28, "Size mismatch!");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x31fcff4, size 0x244, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x31fd238, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::BeatSaber::GameSettings::ControllerProfilesModel__Initialize_d__16) == 0x38, "Size mismatch!");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x31fd240, size 0x504, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x31fd878, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
static_assert(sizeof(::BeatSaber::GameSettings::ControllerProfilesModel__LoadAsync_d__17) == 0x30, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetBuiltInProfiles, addr 0x31fc2ec, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::BeatSaber::GameSettings::ControllerProfile*>* GetBuiltInProfiles();

  /// @brief Method GetControllerProfilesSaveData, addr 0x31fc7a0, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDefaultController, addr 0x31fcd0c, size 0x68, virtual false, abstract: false, final false
  static inline ::BeatSaber::GameSettings::Controller GetDefaultController();

  /// @brief Method GetDefaultControllersProfile, addr 0x31fcc18, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDefaultCustomControllerProfile, addr 0x31fcab4, size 0x130, virtual false, abstract: false, final false
  inline ::BeatSaber::GameSettings::ControllerProfile* GetDefaultCustomControllerProfile(int32_t profileIndex);

  /// @brief Method GetSelectedProfileIndexFromSettings, addr 0x31fca48, size 0x4c, virtual false, abstract: false, final false
  inline int32_t GetSelectedProfileIndexFromSettings(int32_t builtInProfilesCount);

  /// @brief Method Initialize, addr 0x31fc354, size 0xa4, virtual true, abstract: false, final true
  inline void Initialize();

  /// @brief Method LoadAsync, addr 0x31fc3f8, size 0xb0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* LoadAsync();

  static inline ::BeatSaber::GameSettings::ControllerProfilesModel* New_ctor();

  /// @brief Method RefreshControllersReference, addr 0x31fc67c, size 0xa8, virtual false, abstract: false, final false
  inline void RefreshControllersReference();

  /// @brief Method SaveAsync, addr 0x31fc724, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* SaveAsync();

  /// @brief Method UpdateSelectedProfile, addr 0x31fc4a8, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31fc200, size 0xec, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_profiles, addr 0x31fc190, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::BeatSaber::GameSettings::ControllerProfile*>* get_profiles();

  /// @brief Method get_selectedProfile, addr 0x31fc1a8, size 0x58, virtual false, abstract: false, final false
  inline ::BeatSaber::GameSettings::ControllerProfile* get_selectedProfile();

  /// @brief Method get_selectedProfileIndex, addr 0x31fc198, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_selectedProfileIndex();

  /// @brief Convert to "::Zenject::IInitializable"
  constexpr ::Zenject::IInitializable* i___Zenject__IInitializable() noexcept;

  /// @brief Method set_selectedProfileIndex, addr 0x31fc1a0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::GameSettings::ControllerProfilesModel) == 0x38, "Size mismatch!");
