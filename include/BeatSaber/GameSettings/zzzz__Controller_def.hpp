...
DEFINE_IL2CPP_CLASS(::BeatSaber::GameSettings::Controller, "BeatSaber.GameSettings", "Controller");
...
public:
  // Declarations
  /// @brief Method HasDefaultValues, addr 0x31fda8c, size 0xc8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::GameSettings::Controller) == 0x18, "Size mismatch!");
