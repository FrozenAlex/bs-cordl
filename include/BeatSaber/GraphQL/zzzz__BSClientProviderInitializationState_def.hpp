...
DEFINE_IL2CPP_CLASS(::BeatSaber::GraphQL::BSClientProviderInitializationState, "BeatSaber.GraphQL", "BSClientProviderInitializationState");
// Dependencies
namespace BeatSaber::GraphQL {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::GraphQL::BSClientProviderInitializationState) == 0x4, "Size mismatch!");
