...
// Write type traits
MARK_REF_T(::BeatSaber::GraphQL::GraphQLClientEvents*);
DEFINE_IL2CPP_CLASS(::BeatSaber::GraphQL::GraphQLClientEvents*, "BeatSaber.GraphQL", "GraphQLClientEvents");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_onRequestSucceeded,
                      put = __cordl_internal_set_onRequestSucceeded)) ::System::Action_1<::OculusStudios::GraphQL::ClientInterface::Request*>* onRequestSucceeded;
  ...
  /// @brief Method LogError, addr 0x32916f8, size 0xac, virtual true, abstract: false, final true
  inline void LogError(::System::Exception* exception);

  /// @brief Method LogError, addr 0x329166c, size 0x8c, virtual true, abstract: false, final true
  inline void LogError(::StringW message);

  /// @brief Method LogInfo, addr 0x3291830, size 0xac, virtual true, abstract: false, final true
  inline void LogInfo(::System::Exception* exception);

  /// @brief Method LogInfo, addr 0x32917a4, size 0x8c, virtual true, abstract: false, final true
  inline void LogInfo(::StringW message);

  /// @brief Method LogVerbose, addr 0x32918dc, size 0x4, virtual true, abstract: false, final true
  inline void LogVerbose(::StringW message);

  /// @brief Method LogWarning, addr 0x32918e0, size 0x8c, virtual true, abstract: false, final true
  ...
  /// @brief Method OnRequestFailed, addr 0x3291988, size 0x1c, virtual true, abstract: false, final true
  inline void OnRequestFailed(::OculusStudios::GraphQL::ClientInterface::Request* request);

  /// @brief Method OnRequestSucceeded, addr 0x329196c, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3291664, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Action_1<::OculusStudios::GraphQL::ClientInterface::Request*>* onRequestSucceeded,
                    ::System::Action_1<::OculusStudios::GraphQL::ClientInterface::Request*>* onRequestFailed);

  /// @brief Method add_onRequestFailed, addr 0x32914e4, size 0xc0, virtual false, abstract: false, final false
  inline void add_onRequestFailed(::System::Action_1<::OculusStudios::GraphQL::ClientInterface::Request*>* value);

  /// @brief Method add_onRequestSucceeded, addr 0x3291364, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onRequestFailed, addr 0x32915a4, size 0xc0, virtual false, abstract: false, final false
  inline void remove_onRequestFailed(::System::Action_1<::OculusStudios::GraphQL::ClientInterface::Request*>* value);

  /// @brief Method remove_onRequestSucceeded, addr 0x3291424, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::GraphQL::GraphQLClientEvents) == 0x20, "Size mismatch!");
