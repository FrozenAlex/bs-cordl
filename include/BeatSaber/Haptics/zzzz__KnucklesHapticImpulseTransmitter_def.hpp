...
#include <cmath>
#include <cstdint>
CORDL_MODULE_EXPORT(KnucklesHapticImpulseTransmitter)
namespace BeatSaber::Haptics {
class IHapticImpulseTransmitter;
}
namespace BeatSaber::Haptics {
class KnucklesHapticImpulseTransmitter__HapticsCoroutine_d__9;
}
...
namespace BeatSaber::Haptics {
class KnucklesHapticImpulseTransmitter;
}
namespace BeatSaber::Haptics {
class KnucklesHapticImpulseTransmitter__HapticsCoroutine_d__9;
}
// Write type traits
MARK_REF_T(::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter*);
...
namespace BeatSaber::Haptics {
// Is value type: false
// CS Name: BeatSaber.Haptics.KnucklesHapticImpulseTransmitter/<HapticsCoroutine>d__9
class CORDL_TYPE KnucklesHapticImpulseTransmitter__HapticsCoroutine_d__9 : public ::System::Object {
public:
  // Declarations
  ...
  __declspec(property(get = __cordl_internal_get___4__this, put = __cordl_internal_set___4__this)) ::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter* __4__this;
  ...
  /// @brief Method MoveNext, addr 0x3295670, size 0x134, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter__HapticsCoroutine_d__9* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x32957a4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x32957ac, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x32957e4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x329566c, size 0x4, virtual true, abstract: false, final true
  ...
  constexpr ::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter* const& __cordl_internal_get___4__this() const;

  constexpr ::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter*& __cordl_internal_get___4__this();
  ...
  constexpr void __cordl_internal_set___4__this(::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter* value);
  ...
  /// @brief Method .ctor, addr 0x32955dc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  ::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter* _____4__this;
...
static_assert(offsetof(::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter__HapticsCoroutine_d__9, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter__HapticsCoroutine_d__9, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter__HapticsCoroutine_d__9, _____4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter__HapticsCoroutine_d__9, ____device_5__2) == 0x28, "Offset mismatch!");

static_assert(offsetof(::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter__HapticsCoroutine_d__9, ____waiter_5__3) == 0x38, "Offset mismatch!");

static_assert(sizeof(::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter__HapticsCoroutine_d__9) == 0x40, "Size mismatch!");

} // namespace BeatSaber::Haptics
// Dependencies System.Object, UnityEngine.XR.XRNode
namespace BeatSaber::Haptics {
// Is value type: false
// CS Name: BeatSaber.Haptics.KnucklesHapticImpulseTransmitter
class CORDL_TYPE KnucklesHapticImpulseTransmitter : public ::System::Object {
public:
  // Declarations
  using _HapticsCoroutine_d__9 = ::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter__HapticsCoroutine_d__9;
  ...
  /// @brief Method Dispose, addr 0x32955e4, size 0x88, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HapticsCoroutine, addr 0x329554c, size 0x54, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* HapticsCoroutine();

  static inline ::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter* New_ctor(::UnityEngine::XR::XRNode node, ::UnityEngine::MonoBehaviour* coroutineRunner);

  /// @brief Method StopHaptics, addr 0x32955c4, size 0x18, virtual true, abstract: false, final true
  inline void StopHaptics();

  /// @brief Method TriggerHapticPulse, addr 0x32955a0, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3295504, size 0x48, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(offsetof(::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter, ____coroutineRunner) == 0x10, "Offset mismatch!");

static_assert(offsetof(::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter, ____hapticsCoroutine) == 0x18, "Offset mismatch!");

static_assert(offsetof(::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter, ____node) == 0x20, "Offset mismatch!");

static_assert(offsetof(::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter, ____remainingTime) == 0x24, "Offset mismatch!");

static_assert(offsetof(::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter, ____amplitude) == 0x28, "Offset mismatch!");

static_assert(sizeof(::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter) == 0x30, "Size mismatch!");
