...
MARK_REF_T(::BeatSaber::Init::GameVersion*);
MARK_REF_T(::BeatSaber::Init::PreReleaseLabel_GameVersion___c*);
MARK_REF_T(::BeatSaber::Init::PreReleaseLabel_GameVersion___c__DisplayClass10_0*);
MARK_REF_T(::BeatSaber::Init::PreReleaseLabel_GameVersion___c__DisplayClass11_0*);
...
DEFINE_IL2CPP_CLASS(::BeatSaber::Init::GameVersion_PreReleasePrefix, "BeatSaber.Init", "GameVersion/PreReleasePrefix");
DEFINE_IL2CPP_CLASS(::BeatSaber::Init::GameVersion*, "BeatSaber.Init", "GameVersion");
DEFINE_IL2CPP_CLASS(::BeatSaber::Init::PreReleaseLabel_GameVersion___c*, "BeatSaber.Init", "GameVersion/PreReleaseLabel/<>c");
DEFINE_IL2CPP_CLASS(::BeatSaber::Init::PreReleaseLabel_GameVersion___c__DisplayClass10_0*, "BeatSaber.Init", "GameVersion/PreReleaseLabel/<>c__DisplayClass10_0");
DEFINE_IL2CPP_CLASS(::BeatSaber::Init::PreReleaseLabel_GameVersion___c__DisplayClass11_0*, "BeatSaber.Init", "GameVersion/PreReleaseLabel/<>c__DisplayClass11_0");
DEFINE_IL2CPP_CLASS(::BeatSaber::Init::GameVersion_BuildInfo, "BeatSaber.Init", "GameVersion/BuildInfo");
...
public:
  ...
  /// @brief Method CompareTo, addr 0x3296040, size 0x40, virtual true, abstract: false, final true
  inline int32_t CompareTo(::BeatSaber::Init::GameVersion_Content other);

  /// @brief Method Equals, addr 0x3296db8, size 0x94, virtual true, abstract: false, final true
  inline bool Equals(::BeatSaber::Init::GameVersion_Content other);

  /// @brief Method Parse, addr 0x3295cc0, size 0x7c, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_Content Parse(::StringW versionCode);

  /// @brief Method Parse, addr 0x3296984, size 0x324, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_Content Parse(::StringW versionCore, ::StringW pattern);

  /// @brief Method ParseOnStartOf, addr 0x3296ca8, size 0x7c, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_Content ParseOnStartOf(::StringW versionCode);

  /// @brief Method ReadFromApplicationVersion, addr 0x3296d24, size 0x94, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_Content ReadFromApplicationVersion();

  /// @brief Method ToString, addr 0x32962e4, size 0xd8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x3296978, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.cctor>b__16_0, addr 0x3297a18, size 0x8, virtual false, abstract: false, final false
  inline ::StringW __cctor_b__16_0(::System::ValueTuple_2<::BeatSaber::Init::GameVersion_PreReleasePrefix, ::StringW> el);

  /// @brief Method .ctor, addr 0x3297a14, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Parse>b__0, addr 0x3297a20, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3297330, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetPrefixText>b__0, addr 0x3297a4c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3297478, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CompareTo, addr 0x32974f0, size 0x2c, virtual true, abstract: false, final true
  inline int32_t CompareTo(::BeatSaber::Init::GameVersion_PreReleaseLabel other);

  /// @brief Method Equals, addr 0x329751c, size 0x94, virtual true, abstract: false, final true
  inline bool Equals(::BeatSaber::Init::GameVersion_PreReleaseLabel other);

  /// @brief Method FirstLetterToUpper, addr 0x3296f10, size 0x118, virtual false, abstract: false, final false
  static inline ::StringW FirstLetterToUpper(::by_ref<::StringW> value);

  /// @brief Method GetPrefixText, addr 0x3297334, size 0x144, virtual false, abstract: false, final false
  inline ::StringW GetPrefixText();

  /// @brief Method Parse, addr 0x3297028, size 0x308, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_PreReleaseLabel Parse(::StringW releaseLabel);

  /// @brief Method ToString, addr 0x329747c, size 0x74, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x3296e9c, size 0x74, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CompareTo, addr 0x32980c4, size 0xc0, virtual true, abstract: false, final true
  inline int32_t CompareTo(::BeatSaber::Init::GameVersion_BuildInfo other);

  /// @brief Method Equals, addr 0x3298278, size 0x84, virtual true, abstract: false, final true
  inline bool Equals(::BeatSaber::Init::GameVersion_BuildInfo other);

  /// @brief Method ExtractNumberFromPlatformId, addr 0x329821c, size 0x5c, virtual false, abstract: false, final false
  static inline ::StringW ExtractNumberFromPlatformId(::StringW inputPlatformId);

  /// @brief Method Parse, addr 0x3297e4c, size 0x278, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_BuildInfo Parse(::StringW buildMetadataValue);

  /// @brief Method ToString, addr 0x3297c10, size 0x168, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x3296744, size 0xc4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BuildInfoText, addr 0x3297b28, size 0xe8, virtual false, abstract: false, final false
  inline ::StringW BuildInfoText();

  /// @brief Method CompareTo, addr 0x3296080, size 0x130, virtual true, abstract: false, final true
  inline int32_t CompareTo(::BeatSaber::Init::GameVersion_Metadata other);

  /// @brief Method Equals, addr 0x3298184, size 0x94, virtual true, abstract: false, final true
  inline bool Equals(::BeatSaber::Init::GameVersion_Metadata other);

  /// @brief Method ExtractSubStrings, addr 0x3297d78, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x3295d3c, size 0x1a4, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_Metadata Parse(::StringW versionMetadata);

  /// @brief Method ToString, addr 0x32963bc, size 0xf0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x3297a5c, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor(::System::Nullable_1<::BeatSaber::Init::GameVersion_BuildInfo> buildInfo);

  /// @brief Method .ctor, addr 0x3296808, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CompareTo, addr 0x3295ee0, size 0x160, virtual true, abstract: false, final true
  inline int32_t CompareTo(::BeatSaber::Init::GameVersion* other);

  /// @brief Method Equals, addr 0x32961b0, size 0x18, virtual true, abstract: false, final true
  ...
  /// @brief Method Parse, addr 0x3295a78, size 0x248, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion* Parse(::StringW version);

  /// @brief Method ToString, addr 0x32961c8, size 0x11c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UpdatePlatformId, addr 0x3296554, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3295a5c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsReleasable, addr 0x32964ac, size 0xa8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::Init::GameVersion) == 0x60, "Size mismatch!");
