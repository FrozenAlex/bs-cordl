...
// Write type traits
MARK_REF_T(::BeatSaber::Init::InitArguments*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Init::InitArguments*, "BeatSaber.Init", "InitArguments");
...
static_assert(sizeof(::BeatSaber::Init::InitArguments) == 0x10, "Size mismatch!");
