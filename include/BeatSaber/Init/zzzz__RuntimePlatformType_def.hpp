...
DEFINE_IL2CPP_CLASS(::BeatSaber::Init::RuntimePlatformType, "BeatSaber.Init", "RuntimePlatformType");
// Dependencies
namespace BeatSaber::Init {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::Init::RuntimePlatformType) == 0x4, "Size mismatch!");
