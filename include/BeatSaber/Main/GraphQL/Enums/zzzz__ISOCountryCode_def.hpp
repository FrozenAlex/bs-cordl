...
DEFINE_IL2CPP_CLASS(::BeatSaber::Main::GraphQL::Enums::ISOCountryCode, "BeatSaber.Main.GraphQL.Enums", "ISOCountryCode");
// Dependencies
namespace BeatSaber::Main::GraphQL::Enums {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::Main::GraphQL::Enums::ISOCountryCode) == 0x4, "Size mismatch!");
