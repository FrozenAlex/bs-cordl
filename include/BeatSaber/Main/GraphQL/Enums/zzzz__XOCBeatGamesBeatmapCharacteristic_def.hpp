...
DEFINE_IL2CPP_CLASS(::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesBeatmapCharacteristic, "BeatSaber.Main.GraphQL.Enums", "XOCBeatGamesBeatmapCharacteristic");
// Dependencies
namespace BeatSaber::Main::GraphQL::Enums {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesBeatmapCharacteristic) == 0x4, "Size mismatch!");
