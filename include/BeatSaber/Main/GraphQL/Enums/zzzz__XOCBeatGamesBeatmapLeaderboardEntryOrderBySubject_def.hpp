...
DEFINE_IL2CPP_CLASS(::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesBeatmapLeaderboardEntryOrderBySubject, "BeatSaber.Main.GraphQL.Enums", "XOCBeatGamesBeatmapLeaderboardEntryOrderBySubject");
// Dependencies
namespace BeatSaber::Main::GraphQL::Enums {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesBeatmapLeaderboardEntryOrderBySubject) == 0x4, "Size mismatch!");
