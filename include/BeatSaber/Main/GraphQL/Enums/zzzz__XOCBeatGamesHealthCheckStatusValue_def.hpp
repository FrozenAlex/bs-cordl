...
DEFINE_IL2CPP_CLASS(::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesHealthCheckStatusValue, "BeatSaber.Main.GraphQL.Enums", "XOCBeatGamesHealthCheckStatusValue");
// Dependencies
namespace BeatSaber::Main::GraphQL::Enums {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesHealthCheckStatusValue) == 0x4, "Size mismatch!");
