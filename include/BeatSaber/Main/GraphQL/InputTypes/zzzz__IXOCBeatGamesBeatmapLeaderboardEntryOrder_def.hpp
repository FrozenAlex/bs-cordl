...
// Write type traits
MARK_REF_T(::BeatSaber::Main::GraphQL::InputTypes::IXOCBeatGamesBeatmapLeaderboardEntryOrder*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Main::GraphQL::InputTypes::IXOCBeatGamesBeatmapLeaderboardEntryOrder*, "BeatSaber.Main.GraphQL.InputTypes", "IXOCBeatGamesBeatmapLeaderboardEntryOrder");
// Dependencies
namespace BeatSaber::Main::GraphQL::InputTypes {
// Is value type: false
