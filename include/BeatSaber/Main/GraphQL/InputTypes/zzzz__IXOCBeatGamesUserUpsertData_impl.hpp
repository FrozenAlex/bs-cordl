...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::BeatSaber::Main::GraphQL::InputTypes::IXOCBeatGamesUserUpsertData::*)(::StringW)>(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::BeatSaber::Main::GraphQL::InputTypes::IXOCBeatGamesUserUpsertData*>(),
                                                                                          { ::i2c::class_of<::BeatSaber::Main::GraphQL::InputTypes::IXOCBeatGamesUserUpsertData*>(), 0 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::BeatSaber::Main::GraphQL::InputTypes::IXOCBeatGamesUserUpsertData::*)(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::BeatSaber::Main::GraphQL::InputTypes::IXOCBeatGamesUserUpsertData*>(),
                                                                                          { ::i2c::class_of<::BeatSaber::Main::GraphQL::InputTypes::IXOCBeatGamesUserUpsertData*>(), 1 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::BeatSaber::Main::GraphQL::InputTypes::IXOCBeatGamesUserUpsertData::*)(::StringW)>(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::BeatSaber::Main::GraphQL::InputTypes::IXOCBeatGamesUserUpsertData*>(),
                                                                                          { ::i2c::class_of<::BeatSaber::Main::GraphQL::InputTypes::IXOCBeatGamesUserUpsertData*>(), 2 }));
    return ___internal_method;
  }
};
...
inline void BeatSaber::Main::GraphQL::InputTypes::IXOCBeatGamesUserUpsertData::set_CountryCode(::System::Nullable_1<::BeatSaber::Main::GraphQL::Enums::ISOCountryCode> value) {
  auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::BeatSaber::Main::GraphQL::InputTypes::IXOCBeatGamesUserUpsertData*>(), 1 })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, value);
}
