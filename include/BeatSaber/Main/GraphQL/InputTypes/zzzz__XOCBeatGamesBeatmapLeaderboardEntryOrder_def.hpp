...
// Write type traits
MARK_REF_T(::BeatSaber::Main::GraphQL::InputTypes::XOCBeatGamesBeatmapLeaderboardEntryOrder*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Main::GraphQL::InputTypes::XOCBeatGamesBeatmapLeaderboardEntryOrder*, "BeatSaber.Main.GraphQL.InputTypes", "XOCBeatGamesBeatmapLeaderboardEntryOrder");
...
public:
  ...
  /// @brief Method GetParams, addr 0x3208bf4, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3208c00, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_By, addr 0x3208a9c, size 0xac, virtual true, abstract: false, final true
  inline void set_By(::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesBeatmapLeaderboardEntryOrderBySubject value);

  /// @brief Method set_Desc, addr 0x3208b48, size 0xac, virtual true, abstract: false, final true
...
static_assert(sizeof(::BeatSaber::Main::GraphQL::InputTypes::XOCBeatGamesBeatmapLeaderboardEntryOrder) == 0x18, "Size mismatch!");
