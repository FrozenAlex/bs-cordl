...
// Write type traits
MARK_REF_T(::BeatSaber::Main::GraphQL::Queries::BSLeaderboardAroundMe*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Main::GraphQL::Queries::BSLeaderboardAroundMe*, "BeatSaber.Main.GraphQL.Queries", "BSLeaderboardAroundMe");
...
public:
  ...
  /// @brief Method GetPersistedQueryID, addr 0x329a708, size 0x14, virtual true, abstract: false, final false
  inline uint64_t GetPersistedQueryID();

  /// @brief Method GetVariableNames, addr 0x32998cc, size 0x3d4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x329a71c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Characteristic, addr 0x3299f6c, size 0xb0, virtual false, abstract: false, final false
  inline ::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesBeatmapCharacteristic get_Characteristic();

  /// @brief Method get_Difficulty, addr 0x329a0c8, size 0xb0, virtual false, abstract: false, final false
  inline ::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesBeatmapDifficulty get_Difficulty();

  /// @brief Method get_EnvironmentPlayerRootId, addr 0x3299d20, size 0x90, virtual false, abstract: false, final false
  inline ::StringW get_EnvironmentPlayerRootId();

  /// @brief Method get_First, addr 0x329a5a4, size 0x164, virtual false, abstract: false, final false
  inline ::System::Nullable_1<int64_t> get_First();

  /// @brief Method get_ModifierMask, addr 0x329a210, size 0x9c, virtual false, abstract: false, final false
  inline int64_t get_ModifierMask();

  /// @brief Method get_Order, addr 0x329a43c, size 0xb0, virtual false, abstract: false, final false
  inline ::BeatSaber::Main::GraphQL::InputTypes::IXOCBeatGamesBeatmapLeaderboardEntryOrder* get_Order();

  /// @brief Method get_SongClientId, addr 0x3299e30, size 0x90, virtual false, abstract: false, final false
  inline ::StringW get_SongClientId();

  /// @brief Method get_User, addr 0x329a32c, size 0x90, virtual false, abstract: false, final false
  inline ::StringW get_User();

  /// @brief Method set_Characteristic, addr 0x3299ec0, size 0xac, virtual false, abstract: false, final false
  inline void set_Characteristic(::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesBeatmapCharacteristic value);

  /// @brief Method set_Difficulty, addr 0x329a01c, size 0xac, virtual false, abstract: false, final false
  inline void set_Difficulty(::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesBeatmapDifficulty value);

  /// @brief Method set_EnvironmentPlayerRootId, addr 0x3299ca0, size 0x80, virtual false, abstract: false, final false
  inline void set_EnvironmentPlayerRootId(::StringW value);

  /// @brief Method set_First, addr 0x329a4ec, size 0xb8, virtual false, abstract: false, final false
  inline void set_First(::System::Nullable_1<int64_t> value);

  /// @brief Method set_ModifierMask, addr 0x329a178, size 0x98, virtual false, abstract: false, final false
  inline void set_ModifierMask(int64_t value);

  /// @brief Method set_Order, addr 0x329a3bc, size 0x80, virtual false, abstract: false, final false
  inline void set_Order(::BeatSaber::Main::GraphQL::InputTypes::IXOCBeatGamesBeatmapLeaderboardEntryOrder* value);

  /// @brief Method set_SongClientId, addr 0x3299db0, size 0x80, virtual false, abstract: false, final false
  inline void set_SongClientId(::StringW value);

  /// @brief Method set_User, addr 0x329a2ac, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::Main::GraphQL::Queries::BSLeaderboardAroundMe) == 0x18, "Size mismatch!");
