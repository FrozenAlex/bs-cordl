...
DEFINE_IL2CPP_CLASS(::BeatSaber::Main::Leaderboards::BeatLeaderboardsState, "BeatSaber.Main.Leaderboards", "BeatLeaderboardsState");
// Dependencies
namespace BeatSaber::Main::Leaderboards {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::Main::Leaderboards::BeatLeaderboardsState) == 0x4, "Size mismatch!");
