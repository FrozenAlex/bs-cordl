...
// Write type traits
MARK_REF_T(::BeatSaber::Main::Leaderboards::LeaderboardHelpers*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Main::Leaderboards::LeaderboardHelpers*, "BeatSaber.Main.Leaderboards", "LeaderboardHelpers");
...
public:
  // Declarations
  /// @brief Method ConvertCharacteristic, addr 0x32a1b3c, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertDifficulty, addr 0x32a1e84, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::Main::Leaderboards::LeaderboardHelpers) == 0x10, "Size mismatch!");
