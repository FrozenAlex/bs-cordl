...
// Write type traits
MARK_REF_T(::BeatSaber::Main::Leaderboards::QueryLeaderboardAroundMe*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Main::Leaderboards::QueryLeaderboardAroundMe*, "BeatSaber.Main.Leaderboards", "QueryLeaderboardAroundMe");
...
public:
  ...
  /// @brief Method CreateQuery, addr 0x320d6bc, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x320a424, size 0xb8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::Main::Leaderboards::QueryLeaderboardAroundMe) == 0x68, "Size mismatch!");
