...
public:
  ...
  /// @brief Method CreateQuery, addr 0x320d8f0, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x320ac08, size 0xb8, virtual false, abstract: false, final false
