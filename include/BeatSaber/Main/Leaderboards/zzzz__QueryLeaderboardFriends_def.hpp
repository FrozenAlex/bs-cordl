...
// Write type traits
MARK_REF_T(::BeatSaber::Main::Leaderboards::QueryLeaderboardFriends*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Main::Leaderboards::QueryLeaderboardFriends*, "BeatSaber.Main.Leaderboards", "QueryLeaderboardFriends");
...
public:
  ...
  /// @brief Method CreateQuery, addr 0x32a2234, size 0x1d0, virtual false, abstract: false, final false
  static inline ::BeatSaber::Main::GraphQL::Queries::BSLeaderboardFriends* CreateQuery(::StringW userId, ::StringW environmentPlayerRootId, ::GlobalNamespace::BeatmapKey key,
  ...
  static inline ::BeatSaber::Main::Leaderboards::QueryLeaderboardFriends* New_ctor(::StringW userId, ::StringW environmentPlayerRootId, ::GlobalNamespace::BeatmapKey key,
                                                                                   ::GlobalNamespace::GameplayModifierMask modifiers, int64_t amountEntries,
                                                                                   ::BeatSaber::Main::GraphQL::InputTypes::XOCBeatGamesBeatmapLeaderboardEntryOrder* order);

  /// @brief Method .ctor, addr 0x329f428, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::Main::Leaderboards::QueryLeaderboardFriends) == 0x68, "Size mismatch!");
