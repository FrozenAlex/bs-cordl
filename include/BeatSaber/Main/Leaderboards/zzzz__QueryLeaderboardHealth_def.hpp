...
// Write type traits
MARK_REF_T(::BeatSaber::Main::Leaderboards::QueryLeaderboardHealth*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Main::Leaderboards::QueryLeaderboardHealth*, "BeatSaber.Main.Leaderboards", "QueryLeaderboardHealth");
...
public:
  ...
  /// @brief Method .ctor, addr 0x32a1160, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BeatSaber::Main::Leaderboards::QueryLeaderboardHealth) == 0x68, "Size mismatch!");
