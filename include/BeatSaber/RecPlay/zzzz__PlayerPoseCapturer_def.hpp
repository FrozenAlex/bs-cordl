...
// Write type traits
MARK_REF_T(::BeatSaber::RecPlay::PlayerPoseCapturer*);
DEFINE_IL2CPP_CLASS(::BeatSaber::RecPlay::PlayerPoseCapturer*, "BeatSaber.RecPlay", "PlayerPoseCapturer");
...
public:
  ...
  /// @brief Method Capture, addr 0x322b950, size 0x104, virtual false, abstract: false, final false
  inline void Capture(float_t time, ::BeatSaber::RecPlay::PlayerPose pose);

  /// @brief Method CreatePlayerPoseFrames, addr 0x322ba54, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x322b8cc, size 0x84, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::RecPlay::PlayerPoseCapturer) == 0x18, "Size mismatch!");
