...
DEFINE_IL2CPP_CLASS(::BeatSaber::RecPlay::PlayerPoseFrame, "BeatSaber.RecPlay", "PlayerPoseFrame");
...
static_assert(sizeof(::BeatSaber::RecPlay::PlayerPoseFrame) == 0x58, "Size mismatch!");
