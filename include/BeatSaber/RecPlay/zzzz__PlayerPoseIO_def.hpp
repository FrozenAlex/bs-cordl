...
// Write type traits
MARK_REF_T(::BeatSaber::RecPlay::PlayerPoseIO*);
DEFINE_IL2CPP_CLASS(::BeatSaber::RecPlay::PlayerPoseIO*, "BeatSaber.RecPlay", "PlayerPoseIO");
...
static_assert(sizeof(::BeatSaber::RecPlay::PlayerPoseIO) == 0x10, "Size mismatch!");
