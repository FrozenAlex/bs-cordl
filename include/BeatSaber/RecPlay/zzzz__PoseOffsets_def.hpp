...
DEFINE_IL2CPP_CLASS(::BeatSaber::RecPlay::PoseOffsets, "BeatSaber.RecPlay", "PoseOffsets");
...
public:
  ...
  /// @brief Method Adjust, addr 0x322d09c, size 0x198, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::RecPlay::PoseOffsets) == 0x54, "Size mismatch!");
