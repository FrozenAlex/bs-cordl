...
// Write type traits
MARK_REF_T(::BeatSaber::RecPlay::Poser*);
DEFINE_IL2CPP_CLASS(::BeatSaber::RecPlay::Poser*, "BeatSaber.RecPlay", "Poser");
...
public:
  ...
  static inline ::UnityEngine::Pose InterpolatePose(::by_ref<::UnityEngine::Pose> a, ::by_ref<::UnityEngine::Pose> b, float_t t);
...
static_assert(sizeof(::BeatSaber::RecPlay::Poser) == 0x10, "Size mismatch!");
