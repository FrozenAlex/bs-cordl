...
DEFINE_IL2CPP_CLASS(::BeatSaber::Settings::ControllerSettings, "BeatSaber.Settings", "ControllerSettings");
...
static_assert(sizeof(::BeatSaber::Settings::ControllerSettings) == 0x24, "Size mismatch!");
