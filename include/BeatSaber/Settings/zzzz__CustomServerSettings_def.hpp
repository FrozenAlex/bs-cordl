...
DEFINE_IL2CPP_CLASS(::BeatSaber::Settings::CustomServerSettings, "BeatSaber.Settings", "CustomServerSettings");
// Dependencies
namespace BeatSaber::Settings {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::Settings::CustomServerSettings) == 0x10, "Size mismatch!");
