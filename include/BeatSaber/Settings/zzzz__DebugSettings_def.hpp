...
DEFINE_IL2CPP_CLASS(::BeatSaber::Settings::DebugSettings, "BeatSaber.Settings", "DebugSettings");
// Dependencies
namespace BeatSaber::Settings {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::Settings::DebugSettings) == 0x2, "Size mismatch!");
