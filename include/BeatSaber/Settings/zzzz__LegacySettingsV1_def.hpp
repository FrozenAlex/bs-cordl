...
public:
  ...
  /// @brief Method ApplyTo, addr 0x322dca0, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x322ddec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BeatSaber::Settings::LegacySettingsV1) == 0xd8, "Size mismatch!");
