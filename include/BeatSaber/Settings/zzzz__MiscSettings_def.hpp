...
DEFINE_IL2CPP_CLASS(::BeatSaber::Settings::MiscSettings_ResponseLevel, "BeatSaber.Settings", "MiscSettings/ResponseLevel");
DEFINE_IL2CPP_CLASS(::BeatSaber::Settings::MiscSettings, "BeatSaber.Settings", "MiscSettings");
// Dependencies
namespace BeatSaber::Settings {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::Settings::MiscSettings_ResponseLevel) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Field pauseButtonResponse, offset: 0x10, size: 0x4, def value: None
  ::BeatSaber::Settings::MiscSettings_ResponseLevel pauseButtonResponse;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::BeatSaber::Settings::MiscSettings, region) == 0x0, "Offset mismatch!");

static_assert(offsetof(::BeatSaber::Settings::MiscSettings, language) == 0x8, "Offset mismatch!");

static_assert(offsetof(::BeatSaber::Settings::MiscSettings, pauseButtonResponse) == 0x10, "Offset mismatch!");

static_assert(sizeof(::BeatSaber::Settings::MiscSettings) == 0x18, "Size mismatch!");
