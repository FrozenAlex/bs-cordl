...
DEFINE_IL2CPP_CLASS(::BeatSaber::Settings::QualitySettings_BloomQuality, "BeatSaber.Settings", "QualitySettings/BloomQuality");
DEFINE_IL2CPP_CLASS(::BeatSaber::Settings::QualitySettings_MainEffectOption, "BeatSaber.Settings", "QualitySettings/MainEffectOption");
DEFINE_IL2CPP_CLASS(::BeatSaber::Settings::QualitySettings_MirrorQuality, "BeatSaber.Settings", "QualitySettings/MirrorQuality");
DEFINE_IL2CPP_CLASS(::BeatSaber::Settings::QualitySettings_ObstacleQuality, "BeatSaber.Settings", "QualitySettings/ObstacleQuality");
DEFINE_IL2CPP_CLASS(::BeatSaber::Settings::QualitySettings, "BeatSaber.Settings", "QualitySettings");
// Dependencies
namespace BeatSaber::Settings {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::Settings::QualitySettings_MainEffectOption) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::BeatSaber::Settings::QualitySettings_BloomQuality) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::BeatSaber::Settings::QualitySettings_MirrorQuality) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief IL2CPP Metadata Type Index
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 21862 };
...
static_assert(sizeof(::BeatSaber::Settings::QualitySettings_ObstacleQuality) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::BeatSaber::Settings::QualitySettings) == 0x38, "Size mismatch!");
