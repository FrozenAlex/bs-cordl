...
// Write type traits
MARK_REF_T(::BeatSaber::Settings::SettingPresets*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Settings::SettingPresets*, "BeatSaber.Settings", "SettingPresets");
...
static_assert(sizeof(::BeatSaber::Settings::SettingPresets) == 0x10, "Size mismatch!");
