...
public:
  ...
  /// @brief Method Convert, addr 0x36a3500, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a34ec, size 0xc, virtual false, abstract: false, final false
