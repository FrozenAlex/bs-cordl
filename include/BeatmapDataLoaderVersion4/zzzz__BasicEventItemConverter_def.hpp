...
// Write type traits
MARK_REF_T(::BeatmapDataLoaderVersion4::BasicEventItemConverter*);
DEFINE_IL2CPP_CLASS(::BeatmapDataLoaderVersion4::BasicEventItemConverter*, "BeatmapDataLoaderVersion4", "BasicEventItemConverter");
// Dependencies BeatToTimeConverter, BeatmapSaveDataVersion4.BasicEvent
namespace BeatmapDataLoaderVersion4 {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__basicEvents, put = __cordl_internal_set__basicEvents)) ::ArrayW<::BeatmapSaveDataVersion4::BasicEvent> _basicEvents;
  ...
  /// @brief Method Convert, addr 0x375e060, size 0x1ac, virtual false, abstract: false, final false
  ...
  static inline ::BeatmapDataLoaderVersion4::BasicEventItemConverter* New_ctor(::ArrayW<::BeatmapSaveDataVersion4::BasicEvent> basicEvents,
  ...
  constexpr ::ArrayW<::BeatmapSaveDataVersion4::BasicEvent> const& __cordl_internal_get__basicEvents() const;

  constexpr ::ArrayW<::BeatmapSaveDataVersion4::BasicEvent>& __cordl_internal_get__basicEvents();
  ...
  constexpr void __cordl_internal_set__basicEvents(::ArrayW<::BeatmapSaveDataVersion4::BasicEvent> value);
  ...
  /// @brief Method .ctor, addr 0x375e04c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::BeatmapSaveDataVersion4::BasicEvent> basicEvents, ::BeatmapDataLoaderVersion4::SpecialEventsFilter* specialEventsFilter,
...
public:
  ...
  ::ArrayW<::BeatmapSaveDataVersion4::BasicEvent> ____basicEvents;
...
static_assert(sizeof(::BeatmapDataLoaderVersion4::BasicEventItemConverter) == 0x30, "Size mismatch!");
