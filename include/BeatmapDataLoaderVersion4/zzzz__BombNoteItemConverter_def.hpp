...
public:
  ...
  /// @brief Method Convert, addr 0x36a2c40, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a2b30, size 0x8, virtual false, abstract: false, final false
