...
// Write type traits
MARK_REF_T(::BeatmapDataLoaderVersion4::ColorBoostEventItemConverter*);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x375e700, size 0xf8, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::BeatmapDataLoaderVersion4::ColorBoostEventItemConverter__Convert_d__2* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<BeatmapEventData>.GetEnumerator, addr 0x375e840, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<BeatmapEventData>.get_Current, addr 0x375e7f8, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::BeatmapEventData* System_Collections_Generic_IEnumerator_BeatmapEventData__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x375e8e0, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x375e800, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x375e838, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x375e6fc, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x375e6dc, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapDataLoaderVersion4::ColorBoostEventItemConverter__Convert_d__2) == 0x40, "Size mismatch!");

} // namespace BeatmapDataLoaderVersion4
// Dependencies BeatToTimeConverter, BeatmapSaveDataVersion4.ColorBoostEvent
namespace BeatmapDataLoaderVersion4 {
// Is value type: false
...
public:
  ...
  /// @brief Method Convert, addr 0x375e20c, size 0x7c, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::BeatmapSaveDataVersion4::ColorBoostEvent> const& __cordl_internal_get__colorBoostEvents() const;

  constexpr ::ArrayW<::BeatmapSaveDataVersion4::ColorBoostEvent>& __cordl_internal_get__colorBoostEvents();

  constexpr void __cordl_internal_set__colorBoostEvents(::ArrayW<::BeatmapSaveDataVersion4::ColorBoostEvent> value);

  /// @brief Method .ctor, addr 0x375e058, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapDataLoaderVersion4::ColorBoostEventItemConverter) == 0x20, "Size mismatch!");
