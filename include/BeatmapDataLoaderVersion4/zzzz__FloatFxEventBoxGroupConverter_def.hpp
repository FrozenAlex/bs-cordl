...
// Write type traits
MARK_REF_T(::BeatmapDataLoaderVersion4::FloatFxEventBoxGroupConverter*);
DEFINE_IL2CPP_CLASS(::BeatmapDataLoaderVersion4::FloatFxEventBoxGroupConverter*, "BeatmapDataLoaderVersion4", "FloatFxEventBoxGroupConverter");
...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x36a49ac, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a374c, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapDataLoaderVersion4::FloatFxEventBoxGroupConverter) == 0x28, "Size mismatch!");
