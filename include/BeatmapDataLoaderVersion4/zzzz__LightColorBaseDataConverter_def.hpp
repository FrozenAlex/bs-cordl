...
// Write type traits
MARK_REF_T(::BeatmapDataLoaderVersion4::LightColorBaseDataConverter*);
DEFINE_IL2CPP_CLASS(::BeatmapDataLoaderVersion4::LightColorBaseDataConverter*, "BeatmapDataLoaderVersion4", "LightColorBaseDataConverter");
...
public:
  // Declarations
  /// @brief Method Convert, addr 0x375eed0, size 0xc8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapDataLoaderVersion4::LightColorBaseDataConverter) == 0x10, "Size mismatch!");
