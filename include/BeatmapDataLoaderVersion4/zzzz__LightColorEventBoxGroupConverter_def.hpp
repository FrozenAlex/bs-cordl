...
// Write type traits
MARK_REF_T(::BeatmapDataLoaderVersion4::LightColorEventBoxGroupConverter*);
DEFINE_IL2CPP_CLASS(::BeatmapDataLoaderVersion4::LightColorEventBoxGroupConverter*, "BeatmapDataLoaderVersion4", "LightColorEventBoxGroupConverter");
...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x36a414c, size 0x21c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a3728, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapDataLoaderVersion4::LightColorEventBoxGroupConverter) == 0x28, "Size mismatch!");
