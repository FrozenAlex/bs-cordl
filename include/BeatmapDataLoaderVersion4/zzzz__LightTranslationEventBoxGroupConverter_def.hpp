...
// Write type traits
MARK_REF_T(::BeatmapDataLoaderVersion4::LightTranslationEventBoxGroupConverter*);
DEFINE_IL2CPP_CLASS(::BeatmapDataLoaderVersion4::LightTranslationEventBoxGroupConverter*, "BeatmapDataLoaderVersion4", "LightTranslationEventBoxGroupConverter");
...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x375f26c, size 0x21c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x375e2a0, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapDataLoaderVersion4::LightTranslationEventBoxGroupConverter) == 0x28, "Size mismatch!");
