...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x36a4704, size 0x21c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a3740, size 0xc, virtual false, abstract: false, final false
