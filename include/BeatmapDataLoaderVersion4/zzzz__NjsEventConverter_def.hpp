...
public:
  ...
  /// @brief Method Convert, addr 0x375dd38, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x375dd30, size 0x8, virtual false, abstract: false, final false
