...
// Write type traits
MARK_REF_T(::BeatmapDataLoaderVersion4::ObstacleItemConverter*);
DEFINE_IL2CPP_CLASS(::BeatmapDataLoaderVersion4::ObstacleItemConverter*, "BeatmapDataLoaderVersion4", "ObstacleItemConverter");
// Dependencies BeatToTimeConverter, BeatmapSaveDataVersion4.Obstacle
namespace BeatmapDataLoaderVersion4 {
// Is value type: false
...
public:
  ...
  /// @brief Method Convert, addr 0x375d818, size 0x118, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::BeatmapSaveDataVersion4::Obstacle> const& __cordl_internal_get__obstacles() const;

  constexpr ::ArrayW<::BeatmapSaveDataVersion4::Obstacle>& __cordl_internal_get__obstacles();

  constexpr void __cordl_internal_set__obstacles(::ArrayW<::BeatmapSaveDataVersion4::Obstacle> value);

  /// @brief Method .ctor, addr 0x375d694, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapDataLoaderVersion4::ObstacleItemConverter) == 0x20, "Size mismatch!");
