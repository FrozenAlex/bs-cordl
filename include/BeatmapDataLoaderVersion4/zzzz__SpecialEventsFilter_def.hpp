...
// Write type traits
MARK_REF_T(::BeatmapDataLoaderVersion4::SpecialEventsFilter*);
DEFINE_IL2CPP_CLASS(::BeatmapDataLoaderVersion4::SpecialEventsFilter*, "BeatmapDataLoaderVersion4", "SpecialEventsFilter");
...
public:
  ...
  /// @brief Method IsEventValid, addr 0x36a3b0c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a32c0, size 0x22c, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapDataLoaderVersion4::SpecialEventsFilter) == 0x18, "Size mismatch!");
