...
public:
  ...
  /// @brief Method Convert, addr 0x375dc34, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x375d6b4, size 0x8, virtual false, abstract: false, final false
