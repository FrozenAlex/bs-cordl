...
// Write type traits
MARK_REF_T(::BeatmapLevelSaveDataVersion4::AudioSaveData*);
DEFINE_IL2CPP_CLASS(::BeatmapLevelSaveDataVersion4::AudioSaveData*, "BeatmapLevelSaveDataVersion4", "AudioSaveData");
// Dependencies BeatmapLevelSaveDataVersion4.BpmData, BeatmapLevelSaveDataVersion4.LufsData, System.Object
namespace BeatmapLevelSaveDataVersion4 {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_bpmData, put = __cordl_internal_set_bpmData)) ::ArrayW<::BeatmapLevelSaveDataVersion4::BpmData*> bpmData;

  /// @brief Field lufsData, offset 0x30, size 0x8
  __declspec(property(get = __cordl_internal_get_lufsData, put = __cordl_internal_set_lufsData)) ::ArrayW<::BeatmapLevelSaveDataVersion4::LufsData> lufsData;
  ...
  constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::BpmData*> const& __cordl_internal_get_bpmData() const;

  constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::BpmData*>& __cordl_internal_get_bpmData();

  constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::LufsData> const& __cordl_internal_get_lufsData() const;

  constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::LufsData>& __cordl_internal_get_lufsData();
  ...
  constexpr void __cordl_internal_set_bpmData(::ArrayW<::BeatmapLevelSaveDataVersion4::BpmData*> value);

  constexpr void __cordl_internal_set_lufsData(::ArrayW<::BeatmapLevelSaveDataVersion4::LufsData> value);
  ...
  /// @brief Method .ctor, addr 0x375a498, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::BeatmapLevelSaveDataVersion4::BpmData*> ___bpmData;

  /// @brief Field lufsData, offset: 0x30, size: 0x8, def value: None
  ::ArrayW<::BeatmapLevelSaveDataVersion4::LufsData> ___lufsData;
...
static_assert(sizeof(::BeatmapLevelSaveDataVersion4::AudioSaveData) == 0x38, "Size mismatch!");
