...
public:
  ...
  /// @brief Method .ctor, addr 0x375a21c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW keyword, ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>* eventTypes);

  /// @brief Method get_eventTypes, addr 0x375a214, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>* get_eventTypes();

  /// @brief Method get_keyword, addr 0x375a20c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x3758a34, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_data, addr 0x375a204, size 0x8, virtual false, abstract: false, final false
