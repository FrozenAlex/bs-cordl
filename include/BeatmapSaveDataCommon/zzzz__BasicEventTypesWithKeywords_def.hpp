...
// Write type traits
MARK_REF_T(::BeatmapSaveDataCommon::BasicEventTypesWithKeywords*);
MARK_REF_T(::BeatmapSaveDataCommon::BasicEventTypesWithKeywords_BasicEventTypesForKeyword*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataCommon::BasicEventTypesWithKeywords*, "BeatmapSaveDataCommon", "BasicEventTypesWithKeywords");
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataCommon::BasicEventTypesWithKeywords_BasicEventTypesForKeyword*, "BeatmapSaveDataCommon", "BasicEventTypesWithKeywords/BasicEventTypesForKeyword");
...
public:
  ...
  /// @brief Method .ctor, addr 0x369f6a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW keyword, ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>* eventTypes);

  /// @brief Method get_eventTypes, addr 0x369f698, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>* get_eventTypes();

  /// @brief Method get_keyword, addr 0x369f690, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapSaveDataCommon::BasicEventTypesWithKeywords_BasicEventTypesForKeyword) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x369deb8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_data, addr 0x369f688, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapSaveDataCommon::BasicEventTypesWithKeywords) == 0x18, "Size mismatch!");
