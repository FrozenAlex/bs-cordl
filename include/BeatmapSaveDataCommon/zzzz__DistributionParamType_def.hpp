...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataCommon::DistributionParamType, "BeatmapSaveDataCommon", "DistributionParamType");
// Dependencies
namespace BeatmapSaveDataCommon {
// Is value type: true
...
static_assert(sizeof(::BeatmapSaveDataCommon::DistributionParamType) == 0x4, "Size mismatch!");
