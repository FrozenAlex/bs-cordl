...
// Write type traits
MARK_REF_T(::BeatmapSaveDataCommon::EaseTypeConvertor*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataCommon::EaseTypeConvertor*, "BeatmapSaveDataCommon", "EaseTypeConvertor");
...
static_assert(sizeof(::BeatmapSaveDataCommon::EaseTypeConvertor) == 0x10, "Size mismatch!");
