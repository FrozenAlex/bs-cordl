...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataCommon::EaseType, "BeatmapSaveDataCommon", "EaseType");
// Dependencies
namespace BeatmapSaveDataCommon {
// Is value type: true
...
static_assert(sizeof(::BeatmapSaveDataCommon::EaseType) == 0x4, "Size mismatch!");
