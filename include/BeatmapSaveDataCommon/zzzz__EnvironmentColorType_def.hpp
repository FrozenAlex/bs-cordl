...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataCommon::EnvironmentColorType, "BeatmapSaveDataCommon", "EnvironmentColorType");
// Dependencies
namespace BeatmapSaveDataCommon {
// Is value type: true
...
static_assert(sizeof(::BeatmapSaveDataCommon::EnvironmentColorType) == 0x4, "Size mismatch!");
