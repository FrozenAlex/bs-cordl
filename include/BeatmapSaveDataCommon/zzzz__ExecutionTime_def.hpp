...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataCommon::ExecutionTime, "BeatmapSaveDataCommon", "ExecutionTime");
// Dependencies
namespace BeatmapSaveDataCommon {
// Is value type: true
...
static_assert(sizeof(::BeatmapSaveDataCommon::ExecutionTime) == 0x4, "Size mismatch!");
