...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataCommon::IndexFilterLimitAlsoAffectsType, "BeatmapSaveDataCommon", "IndexFilterLimitAlsoAffectsType");
// Dependencies
namespace BeatmapSaveDataCommon {
// Is value type: true
...
static_assert(sizeof(::BeatmapSaveDataCommon::IndexFilterLimitAlsoAffectsType) == 0x4, "Size mismatch!");
