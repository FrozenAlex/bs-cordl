...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataCommon::NoteColorType, "BeatmapSaveDataCommon", "NoteColorType");
// Dependencies
namespace BeatmapSaveDataCommon {
// Is value type: true
...
static_assert(sizeof(::BeatmapSaveDataCommon::NoteColorType) == 0x4, "Size mismatch!");
