...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataCommon::OffsetDirection, "BeatmapSaveDataCommon", "OffsetDirection");
// Dependencies
namespace BeatmapSaveDataCommon {
// Is value type: true
...
static_assert(sizeof(::BeatmapSaveDataCommon::OffsetDirection) == 0x4, "Size mismatch!");
