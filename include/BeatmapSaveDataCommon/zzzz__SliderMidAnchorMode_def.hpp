...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataCommon::SliderMidAnchorMode, "BeatmapSaveDataCommon", "SliderMidAnchorMode");
// Dependencies
namespace BeatmapSaveDataCommon {
// Is value type: true
...
static_assert(sizeof(::BeatmapSaveDataCommon::SliderMidAnchorMode) == 0x4, "Size mismatch!");
