...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion2_6_0AndEarlier::BeatmapSaveData*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion2_6_0AndEarlier::BeatmapSaveData*, "BeatmapSaveDataVersion2_6_0AndEarlier", "BeatmapSaveData");
...
public:
  ...
  /// @brief Method ConvertBeatmapSaveDataPreV2_5_0Inline, addr 0x369f0ec, size 0x300, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369f064, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_events, addr 0x369f034, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::EventData*>* get_events();

  /// @brief Method get_notes, addr 0x369f03c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::NoteData*>* get_notes();

  /// @brief Method get_obstacles, addr 0x369f054, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleData*>* get_obstacles();

  /// @brief Method get_sliders, addr 0x369f044, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::SliderData*>* get_sliders();

  /// @brief Method get_specialEventsKeywordFilters, addr 0x369f05c, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventKeywordFiltersData* get_specialEventsKeywordFilters();

  /// @brief Method get_version, addr 0x369f02c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_version();

  /// @brief Method get_waypoints, addr 0x369f04c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapSaveDataVersion2_6_0AndEarlier::BeatmapSaveData) == 0x48, "Size mismatch!");
