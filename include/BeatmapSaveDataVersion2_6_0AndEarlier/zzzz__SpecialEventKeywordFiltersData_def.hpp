...
public:
  ...
  /// @brief Method .ctor, addr 0x375a0e0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_keywords, addr 0x375a0d8, size 0x8, virtual false, abstract: false, final false
