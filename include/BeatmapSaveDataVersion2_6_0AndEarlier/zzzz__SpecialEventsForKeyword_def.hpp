...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventsForKeyword*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventsForKeyword*, "BeatmapSaveDataVersion2_6_0AndEarlier", "SpecialEventsForKeyword");
...
public:
  ...
  /// @brief Method .ctor, addr 0x375a0f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW keyword, ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>* specialEvents);

  /// @brief Method get_keyword, addr 0x375a0e8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_keyword();

  /// @brief Method get_specialEvents, addr 0x375a0f0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventsForKeyword) == 0x20, "Size mismatch!");
