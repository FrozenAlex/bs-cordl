...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion3::BeatmapSaveData*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::BeatmapSaveData*, "BeatmapSaveDataVersion3", "BeatmapSaveData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x369dfdc, size 0xf0, virtual false, abstract: false, final false
  inline void
...
static_assert(sizeof(::BeatmapSaveDataVersion3::BeatmapSaveData) == 0xa0, "Size mismatch!");
