...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion3::BurstSliderData*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::BurstSliderData*, "BeatmapSaveDataVersion3", "BurstSliderData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3759b4c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_cuttableSlicesCount, addr 0x3759b38, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_cuttableSlicesCount();

  /// @brief Method get_sliceCount, addr 0x3759b30, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_sliceCount();

  /// @brief Method get_squishAmount, addr 0x3759b44, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapSaveDataVersion3::BurstSliderData) == 0x38, "Size mismatch!");
