...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion3::ColorBoostEventData*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::ColorBoostEventData*, "BeatmapSaveDataVersion3", "ColorBoostEventData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x369ee60, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(float_t beat, bool boost);

  /// @brief Method get_boost, addr 0x369ee58, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapSaveDataVersion3::ColorBoostEventData) == 0x18, "Size mismatch!");
