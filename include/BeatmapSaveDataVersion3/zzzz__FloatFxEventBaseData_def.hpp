...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion3::FloatFxEventBaseData*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::FloatFxEventBaseData*, "BeatmapSaveDataVersion3", "FloatFxEventBaseData");
...
static_assert(sizeof(::BeatmapSaveDataVersion3::FloatFxEventBaseData) == 0x20, "Size mismatch!");
