...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion3::FxEventBoxGroup*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::FxEventBoxGroup*, "BeatmapSaveDataVersion3", "FxEventBoxGroup");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3758c74, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method get_type, addr 0x3758c6c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapSaveDataVersion3::FxEventBoxGroup) == 0x28, "Size mismatch!");
