...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion3::LightColorBaseData*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::LightColorBaseData*, "BeatmapSaveDataVersion3", "LightColorBaseData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x369ec90, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beat, addr 0x369ec50, size 0x8, virtual false, abstract: false, final false
  inline float_t get_beat();

  /// @brief Method get_brightness, addr 0x369ec68, size 0x8, virtual false, abstract: false, final false
  inline float_t get_brightness();

  /// @brief Method get_colorType, addr 0x369ec60, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::EnvironmentColorType get_colorType();

  /// @brief Method get_strobeBeatFrequency, addr 0x369ec70, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_strobeBeatFrequency();

  /// @brief Method get_strobeBrightness, addr 0x369ec78, size 0x8, virtual false, abstract: false, final false
  inline float_t get_strobeBrightness();

  /// @brief Method get_strobeFade, addr 0x369ec80, size 0x10, virtual false, abstract: false, final false
  inline bool get_strobeFade();

  /// @brief Method get_transitionType, addr 0x369ec58, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapSaveDataVersion3::LightColorBaseData) == 0x30, "Size mismatch!");
