...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion3::LightRotationEventBoxGroup*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::LightRotationEventBoxGroup*, "BeatmapSaveDataVersion3", "LightRotationEventBoxGroup");
...
public:
  // Declarations
  /// @brief Method CopyWith, addr 0x369e68c, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369e624, size 0x68, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapSaveDataVersion3::LightRotationEventBoxGroup) == 0x20, "Size mismatch!");
