...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion3::RotationEventData*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::RotationEventData*, "BeatmapSaveDataVersion3", "RotationEventData");
// Dependencies BeatmapSaveDataCommon.ExecutionTime, BeatmapSaveDataVersion3.BeatmapSaveDataItem
namespace BeatmapSaveDataVersion3 {
// Is value type: false
...
static_assert(sizeof(::BeatmapSaveDataVersion3::RotationEventData) == 0x20, "Size mismatch!");
