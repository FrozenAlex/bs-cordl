...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion3::SliderData*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::SliderData*, "BeatmapSaveDataVersion3", "SliderData");
// Dependencies BeatmapSaveDataCommon.NoteCutDirection, BeatmapSaveDataCommon.SliderMidAnchorMode, BeatmapSaveDataVersion3.BaseSliderData
namespace BeatmapSaveDataVersion3 {
// Is value type: false
...
public:
  ...
  /// @brief Method .ctor, addr 0x369ef8c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_headControlPointLengthMultiplier, addr 0x369ef6c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_headControlPointLengthMultiplier();

  /// @brief Method get_sliderMidAnchorMode, addr 0x369ef84, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::SliderMidAnchorMode get_sliderMidAnchorMode();

  /// @brief Method get_tailControlPointLengthMultiplier, addr 0x369ef74, size 0x8, virtual false, abstract: false, final false
  inline float_t get_tailControlPointLengthMultiplier();

  /// @brief Method get_tailCutDirection, addr 0x369ef7c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapSaveDataVersion3::SliderData) == 0x40, "Size mismatch!");
