...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::SliderType, "BeatmapSaveDataVersion3", "SliderType");
// Dependencies
namespace BeatmapSaveDataVersion3 {
// Is value type: true
...
static_assert(sizeof(::BeatmapSaveDataVersion3::SliderType) == 0x4, "Size mismatch!");
