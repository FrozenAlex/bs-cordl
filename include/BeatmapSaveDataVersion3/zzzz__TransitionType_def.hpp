...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::TransitionType, "BeatmapSaveDataVersion3", "TransitionType");
// Dependencies
namespace BeatmapSaveDataVersion3 {
// Is value type: true
...
static_assert(sizeof(::BeatmapSaveDataVersion3::TransitionType) == 0x4, "Size mismatch!");
