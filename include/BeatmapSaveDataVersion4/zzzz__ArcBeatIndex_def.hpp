...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion4::ArcBeatIndex*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::ArcBeatIndex*, "BeatmapSaveDataVersion4", "ArcBeatIndex");
...
public:
  ...
  /// @brief Method .ctor, addr 0x369d13c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beat, addr 0x369d134, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::BeatmapSaveDataVersion4::ArcBeatIndex) == 0x30, "Size mismatch!");
