...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::BasicEvent, "BeatmapSaveDataVersion4", "BasicEvent");
...
static_assert(sizeof(::BeatmapSaveDataVersion4::BasicEvent) == 0xc, "Size mismatch!");
