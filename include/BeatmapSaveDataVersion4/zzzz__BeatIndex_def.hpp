...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion4::BeatIndex*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::BeatIndex*, "BeatmapSaveDataVersion4", "BeatIndex");
...
public:
  ...
  /// @brief Method .ctor, addr 0x369d118, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beat, addr 0x369d110, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::BeatmapSaveDataVersion4::BeatIndex) == 0x18, "Size mismatch!");
