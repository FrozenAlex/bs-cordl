...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::BombNote, "BeatmapSaveDataVersion4", "BombNote");
// Dependencies
namespace BeatmapSaveDataVersion4 {
// Is value type: true
...
static_assert(sizeof(::BeatmapSaveDataVersion4::BombNote) == 0x8, "Size mismatch!");
