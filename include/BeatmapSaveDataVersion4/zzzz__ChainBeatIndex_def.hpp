...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion4::ChainBeatIndex*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::ChainBeatIndex*, "BeatmapSaveDataVersion4", "ChainBeatIndex");
...
public:
  ...
  /// @brief Method .ctor, addr 0x369d130, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beat, addr 0x369d128, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::BeatmapSaveDataVersion4::ChainBeatIndex) == 0x28, "Size mismatch!");
