...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<float_t (::BeatmapSaveDataVersion4::ChainBeatIndex::*)()>(&::BeatmapSaveDataVersion4::ChainBeatIndex::get_beat)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3757ca4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BeatmapSaveDataVersion4::ChainBeatIndex*>(), { "get_beat", {}, {} })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::BeatmapSaveDataVersion4::ChainBeatIndex::*)()>(&::BeatmapSaveDataVersion4::ChainBeatIndex::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x3757cac;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BeatmapSaveDataVersion4::ChainBeatIndex*>(), { ".ctor", {}, {} })));
    return ___internal_method;
  }
};
...
constexpr int32_t& BeatmapSaveDataVersion4::ChainBeatIndex::__cordl_internal_get_hr() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___hr;
}
constexpr int32_t const& BeatmapSaveDataVersion4::ChainBeatIndex::__cordl_internal_get_hr() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___hr;
}
constexpr void BeatmapSaveDataVersion4::ChainBeatIndex::__cordl_internal_set_hr(int32_t value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->___hr = value;
}
...
constexpr int32_t& BeatmapSaveDataVersion4::ChainBeatIndex::__cordl_internal_get_tr() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___tr;
}
constexpr int32_t const& BeatmapSaveDataVersion4::ChainBeatIndex::__cordl_internal_get_tr() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___tr;
}
constexpr void BeatmapSaveDataVersion4::ChainBeatIndex::__cordl_internal_set_tr(int32_t value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->___tr = value;
}
...
inline ::BeatmapSaveDataVersion4::ChainBeatIndex* BeatmapSaveDataVersion4::ChainBeatIndex::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::BeatmapSaveDataVersion4::ChainBeatIndex*>());
}
