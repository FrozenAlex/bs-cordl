...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::EventBoxGroupType, "BeatmapSaveDataVersion4", "EventBoxGroupType");
// Dependencies
namespace BeatmapSaveDataVersion4 {
// Is value type: true
...
static_assert(sizeof(::BeatmapSaveDataVersion4::EventBoxGroupType) == 0x4, "Size mismatch!");
