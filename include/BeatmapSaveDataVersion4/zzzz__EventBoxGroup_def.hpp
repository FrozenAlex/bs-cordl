...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion4::EventBoxGroup*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::EventBoxGroup*, "BeatmapSaveDataVersion4", "EventBoxGroup");
// Dependencies BeatmapSaveDataVersion4.EventBox, BeatmapSaveDataVersion4.EventBoxGroupType, System.Object
namespace BeatmapSaveDataVersion4 {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_e, put = __cordl_internal_set_e)) ::ArrayW<::BeatmapSaveDataVersion4::EventBox> e;
  ...
  constexpr ::ArrayW<::BeatmapSaveDataVersion4::EventBox> const& __cordl_internal_get_e() const;

  constexpr ::ArrayW<::BeatmapSaveDataVersion4::EventBox>& __cordl_internal_get_e();
  ...
  constexpr void __cordl_internal_set_e(::ArrayW<::BeatmapSaveDataVersion4::EventBox> value);
  ...
  /// @brief Method .ctor, addr 0x369d6d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beat, addr 0x369d6cc, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  ::ArrayW<::BeatmapSaveDataVersion4::EventBox> ___e;
...
static_assert(sizeof(::BeatmapSaveDataVersion4::EventBoxGroup) == 0x28, "Size mismatch!");
