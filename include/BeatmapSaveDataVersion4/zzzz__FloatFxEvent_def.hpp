...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::FloatFxEvent, "BeatmapSaveDataVersion4", "FloatFxEvent");
...
static_assert(sizeof(::BeatmapSaveDataVersion4::FloatFxEvent) == 0xc, "Size mismatch!");
