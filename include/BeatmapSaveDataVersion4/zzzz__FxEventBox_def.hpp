...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::FxEventBox, "BeatmapSaveDataVersion4", "FxEventBox");
...
static_assert(sizeof(::BeatmapSaveDataVersion4::FxEventBox) == 0x18, "Size mismatch!");
