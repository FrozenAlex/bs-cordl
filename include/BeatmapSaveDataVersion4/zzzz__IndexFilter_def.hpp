...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::IndexFilter, "BeatmapSaveDataVersion4", "IndexFilter");
...
static_assert(sizeof(::BeatmapSaveDataVersion4::IndexFilter) == 0x24, "Size mismatch!");
