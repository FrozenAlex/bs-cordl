...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::LightColorEventBox, "BeatmapSaveDataVersion4", "LightColorEventBox");
...
static_assert(sizeof(::BeatmapSaveDataVersion4::LightColorEventBox) == 0x18, "Size mismatch!");
