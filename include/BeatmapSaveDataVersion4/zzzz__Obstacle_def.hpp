...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::Obstacle, "BeatmapSaveDataVersion4", "Obstacle");
// Dependencies
namespace BeatmapSaveDataVersion4 {
// Is value type: true
...
static_assert(sizeof(::BeatmapSaveDataVersion4::Obstacle) == 0x14, "Size mismatch!");
