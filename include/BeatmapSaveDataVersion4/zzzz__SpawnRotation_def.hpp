...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::SpawnRotation, "BeatmapSaveDataVersion4", "SpawnRotation");
...
static_assert(sizeof(::BeatmapSaveDataVersion4::SpawnRotation) == 0x8, "Size mismatch!");
