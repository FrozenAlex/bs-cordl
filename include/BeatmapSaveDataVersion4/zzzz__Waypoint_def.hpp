...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::Waypoint, "BeatmapSaveDataVersion4", "Waypoint");
...
static_assert(sizeof(::BeatmapSaveDataVersion4::Waypoint) == 0xc, "Size mismatch!");
