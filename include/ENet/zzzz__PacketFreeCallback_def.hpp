...
// Write type traits
MARK_REF_T(::ENet::PacketFreeCallback*);
DEFINE_IL2CPP_CLASS(::ENet::PacketFreeCallback*, "ENet", "PacketFreeCallback");
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x5891e3c, size 0x88, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::ENet::Packet packet, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x5891ec4, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x5891e28, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5891dbc, size 0x6c, virtual false, abstract: false, final false
...
static_assert(sizeof(::ENet::PacketFreeCallback) == 0x80, "Size mismatch!");
