...
public:
  ...
  /// @brief Field _colorSchemes, offset 0x50, size 0x8
...
// Non member Declarations
static_assert(offsetof(::Environments::Definitions::ColorSchemesAsyncInstaller, ____colorSchemes) == 0x50, "Offset mismatch!");

static_assert(sizeof(::Environments::Definitions::ColorSchemesAsyncInstaller) == 0x58, "Size mismatch!");
