...
public:
  ...
  /// @brief Field _environmentInfos, offset 0x50, size 0x8
...
// Non member Declarations
static_assert(offsetof(::Environments::Definitions::EnvironmentsAsyncInstaller, ____environmentInfos) == 0x50, "Offset mismatch!");

static_assert(sizeof(::Environments::Definitions::EnvironmentsAsyncInstaller) == 0x58, "Size mismatch!");
