...
// Write type traits
MARK_REF_T(::GlobalNamespace::AbstractPoolContainer*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AbstractPoolContainer*, "", "AbstractPoolContainer");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5a1e380, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::AbstractPoolContainer) == 0x20, "Size mismatch!");
