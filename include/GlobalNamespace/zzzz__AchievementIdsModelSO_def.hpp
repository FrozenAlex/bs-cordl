...
// Write type traits
MARK_REF_T(::GlobalNamespace::AchievementIdsModelSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AchievementIdsModelSO*, "", "AchievementIdsModelSO");
...
public:
  ...
  /// @brief Method .ctor, addr 0x363a008, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_achievementsIds, addr 0x363a000, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::AchievementIdsModelSO) == 0x20, "Size mismatch!");
