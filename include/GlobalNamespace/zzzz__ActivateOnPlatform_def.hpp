...
// Write type traits
MARK_REF_T(::GlobalNamespace::ActivateOnPlatform*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ActivateOnPlatform*, "", "ActivateOnPlatform");
...
static_assert(sizeof(::GlobalNamespace::ActivateOnPlatform) == 0x30, "Size mismatch!");
