...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AnalyticsPostResponse, "", "AnalyticsPostResponse");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::AnalyticsPostResponse) == 0x10, "Size mismatch!");
