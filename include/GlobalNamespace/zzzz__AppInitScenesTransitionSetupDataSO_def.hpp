...
MARK_REF_T(::GlobalNamespace::AppInitScenesTransitionSetupDataSO*);
MARK_REF_T(::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitSceneSetupData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitOverrideStartType, "", "AppInitScenesTransitionSetupDataSO/AppInitOverrideStartType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AppInitScenesTransitionSetupDataSO*, "", "AppInitScenesTransitionSetupDataSO");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitSceneSetupData*, "", "AppInitScenesTransitionSetupDataSO/AppInitSceneSetupData");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitOverrideStartType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x324686c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitOverrideStartType appInitOverrideStartType);

  /// @brief Method get_appInitOverrideStartType, addr 0x324ec68, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitOverrideStartType get_appInitOverrideStartType();

  /// @brief Method set_appInitOverrideStartType, addr 0x324ec70, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitSceneSetupData) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method Init, addr 0x324eae8, size 0xe4, virtual false, abstract: false, final false
  inline void Init(::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitOverrideStartType appInitOverrideStartType);

  /// @brief Method InitAsDefault, addr 0x324ebcc, size 0x8, virtual false, abstract: false, final false
  inline void InitAsDefault();

  /// @brief Method InitAsMultiSceneEditor, addr 0x324ebd4, size 0x8, virtual false, abstract: false, final false
  inline void InitAsMultiSceneEditor();

  /// @brief Method InitDirectlyToMenu, addr 0x324eae0, size 0x8, virtual false, abstract: false, final false
  inline void InitDirectlyToMenu();

  static inline ::GlobalNamespace::AppInitScenesTransitionSetupDataSO* New_ctor();

  /// @brief Method .ctor, addr 0x324ec58, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::AppInitScenesTransitionSetupDataSO) == 0x28, "Size mismatch!");
