...
MARK_REF_T(::GlobalNamespace::AppInitSetupData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AppInitSetupData_RunMode, "", "AppInitSetupData/RunMode");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AppInitSetupData*, "", "AppInitSetupData");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::AppInitSetupData_RunMode) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x324776c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::AppInitSetupData) == 0x18, "Size mismatch!");
