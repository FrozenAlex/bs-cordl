...
// Write type traits
MARK_REF_T(::GlobalNamespace::AppStaticSettingsInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AppStaticSettingsInstaller*, "", "AppStaticSettingsInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x3767444, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x37674c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::AppStaticSettingsInstaller) == 0x30, "Size mismatch!");
