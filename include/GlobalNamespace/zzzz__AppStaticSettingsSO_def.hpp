...
// Write type traits
MARK_REF_T(::GlobalNamespace::AppStaticSettingsSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AppStaticSettingsSO*, "", "AppStaticSettingsSO");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3645b54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::AppStaticSettingsSO) == 0x20, "Size mismatch!");
