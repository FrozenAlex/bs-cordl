...
public:
  // Declarations
  /// @brief Method IsValidIndex, addr 0x3307a14, size 0x2c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ArrayExtension) == 0x10, "Size mismatch!");
