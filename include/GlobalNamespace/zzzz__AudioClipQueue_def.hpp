...
// Write type traits
MARK_REF_T(::GlobalNamespace::AudioClipQueue*);
MARK_REF_T(::GlobalNamespace::AudioClipQueue_AudioClipWithDelay*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AudioClipQueue*, "", "AudioClipQueue");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AudioClipQueue_AudioClipWithDelay*, "", "AudioClipQueue/AudioClipWithDelay");
...
static_assert(sizeof(::GlobalNamespace::AudioClipQueue_AudioClipWithDelay) == 0x20, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::AudioClipQueue) == 0x30, "Size mismatch!");
