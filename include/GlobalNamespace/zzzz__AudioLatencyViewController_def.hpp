...
public:
  ...
  /// @brief Method DidActivate, addr 0x5a177f4, size 0x334, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x5a17bdc, size 0xfc, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleAmbientVolumeChanged, addr 0x5a17df8, size 0x18, virtual false, abstract: false, final false
  inline void HandleAmbientVolumeChanged(::GlobalNamespace::FormattedFloatListSettingsController* _, float_t newValue);

  /// @brief Method HandleOverrideAudioLatencyToggleValueChanged, addr 0x5a17e40, size 0x50, virtual false, abstract: false, final false
  inline void HandleOverrideAudioLatencyToggleValueChanged(bool isOn);

  /// @brief Method HandleVolumeChanged, addr 0x5a17dc4, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5a17cd8, size 0xec, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RefreshVisuals, addr 0x5a17b28, size 0xb4, virtual false, abstract: false, final false
  inline void RefreshVisuals(bool overrideAudioLatencyIsEnabled);

  /// @brief Method SliderValueDidChange, addr 0x5a17e10, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a17e90, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
