...
// Write type traits
MARK_REF_T(::GlobalNamespace::AudioManagerConfigSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AudioManagerConfigSO*, "", "AudioManagerConfigSO");
...
static_assert(sizeof(::GlobalNamespace::AudioManagerConfigSO) == 0x28, "Size mismatch!");
