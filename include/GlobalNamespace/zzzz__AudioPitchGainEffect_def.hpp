...
public:
  ...
  /// @brief Method MoveNext, addr 0x58b5214, size 0x190, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::AudioPitchGainEffect__StartEffectCoroutine_d__8* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x58b53a4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x58b53ac, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x58b53e4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x58b5210, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x58b518c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InterruptEffect, addr 0x58b51bc, size 0x3c, virtual false, abstract: false, final false
  inline void InterruptEffect();

  static inline ::GlobalNamespace::AudioPitchGainEffect* New_ctor();

  /// @brief Method SetAudioSource, addr 0x58b51f8, size 0x8, virtual false, abstract: false, final false
  inline void SetAudioSource(::UnityEngine::AudioSource* audioSource);

  /// @brief Method Start, addr 0x58b50f4, size 0x24, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartEffect, addr 0x58b5194, size 0x28, virtual false, abstract: false, final false
  inline void StartEffect(float_t volumeScale, ::System::Action* finishCallback);

  /// @brief Method StartEffectCoroutine, addr 0x58b5118, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58b5200, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
