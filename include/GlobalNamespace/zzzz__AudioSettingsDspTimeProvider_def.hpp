...
// Write type traits
MARK_REF_T(::GlobalNamespace::AudioSettingsDspTimeProvider*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AudioSettingsDspTimeProvider*, "", "AudioSettingsDspTimeProvider");
...
public:
  ...
  /// @brief Method .ctor, addr 0x577daa0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_dspTime, addr 0x577da78, size 0x28, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::AudioSettingsDspTimeProvider) == 0x10, "Size mismatch!");
