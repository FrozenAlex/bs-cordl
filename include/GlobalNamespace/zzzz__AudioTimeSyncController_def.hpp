...
public:
  ...
  /// @brief Method .ctor, addr 0x58b6870, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x58b58fc, size 0x48, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleAudioConfigurationChanged, addr 0x58b5b68, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x58b5ae8, size 0x80, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Pause, addr 0x58b67b4, size 0x58, virtual false, abstract: false, final false
  inline void Pause();

  /// @brief Method Resume, addr 0x58b680c, size 0x50, virtual false, abstract: false, final false
  inline void Resume();

  /// @brief Method SeekTo, addr 0x58b65c0, size 0x1ac, virtual false, abstract: false, final false
  inline void SeekTo(float_t startTimeOffset);

  /// @brief Method Start, addr 0x58b5944, size 0x1a4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartSong, addr 0x58b657c, size 0x44, virtual false, abstract: false, final false
  inline void StartSong(float_t startTimeOffset);

  /// @brief Method StopSong, addr 0x58b676c, size 0x48, virtual false, abstract: false, final false
  inline void StopSong();

  /// @brief Method Update, addr 0x58b5bac, size 0x9d0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x58b685c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_waitUntilAudioIsLoaded>b__31_0, addr 0x58b686c, size 0x4, virtual false, abstract: false, final false
  inline bool _get_waitUntilAudioIsLoaded_b__31_0();

  /// @brief Method add_stateChangedEvent, addr 0x58b5760, size 0xac, virtual false, abstract: false, final false
  inline void add_stateChangedEvent(::System::Action* value);

  /// @brief Method get_dspTimeOffset, addr 0x58b5694, size 0x8, virtual false, abstract: false, final false
  inline double_t get_dspTimeOffset();

  /// @brief Method get_forceNoAudioSyncOrAudioSyncErrorFixing, addr 0x58b5750, size 0x8, virtual false, abstract: false, final false
  inline bool get_forceNoAudioSyncOrAudioSyncErrorFixing();

  /// @brief Method get_isAudioLoaded, addr 0x58b5580, size 0xe0, virtual false, abstract: false, final false
  inline bool get_isAudioLoaded();

  /// @brief Method get_isReady, addr 0x58b5740, size 0x8, virtual true, abstract: false, final true
  inline bool get_isReady();

  /// @brief Method get_lastFrameDeltaSongTime, addr 0x58b5400, size 0x8, virtual true, abstract: false, final true
  inline float_t get_lastFrameDeltaSongTime();

  /// @brief Method get_songEndTime, addr 0x58b5668, size 0x24, virtual true, abstract: false, final true
  inline float_t get_songEndTime();

  /// @brief Method get_songFailedToLoad, addr 0x58b54a4, size 0xdc, virtual false, abstract: false, final false
  inline bool get_songFailedToLoad();

  /// @brief Method get_songLength, addr 0x58b5408, size 0x9c, virtual true, abstract: false, final true
  inline float_t get_songLength();

  /// @brief Method get_songTime, addr 0x58b53f8, size 0x8, virtual true, abstract: false, final true
  inline float_t get_songTime();

  /// @brief Method get_songTimeOffset, addr 0x58b5748, size 0x8, virtual false, abstract: false, final false
  inline float_t get_songTimeOffset();

  /// @brief Method get_startSongTime, addr 0x58b5660, size 0x8, virtual false, abstract: false, final false
  inline float_t get_startSongTime();

  /// @brief Method get_state, addr 0x58b53f0, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::IAudioTimeSource_State get_state();

  /// @brief Method get_timeScale, addr 0x58b568c, size 0x8, virtual true, abstract: false, final true
  inline float_t get_timeScale();

  /// @brief Method get_timeSinceStart, addr 0x58b58b8, size 0x44, virtual false, abstract: false, final false
  inline float_t get_timeSinceStart();

  /// @brief Method get_waitUntilAudioIsLoaded, addr 0x58b569c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_stateChangedEvent, addr 0x58b580c, size 0xac, virtual false, abstract: false, final false
  inline void remove_stateChangedEvent(::System::Action* value);

  /// @brief Method set_forceNoAudioSyncOrAudioSyncErrorFixing, addr 0x58b5758, size 0x8, virtual false, abstract: false, final false
