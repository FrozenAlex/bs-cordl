...
// Write type traits
MARK_REF_T(::GlobalNamespace::AutoSetupData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AutoSetupData*, "", "AutoSetupData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x593ad1c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::AutoSetupData) == 0x18, "Size mismatch!");
