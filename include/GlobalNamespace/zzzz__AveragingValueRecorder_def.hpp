...
public:
  ...
  /// @brief Method .ctor, addr 0x5a20b78, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(float_t value, float_t time);

  /// @brief Method get_time, addr 0x5a20ba8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_time();

  /// @brief Method get_value, addr 0x5a20b98, size 0x8, virtual false, abstract: false, final false
  inline float_t get_value();

  /// @brief Method set_time, addr 0x5a20bb0, size 0x8, virtual false, abstract: false, final false
  inline void set_time(float_t value);

  /// @brief Method set_value, addr 0x5a20ba0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetAverageValue, addr 0x5a20b80, size 0x8, virtual false, abstract: false, final false
  inline float_t GetAverageValue();

  /// @brief Method GetHistoryValues, addr 0x5a20b90, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Queue_1<float_t>* GetHistoryValues();

  /// @brief Method GetLastValue, addr 0x5a20b88, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x5a208f0, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a207c8, size 0x128, virtual false, abstract: false, final false
