...
// Write type traits
MARK_REF_T(::GlobalNamespace::BTSCharacterMaterialSwitcher*);
MARK_REF_T(::GlobalNamespace::BTSCharacterMaterialSwitcher_MaterialPairs*);
MARK_REF_T(::GlobalNamespace::BTSCharacterMaterialSwitcher_RendererMaterialsPairs*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BTSCharacterMaterialSwitcher*, "", "BTSCharacterMaterialSwitcher");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BTSCharacterMaterialSwitcher_MaterialPairs*, "", "BTSCharacterMaterialSwitcher/MaterialPairs");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BTSCharacterMaterialSwitcher_RendererMaterialsPairs*, "", "BTSCharacterMaterialSwitcher/RendererMaterialsPairs");
...
public:
  ...
  /// @brief Method .ctor, addr 0x31ec5fc, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Renderer* renderer);

  /// @brief Method get_materialPairs, addr 0x31ec5f4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::GlobalNamespace::BTSCharacterMaterialSwitcher_MaterialPairs*>* get_materialPairs();

  /// @brief Method get_renderer, addr 0x31ec5ec, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BTSCharacterMaterialSwitcher_RendererMaterialsPairs) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x31ec680, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BTSCharacterMaterialSwitcher_MaterialPairs) == 0x28, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies BTSCharacterMaterialSwitcher::RendererMaterialsPairs, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method SwapMaterials, addr 0x31ec394, size 0x214, virtual false, abstract: false, final false
  inline void SwapMaterials(bool alternative);

  constexpr ::ArrayW<::GlobalNamespace::BTSCharacterMaterialSwitcher_RendererMaterialsPairs*> const& __cordl_internal_get__rendererMaterialsPairs() const;

  constexpr ::ArrayW<::GlobalNamespace::BTSCharacterMaterialSwitcher_RendererMaterialsPairs*>& __cordl_internal_get__rendererMaterialsPairs();

  constexpr void __cordl_internal_set__rendererMaterialsPairs(::ArrayW<::GlobalNamespace::BTSCharacterMaterialSwitcher_RendererMaterialsPairs*> value);

  /// @brief Method .ctor, addr 0x31ec5e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BTSCharacterMaterialSwitcher) == 0x28, "Size mismatch!");
