...
// Write type traits
MARK_REF_T(::GlobalNamespace::BakedLightTexturePacking*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BakedLightTexturePacking*, "", "BakedLightTexturePacking");
...
public:
  ...
  __declspec(property(get = getStaticF__texPropertyIds, put = setStaticF__texPropertyIds)) ::ArrayW<int32_t> _texPropertyIds;

  /// @brief Method PackTextures, addr 0x57c1780, size 0x378, virtual false, abstract: false, final false
  ...
  static inline ::ArrayW<int32_t> getStaticF__texPropertyIds();

  static inline void setStaticF__material(::UnityW<::UnityEngine::Material> value);

  static inline void setStaticF__texPropertyIds(::ArrayW<int32_t> value);
...
static_assert(sizeof(::GlobalNamespace::BakedLightTexturePacking) == 0x10, "Size mismatch!");
