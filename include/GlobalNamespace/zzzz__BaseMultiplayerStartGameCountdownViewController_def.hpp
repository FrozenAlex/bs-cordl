...
// Write type traits
MARK_REF_T(::GlobalNamespace::BaseMultiplayerStartGameCountdownViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BaseMultiplayerStartGameCountdownViewController*, "", "BaseMultiplayerStartGameCountdownViewController");
...
static_assert(sizeof(::GlobalNamespace::BaseMultiplayerStartGameCountdownViewController) == 0xa0, "Size mismatch!");
