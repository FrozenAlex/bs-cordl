...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::BaseStateTransition_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::BaseStateTransition_1, "", "BaseStateTransition`1");
// Dependencies BaseStateTransition
namespace GlobalNamespace {
// cpp template
template <typename T>
// Is value type: false
