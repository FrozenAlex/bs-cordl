...
// Write type traits
MARK_REF_T(::GlobalNamespace::BaseTransitionSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BaseTransitionSO*, "", "BaseTransitionSO");
...
public:
  ...
  /// @brief Method GetTransitionTiming, addr 0x63049dc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63049e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BaseTransitionSO) == 0x20, "Size mismatch!");
