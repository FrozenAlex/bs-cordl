...
// Write type traits
MARK_REF_T(::GlobalNamespace::BaseViewControllersInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BaseViewControllersInstaller*, "", "BaseViewControllersInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x58c36f4, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58c37bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BaseViewControllersInstaller) == 0x30, "Size mismatch!");
