...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BasicBeatmapEventType, "", "BasicBeatmapEventType");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::BasicBeatmapEventType) == 0x4, "Size mismatch!");
