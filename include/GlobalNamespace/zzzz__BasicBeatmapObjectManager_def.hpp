...
// Write type traits
MARK_REF_T(::GlobalNamespace::BasicBeatmapObjectManager*);
MARK_REF_T(::GlobalNamespace::BasicBeatmapObjectManager_InitData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BasicBeatmapObjectManager*, "", "BasicBeatmapObjectManager");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BasicBeatmapObjectManager_InitData*, "", "BasicBeatmapObjectManager/InitData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58c2258, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BasicBeatmapObjectManager_InitData) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method DespawnInternal, addr 0x58c1be4, size 0x208, virtual true, abstract: false, final false
  inline void DespawnInternal(::GlobalNamespace::NoteController* noteController);

  /// @brief Method DespawnInternal, addr 0x58c188c, size 0x64, virtual true, abstract: false, final false
  inline void DespawnInternal(::GlobalNamespace::ObstacleController* obstacleController);

  /// @brief Method DespawnInternal, addr 0x58c2028, size 0xb0, virtual true, abstract: false, final false
  inline void DespawnInternal(::GlobalNamespace::SliderController* sliderNoteController);

  /// @brief Method Init, addr 0x58c1238, size 0x5a4, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessNoteData, addr 0x58c18f0, size 0x2f4, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessObstacleData, addr 0x58c17dc, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessSliderData, addr 0x58c1dec, size 0x23c, virtual true, abstract: false, final false
  ...
  /// @brief Method __InvalidateBombNotePool, addr 0x58c21b0, size 0xa0, virtual false, abstract: false, final false
  inline void __InvalidateBombNotePool();

  /// @brief Method __InvalidateGameNotePools, addr 0x58c20d8, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58c2250, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_activeObstacleControllers, addr 0x58c11e4, size 0x54, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BasicBeatmapObjectManager) == 0x100, "Size mismatch!");
