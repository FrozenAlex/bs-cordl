...
// Write type traits
MARK_REF_T(::GlobalNamespace::BasicMockPlayerScoreCalculator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BasicMockPlayerScoreCalculator*, "", "BasicMockPlayerScoreCalculator");
...
public:
  ...
  /// @brief Method GetScoreForNote, addr 0x5a7e054, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5a7dfb0, size 0xa4, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BasicMockPlayerScoreCalculator) == 0x28, "Size mismatch!");
