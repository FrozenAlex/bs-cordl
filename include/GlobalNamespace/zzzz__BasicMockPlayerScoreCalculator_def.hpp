...
public:
  ...
  /// @brief Method GetScoreForNote, addr 0x59477f0, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x594774c, size 0xa4, virtual false, abstract: false, final false
