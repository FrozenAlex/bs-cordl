...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::GlobalNamespace::BasicMockPlayerScoreCalculator::*)(::GlobalNamespace::MockNoteData*)>(
  ...
  constexpr static std::size_t addrs = 0x5a7e054;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{},
                     (::i2c::find_method(::i2c::class_of<::GlobalNamespace::BasicMockPlayerScoreCalculator*>(), { "GetScoreForNote", {}, { ::i2c::type_of<::GlobalNamespace::MockNoteData*>() } })));
    return ___internal_method;
  }
};
...
inline void GlobalNamespace::BasicMockPlayerScoreCalculator::_ctor(float_t hitFrequency, int32_t minScore, int32_t maxScore) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::BasicMockPlayerScoreCalculator*>(),
                                                                                         { ".ctor", {}, { ::i2c::type_of<float_t>(), ::i2c::type_of<int32_t>(), ::i2c::type_of<int32_t>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, hitFrequency, minScore, maxScore);
}
...
inline ::GlobalNamespace::BasicMockPlayerScoreCalculator* GlobalNamespace::BasicMockPlayerScoreCalculator::New_ctor(float_t hitFrequency, int32_t minScore, int32_t maxScore) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::BasicMockPlayerScoreCalculator*>(hitFrequency, minScore, maxScore));
}
