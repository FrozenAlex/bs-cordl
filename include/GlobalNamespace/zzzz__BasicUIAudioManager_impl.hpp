...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::BasicUIAudioManager::*)()>(&::GlobalNamespace::BasicUIAudioManager::Start)> {
  ...
  constexpr static std::size_t addrs = 0x59f82a4;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::BasicUIAudioManager::*)()>(&::GlobalNamespace::BasicUIAudioManager::OnEnable)> {
  ...
  constexpr static std::size_t addrs = 0x59f8374;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::BasicUIAudioManager::*)()>(&::GlobalNamespace::BasicUIAudioManager::OnDisable)> {
  ...
  constexpr static std::size_t addrs = 0x59f8490;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::BasicUIAudioManager::*)()>(&::GlobalNamespace::BasicUIAudioManager::HandleButtonClickEvent)> {
  ...
  constexpr static std::size_t addrs = 0x59f8594;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::BasicUIAudioManager::*)()>(&::GlobalNamespace::BasicUIAudioManager::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x59f875c;
...
constexpr ::ArrayW<::UnityW<::GlobalNamespace::Signal>>& GlobalNamespace::BasicUIAudioManager::__cordl_internal_get__buttonClickEvents() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____buttonClickEvents;
}
constexpr ::ArrayW<::UnityW<::GlobalNamespace::Signal>> const& GlobalNamespace::BasicUIAudioManager::__cordl_internal_get__buttonClickEvents() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____buttonClickEvents;
}
constexpr void GlobalNamespace::BasicUIAudioManager::__cordl_internal_set__buttonClickEvents(::ArrayW<::UnityW<::GlobalNamespace::Signal>> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____buttonClickEvents = value;
}
constexpr ::ArrayW<::UnityW<::UnityEngine::AudioSource>>& GlobalNamespace::BasicUIAudioManager::__cordl_internal_get__audioSources() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____audioSources;
}
constexpr ::ArrayW<::UnityW<::UnityEngine::AudioSource>> const& GlobalNamespace::BasicUIAudioManager::__cordl_internal_get__audioSources() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____audioSources;
}
constexpr void GlobalNamespace::BasicUIAudioManager::__cordl_internal_set__audioSources(::ArrayW<::UnityW<::UnityEngine::AudioSource>> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____audioSources = value;
}
constexpr ::ArrayW<::UnityW<::UnityEngine::AudioClip>>& GlobalNamespace::BasicUIAudioManager::__cordl_internal_get__clickSounds() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____clickSounds;
}
constexpr ::ArrayW<::UnityW<::UnityEngine::AudioClip>> const& GlobalNamespace::BasicUIAudioManager::__cordl_internal_get__clickSounds() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____clickSounds;
}
constexpr void GlobalNamespace::BasicUIAudioManager::__cordl_internal_set__clickSounds(::ArrayW<::UnityW<::UnityEngine::AudioClip>> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____clickSounds = value;
}
...
inline ::GlobalNamespace::BasicUIAudioManager* GlobalNamespace::BasicUIAudioManager::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::BasicUIAudioManager*>());
}
// Ctor Parameters []
