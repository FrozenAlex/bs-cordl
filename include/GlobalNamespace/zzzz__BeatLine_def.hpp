...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatLine*);
MARK_REF_T(::GlobalNamespace::BeatLine_Pool*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatLine*, "", "BeatLine");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatLine_Pool*, "", "BeatLine/Pool");
...
static_assert(sizeof(::GlobalNamespace::BeatLine_Pool) == 0x40, "Size mismatch!");
