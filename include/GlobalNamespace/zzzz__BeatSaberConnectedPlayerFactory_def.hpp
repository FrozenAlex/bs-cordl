...
public:
  ...
  /// @brief Method CreateDirectlyConnectedPlayer, addr 0x32a32c4, size 0x250, virtual true, abstract: false, final true
  ...
  /// @brief Method CreateLocalPlayer, addr 0x32a3200, size 0xc4, virtual true, abstract: false, final true
  inline ::GlobalNamespace::BeatSaberConnectedPlayer*
  ...
  /// @brief Method CreateRemoteConnectedPlayer, addr 0x32a3514, size 0xec, virtual true, abstract: false, final true
  inline ::GlobalNamespace::BeatSaberConnectedPlayer*
  ...
  /// @brief Method .ctor, addr 0x32a3600, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
