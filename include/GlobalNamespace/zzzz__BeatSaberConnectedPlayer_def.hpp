...
public:
  ...
  /// @brief Method GetGameSpecificPlayerIdentityData, addr 0x320e668, size 0x14, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatSaberPlayerIdentityPacketData GetGameSpecificPlayerIdentityData();

  /// @brief Method GetPlayerAvatarPacket, addr 0x320e67c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMultiplayerAvatarsData, addr 0x320e720, size 0x14, virtual false, abstract: false, final false
  inline void SetMultiplayerAvatarsData(::GlobalNamespace::MultiplayerAvatarsData playerAvatars);

  /// @brief Method UpdateAvatar, addr 0x320e700, size 0x20, virtual false, abstract: false, final false
  inline void UpdateAvatar(::GlobalNamespace::PlayerAvatarPacket* packet);

  /// @brief Method UpdateIdentity, addr 0x320e6ec, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x320e590, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_multiplayerAvatarsData, addr 0x320e57c, size 0x14, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::BeatSaberConnectedPlayer) == 0xa8, "Size mismatch!");
