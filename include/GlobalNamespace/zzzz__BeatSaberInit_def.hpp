...
public:
  ...
  /// @brief Method InstallBindings, addr 0x36acf84, size 0x4cc, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::GlobalNamespace::BeatSaberInit* New_ctor();

  /// @brief Method PreloadAsync, addr 0x36acebc, size 0xc8, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* PreloadAsync();

  /// @brief Method RepeatableSetupAsync, addr 0x36acb84, size 0x11c, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* RepeatableSetupAsync();

  /// @brief Method TransitionToNextSceneAsync, addr 0x36acd1c, size 0x40, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* TransitionToNextSceneAsync();

  /// @brief Method <TransitionToNextSceneAsync>g__GetDestinationOverride|13_0, addr 0x36acd5c, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36af08c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_settingsApplicator, addr 0x36acb7c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatSaberInit) == 0x98, "Size mismatch!");
