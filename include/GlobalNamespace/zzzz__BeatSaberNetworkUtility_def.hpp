...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatSaberNetworkUtility*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatSaberNetworkUtility*, "", "BeatSaberNetworkUtility");
...
public:
  // Declarations
  /// @brief Method GetHashedUserId, addr 0x320f7b4, size 0x100, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatSaberNetworkUtility) == 0x10, "Size mismatch!");
