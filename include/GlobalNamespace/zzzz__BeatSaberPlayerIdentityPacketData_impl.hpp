...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::BeatSaberPlayerIdentityPacketData::*)(::GlobalNamespace::MultiplayerAvatarsData)>(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{},
                     (::i2c::find_method(::i2c::class_of<::GlobalNamespace::BeatSaberPlayerIdentityPacketData>(), { ".ctor", {}, { ::i2c::type_of<::GlobalNamespace::MultiplayerAvatarsData>() } })));
...
inline void GlobalNamespace::BeatSaberPlayerIdentityPacketData::_ctor(::GlobalNamespace::MultiplayerAvatarsData playerAvatar) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{},
                   (::i2c::find_method(::i2c::class_of<::GlobalNamespace::BeatSaberPlayerIdentityPacketData>(), { ".ctor", {}, { ::i2c::type_of<::GlobalNamespace::MultiplayerAvatarsData>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(*this, ___internal_method, playerAvatar);
}
