...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatSaberSessionEventType, "", "BeatSaberSessionEventType");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::BeatSaberSessionEventType) == 0x4, "Size mismatch!");
