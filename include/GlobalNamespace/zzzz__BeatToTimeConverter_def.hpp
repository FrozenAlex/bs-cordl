...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatToTimeConverter*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatToTimeConverter*, "", "BeatToTimeConverter");
...
public:
  ...
  /// @brief Method BeatToTime, addr 0x3654434, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x365442c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatToTimeConverter) == 0x18, "Size mismatch!");
