...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapCallbacksUpdater*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapCallbacksUpdater*, "", "BeatmapCallbacksUpdater");
...
static_assert(sizeof(::GlobalNamespace::BeatmapCallbacksUpdater) == 0x38, "Size mismatch!");
