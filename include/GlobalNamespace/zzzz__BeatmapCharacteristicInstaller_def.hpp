...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapCharacteristicInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapCharacteristicInstaller*, "", "BeatmapCharacteristicInstaller");
...
static_assert(sizeof(::GlobalNamespace::BeatmapCharacteristicInstaller) == 0x40, "Size mismatch!");
