...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapCharacteristicsTableView*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapCharacteristicsTableView*, "", "BeatmapCharacteristicsTableView");
...
static_assert(sizeof(::GlobalNamespace::BeatmapCharacteristicsTableView) == 0x58, "Size mismatch!");
