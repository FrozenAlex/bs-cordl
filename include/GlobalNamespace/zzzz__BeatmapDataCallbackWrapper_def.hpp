...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapDataCallbackWrapper*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapDataCallbackWrapper*, "", "BeatmapDataCallbackWrapper");
...
public:
  ...
  ::ArrayW<int32_t> ___subtypeIdentifiers;
...
static_assert(sizeof(::GlobalNamespace::BeatmapDataCallbackWrapper) == 0x28, "Size mismatch!");
