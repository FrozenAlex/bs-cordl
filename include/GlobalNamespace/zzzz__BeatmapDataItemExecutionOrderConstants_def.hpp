...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapDataItemExecutionOrderConstants*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapDataItemExecutionOrderConstants*, "", "BeatmapDataItemExecutionOrderConstants");
...
public:
  ...
  /// @brief Method .ctor, addr 0x32568fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BeatmapDataItemExecutionOrderConstants) == 0x10, "Size mismatch!");
