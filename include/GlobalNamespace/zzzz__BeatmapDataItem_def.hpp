...
public:
  ...
  /// @brief Method CompareTo, addr 0x31c5588, size 0x48, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x31c5578, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_executionOrder, addr 0x31c5548, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_executionOrder();

  /// @brief Method get_subtypeGroupIdentifier, addr 0x31c5550, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_subtypeGroupIdentifier();

  /// @brief Method get_subtypeIdentifier, addr 0x31c5558, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_subtypeIdentifier();

  /// @brief Method get_time, addr 0x31c5538, size 0x8, virtual false, abstract: false, final false
  inline float_t get_time();

  /// @brief Method get_type, addr 0x31c5568, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_subtypeIdentifier, addr 0x31c5560, size 0x8, virtual false, abstract: false, final false
  inline void set_subtypeIdentifier(int32_t value);

  /// @brief Method set_time, addr 0x31c5540, size 0x8, virtual false, abstract: false, final false
  inline void set_time(float_t value);

  /// @brief Method set_type, addr 0x31c5570, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapDataItem) == 0x20, "Size mismatch!");
