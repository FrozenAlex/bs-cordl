...
public:
  // Declarations
  /// @brief Method GetEnvironmentKeywords, addr 0x370eaec, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnvironmentLightGroups, addr 0x370ec5c, size 0x110, virtual false, abstract: false, final false
