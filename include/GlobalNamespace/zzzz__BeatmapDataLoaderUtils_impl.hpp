...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::GlobalNamespace::EnvironmentKeywords* (*)(::GlobalNamespace::IEnvironmentInfo*, ::GlobalNamespace::BeatmapLevelDataVersion)>(
  ...
  constexpr static std::size_t addrs = 0x36533dc;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{},
                     (::i2c::find_method(::i2c::class_of<::GlobalNamespace::BeatmapDataLoaderUtils*>(),
                                         { "GetEnvironmentKeywords", {}, { ::i2c::type_of<::GlobalNamespace::IEnvironmentInfo*>(), ::i2c::type_of<::GlobalNamespace::BeatmapLevelDataVersion>() } })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::GlobalNamespace::IEnvironmentLightGroups* (*)(::GlobalNamespace::IEnvironmentInfo*)>(
  ...
  constexpr static std::size_t addrs = 0x365354c;
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::BeatmapDataLoaderUtils*>(),
                                                                                           { "GetEnvironmentLightGroups", {}, { ::i2c::type_of<::GlobalNamespace::IEnvironmentInfo*>() } })));
    return ___internal_method;
  }
};
inline ::GlobalNamespace::EnvironmentKeywords* GlobalNamespace::BeatmapDataLoaderUtils::GetEnvironmentKeywords(::GlobalNamespace::IEnvironmentInfo* environmentInfo,
  ...
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{},
                   (::i2c::find_method(::i2c::class_of<::GlobalNamespace::BeatmapDataLoaderUtils*>(),
                                       { "GetEnvironmentKeywords", {}, { ::i2c::type_of<::GlobalNamespace::IEnvironmentInfo*>(), ::i2c::type_of<::GlobalNamespace::BeatmapLevelDataVersion>() } })));
  return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::EnvironmentKeywords*>(nullptr, ___internal_method, environmentInfo, beatmapLevelDataVersion);
}
inline ::GlobalNamespace::IEnvironmentLightGroups* GlobalNamespace::BeatmapDataLoaderUtils::GetEnvironmentLightGroups(::GlobalNamespace::IEnvironmentInfo* environmentInfo) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::BeatmapDataLoaderUtils*>(),
                                                                                         { "GetEnvironmentLightGroups", {}, { ::i2c::type_of<::GlobalNamespace::IEnvironmentInfo*>() } })));
  return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::IEnvironmentLightGroups*>(nullptr, ___internal_method, environmentInfo);
}
// Ctor Parameters []
