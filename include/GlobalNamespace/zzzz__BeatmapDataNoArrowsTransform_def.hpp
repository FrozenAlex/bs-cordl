...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapDataNoArrowsTransform*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapDataNoArrowsTransform*, "", "BeatmapDataNoArrowsTransform");
...
public:
  // Declarations
  /// @brief Method CreateTransformedData, addr 0x37015a4, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method <CreateTransformedData>g__ProcessData|0_0, addr 0x3701698, size 0xe4, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapDataNoArrowsTransform) == 0x10, "Size mismatch!");
