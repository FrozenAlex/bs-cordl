...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapDataObstaclesMergingTransform*);
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_prevObstacleDataInLines, put = __cordl_internal_set_prevObstacleDataInLines)) ::ArrayW<::GlobalNamespace::ObstacleData*> prevObstacleDataInLines;

  static inline ::GlobalNamespace::BeatmapDataObstaclesMergingTransform___c__DisplayClass0_0* New_ctor();

  /// @brief Method <CreateTransformedData>g__ProcessData|0, addr 0x3646d90, size 0x288, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::ObstacleData*> const& __cordl_internal_get_prevObstacleDataInLines() const;

  constexpr ::ArrayW<::GlobalNamespace::ObstacleData*>& __cordl_internal_get_prevObstacleDataInLines();
  ...
  /// @brief Method .ctor, addr 0x3646cfc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::GlobalNamespace::ObstacleData*> ___prevObstacleDataInLines;
...
static_assert(sizeof(::GlobalNamespace::BeatmapDataObstaclesMergingTransform___c__DisplayClass0_0) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method CanBeMerged, addr 0x3646d00, size 0x90, virtual false, abstract: false, final false
  static inline bool CanBeMerged(::GlobalNamespace::ObstacleData* firstObstacle, ::GlobalNamespace::ObstacleData* secondObstacle);

  /// @brief Method CreateTransformedData, addr 0x3646b40, size 0x1bc, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::BeatmapDataObstaclesMergingTransform) == 0x10, "Size mismatch!");
