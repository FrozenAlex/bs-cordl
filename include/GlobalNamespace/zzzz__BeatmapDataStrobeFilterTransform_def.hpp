...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapDataStrobeFilterTransform*);
MARK_REF_T(::GlobalNamespace::BeatmapDataStrobeFilterTransform_StrobeStreakData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapDataStrobeFilterTransform*, "", "BeatmapDataStrobeFilterTransform");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapDataStrobeFilterTransform_StrobeStreakData*, "", "BeatmapDataStrobeFilterTransform/StrobeStreakData");
...
public:
  ...
  /// @brief Method AddStrobeData, addr 0x3647e30, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method StartPotentialStrobe, addr 0x3647ed4, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3647da8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BeatmapDataStrobeFilterTransform_StrobeStreakData) == 0x38, "Size mismatch!");
...
public:
  ...
  /// @brief Method CreateTransformedData, addr 0x3647018, size 0xd90, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFlashAndFadeToBlackEventDataValue, addr 0x3647eb8, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t GetFlashAndFadeToBlackEventDataValue(::GlobalNamespace::EnvironmentColorType lightColorType);

  /// @brief Method GetOnEventDataValue, addr 0x3647e94, size 0x24, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::BeatmapDataStrobeFilterTransform) == 0x10, "Size mismatch!");
