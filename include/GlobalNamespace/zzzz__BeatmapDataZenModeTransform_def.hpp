...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapDataZenModeTransform*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapDataZenModeTransform*, "", "BeatmapDataZenModeTransform");
...
public:
  // Declarations
  /// @brief Method CreateTransformedData, addr 0x3702fcc, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method <CreateTransformedData>g__ProcessData|0_0, addr 0x370339c, size 0xb8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapDataZenModeTransform) == 0x10, "Size mismatch!");
