...
MARK_REF_T(::GlobalNamespace::BeatmapData_BeatmapDataBinaryHeapItem*);
MARK_GEN_REF_T_PTR(::GlobalNamespace::BeatmapData___c__DisplayClass50_0_1);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapData*, "", "BeatmapData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapData_BeatmapDataBinaryHeapItem*, "", "BeatmapData/BeatmapDataBinaryHeapItem");
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::BeatmapData___c__DisplayClass50_0_1, "", "BeatmapData/<>c__DisplayClass50_0`1");
...
public:
  ...
  /// @brief Method CompareTo, addr 0x370cba0, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x370c574, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapData_BeatmapDataBinaryHeapItem) == 0x18, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_subtypeGroupIdentifiers, put = __cordl_internal_set_subtypeGroupIdentifiers)) ::ArrayW<int32_t> subtypeGroupIdentifiers;

  static inline ::GlobalNamespace::BeatmapData___c__DisplayClass50_0_1<T>* New_ctor();
  ...
  constexpr ::ArrayW<int32_t> const& __cordl_internal_get_subtypeGroupIdentifiers() const;

  constexpr ::ArrayW<int32_t>& __cordl_internal_get_subtypeGroupIdentifiers();

  constexpr void __cordl_internal_set_subtypeGroupIdentifiers(::ArrayW<int32_t> value);
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr BeatmapData___c__DisplayClass50_0_1();

public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatmapData___c__DisplayClass50_0_1", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatmapData___c__DisplayClass50_0_1(BeatmapData___c__DisplayClass50_0_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatmapData___c__DisplayClass50_0_1", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
...
public:
  ...
  /// @brief Field _allBeatmapDataItemToNodeMap, offset 0x48, size 0x8
  ...
  /// @brief Field _beatmapDataItemsPerTypeAndId, offset 0x50, size 0x8
  __declspec(property(
  ...
  /// @brief Field _beatmapObjectsInTimeRowProcessor, offset 0x68, size 0x8
  ...
  /// @brief Field _isCreatingFilteredCopy, offset 0x74, size 0x1
  ...
  /// @brief Field _numberOfLines, offset 0x58, size 0x4
  ...
  /// @brief Field _prevAddedBeatmapObjectDataTime, offset 0x70, size 0x4
  ...
  /// @brief Field _specialBasicBeatmapEventKeywords, offset 0x60, size 0x8
  ...
  /// @brief Field beatmapEventDataWasInsertedEvent, offset 0x28, size 0x8
  ...
  /// @brief Field beatmapEventDataWasRemovedEvent, offset 0x38, size 0x8
  ...
  /// @brief Field beatmapEventDataWillBeRemovedEvent, offset 0x30, size 0x8
  ...
  __declspec(property(get = get_cuttableScoringObjectsCount, put = set_cuttableScoringObjectsCount)) int32_t cuttableScoringObjectsCount;
  ...
  /// @brief Method AddBeatmapObjectData, addr 0x3700fac, size 0x1dc, virtual false, abstract: false, final false
  inline void AddBeatmapObjectData(::GlobalNamespace::BeatmapObjectData* beatmapObjectData);

  /// @brief Method AddBeatmapObjectDataInOrder, addr 0x3702cb0, size 0x2c, virtual false, abstract: false, final false
  inline void AddBeatmapObjectDataInOrder(::GlobalNamespace::BeatmapObjectData* beatmapObjectData);

  /// @brief Method AddSpecialBasicBeatmapEventKeyword, addr 0x3702df4, size 0x70, virtual false, abstract: false, final false
  ...
  template <typename T> inline ::System::Collections::Generic::IEnumerable_1<T>* GetBeatmapDataItemsMerged(::ArrayW<int32_t> subtypeGroupIdentifiers);

  /// @brief Method GetBeatmapDataItemsMergedCount, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> inline int32_t GetBeatmapDataItemsMergedCount(::ArrayW<int32_t> subtypeGroupIdentifiers);

  /// @brief Method GetCopy, addr 0x370c57c, size 0x2f8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::BeatmapData* GetCopy();

  /// @brief Method GetFilteredCopy, addr 0x370c874, size 0x32c, virtual true, abstract: false, final true
  ...
  /// @brief Method InsertBeatmapEventData, addr 0x3700f00, size 0xac, virtual false, abstract: false, final false
  inline void InsertBeatmapEventData(::GlobalNamespace::BeatmapEventData* beatmapEventData);

  /// @brief Method InsertBeatmapEventDataInOrder, addr 0x3702c58, size 0x58, virtual false, abstract: false, final false
  inline void InsertBeatmapEventDataInOrder(::GlobalNamespace::BeatmapEventData* beatmapEventData);

  /// @brief Method InsertToAllBeatmapData, addr 0x370be74, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method IsBasicEventSpecialKeywordEnabled, addr 0x370be10, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessAndSortBeatmapData, addr 0x370c204, size 0x370, virtual false, abstract: false, final false
  inline void ProcessAndSortBeatmapData();

  /// @brief Method ProcessRemainingData, addr 0x370c1ec, size 0x18, virtual false, abstract: false, final false
  inline void ProcessRemainingData();

  /// @brief Method RemoveBeatmapEventData, addr 0x370c060, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3700d3c, size 0x1c4, virtual false, abstract: false, final false
  inline void _ctor(int32_t numberOfLines);

  /// @brief Method add_beatmapEventDataWasInsertedEvent, addr 0x370b990, size 0xc0, virtual true, abstract: false, final true
  inline void
  ...
  /// @brief Method add_beatmapEventDataWasRemovedEvent, addr 0x370bc90, size 0xc0, virtual true, abstract: false, final true
  inline void add_beatmapEventDataWasRemovedEvent(::System::Action_1<::GlobalNamespace::BeatmapEventData*>* value);

  /// @brief Method add_beatmapEventDataWillBeRemovedEvent, addr 0x370bb10, size 0xc0, virtual true, abstract: false, final true
  inline void
  ...
  /// @brief Method get_allBeatmapDataItems, addr 0x370b888, size 0xa8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::LinkedList_1<::GlobalNamespace::BeatmapDataItem*>* get_allBeatmapDataItems();

  /// @brief Method get_areValid, addr 0x370b930, size 0x10, virtual true, abstract: false, final true
  inline bool get_areValid();

  /// @brief Method get_bombsCount, addr 0x370b978, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_bombsCount();

  /// @brief Method get_cuttableNotesCount, addr 0x370b948, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_cuttableNotesCount();

  /// @brief Method get_cuttableScoringObjectsCount, addr 0x370b958, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_cuttableScoringObjectsCount();

  /// @brief Method get_numberOfLines, addr 0x370b940, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_numberOfLines();

  /// @brief Method get_obstaclesCount, addr 0x370b968, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_obstaclesCount();

  /// @brief Method get_specialBasicBeatmapEventKeywords, addr 0x370b988, size 0x8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerable_1<::StringW>* get_specialBasicBeatmapEventKeywords();

  /// @brief Method get_updateAllBeatmapDataOnInsert, addr 0x370b878, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_beatmapEventDataWasInsertedEvent, addr 0x370ba50, size 0xc0, virtual true, abstract: false, final true
  inline void
  ...
  /// @brief Method remove_beatmapEventDataWasRemovedEvent, addr 0x370bd50, size 0xc0, virtual true, abstract: false, final true
  inline void remove_beatmapEventDataWasRemovedEvent(::System::Action_1<::GlobalNamespace::BeatmapEventData*>* value);

  /// @brief Method remove_beatmapEventDataWillBeRemovedEvent, addr 0x370bbd0, size 0xc0, virtual true, abstract: false, final true
  inline void
  ...
  /// @brief Method set_bombsCount, addr 0x370b980, size 0x8, virtual false, abstract: false, final false
  inline void set_bombsCount(int32_t value);

  /// @brief Method set_cuttableNotesCount, addr 0x370b950, size 0x8, virtual false, abstract: false, final false
  inline void set_cuttableNotesCount(int32_t value);

  /// @brief Method set_cuttableScoringObjectsCount, addr 0x370b960, size 0x8, virtual false, abstract: false, final false
  inline void set_cuttableScoringObjectsCount(int32_t value);

  /// @brief Method set_obstaclesCount, addr 0x370b970, size 0x8, virtual false, abstract: false, final false
  inline void set_obstaclesCount(int32_t value);

  /// @brief Method set_updateAllBeatmapDataOnInsert, addr 0x370b880, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field beatmapEventDataWasInsertedEvent, offset: 0x28, size: 0x8, def value: None
  ...
  /// @brief Field beatmapEventDataWillBeRemovedEvent, offset: 0x30, size: 0x8, def value: None
  ...
  /// @brief Field beatmapEventDataWasRemovedEvent, offset: 0x38, size: 0x8, def value: None
  ::System::Action_1<::GlobalNamespace::BeatmapEventData*>* ___beatmapEventDataWasRemovedEvent;

  /// @brief Field _allBeatmapData, offset: 0x40, size: 0x8, def value: None
  ::GlobalNamespace::ISortedList_1<::GlobalNamespace::BeatmapDataItem*>* ____allBeatmapData;

  /// @brief Field _allBeatmapDataItemToNodeMap, offset: 0x48, size: 0x8, def value: None
  ...
  /// @brief Field _beatmapDataItemsPerTypeAndId, offset: 0x50, size: 0x8, def value: None
  ::GlobalNamespace::BeatmapDataSortedListForTypeAndIds_1<::GlobalNamespace::BeatmapDataItem*>* ____beatmapDataItemsPerTypeAndId;

  /// @brief Field _numberOfLines, offset: 0x58, size: 0x4, def value: None
  int32_t ____numberOfLines;

  /// @brief Field _specialBasicBeatmapEventKeywords, offset: 0x60, size: 0x8, def value: None
  ::System::Collections::Generic::HashSet_1<::StringW>* ____specialBasicBeatmapEventKeywords;

  /// @brief Field _beatmapObjectsInTimeRowProcessor, offset: 0x68, size: 0x8, def value: None
  ::GlobalNamespace::BeatmapObjectsInTimeRowProcessor* ____beatmapObjectsInTimeRowProcessor;

  /// @brief Field _prevAddedBeatmapObjectDataTime, offset: 0x70, size: 0x4, def value: None
  float_t ____prevAddedBeatmapObjectDataTime;

  /// @brief Field _isCreatingFilteredCopy, offset: 0x74, size: 0x1, def value: None
...
static_assert(offsetof(::GlobalNamespace::BeatmapData, ____cuttableScoringObjectsCount_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapData, ____obstaclesCount_k__BackingField) == 0x1c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapData, ____bombsCount_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapData, ___beatmapEventDataWasInsertedEvent) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapData, ___beatmapEventDataWillBeRemovedEvent) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapData, ___beatmapEventDataWasRemovedEvent) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapData, ____allBeatmapData) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapData, ____allBeatmapDataItemToNodeMap) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapData, ____beatmapDataItemsPerTypeAndId) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapData, ____numberOfLines) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapData, ____specialBasicBeatmapEventKeywords) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapData, ____beatmapObjectsInTimeRowProcessor) == 0x68, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapData, ____prevAddedBeatmapObjectDataTime) == 0x70, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapData, ____isCreatingFilteredCopy) == 0x74, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::BeatmapData) == 0x78, "Size mismatch!");
