...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapDifficultyMask, "", "BeatmapDifficultyMask");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::BeatmapDifficultyMask) == 0x1, "Size mismatch!");
