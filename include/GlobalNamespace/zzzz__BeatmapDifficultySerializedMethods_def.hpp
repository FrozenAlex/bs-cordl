...
public:
  // Declarations
  /// @brief Method BeatmapDifficultyFromSerializedName, addr 0x3255e74, size 0x164, virtual false, abstract: false, final false
  static inline bool BeatmapDifficultyFromSerializedName(::StringW name, ::by_ref<::GlobalNamespace::BeatmapDifficulty> difficulty);

  /// @brief Method SerializedName, addr 0x3255dac, size 0xc8, virtual false, abstract: false, final false
