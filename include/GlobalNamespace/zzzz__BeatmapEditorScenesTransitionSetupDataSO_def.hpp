...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapEditorScenesTransitionSetupDataSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapEditorScenesTransitionSetupDataSO*, "", "BeatmapEditorScenesTransitionSetupDataSO");
// Dependencies ScenesTransitionSetupDataSO
namespace GlobalNamespace {
// Is value type: false
// CS Name: BeatmapEditorScenesTransitionSetupDataSO
class CORDL_TYPE BeatmapEditorScenesTransitionSetupDataSO : public ::GlobalNamespace::ScenesTransitionSetupDataSO {
public:
  // Declarations
  /// @brief Field <goStraightToEditor>k__BackingField, offset 0x30, size 0x1
  ...
  /// @brief Method Finish, addr 0x57ee9c8, size 0x20, virtual false, abstract: false, final false
  inline void Finish();

  /// @brief Method Init, addr 0x57ee978, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57ee9e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x57ee7e8, size 0xc0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::BeatmapEditorScenesTransitionSetupDataSO>>* value);

  /// @brief Method get_goStraightToEditor, addr 0x57ee968, size 0x8, virtual false, abstract: false, final false
  inline bool get_goStraightToEditor();

  /// @brief Method remove_didFinishEvent, addr 0x57ee8a8, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::BeatmapEditorScenesTransitionSetupDataSO>>* value);

  /// @brief Method set_goStraightToEditor, addr 0x57ee970, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field <goStraightToEditor>k__BackingField, offset: 0x30, size: 0x1, def value: None
  bool ____goStraightToEditor_k__BackingField;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::BeatmapEditorScenesTransitionSetupDataSO, ___didFinishEvent) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapEditorScenesTransitionSetupDataSO, ____goStraightToEditor_k__BackingField) == 0x30, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::BeatmapEditorScenesTransitionSetupDataSO) == 0x38, "Size mismatch!");
