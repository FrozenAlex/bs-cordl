...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapEditorStartTestLevelData, "", "BeatmapEditorStartTestLevelData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapEditorStartTestLevelData_FpfcData, "", "BeatmapEditorStartTestLevelData/FpfcData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapEditorStartTestLevelData_OverdrawData, "", "BeatmapEditorStartTestLevelData/OverdrawData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapEditorStartTestLevelData_RecordingData, "", "BeatmapEditorStartTestLevelData/RecordingData");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::BeatmapEditorStartTestLevelData_FpfcData) == 0x8, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::BeatmapEditorStartTestLevelData_OverdrawData) == 0x18, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::BeatmapEditorStartTestLevelData_RecordingData) == 0x38, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::BeatmapEditorStartTestLevelData) == 0x58, "Size mismatch!");
