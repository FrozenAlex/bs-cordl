...
MARK_REF_T(::GlobalNamespace::BeatmapEventDataBox*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapEventDataBox_DistributionParamType, "", "BeatmapEventDataBox/DistributionParamType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapEventDataBox*, "", "BeatmapEventDataBox");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::BeatmapEventDataBox_DistributionParamType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method BeatDistributionParamToStep, addr 0x3655238, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method EventDistributionParamToStep, addr 0x36551cc, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBeatStep, addr 0x3655150, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBeatStep, addr 0x3655130, size 0x20, virtual false, abstract: false, final false
  inline float_t GetBeatStep(float_t lastBaseEventRelativeBeat);

  /// @brief Method GetDistribution, addr 0x36551a0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36550dc, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method get_indexFilter, addr 0x36550d4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapEventDataBox) == 0x38, "Size mismatch!");
