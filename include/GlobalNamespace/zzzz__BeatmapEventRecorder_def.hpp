...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapEventRecorder*);
MARK_VAL_T(::GlobalNamespace::BeatmapEventRecorder_EventCounts);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapEventRecorder*, "", "BeatmapEventRecorder");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapEventRecorder_EventCounts, "", "BeatmapEventRecorder/EventCounts");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::BeatmapEventRecorder_EventCounts) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method Begin, addr 0x58e986c, size 0x4, virtual false, abstract: false, final false
  inline void Begin(::GlobalNamespace::BeatmapCallbacksController* callbackController);

  /// @brief Method CaptureFrame, addr 0x58e992c, size 0xec, virtual false, abstract: false, final false
  inline void CaptureFrame();

  /// @brief Method ClearCallbacks, addr 0x58e9abc, size 0x30, virtual false, abstract: false, final false
  inline void ClearCallbacks();

  /// @brief Method Finish, addr 0x58e9a18, size 0xa4, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::BeatmapEventRecorder_EventCounts> Finish();

  /// @brief Method GenerateTableReport, addr 0x58e9aec, size 0x540, virtual false, abstract: false, final false
  static inline ::StringW GenerateTableReport(::ArrayW<::GlobalNamespace::BeatmapEventRecorder_EventCounts> samples);

  /// @brief Method HandleBeatmapEvent, addr 0x58ea02c, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupCallbacks, addr 0x58e9870, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58e97e8, size 0x84, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapEventRecorder) == 0x68, "Size mismatch!");
