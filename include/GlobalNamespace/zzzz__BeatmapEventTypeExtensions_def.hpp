...
public:
  // Declarations
  /// @brief Method IsCoreLightIntensityChangeEvent, addr 0x31c60a4, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapEventTypeExtensions) == 0x10, "Size mismatch!");
