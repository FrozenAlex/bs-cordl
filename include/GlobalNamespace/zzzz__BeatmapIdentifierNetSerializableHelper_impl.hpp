...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::GlobalNamespace::BeatmapKey (*)(::GlobalNamespace::BeatmapKeyNetSerializable*, ::GlobalNamespace::BeatmapCharacteristicCollection*)>(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{},
        (::i2c::find_method(::i2c::class_of<::GlobalNamespace::BeatmapIdentifierNetSerializableHelper*>(),
                            { "ToBeatmapKey", {}, { ::i2c::type_of<::GlobalNamespace::BeatmapKeyNetSerializable*>(), ::i2c::type_of<::GlobalNamespace::BeatmapCharacteristicCollection*>() } })));
...
inline ::GlobalNamespace::BeatmapKey GlobalNamespace::BeatmapIdentifierNetSerializableHelper::ToBeatmapKey(::GlobalNamespace::BeatmapKeyNetSerializable* beatmapKeySerializable,
  ...
  static auto* ___internal_method = THROW_UNLESS(
      ...
      (::i2c::find_method(::i2c::class_of<::GlobalNamespace::BeatmapIdentifierNetSerializableHelper*>(),
                          { "ToBeatmapKey", {}, { ::i2c::type_of<::GlobalNamespace::BeatmapKeyNetSerializable*>(), ::i2c::type_of<::GlobalNamespace::BeatmapCharacteristicCollection*>() } })));
  return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::BeatmapKey>(nullptr, ___internal_method, beatmapKeySerializable, beatmapCharacteristicCollection);
}
