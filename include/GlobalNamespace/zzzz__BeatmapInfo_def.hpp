...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapInfo*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapInfo*, "", "BeatmapInfo");
...
public:
  ...
  /// @brief Method .ctor, addr 0x32b5004, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_characteristic, addr 0x32b4fe4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_characteristic();

  /// @brief Method get_difficulties, addr 0x32b4ff4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDifficultyMask get_difficulties();

  /// @brief Method set_characteristic, addr 0x32b4fec, size 0x8, virtual false, abstract: false, final false
  inline void set_characteristic(::StringW value);

  /// @brief Method set_difficulties, addr 0x32b4ffc, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapInfo) == 0x20, "Size mismatch!");
