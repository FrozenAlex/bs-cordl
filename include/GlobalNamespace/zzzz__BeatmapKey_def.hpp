...
public:
  ...
  /// @brief Method Equals, addr 0x365f9d4, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x365f980, size 0x54, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::BeatmapKey other);

  /// @brief Method GetHashCode, addr 0x365fa60, size 0x7c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetIdentifier, addr 0x365f914, size 0x6c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapKeyNetSerializable* GetIdentifier();

  /// @brief Method IsValid, addr 0x365f84c, size 0x84, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method SerializedName, addr 0x365f8d0, size 0x44, virtual false, abstract: false, final false
  inline ::StringW SerializedName();

  /// @brief Method ToString, addr 0x365fb14, size 0xb8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x365f75c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x365f824, size 0x28, virtual false, abstract: false, final false
  static inline bool op_Equality(::GlobalNamespace::BeatmapKey a, ::GlobalNamespace::BeatmapKey b);

  /// @brief Method op_Inequality, addr 0x365fadc, size 0x38, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapKey) == 0x20, "Size mismatch!");
