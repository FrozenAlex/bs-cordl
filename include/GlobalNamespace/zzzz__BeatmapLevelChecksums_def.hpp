...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapLevelChecksums___c*);
MARK_REF_T(::GlobalNamespace::BeatmapLevelChecksums___c__DisplayClass7_0*);
MARK_REF_T(::GlobalNamespace::BeatmapLevelChecksums___c__DisplayClass8_0*);
...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapLevelChecksums___c*, "", "BeatmapLevelChecksums/<>c");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapLevelChecksums___c__DisplayClass7_0*, "", "BeatmapLevelChecksums/<>c__DisplayClass7_0");
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x3660a84, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3660cd8, size 0x24, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.ctor>b__6_0, addr 0x3660d54, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3660d50, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetOrAddDifficultyBeatmapChecksums>b__0, addr 0x3660d60, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3660a80, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <SetDifficultyBeatmapChecksums>b__0, addr 0x3660da4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3660cd4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BeatmapLevelChecksums___c__DisplayClass8_0) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetOrAddDifficultyBeatmapChecksums, addr 0x3660810, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDifficultyBeatmapChecksums, addr 0x3660a90, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36606b4, size 0x15c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapLevelChecksums) == 0x28, "Size mismatch!");
