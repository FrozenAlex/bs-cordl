...
public:
  ...
  /// @brief Method MoveNext, addr 0x365bfcc, size 0x2f0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x365c368, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CheckBeatmapLevelDataFromAssetBundleExistsAsync, addr 0x365bc34, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x365bd38, size 0x174, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method LoadBeatmapLevelDataFromAssetBundleAsync, addr 0x365b894, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method TryUnload, addr 0x365beac, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x365bf34, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_loadRequestCount, addr 0x365b83c, size 0x58, virtual false, abstract: false, final false
