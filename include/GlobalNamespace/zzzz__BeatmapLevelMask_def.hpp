...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapLevelMask*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapLevelMask*, "", "BeatmapLevelMask");
...
public:
  ...
  /// @brief Method AddLevel, addr 0x36b8874, size 0x64, virtual false, abstract: false, final false
  inline void AddLevel(::StringW state);

  /// @brief Method Contains, addr 0x36b8810, size 0x64, virtual false, abstract: false, final false
  inline bool Contains(::StringW state);

  /// @brief Method Deserialize, addr 0x36b8ac4, size 0x14, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Equals, addr 0x36b8c3c, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x36b8c1c, size 0x20, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::BeatmapLevelMask* other);

  /// @brief Method GetHashCode, addr 0x36b8c00, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method Serialize, addr 0x36b88d8, size 0x14, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method ToString, addr 0x36b8b74, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36b8530, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36b8624, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::StringW level);

  /// @brief Method .ctor, addr 0x36b86b8, size 0x158, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapLevelMask) == 0x18, "Size mismatch!");
