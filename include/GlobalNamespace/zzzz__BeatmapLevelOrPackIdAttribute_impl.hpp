  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{},
                     (::i2c::find_method(::i2c::class_of<::GlobalNamespace::BeatmapLevelOrPackIdAttribute*>(), { ".ctor", {}, { ::i2c::type_of<::GlobalNamespace::BeatmapLevelOrPackIdFilter>() } })));
    return ___internal_method;
  }
};
...
inline ::GlobalNamespace::BeatmapLevelOrPackIdAttribute* GlobalNamespace::BeatmapLevelOrPackIdAttribute::New_ctor(::GlobalNamespace::BeatmapLevelOrPackIdFilter filter) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::BeatmapLevelOrPackIdAttribute*>(filter));
}
// Ctor Parameters []
