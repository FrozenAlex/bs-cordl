...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::BeatmapLevelOrPackPromoInfoIdAttribute::*)(bool)>(&::GlobalNamespace::BeatmapLevelOrPackPromoInfoIdAttribute::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x368ea18;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::BeatmapLevelOrPackPromoInfoIdAttribute*>(), { ".ctor", {}, { ::i2c::type_of<bool>() } })));
...
inline ::GlobalNamespace::BeatmapLevelOrPackPromoInfoIdAttribute* GlobalNamespace::BeatmapLevelOrPackPromoInfoIdAttribute::New_ctor(bool allowEmpty) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::BeatmapLevelOrPackPromoInfoIdAttribute*>(allowEmpty));
}
// Ctor Parameters []
