...
public:
  ...
  /// @brief Method Deserialize, addr 0x320e410, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x320e1c8, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x320e25c, size 0x12c, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::BeatmapLevelSelectionMask other);

  /// @brief Method GetHashCode, addr 0x320e388, size 0x3c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Serialize, addr 0x320e3c4, size 0x4c, virtual false, abstract: false, final false
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer, uint32_t version);

  /// @brief Method .ctor, addr 0x320e1b0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x320e494, size 0x74, virtual false, abstract: false, final false
  static inline bool op_Equality(::GlobalNamespace::BeatmapLevelSelectionMask l, ::GlobalNamespace::BeatmapLevelSelectionMask r);

  /// @brief Method op_Inequality, addr 0x320e508, size 0x74, virtual false, abstract: false, final false
