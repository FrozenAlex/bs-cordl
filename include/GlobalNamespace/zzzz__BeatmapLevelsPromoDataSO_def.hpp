...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapLevelsPromoDataSO*);
MARK_REF_T(::GlobalNamespace::BeatmapLevelsPromoDataSO_BeatmapLevelsPromo*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapLevelsPromoDataSO*, "", "BeatmapLevelsPromoDataSO");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapLevelsPromoDataSO_BeatmapLevelsPromo*, "", "BeatmapLevelsPromoDataSO/BeatmapLevelsPromo");
...
public:
  ...
  /// @brief Method .ctor, addr 0x368ea5c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_promotedBeatmapLevelPacks, addr 0x368ea3c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::StringW>* get_promotedBeatmapLevelPacks();

  /// @brief Method get_promotedBeatmapLevels, addr 0x368ea4c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::StringW>* get_promotedBeatmapLevels();

  /// @brief Method get_updatedBeatmapLevelPacks, addr 0x368ea44, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::StringW>* get_updatedBeatmapLevelPacks();

  /// @brief Method get_updatedBeatmapLevels, addr 0x368ea54, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapLevelsPromoDataSO_BeatmapLevelsPromo) == 0x30, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x368ea34, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_promo, addr 0x368ea24, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevelsPromoDataSO_BeatmapLevelsPromo* get_promo();

  /// @brief Method set_promo, addr 0x368ea2c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapLevelsPromoDataSO) == 0x20, "Size mismatch!");
