...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapLevelsPromoModel*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapLevelsPromoModel*, "", "BeatmapLevelsPromoModel");
...
public:
  ...
  /// @brief Method IsBeatmapLevelPackPromoted, addr 0x368ec18, size 0x68, virtual false, abstract: false, final false
  inline bool IsBeatmapLevelPackPromoted(::GlobalNamespace::BeatmapLevelPack* beatmapLevelPack);

  /// @brief Method IsBeatmapLevelPackUpdated, addr 0x368ec80, size 0x68, virtual false, abstract: false, final false
  inline bool IsBeatmapLevelPackUpdated(::GlobalNamespace::BeatmapLevelPack* beatmapLevelPack);

  /// @brief Method IsBeatmapLevelPromoted, addr 0x368ece8, size 0x68, virtual false, abstract: false, final false
  inline bool IsBeatmapLevelPromoted(::GlobalNamespace::BeatmapLevel* beatmapLevel);

  /// @brief Method IsBeatmapLevelUpdated, addr 0x368ed50, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x368ea60, size 0x1b8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapLevelsPromoModel) == 0x30, "Size mismatch!");
