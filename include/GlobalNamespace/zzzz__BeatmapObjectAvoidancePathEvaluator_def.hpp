...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapObjectAvoidancePathEvaluator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapObjectAvoidancePathEvaluator*, "", "BeatmapObjectAvoidancePathEvaluator");
...
public:
  ...
  /// @brief Method GetCurrentPathPosition, addr 0x31e9e74, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31e9e5c, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapObjectAvoidancePathEvaluator) == 0x40, "Size mismatch!");
