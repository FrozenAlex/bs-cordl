...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator*);
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x327e9c8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData) == 0x8, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies BeatmapObjectAvoidanceYOffsetEvaluator::BufferData, System.Object
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method GetJumpOffsetYAtJumpStartSongTime, addr 0x327eb48, size 0x304, virtual false, abstract: false, final false
  inline float_t GetJumpOffsetYAtJumpStartSongTime(float_t lastDeltaTime);

  /// @brief Method ManualUpdate, addr 0x327e9d0, size 0x178, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData> const& __cordl_internal_get__yJumpOffsetBuffer() const;

  constexpr ::ArrayW<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData>& __cordl_internal_get__yJumpOffsetBuffer();
  ...
  /// @brief Method .ctor, addr 0x327e80c, size 0x1bc, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData> ____yJumpOffsetBuffer;
...
static_assert(sizeof(::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator) == 0x30, "Size mismatch!");
