...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData::*)(float_t, float_t)>(
  ...
  constexpr static std::size_t addrs = 0x31ea504;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::*)(
  ...
  constexpr static std::size_t addrs = 0x31ea348;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator*>(),
                                                             { ".ctor",
                                                               {},
                                                               { ::i2c::type_of<::GlobalNamespace::IAudioTimeSource*>(), ::i2c::type_of<::GlobalNamespace::IJumpOffsetYProvider*>(),
                                                                 ::i2c::type_of<::GlobalNamespace::IVariableMovementDataProvider*>(), ::i2c::type_of<float_t>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::*)()>(
  ...
  constexpr static std::size_t addrs = 0x31ea50c;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<float_t (::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::*)(float_t)>(
  ...
  constexpr static std::size_t addrs = 0x31ea684;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{},
                     (::i2c::find_method(::i2c::class_of<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator*>(), { "GetJumpOffsetYAtJumpStartSongTime", {}, { ::i2c::type_of<float_t>() } })));
    return ___internal_method;
  }
};
...
constexpr ::ArrayW<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData>& GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::__cordl_internal_get__yJumpOffsetBuffer() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____yJumpOffsetBuffer;
}
constexpr ::ArrayW<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData> const&
GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::__cordl_internal_get__yJumpOffsetBuffer() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____yJumpOffsetBuffer;
}
constexpr void GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::__cordl_internal_set__yJumpOffsetBuffer(::ArrayW<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____yJumpOffsetBuffer = value;
}
  ...
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator*>(),
                                                           { ".ctor",
                                                             ...
                                                             { ::i2c::type_of<::GlobalNamespace::IAudioTimeSource*>(), ::i2c::type_of<::GlobalNamespace::IJumpOffsetYProvider*>(),
                                                               ::i2c::type_of<::GlobalNamespace::IVariableMovementDataProvider*>(), ::i2c::type_of<float_t>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, audioTimeSource, jumpOffsetYProvider, variableMovementDataProvider, moveToPlayerHeadTParam);
}
...
inline float_t GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::GetJumpOffsetYAtJumpStartSongTime(float_t lastDeltaTime) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{},
                   (::i2c::find_method(::i2c::class_of<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator*>(), { "GetJumpOffsetYAtJumpStartSongTime", {}, { ::i2c::type_of<float_t>() } })));
  return ::cordl_internals::RunMethodRethrow<float_t>(this, ___internal_method, lastDeltaTime);
}
...
GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::New_ctor(::GlobalNamespace::IAudioTimeSource* audioTimeSource, ::GlobalNamespace::IJumpOffsetYProvider* jumpOffsetYProvider,
  ...
  return THROW_UNLESS(::i2c::no_logger{},
                      ::i2c::new_ctor<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator*>(audioTimeSource, jumpOffsetYProvider, variableMovementDataProvider, moveToPlayerHeadTParam));
}
// Ctor Parameters []
