...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapObjectData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapObjectData*, "", "BeatmapObjectData");
...
public:
  ...
  /// @brief Method Mirror, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
