...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapObjectExecutionRating*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapObjectExecutionRating*, "", "BeatmapObjectExecutionRating");
...
public:
  ...
  /// @brief Method .ctor, addr 0x36485a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(float_t time);

  /// @brief Method get_time, addr 0x36485a0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapObjectExecutionRating) == 0x18, "Size mismatch!");
