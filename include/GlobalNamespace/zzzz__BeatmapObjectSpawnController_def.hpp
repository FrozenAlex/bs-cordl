...
public:
  ...
  /// @brief Method .ctor, addr 0x5790174, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method HandleNoteDataCallback, addr 0x578fa28, size 0xf8, virtual false, abstract: false, final false
  inline void HandleNoteDataCallback(::GlobalNamespace::NoteData* noteData);

  /// @brief Method HandleObstacleDataCallback, addr 0x578fc14, size 0xf4, virtual false, abstract: false, final false
  inline void HandleObstacleDataCallback(::GlobalNamespace::ObstacleData* obstacleData);

  /// @brief Method HandleSliderDataCallback, addr 0x578fe98, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x578f9e0, size 0x48, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x578f1f0, size 0x7dc, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StopSpawning, addr 0x57900bc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57900c8, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didInitEvent, addr 0x578f098, size 0xac, virtual false, abstract: false, final false
  inline void add_didInitEvent(::System::Action* value);

  /// @brief Method get_beatmapObjectSpawnMovementData, addr 0x578f020, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapObjectSpawnMovementData* get_beatmapObjectSpawnMovementData();

  /// @brief Method get_isInitialized, addr 0x578f090, size 0x8, virtual false, abstract: false, final false
  inline bool get_isInitialized();

  /// @brief Method get_noteLinesCount, addr 0x578f028, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_noteLinesCount();

  /// @brief Method get_noteLinesDistance, addr 0x578f040, size 0x1c, virtual false, abstract: false, final false
  inline float_t get_noteLinesDistance();

  /// @brief Method get_verticalLayerDistance, addr 0x578f068, size 0x1c, virtual false, abstract: false, final false
  inline float_t get_verticalLayerDistance();

  /// @brief Method remove_didInitEvent, addr 0x578f144, size 0xac, virtual false, abstract: false, final false
