...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapObjectsInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapObjectsInstaller*, "", "BeatmapObjectsInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x58c37c4, size 0x440, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58c3c04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BeatmapObjectsInstaller) == 0x80, "Size mismatch!");
