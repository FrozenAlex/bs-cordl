...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapSelectionView*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapSelectionView*, "", "BeatmapSelectionView");
...
public:
  ...
  /// @brief Method SetBeatmap, addr 0x5967b78, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5967c1c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BeatmapSelectionView) == 0x30, "Size mismatch!");
