...
// Write type traits
MARK_REF_T(::GlobalNamespace::BezierSplineEvaluator*);
MARK_VAL_T(::GlobalNamespace::BezierSplineEvaluator_CubicSolveResult);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BezierSplineEvaluator*, "", "BezierSplineEvaluator");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BezierSplineEvaluator_CubicSolveResult, "", "BezierSplineEvaluator/CubicSolveResult");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x3284a0c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(float_t solution1);

  /// @brief Method .ctor, addr 0x3284a20, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(float_t solution1, float_t solution2);

  /// @brief Method .ctor, addr 0x3284a34, size 0x14, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BezierSplineEvaluator_CubicSolveResult) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method CubeRoot, addr 0x32849d8, size 0x34, virtual false, abstract: false, final false
  static inline float_t CubeRoot(float_t x);

  /// @brief Method Evaluate, addr 0x3283f4c, size 0x15c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 Evaluate(float_t t);

  /// @brief Method EvaluateFirstDerivation, addr 0x32840a8, size 0x16c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 EvaluateFirstDerivation(float_t t);

  /// @brief Method EvaluatePosition, addr 0x327e42c, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 EvaluatePosition(float_t time);

  /// @brief Method EvaluateSecondDerivation, addr 0x3284214, size 0x15c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 EvaluateSecondDerivation(float_t t);

  /// @brief Method GetTForSegment, addr 0x328449c, size 0x158, virtual false, abstract: false, final false
  inline float_t GetTForSegment(int32_t segmentIndex, float_t time);

  /// @brief Method GetTimeValuesForSegment, addr 0x3284914, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method OffsetSegmentAndGetT, addr 0x3283e30, size 0x11c, virtual false, abstract: false, final false
  inline float_t OffsetSegmentAndGetT(float_t time);

  /// @brief Method OffsetStartIndexToDistance, addr 0x3284370, size 0x12c, virtual false, abstract: false, final false
  inline void OffsetStartIndexToDistance(float_t time);

  /// @brief Method SolveCubic, addr 0x32845f4, size 0x320, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3280628, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BezierSplineEvaluator) == 0x20, "Size mismatch!");
