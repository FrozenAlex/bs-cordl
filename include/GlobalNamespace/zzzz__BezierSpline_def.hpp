...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x31f0bd4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <ComputeControlPoints>b__8_0, addr 0x31f0c8c, size 0x4, virtual false, abstract: false, final false
  inline float_t _ComputeControlPoints_b__8_0(::UnityEngine::Vector3 p);

  /// @brief Method <ComputeControlPoints>b__8_1, addr 0x31f0c90, size 0x8, virtual false, abstract: false, final false
  inline float_t _ComputeControlPoints_b__8_1(::UnityEngine::Vector3 p);

  /// @brief Method <ComputeControlPoints>b__8_2, addr 0x31f0c98, size 0x8, virtual false, abstract: false, final false
  inline float_t _ComputeControlPoints_b__8_2(::UnityEngine::Vector3 p);

  /// @brief Method <SortSourceData>b__6_0, addr 0x31f0c34, size 0x58, virtual false, abstract: false, final false
  inline int32_t _SortSourceData_b__6_0(::UnityEngine::Vector3 point1, ::UnityEngine::Vector3 point2);

  /// @brief Method .ctor, addr 0x31f0c30, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddArtificialStartAndFinishPoint, addr 0x31eba04, size 0x214, virtual false, abstract: false, final false
  inline void AddArtificialStartAndFinishPoint();

  /// @brief Method AddPoint, addr 0x31eb928, size 0xdc, virtual false, abstract: false, final false
  inline void AddPoint(float_t distance, ::UnityEngine::Vector2 point);

  /// @brief Method Clear, addr 0x31f0b54, size 0x80, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ComputeControlPoints, addr 0x31f0648, size 0x50c, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeControlPoints, addr 0x31ebc18, size 0x54c, virtual false, abstract: false, final false
  inline void ComputeControlPoints();

  static inline ::GlobalNamespace::BezierSpline* New_ctor();

  /// @brief Method SortSourceData, addr 0x31f053c, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31eb6b4, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_segments, addr 0x31f0534, size 0x8, virtual false, abstract: false, final false
