...
MARK_REF_T(::GlobalNamespace::BezierSpline___c*);
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x3283d64, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<float_t> p1, ::ArrayW<float_t> p2);
...
public:
  ...
  /// @brief Method <ComputeControlPoints>b__8_0, addr 0x3283e1c, size 0x4, virtual false, abstract: false, final false
  inline float_t _ComputeControlPoints_b__8_0(::UnityEngine::Vector3 p);

  /// @brief Method <ComputeControlPoints>b__8_1, addr 0x3283e20, size 0x8, virtual false, abstract: false, final false
  inline float_t _ComputeControlPoints_b__8_1(::UnityEngine::Vector3 p);

  /// @brief Method <ComputeControlPoints>b__8_2, addr 0x3283e28, size 0x8, virtual false, abstract: false, final false
  inline float_t _ComputeControlPoints_b__8_2(::UnityEngine::Vector3 p);

  /// @brief Method <SortSourceData>b__6_0, addr 0x3283dc4, size 0x58, virtual false, abstract: false, final false
  inline int32_t _SortSourceData_b__6_0(::UnityEngine::Vector3 point1, ::UnityEngine::Vector3 point2);

  /// @brief Method .ctor, addr 0x3283dc0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::BezierSpline___c) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method AddArtificialStartAndFinishPoint, addr 0x327fec8, size 0x214, virtual false, abstract: false, final false
  inline void AddArtificialStartAndFinishPoint();

  /// @brief Method AddPoint, addr 0x327fdec, size 0xdc, virtual false, abstract: false, final false
  inline void AddPoint(float_t distance, ::UnityEngine::Vector2 point);

  /// @brief Method Clear, addr 0x3283ce4, size 0x80, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ComputeControlPoints, addr 0x32837d8, size 0x50c, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeControlPoints, addr 0x32800dc, size 0x54c, virtual false, abstract: false, final false
  inline void ComputeControlPoints();

  static inline ::GlobalNamespace::BezierSpline* New_ctor();

  /// @brief Method SortSourceData, addr 0x32836cc, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x327fb78, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_segments, addr 0x32836c4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BezierSpline) == 0x20, "Size mismatch!");
