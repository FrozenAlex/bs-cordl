...
MARK_REF_T(::GlobalNamespace::Billboard*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::Billboard_RotationMode, "", "Billboard/RotationMode");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::Billboard*, "", "Billboard");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::Billboard_RotationMode) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::Billboard) == 0x30, "Size mismatch!");
