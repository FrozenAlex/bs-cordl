...
public:
  // Declarations
  /// @brief Method ReadColor, addr 0x331ee1c, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadPose, addr 0x331f0c8, size 0x54, virtual false, abstract: false, final false
  static inline ::UnityEngine::Pose ReadPose(::System::IO::BinaryReader* binaryReader);

  /// @brief Method ReadQuaternion, addr 0x331f004, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::Quaternion ReadQuaternion(::System::IO::BinaryReader* binaryReader);

  /// @brief Method ReadVector3, addr 0x331ef10, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 ReadVector3(::System::IO::BinaryReader* binaryReader);

  /// @brief Method Write, addr 0x331ed94, size 0x88, virtual false, abstract: false, final false
  static inline void Write(::System::IO::BinaryWriter* binaryWriter, ::UnityEngine::Color color);

  /// @brief Method Write, addr 0x331f094, size 0x34, virtual false, abstract: false, final false
  static inline void Write(::System::IO::BinaryWriter* binaryWriter, ::UnityEngine::Pose pose);

  /// @brief Method Write, addr 0x331ef7c, size 0x88, virtual false, abstract: false, final false
  static inline void Write(::System::IO::BinaryWriter* binaryWriter, ::UnityEngine::Quaternion quaternion);

  /// @brief Method Write, addr 0x331eeac, size 0x64, virtual false, abstract: false, final false
