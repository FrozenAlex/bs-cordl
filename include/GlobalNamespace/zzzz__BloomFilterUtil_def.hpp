...
MARK_GEN_REF_T_PTR(::GlobalNamespace::BloomFilterUtil___c__DisplayClass1_0_1);
MARK_GEN_REF_T_PTR(::GlobalNamespace::BloomFilterUtil___c__DisplayClass2_0_1);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomFilterUtil*, "", "BloomFilterUtil");
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::BloomFilterUtil) == 0x10, "Size mismatch!");
