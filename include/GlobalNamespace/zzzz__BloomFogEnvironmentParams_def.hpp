...
// Write type traits
MARK_REF_T(::GlobalNamespace::BloomFogEnvironmentParams*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomFogEnvironmentParams*, "", "BloomFogEnvironmentParams");
...
static_assert(sizeof(::GlobalNamespace::BloomFogEnvironmentParams) == 0x38, "Size mismatch!");
