...
MARK_REF_T(::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors*);
MARK_REF_T(::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors_Element*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors_EnvironmentColor, "", "BloomPrePassBackgroundColorsGradientFromColorSchemeColors/EnvironmentColor");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors*, "", "BloomPrePassBackgroundColorsGradientFromColorSchemeColors");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors_Element*, "", "BloomPrePassBackgroundColorsGradientFromColorSchemeColors/Element");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors_EnvironmentColor) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x57b8ac8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors_Element) == 0x30, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies BloomPrePassBackgroundColorsGradientFromColorSchemeColors::Element, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method HandleColorProviderDidChangeColor, addr 0x57b8fcc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x57b8e94, size 0x138, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetColorsToElements, addr 0x57b8bcc, size 0x2c8, virtual false, abstract: false, final false
  inline void SetColorsToElements();

  /// @brief Method Start, addr 0x57b8acc, size 0x100, virtual false, abstract: false, final false
  inline void Start();
  ...
  constexpr ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors_Element*> const& __cordl_internal_get__elements() const;

  constexpr ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors_Element*>& __cordl_internal_get__elements();
  ...
  /// @brief Method .ctor, addr 0x57b8820, size 0x2a8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors) == 0x38, "Size mismatch!");
