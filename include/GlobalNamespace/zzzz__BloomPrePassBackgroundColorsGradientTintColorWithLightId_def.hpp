...
// Write type traits
MARK_REF_T(::GlobalNamespace::BloomPrePassBackgroundColorsGradientTintColorWithLightId*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomPrePassBackgroundColorsGradientTintColorWithLightId*, "", "BloomPrePassBackgroundColorsGradientTintColorWithLightId");
...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x57282f4, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5728368, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BloomPrePassBackgroundColorsGradientTintColorWithLightId) == 0x60, "Size mismatch!");
