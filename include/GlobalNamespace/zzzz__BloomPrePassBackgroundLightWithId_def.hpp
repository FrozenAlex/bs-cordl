...
// Write type traits
MARK_REF_T(::GlobalNamespace::BloomPrePassBackgroundLightWithId*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomPrePassBackgroundLightWithId*, "", "BloomPrePassBackgroundLightWithId");
...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x586d2a0, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x586d2bc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x586d284, size 0x1c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BloomPrePassBackgroundLightWithId) == 0x40, "Size mismatch!");
