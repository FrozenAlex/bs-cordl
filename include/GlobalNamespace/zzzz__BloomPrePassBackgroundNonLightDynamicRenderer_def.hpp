...
// Write type traits
MARK_REF_T(::GlobalNamespace::BloomPrePassBackgroundNonLightDynamicRenderer*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomPrePassBackgroundNonLightDynamicRenderer*, "", "BloomPrePassBackgroundNonLightDynamicRenderer");
...
public:
  ...
  /// @brief Method OnEnable, addr 0x571db70, size 0x7c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method SetRenderer, addr 0x571dd18, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x571de70, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_renderer, addr 0x571db68, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BloomPrePassBackgroundNonLightDynamicRenderer) == 0x60, "Size mismatch!");
