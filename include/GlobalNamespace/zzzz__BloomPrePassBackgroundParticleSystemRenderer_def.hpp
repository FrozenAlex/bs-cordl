...
public:
  ...
  /// @brief Method Awake, addr 0x586265c, size 0x6c, virtual true, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x58626c8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_renderer, addr 0x5862654, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BloomPrePassBackgroundParticleSystemRenderer) == 0x60, "Size mismatch!");
