...
// Write type traits
MARK_REF_T(::GlobalNamespace::BloomPrePassBackgroundParticleSystemRenderer*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomPrePassBackgroundParticleSystemRenderer*, "", "BloomPrePassBackgroundParticleSystemRenderer");
...
public:
  // Declarations
  /// @brief Field _particleSystem, offset 0x58, size 0x8
  ...
  /// @brief Method Awake, addr 0x571f52c, size 0x6c, virtual true, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x571f598, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_renderer, addr 0x571f524, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Field _particleSystem, offset: 0x58, size: 0x8, def value: None
...
static_assert(offsetof(::GlobalNamespace::BloomPrePassBackgroundParticleSystemRenderer, ____particleSystem) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BloomPrePassBackgroundParticleSystemRenderer, ____renderer) == 0x60, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::BloomPrePassBackgroundParticleSystemRenderer) == 0x68, "Size mismatch!");
