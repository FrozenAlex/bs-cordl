...
// Write type traits
MARK_REF_T(::GlobalNamespace::BloomPrePassEffectSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomPrePassEffectSO*, "", "BloomPrePassEffectSO");
// Dependencies TextureEffectSO, UnityEngine.Vector2
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method .ctor, addr 0x571fcfc, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_fov, addr 0x571fce4, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector2 get_fov();

  /// @brief Method get_linesWidth, addr 0x571fcec, size 0x8, virtual true, abstract: false, final true
  inline float_t get_linesWidth();

  /// @brief Method get_textureEffect, addr 0x571fcd0, size 0x4, virtual true, abstract: false, final true
  inline ::UnityW<::GlobalNamespace::TextureEffectSO> get_textureEffect();

  /// @brief Method get_textureHeight, addr 0x571fcdc, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_textureHeight();

  /// @brief Method get_textureWidth, addr 0x571fcd4, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_textureWidth();

  /// @brief Method get_toneMapping, addr 0x571fcf4, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BloomPrePassEffectSO) == 0x30, "Size mismatch!");
