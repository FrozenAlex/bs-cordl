...
public:
  ...
  /// @brief Method .ctor, addr 0x5860490, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x58638e4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
