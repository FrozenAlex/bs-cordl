...
// Write type traits
MARK_REF_T(::GlobalNamespace::BlueNoiseDithering*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BlueNoiseDithering*, "", "BlueNoiseDithering");
...
public:
  ...
  __declspec(property(get = getStaticF__globalNoiseTextureID, put = setStaticF__globalNoiseTextureID)) int32_t _globalNoiseTextureID;

  /// @brief Field _noiseParamsID, offset 0xffffffff, size 0x4
  __declspec(property(get = getStaticF__noiseParamsID, put = setStaticF__noiseParamsID)) int32_t _noiseParamsID;
  ...
  /// @brief Method SetBlueNoiseShaderParams, addr 0x57240c8, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57241b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BlueNoiseDithering) == 0x20, "Size mismatch!");
