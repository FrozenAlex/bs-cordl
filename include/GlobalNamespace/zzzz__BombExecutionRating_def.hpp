...
MARK_REF_T(::GlobalNamespace::BombExecutionRating*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BombExecutionRating_Rating, "", "BombExecutionRating/Rating");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BombExecutionRating*, "", "BombExecutionRating");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::BombExecutionRating_Rating) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x36485b8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(float_t time, ::GlobalNamespace::BombExecutionRating_Rating rating);

  /// @brief Method get_rating, addr 0x36485b0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BombExecutionRating) == 0x18, "Size mismatch!");
