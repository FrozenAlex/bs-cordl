...
// Write type traits
MARK_REF_T(::GlobalNamespace::BoolSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BoolSO*, "", "BoolSO");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3323ea8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BoolSO) == 0x28, "Size mismatch!");
