...
// Write type traits
MARK_REF_T(::GlobalNamespace::BoxCuttableBySaber*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BoxCuttableBySaber*, "", "BoxCuttableBySaber");
...
static_assert(sizeof(::GlobalNamespace::BoxCuttableBySaber) == 0x38, "Size mismatch!");
