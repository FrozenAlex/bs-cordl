...
// Write type traits
MARK_REF_T(::GlobalNamespace::BrowsingMenusRichPresenceData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BrowsingMenusRichPresenceData*, "", "BrowsingMenusRichPresenceData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x57ddac0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_apiName, addr 0x57dda20, size 0x44, virtual true, abstract: false, final true
  inline ::StringW get_apiName();

  /// @brief Method get_localizedDescription, addr 0x57dda64, size 0x5c, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::BrowsingMenusRichPresenceData) == 0x18, "Size mismatch!");
