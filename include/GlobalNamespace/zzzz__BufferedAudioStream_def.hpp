...
// Write type traits
MARK_REF_T(::GlobalNamespace::BufferedAudioStream*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BufferedAudioStream*, "", "BufferedAudioStream");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_audioBuffer, put = __cordl_internal_set_audioBuffer)) ::ArrayW<float_t> audioBuffer;
  ...
  /// @brief Method AddData, addr 0x5daf304, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method Stop, addr 0x5daf09c, size 0x44, virtual false, abstract: false, final false
  inline void Stop();

  /// @brief Method Update, addr 0x5daf0e0, size 0x224, virtual false, abstract: false, final false
  inline void Update();
  ...
  constexpr ::ArrayW<float_t> const& __cordl_internal_get_audioBuffer() const;

  constexpr ::ArrayW<float_t>& __cordl_internal_get_audioBuffer();
  ...
  constexpr void __cordl_internal_set_audioBuffer(::ArrayW<float_t> value);
  ...
  /// @brief Method .ctor, addr 0x5daefdc, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BufferedAudioStream) == 0x30, "Size mismatch!");
