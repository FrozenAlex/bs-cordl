...
// Write type traits
MARK_REF_T(::GlobalNamespace::BufferedLightColorGroupEffect*);
MARK_REF_T(::GlobalNamespace::BufferedLightColorGroupEffect_InitData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BufferedLightColorGroupEffect*, "", "BufferedLightColorGroupEffect");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BufferedLightColorGroupEffect_InitData*, "", "BufferedLightColorGroupEffect/InitData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5858cd0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BufferedLightColorGroupEffect_InitData) == 0x20, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies BeatmapDataCallbackWrapper, System.Object, UnityEngine.Vector4
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__colorsBuffer, put = __cordl_internal_set__colorsBuffer)) ::ArrayW<::UnityEngine::Vector4> _colorsBuffer;
  ...
  __declspec(property(get = __cordl_internal_get__elementIdsBuffer, put = __cordl_internal_set__elementIdsBuffer)) ::ArrayW<float_t> _elementIdsBuffer;
  ...
  __declspec(property(get = __cordl_internal_get__timesBuffer, put = __cordl_internal_set__timesBuffer)) ::ArrayW<float_t> _timesBuffer;
  ...
  /// @brief Method Cleanup, addr 0x5858884, size 0x140, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method GetColor, addr 0x5858bc4, size 0x34, virtual true, abstract: false, final false
  inline ::UnityEngine::Color GetColor(::GlobalNamespace::EnvironmentColorType colorType, bool colorBoost, float_t brightness);

  /// @brief Method HandleBeatmapCallbacksControllerDidProcessAllCallbacksThisFrame, addr 0x5858ab8, size 0x10c, virtual false, abstract: false, final false
  inline void HandleBeatmapCallbacksControllerDidProcessAllCallbacksThisFrame();

  /// @brief Method HandleColorBoostBeatmapEvent, addr 0x58589c4, size 0x18, virtual false, abstract: false, final false
  inline void HandleColorBoostBeatmapEvent(::GlobalNamespace::ColorBoostBeatmapEventData* colorBoost);

  /// @brief Method HandleColorChangeBeatmapEvent, addr 0x58589dc, size 0xdc, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get__colorsBuffer() const;

  constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get__colorsBuffer();
  ...
  constexpr ::ArrayW<float_t> const& __cordl_internal_get__elementIdsBuffer() const;

  constexpr ::ArrayW<float_t>& __cordl_internal_get__elementIdsBuffer();

  constexpr int32_t const& __cordl_internal_get__lastIndex() const;

  constexpr int32_t& __cordl_internal_get__lastIndex();

  constexpr ::ArrayW<::GlobalNamespace::BeatmapDataCallbackWrapper*> const& __cordl_internal_get__lightColorBeatmapEventCallbackWrappers() const;

  constexpr ::ArrayW<::GlobalNamespace::BeatmapDataCallbackWrapper*>& __cordl_internal_get__lightColorBeatmapEventCallbackWrappers();
  ...
  constexpr ::ArrayW<float_t> const& __cordl_internal_get__timesBuffer() const;

  constexpr ::ArrayW<float_t>& __cordl_internal_get__timesBuffer();
  ...
  constexpr void __cordl_internal_set__colorsBuffer(::ArrayW<::UnityEngine::Vector4> value);

  constexpr void __cordl_internal_set__didReceiveEventThisFrame(bool value);

  constexpr void __cordl_internal_set__elementIdsBuffer(::ArrayW<float_t> value);

  constexpr void __cordl_internal_set__lastIndex(int32_t value);

  constexpr void __cordl_internal_set__lightColorBeatmapEventCallbackWrappers(::ArrayW<::GlobalNamespace::BeatmapDataCallbackWrapper*> value);

  constexpr void __cordl_internal_set__materialPropertyBlockController(::UnityW<::GlobalNamespace::MaterialPropertyBlockController> value);

  constexpr void __cordl_internal_set__timesBuffer(::ArrayW<float_t> value);

  constexpr void __cordl_internal_set__useBoostColors(bool value);

  /// @brief Method .ctor, addr 0x58584d8, size 0x3ac, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::GlobalNamespace::BeatmapDataCallbackWrapper*> ____lightColorBeatmapEventCallbackWrappers;
...
static_assert(sizeof(::GlobalNamespace::BufferedLightColorGroupEffect) == 0x60, "Size mismatch!");
