...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x57907fc, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x57908b0, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::by_ref<::GlobalNamespace::NoteSpawnData> noteSpawnData, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x57907e8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57906a0, size 0x148, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BezierCurve, addr 0x57901c0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessSliderData, addr 0x579024c, size 0x418, virtual false, abstract: false, final false
