...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CannotStartGameReason, "", "CannotStartGameReason");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::CannotStartGameReason) == 0x4, "Size mismatch!");
