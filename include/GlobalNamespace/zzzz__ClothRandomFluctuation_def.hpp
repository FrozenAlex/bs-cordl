...
public:
  ...
  /// @brief Method .ctor, addr 0x58aff7c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method FluctuateCloth, addr 0x58afca4, size 0x1c4, virtual false, abstract: false, final false
  inline void FluctuateCloth(::UnityEngine::Cloth* cloth);

  /// @brief Method GetNoise, addr 0x58afe68, size 0x110, virtual false, abstract: false, final false
  inline float_t GetNoise(float_t time, float_t offset);

  static inline ::GlobalNamespace::ClothRandomFluctuation* New_ctor();

  /// @brief Method Update, addr 0x58afc9c, size 0x8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x58aff78, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
