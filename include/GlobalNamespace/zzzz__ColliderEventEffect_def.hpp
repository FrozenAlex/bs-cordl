...
// Write type traits
MARK_REF_T(::GlobalNamespace::ColliderEventEffect*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ColliderEventEffect*, "", "ColliderEventEffect");
...
public:
  ...
  /// @brief Method SetValue, addr 0x5861f88, size 0x8, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method Start, addr 0x5861ef4, size 0x18, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TriggerValue, addr 0x5861f90, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5861f98, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_effectCollider, addr 0x5861ee4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Collider> get_effectCollider();

  /// @brief Method get_value, addr 0x5861eec, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ColliderEventEffect) == 0x38, "Size mismatch!");
