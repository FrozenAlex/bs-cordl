...
public:
  ...
  /// @brief Method Deserialize, addr 0x377e038, size 0x64, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Equals, addr 0x377e0ec, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x377e0a4, size 0x48, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::Color32Serializable other);

  /// @brief Method GetHashCode, addr 0x377e198, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Serialize, addr 0x377dfd8, size 0x60, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method ToString, addr 0x377e1a0, size 0x10, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x377dfd0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x377e0a0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x377e09c, size 0x4, virtual false, abstract: false, final false
