...
// Write type traits
MARK_REF_T(::GlobalNamespace::ColorArrayLightWithIdsGroupEntry*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ColorArrayLightWithIdsGroupEntry*, "", "ColorArrayLightWithIdsGroupEntry");
// Dependencies LightGroupSO, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method .ctor, addr 0x5728b00, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lightGroups, addr 0x5728af8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ColorArrayLightWithIdsGroupEntry) == 0x38, "Size mismatch!");
