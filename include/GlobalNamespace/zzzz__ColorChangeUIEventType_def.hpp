...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ColorChangeUIEventType, "", "ColorChangeUIEventType");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::ColorChangeUIEventType) == 0x4, "Size mismatch!");
