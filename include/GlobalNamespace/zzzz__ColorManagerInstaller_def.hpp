...
// Write type traits
MARK_REF_T(::GlobalNamespace::ColorManagerInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ColorManagerInstaller*, "", "ColorManagerInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x59f300c, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59f30f0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ColorManagerInstaller) == 0x30, "Size mismatch!");
