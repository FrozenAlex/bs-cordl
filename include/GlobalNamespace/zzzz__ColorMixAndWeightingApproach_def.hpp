...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ColorMixAndWeightingApproach, "", "ColorMixAndWeightingApproach");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::ColorMixAndWeightingApproach) == 0x4, "Size mismatch!");
