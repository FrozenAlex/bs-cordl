...
public:
  ...
  __declspec(property(get = __cordl_internal_get__arrowMeshRenderers, put = __cordl_internal_set__arrowMeshRenderers)) ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>> _arrowMeshRenderers;

  /// @brief Field _circleMeshRenderers, offset 0x40, size 0x8
  __declspec(property(get = __cordl_internal_get__circleMeshRenderers, put = __cordl_internal_set__circleMeshRenderers)) ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>> _circleMeshRenderers;
  ...
  /// @brief Method Awake, addr 0x58d17fc, size 0x1dc, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleNoteControllerDidInit, addr 0x58d1c08, size 0x178, virtual true, abstract: false, final true
  inline void HandleNoteControllerDidInit(::GlobalNamespace::NoteControllerBase* noteController);

  /// @brief Method HandleNoteControllerNoteDidPassJumpThreeQuarters, addr 0x58d1d80, size 0x20, virtual true, abstract: false, final true
  inline void HandleNoteControllerNoteDidPassJumpThreeQuarters(::GlobalNamespace::NoteControllerBase* noteController);

  /// @brief Method HandleNoteControllerNoteDidStartDissolving, addr 0x58d1da0, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method OnDestroy, addr 0x58d19d8, size 0x230, virtual false, abstract: false, final false
  inline void OnDestroy();

  constexpr ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>> const& __cordl_internal_get__arrowMeshRenderers() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>>& __cordl_internal_get__arrowMeshRenderers();

  constexpr ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>> const& __cordl_internal_get__circleMeshRenderers() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>>& __cordl_internal_get__circleMeshRenderers();
  ...
  constexpr void __cordl_internal_set__arrowMeshRenderers(::ArrayW<::UnityW<::UnityEngine::MeshRenderer>> value);

  constexpr void __cordl_internal_set__circleMeshRenderers(::ArrayW<::UnityW<::UnityEngine::MeshRenderer>> value);
  ...
  /// @brief Method .ctor, addr 0x58d1dc0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didInitEvent, addr 0x58d15b4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didInitEvent, addr 0x58d1674, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_showArrow, addr 0x58d1734, size 0x64, virtual false, abstract: false, final false
  inline void set_showArrow(bool value);

  /// @brief Method set_showCircle, addr 0x58d1798, size 0x64, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ColorNoteVisuals) == 0x68, "Size mismatch!");
