...
// Write type traits
MARK_REF_T(::GlobalNamespace::ColorSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ColorSO*, "", "ColorSO");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3638494, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method op_Implicit, addr 0x363921c, size 0x98, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ColorSO) == 0x18, "Size mismatch!");
