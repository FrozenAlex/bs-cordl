...
public:
  // Declarations
  /// @brief Method GetColorSchemeForGameplayOverride, addr 0x36f37c4, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetColorSchemeForLightshowOverride, addr 0x36f38a0, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveColorScheme, addr 0x36f32a4, size 0x520, virtual false, abstract: false, final false
