...
// Write type traits
MARK_REF_T(::GlobalNamespace::ColorSchemeSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ColorSchemeSO*, "", "ColorSchemeSO");
...
public:
  ...
  /// @brief Method LogColorScheme, addr 0x3638f50, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3639214, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_colorScheme, addr 0x3638f40, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorScheme* get_colorScheme();

  /// @brief Method get_order, addr 0x3638f48, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ColorSchemeSO) == 0x28, "Size mismatch!");
