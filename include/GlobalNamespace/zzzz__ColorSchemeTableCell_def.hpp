...
public:
  ...
  /// @brief Method SetColors, addr 0x591cfc0, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x591d1f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_text, addr 0x591cf84, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method set_showEditIcon, addr 0x591cfa4, size 0x1c, virtual false, abstract: false, final false
  inline void set_showEditIcon(bool value);

  /// @brief Method set_text, addr 0x591cf64, size 0x20, virtual false, abstract: false, final false
