...
// Write type traits
MARK_REF_T(::GlobalNamespace::CombineGroupIdToVector4FloatFxGroupEffectTarget*);
MARK_REF_T(::GlobalNamespace::CombineGroupIdToVector4FloatFxGroupEffectTarget___c*);
MARK_VAL_T(::GlobalNamespace::CombineGroupIdToVector4FloatFxGroupEffectTarget_LightGroupSOToIndex);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CombineGroupIdToVector4FloatFxGroupEffectTarget*, "", "CombineGroupIdToVector4FloatFxGroupEffectTarget");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CombineGroupIdToVector4FloatFxGroupEffectTarget___c*, "", "CombineGroupIdToVector4FloatFxGroupEffectTarget/<>c");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CombineGroupIdToVector4FloatFxGroupEffectTarget_LightGroupSOToIndex, "", "CombineGroupIdToVector4FloatFxGroupEffectTarget/LightGroupSOToIndex");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::CombineGroupIdToVector4FloatFxGroupEffectTarget_LightGroupSOToIndex) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method <Awake>b__10_0, addr 0x5854948, size 0x14, virtual false, abstract: false, final false
  inline int32_t _Awake_b__10_0(::GlobalNamespace::CombineGroupIdToVector4FloatFxGroupEffectTarget_LightGroupSOToIndex item);

  /// @brief Method <Awake>b__10_1, addr 0x585495c, size 0x8, virtual false, abstract: false, final false
  inline int32_t _Awake_b__10_1(::GlobalNamespace::CombineGroupIdToVector4FloatFxGroupEffectTarget_LightGroupSOToIndex item);

  /// @brief Method .ctor, addr 0x5854944, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::CombineGroupIdToVector4FloatFxGroupEffectTarget___c) == 0x10, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies CombineGroupIdToVector4FloatFxGroupEffectTarget::LightGroupSOToIndex, FloatFxGroupEffectTarget, UnityEngine.Vector4
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method Awake, addr 0x585434c, size 0x1ac, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleBeatmapCallbacksControllerDidProcessAllCallbacksThisFrame, addr 0x5854894, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5854588, size 0xcc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetValue, addr 0x5854654, size 0x120, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method Start, addr 0x58544f8, size 0x90, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TriggerValue, addr 0x5854774, size 0x120, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::CombineGroupIdToVector4FloatFxGroupEffectTarget_LightGroupSOToIndex> const& __cordl_internal_get__lightGroupsToIndices() const;

  constexpr ::ArrayW<::GlobalNamespace::CombineGroupIdToVector4FloatFxGroupEffectTarget_LightGroupSOToIndex>& __cordl_internal_get__lightGroupsToIndices();
  ...
  constexpr void __cordl_internal_set__lightGroupsToIndices(::ArrayW<::GlobalNamespace::CombineGroupIdToVector4FloatFxGroupEffectTarget_LightGroupSOToIndex> value);
  ...
  /// @brief Method .ctor, addr 0x58548ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::GlobalNamespace::CombineGroupIdToVector4FloatFxGroupEffectTarget_LightGroupSOToIndex> ____lightGroupsToIndices;
...
static_assert(sizeof(::GlobalNamespace::CombineGroupIdToVector4FloatFxGroupEffectTarget) == 0x78, "Size mismatch!");
