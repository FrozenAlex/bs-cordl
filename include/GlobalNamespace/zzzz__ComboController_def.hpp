...
public:
  ...
  /// @brief Method HandleNoteWasCut, addr 0x59eb168, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleNoteWasMissed, addr 0x59eb218, size 0x84, virtual false, abstract: false, final false
  inline void HandleNoteWasMissed(::GlobalNamespace::NoteController* noteController);

  /// @brief Method HandlePlayerHeadDidEnterObstacles, addr 0x59eb110, size 0x58, virtual false, abstract: false, final false
  inline void HandlePlayerHeadDidEnterObstacles();

  static inline ::GlobalNamespace::ComboController* New_ctor();

  /// @brief Method OnDestroy, addr 0x59eaf3c, size 0x1d4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x59eade8, size 0x154, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x59eb29c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_comboBreakingEventHappenedEvent, addr 0x59eac90, size 0xac, virtual true, abstract: false, final true
  inline void add_comboBreakingEventHappenedEvent(::System::Action* value);

  /// @brief Method add_comboDidChangeEvent, addr 0x59eab10, size 0xc0, virtual true, abstract: false, final true
  inline void add_comboDidChangeEvent(::System::Action_1<int32_t>* value);

  /// @brief Method get_maxCombo, addr 0x59eab08, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_comboBreakingEventHappenedEvent, addr 0x59ead3c, size 0xac, virtual true, abstract: false, final true
  inline void remove_comboBreakingEventHappenedEvent(::System::Action* value);

  /// @brief Method remove_comboDidChangeEvent, addr 0x59eabd0, size 0xc0, virtual true, abstract: false, final true
