...
public:
  ...
  /// @brief Method OnDisable, addr 0x5f3d534, size 0x448, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5f3d12c, size 0x408, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnWillRenderObject, addr 0x5f3da3c, size 0x1d4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f3cccc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
