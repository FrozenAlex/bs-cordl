...
public:
  // Declarations
  /// @brief Method Get, addr 0x32a4eac, size 0x44, virtual false, abstract: false, final false
  static inline ::StringW Get();

  /// @brief Method Length, addr 0x32a4ef0, size 0x8, virtual false, abstract: false, final false
  static inline int32_t Length();

  static inline ::GlobalNamespace::CompatibilityVersion* New_ctor();

  /// @brief Method .ctor, addr 0x32a4ef8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
