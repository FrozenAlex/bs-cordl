...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::CompletableViewController_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::CompletableViewController_1, "", "CompletableViewController`1");
