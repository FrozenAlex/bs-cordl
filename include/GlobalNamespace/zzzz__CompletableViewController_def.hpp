...
// Write type traits
MARK_REF_T(::GlobalNamespace::CompletableViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CompletableViewController*, "", "CompletableViewController");
...
static_assert(sizeof(::GlobalNamespace::CompletableViewController) == 0x80, "Size mismatch!");
