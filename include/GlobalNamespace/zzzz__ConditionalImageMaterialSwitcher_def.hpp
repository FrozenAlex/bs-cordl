...
public:
  ...
  /// @brief Method Awake, addr 0x58fda24, size 0x84, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x58fdaa8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
