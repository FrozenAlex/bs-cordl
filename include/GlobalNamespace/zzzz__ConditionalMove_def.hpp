...
// Write type traits
MARK_REF_T(::GlobalNamespace::ConditionalMove*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ConditionalMove*, "", "ConditionalMove");
...
public:
  ...
  /// @brief Method Awake, addr 0x58fdb28, size 0xb8, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x58fdbe0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ConditionalMove) == 0x40, "Size mismatch!");
