...
public:
  // Declarations
  using _InitializePlayerEncryption_d__119 = ::GlobalNamespace::ConnectedPlayerManager_3__InitializePlayerEncryption_d__119<TConnectedPlayer, TConnectedPlayerImpl, TGameSpecificIdentityData>;

  /// @brief Field _connectedPlayerFactory, offset 0x90, size 0x8
  __declspec(property(
  ...
  /// @brief Field _encryptionKeys, offset 0xc8, size 0x8
  ...
  /// @brief Field _encryptionRandom, offset 0xd0, size 0x8
  __declspec(property(get = __cordl_internal_get__encryptionRandom, put = __cordl_internal_set__encryptionRandom)) ::ArrayW<uint8_t> _encryptionRandom;

  /// @brief Field _lastConnectionId, offset 0xe0, size 0x1
  ...
  /// @brief Field _localPlayerState, offset 0xc0, size 0x8
  ...
  /// @brief Field _messageSerializer, offset 0x100, size 0x8
  __declspec(property(
  ...
  /// @brief Field _players, offset 0xb8, size 0x8
  ...
  /// @brief Field _reliableDataWriter, offset 0xa8, size 0x8
  ...
  /// @brief Field _temporaryDataWriter, offset 0x98, size 0x8
  ...
  /// @brief Field _temporaryEncryptedDataWriter, offset 0xa0, size 0x8
  ...
  /// @brief Field _unreliableDataWriter, offset 0xb0, size 0x8
  ...
  /// @brief Field packetReceivedEvent, offset 0x60, size 0x8
  __declspec(property(get = __cordl_internal_get_packetReceivedEvent, put = __cordl_internal_set_packetReceivedEvent)) ::System::Action_2<::StringW, ::StringW>* packetReceivedEvent;
  ...
  constexpr operator ::GlobalNamespace::INetworkPacketProcessedHandler_1<TConnectedPlayer>*() noexcept;
  ...
  /// @brief Method HandlePacketProcessed, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final true
  inline void HandlePacketProcessed(::StringW packetTypeName, TConnectedPlayer player);
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get__encryptionRandom() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get__encryptionRandom();
  ...
  constexpr ::System::Action_2<::StringW, ::StringW>* const& __cordl_internal_get_packetReceivedEvent() const;

  constexpr ::System::Action_2<::StringW, ::StringW>*& __cordl_internal_get_packetReceivedEvent();
  ...
  constexpr void __cordl_internal_set__encryptionRandom(::ArrayW<uint8_t> value);
  ...
  constexpr void __cordl_internal_set_packetReceivedEvent(::System::Action_2<::StringW, ::StringW>* value);
  ...
  constexpr ::GlobalNamespace::INetworkPacketProcessedHandler_1<TConnectedPlayer>* i___GlobalNamespace__INetworkPacketProcessedHandler_1_TConnectedPlayer_() noexcept;
...
public:
  ...
  /// @brief Field _connectedPlayerFactory, offset: 0x90, size: 0x8, def value: None
  ...
  /// @brief Field _temporaryDataWriter, offset: 0x98, size: 0x8, def value: None
  ::LiteNetLib::Utils::NetDataWriter* ____temporaryDataWriter;

  /// @brief Field _temporaryEncryptedDataWriter, offset: 0xa0, size: 0x8, def value: None
  ::LiteNetLib::Utils::NetDataWriter* ____temporaryEncryptedDataWriter;

  /// @brief Field _reliableDataWriter, offset: 0xa8, size: 0x8, def value: None
  ::LiteNetLib::Utils::NetDataWriter* ____reliableDataWriter;

  /// @brief Field _unreliableDataWriter, offset: 0xb0, size: 0x8, def value: None
  ::LiteNetLib::Utils::NetDataWriter* ____unreliableDataWriter;

  /// @brief Field _players, offset: 0xb8, size: 0x8, def value: None
  ::System::Collections::Generic::List_1<TConnectedPlayerImpl>* ____players;

  /// @brief Field _localPlayerState, offset: 0xc0, size: 0x8, def value: None
  ::System::Collections::Generic::HashSet_1<::StringW>* ____localPlayerState;

  /// @brief Field _encryptionKeys, offset: 0xc8, size: 0x8, def value: None
  ::GlobalNamespace::IDiffieHellmanKeyPair* ____encryptionKeys;

  /// @brief Field _encryptionRandom, offset: 0xd0, size: 0x8, def value: None
  ::ArrayW<uint8_t> ____encryptionRandom;

  /// @brief Field _localPlayer, offset: 0xd8, size: 0x8, def value: None
  TConnectedPlayerImpl ____localPlayer;

  /// @brief Field _lastConnectionId, offset: 0xe0, size: 0x1, def value: None
  uint8_t ____lastConnectionId;

  /// @brief Field _lastPollTime, offset: 0xe8, size: 0x8, def value: None
  int64_t ____lastPollTime;

  /// @brief Field _lastPollFrame, offset: 0xf0, size: 0x4, def value: None
  int32_t ____lastPollFrame;

  /// @brief Field _lastPingTime, offset: 0xf8, size: 0x8, def value: None
  int64_t ____lastPingTime;

  /// @brief Field _messageSerializer, offset: 0x100, size: 0x8, def value: None
