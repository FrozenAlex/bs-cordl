...
MARK_REF_T(::GlobalNamespace::ConnectedPlayerManager*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ConnectedPlayerManager_InternalMessageType, "", "ConnectedPlayerManager/InternalMessageType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ConnectedPlayerManager_MessageType, "", "ConnectedPlayerManager/MessageType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ConnectedPlayerManager*, "", "ConnectedPlayerManager");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::ConnectedPlayerManager_InternalMessageType) == 0x1, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::ConnectedPlayerManager_MessageType) == 0x1, "Size mismatch!");
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::ConnectedPlayerManager) == 0x10, "Size mismatch!");
