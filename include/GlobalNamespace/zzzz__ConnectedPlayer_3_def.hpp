...
public:
  ...
  __declspec(property(get = __cordl_internal_get__publicEncryptionKey, put = __cordl_internal_set__publicEncryptionKey)) ::ArrayW<uint8_t> _publicEncryptionKey;

  /// @brief Field _random, offset 0x78, size 0x8
  __declspec(property(get = __cordl_internal_get__random, put = __cordl_internal_set__random)) ::ArrayW<uint8_t> _random;
  ...
  __declspec(property(get = get_publicEncryptionKey)) ::ArrayW<uint8_t> publicEncryptionKey;

  __declspec(property(get = get_random)) ::ArrayW<uint8_t> random;
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get__publicEncryptionKey() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get__publicEncryptionKey();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get__random() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get__random();
  ...
  constexpr void __cordl_internal_set__publicEncryptionKey(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set__random(::ArrayW<uint8_t> value);
...
public:
  ...
  ::ArrayW<uint8_t> ____publicEncryptionKey;

  /// @brief Field _random, offset: 0x78, size: 0x8, def value: None
  ::ArrayW<uint8_t> ____random;
