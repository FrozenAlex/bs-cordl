...
MARK_REF_T(::GlobalNamespace::ConnectionErrorDialogViewController___c__DisplayClass0_0*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ConnectionErrorDialogViewController*, "", "ConnectionErrorDialogViewController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ConnectionErrorDialogViewController___c__DisplayClass0_0*, "", "ConnectionErrorDialogViewController/<>c__DisplayClass0_0");
...
static_assert(sizeof(::GlobalNamespace::ConnectionErrorDialogViewController___c__DisplayClass0_0) == 0x18, "Size mismatch!");
