...
public:
  ...
  /// @brief Method EndEffect, addr 0x58bfb10, size 0x24, virtual false, abstract: false, final false
  inline void EndEffect();

  /// @brief Method HandleColorChangeBeatmapEvent, addr 0x58bf9c0, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method SetInitialValues, addr 0x58bf73c, size 0xa8, virtual false, abstract: false, final false
  inline void SetInitialValues();

  /// @brief Method Start, addr 0x58bf714, size 0x28, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method StartEffect, addr 0x58bfb34, size 0xe0, virtual false, abstract: false, final false
  inline void StartEffect(float_t startTime, float_t endTime);

  /// @brief Method Update, addr 0x58bf7e4, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateEffect, addr 0x58bf7e8, size 0x1d8, virtual false, abstract: false, final false
  inline void UpdateEffect();

  /// @brief Method UpdateRenderers, addr 0x58bfc14, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58bfdfc, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
