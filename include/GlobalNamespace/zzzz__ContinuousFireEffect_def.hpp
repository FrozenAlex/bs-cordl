...
// Write type traits
MARK_REF_T(::GlobalNamespace::ContinuousFireEffect*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ContinuousFireEffect*, "", "ContinuousFireEffect");
...
public:
  ...
  /// @brief Method EndEffect, addr 0x5784bb0, size 0x24, virtual false, abstract: false, final false
  inline void EndEffect();

  /// @brief Method HandleColorChangeBeatmapEvent, addr 0x5784a60, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method SetInitialValues, addr 0x57847dc, size 0xa8, virtual false, abstract: false, final false
  inline void SetInitialValues();

  /// @brief Method Start, addr 0x57847b4, size 0x28, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method StartEffect, addr 0x5784bd4, size 0xe0, virtual false, abstract: false, final false
  inline void StartEffect(float_t startTime, float_t endTime);

  /// @brief Method Update, addr 0x5784884, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateEffect, addr 0x5784888, size 0x1d8, virtual false, abstract: false, final false
  inline void UpdateEffect();

  /// @brief Method UpdateRenderers, addr 0x5784cb4, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5784e9c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ContinuousFireEffect) == 0xd8, "Size mismatch!");
