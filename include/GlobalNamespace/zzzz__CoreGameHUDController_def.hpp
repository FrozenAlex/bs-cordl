...
// Write type traits
MARK_REF_T(::GlobalNamespace::CoreGameHUDController*);
MARK_REF_T(::GlobalNamespace::CoreGameHUDController_InitData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CoreGameHUDController*, "", "CoreGameHUDController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CoreGameHUDController_InitData*, "", "CoreGameHUDController/InitData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x586feac, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Initialize, addr 0x586fe18, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x586fea8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_energyPanelGo, addr 0x586fdf8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_energyPanelGo();

  /// @brief Method get_immediateRankGo, addr 0x586fdf0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_immediateRankGo();

  /// @brief Method get_relativeScoreGo, addr 0x586fde8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_relativeScoreGo();

  /// @brief Method get_songProgressPanelGO, addr 0x586fde0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_songProgressPanelGO();

  /// @brief Method set_alpha, addr 0x586fe00, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::CoreGameHUDController) == 0x48, "Size mismatch!");
