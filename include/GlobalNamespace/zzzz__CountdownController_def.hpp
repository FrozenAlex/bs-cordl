...
// Write type traits
MARK_REF_T(::GlobalNamespace::CountdownController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CountdownController*, "", "CountdownController");
// Dependencies CountdownElementController, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method Awake, addr 0x5a0796c, size 0x18, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::CountdownController* New_ctor();

  /// @brief Method StartCountdown, addr 0x5a07bcc, size 0xf0, virtual false, abstract: false, final false
  inline void StartCountdown(int64_t countdownEndTime);

  /// @brief Method StopCountdown, addr 0x5a07d44, size 0x74, virtual false, abstract: false, final false
  inline void StopCountdown();

  /// @brief Method Update, addr 0x5a07984, size 0x1e8, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateCountdown, addr 0x5a07ce0, size 0x64, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityW<::GlobalNamespace::CountdownElementController>> const& __cordl_internal_get__countdownElementControllers() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::CountdownElementController>>& __cordl_internal_get__countdownElementControllers();
  ...
  constexpr void __cordl_internal_set__countdownElementControllers(::ArrayW<::UnityW<::GlobalNamespace::CountdownElementController>> value);
  ...
  /// @brief Method .ctor, addr 0x5a07db8, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::CountdownController) == 0x50, "Size mismatch!");
