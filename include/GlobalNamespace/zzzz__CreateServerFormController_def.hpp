...
// Write type traits
MARK_REF_T(::GlobalNamespace::CreateServerFormController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CreateServerFormController*, "", "CreateServerFormController");
...
public:
  ...
  /// @brief Method Setup, addr 0x5815cf4, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5815d58, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_formData, addr 0x5815c20, size 0xd4, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::CreateServerFormController) == 0x30, "Size mismatch!");
