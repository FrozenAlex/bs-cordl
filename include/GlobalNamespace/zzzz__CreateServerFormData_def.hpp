...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CreateServerFormData, "", "CreateServerFormData");
...
static_assert(sizeof(::GlobalNamespace::CreateServerFormData) == 0x50, "Size mismatch!");
