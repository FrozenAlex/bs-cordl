...
// Write type traits
MARK_REF_T(::GlobalNamespace::CreateServerViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CreateServerViewController*, "", "CreateServerViewController");
...
public:
  ...
  /// @brief Method ApplyAndGetData, addr 0x582f19c, size 0xcc, virtual false, abstract: false, final false
  inline ::GlobalNamespace::CreateServerFormData ApplyAndGetData();

  /// @brief Method DidActivate, addr 0x582f05c, size 0x140, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::CreateServerViewController* New_ctor();

  /// @brief Method Setup, addr 0x582f018, size 0x44, virtual false, abstract: false, final false
  inline void Setup(::GlobalNamespace::MultiplayerModeSettings* multiplayerModeSettings);

  /// @brief Method <DidActivate>b__10_0, addr 0x582f26c, size 0x3c, virtual false, abstract: false, final false
  inline void _DidActivate_b__10_0();

  /// @brief Method <DidActivate>b__10_1, addr 0x582f2a8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x582f268, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x582ee90, size 0xc0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_2<bool, ::GlobalNamespace::CreateServerFormData>* value);

  /// @brief Method get_multiplayerModeSettings, addr 0x582f010, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MultiplayerModeSettings* get_multiplayerModeSettings();

  /// @brief Method remove_didFinishEvent, addr 0x582ef50, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::CreateServerViewController) == 0xa0, "Size mismatch!");
