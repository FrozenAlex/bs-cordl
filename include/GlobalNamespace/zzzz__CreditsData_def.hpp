...
MARK_REF_T(::GlobalNamespace::CreditsData*);
MARK_REF_T(::GlobalNamespace::CreditsData_ChildCreditsItem*);
MARK_REF_T(::GlobalNamespace::CreditsData_RootCreditsItem*);
MARK_REF_T(::GlobalNamespace::CreditsData_Text*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CreditsData_TextStyle, "", "CreditsData/TextStyle");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CreditsData*, "", "CreditsData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CreditsData_ChildCreditsItem*, "", "CreditsData/ChildCreditsItem");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CreditsData_RootCreditsItem*, "", "CreditsData/RootCreditsItem");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CreditsData_Text*, "", "CreditsData/Text");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::CreditsData_TextStyle) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method IsEmpty, addr 0x327cdf0, size 0x20, virtual false, abstract: false, final false
  inline bool IsEmpty();

  static inline ::GlobalNamespace::CreditsData_Text* New_ctor();

  /// @brief Method ToString, addr 0x327ce10, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x327cee4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::CreditsData_Text) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method HasText, addr 0x327cf3c, size 0x10, virtual false, abstract: false, final false
  inline bool HasText();

  /// @brief Method HasTitle, addr 0x327cf2c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x327cf4c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::CreditsData_ChildCreditsItem) == 0x20, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies CreditsData::ChildCreditsItem, System.Object
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_creditsItems, put = __cordl_internal_set_creditsItems)) ::ArrayW<::GlobalNamespace::CreditsData_ChildCreditsItem*> creditsItems;
  ...
  /// @brief Method HasRowItems, addr 0x327cf08, size 0x20, virtual false, abstract: false, final false
  inline bool HasRowItems();

  /// @brief Method HasText, addr 0x327cef8, size 0x10, virtual false, abstract: false, final false
  inline bool HasText();

  /// @brief Method HasTitle, addr 0x327cee8, size 0x10, virtual false, abstract: false, final false
  inline bool HasTitle();

  static inline ::GlobalNamespace::CreditsData_RootCreditsItem* New_ctor();

  constexpr ::ArrayW<::GlobalNamespace::CreditsData_ChildCreditsItem*> const& __cordl_internal_get_creditsItems() const;

  constexpr ::ArrayW<::GlobalNamespace::CreditsData_ChildCreditsItem*>& __cordl_internal_get_creditsItems();
  ...
  constexpr void __cordl_internal_set_creditsItems(::ArrayW<::GlobalNamespace::CreditsData_ChildCreditsItem*> value);
  ...
  /// @brief Method .ctor, addr 0x327cf28, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::GlobalNamespace::CreditsData_ChildCreditsItem*> ___creditsItems;
...
static_assert(sizeof(::GlobalNamespace::CreditsData_RootCreditsItem) == 0x30, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies CreditsData::RootCreditsItem, System.Object
namespace GlobalNamespace {
// Is value type: false
// CS Name: CreditsData
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_creditsItems, put = __cordl_internal_set_creditsItems)) ::ArrayW<::GlobalNamespace::CreditsData_RootCreditsItem*> creditsItems;

  /// @brief Method Deserialize, addr 0x327ccd8, size 0x114, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::CreditsData* Deserialize(::StringW text);

  static inline ::GlobalNamespace::CreditsData* New_ctor();

  constexpr ::ArrayW<::GlobalNamespace::CreditsData_RootCreditsItem*> const& __cordl_internal_get_creditsItems() const;

  constexpr ::ArrayW<::GlobalNamespace::CreditsData_RootCreditsItem*>& __cordl_internal_get_creditsItems();

  constexpr void __cordl_internal_set_creditsItems(::ArrayW<::GlobalNamespace::CreditsData_RootCreditsItem*> value);

  /// @brief Method .ctor, addr 0x327cdec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::GlobalNamespace::CreditsData_RootCreditsItem*> ___creditsItems;
...
static_assert(sizeof(::GlobalNamespace::CreditsData) == 0x18, "Size mismatch!");
