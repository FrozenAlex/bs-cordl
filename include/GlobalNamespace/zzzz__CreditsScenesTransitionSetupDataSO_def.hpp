...
// Write type traits
MARK_REF_T(::GlobalNamespace::CreditsScenesTransitionSetupDataSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CreditsScenesTransitionSetupDataSO*, "", "CreditsScenesTransitionSetupDataSO");
...
static_assert(sizeof(::GlobalNamespace::CreditsScenesTransitionSetupDataSO) == 0x30, "Size mismatch!");
