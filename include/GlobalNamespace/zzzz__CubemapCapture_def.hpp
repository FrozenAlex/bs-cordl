...
MARK_REF_T(::GlobalNamespace::CubemapCapture*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CubemapCapture_ImageType, "", "CubemapCapture/ImageType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CubemapCapture*, "", "CubemapCapture");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::CubemapCapture_ImageType) == 0x4, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies CubemapCapture::ImageType, UnityEngine.CubemapFace, UnityEngine.InputSystem.Key, UnityEngine.MonoBehaviour, UnityEngine.Texture2D::EXRFlags, UnityEngine.Vector3
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__faceAngles, put = __cordl_internal_set__faceAngles)) ::ArrayW<::UnityEngine::Vector3> _faceAngles;

  /// @brief Field _faces, offset 0x48, size 0x8
  __declspec(property(get = __cordl_internal_get__faces, put = __cordl_internal_set__faces)) ::ArrayW<::UnityEngine::CubemapFace> _faces;
  ...
  /// @brief Method GenerateAndSaveCubemapTexture, addr 0x57b96e8, size 0xb4, virtual false, abstract: false, final false
  inline void GenerateAndSaveCubemapTexture();

  static inline ::GlobalNamespace::CubemapCapture* New_ctor();

  /// @brief Method RenderCubemapTexture, addr 0x57b979c, size 0x4c0, virtual false, abstract: false, final false
  inline void RenderCubemapTexture(::UnityEngine::Cubemap* cubemap);

  /// @brief Method SaveCubemapTexture, addr 0x57b9c5c, size 0x7dc, virtual false, abstract: false, final false
  inline void SaveCubemapTexture(::UnityEngine::Cubemap* cubemap, ::StringW path);

  /// @brief Method SerializeTextureToByteArray, addr 0x57ba438, size 0xe0, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> SerializeTextureToByteArray(::UnityEngine::Texture2D* texture);

  /// @brief Method Update, addr 0x57b9664, size 0x84, virtual false, abstract: false, final false
  inline void Update();
  ...
  constexpr ::ArrayW<::UnityEngine::Vector3> const& __cordl_internal_get__faceAngles() const;

  constexpr ::ArrayW<::UnityEngine::Vector3>& __cordl_internal_get__faceAngles();

  constexpr ::ArrayW<::UnityEngine::CubemapFace> const& __cordl_internal_get__faces() const;

  constexpr ::ArrayW<::UnityEngine::CubemapFace>& __cordl_internal_get__faces();
  ...
  constexpr void __cordl_internal_set__faceAngles(::ArrayW<::UnityEngine::Vector3> value);

  constexpr void __cordl_internal_set__faces(::ArrayW<::UnityEngine::CubemapFace> value);
  ...
  /// @brief Method .ctor, addr 0x57ba518, size 0x154, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::UnityEngine::CubemapFace> ____faces;

  /// @brief Field _faceAngles, offset: 0x50, size: 0x8, def value: None
  ::ArrayW<::UnityEngine::Vector3> ____faceAngles;
...
static_assert(sizeof(::GlobalNamespace::CubemapCapture) == 0x58, "Size mismatch!");
