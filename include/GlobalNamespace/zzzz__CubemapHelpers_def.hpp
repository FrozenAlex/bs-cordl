...
public:
  ...
  /// @brief Method Create2DTextureFromCubemap, addr 0x58e052c, size 0x18c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::RenderTexture> Create2DTextureFromCubemap(::UnityEngine::RenderTexture* src);

  /// @brief Method CreateDownsampledCubemap, addr 0x58e0330, size 0x1fc, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::RenderTexture> CreateDownsampledCubemap(::UnityEngine::RenderTexture* src, int32_t count);

  /// @brief Method Downsample, addr 0x58dff24, size 0x134, virtual false, abstract: false, final false
  static inline void Downsample(::UnityEngine::Texture* src, ::UnityEngine::RenderTexture* dest);

  /// @brief Method DrawCubemapFace, addr 0x58e0058, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_cubemapHelpersMaterial, addr 0x58dfdf4, size 0x130, virtual false, abstract: false, final false
