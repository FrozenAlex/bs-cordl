...
// Write type traits
MARK_REF_T(::GlobalNamespace::CubemapTest*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CubemapTest*, "", "CubemapTest");
...
public:
  ...
  /// @brief Method Start, addr 0x57c373c, size 0x80, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x57c37bc, size 0x25c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x57c3a18, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::CubemapTest) == 0x50, "Size mismatch!");
