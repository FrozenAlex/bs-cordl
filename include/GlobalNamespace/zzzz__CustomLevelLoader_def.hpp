...
// Write type traits
MARK_REF_T(::GlobalNamespace::CustomLevelLoader*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CustomLevelLoader*, "", "CustomLevelLoader");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3648bc4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::CustomLevelLoader) == 0x30, "Size mismatch!");
