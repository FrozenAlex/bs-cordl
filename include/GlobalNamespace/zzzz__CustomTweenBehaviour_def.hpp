...
// Write type traits
MARK_REF_T(::GlobalNamespace::CustomTweenBehaviour*);
...
public:
  ...
  /// @brief Method <OnBehaviourPlay>b__21_0, addr 0x57e6124, size 0x28, virtual false, abstract: false, final false
  inline float_t _OnBehaviourPlay_b__21_0(int32_t i);

  /// @brief Method .ctor, addr 0x57e6120, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::CustomTweenBehaviour___c) == 0x10, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies EaseType, UnityEngine.Playables.PlayableBehaviour, UnityEngine.Transform, UnityEngine.Vector3
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__originalLocalPos, put = __cordl_internal_set__originalLocalPos)) ::ArrayW<::UnityEngine::Vector3> _originalLocalPos;
  ...
  __declspec(property(get = __cordl_internal_get__randomizedDuration, put = __cordl_internal_set__randomizedDuration)) ::ArrayW<float_t> _randomizedDuration;
  ...
  __declspec(property(get = __cordl_internal_get__randomizedOrder, put = __cordl_internal_set__randomizedOrder)) ::ArrayW<int32_t> _randomizedOrder;
  ...
  /// @brief Method OnBehaviourPlay, addr 0x57e5e9c, size 0x21c, virtual true, abstract: false, final false
  inline void OnBehaviourPlay(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method OnGraphStart, addr 0x57e5878, size 0x13c, virtual true, abstract: false, final false
  inline void OnGraphStart(::UnityEngine::Playables::Playable playable);

  /// @brief Method OnPlayableDestroy, addr 0x57e5d94, size 0x108, virtual true, abstract: false, final false
  inline void OnPlayableDestroy(::UnityEngine::Playables::Playable playable);

  /// @brief Method ProcessFrame, addr 0x57e59b4, size 0x3e0, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityEngine::Vector3> const& __cordl_internal_get__originalLocalPos() const;

  constexpr ::ArrayW<::UnityEngine::Vector3>& __cordl_internal_get__originalLocalPos();
  ...
  constexpr ::ArrayW<float_t> const& __cordl_internal_get__randomizedDuration() const;

  constexpr ::ArrayW<float_t>& __cordl_internal_get__randomizedDuration();
  ...
  constexpr ::ArrayW<int32_t> const& __cordl_internal_get__randomizedOrder() const;

  constexpr ::ArrayW<int32_t>& __cordl_internal_get__randomizedOrder();
  ...
  constexpr void __cordl_internal_set__originalLocalPos(::ArrayW<::UnityEngine::Vector3> value);
  ...
  constexpr void __cordl_internal_set__randomizedDuration(::ArrayW<float_t> value);

  constexpr void __cordl_internal_set__randomizedMinDurationMultiplier(float_t value);

  constexpr void __cordl_internal_set__randomizedOrder(::ArrayW<int32_t> value);
  ...
  /// @brief Method .ctor, addr 0x57e60b8, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::UnityEngine::Vector3> ____originalLocalPos;
  ...
  ::ArrayW<int32_t> ____randomizedOrder;

  /// @brief Field _randomizedDuration, offset: 0x68, size: 0x8, def value: None
  ::ArrayW<float_t> ____randomizedDuration;
...
static_assert(sizeof(::GlobalNamespace::CustomTweenBehaviour) == 0x70, "Size mismatch!");
