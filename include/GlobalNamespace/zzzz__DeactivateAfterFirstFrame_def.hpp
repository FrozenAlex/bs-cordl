...
// Write type traits
MARK_REF_T(::GlobalNamespace::DeactivateAfterFirstFrame*);
MARK_REF_T(::GlobalNamespace::DeactivateAfterFirstFrame__Start_d__0*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DeactivateAfterFirstFrame*, "", "DeactivateAfterFirstFrame");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DeactivateAfterFirstFrame__Start_d__0*, "", "DeactivateAfterFirstFrame/<Start>d__0");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x570b7fc, size 0x64, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::DeactivateAfterFirstFrame__Start_d__0* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x570b860, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x570b868, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x570b8a0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x570b7f8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x570b7ec, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::DeactivateAfterFirstFrame__Start_d__0) == 0x28, "Size mismatch!");
...
public:
  ...
  /// @brief Method Start, addr 0x570b798, size 0x54, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* Start();

  /// @brief Method .ctor, addr 0x570b7f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::DeactivateAfterFirstFrame) == 0x20, "Size mismatch!");
