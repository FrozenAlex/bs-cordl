...
// Write type traits
MARK_REF_T(::GlobalNamespace::DefaultEnvironmentEventsFactory*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DefaultEnvironmentEventsFactory*, "", "DefaultEnvironmentEventsFactory");
...
public:
  // Declarations
  /// @brief Method InsertDefaultEvents, addr 0x3654608, size 0xb0, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::DefaultEnvironmentEventsFactory) == 0x10, "Size mismatch!");
