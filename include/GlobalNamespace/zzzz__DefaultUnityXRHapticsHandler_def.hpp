...
// Write type traits
MARK_REF_T(::GlobalNamespace::DefaultUnityXRHapticsHandler*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DefaultUnityXRHapticsHandler*, "", "DefaultUnityXRHapticsHandler");
...
static_assert(sizeof(::GlobalNamespace::DefaultUnityXRHapticsHandler) == 0x18, "Size mismatch!");
