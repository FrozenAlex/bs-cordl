...
// Write type traits
MARK_REF_T(::GlobalNamespace::DeterminismConfig*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DeterminismConfig*, "", "DeterminismConfig");
...
public:
  ...
  /// @brief Method SetDeterminism, addr 0x570e9b4, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x570e9ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(bool initialDeterminism, ::GlobalNamespace::TimeHelper* timeHelper);

  /// @brief Method add_determinismSetEvent, addr 0x570e82c, size 0xc0, virtual false, abstract: false, final false
  inline void add_determinismSetEvent(::System::Action_1<bool>* value);

  /// @brief Method get_isDeterministic, addr 0x570e81c, size 0x8, virtual false, abstract: false, final false
  inline bool get_isDeterministic();

  /// @brief Method remove_determinismSetEvent, addr 0x570e8ec, size 0xc0, virtual false, abstract: false, final false
  inline void remove_determinismSetEvent(::System::Action_1<bool>* value);

  /// @brief Method set_isDeterministic, addr 0x570e824, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::DeterminismConfig) == 0x28, "Size mismatch!");
