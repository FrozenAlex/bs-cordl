...
MARK_REF_T(::GlobalNamespace::DiffieHellmanKeyPair_DiffieHellmanUtility___c__DisplayClass5_0*);
MARK_REF_T(::GlobalNamespace::DiffieHellmanUtility*);
MARK_REF_T(::GlobalNamespace::DiffieHellmanUtility_DiffieHellmanKeyPair*);
MARK_REF_T(::GlobalNamespace::DiffieHellmanUtility_ElipticalCurveKeyPair*);
MARK_REF_T(::GlobalNamespace::DiffieHellmanUtility_OperationTimer*);
MARK_REF_T(::GlobalNamespace::ElipticalCurveKeyPair_DiffieHellmanUtility___c__DisplayClass5_0*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DiffieHellmanUtility_KeyType, "", "DiffieHellmanUtility/KeyType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DiffieHellmanKeyPair_DiffieHellmanUtility___c__DisplayClass5_0*, "", "DiffieHellmanUtility/DiffieHellmanKeyPair/<>c__DisplayClass5_0");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DiffieHellmanUtility*, "", "DiffieHellmanUtility");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DiffieHellmanUtility_DiffieHellmanKeyPair*, "", "DiffieHellmanUtility/DiffieHellmanKeyPair");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DiffieHellmanUtility_ElipticalCurveKeyPair*, "", "DiffieHellmanUtility/ElipticalCurveKeyPair");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DiffieHellmanUtility_OperationTimer*, "", "DiffieHellmanUtility/OperationTimer");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ElipticalCurveKeyPair_DiffieHellmanUtility___c__DisplayClass5_0*, "", "DiffieHellmanUtility/ElipticalCurveKeyPair/<>c__DisplayClass5_0");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_clientPublicKey, put = __cordl_internal_set_clientPublicKey)) ::ArrayW<uint8_t> clientPublicKey;

  static inline ::GlobalNamespace::DiffieHellmanKeyPair_DiffieHellmanUtility___c__DisplayClass5_0* New_ctor();

  /// @brief Method <GetPreMasterSecretAsync>b__0, addr 0x3270d14, size 0x70, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_clientPublicKey() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_clientPublicKey();
  ...
  /// @brief Method .ctor, addr 0x3270ca4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<uint8_t> ___clientPublicKey;
...
static_assert(sizeof(::GlobalNamespace::DiffieHellmanKeyPair_DiffieHellmanUtility___c__DisplayClass5_0) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetPreMasterSecret, addr 0x3270ca8, size 0x6c, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> GetPreMasterSecret(::ArrayW<uint8_t> clientPublicKey);

  /// @brief Method GetPreMasterSecretAsync, addr 0x3270b24, size 0x180, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3270414, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_publicKey, addr 0x3270b1c, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method <GetPreMasterSecretAsync>b__0, addr 0x3270f7c, size 0x70, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> _GetPreMasterSecretAsync_b__0();
  ...
  /// @brief Method .ctor, addr 0x3270f0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ElipticalCurveKeyPair_DiffieHellmanUtility___c__DisplayClass5_0) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetPreMasterSecret, addr 0x3270f10, size 0x6c, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> GetPreMasterSecret(::ArrayW<uint8_t> clientPublicKey);

  /// @brief Method GetPreMasterSecretAsync, addr 0x3270d8c, size 0x180, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task_1<::ArrayW<uint8_t>>* GetPreMasterSecretAsync(::BGNet::Core::ITaskUtility* taskUtility, ::ArrayW<uint8_t> clientPublicKey);
  ...
  /// @brief Method .ctor, addr 0x3270490, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_publicKey, addr 0x3270d84, size 0x8, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> get_publicKey();
...
static_assert(sizeof(::GlobalNamespace::DiffieHellmanUtility_ElipticalCurveKeyPair) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method Dispose, addr 0x3271058, size 0x100, virtual true, abstract: false, final true
  inline void Dispose();

  static inline ::GlobalNamespace::DiffieHellmanUtility_OperationTimer* New_ctor(::StringW operationName);

  /// @brief Method Time, addr 0x327040c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3270fec, size 0x6c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::DiffieHellmanUtility_OperationTimer) == 0x20, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = getStaticF__ecPointFormats, put = setStaticF__ecPointFormats)) ::ArrayW<uint8_t> _ecPointFormats;
  ...
  /// @brief Method GenerateDiffieHellmanKeys, addr 0x32701e0, size 0x22c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::DiffieHellmanUtility_DiffieHellmanKeyPair* GenerateDiffieHellmanKeys();

  /// @brief Method GenerateElipticalCurveKeys, addr 0x326ffa4, size 0x23c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::DiffieHellmanUtility_ElipticalCurveKeyPair* GenerateElipticalCurveKeys();

  /// @brief Method GenerateKeys, addr 0x326ff34, size 0x70, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::IDiffieHellmanKeyPair* GenerateKeys(::GlobalNamespace::DiffieHellmanUtility_KeyType keyType);

  /// @brief Method GenerateKeysAsync, addr 0x326fd9c, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreMasterSecret, addr 0x327050c, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreMasterSecret, addr 0x3270760, size 0x274, virtual false, abstract: false, final false
  ...
  static inline ::ArrayW<uint8_t> getStaticF__ecPointFormats();
  ...
  static inline void setStaticF__ecPointFormats(::ArrayW<uint8_t> value);
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::DiffieHellmanUtility) == 0x10, "Size mismatch!");
