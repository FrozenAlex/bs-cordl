...
// Write type traits
MARK_REF_T(::GlobalNamespace::DirectionalLightWithIds*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DirectionalLightWithIds*, "", "DirectionalLightWithIds");
...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x5728b48, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5728b8c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::DirectionalLightWithIds) == 0x70, "Size mismatch!");
