...
// Write type traits
MARK_REF_T(::GlobalNamespace::DirectionalLightWithLightGroupIds*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DirectionalLightWithLightGroupIds*, "", "DirectionalLightWithLightGroupIds");
...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x5728c04, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5728c20, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::DirectionalLightWithLightGroupIds) == 0x60, "Size mismatch!");
