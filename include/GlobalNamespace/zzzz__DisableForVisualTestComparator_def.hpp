...
// Write type traits
MARK_REF_T(::GlobalNamespace::DisableForVisualTestComparator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DisableForVisualTestComparator*, "", "DisableForVisualTestComparator");
...
static_assert(sizeof(::GlobalNamespace::DisableForVisualTestComparator) == 0x38, "Size mismatch!");
