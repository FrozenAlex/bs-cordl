...
// Write type traits
MARK_REF_T(::GlobalNamespace::DisableWhenMirrorIsEnabled*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DisableWhenMirrorIsEnabled*, "", "DisableWhenMirrorIsEnabled");
...
public:
  ...
  /// @brief Method HandleMirrorDidChangeEnabledState, addr 0x58e0d50, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x58e0d7c, size 0x114, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x58e0cac, size 0xa4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x58e0e90, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mirror, addr 0x58e0c9c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::Mirror> get_mirror();

  /// @brief Method set_mirror, addr 0x58e0ca4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::DisableWhenMirrorIsEnabled) == 0x28, "Size mismatch!");
