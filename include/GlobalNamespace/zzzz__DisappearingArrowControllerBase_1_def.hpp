...
public:
  ...
  constexpr ::ArrayW<::UnityW<::GlobalNamespace::MaterialPropertyBlockController>> const& __cordl_internal_get__transparentObjectMaterialPropertyBlocks() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::MaterialPropertyBlockController>>& __cordl_internal_get__transparentObjectMaterialPropertyBlocks();
  ...
  constexpr void __cordl_internal_set__transparentObjectMaterialPropertyBlocks(::ArrayW<::UnityW<::GlobalNamespace::MaterialPropertyBlockController>> value);
