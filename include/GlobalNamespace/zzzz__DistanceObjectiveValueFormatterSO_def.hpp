...
// Write type traits
MARK_REF_T(::GlobalNamespace::DistanceObjectiveValueFormatterSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DistanceObjectiveValueFormatterSO*, "", "DistanceObjectiveValueFormatterSO");
...
public:
  // Declarations
  /// @brief Method FormatValue, addr 0x3750594, size 0x94, virtual true, abstract: false, final false
  inline ::StringW FormatValue(int32_t value);

  static inline ::GlobalNamespace::DistanceObjectiveValueFormatterSO* New_ctor();

  /// @brief Method .ctor, addr 0x3750628, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::DistanceObjectiveValueFormatterSO) == 0x18, "Size mismatch!");
