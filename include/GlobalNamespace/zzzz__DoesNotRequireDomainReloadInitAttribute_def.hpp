...
// Write type traits
MARK_REF_T(::GlobalNamespace::DoesNotRequireDomainReloadInitAttribute*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DoesNotRequireDomainReloadInitAttribute*, "", "DoesNotRequireDomainReloadInitAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x325111c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::DoesNotRequireDomainReloadInitAttribute) == 0x10, "Size mismatch!");
