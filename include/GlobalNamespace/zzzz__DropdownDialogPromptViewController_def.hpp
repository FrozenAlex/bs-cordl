...
// Write type traits
MARK_REF_T(::GlobalNamespace::DropdownDialogPromptViewController*);
MARK_REF_T(::GlobalNamespace::DropdownDialogPromptViewController_ButtonAndLabel*);
MARK_REF_T(::GlobalNamespace::DropdownDialogPromptViewController___c*);
MARK_REF_T(::GlobalNamespace::DropdownDialogPromptViewController___c__DisplayClass13_0*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DropdownDialogPromptViewController*, "", "DropdownDialogPromptViewController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DropdownDialogPromptViewController_ButtonAndLabel*, "", "DropdownDialogPromptViewController/ButtonAndLabel");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DropdownDialogPromptViewController___c*, "", "DropdownDialogPromptViewController/<>c");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DropdownDialogPromptViewController___c__DisplayClass13_0*, "", "DropdownDialogPromptViewController/<>c__DisplayClass13_0");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5a10488, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_component, addr 0x5a10478, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Button> get_component();

  /// @brief Method get_label, addr 0x5a10480, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <Init>b__12_0, addr 0x5a104e4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW _Init_b__12_0(::System::ValueTuple_2<::StringW, int32_t> e);

  /// @brief Method .ctor, addr 0x5a104e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <DidActivate>b__0, addr 0x5a104ec, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a10344, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::DropdownDialogPromptViewController___c__DisplayClass13_0) == 0x20, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies DropdownDialogPromptViewController::ButtonAndLabel, HMUI.ViewController, System.ValueTuple`2<T1, T2>
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__buttons, put = __cordl_internal_set__buttons)) ::ArrayW<::GlobalNamespace::DropdownDialogPromptViewController_ButtonAndLabel*> _buttons;
  ...
  __declspec(property(get = __cordl_internal_get__dropdownValues, put = __cordl_internal_set__dropdownValues)) ::ArrayW<::System::ValueTuple_2<::StringW, int32_t>> _dropdownValues;
  ...
  /// @brief Method DidActivate, addr 0x5a101cc, size 0x178, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x5a10348, size 0xc, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method Init, addr 0x5a0ff50, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnButtonClick, addr 0x5a10354, size 0x80, virtual false, abstract: false, final false
  inline void OnButtonClick(int32_t buttonNum);

  constexpr ::ArrayW<::GlobalNamespace::DropdownDialogPromptViewController_ButtonAndLabel*> const& __cordl_internal_get__buttons() const;

  constexpr ::ArrayW<::GlobalNamespace::DropdownDialogPromptViewController_ButtonAndLabel*>& __cordl_internal_get__buttons();
  ...
  constexpr ::ArrayW<::System::ValueTuple_2<::StringW, int32_t>> const& __cordl_internal_get__dropdownValues() const;

  constexpr ::ArrayW<::System::ValueTuple_2<::StringW, int32_t>>& __cordl_internal_get__dropdownValues();
  ...
  constexpr void __cordl_internal_set__buttons(::ArrayW<::GlobalNamespace::DropdownDialogPromptViewController_ButtonAndLabel*> value);
  ...
  constexpr void __cordl_internal_set__dropdownValues(::ArrayW<::System::ValueTuple_2<::StringW, int32_t>> value);
  ...
  /// @brief Method .ctor, addr 0x5a103d4, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add__didFinishAction, addr 0x5a0fdd0, size 0xc0, virtual false, abstract: false, final false
  inline void add__didFinishAction(::System::Action_1<::System::ValueTuple_2<int32_t, int32_t>>* value);

  /// @brief Method get_selectedValue, addr 0x5a0fd94, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_selectedValue();

  /// @brief Method remove__didFinishAction, addr 0x5a0fe90, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::DropdownDialogPromptViewController) == 0xb0, "Size mismatch!");
