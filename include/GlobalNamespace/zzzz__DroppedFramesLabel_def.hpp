...
// Write type traits
MARK_REF_T(::GlobalNamespace::DroppedFramesLabel*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DroppedFramesLabel*, "", "DroppedFramesLabel");
...
public:
  ...
  /// @brief Method RefreshText, addr 0x570ec54, size 0x16c, virtual false, abstract: false, final false
  inline void RefreshText();

  /// @brief Method Start, addr 0x570eb18, size 0x78, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x570eb90, size 0xc4, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x570edc0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::DroppedFramesLabel) == 0x48, "Size mismatch!");
