...
public:
  ...
  /// @brief Method ManualInstallBindings, addr 0x58c3cf0, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58c3f50, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
