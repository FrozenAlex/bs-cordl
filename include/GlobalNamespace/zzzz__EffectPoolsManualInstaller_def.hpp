...
// Write type traits
MARK_REF_T(::GlobalNamespace::EffectPoolsManualInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EffectPoolsManualInstaller*, "", "EffectPoolsManualInstaller");
...
public:
  ...
  /// @brief Method ManualInstallBindings, addr 0x59f30f4, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59f3354, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::EffectPoolsManualInstaller) == 0x58, "Size mismatch!");
