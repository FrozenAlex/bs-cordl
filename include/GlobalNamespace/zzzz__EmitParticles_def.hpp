...
// Write type traits
MARK_REF_T(::GlobalNamespace::EmitParticles*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EmitParticles*, "", "EmitParticles");
...
public:
  ...
  /// @brief Method Emit, addr 0x5846d3c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5846d50, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::EmitParticles) == 0x28, "Size mismatch!");
