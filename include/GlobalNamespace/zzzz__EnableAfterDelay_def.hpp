...
// Write type traits
MARK_REF_T(::GlobalNamespace::EnableAfterDelay*);
MARK_REF_T(::GlobalNamespace::EnableAfterDelay__Start_d__1*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnableAfterDelay*, "", "EnableAfterDelay");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnableAfterDelay__Start_d__1*, "", "EnableAfterDelay/<Start>d__1");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x571088c, size 0xa4, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::EnableAfterDelay__Start_d__1* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x5710930, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5710938, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5710970, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5710888, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x571087c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::EnableAfterDelay__Start_d__1) == 0x28, "Size mismatch!");
...
public:
  ...
  /// @brief Method Start, addr 0x5710828, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5710884, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::EnableAfterDelay) == 0x28, "Size mismatch!");
