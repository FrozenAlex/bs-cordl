...
// Write type traits
MARK_REF_T(::GlobalNamespace::EncryptionUtility*);
MARK_REF_T(::GlobalNamespace::EncryptionUtility_EncryptionState*);
MARK_REF_T(::GlobalNamespace::EncryptionUtility_IEncryptionState*);
MARK_REF_T(::GlobalNamespace::EncryptionUtility___c__DisplayClass19_0*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EncryptionUtility*, "", "EncryptionUtility");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EncryptionUtility_EncryptionState*, "", "EncryptionUtility/EncryptionState");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EncryptionUtility_IEncryptionState*, "", "EncryptionUtility/IEncryptionState");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EncryptionUtility___c__DisplayClass19_0*, "", "EncryptionUtility/<>c__DisplayClass19_0");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__receiveMacKey, put = __cordl_internal_set__receiveMacKey)) ::ArrayW<uint8_t> _receiveMacKey;
  ...
  __declspec(property(get = __cordl_internal_get__receivedSequenceNumBuffer, put = __cordl_internal_set__receivedSequenceNumBuffer)) ::ArrayW<bool> _receivedSequenceNumBuffer;

  /// @brief Field _sendMacKey, offset 0x38, size 0x8
  __declspec(property(get = __cordl_internal_get__sendMacKey, put = __cordl_internal_set__sendMacKey)) ::ArrayW<uint8_t> _sendMacKey;
  ...
  __declspec(property(get = __cordl_internal_get_receiveKey, put = __cordl_internal_set_receiveKey)) ::ArrayW<uint8_t> receiveKey;

  /// @brief Field sendKey, offset 0x28, size 0x8
  __declspec(property(get = __cordl_internal_get_sendKey, put = __cordl_internal_set_sendKey)) ::ArrayW<uint8_t> sendKey;
  ...
  /// @brief Method ComputeReceiveMac, addr 0x3273068, size 0x2e8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> ComputeReceiveMac(::ArrayW<uint8_t> data, int32_t offset, int32_t count);

  /// @brief Method ComputeSendMac, addr 0x3272560, size 0x2e8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> ComputeSendMac(::ArrayW<uint8_t> data, int32_t offset, int32_t count);

  /// @brief Method Dispose, addr 0x3273f80, size 0xc, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method EncryptData, addr 0x3273aec, size 0x88, virtual true, abstract: false, final true
  inline void EncryptData(::ArrayW<uint8_t> data, ::by_ref<int32_t> offset, ::by_ref<int32_t> length, int32_t extraPrefixBytes);

  /// @brief Method GetNextSentSequenceNum, addr 0x32724bc, size 0x20, virtual false, abstract: false, final false
  inline uint32_t GetNextSentSequenceNum();

  /// @brief Method IsValidSequenceNum, addr 0x3272f3c, size 0x12c, virtual false, abstract: false, final false
  inline bool IsValidSequenceNum(uint32_t sequenceNum);

  /// @brief Method MakeSeed, addr 0x3273bf4, size 0xe4, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> MakeSeed(::ArrayW<uint8_t> baseSeed, ::ArrayW<uint8_t> serverSeed, ::ArrayW<uint8_t> clientSeed);

  static inline ::GlobalNamespace::EncryptionUtility_EncryptionState* New_ctor(::ArrayW<uint8_t> preMasterSecret, ::ArrayW<uint8_t> serverSeed, ::ArrayW<uint8_t> clientSeed, bool isClient);

  /// @brief Method PRF, addr 0x3273cd8, size 0xec, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> PRF(::ArrayW<uint8_t> key, ::ArrayW<uint8_t> seed, int32_t length);

  /// @brief Method PRF_Hash, addr 0x3273dc4, size 0x1bc, virtual false, abstract: false, final false
  static inline void PRF_Hash(::ArrayW<uint8_t> key, ::ArrayW<uint8_t> seed, ::by_ref<int32_t> length);

  /// @brief Method PutSequenceNum, addr 0x3273350, size 0x1fc, virtual false, abstract: false, final false
  inline bool PutSequenceNum(uint32_t sequenceNum);

  /// @brief Method TryDecryptData, addr 0x3273b74, size 0x80, virtual true, abstract: false, final true
  inline bool TryDecryptData(::ArrayW<uint8_t> data, ::by_ref<int32_t> offset, ::by_ref<int32_t> length);
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get__receiveMacKey() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get__receiveMacKey();
  ...
  constexpr ::ArrayW<bool> const& __cordl_internal_get__receivedSequenceNumBuffer() const;

  constexpr ::ArrayW<bool>& __cordl_internal_get__receivedSequenceNumBuffer();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get__sendMacKey() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get__sendMacKey();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_receiveKey() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_receiveKey();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_sendKey() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_sendKey();
  ...
  constexpr void __cordl_internal_set__receiveMacKey(::ArrayW<uint8_t> value);
  ...
  constexpr void __cordl_internal_set__receivedSequenceNumBuffer(::ArrayW<bool> value);

  constexpr void __cordl_internal_set__sendMacKey(::ArrayW<uint8_t> value);
  ...
  constexpr void __cordl_internal_set_receiveKey(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_sendKey(::ArrayW<uint8_t> value);

  /// @brief Method .ctor, addr 0x3271974, size 0x270, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> preMasterSecret, ::ArrayW<uint8_t> serverSeed, ::ArrayW<uint8_t> clientSeed, bool isClient);

  /// @brief Method get_isValid, addr 0x3273ae0, size 0xc, virtual true, abstract: false, final true
  inline bool get_isValid();
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_clientSeed, put = __cordl_internal_set_clientSeed)) ::ArrayW<uint8_t> clientSeed;
  ...
  __declspec(property(get = __cordl_internal_get_preMasterSecret, put = __cordl_internal_set_preMasterSecret)) ::ArrayW<uint8_t> preMasterSecret;

  /// @brief Field serverSeed, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get_serverSeed, put = __cordl_internal_set_serverSeed)) ::ArrayW<uint8_t> serverSeed;

  static inline ::GlobalNamespace::EncryptionUtility___c__DisplayClass19_0* New_ctor();

  /// @brief Method <CreateEncryptionStateAsync>b__0, addr 0x3273f8c, size 0x7c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EncryptionUtility_IEncryptionState* _CreateEncryptionStateAsync_b__0();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_clientSeed() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_clientSeed();

  constexpr bool const& __cordl_internal_get_isClient() const;

  constexpr bool& __cordl_internal_get_isClient();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_preMasterSecret() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_preMasterSecret();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_serverSeed() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_serverSeed();

  constexpr void __cordl_internal_set_clientSeed(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_isClient(bool value);

  constexpr void __cordl_internal_set_preMasterSecret(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_serverSeed(::ArrayW<uint8_t> value);

  /// @brief Method .ctor, addr 0x3271d80, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::EncryptionUtility___c__DisplayClass19_0) == 0x30, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = getStaticF__keyExpansionSeed, put = setStaticF__keyExpansionSeed)) ::ArrayW<uint8_t> _keyExpansionSeed;

  /// @brief Field _masterSecretSeed, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF__masterSecretSeed, put = setStaticF__masterSecretSeed)) ::ArrayW<uint8_t> _masterSecretSeed;

  /// @brief Field _tempHash, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF__tempHash, put = setStaticF__tempHash)) ::ArrayW<uint8_t> _tempHash;

  /// @brief Field _tempIV, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF__tempIV, put = setStaticF__tempIV)) ::ArrayW<uint8_t> _tempIV;

  /// @brief Method CreateEncryptionState, addr 0x32718f0, size 0x84, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::EncryptionUtility_IEncryptionState* CreateEncryptionState(::ArrayW<uint8_t> preMasterSecret, ::ArrayW<uint8_t> serverSeed, ::ArrayW<uint8_t> clientSeed,
                                                                                             bool isClient);

  /// @brief Method CreateEncryptionStateAsync, addr 0x3271be4, size 0x19c, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::EncryptionUtility_IEncryptionState*>*
  CreateEncryptionStateAsync(::BGNet::Core::ITaskUtility* taskUtility, ::ArrayW<uint8_t> preMasterSecret, ::ArrayW<uint8_t> serverSeed, ::ArrayW<uint8_t> clientSeed, bool isClient);

  /// @brief Method EncryptData, addr 0x3271d9c, size 0x720, virtual false, abstract: false, final false
  static inline void EncryptData(::GlobalNamespace::EncryptionUtility_EncryptionState* state, ::ArrayW<uint8_t> data, ::by_ref<int32_t> offset, ::by_ref<int32_t> length, int32_t extraPrefixedData);

  /// @brief Method FastCopyBlock, addr 0x327354c, size 0x314, virtual false, abstract: false, final false
  static inline void FastCopyBlock(::ArrayW<uint8_t> inArr, int32_t inOff, ::ArrayW<uint8_t> outArr, int32_t outOff);

  /// @brief Method FastCopyMac, addr 0x3273860, size 0x1f4, virtual false, abstract: false, final false
  static inline void FastCopyMac(::ArrayW<uint8_t> inArr, int32_t inOff, ::ArrayW<uint8_t> outArr, int32_t outOff);

  /// @brief Method IsValidLength, addr 0x3271d84, size 0x18, virtual false, abstract: false, final false
  static inline bool IsValidLength(int32_t length);

  /// @brief Method Log, addr 0x3273a54, size 0x8c, virtual false, abstract: false, final false
  static inline void Log(::StringW message);

  /// @brief Method TryDecryptData, addr 0x3272848, size 0x6f4, virtual false, abstract: false, final false
  static inline bool TryDecryptData(::GlobalNamespace::EncryptionUtility_EncryptionState* state, ::ArrayW<uint8_t> data, ::by_ref<int32_t> offset, ::by_ref<int32_t> length);

  static inline ::System::Security::Cryptography::Aes* getStaticF__aes();

  static inline ::ArrayW<uint8_t> getStaticF__keyExpansionSeed();

  static inline ::ArrayW<uint8_t> getStaticF__masterSecretSeed();

  static inline ::ArrayW<uint8_t> getStaticF__tempHash();

  static inline ::ArrayW<uint8_t> getStaticF__tempIV();

  static inline void setStaticF__aes(::System::Security::Cryptography::Aes* value);

  static inline void setStaticF__keyExpansionSeed(::ArrayW<uint8_t> value);

  static inline void setStaticF__masterSecretSeed(::ArrayW<uint8_t> value);

  static inline void setStaticF__tempHash(::ArrayW<uint8_t> value);

  static inline void setStaticF__tempIV(::ArrayW<uint8_t> value);
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::EncryptionUtility) == 0x10, "Size mismatch!");
