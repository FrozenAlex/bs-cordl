...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EntitlementStatus, "", "EntitlementStatus");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
public:
  ...
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23624 };
...
static_assert(sizeof(::GlobalNamespace::EntitlementStatus) == 0x4, "Size mismatch!");
