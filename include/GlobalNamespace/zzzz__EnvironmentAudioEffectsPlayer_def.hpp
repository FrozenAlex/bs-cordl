...
// Write type traits
MARK_REF_T(::GlobalNamespace::EnvironmentAudioEffectsPlayer*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnvironmentAudioEffectsPlayer*, "", "EnvironmentAudioEffectsPlayer");
...
static_assert(sizeof(::GlobalNamespace::EnvironmentAudioEffectsPlayer) == 0x28, "Size mismatch!");
