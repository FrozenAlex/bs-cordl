#pragma once
// IWYU pragma private; include "GlobalNamespace/EnvironmentContext.hpp"
...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnvironmentContext, "", "EnvironmentContext");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
public:
  ...
  /// @brief Field BeatmapEditor value: I32(1)
  static ::GlobalNamespace::EnvironmentContext const BeatmapEditor;

  /// @brief Field Gameplay value: I32(0)
...
static_assert(sizeof(::GlobalNamespace::EnvironmentContext) == 0x4, "Size mismatch!");
