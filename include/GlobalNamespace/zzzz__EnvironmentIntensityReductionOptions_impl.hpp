...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::GlobalNamespace::EnvironmentIntensityReductionOptions_CompressExpandReductionType (
  ...
  constexpr static std::size_t addrs = 0x364950c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::EnvironmentIntensityReductionOptions*>(), { "get_compressExpand", {}, {} })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::GlobalNamespace::EnvironmentIntensityReductionOptions_RotateRingsReductionType (::GlobalNamespace::EnvironmentIntensityReductionOptions::*)()>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3649514;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::EnvironmentIntensityReductionOptions*>(), { "get_rotateRings", {}, {} })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::EnvironmentIntensityReductionOptions::*)()>(&::GlobalNamespace::EnvironmentIntensityReductionOptions::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x364951c;
...
inline ::GlobalNamespace::EnvironmentIntensityReductionOptions_CompressExpandReductionType GlobalNamespace::EnvironmentIntensityReductionOptions::get_compressExpand() {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::EnvironmentIntensityReductionOptions*>(), { "get_compressExpand", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::EnvironmentIntensityReductionOptions_CompressExpandReductionType>(this, ___internal_method);
}
inline ::GlobalNamespace::EnvironmentIntensityReductionOptions_RotateRingsReductionType GlobalNamespace::EnvironmentIntensityReductionOptions::get_rotateRings() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::EnvironmentIntensityReductionOptions*>(), { "get_rotateRings", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::EnvironmentIntensityReductionOptions_RotateRingsReductionType>(this, ___internal_method);
}
...
inline ::GlobalNamespace::EnvironmentIntensityReductionOptions* GlobalNamespace::EnvironmentIntensityReductionOptions::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::EnvironmentIntensityReductionOptions*>());
}
// Ctor Parameters []
