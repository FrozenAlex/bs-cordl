...
public:
  ...
  /// @brief Method InstallBindings, addr 0x57e95a8, size 0x1a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57e974c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::EnvironmentSceneSetup) == 0x30, "Size mismatch!");
