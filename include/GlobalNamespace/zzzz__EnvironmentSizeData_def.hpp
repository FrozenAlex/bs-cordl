...
MARK_REF_T(::GlobalNamespace::EnvironmentSizeData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnvironmentSizeData_CeilingType, "", "EnvironmentSizeData/CeilingType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnvironmentSizeData_FloorType, "", "EnvironmentSizeData/FloorType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnvironmentSizeData_TrackLaneType, "", "EnvironmentSizeData/TrackLaneType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnvironmentSizeData*, "", "EnvironmentSizeData");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::EnvironmentSizeData_FloorType) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::EnvironmentSizeData_CeilingType) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::EnvironmentSizeData_TrackLaneType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3649c58, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ceilingType, addr 0x3649c48, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EnvironmentSizeData_CeilingType get_ceilingType();

  /// @brief Method get_floorType, addr 0x3649c40, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EnvironmentSizeData_FloorType get_floorType();

  /// @brief Method get_trackLaneType, addr 0x3649c50, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::EnvironmentSizeData) == 0x20, "Size mismatch!");
