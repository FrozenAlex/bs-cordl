...
public:
  ...
  /// @brief Method <CreateFromAddressables>b__13_0, addr 0x364a8d0, size 0x4, virtual false, abstract: false, final false
  inline void _CreateFromAddressables_b__13_0(::GlobalNamespace::EnvironmentInfoSO* _);

  /// @brief Method <.ctor>b__12_0, addr 0x364a848, size 0x14, virtual false, abstract: false, final false
  inline int32_t __ctor_b__12_0(::GlobalNamespace::EnvironmentInfoSO* envInfo);

  /// @brief Method <.ctor>b__12_1, addr 0x364a85c, size 0x1c, virtual false, abstract: false, final false
  inline bool __ctor_b__12_1(::GlobalNamespace::EnvironmentInfoSO* e);

  /// @brief Method <.ctor>b__12_2, addr 0x364a878, size 0x14, virtual false, abstract: false, final false
  inline ::StringW __ctor_b__12_2(::GlobalNamespace::EnvironmentInfoSO* e);

  /// @brief Method <.ctor>b__12_3, addr 0x364a88c, size 0x1c, virtual false, abstract: false, final false
  inline bool __ctor_b__12_3(::GlobalNamespace::EnvironmentInfoSO* e);

  /// @brief Method <.ctor>b__12_4, addr 0x364a8a8, size 0x14, virtual false, abstract: false, final false
  inline ::StringW __ctor_b__12_4(::GlobalNamespace::EnvironmentInfoSO* e);

  /// @brief Method <.ctor>b__12_5, addr 0x364a8bc, size 0x14, virtual false, abstract: false, final false
  inline ::StringW __ctor_b__12_5(::GlobalNamespace::EnvironmentInfoSO* envInfo);

  /// @brief Method .ctor, addr 0x364a844, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__normalEnvironmentNames, put = __cordl_internal_set__normalEnvironmentNames)) ::ArrayW<::StringW> _normalEnvironmentNames;

  /// @brief Field _normalEnvironmentSerializedNames, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get__normalEnvironmentSerializedNames, put = __cordl_internal_set__normalEnvironmentSerializedNames)) ::ArrayW<::StringW>
  ...
  __declspec(property(get = get_normalEnvironmentNames)) ::ArrayW<::StringW> normalEnvironmentNames;

  __declspec(property(get = get_normalEnvironmentSerializedNames)) ::ArrayW<::StringW> normalEnvironmentSerializedNames;

  /// @brief Convert operator to "::GlobalNamespace::IVerboseLogger"
  constexpr operator ::GlobalNamespace::IVerboseLogger*() noexcept;

  /// @brief Method CreateFromAddressables, addr 0x364a188, size 0x26c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::EnvironmentsListModel* CreateFromAddressables();

  /// @brief Method GetAllEnvironmentInfosWithType, addr 0x364a5ec, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnvironmentInfoBySerializedName, addr 0x364a3f4, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> GetEnvironmentInfoBySerializedName(::StringW environmentSerializedName);

  /// @brief Method GetEnvironmentInfoBySerializedNameSafe, addr 0x364a470, size 0x17c, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> GetEnvironmentInfoBySerializedNameSafe(::StringW environmentSerializedName);

  /// @brief Method GetFirstEnvironmentInfoWithType, addr 0x364a730, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLastEnvironmentInfoWithType, addr 0x364a790, size 0x60, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::StringW> const& __cordl_internal_get__normalEnvironmentNames() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get__normalEnvironmentNames();

  constexpr ::ArrayW<::StringW> const& __cordl_internal_get__normalEnvironmentSerializedNames() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get__normalEnvironmentSerializedNames();
  ...
  constexpr void __cordl_internal_set__normalEnvironmentNames(::ArrayW<::StringW> value);

  constexpr void __cordl_internal_set__normalEnvironmentSerializedNames(::ArrayW<::StringW> value);

  /// @brief Method .ctor, addr 0x3649cb8, size 0x4d0, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IEnumerable_1<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>* envInfoSOs);

  /// @brief Method get_environmentInfos, addr 0x3649ca0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>* get_environmentInfos();

  /// @brief Method get_loggerPrefix, addr 0x3649c5c, size 0x44, virtual true, abstract: false, final true
  inline ::StringW get_loggerPrefix();

  /// @brief Method get_normalEnvironmentNames, addr 0x3649ca8, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW> get_normalEnvironmentNames();

  /// @brief Method get_normalEnvironmentSerializedNames, addr 0x3649cb0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW> get_normalEnvironmentSerializedNames();
...
public:
  ...
  ::ArrayW<::StringW> ____normalEnvironmentSerializedNames;

  /// @brief Field _normalEnvironmentNames, offset: 0x20, size: 0x8, def value: None
  ::ArrayW<::StringW> ____normalEnvironmentNames;
