...
// Write type traits
MARK_REF_T(::GlobalNamespace::EventsTestGameplayManager*);
MARK_REF_T(::GlobalNamespace::EventsTestGameplayManager_MockBeatToTimeConverter*);
MARK_REF_T(::GlobalNamespace::EventsTestGameplayManager___c__DisplayClass18_0*);
MARK_REF_T(::GlobalNamespace::EventsTestGameplayManager___c__DisplayClass19_0*);
MARK_REF_T(::GlobalNamespace::EventsTestGameplayManager___c__DisplayClass20_0*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EventsTestGameplayManager*, "", "EventsTestGameplayManager");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EventsTestGameplayManager_MockBeatToTimeConverter*, "", "EventsTestGameplayManager/MockBeatToTimeConverter");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EventsTestGameplayManager___c__DisplayClass18_0*, "", "EventsTestGameplayManager/<>c__DisplayClass18_0");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EventsTestGameplayManager___c__DisplayClass19_0*, "", "EventsTestGameplayManager/<>c__DisplayClass19_0");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EventsTestGameplayManager___c__DisplayClass20_0*, "", "EventsTestGameplayManager/<>c__DisplayClass20_0");
...
static_assert(sizeof(::GlobalNamespace::EventsTestGameplayManager_MockBeatToTimeConverter) == 0x18, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::EventsTestGameplayManager___c__DisplayClass18_0) == 0x18, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::EventsTestGameplayManager___c__DisplayClass19_0) == 0x18, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::EventsTestGameplayManager___c__DisplayClass20_0) == 0x18, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies BasicBeatmapEventType, BeatmapEventDataBoxGroupList, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__beatmapEventDataBoxGroupLists, put = __cordl_internal_set__beatmapEventDataBoxGroupLists)) ::ArrayW<::GlobalNamespace::BeatmapEventDataBoxGroupList*>
  ...
  __declspec(property(get = __cordl_internal_get_groupState, put = __cordl_internal_set_groupState)) ::ArrayW<bool> groupState;
  ...
  constexpr ::ArrayW<::GlobalNamespace::BeatmapEventDataBoxGroupList*> const& __cordl_internal_get__beatmapEventDataBoxGroupLists() const;

  constexpr ::ArrayW<::GlobalNamespace::BeatmapEventDataBoxGroupList*>& __cordl_internal_get__beatmapEventDataBoxGroupLists();
  ...
  constexpr ::ArrayW<bool> const& __cordl_internal_get_groupState() const;

  constexpr ::ArrayW<bool>& __cordl_internal_get_groupState();
  ...
  constexpr void __cordl_internal_set__beatmapEventDataBoxGroupLists(::ArrayW<::GlobalNamespace::BeatmapEventDataBoxGroupList*> value);
  ...
  constexpr void __cordl_internal_set_groupState(::ArrayW<bool> value);
...
public:
  ...
  ::ArrayW<::GlobalNamespace::BeatmapEventDataBoxGroupList*> ____beatmapEventDataBoxGroupLists;

  /// @brief Field groupState, offset: 0x50, size: 0x8, def value: None
  ::ArrayW<bool> ___groupState;
...
static_assert(sizeof(::GlobalNamespace::EventsTestGameplayManager) == 0x80, "Size mismatch!");
