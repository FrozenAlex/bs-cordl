...
// Write type traits
MARK_REF_T(::GlobalNamespace::EventsTestSceneSetup*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EventsTestSceneSetup*, "", "EventsTestSceneSetup");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x57e97c0, size 0xec4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57ea684, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::EventsTestSceneSetup) == 0x30, "Size mismatch!");
