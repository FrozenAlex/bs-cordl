...
// Write type traits
MARK_REF_T(::GlobalNamespace::EventsTestScenesTransitionSetupDataSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EventsTestScenesTransitionSetupDataSO*, "", "EventsTestScenesTransitionSetupDataSO");
...
static_assert(sizeof(::GlobalNamespace::EventsTestScenesTransitionSetupDataSO) == 0x28, "Size mismatch!");
