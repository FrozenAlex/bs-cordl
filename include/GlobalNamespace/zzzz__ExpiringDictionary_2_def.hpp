...
MARK_GEN_REF_T_PTR(::GlobalNamespace::ExpiringDictionary_2_Entry);
MARK_GEN_REF_T_PTR(::GlobalNamespace::ExpiringDictionary_2__Enumerate_d__14);
...
public:
  ...
  inline bool TryGetValueAndResetExpiration(TKey key, ::by_ref<TValue> value);
