...
// Write type traits
MARK_REF_T(::GlobalNamespace::ExplicitContentWarningViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ExplicitContentWarningViewController*, "", "ExplicitContentWarningViewController");
...
static_assert(sizeof(::GlobalNamespace::ExplicitContentWarningViewController) == 0x90, "Size mismatch!");
