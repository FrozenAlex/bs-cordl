...
public:
  // Declarations
  /// @brief Method ContainsLayer, addr 0x331fdc8, size 0xc, virtual false, abstract: false, final false
  static inline bool ContainsLayer(::UnityEngine::LayerMask layerMask, int32_t layer);

  /// @brief Method CreateTexture2D, addr 0x3320250, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFixedSeed, addr 0x33205f4, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t GetFixedSeed(::UnityEngine::Component* component);

  /// @brief Method GetFixedSeed, addr 0x33205d8, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t GetFixedSeed(::UnityEngine::GameObject* gameObject);

  /// @brief Method GetFixedSeed, addr 0x3320470, size 0x168, virtual false, abstract: false, final false
  static inline int32_t GetFixedSeed(::UnityEngine::Transform* transform);

  /// @brief Method GetPath, addr 0x331ffc8, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDescendantOf, addr 0x331fea4, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method Reflect, addr 0x33200c4, size 0x18c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Quaternion Reflect(::UnityEngine::Quaternion source, ::UnityEngine::Vector3 normal);

  /// @brief Method Rotate, addr 0x33203ac, size 0x48, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 Rotate(::UnityEngine::Vector2 vector, float_t rads);

  /// @brief Method SetLocalPositionAndRotation, addr 0x331ff70, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSeed, addr 0x33203f4, size 0x7c, virtual false, abstract: false, final false
  static inline void SetSeed(::UnityEngine::ParticleSystem* particleSystem, uint32_t seed);

  /// @brief Method StartUniqueCoroutine, addr 0x331fdd4, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method StopUniqueCoroutine, addr 0x331fe58, size 0x4c, virtual false, abstract: false, final false
