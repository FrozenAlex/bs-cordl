...
// Write type traits
MARK_REF_T(::GlobalNamespace::FPSCounter*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FPSCounter*, "", "FPSCounter");
...
public:
  // Declarations
  /// @brief Field <currentFPS>k__BackingField, offset 0x20, size 0x4
  ...
  /// @brief Field <droppedFrames>k__BackingField, offset 0x2c, size 0x4
  ...
  /// @brief Field <lowestFPS>k__BackingField, offset 0x24, size 0x4
  ...
  /// @brief Method Awake, addr 0x570bb30, size 0x10, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::FPSCounter* New_ctor();

  /// @brief Method Update, addr 0x570bb40, size 0xd0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x570bc10, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_currentFPS, addr 0x570baf0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_currentFPS();

  /// @brief Method get_droppedFrames, addr 0x570bb20, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_droppedFrames();

  /// @brief Method get_highestFPS, addr 0x570bb10, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_highestFPS();

  /// @brief Method get_lowestFPS, addr 0x570bb00, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_lowestFPS();

  /// @brief Method set_currentFPS, addr 0x570baf8, size 0x8, virtual false, abstract: false, final false
  inline void set_currentFPS(int32_t value);

  /// @brief Method set_droppedFrames, addr 0x570bb28, size 0x8, virtual false, abstract: false, final false
  inline void set_droppedFrames(int32_t value);

  /// @brief Method set_highestFPS, addr 0x570bb18, size 0x8, virtual false, abstract: false, final false
  inline void set_highestFPS(int32_t value);

  /// @brief Method set_lowestFPS, addr 0x570bb08, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field _timeBuffer, offset: 0x30, size: 0x4, def value: None
  float_t ____timeBuffer;

  /// @brief Field _frameCounter, offset: 0x34, size: 0x4, def value: None
...
static_assert(offsetof(::GlobalNamespace::FPSCounter, ____highestFPS_k__BackingField) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::FPSCounter, ____droppedFrames_k__BackingField) == 0x2c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::FPSCounter, ____timeBuffer) == 0x30, "Offset mismatch!");
...
static_assert(sizeof(::GlobalNamespace::FPSCounter) == 0x40, "Size mismatch!");
