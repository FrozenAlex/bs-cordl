...
public:
  ...
  /// @brief Method MoveNext, addr 0x5e0816c, size 0xc4, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::FadeInOnSceneTransitionFinished__FadeCoroutine_d__4* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x5e08230, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5e08238, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5e08270, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5e08168, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5e08158, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FadeCoroutine, addr 0x5e080fc, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x5e08150, size 0x8, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnablePostInjection, addr 0x5e080dc, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e08160, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
