...
// Write type traits
MARK_REF_T(::GlobalNamespace::FadeOutInstantly*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FadeOutInstantly*, "", "FadeOutInstantly");
...
public:
  ...
  /// @brief Method Start, addr 0x5f3ded4, size 0x1c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5f3def0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::FadeOutInstantly) == 0x28, "Size mismatch!");
