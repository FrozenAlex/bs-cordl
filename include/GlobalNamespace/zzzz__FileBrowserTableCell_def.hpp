...
// Write type traits
MARK_REF_T(::GlobalNamespace::FileBrowserTableCell*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FileBrowserTableCell*, "", "FileBrowserTableCell");
...
public:
  ...
  /// @brief Method HighlightDidChange, addr 0x5920630, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method SelectionDidChange, addr 0x5920598, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5920670, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_text, addr 0x5920578, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method set_text, addr 0x5920558, size 0x20, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::FileBrowserTableCell, ____text) == 0x78, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::FileBrowserTableCell, ____bgImage) == 0x80, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::FileBrowserTableCell, ____highlightImage) == 0x88, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::FileBrowserTableCell) == 0x90, "Size mismatch!");
