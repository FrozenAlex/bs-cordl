...
// Write type traits
MARK_REF_T(::GlobalNamespace::FillIndicator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FillIndicator*, "", "FillIndicator");
...
static_assert(sizeof(::GlobalNamespace::FillIndicator) == 0x30, "Size mismatch!");
