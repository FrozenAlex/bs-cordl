...
// Write type traits
MARK_REF_T(::GlobalNamespace::FireEffectShaderHelper*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FireEffectShaderHelper*, "", "FireEffectShaderHelper");
...
static_assert(sizeof(::GlobalNamespace::FireEffectShaderHelper) == 0x10, "Size mismatch!");
