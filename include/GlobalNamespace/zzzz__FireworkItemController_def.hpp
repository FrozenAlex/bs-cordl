...
// Write type traits
MARK_REF_T(::GlobalNamespace::FireworkItemController*);
MARK_REF_T(::GlobalNamespace::FireworkItemController_FireworkItemParticleSystem*);
MARK_REF_T(::GlobalNamespace::FireworkItemController_Pool*);
MARK_REF_T(::GlobalNamespace::FireworkItemController__FireCoroutine_d__29*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FireworkItemController*, "", "FireworkItemController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FireworkItemController_FireworkItemParticleSystem*, "", "FireworkItemController/FireworkItemParticleSystem");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FireworkItemController_Pool*, "", "FireworkItemController/Pool");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FireworkItemController__FireCoroutine_d__29*, "", "FireworkItemController/<FireCoroutine>d__29");
...
public:
  ...
  /// @brief Method .ctor, addr 0x597e010, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::FireworkItemController_FireworkItemParticleSystem) == 0x30, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x597e01c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x597e05c, size 0x248, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::FireworkItemController__FireCoroutine_d__29* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x597e2a4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x597e2ac, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x597e2e4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x597e058, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x597dbd8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__explosionClips, put = __cordl_internal_set__explosionClips)) ::ArrayW<::UnityW<::UnityEngine::AudioClip>> _explosionClips;
  ...
  __declspec(property(get = __cordl_internal_get__particleSystems, put = __cordl_internal_set__particleSystems)) ::ArrayW<::GlobalNamespace::FireworkItemController_FireworkItemParticleSystem*>
      _particleSystems;
  ...
  /// @brief Method Awake, addr 0x597d980, size 0x84, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Fire, addr 0x597db64, size 0x20, virtual false, abstract: false, final false
  inline void Fire();

  /// @brief Method FireCoroutine, addr 0x597db84, size 0x54, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* FireCoroutine();

  /// @brief Method InitializeParticleSystem, addr 0x597dce4, size 0x310, virtual false, abstract: false, final false
  inline void InitializeParticleSystem();

  static inline ::GlobalNamespace::FireworkItemController* New_ctor();

  /// @brief Method OnDisable, addr 0x597da04, size 0x68, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method PlayExplosionSound, addr 0x597dbe0, size 0x104, virtual false, abstract: false, final false
  inline void PlayExplosionSound();

  /// @brief Method SetLightsColor, addr 0x597da6c, size 0xf8, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::AudioClip>> const& __cordl_internal_get__explosionClips() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::AudioClip>>& __cordl_internal_get__explosionClips();
  ...
  constexpr ::ArrayW<::GlobalNamespace::FireworkItemController_FireworkItemParticleSystem*> const& __cordl_internal_get__particleSystems() const;

  constexpr ::ArrayW<::GlobalNamespace::FireworkItemController_FireworkItemParticleSystem*>& __cordl_internal_get__particleSystems();
  ...
  constexpr void __cordl_internal_set__explosionClips(::ArrayW<::UnityW<::UnityEngine::AudioClip>> value);
  ...
  constexpr void __cordl_internal_set__particleSystems(::ArrayW<::GlobalNamespace::FireworkItemController_FireworkItemParticleSystem*> value);
  ...
  /// @brief Method .ctor, addr 0x597dff4, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x597d800, size 0xc0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::FireworkItemController>>* value);

  /// @brief Method remove_didFinishEvent, addr 0x597d8c0, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::FireworkItemController>>* value);

  /// @brief Method set_directionalLight, addr 0x597d7f0, size 0x8, virtual false, abstract: false, final false
  inline void set_directionalLight(::GlobalNamespace::DirectionalLight* value);

  /// @brief Method set_directionalLightIntensity, addr 0x597d7f8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::FireworkItemController) == 0xa0, "Size mismatch!");
