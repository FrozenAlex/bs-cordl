...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::FirstPersonFlyingController::*)()>(&::GlobalNamespace::FirstPersonFlyingController::OnEnable)> {
  ...
  constexpr static std::size_t addrs = 0x5918b78;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::FirstPersonFlyingController::*)()>(&::GlobalNamespace::FirstPersonFlyingController::Update)> {
  ...
  constexpr static std::size_t addrs = 0x5919054;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::FirstPersonFlyingController::*)(
  ...
  constexpr static std::size_t addrs = 0x59194f4;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::FirstPersonFlyingController::*)()>(&::GlobalNamespace::FirstPersonFlyingController::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x59195f0;
...
constexpr ::ArrayW<::UnityW<::UnityEngine::GameObject>>& GlobalNamespace::FirstPersonFlyingController::__cordl_internal_get__controllerModels() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____controllerModels;
}
constexpr ::ArrayW<::UnityW<::UnityEngine::GameObject>> const& GlobalNamespace::FirstPersonFlyingController::__cordl_internal_get__controllerModels() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____controllerModels;
}
constexpr void GlobalNamespace::FirstPersonFlyingController::__cordl_internal_set__controllerModels(::ArrayW<::UnityW<::UnityEngine::GameObject>> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____controllerModels = value;
}
...
constexpr ::GlobalNamespace::MouseLook* const& GlobalNamespace::FirstPersonFlyingController::__cordl_internal_get__mouseLook() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____mouseLook;
}
...
constexpr void GlobalNamespace::FirstPersonFlyingController::__cordl_internal_set__trackedPoseDriver(::UnityW<::UnityEngine::SpatialTracking::TrackedPoseDriver> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____trackedPoseDriver = value;
}
...
constexpr bool& GlobalNamespace::FirstPersonFlyingController::__cordl_internal_get__overrideDisableMovement() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____overrideDisableMovement;
}
constexpr bool const& GlobalNamespace::FirstPersonFlyingController::__cordl_internal_get__overrideDisableMovement() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____overrideDisableMovement;
}
constexpr void GlobalNamespace::FirstPersonFlyingController::__cordl_internal_set__overrideDisableMovement(bool value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline ::GlobalNamespace::FirstPersonFlyingController* GlobalNamespace::FirstPersonFlyingController::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::FirstPersonFlyingController*>());
}
// Ctor Parameters []
