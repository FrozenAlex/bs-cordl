...
// Write type traits
MARK_REF_T(::GlobalNamespace::FixedUpdateVector3SmoothValue*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FixedUpdateVector3SmoothValue*, "", "FixedUpdateVector3SmoothValue");
...
public:
  // Declarations
  /// @brief Method Interpolate, addr 0x570d828, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x570d7d8, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::FixedUpdateVector3SmoothValue) == 0x30, "Size mismatch!");
