...
// Write type traits
MARK_REF_T(::GlobalNamespace::FloatFxBaseData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FloatFxBaseData*, "", "FloatFxBaseData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3657db8, size 0x14, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::FloatFxBaseData) == 0x20, "Size mismatch!");
