...
// Write type traits
MARK_REF_T(::GlobalNamespace::FloatSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FloatSO*, "", "FloatSO");
...
public:
  ...
  /// @brief Method .ctor, addr 0x33241e0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::FloatSO) == 0x28, "Size mismatch!");
