...
MARK_REF_T(::GlobalNamespace::FloatTextureProcessor3DMappingFloatEffectTarget*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FloatTextureProcessor3DMappingFloatEffectTarget_TextureProcessor3DMapping, "", "FloatTextureProcessor3DMappingFloatEffectTarget/TextureProcessor3DMapping");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FloatTextureProcessor3DMappingFloatEffectTarget*, "", "FloatTextureProcessor3DMappingFloatEffectTarget");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::FloatTextureProcessor3DMappingFloatEffectTarget_TextureProcessor3DMapping) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::FloatTextureProcessor3DMappingFloatEffectTarget) == 0x48, "Size mismatch!");
