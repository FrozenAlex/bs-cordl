...
// Write type traits
MARK_REF_T(::GlobalNamespace::FlyingScoreEffect*);
MARK_REF_T(::GlobalNamespace::FlyingScoreEffect_Pool*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FlyingScoreEffect*, "", "FlyingScoreEffect");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FlyingScoreEffect_Pool*, "", "FlyingScoreEffect/Pool");
...
static_assert(sizeof(::GlobalNamespace::FlyingScoreEffect) == 0xc0, "Size mismatch!");
