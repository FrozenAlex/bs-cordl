...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::FlyingSpriteEffect_Pool::*)()>(&::GlobalNamespace::FlyingSpriteEffect_Pool::_ctor)> {
  constexpr static std::size_t size = 0x3c;
  constexpr static std::size_t addrs = 0x5849368;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::FlyingSpriteEffect_Pool*>(), { ".ctor", {}, {} })));
...
inline ::GlobalNamespace::FlyingSpriteEffect_Pool* GlobalNamespace::FlyingSpriteEffect_Pool::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::FlyingSpriteEffect_Pool*>());
}
// Ctor Parameters []
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::FlyingSpriteEffect::*)(float_t, ::UnityEngine::Vector3, ::UnityEngine::Quaternion, ::UnityEngine::Sprite*,
                                                                                                       ::UnityEngine::Material*, ::UnityEngine::Color, bool)>(
    &::GlobalNamespace::FlyingSpriteEffect::InitAndPresent)> {
  constexpr static std::size_t size = 0xb4;
  constexpr static std::size_t addrs = 0x5849224;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{},
                     (::i2c::find_method(::i2c::class_of<::GlobalNamespace::FlyingSpriteEffect*>(),
                                         { "InitAndPresent",
                                           {},
                                           { ::i2c::type_of<float_t>(), ::i2c::type_of<::UnityEngine::Vector3>(), ::i2c::type_of<::UnityEngine::Quaternion>(), ::i2c::type_of<::UnityEngine::Sprite*>(),
                                             ::i2c::type_of<::UnityEngine::Material*>(), ::i2c::type_of<::UnityEngine::Color>(), ::i2c::type_of<bool>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::FlyingSpriteEffect::*)(float_t)>(&::GlobalNamespace::FlyingSpriteEffect::ManualUpdate)> {
  constexpr static std::size_t size = 0x5c;
  constexpr static std::size_t addrs = 0x58492d8;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::GlobalNamespace::FlyingSpriteEffect*>(), { ::i2c::class_of<::GlobalNamespace::FlyingSpriteEffect*>(), 4 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::FlyingSpriteEffect::*)()>(&::GlobalNamespace::FlyingSpriteEffect::_ctor)> {
  constexpr static std::size_t size = 0x34;
  constexpr static std::size_t addrs = 0x5849334;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::FlyingSpriteEffect*>(), { ".ctor", {}, {} })));
    return ___internal_method;
  }
};
      ...
      THROW_UNLESS(::i2c::no_logger{},
                   (::i2c::find_method(::i2c::class_of<::GlobalNamespace::FlyingSpriteEffect*>(),
                                       { "InitAndPresent",
                                         ...
                                         { ::i2c::type_of<float_t>(), ::i2c::type_of<::UnityEngine::Vector3>(), ::i2c::type_of<::UnityEngine::Quaternion>(), ::i2c::type_of<::UnityEngine::Sprite*>(),
                                           ::i2c::type_of<::UnityEngine::Material*>(), ::i2c::type_of<::UnityEngine::Color>(), ::i2c::type_of<bool>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, duration, targetPos, rotation, sprite, material, color, shake);
}
inline void GlobalNamespace::FlyingSpriteEffect::ManualUpdate(float_t t) {
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::FlyingSpriteEffect*>(), 4 })));
...
inline ::GlobalNamespace::FlyingSpriteEffect* GlobalNamespace::FlyingSpriteEffect::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::FlyingSpriteEffect*>());
}
// Ctor Parameters []
