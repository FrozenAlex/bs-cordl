...
// Write type traits
MARK_REF_T(::GlobalNamespace::FlyingTextEffect*);
MARK_REF_T(::GlobalNamespace::FlyingTextEffect_Pool*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FlyingTextEffect*, "", "FlyingTextEffect");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FlyingTextEffect_Pool*, "", "FlyingTextEffect/Pool");
...
static_assert(sizeof(::GlobalNamespace::FlyingTextEffect_Pool) == 0x40, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::FlyingTextEffect) == 0xa8, "Size mismatch!");
