...
public:
  ...
  /// @brief Method ApplyValue, addr 0x5a0c7ac, size 0x30, virtual true, abstract: false, final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method GetInitValues, addr 0x5a0c784, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x5a0c770, size 0x14, virtual false, abstract: false, final false
  inline void SetValue(int32_t value, bool callCallback);

  /// @brief Method TextForValue, addr 0x5a0c7dc, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a0c840, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_valueDidChangeEvent, addr 0x5a0c5f0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_value, addr 0x5a0c5e8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_value();

  /// @brief Method remove_valueDidChangeEvent, addr 0x5a0c6b0, size 0xc0, virtual false, abstract: false, final false
