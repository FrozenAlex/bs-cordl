...
public:
  ...
  /// @brief Method HandleComboBreakingEventHappened, addr 0x5916bf0, size 0x3c, virtual false, abstract: false, final false
  inline void HandleComboBreakingEventHappened();

  /// @brief Method Init, addr 0x5916978, size 0x168, virtual true, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::FullComboMissionObjectiveChecker* New_ctor();

  /// @brief Method OnDestroy, addr 0x5916ae0, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5916c2c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
