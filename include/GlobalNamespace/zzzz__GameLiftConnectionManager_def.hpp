...
namespace GlobalNamespace {
struct GameLiftConnectionManager__GameLiftConnectToServer_d__83;
}
namespace GlobalNamespace {
struct GameLiftConnectionManager__GetGameLiftPlayerSessionInfo_d__82;
}
namespace GlobalNamespace {
...
MARK_REF_T(::GlobalNamespace::GameLiftConnectionManager*);
MARK_REF_T(::GlobalNamespace::GameLiftConnectionManager_ConnectToServerParams*);
MARK_REF_T(::GlobalNamespace::GameLiftConnectionManager_GameLiftConnectionManagerParamsBase*);
MARK_REF_T(::GlobalNamespace::GameLiftConnectionManager_StartClientParams*);
MARK_VAL_T(::GlobalNamespace::GameLiftConnectionManager__GameLiftConnectToServer_d__83);
MARK_VAL_T(::GlobalNamespace::GameLiftConnectionManager__GetGameLiftPlayerSessionInfo_d__82);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameLiftConnectionManager_ConnectionState, "", "GameLiftConnectionManager/ConnectionState");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameLiftConnectionManager*, "", "GameLiftConnectionManager");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameLiftConnectionManager_ConnectToServerParams*, "", "GameLiftConnectionManager/ConnectToServerParams");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameLiftConnectionManager_GameLiftConnectionManagerParamsBase*, "", "GameLiftConnectionManager/GameLiftConnectionManagerParamsBase");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameLiftConnectionManager_StartClientParams*, "", "GameLiftConnectionManager/StartClientParams");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameLiftConnectionManager__GameLiftConnectToServer_d__83, "", "GameLiftConnectionManager/<GameLiftConnectToServer>d__83");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameLiftConnectionManager__GetGameLiftPlayerSessionInfo_d__82, "", "GameLiftConnectionManager/<GetGameLiftPlayerSessionInfo>d__82");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::GameLiftConnectionManager_ConnectionState) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3212b20, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::GameLiftConnectionManager_GameLiftConnectionManagerParamsBase) == 0x60, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3212b5c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::GameLiftConnectionManager_ConnectToServerParams) == 0x70, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3212b84, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
...
namespace GlobalNamespace {
// Is value type: true
// CS Name: GameLiftConnectionManager/<GameLiftConnectToServer>d__83
struct CORDL_TYPE GameLiftConnectionManager__GameLiftConnectToServer_d__83 {
public:
  // Declarations
  /// @brief Convert operator to "::System::Runtime::CompilerServices::IAsyncStateMachine"
  constexpr operator ::System::Runtime::CompilerServices::IAsyncStateMachine*();

  /// @brief Method MoveNext, addr 0x3212bac, size 0x514, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x32130c0, size 0x8, virtual true, abstract: false, final true
  ...
  constexpr GameLiftConnectionManager__GameLiftConnectToServer_d__83(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder,
...
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::GameLiftConnectionManager__GameLiftConnectToServer_d__83, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameLiftConnectionManager__GameLiftConnectToServer_d__83, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameLiftConnectionManager__GameLiftConnectToServer_d__83, __4__this) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameLiftConnectionManager__GameLiftConnectToServer_d__83, cancellationToken) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameLiftConnectionManager__GameLiftConnectToServer_d__83, secret) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameLiftConnectionManager__GameLiftConnectToServer_d__83, code) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameLiftConnectionManager__GameLiftConnectToServer_d__83, __u__1) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameLiftConnectionManager__GameLiftConnectToServer_d__83, __u__2) == 0x50, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::GameLiftConnectionManager__GameLiftConnectToServer_d__83) == 0x58, "Size mismatch!");
...
namespace GlobalNamespace {
// Is value type: true
// CS Name: GameLiftConnectionManager/<GetGameLiftPlayerSessionInfo>d__82
struct CORDL_TYPE GameLiftConnectionManager__GetGameLiftPlayerSessionInfo_d__82 {
public:
  // Declarations
  /// @brief Convert operator to "::System::Runtime::CompilerServices::IAsyncStateMachine"
  constexpr operator ::System::Runtime::CompilerServices::IAsyncStateMachine*();

  /// @brief Method MoveNext, addr 0x32130c8, size 0x3d0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3213498, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::GameLiftConnectionManager__GetGameLiftPlayerSessionInfo_d__82, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameLiftConnectionManager__GetGameLiftPlayerSessionInfo_d__82, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameLiftConnectionManager__GetGameLiftPlayerSessionInfo_d__82, __4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameLiftConnectionManager__GetGameLiftPlayerSessionInfo_d__82, authenticationTokenProvider) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameLiftConnectionManager__GetGameLiftPlayerSessionInfo_d__82, secret) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameLiftConnectionManager__GetGameLiftPlayerSessionInfo_d__82, code) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameLiftConnectionManager__GetGameLiftPlayerSessionInfo_d__82, cancellationToken) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameLiftConnectionManager__GetGameLiftPlayerSessionInfo_d__82, __u__1) == 0x48, "Offset mismatch!");
...
public:
  ...
  using _GameLiftConnectToServer_d__83 = ::GlobalNamespace::GameLiftConnectionManager__GameLiftConnectToServer_d__83;

  using _GetGameLiftPlayerSessionInfo_d__82 = ::GlobalNamespace::GameLiftConnectionManager__GetGameLiftPlayerSessionInfo_d__82;
  ...
  /// @brief Method Disconnect, addr 0x32120d4, size 0x8, virtual true, abstract: false, final true
  inline void Disconnect(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method DisconnectInternal, addr 0x32123a0, size 0xc, virtual false, abstract: false, final false
  inline void DisconnectInternal(::GlobalNamespace::ConnectionFailedReason connectionFailedReason);

  /// @brief Method DisconnectInternal, addr 0x32120dc, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x3212030, size 0xa4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DisposeAsync, addr 0x3211f8c, size 0xa4, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::ValueTask DisposeAsync();

  /// @brief Method GameLiftConnectToServer, addr 0x32125fc, size 0xc8, virtual false, abstract: false, final false
  inline void GameLiftConnectToServer(::StringW secret, ::StringW code, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method GetConnection, addr 0x32123ac, size 0xb8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::IConnection* GetConnection(int32_t index);

  /// @brief Method GetGameLiftPlayerSessionInfo, addr 0x32124f4, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method GetPublicServers, addr 0x3212ac4, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleConnectToServerSuccess, addr 0x32126c4, size 0x400, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleConnected, addr 0x3212464, size 0x30, virtual false, abstract: false, final false
  inline void HandleConnected();

  /// @brief Method HandleConnectionConnected, addr 0x3212494, size 0x1c, virtual false, abstract: false, final false
  inline void HandleConnectionConnected(::GlobalNamespace::IConnection* connection);

  /// @brief Method HandleConnectionDisconnected, addr 0x32124b0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleConnectionFailed, addr 0x32124cc, size 0xc, virtual false, abstract: false, final false
  inline void HandleConnectionFailed(::GlobalNamespace::ConnectionFailedReason failedReason);

  /// @brief Method HandleReceivedData, addr 0x32124d8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method PollUpdate, addr 0x32118ec, size 0xa4, virtual true, abstract: false, final true
  inline void PollUpdate();

  /// @brief Method SendToAll, addr 0x321175c, size 0xc0, virtual true, abstract: false, final true
  inline void SendToAll(::LiteNetLib::Utils::NetDataWriter* writer, ::BGNet::Core::DeliveryMethod deliveryMethod);

  /// @brief Method SendToAll, addr 0x321181c, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3211990, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3211a6c, size 0x520, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onConnectedEvent, addr 0x3210938, size 0xac, virtual true, abstract: false, final true
  inline void add_onConnectedEvent(::System::Action* value);

  /// @brief Method add_onConnectionConnectedEvent, addr 0x3210d90, size 0xc0, virtual true, abstract: false, final true
  inline void add_onConnectionConnectedEvent(::System::Action_1<::GlobalNamespace::IConnection*>* value);

  /// @brief Method add_onConnectionDisconnectedEvent, addr 0x3210f10, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method add_onConnectionFailedEvent, addr 0x3210c10, size 0xc0, virtual true, abstract: false, final true
  inline void add_onConnectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>* value);

  /// @brief Method add_onDisconnectedEvent, addr 0x3210a90, size 0xc0, virtual true, abstract: false, final true
  inline void add_onDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method add_onInitializedEvent, addr 0x32107e0, size 0xac, virtual true, abstract: false, final true
  inline void add_onInitializedEvent(::System::Action* value);

  /// @brief Method add_onReceivedDataEvent, addr 0x3211090, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method get_code, addr 0x321174c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_code();

  /// @brief Method get_compatibilityVersion, addr 0x3211660, size 0xa8, virtual true, abstract: false, final true
  inline ::StringW get_compatibilityVersion();

  /// @brief Method get_configuration, addr 0x3211738, size 0x14, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayServerConfiguration get_configuration();

  /// @brief Method get_connectionCount, addr 0x3211468, size 0xa8, virtual true, abstract: false, final true
  inline int32_t get_connectionCount();

  /// @brief Method get_isConnected, addr 0x3211438, size 0x10, virtual true, abstract: false, final true
  inline bool get_isConnected();

  /// @brief Method get_isConnecting, addr 0x3211448, size 0x10, virtual true, abstract: false, final true
  inline bool get_isConnecting();

  /// @brief Method get_isConnectionOwner, addr 0x3211510, size 0xa8, virtual true, abstract: false, final true
  inline bool get_isConnectionOwner();

  /// @brief Method get_isDisconnecting, addr 0x3211458, size 0x10, virtual true, abstract: false, final true
  inline bool get_isDisconnecting();

  /// @brief Method get_isDisposed, addr 0x32115b8, size 0xa8, virtual true, abstract: false, final true
  inline bool get_isDisposed();

  /// @brief Method get_playerSessionId, addr 0x3211708, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_playerSessionId();

  /// @brief Method get_secret, addr 0x3211754, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_secret();

  /// @brief Method get_selectionMask, addr 0x3211720, size 0x18, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevelSelectionMask get_selectionMask();

  /// @brief Method get_userId, addr 0x3211210, size 0x114, virtual true, abstract: false, final true
  inline ::StringW get_userId();

  /// @brief Method get_userName, addr 0x3211324, size 0x114, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_onConnectedEvent, addr 0x32109e4, size 0xac, virtual true, abstract: false, final true
  inline void remove_onConnectedEvent(::System::Action* value);

  /// @brief Method remove_onConnectionConnectedEvent, addr 0x3210e50, size 0xc0, virtual true, abstract: false, final true
  inline void remove_onConnectionConnectedEvent(::System::Action_1<::GlobalNamespace::IConnection*>* value);

  /// @brief Method remove_onConnectionDisconnectedEvent, addr 0x3210fd0, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_onConnectionFailedEvent, addr 0x3210cd0, size 0xc0, virtual true, abstract: false, final true
  inline void remove_onConnectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>* value);

  /// @brief Method remove_onDisconnectedEvent, addr 0x3210b50, size 0xc0, virtual true, abstract: false, final true
  inline void remove_onDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method remove_onInitializedEvent, addr 0x321088c, size 0xac, virtual true, abstract: false, final true
  inline void remove_onInitializedEvent(::System::Action* value);

  /// @brief Method remove_onReceivedDataEvent, addr 0x3211150, size 0xc0, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::GameLiftConnectionManager) == 0xd8, "Size mismatch!");
