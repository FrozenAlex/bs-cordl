...
public:
  ...
  /// @brief Method MoveNext, addr 0x376a870, size 0x450, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x376acc0, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method HandleSceneContextPostInstall, addr 0x376a6f0, size 0x17c, virtual false, abstract: false, final false
  inline void HandleSceneContextPostInstall();

  static inline ::GlobalNamespace::GameLoader* New_ctor();

  /// @brief Method Start, addr 0x376a64c, size 0xa4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x376a86c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
