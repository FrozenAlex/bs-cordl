...
// Write type traits
MARK_REF_T(::GlobalNamespace::GameObjectIntSwitchEventEffect*);
MARK_REF_T(::GlobalNamespace::GameObjectIntSwitchEventEffect_GameObjectValueList*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameObjectIntSwitchEventEffect*, "", "GameObjectIntSwitchEventEffect");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameObjectIntSwitchEventEffect_GameObjectValueList*, "", "GameObjectIntSwitchEventEffect/GameObjectValueList");
...
public:
  ...
  /// @brief Method SetActive, addr 0x5853c6c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5853e74, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isActive, addr 0x5853e64, size 0x8, virtual false, abstract: false, final false
  inline bool get_isActive();

  /// @brief Method set_isActive, addr 0x5853e6c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::GameObjectIntSwitchEventEffect_GameObjectValueList) == 0x28, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies BasicBeatmapEventType, GameObjectIntSwitchEventEffect::GameObjectValueList, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method HandleBasicBeatmapEventData, addr 0x5853d00, size 0x160, virtual false, abstract: false, final false
  inline void HandleBasicBeatmapEventData(::GlobalNamespace::BasicBeatmapEventData* data);

  /// @brief Method Initialize, addr 0x5853a64, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5853cdc, size 0x24, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::GameObjectIntSwitchEventEffect_GameObjectValueList*> const& __cordl_internal_get__gameObjectsValueLists() const;

  constexpr ::ArrayW<::GlobalNamespace::GameObjectIntSwitchEventEffect_GameObjectValueList*>& __cordl_internal_get__gameObjectsValueLists();
  ...
  constexpr void __cordl_internal_set__gameObjectsValueLists(::ArrayW<::GlobalNamespace::GameObjectIntSwitchEventEffect_GameObjectValueList*> value);
  ...
  /// @brief Method .ctor, addr 0x5853e60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::GameObjectIntSwitchEventEffect) == 0x58, "Size mismatch!");
