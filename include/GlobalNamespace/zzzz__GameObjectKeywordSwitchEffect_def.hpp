...
// Write type traits
MARK_REF_T(::GlobalNamespace::GameObjectKeywordSwitchEffect*);
MARK_REF_T(::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameObjectKeywordSwitchEffect*, "", "GameObjectKeywordSwitchEffect");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*, "", "GameObjectKeywordSwitchEffect/GameObjectKeywordItem");
...
public:
  ...
  /// @brief Method .ctor, addr 0x598a8e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem) == 0x20, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies GameObjectKeywordSwitchEffect::GameObjectKeywordItem, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method Initialize, addr 0x598a798, size 0x148, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*> const& __cordl_internal_get__gameObjectKeywordItems() const;

  constexpr ::ArrayW<::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*>& __cordl_internal_get__gameObjectKeywordItems();
  ...
  /// @brief Method .ctor, addr 0x598a8e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::GameObjectKeywordSwitchEffect) == 0x30, "Size mismatch!");
