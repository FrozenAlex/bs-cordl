...
public:
  ...
  __declspec(property(get = __cordl_internal_get__activateOnBoostObjects, put = __cordl_internal_set__activateOnBoostObjects)) ::ArrayW<::UnityW<::UnityEngine::GameObject>> _activateOnBoostObjects;
  ...
  /// @brief Method HandleBeatmapEvent, addr 0x5854094, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5854078, size 0x1c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x5853fc8, size 0xb0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method ToggleObjects, addr 0x58540a8, size 0xb4, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::GameObject>>& __cordl_internal_get__activateOnBoostObjects();
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::GameObject>> const& __cordl_internal_get__deactivateOnBoostObjects() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::GameObject>>& __cordl_internal_get__deactivateOnBoostObjects();

  constexpr void __cordl_internal_set__activateOnBoostObjects(::ArrayW<::UnityW<::UnityEngine::GameObject>> value);
  ...
  /// @brief Method .ctor, addr 0x585415c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::GameObjectSwitchEventEffect) == 0x40, "Size mismatch!");
