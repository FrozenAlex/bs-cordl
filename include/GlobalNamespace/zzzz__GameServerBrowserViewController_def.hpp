...
// Write type traits
MARK_REF_T(::GlobalNamespace::GameServerBrowserViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameServerBrowserViewController*, "", "GameServerBrowserViewController");
...
public:
  ...
  /// @brief Method .ctor, addr 0x582f2f0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::GameServerBrowserViewController) == 0xa8, "Size mismatch!");
