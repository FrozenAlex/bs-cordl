...
// Write type traits
MARK_REF_T(::GlobalNamespace::GameServerListItem*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameServerListItem*, "", "GameServerListItem");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3730fe0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::GameServerListItem) == 0x28, "Size mismatch!");
