...
// Write type traits
MARK_REF_T(::GlobalNamespace::GameServersListTableView*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameServersListTableView*, "", "GameServersListTableView");
// Dependencies INetworkPlayer, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__gamesList, put = __cordl_internal_set__gamesList)) ::ArrayW<::GlobalNamespace::INetworkPlayer*> _gamesList;
  ...
  /// @brief Method CellForContent, addr 0x57b2988, size 0x174, virtual true, abstract: false, final true
  ...
  /// @brief Method CellForDetail, addr 0x57b2afc, size 0x1cc, virtual true, abstract: false, final true
  inline ::UnityW<::HMUI::TableCell> CellForDetail(::GlobalNamespace::TableViewWithDetailCell* tableView, int32_t contentIdx);

  /// @brief Method CellSize, addr 0x57b2830, size 0xc, virtual true, abstract: false, final true
  inline float_t CellSize();

  /// @brief Method HandleGameServerListDetailTableCellJoinServerButtonWasPressed, addr 0x57b2df8, size 0x24, virtual false, abstract: false, final false
  inline void HandleGameServerListDetailTableCellJoinServerButtonWasPressed();

  /// @brief Method HandleTableViewDidDeselectCellWithIdx, addr 0x57b2e50, size 0x8, virtual false, abstract: false, final false
  inline void HandleTableViewDidDeselectCellWithIdx(::GlobalNamespace::TableViewWithDetailCell* arg1, int32_t arg2);

  /// @brief Method HandleTableViewDidSelectCellWithIdx, addr 0x57b2e1c, size 0x34, virtual false, abstract: false, final false
  inline void HandleTableViewDidSelectCellWithIdx(::HMUI::TableView* tableView, int32_t id);

  /// @brief Method Init, addr 0x57b2854, size 0x134, virtual false, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::GameServersListTableView* New_ctor();

  /// @brief Method NumberOfCells, addr 0x57b283c, size 0x18, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method OnDestroy, addr 0x57b2e58, size 0xf4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetData, addr 0x57b2cc8, size 0x130, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::INetworkPlayer*> const& __cordl_internal_get__gamesList() const;

  constexpr ::ArrayW<::GlobalNamespace::INetworkPlayer*>& __cordl_internal_get__gamesList();
  ...
  constexpr void __cordl_internal_set__gamesList(::ArrayW<::GlobalNamespace::INetworkPlayer*> value);
  ...
  /// @brief Method .ctor, addr 0x57b2f4c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_joinButtonPressedEvent, addr 0x57b26b0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_joinButtonPressedEvent, addr 0x57b2770, size 0xc0, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::GlobalNamespace::INetworkPlayer*> ____gamesList;
...
static_assert(sizeof(::GlobalNamespace::GameServersListTableView) == 0x60, "Size mismatch!");
