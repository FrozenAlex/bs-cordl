...
// Write type traits
MARK_REF_T(::GlobalNamespace::GameSessionAnalyticsManager*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameSessionAnalyticsManager*, "", "GameSessionAnalyticsManager");
...
static_assert(sizeof(::GlobalNamespace::GameSessionAnalyticsManager) == 0x30, "Size mismatch!");
