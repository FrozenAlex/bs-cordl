...
// Write type traits
MARK_REF_T(::GlobalNamespace::GameState*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameState*, "", "GameState");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3219af0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::GameState) == 0x18, "Size mismatch!");
