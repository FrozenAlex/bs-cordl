...
static_assert(offsetof(::GlobalNamespace::GameplayAdditionalInformation, ___useTestNoteCutSoundEffects) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayAdditionalInformation, ___startPaused) == 0x19, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayAdditionalInformation, ___playmodeOptions) == 0x1c, "Offset mismatch!");
