...
namespace GlobalNamespace {
struct GameplayCoreSceneSetupData__LoadTransformedBeatmapDataAsync_d__33;
}
namespace GlobalNamespace {
...
MARK_VAL_T(::GlobalNamespace::GameplayCoreSceneSetupData__LoadTransformedBeatmapDataAsync_d__33);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameplayCoreSceneSetupData*, "", "GameplayCoreSceneSetupData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameplayCoreSceneSetupData__LoadTransformedBeatmapDataAsync_d__33, "", "GameplayCoreSceneSetupData/<LoadTransformedBeatmapDataAsync>d__33");
...
struct CORDL_TYPE GameplayCoreSceneSetupData__LoadTransformedBeatmapDataAsync_d__33 {
public:
  // Declarations
  /// @brief Convert operator to "::System::Runtime::CompilerServices::IAsyncStateMachine"
  constexpr operator ::System::Runtime::CompilerServices::IAsyncStateMachine*();

  /// @brief Method MoveNext, addr 0x57edbbc, size 0xa84, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x57ee640, size 0x6c, virtual true, abstract: false, final true
  ...
  // Ctor Parameters []
  // @brief default ctor
  constexpr GameplayCoreSceneSetupData__LoadTransformedBeatmapDataAsync_d__33();
  ...
  constexpr GameplayCoreSceneSetupData__LoadTransformedBeatmapDataAsync_d__33(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder __t__builder,
...
static_assert(offsetof(::GlobalNamespace::GameplayCoreSceneSetupData__LoadTransformedBeatmapDataAsync_d__33, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayCoreSceneSetupData__LoadTransformedBeatmapDataAsync_d__33, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayCoreSceneSetupData__LoadTransformedBeatmapDataAsync_d__33, __4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayCoreSceneSetupData__LoadTransformedBeatmapDataAsync_d__33, _beatmapLevelDataVersion_5__2) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayCoreSceneSetupData__LoadTransformedBeatmapDataAsync_d__33, __u__1) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayCoreSceneSetupData__LoadTransformedBeatmapDataAsync_d__33, __u__2) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayCoreSceneSetupData__LoadTransformedBeatmapDataAsync_d__33, __u__3) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayCoreSceneSetupData__LoadTransformedBeatmapDataAsync_d__33, __u__4) == 0x48, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::GameplayCoreSceneSetupData__LoadTransformedBeatmapDataAsync_d__33) == 0x50, "Size mismatch!");
...
public:
  // Declarations
  using _LoadTransformedBeatmapDataAsync_d__33 = ::GlobalNamespace::GameplayCoreSceneSetupData__LoadTransformedBeatmapDataAsync_d__33;
  ...
  /// @brief Field beatmapBasicData, offset 0x30, size 0x8
  ...
  /// @brief Field playerSpecificSettings, offset 0x48, size 0x8
  ...
  /// @brief Field practiceSettings, offset 0x50, size 0x8
  ...
  /// @brief Method ApplyDisableUpdateAlwaysConfiguration, addr 0x57ed688, size 0x7c, virtual false, abstract: false, final false
  inline void ApplyDisableUpdateAlwaysConfiguration();

  /// @brief Method LoadTransformedBeatmapData, addr 0x57ed704, size 0x398, virtual false, abstract: false, final false
  inline void LoadTransformedBeatmapData();

  /// @brief Method LoadTransformedBeatmapDataAsync, addr 0x57edb08, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method TransformBeatmapData, addr 0x57eda9c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57ed3f0, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatmapLevelData, addr 0x57ed3d0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IBeatmapLevelData* get_beatmapLevelData();

  /// @brief Method get_songAudioClip, addr 0x57ed3c0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::AudioClip> get_songAudioClip();

  /// @brief Method get_transformedBeatmapData, addr 0x57ed3e0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IReadonlyBeatmapData* get_transformedBeatmapData();

  /// @brief Method set_beatmapLevelData, addr 0x57ed3d8, size 0x8, virtual false, abstract: false, final false
  inline void set_beatmapLevelData(::GlobalNamespace::IBeatmapLevelData* value);

  /// @brief Method set_songAudioClip, addr 0x57ed3c8, size 0x8, virtual false, abstract: false, final false
  inline void set_songAudioClip(::UnityEngine::AudioClip* value);

  /// @brief Method set_transformedBeatmapData, addr 0x57ed3e8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field beatmapBasicData, offset: 0x30, size: 0x8, def value: None
  ...
  /// @brief Field playerSpecificSettings, offset: 0x48, size: 0x8, def value: None
  ::GlobalNamespace::PlayerSpecificSettings* ___playerSpecificSettings;

  /// @brief Field practiceSettings, offset: 0x50, size: 0x8, def value: None
...
static_assert(offsetof(::GlobalNamespace::GameplayCoreSceneSetupData, ___beatmapBasicData) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayCoreSceneSetupData, ___beatmapLevel) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayCoreSceneSetupData, ___gameplayModifiers) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayCoreSceneSetupData, ___playerSpecificSettings) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayCoreSceneSetupData, ___practiceSettings) == 0x50, "Offset mismatch!");
...
static_assert(sizeof(::GlobalNamespace::GameplayCoreSceneSetupData) == 0xc8, "Size mismatch!");
