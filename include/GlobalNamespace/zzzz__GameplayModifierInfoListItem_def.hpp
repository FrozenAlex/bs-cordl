...
// Write type traits
MARK_REF_T(::GlobalNamespace::GameplayModifierInfoListItem*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameplayModifierInfoListItem*, "", "GameplayModifierInfoListItem");
...
public:
  ...
  /// @brief Method SetModifier, addr 0x5a2c600, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a2c78c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23585 };
...
static_assert(sizeof(::GlobalNamespace::GameplayModifierInfoListItem) == 0x30, "Size mismatch!");
