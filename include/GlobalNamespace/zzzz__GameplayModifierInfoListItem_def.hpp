...
public:
  ...
  /// @brief Method SetModifier, addr 0x58f50b8, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58f5244, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
