...
// Write type traits
MARK_REF_T(::GlobalNamespace::GameplayModifierToggle*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameplayModifierToggle*, "", "GameplayModifierToggle");
...
public:
  // Declarations
  /// @brief Field _gameplayModifier, offset 0x20, size 0x8
  ...
  /// @brief Field _hoverTextSetter, offset 0x38, size 0x8
  ...
  /// @brief Field _positiveColor, offset 0x50, size 0x10
  ...
  /// @brief Field _toggle, offset 0x48, size 0x8
  ...
  /// @brief Method Start, addr 0x58f5258, size 0x3cc, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x58f5624, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_gameplayModifier, addr 0x58f5250, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::GameplayModifierParamsSO> get_gameplayModifier();

  /// @brief Method get_toggle, addr 0x58f5248, size 0x8, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::GameplayModifierToggle, ____gameplayModifier) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayModifierToggle, ____nameText) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayModifierToggle, ____multiplierText) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayModifierToggle, ____hoverTextSetter) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayModifierToggle, ____icon) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayModifierToggle, ____toggle) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayModifierToggle, ____positiveColor) == 0x50, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::GameplayModifierToggle) == 0x60, "Size mismatch!");
