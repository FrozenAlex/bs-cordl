...
// Write type traits
MARK_REF_T(::GlobalNamespace::GameplayModifiersConfiguration*);
MARK_REF_T(::GlobalNamespace::GameplayModifiersConfiguration_CutAngleTolerance*);
MARK_REF_T(::GlobalNamespace::GameplayModifiersConfiguration_NoteUniformScale*);
MARK_REF_T(::GlobalNamespace::GameplayModifiersConfiguration_SongSpeed*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameplayModifiersConfiguration*, "", "GameplayModifiersConfiguration");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameplayModifiersConfiguration_CutAngleTolerance*, "", "GameplayModifiersConfiguration/CutAngleTolerance");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameplayModifiersConfiguration_NoteUniformScale*, "", "GameplayModifiersConfiguration/NoteUniformScale");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameplayModifiersConfiguration_SongSpeed*, "", "GameplayModifiersConfiguration/SongSpeed");
...
static_assert(sizeof(::GlobalNamespace::GameplayModifiersConfiguration_SongSpeed) == 0x10, "Size mismatch!");
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::GameplayModifiersConfiguration_CutAngleTolerance) == 0x10, "Size mismatch!");
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::GameplayModifiersConfiguration_NoteUniformScale) == 0x10, "Size mismatch!");
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::GameplayModifiersConfiguration) == 0x10, "Size mismatch!");
