...
public:
  ...
  /// @brief Method CreateFromSerializedData, addr 0x32ad918, size 0x34, virtual true, abstract: false, final true
  inline ::GlobalNamespace::GameplayServerConfiguration CreateFromSerializedData(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Deserialize, addr 0x32ad94c, size 0xc4, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::GameplayServerConfiguration Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Equals, addr 0x32ad724, size 0xcc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x32ad720, size 0x4, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::GameplayServerConfiguration other);

  /// @brief Method Equals, addr 0x32ad6b4, size 0x6c, virtual false, abstract: false, final false
  inline bool Equals(::by_ref<::GlobalNamespace::GameplayServerConfiguration> other);

  /// @brief Method GetHashCode, addr 0x32ad7f0, size 0x40, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Serialize, addr 0x32ad84c, size 0xcc, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method WithMaxPlayerCount, addr 0x32ada10, size 0x18, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayServerConfiguration WithMaxPlayerCount(int32_t maxPlayerCount);

  /// @brief Method .ctor, addr 0x32a7de4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x32ad830, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x32ad834, size 0x18, virtual false, abstract: false, final false
