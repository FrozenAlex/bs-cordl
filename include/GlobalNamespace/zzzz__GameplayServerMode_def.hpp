...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameplayServerMode, "", "GameplayServerMode");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
public:
  ...
  /// @brief Field Managed value: I32(1)
  static ::GlobalNamespace::GameplayServerMode const Managed;

  /// @brief Field QuickStartOneSong value: I32(2)
...
static_assert(sizeof(::GlobalNamespace::GameplayServerMode) == 0x4, "Size mismatch!");
