...
// Write type traits
MARK_REF_T(::GlobalNamespace::GhostEffectAsset*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GhostEffectAsset*, "", "GhostEffectAsset");
...
public:
  ...
  /// @brief Method CreatePlayable, addr 0x57e6154, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57e62b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_clipCaps, addr 0x57e614c, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::GhostEffectAsset) == 0x38, "Size mismatch!");
