...
MARK_REF_T(::GlobalNamespace::GhostEffectBehaviour*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GhostEffectBehaviour_EndBehavior, "", "GhostEffectBehaviour/EndBehavior");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GhostEffectBehaviour_GhostEffectType, "", "GhostEffectBehaviour/GhostEffectType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GhostEffectBehaviour*, "", "GhostEffectBehaviour");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::GhostEffectBehaviour_EndBehavior) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::GhostEffectBehaviour_GhostEffectType) == 0x4, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies EaseType, GhostEffectBehaviour::EndBehavior, GhostEffectBehaviour::GhostEffectType, TMPro.TextMeshPro, UnityEngine.CanvasGroup, UnityEngine.Playables.PlayableBehaviour,
// UnityEngine.Vector3
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__canvasGroups, put = __cordl_internal_set__canvasGroups)) ::ArrayW<::UnityW<::UnityEngine::CanvasGroup>> _canvasGroups;
  ...
  __declspec(property(get = __cordl_internal_get_textMeshPros, put = __cordl_internal_set_textMeshPros)) ::ArrayW<::UnityW<::TMPro::TextMeshPro>> textMeshPros;

  /// @brief Method EnableObjects, addr 0x5904fbc, size 0x114, virtual false, abstract: false, final false
  inline void EnableObjects(bool on);

  static inline ::GlobalNamespace::GhostEffectBehaviour* New_ctor();

  /// @brief Method OnBehaviourPlay, addr 0x5904e2c, size 0x190, virtual true, abstract: false, final false
  inline void OnBehaviourPlay(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method ProcessFrame, addr 0x59050d0, size 0x478, virtual true, abstract: false, final false
  inline void ProcessFrame(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info, ::System::Object* playerData);

  constexpr ::ArrayW<::UnityW<::UnityEngine::CanvasGroup>> const& __cordl_internal_get__canvasGroups() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::CanvasGroup>>& __cordl_internal_get__canvasGroups();
  ...
  constexpr ::ArrayW<::UnityW<::TMPro::TextMeshPro>> const& __cordl_internal_get_textMeshPros() const;

  constexpr ::ArrayW<::UnityW<::TMPro::TextMeshPro>>& __cordl_internal_get_textMeshPros();

  constexpr void __cordl_internal_set__canvasGroups(::ArrayW<::UnityW<::UnityEngine::CanvasGroup>> value);
  ...
  constexpr void __cordl_internal_set_textMeshPros(::ArrayW<::UnityW<::TMPro::TextMeshPro>> value);

  /// @brief Method .ctor, addr 0x5905548, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::GhostEffectBehaviour) == 0xa8, "Size mismatch!");
