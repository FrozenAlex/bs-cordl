...
public:
  ...
  /// @brief Method SetColors, addr 0x643cc94, size 0x70, virtual false, abstract: false, final false
  inline void SetColors(::UnityEngine::Color startColor, ::UnityEngine::Color endColor);

  /// @brief Method SetDisabledState, addr 0x643ce04, size 0x80, virtual true, abstract: false, final false
  inline void SetDisabledState();

  /// @brief Method SetHighlightedState, addr 0x643cd04, size 0x80, virtual true, abstract: false, final false
  inline void SetHighlightedState();

  /// @brief Method SetNormalState, addr 0x643cc14, size 0x80, virtual true, abstract: false, final false
  inline void SetNormalState();

  /// @brief Method SetPressedState, addr 0x643cd84, size 0x80, virtual true, abstract: false, final false
  inline void SetPressedState();

  /// @brief Method SetSelectedAndHighlightedState, addr 0x643cf04, size 0x80, virtual true, abstract: false, final false
  inline void SetSelectedAndHighlightedState();

  /// @brief Method SetSelectedState, addr 0x643ce84, size 0x80, virtual true, abstract: false, final false
  inline void SetSelectedState();

  /// @brief Method StartTween, addr 0x643cf84, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method StartTweens, addr 0x643c504, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method StopCurrentTransitionAnimation, addr 0x643cb44, size 0xd0, virtual true, abstract: false, final false
  inline void StopCurrentTransitionAnimation();

  /// @brief Method TransitionToDisabledState, addr 0x643c94c, size 0x90, virtual true, abstract: false, final false
  inline void TransitionToDisabledState(::GlobalNamespace::TransitionTimingSO* transitionTiming);

  /// @brief Method TransitionToHighlightedState, addr 0x643c7fc, size 0x90, virtual true, abstract: false, final false
  inline void TransitionToHighlightedState(::GlobalNamespace::TransitionTimingSO* transitionTiming);

  /// @brief Method TransitionToNormalState, addr 0x643c45c, size 0x90, virtual true, abstract: false, final false
  inline void TransitionToNormalState(::GlobalNamespace::TransitionTimingSO* transitionTiming);

  /// @brief Method TransitionToPressedState, addr 0x643c8a4, size 0x90, virtual true, abstract: false, final false
  inline void TransitionToPressedState(::GlobalNamespace::TransitionTimingSO* transitionTiming);

  /// @brief Method TransitionToSelectedAndHighlightedState, addr 0x643ca9c, size 0x90, virtual true, abstract: false, final false
  inline void TransitionToSelectedAndHighlightedState(::GlobalNamespace::TransitionTimingSO* transitionTiming);

  /// @brief Method TransitionToSelectedState, addr 0x643c9f4, size 0x90, virtual true, abstract: false, final false
  inline void TransitionToSelectedState(::GlobalNamespace::TransitionTimingSO* transitionTiming);

  /// @brief Method <StartTweens>b__18_2, addr 0x643d254, size 0x20, virtual false, abstract: false, final false
  inline void _StartTweens_b__18_2(::UnityEngine::Color color);

  /// @brief Method <StartTweens>b__18_3, addr 0x643d274, size 0x20, virtual false, abstract: false, final false
  inline void _StartTweens_b__18_3(::UnityEngine::Color color);

  /// @brief Method <StartTweens>g__Color1CompleteAction|18_0, addr 0x643d134, size 0x90, virtual false, abstract: false, final false
  inline void _StartTweens_g__Color1CompleteAction_18_0();

  /// @brief Method <StartTweens>g__Color2CompleteAction|18_1, addr 0x643d1c4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x643d0f0, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_transition, addr 0x643c454, size 0x8, virtual true, abstract: false, final false
