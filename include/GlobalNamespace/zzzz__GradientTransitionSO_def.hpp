...
// Write type traits
MARK_REF_T(::GlobalNamespace::GradientTransitionSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GradientTransitionSO*, "", "GradientTransitionSO");
...
static_assert(sizeof(::GlobalNamespace::GradientTransitionSO) == 0x80, "Size mismatch!");
