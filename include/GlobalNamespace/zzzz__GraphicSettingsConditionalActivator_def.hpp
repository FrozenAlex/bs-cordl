...
MARK_REF_T(::GlobalNamespace::GraphicSettingsConditionalActivator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GraphicSettingsConditionalActivator_ActivatorType, "", "GraphicSettingsConditionalActivator/ActivatorType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GraphicSettingsConditionalActivator*, "", "GraphicSettingsConditionalActivator");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
public:
  ...
  /// @brief Method GetGraphicsActivatorType, addr 0x57df26c, size 0xa0, virtual false, abstract: false, final false
  inline bool GetGraphicsActivatorType();

  static inline ::GlobalNamespace::GraphicSettingsConditionalActivator* New_ctor();

  /// @brief Method Start, addr 0x57df21c, size 0x50, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x57df30c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::GraphicSettingsConditionalActivator) == 0x38, "Size mismatch!");
