...
// Write type traits
MARK_REF_T(::GlobalNamespace::GraphicSettingsViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GraphicSettingsViewController*, "", "GraphicSettingsViewController");
...
static_assert(sizeof(::GlobalNamespace::GraphicSettingsViewController) == 0x80, "Size mismatch!");
