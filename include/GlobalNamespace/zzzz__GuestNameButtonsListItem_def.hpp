...
// Write type traits
MARK_REF_T(::GlobalNamespace::GuestNameButtonsListItem*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GuestNameButtonsListItem*, "", "GuestNameButtonsListItem");
...
public:
  ...
  /// @brief Method Awake, addr 0x5a070c4, size 0xcc, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::GuestNameButtonsListItem* New_ctor();

  /// @brief Method <Awake>b__7_0, addr 0x5a07194, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a07190, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_buttonPressed, addr 0x5a070bc, size 0x8, virtual false, abstract: false, final false
  inline void set_buttonPressed(::System::Action* value);

  /// @brief Method set_nameText, addr 0x5a0709c, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::GuestNameButtonsListItem) == 0x38, "Size mismatch!");
