...
// Write type traits
MARK_REF_T(::GlobalNamespace::HMAutoincrementedRequestId*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::HMAutoincrementedRequestId*, "", "HMAutoincrementedRequestId");
...
public:
  ...
  /// @brief Method Equals, addr 0x5857f14, size 0x20, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::HMAutoincrementedRequestId* obj);

  /// @brief Method Equals, addr 0x5857f34, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x5857fd0, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5857d2c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline uint64_t getStaticF__nextRequestId();

  /// @brief Method get_RequestId, addr 0x5857f0c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::HMAutoincrementedRequestId) == 0x18, "Size mismatch!");
