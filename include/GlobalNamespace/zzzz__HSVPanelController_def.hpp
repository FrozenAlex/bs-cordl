...
public:
  ...
  /// @brief Method Awake, addr 0x5a28b68, size 0xec, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleColorHueDidChange, addr 0x5a28e34, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleColorSaturationOrValueDidChange, addr 0x5a28dc0, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5a28c54, size 0x16c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RefreshSlidersColors, addr 0x5a28acc, size 0x2c, virtual false, abstract: false, final false
  inline void RefreshSlidersColors();

  /// @brief Method RefreshSlidersValues, addr 0x5a28af8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a28ea0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_colorDidChangeEvent, addr 0x5a288e8, size 0xc0, virtual false, abstract: false, final false
  inline void add_colorDidChangeEvent(::System::Action_2<::UnityEngine::Color, ::GlobalNamespace::ColorChangeUIEventType>* value);

  /// @brief Method get_color, addr 0x5a28a68, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method remove_colorDidChangeEvent, addr 0x5a289a8, size 0xc0, virtual false, abstract: false, final false
  inline void remove_colorDidChangeEvent(::System::Action_2<::UnityEngine::Color, ::GlobalNamespace::ColorChangeUIEventType>* value);

  /// @brief Method set_color, addr 0x5a28a80, size 0x4c, virtual false, abstract: false, final false
