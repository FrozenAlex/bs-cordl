...
// Write type traits
MARK_REF_T(::GlobalNamespace::HandsMovementMissionObjectiveChecker*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::HandsMovementMissionObjectiveChecker*, "", "HandsMovementMissionObjectiveChecker");
...
static_assert(sizeof(::GlobalNamespace::HandsMovementMissionObjectiveChecker) == 0x58, "Size mismatch!");
