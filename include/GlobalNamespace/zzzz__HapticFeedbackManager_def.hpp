...
// Write type traits
MARK_REF_T(::GlobalNamespace::HapticFeedbackManager*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::HapticFeedbackManager*, "", "HapticFeedbackManager");
...
static_assert(sizeof(::GlobalNamespace::HapticFeedbackManager) == 0x38, "Size mismatch!");
