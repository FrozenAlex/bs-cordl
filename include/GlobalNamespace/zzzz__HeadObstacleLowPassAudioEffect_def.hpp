...
// Write type traits
MARK_REF_T(::GlobalNamespace::HeadObstacleLowPassAudioEffect*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::HeadObstacleLowPassAudioEffect*, "", "HeadObstacleLowPassAudioEffect");
...
public:
  // Declarations
  /// @brief Field _headWasInObstacle, offset 0x30, size 0x1
  ...
  /// @brief Field _mainAudioEffects, offset 0x28, size 0x8
  ...
  /// @brief Method Update, addr 0x5854160, size 0x7c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x58541dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field _mainAudioEffects, offset: 0x28, size: 0x8, def value: None
...
static_assert(sizeof(::GlobalNamespace::HeadObstacleLowPassAudioEffect) == 0x38, "Size mismatch!");
