...
// Write type traits
MARK_REF_T(::GlobalNamespace::HealthWarningSceneSetupData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::HealthWarningSceneSetupData*, "", "HealthWarningSceneSetupData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x57ee6ac, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::HealthWarningSceneSetupData) == 0x18, "Size mismatch!");
