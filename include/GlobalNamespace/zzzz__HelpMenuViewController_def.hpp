...
// Write type traits
MARK_REF_T(::GlobalNamespace::HelpMenuViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::HelpMenuViewController*, "", "HelpMenuViewController");
...
public:
  ...
  /// @brief Field _healthWarningDisplayViewController, offset 0x90, size 0x8
  ...
  /// @brief Field _privacyPolicyDisplayViewController, offset 0x88, size 0x8
  ...
  /// @brief Method DidActivate, addr 0x5945af8, size 0x548, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HandleHelpMenuSegmentedControlDidSelectCell, addr 0x5946040, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59460d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectHelpSubMenuEvent, addr 0x5945978, size 0xc0, virtual false, abstract: false, final false
  inline void add_didSelectHelpSubMenuEvent(::System::Action_1<::UnityW<::HMUI::ViewController>>* value);

  /// @brief Method remove_didSelectHelpSubMenuEvent, addr 0x5945a38, size 0xc0, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::HelpMenuViewController, ____privacyPolicyDisplayViewController) == 0x88, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HelpMenuViewController, ____healthWarningDisplayViewController) == 0x90, "Offset mismatch!");
...
static_assert(sizeof(::GlobalNamespace::HelpMenuViewController) == 0xb8, "Size mismatch!");
