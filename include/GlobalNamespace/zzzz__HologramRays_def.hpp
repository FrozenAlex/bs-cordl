...
namespace GlobalNamespace {
class HologramRays__FadingCoroutine_d__28;
}
namespace GlobalNamespace {
...
// Write type traits
MARK_REF_T(::GlobalNamespace::HologramRays*);
...
class CORDL_TYPE HologramRays__FadingCoroutine_d__28 : public ::System::Object {
public:
  // Declarations
  ...
  /// @brief Method MoveNext, addr 0x59afa34, size 0x18c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::HologramRays__FadingCoroutine_d__28* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x59afbc0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x59afbc8, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x59afc00, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x59afa30, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x59af8c8, size 0x8, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::HologramRays__FadingCoroutine_d__28, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays__FadingCoroutine_d__28, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays__FadingCoroutine_d__28, ___turningOn) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays__FadingCoroutine_d__28, _____4__this) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays__FadingCoroutine_d__28, ___easeType) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays__FadingCoroutine_d__28, ___duration) == 0x34, "Offset mismatch!");
...
public:
  // Declarations
  using _FadingCoroutine_d__28 = ::GlobalNamespace::HologramRays__FadingCoroutine_d__28;

  /// @brief Field _alpha, offset 0x90, size 0x4
  __declspec(property(get = __cordl_internal_get__alpha, put = __cordl_internal_set__alpha)) float_t _alpha;

  /// @brief Field _bloomColor, offset 0x70, size 0x10
  ...
  /// @brief Field _bloomLight, offset 0x20, size 0x8
  ...
  /// @brief Field _bloomTransparentColor, offset 0x80, size 0x10
  ...
  /// @brief Field _bottomYPosition, offset 0x54, size 0x4
  ...
  /// @brief Field _hologramRaysMesh, offset 0x48, size 0x8
  ...
  /// @brief Field _hologramRaysTransform, offset 0x40, size 0x8
  ...
  /// @brief Field _laserHolderTransform, offset 0x38, size 0x8
  ...
  __declspec(property(get = getStaticF__materialAlphaID, put = setStaticF__materialAlphaID)) int32_t _materialAlphaID;

  /// @brief Field _materialBottomPositionID, offset 0xffffffff, size 0x4
  __declspec(property(get = getStaticF__materialBottomPositionID, put = setStaticF__materialBottomPositionID)) int32_t _materialBottomPositionID;
  ...
  __declspec(property(get = getStaticF__materialTopPositionID, put = setStaticF__materialTopPositionID)) int32_t _materialTopPositionID;

  /// @brief Field _raysDistance, offset 0x94, size 0x4
  __declspec(property(get = __cordl_internal_get__raysDistance, put = __cordl_internal_set__raysDistance)) float_t _raysDistance;

  /// @brief Field _raysLocalScale, offset 0x98, size 0xc
  ...
  /// @brief Field _raysMeshRenderer, offset 0x28, size 0x8
  ...
  /// @brief Field boundsInitialized, offset 0xa4, size 0x1
  ...
  /// @brief Method Animate, addr 0x59af6d4, size 0xa4, virtual false, abstract: false, final false
  inline void Animate(bool turningOn, float_t duration, ::GlobalNamespace::EaseType easeType);

  /// @brief Method Awake, addr 0x59af19c, size 0x1b4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method FadingCoroutine, addr 0x59af778, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x59af350, size 0x1c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnValidate, addr 0x59af36c, size 0xd0, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Refresh, addr 0x59af43c, size 0x294, virtual false, abstract: false, final false
  inline void Refresh();

  /// @brief Method RuntimeInit, addr 0x59af140, size 0x5c, virtual false, abstract: false, final false
  static inline void RuntimeInit();

  /// @brief Method Update, addr 0x59af6d0, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateBounds, addr 0x59af7f8, size 0xd0, virtual false, abstract: false, final false
  inline void UpdateBounds();

  /// @brief Method <Awake>b__22_0, addr 0x59af9c8, size 0x68, virtual false, abstract: false, final false
  ...
  constexpr ::Tweening::FloatTween* const& __cordl_internal_get__transitionTween() const;
  ...
  /// @brief Method .ctor, addr 0x59af8d0, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field _transitionTween, offset: 0x68, size: 0x8, def value: None
  ::Tweening::FloatTween* ____transitionTween;

  /// @brief Field _bloomColor, offset: 0x70, size: 0x10, def value: None
  ::UnityEngine::Color ____bloomColor;

  /// @brief Field _bloomTransparentColor, offset: 0x80, size: 0x10, def value: None
  ::UnityEngine::Color ____bloomTransparentColor;

  /// @brief Field _alpha, offset: 0x90, size: 0x4, def value: None
  float_t ____alpha;

  /// @brief Field _raysDistance, offset: 0x94, size: 0x4, def value: None
  float_t ____raysDistance;

  /// @brief Field _raysLocalScale, offset: 0x98, size: 0xc, def value: None
  ::UnityEngine::Vector3 ____raysLocalScale;

  /// @brief Field boundsInitialized, offset: 0xa4, size: 0x1, def value: None
  bool ___boundsInitialized;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::HologramRays, ____bloomLight) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays, ____raysMeshRenderer) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays, ____targetTransform) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays, ____laserHolderTransform) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays, ____hologramRaysTransform) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays, ____hologramRaysMesh) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays, ____topYPosition) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays, ____bottomYPosition) == 0x54, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays, ___cachedExtent) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays, ____tweeningManager) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays, ____transitionTween) == 0x68, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays, ____bloomColor) == 0x70, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays, ____bloomTransparentColor) == 0x80, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays, ____alpha) == 0x90, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays, ____raysDistance) == 0x94, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays, ____raysLocalScale) == 0x98, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HologramRays, ___boundsInitialized) == 0xa4, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::HologramRays) == 0xa8, "Size mismatch!");
