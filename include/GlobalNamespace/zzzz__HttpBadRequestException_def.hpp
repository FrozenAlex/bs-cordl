...
// Write type traits
MARK_REF_T(::GlobalNamespace::HttpBadRequestException*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::HttpBadRequestException*, "", "HttpBadRequestException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3274008, size 0x6c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::HttpBadRequestException) == 0x90, "Size mismatch!");
