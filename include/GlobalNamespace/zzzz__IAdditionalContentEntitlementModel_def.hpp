...
// Write type traits
MARK_REF_T(::GlobalNamespace::IAdditionalContentEntitlementModel*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IAdditionalContentEntitlementModel*, "", "IAdditionalContentEntitlementModel");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
