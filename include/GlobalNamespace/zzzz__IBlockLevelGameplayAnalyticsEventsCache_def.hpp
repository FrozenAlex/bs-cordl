...
// Write type traits
MARK_REF_T(::GlobalNamespace::IBlockLevelGameplayAnalyticsEventsCache*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IBlockLevelGameplayAnalyticsEventsCache*, "", "IBlockLevelGameplayAnalyticsEventsCache");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
