...
// Write type traits
MARK_REF_T(::GlobalNamespace::IConnectedPlayerBeatmapObjectEventManager*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IConnectedPlayerBeatmapObjectEventManager*, "", "IConnectedPlayerBeatmapObjectEventManager");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
