...
// Write type traits
MARK_REF_T(::GlobalNamespace::IMultiplayerLevelEndActionsPublisher*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IMultiplayerLevelEndActionsPublisher*, "", "IMultiplayerLevelEndActionsPublisher");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
