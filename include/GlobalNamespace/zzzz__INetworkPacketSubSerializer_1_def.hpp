...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::INetworkPacketSubSerializer_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::INetworkPacketSubSerializer_1, "", "INetworkPacketSubSerializer`1");
// Dependencies
namespace GlobalNamespace {
// cpp template
