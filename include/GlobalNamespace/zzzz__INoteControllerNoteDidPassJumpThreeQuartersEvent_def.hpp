...
// Write type traits
MARK_REF_T(::GlobalNamespace::INoteControllerNoteDidPassJumpThreeQuartersEvent*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::INoteControllerNoteDidPassJumpThreeQuartersEvent*, "", "INoteControllerNoteDidPassJumpThreeQuartersEvent");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
