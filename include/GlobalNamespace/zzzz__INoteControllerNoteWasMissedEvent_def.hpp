...
// Write type traits
MARK_REF_T(::GlobalNamespace::INoteControllerNoteWasMissedEvent*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::INoteControllerNoteWasMissedEvent*, "", "INoteControllerNoteWasMissedEvent");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
...
public:
  // Declarations
  /// @brief Method HandleNoteControllerNoteWasMissed, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
