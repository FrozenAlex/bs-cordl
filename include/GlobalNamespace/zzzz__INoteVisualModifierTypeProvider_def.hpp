...
// Write type traits
MARK_REF_T(::GlobalNamespace::INoteVisualModifierTypeProvider*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::INoteVisualModifierTypeProvider*, "", "INoteVisualModifierTypeProvider");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
