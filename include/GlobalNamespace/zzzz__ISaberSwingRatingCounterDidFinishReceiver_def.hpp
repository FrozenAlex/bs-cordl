...
// Write type traits
MARK_REF_T(::GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver*, "", "ISaberSwingRatingCounterDidFinishReceiver");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
