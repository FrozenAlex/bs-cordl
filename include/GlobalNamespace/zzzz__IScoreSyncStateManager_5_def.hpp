...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::IScoreSyncStateManager_5);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::IScoreSyncStateManager_5, "", "IScoreSyncStateManager`5");
// Dependencies
namespace GlobalNamespace {
// cpp template
