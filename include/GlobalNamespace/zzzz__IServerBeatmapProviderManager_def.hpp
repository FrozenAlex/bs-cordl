...
// Write type traits
MARK_REF_T(::GlobalNamespace::IServerBeatmapProviderManager*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IServerBeatmapProviderManager*, "", "IServerBeatmapProviderManager");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
