...
MARK_REF_T(::GlobalNamespace::IgnoranceConnectionManager*);
MARK_REF_T(::GlobalNamespace::IgnoranceConnectionManager_ConnectToServerParams*);
MARK_REF_T(::GlobalNamespace::IgnoranceConnectionManager_IgnoranceConnection*);
MARK_REF_T(::GlobalNamespace::IgnoranceConnectionManager_IgnoranceConnectionParamsBase*);
MARK_REF_T(::GlobalNamespace::IgnoranceConnectionManager_StartServerParams*);
MARK_REF_T(::GlobalNamespace::IgnoranceConnectionManager___c__DisplayClass81_0*);
MARK_REF_T(::GlobalNamespace::IgnoranceConnectionManager___c__DisplayClass81_1*);
MARK_REF_T(::GlobalNamespace::IgnoranceConnectionManager___c__DisplayClass85_0*);
...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IgnoranceConnectionManager_ConnectionState, "", "IgnoranceConnectionManager/ConnectionState");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IgnoranceConnectionManager*, "", "IgnoranceConnectionManager");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IgnoranceConnectionManager_ConnectToServerParams*, "", "IgnoranceConnectionManager/ConnectToServerParams");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IgnoranceConnectionManager_IgnoranceConnection*, "", "IgnoranceConnectionManager/IgnoranceConnection");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IgnoranceConnectionManager_IgnoranceConnectionParamsBase*, "", "IgnoranceConnectionManager/IgnoranceConnectionParamsBase");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IgnoranceConnectionManager_StartServerParams*, "", "IgnoranceConnectionManager/StartServerParams");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IgnoranceConnectionManager___c__DisplayClass81_0*, "", "IgnoranceConnectionManager/<>c__DisplayClass81_0");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IgnoranceConnectionManager___c__DisplayClass81_1*, "", "IgnoranceConnectionManager/<>c__DisplayClass81_1");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IgnoranceConnectionManager___c__DisplayClass85_0*, "", "IgnoranceConnectionManager/<>c__DisplayClass85_0");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IgnoranceConnectionManager__BackgroundDisconnectSentry_d__104, "", "IgnoranceConnectionManager/<BackgroundDisconnectSentry>d__104");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IgnoranceConnectionManager__DisposeAsync_d__81, "", "IgnoranceConnectionManager/<DisposeAsync>d__81");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::IgnoranceConnectionManager_ConnectionState) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3276ef8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::IgnoranceConnectionManager_IgnoranceConnectionParamsBase) == 0x40, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3276f04, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::IgnoranceConnectionManager_StartServerParams) == 0x68, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3276f10, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::IgnoranceConnectionManager_ConnectToServerParams) == 0x78, "Size mismatch!");
...
public:
  ...
  /// @brief Method Disconnect, addr 0x3276f80, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method Send, addr 0x3276f5c, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x327635c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method get_compatibilityVersion, addr 0x3276f4c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_compatibilityVersion();

  /// @brief Method get_isConnectionOwner, addr 0x3276f3c, size 0x8, virtual true, abstract: false, final true
  inline bool get_isConnectionOwner();

  /// @brief Method get_userId, addr 0x3276f1c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_userId();

  /// @brief Method get_userName, addr 0x3276f2c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_compatibilityVersion, addr 0x3276f54, size 0x8, virtual false, abstract: false, final false
  inline void set_compatibilityVersion(::StringW value);

  /// @brief Method set_isConnectionOwner, addr 0x3276f44, size 0x8, virtual false, abstract: false, final false
  inline void set_isConnectionOwner(bool value);

  /// @brief Method set_userId, addr 0x3276f24, size 0x8, virtual false, abstract: false, final false
  inline void set_userId(::StringW value);

  /// @brief Method set_userName, addr 0x3276f34, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <DisposeAsync>b__0, addr 0x3276fa4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3276fa0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <DisposeAsync>b__1, addr 0x3276fb0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3276fac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <HandleConnectionMessage>b__0, addr 0x3276fb8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32768e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3276fd4, size 0x48c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3277460, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x32774cc, size 0x430, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x32778fc, size 0xc, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__channels, put = __cordl_internal_set__channels)) ::ArrayW<::IgnoranceCore::IgnoranceChannelTypes> _channels;
  ...
  /// @brief Method BackgroundDisconnectSentry, addr 0x3276e44, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* BackgroundDisconnectSentry();

  /// @brief Method CheckSentryState, addr 0x327577c, size 0x24, virtual false, abstract: false, final false
  inline void CheckSentryState();

  /// @brief Method Disconnect, addr 0x3275df4, size 0x1d0, virtual true, abstract: false, final true
  inline void Disconnect(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method DisconnectPeer, addr 0x32766c4, size 0x11c, virtual false, abstract: false, final false
  inline void DisconnectPeer(uint32_t peerId, ::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method Dispose, addr 0x3275dc0, size 0x34, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DisposeAsync, addr 0x3275cec, size 0xd4, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::ValueTask DisposeAsync();

  /// @brief Method GetConnection, addr 0x3276ab8, size 0x64, virtual true, abstract: false, final true
  inline ::GlobalNamespace::IConnection* GetConnection(int32_t index);

  /// @brief Method GetConnectionMessage, addr 0x3276154, size 0x114, virtual false, abstract: false, final false
  inline ::LiteNetLib::Utils::NetDataWriter* GetConnectionMessage();

  /// @brief Method HandleConnectionEvents, addr 0x32757a0, size 0x270, virtual false, abstract: false, final false
  inline void HandleConnectionEvents();

  /// @brief Method HandleConnectionMessage, addr 0x32764cc, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleDisconnectionEvents, addr 0x3275c2c, size 0xc0, virtual false, abstract: false, final false
  inline void HandleDisconnectionEvents();

  /// @brief Method HandleIncomingEvents, addr 0x3275a10, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method Log, addr 0x3276ba8, size 0x8c, virtual false, abstract: false, final false
  static inline void Log(::StringW msg);

  /// @brief Method LogError, addr 0x3276b1c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method PollUpdate, addr 0x3275688, size 0xf4, virtual true, abstract: false, final true
  inline void PollUpdate();

  /// @brief Method Send, addr 0x3276268, size 0xf4, virtual false, abstract: false, final false
  inline void Send(uint32_t peerId, ::LiteNetLib::Utils::NetDataWriter* writer, ::BGNet::Core::DeliveryMethod deliveryMethod);

  /// @brief Method SendToAll, addr 0x32768f4, size 0xc4, virtual true, abstract: false, final true
  inline void SendToAll(::LiteNetLib::Utils::NetDataWriter* writer, ::BGNet::Core::DeliveryMethod deliveryMethod);

  /// @brief Method SendToAll, addr 0x32769b8, size 0x100, virtual true, abstract: false, final true
  ...
  /// @brief Method StartBackgroundSentry, addr 0x3276c34, size 0x210, virtual false, abstract: false, final false
  inline void StartBackgroundSentry();

  /// @brief Method ToChannel, addr 0x32768e4, size 0x10, virtual false, abstract: false, final false
  static inline uint8_t ToChannel(::BGNet::Core::DeliveryMethod deliveryMethod);

  /// @brief Method ToDeliveryMethod, addr 0x32768d4, size 0xc, virtual false, abstract: false, final false
  static inline ::BGNet::Core::DeliveryMethod ToDeliveryMethod(uint8_t channel);

  /// @brief Method TryGetConnection, addr 0x32767e0, size 0xf4, virtual false, abstract: false, final false
  inline bool TryGetConnection(uint32_t peerId, ::by_ref<::GlobalNamespace::IgnoranceConnectionManager_IgnoranceConnection*> connection);

  /// @brief Method TryParseConnectionMessage, addr 0x3276374, size 0x158, virtual false, abstract: false, final false
  inline bool TryParseConnectionMessage(::LiteNetLib::Utils::NetDataReader* reader, ::by_ref<::StringW> userId, ::by_ref<::StringW> userName, ::by_ref<bool> isConnectionOwner,
                                        ::by_ref<::StringW> compatibilityVersion);

  /// @brief Method WaitForClientShutdown, addr 0x3275fc4, size 0xc8, virtual false, abstract: false, final false
  static inline void WaitForClientShutdown(::IgnoranceCore::IgnoranceClient* client);

  /// @brief Method WaitForServerShutdown, addr 0x327608c, size 0xc8, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::IgnoranceCore::IgnoranceChannelTypes> const& __cordl_internal_get__channels() const;

  constexpr ::ArrayW<::IgnoranceCore::IgnoranceChannelTypes>& __cordl_internal_get__channels();
  ...
  constexpr void __cordl_internal_set__channels(::ArrayW<::IgnoranceCore::IgnoranceChannelTypes> value);
  ...
  /// @brief Method .ctor, addr 0x3275430, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x32754e4, size 0x1a4, virtual false, abstract: false, final false
  inline void _ctor(::BGNet::Core::ITimeProvider* timeProvider, ::BGNet::Core::ITaskUtility* taskUtility);

  /// @brief Method add_onConnectedEvent, addr 0x3274a68, size 0xac, virtual true, abstract: false, final true
  inline void add_onConnectedEvent(::System::Action* value);

  /// @brief Method add_onConnectionConnectedEvent, addr 0x3274ec0, size 0xc0, virtual true, abstract: false, final true
  inline void add_onConnectionConnectedEvent(::System::Action_1<::GlobalNamespace::IConnection*>* value);

  /// @brief Method add_onConnectionDisconnectedEvent, addr 0x3275040, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method add_onConnectionFailedEvent, addr 0x3274d40, size 0xc0, virtual true, abstract: false, final true
  inline void add_onConnectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>* value);

  /// @brief Method add_onDisconnectedEvent, addr 0x3274bc0, size 0xc0, virtual true, abstract: false, final true
  inline void add_onDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method add_onInitializedEvent, addr 0x3274910, size 0xac, virtual true, abstract: false, final true
  inline void add_onInitializedEvent(::System::Action* value);

  /// @brief Method add_onReceivedDataEvent, addr 0x32751c0, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method get_compatibilityVersion, addr 0x3275360, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_compatibilityVersion();

  /// @brief Method get_connectionCount, addr 0x32753a0, size 0x50, virtual true, abstract: false, final true
  inline int32_t get_connectionCount();

  /// @brief Method get_isConnected, addr 0x3275370, size 0x10, virtual true, abstract: false, final true
  inline bool get_isConnected();

  /// @brief Method get_isConnecting, addr 0x3275380, size 0x10, virtual true, abstract: false, final true
  inline bool get_isConnecting();

  /// @brief Method get_isConnectionOwner, addr 0x32753f0, size 0x10, virtual true, abstract: false, final true
  inline bool get_isConnectionOwner();

  /// @brief Method get_isDisconnecting, addr 0x3275390, size 0x10, virtual true, abstract: false, final true
  inline bool get_isDisconnecting();

  /// @brief Method get_isDisposed, addr 0x3275400, size 0x10, virtual true, abstract: false, final true
  inline bool get_isDisposed();

  /// @brief Method get_serverUserId, addr 0x3275410, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_serverUserId();

  /// @brief Method get_serverUserName, addr 0x3275420, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_serverUserName();

  /// @brief Method get_userId, addr 0x3275340, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_userId();

  /// @brief Method get_userName, addr 0x3275350, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_userName();
  ...
  /// @brief Method remove_onConnectedEvent, addr 0x3274b14, size 0xac, virtual true, abstract: false, final true
  inline void remove_onConnectedEvent(::System::Action* value);

  /// @brief Method remove_onConnectionConnectedEvent, addr 0x3274f80, size 0xc0, virtual true, abstract: false, final true
  inline void remove_onConnectionConnectedEvent(::System::Action_1<::GlobalNamespace::IConnection*>* value);

  /// @brief Method remove_onConnectionDisconnectedEvent, addr 0x3275100, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_onConnectionFailedEvent, addr 0x3274e00, size 0xc0, virtual true, abstract: false, final true
  inline void remove_onConnectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>* value);

  /// @brief Method remove_onDisconnectedEvent, addr 0x3274c80, size 0xc0, virtual true, abstract: false, final true
  inline void remove_onDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method remove_onInitializedEvent, addr 0x32749bc, size 0xac, virtual true, abstract: false, final true
  inline void remove_onInitializedEvent(::System::Action* value);

  /// @brief Method remove_onReceivedDataEvent, addr 0x3275280, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method set_compatibilityVersion, addr 0x3275368, size 0x8, virtual false, abstract: false, final false
  inline void set_compatibilityVersion(::StringW value);

  /// @brief Method set_serverUserId, addr 0x3275418, size 0x8, virtual false, abstract: false, final false
  inline void set_serverUserId(::StringW value);

  /// @brief Method set_serverUserName, addr 0x3275428, size 0x8, virtual false, abstract: false, final false
  inline void set_serverUserName(::StringW value);

  /// @brief Method set_userId, addr 0x3275348, size 0x8, virtual false, abstract: false, final false
  inline void set_userId(::StringW value);

  /// @brief Method set_userName, addr 0x3275358, size 0x8, virtual false, abstract: false, final false
  inline void set_userName(::StringW value);
...
public:
  ...
  ::ArrayW<::IgnoranceCore::IgnoranceChannelTypes> ____channels;
...
static_assert(sizeof(::GlobalNamespace::IgnoranceConnectionManager) == 0xe8, "Size mismatch!");
