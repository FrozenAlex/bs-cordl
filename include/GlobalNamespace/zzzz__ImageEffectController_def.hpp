...
MARK_REF_T(::GlobalNamespace::ImageEffectController_RenderImageCallback*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ImageEffectController*, "", "ImageEffectController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ImageEffectController_RenderImageCallback*, "", "ImageEffectController/RenderImageCallback");
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x5725854, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x572587c, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x5725840, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57256f8, size 0x148, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ImageEffectController_RenderImageCallback) == 0x80, "Size mismatch!");
...
public:
  ...
  /// @brief Method OnRenderImage, addr 0x57256d8, size 0x1c, virtual false, abstract: false, final false
  inline void OnRenderImage(::UnityEngine::RenderTexture* src, ::UnityEngine::RenderTexture* dest);

  /// @brief Method SetCallback, addr 0x57256d0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57256f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ImageEffectController) == 0x28, "Size mismatch!");
