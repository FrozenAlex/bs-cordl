...
// Write type traits
MARK_REF_T(::GlobalNamespace::InMultiplayerRichPresenceData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::InMultiplayerRichPresenceData*, "", "InMultiplayerRichPresenceData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58fbf28, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::StringW multiplayerSecret, bool canInvite, bool atMaxPartySize);

  /// @brief Method get_apiName, addr 0x58fbea8, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_apiName();

  /// @brief Method get_atMaxPartySize, addr 0x58fbed8, size 0x8, virtual true, abstract: false, final true
  inline bool get_atMaxPartySize();

  /// @brief Method get_canInvite, addr 0x58fbee8, size 0x8, virtual true, abstract: false, final true
  inline bool get_canInvite();

  /// @brief Method get_isJoinable, addr 0x58fbef8, size 0x30, virtual true, abstract: false, final true
  inline bool get_isJoinable();

  /// @brief Method get_localizedDescription, addr 0x58fbeb8, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_localizedDescription();

  /// @brief Method get_multiplayerSecret, addr 0x58fbec8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_apiName, addr 0x58fbeb0, size 0x8, virtual false, abstract: false, final false
  inline void set_apiName(::StringW value);

  /// @brief Method set_atMaxPartySize, addr 0x58fbee0, size 0x8, virtual true, abstract: false, final true
  inline void set_atMaxPartySize(bool value);

  /// @brief Method set_canInvite, addr 0x58fbef0, size 0x8, virtual true, abstract: false, final true
  inline void set_canInvite(bool value);

  /// @brief Method set_localizedDescription, addr 0x58fbec0, size 0x8, virtual false, abstract: false, final false
  inline void set_localizedDescription(::StringW value);

  /// @brief Method set_multiplayerSecret, addr 0x58fbed0, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::InMultiplayerRichPresenceData) == 0x30, "Size mismatch!");
