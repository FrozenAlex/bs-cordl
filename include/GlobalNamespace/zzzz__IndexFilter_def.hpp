...
MARK_REF_T(::GlobalNamespace::IndexFilter*);
MARK_REF_T(::GlobalNamespace::IndexFilter__GetEnumerator_d__23*);
MARK_REF_T(::GlobalNamespace::IndexFilter__GetValues_d__24*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IndexFilter_IndexFilterLimitAlsoAffectType, "", "IndexFilter/IndexFilterLimitAlsoAffectType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IndexFilter_IndexFilterRandomType, "", "IndexFilter/IndexFilterRandomType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IndexFilter*, "", "IndexFilter");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IndexFilter__GetEnumerator_d__23*, "", "IndexFilter/<GetEnumerator>d__23");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IndexFilter__GetValues_d__24*, "", "IndexFilter/<GetValues>d__24");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::IndexFilter_IndexFilterRandomType) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::IndexFilter_IndexFilterLimitAlsoAffectType) == 0x4, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies System.Object, System.ValueTuple`3<T1, T2, T3>
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x37138a8, size 0x4a8, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::IndexFilter__GetEnumerator_d__23* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<(System.Int32element,System.Int32durationOrder,System.Int32distributionOrder)>.get_Current, addr 0x3713e04, size 0x10, virtual true,
  ...
  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3713e14, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3713e4c, size 0x68, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x371388c, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x3713d50, size 0xb4, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x37137f0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::IndexFilter__GetEnumerator_d__23) == 0x48, "Size mismatch!");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3713eb8, size 0x80, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::IndexFilter__GetValues_d__24* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<System.Int32>.GetEnumerator, addr 0x3713f9c, size 0x98, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Int32>.get_Current, addr 0x3713f38, size 0x8, virtual true, abstract: false, final true
  inline int32_t System_Collections_Generic_IEnumerator_System_Int32__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x3714034, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3713f40, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3713f78, size 0x24, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3713eb4, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method .ctor, addr 0x3713868, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
static_assert(sizeof(::GlobalNamespace::IndexFilter__GetValues_d__24) == 0x30, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x37111c4, size 0x54, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::System::ValueTuple_3<int32_t, int32_t, int32_t>>* GetEnumerator();

  /// @brief Method GetValues, addr 0x37137f8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x3713888, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();
  ...
  /// @brief Method .ctor, addr 0x3713714, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x371365c, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Count, addr 0x3713638, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_VisibleCount, addr 0x3713640, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_VisibleCount();

  /// @brief Method get_limitAlsoAffectType, addr 0x3713648, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IndexFilter_IndexFilterLimitAlsoAffectType get_limitAlsoAffectType();

  /// @brief Method get_limitsDistribution, addr 0x3710990, size 0xc, virtual false, abstract: false, final false
  inline bool get_limitsDistribution();

  /// @brief Method get_limitsDuration, addr 0x3713650, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::IndexFilter) == 0x38, "Size mismatch!");
