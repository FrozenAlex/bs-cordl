...
// Write type traits
MARK_REF_T(::GlobalNamespace::InlineLinkAttribute*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::InlineLinkAttribute*, "", "InlineLinkAttribute");
...
static_assert(sizeof(::GlobalNamespace::InlineLinkAttribute) == 0x20, "Size mismatch!");
