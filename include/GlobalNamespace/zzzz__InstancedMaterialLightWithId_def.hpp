...
MARK_REF_T(::GlobalNamespace::InstancedMaterialLightWithId*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::InstancedMaterialLightWithId_MultiplyColorByAlphaType, "", "InstancedMaterialLightWithId/MultiplyColorByAlphaType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::InstancedMaterialLightWithId*, "", "InstancedMaterialLightWithId");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::InstancedMaterialLightWithId_MultiplyColorByAlphaType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method AddNecessaryComponents, addr 0x5728f60, size 0x110, virtual false, abstract: false, final false
  inline void AddNecessaryComponents();

  /// @brief Method ColorWasSet, addr 0x5728e8c, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5729070, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_intensity, addr 0x5728e68, size 0x8, virtual false, abstract: false, final false
  inline float_t get_intensity();

  /// @brief Method set_intensity, addr 0x5728e70, size 0x1c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::InstancedMaterialLightWithId) == 0x78, "Size mismatch!");
