...
// Write type traits
MARK_REF_T(::GlobalNamespace::IntFxBaseData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IntFxBaseData*, "", "IntFxBaseData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3713614, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::IntFxBaseData) == 0x20, "Size mismatch!");
