...
// Write type traits
MARK_REF_T(::GlobalNamespace::InternalPlatformInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::InternalPlatformInstaller*, "", "InternalPlatformInstaller");
...
public:
  ...
  /// @brief Method BindAdditionalContentModel, addr 0x36b6904, size 0x8c, virtual false, abstract: false, final false
  inline void BindAdditionalContentModel();

  /// @brief Method BindAnalyticsModel, addr 0x36b6830, size 0xd4, virtual false, abstract: false, final false
  inline void BindAnalyticsModel();

  /// @brief Method BindBeatmapDataAssetFileModel, addr 0x36b6990, size 0xa0, virtual false, abstract: false, final false
  inline void BindBeatmapDataAssetFileModel();

  /// @brief Method BindMockPlatformAdditionalContentModel, addr 0x36b6a30, size 0xc8, virtual false, abstract: false, final false
  inline void BindMockPlatformAdditionalContentModel();

  /// @brief Method InstallBindings, addr 0x36b6810, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36b67a4, size 0x6c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::InternalPlatformInstaller) == 0x28, "Size mismatch!");
