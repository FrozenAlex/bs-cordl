...
public:
  // Declarations
  /// @brief Method Info, addr 0x597258c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::InteropErrorExtensions) == 0x10, "Size mismatch!");
