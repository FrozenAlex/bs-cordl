...
// Write type traits
MARK_REF_T(::GlobalNamespace::Interpolation*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::Interpolation*, "", "Interpolation");
...
public:
  // Declarations
  /// @brief Method Interpolate, addr 0x643fc70, size 0x574, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::Interpolation) == 0x10, "Size mismatch!");
