...
// Write type traits
MARK_REF_T(::GlobalNamespace::IntroTutorialRing*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IntroTutorialRing*, "", "IntroTutorialRing");
// Dependencies SaberType, UnityEngine.MonoBehaviour, UnityEngine.UI.Image
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__progressImages, put = __cordl_internal_set__progressImages)) ::ArrayW<::UnityW<::UnityEngine::UI::Image>> _progressImages;

  /// @brief Field _ringGLowImages, offset 0x48, size 0x8
  __declspec(property(get = __cordl_internal_get__ringGLowImages, put = __cordl_internal_set__ringGLowImages)) ::ArrayW<::UnityW<::UnityEngine::UI::Image>> _ringGLowImages;
  ...
  /// @brief Method OnEnable, addr 0x57fb2e0, size 0x54, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnTriggerEnter, addr 0x57fb4fc, size 0x114, virtual false, abstract: false, final false
  inline void OnTriggerEnter(::UnityEngine::Collider* other);

  /// @brief Method OnTriggerExit, addr 0x57fb610, size 0x108, virtual false, abstract: false, final false
  inline void OnTriggerExit(::UnityEngine::Collider* other);

  /// @brief Method OnTriggerStay, addr 0x57fb718, size 0x120, virtual false, abstract: false, final false
  inline void OnTriggerStay(::UnityEngine::Collider* other);

  /// @brief Method SetProgressImagesfillAmount, addr 0x57fb498, size 0x64, virtual false, abstract: false, final false
  inline void SetProgressImagesfillAmount(float_t fillAmount);

  /// @brief Method Start, addr 0x57fb260, size 0x80, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x57fb334, size 0x164, virtual false, abstract: false, final false
  inline void Update();
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::UI::Image>> const& __cordl_internal_get__progressImages() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::UI::Image>>& __cordl_internal_get__progressImages();

  constexpr ::ArrayW<::UnityW<::UnityEngine::UI::Image>> const& __cordl_internal_get__ringGLowImages() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::UI::Image>>& __cordl_internal_get__ringGLowImages();
  ...
  constexpr void __cordl_internal_set__progressImages(::ArrayW<::UnityW<::UnityEngine::UI::Image>> value);

  constexpr void __cordl_internal_set__ringGLowImages(::ArrayW<::UnityW<::UnityEngine::UI::Image>> value);
  ...
  /// @brief Method .ctor, addr 0x57fb838, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_fullyActivated, addr 0x57fb22c, size 0x24, virtual false, abstract: false, final false
  inline bool get_fullyActivated();

  /// @brief Method get_saberType, addr 0x57fb250, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SaberType get_saberType();

  /// @brief Method set_alpha, addr 0x57fb214, size 0x18, virtual false, abstract: false, final false
  inline void set_alpha(float_t value);

  /// @brief Method set_saberType, addr 0x57fb258, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::UnityW<::UnityEngine::UI::Image>> ____ringGLowImages;
...
static_assert(sizeof(::GlobalNamespace::IntroTutorialRing) == 0x78, "Size mismatch!");
