...
// Write type traits
MARK_REF_T(::GlobalNamespace::JoiningLobbyViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::JoiningLobbyViewController*, "", "JoiningLobbyViewController");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x57a338c, size 0x100, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HideLoading, addr 0x57a334c, size 0x40, virtual false, abstract: false, final false
  inline void HideLoading();

  /// @brief Method Init, addr 0x57a3318, size 0x34, virtual false, abstract: false, final false
  inline void Init(::StringW text);

  static inline ::GlobalNamespace::JoiningLobbyViewController* New_ctor();

  /// @brief Method <DidActivate>b__8_0, addr 0x57a3490, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57a348c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didCancelEvent, addr 0x57a31c0, size 0xac, virtual false, abstract: false, final false
  inline void add_didCancelEvent(::System::Action* value);

  /// @brief Method remove_didCancelEvent, addr 0x57a326c, size 0xac, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::JoiningLobbyViewController) == 0x98, "Size mismatch!");
