...
public:
  ...
  /// @brief Method OnNotify, addr 0x5713cb0, size 0x148, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5713df8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_jumpToDestinationValid, addr 0x5713ca0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_jumpToDestinationValid, addr 0x5713ca8, size 0x8, virtual false, abstract: false, final false
