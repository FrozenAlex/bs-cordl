...
MARK_REF_T(::GlobalNamespace::KawaseBlurRendererSO*);
MARK_REF_T(::GlobalNamespace::KawaseBlurRendererSO_BloomKernel*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::KawaseBlurRendererSO_KernelSize, "", "KawaseBlurRendererSO/KernelSize");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::KawaseBlurRendererSO_Pass, "", "KawaseBlurRendererSO/Pass");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::KawaseBlurRendererSO_WeightsType, "", "KawaseBlurRendererSO/WeightsType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::KawaseBlurRendererSO*, "", "KawaseBlurRendererSO");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::KawaseBlurRendererSO_BloomKernel*, "", "KawaseBlurRendererSO/BloomKernel");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::KawaseBlurRendererSO_KernelSize) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::KawaseBlurRendererSO_WeightsType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5725eb4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::KawaseBlurRendererSO_BloomKernel) == 0x18, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::KawaseBlurRendererSO_Pass) == 0x4, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies KawaseBlurRendererSO::BloomKernel, PersistentScriptableObject, UnityEngine.RenderTexture
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__bloomKernels, put = __cordl_internal_set__bloomKernels)) ::ArrayW<::GlobalNamespace::KawaseBlurRendererSO_BloomKernel*> _bloomKernels;

  /// @brief Field _blurTextures, offset 0x60, size 0x8
  __declspec(property(get = __cordl_internal_get__blurTextures, put = __cordl_internal_set__blurTextures)) ::ArrayW<::UnityW<::UnityEngine::RenderTexture>> _blurTextures;
  ...
  __declspec(property(get = __cordl_internal_get__kernels, put = __cordl_internal_set__kernels)) ::ArrayW<::ArrayW<int32_t>> _kernels;
  ...
  __declspec(property(get = getStaticF_kBloomIterationWeights, put = setStaticF_kBloomIterationWeights)) ::ArrayW<::ArrayW<float_t>> kBloomIterationWeights;

  /// @brief Method AlphaWeights, addr 0x5726d64, size 0xd4, virtual false, abstract: false, final false
  inline void AlphaWeights(::UnityEngine::RenderTexture* src, ::UnityEngine::RenderTexture* dest);

  /// @brief Method Bloom, addr 0x5725ef4, size 0x520, virtual false, abstract: false, final false
  inline void Bloom(::UnityEngine::RenderTexture* src, ::UnityEngine::RenderTexture* dest, int32_t iterationsStart, int32_t iterations, float_t boost, float_t alphaWeights,
                    ::GlobalNamespace::KawaseBlurRendererSO_WeightsType blurStartWeightsType, ::ArrayW<float_t> bloomIterationWeights);

  /// @brief Method Blur, addr 0x5726c00, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method Blur, addr 0x5726414, size 0x558, virtual false, abstract: false, final false
  inline void Blur(::UnityEngine::Texture* src, ::UnityEngine::RenderTexture* dest, ::ArrayW<int32_t> kernel, float_t boost, int32_t downsample, int32_t startIdx, int32_t length, float_t alphaWeights,
                   float_t additiveAlpha, bool additivelyBlendToDest, bool gammaCorrection, ::GlobalNamespace::KawaseBlurRendererSO_WeightsType blurStartWeightsType);

  /// @brief Method Blur, addr 0x5726cdc, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateBlurCommandBuffer, addr 0x5726e38, size 0x344, virtual false, abstract: false, final false
  ...
  /// @brief Method DoubleBlur, addr 0x572696c, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBlurKernel, addr 0x5725904, size 0x230, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t> GetBlurKernel(::GlobalNamespace::KawaseBlurRendererSO_KernelSize kernelSize);

  static inline ::GlobalNamespace::KawaseBlurRendererSO* New_ctor();

  /// @brief Method OnDisable, addr 0x5725eb8, size 0x3c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5725b34, size 0x380, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::KawaseBlurRendererSO_BloomKernel*> const& __cordl_internal_get__bloomKernels() const;

  constexpr ::ArrayW<::GlobalNamespace::KawaseBlurRendererSO_BloomKernel*>& __cordl_internal_get__bloomKernels();

  constexpr ::ArrayW<::UnityW<::UnityEngine::RenderTexture>> const& __cordl_internal_get__blurTextures() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::RenderTexture>>& __cordl_internal_get__blurTextures();
  ...
  constexpr ::ArrayW<::ArrayW<int32_t>> const& __cordl_internal_get__kernels() const;

  constexpr ::ArrayW<::ArrayW<int32_t>>& __cordl_internal_get__kernels();
  ...
  constexpr void __cordl_internal_set__bloomKernels(::ArrayW<::GlobalNamespace::KawaseBlurRendererSO_BloomKernel*> value);

  constexpr void __cordl_internal_set__blurTextures(::ArrayW<::UnityW<::UnityEngine::RenderTexture>> value);
  ...
  constexpr void __cordl_internal_set__kernels(::ArrayW<::ArrayW<int32_t>> value);
  ...
  /// @brief Method .ctor, addr 0x572717c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  static inline ::ArrayW<::ArrayW<float_t>> getStaticF_kBloomIterationWeights();
  ...
  static inline void setStaticF_kBloomIterationWeights(::ArrayW<::ArrayW<float_t>> value);
...
public:
  ...
  ::ArrayW<::ArrayW<int32_t>> ____kernels;

  /// @brief Field _bloomKernels, offset: 0x58, size: 0x8, def value: None
  ::ArrayW<::GlobalNamespace::KawaseBlurRendererSO_BloomKernel*> ____bloomKernels;

  /// @brief Field _blurTextures, offset: 0x60, size: 0x8, def value: None
  ::ArrayW<::UnityW<::UnityEngine::RenderTexture>> ____blurTextures;
...
static_assert(sizeof(::GlobalNamespace::KawaseBlurRendererSO) == 0x68, "Size mismatch!");
