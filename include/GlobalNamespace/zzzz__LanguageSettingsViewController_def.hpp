...
// Write type traits
MARK_REF_T(::GlobalNamespace::LanguageSettingsViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LanguageSettingsViewController*, "", "LanguageSettingsViewController");
...
public:
  ...
  /// @brief Method .ctor, addr 0x57ab160, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LanguageSettingsViewController) == 0x78, "Size mismatch!");
