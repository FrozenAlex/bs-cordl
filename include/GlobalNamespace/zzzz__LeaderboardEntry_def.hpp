...
// Write type traits
MARK_REF_T(::GlobalNamespace::LeaderboardEntry*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LeaderboardEntry*, "", "LeaderboardEntry");
...
public:
  ...
  /// @brief Method SetScore, addr 0x5936438, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59365d8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LeaderboardEntry) == 0x48, "Size mismatch!");
