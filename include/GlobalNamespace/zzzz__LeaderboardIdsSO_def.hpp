...
// Write type traits
MARK_REF_T(::GlobalNamespace::LeaderboardIdsSO*);
MARK_REF_T(::GlobalNamespace::LeaderboardIdsSO_LeaderboardIdData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LeaderboardIdsSO*, "", "LeaderboardIdsSO");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LeaderboardIdsSO_LeaderboardIdData*, "", "LeaderboardIdsSO/LeaderboardIdData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3669c80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW difficultyBeatmapId, ::StringW platformLeaderboardId);

  /// @brief Method get_difficultyBeatmapId, addr 0x3669d0c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_difficultyBeatmapId();

  /// @brief Method get_platformLeaderboardId, addr 0x3669d04, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LeaderboardIdsSO_LeaderboardIdData) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method Add, addr 0x3669ba0, size 0xe0, virtual false, abstract: false, final false
  inline void Add(::StringW difficultyBeatmapId, ::StringW platformLeaderboardId);

  /// @brief Method ILeaderboardIdContainer.get_leaderboardIds, addr 0x3669b30, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3669c88, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_leaderboardIds, addr 0x3669b38, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_leaderboardIds, addr 0x3669b40, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LeaderboardIdsSO) == 0x20, "Size mismatch!");
