...
public:
  // Declarations
  /// @brief Field <badCutsCount>k__BackingField, offset 0x40, size 0x4
  ...
  /// @brief Field <beatmapKey>k__BackingField, offset 0x18, size 0x10
  ...
  /// @brief Field <fullCombo>k__BackingField, offset 0x38, size 0x1
  ...
  /// @brief Field <gameplayModifiers>k__BackingField, offset 0x28, size 0x8
  ...
  /// @brief Field <goodCutsCount>k__BackingField, offset 0x3c, size 0x4
  ...
  /// @brief Field <maxCombo>k__BackingField, offset 0x48, size 0x4
  ...
  /// @brief Field <missedCount>k__BackingField, offset 0x44, size 0x4
  ...
  /// @brief Field <modifiedScore>k__BackingField, offset 0x34, size 0x4
  ...
  /// @brief Field <multipliedScore>k__BackingField, offset 0x30, size 0x4
  ...
  /// @brief Field currentUploadAttemptCount, offset 0x50, size 0x4
  ...
  /// @brief Method .ctor, addr 0x3751b28, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_badCutsCount, addr 0x3751af8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_badCutsCount();

  /// @brief Method get_beatmapKey, addr 0x3751a94, size 0xc, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapKey get_beatmapKey();

  /// @brief Method get_fullCombo, addr 0x3751ad8, size 0x8, virtual false, abstract: false, final false
  inline bool get_fullCombo();

  /// @brief Method get_gameplayModifiers, addr 0x3751aa8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers();

  /// @brief Method get_goodCutsCount, addr 0x3751ae8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_goodCutsCount();

  /// @brief Method get_maxCombo, addr 0x3751b18, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxCombo();

  /// @brief Method get_missedCount, addr 0x3751b08, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_missedCount();

  /// @brief Method get_modifiedScore, addr 0x3751ac8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_modifiedScore();

  /// @brief Method get_multipliedScore, addr 0x3751ab8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_multipliedScore();

  /// @brief Method get_playerId, addr 0x3751a84, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_playerId();

  /// @brief Method set_badCutsCount, addr 0x3751b00, size 0x8, virtual false, abstract: false, final false
  inline void set_badCutsCount(int32_t value);

  /// @brief Method set_beatmapKey, addr 0x3751aa0, size 0x8, virtual false, abstract: false, final false
  inline void set_beatmapKey(::GlobalNamespace::BeatmapKey value);

  /// @brief Method set_fullCombo, addr 0x3751ae0, size 0x8, virtual false, abstract: false, final false
  inline void set_fullCombo(bool value);

  /// @brief Method set_gameplayModifiers, addr 0x3751ab0, size 0x8, virtual false, abstract: false, final false
  inline void set_gameplayModifiers(::GlobalNamespace::GameplayModifiers* value);

  /// @brief Method set_goodCutsCount, addr 0x3751af0, size 0x8, virtual false, abstract: false, final false
  inline void set_goodCutsCount(int32_t value);

  /// @brief Method set_maxCombo, addr 0x3751b20, size 0x8, virtual false, abstract: false, final false
  inline void set_maxCombo(int32_t value);

  /// @brief Method set_missedCount, addr 0x3751b10, size 0x8, virtual false, abstract: false, final false
  inline void set_missedCount(int32_t value);

  /// @brief Method set_modifiedScore, addr 0x3751ad0, size 0x8, virtual false, abstract: false, final false
  inline void set_modifiedScore(int32_t value);

  /// @brief Method set_multipliedScore, addr 0x3751ac0, size 0x8, virtual false, abstract: false, final false
  inline void set_multipliedScore(int32_t value);

  /// @brief Method set_playerId, addr 0x3751a8c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field <beatmapKey>k__BackingField, offset: 0x18, size: 0x10, def value: None
  ::GlobalNamespace::BeatmapKey ____beatmapKey_k__BackingField;

  /// @brief Field <gameplayModifiers>k__BackingField, offset: 0x28, size: 0x8, def value: None
  ::GlobalNamespace::GameplayModifiers* ____gameplayModifiers_k__BackingField;

  /// @brief Field <multipliedScore>k__BackingField, offset: 0x30, size: 0x4, def value: None
  int32_t ____multipliedScore_k__BackingField;

  /// @brief Field <modifiedScore>k__BackingField, offset: 0x34, size: 0x4, def value: None
  int32_t ____modifiedScore_k__BackingField;

  /// @brief Field <fullCombo>k__BackingField, offset: 0x38, size: 0x1, def value: None
  bool ____fullCombo_k__BackingField;

  /// @brief Field <goodCutsCount>k__BackingField, offset: 0x3c, size: 0x4, def value: None
  int32_t ____goodCutsCount_k__BackingField;

  /// @brief Field <badCutsCount>k__BackingField, offset: 0x40, size: 0x4, def value: None
  int32_t ____badCutsCount_k__BackingField;

  /// @brief Field <missedCount>k__BackingField, offset: 0x44, size: 0x4, def value: None
  int32_t ____missedCount_k__BackingField;

  /// @brief Field <maxCombo>k__BackingField, offset: 0x48, size: 0x4, def value: None
  int32_t ____maxCombo_k__BackingField;

  /// @brief Field uploadAttemptCount, offset: 0x4c, size: 0x4, def value: None
  int32_t ___uploadAttemptCount;

  /// @brief Field currentUploadAttemptCount, offset: 0x50, size: 0x4, def value: None
...
static_assert(offsetof(::GlobalNamespace::LeaderboardScoreUploader_ScoreData, ____gameplayModifiers_k__BackingField) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LeaderboardScoreUploader_ScoreData, ____multipliedScore_k__BackingField) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LeaderboardScoreUploader_ScoreData, ____modifiedScore_k__BackingField) == 0x34, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LeaderboardScoreUploader_ScoreData, ____fullCombo_k__BackingField) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LeaderboardScoreUploader_ScoreData, ____goodCutsCount_k__BackingField) == 0x3c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LeaderboardScoreUploader_ScoreData, ____badCutsCount_k__BackingField) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LeaderboardScoreUploader_ScoreData, ____missedCount_k__BackingField) == 0x44, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LeaderboardScoreUploader_ScoreData, ____maxCombo_k__BackingField) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LeaderboardScoreUploader_ScoreData, ___uploadAttemptCount) == 0x4c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LeaderboardScoreUploader_ScoreData, ___currentUploadAttemptCount) == 0x50, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::LeaderboardScoreUploader_ScoreData) == 0x58, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3751b60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x3751cc0, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x3751ce8, size 0xc, virtual true, abstract: false, final false
  inline ::GlobalNamespace::HMAsyncRequest* EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x3751cac, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3751b64, size 0x148, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <UploadScoresCoroutine>b__0, addr 0x3751cf8, size 0x24c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3751cf4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3751f44, size 0x5d8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x375251c, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3752588, size 0x478, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3752a00, size 0x8, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3752a0c, size 0x260, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::LeaderboardScoreUploader__UploadScoresCoroutine_d__16* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3752c6c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3752c74, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3752cac, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3752a08, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3751798, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddScore, addr 0x37518f4, size 0xe8, virtual false, abstract: false, final false
  inline void AddScore(::GlobalNamespace::LeaderboardScoreUploader_ScoreData* scoreData);

  /// @brief Method Init, addr 0x3751664, size 0x30, virtual false, abstract: false, final false
  inline void Init(::GlobalNamespace::LeaderboardScoreUploader_UploadScoreCallback* uploadScoreCallback, uint64_t playerId);

  /// @brief Method LoadScoresToUploadFromFile, addr 0x37517a0, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnApplicationQuit, addr 0x3751794, size 0x4, virtual false, abstract: false, final false
  inline void OnApplicationQuit();

  /// @brief Method SaveScoresToUploadToFile, addr 0x3751850, size 0xa4, virtual false, abstract: false, final false
  inline void SaveScoresToUploadToFile();

  /// @brief Method Uninitialize, addr 0x37516e8, size 0xac, virtual false, abstract: false, final false
  inline void Uninitialize();

  /// @brief Method UploadScoresCoroutine, addr 0x3751694, size 0x54, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* UploadScoresCoroutine();

  /// @brief Method <UploadScoresCoroutine>b__16_1, addr 0x3751a74, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x37519dc, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_allScoresDidUploadEvent, addr 0x375150c, size 0xac, virtual false, abstract: false, final false
  inline void add_allScoresDidUploadEvent(::System::Action* value);

  /// @brief Method remove_allScoresDidUploadEvent, addr 0x37515b8, size 0xac, virtual false, abstract: false, final false
