...
// Write type traits
MARK_REF_T(::GlobalNamespace::LeaderboardUploadData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LeaderboardUploadData*, "", "LeaderboardUploadData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3696274, size 0x28, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LeaderboardUploadData) == 0x68, "Size mismatch!");
