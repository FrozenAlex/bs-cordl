...
public:
  // Declarations
  /// @brief Method Create, addr 0x370a0c4, size 0x444, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessScore, addr 0x370a508, size 0x148, virtual false, abstract: false, final false
