...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelDataAssetDownloadUpdate_AssetDownloadingState, "", "LevelDataAssetDownloadUpdate/AssetDownloadingState");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelDataAssetDownloadUpdate, "", "LevelDataAssetDownloadUpdate");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::LevelDataAssetDownloadUpdate_AssetDownloadingState) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x366e6f0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LevelDataAssetDownloadUpdate) == 0x18, "Size mismatch!");
