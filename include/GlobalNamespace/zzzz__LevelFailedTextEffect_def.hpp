...
// Write type traits
MARK_REF_T(::GlobalNamespace::LevelFailedTextEffect*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelFailedTextEffect*, "", "LevelFailedTextEffect");
...
public:
  ...
  /// @brief Method ShowEffect, addr 0x584a634, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x584a670, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LevelFailedTextEffect) == 0x28, "Size mismatch!");
