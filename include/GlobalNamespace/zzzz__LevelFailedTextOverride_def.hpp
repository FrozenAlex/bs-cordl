...
// Write type traits
MARK_REF_T(::GlobalNamespace::LevelFailedTextOverride*);
MARK_REF_T(::GlobalNamespace::LevelFailedTextOverride_LanguageOverride*);
MARK_REF_T(::GlobalNamespace::LevelFailedTextOverride___c__DisplayClass6_0*);
MARK_VAL_T(::GlobalNamespace::LevelFailedTextOverride__Start_d__6);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelFailedTextOverride*, "", "LevelFailedTextOverride");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelFailedTextOverride_LanguageOverride*, "", "LevelFailedTextOverride/LanguageOverride");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelFailedTextOverride___c__DisplayClass6_0*, "", "LevelFailedTextOverride/<>c__DisplayClass6_0");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelFailedTextOverride__Start_d__6, "", "LevelFailedTextOverride/<Start>d__6");
...
public:
  ...
  ::System::Runtime::CompilerServices::TaskAwaiter_1<::ArrayW<::UnityW<::GlobalNamespace::BeatmapLevelPackSO>>> __u__2;
...
static_assert(sizeof(::GlobalNamespace::LevelFailedTextOverride__Start_d__6) == 0x50, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies BeatmapKey, LevelFailedTextOverride::LanguageOverride, UnityEngine.AddressableAssets.AssetReferenceT`1<TObject>, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__perLanguageOverrides, put = __cordl_internal_set__perLanguageOverrides)) ::ArrayW<::GlobalNamespace::LevelFailedTextOverride_LanguageOverride*>
  ...
  constexpr ::ArrayW<::UnityEngine::AddressableAssets::AssetReferenceT_1<::UnityW<::GlobalNamespace::BeatmapLevelPackSO>>*> const& __cordl_internal_get__beatmapLevelPacks() const;

  constexpr ::ArrayW<::UnityEngine::AddressableAssets::AssetReferenceT_1<::UnityW<::GlobalNamespace::BeatmapLevelPackSO>>*>& __cordl_internal_get__beatmapLevelPacks();

  constexpr ::ArrayW<::UnityEngine::AddressableAssets::AssetReferenceT_1<::UnityW<::GlobalNamespace::BeatmapLevelSO>>*> const& __cordl_internal_get__beatmapLevels() const;

  constexpr ::ArrayW<::UnityEngine::AddressableAssets::AssetReferenceT_1<::UnityW<::GlobalNamespace::BeatmapLevelSO>>*>& __cordl_internal_get__beatmapLevels();
  ...
  constexpr ::ArrayW<::GlobalNamespace::LevelFailedTextOverride_LanguageOverride*> const& __cordl_internal_get__perLanguageOverrides() const;

  constexpr ::ArrayW<::GlobalNamespace::LevelFailedTextOverride_LanguageOverride*>& __cordl_internal_get__perLanguageOverrides();

  constexpr void __cordl_internal_set__beatmapKey(::GlobalNamespace::BeatmapKey value);

  constexpr void __cordl_internal_set__beatmapLevelPacks(::ArrayW<::UnityEngine::AddressableAssets::AssetReferenceT_1<::UnityW<::GlobalNamespace::BeatmapLevelPackSO>>*> value);

  constexpr void __cordl_internal_set__beatmapLevels(::ArrayW<::UnityEngine::AddressableAssets::AssetReferenceT_1<::UnityW<::GlobalNamespace::BeatmapLevelSO>>*> value);
