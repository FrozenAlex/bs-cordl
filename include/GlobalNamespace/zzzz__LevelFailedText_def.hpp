...
// Write type traits
MARK_REF_T(::GlobalNamespace::LevelFailedText*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelFailedText*, "", "LevelFailedText");
...
public:
  ...
  /// @brief Method OverrideText, addr 0x584a5e4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x584a630, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LevelFailedText) == 0x30, "Size mismatch!");
