...
public:
  ...
  /// @brief Method <FilterLevelByText>b__15_0, addr 0x366ae04, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x366ae00, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <FilterLevelsAsync>b__3, addr 0x366ae44, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x366ac04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <FilterLevelsAsync>b__4, addr 0x366ae60, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x366ada8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CleanText, addr 0x366a5bc, size 0x94, virtual false, abstract: false, final false
  static inline ::StringW CleanText(::StringW s);

  /// @brief Method FilterLevelByText, addr 0x366a0c0, size 0x4fc, virtual false, abstract: false, final false
  ...
  /// @brief Method FilterLevelsAsync, addr 0x3669fa8, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method FilterLevelsAsync, addr 0x3669db0, size 0x1f8, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::Task_1<::ArrayW<::GlobalNamespace::BeatmapLevel*>>*
  ...
  /// @brief Method IsWithoutFilter, addr 0x3669d14, size 0x9c, virtual false, abstract: false, final false
  static inline bool IsWithoutFilter(::by_ref<::GlobalNamespace::LevelFilter> filter, bool ignoreFilterBySongs);

  /// @brief Method <FilterLevelByText>g__CalculateMatchScore|15_1, addr 0x366a650, size 0x114, virtual false, abstract: false, final false
  static inline int32_t _FilterLevelByText_g__CalculateMatchScore_15_1(::StringW levelString, ::ArrayW<::StringW> searchTerms);

  /// @brief Method <FilterLevelsAsync>g__HasPlayedAnyDifficulty|14_0, addr 0x366a7fc, size 0x31c, virtual false, abstract: false, final false
  ...
  /// @brief Method <FilterLevelsAsync>g__MatchesCharacteristic|14_1, addr 0x366ab18, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method <FilterLevelsAsync>g__MatchesDifficulty|14_2, addr 0x366ac08, size 0x1a0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x366aea8, size 0x964, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x366b80c, size 0x80, virtual true, abstract: false, final true
