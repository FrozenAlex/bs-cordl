...
// Write type traits
MARK_REF_T(::GlobalNamespace::LevelFilter___c*);
MARK_REF_T(::GlobalNamespace::LevelFilter___c__DisplayClass14_0*);
MARK_REF_T(::GlobalNamespace::LevelFilter___c__DisplayClass14_1*);
MARK_VAL_T(::GlobalNamespace::LevelFilter);
MARK_VAL_T(::GlobalNamespace::LevelFilter__FilterLevelsAsync_d__14);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelFilter___c*, "", "LevelFilter/<>c");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelFilter___c__DisplayClass14_0*, "", "LevelFilter/<>c__DisplayClass14_0");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelFilter___c__DisplayClass14_1*, "", "LevelFilter/<>c__DisplayClass14_1");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelFilter, "", "LevelFilter");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelFilter__FilterLevelsAsync_d__14, "", "LevelFilter/<FilterLevelsAsync>d__14");
...
public:
  ...
  /// @brief Method <FilterLevelByText>b__15_0, addr 0x3726794, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3726790, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LevelFilter___c) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method <FilterLevelsAsync>b__3, addr 0x37267d4, size 0x70, virtual false, abstract: false, final false
  inline bool _FilterLevelsAsync_b__3(::GlobalNamespace::BeatmapCharacteristic characteristic);
  ...
  /// @brief Method .ctor, addr 0x3726594, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LevelFilter___c__DisplayClass14_0) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method <FilterLevelsAsync>b__4, addr 0x3726844, size 0xb0, virtual false, abstract: false, final false
  inline bool _FilterLevelsAsync_b__4(::System::ValueTuple_2<::GlobalNamespace::BeatmapCharacteristic, ::GlobalNamespace::BeatmapDifficulty> entry);
  ...
  /// @brief Method .ctor, addr 0x3726738, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LevelFilter___c__DisplayClass14_1) == 0x20, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = getStaticF_bpmOptions, put = setStaticF_bpmOptions)) ::ArrayW<float_t> bpmOptions;

  /// @brief Method CleanText, addr 0x3725f20, size 0x94, virtual false, abstract: false, final false
  static inline ::StringW CleanText(::StringW s);

  /// @brief Method FilterLevelByText, addr 0x3725a24, size 0x4fc, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapLevel*>* FilterLevelByText(::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapLevel*>* levels,
                                                                                                            ::ArrayW<::StringW> searchTerms);

  /// @brief Method FilterLevelsAsync, addr 0x372590c, size 0x118, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::Task_1<::ArrayW<::GlobalNamespace::BeatmapLevel*>>*
  ...
  /// @brief Method FilterLevelsAsync, addr 0x3725714, size 0x1f8, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::Task_1<::ArrayW<::GlobalNamespace::BeatmapLevel*>>*
  FilterLevelsAsync(::ArrayW<::GlobalNamespace::BeatmapLevelPack*> packs, ::GlobalNamespace::LevelFilter filter, ::GlobalNamespace::PlayerDataModel* playerDataModel,
                    ::GlobalNamespace::IEntitlementModel* levelsModel, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method IsWithoutFilter, addr 0x3725678, size 0x9c, virtual false, abstract: false, final false
  static inline bool IsWithoutFilter(::by_ref<::GlobalNamespace::LevelFilter> filter, bool ignoreFilterBySongs);

  /// @brief Method <FilterLevelByText>g__CalculateMatchScore|15_1, addr 0x3725fb4, size 0x114, virtual false, abstract: false, final false
  static inline int32_t _FilterLevelByText_g__CalculateMatchScore_15_1(::StringW levelString, ::ArrayW<::StringW> searchTerms);

  /// @brief Method <FilterLevelsAsync>g__HasPlayedAnyDifficulty|14_0, addr 0x3726160, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method <FilterLevelsAsync>g__MatchesCharacteristic|14_1, addr 0x3726470, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method <FilterLevelsAsync>g__MatchesDifficulty|14_2, addr 0x3726598, size 0x1a0, virtual false, abstract: false, final false
  ...
  static inline ::ArrayW<float_t> getStaticF_bpmOptions();

  static inline void setStaticF_bpmOptions(::ArrayW<float_t> value);
  ...
  constexpr LevelFilter(bool songOwned, bool songNotOwned, bool songUnplayed, ::GlobalNamespace::BeatmapDifficultyMask difficulties, ::GlobalNamespace::SongPackMask songPacks,
                        ...
                        ::ArrayW<::StringW> limitIds) noexcept;
...
static_assert(sizeof(::GlobalNamespace::LevelFilter) == 0x50, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies EntitlementStatus, LevelFilter, System.Runtime.CompilerServices.AsyncTaskMethodBuilder`1<TResult>, System.Runtime.CompilerServices.TaskAwaiter`1<TResult>,
...
public:
  ...
  /// @brief Method MoveNext, addr 0x37268f4, size 0x964, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3727258, size 0x80, virtual true, abstract: false, final true
  ...
  // "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::ArrayW<::GlobalNamespace::BeatmapLevel*>>", modifiers: "", def_value: None }, CppParam { name: "beatmapLevels", ty:
  // "::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::BeatmapLevel*>*", modifiers: "", def_value: None }, CppParam { name: "filter", ty: "::GlobalNamespace::LevelFilter", modifiers:
  // "", def_value: None }, CppParam { name: "levelsModel", ty: "::GlobalNamespace::IEntitlementModel*", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty:
  // "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "playerDataModel", ty: "::UnityW<::GlobalNamespace::PlayerDataModel>", modifiers: "", def_value: None
  // }, CppParam { name: "_filteredLevels_5__2", ty: "::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapLevel*>*", modifiers: "", def_value: None }, CppParam { name: "__7__wrap2", ty:
  // "::System::Collections::Generic::IEnumerator_1<::GlobalNamespace::BeatmapLevel*>*", modifiers: "", def_value: None }, CppParam { name: "_level_5__4", ty: "::GlobalNamespace::BeatmapLevel*",
  ...
  constexpr LevelFilter__FilterLevelsAsync_d__14(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::ArrayW<::GlobalNamespace::BeatmapLevel*>> __t__builder,
                                                 ::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::BeatmapLevel*>* beatmapLevels, ::GlobalNamespace::LevelFilter filter,
                                                 ::GlobalNamespace::IEntitlementModel* levelsModel, ::System::Threading::CancellationToken cancellationToken,
                                                 ...
                                                 ::System::Collections::Generic::IEnumerator_1<::GlobalNamespace::BeatmapLevel*>* __7__wrap2, ::GlobalNamespace::BeatmapLevel* _level_5__4,
  ...
  ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::ArrayW<::GlobalNamespace::BeatmapLevel*>> __t__builder;
...
static_assert(sizeof(::GlobalNamespace::LevelFilter__FilterLevelsAsync_d__14) == 0xb0, "Size mismatch!");
