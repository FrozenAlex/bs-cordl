...
public:
  ...
  /// @brief Method <SelectAnnotatedBeatmapLevelCollection>b__53_0, addr 0x5822c14, size 0x14, virtual false, abstract: false, final false
  inline ::StringW _SelectAnnotatedBeatmapLevelCollection_b__53_0(::GlobalNamespace::BeatmapLevelPack* pack);

  /// @brief Method .ctor, addr 0x5822c10, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <SelectAnnotatedBeatmapLevelCollection>b__1, addr 0x5822c28, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5822aac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5822c48, size 0x5dc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5823224, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method DidActivate, addr 0x5821680, size 0x468, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x5821e7c, size 0x3d4, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleAnnotatedBeatmapLevelCollectionsViewControllerDidCloseBeatmapLevelCollections, addr 0x5822838, size 0x1c, virtual false, abstract: false, final false
  inline void HandleAnnotatedBeatmapLevelCollectionsViewControllerDidCloseBeatmapLevelCollections();

  /// @brief Method HandleAnnotatedBeatmapLevelCollectionsViewControllerDidOpenBeatmapLevelCollections, addr 0x582281c, size 0x1c, virtual false, abstract: false, final false
  inline void HandleAnnotatedBeatmapLevelCollectionsViewControllerDidOpenBeatmapLevelCollections();

  /// @brief Method HandleAnnotatedBeatmapLevelCollectionsViewControllerDidSelectAnnotatedBeatmapLevelCollection, addr 0x5822854, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleIncreaseNumberOfGameplays, addr 0x58227c4, size 0x4c, virtual false, abstract: false, final false
  inline void HandleIncreaseNumberOfGameplays();

  /// @brief Method HandleLevelSearchViewControllerDidFilterBeatmapLevelCollection, addr 0x58223d0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelSearchViewControllerDidStartLoading, addr 0x5821e5c, size 0x20, virtual false, abstract: false, final false
  inline void HandleLevelSearchViewControllerDidStartLoading(::GlobalNamespace::LevelSearchViewController* obj);

  /// @brief Method HandlePlayerDataFavoriteLevelsSetDidChange, addr 0x5822778, size 0x4c, virtual false, abstract: false, final false
  inline void HandlePlayerDataFavoriteLevelsSetDidChange();

  /// @brief Method HandleSelectLevelCategoryViewControllerDidSelectLevelCategory, addr 0x5822428, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceSecondViewController, addr 0x5822624, size 0xb4, virtual false, abstract: false, final false
  inline void ReplaceSecondViewController(::HMUI::ViewController* viewController);

  /// @brief Method SelectAnnotatedBeatmapLevelCollection, addr 0x58228a8, size 0x204, virtual false, abstract: false, final false
  inline void SelectAnnotatedBeatmapLevelCollection(::GlobalNamespace::BeatmapLevelPack* levelPack);

  /// @brief Method Setup, addr 0x58211fc, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupBeatmapLevelPacks, addr 0x58212a0, size 0x3e0, virtual false, abstract: false, final false
  inline void SetupBeatmapLevelPacks();

  /// @brief Method ShowPacksInSecondChildController, addr 0x5822430, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateCustomSongs, addr 0x58226d8, size 0xa0, virtual false, abstract: false, final false
  inline void UpdateCustomSongs();

  /// @brief Method UpdateSecondChildControllerContent, addr 0x5821c68, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method <SetupBeatmapLevelPacks>b__39_0, addr 0x5822abc, size 0x80, virtual false, abstract: false, final false
  inline bool _SetupBeatmapLevelPacks_b__39_0(::GlobalNamespace::BeatmapLevelPack* pack);

  /// @brief Method <SetupBeatmapLevelPacks>b__39_1, addr 0x5822b3c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5822ab0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didCloseBeatmapLevelCollectionsEvent, addr 0x5821078, size 0xac, virtual false, abstract: false, final false
  inline void add_didCloseBeatmapLevelCollectionsEvent(::System::Action* value);

  /// @brief Method add_didOpenBeatmapLevelCollectionsEvent, addr 0x5820f20, size 0xac, virtual false, abstract: false, final false
  inline void add_didOpenBeatmapLevelCollectionsEvent(::System::Action* value);

  /// @brief Method add_didPressAllSongsEvent, addr 0x5820da0, size 0xc0, virtual false, abstract: false, final false
  inline void add_didPressAllSongsEvent(::System::Action_1<::UnityW<::GlobalNamespace::LevelFilteringNavigationController>>* value);

  /// @brief Method add_didSelectBeatmapLevelPackEvent, addr 0x5820aa0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didStartLoadingEvent, addr 0x5820c20, size 0xc0, virtual false, abstract: false, final false
  inline void add_didStartLoadingEvent(::System::Action_1<::UnityW<::GlobalNamespace::LevelFilteringNavigationController>>* value);

  /// @brief Method get_selectedBeatmapLevelPack, addr 0x58211d0, size 0x14, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevelPack* get_selectedBeatmapLevelPack();

  /// @brief Method get_selectedLevelCategory, addr 0x58211e4, size 0x18, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SelectLevelCategoryViewController_LevelCategory get_selectedLevelCategory();

  /// @brief Method remove_didCloseBeatmapLevelCollectionsEvent, addr 0x5821124, size 0xac, virtual false, abstract: false, final false
  inline void remove_didCloseBeatmapLevelCollectionsEvent(::System::Action* value);

  /// @brief Method remove_didOpenBeatmapLevelCollectionsEvent, addr 0x5820fcc, size 0xac, virtual false, abstract: false, final false
  inline void remove_didOpenBeatmapLevelCollectionsEvent(::System::Action* value);

  /// @brief Method remove_didPressAllSongsEvent, addr 0x5820e60, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didPressAllSongsEvent(::System::Action_1<::UnityW<::GlobalNamespace::LevelFilteringNavigationController>>* value);

  /// @brief Method remove_didSelectBeatmapLevelPackEvent, addr 0x5820b60, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didStartLoadingEvent, addr 0x5820ce0, size 0xc0, virtual false, abstract: false, final false
