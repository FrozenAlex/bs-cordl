...
public:
  ...
  /// @brief Method ClearGameplaySetupData, addr 0x36770c0, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetBeatmapKey, addr 0x367712c, size 0xc, virtual false, abstract: false, final false
  inline void SetBeatmapKey(::by_ref<::GlobalNamespace::BeatmapKey> beatmapKey);

  /// @brief Method SetGameplayModifiers, addr 0x3677138, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3676fc0, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3677024, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::by_ref<::GlobalNamespace::BeatmapKey> beatmapKey, ::GlobalNamespace::GameplayModifiers* gameplayModifiers);

  /// @brief Method get_beatmapKey, addr 0x3676fac, size 0xc, virtual true, abstract: false, final true
  inline ::GlobalNamespace::BeatmapKey get_beatmapKey();

  /// @brief Method get_gameplayModifiers, addr 0x3676fb8, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::LevelGameplaySetupData) == 0x38, "Size mismatch!");
