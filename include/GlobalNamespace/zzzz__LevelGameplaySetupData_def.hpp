...
public:
  ...
  /// @brief Method ClearGameplaySetupData, addr 0x373122c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method SetBeatmapKey, addr 0x3731294, size 0xc, virtual false, abstract: false, final false
  inline void SetBeatmapKey(::by_ref<::GlobalNamespace::BeatmapKey> beatmapKey);

  /// @brief Method SetGameplayModifiers, addr 0x37312a0, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x373112c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3731190, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::by_ref<::GlobalNamespace::BeatmapKey> beatmapKey, ::GlobalNamespace::GameplayModifiers* gameplayModifiers);

  /// @brief Method get_beatmapKey, addr 0x3731118, size 0xc, virtual true, abstract: false, final true
  inline ::GlobalNamespace::BeatmapKey get_beatmapKey();

  /// @brief Method get_gameplayModifiers, addr 0x3731124, size 0x8, virtual true, abstract: false, final true
