...
// Write type traits
MARK_REF_T(::GlobalNamespace::LevelMissionParser*);
MARK_REF_T(::GlobalNamespace::LevelMissionParser_ParserFunction*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelMissionParser*, "", "LevelMissionParser");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelMissionParser_ParserFunction*, "", "LevelMissionParser/ParserFunction");
...
public:
  ...
  inline ::System::IAsyncResult* BeginInvoke(::ArrayW<float_t> functionParams, int32_t paramCount, ::System::AsyncCallback* callback, ::System::Object* object);
  ...
  inline bool Invoke(::ArrayW<float_t> functionParams, int32_t paramCount);
...
static_assert(sizeof(::GlobalNamespace::LevelMissionParser_ParserFunction) == 0x80, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::LevelMissionParser) == 0x18, "Size mismatch!");
