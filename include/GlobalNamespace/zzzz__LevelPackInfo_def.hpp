...
// Write type traits
MARK_REF_T(::GlobalNamespace::LevelPackInfo*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelPackInfo*, "", "LevelPackInfo");
// Dependencies LevelInfo, System.Object
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__levels_k__BackingField, put = __cordl_internal_set__levels_k__BackingField)) ::ArrayW<::GlobalNamespace::LevelInfo*> _levels_k__BackingField;
  ...
  __declspec(property(get = get_levels, put = set_levels)) ::ArrayW<::GlobalNamespace::LevelInfo*> levels;
  ...
  constexpr ::ArrayW<::GlobalNamespace::LevelInfo*> const& __cordl_internal_get__levels_k__BackingField() const;

  constexpr ::ArrayW<::GlobalNamespace::LevelInfo*>& __cordl_internal_get__levels_k__BackingField();
  ...
  constexpr void __cordl_internal_set__levels_k__BackingField(::ArrayW<::GlobalNamespace::LevelInfo*> value);
  ...
  /// @brief Method .ctor, addr 0x321fc00, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_levels, addr 0x321fbe0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::LevelInfo*> get_levels();

  /// @brief Method get_minimumProtocolVersion, addr 0x321fbf0, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_minimumProtocolVersion();

  /// @brief Method get_packID, addr 0x321fbd0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_packID();

  /// @brief Method set_levels, addr 0x321fbe8, size 0x8, virtual false, abstract: false, final false
  inline void set_levels(::ArrayW<::GlobalNamespace::LevelInfo*> value);

  /// @brief Method set_minimumProtocolVersion, addr 0x321fbf8, size 0x8, virtual false, abstract: false, final false
  inline void set_minimumProtocolVersion(uint32_t value);

  /// @brief Method set_packID, addr 0x321fbd8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::GlobalNamespace::LevelInfo*> ____levels_k__BackingField;
...
static_assert(sizeof(::GlobalNamespace::LevelPackInfo) == 0x28, "Size mismatch!");
