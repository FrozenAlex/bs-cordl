...
// Write type traits
MARK_REF_T(::GlobalNamespace::LevelParamsPanel*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelParamsPanel*, "", "LevelParamsPanel");
...
public:
  ...
  /// @brief Method .ctor, addr 0x57b5c38, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_bombsCount, addr 0x57b5bf4, size 0x44, virtual false, abstract: false, final false
  inline void set_bombsCount(int32_t value);

  /// @brief Method set_notesCount, addr 0x57b5b6c, size 0x44, virtual false, abstract: false, final false
  inline void set_notesCount(int32_t value);

  /// @brief Method set_notesPerSecond, addr 0x57b5aec, size 0x80, virtual false, abstract: false, final false
  inline void set_notesPerSecond(float_t value);

  /// @brief Method set_obstaclesCount, addr 0x57b5bb0, size 0x44, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LevelParamsPanel) == 0x40, "Size mismatch!");
