...
// Write type traits
MARK_REF_T(::GlobalNamespace::LevelScenesTransitionSetupDataSO*);
MARK_VAL_T(::GlobalNamespace::LevelScenesTransitionSetupDataSO__BeforeScenesWillBeActivatedAsync_d__11);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelScenesTransitionSetupDataSO*, "", "LevelScenesTransitionSetupDataSO");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelScenesTransitionSetupDataSO__BeforeScenesWillBeActivatedAsync_d__11, "", "LevelScenesTransitionSetupDataSO/<BeforeScenesWillBeActivatedAsync>d__11");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x57efbc0, size 0x3f8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x57effb8, size 0x6c, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::LevelScenesTransitionSetupDataSO__BeforeScenesWillBeActivatedAsync_d__11) == 0x38, "Size mismatch!");
...
public:
  ...
  /// @brief Method BeforeScenesWillBeActivated, addr 0x57efb9c, size 0x14, virtual true, abstract: false, final false
  inline void BeforeScenesWillBeActivated();

  /// @brief Method BeforeScenesWillBeActivatedAsync, addr 0x57efae8, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method <>n__0, addr 0x57efbb8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* __n__0();

  /// @brief Method .ctor, addr 0x57efbb0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_gameplayAdditionalInformationSetupData, addr 0x57efad8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayAdditionalInformationSetupData* get_gameplayAdditionalInformationSetupData();

  /// @brief Method get_gameplayCoreSceneSetupData, addr 0x57efac8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayCoreSceneSetupData* get_gameplayCoreSceneSetupData();

  /// @brief Method get_transformedBeatmapData, addr 0x57efab0, size 0x18, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IReadonlyBeatmapData* get_transformedBeatmapData();

  /// @brief Method set_gameplayAdditionalInformationSetupData, addr 0x57efae0, size 0x8, virtual false, abstract: false, final false
  inline void set_gameplayAdditionalInformationSetupData(::GlobalNamespace::GameplayAdditionalInformationSetupData* value);

  /// @brief Method set_gameplayCoreSceneSetupData, addr 0x57efad0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LevelScenesTransitionSetupDataSO) == 0x40, "Size mismatch!");
