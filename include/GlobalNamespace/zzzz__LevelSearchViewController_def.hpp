...
public:
  ...
  /// @brief Method MoveNext, addr 0x595258c, size 0xa5c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5952fe8, size 0x8, virtual true, abstract: false, final true
  ...
  // modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::ArrayW<::GlobalNamespace::BeatmapLevel*>>", modifiers: "", def_value: None
  // }]
  ...
  ::System::Runtime::CompilerServices::TaskAwaiter_1<::ArrayW<::GlobalNamespace::BeatmapLevel*>> __u__1;
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__preferredBeatmapCharacteristic,
                      put = __cordl_internal_set__preferredBeatmapCharacteristic)) ::System::Nullable_1<::GlobalNamespace::BeatmapCharacteristic>
  ...
  /// @brief Method DidActivate, addr 0x5951a74, size 0x1d8, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x5951c4c, size 0xe0, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method IsFilteringPlayCounts, addr 0x594f400, size 0x8, virtual false, abstract: false, final false
  inline bool IsFilteringPlayCounts();

  /// @brief Method LocalizedLevelFilterParamsDescription, addr 0x5951e04, size 0x68c, virtual false, abstract: false, final false
  static inline ::StringW LocalizedLevelFilterParamsDescription(::by_ref<::GlobalNamespace::LevelFilter> filter, ::GlobalNamespace::SongPackMasksModel* songPackMasksModel,
  ...
  /// @brief Method Refresh, addr 0x594f408, size 0x4, virtual false, abstract: false, final false
  inline void Refresh();

  /// @brief Method Refresh, addr 0x5951a54, size 0x20, virtual false, abstract: false, final false
  inline void Refresh(::by_ref<::GlobalNamespace::LevelFilter> filter);

  /// @brief Method RefreshAsync, addr 0x59519b0, size 0xa4, virtual false, abstract: false, final false
  inline void RefreshAsync();

  /// @brief Method ResetAllFilterSettings, addr 0x5951998, size 0x18, virtual false, abstract: false, final false
  inline void ResetAllFilterSettings(bool onlyFavorites);

  /// @brief Method ResetFilter, addr 0x594f1f0, size 0x2c, virtual false, abstract: false, final false
  inline void ResetFilter(bool onlyFavorites);

  /// @brief Method ResetOptionFilterSettings, addr 0x5951d34, size 0xb8, virtual false, abstract: false, final false
  inline void ResetOptionFilterSettings(bool onlyFavorites);

  /// @brief Method ResetTextFilterSettings, addr 0x5951d2c, size 0x8, virtual false, abstract: false, final false
  inline void ResetTextFilterSettings(::StringW text);

  /// @brief Method SearchTextInputFieldViewOnValueChanged, addr 0x5951dec, size 0x18, virtual false, abstract: false, final false
  inline void SearchTextInputFieldViewOnValueChanged(::HMUI::InputFieldView* inputFieldView);

  /// @brief Method Setup, addr 0x5951990, size 0x8, virtual false, abstract: false, final false
  inline void Setup(::ArrayW<::GlobalNamespace::BeatmapLevelPack*> beatmapLevelPacks);

  /// @brief Method <DidActivate>b__37_0, addr 0x5952518, size 0x50, virtual false, abstract: false, final false
  inline void _DidActivate_b__37_0();

  /// @brief Method <DidActivate>b__37_1, addr 0x5952568, size 0x24, virtual false, abstract: false, final false
  inline void _DidActivate_b__37_1();

  /// @brief Method <LocalizedLevelFilterParamsDescription>g__Append|44_0, addr 0x5952490, size 0x84, virtual false, abstract: false, final false
  ...
  constexpr ::System::Nullable_1<::GlobalNamespace::BeatmapCharacteristic> const& __cordl_internal_get__preferredBeatmapCharacteristic() const;

  constexpr ::System::Nullable_1<::GlobalNamespace::BeatmapCharacteristic>& __cordl_internal_get__preferredBeatmapCharacteristic();
  ...
  constexpr void __cordl_internal_set__preferredBeatmapCharacteristic(::System::Nullable_1<::GlobalNamespace::BeatmapCharacteristic> value);
  ...
  /// @brief Method .ctor, addr 0x5952514, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFilterBeatmapLevelCollectionEvent, addr 0x594e614, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didPressSearchButtonEvent, addr 0x5951810, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didStartLoadingEvent, addr 0x594e6d4, size 0xc0, virtual false, abstract: false, final false
  inline void add_didStartLoadingEvent(::System::Action_1<::UnityW<::GlobalNamespace::LevelSearchViewController>>* value);

  /// @brief Method remove_didFilterBeatmapLevelCollectionEvent, addr 0x594ee48, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didPressSearchButtonEvent, addr 0x59518d0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didStartLoadingEvent, addr 0x594ef08, size 0xc0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field kFilterByNotPlayedYetLocalizationKey offset 0xffffffff size 0x8
  static constexpr ::ConstString kFilterByNotPlayedYetLocalizationKey{ u"FILTER_BY_NOT_PLAYED_YET" };
  ...
  /// @brief Field kMinBpmLocalizationKey offset 0xffffffff size 0x8
  static constexpr ::ConstString kMinBpmLocalizationKey{ u"MIN_BPM" };
  ...
  ::System::Nullable_1<::GlobalNamespace::BeatmapCharacteristic> ____preferredBeatmapCharacteristic;
...
static_assert(sizeof(::GlobalNamespace::LevelSearchViewController) == 0x158, "Size mismatch!");
