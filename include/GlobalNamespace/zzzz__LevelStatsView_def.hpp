...
// Write type traits
MARK_REF_T(::GlobalNamespace::LevelStatsView*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelStatsView*, "", "LevelStatsView");
...
public:
  ...
  /// @brief Method Hide, addr 0x5a1cc84, size 0x24, virtual false, abstract: false, final false
  inline void Hide();

  static inline ::GlobalNamespace::LevelStatsView* New_ctor();

  /// @brief Method ShowStats, addr 0x5a1cca8, size 0x2c, virtual false, abstract: false, final false
  inline void ShowStats(::by_ref<::GlobalNamespace::BeatmapKey> beatmapKey, ::GlobalNamespace::PlayerData* playerData);

  /// @brief Method ShowStats, addr 0x5a1ccd4, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a1ce44, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LevelStatsView) == 0x38, "Size mismatch!");
