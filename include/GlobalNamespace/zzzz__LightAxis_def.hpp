...
#include <cstddef>
#include <cstdint>
CORDL_MODULE_EXPORT(LightAxis)
// Forward declare root types
namespace GlobalNamespace {
struct LightAxis;
}
// Write type traits
MARK_VAL_T(::GlobalNamespace::LightAxis);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightAxis, "", "LightAxis");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
// CS Name: LightAxis
...
public:
  ...
  /// @brief Nested struct __LightAxis_Unwrapped
  enum struct __LightAxis_Unwrapped : int32_t {
  ...
  constexpr operator __LightAxis_Unwrapped() const noexcept {
    return static_cast<__LightAxis_Unwrapped>(this->value__);
  }
...
static_assert(offsetof(::GlobalNamespace::LightAxis, value__) == 0x0, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::LightAxis) == 0x4, "Size mismatch!");
