...
public:
  ...
  /// @brief Method HandleColorBoostBeatmapEvent, addr 0x5859f6c, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5859e54, size 0x118, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x5859bbc, size 0x298, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x585a08c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lightGroups, addr 0x5859bb4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LightColorGroupEffectManager) == 0x48, "Size mismatch!");
