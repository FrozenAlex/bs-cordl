...
// Write type traits
MARK_REF_T(::GlobalNamespace::LightColorGroup*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightColorGroup*, "", "LightColorGroup");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5858ef4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LightColorGroup) == 0x28, "Size mismatch!");
