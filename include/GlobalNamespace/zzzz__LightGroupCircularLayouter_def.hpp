...
MARK_REF_T(::GlobalNamespace::LightGroupCircularLayouter*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightGroupCircularLayouter_RotationDirection, "", "LightGroupCircularLayouter/RotationDirection");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightGroupCircularLayouter*, "", "LightGroupCircularLayouter");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
public:
  ...
  /// @brief Method .ctor, addr 0x585a590, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LightGroupCircularLayouter) == 0x48, "Size mismatch!");
