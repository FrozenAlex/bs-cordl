...
// Write type traits
MARK_REF_T(::GlobalNamespace::LightGroupEditorPrefabContext*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightGroupEditorPrefabContext*, "", "LightGroupEditorPrefabContext");
...
public:
  ...
  /// @brief Method .ctor, addr 0x586cbfc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LightGroupEditorPrefabContext) == 0x28, "Size mismatch!");
