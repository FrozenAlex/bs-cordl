...
public:
  ...
  /// @brief Method .ctor, addr 0x586cc40, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LightGroupElementsSpawner) == 0x38, "Size mismatch!");
