...
public:
  ...
  /// @brief Method .ctor, addr 0x585a5f8, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LightGroupGridLayouter) == 0x58, "Size mismatch!");
