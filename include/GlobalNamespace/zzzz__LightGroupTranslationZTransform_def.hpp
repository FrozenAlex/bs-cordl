...
// Write type traits
MARK_REF_T(::GlobalNamespace::LightGroupTranslationZTransform*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightGroupTranslationZTransform*, "", "LightGroupTranslationZTransform");
...
public:
  ...
  /// @brief Method .ctor, addr 0x585a784, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LightGroupTranslationZTransform) == 0x20, "Size mismatch!");
