...
namespace GlobalNamespace {
class LightPairSinMoveEventEffect_MovementData;
}
namespace GlobalNamespace {
class TimeHelper;
}
...
// Write type traits
MARK_REF_T(::GlobalNamespace::LightPairSinMoveEventEffect*);
MARK_REF_T(::GlobalNamespace::LightPairSinMoveEventEffect_MovementData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightPairSinMoveEventEffect*, "", "LightPairSinMoveEventEffect");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightPairSinMoveEventEffect_MovementData*, "", "LightPairSinMoveEventEffect/MovementData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x585de0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::LightPairSinMoveEventEffect_MovementData, ___speed) == 0x14, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightPairSinMoveEventEffect_MovementData, ___startPosition) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightPairSinMoveEventEffect_MovementData, ___transform) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightPairSinMoveEventEffect_MovementData, ___startMovementValue) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightPairSinMoveEventEffect_MovementData, ___movementValue) == 0x34, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightPairSinMoveEventEffect_MovementData, ___side) == 0x38, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::LightPairSinMoveEventEffect_MovementData) == 0x40, "Size mismatch!");
...
public:
  ...
  /// @brief Method HandleBeatmapEvent, addr 0x585e008, size 0x18c, virtual false, abstract: false, final false
  inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData* basicBeatmapEventData);

  static inline ::GlobalNamespace::LightPairSinMoveEventEffect* New_ctor();

  /// @brief Method OnDestroy, addr 0x585dfec, size 0x1c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x585db1c, size 0x2f0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x585de10, size 0x1dc, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateMovementData, addr 0x585e194, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x585e2d4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::LightPairSinMoveEventEffect, ____random) == 0x70, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightPairSinMoveEventEffect, ____timeHelper) == 0x78, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightPairSinMoveEventEffect, ____movementDataL) == 0x80, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightPairSinMoveEventEffect, ____movementDataR) == 0x88, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightPairSinMoveEventEffect, ____randomGenerationFrameNum) == 0x90, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightPairSinMoveEventEffect, ____randomStartOffset) == 0x94, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightPairSinMoveEventEffect, ____beatmapDataCallbackWrapper) == 0x98, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::LightPairSinMoveEventEffect) == 0xa0, "Size mismatch!");
