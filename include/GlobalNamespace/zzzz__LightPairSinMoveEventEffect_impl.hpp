...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::LightPairSinMoveEventEffect_MovementData::*)()>(&::GlobalNamespace::LightPairSinMoveEventEffect_MovementData::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5994b00;
...
inline ::GlobalNamespace::LightPairSinMoveEventEffect_MovementData* GlobalNamespace::LightPairSinMoveEventEffect_MovementData::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::LightPairSinMoveEventEffect_MovementData*>());
}
// Ctor Parameters []
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::LightPairSinMoveEventEffect::*)()>(&::GlobalNamespace::LightPairSinMoveEventEffect::Start)> {
  ...
  constexpr static std::size_t addrs = 0x5994810;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::LightPairSinMoveEventEffect::*)()>(&::GlobalNamespace::LightPairSinMoveEventEffect::Update)> {
  ...
  constexpr static std::size_t addrs = 0x5994b04;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::LightPairSinMoveEventEffect::*)()>(&::GlobalNamespace::LightPairSinMoveEventEffect::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x5994ce0;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::LightPairSinMoveEventEffect::*)(::GlobalNamespace::BasicBeatmapEventData*)>(
  ...
  constexpr static std::size_t addrs = 0x5994cfc;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::LightPairSinMoveEventEffect::*)(int32_t, ::GlobalNamespace::LightPairSinMoveEventEffect_MovementData*, float_t)>(
  ...
  constexpr static std::size_t addrs = 0x5994e88;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{},
        (::i2c::find_method(::i2c::class_of<::GlobalNamespace::LightPairSinMoveEventEffect*>(),
                            { "UpdateMovementData", {}, { ::i2c::type_of<int32_t>(), ::i2c::type_of<::GlobalNamespace::LightPairSinMoveEventEffect_MovementData*>(), ::i2c::type_of<float_t>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::LightPairSinMoveEventEffect::*)()>(&::GlobalNamespace::LightPairSinMoveEventEffect::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5994fc8;
...
constexpr ::GlobalNamespace::IRandom*& GlobalNamespace::LightPairSinMoveEventEffect::__cordl_internal_get__random() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____random;
}
constexpr ::GlobalNamespace::IRandom* const& GlobalNamespace::LightPairSinMoveEventEffect::__cordl_internal_get__random() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____random;
}
constexpr void GlobalNamespace::LightPairSinMoveEventEffect::__cordl_internal_set__random(::GlobalNamespace::IRandom* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____random = value;
}
constexpr ::UnityW<::GlobalNamespace::TimeHelper>& GlobalNamespace::LightPairSinMoveEventEffect::__cordl_internal_get__timeHelper() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____timeHelper;
}
constexpr ::UnityW<::GlobalNamespace::TimeHelper> const& GlobalNamespace::LightPairSinMoveEventEffect::__cordl_internal_get__timeHelper() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____timeHelper;
}
constexpr void GlobalNamespace::LightPairSinMoveEventEffect::__cordl_internal_set__timeHelper(::UnityW<::GlobalNamespace::TimeHelper> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline void GlobalNamespace::LightPairSinMoveEventEffect::UpdateMovementData(int32_t beatmapEventDataValue, ::GlobalNamespace::LightPairSinMoveEventEffect_MovementData* movementData,
  ...
  static auto* ___internal_method = THROW_UNLESS(
      ...
      (::i2c::find_method(::i2c::class_of<::GlobalNamespace::LightPairSinMoveEventEffect*>(),
                          { "UpdateMovementData", {}, { ::i2c::type_of<int32_t>(), ::i2c::type_of<::GlobalNamespace::LightPairSinMoveEventEffect_MovementData*>(), ::i2c::type_of<float_t>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, beatmapEventDataValue, movementData, movementValueOffset);
}
...
inline ::GlobalNamespace::LightPairSinMoveEventEffect* GlobalNamespace::LightPairSinMoveEventEffect::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::LightPairSinMoveEventEffect*>());
}
// Ctor Parameters []
