...
// Write type traits
MARK_REF_T(::GlobalNamespace::LightRotationBaseData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightRotationBaseData*, "", "LightRotationBaseData");
...
static_assert(sizeof(::GlobalNamespace::LightRotationBaseData) == 0x28, "Size mismatch!");
