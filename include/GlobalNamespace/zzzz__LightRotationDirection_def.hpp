...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightRotationDirection, "", "LightRotationDirection");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::LightRotationDirection) == 0x4, "Size mismatch!");
