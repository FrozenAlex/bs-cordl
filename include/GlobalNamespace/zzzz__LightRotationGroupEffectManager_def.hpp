...
public:
  ...
  __declspec(property(get = __cordl_internal_get__lightRotationGroups, put = __cordl_internal_set__lightRotationGroups)) ::ArrayW<::UnityW<::GlobalNamespace::LightRotationGroup>> _lightRotationGroups;
  ...
  constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightRotationGroup>> const& __cordl_internal_get__lightRotationGroups() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightRotationGroup>>& __cordl_internal_get__lightRotationGroups();
...
static_assert(sizeof(::GlobalNamespace::LightRotationGroupEffectManager) == 0x38, "Size mismatch!");
