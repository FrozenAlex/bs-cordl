...
// Write type traits
MARK_REF_T(::GlobalNamespace::LightRotationGroup*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightRotationGroup*, "", "LightRotationGroup");
...
public:
  ...
  /// @brief Method .ctor, addr 0x585a790, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_transformGroupType, addr 0x585a788, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LightRotationGroup) == 0x48, "Size mismatch!");
