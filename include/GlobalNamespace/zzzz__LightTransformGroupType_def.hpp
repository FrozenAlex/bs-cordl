...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightTransformGroupType, "", "LightTransformGroupType");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::LightTransformGroupType) == 0x4, "Size mismatch!");
