...
// Write type traits
MARK_REF_T(::GlobalNamespace::LightTranslationBeatmapEventData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightTranslationBeatmapEventData*, "", "LightTranslationBeatmapEventData");
// Dependencies BeatmapEventData, EaseType, LightAxis
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = getStaticF__defaults, put = setStaticF__defaults)) ::System::Collections::Generic::Dictionary_2<int32_t, ::GlobalNamespace::LightTranslationBeatmapEventData*>* _defaults;

  /// @brief Field <distribution>k__BackingField, offset 0x50, size 0x4
  ...
  /// @brief Field <translation>k__BackingField, offset 0x4c, size 0x4
  ...
  /// @brief Field easeType, offset 0x44, size 0x4
  ...
  __declspec(property(get = get_nextSameTypeEventData)) ::GlobalNamespace::LightTranslationBeatmapEventData* nextSameTypeEventData;

  __declspec(property(get = get_previousSameTypeEventData)) ::GlobalNamespace::LightTranslationBeatmapEventData* previousSameTypeEventData;
  ...
  /// @brief Method ChangeTranslation, addr 0x3257f34, size 0x8, virtual false, abstract: false, final false
  inline void ChangeTranslation(float_t translation, float_t distribution);

  /// @brief Method GetCopy, addr 0x3257f3c, size 0xac, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0x3257fe8, size 0x178, virtual true, abstract: false, final false
  ...
  /// @brief Method SubtypeIdentifier, addr 0x3257f1c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3257e48, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_distribution, addr 0x3257e38, size 0x8, virtual false, abstract: false, final false
  inline float_t get_distribution();

  /// @brief Method get_nextSameTypeEventData, addr 0x3257dac, size 0x7c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::LightTranslationBeatmapEventData* get_nextSameTypeEventData();

  /// @brief Method get_previousSameTypeEventData, addr 0x3257d30, size 0x7c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::LightTranslationBeatmapEventData* get_previousSameTypeEventData();

  /// @brief Method get_translation, addr 0x3257e28, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_distribution, addr 0x3257e40, size 0x8, virtual false, abstract: false, final false
  inline void set_distribution(float_t value);

  /// @brief Method set_translation, addr 0x3257e30, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field easeType, offset: 0x44, size: 0x4, def value: None
...
static_assert(offsetof(::GlobalNamespace::LightTranslationBeatmapEventData, ___groupId) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationBeatmapEventData, ___elementId) == 0x3c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationBeatmapEventData, ___usePreviousEventValue) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationBeatmapEventData, ___easeType) == 0x44, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationBeatmapEventData, ___axis) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationBeatmapEventData, ____translation_k__BackingField) == 0x4c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationBeatmapEventData, ____distribution_k__BackingField) == 0x50, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::LightTranslationBeatmapEventData) == 0x58, "Size mismatch!");
