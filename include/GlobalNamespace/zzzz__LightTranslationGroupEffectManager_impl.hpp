...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::LightTranslationGroupEffectManager::*)()>(&::GlobalNamespace::LightTranslationGroupEffectManager::Start)> {
  ...
  constexpr static std::size_t addrs = 0x585c8fc;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::LightTranslationGroupEffectManager::*)()>(&::GlobalNamespace::LightTranslationGroupEffectManager::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x585cce4;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::LightTranslationGroupEffectManager::*)()>(&::GlobalNamespace::LightTranslationGroupEffectManager::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x585cde8;
...
constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightTranslationGroup>>& GlobalNamespace::LightTranslationGroupEffectManager::__cordl_internal_get__lightTranslationGroups() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____lightTranslationGroups;
}
constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightTranslationGroup>> const& GlobalNamespace::LightTranslationGroupEffectManager::__cordl_internal_get__lightTranslationGroups() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____lightTranslationGroups;
}
constexpr void GlobalNamespace::LightTranslationGroupEffectManager::__cordl_internal_set__lightTranslationGroups(::ArrayW<::UnityW<::GlobalNamespace::LightTranslationGroup>> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____lightTranslationGroups = value;
}
...
constexpr void GlobalNamespace::LightTranslationGroupEffectManager::__cordl_internal_set__lightTranslationGroupEffects(
  ...
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____lightTranslationGroupEffects = value;
}
...
inline ::GlobalNamespace::LightTranslationGroupEffectManager* GlobalNamespace::LightTranslationGroupEffectManager::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::LightTranslationGroupEffectManager*>());
}
// Ctor Parameters []
