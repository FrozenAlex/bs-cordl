...
// Dependencies System.Collections.Generic.List`1<T>, System.Nullable`1<T>, UnityEngine.Color, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__colors, put = __cordl_internal_set__colors)) ::ArrayW<::System::Nullable_1<::UnityEngine::Color>> _colors;
  ...
  __declspec(property(get = __cordl_internal_get__lights, put = __cordl_internal_set__lights)) ::ArrayW<::System::Collections::Generic::List_1<::GlobalNamespace::ILightWithId*>*> _lights;
  ...
  /// @brief Method GetColorForId, addr 0x586f6e4, size 0xd8, virtual false, abstract: false, final false
  inline ::UnityEngine::Color GetColorForId(int32_t lightId, bool initializeIfNull);

  /// @brief Method LateUpdate, addr 0x586ee40, size 0x248, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::LightWithIdManager* New_ctor();

  /// @brief Method RegisterLight, addr 0x586f088, size 0x448, virtual false, abstract: false, final false
  inline void RegisterLight(::GlobalNamespace::ILightWithId* lightWithId);

  /// @brief Method SetColorForId, addr 0x586c9e4, size 0x214, virtual false, abstract: false, final false
  inline void SetColorForId(int32_t lightId, ::UnityEngine::Color color);

  /// @brief Method UnregisterLight, addr 0x586f4d0, size 0x214, virtual false, abstract: false, final false
  inline void UnregisterLight(::GlobalNamespace::ILightWithId* lightWithId);

  constexpr ::ArrayW<::System::Nullable_1<::UnityEngine::Color>> const& __cordl_internal_get__colors() const;

  constexpr ::ArrayW<::System::Nullable_1<::UnityEngine::Color>>& __cordl_internal_get__colors();
  ...
  constexpr ::ArrayW<::System::Collections::Generic::List_1<::GlobalNamespace::ILightWithId*>*> const& __cordl_internal_get__lights() const;

  constexpr ::ArrayW<::System::Collections::Generic::List_1<::GlobalNamespace::ILightWithId*>*>& __cordl_internal_get__lights();
  ...
  constexpr void __cordl_internal_set__colors(::ArrayW<::System::Nullable_1<::UnityEngine::Color>> value);

  constexpr void __cordl_internal_set__didChangeSomeColorsThisFrame(bool value);

  constexpr void __cordl_internal_set__lights(::ArrayW<::System::Collections::Generic::List_1<::GlobalNamespace::ILightWithId*>*> value);
  ...
  /// @brief Method .ctor, addr 0x586f7bc, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didChangeSomeColorsThisFrameEvent, addr 0x586ece8, size 0xac, virtual false, abstract: false, final false
  inline void add_didChangeSomeColorsThisFrameEvent(::System::Action* value);

  /// @brief Method remove_didChangeSomeColorsThisFrameEvent, addr 0x586ed94, size 0xac, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::System::Collections::Generic::List_1<::GlobalNamespace::ILightWithId*>*> ____lights;

  /// @brief Field _colors, offset: 0x30, size: 0x8, def value: None
  ::ArrayW<::System::Nullable_1<::UnityEngine::Color>> ____colors;
