...
// Write type traits
MARK_REF_T(::GlobalNamespace::LightmapLightWithIdsGroupEntry*);
MARK_REF_T(::GlobalNamespace::LightmapLightWithIdsGroupEntry_GroupLightData*);
MARK_REF_T(::GlobalNamespace::LightmapLightWithIdsGroupEntry_LightIntensitiesWithId*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightmapLightWithIdsGroupEntry*, "", "LightmapLightWithIdsGroupEntry");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightmapLightWithIdsGroupEntry_GroupLightData*, "", "LightmapLightWithIdsGroupEntry/GroupLightData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightmapLightWithIdsGroupEntry_LightIntensitiesWithId*, "", "LightmapLightWithIdsGroupEntry/LightIntensitiesWithId");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5729dc0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_groupIntensity, addr 0x5729db0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_groupIntensity();

  /// @brief Method get_groupProbeHighlightsIntensityMultiplier, addr 0x5729db8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_groupProbeHighlightsIntensityMultiplier();

  /// @brief Method get_lightGroup, addr 0x5729da8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LightmapLightWithIdsGroupEntry_GroupLightData) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5729de4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t lightId, float_t intensity, float_t probeHighlightsIntensityMultiplier);

  /// @brief Method get_intensity, addr 0x5729dd4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_intensity();

  /// @brief Method get_lightId, addr 0x5729dcc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_lightId();

  /// @brief Method get_probeHighlightsIntensityMultiplier, addr 0x5729ddc, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LightmapLightWithIdsGroupEntry_LightIntensitiesWithId) == 0x20, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__excludedLightIds, put = __cordl_internal_set__excludedLightIds)) ::ArrayW<int32_t> _excludedLightIds;
  ...
  constexpr ::ArrayW<int32_t> const& __cordl_internal_get__excludedLightIds() const;

  constexpr ::ArrayW<int32_t>& __cordl_internal_get__excludedLightIds();
  ...
  constexpr void __cordl_internal_set__excludedLightIds(::ArrayW<int32_t> value);
  ...
  /// @brief Method .ctor, addr 0x5729da4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_groupLightData, addr 0x5729d8c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_groupLightsWeighting, addr 0x5729d9c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorMixAndWeightingApproach get_groupLightsWeighting();

  /// @brief Method get_individualLightData, addr 0x5729d94, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_lightmapLightWithIds, addr 0x5729d84, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LightmapLightWithIdsGroupEntry) == 0x48, "Size mismatch!");
