...
// Write type traits
MARK_REF_T(::GlobalNamespace::ListColorController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ListColorController*, "", "ListColorController");
// Dependencies IncDecColorController
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method DecButtonPressed, addr 0x5a2b914, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method IncButtonPressed, addr 0x5a2b8d4, size 0x40, virtual true, abstract: false, final false
  inline void IncButtonPressed();

  static inline ::GlobalNamespace::ListColorController* New_ctor();

  /// @brief Method OnEnable, addr 0x5a2b7f4, size 0x34, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Refresh, addr 0x5a2b878, size 0x5c, virtual false, abstract: false, final false
  inline void Refresh(bool applyValue);

  /// @brief Method RefreshUI, addr 0x5a2b828, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a2b94c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ListColorController) == 0x30, "Size mismatch!");
