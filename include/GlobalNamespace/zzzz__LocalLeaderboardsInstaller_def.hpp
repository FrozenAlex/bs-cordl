...
// Write type traits
MARK_REF_T(::GlobalNamespace::LocalLeaderboardsInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LocalLeaderboardsInstaller*, "", "LocalLeaderboardsInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x36b38f4, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36b39d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LocalLeaderboardsInstaller) == 0x30, "Size mismatch!");
