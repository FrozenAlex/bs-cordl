...
public:
  ...
  /// @brief Method .ctor, addr 0x369af84, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_maxNumberOfScoresInLeaderboard, addr 0x369af74, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxNumberOfScoresInLeaderboard();

  /// @brief Method set_maxNumberOfScoresInLeaderboard, addr 0x369af7c, size 0x8, virtual false, abstract: false, final false
