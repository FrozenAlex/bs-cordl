...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::LocalMultiplayerSyncState_3);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::LocalMultiplayerSyncState_3, "", "LocalMultiplayerSyncState`3");
...
public:
  ...
  static inline ::GlobalNamespace::LocalMultiplayerSyncState_3<TStateTable, TType, TState>* New_ctor(::GlobalNamespace::IBeatSaberConnectedPlayer* player, int64_t fullStateUpdateFrequency,
  ...
  template <typename T> inline bool TryGetSerializedState(::GlobalNamespace::IPacketPool_1<T>* pool, ::by_ref<T> serializable);

  /// @brief Method TryGetSerializedStateDelta, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> inline bool TryGetSerializedStateDelta(::GlobalNamespace::IPacketPool_1<T>* pool, ::by_ref<T> serializable);
  ...
  inline void _ctor(::GlobalNamespace::IBeatSaberConnectedPlayer* player, int64_t fullStateUpdateFrequency, int64_t deltaUpdateFrequency, int32_t size,
                    ::GlobalNamespace::StateBuffer_3_InterpolationDelegate<TStateTable, TType, TState>* interpolator,
                    ::GlobalNamespace::StateBuffer_3_SmoothingDelegate<TStateTable, TType, TState>* smoother);
