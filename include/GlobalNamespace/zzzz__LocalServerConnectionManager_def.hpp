...
public:
  ...
  /// @brief Method .ctor, addr 0x32aaba4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x32aaba8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x32aabac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ConnectToLocalServer, addr 0x32aa048, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method Disconnect, addr 0x32aa5d4, size 0x2c0, virtual true, abstract: false, final true
  inline void Disconnect(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method Dispose, addr 0x32a9d70, size 0xa4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DisposeAsync, addr 0x32aaae0, size 0xc4, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::ValueTask DisposeAsync();

  /// @brief Method GetConnection, addr 0x32aa9e0, size 0x100, virtual true, abstract: false, final true
  inline ::GlobalNamespace::IConnection* GetConnection(int32_t index);

  /// @brief Method GetPlayerSessionInfo, addr 0x32aa1b0, size 0xbc, virtual false, abstract: false, final false
  inline ::BGNet::Core::GameLift::PlayerSessionInfo* GetPlayerSessionInfo();

  /// @brief Method GetPublicServers, addr 0x32aa894, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleConnectToServerSuccess, addr 0x32aa26c, size 0x368, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleConnected, addr 0x32aa8f0, size 0x30, virtual false, abstract: false, final false
  inline void HandleConnected();

  /// @brief Method HandleReceivedData, addr 0x32aa9c4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleServerConnectionConnected, addr 0x32aa920, size 0x80, virtual false, abstract: false, final false
  inline void HandleServerConnectionConnected(::GlobalNamespace::IConnection* connection);

  /// @brief Method HandleServerConnectionDisconnected, addr 0x32aa9a0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleServerConnectionFailed, addr 0x32aa9bc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Log, addr 0x32aa124, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method PollUpdate, addr 0x32a9e14, size 0xa4, virtual true, abstract: false, final true
  inline void PollUpdate();

  /// @brief Method SendToAll, addr 0x32a9eb8, size 0xc0, virtual true, abstract: false, final true
  inline void SendToAll(::LiteNetLib::Utils::NetDataWriter* writer, ::BGNet::Core::DeliveryMethod deliveryMethod);

  /// @brief Method SendToAll, addr 0x32a9f78, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32a9838, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x32a9898, size 0x4d8, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::IConnectionManager* connectionManager);

  /// @brief Method add_onConnectedEvent, addr 0x32a8a2c, size 0xac, virtual true, abstract: false, final true
  inline void add_onConnectedEvent(::System::Action* value);

  /// @brief Method add_onConnectionConnectedEvent, addr 0x32a8e84, size 0xc0, virtual true, abstract: false, final true
  inline void add_onConnectionConnectedEvent(::System::Action_1<::GlobalNamespace::IConnection*>* value);

  /// @brief Method add_onConnectionDisconnectedEvent, addr 0x32a9004, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method add_onConnectionFailedEvent, addr 0x32a8d04, size 0xc0, virtual true, abstract: false, final true
  inline void add_onConnectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>* value);

  /// @brief Method add_onDisconnectedEvent, addr 0x32a8b84, size 0xc0, virtual true, abstract: false, final true
  inline void add_onDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method add_onInitializedEvent, addr 0x32a88d4, size 0xac, virtual true, abstract: false, final true
  inline void add_onInitializedEvent(::System::Action* value);

  /// @brief Method add_onReceivedDataEvent, addr 0x32a9184, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method get_code, addr 0x32a9828, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_code();

  /// @brief Method get_compatibilityVersion, addr 0x32a952c, size 0xa8, virtual true, abstract: false, final true
  inline ::StringW get_compatibilityVersion();

  /// @brief Method get_configuration, addr 0x32a9814, size 0x14, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayServerConfiguration get_configuration();

  /// @brief Method get_connectionCount, addr 0x32a9604, size 0xa8, virtual true, abstract: false, final true
  inline int32_t get_connectionCount();

  /// @brief Method get_isConnected, addr 0x32a95d4, size 0x10, virtual true, abstract: false, final true
  inline bool get_isConnected();

  /// @brief Method get_isConnecting, addr 0x32a95e4, size 0x10, virtual true, abstract: false, final true
  inline bool get_isConnecting();

  /// @brief Method get_isConnectionOwner, addr 0x32a96ac, size 0xa8, virtual true, abstract: false, final true
  inline bool get_isConnectionOwner();

  /// @brief Method get_isDisconnecting, addr 0x32a95f4, size 0x10, virtual true, abstract: false, final true
  inline bool get_isDisconnecting();

  /// @brief Method get_isDisposed, addr 0x32a9754, size 0xa8, virtual true, abstract: false, final true
  inline bool get_isDisposed();

  /// @brief Method get_secret, addr 0x32a9830, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_secret();

  /// @brief Method get_selectionMask, addr 0x32a97fc, size 0x18, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevelSelectionMask get_selectionMask();

  /// @brief Method get_userId, addr 0x32a9304, size 0x114, virtual true, abstract: false, final true
  inline ::StringW get_userId();

  /// @brief Method get_userName, addr 0x32a9418, size 0x114, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_onConnectedEvent, addr 0x32a8ad8, size 0xac, virtual true, abstract: false, final true
  inline void remove_onConnectedEvent(::System::Action* value);

  /// @brief Method remove_onConnectionConnectedEvent, addr 0x32a8f44, size 0xc0, virtual true, abstract: false, final true
  inline void remove_onConnectionConnectedEvent(::System::Action_1<::GlobalNamespace::IConnection*>* value);

  /// @brief Method remove_onConnectionDisconnectedEvent, addr 0x32a90c4, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_onConnectionFailedEvent, addr 0x32a8dc4, size 0xc0, virtual true, abstract: false, final true
  inline void remove_onConnectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>* value);

  /// @brief Method remove_onDisconnectedEvent, addr 0x32a8c44, size 0xc0, virtual true, abstract: false, final true
  inline void remove_onDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method remove_onInitializedEvent, addr 0x32a8980, size 0xac, virtual true, abstract: false, final true
  inline void remove_onInitializedEvent(::System::Action* value);

  /// @brief Method remove_onReceivedDataEvent, addr 0x32a9244, size 0xc0, virtual true, abstract: false, final true
