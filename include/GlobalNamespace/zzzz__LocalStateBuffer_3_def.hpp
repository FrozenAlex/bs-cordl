...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::LocalStateBuffer_3);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::LocalStateBuffer_3, "", "LocalStateBuffer`3");
// Dependencies StateBuffer`3::TimestampedStateTable<TStateTable, TType, TState>, StateBuffer`3<TStateTable, TType, TState>, SyncStateId
namespace GlobalNamespace {
// cpp template
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__current, put = __cordl_internal_set__current)) ::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState> _current;
  ...
  __declspec(property(get = __cordl_internal_get__sentDeltas, put = __cordl_internal_set__sentDeltas)) ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>>
      _sentDeltas;
  ...
  __declspec(property(get = __cordl_internal_get__sentStates, put = __cordl_internal_set__sentStates)) ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>>
      _sentStates;
  ...
  inline bool TryGetSerializedState(::by_ref<TStateTable> state, ::by_ref<int64_t> time, ::by_ref<::GlobalNamespace::SyncStateId> id);

  /// @brief Method TryGetSerializedStateDelta, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline bool TryGetSerializedStateDelta(::by_ref<TStateTable> delta, ::by_ref<int32_t> timeOffset, ::by_ref<::GlobalNamespace::SyncStateId> baseId);

  constexpr ::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState> const& __cordl_internal_get__current() const;

  constexpr ::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>& __cordl_internal_get__current();
  ...
  constexpr ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>> const& __cordl_internal_get__sentDeltas() const;

  constexpr ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>>& __cordl_internal_get__sentDeltas();

  constexpr int32_t const& __cordl_internal_get__sentStateIndex() const;

  constexpr int32_t& __cordl_internal_get__sentStateIndex();

  constexpr ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>> const& __cordl_internal_get__sentStates() const;

  constexpr ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>>& __cordl_internal_get__sentStates();

  constexpr void __cordl_internal_set__current(::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState> value);
  ...
  constexpr void __cordl_internal_set__sentDeltas(::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>> value);

  constexpr void __cordl_internal_set__sentStateIndex(int32_t value);

  constexpr void __cordl_internal_set__sentStates(::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>> value);

  /// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline void _ctor(int64_t fullStateUpdateFrequency, int64_t deltaUpdateFrequency, int32_t size, ::GlobalNamespace::StateBuffer_3_InterpolationDelegate<TStateTable, TType, TState>* interpolator,
                    ::GlobalNamespace::StateBuffer_3_SmoothingDelegate<TStateTable, TType, TState>* smoother);
...
public:
  ...
  ::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState> ____current;
  ...
  ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>> ____sentStates;

  /// @brief Field _sentDeltas, offset: 0x68, size: 0x8, def value: None
  ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>> ____sentDeltas;
