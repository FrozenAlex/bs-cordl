...
// Write type traits
MARK_REF_T(::GlobalNamespace::LocalizationKeyAttribute*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LocalizationKeyAttribute*, "", "LocalizationKeyAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3251144, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LocalizationKeyAttribute) == 0x18, "Size mismatch!");
