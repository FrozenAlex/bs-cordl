...
// Write type traits
MARK_REF_T(::GlobalNamespace::LocalizedAudioClipSO*);
MARK_REF_T(::GlobalNamespace::LocalizedAudioClipSO_LocalizedAudioClipInfo*);
MARK_REF_T(::GlobalNamespace::LocalizedAudioClipSO___c__DisplayClass4_0*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LocalizedAudioClipSO*, "", "LocalizedAudioClipSO");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LocalizedAudioClipSO_LocalizedAudioClipInfo*, "", "LocalizedAudioClipSO/LocalizedAudioClipInfo");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LocalizedAudioClipSO___c__DisplayClass4_0*, "", "LocalizedAudioClipSO/<>c__DisplayClass4_0");
...
public:
  ...
  /// @brief Method .ctor, addr 0x57c4340, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x57c4334, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_localizedAudioClip>b__0, addr 0x57c4344, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LocalizedAudioClipSO___c__DisplayClass4_0) == 0x18, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies LocalizedAudioClipSO::LocalizedAudioClipInfo, UnityEngine.ScriptableObject
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__localizedAudioClipInfo, put = __cordl_internal_set__localizedAudioClipInfo)) ::ArrayW<::GlobalNamespace::LocalizedAudioClipSO_LocalizedAudioClipInfo*>
  ...
  constexpr ::ArrayW<::GlobalNamespace::LocalizedAudioClipSO_LocalizedAudioClipInfo*> const& __cordl_internal_get__localizedAudioClipInfo() const;

  constexpr ::ArrayW<::GlobalNamespace::LocalizedAudioClipSO_LocalizedAudioClipInfo*>& __cordl_internal_get__localizedAudioClipInfo();
  ...
  /// @brief Method .ctor, addr 0x57c4338, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_localizedAudioClip, addr 0x57c4220, size 0x114, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LocalizedAudioClipSO) == 0x28, "Size mismatch!");
