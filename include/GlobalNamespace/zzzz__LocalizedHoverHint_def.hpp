...
// Write type traits
MARK_REF_T(::GlobalNamespace::LocalizedHoverHint*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LocalizedHoverHint*, "", "LocalizedHoverHint");
...
public:
  ...
  /// @brief Method SetText, addr 0x58dbbd8, size 0x14, virtual true, abstract: false, final false
  inline void SetText(::HMUI::HoverHint* hoverHint, ::StringW value);

  /// @brief Method UpdateAlignment, addr 0x58dbbec, size 0x4, virtual true, abstract: false, final false
  inline void UpdateAlignment(::HMUI::HoverHint* hoverHint, ::BGLib::Polyglot::LanguageDirection direction);

  /// @brief Method .ctor, addr 0x58dbbf0, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LocalizedHoverHint) == 0x40, "Size mismatch!");
