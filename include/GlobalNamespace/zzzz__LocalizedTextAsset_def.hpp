...
// Write type traits
MARK_REF_T(::GlobalNamespace::LocalizedTextAsset*);
MARK_REF_T(::GlobalNamespace::LocalizedTextAsset_TextInfo*);
MARK_REF_T(::GlobalNamespace::LocalizedTextAsset___c*);
MARK_REF_T(::GlobalNamespace::LocalizedTextAsset___c__DisplayClass6_0*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LocalizedTextAsset*, "", "LocalizedTextAsset");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LocalizedTextAsset_TextInfo*, "", "LocalizedTextAsset/TextInfo");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LocalizedTextAsset___c*, "", "LocalizedTextAsset/<>c");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LocalizedTextAsset___c__DisplayClass6_0*, "", "LocalizedTextAsset/<>c__DisplayClass6_0");
...
public:
  ...
  /// @brief Method .ctor, addr 0x57c4710, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x57c4768, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_localizedText>b__6_0, addr 0x57c476c, size 0x1c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x57c46b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_localizedText>b__1, addr 0x57c4788, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LocalizedTextAsset___c__DisplayClass6_0) == 0x18, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies LocalizedTextAsset::TextInfo, UnityEngine.ScriptableObject
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Field _substituteLocalizationKey, offset 0x20, size 0x8
  __declspec(property(get = __cordl_internal_get__substituteLocalizationKey, put = __cordl_internal_set__substituteLocalizationKey)) ::StringW _substituteLocalizationKey;

  /// @brief Field _textInfos, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get__textInfos, put = __cordl_internal_set__textInfos)) ::ArrayW<::GlobalNamespace::LocalizedTextAsset_TextInfo*> _textInfos;

  __declspec(property(get = get_localizedText)) ::StringW localizedText;

  __declspec(property(get = get_textInfos)) ::ArrayW<::GlobalNamespace::LocalizedTextAsset_TextInfo*> textInfos;

  static inline ::GlobalNamespace::LocalizedTextAsset* New_ctor();

  constexpr ::StringW const& __cordl_internal_get__substituteLocalizationKey() const;

  constexpr ::StringW& __cordl_internal_get__substituteLocalizationKey();

  constexpr ::ArrayW<::GlobalNamespace::LocalizedTextAsset_TextInfo*> const& __cordl_internal_get__textInfos() const;

  constexpr ::ArrayW<::GlobalNamespace::LocalizedTextAsset_TextInfo*>& __cordl_internal_get__textInfos();

  constexpr void __cordl_internal_set__substituteLocalizationKey(::StringW value);

  constexpr void __cordl_internal_set__textInfos(::ArrayW<::GlobalNamespace::LocalizedTextAsset_TextInfo*> value);

  /// @brief Method .ctor, addr 0x57c46bc, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_localizedText, addr 0x57c436c, size 0x34c, virtual false, abstract: false, final false
  inline ::StringW get_localizedText();

  /// @brief Method get_textInfos, addr 0x57c4364, size 0x8, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::LocalizedTextAsset, ____substituteLocalizationKey) == 0x20, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::LocalizedTextAsset) == 0x28, "Size mismatch!");
