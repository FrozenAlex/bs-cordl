...
// Write type traits
MARK_REF_T(::GlobalNamespace::MainAudioEffects*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MainAudioEffects*, "", "MainAudioEffects");
...
public:
  ...
  /// @brief Method LateUpdate, addr 0x577dad8, size 0xe0, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::MainAudioEffects* New_ctor();

  /// @brief Method ResumeNormalSound, addr 0x577dbb8, size 0x28, virtual false, abstract: false, final false
  inline void ResumeNormalSound();

  /// @brief Method Start, addr 0x577daa4, size 0x34, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TriggerLowPass, addr 0x577dbe0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x577dc1c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MainAudioEffects) == 0x30, "Size mismatch!");
