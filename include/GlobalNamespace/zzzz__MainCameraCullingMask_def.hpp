...
// Write type traits
MARK_REF_T(::GlobalNamespace::MainCameraCullingMask*);
MARK_REF_T(::GlobalNamespace::MainCameraCullingMask_InitData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MainCameraCullingMask*, "", "MainCameraCullingMask");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MainCameraCullingMask_InitData*, "", "MainCameraCullingMask/InitData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5e088d8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MainCameraCullingMask_InitData) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method Start, addr 0x5e0878c, size 0xec, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5e08878, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MainCameraCullingMask) == 0x30, "Size mismatch!");
