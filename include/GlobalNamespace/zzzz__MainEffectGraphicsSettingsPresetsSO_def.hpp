...
public:
  ...
  /// @brief Method .ctor, addr 0x372ba6c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x372ba64, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_namedPresets, addr 0x372ba5c, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::NamedPreset*> get_namedPresets();

  /// @brief Method get_presets, addr 0x372ba54, size 0x8, virtual false, abstract: false, final false
