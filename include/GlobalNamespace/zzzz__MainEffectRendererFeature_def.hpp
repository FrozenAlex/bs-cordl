...
public:
  ...
  /// @brief Method AddRenderPasses, addr 0x5e0964c, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x5e09648, size 0x4, virtual true, abstract: false, final false
  inline void Create();
  ...
  /// @brief Method .ctor, addr 0x5e09650, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MainEffectRendererFeature) == 0x28, "Size mismatch!");
