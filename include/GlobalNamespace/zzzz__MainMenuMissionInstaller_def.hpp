...
// Write type traits
MARK_REF_T(::GlobalNamespace::MainMenuMissionInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MainMenuMissionInstaller*, "", "MainMenuMissionInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x58c67b8, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58c6850, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MainMenuMissionInstaller) == 0x30, "Size mismatch!");
