...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MainSettingsAsyncLoader__LoadResourcesBeforeInstallAsync_d__9, "", "MainSettingsAsyncLoader/<LoadResourcesBeforeInstallAsync>d__9");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x36b43a0, size 0x2f4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x36b4694, size 0x6c, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::MainSettingsAsyncLoader__LoadResourcesBeforeInstallAsync_d__9) == 0x40, "Size mismatch!");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x36b3b84, size 0x138, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method InstallBindingsThatRelyOnSettings, addr 0x36b3cbc, size 0x6c0, virtual false, abstract: false, final false
  inline void InstallBindingsThatRelyOnSettings();

  /// @brief Method LoadResourcesBeforeInstall, addr 0x36b39f4, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method LoadResourcesBeforeInstallAsync, addr 0x36b3ac4, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36b437c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isRunningFromTests, addr 0x36b39d4, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MainSettingsAsyncLoader) == 0x68, "Size mismatch!");
