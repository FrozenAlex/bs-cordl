...
// Write type traits
MARK_REF_T(::GlobalNamespace::MaterialPropertyBlockRandomValueSetter*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MaterialPropertyBlockRandomValueSetter*, "", "MaterialPropertyBlockRandomValueSetter");
// Dependencies UnityEngine.MaterialPropertyBlock, UnityEngine.MonoBehaviour, UnityEngine.Renderer
namespace GlobalNamespace {
// Is value type: false
...
static_assert(offsetof(::GlobalNamespace::MaterialPropertyBlockRandomValueSetter, ____propertyName) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MaterialPropertyBlockRandomValueSetter, ____minValue) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MaterialPropertyBlockRandomValueSetter, ____maxValue) == 0x34, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MaterialPropertyBlockRandomValueSetter, ____materialPropertyBlocks) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MaterialPropertyBlockRandomValueSetter, ____propertyId) == 0x40, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::MaterialPropertyBlockRandomValueSetter) == 0x48, "Size mismatch!");
