...
// Write type traits
MARK_REF_T(::GlobalNamespace::MenuDestination*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MenuDestination*, "", "MenuDestination");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3648ce0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MenuDestination) == 0x10, "Size mismatch!");
