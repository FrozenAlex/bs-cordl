...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MenuNeonLightsGenerator::*)()>(&::GlobalNamespace::MenuNeonLightsGenerator::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x5785294;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::MenuNeonLightsGenerator*>(), { ".ctor", {}, {} })));
...
constexpr void GlobalNamespace::MenuNeonLightsGenerator::__cordl_internal_set__neonLightPrefab(::UnityW<::GlobalNamespace::TubeBloomPrePassLight> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____neonLightPrefab = value;
}
...
inline ::GlobalNamespace::MenuNeonLightsGenerator* GlobalNamespace::MenuNeonLightsGenerator::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::MenuNeonLightsGenerator*>());
}
// Ctor Parameters []
