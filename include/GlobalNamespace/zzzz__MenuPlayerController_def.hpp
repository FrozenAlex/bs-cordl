...
// Write type traits
MARK_REF_T(::GlobalNamespace::MenuPlayerController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MenuPlayerController*, "", "MenuPlayerController");
...
static_assert(sizeof(::GlobalNamespace::MenuPlayerController) == 0x38, "Size mismatch!");
