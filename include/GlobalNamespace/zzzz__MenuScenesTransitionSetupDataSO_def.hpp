...
// Write type traits
MARK_REF_T(::GlobalNamespace::MenuScenesTransitionSetupDataSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MenuScenesTransitionSetupDataSO*, "", "MenuScenesTransitionSetupDataSO");
...
static_assert(sizeof(::GlobalNamespace::MenuScenesTransitionSetupDataSO) == 0x28, "Size mismatch!");
