...
public:
  ...
  /// @brief Method Equals, addr 0x5f43508, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x5f43424, size 0xe4, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::MirrorRendererSO_CameraTransformData other);

  /// @brief Method GetHashCode, addr 0x5f435a4, size 0x158, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x5f436fc, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x5f43734, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field _antialiasing, offset 0x50, size 0x4
  ...
  /// @brief Field _mirrorCamera, offset 0x40, size 0x8
  ...
  /// @brief Field _mirrorCameraComponent, offset 0x48, size 0x8
  ...
  /// @brief Field _renderTextures, offset 0x58, size 0x8
  ...
  /// @brief Method CreateOrUpdateMirrorCamera, addr 0x5f42904, size 0x2e4, virtual false, abstract: false, final false
  inline void CreateOrUpdateMirrorCamera(::UnityEngine::Camera* currentCamera, ::UnityEngine::RenderTexture* renderTexture);

  /// @brief Method Init, addr 0x5f428f4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x5f431b0, size 0x1a4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnValidate, addr 0x5f42854, size 0x4, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Plane, addr 0x5f42f54, size 0x2c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 Plane(::UnityEngine::Vector3 pos, ::UnityEngine::Vector3 normal);

  /// @brief Method PrepareForNextFrame, addr 0x5f41a10, size 0x14c, virtual false, abstract: false, final false
  inline void PrepareForNextFrame();

  /// @brief Method RenderMirror, addr 0x5f42be8, size 0x36c, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderMirrorTexture, addr 0x5f41f00, size 0x6bc, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateParams, addr 0x5f42858, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f43354, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field _mirrorCamera, offset: 0x40, size: 0x8, def value: None
  ::UnityW<::UnityEngine::Camera> ____mirrorCamera;

  /// @brief Field _mirrorCameraComponent, offset: 0x48, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::MirrorCamera> ____mirrorCameraComponent;

  /// @brief Field _antialiasing, offset: 0x50, size: 0x4, def value: None
  int32_t ____antialiasing;

  /// @brief Field _renderTextures, offset: 0x58, size: 0x8, def value: None
  ...
  /// @brief Field kLeftRect, offset: 0x60, size: 0x10, def value: None
  ::UnityEngine::Rect ___kLeftRect;

  /// @brief Field kRightRect, offset: 0x70, size: 0x10, def value: None
  ::UnityEngine::Rect ___kRightRect;

  /// @brief Field kFullRect, offset: 0x80, size: 0x10, def value: None
...
static_assert(offsetof(::GlobalNamespace::MirrorRendererSO, ____mirrorCamera) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MirrorRendererSO, ____mirrorCameraComponent) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MirrorRendererSO, ____antialiasing) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MirrorRendererSO, ____renderTextures) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MirrorRendererSO, ___kLeftRect) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MirrorRendererSO, ___kRightRect) == 0x70, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MirrorRendererSO, ___kFullRect) == 0x80, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::MirrorRendererSO) == 0x90, "Size mismatch!");
