...
// Write type traits
MARK_REF_T(::GlobalNamespace::MirroredDisappearingArrowController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MirroredDisappearingArrowController*, "", "MirroredDisappearingArrowController");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5797adc, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_gameNoteController, addr 0x5797ad4, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MirroredDisappearingArrowController) == 0x60, "Size mismatch!");
