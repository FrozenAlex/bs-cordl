...
public:
  ...
  /// @brief Method .ctor, addr 0x579ed8c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x579e9b8, size 0x1c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleDidStartDissolving, addr 0x579ed68, size 0x20, virtual false, abstract: false, final false
  inline void HandleDidStartDissolving(::GlobalNamespace::ObstacleControllerBase* obstacleController, float_t duration);

  /// @brief Method Mirror, addr 0x57914a0, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x579e9d4, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RemoveListeners, addr 0x579e9d8, size 0xd8, virtual false, abstract: false, final false
  inline void RemoveListeners();

  /// @brief Method Update, addr 0x579eab0, size 0x114, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdatePositionAndRotation, addr 0x579ebc4, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x579ed88, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_hide, addr 0x5791f3c, size 0x2c, virtual false, abstract: false, final false
