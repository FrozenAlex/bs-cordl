...
// Write type traits
MARK_REF_T(::GlobalNamespace::MirroredObstacleController*);
MARK_REF_T(::GlobalNamespace::MirroredObstacleController_Pool*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MirroredObstacleController*, "", "MirroredObstacleController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MirroredObstacleController_Pool*, "", "MirroredObstacleController/Pool");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58da26c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MirroredObstacleController_Pool) == 0x40, "Size mismatch!");
...
public:
  ...
  /// @brief Method Awake, addr 0x58d9ce0, size 0x1c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleDidStartDissolving, addr 0x58da228, size 0x20, virtual false, abstract: false, final false
  inline void HandleDidStartDissolving(::GlobalNamespace::ObstacleControllerBase* obstacleController, float_t duration);

  /// @brief Method Mirror, addr 0x58cc7c0, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x58d9cfc, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RemoveListeners, addr 0x58d9d00, size 0xd4, virtual false, abstract: false, final false
  inline void RemoveListeners();

  /// @brief Method Update, addr 0x58d9dd4, size 0x114, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdatePositionAndRotation, addr 0x58d9ee8, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58da264, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_hide, addr 0x58cd258, size 0x2c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MirroredObstacleController) == 0x58, "Size mismatch!");
