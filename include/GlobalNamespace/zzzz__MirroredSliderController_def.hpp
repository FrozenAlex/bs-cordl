...
// Write type traits
MARK_REF_T(::GlobalNamespace::MirroredSliderController*);
MARK_REF_T(::GlobalNamespace::MirroredSliderController_Pool*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MirroredSliderController*, "", "MirroredSliderController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MirroredSliderController_Pool*, "", "MirroredSliderController/Pool");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5798358, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MirroredSliderController_Pool) == 0x40, "Size mismatch!");
...
public:
  ...
  /// @brief Method Awake, addr 0x5798078, size 0x1c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Dissolve, addr 0x579832c, size 0x28, virtual false, abstract: false, final false
  inline void Dissolve(float_t duration);

  /// @brief Method HandleSliderDidStartDissolving, addr 0x5798304, size 0x28, virtual true, abstract: false, final true
  inline void HandleSliderDidStartDissolving(::GlobalNamespace::SliderController* sliderController, float_t duration);

  /// @brief Method Mirror, addr 0x57917a4, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5798204, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RemoveListeners, addr 0x5798208, size 0xfc, virtual false, abstract: false, final false
  inline void RemoveListeners();

  /// @brief Method Update, addr 0x5798094, size 0xb0, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateMaterialPropertyBlock, addr 0x5798144, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5798354, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_hide, addr 0x5791f68, size 0x2c, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::MirroredSliderController, ____timeHelper) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MirroredSliderController, ____followedSlider) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MirroredSliderController, ____transform) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MirroredSliderController, ____followedTransform) == 0x68, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::MirroredSliderController) == 0x70, "Size mismatch!");
