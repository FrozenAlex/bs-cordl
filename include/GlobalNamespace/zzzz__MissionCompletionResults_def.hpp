...
public:
  ...
  /// @brief Method .ctor, addr 0x3670ed4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsMissionComplete, addr 0x3670e58, size 0x7c, virtual false, abstract: false, final false
