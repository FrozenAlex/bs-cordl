...
public:
  ...
  /// @brief Method InstallBindings, addr 0x591b650, size 0x50c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x591bb5c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
