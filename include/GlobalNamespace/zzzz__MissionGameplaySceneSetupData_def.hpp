...
static_assert(offsetof(::GlobalNamespace::MissionGameplaySceneSetupData, ___beatmapLevel) == 0x30, "Offset mismatch!");
...
static_assert(sizeof(::GlobalNamespace::MissionGameplaySceneSetupData) == 0x48, "Size mismatch!");
