...
// Write type traits
MARK_REF_T(::GlobalNamespace::MissionHelpSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MissionHelpSO*, "", "MissionHelpSO");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3750708, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_missionHelpId, addr 0x3750700, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MissionHelpSO) == 0x20, "Size mismatch!");
