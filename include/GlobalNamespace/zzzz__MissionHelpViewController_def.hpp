...
// Write type traits
MARK_REF_T(::GlobalNamespace::MissionHelpViewController*);
MARK_REF_T(::GlobalNamespace::MissionHelpViewController_MissionHelpGameObjectPair*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MissionHelpViewController*, "", "MissionHelpViewController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MissionHelpViewController_MissionHelpGameObjectPair*, "", "MissionHelpViewController/MissionHelpGameObjectPair");
...
public:
  ...
  /// @brief Method .ctor, addr 0x595a65c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MissionHelpViewController_MissionHelpGameObjectPair) == 0x20, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies HMUI.ViewController, MissionHelpViewController::MissionHelpGameObjectPair
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method DidActivate, addr 0x595a588, size 0xb0, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::MissionHelpViewController* New_ctor();

  /// @brief Method OkButtonPressed, addr 0x595a638, size 0x20, virtual false, abstract: false, final false
  inline void OkButtonPressed();

  /// @brief Method RefreshContent, addr 0x595a4ac, size 0xdc, virtual false, abstract: false, final false
  inline void RefreshContent();

  /// @brief Method Setup, addr 0x595a480, size 0x2c, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::MissionHelpViewController_MissionHelpGameObjectPair*> const& __cordl_internal_get__missionHelpGameObjectPairs() const;

  constexpr ::ArrayW<::GlobalNamespace::MissionHelpViewController_MissionHelpGameObjectPair*>& __cordl_internal_get__missionHelpGameObjectPairs();
  ...
  constexpr void __cordl_internal_set__missionHelpGameObjectPairs(::ArrayW<::GlobalNamespace::MissionHelpViewController_MissionHelpGameObjectPair*> value);
  ...
  /// @brief Method .ctor, addr 0x595a658, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x595a300, size 0xc0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionHelpViewController>>* value);

  /// @brief Method remove_didFinishEvent, addr 0x595a3c0, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MissionHelpViewController) == 0x98, "Size mismatch!");
