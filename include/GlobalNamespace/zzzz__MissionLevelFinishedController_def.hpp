...
public:
  ...
  /// @brief Method HandleLevelFinished, addr 0x587bcd8, size 0x4, virtual false, abstract: false, final false
  inline void HandleLevelFinished();

  static inline ::GlobalNamespace::MissionLevelFinishedController* New_ctor();

  /// @brief Method OnDestroy, addr 0x587bba0, size 0x138, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x587baac, size 0xf4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartLevelFinished, addr 0x587bcdc, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x587bd90, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
