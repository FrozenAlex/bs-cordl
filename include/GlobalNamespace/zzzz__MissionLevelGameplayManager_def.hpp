...
public:
  ...
  /// @brief Method .ctor, addr 0x586dbcc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x586dbd8, size 0x558, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::MissionLevelGameplayManager__Start_d__23* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x586e130, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x586e138, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x586e170, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x586dbd4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x586d608, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x586d5ac, size 0x8, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleGameEnergyDidReach0, addr 0x586da84, size 0x54, virtual false, abstract: false, final false
  inline void HandleGameEnergyDidReach0();

  /// @brief Method HandleMissionObjectiveCheckersManagerObjectiveDidFail, addr 0x586dad8, size 0x3c, virtual false, abstract: false, final false
  inline void HandleMissionObjectiveCheckersManagerObjectiveDidFail();

  /// @brief Method HandlePauseControllerCanPause, addr 0x586db48, size 0x38, virtual false, abstract: false, final false
  inline void HandlePauseControllerCanPause(::System::Action_1<bool>* canPause);

  /// @brief Method HandlePauseControllerDidPause, addr 0x586db80, size 0x18, virtual false, abstract: false, final false
  inline void HandlePauseControllerDidPause();

  /// @brief Method HandlePauseControllerDidResume, addr 0x586dbb0, size 0x18, virtual false, abstract: false, final false
  inline void HandlePauseControllerDidResume();

  /// @brief Method HandlePauseControllerDidStartResume, addr 0x586db98, size 0x18, virtual false, abstract: false, final false
  inline void HandlePauseControllerDidStartResume();

  /// @brief Method HandleSongDidFinish, addr 0x586db14, size 0x34, virtual false, abstract: false, final false
  inline void HandleSongDidFinish();

  static inline ::GlobalNamespace::MissionLevelGameplayManager* New_ctor();

  /// @brief Method OnDestroy, addr 0x586d610, size 0x474, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x586d5b4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x586dbc8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_levelDidStartEvent, addr 0x586d19c, size 0xac, virtual true, abstract: false, final true
  inline void add_levelDidStartEvent(::System::Action* value);

  /// @brief Method add_levelFailedEvent, addr 0x586d44c, size 0xac, virtual true, abstract: false, final true
  inline void add_levelFailedEvent(::System::Action* value);

  /// @brief Method add_levelFinishedEvent, addr 0x586d2f4, size 0xac, virtual true, abstract: false, final true
  inline void add_levelFinishedEvent(::System::Action* value);

  /// @brief Method get_levelEndStateType, addr 0x586d5a4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_levelDidStartEvent, addr 0x586d248, size 0xac, virtual true, abstract: false, final true
  inline void remove_levelDidStartEvent(::System::Action* value);

  /// @brief Method remove_levelFailedEvent, addr 0x586d4f8, size 0xac, virtual true, abstract: false, final true
  inline void remove_levelFailedEvent(::System::Action* value);

  /// @brief Method remove_levelFinishedEvent, addr 0x586d3a0, size 0xac, virtual true, abstract: false, final true
