...
// Write type traits
MARK_REF_T(::GlobalNamespace::MissionLevelNoTransitionInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MissionLevelNoTransitionInstaller*, "", "MissionLevelNoTransitionInstaller");
// Dependencies BeatmapDifficulty, MissionObjective, Zenject.NoTransitionInstaller
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x57ebe98, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57ec440, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MissionLevelNoTransitionInstaller) == 0x70, "Size mismatch!");
