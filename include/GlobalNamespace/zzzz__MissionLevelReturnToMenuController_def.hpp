...
public:
  ...
  /// @brief Method ReturnToMenu, addr 0x587be4c, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x587bf00, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
