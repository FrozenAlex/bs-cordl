...
// Write type traits
MARK_REF_T(::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO*, "", "MissionLevelScenesTransitionSetupDataSO");
...
static_assert(sizeof(::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO) == 0x70, "Size mismatch!");
