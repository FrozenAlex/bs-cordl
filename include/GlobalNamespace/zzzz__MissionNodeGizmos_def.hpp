...
// Write type traits
MARK_REF_T(::GlobalNamespace::MissionNodeGizmos*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MissionNodeGizmos*, "", "MissionNodeGizmos");
...
public:
  ...
  /// @brief Method .ctor, addr 0x581446c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MissionNodeGizmos) == 0x38, "Size mismatch!");
