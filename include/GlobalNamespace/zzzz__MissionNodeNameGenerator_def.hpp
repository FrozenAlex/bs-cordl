...
// Write type traits
MARK_REF_T(::GlobalNamespace::MissionNodeNameGenerator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MissionNodeNameGenerator*, "", "MissionNodeNameGenerator");
...
public:
  ...
  /// @brief Method .ctor, addr 0x59384ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MissionNodeNameGenerator) == 0x28, "Size mismatch!");
