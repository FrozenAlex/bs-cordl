...
// Write type traits
MARK_REF_T(::GlobalNamespace::MissionNodeSelectionManager*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MissionNodeSelectionManager*, "", "MissionNodeSelectionManager");
// Dependencies MissionNode, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__missionNodes, put = __cordl_internal_set__missionNodes)) ::ArrayW<::UnityW<::GlobalNamespace::MissionNode>> _missionNodes;
  ...
  /// @brief Method DeselectSelectedNode, addr 0x58dd4c0, size 0x84, virtual false, abstract: false, final false
  inline void DeselectSelectedNode();

  /// @brief Method HandleNodeWasDisplayed, addr 0x58ddbd4, size 0x84, virtual false, abstract: false, final false
  inline void HandleNodeWasDisplayed(::GlobalNamespace::MissionNodeVisualController* missionNode);

  /// @brief Method HandleNodeWasSelect, addr 0x58ddb1c, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x58dd824, size 0x178, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x58dd56c, size 0x138, virtual false, abstract: false, final false
  inline void Start();

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::MissionNode>> const& __cordl_internal_get__missionNodes() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::MissionNode>>& __cordl_internal_get__missionNodes();
  ...
  constexpr void __cordl_internal_set__missionNodes(::ArrayW<::UnityW<::GlobalNamespace::MissionNode>> value);
  ...
  /// @brief Method .ctor, addr 0x58ddc58, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectMissionNodeEvent, addr 0x58dd340, size 0xc0, virtual false, abstract: false, final false
  inline void add_didSelectMissionNodeEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionNodeVisualController>>* value);

  /// @brief Method remove_didSelectMissionNodeEvent, addr 0x58dd400, size 0xc0, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::UnityW<::GlobalNamespace::MissionNode>> ____missionNodes;
...
static_assert(sizeof(::GlobalNamespace::MissionNodeSelectionManager) == 0x40, "Size mismatch!");
