...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MissionNodeUpdatePositionInEditMode::*)()>(&::GlobalNamespace::MissionNodeUpdatePositionInEditMode::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x58de1b4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::MissionNodeUpdatePositionInEditMode*>(), { ".ctor", {}, {} })));
...
constexpr void GlobalNamespace::MissionNodeUpdatePositionInEditMode::__cordl_internal_set__missionNodeConnection(::UnityW<::GlobalNamespace::MissionNodeConnection> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____missionNodeConnection = value;
}
...
inline ::GlobalNamespace::MissionNodeUpdatePositionInEditMode* GlobalNamespace::MissionNodeUpdatePositionInEditMode::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::MissionNodeUpdatePositionInEditMode*>());
}
// Ctor Parameters []
