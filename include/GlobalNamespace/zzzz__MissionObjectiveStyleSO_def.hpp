...
// Write type traits
MARK_REF_T(::GlobalNamespace::MissionObjectiveStyleSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MissionObjectiveStyleSO*, "", "MissionObjectiveStyleSO");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3232b8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MissionObjectiveStyleSO) == 0x30, "Size mismatch!");
