...
public:
  ...
  /// @brief Method Equals, addr 0x375080c, size 0xf4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x3750900, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3750710, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_referenceValue, addr 0x375072c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_referenceValue();

  /// @brief Method get_referenceValueComparisonType, addr 0x3750724, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MissionObjective_ReferenceValueComparisonType get_referenceValueComparisonType();

  /// @brief Method get_type, addr 0x375071c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MissionObjectiveTypeSO> get_type();

  /// @brief Method op_Equality, addr 0x3750734, size 0xc0, virtual false, abstract: false, final false
  static inline bool op_Equality(::GlobalNamespace::MissionObjective* obj1, ::GlobalNamespace::MissionObjective* obj2);

  /// @brief Method op_Inequality, addr 0x37507f4, size 0x18, virtual false, abstract: false, final false
