...
// Write type traits
MARK_REF_T(::GlobalNamespace::MissionSelectionNavigationController*);
...
public:
  ...
  /// @brief Method <PresentMissionClearedIfNeeded>b__0, addr 0x582ed78, size 0xf8, virtual false, abstract: false, final false
  inline void _PresentMissionClearedIfNeeded_b__0();

  /// @brief Method <PresentMissionClearedIfNeeded>b__1, addr 0x582ee70, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x582ed68, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MissionSelectionNavigationController___c__DisplayClass11_0) == 0x28, "Size mismatch!");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x582e8ec, size 0x188, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x582ea74, size 0x114, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleMissionLevelDetailViewControllerDidPressPlayButton, addr 0x582ebfc, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleMissionSelectionMapViewControllerDidSelectMissionLevel, addr 0x582eb88, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method PresentMissionClearedIfNeeded, addr 0x582ec1c, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x582ed6c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didPressPlayButtonEvent, addr 0x582e754, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_selectedMissionNode, addr 0x582e8d4, size 0x18, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MissionNode> get_selectedMissionNode();

  /// @brief Method remove_didPressPlayButtonEvent, addr 0x582e814, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MissionSelectionNavigationController) == 0xb8, "Size mismatch!");
