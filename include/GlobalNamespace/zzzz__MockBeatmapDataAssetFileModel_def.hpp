...
// Write type traits
MARK_REF_T(::GlobalNamespace::MockBeatmapDataAssetFileModel*);
MARK_VAL_T(::GlobalNamespace::MockBeatmapDataAssetFileModel__GetAssetBundleFileForBeatmapLevelAsync_d__4);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MockBeatmapDataAssetFileModel*, "", "MockBeatmapDataAssetFileModel");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MockBeatmapDataAssetFileModel__GetAssetBundleFileForBeatmapLevelAsync_d__4, "", "MockBeatmapDataAssetFileModel/<GetAssetBundleFileForBeatmapLevelAsync>d__4");
// Dependencies GetAssetBundleFileResult, System.Runtime.CompilerServices.AsyncTaskMethodBuilder`1<TResult>, System.Runtime.CompilerServices.TaskAwaiter, System.Threading.CancellationToken
namespace GlobalNamespace {
// Is value type: true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3729d7c, size 0x4e8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x372a264, size 0x80, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::MockBeatmapDataAssetFileModel__GetAssetBundleFileForBeatmapLevelAsync_d__4) == 0x50, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetAssetBundleFileForBeatmapLevelAsync, addr 0x3729c14, size 0xf4, virtual true, abstract: false, final true
  ...
  /// @brief Method TryDeleteAssetBundleFileForBeatmapLevelAsync, addr 0x3729d08, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3729d78, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_levelDataAssetDownloadUpdateEvent, addr 0x3729a94, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_levelDataAssetDownloadUpdateEvent, addr 0x3729b54, size 0xc0, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::MockBeatmapDataAssetFileModel) == 0x18, "Size mismatch!");
