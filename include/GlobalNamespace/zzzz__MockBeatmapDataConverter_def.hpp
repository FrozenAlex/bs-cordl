...
public:
  ...
  /// @brief Method <ToMockBeatmapData>b__0_0, addr 0x59c2470, size 0x1c, virtual false, abstract: false, final false
  inline bool _ToMockBeatmapData_b__0_0(::GlobalNamespace::NoteData* nd);

  /// @brief Method <ToMockBeatmapData>b__0_1, addr 0x59c248c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MockNoteData* _ToMockBeatmapData_b__0_1(::GlobalNamespace::NoteData* nd);

  /// @brief Method <ToMockBeatmapData>b__0_2, addr 0x59c2494, size 0x1c, virtual false, abstract: false, final false
  inline bool _ToMockBeatmapData_b__0_2(::GlobalNamespace::NoteData* nd);

  /// @brief Method <ToMockBeatmapData>b__0_3, addr 0x59c24b0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MockNoteData* _ToMockBeatmapData_b__0_3(::GlobalNamespace::NoteData* nd);

  /// @brief Method <ToMockBeatmapData>b__0_4, addr 0x59c24b8, size 0x1c, virtual false, abstract: false, final false
  inline bool _ToMockBeatmapData_b__0_4(::GlobalNamespace::NoteData* nd);

  /// @brief Method <ToMockBeatmapData>b__0_5, addr 0x59c24d4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MockNoteData* _ToMockBeatmapData_b__0_5(::GlobalNamespace::NoteData* nd);

  /// @brief Method <ToMockBeatmapData>b__0_6, addr 0x59c24dc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MockObstacleData* _ToMockBeatmapData_b__0_6(::GlobalNamespace::ObstacleData* od);

  /// @brief Method .ctor, addr 0x59c246c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ToMockBeatmapData, addr 0x59c1a10, size 0x918, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::MockBeatmapData* ToMockBeatmapData(::GlobalNamespace::IReadonlyBeatmapData* beatmapData);

  /// @brief Method ToMockNoteData, addr 0x59c2328, size 0x78, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::MockNoteData* ToMockNoteData(::GlobalNamespace::NoteData* noteData);

  /// @brief Method ToMockObstacleData, addr 0x59c23a0, size 0x78, virtual false, abstract: false, final false
