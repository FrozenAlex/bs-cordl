...
// Write type traits
MARK_REF_T(::GlobalNamespace::MockMultiplayerStatusModel*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MockMultiplayerStatusModel*, "", "MockMultiplayerStatusModel");
...
public:
  ...
  /// @brief Method GetMultiplayerStatusAsync, addr 0x59c2d48, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x59c2dc0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MockMultiplayerStatusModel) == 0x18, "Size mismatch!");
