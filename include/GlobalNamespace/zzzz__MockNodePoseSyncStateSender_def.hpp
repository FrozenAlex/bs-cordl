...
public:
  ...
  /// @brief Method Dispose, addr 0x5a7e2d4, size 0xc0, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleNodePoseSyncStateUpdate, addr 0x5a7e56c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method SendPose, addr 0x5a7e394, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a7e12c, size 0x1a8, virtual false, abstract: false, final false
