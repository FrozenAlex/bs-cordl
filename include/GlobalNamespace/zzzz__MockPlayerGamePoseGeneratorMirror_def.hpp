...
public:
  ...
  /// @brief Method Dispose, addr 0x589622c, size 0x514, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method FindPlayerToMirror, addr 0x589680c, size 0x380, virtual false, abstract: false, final false
  inline void FindPlayerToMirror();

  /// @brief Method HandleLevelFinished, addr 0x58976f4, size 0x178, virtual false, abstract: false, final false
  inline void HandleLevelFinished(::StringW userId, ::GlobalNamespace::MultiplayerLevelCompletionResults* results);

  /// @brief Method HandleNoteWasCut, addr 0x58971ac, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleNoteWasMissed, addr 0x5897024, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleNoteWasSpawned, addr 0x5896b8c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleObstacleWasSpawned, addr 0x5896d14, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleOptionalAvatarDataReceived, addr 0x5897514, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleScoreSyncStateUpdate, addr 0x5897334, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSliderWasSpawned, addr 0x5896e9c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x5896740, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Tick, addr 0x5896748, size 0xc4, virtual true, abstract: false, final false
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x58957f8, size 0x758, virtual false, abstract: false, final false
