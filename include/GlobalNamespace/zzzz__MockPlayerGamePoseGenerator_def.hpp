...
// Write type traits
MARK_REF_T(::GlobalNamespace::MockPlayerGamePoseGenerator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MockPlayerGamePoseGenerator*, "", "MockPlayerGamePoseGenerator");
...
public:
  ...
  /// @brief Method CreateEmptyLevelCompletionResults, addr 0x5a7ecac, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x5a7ead4, size 0x2c, virtual true, abstract: false, final false
  inline void Dispose();
  ...
  /// @brief Method SimulateFail, addr 0x5a7ebc0, size 0xec, virtual true, abstract: false, final false
  inline void SimulateFail();

  /// @brief Method SimulateGiveUp, addr 0x5a7ed7c, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a7e878, size 0xb4, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MockPlayerGamePoseGenerator) == 0x38, "Size mismatch!");
