...
// Write type traits
MARK_REF_T(::GlobalNamespace::MockPlayerLobbyPoseGeneratorAI*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MockPlayerLobbyPoseGeneratorAI*, "", "MockPlayerLobbyPoseGeneratorAI");
...
public:
  ...
  /// @brief Method Init, addr 0x594d334, size 0x1e0, virtual true, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method Tick, addr 0x594d514, size 0x978, virtual true, abstract: false, final false
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x594c354, size 0x4, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MockPlayerLobbyPoseGeneratorAI) == 0x138, "Size mismatch!");
