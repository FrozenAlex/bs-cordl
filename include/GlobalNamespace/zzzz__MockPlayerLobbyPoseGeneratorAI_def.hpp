...
public:
  ...
  /// @brief Method Init, addr 0x5a83ae4, size 0x1e0, virtual true, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method Tick, addr 0x5a83cc4, size 0x978, virtual true, abstract: false, final false
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x5a82b04, size 0x4, virtual false, abstract: false, final false
