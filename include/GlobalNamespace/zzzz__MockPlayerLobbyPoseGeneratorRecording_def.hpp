...
// Write type traits
MARK_REF_T(::GlobalNamespace::MockPlayerLobbyPoseGeneratorRecording*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MockPlayerLobbyPoseGeneratorRecording*, "", "MockPlayerLobbyPoseGeneratorRecording");
...
public:
  // Declarations
  /// @brief Method Init, addr 0x59c70c0, size 0x70, virtual true, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method Tick, addr 0x59c7130, size 0x70, virtual true, abstract: false, final false
  inline void Tick();

  /// @brief Method .ctor, addr 0x59c5094, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MockPlayerLobbyPoseGeneratorRecording) == 0x20, "Size mismatch!");
