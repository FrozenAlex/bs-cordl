...
// Write type traits
MARK_REF_T(::GlobalNamespace::MockPlayerLobbyPoseGenerator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MockPlayerLobbyPoseGenerator*, "", "MockPlayerLobbyPoseGenerator");
...
public:
  ...
  /// @brief Method Dispose, addr 0x594d324, size 0x10, virtual true, abstract: false, final false
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x594d2b8, size 0x6c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MockPlayerLobbyPoseGenerator) == 0x20, "Size mismatch!");
