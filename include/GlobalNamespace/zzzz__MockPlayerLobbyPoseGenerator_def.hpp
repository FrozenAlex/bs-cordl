...
public:
  ...
  /// @brief Method Dispose, addr 0x5a83ad4, size 0x10, virtual true, abstract: false, final false
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x5a83a68, size 0x6c, virtual false, abstract: false, final false
