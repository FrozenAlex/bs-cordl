...
static_assert(offsetof(::GlobalNamespace::MockPlayerSettings, ____gameplayModifiers) == 0x98, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::MockPlayerSettings) == 0xa0, "Size mismatch!");
