...
// Write type traits
MARK_REF_T(::GlobalNamespace::MockPlayersModel*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MockPlayersModel*, "", "MockPlayersModel");
...
public:
  ...
  /// @brief Method .ctor, addr 0x59c72dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MockPlayersModel) == 0x10, "Size mismatch!");
