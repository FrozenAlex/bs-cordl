...
public:
  ...
  /// @brief Method GetQuickPlaySetupAsync, addr 0x59c72e0, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x59c7358, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
