...
// Write type traits
MARK_REF_T(::GlobalNamespace::ModifiersSelectionView*);
...
public:
  ...
  /// @brief Method <SetGameplayModifiers>b__0, addr 0x596b3bc, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x596b3b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ModifiersSelectionView___c__DisplayClass3_0) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method SetGameplayModifiers, addr 0x5968860, size 0x1b4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5968a20, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ModifiersSelectionView) == 0x38, "Size mismatch!");
