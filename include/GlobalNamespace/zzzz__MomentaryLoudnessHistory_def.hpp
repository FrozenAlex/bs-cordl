...
// Write type traits
MARK_REF_T(::GlobalNamespace::MomentaryLoudnessHistory*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MomentaryLoudnessHistory*, "", "MomentaryLoudnessHistory");
...
public:
  ...
  /// @brief Method Add, addr 0x5779540, size 0x50, virtual false, abstract: false, final false
  inline void Add(float_t momentaryLoudness);

  /// @brief Method GetAverageLoudness, addr 0x57795c4, size 0x78, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<float_t> const& __cordl_internal_get__rmsValues() const;

  constexpr ::ArrayW<float_t>& __cordl_internal_get__rmsValues();
  ...
  /// @brief Method .ctor, addr 0x5779700, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MomentaryLoudnessHistory) == 0x20, "Size mismatch!");
