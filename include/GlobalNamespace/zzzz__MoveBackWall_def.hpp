...
public:
  ...
  /// @brief Method Start, addr 0x58b4dd8, size 0x50, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x58b4e28, size 0xbc, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x58b4ee4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MoveBackWall) == 0x48, "Size mismatch!");
