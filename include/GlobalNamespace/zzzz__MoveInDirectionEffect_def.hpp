...
public:
  ...
  /// @brief Method Awake, addr 0x598dd20, size 0x120, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Move, addr 0x598de44, size 0x48, virtual false, abstract: false, final false
  inline void Move(float_t value);

  static inline ::GlobalNamespace::MoveInDirectionEffect* New_ctor();

  /// @brief Method SetValue, addr 0x598de40, size 0x4, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x598de8c, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x598de90, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
