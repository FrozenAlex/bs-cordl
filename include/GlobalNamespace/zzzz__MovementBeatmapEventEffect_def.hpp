...
// Write type traits
MARK_REF_T(::GlobalNamespace::MovementBeatmapEventEffect*);
MARK_REF_T(::GlobalNamespace::MovementBeatmapEventEffect_MovementData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MovementBeatmapEventEffect*, "", "MovementBeatmapEventEffect");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MovementBeatmapEventEffect_MovementData*, "", "MovementBeatmapEventEffect/MovementData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5865f6c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_localPositionOffset, addr 0x5865f60, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__movementData, put = __cordl_internal_set__movementData)) ::ArrayW<::GlobalNamespace::MovementBeatmapEventEffect_MovementData*> _movementData;
  ...
  __declspec(property(get = __cordl_internal_get__startLocalPositions, put = __cordl_internal_set__startLocalPositions)) ::ArrayW<::UnityEngine::Vector3> _startLocalPositions;
  ...
  /// @brief Method FixedUpdate, addr 0x5865db0, size 0x130, virtual false, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method HandleBeatmapEvent, addr 0x5865f24, size 0x38, virtual false, abstract: false, final false
  inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData* basicBeatmapEventData);

  /// @brief Method LateUpdate, addr 0x5865ee0, size 0x44, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::MovementBeatmapEventEffect* New_ctor();

  /// @brief Method OnDestroy, addr 0x5865d94, size 0x1c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetLocalPositionOffsetsForAllObjects, addr 0x5865ce8, size 0xac, virtual false, abstract: false, final false
  inline void SetLocalPositionOffsetsForAllObjects(::UnityEngine::Vector3 localPositionOffset);

  /// @brief Method Start, addr 0x5865aec, size 0x1fc, virtual false, abstract: false, final false
  inline void Start();
  ...
  constexpr ::ArrayW<::GlobalNamespace::MovementBeatmapEventEffect_MovementData*> const& __cordl_internal_get__movementData() const;

  constexpr ::ArrayW<::GlobalNamespace::MovementBeatmapEventEffect_MovementData*>& __cordl_internal_get__movementData();
  ...
  constexpr ::ArrayW<::UnityEngine::Vector3> const& __cordl_internal_get__startLocalPositions() const;

  constexpr ::ArrayW<::UnityEngine::Vector3>& __cordl_internal_get__startLocalPositions();
  ...
  constexpr void __cordl_internal_set__movementData(::ArrayW<::GlobalNamespace::MovementBeatmapEventEffect_MovementData*> value);

  constexpr void __cordl_internal_set__prevPositionOffset(::UnityEngine::Vector3 value);

  constexpr void __cordl_internal_set__startLocalPositions(::ArrayW<::UnityEngine::Vector3> value);
  ...
  /// @brief Method .ctor, addr 0x5865f5c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::UnityEngine::Vector3> ____startLocalPositions;
...
static_assert(sizeof(::GlobalNamespace::MovementBeatmapEventEffect) == 0x78, "Size mismatch!");
