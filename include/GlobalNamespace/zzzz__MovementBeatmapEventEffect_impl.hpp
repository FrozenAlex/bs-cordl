...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::Vector3 (::GlobalNamespace::MovementBeatmapEventEffect_MovementData::*)()>(
  ...
  constexpr static std::size_t addrs = 0x599dc04;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::MovementBeatmapEventEffect_MovementData*>(), { "get_localPositionOffset", {}, {} })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MovementBeatmapEventEffect_MovementData::*)()>(&::GlobalNamespace::MovementBeatmapEventEffect_MovementData::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x599dc10;
...
inline ::GlobalNamespace::MovementBeatmapEventEffect_MovementData* GlobalNamespace::MovementBeatmapEventEffect_MovementData::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::MovementBeatmapEventEffect_MovementData*>());
}
// Ctor Parameters []
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MovementBeatmapEventEffect::*)()>(&::GlobalNamespace::MovementBeatmapEventEffect::Start)> {
  ...
  constexpr static std::size_t addrs = 0x599d790;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MovementBeatmapEventEffect::*)()>(&::GlobalNamespace::MovementBeatmapEventEffect::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x599da38;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MovementBeatmapEventEffect::*)()>(&::GlobalNamespace::MovementBeatmapEventEffect::FixedUpdate)> {
  ...
  constexpr static std::size_t addrs = 0x599da54;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MovementBeatmapEventEffect::*)()>(&::GlobalNamespace::MovementBeatmapEventEffect::LateUpdate)> {
  ...
  constexpr static std::size_t addrs = 0x599db84;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MovementBeatmapEventEffect::*)(::GlobalNamespace::BasicBeatmapEventData*)>(
  ...
  constexpr static std::size_t addrs = 0x599dbc8;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MovementBeatmapEventEffect::*)(::UnityEngine::Vector3)>(
  ...
  constexpr static std::size_t addrs = 0x599d98c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::MovementBeatmapEventEffect*>(),
                                                                                           { "SetLocalPositionOffsetsForAllObjects", {}, { ::i2c::type_of<::UnityEngine::Vector3>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MovementBeatmapEventEffect::*)()>(&::GlobalNamespace::MovementBeatmapEventEffect::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x599dc00;
...
constexpr ::ArrayW<::GlobalNamespace::MovementBeatmapEventEffect_MovementData*>& GlobalNamespace::MovementBeatmapEventEffect::__cordl_internal_get__movementData() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____movementData;
}
constexpr ::ArrayW<::GlobalNamespace::MovementBeatmapEventEffect_MovementData*> const& GlobalNamespace::MovementBeatmapEventEffect::__cordl_internal_get__movementData() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____movementData;
}
constexpr void GlobalNamespace::MovementBeatmapEventEffect::__cordl_internal_set__movementData(::ArrayW<::GlobalNamespace::MovementBeatmapEventEffect_MovementData*> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____movementData = value;
}
constexpr ::ArrayW<::UnityW<::UnityEngine::Transform>>& GlobalNamespace::MovementBeatmapEventEffect::__cordl_internal_get__transforms() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____transforms;
}
constexpr ::ArrayW<::UnityW<::UnityEngine::Transform>> const& GlobalNamespace::MovementBeatmapEventEffect::__cordl_internal_get__transforms() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____transforms;
}
constexpr void GlobalNamespace::MovementBeatmapEventEffect::__cordl_internal_set__transforms(::ArrayW<::UnityW<::UnityEngine::Transform>> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::UnityW<::GlobalNamespace::TimeHelper>& GlobalNamespace::MovementBeatmapEventEffect::__cordl_internal_get__timeHelper() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____timeHelper;
}
constexpr ::UnityW<::GlobalNamespace::TimeHelper> const& GlobalNamespace::MovementBeatmapEventEffect::__cordl_internal_get__timeHelper() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____timeHelper;
}
constexpr void GlobalNamespace::MovementBeatmapEventEffect::__cordl_internal_set__timeHelper(::UnityW<::GlobalNamespace::TimeHelper> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::ArrayW<::UnityEngine::Vector3>& GlobalNamespace::MovementBeatmapEventEffect::__cordl_internal_get__startLocalPositions() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____startLocalPositions;
}
constexpr ::ArrayW<::UnityEngine::Vector3> const& GlobalNamespace::MovementBeatmapEventEffect::__cordl_internal_get__startLocalPositions() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____startLocalPositions;
}
constexpr void GlobalNamespace::MovementBeatmapEventEffect::__cordl_internal_set__startLocalPositions(::ArrayW<::UnityEngine::Vector3> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____startLocalPositions = value;
}
...
inline void GlobalNamespace::MovementBeatmapEventEffect::SetLocalPositionOffsetsForAllObjects(::UnityEngine::Vector3 localPositionOffset) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::MovementBeatmapEventEffect*>(),
                                                                                         { "SetLocalPositionOffsetsForAllObjects", {}, { ::i2c::type_of<::UnityEngine::Vector3>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, localPositionOffset);
}
...
inline ::GlobalNamespace::MovementBeatmapEventEffect* GlobalNamespace::MovementBeatmapEventEffect::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::MovementBeatmapEventEffect*>());
}
// Ctor Parameters []
