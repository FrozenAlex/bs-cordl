...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerActivePlayersTimeOffsetAverage*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerActivePlayersTimeOffsetAverage*, "", "MultiplayerActivePlayersTimeOffsetAverage");
...
public:
  ...
  /// @brief Method .ctor, addr 0x589872c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isFailed, addr 0x58985e0, size 0x14c, virtual true, abstract: false, final true
  inline bool get_isFailed();

  /// @brief Method get_offsetSyncTime, addr 0x5898354, size 0x28c, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::MultiplayerActivePlayersTimeOffsetAverage) == 0x28, "Size mismatch!");
