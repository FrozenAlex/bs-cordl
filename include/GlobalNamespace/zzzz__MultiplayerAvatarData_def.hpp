...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x3778440, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(uint32_t avatarTypeIdentifierHash, ::ArrayW<uint8_t> data);
...
static_assert(sizeof(::GlobalNamespace::MultiplayerAvatarData) == 0x10, "Size mismatch!");
