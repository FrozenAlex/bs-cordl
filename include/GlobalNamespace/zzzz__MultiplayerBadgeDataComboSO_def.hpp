...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerBadgeDataComboSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerBadgeDataComboSO*, "", "MultiplayerBadgeDataComboSO");
...
public:
  // Declarations
  /// @brief Method GetValue, addr 0x367335c, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3673384, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerBadgeDataComboSO) == 0x38, "Size mismatch!");
