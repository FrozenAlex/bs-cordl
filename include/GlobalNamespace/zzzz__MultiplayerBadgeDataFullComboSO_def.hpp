...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerBadgeDataFullComboSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerBadgeDataFullComboSO*, "", "MultiplayerBadgeDataFullComboSO");
...
public:
  ...
  /// @brief Method CalculateBadgeData, addr 0x372d518, size 0x434, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x372d970, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerBadgeDataFullComboSO) == 0x38, "Size mismatch!");
