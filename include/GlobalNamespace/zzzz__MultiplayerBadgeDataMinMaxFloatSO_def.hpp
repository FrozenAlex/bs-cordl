...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerBadgeDataMinMaxFloatSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerBadgeDataMinMaxFloatSO*, "", "MultiplayerBadgeDataMinMaxFloatSO");
...
public:
  ...
  /// @brief Method CalculateBadgeData, addr 0x3673898, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method CalculateMax, addr 0x36738ac, size 0x560, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateMin, addr 0x3673e0c, size 0x56c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3673888, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerBadgeDataMinMaxFloatSO) == 0x38, "Size mismatch!");
