...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerBadgeDataPersonalBestSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerBadgeDataPersonalBestSO*, "", "MultiplayerBadgeDataPersonalBestSO");
...
public:
  ...
  /// @brief Method CalculateBadgeData, addr 0x372efcc, size 0x55c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x372f620, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerBadgeDataPersonalBestSO) == 0x38, "Size mismatch!");
