...
public:
  // Declarations
  /// @brief Method GetValue, addr 0x372f67c, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x372f6a8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
