...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerBadgesModelSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerBadgesModelSO*, "", "MultiplayerBadgesModelSO");
...
public:
  ...
  /// @brief Method .ctor, addr 0x372f6e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_negativeBadges, addr 0x372f6d8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::UnityW<::GlobalNamespace::MultiplayerBadgeDataSO>>* get_negativeBadges();

  /// @brief Method get_positiveBadges, addr 0x372f6d0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MultiplayerBadgesModelSO) == 0x28, "Size mismatch!");
