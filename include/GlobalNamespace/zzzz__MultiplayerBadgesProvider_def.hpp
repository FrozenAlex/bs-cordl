...
public:
  ...
  /// @brief Method <SelectBadgesAndPutThemIntoResults>b__7_0, addr 0x3676a08, size 0x28, virtual false, abstract: false, final false
  inline bool _SelectBadgesAndPutThemIntoResults_b__7_0(::GlobalNamespace::MultiplayerPlayerResultsData* result);

  /// @brief Method <SelectBadgesAndPutThemIntoResults>b__7_1, addr 0x3676a30, size 0x28, virtual false, abstract: false, final false
  inline int32_t _SelectBadgesAndPutThemIntoResults_b__7_1(::GlobalNamespace::MultiplayerPlayerResultsData* p);

  /// @brief Method .ctor, addr 0x3676a04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method SelectBadgesAndPutThemIntoResults, addr 0x36756f0, size 0x12bc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36769ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerBadgesProvider) == 0x40, "Size mismatch!");
