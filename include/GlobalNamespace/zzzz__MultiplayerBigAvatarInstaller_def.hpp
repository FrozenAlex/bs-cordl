...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerBigAvatarInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerBigAvatarInstaller*, "", "MultiplayerBigAvatarInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x5898eb4, size 0x518, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58993cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerBigAvatarInstaller) == 0x40, "Size mismatch!");
