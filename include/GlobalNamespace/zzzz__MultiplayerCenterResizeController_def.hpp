...
public:
  ...
  /// @brief Method HandlePlayersLayoutWasCalculated, addr 0x59c83cc, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x59c8444, size 0xd0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x59c82e8, size 0xe4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x59c8514, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_edgeDistanceFromCenterWasCalculatedEvent, addr 0x59bbbb0, size 0xc0, virtual false, abstract: false, final false
  inline void add_edgeDistanceFromCenterWasCalculatedEvent(::System::Action_1<float_t>* value);

  /// @brief Method get_edgeDistanceFromCenter, addr 0x59c82d8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_edgeDistanceFromCenter();

  /// @brief Method get_isEdgeDistanceFromCenterCalculated, addr 0x59c82c8, size 0x8, virtual false, abstract: false, final false
  inline bool get_isEdgeDistanceFromCenterCalculated();

  /// @brief Method remove_edgeDistanceFromCenterWasCalculatedEvent, addr 0x59bbe48, size 0xc0, virtual false, abstract: false, final false
  inline void remove_edgeDistanceFromCenterWasCalculatedEvent(::System::Action_1<float_t>* value);

  /// @brief Method set_edgeDistanceFromCenter, addr 0x59c82e0, size 0x8, virtual false, abstract: false, final false
  inline void set_edgeDistanceFromCenter(float_t value);

  /// @brief Method set_isEdgeDistanceFromCenterCalculated, addr 0x59c82d0, size 0x8, virtual false, abstract: false, final false
