...
MARK_REF_T(::GlobalNamespace::MultiplayerConditionalActiveByLayout*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerConditionalActiveByLayout_Condition, "", "MultiplayerConditionalActiveByLayout/Condition");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerConditionalActiveByLayout*, "", "MultiplayerConditionalActiveByLayout");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::MultiplayerConditionalActiveByLayout_Condition) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::MultiplayerConditionalActiveByLayout) == 0x30, "Size mismatch!");
