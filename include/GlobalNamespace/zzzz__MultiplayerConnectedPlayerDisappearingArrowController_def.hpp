...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerConnectedPlayerDisappearingArrowController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerConnectedPlayerDisappearingArrowController*, "", "MultiplayerConnectedPlayerDisappearingArrowController");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58866e4, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_gameNoteController, addr 0x58866dc, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MultiplayerConnectedPlayerDisappearingArrowController) == 0x60, "Size mismatch!");
