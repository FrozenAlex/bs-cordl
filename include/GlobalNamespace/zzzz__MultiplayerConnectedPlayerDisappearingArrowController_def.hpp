...
public:
  ...
  /// @brief Method .ctor, addr 0x59b5b18, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_gameNoteController, addr 0x59b5b10, size 0x8, virtual true, abstract: false, final false
