...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerConnectedPlayerInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerConnectedPlayerInstaller*, "", "MultiplayerConnectedPlayerInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x59b3b1c, size 0xb7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59b46a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerConnectedPlayerInstaller) == 0x80, "Size mismatch!");
