...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerConnectedPlayerIntroAnimator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerConnectedPlayerIntroAnimator*, "", "MultiplayerConnectedPlayerIntroAnimator");
...
public:
  ...
  /// @brief Method SetBeforeIntroValues, addr 0x5885270, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5885288, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerConnectedPlayerIntroAnimator) == 0x28, "Size mismatch!");
