...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerConnectedPlayerObstacleController*);
MARK_REF_T(::GlobalNamespace::MultiplayerConnectedPlayerObstacleController_Pool*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerConnectedPlayerObstacleController*, "", "MultiplayerConnectedPlayerObstacleController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerConnectedPlayerObstacleController_Pool*, "", "MultiplayerConnectedPlayerObstacleController/Pool");
...
public:
  ...
  /// @brief Method OnCreated, addr 0x5886d60, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5886df8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerConnectedPlayerObstacleController_Pool) == 0x48, "Size mismatch!");
...
public:
  ...
  /// @brief Method Init, addr 0x5886b60, size 0x1f8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5886d58, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerConnectedPlayerObstacleController) == 0x140, "Size mismatch!");
