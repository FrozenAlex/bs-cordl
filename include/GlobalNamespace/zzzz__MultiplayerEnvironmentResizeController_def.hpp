...
MARK_REF_T(::GlobalNamespace::MultiplayerEnvironmentResizeController*);
MARK_REF_T(::GlobalNamespace::MultiplayerEnvironmentResizeController_ResizeData*);
...
static_assert(sizeof(::GlobalNamespace::MultiplayerEnvironmentResizeController_ResizeType) == 0x4, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies MultiplayerEnvironmentResizeController::ResizeType, System.Object, TubeBloomPrePassLight, UnityEngine.Transform
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__otherTransforms, put = __cordl_internal_set__otherTransforms)) ::ArrayW<::UnityW<::UnityEngine::Transform>> _otherTransforms;
  ...
  __declspec(property(get = get_lights)) ::ArrayW<::UnityW<::GlobalNamespace::TubeBloomPrePassLight>> lights;

  __declspec(property(get = get_offset)) float_t offset;

  __declspec(property(get = get_otherTransforms)) ::ArrayW<::UnityW<::UnityEngine::Transform>> otherTransforms;
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::Transform>> const& __cordl_internal_get__otherTransforms() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::Transform>>& __cordl_internal_get__otherTransforms();
  ...
  constexpr void __cordl_internal_set__otherTransforms(::ArrayW<::UnityW<::UnityEngine::Transform>> value);

  constexpr void __cordl_internal_set__resizeType(::GlobalNamespace::MultiplayerEnvironmentResizeController_ResizeType value);

  /// @brief Method .ctor, addr 0x59cf730, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lights, addr 0x59cf720, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::GlobalNamespace::TubeBloomPrePassLight>> get_lights();

  /// @brief Method get_offset, addr 0x59cf718, size 0x8, virtual false, abstract: false, final false
  inline float_t get_offset();

  /// @brief Method get_otherTransforms, addr 0x59cf728, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::UnityEngine::Transform>> get_otherTransforms();

  /// @brief Method get_resizeType, addr 0x59cf710, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MultiplayerEnvironmentResizeController_ResizeData) == 0x28, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies MultiplayerEnvironmentResizeController::ResizeData, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__resizeData, put = __cordl_internal_set__resizeData)) ::ArrayW<::GlobalNamespace::MultiplayerEnvironmentResizeController_ResizeData*> _resizeData;
  ...
  /// @brief Method HandleEdgeDistanceFromCenterWasCalculated, addr 0x59cf320, size 0x18, virtual false, abstract: false, final false
  inline void HandleEdgeDistanceFromCenterWasCalculated(float_t edgeDistanceFromCenter);

  /// @brief Method HandleSpawnCenterDistanceWasFound, addr 0x59cf338, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x59cf350, size 0x1c4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Resize, addr 0x59cf52c, size 0x1e0, virtual false, abstract: false, final false
  inline void Resize();

  /// @brief Method Start, addr 0x59cf178, size 0x1a8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TryResize, addr 0x59cf514, size 0x18, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::MultiplayerEnvironmentResizeController_ResizeData*> const& __cordl_internal_get__resizeData() const;

  constexpr ::ArrayW<::GlobalNamespace::MultiplayerEnvironmentResizeController_ResizeData*>& __cordl_internal_get__resizeData();
  ...
  constexpr void __cordl_internal_set__resizeData(::ArrayW<::GlobalNamespace::MultiplayerEnvironmentResizeController_ResizeData*> value);
  ...
  /// @brief Method .ctor, addr 0x59cf70c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_resizingDidFinishEvent, addr 0x59cf020, size 0xac, virtual false, abstract: false, final false
  inline void add_resizingDidFinishEvent(::System::Action* value);

  /// @brief Method get_isResizingFinished, addr 0x59cf018, size 0x8, virtual false, abstract: false, final false
  inline bool get_isResizingFinished();

  /// @brief Method remove_resizingDidFinishEvent, addr 0x59cf0cc, size 0xac, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MultiplayerEnvironmentResizeController) == 0x50, "Size mismatch!");
