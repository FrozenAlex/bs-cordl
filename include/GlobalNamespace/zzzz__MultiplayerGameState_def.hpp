...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerGameState, "", "MultiplayerGameState");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::MultiplayerGameState) == 0x4, "Size mismatch!");
