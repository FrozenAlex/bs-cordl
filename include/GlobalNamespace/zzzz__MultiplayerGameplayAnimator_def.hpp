...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerGameplayAnimator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerGameplayAnimator*, "", "MultiplayerGameplayAnimator");
// Dependencies LightsAnimator, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__allLightsAnimators, put = __cordl_internal_set__allLightsAnimators)) ::ArrayW<::UnityW<::GlobalNamespace::LightsAnimator>> _allLightsAnimators;
  ...
  __declspec(property(get = __cordl_internal_get__gameplayLightsAnimators, put = __cordl_internal_set__gameplayLightsAnimators)) ::ArrayW<::UnityW<::GlobalNamespace::LightsAnimator>>
  ...
  /// @brief Method HandleNewLeaderWasSelected, addr 0x59cfca4, size 0xf4, virtual false, abstract: false, final false
  inline void HandleNewLeaderWasSelected(::StringW userId);

  /// @brief Method HandleStateChanged, addr 0x59cfa94, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x59cf804, size 0x1d0, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x59cf734, size 0xd0, virtual true, abstract: false, final false
  inline void Start();
  ...
  constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightsAnimator>> const& __cordl_internal_get__allLightsAnimators() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightsAnimator>>& __cordl_internal_get__allLightsAnimators();
  ...
  constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightsAnimator>> const& __cordl_internal_get__gameplayLightsAnimators() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightsAnimator>>& __cordl_internal_get__gameplayLightsAnimators();
  ...
  constexpr void __cordl_internal_set__allLightsAnimators(::ArrayW<::UnityW<::GlobalNamespace::LightsAnimator>> value);

  constexpr void __cordl_internal_set__failedLightsColor(::UnityW<::GlobalNamespace::ColorSO> value);

  constexpr void __cordl_internal_set__gameplayLightsAnimators(::ArrayW<::UnityW<::GlobalNamespace::LightsAnimator>> value);
  ...
  /// @brief Method .ctor, addr 0x59cfd98, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerGameplayAnimator) == 0x70, "Size mismatch!");
