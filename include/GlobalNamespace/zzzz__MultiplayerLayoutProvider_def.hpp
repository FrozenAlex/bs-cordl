...
public:
  ...
  /// @brief Method CalculateLayout, addr 0x58a3a58, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58a3ab4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_playersLayoutWasCalculatedEvent, addr 0x58996c8, size 0xc0, virtual false, abstract: false, final false
  inline void add_playersLayoutWasCalculatedEvent(::System::Action_2<::GlobalNamespace::MultiplayerPlayerLayout, int32_t>* value);

  /// @brief Method get_activePlayerSpotsCount, addr 0x58a3a48, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_activePlayerSpotsCount();

  /// @brief Method get_layout, addr 0x58a3a38, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MultiplayerPlayerLayout get_layout();

  /// @brief Method remove_playersLayoutWasCalculatedEvent, addr 0x5899854, size 0xc0, virtual false, abstract: false, final false
  inline void remove_playersLayoutWasCalculatedEvent(::System::Action_2<::GlobalNamespace::MultiplayerPlayerLayout, int32_t>* value);

  /// @brief Method set_activePlayerSpotsCount, addr 0x58a3a50, size 0x8, virtual false, abstract: false, final false
  inline void set_activePlayerSpotsCount(int32_t value);

  /// @brief Method set_layout, addr 0x58a3a40, size 0x8, virtual false, abstract: false, final false
