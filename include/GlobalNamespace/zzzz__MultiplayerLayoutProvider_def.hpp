...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerLayoutProvider*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLayoutProvider*, "", "MultiplayerLayoutProvider");
// Dependencies MultiplayerPlayerLayout, System.Object
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method CalculateLayout, addr 0x59d2c10, size 0x5c, virtual false, abstract: false, final false
  ...
  constexpr ::System::Action_2<::GlobalNamespace::MultiplayerPlayerLayout, int32_t>* const& __cordl_internal_get_playersLayoutWasCalculatedEvent() const;
  ...
  /// @brief Method .ctor, addr 0x59d2c6c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_playersLayoutWasCalculatedEvent, addr 0x59c9118, size 0xc0, virtual false, abstract: false, final false
  inline void add_playersLayoutWasCalculatedEvent(::System::Action_2<::GlobalNamespace::MultiplayerPlayerLayout, int32_t>* value);

  /// @brief Method get_activePlayerSpotsCount, addr 0x59d2b40, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_activePlayerSpotsCount();

  /// @brief Method get_layout, addr 0x59d2b30, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MultiplayerPlayerLayout get_layout();

  /// @brief Method remove_playersLayoutWasCalculatedEvent, addr 0x59d2b50, size 0xc0, virtual false, abstract: false, final false
  inline void remove_playersLayoutWasCalculatedEvent(::System::Action_2<::GlobalNamespace::MultiplayerPlayerLayout, int32_t>* value);

  /// @brief Method set_activePlayerSpotsCount, addr 0x59d2b48, size 0x8, virtual false, abstract: false, final false
  inline void set_activePlayerSpotsCount(int32_t value);

  /// @brief Method set_layout, addr 0x59d2b38, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLayoutProvider) == 0x20, "Size mismatch!");
