...
public:
  ...
  /// @brief Method SetData, addr 0x59a4f40, size 0x2c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59a520c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_hide, addr 0x59a4cdc, size 0x2c, virtual false, abstract: false, final false
