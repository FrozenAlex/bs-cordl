...
public:
  ...
  /// @brief Method CompareTo, addr 0x32b4b68, size 0xf8, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Object* obj);

  /// @brief Method CreateFromSerializedData, addr 0x32b4ac0, size 0xa8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::MultiplayerLevelCompletionResults* CreateFromSerializedData(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method HasAnyResult, addr 0x32b4a04, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Serialize, addr 0x32b4a34, size 0x8c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32b4a24, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x32b4a28, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_failedOrGivenUp, addr 0x32b4a10, size 0x14, virtual false, abstract: false, final false
  inline bool get_failedOrGivenUp();

  /// @brief Method get_hasAnyResults, addr 0x32b49f4, size 0x10, virtual false, abstract: false, final false
  inline bool get_hasAnyResults();

  /// @brief Method get_levelCompletionResults, addr 0x32b49ec, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::LevelCompletionResults* get_levelCompletionResults();

  /// @brief Method get_playerLevelEndReason, addr 0x32b49e4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MultiplayerLevelCompletionResults_MultiplayerPlayerLevelEndReason get_playerLevelEndReason();

  /// @brief Method get_playerLevelEndState, addr 0x32b49dc, size 0x8, virtual false, abstract: false, final false
