...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerLevelFinishedController*);
MARK_REF_T(::GlobalNamespace::MultiplayerLevelFinishedController__StartLevelFinished_d__20*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLevelFinishedController*, "", "MultiplayerLevelFinishedController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLevelFinishedController__StartLevelFinished_d__20*, "", "MultiplayerLevelFinishedController/<StartLevelFinished>d__20");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x59ae404, size 0x4f8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x59ae8fc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x59ae904, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x59ae93c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x59ae400, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x59ae124, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLevelFinishedController__StartLevelFinished_d__20) == 0x40, "Size mismatch!");
...
public:
  ...
  /// @brief Method HandlePlayerDidFinish, addr 0x59ae12c, size 0x20, virtual false, abstract: false, final false
  inline void HandlePlayerDidFinish(::GlobalNamespace::MultiplayerLevelCompletionResults* levelCompletionResults);

  /// @brief Method HandlePlayerNetworkDidFailed, addr 0x59ae14c, size 0x38, virtual false, abstract: false, final false
  inline void HandlePlayerNetworkDidFailed(::GlobalNamespace::MultiplayerLevelCompletionResults* levelCompletionResults);

  /// @brief Method HandleRpcLevelFinished, addr 0x59ae184, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x59ade4c, size 0x278, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x59adbc4, size 0x288, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartLevelFinished, addr 0x59ae0c4, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59ae364, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_allResultsCollectedEvent, addr 0x59ada2c, size 0xc0, virtual false, abstract: false, final false
  inline void add_allResultsCollectedEvent(::System::Action_2<::GlobalNamespace::MultiplayerLevelCompletionResults*,
                                                              ::System::Collections::Generic::Dictionary_2<::StringW, ::GlobalNamespace::MultiplayerLevelCompletionResults*>*>* value);

  /// @brief Method get_gameResultsReady, addr 0x59adbac, size 0x8, virtual false, abstract: false, final false
  inline bool get_gameResultsReady();

  /// @brief Method get_localPlayerResults, addr 0x59adbbc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MultiplayerLevelCompletionResults* get_localPlayerResults();

  /// @brief Method get_otherPlayersCompletionResults, addr 0x59adbb4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_allResultsCollectedEvent, addr 0x59adaec, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLevelFinishedController) == 0x60, "Size mismatch!");
