...
MARK_REF_T(::GlobalNamespace::MultiplayerLevelLoader*);
MARK_VAL_T(::GlobalNamespace::MultiplayerLevelLoader__LoadBeatmapLevelDataAsync_d__21);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLevelLoader_MultiplayerBeatmapLoaderState, "", "MultiplayerLevelLoader/MultiplayerBeatmapLoaderState");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLevelLoader*, "", "MultiplayerLevelLoader");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLevelLoader__LoadBeatmapLevelDataAsync_d__21, "", "MultiplayerLevelLoader/<LoadBeatmapLevelDataAsync>d__21");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x58e0b6c, size 0x4d8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x58e1044, size 0x80, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLevelLoader__LoadBeatmapLevelDataAsync_d__21) == 0x40, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies MultiplayerLevelLoader::MultiplayerBeatmapLoaderState, System.Object
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method ClearLoading, addr 0x58e08b0, size 0x48, virtual false, abstract: false, final false
  inline void ClearLoading();

  /// @brief Method LoadBeatmapLevelDataAsync, addr 0x58e07bc, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadLevel, addr 0x58e0720, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetNewStartTime, addr 0x58e08a8, size 0x8, virtual false, abstract: false, final false
  inline void SetNewStartTime(int64_t newStartTime);

  /// @brief Method Tick, addr 0x58e08f8, size 0x270, virtual true, abstract: false, final true
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x58e0b68, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_countdownFinishedEvent, addr 0x58e05a0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_stillDownloadingSongEvent, addr 0x58e0448, size 0xac, virtual false, abstract: false, final false
  inline void add_stillDownloadingSongEvent(::System::Action* value);

  /// @brief Convert to "::Zenject::ITickable"
  constexpr ::Zenject::ITickable* i___Zenject__ITickable() noexcept;

  /// @brief Method remove_countdownFinishedEvent, addr 0x58e0660, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_stillDownloadingSongEvent, addr 0x58e04f4, size 0xac, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLevelLoader) == 0x70, "Size mismatch!");
