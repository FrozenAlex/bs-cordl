...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerLevelNoTransitionInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLevelNoTransitionInstaller*, "", "MultiplayerLevelNoTransitionInstaller");
...
public:
  ...
  /// @brief Method .ctor, addr 0x57ec444, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLevelNoTransitionInstaller) == 0x20, "Size mismatch!");
