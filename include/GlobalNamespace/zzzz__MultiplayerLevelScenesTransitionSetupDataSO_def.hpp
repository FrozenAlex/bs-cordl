...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO*, "", "MultiplayerLevelScenesTransitionSetupDataSO");
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO) == 0xa0, "Size mismatch!");
