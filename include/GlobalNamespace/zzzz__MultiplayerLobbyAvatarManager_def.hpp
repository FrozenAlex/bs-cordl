...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerLobbyAvatarManager*);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x59d4aa4, size 0x13c, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x59d4be0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x59d4be8, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x59d4c20, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x59d4aa0, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x59d49a8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLobbyAvatarManager__RemovePlayerAndDestroy_d__13) == 0x38, "Size mismatch!");
...
public:
  ...
  /// @brief Method ActivateMultiplayerLobbyAvatarManager, addr 0x59d3a60, size 0x2d0, virtual false, abstract: false, final false
  inline void ActivateMultiplayerLobbyAvatarManager();

  /// @brief Method AddPlayer, addr 0x59d3d30, size 0x478, virtual false, abstract: false, final false
  inline void AddPlayer(::GlobalNamespace::IBeatSaberConnectedPlayer* connectedPlayer);

  /// @brief Method DeactivateMultiplayerLobbyAvatarManager, addr 0x59d41a8, size 0x44c, virtual false, abstract: false, final false
  inline void DeactivateMultiplayerLobbyAvatarManager();

  /// @brief Method HandleLobbyStateDataModelPlayerConnected, addr 0x59d45f4, size 0x4, virtual false, abstract: false, final false
  inline void HandleLobbyStateDataModelPlayerConnected(::GlobalNamespace::IBeatSaberConnectedPlayer* connectedPlayer);

  /// @brief Method HandleLobbyStateDataModelPlayerDisconnected, addr 0x59d45f8, size 0x4, virtual false, abstract: false, final false
  inline void HandleLobbyStateDataModelPlayerDisconnected(::GlobalNamespace::IBeatSaberConnectedPlayer* connectedPlayer);

  /// @brief Method Init, addr 0x59d3a58, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method RemovePlayer, addr 0x59d45fc, size 0x178, virtual false, abstract: false, final false
  inline void RemovePlayer(::GlobalNamespace::IConnectedPlayer* connectedPlayer);

  /// @brief Method RemovePlayerAndDestroy, addr 0x59d4940, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59d49b0, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLobbyAvatarManager) == 0x48, "Size mismatch!");
