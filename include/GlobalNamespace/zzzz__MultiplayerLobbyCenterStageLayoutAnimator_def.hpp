...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator*, "", "MultiplayerLobbyCenterStageLayoutAnimator");
...
public:
  ...
  /// @brief Method Move, addr 0x58df180, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method StartCountdown, addr 0x58df0fc, size 0x84, virtual false, abstract: false, final false
  inline void StartCountdown();

  /// @brief Method StopCountdown, addr 0x58df324, size 0xa0, virtual false, abstract: false, final false
  inline void StopCountdown(bool instant);

  /// @brief Method <Move>b__7_0, addr 0x58df3c8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58df3c4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator) == 0x48, "Size mismatch!");
