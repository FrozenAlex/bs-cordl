...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerLobbyCenterStageManager*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLobbyCenterStageManager*, "", "MultiplayerLobbyCenterStageManager");
...
public:
  ...
  /// @brief Method ActivateCenterStageManager, addr 0x5a083c0, size 0x24, virtual false, abstract: false, final false
  inline void ActivateCenterStageManager();

  /// @brief Method DeactivateCenterStageManager, addr 0x5a08514, size 0x24, virtual false, abstract: false, final false
  inline void DeactivateCenterStageManager();

  /// @brief Method Init, addr 0x5a083b8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method RecalculateCenterPosition, addr 0x5a083e4, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a08538, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLobbyCenterStageManager) == 0x40, "Size mismatch!");
