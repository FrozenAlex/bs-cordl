...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerLobbyInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLobbyInstaller*, "", "MultiplayerLobbyInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x59f65bc, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59f66c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLobbyInstaller) == 0x38, "Size mismatch!");
