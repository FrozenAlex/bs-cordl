...
public:
  ...
  /// @brief Method .ctor, addr 0x588eec8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DisablePlayer, addr 0x588edf8, size 0x58, virtual false, abstract: false, final false
  inline void DisablePlayer();

  static inline ::GlobalNamespace::MultiplayerLocalActivePlayerFacade* New_ctor();

  /// @brief Method PauseSpawning, addr 0x588ee50, size 0x1c, virtual false, abstract: false, final false
  inline void PauseSpawning();

  /// @brief Method ReportPlayerDidFinish, addr 0x588edc0, size 0x1c, virtual true, abstract: false, final true
  inline void ReportPlayerDidFinish(::GlobalNamespace::MultiplayerLevelCompletionResults* results);

  /// @brief Method ReportPlayerNetworkDidFailed, addr 0x588eddc, size 0x1c, virtual true, abstract: false, final true
  inline void ReportPlayerNetworkDidFailed(::GlobalNamespace::MultiplayerLevelCompletionResults* results);

  /// @brief Method ResumeSpawning, addr 0x588ee6c, size 0x1c, virtual false, abstract: false, final false
  inline void ResumeSpawning();

  /// @brief Method __ForceStopSong, addr 0x588ee88, size 0x34, virtual false, abstract: false, final false
  inline void __ForceStopSong();

  /// @brief Method __GetActiveOnlyGameObjects, addr 0x588eebc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x588eec4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_playerDidFinishEvent, addr 0x588eac0, size 0xc0, virtual true, abstract: false, final true
  inline void add_playerDidFinishEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>* value);

  /// @brief Method add_playerNetworkDidFailedEvent, addr 0x588ec40, size 0xc0, virtual true, abstract: false, final true
  inline void add_playerNetworkDidFailedEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>* value);

  /// @brief Method get_currentLocalPlayerLevelCompletionResult, addr 0x588eaa0, size 0x20, virtual false, abstract: false, final false
  inline ::GlobalNamespace::LevelCompletionResults* get_currentLocalPlayerLevelCompletionResult();

  /// @brief Method get_introAnimator, addr 0x588ea88, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MultiplayerLocalActivePlayerIntroAnimator> get_introAnimator();

  /// @brief Method get_outroAnimator, addr 0x588ea90, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_outroAnimator();

  /// @brief Method get_songController, addr 0x588ea98, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_playerDidFinishEvent, addr 0x588eb80, size 0xc0, virtual true, abstract: false, final true
  inline void remove_playerDidFinishEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>* value);

  /// @brief Method remove_playerNetworkDidFailedEvent, addr 0x588ed00, size 0xc0, virtual true, abstract: false, final true
