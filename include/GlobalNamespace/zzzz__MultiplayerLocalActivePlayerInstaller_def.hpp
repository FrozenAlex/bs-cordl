...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerLocalActivePlayerInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLocalActivePlayerInstaller*, "", "MultiplayerLocalActivePlayerInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x59bfbbc, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59bfd0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLocalActivePlayerInstaller) == 0x40, "Size mismatch!");
