...
public:
  ...
  /// @brief Method InstallBindings, addr 0x5890780, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58908d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
