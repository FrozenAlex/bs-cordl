...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerLocalInactivePlayerFacade*);
MARK_REF_T(::GlobalNamespace::MultiplayerLocalInactivePlayerFacade_Factory*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLocalInactivePlayerFacade*, "", "MultiplayerLocalInactivePlayerFacade");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLocalInactivePlayerFacade_Factory*, "", "MultiplayerLocalInactivePlayerFacade/Factory");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5890fc0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLocalInactivePlayerFacade_Factory) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method ReportPlayerDidFinish, addr 0x5890f84, size 0x1c, virtual true, abstract: false, final true
  inline void ReportPlayerDidFinish(::GlobalNamespace::MultiplayerLevelCompletionResults* results);

  /// @brief Method ReportPlayerNetworkDidFailed, addr 0x5890fa0, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5890fbc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_playerDidFinishEvent, addr 0x5890c84, size 0xc0, virtual true, abstract: false, final true
  inline void add_playerDidFinishEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>* value);

  /// @brief Method add_playerNetworkDidFailedEvent, addr 0x5890e04, size 0xc0, virtual true, abstract: false, final true
  inline void add_playerNetworkDidFailedEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>* value);

  /// @brief Method get_introAnimator, addr 0x5890c5c, size 0x18, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_introAnimator();

  /// @brief Method get_introPlayableDirector, addr 0x5890c74, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Playables::PlayableDirector> get_introPlayableDirector();

  /// @brief Method get_outroAnimator, addr 0x5890c7c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MultiplayerLocalInactivePlayerOutroAnimator> get_outroAnimator();

  /// @brief Method get_songController, addr 0x5890c4c, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::IStartSeekSongController* get_songController();

  /// @brief Method get_spectatorController, addr 0x5890c54, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_playerDidFinishEvent, addr 0x5890d44, size 0xc0, virtual true, abstract: false, final true
  inline void remove_playerDidFinishEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>* value);

  /// @brief Method remove_playerNetworkDidFailedEvent, addr 0x5890ec4, size 0xc0, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLocalInactivePlayerFacade) == 0x50, "Size mismatch!");
