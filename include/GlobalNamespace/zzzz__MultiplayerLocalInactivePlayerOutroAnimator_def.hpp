...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerLocalInactivePlayerOutroAnimator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLocalInactivePlayerOutroAnimator*, "", "MultiplayerLocalInactivePlayerOutroAnimator");
...
public:
  ...
  /// @brief Method Start, addr 0x59c08f8, size 0x3c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x59c0934, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLocalInactivePlayerOutroAnimator) == 0x30, "Size mismatch!");
