...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper::*)(
  ...
  constexpr static std::size_t addrs = 0x58925fc;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::StringW (::GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper::*)()>(
  ...
  constexpr static std::size_t addrs = 0x5892804;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper*>(), { "ResolveDisconnectButtonString", {}, {} })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper::*)()>(&::GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5892884;
...
inline void GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper::Disconnect(::GlobalNamespace::MultiplayerLevelCompletionResults_MultiplayerPlayerLevelEndState playerLevelEndState,
  ...
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper*>(),
                                                                                         { "Disconnect",
                                                                                           ...
                                                                                           { ::i2c::type_of<::GlobalNamespace::MultiplayerLevelCompletionResults_MultiplayerPlayerLevelEndState>(),
                                                                                             ::i2c::type_of<::GlobalNamespace::LevelCompletionResults*>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, playerLevelEndState, levelCompletionResults);
}
...
inline ::GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper* GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper*>());
}
// Ctor Parameters []
