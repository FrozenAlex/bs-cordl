...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerLocalPlayerScoreDiffTextManager*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLocalPlayerScoreDiffTextManager*, "", "MultiplayerLocalPlayerScoreDiffTextManager");
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLocalPlayerScoreDiffTextManager) == 0x50, "Size mismatch!");
