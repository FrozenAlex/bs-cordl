...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerMenuClient*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerMenuClient*, "", "MultiplayerMenuClient");
...
public:
  ...
  /// @brief Method LateUpdate, addr 0x593fdd8, size 0x338, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5940110, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerMenuClient) == 0x30, "Size mismatch!");
