...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MultiplayerModeSelectionViewController::*)(
  ...
  constexpr static std::size_t addrs = 0x595f2b8;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{},
        (::i2c::find_method(
            ::i2c::class_of<::GlobalNamespace::MultiplayerModeSelectionViewController*>(),
            { "add_didFinishEvent",
              {},
              { ::i2c::type_of<::System::Action_2<::UnityW<::GlobalNamespace::MultiplayerModeSelectionViewController>, ::GlobalNamespace::MultiplayerModeSelectionViewController_MenuButton>*>() } })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MultiplayerModeSelectionViewController::*)(
  ...
  constexpr static std::size_t size = 0xc0;
  constexpr static std::size_t addrs = 0x595f378;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MultiplayerModeSelectionViewController::*)(bool, bool, bool)>(
  ...
  constexpr static std::size_t addrs = 0x595f438;
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::GlobalNamespace::MultiplayerModeSelectionViewController*>(),
                                                                                          { ::i2c::class_of<::GlobalNamespace::MultiplayerModeSelectionViewController*>(), 5 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MultiplayerModeSelectionViewController::*)(::GlobalNamespace::MultiplayerStatusData*)>(
  ...
  constexpr static std::size_t addrs = 0x595f7c0;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::MultiplayerModeSelectionViewController*>(),
                                                                                           { "SetData", {}, { ::i2c::type_of<::GlobalNamespace::MultiplayerStatusData*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MultiplayerModeSelectionViewController::*)(::GlobalNamespace::MultiplayerModeSelectionViewController_MenuButton)>(
  ...
  constexpr static std::size_t addrs = 0x595fa70;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::MultiplayerModeSelectionViewController*>(),
                                                             { "HandleMenuButton", {}, { ::i2c::type_of<::GlobalNamespace::MultiplayerModeSelectionViewController_MenuButton>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MultiplayerModeSelectionViewController::*)()>(
  ...
  constexpr static std::size_t addrs = 0x595fa9c;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MultiplayerModeSelectionViewController::*)()>(
  ...
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x595fac0;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MultiplayerModeSelectionViewController::*)()>(
  ...
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x595fae4;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MultiplayerModeSelectionViewController::*)()>(
  ...
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x595fb08;
...
constexpr void GlobalNamespace::MultiplayerModeSelectionViewController::__cordl_internal_set__quickPlayButton(::UnityW<::UnityEngine::UI::Button> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____quickPlayButton = value;
}
...
constexpr void GlobalNamespace::MultiplayerModeSelectionViewController::__cordl_internal_set__gameBrowserButton(::UnityW<::UnityEngine::UI::Button> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____gameBrowserButton = value;
}
...
constexpr void GlobalNamespace::MultiplayerModeSelectionViewController::__cordl_internal_set__joinWithCodeButton(::UnityW<::UnityEngine::UI::Button> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____joinWithCodeButton = value;
}
...
constexpr void GlobalNamespace::MultiplayerModeSelectionViewController::__cordl_internal_set__maintenanceMessageText(::UnityW<::TMPro::TextMeshProUGUI> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____maintenanceMessageText = value;
}
...
constexpr void GlobalNamespace::MultiplayerModeSelectionViewController::__cordl_internal_set__customServerEndPointText(::UnityW<::TMPro::TextMeshProUGUI> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____customServerEndPointText = value;
}
...
inline void GlobalNamespace::MultiplayerModeSelectionViewController::DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::MultiplayerModeSelectionViewController*>(), 5 })));
...
inline void GlobalNamespace::MultiplayerModeSelectionViewController::SetData(::GlobalNamespace::MultiplayerStatusData* multiplayerStatusData) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::MultiplayerModeSelectionViewController*>(),
                                                                                         { "SetData", {}, { ::i2c::type_of<::GlobalNamespace::MultiplayerStatusData*>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, multiplayerStatusData);
}
...
inline ::GlobalNamespace::MultiplayerModeSelectionViewController* GlobalNamespace::MultiplayerModeSelectionViewController::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::MultiplayerModeSelectionViewController*>());
}
// Ctor Parameters []
