...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerModeSettings*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerModeSettings*, "", "MultiplayerModeSettings");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3737ca8, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerModeSettings) == 0x28, "Size mismatch!");
