...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerObjectInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerObjectInstaller*, "", "MultiplayerObjectInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x58a80b4, size 0x168, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58a821c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerObjectInstaller) == 0x40, "Size mismatch!");
