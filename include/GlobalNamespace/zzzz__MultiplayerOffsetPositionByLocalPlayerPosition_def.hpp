...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerOffsetPositionByLocalPlayerPosition*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerOffsetPositionByLocalPlayerPosition*, "", "MultiplayerOffsetPositionByLocalPlayerPosition");
...
public:
  ...
  /// @brief Method Awake, addr 0x58a8220, size 0x50, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::MultiplayerOffsetPositionByLocalPlayerPosition* New_ctor();

  /// @brief Method SetEnabled, addr 0x58a31f0, size 0x8, virtual false, abstract: false, final false
  inline void SetEnabled(bool isEnabled);

  /// @brief Method Update, addr 0x58a8270, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdatePositionAndRotationIfNeeded, addr 0x58a8274, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58a8500, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerOffsetPositionByLocalPlayerPosition) == 0x60, "Size mismatch!");
