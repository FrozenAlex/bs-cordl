...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerPlacementErrorCode, "", "MultiplayerPlacementErrorCode");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::MultiplayerPlacementErrorCode) == 0x4, "Size mismatch!");
