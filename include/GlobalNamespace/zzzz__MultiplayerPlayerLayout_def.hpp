...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerPlayerLayout, "", "MultiplayerPlayerLayout");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
public:
  ...
  /// @brief Field Duel value: I32(2)
  static ::GlobalNamespace::MultiplayerPlayerLayout const Duel;

  /// @brief Field NotDetermined value: I32(0)
...
static_assert(sizeof(::GlobalNamespace::MultiplayerPlayerLayout) == 0x4, "Size mismatch!");
