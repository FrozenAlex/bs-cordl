...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerPlayerResultsData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerPlayerResultsData*, "", "MultiplayerPlayerResultsData");
...
public:
  ...
  /// @brief Method CompareTo, addr 0x3737d10, size 0x1dc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3737d08, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MultiplayerPlayerResultsData) == 0x28, "Size mismatch!");
