...
public:
  ...
  /// @brief Method MoveNext, addr 0x59db364, size 0x3d8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x59db73c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x59db744, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x59db77c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x59db360, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x59db218, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BindPlayerFactories, addr 0x59dae54, size 0x2e4, virtual false, abstract: false, final false
  inline void BindPlayerFactories(::GlobalNamespace::MultiplayerPlayerLayout layout);

  /// @brief Method HandlePlayerDidFinish, addr 0x59db220, size 0x1c, virtual false, abstract: false, final false
  inline void HandlePlayerDidFinish(::GlobalNamespace::MultiplayerLevelCompletionResults* levelCompletionResults);

  /// @brief Method HandlePlayerNetworkDidFailed, addr 0x59db23c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReportLocalPlayerNetworkDidFailed, addr 0x59cad84, size 0x1c, virtual false, abstract: false, final false
  inline void ReportLocalPlayerNetworkDidFailed(::GlobalNamespace::MultiplayerLevelCompletionResults* levelCompletionResults);

  /// @brief Method SpawnPlayers, addr 0x59cd5e8, size 0x9a0, virtual false, abstract: false, final false
  ...
  /// @brief Method SwitchLocalPlayerToInactive, addr 0x59ce4a8, size 0x20, virtual false, abstract: false, final false
  inline void SwitchLocalPlayerToInactive();

  /// @brief Method SwitchLocalPlayerToInactiveCoroutine, addr 0x59db1c4, size 0x54, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* SwitchLocalPlayerToInactiveCoroutine();

  /// @brief Method TryGetConnectedCenterFacingRotation, addr 0x59db158, size 0x6c, virtual false, abstract: false, final false
  inline bool TryGetConnectedCenterFacingRotation(::StringW userId, ::by_ref<float_t> centerFacingRotation);

  /// @brief Method TryGetConnectedPlayerController, addr 0x59cc654, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59db258, size 0x108, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSwitchPlayerToInactiveEvent, addr 0x59cdf88, size 0xac, virtual false, abstract: false, final false
  inline void add_didSwitchPlayerToInactiveEvent(::System::Action* value);

  /// @brief Method add_playerDidFinishEvent, addr 0x59dab54, size 0xc0, virtual true, abstract: false, final true
  inline void add_playerDidFinishEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>* value);

  /// @brief Method add_playerNetworkDidFailedEvent, addr 0x59dacd4, size 0xc0, virtual true, abstract: false, final true
  inline void add_playerNetworkDidFailedEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>* value);

  /// @brief Method add_playerSpawningDidFinishEvent, addr 0x59d8a88, size 0xac, virtual false, abstract: false, final false
  inline void add_playerSpawningDidFinishEvent(::System::Action* value);

  /// @brief Method get_activeLocalPlayerFacade, addr 0x59dab44, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MultiplayerLocalActivePlayerFacade> get_activeLocalPlayerFacade();

  /// @brief Method get_allActiveAtGameStartPlayers, addr 0x59dab34, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_inactivePlayerFacade, addr 0x59dab4c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MultiplayerLocalInactivePlayerFacade> get_inactivePlayerFacade();

  /// @brief Method get_localPlayerStartSeekSongController, addr 0x59dab3c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IStartSeekSongControllerProvider* get_localPlayerStartSeekSongController();

  /// @brief Method get_localPlayerTransform, addr 0x59d7888, size 0x84, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_localPlayerTransform();

  /// @brief Method get_playerSpawningFinished, addr 0x59dab24, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didSwitchPlayerToInactiveEvent, addr 0x59ca490, size 0xac, virtual false, abstract: false, final false
  inline void remove_didSwitchPlayerToInactiveEvent(::System::Action* value);

  /// @brief Method remove_playerDidFinishEvent, addr 0x59dac14, size 0xc0, virtual true, abstract: false, final true
  inline void remove_playerDidFinishEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>* value);

  /// @brief Method remove_playerNetworkDidFailedEvent, addr 0x59dad94, size 0xc0, virtual true, abstract: false, final true
  inline void remove_playerNetworkDidFailedEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>* value);

  /// @brief Method remove_playerSpawningDidFinishEvent, addr 0x59d8c40, size 0xac, virtual false, abstract: false, final false
  inline void remove_playerSpawningDidFinishEvent(::System::Action* value);

  /// @brief Method set_playerSpawningFinished, addr 0x59dab2c, size 0x8, virtual false, abstract: false, final false
