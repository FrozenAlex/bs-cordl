...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerResultsData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerResultsData*, "", "MultiplayerResultsData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3737f0c, size 0x5cc, virtual false, abstract: false, final false
  inline void _ctor(::StringW gameId, ::GlobalNamespace::MultiplayerLevelCompletionResults* localPlayerResultData,
                    ::System::Collections::Generic::Dictionary_2<::StringW, ::GlobalNamespace::MultiplayerLevelCompletionResults*>* otherPlayersResultData,
                    ::GlobalNamespace::MultiplayerBadgesProvider* badgesProvider, ::GlobalNamespace::IBeatSaberMultiplayerSessionManager* multiplayerSessionManager);

  /// @brief Method get_allPlayersSortedData, addr 0x3737f04, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::MultiplayerPlayerResultsData*>* get_allPlayersSortedData();

  /// @brief Method get_gameId, addr 0x3737eec, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_gameId();

  /// @brief Method get_localPlayerResultData, addr 0x3737ef4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MultiplayerPlayerResultsData* get_localPlayerResultData();

  /// @brief Method get_otherPlayersData, addr 0x3737efc, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MultiplayerResultsData) == 0x30, "Size mismatch!");
