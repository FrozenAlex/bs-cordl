...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerScoreRingItem*);
MARK_REF_T(::GlobalNamespace::MultiplayerScoreRingItem_Pool*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerScoreRingItem*, "", "MultiplayerScoreRingItem");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerScoreRingItem_Pool*, "", "MultiplayerScoreRingItem/Pool");
...
public:
  ...
  /// @brief Method .ctor, addr 0x59ddc50, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerScoreRingItem_Pool) == 0x40, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x59ddc4c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::MultiplayerScoreRingItem) == 0x48, "Size mismatch!");
