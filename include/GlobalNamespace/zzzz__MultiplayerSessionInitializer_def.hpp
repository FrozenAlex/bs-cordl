...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerSessionInitializer, "", "MultiplayerSessionInitializer");
...
public:
  ...
  /// @brief Method InitializeLocalPlayerSessionState, addr 0x32b4c6c, size 0x284, virtual true, abstract: false, final true
  inline void InitializeLocalPlayerSessionState();

  /// @brief Method .ctor, addr 0x32b4c60, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MultiplayerSessionInitializer) == 0x10, "Size mismatch!");
