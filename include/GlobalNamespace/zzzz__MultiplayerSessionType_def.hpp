...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerSessionType, "", "MultiplayerSessionType");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::MultiplayerSessionType) == 0x4, "Size mismatch!");
