...
public:
  ...
  /// @brief Method Awake, addr 0x59438dc, size 0xc8, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HideConnectionSettings, addr 0x594387c, size 0x20, virtual false, abstract: false, final false
  inline void HideConnectionSettings(bool hide);

  /// @brief Method HideSpectateSettings, addr 0x594389c, size 0x20, virtual false, abstract: false, final false
  inline void HideSpectateSettings(bool hide);

  static inline ::GlobalNamespace::MultiplayerSettingsPanelController* New_ctor();

  /// @brief Method OnDestroy, addr 0x59439a4, size 0x14, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Refresh, addr 0x594376c, size 0x110, virtual true, abstract: false, final true
  inline void Refresh();

  /// @brief Method SetLobbyCode, addr 0x59438bc, size 0x20, virtual false, abstract: false, final false
  inline void SetLobbyCode(::StringW code);

  /// @brief Method SetLobbyPlayerDataModel, addr 0x5943760, size 0xc, virtual false, abstract: false, final false
  inline void SetLobbyPlayerDataModel(::GlobalNamespace::ILobbyPlayerData* lobbyPlayerData);

  /// @brief Method UpdateLocalPlayerIsActiveState, addr 0x59439b8, size 0x24, virtual false, abstract: false, final false
  inline void UpdateLocalPlayerIsActiveState(bool isActive);

  /// @brief Method <Awake>b__14_0, addr 0x59439e0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59439dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_playerActiveStateChangedEvent, addr 0x59435e0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_playerActiveStateChangedEvent, addr 0x59436a0, size 0xc0, virtual false, abstract: false, final false
