...
public:
  ...
  /// @brief Method ErrorCode, addr 0x367e444, size 0x94, virtual false, abstract: false, final false
  static inline ::StringW ErrorCode(::GlobalNamespace::MultiplayerUnavailableReason multiplayerUnavailableReason);

  /// @brief Method GetLocalizedMessage, addr 0x367e7fc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method LocalizedKey, addr 0x367e3a0, size 0xa4, virtual false, abstract: false, final false
  static inline ::StringW LocalizedKey(::GlobalNamespace::MultiplayerUnavailableReason multiplayerUnavailableReason);

  /// @brief Method TryGetMultiplayerUnavailableReason, addr 0x367e4d8, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method VersionLessThan, addr 0x367e640, size 0x1bc, virtual false, abstract: false, final false
