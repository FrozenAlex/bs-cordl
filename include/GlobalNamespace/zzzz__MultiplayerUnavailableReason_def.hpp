...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerUnavailableReason, "", "MultiplayerUnavailableReason");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::MultiplayerUnavailableReason) == 0x4, "Size mismatch!");
