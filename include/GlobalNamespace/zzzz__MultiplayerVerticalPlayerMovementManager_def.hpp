...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerVerticalPlayerMovementManager*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerVerticalPlayerMovementManager*, "", "MultiplayerVerticalPlayerMovementManager");
...
static_assert(offsetof(::GlobalNamespace::MultiplayerVerticalPlayerMovementManager, ____duelMovementRange) == 0x24, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerVerticalPlayerMovementManager, ____maxMoveSpeedMetersPerSecond) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerVerticalPlayerMovementManager, ____accelerationMetersPerSecondSquared) == 0x2c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerVerticalPlayerMovementManager, ____decelerationMetersPerSecondSquared) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerVerticalPlayerMovementManager, ____minScoreDifference) == 0x34, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerVerticalPlayerMovementManager, ____multiplayerPlayersManager) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerVerticalPlayerMovementManager, ____scoreProvider) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerVerticalPlayerMovementManager, ____layoutProvider) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerVerticalPlayerMovementManager, ____multiplayerController) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerVerticalPlayerMovementManager, ____reusablePlayersList) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerVerticalPlayerMovementManager, ____currentSpeedsDictionary) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerVerticalPlayerMovementManager, ____lastFrameBaseScore) == 0x68, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::MultiplayerVerticalPlayerMovementManager) == 0x70, "Size mismatch!");
