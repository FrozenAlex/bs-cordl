...
MARK_GEN_REF_T_PTR(::GlobalNamespace::MultipleSortedBeatmapObjectsListsEnumerator_1_BeatmapObjectListNode);
MARK_GEN_REF_T_PTR(::GlobalNamespace::MultipleSortedBeatmapObjectsListsEnumerator_1__GetEnumerator_d__4);
