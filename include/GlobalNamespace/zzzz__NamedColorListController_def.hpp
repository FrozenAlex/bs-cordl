...
public:
  ...
  /// @brief Method .ctor, addr 0x5a2bd78, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ApplyValue, addr 0x5a2bd18, size 0x20, virtual true, abstract: false, final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method ColorForValue, addr 0x5a2bd38, size 0x3c, virtual true, abstract: false, final false
  inline ::UnityEngine::Color ColorForValue(int32_t idx);

  /// @brief Method GetInitValues, addr 0x5a2bca4, size 0x74, virtual true, abstract: false, final false
  inline bool GetInitValues(::by_ref<int32_t> idx, ::by_ref<int32_t> numberOfElements);

  /// @brief Method Init, addr 0x5a2bc30, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x5a2bc6c, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a2bd74, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_valueChangedEvent, addr 0x5a2bab0, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_valueChangedEvent, addr 0x5a2bb70, size 0xc0, virtual true, abstract: false, final true
