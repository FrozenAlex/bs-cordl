...
// Write type traits
MARK_REF_T(::GlobalNamespace::NamedIntListSettingsController*);
MARK_REF_T(::GlobalNamespace::NamedIntListSettingsController_TextValuePair*);
MARK_REF_T(::GlobalNamespace::NamedIntListSettingsController___c__DisplayClass6_0*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NamedIntListSettingsController*, "", "NamedIntListSettingsController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NamedIntListSettingsController_TextValuePair*, "", "NamedIntListSettingsController/TextValuePair");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NamedIntListSettingsController___c__DisplayClass6_0*, "", "NamedIntListSettingsController/<>c__DisplayClass6_0");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5a0cc00, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_localizedText, addr 0x5a0cbd4, size 0x28, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NamedIntListSettingsController_TextValuePair) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method <SetValue>b__0, addr 0x5a0cc04, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a0cb1c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::NamedIntListSettingsController___c__DisplayClass6_0) == 0x18, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies ListSettingsController, NamedIntListSettingsController::TextValuePair
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__textValuePairs, put = __cordl_internal_set__textValuePairs)) ::ArrayW<::GlobalNamespace::NamedIntListSettingsController_TextValuePair*>
      _textValuePairs;
  ...
  /// @brief Method ApplyValue, addr 0x5a0cb48, size 0x58, virtual true, abstract: false, final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method GetInitValues, addr 0x5a0cb20, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x5a0ca10, size 0x10c, virtual false, abstract: false, final false
  inline void SetValue(int32_t value, bool applyValue);

  /// @brief Method TextForValue, addr 0x5a0cba0, size 0x34, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::NamedIntListSettingsController_TextValuePair*> const& __cordl_internal_get__textValuePairs() const;

  constexpr ::ArrayW<::GlobalNamespace::NamedIntListSettingsController_TextValuePair*>& __cordl_internal_get__textValuePairs();
  ...
  constexpr void __cordl_internal_set__textValuePairs(::ArrayW<::GlobalNamespace::NamedIntListSettingsController_TextValuePair*> value);

  constexpr void __cordl_internal_set_valueDidChangeEvent(::System::Action_1<int32_t>* value);

  /// @brief Method .ctor, addr 0x5a0cbfc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_valueDidChangeEvent, addr 0x5a0c890, size 0xc0, virtual false, abstract: false, final false
  inline void add_valueDidChangeEvent(::System::Action_1<int32_t>* value);

  /// @brief Method remove_valueDidChangeEvent, addr 0x5a0c950, size 0xc0, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::GlobalNamespace::NamedIntListSettingsController_TextValuePair*> ____textValuePairs;
...
static_assert(sizeof(::GlobalNamespace::NamedIntListSettingsController) == 0x48, "Size mismatch!");
