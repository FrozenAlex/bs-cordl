...
// Write type traits
MARK_REF_T(::GlobalNamespace::NamedPreset*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NamedPreset*, "", "NamedPreset");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3670df8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_presetNameLocalizationKey, addr 0x3670e50, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NamedPreset) == 0x18, "Size mismatch!");
