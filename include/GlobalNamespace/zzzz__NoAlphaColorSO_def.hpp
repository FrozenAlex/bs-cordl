...
// Write type traits
MARK_REF_T(::GlobalNamespace::NoAlphaColorSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoAlphaColorSO*, "", "NoAlphaColorSO");
...
public:
  ...
  /// @brief Method .ctor, addr 0x36f4624, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x36f4614, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NoAlphaColorSO) == 0x28, "Size mismatch!");
