...
public:
  ...
  /// @brief Method .ctor, addr 0x3639ba4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x3639b94, size 0x10, virtual true, abstract: false, final false
