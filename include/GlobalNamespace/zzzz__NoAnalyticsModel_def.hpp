...
// Write type traits
MARK_REF_T(::GlobalNamespace::NoAnalyticsModel*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoAnalyticsModel*, "", "NoAnalyticsModel");
...
public:
  ...
  /// @brief Method OpenDataPrivacyPage, addr 0x3253270, size 0x4, virtual true, abstract: false, final true
  inline void OpenDataPrivacyPage();

  /// @brief Method .ctor, addr 0x325328c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_supportsOpenDataPrivacyPage, addr 0x3253268, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::NoAnalyticsModel) == 0x10, "Size mismatch!");
