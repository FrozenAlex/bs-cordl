...
// Write type traits
MARK_REF_T(::GlobalNamespace::NoRichPresencePlatformHandler*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoRichPresencePlatformHandler*, "", "NoRichPresencePlatformHandler");
...
public:
  ...
  /// @brief Method Clear, addr 0x57dd610, size 0x18, virtual true, abstract: false, final true
  inline void Clear();

  static inline ::GlobalNamespace::NoRichPresencePlatformHandler* New_ctor();

  /// @brief Method SetPresence, addr 0x57dd55c, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x57dd628, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_currentPresenceApiName, addr 0x57dd54c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_currentPresenceApiName, addr 0x57dd554, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NoRichPresencePlatformHandler) == 0x18, "Size mismatch!");
