...
// Write type traits
MARK_REF_T(::GlobalNamespace::NodePoseSyncStateNetSerializable*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NodePoseSyncStateNetSerializable*, "", "NodePoseSyncStateNetSerializable");
...
public:
  ...
  /// @brief Method Deserialize, addr 0x3225660, size 0x50, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  static inline ::GlobalNamespace::NodePoseSyncStateNetSerializable* New_ctor();

  /// @brief Method Release, addr 0x32256b0, size 0x58, virtual true, abstract: false, final true
  inline void Release();

  /// @brief Method Serialize, addr 0x3225614, size 0x4c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3225708, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_id, addr 0x32255d8, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::SyncStateId get_id();

  /// @brief Method get_pool, addr 0x3225594, size 0x44, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::PacketPool_1<::GlobalNamespace::NodePoseSyncStateNetSerializable*>* get_pool();

  /// @brief Method get_state, addr 0x32255f8, size 0x10, virtual true, abstract: false, final true
  inline ::GlobalNamespace::NodePoseSyncState get_state();

  /// @brief Method get_time, addr 0x32255e8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_id, addr 0x32255e0, size 0x8, virtual true, abstract: false, final true
  inline void set_id(::GlobalNamespace::SyncStateId value);

  /// @brief Method set_state, addr 0x3225608, size 0xc, virtual true, abstract: false, final true
  inline void set_state(::GlobalNamespace::NodePoseSyncState value);

  /// @brief Method set_time, addr 0x32255f0, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::NodePoseSyncStateNetSerializable) == 0x68, "Size mismatch!");
