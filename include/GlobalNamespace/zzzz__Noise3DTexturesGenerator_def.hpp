...
// Write type traits
MARK_REF_T(::GlobalNamespace::Noise3DTexturesGenerator*);
...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::Noise3DTexturesGenerator*, "", "Noise3DTexturesGenerator");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::Noise3DTexturesGenerator_MaterialPropertyNameCouple, "", "Noise3DTexturesGenerator/MaterialPropertyNameCouple");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple, "", "Noise3DTexturesGenerator/MaterialTextureParamsCouple");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::Noise3DTexturesGenerator_MaterialPropertyNameCouple) == 0x10, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies Noise3DTexturesGenerator::MaterialPropertyNameCouple
namespace GlobalNamespace {
// Is value type: true
...
public:
  ...
  ::ArrayW<::GlobalNamespace::Noise3DTexturesGenerator_MaterialPropertyNameCouple> materialPropertyNameCouples;
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__data, put = __cordl_internal_set__data)) ::ArrayW<::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple> _data;
  ...
  /// @brief Method Awake, addr 0x5f439d8, size 0x21c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CreateNoisePixels, addr 0x5f43bf4, size 0x33c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::Color32> CreateNoisePixels(int32_t width, int32_t height, int32_t depth, float_t scale, int32_t repeat, float_t contrast);

  static inline ::GlobalNamespace::Noise3DTexturesGenerator* New_ctor();

  constexpr ::ArrayW<::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple> const& __cordl_internal_get__data() const;

  constexpr ::ArrayW<::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple>& __cordl_internal_get__data();

  constexpr void __cordl_internal_set__data(::ArrayW<::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple> value);

  /// @brief Method .ctor, addr 0x5f43f30, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::Noise3DTexturesGenerator) == 0x28, "Size mismatch!");
