...
// Write type traits
MARK_REF_T(::GlobalNamespace::NoopBlockLevelGameplayAnalyticsEventsCache*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoopBlockLevelGameplayAnalyticsEventsCache*, "", "NoopBlockLevelGameplayAnalyticsEventsCache");
...
public:
  ...
  /// @brief Method AddBadCut, addr 0x59ec1b0, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method AddBlockMiss, addr 0x59ec1b4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method AddBombCut, addr 0x59ec1b8, size 0x4, virtual true, abstract: false, final true
  inline void AddBombCut(float_t beat);

  /// @brief Method AddGoodCut, addr 0x59ec1ac, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method AddObstacleHit, addr 0x59ec1bc, size 0x4, virtual true, abstract: false, final true
  inline void AddObstacleHit(float_t beat, float_t duration);

  /// @brief Method IsEmpty, addr 0x59ec1c8, size 0x8, virtual true, abstract: false, final true
  inline bool IsEmpty();

  static inline ::GlobalNamespace::NoopBlockLevelGameplayAnalyticsEventsCache* New_ctor();

  /// @brief Method SerializeJSON, addr 0x59ec1c0, size 0x8, virtual true, abstract: false, final true
  inline ::StringW SerializeJSON();

  /// @brief Method .ctor, addr 0x59ec1d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::NoopBlockLevelGameplayAnalyticsEventsCache) == 0x10, "Size mismatch!");
