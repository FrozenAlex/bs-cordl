...
// Write type traits
MARK_REF_T(::GlobalNamespace::NoteControllerBase*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteControllerBase*, "", "NoteControllerBase");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5799630, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::NoteControllerBase) == 0x20, "Size mismatch!");
