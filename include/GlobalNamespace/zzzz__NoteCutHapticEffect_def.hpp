...
MARK_REF_T(::GlobalNamespace::NoteCutHapticEffect*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteCutHapticEffect_Type, "", "NoteCutHapticEffect/Type");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteCutHapticEffect*, "", "NoteCutHapticEffect");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::NoteCutHapticEffect) == 0x68, "Size mismatch!");
