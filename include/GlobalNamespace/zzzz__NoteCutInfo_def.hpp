...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteCutInfo_FailReason, "", "NoteCutInfo/FailReason");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteCutInfo, "", "NoteCutInfo");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
public:
  ...
  /// @brief Method .ctor, addr 0x36bc244, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method get_allExceptSaberTypeIsOK, addr 0x36bc1d8, size 0x28, virtual false, abstract: false, final false
  inline bool get_allExceptSaberTypeIsOK();

  /// @brief Method get_allIsOK, addr 0x36bc1a8, size 0x30, virtual false, abstract: false, final false
  inline bool get_allIsOK();

  /// @brief Method get_failReason, addr 0x36bc200, size 0x44, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NoteCutInfo) == 0x90, "Size mismatch!");
