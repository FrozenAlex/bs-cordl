...
public:
  ...
  /// @brief Method Awake, addr 0x584b32c, size 0x1c8, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::NoteCutParticlesEffect* New_ctor();

  /// @brief Method SpawnParticles, addr 0x584b4f4, size 0x4a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x584b99c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::NoteCutParticlesEffect) == 0x238, "Size mismatch!");
