...
public:
  ...
  /// @brief Method HandleScoringForNoteStarted, addr 0x59885fc, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x59884fc, size 0x100, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x5988404, size 0xf8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x59886c4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::NoteCutScoreSpawner) == 0x30, "Size mismatch!");
