...
// Write type traits
MARK_REF_T(::GlobalNamespace::NoteCutSoundEffectManager*);
MARK_REF_T(::GlobalNamespace::NoteCutSoundEffectManager_InitData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteCutSoundEffectManager*, "", "NoteCutSoundEffectManager");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteCutSoundEffectManager_InitData*, "", "NoteCutSoundEffectManager/InitData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x577f6cc, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NoteCutSoundEffectManager_InitData) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Field _audioManager, offset 0x48, size 0x8
  ...
  __declspec(property(get = __cordl_internal_get__longCutEffectsAudioClips, put = __cordl_internal_set__longCutEffectsAudioClips)) ::ArrayW<::UnityW<::UnityEngine::AudioClip>>
  ...
  __declspec(property(get = __cordl_internal_get__shortCutEffectsAudioClips, put = __cordl_internal_set__shortCutEffectsAudioClips)) ::ArrayW<::UnityW<::UnityEngine::AudioClip>>
  ...
  /// @brief Method HandleNoteCutSoundEffectDidFinish, addr 0x577f578, size 0xe8, virtual true, abstract: false, final true
  inline void HandleNoteCutSoundEffectDidFinish(::GlobalNamespace::NoteCutSoundEffect* noteCutSoundEffect);

  /// @brief Method HandleNoteDidStartDissolving, addr 0x577f410, size 0x168, virtual false, abstract: false, final false
  inline void HandleNoteDidStartDissolving(::GlobalNamespace::NoteControllerBase* noteController);

  /// @brief Method HandleNoteWasCut, addr 0x577f2a0, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleNoteWasSpawned, addr 0x577ecec, size 0x584, virtual false, abstract: false, final false
  inline void HandleNoteWasSpawned(::GlobalNamespace::NoteController* noteController);

  /// @brief Method IsSupportedNote, addr 0x577f270, size 0x30, virtual false, abstract: false, final false
  inline bool IsSupportedNote(::GlobalNamespace::NoteData* noteData);

  /// @brief Method LateUpdate, addr 0x577ec30, size 0xbc, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::NoteCutSoundEffectManager* New_ctor();

  /// @brief Method OnDestroy, addr 0x577eacc, size 0x164, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x577e800, size 0x2cc, virtual false, abstract: false, final false
  inline void Start();
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::AudioClip>> const& __cordl_internal_get__longCutEffectsAudioClips() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::AudioClip>>& __cordl_internal_get__longCutEffectsAudioClips();
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::AudioClip>> const& __cordl_internal_get__shortCutEffectsAudioClips() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::AudioClip>>& __cordl_internal_get__shortCutEffectsAudioClips();
  ...
  constexpr void __cordl_internal_set__longCutEffectsAudioClips(::ArrayW<::UnityW<::UnityEngine::AudioClip>> value);
  ...
  constexpr void __cordl_internal_set__shortCutEffectsAudioClips(::ArrayW<::UnityW<::UnityEngine::AudioClip>> value);
  ...
  /// @brief Method .ctor, addr 0x577f660, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_handleWrongSaberTypeAsGood, addr 0x577e7f0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_handleWrongSaberTypeAsGood, addr 0x577e7f8, size 0x8, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffectManager, ____audioManager) == 0x48, "Offset mismatch!");
...
static_assert(sizeof(::GlobalNamespace::NoteCutSoundEffectManager) == 0xb0, "Size mismatch!");
