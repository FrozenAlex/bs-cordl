...
// Write type traits
MARK_REF_T(::GlobalNamespace::NoteCutter*);
MARK_REF_T(::GlobalNamespace::NoteCutter_CuttableBySaberSortParams*);
MARK_REF_T(::GlobalNamespace::NoteCutter_CuttableBySaberSortParamsComparer*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteCutter*, "", "NoteCutter");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteCutter_CuttableBySaberSortParams*, "", "NoteCutter/CuttableBySaberSortParams");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteCutter_CuttableBySaberSortParamsComparer*, "", "NoteCutter/CuttableBySaberSortParamsComparer");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58b84ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::NoteCutter_CuttableBySaberSortParams) == 0x28, "Size mismatch!");
...
public:
  ...
  /// @brief Method Compare, addr 0x58b84f0, size 0x12c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x58b84e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::NoteCutter_CuttableBySaberSortParamsComparer) == 0x10, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies NoteCutter::CuttableBySaberSortParams, System.Object, UnityEngine.Collider
namespace GlobalNamespace {
// Is value type: false
// CS Name: NoteCutter
...
public:
  ...
  /// @brief Method Cut, addr 0x58b7d3c, size 0x584, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::NoteCutter_CuttableBySaberSortParams*> const& __cordl_internal_get__cuttableBySaberSortParams() const;

  constexpr ::ArrayW<::GlobalNamespace::NoteCutter_CuttableBySaberSortParams*>& __cordl_internal_get__cuttableBySaberSortParams();
  ...
  /// @brief Method .ctor, addr 0x58b83bc, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::GlobalNamespace::NoteCutter_CuttableBySaberSortParams*> ____cuttableBySaberSortParams;
...
static_assert(sizeof(::GlobalNamespace::NoteCutter) == 0x28, "Size mismatch!");
