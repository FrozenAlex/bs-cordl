...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::NoteCutter_CuttableBySaberSortParams::*)()>(&::GlobalNamespace::NoteCutter_CuttableBySaberSortParams::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x59e70e0;
...
inline ::GlobalNamespace::NoteCutter_CuttableBySaberSortParams* GlobalNamespace::NoteCutter_CuttableBySaberSortParams::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::NoteCutter_CuttableBySaberSortParams*>());
}
// Ctor Parameters []
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::GlobalNamespace::NoteCutter_CuttableBySaberSortParamsComparer::*)(::System::Object*, ::System::Object*)>(
  ...
  constexpr static std::size_t addrs = 0x59e70e4;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::NoteCutter_CuttableBySaberSortParamsComparer::*)()>(
  ...
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x59e70dc;
...
inline int32_t GlobalNamespace::NoteCutter_CuttableBySaberSortParamsComparer::Compare(::System::Object* p0, ::System::Object* p1) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::NoteCutter_CuttableBySaberSortParamsComparer*>(),
                                                                                         { "Compare", {}, { ::i2c::type_of<::System::Object*>(), ::i2c::type_of<::System::Object*>() } })));
  return ::cordl_internals::RunMethodRethrow<int32_t>(this, ___internal_method, p0, p1);
}
...
inline ::GlobalNamespace::NoteCutter_CuttableBySaberSortParamsComparer* GlobalNamespace::NoteCutter_CuttableBySaberSortParamsComparer::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::NoteCutter_CuttableBySaberSortParamsComparer*>());
}
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::NoteCutter::*)()>(&::GlobalNamespace::NoteCutter::_ctor)> {
  constexpr static std::size_t size = 0x12c;
  constexpr static std::size_t addrs = 0x59e6fb0;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::NoteCutter::*)(::GlobalNamespace::Saber*)>(&::GlobalNamespace::NoteCutter::Cut)> {
  ...
  constexpr static std::size_t addrs = 0x59e6930;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::NoteCutter*>(), { "Cut", {}, { ::i2c::type_of<::GlobalNamespace::Saber*>() } })));
    return ___internal_method;
  }
};
constexpr ::ArrayW<::UnityW<::UnityEngine::Collider>>& GlobalNamespace::NoteCutter::__cordl_internal_get__colliders() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____colliders;
}
constexpr ::ArrayW<::UnityW<::UnityEngine::Collider>> const& GlobalNamespace::NoteCutter::__cordl_internal_get__colliders() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____colliders;
}
constexpr void GlobalNamespace::NoteCutter::__cordl_internal_set__colliders(::ArrayW<::UnityW<::UnityEngine::Collider>> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____colliders = value;
}
constexpr ::ArrayW<::GlobalNamespace::NoteCutter_CuttableBySaberSortParams*>& GlobalNamespace::NoteCutter::__cordl_internal_get__cuttableBySaberSortParams() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____cuttableBySaberSortParams;
}
constexpr ::ArrayW<::GlobalNamespace::NoteCutter_CuttableBySaberSortParams*> const& GlobalNamespace::NoteCutter::__cordl_internal_get__cuttableBySaberSortParams() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____cuttableBySaberSortParams;
}
constexpr void GlobalNamespace::NoteCutter::__cordl_internal_set__cuttableBySaberSortParams(::ArrayW<::GlobalNamespace::NoteCutter_CuttableBySaberSortParams*> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____cuttableBySaberSortParams = value;
}
...
inline void GlobalNamespace::NoteCutter::Cut(::GlobalNamespace::Saber* saber) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::NoteCutter*>(), { "Cut", {}, { ::i2c::type_of<::GlobalNamespace::Saber*>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, saber);
}
inline ::GlobalNamespace::NoteCutter* GlobalNamespace::NoteCutter::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::NoteCutter*>());
}
// Ctor Parameters []
