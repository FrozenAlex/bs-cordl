...
MARK_REF_T(::GlobalNamespace::NoteData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteData_GameplayType, "", "NoteData/GameplayType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteData_ScoringType, "", "NoteData/ScoringType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteData*, "", "NoteData");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::NoteData_GameplayType) == 0x4, "Size mismatch!");
...
public:
  ...
  enum struct __NoteData_ScoringType_Unwrapped : int32_t {
    ...
    __E_ChainHeadArcHead = static_cast<int32_t>(0x9),
    __E_ChainHeadArcHeadArcTail = static_cast<int32_t>(0xa),
  };
  ...
  /// @brief Field ChainHeadArcHead value: I32(9)
  static ::GlobalNamespace::NoteData_ScoringType const ChainHeadArcHead;

  /// @brief Field ChainHeadArcHeadArcTail value: I32(10)
  static ::GlobalNamespace::NoteData_ScoringType const ChainHeadArcHeadArcTail;
...
static_assert(sizeof(::GlobalNamespace::NoteData_ScoringType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Field <beforeJumpNoteLineLayer>k__BackingField, offset 0x50, size 0x4
  ...
  /// @brief Field <colorType>k__BackingField, offset 0x38, size 0x4
  ...
  /// @brief Field <cutDirectionAngleOffset>k__BackingField, offset 0x5c, size 0x4
  ...
  /// @brief Field <cutDirection>k__BackingField, offset 0x3c, size 0x4
  ...
  /// @brief Field <cutSfxVolumeMultiplier>k__BackingField, offset 0x60, size 0x4
  ...
  /// @brief Field <flipLineIndex>k__BackingField, offset 0x54, size 0x4
  ...
  /// @brief Field <flipYSide>k__BackingField, offset 0x58, size 0x4
  ...
  /// @brief Field <gameplayType>k__BackingField, offset 0x30, size 0x4
  ...
  /// @brief Field <isArcHead>k__BackingField, offset 0x64, size 0x1
  ...
  /// @brief Field <isArcTail>k__BackingField, offset 0x65, size 0x1
  ...
  /// @brief Field <lineIndex>k__BackingField, offset 0x48, size 0x4
  ...
  /// @brief Field <noteLineLayer>k__BackingField, offset 0x4c, size 0x4
  ...
  /// @brief Field <scoringType>k__BackingField, offset 0x34, size 0x4
  ...
  /// @brief Field <timeToNextColorNote>k__BackingField, offset 0x40, size 0x4
  ...
  /// @brief Field <timeToPrevColorNote>k__BackingField, offset 0x44, size 0x4
  ...
  /// @brief Method ChangeNoteCutDirection, addr 0x325a364, size 0x8, virtual false, abstract: false, final false
  inline void ChangeNoteCutDirection(::GlobalNamespace::NoteCutDirection newCutDirection);

  /// @brief Method ChangeToBurstSliderHead, addr 0x325a17c, size 0x3c, virtual false, abstract: false, final false
  inline void ChangeToBurstSliderHead();

  /// @brief Method ChangeToGameNote, addr 0x325a1b8, size 0x10, virtual false, abstract: false, final false
  inline void ChangeToGameNote();

  /// @brief Method CopyWith, addr 0x3259e08, size 0x36c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateBasicNoteData, addr 0x3259c6c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateBombNoteData, addr 0x3259bbc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateBurstSliderNoteData, addr 0x3259d30, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCopy, addr 0x3259a50, size 0xc8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetCutDirectionAngleOffsetForSlider, addr 0x325a2b8, size 0x1c, virtual false, abstract: false, final false
  inline float_t GetCutDirectionAngleOffsetForSlider();

  /// @brief Method MarkAsSliderHead, addr 0x325a1c8, size 0x40, virtual false, abstract: false, final false
  inline void MarkAsSliderHead();

  /// @brief Method MarkAsSliderTail, addr 0x325a208, size 0x44, virtual false, abstract: false, final false
  inline void MarkAsSliderTail();

  /// @brief Method Mirror, addr 0x325a2e0, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method ResetNoteFlip, addr 0x325a2d4, size 0xc, virtual false, abstract: false, final false
  inline void ResetNoteFlip();

  /// @brief Method SetBeforeJumpNoteLineLayer, addr 0x325a174, size 0x8, virtual false, abstract: false, final false
  inline void SetBeforeJumpNoteLineLayer(::GlobalNamespace::NoteLineLayer lineLayer);

  /// @brief Method SetCutDirectionAngleOffset, addr 0x325a2b0, size 0x8, virtual false, abstract: false, final false
  inline void SetCutDirectionAngleOffset(float_t cutDirectionAngleOffset);

  /// @brief Method SetNoteFlipToNote, addr 0x325a24c, size 0x64, virtual false, abstract: false, final false
  inline void SetNoteFlipToNote(::GlobalNamespace::NoteData* targetNote);

  /// @brief Method SetNoteToAnyCutDirection, addr 0x325a358, size 0xc, virtual false, abstract: false, final false
  inline void SetNoteToAnyCutDirection();

  /// @brief Method SubtypeIdentifier, addr 0x3259bb8, size 0x4, virtual false, abstract: false, final false
  static inline int32_t SubtypeIdentifier(::GlobalNamespace::ColorType colorType);

  /// @brief Method TransformNoteAOrBToRandomType, addr 0x325a36c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3259b18, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beforeJumpNoteLineLayer, addr 0x32599e0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteLineLayer get_beforeJumpNoteLineLayer();

  /// @brief Method get_colorType, addr 0x3259980, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorType get_colorType();

  /// @brief Method get_cutDirection, addr 0x3259990, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteCutDirection get_cutDirection();

  /// @brief Method get_cutDirectionAngleOffset, addr 0x3259a10, size 0x8, virtual false, abstract: false, final false
  inline float_t get_cutDirectionAngleOffset();

  /// @brief Method get_cutSfxVolumeMultiplier, addr 0x3259a20, size 0x8, virtual false, abstract: false, final false
  inline float_t get_cutSfxVolumeMultiplier();

  /// @brief Method get_flipLineIndex, addr 0x32599f0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_flipLineIndex();

  /// @brief Method get_flipYSide, addr 0x3259a00, size 0x8, virtual false, abstract: false, final false
  inline float_t get_flipYSide();

  /// @brief Method get_gameplayType, addr 0x3259960, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteData_GameplayType get_gameplayType();

  /// @brief Method get_isArcHead, addr 0x3259a30, size 0x8, virtual false, abstract: false, final false
  inline bool get_isArcHead();

  /// @brief Method get_isArcTail, addr 0x3259a40, size 0x8, virtual false, abstract: false, final false
  inline bool get_isArcTail();

  /// @brief Method get_lineIndex, addr 0x32599c0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_lineIndex();

  /// @brief Method get_noteLineLayer, addr 0x32599d0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteLineLayer get_noteLineLayer();

  /// @brief Method get_scoringType, addr 0x3259970, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteData_ScoringType get_scoringType();

  /// @brief Method get_subtypeGroupIdentifier, addr 0x3259958, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_subtypeGroupIdentifier();

  /// @brief Method get_timeToNextColorNote, addr 0x32599a0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_timeToNextColorNote();

  /// @brief Method get_timeToPrevColorNote, addr 0x32599b0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_timeToPrevColorNote();

  /// @brief Method set_beforeJumpNoteLineLayer, addr 0x32599e8, size 0x8, virtual false, abstract: false, final false
  inline void set_beforeJumpNoteLineLayer(::GlobalNamespace::NoteLineLayer value);

  /// @brief Method set_colorType, addr 0x3259988, size 0x8, virtual false, abstract: false, final false
  inline void set_colorType(::GlobalNamespace::ColorType value);

  /// @brief Method set_cutDirection, addr 0x3259998, size 0x8, virtual false, abstract: false, final false
  inline void set_cutDirection(::GlobalNamespace::NoteCutDirection value);

  /// @brief Method set_cutDirectionAngleOffset, addr 0x3259a18, size 0x8, virtual false, abstract: false, final false
  inline void set_cutDirectionAngleOffset(float_t value);

  /// @brief Method set_cutSfxVolumeMultiplier, addr 0x3259a28, size 0x8, virtual false, abstract: false, final false
  inline void set_cutSfxVolumeMultiplier(float_t value);

  /// @brief Method set_flipLineIndex, addr 0x32599f8, size 0x8, virtual false, abstract: false, final false
  inline void set_flipLineIndex(int32_t value);

  /// @brief Method set_flipYSide, addr 0x3259a08, size 0x8, virtual false, abstract: false, final false
  inline void set_flipYSide(float_t value);

  /// @brief Method set_gameplayType, addr 0x3259968, size 0x8, virtual false, abstract: false, final false
  inline void set_gameplayType(::GlobalNamespace::NoteData_GameplayType value);

  /// @brief Method set_isArcHead, addr 0x3259a38, size 0x8, virtual false, abstract: false, final false
  inline void set_isArcHead(bool value);

  /// @brief Method set_isArcTail, addr 0x3259a48, size 0x8, virtual false, abstract: false, final false
  inline void set_isArcTail(bool value);

  /// @brief Method set_lineIndex, addr 0x32599c8, size 0x8, virtual false, abstract: false, final false
  inline void set_lineIndex(int32_t value);

  /// @brief Method set_noteLineLayer, addr 0x32599d8, size 0x8, virtual false, abstract: false, final false
  inline void set_noteLineLayer(::GlobalNamespace::NoteLineLayer value);

  /// @brief Method set_scoringType, addr 0x3259978, size 0x8, virtual false, abstract: false, final false
  inline void set_scoringType(::GlobalNamespace::NoteData_ScoringType value);

  /// @brief Method set_timeToNextColorNote, addr 0x32599a8, size 0x8, virtual false, abstract: false, final false
  inline void set_timeToNextColorNote(float_t value);

  /// @brief Method set_timeToPrevColorNote, addr 0x32599b8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field <gameplayType>k__BackingField, offset: 0x30, size: 0x4, def value: None
  ::GlobalNamespace::NoteData_GameplayType ____gameplayType_k__BackingField;

  /// @brief Field <scoringType>k__BackingField, offset: 0x34, size: 0x4, def value: None
  ::GlobalNamespace::NoteData_ScoringType ____scoringType_k__BackingField;

  /// @brief Field <colorType>k__BackingField, offset: 0x38, size: 0x4, def value: None
  ::GlobalNamespace::ColorType ____colorType_k__BackingField;

  /// @brief Field <cutDirection>k__BackingField, offset: 0x3c, size: 0x4, def value: None
  ::GlobalNamespace::NoteCutDirection ____cutDirection_k__BackingField;

  /// @brief Field <timeToNextColorNote>k__BackingField, offset: 0x40, size: 0x4, def value: None
  float_t ____timeToNextColorNote_k__BackingField;

  /// @brief Field <timeToPrevColorNote>k__BackingField, offset: 0x44, size: 0x4, def value: None
  float_t ____timeToPrevColorNote_k__BackingField;

  /// @brief Field <lineIndex>k__BackingField, offset: 0x48, size: 0x4, def value: None
  int32_t ____lineIndex_k__BackingField;

  /// @brief Field <noteLineLayer>k__BackingField, offset: 0x4c, size: 0x4, def value: None
  ::GlobalNamespace::NoteLineLayer ____noteLineLayer_k__BackingField;

  /// @brief Field <beforeJumpNoteLineLayer>k__BackingField, offset: 0x50, size: 0x4, def value: None
  ::GlobalNamespace::NoteLineLayer ____beforeJumpNoteLineLayer_k__BackingField;

  /// @brief Field <flipLineIndex>k__BackingField, offset: 0x54, size: 0x4, def value: None
  int32_t ____flipLineIndex_k__BackingField;

  /// @brief Field <flipYSide>k__BackingField, offset: 0x58, size: 0x4, def value: None
  float_t ____flipYSide_k__BackingField;

  /// @brief Field <cutDirectionAngleOffset>k__BackingField, offset: 0x5c, size: 0x4, def value: None
  float_t ____cutDirectionAngleOffset_k__BackingField;

  /// @brief Field <cutSfxVolumeMultiplier>k__BackingField, offset: 0x60, size: 0x4, def value: None
  float_t ____cutSfxVolumeMultiplier_k__BackingField;

  /// @brief Field <isArcHead>k__BackingField, offset: 0x64, size: 0x1, def value: None
  bool ____isArcHead_k__BackingField;

  /// @brief Field <isArcTail>k__BackingField, offset: 0x65, size: 0x1, def value: None
  bool ____isArcTail_k__BackingField;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::NoteData, ____gameplayType_k__BackingField) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteData, ____scoringType_k__BackingField) == 0x34, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteData, ____colorType_k__BackingField) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteData, ____cutDirection_k__BackingField) == 0x3c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteData, ____timeToNextColorNote_k__BackingField) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteData, ____timeToPrevColorNote_k__BackingField) == 0x44, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteData, ____lineIndex_k__BackingField) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteData, ____noteLineLayer_k__BackingField) == 0x4c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteData, ____beforeJumpNoteLineLayer_k__BackingField) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteData, ____flipLineIndex_k__BackingField) == 0x54, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteData, ____flipYSide_k__BackingField) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteData, ____cutDirectionAngleOffset_k__BackingField) == 0x5c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteData, ____cutSfxVolumeMultiplier_k__BackingField) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteData, ____isArcHead_k__BackingField) == 0x64, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteData, ____isArcTail_k__BackingField) == 0x65, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::NoteData) == 0x68, "Size mismatch!");
