...
public:
  ...
  /// @brief Method ChangeNoteCutDirection, addr 0x31c990c, size 0x8, virtual false, abstract: false, final false
  inline void ChangeNoteCutDirection(::GlobalNamespace::NoteCutDirection newCutDirection);

  /// @brief Method ChangeToBurstSliderHead, addr 0x31c9724, size 0x3c, virtual false, abstract: false, final false
  inline void ChangeToBurstSliderHead();

  /// @brief Method ChangeToGameNote, addr 0x31c9760, size 0x10, virtual false, abstract: false, final false
  inline void ChangeToGameNote();

  /// @brief Method CopyWith, addr 0x31c93bc, size 0x360, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateBasicNoteData, addr 0x31c9228, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateBombNoteData, addr 0x31c9178, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateBurstSliderNoteData, addr 0x31c92e8, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCopy, addr 0x31c9068, size 0xc8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetCutDirectionAngleOffsetForSlider, addr 0x31c9860, size 0x1c, virtual false, abstract: false, final false
  inline float_t GetCutDirectionAngleOffsetForSlider();

  /// @brief Method MarkAsSliderHead, addr 0x31c9770, size 0x40, virtual false, abstract: false, final false
  inline void MarkAsSliderHead();

  /// @brief Method MarkAsSliderTail, addr 0x31c97b0, size 0x44, virtual false, abstract: false, final false
  inline void MarkAsSliderTail();

  /// @brief Method Mirror, addr 0x31c9888, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method ResetNoteFlip, addr 0x31c987c, size 0xc, virtual false, abstract: false, final false
  inline void ResetNoteFlip();

  /// @brief Method SetBeforeJumpNoteLineLayer, addr 0x31c971c, size 0x8, virtual false, abstract: false, final false
  inline void SetBeforeJumpNoteLineLayer(::GlobalNamespace::NoteLineLayer lineLayer);

  /// @brief Method SetCutDirectionAngleOffset, addr 0x31c9858, size 0x8, virtual false, abstract: false, final false
  inline void SetCutDirectionAngleOffset(float_t cutDirectionAngleOffset);

  /// @brief Method SetNoteFlipToNote, addr 0x31c97f4, size 0x64, virtual false, abstract: false, final false
  inline void SetNoteFlipToNote(::GlobalNamespace::NoteData* targetNote);

  /// @brief Method SetNoteToAnyCutDirection, addr 0x31c9900, size 0xc, virtual false, abstract: false, final false
  inline void SetNoteToAnyCutDirection();

  /// @brief Method SubtypeIdentifier, addr 0x31c9174, size 0x4, virtual false, abstract: false, final false
  static inline int32_t SubtypeIdentifier(::GlobalNamespace::ColorType colorType);

  /// @brief Method TransformNoteAOrBToRandomType, addr 0x31c9914, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31c9130, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beforeJumpNoteLineLayer, addr 0x31c8ff8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteLineLayer get_beforeJumpNoteLineLayer();

  /// @brief Method get_colorType, addr 0x31c8f98, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorType get_colorType();

  /// @brief Method get_cutDirection, addr 0x31c8fa8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteCutDirection get_cutDirection();

  /// @brief Method get_cutDirectionAngleOffset, addr 0x31c9028, size 0x8, virtual false, abstract: false, final false
  inline float_t get_cutDirectionAngleOffset();

  /// @brief Method get_cutSfxVolumeMultiplier, addr 0x31c9038, size 0x8, virtual false, abstract: false, final false
  inline float_t get_cutSfxVolumeMultiplier();

  /// @brief Method get_flipLineIndex, addr 0x31c9008, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_flipLineIndex();

  /// @brief Method get_flipYSide, addr 0x31c9018, size 0x8, virtual false, abstract: false, final false
  inline float_t get_flipYSide();

  /// @brief Method get_gameplayType, addr 0x31c8f78, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteData_GameplayType get_gameplayType();

  /// @brief Method get_isArcHead, addr 0x31c9048, size 0x8, virtual false, abstract: false, final false
  inline bool get_isArcHead();

  /// @brief Method get_isArcTail, addr 0x31c9058, size 0x8, virtual false, abstract: false, final false
  inline bool get_isArcTail();

  /// @brief Method get_lineIndex, addr 0x31c8fd8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_lineIndex();

  /// @brief Method get_noteLineLayer, addr 0x31c8fe8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteLineLayer get_noteLineLayer();

  /// @brief Method get_scoringType, addr 0x31c8f88, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteData_ScoringType get_scoringType();

  /// @brief Method get_subtypeGroupIdentifier, addr 0x31c8f70, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_subtypeGroupIdentifier();

  /// @brief Method get_timeToNextColorNote, addr 0x31c8fb8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_timeToNextColorNote();

  /// @brief Method get_timeToPrevColorNote, addr 0x31c8fc8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_timeToPrevColorNote();

  /// @brief Method set_beforeJumpNoteLineLayer, addr 0x31c9000, size 0x8, virtual false, abstract: false, final false
  inline void set_beforeJumpNoteLineLayer(::GlobalNamespace::NoteLineLayer value);

  /// @brief Method set_colorType, addr 0x31c8fa0, size 0x8, virtual false, abstract: false, final false
  inline void set_colorType(::GlobalNamespace::ColorType value);

  /// @brief Method set_cutDirection, addr 0x31c8fb0, size 0x8, virtual false, abstract: false, final false
  inline void set_cutDirection(::GlobalNamespace::NoteCutDirection value);

  /// @brief Method set_cutDirectionAngleOffset, addr 0x31c9030, size 0x8, virtual false, abstract: false, final false
  inline void set_cutDirectionAngleOffset(float_t value);

  /// @brief Method set_cutSfxVolumeMultiplier, addr 0x31c9040, size 0x8, virtual false, abstract: false, final false
  inline void set_cutSfxVolumeMultiplier(float_t value);

  /// @brief Method set_flipLineIndex, addr 0x31c9010, size 0x8, virtual false, abstract: false, final false
  inline void set_flipLineIndex(int32_t value);

  /// @brief Method set_flipYSide, addr 0x31c9020, size 0x8, virtual false, abstract: false, final false
  inline void set_flipYSide(float_t value);

  /// @brief Method set_gameplayType, addr 0x31c8f80, size 0x8, virtual false, abstract: false, final false
  inline void set_gameplayType(::GlobalNamespace::NoteData_GameplayType value);

  /// @brief Method set_isArcHead, addr 0x31c9050, size 0x8, virtual false, abstract: false, final false
  inline void set_isArcHead(bool value);

  /// @brief Method set_isArcTail, addr 0x31c9060, size 0x8, virtual false, abstract: false, final false
  inline void set_isArcTail(bool value);

  /// @brief Method set_lineIndex, addr 0x31c8fe0, size 0x8, virtual false, abstract: false, final false
  inline void set_lineIndex(int32_t value);

  /// @brief Method set_noteLineLayer, addr 0x31c8ff0, size 0x8, virtual false, abstract: false, final false
  inline void set_noteLineLayer(::GlobalNamespace::NoteLineLayer value);

  /// @brief Method set_scoringType, addr 0x31c8f90, size 0x8, virtual false, abstract: false, final false
  inline void set_scoringType(::GlobalNamespace::NoteData_ScoringType value);

  /// @brief Method set_timeToNextColorNote, addr 0x31c8fc0, size 0x8, virtual false, abstract: false, final false
  inline void set_timeToNextColorNote(float_t value);

  /// @brief Method set_timeToPrevColorNote, addr 0x31c8fd0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NoteData) == 0x60, "Size mismatch!");
