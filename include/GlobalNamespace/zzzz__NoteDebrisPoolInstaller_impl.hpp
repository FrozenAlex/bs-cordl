...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::NoteDebrisPoolInstaller::*)()>(&::GlobalNamespace::NoteDebrisPoolInstaller::InstallBindings)> {
  ...
  constexpr static std::size_t addrs = 0x58c7b84;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::GlobalNamespace::NoteDebrisPoolInstaller*>(), { ::i2c::class_of<::GlobalNamespace::NoteDebrisPoolInstaller*>(), 6 }));
    return ___internal_method;
  }
};
//  Writing Method size for method: ::GlobalNamespace::NoteDebrisPoolInstaller._ctor
template <>
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::NoteDebrisPoolInstaller::*)()>(&::GlobalNamespace::NoteDebrisPoolInstaller::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x58c7d8c;
...
constexpr void GlobalNamespace::NoteDebrisPoolInstaller::__cordl_internal_set__normalNoteDebrisHDPrefab(::UnityW<::GlobalNamespace::NoteDebris> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____normalNoteDebrisHDPrefab = value;
}
...
constexpr void GlobalNamespace::NoteDebrisPoolInstaller::__cordl_internal_set__normalNoteDebrisLWPrefab(::UnityW<::GlobalNamespace::NoteDebris> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____normalNoteDebrisLWPrefab = value;
}
...
constexpr void GlobalNamespace::NoteDebrisPoolInstaller::__cordl_internal_set__burstSliderHeadNoteDebrisHDPrefab(::UnityW<::GlobalNamespace::NoteDebris> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____burstSliderHeadNoteDebrisHDPrefab = value;
}
...
constexpr void GlobalNamespace::NoteDebrisPoolInstaller::__cordl_internal_set__burstSliderHeadNoteDebrisLWPrefab(::UnityW<::GlobalNamespace::NoteDebris> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____burstSliderHeadNoteDebrisLWPrefab = value;
}
...
constexpr void GlobalNamespace::NoteDebrisPoolInstaller::__cordl_internal_set__burstSliderElementNoteHDPrefab(::UnityW<::GlobalNamespace::NoteDebris> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____burstSliderElementNoteHDPrefab = value;
}
...
constexpr void GlobalNamespace::NoteDebrisPoolInstaller::__cordl_internal_set__burstSliderElementNoteLWPrefab(::UnityW<::GlobalNamespace::NoteDebris> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____burstSliderElementNoteLWPrefab = value;
}
...
constexpr void GlobalNamespace::NoteDebrisPoolInstaller::__cordl_internal_set__noteDebrisHDConditionVariable(::UnityW<::GlobalNamespace::BoolSO> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____noteDebrisHDConditionVariable = value;
}
inline void GlobalNamespace::NoteDebrisPoolInstaller::InstallBindings() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::NoteDebrisPoolInstaller*>(), 6 })));
...
inline ::GlobalNamespace::NoteDebrisPoolInstaller* GlobalNamespace::NoteDebrisPoolInstaller::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::NoteDebrisPoolInstaller*>());
}
// Ctor Parameters []
constexpr ::GlobalNamespace::NoteDebrisPoolInstaller::NoteDebrisPoolInstaller() {}
