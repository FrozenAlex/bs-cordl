...
public:
  ...
  /// @brief Method Awake, addr 0x579a4a8, size 0x48, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method FixedUpdate, addr 0x579a4f0, size 0x138, virtual false, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method Init, addr 0x579a7b4, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x579a8fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::NoteDebrisRigidbodyPhysics) == 0x38, "Size mismatch!");
