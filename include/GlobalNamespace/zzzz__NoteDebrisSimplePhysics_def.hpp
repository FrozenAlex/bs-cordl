...
// Write type traits
MARK_REF_T(::GlobalNamespace::NoteDebrisSimplePhysics*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteDebrisSimplePhysics*, "", "NoteDebrisSimplePhysics");
...
static_assert(sizeof(::GlobalNamespace::NoteDebrisSimplePhysics) == 0x70, "Size mismatch!");
