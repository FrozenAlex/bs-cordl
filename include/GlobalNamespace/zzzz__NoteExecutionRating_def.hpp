...
MARK_REF_T(::GlobalNamespace::NoteExecutionRating*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteExecutionRating_Rating, "", "NoteExecutionRating/Rating");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteExecutionRating*, "", "NoteExecutionRating");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::NoteExecutionRating_Rating) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x367f528, size 0x14, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NoteExecutionRating) == 0x30, "Size mismatch!");
