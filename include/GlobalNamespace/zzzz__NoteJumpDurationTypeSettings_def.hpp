...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteJumpDurationTypeSettings, "", "NoteJumpDurationTypeSettings");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::NoteJumpDurationTypeSettings) == 0x4, "Size mismatch!");
