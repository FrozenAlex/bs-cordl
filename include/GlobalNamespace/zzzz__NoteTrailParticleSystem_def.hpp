...
// Write type traits
MARK_REF_T(::GlobalNamespace::NoteTrailParticleSystem*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteTrailParticleSystem*, "", "NoteTrailParticleSystem");
...
public:
  ...
  /// @brief Method Awake, addr 0x584b9a0, size 0x10, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Emit, addr 0x584b9b0, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x584bab4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::NoteTrailParticleSystem) == 0xb8, "Size mismatch!");
