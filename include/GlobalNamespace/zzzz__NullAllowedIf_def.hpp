...
// Write type traits
MARK_REF_T(::GlobalNamespace::NullAllowedIf*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NullAllowedIf*, "", "NullAllowedIf");
...
static_assert(sizeof(::GlobalNamespace::NullAllowedIf) == 0x38, "Size mismatch!");
