...
MARK_REF_T(::GlobalNamespace::NullAllowed*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NullAllowed_Context, "", "NullAllowed/Context");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NullAllowed*, "", "NullAllowed");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::NullAllowed_Context) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::NullAllowed) == 0x20, "Size mismatch!");
