...
public:
  ...
  /// @brief Method Start, addr 0x5eed4d4, size 0x118, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method .ctor, addr 0x5eed5ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
