...
// Write type traits
MARK_REF_T(::GlobalNamespace::OVRAutoDestroyInMRC*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRAutoDestroyInMRC*, "", "OVRAutoDestroyInMRC");
...
public:
  ...
  /// @brief Method Start, addr 0x5db7540, size 0x118, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method .ctor, addr 0x5db7658, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::OVRAutoDestroyInMRC) == 0x20, "Size mismatch!");
