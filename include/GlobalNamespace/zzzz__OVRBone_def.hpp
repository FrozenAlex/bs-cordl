...
// Write type traits
MARK_REF_T(::GlobalNamespace::OVRBone*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRBone*, "", "OVRBone");
...
public:
  ...
  /// @brief Method Dispose, addr 0x5dd54cc, size 0xa8, virtual true, abstract: false, final true
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x5dd5574, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5dd794c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::OVRSkeleton_BoneId id, int16_t parentBoneIndex, ::UnityEngine::Transform* trans);

  /// @brief Method get_Id, addr 0x5dd791c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRSkeleton_BoneId get_Id();

  /// @brief Method get_ParentBoneIndex, addr 0x5dd792c, size 0x8, virtual false, abstract: false, final false
  inline int16_t get_ParentBoneIndex();

  /// @brief Method get_Transform, addr 0x5dd793c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_Transform();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_Id, addr 0x5dd7924, size 0x8, virtual false, abstract: false, final false
  inline void set_Id(::GlobalNamespace::OVRSkeleton_BoneId value);

  /// @brief Method set_ParentBoneIndex, addr 0x5dd7934, size 0x8, virtual false, abstract: false, final false
  inline void set_ParentBoneIndex(int16_t value);

  /// @brief Method set_Transform, addr 0x5dd7944, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::OVRBone) == 0x20, "Size mismatch!");
