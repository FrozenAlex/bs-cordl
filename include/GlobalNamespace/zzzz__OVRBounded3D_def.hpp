...
public:
  ...
  /// @brief Method ConvertBounds, addr 0x5cd9708, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::Bounds ConvertBounds(::GlobalNamespace::OVRPlugin_Boundsf openXrBounds);

  /// @brief Method Equals, addr 0x5cd93e0, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x5cd9290, size 0x6c, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::OVRBounded3D other);

  /// @brief Method GetHashCode, addr 0x5cd9470, size 0x6c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IOVRAnchorComponent<OVRBounded3D>.FromAnchor, addr 0x5cd9064, size 0x30, virtual true, abstract: false, final true
  inline ::GlobalNamespace::OVRBounded3D IOVRAnchorComponent_OVRBounded3D__FromAnchor(::GlobalNamespace::OVRAnchor anchor);

  /// @brief Method IOVRAnchorComponent<OVRBounded3D>.SetEnabledAsync, addr 0x5cd9244, size 0x4c, virtual true, abstract: false, final true
  inline ::GlobalNamespace::OVRTask_1<bool> IOVRAnchorComponent_OVRBounded3D__SetEnabledAsync(bool enabled, double_t timeout);

  /// @brief Method IOVRAnchorComponent<OVRBounded3D>.get_Handle, addr 0x5cd900c, size 0x58, virtual true, abstract: false, final true
  inline uint64_t IOVRAnchorComponent_OVRBounded3D__get_Handle();

  /// @brief Method IOVRAnchorComponent<OVRBounded3D>.get_Type, addr 0x5cd8fb0, size 0x54, virtual true, abstract: false, final true
  inline ::GlobalNamespace::OVRPlugin_SpaceComponentType IOVRAnchorComponent_OVRBounded3D__get_Type();

  /// @brief Method ToString, addr 0x5cd94dc, size 0xc0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x5cd9094, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::OVRAnchor anchor);

  static inline ::GlobalNamespace::OVRBounded3D getStaticF_Null();

  /// @brief Method get_BoundingBox, addr 0x5cd95a4, size 0x164, virtual false, abstract: false, final false
  inline ::UnityEngine::Bounds get_BoundingBox();

  /// @brief Method get_Handle, addr 0x5cd959c, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_Handle();

  /// @brief Method get_IsEnabled, addr 0x5cd915c, size 0xe8, virtual true, abstract: false, final true
  inline bool get_IsEnabled();

  /// @brief Method get_IsNull, addr 0x5cd90fc, size 0x60, virtual true, abstract: false, final true
  inline bool get_IsNull();

  /// @brief Method get_Type, addr 0x5cd9004, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x5cd92fc, size 0x70, virtual false, abstract: false, final false
  static inline bool op_Equality(::GlobalNamespace::OVRBounded3D lhs, ::GlobalNamespace::OVRBounded3D rhs);

  /// @brief Method op_Inequality, addr 0x5cd936c, size 0x74, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::OVRBounded3D) == 0x8, "Size mismatch!");
