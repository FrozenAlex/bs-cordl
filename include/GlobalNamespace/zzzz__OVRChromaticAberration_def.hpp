...
public:
  ...
  /// @brief Method Start, addr 0x5db765c, size 0xb0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5db770c, size 0x10c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5db7818, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::OVRChromaticAberration) == 0x28, "Size mismatch!");
