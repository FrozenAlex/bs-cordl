...
public:
  ...
  /// @brief Method ComputeCameraTrackingSpacePose, addr 0x5def4c8, size 0x2ac, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPose ComputeCameraTrackingSpacePose(::GlobalNamespace::OVRPlugin_CameraExtrinsics extrinsics);

  /// @brief Method ComputeCameraWorldSpacePose, addr 0x5def45c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method RecenterPose, addr 0x5def458, size 0x4, virtual true, abstract: false, final false
  inline void RecenterPose();

  /// @brief Method RefreshCameraRig, addr 0x5def284, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5def280, size 0x4, virtual false, abstract: false, final false
