...
// Write type traits
MARK_REF_T(::GlobalNamespace::OVRComposition*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRComposition*, "", "OVRComposition");
...
public:
  ...
  /// @brief Method ComputeCameraTrackingSpacePose, addr 0x5cb9534, size 0x2ac, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPose ComputeCameraTrackingSpacePose(::GlobalNamespace::OVRPlugin_CameraExtrinsics extrinsics);

  /// @brief Method ComputeCameraWorldSpacePose, addr 0x5cb94c8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method RecenterPose, addr 0x5cb94c4, size 0x4, virtual true, abstract: false, final false
  inline void RecenterPose();

  /// @brief Method RefreshCameraRig, addr 0x5cb92f0, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5cb92ec, size 0x4, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::OVRComposition) == 0x40, "Size mismatch!");
