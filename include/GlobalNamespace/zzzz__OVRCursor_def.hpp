...
// Write type traits
MARK_REF_T(::GlobalNamespace::OVRCursor*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRCursor*, "", "OVRCursor");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dbdd44, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::OVRCursor) == 0x20, "Size mismatch!");
