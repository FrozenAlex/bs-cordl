...
public:
  ...
  /// @brief Field GamePad_YawDegreesPerSec, offset 0x28, size 0x4
  ...
  /// @brief Field InvertPitch, offset 0x22, size 0x1
  ...
  /// @brief Method Awake, addr 0x5e1a338, size 0x10c, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::OVRDebugHeadController* New_ctor();

  /// @brief Method Start, addr 0x5e1a444, size 0x4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5e1a448, size 0x5a8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5e1a9f0, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::OVRDebugHeadController, ___InvertPitch) == 0x22, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRDebugHeadController, ___GamePad_PitchDegreesPerSec) == 0x24, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRDebugHeadController, ___GamePad_YawDegreesPerSec) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRDebugHeadController, ___AllowMovement) == 0x2c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRDebugHeadController, ___ForwardSpeed) == 0x30, "Offset mismatch!");
...
static_assert(sizeof(::GlobalNamespace::OVRDebugHeadController) == 0x40, "Size mismatch!");
