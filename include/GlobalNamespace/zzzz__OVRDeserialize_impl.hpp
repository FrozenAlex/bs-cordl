...
template <typename T> inline T GlobalNamespace::OVRDeserialize::ByteArrayToStructure(::ArrayW<uint8_t> bytes) {
  static auto* ___internal_method_base = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::OVRDeserialize*>(), { "ByteArrayToStructure", { ::i2c::class_of<T>() }, { ::i2c::type_of<::ArrayW<uint8_t>>() } })));
