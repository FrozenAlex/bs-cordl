...
public:
  ...
  /// @brief Method MoveNext, addr 0x5db6bdc, size 0x274, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5db6e50, size 0x3c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method When, addr 0x5db6840, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method <When>g__CheckCancellationAndThrow|0_1, addr 0x5db6a10, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method <When>g__LogIfNotSuccess|0_0, addr 0x5db6904, size 0x10c, virtual false, abstract: false, final false
