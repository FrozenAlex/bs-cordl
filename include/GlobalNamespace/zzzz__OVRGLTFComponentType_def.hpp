...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRGLTFComponentType, "", "OVRGLTFComponentType");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::OVRGLTFComponentType) == 0x4, "Size mismatch!");
