...
static_assert(offsetof(::GlobalNamespace::OVRGazePointer, ___hideByDefault) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRGazePointer, ___showTimeoutPeriod) == 0x2c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRGazePointer, ___hideTimeoutPeriod) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRGazePointer, ___dimOnHideRequest) == 0x34, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRGazePointer, ___depthScaleMultiplier) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRGazePointer, ___matchNormalOnPhysicsColliders) == 0x3c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRGazePointer, ___rayTransform) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRGazePointer, ____hidden_k__BackingField) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRGazePointer, ____currentScale_k__BackingField) == 0x4c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRGazePointer, ___depth) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRGazePointer, ___hideUntilTime) == 0x54, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRGazePointer, ___positionSetsThisFrame) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRGazePointer, ___lastShowRequestTime) == 0x5c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRGazePointer, ___lastHideRequestTime) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRGazePointer, ___progressIndicator) == 0x68, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::OVRGazePointer) == 0x70, "Size mismatch!");
