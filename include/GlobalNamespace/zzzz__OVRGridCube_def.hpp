...
public:
  ...
  /// @brief Method CreateCubeGrid, addr 0x5dc3728, size 0x3a0, virtual false, abstract: false, final false
  inline void CreateCubeGrid();

  /// @brief Method CubeGridSwitchColor, addr 0x5dc3ac8, size 0x17c, virtual false, abstract: false, final false
  inline void CubeGridSwitchColor(bool CubeSwitchColor);

  static inline ::GlobalNamespace::OVRGridCube* New_ctor();

  /// @brief Method SetOVRCameraController, addr 0x5dc371c, size 0xc, virtual false, abstract: false, final false
  inline void SetOVRCameraController(::by_ref<::GlobalNamespace::OVRCameraRig*> cameraController);

  /// @brief Method Update, addr 0x5dc34b8, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateCubeGrid, addr 0x5dc34bc, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dc3c44, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::OVRGridCube) == 0x50, "Size mismatch!");
