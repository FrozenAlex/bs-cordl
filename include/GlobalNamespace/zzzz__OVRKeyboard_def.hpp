...
// Write type traits
MARK_REF_T(::GlobalNamespace::OVRKeyboard*);
MARK_VAL_T(::GlobalNamespace::OVRKeyboard_TrackedKeyboardInfo);
MARK_VAL_T(::GlobalNamespace::OVRKeyboard_TrackedKeyboardState);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRKeyboard*, "", "OVRKeyboard");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRKeyboard_TrackedKeyboardInfo, "", "OVRKeyboard/TrackedKeyboardInfo");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRKeyboard_TrackedKeyboardState, "", "OVRKeyboard/TrackedKeyboardState");
...
static_assert(sizeof(::GlobalNamespace::OVRKeyboard_TrackedKeyboardState) == 0x28, "Size mismatch!");
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::OVRKeyboard) == 0x10, "Size mismatch!");
