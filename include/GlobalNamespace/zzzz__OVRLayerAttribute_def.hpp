...
// Write type traits
MARK_REF_T(::GlobalNamespace::OVRLayerAttribute*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRLayerAttribute*, "", "OVRLayerAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5d28548, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::OVRLayerAttribute) == 0x18, "Size mismatch!");
