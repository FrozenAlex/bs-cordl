...
public:
  // Declarations
  /// @brief Method ApplyTo, addr 0x5dc8278, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadFrom, addr 0x5dc827c, size 0x142c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::OVRMixedRealityCaptureConfigurationExtensions) == 0x10, "Size mismatch!");
