...
// Write type traits
MARK_REF_T(::GlobalNamespace::OVRMixedRealityCaptureConfiguration*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRMixedRealityCaptureConfiguration*, "", "OVRMixedRealityCaptureConfiguration");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
