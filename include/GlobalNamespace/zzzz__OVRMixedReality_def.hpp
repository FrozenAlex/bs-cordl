...
public:
  ...
  /// @brief Method Cleanup, addr 0x5e6db14, size 0xf0, virtual false, abstract: false, final false
  static inline void Cleanup();

  /// @brief Method RecenterPose, addr 0x5e6f248, size 0x98, virtual false, abstract: false, final false
  static inline void RecenterPose();

  /// @brief Method Update, addr 0x5e6d618, size 0x4fc, virtual false, abstract: false, final false
