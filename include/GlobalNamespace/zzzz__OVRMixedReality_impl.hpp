...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (*)(::UnityEngine::GameObject*, ::UnityEngine::Camera*, ::GlobalNamespace::OVRMixedRealityCaptureConfiguration*,
  ...
  constexpr static std::size_t addrs = 0x5d37684;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::OVRMixedReality*>(),
                                                { "Update",
                                                  {},
                                                  { ::i2c::type_of<::UnityEngine::GameObject*>(), ::i2c::type_of<::UnityEngine::Camera*>(),
                                                    ::i2c::type_of<::GlobalNamespace::OVRMixedRealityCaptureConfiguration*>(), ::i2c::type_of<::GlobalNamespace::OVRManager_TrackingOrigin>() } })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (*)()>(&::GlobalNamespace::OVRMixedReality::Cleanup)> {
  ...
  constexpr static std::size_t addrs = 0x5d37b80;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (*)()>(&::GlobalNamespace::OVRMixedReality::RecenterPose)> {
  ...
  constexpr static std::size_t addrs = 0x5d392b4;
