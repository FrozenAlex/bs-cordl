...
MARK_REF_T(::GlobalNamespace::OVROverlayMeshGenerator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVROverlayMeshGenerator_CubeFace, "", "OVROverlayMeshGenerator/CubeFace");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVROverlayMeshGenerator*, "", "OVROverlayMeshGenerator");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
public:
  ...
  /// @brief Method BuildCube, addr 0x5d610c0, size 0x83c, virtual false, abstract: false, final false
  static inline void BuildCube(::System::Collections::Generic::List_1<::UnityEngine::Vector3>* verts, ::System::Collections::Generic::List_1<::UnityEngine::Vector2>* uv,
                               ::System::Collections::Generic::List_1<::UnityEngine::Vector4>* cubeUV, ::System::Collections::Generic::List_1<int32_t>* triangles, ::UnityEngine::Vector3 position,
                               ::UnityEngine::Quaternion rotation, ::UnityEngine::Vector3 scale, float_t worldScale, int32_t subQuads, float_t expandCoefficient);

  /// @brief Method BuildHemicylinder, addr 0x5d61f40, size 0x5cc, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildQuad, addr 0x5d618fc, size 0x644, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildSphere, addr 0x5d609f0, size 0x6d0, virtual false, abstract: false, final false
  static inline void BuildSphere(::System::Collections::Generic::List_1<::UnityEngine::Vector3>* verts, ::System::Collections::Generic::List_1<::UnityEngine::Vector2>* uv,
                                 ...
                                 ::UnityEngine::Rect rect, float_t worldScale, int32_t latitudes, int32_t longitudes, float_t expandCoefficient);

  /// @brief Method GenerateMesh, addr 0x5d608f0, size 0x100, virtual false, abstract: false, final false
  static inline void GenerateMesh(::System::Collections::Generic::List_1<::UnityEngine::Vector3>* verts, ::System::Collections::Generic::List_1<::UnityEngine::Vector2>* uvs,
                                  ...
                                  ::GlobalNamespace::OVROverlay_OverlayShape shape, ::UnityEngine::Vector3 position, ::UnityEngine::Quaternion rotation, ::UnityEngine::Vector3 scale,
                                  ::UnityEngine::Rect rect);

  /// @brief Method GetCubeUV, addr 0x5d625d4, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCubeVert, addr 0x5d626b8, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSphereUV, addr 0x5d62548, size 0x38, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 GetSphereUV(float_t theta, float_t phi, float_t expandScale);

  /// @brief Method GetSphereVert, addr 0x5d62580, size 0x54, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetSphereVert(float_t theta, float_t phi);

  /// @brief Method Initialize, addr 0x5d5fc94, size 0x168, virtual false, abstract: false, final false
  inline void Initialize();

  /// @brief Method InverseTransformVert, addr 0x5d6250c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5d5fdfc, size 0x1a4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEnable, addr 0x5d5fc90, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method SetOverlay, addr 0x5d606e4, size 0x8, virtual false, abstract: false, final false
  inline void SetOverlay(::GlobalNamespace::OVROverlay* overlay);

  /// @brief Method TryUpdateMesh, addr 0x5d5ffa0, size 0x744, virtual false, abstract: false, final false
  inline void TryUpdateMesh();

  /// @brief Method UpdateMesh, addr 0x5d606ec, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d627b8, size 0x158, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::OVROverlayMeshGenerator) == 0xd0, "Size mismatch!");
