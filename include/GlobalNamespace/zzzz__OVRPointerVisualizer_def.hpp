...
// Write type traits
MARK_REF_T(::GlobalNamespace::OVRPointerVisualizer*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRPointerVisualizer*, "", "OVRPointerVisualizer");
...
public:
  ...
  /// @brief Method Update, addr 0x5d84a08, size 0x20c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5d84c14, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::OVRPointerVisualizer) == 0x38, "Size mismatch!");
