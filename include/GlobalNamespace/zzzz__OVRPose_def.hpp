...
public:
  // Declarations
  /// @brief Method Equals, addr 0x5e19964, size 0xe0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x5e19ac4, size 0xc8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Inverse, addr 0x5e0c6d4, size 0x84, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPose Inverse();

  /// @brief Method Rotate180AlongX, addr 0x5e19c80, size 0x10c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPose Rotate180AlongX();

  /// @brief Method ToPosef, addr 0x5e19c54, size 0x2c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPlugin_Posef ToPosef();

  /// @brief Method ToPosef_Legacy, addr 0x5e19c38, size 0x1c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPlugin_Posef ToPosef_Legacy();

  /// @brief Method flipZ, addr 0x5e19c0c, size 0x2c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPose flipZ();

  /// @brief Method get_identity, addr 0x5e0c154, size 0xa0, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRPose get_identity();

  /// @brief Method op_Equality, addr 0x5e19a44, size 0x80, virtual false, abstract: false, final false
  static inline bool op_Equality(::GlobalNamespace::OVRPose x, ::GlobalNamespace::OVRPose y);

  /// @brief Method op_Inequality, addr 0x5e19b8c, size 0x80, virtual false, abstract: false, final false
  static inline bool op_Inequality(::GlobalNamespace::OVRPose x, ::GlobalNamespace::OVRPose y);

  /// @brief Method op_Multiply, addr 0x5e18a04, size 0xfc, virtual false, abstract: false, final false
