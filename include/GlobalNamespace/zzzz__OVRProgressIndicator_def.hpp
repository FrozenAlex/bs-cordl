...
public:
  ...
  /// @brief Method Awake, addr 0x5dcfac8, size 0x1c, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::OVRProgressIndicator* New_ctor();

  /// @brief Method Update, addr 0x5dcfae4, size 0x84, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5dcfb68, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::OVRProgressIndicator) == 0x30, "Size mismatch!");
