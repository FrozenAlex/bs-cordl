...
// Write type traits
MARK_REF_T(::GlobalNamespace::OVRReadOnlyAttribute*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRReadOnlyAttribute*, "", "OVRReadOnlyAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5f07ac4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::OVRReadOnlyAttribute) == 0x18, "Size mismatch!");
