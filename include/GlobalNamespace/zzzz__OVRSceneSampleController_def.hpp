...
public:
  ...
  /// @brief Method Awake, addr 0x5dd2988, size 0x1cc, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::OVRSceneSampleController* New_ctor();

  /// @brief Method Start, addr 0x5dd2b54, size 0x128, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5dd2c7c, size 0x174, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateRecenterPose, addr 0x5dd2df0, size 0xd8, virtual false, abstract: false, final false
  inline void UpdateRecenterPose();

  /// @brief Method UpdateSpeedAndRotationScaleMultiplier, addr 0x5dd2fb8, size 0x118, virtual false, abstract: false, final false
  inline void UpdateSpeedAndRotationScaleMultiplier();

  /// @brief Method UpdateVisionMode, addr 0x5dd2ec8, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd30d0, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::OVRSceneSampleController) == 0x60, "Size mismatch!");
