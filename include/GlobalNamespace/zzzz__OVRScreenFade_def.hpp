...
public:
  ...
  /// @brief Method MoveNext, addr 0x5f09b00, size 0x12c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::OVRScreenFade__Fade_d__25* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x5f09c2c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5f09c34, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5f09c6c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5f09afc, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5f09acc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Fade, addr 0x5f0970c, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* Fade(float_t startAlpha, float_t endAlpha);

  /// @brief Method FadeIn, addr 0x5f096e4, size 0x28, virtual false, abstract: false, final false
  inline void FadeIn();

  /// @brief Method FadeOut, addr 0x5f09774, size 0x28, virtual false, abstract: false, final false
  inline void FadeOut();

  static inline ::GlobalNamespace::OVRScreenFade* New_ctor();

  /// @brief Method OnDestroy, addr 0x5f097dc, size 0x1c0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEnable, addr 0x5f097c4, size 0x18, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnLevelFinishedLoading, addr 0x5f0979c, size 0x28, virtual false, abstract: false, final false
  inline void OnLevelFinishedLoading(int32_t level);

  /// @brief Method SetExplicitFade, addr 0x5f09ac4, size 0x8, virtual false, abstract: false, final false
  inline void SetExplicitFade(float_t level);

  /// @brief Method SetMaterialAlpha, addr 0x5f099bc, size 0x108, virtual false, abstract: false, final false
  inline void SetMaterialAlpha();

  /// @brief Method SetUIFade, addr 0x5f0999c, size 0x20, virtual false, abstract: false, final false
  inline void SetUIFade(float_t level);

  /// @brief Method Start, addr 0x5f0921c, size 0x4c8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5f09ad4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityW<::GlobalNamespace::OVRScreenFade> getStaticF__instance_k__BackingField();

  /// @brief Method get_currentAlpha, addr 0x5f0916c, size 0xb0, virtual false, abstract: false, final false
  inline float_t get_currentAlpha();

  /// @brief Method get_instance, addr 0x5f090d0, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_instance, addr 0x5f0911c, size 0x50, virtual false, abstract: false, final false
