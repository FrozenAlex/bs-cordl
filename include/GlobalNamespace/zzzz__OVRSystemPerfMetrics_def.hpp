...
// Write type traits
MARK_REF_T(::GlobalNamespace::OVRSystemPerfMetrics*);
MARK_REF_T(::GlobalNamespace::OVRSystemPerfMetrics_OVRSystemPerfMetricsTcpServer*);
MARK_REF_T(::GlobalNamespace::OVRSystemPerfMetrics_PerfMetrics*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRSystemPerfMetrics*, "", "OVRSystemPerfMetrics");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRSystemPerfMetrics_OVRSystemPerfMetricsTcpServer*, "", "OVRSystemPerfMetrics/OVRSystemPerfMetricsTcpServer");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRSystemPerfMetrics_PerfMetrics*, "", "OVRSystemPerfMetrics/PerfMetrics");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_deviceCpuCoreUtilPercentage, put = __cordl_internal_set_deviceCpuCoreUtilPercentage)) ::ArrayW<float_t> deviceCpuCoreUtilPercentage;

  /// @brief Field deviceCpuCoreUtilPercentage_IsValid, offset 0x88, size 0x8
  __declspec(property(get = __cordl_internal_get_deviceCpuCoreUtilPercentage_IsValid, put = __cordl_internal_set_deviceCpuCoreUtilPercentage_IsValid)) ::ArrayW<bool>
  ...
  /// @brief Method LoadFromJSON, addr 0x5dda410, size 0xb48, virtual false, abstract: false, final false
  inline bool LoadFromJSON(::StringW json);

  static inline ::GlobalNamespace::OVRSystemPerfMetrics_PerfMetrics* New_ctor();

  /// @brief Method ToJSON, addr 0x5dd9ce4, size 0x72c, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<float_t> const& __cordl_internal_get_deviceCpuCoreUtilPercentage() const;

  constexpr ::ArrayW<float_t>& __cordl_internal_get_deviceCpuCoreUtilPercentage();

  constexpr ::ArrayW<bool> const& __cordl_internal_get_deviceCpuCoreUtilPercentage_IsValid() const;

  constexpr ::ArrayW<bool>& __cordl_internal_get_deviceCpuCoreUtilPercentage_IsValid();
  ...
  constexpr void __cordl_internal_set_deviceCpuCoreUtilPercentage(::ArrayW<float_t> value);

  constexpr void __cordl_internal_set_deviceCpuCoreUtilPercentage_IsValid(::ArrayW<bool> value);
  ...
  /// @brief Method .ctor, addr 0x5ddb9d8, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<bool> ___deviceCpuCoreUtilPercentage_IsValid;

  /// @brief Field deviceCpuCoreUtilPercentage, offset: 0x90, size: 0x8, def value: None
  ::ArrayW<float_t> ___deviceCpuCoreUtilPercentage;
...
static_assert(sizeof(::GlobalNamespace::OVRSystemPerfMetrics_PerfMetrics) == 0x98, "Size mismatch!");
...
public:
  ...
  /// @brief Method GatherPerfMetrics, addr 0x5ddbce4, size 0x374, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x5ddbbb8, size 0xac, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5ddba90, size 0x128, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Update, addr 0x5ddbc64, size 0x80, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5ddc058, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::OVRSystemPerfMetrics_OVRSystemPerfMetricsTcpServer) == 0x30, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dd9ce0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::OVRSystemPerfMetrics) == 0x10, "Size mismatch!");
