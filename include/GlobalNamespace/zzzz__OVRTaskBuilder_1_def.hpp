...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::OVRTaskBuilder_1_PooledStateMachine);
MARK_GEN_REF_T_PTR(::GlobalNamespace::OVRTaskBuilder_1_PooledStateMachine_1);
MARK_GEN_VAL_T(::GlobalNamespace::OVRTaskBuilder_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::OVRTaskBuilder_1_PooledStateMachine, "", "OVRTaskBuilder`1/PooledStateMachine");
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::OVRTaskBuilder_1_PooledStateMachine_1, "", "OVRTaskBuilder`1/PooledStateMachine`1");
DEFINE_IL2CPP_GEN_CLASS(::GlobalNamespace::OVRTaskBuilder_1, "", "OVRTaskBuilder`1");
