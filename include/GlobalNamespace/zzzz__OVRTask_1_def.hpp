...
public:
  ...
  __declspec(property(
      get = getStaticF__onCombinedTaskCompleted,
      put = setStaticF__onCombinedTaskCompleted)) ::System::Action_2<::System::Collections::Generic::List_1<TResult>*, ::GlobalNamespace::OVRTask_1<::ArrayW<TResult>>>* _onCombinedTaskCompleted;
  ...
  template <typename T> inline bool TryGetInternalData(::by_ref<T> data);
