...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRTextureQualityFiltering, "", "OVRTextureQualityFiltering");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::OVRTextureQualityFiltering) == 0x4, "Size mismatch!");
