...
// Write type traits
MARK_REF_T(::GlobalNamespace::OVRTrackedKeyboardSampleControls*);
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_ShaderButtons, put = __cordl_internal_set_ShaderButtons)) ::ArrayW<::UnityW<::UnityEngine::UI::Button>> ShaderButtons;
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::UI::Button>> const& __cordl_internal_get_ShaderButtons() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::UI::Button>>& __cordl_internal_get_ShaderButtons();
  ...
  constexpr void __cordl_internal_set_ShaderButtons(::ArrayW<::UnityW<::UnityEngine::UI::Button>> value);
...
public:
  ...
  ::ArrayW<::UnityW<::UnityEngine::UI::Button>> ___ShaderButtons;
...
static_assert(sizeof(::GlobalNamespace::OVRTrackedKeyboardSampleControls) == 0x98, "Size mismatch!");
