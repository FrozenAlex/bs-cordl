...
namespace GlobalNamespace {
class OVRTrackedKeyboard__InitializeHandPresenceData_d__86;
}
namespace GlobalNamespace {
class OVRTrackedKeyboard__StartKeyboardTrackingCoroutine_d__93;
}
namespace GlobalNamespace {
class OVRTrackedKeyboard__Start_d__85;
}
namespace GlobalNamespace {
class OVRTrackedKeyboard__UpdateKeyboardPose_d__95;
}
namespace GlobalNamespace {
class OVRTrackedKeyboard__UpdateTrackingStateCoroutine_d__92;
}
namespace GlobalNamespace {
...
MARK_REF_T(::GlobalNamespace::OVRTrackedKeyboard*);
MARK_REF_T(::GlobalNamespace::OVRTrackedKeyboard__InitializeHandPresenceData_d__86*);
MARK_REF_T(::GlobalNamespace::OVRTrackedKeyboard__StartKeyboardTrackingCoroutine_d__93*);
MARK_REF_T(::GlobalNamespace::OVRTrackedKeyboard__Start_d__85*);
MARK_REF_T(::GlobalNamespace::OVRTrackedKeyboard__UpdateKeyboardPose_d__95*);
MARK_REF_T(::GlobalNamespace::OVRTrackedKeyboard__UpdateTrackingStateCoroutine_d__92*);
MARK_REF_T(::GlobalNamespace::OVRTrackedKeyboard___c*);
...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRTrackedKeyboard_KeyboardPresentation, "", "OVRTrackedKeyboard/KeyboardPresentation");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRTrackedKeyboard_TrackedKeyboardState, "", "OVRTrackedKeyboard/TrackedKeyboardState");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRTrackedKeyboard*, "", "OVRTrackedKeyboard");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRTrackedKeyboard__InitializeHandPresenceData_d__86*, "", "OVRTrackedKeyboard/<InitializeHandPresenceData>d__86");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRTrackedKeyboard__StartKeyboardTrackingCoroutine_d__93*, "", "OVRTrackedKeyboard/<StartKeyboardTrackingCoroutine>d__93");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRTrackedKeyboard__Start_d__85*, "", "OVRTrackedKeyboard/<Start>d__85");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRTrackedKeyboard__UpdateKeyboardPose_d__95*, "", "OVRTrackedKeyboard/<UpdateKeyboardPose>d__95");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRTrackedKeyboard__UpdateTrackingStateCoroutine_d__92*, "", "OVRTrackedKeyboard/<UpdateTrackingStateCoroutine>d__92");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRTrackedKeyboard___c*, "", "OVRTrackedKeyboard/<>c");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRTrackedKeyboard_TrackedKeyboardSetActiveEvent, "", "OVRTrackedKeyboard/TrackedKeyboardSetActiveEvent");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRTrackedKeyboard_TrackedKeyboardVisibilityChangedEvent, "", "OVRTrackedKeyboard/TrackedKeyboardVisibilityChangedEvent");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::OVRTrackedKeyboard_TrackedKeyboardState) == 0x4, "Size mismatch!");
...
public:
  ...
  enum struct __OVRTrackedKeyboard_KeyboardPresentation_Unwrapped : int32_t {
    ...
    __E_PreferMR = static_cast<int32_t>(0x1),
  };
  ...
  /// @brief Field PreferMR value: I32(1)
  static ::GlobalNamespace::OVRTrackedKeyboard_KeyboardPresentation const PreferMR;
...
static_assert(sizeof(::GlobalNamespace::OVRTrackedKeyboard_KeyboardPresentation) == 0x4, "Size mismatch!");
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x5da722c, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::OVRTrackedKeyboard_TrackedKeyboardVisibilityChangedEvent) == 0x10, "Size mismatch!");
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x5da744c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::OVRTrackedKeyboard_TrackedKeyboardSetActiveEvent) == 0x1, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = getStaticF___9__110_0, put = setStaticF___9__110_0)) ::System::Action_1<::GlobalNamespace::OVRTrackedKeyboard_TrackedKeyboardSetActiveEvent>* __9__110_0;

  /// @brief Field <>9__110_1, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF___9__110_1, put = setStaticF___9__110_1)) ::System::Action_1<::GlobalNamespace::OVRTrackedKeyboard_TrackedKeyboardVisibilityChangedEvent>* __9__110_1;

  static inline ::GlobalNamespace::OVRTrackedKeyboard___c* New_ctor();

  /// @brief Method <.ctor>b__110_0, addr 0x5da74ac, size 0x4, virtual false, abstract: false, final false
  inline void __ctor_b__110_0(::GlobalNamespace::OVRTrackedKeyboard_TrackedKeyboardSetActiveEvent _p0_);

  /// @brief Method <.ctor>b__110_1, addr 0x5da74b0, size 0x4, virtual false, abstract: false, final false
  inline void __ctor_b__110_1(::GlobalNamespace::OVRTrackedKeyboard_TrackedKeyboardVisibilityChangedEvent _p0_);

  /// @brief Method .ctor, addr 0x5da74a8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::GlobalNamespace::OVRTrackedKeyboard___c* getStaticF___9();

  static inline ::System::Action_1<::GlobalNamespace::OVRTrackedKeyboard_TrackedKeyboardSetActiveEvent>* getStaticF___9__110_0();

  static inline ::System::Action_1<::GlobalNamespace::OVRTrackedKeyboard_TrackedKeyboardVisibilityChangedEvent>* getStaticF___9__110_1();

  static inline void setStaticF___9(::GlobalNamespace::OVRTrackedKeyboard___c* value);

  static inline void setStaticF___9__110_0(::System::Action_1<::GlobalNamespace::OVRTrackedKeyboard_TrackedKeyboardSetActiveEvent>* value);

  static inline void setStaticF___9__110_1(::System::Action_1<::GlobalNamespace::OVRTrackedKeyboard_TrackedKeyboardVisibilityChangedEvent>* value);
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::OVRTrackedKeyboard___c) == 0x10, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies System.Object
namespace GlobalNamespace {
// Is value type: false
// CS Name: OVRTrackedKeyboard/<InitializeHandPresenceData>d__86
class CORDL_TYPE OVRTrackedKeyboard__InitializeHandPresenceData_d__86 : public ::System::Object {
public:
  // Declarations
  ...
  /// @brief Method MoveNext, addr 0x5da74b8, size 0x184, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::OVRTrackedKeyboard__InitializeHandPresenceData_d__86* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x5da763c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5da7644, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5da767c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5da74b4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5da5aa4, size 0x8, virtual false, abstract: false, final false
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr OVRTrackedKeyboard__InitializeHandPresenceData_d__86();

public:
  // Ctor Parameters [CppParam { name: "", ty: "OVRTrackedKeyboard__InitializeHandPresenceData_d__86", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OVRTrackedKeyboard__InitializeHandPresenceData_d__86(OVRTrackedKeyboard__InitializeHandPresenceData_d__86&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OVRTrackedKeyboard__InitializeHandPresenceData_d__86", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
...
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard__InitializeHandPresenceData_d__86, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard__InitializeHandPresenceData_d__86, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard__InitializeHandPresenceData_d__86, _____4__this) == 0x20, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::OVRTrackedKeyboard__InitializeHandPresenceData_d__86) == 0x28, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies System.Object
namespace GlobalNamespace {
// Is value type: false
// CS Name: OVRTrackedKeyboard/<Start>d__85
class CORDL_TYPE OVRTrackedKeyboard__Start_d__85 : public ::System::Object {
public:
  // Declarations
  __declspec(property(get = System_Collections_Generic_IEnumerator_System_Object__get_Current)) ::System::Object* System_Collections_Generic_IEnumerator_System_Object__Current;
  ...
  /// @brief Method MoveNext, addr 0x5da7688, size 0x110, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::OVRTrackedKeyboard__Start_d__85* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x5da7798, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5da77a0, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5da77d8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5da7684, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method .ctor, addr 0x5da5a48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr OVRTrackedKeyboard__Start_d__85();

public:
  // Ctor Parameters [CppParam { name: "", ty: "OVRTrackedKeyboard__Start_d__85", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OVRTrackedKeyboard__Start_d__85(OVRTrackedKeyboard__Start_d__85&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OVRTrackedKeyboard__Start_d__85", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
...
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard__Start_d__85, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard__Start_d__85, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard__Start_d__85, _____4__this) == 0x20, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::OVRTrackedKeyboard__Start_d__85) == 0x28, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies System.Object
namespace GlobalNamespace {
// Is value type: false
// CS Name: OVRTrackedKeyboard/<StartKeyboardTrackingCoroutine>d__93
class CORDL_TYPE OVRTrackedKeyboard__StartKeyboardTrackingCoroutine_d__93 : public ::System::Object {
public:
  // Declarations
  __declspec(property(get = System_Collections_Generic_IEnumerator_System_Object__get_Current)) ::System::Object* System_Collections_Generic_IEnumerator_System_Object__Current;
  ...
  /// @brief Method MoveNext, addr 0x5da77e4, size 0x2e0, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::OVRTrackedKeyboard__StartKeyboardTrackingCoroutine_d__93* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x5da7ac4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5da7acc, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5da7b04, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5da77e0, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method .ctor, addr 0x5da6288, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr OVRTrackedKeyboard__StartKeyboardTrackingCoroutine_d__93();

public:
  // Ctor Parameters [CppParam { name: "", ty: "OVRTrackedKeyboard__StartKeyboardTrackingCoroutine_d__93", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OVRTrackedKeyboard__StartKeyboardTrackingCoroutine_d__93(OVRTrackedKeyboard__StartKeyboardTrackingCoroutine_d__93&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OVRTrackedKeyboard__StartKeyboardTrackingCoroutine_d__93", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
...
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard__StartKeyboardTrackingCoroutine_d__93, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard__StartKeyboardTrackingCoroutine_d__93, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard__StartKeyboardTrackingCoroutine_d__93, _____4__this) == 0x20, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::OVRTrackedKeyboard__StartKeyboardTrackingCoroutine_d__93) == 0x28, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies System.Object
namespace GlobalNamespace {
// Is value type: false
// CS Name: OVRTrackedKeyboard/<UpdateKeyboardPose>d__95
class CORDL_TYPE OVRTrackedKeyboard__UpdateKeyboardPose_d__95 : public ::System::Object {
public:
  // Declarations
  __declspec(property(get = System_Collections_Generic_IEnumerator_System_Object__get_Current)) ::System::Object* System_Collections_Generic_IEnumerator_System_Object__Current;
  ...
  /// @brief Method MoveNext, addr 0x5da7b10, size 0x988, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::OVRTrackedKeyboard__UpdateKeyboardPose_d__95* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x5da8498, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5da84a0, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5da84d8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5da7b0c, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method .ctor, addr 0x5da6640, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr OVRTrackedKeyboard__UpdateKeyboardPose_d__95();

public:
  // Ctor Parameters [CppParam { name: "", ty: "OVRTrackedKeyboard__UpdateKeyboardPose_d__95", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OVRTrackedKeyboard__UpdateKeyboardPose_d__95(OVRTrackedKeyboard__UpdateKeyboardPose_d__95&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OVRTrackedKeyboard__UpdateKeyboardPose_d__95", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
...
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard__UpdateKeyboardPose_d__95, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard__UpdateKeyboardPose_d__95, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard__UpdateKeyboardPose_d__95, _____4__this) == 0x20, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::OVRTrackedKeyboard__UpdateKeyboardPose_d__95) == 0x28, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies OVRKeyboard::TrackedKeyboardInfo, System.Object
namespace GlobalNamespace {
// Is value type: false
// CS Name: OVRTrackedKeyboard/<UpdateTrackingStateCoroutine>d__92
class CORDL_TYPE OVRTrackedKeyboard__UpdateTrackingStateCoroutine_d__92 : public ::System::Object {
public:
  // Declarations
  __declspec(property(get = System_Collections_Generic_IEnumerator_System_Object__get_Current)) ::System::Object* System_Collections_Generic_IEnumerator_System_Object__Current;
  ...
  /// @brief Method MoveNext, addr 0x5da84e4, size 0x490, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::OVRTrackedKeyboard__UpdateTrackingStateCoroutine_d__92* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x5da8974, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5da897c, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5da89b4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5da84e0, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method .ctor, addr 0x5da622c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr OVRTrackedKeyboard__UpdateTrackingStateCoroutine_d__92();

public:
  // Ctor Parameters [CppParam { name: "", ty: "OVRTrackedKeyboard__UpdateTrackingStateCoroutine_d__92", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OVRTrackedKeyboard__UpdateTrackingStateCoroutine_d__92(OVRTrackedKeyboard__UpdateTrackingStateCoroutine_d__92&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OVRTrackedKeyboard__UpdateTrackingStateCoroutine_d__92", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
...
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard__UpdateTrackingStateCoroutine_d__92, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard__UpdateTrackingStateCoroutine_d__92, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard__UpdateTrackingStateCoroutine_d__92, _____4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard__UpdateTrackingStateCoroutine_d__92, ____keyboardInfo_5__2) == 0x28, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::OVRTrackedKeyboard__UpdateTrackingStateCoroutine_d__92) == 0x50, "Size mismatch!");
...
// OVRTrackedKeyboard::KeyboardPresentation, OVRTrackedKeyboard::TrackedKeyboardState, System.Nullable`1<T>, UnityEngine.MeshRenderer, UnityEngine.MonoBehaviour, UnityEngine.Quaternion,
// UnityEngine.Vector3
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  using _InitializeHandPresenceData_d__86 = ::GlobalNamespace::OVRTrackedKeyboard__InitializeHandPresenceData_d__86;

  using _StartKeyboardTrackingCoroutine_d__93 = ::GlobalNamespace::OVRTrackedKeyboard__StartKeyboardTrackingCoroutine_d__93;

  using _Start_d__85 = ::GlobalNamespace::OVRTrackedKeyboard__Start_d__85;

  using _UpdateKeyboardPose_d__95 = ::GlobalNamespace::OVRTrackedKeyboard__UpdateKeyboardPose_d__95;

  using _UpdateTrackingStateCoroutine_d__92 = ::GlobalNamespace::OVRTrackedKeyboard__UpdateTrackingStateCoroutine_d__92;
  ...
  /// @brief Field ActiveKeyboardTransform, offset 0x118, size 0x8
  ...
  /// @brief Field EWAPosition, offset 0x150, size 0x10
  ...
  /// @brief Field EWARotation, offset 0x160, size 0x14
  ...
  /// @brief Field HAND_HEIGHT_TUNING, offset 0x174, size 0x4
  ...
  /// @brief Field HandsOverKeyboard, offset 0x120, size 0x1
  ...
  /// @brief Field PassthroughShader, offset 0xe8, size 0x8
  ...
  /// @brief Field ProjectedPassthroughMR, offset 0x100, size 0x8
  __declspec(property(get = __cordl_internal_get_ProjectedPassthroughMR, put = __cordl_internal_set_ProjectedPassthroughMR)) ::UnityW<::GlobalNamespace::OVRPassthroughLayer> ProjectedPassthroughMR;
  ...
  /// @brief Field TrackedKeyboardActiveChanged, offset 0x108, size 0x8
  ...
  /// @brief Field TrackedKeyboardVisibilityChanged, offset 0x110, size 0x8
  __declspec(property(
  ...
  /// @brief Field UseHeuristicRollback, offset 0x178, size 0x1
  ...
  __declspec(property(get = __cordl_internal_get_activeKeyboardRenderers_, put = __cordl_internal_set_activeKeyboardRenderers_)) ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>>
  ...
  /// @brief Field cameraRig_, offset 0x128, size 0x8
  ...
  /// @brief Field dynamicQualityTexture_, offset 0xd0, size 0x8
  ...
  /// @brief Field keyboardBoundingBox_, offset 0x138, size 0x8
  ...
  /// @brief Field projectedPassthroughMesh, offset 0xf8, size 0x8
  ...
  /// @brief Field projectedPassthroughRoot, offset 0xf0, size 0x8
  ...
  /// @brief Field reacquisitionTimer_, offset 0x144, size 0x4
  ...
  /// @brief Field sendFilteredPoseEventTimer_, offset 0x148, size 0x4
  ...
  /// @brief Field skippedPoseCount_, offset 0x14c, size 0x4
  ...
  /// @brief Field staleTimeoutCounter_, offset 0x140, size 0x4
  ...
  /// @brief Field untrackedPosition_, offset 0xd8, size 0xc
  ...
  /// @brief Method DispatchVisibilityEvent, addr 0x5da70f0, size 0x34, virtual false, abstract: false, final false
  inline void DispatchVisibilityEvent(bool timeOut);

  /// @brief Method Dispose, addr 0x5da7124, size 0x108, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method GetDistanceToKeyboard, addr 0x5da5b44, size 0x22c, virtual false, abstract: false, final false
  inline float_t GetDistanceToKeyboard(::UnityEngine::Vector3 point);

  /// @brief Method GetKeyboardVisibility, addr 0x5da57e0, size 0x4c, virtual false, abstract: false, final false
  inline bool GetKeyboardVisibility();

  /// @brief Method InitializeHandPresenceData, addr 0x5da5a50, size 0x54, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* InitializeHandPresenceData();

  /// @brief Method InitializeKeyboardInfo, addr 0x5da6594, size 0x58, virtual false, abstract: false, final false
  inline void InitializeKeyboardInfo();

  /// @brief Method KeyboardTrackerIsRunning, addr 0x5da61c4, size 0x14, virtual false, abstract: false, final false
  inline bool KeyboardTrackerIsRunning();

  /// @brief Method LaunchLocalKeyboardSelectionDialog, addr 0x5da5d70, size 0x44, virtual false, abstract: false, final false
  inline void LaunchLocalKeyboardSelectionDialog();

  /// @brief Method LaunchOverlayIntent, addr 0x5da5db4, size 0x3cc, virtual false, abstract: false, final false
  inline void LaunchOverlayIntent(::StringW dataUri);

  /// @brief Method LaunchRemoteKeyboardSelectionDialog, addr 0x5da6180, size 0x44, virtual false, abstract: false, final false
  inline void LaunchRemoteKeyboardSelectionDialog();

  /// @brief Method LoadKeyboardMesh, addr 0x5da66b0, size 0x518, virtual false, abstract: false, final false
  inline void LoadKeyboardMesh();

  /// @brief Method LoadRuntimeKeyboardMesh, addr 0x5da6bc8, size 0x2cc, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> LoadRuntimeKeyboardMesh();

  static inline ::GlobalNamespace::OVRTrackedKeyboard* New_ctor();

  /// @brief Method RegisterPassthroughMeshToSDK, addr 0x5da5aac, size 0x98, virtual false, abstract: false, final false
  inline void RegisterPassthroughMeshToSDK();

  /// @brief Method SetKeyboardState, addr 0x5da6484, size 0x110, virtual false, abstract: false, final false
  inline void SetKeyboardState(::GlobalNamespace::OVRTrackedKeyboard_TrackedKeyboardState state);

  /// @brief Method Start, addr 0x5da59f4, size 0x54, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* Start();

  /// @brief Method StartKeyboardTrackingCoroutine, addr 0x5da6234, size 0x54, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* StartKeyboardTrackingCoroutine();

  /// @brief Method StopKeyboardTrackingInternal, addr 0x5da6290, size 0x1f4, virtual false, abstract: false, final false
  inline void StopKeyboardTrackingInternal();

  /// @brief Method UpdateKeyboardPose, addr 0x5da65ec, size 0x54, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* UpdateKeyboardPose();

  /// @brief Method UpdateKeyboardVisibility, addr 0x5da6fd4, size 0x11c, virtual false, abstract: false, final false
  inline void UpdateKeyboardVisibility();

  /// @brief Method UpdatePresentation, addr 0x5da582c, size 0x154, virtual false, abstract: false, final false
  inline void UpdatePresentation(bool isVisible);

  /// @brief Method UpdateSkippedPoseTimer, addr 0x5da6648, size 0x68, virtual false, abstract: false, final false
  inline void UpdateSkippedPoseTimer();

  /// @brief Method UpdateTextureQuality, addr 0x5da6e94, size 0x140, virtual false, abstract: false, final false
  inline void UpdateTextureQuality();

  /// @brief Method UpdateTrackingStateCoroutine, addr 0x5da61d8, size 0x54, virtual false, abstract: false, final false
  ...
  constexpr ::UnityW<::GlobalNamespace::OVRPassthroughLayer> const& __cordl_internal_get_ProjectedPassthroughMR() const;

  constexpr ::UnityW<::GlobalNamespace::OVRPassthroughLayer>& __cordl_internal_get_ProjectedPassthroughMR();
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>> const& __cordl_internal_get_activeKeyboardRenderers_() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>>& __cordl_internal_get_activeKeyboardRenderers_();
  ...
  constexpr void __cordl_internal_set_ProjectedPassthroughMR(::UnityW<::GlobalNamespace::OVRPassthroughLayer> value);
  ...
  constexpr void __cordl_internal_set_activeKeyboardRenderers_(::ArrayW<::UnityW<::UnityEngine::MeshRenderer>> value);
  ...
  /// @brief Method .ctor, addr 0x5da723c, size 0x194, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ActiveKeyboardInfo, addr 0x5da5730, size 0x18, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRKeyboard_TrackedKeyboardInfo get_ActiveKeyboardInfo();

  /// @brief Method get_ConnectionRequired, addr 0x5da5990, size 0x8, virtual false, abstract: false, final false
  inline bool get_ConnectionRequired();

  /// @brief Method get_CurrentKeyboardAngleFromUp, addr 0x5da5710, size 0x8, virtual false, abstract: false, final false
  inline float_t get_CurrentKeyboardAngleFromUp();

  /// @brief Method get_KeyboardQueryFlags, addr 0x5da59d8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPlugin_TrackedKeyboardQueryFlags get_KeyboardQueryFlags();

  /// @brief Method get_PassthroughOverlay, addr 0x5da59e8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::OVROverlay> get_PassthroughOverlay();

  /// @brief Method get_Presentation, addr 0x5da5788, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTrackedKeyboard_KeyboardPresentation get_Presentation();

  /// @brief Method get_RemoteKeyboard, addr 0x5da59b0, size 0x10, virtual false, abstract: false, final false
  inline bool get_RemoteKeyboard();

  /// @brief Method get_ShowUntracked, addr 0x5da59a0, size 0x8, virtual false, abstract: false, final false
  inline bool get_ShowUntracked();

  /// @brief Method get_SystemKeyboardInfo, addr 0x5da5760, size 0x14, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRKeyboard_TrackedKeyboardInfo get_SystemKeyboardInfo();

  /// @brief Method get_TrackingEnabled, addr 0x5da5980, size 0x8, virtual false, abstract: false, final false
  inline bool get_TrackingEnabled();

  /// @brief Method get_TrackingState, addr 0x5da5720, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ActiveKeyboardInfo, addr 0x5da5748, size 0x18, virtual false, abstract: false, final false
  inline void set_ActiveKeyboardInfo(::GlobalNamespace::OVRKeyboard_TrackedKeyboardInfo value);

  /// @brief Method set_ConnectionRequired, addr 0x5da5998, size 0x8, virtual false, abstract: false, final false
  inline void set_ConnectionRequired(bool value);

  /// @brief Method set_CurrentKeyboardAngleFromUp, addr 0x5da5718, size 0x8, virtual false, abstract: false, final false
  inline void set_CurrentKeyboardAngleFromUp(float_t value);

  /// @brief Method set_KeyboardQueryFlags, addr 0x5da59e0, size 0x8, virtual false, abstract: false, final false
  inline void set_KeyboardQueryFlags(::GlobalNamespace::OVRPlugin_TrackedKeyboardQueryFlags value);

  /// @brief Method set_PassthroughOverlay, addr 0x5da59f0, size 0x4, virtual false, abstract: false, final false
  inline void set_PassthroughOverlay(::GlobalNamespace::OVROverlay* value);

  /// @brief Method set_Presentation, addr 0x5da5790, size 0x50, virtual false, abstract: false, final false
  inline void set_Presentation(::GlobalNamespace::OVRTrackedKeyboard_KeyboardPresentation value);

  /// @brief Method set_RemoteKeyboard, addr 0x5da59c0, size 0x18, virtual false, abstract: false, final false
  inline void set_RemoteKeyboard(bool value);

  /// @brief Method set_ShowUntracked, addr 0x5da59a8, size 0x8, virtual false, abstract: false, final false
  inline void set_ShowUntracked(bool value);

  /// @brief Method set_SystemKeyboardInfo, addr 0x5da5774, size 0x14, virtual false, abstract: false, final false
  inline void set_SystemKeyboardInfo(::GlobalNamespace::OVRKeyboard_TrackedKeyboardInfo value);

  /// @brief Method set_TrackingEnabled, addr 0x5da5988, size 0x8, virtual false, abstract: false, final false
  inline void set_TrackingEnabled(bool value);

  /// @brief Method set_TrackingState, addr 0x5da5728, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>> ___activeKeyboardRenderers_;
  ...
  /// @brief Field dynamicQualityTexture_, offset: 0xd0, size: 0x8, def value: None
  ::UnityW<::UnityEngine::Texture2D> ___dynamicQualityTexture_;

  /// @brief Field untrackedPosition_, offset: 0xd8, size: 0xc, def value: None
  ::UnityEngine::Vector3 ___untrackedPosition_;

  /// @brief Field PassthroughShader, offset: 0xe8, size: 0x8, def value: None
  ::UnityW<::UnityEngine::Shader> ___PassthroughShader;

  /// @brief Field projectedPassthroughRoot, offset: 0xf0, size: 0x8, def value: None
  ::UnityW<::UnityEngine::Transform> ___projectedPassthroughRoot;

  /// @brief Field projectedPassthroughMesh, offset: 0xf8, size: 0x8, def value: None
  ::UnityW<::UnityEngine::MeshFilter> ___projectedPassthroughMesh;

  /// @brief Field ProjectedPassthroughMR, offset: 0x100, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::OVRPassthroughLayer> ___ProjectedPassthroughMR;

  /// @brief Field TrackedKeyboardActiveChanged, offset: 0x108, size: 0x8, def value: None
  ::System::Action_1<::GlobalNamespace::OVRTrackedKeyboard_TrackedKeyboardSetActiveEvent>* ___TrackedKeyboardActiveChanged;

  /// @brief Field TrackedKeyboardVisibilityChanged, offset: 0x110, size: 0x8, def value: None
  ...
  /// @brief Field ActiveKeyboardTransform, offset: 0x118, size: 0x8, def value: None
  ::UnityW<::UnityEngine::Transform> ___ActiveKeyboardTransform;

  /// @brief Field HandsOverKeyboard, offset: 0x120, size: 0x1, def value: None
  bool ___HandsOverKeyboard;

  /// @brief Field cameraRig_, offset: 0x128, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::OVRCameraRig> ___cameraRig_;

  /// @brief Field updateKeyboardRoutine_, offset: 0x130, size: 0x8, def value: None
  ::UnityEngine::Coroutine* ___updateKeyboardRoutine_;

  /// @brief Field keyboardBoundingBox_, offset: 0x138, size: 0x8, def value: None
  ::UnityW<::UnityEngine::BoxCollider> ___keyboardBoundingBox_;

  /// @brief Field staleTimeoutCounter_, offset: 0x140, size: 0x4, def value: None
  float_t ___staleTimeoutCounter_;

  /// @brief Field reacquisitionTimer_, offset: 0x144, size: 0x4, def value: None
  float_t ___reacquisitionTimer_;

  /// @brief Field sendFilteredPoseEventTimer_, offset: 0x148, size: 0x4, def value: None
  float_t ___sendFilteredPoseEventTimer_;

  /// @brief Field skippedPoseCount_, offset: 0x14c, size: 0x4, def value: None
  int32_t ___skippedPoseCount_;

  /// @brief Field EWAPosition, offset: 0x150, size: 0x10, def value: None
  ::System::Nullable_1<::UnityEngine::Vector3> ___EWAPosition;

  /// @brief Field EWARotation, offset: 0x160, size: 0x14, def value: None
  ::System::Nullable_1<::UnityEngine::Quaternion> ___EWARotation;

  /// @brief Field HAND_HEIGHT_TUNING, offset: 0x174, size: 0x4, def value: None
  float_t ___HAND_HEIGHT_TUNING;

  /// @brief Field UseHeuristicRollback, offset: 0x178, size: 0x1, def value: None
...
static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___dynamicQualityTexture_) == 0xd0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___untrackedPosition_) == 0xd8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___PassthroughShader) == 0xe8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___projectedPassthroughRoot) == 0xf0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___projectedPassthroughMesh) == 0xf8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___ProjectedPassthroughMR) == 0x100, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___TrackedKeyboardActiveChanged) == 0x108, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___TrackedKeyboardVisibilityChanged) == 0x110, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___ActiveKeyboardTransform) == 0x118, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___HandsOverKeyboard) == 0x120, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___cameraRig_) == 0x128, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___updateKeyboardRoutine_) == 0x130, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___keyboardBoundingBox_) == 0x138, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___staleTimeoutCounter_) == 0x140, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___reacquisitionTimer_) == 0x144, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___sendFilteredPoseEventTimer_) == 0x148, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___skippedPoseCount_) == 0x14c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___EWAPosition) == 0x150, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___EWARotation) == 0x160, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___HAND_HEIGHT_TUNING) == 0x174, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRTrackedKeyboard, ___UseHeuristicRollback) == 0x178, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::OVRTrackedKeyboard) == 0x180, "Size mismatch!");
