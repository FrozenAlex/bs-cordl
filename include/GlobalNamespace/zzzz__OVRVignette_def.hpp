...
MARK_REF_T(::GlobalNamespace::OVRVignette*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRVignette_FalloffType, "", "OVRVignette/FalloffType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRVignette_MeshComplexityLevel, "", "OVRVignette/MeshComplexityLevel");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRVignette*, "", "OVRVignette");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__OpaqueScaleAndOffset0, put = __cordl_internal_set__OpaqueScaleAndOffset0)) ::ArrayW<::UnityEngine::Vector4> _OpaqueScaleAndOffset0;

  /// @brief Field _OpaqueScaleAndOffset1, offset 0xd8, size 0x8
  __declspec(property(get = __cordl_internal_get__OpaqueScaleAndOffset1, put = __cordl_internal_set__OpaqueScaleAndOffset1)) ::ArrayW<::UnityEngine::Vector4> _OpaqueScaleAndOffset1;
  ...
  __declspec(property(get = __cordl_internal_get__TransparentScaleAndOffset0, put = __cordl_internal_set__TransparentScaleAndOffset0)) ::ArrayW<::UnityEngine::Vector4> _TransparentScaleAndOffset0;

  /// @brief Field _TransparentScaleAndOffset1, offset 0xc8, size 0x8
  __declspec(property(get = __cordl_internal_get__TransparentScaleAndOffset1, put = __cordl_internal_set__TransparentScaleAndOffset1)) ::ArrayW<::UnityEngine::Vector4> _TransparentScaleAndOffset1;
  ...
  /// @brief Method Awake, addr 0x5f12da0, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method BuildMaterials, addr 0x5f12780, size 0x400, virtual false, abstract: false, final false
  inline void BuildMaterials();

  /// @brief Method BuildMeshes, addr 0x5f12078, size 0x708, virtual false, abstract: false, final false
  inline void BuildMeshes();

  /// @brief Method DisableRenderers, addr 0x5f12cd8, size 0xc8, virtual false, abstract: false, final false
  inline void DisableRenderers();

  /// @brief Method EnableRenderers, addr 0x5f138b0, size 0x3c, virtual false, abstract: false, final false
  inline void EnableRenderers();

  /// @brief Method GetTanFovAndOffsetForMonoEye, addr 0x5f13374, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTanFovAndOffsetForStereoEye, addr 0x5f131e4, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTriangleCount, addr 0x5f12054, size 0x24, virtual false, abstract: false, final false
  inline int32_t GetTriangleCount();

  /// @brief Method Initialize, addr 0x5f12da4, size 0x440, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::GlobalNamespace::OVRVignette* New_ctor();

  /// @brief Method OnBeginCameraRendering, addr 0x5f138f4, size 0x90, virtual false, abstract: false, final false
  inline void OnBeginCameraRendering(::UnityEngine::Rendering::ScriptableRenderContext context, ::UnityEngine::Camera* camera);

  /// @brief Method OnDisable, addr 0x5f12c28, size 0xb0, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5f12b80, size 0xa8, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnPostRender, addr 0x5f138f0, size 0x4, virtual false, abstract: false, final false
  inline void OnPostRender();

  /// @brief Method OnPreCull, addr 0x5f138ec, size 0x4, virtual false, abstract: false, final false
  inline void OnPreCull();

  /// @brief Method Update, addr 0x5f13434, size 0x47c, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method VisibilityTest, addr 0x5f13400, size 0x34, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get__OpaqueScaleAndOffset0() const;

  constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get__OpaqueScaleAndOffset0();

  constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get__OpaqueScaleAndOffset1() const;

  constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get__OpaqueScaleAndOffset1();
  ...
  constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get__TransparentScaleAndOffset0() const;

  constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get__TransparentScaleAndOffset0();

  constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get__TransparentScaleAndOffset1() const;

  constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get__TransparentScaleAndOffset1();
  ...
  constexpr void __cordl_internal_set__OpaqueScaleAndOffset0(::ArrayW<::UnityEngine::Vector4> value);

  constexpr void __cordl_internal_set__OpaqueScaleAndOffset1(::ArrayW<::UnityEngine::Vector4> value);
  ...
  constexpr void __cordl_internal_set__TransparentScaleAndOffset0(::ArrayW<::UnityEngine::Vector4> value);

  constexpr void __cordl_internal_set__TransparentScaleAndOffset1(::ArrayW<::UnityEngine::Vector4> value);

  constexpr void __cordl_internal_set__TransparentVignetteVisible(bool value);

  /// @brief Method .ctor, addr 0x5f13984, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::UnityEngine::Vector4> ____TransparentScaleAndOffset0;

  /// @brief Field _TransparentScaleAndOffset1, offset: 0xc8, size: 0x8, def value: None
  ::ArrayW<::UnityEngine::Vector4> ____TransparentScaleAndOffset1;

  /// @brief Field _OpaqueScaleAndOffset0, offset: 0xd0, size: 0x8, def value: None
  ::ArrayW<::UnityEngine::Vector4> ____OpaqueScaleAndOffset0;

  /// @brief Field _OpaqueScaleAndOffset1, offset: 0xd8, size: 0x8, def value: None
  ::ArrayW<::UnityEngine::Vector4> ____OpaqueScaleAndOffset1;
...
static_assert(sizeof(::GlobalNamespace::OVRVignette) == 0xe8, "Size mismatch!");
