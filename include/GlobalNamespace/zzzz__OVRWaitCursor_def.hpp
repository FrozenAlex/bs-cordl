...
public:
  ...
  /// @brief Method Update, addr 0x5dddb14, size 0x80, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5dddb94, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::OVRWaitCursor) == 0x30, "Size mismatch!");
