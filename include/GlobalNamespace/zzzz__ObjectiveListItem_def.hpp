...
// Write type traits
MARK_REF_T(::GlobalNamespace::ObjectiveListItem*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ObjectiveListItem*, "", "ObjectiveListItem");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5834b44, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_conditionText, addr 0x5834af0, size 0x20, virtual false, abstract: false, final false
  inline void set_conditionText(::StringW value);

  /// @brief Method set_hideCondition, addr 0x5834b10, size 0x34, virtual false, abstract: false, final false
  inline void set_hideCondition(bool value);

  /// @brief Method set_title, addr 0x5834ad0, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ObjectiveListItem) == 0x30, "Size mismatch!");
