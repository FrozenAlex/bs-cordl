...
MARK_REF_T(::GlobalNamespace::ObjectsMovementRecorder*);
MARK_REF_T(::GlobalNamespace::ObjectsMovementRecorder_InitData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ObjectsMovementRecorder_CameraView, "", "ObjectsMovementRecorder/CameraView");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ObjectsMovementRecorder_Mode, "", "ObjectsMovementRecorder/Mode");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ObjectsMovementRecorder*, "", "ObjectsMovementRecorder");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ObjectsMovementRecorder_InitData*, "", "ObjectsMovementRecorder/InitData");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::ObjectsMovementRecorder_Mode) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::ObjectsMovementRecorder_CameraView) == 0x4, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies ObjectsMovementRecorder::CameraView, ObjectsMovementRecorder::Mode, PlaybackRenderer::PlaybackScreenshot, System.Object
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  static inline ::GlobalNamespace::ObjectsMovementRecorder_InitData* New_ctor(::GlobalNamespace::ObjectsMovementRecorder_Mode mode, ::StringW recordingPath,
                                                                              ::GlobalNamespace::ObjectsMovementRecorder_CameraView cameraView, bool addDateTimeSuffixToRecordingName,
  ...
  /// @brief Method .ctor, addr 0x58e4ed4, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::ObjectsMovementRecorder_Mode mode, ::StringW recordingPath, ::GlobalNamespace::ObjectsMovementRecorder_CameraView cameraView,
                    ...
                    ::ArrayW<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*> playbackScreenshots, bool saveToOldFormat, ::GlobalNamespace::IBeatSaberLogger* logger,
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__playbackScreenshots, put = __cordl_internal_set__playbackScreenshots)) ::ArrayW<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*>
      _playbackScreenshots;

  /// @brief Field _poseObjects, offset 0x20, size 0x8
  __declspec(property(get = __cordl_internal_get__poseObjects, put = __cordl_internal_set__poseObjects)) ::ArrayW<::GlobalNamespace::PoseObject*> _poseObjects;
  ...
  /// @brief Method HandleGameStateChanged, addr 0x58e4d58, size 0x74, virtual false, abstract: false, final false
  inline void HandleGameStateChanged();

  /// @brief Method Init, addr 0x58e3cf4, size 0x6b0, virtual false, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::ObjectsMovementRecorder* New_ctor();

  /// @brief Method OnDestroy, addr 0x58e4ad8, size 0x268, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*> const& __cordl_internal_get__playbackScreenshots() const;

  constexpr ::ArrayW<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*>& __cordl_internal_get__playbackScreenshots();

  constexpr ::ArrayW<::GlobalNamespace::PoseObject*> const& __cordl_internal_get__poseObjects() const;

  constexpr ::ArrayW<::GlobalNamespace::PoseObject*>& __cordl_internal_get__poseObjects();
  ...
  constexpr void __cordl_internal_set__playbackScreenshots(::ArrayW<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*> value);

  constexpr void __cordl_internal_set__poseObjects(::ArrayW<::GlobalNamespace::PoseObject*> value);
  ...
  /// @brief Method .ctor, addr 0x58e4ec8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*> ____playbackScreenshots;
...
static_assert(sizeof(::GlobalNamespace::ObjectsMovementRecorder) == 0xa8, "Size mismatch!");
