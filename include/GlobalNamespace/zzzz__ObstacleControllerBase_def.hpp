...
public:
  ...
  /// @brief Method InvokeDidInitEvent, addr 0x58da20c, size 0x1c, virtual false, abstract: false, final false
  inline void InvokeDidInitEvent(::GlobalNamespace::ObstacleControllerBase* obstacleController);

  /// @brief Method InvokeDidStartDissolvingEvent, addr 0x58da248, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58da268, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didInitEvent, addr 0x58db1f8, size 0xc0, virtual false, abstract: false, final false
  inline void add_didInitEvent(::System::Action_1<::UnityW<::GlobalNamespace::ObstacleControllerBase>>* value);

  /// @brief Method add_didStartDissolvingEvent, addr 0x58da14c, size 0xc0, virtual false, abstract: false, final false
  inline void add_didStartDissolvingEvent(::System::Action_2<::UnityW<::GlobalNamespace::ObstacleControllerBase>, float_t>* value);

  /// @brief Method remove_didInitEvent, addr 0x58db2b8, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didInitEvent(::System::Action_1<::UnityW<::GlobalNamespace::ObstacleControllerBase>>* value);

  /// @brief Method remove_didStartDissolvingEvent, addr 0x58da08c, size 0xc0, virtual false, abstract: false, final false
