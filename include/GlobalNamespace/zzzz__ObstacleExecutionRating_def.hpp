...
MARK_REF_T(::GlobalNamespace::ObstacleExecutionRating*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ObstacleExecutionRating_Rating, "", "ObstacleExecutionRating/Rating");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ObstacleExecutionRating*, "", "ObstacleExecutionRating");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::ObstacleExecutionRating_Rating) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x373967c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(float_t time, ::GlobalNamespace::ObstacleExecutionRating_Rating rating);

  /// @brief Method get_rating, addr 0x3739674, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ObstacleExecutionRating) == 0x18, "Size mismatch!");
