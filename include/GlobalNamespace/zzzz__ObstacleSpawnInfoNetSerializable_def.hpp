...
// Write type traits
MARK_REF_T(::GlobalNamespace::ObstacleSpawnInfoNetSerializable*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ObstacleSpawnInfoNetSerializable*, "", "ObstacleSpawnInfoNetSerializable");
...
public:
  ...
  /// @brief Method Deserialize, addr 0x377a73c, size 0x130, virtual true, abstract: false, final false
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x377a4d8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method Obtain, addr 0x377a46c, size 0x6c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::ObstacleSpawnInfoNetSerializable* Obtain();

  /// @brief Method Serialize, addr 0x377a5b0, size 0x18c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x377a558, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ObstacleSpawnInfoNetSerializable) == 0x50, "Size mismatch!");
