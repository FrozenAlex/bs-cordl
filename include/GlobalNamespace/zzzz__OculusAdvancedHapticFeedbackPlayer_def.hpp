...
// Write type traits
MARK_REF_T(::GlobalNamespace::OculusAdvancedHapticFeedbackPlayer*);
MARK_REF_T(::GlobalNamespace::OculusAdvancedHapticFeedbackPlayer_HapticPlayerState*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OculusAdvancedHapticFeedbackPlayer*, "", "OculusAdvancedHapticFeedbackPlayer");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OculusAdvancedHapticFeedbackPlayer_HapticPlayerState*, "", "OculusAdvancedHapticFeedbackPlayer/HapticPlayerState");
...
static_assert(sizeof(::GlobalNamespace::OculusAdvancedHapticFeedbackPlayer_HapticPlayerState) == 0x20, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::OculusAdvancedHapticFeedbackPlayer) == 0x28, "Size mismatch!");
