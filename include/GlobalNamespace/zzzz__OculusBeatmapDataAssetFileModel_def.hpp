...
// Write type traits
MARK_REF_T(::GlobalNamespace::OculusBeatmapDataAssetFileModel*);
MARK_REF_T(::GlobalNamespace::OculusBeatmapDataAssetFileModel_AssetBundleDownloadingData*);
MARK_REF_T(::GlobalNamespace::OculusBeatmapDataAssetFileModel___c__DisplayClass18_0*);
...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OculusBeatmapDataAssetFileModel*, "", "OculusBeatmapDataAssetFileModel");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OculusBeatmapDataAssetFileModel_AssetBundleDownloadingData*, "", "OculusBeatmapDataAssetFileModel/AssetBundleDownloadingData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OculusBeatmapDataAssetFileModel___c__DisplayClass18_0*, "", "OculusBeatmapDataAssetFileModel/<>c__DisplayClass18_0");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OculusBeatmapDataAssetFileModel__GetAssetBundleFileForBeatmapLevelAsync_d__19, "",
                    "OculusBeatmapDataAssetFileModel/<GetAssetBundleFileForBeatmapLevelAsync>d__19");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OculusBeatmapDataAssetFileModel__HandleAssetFileDownloadUpdateAsync_d__24, "", "OculusBeatmapDataAssetFileModel/<HandleAssetFileDownloadUpdateAsync>d__24");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OculusBeatmapDataAssetFileModel__ReloadAssetDetailsForAllLevelsAsync_d__21, "", "OculusBeatmapDataAssetFileModel/<ReloadAssetDetailsForAllLevelsAsync>d__21");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OculusBeatmapDataAssetFileModel__TryDeleteAssetBundleFileForBeatmapLevelAsync_d__20, "",
...
public:
  ...
  /// @brief Method GetLevelDataAssetDownloadUpdate, addr 0x36805a8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3680ebc, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_debugInfo, addr 0x36805d0, size 0x9c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::OculusBeatmapDataAssetFileModel_AssetBundleDownloadingData) == 0x50, "Size mismatch!");
...
public:
  ...
  /// @brief Method <StartMostRecentlyRequestedDownload>b__0, addr 0x3681740, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36805cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::OculusBeatmapDataAssetFileModel___c__DisplayClass18_0) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x368195c, size 0x888, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x36821e4, size 0x80, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::OculusBeatmapDataAssetFileModel__GetAssetBundleFileForBeatmapLevelAsync_d__19) == 0x60, "Size mismatch!");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3682264, size 0xc04, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3682e68, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
static_assert(sizeof(::GlobalNamespace::OculusBeatmapDataAssetFileModel__HandleAssetFileDownloadUpdateAsync_d__24) == 0x50, "Size mismatch!");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3682ed4, size 0xa9c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3683970, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
static_assert(sizeof(::GlobalNamespace::OculusBeatmapDataAssetFileModel__ReloadAssetDetailsForAllLevelsAsync_d__21) == 0x40, "Size mismatch!");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x36839f0, size 0x974, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3684364, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
static_assert(sizeof(::GlobalNamespace::OculusBeatmapDataAssetFileModel__TryDeleteAssetBundleFileForBeatmapLevelAsync_d__20) == 0x60, "Size mismatch!");
...
public:
  ...
  /// @brief Method CancelDownload, addr 0x36804a0, size 0x108, virtual false, abstract: false, final false
  inline void CancelDownload(uint64_t assetId);

  /// @brief Method CancelNotRespondingDownloads, addr 0x367fd3c, size 0x128, virtual false, abstract: false, final false
  inline void CancelNotRespondingDownloads(float_t currentTimeSeconds);

  /// @brief Method GetAssetBundleFileForBeatmapLevelAsync, addr 0x368066c, size 0x108, virtual true, abstract: false, final true
  ...
  /// @brief Method GetCurrentTimeSeconds, addr 0x367fd14, size 0x28, virtual false, abstract: false, final false
  inline float_t GetCurrentTimeSeconds();

  /// @brief Method GetDownloadAssetBundleFileAsync, addr 0x3680964, size 0x558, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleAssetFileDownloadUpdate, addr 0x3680fb0, size 0xa8, virtual false, abstract: false, final false
  inline void HandleAssetFileDownloadUpdate(::Oculus::Platform::Message_1<::Oculus::Platform::Models::AssetFileDownloadUpdate*>* msg);

  /// @brief Method HandleAssetFileDownloadUpdateAsync, addr 0x3681058, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method MarkDownloadCompleted, addr 0x368111c, size 0x324, virtual false, abstract: false, final false
  ...
  /// @brief Method NotifyRecentlyRequestedDownloads, addr 0x367fe64, size 0x1b4, virtual false, abstract: false, final false
  inline void NotifyRecentlyRequestedDownloads(float_t currentTimeSeconds);

  /// @brief Method ReloadAssetDetailsForAllLevelsAsync, addr 0x3680878, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveFromDownloadingDataStructures, addr 0x3681440, size 0x300, virtual false, abstract: false, final false
  inline bool RemoveFromDownloadingDataStructures(uint64_t assetId);

  /// @brief Method StartMostRecentlyRequestedDownload, addr 0x3680018, size 0x488, virtual false, abstract: false, final false
  inline void StartMostRecentlyRequestedDownload(float_t currentTimeSeconds);

  /// @brief Method Tick, addr 0x367fcb0, size 0x64, virtual true, abstract: false, final true
  inline void Tick();

  /// @brief Method TryDeleteAssetBundleFileForBeatmapLevelAsync, addr 0x3680774, size 0x104, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x367fa60, size 0x250, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::OculusPlatformAdditionalContentModel* oculusPlatformAdditionalContentModel);

  /// @brief Method add_levelDataAssetDownloadUpdateEvent, addr 0x367f8e0, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_levelDataAssetDownloadUpdateEvent, addr 0x367f9a0, size 0xc0, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::OculusBeatmapDataAssetFileModel) == 0x50, "Size mismatch!");
