...
public:
  ...
  /// @brief Method ILevelPackProductDataContainer<OculusLevelProductCollectionModel.LevelPackProductData,OculusLevelProductCollectionModel.LevelProductData>.SetLevelPackProductData, addr 0x36852b0,
  ...
  /// @brief Method .ctor, addr 0x36852b8, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_levelPackProductData, addr 0x36852a0, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::OculusLevelProductCollectionModel_LevelPackProductData* get_levelPackProductData();

  /// @brief Method get_levelPackRedirectionData, addr 0x36852a8, size 0x8, virtual false, abstract: false, final false
