...
// Write type traits
MARK_REF_T(::GlobalNamespace::OculusLevelProductPacksSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OculusLevelProductPacksSO*, "", "OculusLevelProductPacksSO");
// Dependencies OculusLevelProductCollectionModel::LevelPackRedirectionData, PersistentScriptableObject
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method ILevelPackProductDataContainer<OculusLevelProductCollectionModel.LevelPackProductData,OculusLevelProductCollectionModel.LevelProductData>.SetLevelPackProductData, addr 0x373f058,
  ...
  constexpr ::ArrayW<::GlobalNamespace::OculusLevelProductCollectionModel_LevelPackRedirectionData*> const& __cordl_internal_get__levelPackRedirectionData() const;

  constexpr ::ArrayW<::GlobalNamespace::OculusLevelProductCollectionModel_LevelPackRedirectionData*>& __cordl_internal_get__levelPackRedirectionData();
  ...
  constexpr void __cordl_internal_set__levelPackRedirectionData(::ArrayW<::GlobalNamespace::OculusLevelProductCollectionModel_LevelPackRedirectionData*> value);

  /// @brief Method .ctor, addr 0x373f060, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_levelPackProductData, addr 0x373f048, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::OculusLevelProductCollectionModel_LevelPackProductData* get_levelPackProductData();

  /// @brief Method get_levelPackRedirectionData, addr 0x373f050, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::GlobalNamespace::OculusLevelProductCollectionModel_LevelPackRedirectionData*> ____levelPackRedirectionData;
...
static_assert(sizeof(::GlobalNamespace::OculusLevelProductPacksSO) == 0x28, "Size mismatch!");
