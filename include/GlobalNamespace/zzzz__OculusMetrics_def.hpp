...
// Write type traits
MARK_REF_T(::GlobalNamespace::OculusMetrics*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OculusMetrics*, "", "OculusMetrics");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__sample, put = __cordl_internal_set__sample)) ::ArrayW<float_t> _sample;
  ...
  constexpr ::ArrayW<float_t> const& __cordl_internal_get__sample() const;

  constexpr ::ArrayW<float_t>& __cordl_internal_get__sample();
  ...
  constexpr void __cordl_internal_set__sample(::ArrayW<float_t> value);
...
static_assert(sizeof(::GlobalNamespace::OculusMetrics) == 0x28, "Size mismatch!");
