...
public:
  ...
  /// @brief Method .ctor, addr 0x3705db4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW experimentPlatformKey);

  /// @brief Method get_experimentPlatformKey, addr 0x3705dac, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3705dbc, size 0x470, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x370622c, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Init, addr 0x3705d04, size 0xa4, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x3705da8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
