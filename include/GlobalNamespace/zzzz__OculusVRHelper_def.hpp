...
// Write type traits
MARK_REF_T(::GlobalNamespace::OculusVRHelper*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OculusVRHelper*, "", "OculusVRHelper");
...
public:
  ...
  /// @brief Method DisableEventSystem, addr 0x57f8070, size 0x104, virtual false, abstract: false, final false
  inline void DisableEventSystem();

  /// @brief Method EnableEventSystem, addr 0x57f8174, size 0x88, virtual false, abstract: false, final false
  inline void EnableEventSystem();

  /// @brief Method FixedUpdate, addr 0x57f81fc, size 0x68, virtual false, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method GetAnyJoystickMaxAxis, addr 0x57f8848, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector2 GetAnyJoystickMaxAxis();

  /// @brief Method GetInteractionProfile, addr 0x57f8a00, size 0x80, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRInput_InteractionProfile GetInteractionProfile(::UnityEngine::XR::XRNode node);

  /// @brief Method GetMenuButton, addr 0x57f8a90, size 0x5c, virtual true, abstract: false, final true
  inline bool GetMenuButton();

  /// @brief Method GetMenuButtonDown, addr 0x57f8aec, size 0xc8, virtual true, abstract: false, final true
  inline bool GetMenuButtonDown();

  /// @brief Method GetNodePose, addr 0x57f8498, size 0x1a4, virtual true, abstract: false, final true
  ...
  /// @brief Method GetRootPositionOffsetForLegacyNodePose, addr 0x57f8740, size 0x78, virtual true, abstract: false, final true
  inline ::UnityEngine::Pose GetRootPositionOffsetForLegacyNodePose(::UnityEngine::XR::XRNode node);

  /// @brief Method GetThumbstickValue, addr 0x57f88f4, size 0x10c, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector2 GetThumbstickValue(::UnityEngine::XR::XRNode node);

  /// @brief Method GetTriggerValue, addr 0x57f8850, size 0xa4, virtual true, abstract: false, final true
  inline float_t GetTriggerValue(::UnityEngine::XR::XRNode node);

  /// @brief Method IsAdvancedHapticsSupported, addr 0x57f8a80, size 0x10, virtual true, abstract: false, final true
  inline bool IsAdvancedHapticsSupported(::UnityEngine::XR::XRNode node);

  /// @brief Method LateUpdate, addr 0x57f8264, size 0x68, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::OculusVRHelper* New_ctor();

  /// @brief Method RefreshControllersReference, addr 0x57f8bb4, size 0x1c, virtual true, abstract: false, final true
  inline void RefreshControllersReference();

  /// @brief Method StopHaptics, addr 0x57f8348, size 0x6c, virtual true, abstract: false, final true
  inline void StopHaptics(::UnityEngine::XR::XRNode node);

  /// @brief Method TriggerHapticPulse, addr 0x57f82cc, size 0x7c, virtual true, abstract: false, final true
  inline void TriggerHapticPulse(::UnityEngine::XR::XRNode node, float_t duration, float_t strength, float_t frequency);

  /// @brief Method TryGetLegacyPoseOffsetForNode, addr 0x57f87b8, size 0x90, virtual true, abstract: false, final true
  ...
  /// @brief Method TryGetPoseOffsetForNode, addr 0x57f83b4, size 0xe4, virtual true, abstract: false, final true
  inline bool TryGetPoseOffsetForNode(::UnityEngine::XR::XRNode node, ::by_ref<::UnityEngine::Pose> poseOffset);

  /// @brief Method Update, addr 0x57f7d98, size 0x2d8, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method XRNodeToOVRNode, addr 0x57f863c, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57f8bd0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_controllersDidChangeReferenceEvent, addr 0x57f7918, size 0xac, virtual true, abstract: false, final true
  inline void add_controllersDidChangeReferenceEvent(::System::Action* value);

  /// @brief Method add_controllersDidDisconnectEvent, addr 0x57f7a70, size 0xac, virtual true, abstract: false, final true
  inline void add_controllersDidDisconnectEvent(::System::Action* value);

  /// @brief Method add_hmdMountedEvent, addr 0x57f77c0, size 0xac, virtual true, abstract: false, final true
  inline void add_hmdMountedEvent(::System::Action* value);

  /// @brief Method add_hmdUnmountedEvent, addr 0x57f7668, size 0xac, virtual true, abstract: false, final true
  inline void add_hmdUnmountedEvent(::System::Action* value);

  /// @brief Method add_inputFocusWasCapturedEvent, addr 0x57f7108, size 0xac, virtual true, abstract: false, final true
  inline void add_inputFocusWasCapturedEvent(::System::Action* value);

  /// @brief Method add_inputFocusWasReleasedEvent, addr 0x57f7260, size 0xac, virtual true, abstract: false, final true
  inline void add_inputFocusWasReleasedEvent(::System::Action* value);

  /// @brief Method add_vrFocusWasCapturedEvent, addr 0x57f73b8, size 0xac, virtual true, abstract: false, final true
  inline void add_vrFocusWasCapturedEvent(::System::Action* value);

  /// @brief Method add_vrFocusWasReleasedEvent, addr 0x57f7510, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method get__isOVRManagerPresent, addr 0x57f7ccc, size 0xcc, virtual false, abstract: false, final false
  inline bool get__isOVRManagerPresent();

  /// @brief Method get_hasInputFocus, addr 0x57f7bc8, size 0x54, virtual true, abstract: false, final true
  inline bool get_hasInputFocus();

  /// @brief Method get_hasVrFocus, addr 0x57f7c1c, size 0x54, virtual true, abstract: false, final true
  inline bool get_hasVrFocus();

  /// @brief Method get_isAlwaysWireless, addr 0x57f7c70, size 0x8, virtual true, abstract: false, final true
  inline bool get_isAlwaysWireless();

  /// @brief Method get_isHmdMounted, addr 0x57f7cc4, size 0x8, virtual true, abstract: false, final true
  inline bool get_isHmdMounted();

  /// @brief Method get_loggerPrefix, addr 0x57f7c80, size 0x44, virtual true, abstract: false, final true
  inline ::StringW get_loggerPrefix();

  /// @brief Method get_vrPlatformSDK, addr 0x57f7c78, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_controllersDidChangeReferenceEvent, addr 0x57f79c4, size 0xac, virtual true, abstract: false, final true
  inline void remove_controllersDidChangeReferenceEvent(::System::Action* value);

  /// @brief Method remove_controllersDidDisconnectEvent, addr 0x57f7b1c, size 0xac, virtual true, abstract: false, final true
  inline void remove_controllersDidDisconnectEvent(::System::Action* value);

  /// @brief Method remove_hmdMountedEvent, addr 0x57f786c, size 0xac, virtual true, abstract: false, final true
  inline void remove_hmdMountedEvent(::System::Action* value);

  /// @brief Method remove_hmdUnmountedEvent, addr 0x57f7714, size 0xac, virtual true, abstract: false, final true
  inline void remove_hmdUnmountedEvent(::System::Action* value);

  /// @brief Method remove_inputFocusWasCapturedEvent, addr 0x57f71b4, size 0xac, virtual true, abstract: false, final true
  inline void remove_inputFocusWasCapturedEvent(::System::Action* value);

  /// @brief Method remove_inputFocusWasReleasedEvent, addr 0x57f730c, size 0xac, virtual true, abstract: false, final true
  inline void remove_inputFocusWasReleasedEvent(::System::Action* value);

  /// @brief Method remove_vrFocusWasCapturedEvent, addr 0x57f7464, size 0xac, virtual true, abstract: false, final true
  inline void remove_vrFocusWasCapturedEvent(::System::Action* value);

  /// @brief Method remove_vrFocusWasReleasedEvent, addr 0x57f75bc, size 0xac, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::OculusVRHelper) == 0x78, "Size mismatch!");
