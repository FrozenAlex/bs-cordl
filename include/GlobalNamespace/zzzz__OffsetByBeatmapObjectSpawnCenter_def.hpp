...
// Write type traits
MARK_REF_T(::GlobalNamespace::OffsetByBeatmapObjectSpawnCenter*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OffsetByBeatmapObjectSpawnCenter*, "", "OffsetByBeatmapObjectSpawnCenter");
...
public:
  ...
  /// @brief Method HandleSpawnCenterDistanceWasFound, addr 0x58c03f4, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x58c0310, size 0xe4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x58c045c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::OffsetByBeatmapObjectSpawnCenter) == 0x28, "Size mismatch!");
