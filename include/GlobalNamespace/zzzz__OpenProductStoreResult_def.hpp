...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OpenProductStoreResult, "", "OpenProductStoreResult");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
public:
  ...
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23625 };
...
static_assert(sizeof(::GlobalNamespace::OpenProductStoreResult) == 0x4, "Size mismatch!");
