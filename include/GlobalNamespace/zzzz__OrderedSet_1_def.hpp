...
MARK_GEN_REF_T_PTR(::GlobalNamespace::OrderedSet_1);
MARK_GEN_REF_T_PTR(::GlobalNamespace::OrderedSet_1_Node);
MARK_GEN_REF_T_PTR(::GlobalNamespace::OrderedSet_1__GetEnumerator_d__23);
DEFINE_IL2CPP_GEN_CLASS(::GlobalNamespace::OrderedSet_1_ProcessOrder, "", "OrderedSet`1/ProcessOrder");
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::OrderedSet_1, "", "OrderedSet`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::OrderedSet_1_Node, "", "OrderedSet`1/Node");
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::OrderedSet_1__GetEnumerator_d__23, "", "OrderedSet`1/<GetEnumerator>d__23");
// Dependencies
namespace GlobalNamespace {
// cpp template
template <typename T>
...
public:
  ...
  inline bool TryGetFirst(::by_ref<T> value);
