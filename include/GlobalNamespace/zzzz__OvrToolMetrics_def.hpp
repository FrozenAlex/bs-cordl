...
public:
  ...
  /// @brief Method CaptureFrame, addr 0x58ecdd0, size 0x6a0, virtual false, abstract: false, final false
  inline void CaptureFrame();

  /// @brief Method Dispose, addr 0x58ecdcc, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GenerateListReport, addr 0x58ed470, size 0x1fc, virtual false, abstract: false, final false
  inline ::StringW GenerateListReport();

  /// @brief Method GenerateTableReport, addr 0x58ed66c, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method RecordMetrics, addr 0x58ec184, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58ec234, size 0xb98, virtual false, abstract: false, final false
