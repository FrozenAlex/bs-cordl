...
// Write type traits
MARK_REF_T(::GlobalNamespace::PackLevelListHeaderTableCell*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PackLevelListHeaderTableCell*, "", "PackLevelListHeaderTableCell");
...
public:
  // Declarations
  /// @brief Field _arrowImage, offset 0xa0, size 0x8
  ...
  /// @brief Field _cancellationTokenSource, offset 0xa8, size 0x8
  ...
  /// @brief Field _selectedHighlightElementsColor, offset 0x78, size 0x10
...
public:
  ...
  /// @brief Field _arrowImage, offset: 0xa0, size: 0x8, def value: None
  ::UnityW<::UnityEngine::UI::Image> ____arrowImage;

  /// @brief Field _cancellationTokenSource, offset: 0xa8, size: 0x8, def value: None
  ::System::Threading::CancellationTokenSource* ____cancellationTokenSource;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::PackLevelListHeaderTableCell, ____selectedHighlightElementsColor) == 0x78, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PackLevelListHeaderTableCell, ____text) == 0x88, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PackLevelListHeaderTableCell, ____bgImage) == 0x90, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PackLevelListHeaderTableCell, ____highlightImage) == 0x98, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PackLevelListHeaderTableCell, ____arrowImage) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PackLevelListHeaderTableCell, ____cancellationTokenSource) == 0xa8, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::PackLevelListHeaderTableCell) == 0xb0, "Size mismatch!");
