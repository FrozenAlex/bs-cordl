...
// Write type traits
MARK_REF_T(::GlobalNamespace::Parametric3SliceSpriteWidthEndFloatFxEffectTarget*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::Parametric3SliceSpriteWidthEndFloatFxEffectTarget*, "", "Parametric3SliceSpriteWidthEndFloatFxEffectTarget");
...
public:
  ...
  /// @brief Method SetValue, addr 0x585742c, size 0xa4, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x58574d0, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5857574, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::Parametric3SliceSpriteWidthEndFloatFxEffectTarget) == 0x38, "Size mismatch!");
