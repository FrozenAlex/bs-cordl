...
public:
  ...
  /// @brief Method Update, addr 0x5867a30, size 0x14, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5867a44, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::Parametric3SliceUpdater) == 0x28, "Size mismatch!");
