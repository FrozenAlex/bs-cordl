...
public:
  ...
  /// @brief Method Awake, addr 0x57230e0, size 0x1c, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::ParametricBoxFrameController* New_ctor();

  /// @brief Method OnDisable, addr 0x5723234, size 0x1c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x57230fc, size 0x28, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Refresh, addr 0x5723124, size 0x110, virtual false, abstract: false, final false
  inline void Refresh();
  ...
  /// @brief Method .ctor, addr 0x5723250, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_localPosition, addr 0x5723078, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method set_localPosition, addr 0x5723098, size 0x48, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ParametricBoxFrameController) == 0x50, "Size mismatch!");
