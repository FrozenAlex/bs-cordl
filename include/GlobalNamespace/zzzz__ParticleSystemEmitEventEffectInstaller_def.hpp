...
// Write type traits
MARK_REF_T(::GlobalNamespace::ParticleSystemEmitEventEffectInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ParticleSystemEmitEventEffectInstaller*, "", "ParticleSystemEmitEventEffectInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x5997c58, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5997cfc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ParticleSystemEmitEventEffectInstaller) == 0x38, "Size mismatch!");
