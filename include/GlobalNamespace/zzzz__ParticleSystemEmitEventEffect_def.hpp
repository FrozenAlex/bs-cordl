...
// Write type traits
MARK_REF_T(::GlobalNamespace::ParticleSystemEmitEventEffect*);
MARK_REF_T(::GlobalNamespace::ParticleSystemEmitEventEffect_BeatmapEditorParticleSystemEmitBehavior*);
MARK_REF_T(::GlobalNamespace::ParticleSystemEmitEventEffect_GameplayParticleSystemEmitBehavior*);
MARK_REF_T(::GlobalNamespace::ParticleSystemEmitEventEffect_ParticleSystemEmitBehavior*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ParticleSystemEmitEventEffect*, "", "ParticleSystemEmitEventEffect");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ParticleSystemEmitEventEffect_BeatmapEditorParticleSystemEmitBehavior*, "", "ParticleSystemEmitEventEffect/BeatmapEditorParticleSystemEmitBehavior");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ParticleSystemEmitEventEffect_GameplayParticleSystemEmitBehavior*, "", "ParticleSystemEmitEventEffect/GameplayParticleSystemEmitBehavior");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ParticleSystemEmitEventEffect_ParticleSystemEmitBehavior*, "", "ParticleSystemEmitEventEffect/ParticleSystemEmitBehavior");
...
public:
  ...
  /// @brief Method Dispose, addr 0x5996cdc, size 0x158, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method EmitParticles, addr 0x5996fd0, size 0x188, virtual true, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::ParticleSystemEventController> EmitParticles(float_t startTime);

  /// @brief Method HandleBeatmapEvent, addr 0x5996e50, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5996b38, size 0x1a4, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ParticleSystemEmitEventEffect_ParticleSystemEmitBehavior) == 0x40, "Size mismatch!");
...
public:
  ...
  /// @brief Method Dispose, addr 0x5997580, size 0x28, virtual true, abstract: false, final false
  inline void Dispose();
  ...
  /// @brief Method Tick, addr 0x59971bc, size 0x350, virtual true, abstract: false, final true
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x5997184, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BasicBeatmapEventType beatmapEvent, ::UnityEngine::Transform* particleSystemParentTransform, int32_t particleSystemMaxSpawnedSystems,
                    ::GlobalNamespace::IAudioTimeSource* audioTimeSource, ::GlobalNamespace::BeatmapCallbacksController* beatmapCallbacksController,
                    ::GlobalNamespace::ParticleSystemEventController_Pool* particleSystemEventControllerPool, ::Zenject::TickableManager* tickableManager);
...
static_assert(sizeof(::GlobalNamespace::ParticleSystemEmitEventEffect_BeatmapEditorParticleSystemEmitBehavior) == 0x48, "Size mismatch!");
...
public:
  ...
  /// @brief Method Dispose, addr 0x5997718, size 0x194, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method EmitParticles, addr 0x5997b44, size 0xc0, virtual true, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::ParticleSystemEventController> EmitParticles(float_t startTime);

  /// @brief Method HandlePauseControllerDidPause, addr 0x59978ac, size 0x134, virtual false, abstract: false, final false
  inline void HandlePauseControllerDidPause();

  /// @brief Method HandlePauseControllerDidResume, addr 0x59979f8, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59975a8, size 0x170, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BasicBeatmapEventType beatmapEvent, ::UnityEngine::Transform* particleSystemParentTransform, int32_t particleSystemMaxSpawnedSystems,
                    ::GlobalNamespace::IAudioTimeSource* audioTimeSource, ::GlobalNamespace::BeatmapCallbacksController* beatmapCallbacksController,
                    ::GlobalNamespace::ParticleSystemEventController_Pool* particleSystemEventControllerPool, ::GlobalNamespace::PauseController* pauseController,
                    ::GlobalNamespace::SongSpeedData* songSpeedData);
...
static_assert(sizeof(::GlobalNamespace::ParticleSystemEmitEventEffect_GameplayParticleSystemEmitBehavior) == 0x50, "Size mismatch!");
...
public:
  ...
  /// @brief Method OnDestroy, addr 0x5996b14, size 0x18, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x59968a8, size 0x26c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5996b2c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ParticleSystemEmitEventEffect) == 0x48, "Size mismatch!");
