...
// Write type traits
MARK_REF_T(::GlobalNamespace::ParticleSystemEventController*);
MARK_REF_T(::GlobalNamespace::ParticleSystemEventController_Pool*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ParticleSystemEventController*, "", "ParticleSystemEventController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ParticleSystemEventController_Pool*, "", "ParticleSystemEventController/Pool");
...
static_assert(sizeof(::GlobalNamespace::ParticleSystemEventController_Pool) == 0x40, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::ParticleSystemEventController) == 0x30, "Size mismatch!");
