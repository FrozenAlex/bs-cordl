...
// Write type traits
MARK_REF_T(::GlobalNamespace::ParticleSystemLightWithIds*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ParticleSystemLightWithIds*, "", "ParticleSystemLightWithIds");
// Dependencies RuntimeLightWithIds, UnityEngine.ParticleSystem::MainModule, UnityEngine.ParticleSystem::Particle
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method Awake, addr 0x572bb14, size 0x9c, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method ColorWasSet, addr 0x572bbb0, size 0x17c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x572bd2c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ParticleSystemLightWithIds) == 0x70, "Size mismatch!");
