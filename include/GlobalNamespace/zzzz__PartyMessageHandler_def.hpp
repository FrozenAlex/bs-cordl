...
MARK_REF_T(::GlobalNamespace::PartyMessageHandler*);
MARK_REF_T(::GlobalNamespace::PartyMessageHandler_ConnectToMasterServerDelegate*);
MARK_REF_T(::GlobalNamespace::PartyMessageHandler_ConnectToMasterServerMessage*);
MARK_REF_T(::GlobalNamespace::PartyMessageHandler_ServerStatusUpdatedDelegate*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PartyMessageHandler_MessageType, "", "PartyMessageHandler/MessageType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PartyMessageHandler*, "", "PartyMessageHandler");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PartyMessageHandler_ConnectToMasterServerDelegate*, "", "PartyMessageHandler/ConnectToMasterServerDelegate");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PartyMessageHandler_ConnectToMasterServerMessage*, "", "PartyMessageHandler/ConnectToMasterServerMessage");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PartyMessageHandler_ServerStatusUpdatedDelegate*, "", "PartyMessageHandler/ServerStatusUpdatedDelegate");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::PartyMessageHandler_MessageType) == 0x4, "Size mismatch!");
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x32201f8, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x32202b8, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x32201a8, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x322013c, size 0x6c, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::PartyMessageHandler_ServerStatusUpdatedDelegate) == 0x80, "Size mismatch!");
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x3220354, size 0x20, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::StringW secret, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x3220374, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x3220340, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32202c4, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::PartyMessageHandler_ConnectToMasterServerDelegate) == 0x80, "Size mismatch!");
...
public:
  ...
  /// @brief Method Deserialize, addr 0x32203a0, size 0x28, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x322009c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x32200e4, size 0x58, virtual true, abstract: false, final true
  inline void Release();

  /// @brief Method Serialize, addr 0x3220380, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32203c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_pool, addr 0x321fe0c, size 0x44, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PartyMessageHandler_ConnectToMasterServerMessage) == 0x18, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__serializer,
                      put = __cordl_internal_set__serializer)) ::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::PartyMessageHandler_MessageType,
                                                                                                            ::GlobalNamespace::IBeatSaberConnectedPlayer*>* _serializer;
  ...
  /// @brief Method ConnectToMasterServer, addr 0x3220004, size 0x98, virtual false, abstract: false, final false
  inline void ConnectToMasterServer(::StringW secret);

  /// @brief Method Dispose, addr 0x321fe50, size 0x5c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleConnectToMasterServer, addr 0x32200a4, size 0x40, virtual false, abstract: false, final false
  inline void HandleConnectToMasterServer(::GlobalNamespace::PartyMessageHandler_ConnectToMasterServerMessage* packet);

  static inline ::GlobalNamespace::PartyMessageHandler* New_ctor(::GlobalNamespace::BeatSaberConnectedPlayerManager* connectedPlayerManager);
  ...
  constexpr ::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::PartyMessageHandler_MessageType, ::GlobalNamespace::IBeatSaberConnectedPlayer*>*& __cordl_internal_get__serializer();
  ...
  constexpr void
  __cordl_internal_set__serializer(::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::PartyMessageHandler_MessageType, ::GlobalNamespace::IBeatSaberConnectedPlayer*>* value);
  ...
  /// @brief Method .ctor, addr 0x321fc5c, size 0x1b0, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BeatSaberConnectedPlayerManager* connectedPlayerManager);

  /// @brief Method add_connectToMasterServerEvent, addr 0x321feac, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_connectToMasterServerEvent, addr 0x321ff58, size 0xac, virtual false, abstract: false, final false
...
public:
  ...
  ::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::PartyMessageHandler_MessageType, ::GlobalNamespace::IBeatSaberConnectedPlayer*>* ____serializer;
...
static_assert(sizeof(::GlobalNamespace::PartyMessageHandler) == 0x28, "Size mismatch!");
