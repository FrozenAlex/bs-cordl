...
// Write type traits
MARK_REF_T(::GlobalNamespace::PerformanceConfigurationChecks*);
...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PerformanceConfigurationChecks*, "", "PerformanceConfigurationChecks");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PerformanceConfigurationChecks_AppConfig, "", "PerformanceConfigurationChecks/AppConfig");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PerformanceConfigurationChecks_LevelConfig, "", "PerformanceConfigurationChecks/LevelConfig");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PerformanceConfigurationChecks_Mismatch, "", "PerformanceConfigurationChecks/Mismatch");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PerformanceConfigurationChecks_PlayerConfig, "", "PerformanceConfigurationChecks/PlayerConfig");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PerformanceConfigurationChecks_XRConfig, "", "PerformanceConfigurationChecks/XRConfig");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::PerformanceConfigurationChecks_Mismatch) == 0x10, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::PerformanceConfigurationChecks_AppConfig) == 0x10, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::PerformanceConfigurationChecks_XRConfig) == 0x30, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::PerformanceConfigurationChecks_PlayerConfig) == 0x3c, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::PerformanceConfigurationChecks_LevelConfig) == 0x2, "Size mismatch!");
