...
// Write type traits
MARK_REF_T(::GlobalNamespace::PerformanceConfigurationStats*);
...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PerformanceConfigurationStats*, "", "PerformanceConfigurationStats");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PerformanceConfigurationStats_BoolStats, "", "PerformanceConfigurationStats/BoolStats");
DEFINE_IL2CPP_GEN_CLASS(::GlobalNamespace::PerformanceConfigurationStats_EnumStats_1, "", "PerformanceConfigurationStats/EnumStats`1");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PerformanceConfigurationStats_FloatStats, "", "PerformanceConfigurationStats/FloatStats");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PerformanceConfigurationStats_IntStats, "", "PerformanceConfigurationStats/IntStats");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
public:
  // Declarations
  /// @brief Method CreateLogValue, addr 0x58ef854, size 0xb0, virtual false, abstract: false, final false
  inline ::StringW CreateLogValue();

  /// @brief Method Update, addr 0x58ef838, size 0x1c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PerformanceConfigurationStats_BoolStats) == 0x8, "Size mismatch!");
...
public:
  ...
  /// @brief Method CreateLogValue, addr 0x58ef904, size 0xdc, virtual false, abstract: false, final false
  inline ::StringW CreateLogValue();

  /// @brief Method Update, addr 0x58ef67c, size 0x7c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PerformanceConfigurationStats_IntStats) == 0x8, "Size mismatch!");
...
public:
  ...
  /// @brief Method CreateLogValue, addr 0x58efa30, size 0xdc, virtual false, abstract: false, final false
  inline ::StringW CreateLogValue();

  /// @brief Method Update, addr 0x58ef6f8, size 0x98, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Update, addr 0x58ef4d8, size 0x1a4, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x58ef790, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::PerformanceConfigurationStats) == 0x40, "Size mismatch!");
