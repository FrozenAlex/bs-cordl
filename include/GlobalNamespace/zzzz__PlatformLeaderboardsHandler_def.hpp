...
// Write type traits
MARK_REF_T(::GlobalNamespace::PlatformLeaderboardsHandler*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlatformLeaderboardsHandler*, "", "PlatformLeaderboardsHandler");
...
public:
  ...
  /// @brief Method .ctor, addr 0x369b0b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::PlatformLeaderboardsHandler) == 0x10, "Size mismatch!");
