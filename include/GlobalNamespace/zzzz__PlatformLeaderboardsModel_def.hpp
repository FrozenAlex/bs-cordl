...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x369c7e8, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x369c894, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x369c7d4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369c560, size 0x6c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x369c8b4, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x369c93c, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x369c8a0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36980bc, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  ...
  /// @brief Method CompareTo, addr 0x369c948, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x369bad0, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <GetScores>b__26_2, addr 0x369c9c4, size 0x1c, virtual false, abstract: false, final false
  inline bool _GetScores_b__26_2(::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore* entry);

  /// @brief Method .ctor, addr 0x369c9c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetScores>b__0, addr 0x369c9e0, size 0x28, virtual false, abstract: false, final false
  inline void _GetScores_b__0(::GlobalNamespace::HMAsyncRequest* _);

  /// @brief Method <GetScores>b__3, addr 0x369cf8c, size 0xc0, virtual false, abstract: false, final false
  inline bool _GetScores_b__3(::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore* entry);

  /// @brief Method <GetScores>g__HandleGetScoresCompleted|1, addr 0x369ca08, size 0x584, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369c55c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::PlatformLeaderboardsModel___c__DisplayClass26_0) == 0x60, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetFriendsScores, addr 0x369c644, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetScores, addr 0x369c288, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetScores, addr 0x369c5e8, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetScoresAroundPlayer, addr 0x369c614, size 0x30, virtual false, abstract: false, final false
  inline ::GlobalNamespace::HMAsyncRequest* GetScoresAroundPlayer(::by_ref<::GlobalNamespace::BeatmapKey> beatmapKey, int32_t count,
                                                                  ::GlobalNamespace::PlatformLeaderboardsModel_GetScoresCompletionHandler* completionHandler);

  /// @brief Method HandleAllScoresDidUpload, addr 0x369c5cc, size 0x1c, virtual false, abstract: false, final false
  inline void HandleAllScoresDidUpload();

  /// @brief Method Initialize, addr 0x369bdb4, size 0x148, virtual false, abstract: false, final false
  inline void Initialize();

  /// @brief Method InitializeForUserInfo, addr 0x369c014, size 0x1f4, virtual false, abstract: false, final false
  inline void InitializeForUserInfo(uint64_t userId);

  static inline ::GlobalNamespace::PlatformLeaderboardsModel* New_ctor();

  /// @brief Method OnDestroy, addr 0x369befc, size 0x118, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method UploadScore, addr 0x369c208, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method UploadScore, addr 0x369c670, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369c7d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_allScoresDidUploadEvent, addr 0x369bc2c, size 0xac, virtual false, abstract: false, final false
  inline void add_allScoresDidUploadEvent(::System::Action* value);

  /// @brief Method get_initialized, addr 0x369bd8c, size 0x28, virtual false, abstract: false, final false
  inline bool get_initialized();

  /// @brief Method get_playerId, addr 0x369bd84, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_playerId();

  /// @brief Method remove_allScoresDidUploadEvent, addr 0x369bcd8, size 0xac, virtual false, abstract: false, final false
