...
MARK_REF_T(::GlobalNamespace::PlatformLeaderboardsModel*);
MARK_REF_T(::GlobalNamespace::PlatformLeaderboardsModel_GetScoresCompletionHandler*);
MARK_REF_T(::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*);
MARK_REF_T(::GlobalNamespace::PlatformLeaderboardsModel_UploadScoreCompletionHandler*);
MARK_REF_T(::GlobalNamespace::PlatformLeaderboardsModel___c*);
MARK_REF_T(::GlobalNamespace::PlatformLeaderboardsModel___c__DisplayClass26_0*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlatformLeaderboardsModel_GetScoresResult, "", "PlatformLeaderboardsModel/GetScoresResult");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlatformLeaderboardsModel_ScoresScope, "", "PlatformLeaderboardsModel/ScoresScope");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlatformLeaderboardsModel_State, "", "PlatformLeaderboardsModel/State");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlatformLeaderboardsModel_UploadScoreResult, "", "PlatformLeaderboardsModel/UploadScoreResult");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlatformLeaderboardsModel*, "", "PlatformLeaderboardsModel");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlatformLeaderboardsModel_GetScoresCompletionHandler*, "", "PlatformLeaderboardsModel/GetScoresCompletionHandler");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*, "", "PlatformLeaderboardsModel/LeaderboardScore");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlatformLeaderboardsModel_UploadScoreCompletionHandler*, "", "PlatformLeaderboardsModel/UploadScoreCompletionHandler");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlatformLeaderboardsModel___c*, "", "PlatformLeaderboardsModel/<>c");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlatformLeaderboardsModel___c__DisplayClass26_0*, "", "PlatformLeaderboardsModel/<>c__DisplayClass26_0");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::PlatformLeaderboardsModel_State) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::PlatformLeaderboardsModel_GetScoresResult) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::PlatformLeaderboardsModel_UploadScoreResult) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::PlatformLeaderboardsModel_ScoresScope) == 0x4, "Size mismatch!");
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x375737c, size 0xac, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::GlobalNamespace::PlatformLeaderboardsModel_GetScoresResult result, ::ArrayW<::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*> scores,
                                             int32_t referencePlayerScoreIndex, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x3757428, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x3757368, size 0x14, virtual true, abstract: false, final false
  inline void Invoke(::GlobalNamespace::PlatformLeaderboardsModel_GetScoresResult result, ::ArrayW<::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*> scores,
  ...
  /// @brief Method .ctor, addr 0x37572fc, size 0x6c, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::PlatformLeaderboardsModel_GetScoresCompletionHandler) == 0x80, "Size mismatch!");
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x37574b4, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x375753c, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x37574a0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3757434, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::PlatformLeaderboardsModel_UploadScoreCompletionHandler) == 0x80, "Size mismatch!");
...
public:
  ...
  /// @brief Method CompareTo, addr 0x3757554, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3757548, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <GetScores>b__26_2, addr 0x37575d0, size 0x1c, virtual false, abstract: false, final false
  inline bool _GetScores_b__26_2(::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore* entry);

  /// @brief Method .ctor, addr 0x37575cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field beatmapKey, offset 0x38, size 0x10
  ...
  /// @brief Field fromRank, offset 0x48, size 0x4
  ...
  /// @brief Field scope, offset 0x4c, size 0x4
  ...
  /// @brief Method <GetScores>b__0, addr 0x37575f0, size 0x28, virtual false, abstract: false, final false
  inline void _GetScores_b__0(::GlobalNamespace::HMAsyncRequest* _);

  /// @brief Method <GetScores>b__3, addr 0x3757b9c, size 0x2c, virtual false, abstract: false, final false
  inline bool _GetScores_b__3(::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore* entry);

  /// @brief Method <GetScores>g__HandleGetScoresCompleted|1, addr 0x3757618, size 0x584, virtual false, abstract: false, final false
  inline void _GetScores_g__HandleGetScoresCompleted_1(::GlobalNamespace::PlatformLeaderboardsModel_GetScoresResult result,
                                                       ::ArrayW<::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*> entries, int32_t referencePlayerScoreIndex);
  ...
  /// @brief Method .ctor, addr 0x37575ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field fromRank, offset: 0x48, size: 0x4, def value: None
  int32_t ___fromRank;

  /// @brief Field scope, offset: 0x4c, size: 0x4, def value: None
...
static_assert(offsetof(::GlobalNamespace::PlatformLeaderboardsModel___c__DisplayClass26_0, ___fromRank) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PlatformLeaderboardsModel___c__DisplayClass26_0, ___scope) == 0x4c, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::PlatformLeaderboardsModel___c__DisplayClass26_0) == 0x50, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetFriendsScores, addr 0x37570e8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetScores, addr 0x3756db8, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetScores, addr 0x37570a8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetScoresAroundPlayer, addr 0x37570c8, size 0x20, virtual false, abstract: false, final false
  inline ::GlobalNamespace::HMAsyncRequest* GetScoresAroundPlayer(::by_ref<::GlobalNamespace::BeatmapKey> beatmapKey, int32_t count,
                                                                  ::GlobalNamespace::PlatformLeaderboardsModel_GetScoresCompletionHandler* completionHandler);

  /// @brief Method HandleAllScoresDidUpload, addr 0x375708c, size 0x1c, virtual false, abstract: false, final false
  inline void HandleAllScoresDidUpload();

  /// @brief Method Initialize, addr 0x37568e4, size 0x148, virtual false, abstract: false, final false
  inline void Initialize();

  /// @brief Method InitializeForUserInfo, addr 0x3756b44, size 0x1f4, virtual false, abstract: false, final false
  inline void InitializeForUserInfo(uint64_t userId);

  static inline ::GlobalNamespace::PlatformLeaderboardsModel* New_ctor();

  /// @brief Method OnDestroy, addr 0x3756a2c, size 0x118, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method UploadScore, addr 0x3756d38, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method UploadScore, addr 0x3757108, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3757264, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_allScoresDidUploadEvent, addr 0x375675c, size 0xac, virtual false, abstract: false, final false
  inline void add_allScoresDidUploadEvent(::System::Action* value);

  /// @brief Method get_initialized, addr 0x37568bc, size 0x28, virtual false, abstract: false, final false
  inline bool get_initialized();

  /// @brief Method get_playerId, addr 0x37568b4, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_playerId();

  /// @brief Method remove_allScoresDidUploadEvent, addr 0x3756808, size 0xac, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PlatformLeaderboardsModel) == 0x68, "Size mismatch!");
