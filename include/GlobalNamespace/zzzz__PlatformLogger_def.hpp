...
// Write type traits
MARK_REF_T(::GlobalNamespace::PlatformLogger*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlatformLogger*, "", "PlatformLogger");
...
static_assert(sizeof(::GlobalNamespace::PlatformLogger) == 0x18, "Size mismatch!");
