...
// Write type traits
MARK_REF_T(::GlobalNamespace::PlatformUpdater*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlatformUpdater*, "", "PlatformUpdater");
...
public:
  ...
  /// @brief Method Tick, addr 0x3773c6c, size 0xe4, virtual true, abstract: false, final true
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x3773c64, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PlatformUpdater) == 0x18, "Size mismatch!");
