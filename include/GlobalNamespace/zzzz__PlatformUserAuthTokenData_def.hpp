...
// Write type traits
MARK_REF_T(::GlobalNamespace::PlatformUserAuthTokenData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlatformUserAuthTokenData*, "", "PlatformUserAuthTokenData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5e06100, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW token, ::GlobalNamespace::PlatformEnvironment validPlatformEnvironment);

  /// @brief Method get_token, addr 0x5e060e0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_token();

  /// @brief Method get_validPlatformEnvironment, addr 0x5e060f0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlatformEnvironment get_validPlatformEnvironment();

  /// @brief Method set_token, addr 0x5e060e8, size 0x8, virtual false, abstract: false, final false
  inline void set_token(::StringW value);

  /// @brief Method set_validPlatformEnvironment, addr 0x5e060f8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PlatformUserAuthTokenData) == 0x20, "Size mismatch!");
