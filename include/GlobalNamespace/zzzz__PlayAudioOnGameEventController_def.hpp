...
// Write type traits
MARK_REF_T(::GlobalNamespace::PlayAudioOnGameEventController*);
MARK_REF_T(::GlobalNamespace::PlayAudioOnGameEventController_EventAudioBinding*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlayAudioOnGameEventController*, "", "PlayAudioOnGameEventController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlayAudioOnGameEventController_EventAudioBinding*, "", "PlayAudioOnGameEventController/EventAudioBinding");
// Dependencies LocalizedAudioClipSO, System.Object
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__localizedAudioClips, put = __cordl_internal_set__localizedAudioClips)) ::ArrayW<::UnityW<::GlobalNamespace::LocalizedAudioClipSO>>
  ...
  /// @brief Method Deinit, addr 0x58ba4fc, size 0x8c, virtual false, abstract: false, final false
  inline void Deinit();

  /// @brief Method HandleGameEvent, addr 0x58ba58c, size 0xc8, virtual false, abstract: false, final false
  inline void HandleGameEvent();

  /// @brief Method Init, addr 0x58ba3ac, size 0x100, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityW<::GlobalNamespace::LocalizedAudioClipSO>> const& __cordl_internal_get__localizedAudioClips() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::LocalizedAudioClipSO>>& __cordl_internal_get__localizedAudioClips();
  ...
  constexpr void __cordl_internal_set__localizedAudioClips(::ArrayW<::UnityW<::GlobalNamespace::LocalizedAudioClipSO>> value);
  ...
  /// @brief Method .ctor, addr 0x58ba654, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::PlayAudioOnGameEventController_EventAudioBinding) == 0x38, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies PlayAudioOnGameEventController::EventAudioBinding, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__eventAudioBindings, put = __cordl_internal_set__eventAudioBindings)) ::ArrayW<::GlobalNamespace::PlayAudioOnGameEventController_EventAudioBinding*>
      _eventAudioBindings;

  /// @brief Method Awake, addr 0x58ba34c, size 0x60, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::PlayAudioOnGameEventController* New_ctor();

  /// @brief Method OnDestroy, addr 0x58ba4ac, size 0x50, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::PlayAudioOnGameEventController_EventAudioBinding*> const& __cordl_internal_get__eventAudioBindings() const;

  constexpr ::ArrayW<::GlobalNamespace::PlayAudioOnGameEventController_EventAudioBinding*>& __cordl_internal_get__eventAudioBindings();

  constexpr void __cordl_internal_set__audioClipQueue(::UnityW<::GlobalNamespace::AudioClipQueue> value);

  constexpr void __cordl_internal_set__eventAudioBindings(::ArrayW<::GlobalNamespace::PlayAudioOnGameEventController_EventAudioBinding*> value);

  /// @brief Method .ctor, addr 0x58ba588, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::PlayAudioOnGameEventController) == 0x30, "Size mismatch!");
