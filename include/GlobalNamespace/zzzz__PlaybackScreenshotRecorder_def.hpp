...
// Write type traits
MARK_REF_T(::GlobalNamespace::PlaybackScreenshotRecorder*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlaybackScreenshotRecorder*, "", "PlaybackScreenshotRecorder");
...
public:
  ...
  /// @brief Method ConvertRenderTexture, addr 0x57c8b74, size 0xfc, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture2D> ConvertRenderTexture(::UnityEngine::RenderTexture* renderTexture);

  /// @brief Method HandleTexturesReady, addr 0x57c89b4, size 0x78, virtual false, abstract: false, final false
  inline void HandleTexturesReady();

  /// @brief Method Init, addr 0x57c7068, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x57c8928, size 0x8c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x57c889c, size 0x8c, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method SaveScreenshot, addr 0x57c8a2c, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57c8c70, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_directory, addr 0x57c8894, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PlaybackScreenshotRecorder) == 0x38, "Size mismatch!");
