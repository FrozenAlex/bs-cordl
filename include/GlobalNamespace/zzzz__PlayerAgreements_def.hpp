...
// Write type traits
MARK_REF_T(::GlobalNamespace::PlayerAgreements*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlayerAgreements*, "", "PlayerAgreements");
...
public:
  ...
  /// @brief Method AgreeToEndOfLifeNotice, addr 0x37407c0, size 0xc, virtual false, abstract: false, final false
  inline void AgreeToEndOfLifeNotice();

  /// @brief Method AgreeToEula, addr 0x3740778, size 0x24, virtual false, abstract: false, final false
  inline void AgreeToEula();

  /// @brief Method AgreeToHealthAndSafety, addr 0x37407a8, size 0xc, virtual false, abstract: false, final false
  inline void AgreeToHealthAndSafety();

  /// @brief Method AgreeToPlayerSensitivityFlag, addr 0x37407b4, size 0xc, virtual false, abstract: false, final false
  inline void AgreeToPlayerSensitivityFlag();

  /// @brief Method AgreeToPrivacyPolicy, addr 0x374079c, size 0xc, virtual false, abstract: false, final false
  inline void AgreeToPrivacyPolicy();

  /// @brief Method AgreedToAnyPreviousEula, addr 0x37407dc, size 0x14, virtual false, abstract: false, final false
  inline bool AgreedToAnyPreviousEula();

  /// @brief Method AgreedToAnyPreviousHealthAndSafety, addr 0x3740804, size 0xc, virtual false, abstract: false, final false
  inline bool AgreedToAnyPreviousHealthAndSafety();

  /// @brief Method AgreedToAnyPreviousPlayerSensitivityFlag, addr 0x3740810, size 0x14, virtual false, abstract: false, final false
  inline bool AgreedToAnyPreviousPlayerSensitivityFlag();

  /// @brief Method AgreedToAnyPreviousPrivacyPolicy, addr 0x37407f0, size 0x14, virtual false, abstract: false, final false
  inline bool AgreedToAnyPreviousPrivacyPolicy();

  /// @brief Method AgreedToEndOfLifeNotice, addr 0x3740864, size 0x10, virtual false, abstract: false, final false
  inline bool AgreedToEndOfLifeNotice();

  /// @brief Method AgreedToEula, addr 0x3740824, size 0x10, virtual false, abstract: false, final false
  inline bool AgreedToEula();

  /// @brief Method AgreedToHealthAndSafety, addr 0x3740844, size 0x10, virtual false, abstract: false, final false
  inline bool AgreedToHealthAndSafety();

  /// @brief Method AgreedToPlayerSenstivityFlag, addr 0x3740854, size 0x10, virtual false, abstract: false, final false
  inline bool AgreedToPlayerSenstivityFlag();

  /// @brief Method AgreedToPreviousPrivacyPolicy, addr 0x37407cc, size 0x10, virtual false, abstract: false, final false
  inline bool AgreedToPreviousPrivacyPolicy();

  /// @brief Method AgreedToPrivacyPolicy, addr 0x3740834, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x374075c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3740768, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method add_agreedToEulaEvent, addr 0x3740604, size 0xac, virtual false, abstract: false, final false
  inline void add_agreedToEulaEvent(::System::Action* value);

  /// @brief Method remove_agreedToEulaEvent, addr 0x37406b0, size 0xac, virtual false, abstract: false, final false
...
public:
  ...
  static constexpr int32_t kCurrentPrivacyPolicyVersion{ static_cast<int32_t>(0x6) };
...
static_assert(sizeof(::GlobalNamespace::PlayerAgreements) == 0x30, "Size mismatch!");
