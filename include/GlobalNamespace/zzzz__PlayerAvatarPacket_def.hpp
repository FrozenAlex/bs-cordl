...
// Write type traits
MARK_REF_T(::GlobalNamespace::PlayerAvatarPacket*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlayerAvatarPacket*, "", "PlayerAvatarPacket");
...
public:
  ...
  /// @brief Method Deserialize, addr 0x3329c94, size 0x38, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x3329d24, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x3329ccc, size 0x58, virtual true, abstract: false, final true
  inline void Release();

  /// @brief Method Serialize, addr 0x3329c68, size 0x2c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3329d38, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_pool, addr 0x3329c24, size 0x44, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PlayerAvatarPacket) == 0x28, "Size mismatch!");
