...
public:
  ...
  /// @brief Method Deserialize, addr 0x326f214, size 0x38, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x326f2a4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x326f24c, size 0x58, virtual true, abstract: false, final true
  inline void Release();

  /// @brief Method Serialize, addr 0x326f1e8, size 0x2c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x326f2b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_pool, addr 0x326f1a4, size 0x44, virtual false, abstract: false, final false
