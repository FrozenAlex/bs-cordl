...
// Write type traits
MARK_REF_T(::GlobalNamespace::PlayerConnectedPacket*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlayerConnectedPacket*, "", "PlayerConnectedPacket");
...
public:
  ...
  /// @brief Method Deserialize, addr 0x326f0bc, size 0x78, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x326f18c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x326f134, size 0x58, virtual true, abstract: false, final true
  inline void Release();

  /// @brief Method Serialize, addr 0x326f04c, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x326f1a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_pool, addr 0x326f008, size 0x44, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PlayerConnectedPacket) == 0x38, "Size mismatch!");
