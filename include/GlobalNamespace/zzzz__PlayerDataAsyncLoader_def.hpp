...
struct PlayerDataAsyncLoader__LoadResourcesBeforeInstallAsync_d__1;
}
...
// Write type traits
MARK_REF_T(::GlobalNamespace::PlayerDataAsyncLoader*);
...
namespace GlobalNamespace {
// Is value type: true
// CS Name: PlayerDataAsyncLoader/<LoadResourcesBeforeInstallAsync>d__1
struct CORDL_TYPE PlayerDataAsyncLoader__LoadResourcesBeforeInstallAsync_d__1 {
public:
  // Declarations
...
static_assert(offsetof(::GlobalNamespace::PlayerDataAsyncLoader__LoadResourcesBeforeInstallAsync_d__1, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PlayerDataAsyncLoader__LoadResourcesBeforeInstallAsync_d__1, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PlayerDataAsyncLoader__LoadResourcesBeforeInstallAsync_d__1, container) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PlayerDataAsyncLoader__LoadResourcesBeforeInstallAsync_d__1, __4__this) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PlayerDataAsyncLoader__LoadResourcesBeforeInstallAsync_d__1, __u__1) == 0x30, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::PlayerDataAsyncLoader__LoadResourcesBeforeInstallAsync_d__1) == 0x38, "Size mismatch!");
...
public:
  // Declarations
  using _LoadResourcesBeforeInstallAsync_d__1 = ::GlobalNamespace::PlayerDataAsyncLoader__LoadResourcesBeforeInstallAsync_d__1;
...
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::PlayerDataAsyncLoader, ____playerDataContent) == 0x38, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::PlayerDataAsyncLoader) == 0x40, "Size mismatch!");
