...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlayerDataAsyncLoader__LoadResourcesBeforeInstallAsync_d__2, "", "PlayerDataAsyncLoader/<LoadResourcesBeforeInstallAsync>d__2");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x36b7054, size 0x28c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x36b72e0, size 0x6c, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::PlayerDataAsyncLoader__LoadResourcesBeforeInstallAsync_d__2) == 0x38, "Size mismatch!");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x36b6f7c, size 0xd4, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method LoadResourcesBeforeInstall, addr 0x36b6e14, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method LoadResourcesBeforeInstallAsync, addr 0x36b6eb8, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36b7050, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::PlayerDataAsyncLoader) == 0x30, "Size mismatch!");
