...
// Write type traits
MARK_REF_T(::GlobalNamespace::PlayerMissionStatsData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlayerMissionStatsData*, "", "PlayerMissionStatsData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x374646c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW missionId, bool cleared);

  /// @brief Method get_cleared, addr 0x3748474, size 0x8, virtual false, abstract: false, final false
  inline bool get_cleared();

  /// @brief Method get_missionId, addr 0x374846c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_missionId();

  /// @brief Method set_cleared, addr 0x374847c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PlayerMissionStatsData) == 0x20, "Size mismatch!");
