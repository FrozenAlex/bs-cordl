...
// Write type traits
MARK_REF_T(::GlobalNamespace::PlayerOptionsViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlayerOptionsViewController*, "", "PlayerOptionsViewController");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x58eba10, size 0x124, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x58ebeec, size 0xf8, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  static inline ::GlobalNamespace::PlayerOptionsViewController* New_ctor();

  /// @brief Method <DidActivate>b__6_0, addr 0x58ebfe8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58ebfe4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x58eb890, size 0xc0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_1<::UnityW<::HMUI::ViewController>>* value);

  /// @brief Method remove_didFinishEvent, addr 0x58eb950, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PlayerOptionsViewController) == 0x98, "Size mismatch!");
