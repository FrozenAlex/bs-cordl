...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlayerSensitivityFlag, "", "PlayerSensitivityFlag");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::PlayerSensitivityFlag) == 0x4, "Size mismatch!");
