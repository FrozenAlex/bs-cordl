...
// Write type traits
MARK_VAL_T(::GlobalNamespace::PlayerSettingsPanelController_PlayerSettingsPanelLayout);
MARK_REF_T(::GlobalNamespace::PlayerSettingsPanelController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlayerSettingsPanelController_PlayerSettingsPanelLayout, "", "PlayerSettingsPanelController/PlayerSettingsPanelLayout");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlayerSettingsPanelController*, "", "PlayerSettingsPanelController");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
// CS Name: PlayerSettingsPanelController/PlayerSettingsPanelLayout
struct CORDL_TYPE PlayerSettingsPanelController_PlayerSettingsPanelLayout {
public:
  // Declarations
  using __CORDL_BACKING_ENUM_TYPE = int32_t;

  /// @brief Nested struct __PlayerSettingsPanelController_PlayerSettingsPanelLayout_Unwrapped
  enum struct __PlayerSettingsPanelController_PlayerSettingsPanelLayout_Unwrapped : int32_t {
  ...
  constexpr operator __PlayerSettingsPanelController_PlayerSettingsPanelLayout_Unwrapped() const noexcept {
    return static_cast<__PlayerSettingsPanelController_PlayerSettingsPanelLayout_Unwrapped>(this->value__);
  }
  ...
  static ::GlobalNamespace::PlayerSettingsPanelController_PlayerSettingsPanelLayout const All;

  /// @brief Field Multiplayer value: I32(2)
  static ::GlobalNamespace::PlayerSettingsPanelController_PlayerSettingsPanelLayout const Multiplayer;

  /// @brief Field Singleplayer value: I32(1)
  static ::GlobalNamespace::PlayerSettingsPanelController_PlayerSettingsPanelLayout const Singleplayer;
...
static_assert(offsetof(::GlobalNamespace::PlayerSettingsPanelController_PlayerSettingsPanelLayout, value__) == 0x0, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::PlayerSettingsPanelController_PlayerSettingsPanelLayout) == 0x4, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies ArcVisibilityType, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  // Declarations
  using PlayerSettingsPanelLayout = ::GlobalNamespace::PlayerSettingsPanelController_PlayerSettingsPanelLayout;
  ...
  /// @brief Method Awake, addr 0x594428c, size 0x60, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleAdvancedHudToggleChanged, addr 0x5944b6c, size 0x50, virtual false, abstract: false, final false
  inline void HandleAdvancedHudToggleChanged(bool on);

  /// @brief Method HandleArcVisibilityDropdownDidSelectCellWithIdx, addr 0x5944a58, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleHeadsetHapticIntensityControllerValueDidChange, addr 0x5944b00, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLightReductionAmountSelected, addr 0x5944b48, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleNoTextsAndHudsToggleChanged, addr 0x5944c1c, size 0x50, virtual false, abstract: false, final false
  inline void HandleNoTextsAndHudsToggleChanged(bool on);

  /// @brief Method HandleNoteJumpDurationTypeSettingsDropdownDidSelectCellWithIdx, addr 0x5944bbc, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleNoteJumpFixedDurationSettingsControllerValueDidChange, addr 0x5944bf8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleNoteJumpStartBeatOffsetPositionSelected, addr 0x5944b24, size 0x24, virtual false, abstract: false, final false
  inline void HandleNoteJumpStartBeatOffsetPositionSelected(int32_t idx, float_t startBeatOffset);

  /// @brief Method HandlePlayerHeightSettingsControllerValueDidChange, addr 0x5944adc, size 0x24, virtual false, abstract: false, final false
  inline void HandlePlayerHeightSettingsControllerValueDidChange(float_t value);

  /// @brief Method HandleSFXVolumeSettingsControllerValueDidChange, addr 0x5944a10, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSaberTrailIntensitySettingsControllerValueDidChange, addr 0x5944ab8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x59448ec, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x59448b4, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x59442ec, size 0x5c8, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Refresh, addr 0x5943ca8, size 0x3b8, virtual true, abstract: false, final true
  inline void Refresh();

  /// @brief Method RefreshArcsWarning, addr 0x5944928, size 0xe8, virtual false, abstract: false, final false
  inline void RefreshArcsWarning(::GlobalNamespace::ArcVisibilityType arcVisibilityType, bool forceRebuild);

  /// @brief Method RefreshNoteJumpUI, addr 0x59448f0, size 0x38, virtual false, abstract: false, final false
  inline void RefreshNoteJumpUI(::GlobalNamespace::NoteJumpDurationTypeSettings noteJumpDurationTypeSettings);

  /// @brief Method SetData, addr 0x5942fd8, size 0x20, virtual false, abstract: false, final false
  inline void SetData(::GlobalNamespace::PlayerData* playerData);

  /// @brief Method SetIsDirty, addr 0x5944a34, size 0x24, virtual false, abstract: false, final false
  inline void SetIsDirty();

  /// @brief Method SetLayout, addr 0x5942874, size 0x18, virtual false, abstract: false, final false
  inline void SetLayout(::GlobalNamespace::PlayerSettingsPanelController_PlayerSettingsPanelLayout layout);

  /// @brief Method SetSectionDisabled, addr 0x5944228, size 0x64, virtual false, abstract: false, final false
  inline void SetSectionDisabled(::UnityEngine::CanvasGroup* sectionCanvasGroup, bool disable);

  /// @brief Method UnsubscribeAllUICallbacks, addr 0x59448b8, size 0x34, virtual false, abstract: false, final false
  inline void UnsubscribeAllUICallbacks();

  /// @brief Method <OnEnable>b__42_0, addr 0x5944ccc, size 0x24, virtual false, abstract: false, final false
  inline void _OnEnable_b__42_0(bool on);

  /// @brief Method <OnEnable>b__42_1, addr 0x5944cf0, size 0x24, virtual false, abstract: false, final false
  inline void _OnEnable_b__42_1(bool on);

  /// @brief Method <OnEnable>b__42_2, addr 0x5944d14, size 0x24, virtual false, abstract: false, final false
  inline void _OnEnable_b__42_2(bool on);

  /// @brief Method <OnEnable>b__42_3, addr 0x5944d38, size 0x24, virtual false, abstract: false, final false
  inline void _OnEnable_b__42_3(bool on);

  /// @brief Method <OnEnable>b__42_4, addr 0x5944d5c, size 0x24, virtual false, abstract: false, final false
  inline void _OnEnable_b__42_4(bool on);

  /// @brief Method <OnEnable>b__42_5, addr 0x5944d80, size 0x44, virtual false, abstract: false, final false
  inline void _OnEnable_b__42_5(bool on);

  /// @brief Method <OnEnable>b__42_6, addr 0x5944dc4, size 0x24, virtual false, abstract: false, final false
  inline void _OnEnable_b__42_6(bool on);

  /// @brief Method <OnEnable>b__42_7, addr 0x5944de8, size 0x548, virtual false, abstract: false, final false
  inline void _OnEnable_b__42_7();

  /// @brief Method <OnEnable>b__42_8, addr 0x5945330, size 0x648, virtual false, abstract: false, final false
  ...
  constexpr ::System::Action* const& __cordl_internal_get_didChangePlayerSettingsEvent() const;
  ...
  /// @brief Method .ctor, addr 0x5944c6c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didChangePlayerSettingsEvent, addr 0x59431d4, size 0xac, virtual false, abstract: false, final false
  inline void add_didChangePlayerSettingsEvent(::System::Action* value);

  /// @brief Method get_playerSpecificSettings, addr 0x59423e0, size 0x304, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didChangePlayerSettingsEvent, addr 0x594417c, size 0xac, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PlayerSettingsPanelController) == 0x120, "Size mismatch!");
