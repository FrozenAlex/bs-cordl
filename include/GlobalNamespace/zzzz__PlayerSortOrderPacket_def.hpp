...
// Write type traits
MARK_REF_T(::GlobalNamespace::PlayerSortOrderPacket*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlayerSortOrderPacket*, "", "PlayerSortOrderPacket");
...
public:
  ...
  /// @brief Method Deserialize, addr 0x326f438, size 0x50, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x326f4e0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x326f488, size 0x58, virtual true, abstract: false, final true
  inline void Release();

  /// @brief Method Serialize, addr 0x326f3e4, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x326f4ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_pool, addr 0x326f3a0, size 0x44, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PlayerSortOrderPacket) == 0x20, "Size mismatch!");
