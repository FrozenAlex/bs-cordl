...
public:
  ...
  /// @brief Method AreValuesEqual, addr 0x3748564, size 0x2bc, virtual false, abstract: false, final false
  inline bool AreValuesEqual(::GlobalNamespace::PlayerSpecificSettings* other);

  /// @brief Method BucketHeight, addr 0x374848c, size 0x28, virtual false, abstract: false, final false
  inline float_t BucketHeight(float_t heightMeters);

  /// @brief Method CopyWith, addr 0x374663c, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnvironmentEffectsFilterPreset, addr 0x374854c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x37465d8, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3746314, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_adaptiveSfx, addr 0x374851c, size 0x8, virtual false, abstract: false, final false
  inline bool get_adaptiveSfx();

  /// @brief Method get_advancedHud, addr 0x37484e4, size 0x8, virtual false, abstract: false, final false
  inline bool get_advancedHud();

  /// @brief Method get_arcVisibility, addr 0x374852c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ArcVisibilityType get_arcVisibility();

  /// @brief Method get_arcsHapticFeedback, addr 0x3748524, size 0x8, virtual false, abstract: false, final false
  inline bool get_arcsHapticFeedback();

  /// @brief Method get_autoRestart, addr 0x37484ec, size 0x8, virtual false, abstract: false, final false
  inline bool get_autoRestart();

  /// @brief Method get_automaticPlayerHeight, addr 0x37484bc, size 0x8, virtual false, abstract: false, final false
  inline bool get_automaticPlayerHeight();

  /// @brief Method get_environmentEffectsFilterDefaultPreset, addr 0x3748534, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EnvironmentEffectsFilterPreset get_environmentEffectsFilterDefaultPreset();

  /// @brief Method get_environmentEffectsFilterExpertPlusPreset, addr 0x374853c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EnvironmentEffectsFilterPreset get_environmentEffectsFilterExpertPlusPreset();

  /// @brief Method get_headsetHapticIntensity, addr 0x3748544, size 0x8, virtual false, abstract: false, final false
  inline float_t get_headsetHapticIntensity();

  /// @brief Method get_hideNoteSpawnEffect, addr 0x3748514, size 0x8, virtual false, abstract: false, final false
  inline bool get_hideNoteSpawnEffect();

  /// @brief Method get_leftHanded, addr 0x3748484, size 0x8, virtual false, abstract: false, final false
  inline bool get_leftHanded();

  /// @brief Method get_noFailEffects, addr 0x37484dc, size 0x8, virtual false, abstract: false, final false
  inline bool get_noFailEffects();

  /// @brief Method get_noTextsAndHuds, addr 0x37484d4, size 0x8, virtual false, abstract: false, final false
  inline bool get_noTextsAndHuds();

  /// @brief Method get_noteJumpDurationTypeSettings, addr 0x37484fc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteJumpDurationTypeSettings get_noteJumpDurationTypeSettings();

  /// @brief Method get_noteJumpFixedDuration, addr 0x3748504, size 0x8, virtual false, abstract: false, final false
  inline float_t get_noteJumpFixedDuration();

  /// @brief Method get_noteJumpStartBeatOffset, addr 0x374850c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_noteJumpStartBeatOffset();

  /// @brief Method get_playerHeight, addr 0x37484b4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_playerHeight();

  /// @brief Method get_reduceDebris, addr 0x37484cc, size 0x8, virtual false, abstract: false, final false
  inline bool get_reduceDebris();

  /// @brief Method get_saberTrailIntensity, addr 0x37484f4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_saberTrailIntensity();

  /// @brief Method get_sfxVolume, addr 0x37484c4, size 0x8, virtual false, abstract: false, final false
