...
// Write type traits
MARK_REF_T(::GlobalNamespace::PlayingCampaignRichPresenceData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlayingCampaignRichPresenceData*, "", "PlayingCampaignRichPresenceData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58fc674, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_apiName, addr 0x58fc5d4, size 0x44, virtual true, abstract: false, final true
  inline ::StringW get_apiName();

  /// @brief Method get_localizedDescription, addr 0x58fc618, size 0x5c, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::PlayingCampaignRichPresenceData) == 0x18, "Size mismatch!");
