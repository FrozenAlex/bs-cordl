...
// Write type traits
MARK_REF_T(::GlobalNamespace::PointLightWithIds*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PointLightWithIds*, "", "PointLightWithIds");
...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x572bd40, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x572bd5c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::PointLightWithIds) == 0x58, "Size mismatch!");
