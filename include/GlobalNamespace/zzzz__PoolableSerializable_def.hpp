...
// Write type traits
MARK_REF_T(::GlobalNamespace::PoolableSerializable*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PoolableSerializable*, "", "PoolableSerializable");
...
public:
  ...
  /// @brief Method GetPool, addr 0x36be8e4, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method NoDomainReloadInit, addr 0x36be78c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x36be220, size 0x74, virtual true, abstract: false, final false
  inline void Release();

  /// @brief Method Release, addr 0x36be80c, size 0xd8, virtual false, abstract: false, final false
  static inline void Release(::GlobalNamespace::IPoolableSerializable* t);

  /// @brief Method Retain, addr 0x36be33c, size 0x10, virtual true, abstract: false, final false
  inline void Retain();
  ...
  /// @brief Method .ctor, addr 0x36bca40, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::PoolableSerializable) == 0x18, "Size mismatch!");
