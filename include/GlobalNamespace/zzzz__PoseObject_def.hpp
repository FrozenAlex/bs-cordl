...
// Write type traits
MARK_REF_T(::GlobalNamespace::PoseObject*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PoseObject*, "", "PoseObject");
...
static_assert(sizeof(::GlobalNamespace::PoseObject) == 0x20, "Size mismatch!");
