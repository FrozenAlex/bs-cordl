...
// Write type traits
MARK_REF_T(::GlobalNamespace::PosesRecordingSaveData*);
MARK_REF_T(::GlobalNamespace::PosesRecordingSaveData_ExternalCameraCalibrationSaveData*);
MARK_REF_T(::GlobalNamespace::PosesRecordingSaveData_PoseSaveData*);
MARK_REF_T(::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PosesRecordingSaveData*, "", "PosesRecordingSaveData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PosesRecordingSaveData_ExternalCameraCalibrationSaveData*, "", "PosesRecordingSaveData/ExternalCameraCalibrationSaveData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PosesRecordingSaveData_PoseSaveData*, "", "PosesRecordingSaveData/PoseSaveData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe*, "", "PosesRecordingSaveData/TransformsSaveKeyframe");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58e6db4, size 0x14, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PosesRecordingSaveData_PoseSaveData) == 0x30, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies PosesRecordingSaveData::PoseSaveData, System.Object
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_poses, put = __cordl_internal_set_poses)) ::ArrayW<::GlobalNamespace::PosesRecordingSaveData_PoseSaveData*> poses;
  ...
  static inline ::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe* New_ctor(::ArrayW<::GlobalNamespace::PosesRecordingSaveData_PoseSaveData*> poses, float_t time);

  constexpr ::ArrayW<::GlobalNamespace::PosesRecordingSaveData_PoseSaveData*> const& __cordl_internal_get_poses() const;

  constexpr ::ArrayW<::GlobalNamespace::PosesRecordingSaveData_PoseSaveData*>& __cordl_internal_get_poses();

  constexpr float_t const& __cordl_internal_get_time() const;

  constexpr float_t& __cordl_internal_get_time();

  constexpr void __cordl_internal_set_poses(::ArrayW<::GlobalNamespace::PosesRecordingSaveData_PoseSaveData*> value);

  constexpr void __cordl_internal_set_time(float_t value);

  /// @brief Method .ctor, addr 0x58e6dc8, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58e6dd4, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PosesRecordingSaveData_ExternalCameraCalibrationSaveData) == 0x28, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies PosesRecordingSaveData::TransformsSaveKeyframe, System.Object
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_keyframes, put = __cordl_internal_set_keyframes)) ::ArrayW<::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe*> keyframes;

  /// @brief Field objectIds, offset 0x10, size 0x8
  __declspec(property(get = __cordl_internal_get_objectIds, put = __cordl_internal_set_objectIds)) ::ArrayW<::StringW> objectIds;

  static inline ::GlobalNamespace::PosesRecordingSaveData* New_ctor(::ArrayW<::StringW> objectIds, ::ArrayW<::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe*> keyframes,
  ...
  constexpr ::ArrayW<::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe*> const& __cordl_internal_get_keyframes() const;

  constexpr ::ArrayW<::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe*>& __cordl_internal_get_keyframes();

  constexpr ::ArrayW<::StringW> const& __cordl_internal_get_objectIds() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get_objectIds();
  ...
  constexpr void __cordl_internal_set_keyframes(::ArrayW<::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe*> value);

  constexpr void __cordl_internal_set_objectIds(::ArrayW<::StringW> value);

  /// @brief Method .ctor, addr 0x58e6da8, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe*> ___keyframes;
...
static_assert(sizeof(::GlobalNamespace::PosesRecordingSaveData) == 0x28, "Size mismatch!");
