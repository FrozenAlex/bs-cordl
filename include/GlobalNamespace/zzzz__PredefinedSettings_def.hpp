...
// Write type traits
MARK_REF_T(::GlobalNamespace::PredefinedSettings*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PredefinedSettings*, "", "PredefinedSettings");
...
static_assert(sizeof(::GlobalNamespace::PredefinedSettings) == 0x10, "Size mismatch!");
