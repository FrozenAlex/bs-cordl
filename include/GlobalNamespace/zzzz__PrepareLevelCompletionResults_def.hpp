...
public:
  ...
  /// @brief Method FillLevelCompletionResults, addr 0x58b589c, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58b5ba0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::PrepareLevelCompletionResults) == 0x68, "Size mismatch!");
