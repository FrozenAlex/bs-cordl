...
// Write type traits
MARK_REF_T(::GlobalNamespace::PresentHiddenSettingsAfterNClicks*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PresentHiddenSettingsAfterNClicks*, "", "PresentHiddenSettingsAfterNClicks");
...
public:
  ...
  /// @brief Method OnDisable, addr 0x581804c, size 0x18, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5817fac, size 0xa0, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method <OnEnable>b__6_0, addr 0x58180c8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5818064, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::PresentHiddenSettingsAfterNClicks, ____numberOfClicksRequired) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PresentHiddenSettingsAfterNClicks, ____settingsFlowCoordinator) == 0x38, "Offset mismatch!");
...
static_assert(sizeof(::GlobalNamespace::PresentHiddenSettingsAfterNClicks) == 0x50, "Size mismatch!");
