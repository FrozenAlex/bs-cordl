...
// Write type traits
MARK_REF_T(::GlobalNamespace::PreviousColorPanelController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PreviousColorPanelController*, "", "PreviousColorPanelController");
// Dependencies UnityEngine.Color, UnityEngine.MonoBehaviour, UnityEngine.UI.Graphic
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method AddColor, addr 0x58f29b0, size 0xa0, virtual false, abstract: false, final false
  inline void AddColor(::UnityEngine::Color color);

  /// @brief Method Awake, addr 0x58f28d0, size 0xc8, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method DiscardUpcomingColor, addr 0x58f2a50, size 0xc, virtual false, abstract: false, final false
  inline void DiscardUpcomingColor();

  static inline ::GlobalNamespace::PreviousColorPanelController* New_ctor();

  /// @brief Method OnDestroy, addr 0x58f2998, size 0x18, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method <Awake>b__9_0, addr 0x58f2a6c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58f2a5c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_colorWasSelectedEvent, addr 0x58f2750, size 0xc0, virtual false, abstract: false, final false
  inline void add_colorWasSelectedEvent(::System::Action_1<::UnityEngine::Color>* value);

  /// @brief Method remove_colorWasSelectedEvent, addr 0x58f2810, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PreviousColorPanelController) == 0x60, "Size mismatch!");
