...
// Write type traits
MARK_REF_T(::GlobalNamespace::PrivacyPolicyViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PrivacyPolicyViewController*, "", "PrivacyPolicyViewController");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x57a7580, size 0x1ac, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method Init, addr 0x57a772c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57a7734, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::PrivacyPolicyViewController) == 0xa0, "Size mismatch!");
