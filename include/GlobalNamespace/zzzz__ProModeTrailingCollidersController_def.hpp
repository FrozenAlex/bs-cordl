...
public:
  ...
  /// @brief Method HandleNoteDidMoveInJumpPhase, addr 0x58d9084, size 0x15c, virtual false, abstract: false, final false
  inline void HandleNoteDidMoveInJumpPhase();

  static inline ::GlobalNamespace::ProModeTrailingCollidersController* New_ctor();

  /// @brief Method OnDestroy, addr 0x58d8f78, size 0x10c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x58d8ed8, size 0xa0, virtual false, abstract: false, final false
  inline void Start();
  ...
  constexpr ::ArrayW<::UnityW<::GlobalNamespace::BoxCuttableBySaber>> const& __cordl_internal_get__trailingSmallCuttableBySaberList() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::BoxCuttableBySaber>>& __cordl_internal_get__trailingSmallCuttableBySaberList();
  ...
  constexpr void __cordl_internal_set__trailingSmallCuttableBySaberList(::ArrayW<::UnityW<::GlobalNamespace::BoxCuttableBySaber>> value);

  constexpr void __cordl_internal_set__transform(::UnityW<::UnityEngine::Transform> value);

  /// @brief Method .ctor, addr 0x58d91e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ProModeTrailingCollidersController) == 0x40, "Size mismatch!");
