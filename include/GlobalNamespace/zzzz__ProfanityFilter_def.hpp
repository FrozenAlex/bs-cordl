...
public:
  ...
  /// @brief Method AddWord, addr 0x32815c0, size 0x4b8, virtual false, abstract: false, final false
  inline void AddWord(::StringW word, int32_t index);

  /// @brief Method IsMatch, addr 0x3281ae0, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32815b4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3281cb4, size 0x98, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::ProfanityFilter__GetLookalikeLetters_d__4* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<System.Char>.GetEnumerator, addr 0x3281db0, size 0x98, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Char>.get_Current, addr 0x3281d4c, size 0x8, virtual true, abstract: false, final true
  inline char16_t System_Collections_Generic_IEnumerator_System_Char__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x3281e48, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3281d54, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3281d8c, size 0x24, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3281cb0, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3281c6c, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetLeetEquivalent, addr 0x3281c8c, size 0x24, virtual false, abstract: false, final false
  static inline char16_t GetLeetEquivalent(char16_t c);

  /// @brief Method GetLookalikeLetters, addr 0x3281bfc, size 0x70, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<char16_t>* GetLookalikeLetters(char16_t c);

  /// @brief Method IsProfane, addr 0x3281a78, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32812b8, size 0x2fc, virtual false, abstract: false, final false
