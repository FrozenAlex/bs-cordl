...
public:
  // Declarations
  /// @brief Method Deserialize, addr 0x3221634, size 0x4c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::PublicServerInfo Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Serialize, addr 0x32215e0, size 0x54, virtual false, abstract: false, final false
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method .ctor, addr 0x32215d4, size 0xc, virtual false, abstract: false, final false
