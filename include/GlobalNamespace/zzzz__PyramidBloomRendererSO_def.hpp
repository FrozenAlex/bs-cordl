...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PyramidBloomRendererSO_Level, "", "PyramidBloomRendererSO/Level");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::PyramidBloomRendererSO_Level) == 0x10, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies PersistentScriptableObject, PyramidBloomRendererSO::Level, UnityEngine.Rendering.GlobalKeyword
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__pyramid, put = __cordl_internal_set__pyramid)) ::ArrayW<::GlobalNamespace::PyramidBloomRendererSO_Level> _pyramid;
  ...
  /// @brief Method OnDisable, addr 0x571aa34, size 0x24, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x571a914, size 0x120, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RenderBloom, addr 0x571aa58, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderBloom, addr 0x571aae8, size 0x880, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::PyramidBloomRendererSO_Level> const& __cordl_internal_get__pyramid() const;

  constexpr ::ArrayW<::GlobalNamespace::PyramidBloomRendererSO_Level>& __cordl_internal_get__pyramid();
  ...
  constexpr void __cordl_internal_set__pyramid(::ArrayW<::GlobalNamespace::PyramidBloomRendererSO_Level> value);
  ...
  /// @brief Method .ctor, addr 0x571b368, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::GlobalNamespace::PyramidBloomRendererSO_Level> ____pyramid;
...
static_assert(sizeof(::GlobalNamespace::PyramidBloomRendererSO) == 0x58, "Size mismatch!");
