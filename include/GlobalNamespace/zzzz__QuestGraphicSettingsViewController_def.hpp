...
// Write type traits
MARK_REF_T(::GlobalNamespace::QuestGraphicSettingsViewController*);
...
public:
  ...
  /// @brief Method <ShouldShowStinsonEntries>b__7_0, addr 0x57aa698, size 0x1c, virtual false, abstract: false, final false
  inline bool _ShouldShowStinsonEntries_b__7_0(float_t freq);

  /// @brief Method .ctor, addr 0x57aa694, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::QuestGraphicSettingsViewController___c) == 0x10, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies GraphicSettingsViewController, UnityEngine.GameObject
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method DidActivate, addr 0x57aa0e4, size 0x228, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x57aa498, size 0x14c, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method Handle120HzToggleValueChanged, addr 0x57aa5fc, size 0x40, virtual false, abstract: false, final false
  inline void Handle120HzToggleValueChanged(bool newState);

  /// @brief Method HandleMirrorChanged, addr 0x57aa5e4, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldShowStinsonEntries, addr 0x57aa30c, size 0x18c, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::GameObject>> const& __cordl_internal_get__stinsonOnlyEntries() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::GameObject>>& __cordl_internal_get__stinsonOnlyEntries();
  ...
  /// @brief Method .ctor, addr 0x57aa63c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::QuestGraphicSettingsViewController) == 0x98, "Size mismatch!");
