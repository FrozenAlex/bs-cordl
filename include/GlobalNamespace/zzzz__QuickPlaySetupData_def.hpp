...
// Write type traits
MARK_REF_T(::GlobalNamespace::QuickPlaySetupData*);
MARK_REF_T(::GlobalNamespace::QuickPlaySetupData_QuickPlaySongPacksOverride*);
MARK_REF_T(::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPack*);
MARK_REF_T(::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPackName*);
MARK_REF_T(::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_PredefinedPack*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::QuickPlaySetupData*, "", "QuickPlaySetupData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::QuickPlaySetupData_QuickPlaySongPacksOverride*, "", "QuickPlaySetupData/QuickPlaySongPacksOverride");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPack*, "", "QuickPlaySetupData/QuickPlaySongPacksOverride/LocalizedCustomPack");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPackName*, "", "QuickPlaySetupData/QuickPlaySongPacksOverride/LocalizedCustomPackName");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_PredefinedPack*, "", "QuickPlaySetupData/QuickPlaySongPacksOverride/PredefinedPack");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3672618, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPackName) == 0x20, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies QuickPlaySetupData::QuickPlaySongPacksOverride::LocalizedCustomPackName, System.Object
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  constexpr ::ArrayW<::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPackName*> const& __cordl_internal_get_localizedNames() const;

  constexpr ::ArrayW<::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPackName*>& __cordl_internal_get_localizedNames();
  ...
  constexpr void __cordl_internal_set_localizedNames(::ArrayW<::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPackName*> value);
  ...
  /// @brief Method .ctor, addr 0x367261c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPackName*> ___localizedNames;
...
static_assert(sizeof(::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPack) == 0x30, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3672690, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_PredefinedPack) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x367255c, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x3672558, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_hasOverride, addr 0x36724c0, size 0x98, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::QuickPlaySetupData) == 0x18, "Size mismatch!");
