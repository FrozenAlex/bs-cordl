...
public:
  ...
  /// @brief Method .ctor, addr 0x372cb90, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x372cb94, size 0x8bc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x372d450, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method GetQuickPlaySetupAsync, addr 0x372c808, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method GetQuickPlaySetupInternal, addr 0x372c9f4, size 0xe0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::QuickPlaySetupData*>* GetQuickPlaySetupInternal();

  /// @brief Method Init, addr 0x372c9f0, size 0x4, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method IsQuickPlaySetupTaskValid, addr 0x372c878, size 0x108, virtual false, abstract: false, final false
  inline bool IsQuickPlaySetupTaskValid();

  /// @brief Method IsUrlValid, addr 0x372cad4, size 0x60, virtual false, abstract: false, final false
  inline bool IsUrlValid(::StringW url);

  static inline ::GlobalNamespace::QuickPlaySetupModel* New_ctor();

  /// @brief Method StartRequest, addr 0x372c980, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x372cb34, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
