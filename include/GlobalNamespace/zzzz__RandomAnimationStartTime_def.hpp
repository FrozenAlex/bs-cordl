...
// Write type traits
MARK_REF_T(::GlobalNamespace::RandomAnimationStartTime*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RandomAnimationStartTime*, "", "RandomAnimationStartTime");
...
public:
  ...
  /// @brief Method PlayAnimation, addr 0x5712110, size 0x2bc, virtual false, abstract: false, final false
  inline void PlayAnimation();

  /// @brief Method Start, addr 0x571210c, size 0x4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x57123cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::RandomAnimationStartTime) == 0x30, "Size mismatch!");
