...
public:
  ...
  /// @brief Method Awake, addr 0x58d91e4, size 0xbc, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleNoteControllerDidInit, addr 0x58d93a8, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method OnDestroy, addr 0x58d92a0, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58d93d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::RandomNoteRotation) == 0x30, "Size mismatch!");
