...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::RandomObjectPicker_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::RandomObjectPicker_1, "", "RandomObjectPicker`1");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__objects, put = __cordl_internal_set__objects)) ::ArrayW<T> _objects;

  static inline ::GlobalNamespace::RandomObjectPicker_1<T>* New_ctor(T obj, float_t minimumPickInterval);

  static inline ::GlobalNamespace::RandomObjectPicker_1<T>* New_ctor(::ArrayW<T> objects, float_t minimumPickInterval);
  ...
  constexpr ::ArrayW<T> const& __cordl_internal_get__objects() const;

  constexpr ::ArrayW<T>& __cordl_internal_get__objects();
  ...
  constexpr void __cordl_internal_set__objects(::ArrayW<T> value);

  /// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline void _ctor(T obj, float_t minimumPickInterval);

  /// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<T> objects, float_t minimumPickInterval);
