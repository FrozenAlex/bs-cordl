...
MARK_REF_T(::GlobalNamespace::RankModel*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RankModel_Rank, "", "RankModel/Rank");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RankModel*, "", "RankModel");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::RankModel_Rank) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetRankForScore, addr 0x377b9d4, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRankName, addr 0x377b8d0, size 0x104, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::RankModel) == 0x10, "Size mismatch!");
