...
public:
  // Declarations
  /// @brief Method CircleIntersections, addr 0x3269ef8, size 0x120, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::Ray2DExtensions) == 0x10, "Size mismatch!");
