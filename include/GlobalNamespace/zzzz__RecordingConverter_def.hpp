...
// Write type traits
MARK_REF_T(::GlobalNamespace::RecordingConverter*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RecordingConverter*, "", "RecordingConverter");
...
public:
  ...
  /// @brief Method SaveToOldFormat, addr 0x57ca6d0, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57c95cc, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::RecordingConverter) == 0x18, "Size mismatch!");
