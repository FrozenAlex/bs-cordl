...
// Dependencies BeatmapDifficulty, EnvironmentType, ObjectsMovementRecorder::CameraView, ObjectsMovementRecorder::Mode, PlaybackRenderer::PlaybackScreenshot, System.Nullable`1<T>, System.Object
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method ToString, addr 0x57dc42c, size 0xcbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57db560, size 0x90, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::RecordingSettings) == 0x90, "Size mismatch!");
