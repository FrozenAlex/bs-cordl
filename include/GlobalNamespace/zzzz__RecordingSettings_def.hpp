...
// Write type traits
MARK_REF_T(::GlobalNamespace::RecordingSettings*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RecordingSettings*, "", "RecordingSettings");
// Dependencies BeatmapCharacteristic, BeatmapDifficulty, EnvironmentType, ObjectsMovementRecorder::CameraView, ObjectsMovementRecorder::Mode, PlaybackRenderer::PlaybackScreenshot,
...
public:
  // Declarations
  /// @brief Field addDateTimeSuffixToRecordingName, offset 0x44, size 0x1
  ...
  /// @brief Field cameraView, offset 0x40, size 0x4
  ...
  /// @brief Field characteristic, offset 0x2c, size 0x4
  ...
  /// @brief Field environmentInfo, offset 0x78, size 0x8
  ...
  /// @brief Field environmentType, offset 0x70, size 0x8
  ...
  /// @brief Field framerate, offset 0x50, size 0x4
  ...
  /// @brief Field overrideEnvironments, offset 0x6c, size 0x1
  ...
  /// @brief Field playbackScreenshots, offset 0x58, size 0x8
  __declspec(property(get = __cordl_internal_get_playbackScreenshots, put = __cordl_internal_set_playbackScreenshots)) ::ArrayW<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*>
      playbackScreenshots;

  /// @brief Field practice, offset 0x60, size 0x1
  __declspec(property(get = __cordl_internal_get_practice, put = __cordl_internal_set_practice)) bool practice;

  /// @brief Field recordPerformance, offset 0x31, size 0x1
  ...
  /// @brief Field recordingMode, offset 0x34, size 0x4
  ...
  /// @brief Field screenshotHeight, offset 0x4c, size 0x4
  ...
  /// @brief Field screenshotRecording, offset 0x45, size 0x1
  ...
  /// @brief Field screenshotWidth, offset 0x48, size 0x4
  ...
  /// @brief Field songSpeedMultiplier, offset 0x68, size 0x4
  ...
  /// @brief Field startSongTime, offset 0x64, size 0x4
  ...
  constexpr ::ArrayW<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*> const& __cordl_internal_get_playbackScreenshots() const;

  constexpr ::ArrayW<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*>& __cordl_internal_get_playbackScreenshots();
  ...
  constexpr void __cordl_internal_set_playbackScreenshots(::ArrayW<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*> value);
  ...
  inline void _ctor(::StringW gameMode, ::GlobalNamespace::BeatmapLevelPack* pack, ::GlobalNamespace::BeatmapLevel* level, ::GlobalNamespace::BeatmapDifficulty difficulty,
                    ...
                    int32_t screenshotHeight, int32_t framerate, ::ArrayW<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*> playbackScreenshots, bool practice, float_t startSongTime,
                    float_t songSpeedMultiplier, bool overrideEnvironments, ::System::Nullable_1<::GlobalNamespace::EnvironmentType> environmentType,
...
public:
  ...
  /// @brief Field characteristic, offset: 0x2c, size: 0x4, def value: None
  ::GlobalNamespace::BeatmapCharacteristic ___characteristic;

  /// @brief Field runLevel, offset: 0x30, size: 0x1, def value: None
  bool ___runLevel;

  /// @brief Field recordPerformance, offset: 0x31, size: 0x1, def value: None
  bool ___recordPerformance;

  /// @brief Field recordingMode, offset: 0x34, size: 0x4, def value: None
  ::GlobalNamespace::ObjectsMovementRecorder_Mode ___recordingMode;

  /// @brief Field recordingPath, offset: 0x38, size: 0x8, def value: None
  ::StringW ___recordingPath;

  /// @brief Field cameraView, offset: 0x40, size: 0x4, def value: None
  ::GlobalNamespace::ObjectsMovementRecorder_CameraView ___cameraView;

  /// @brief Field addDateTimeSuffixToRecordingName, offset: 0x44, size: 0x1, def value: None
  bool ___addDateTimeSuffixToRecordingName;

  /// @brief Field screenshotRecording, offset: 0x45, size: 0x1, def value: None
  bool ___screenshotRecording;

  /// @brief Field screenshotWidth, offset: 0x48, size: 0x4, def value: None
  int32_t ___screenshotWidth;

  /// @brief Field screenshotHeight, offset: 0x4c, size: 0x4, def value: None
  int32_t ___screenshotHeight;

  /// @brief Field framerate, offset: 0x50, size: 0x4, def value: None
  int32_t ___framerate;

  /// @brief Field playbackScreenshots, offset: 0x58, size: 0x8, def value: None
  ::ArrayW<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*> ___playbackScreenshots;

  /// @brief Field practice, offset: 0x60, size: 0x1, def value: None
  bool ___practice;

  /// @brief Field startSongTime, offset: 0x64, size: 0x4, def value: None
  float_t ___startSongTime;

  /// @brief Field songSpeedMultiplier, offset: 0x68, size: 0x4, def value: None
  float_t ___songSpeedMultiplier;

  /// @brief Field overrideEnvironments, offset: 0x6c, size: 0x1, def value: None
  bool ___overrideEnvironments;

  /// @brief Field environmentType, offset: 0x70, size: 0x8, def value: None
  ::System::Nullable_1<::GlobalNamespace::EnvironmentType> ___environmentType;

  /// @brief Field environmentInfo, offset: 0x78, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::EnvironmentInfoSO> ___environmentInfo;

  /// @brief Field saveToOldFormat, offset: 0x80, size: 0x1, def value: None
...
static_assert(offsetof(::GlobalNamespace::RecordingSettings, ___characteristic) == 0x2c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingSettings, ___runLevel) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingSettings, ___recordPerformance) == 0x31, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingSettings, ___recordingMode) == 0x34, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingSettings, ___recordingPath) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingSettings, ___cameraView) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingSettings, ___addDateTimeSuffixToRecordingName) == 0x44, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingSettings, ___screenshotRecording) == 0x45, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingSettings, ___screenshotWidth) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingSettings, ___screenshotHeight) == 0x4c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingSettings, ___framerate) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingSettings, ___playbackScreenshots) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingSettings, ___practice) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingSettings, ___startSongTime) == 0x64, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingSettings, ___songSpeedMultiplier) == 0x68, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingSettings, ___overrideEnvironments) == 0x6c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingSettings, ___environmentType) == 0x70, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingSettings, ___environmentInfo) == 0x78, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingSettings, ___saveToOldFormat) == 0x80, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::RecordingSettings) == 0x88, "Size mismatch!");
