...
// Write type traits
MARK_REF_T(::GlobalNamespace::RecordingToolScenesTransitionSetupDataSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RecordingToolScenesTransitionSetupDataSO*, "", "RecordingToolScenesTransitionSetupDataSO");
...
static_assert(sizeof(::GlobalNamespace::RecordingToolScenesTransitionSetupDataSO) == 0x28, "Size mismatch!");
