...
// Write type traits
MARK_REF_T(::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller*);
MARK_VAL_T(::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller__WaitForTransition_d__3);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller*, "", "RecordingToolSettingsNoTransitionInstaller");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller__WaitForTransition_d__3, "", "RecordingToolSettingsNoTransitionInstaller/<WaitForTransition>d__3");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x57ec740, size 0x264, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x57ec9a4, size 0x6c, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller__WaitForTransition_d__3) == 0x38, "Size mismatch!");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x57ec448, size 0xf8, virtual true, abstract: false, final false
  inline void InstallBindings(::Zenject::DiContainer* container);

  static inline ::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller* New_ctor();

  /// @brief Method WaitForTransition, addr 0x57ec678, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57ec73c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller) == 0x30, "Size mismatch!");
