...
// Write type traits
MARK_REF_T(::GlobalNamespace::RecordingUIController*);
MARK_REF_T(::GlobalNamespace::RecordingUIController_InitData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RecordingUIController*, "", "RecordingUIController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RecordingUIController_InitData*, "", "RecordingUIController/InitData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x59a56c4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::RecordingUIController_InitData) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method Init, addr 0x59a5578, size 0xa4, virtual false, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::RecordingUIController* New_ctor();

  /// @brief Method Update, addr 0x59a561c, size 0x9c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x59a56b8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::RecordingUIController) == 0x40, "Size mismatch!");
