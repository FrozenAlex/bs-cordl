...
public:
  ...
  /// @brief Method Awake, addr 0x5866040, size 0x60, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::RectangleFakeGlow* New_ctor();

  /// @brief Method OnDisable, addr 0x5866218, size 0x60, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x58660a0, size 0x68, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Refresh, addr 0x5866108, size 0x110, virtual false, abstract: false, final false
  inline void Refresh();
  ...
  /// @brief Method .ctor, addr 0x5866278, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_color, addr 0x5866034, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_color, addr 0x5865f70, size 0xc4, virtual false, abstract: false, final false
