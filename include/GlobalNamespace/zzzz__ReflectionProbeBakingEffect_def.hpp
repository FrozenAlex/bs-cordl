...
public:
  ...
  /// @brief Method OnRenderImage, addr 0x5725888, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5725900, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ReflectionProbeBakingEffect) == 0x28, "Size mismatch!");
