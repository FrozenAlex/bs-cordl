...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::ReflectionProbeBakingEffect::*)(::UnityEngine::RenderTexture*, ::UnityEngine::RenderTexture*)>(
  ...
  constexpr static std::size_t addrs = 0x5725888;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::ReflectionProbeBakingEffect*>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::ReflectionProbeBakingEffect::*)()>(&::GlobalNamespace::ReflectionProbeBakingEffect::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5725900;
...
inline ::GlobalNamespace::ReflectionProbeBakingEffect* GlobalNamespace::ReflectionProbeBakingEffect::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::ReflectionProbeBakingEffect*>());
}
// Ctor Parameters []
