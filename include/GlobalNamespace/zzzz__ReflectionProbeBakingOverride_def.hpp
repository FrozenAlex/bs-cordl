...
MARK_REF_T(::GlobalNamespace::ReflectionProbeBakingOverride*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ReflectionProbeBakingOverride_ActiveStateHandling, "", "ReflectionProbeBakingOverride/ActiveStateHandling");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ReflectionProbeBakingOverride*, "", "ReflectionProbeBakingOverride");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::ReflectionProbeBakingOverride_ActiveStateHandling) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::ReflectionProbeBakingOverride) == 0x58, "Size mismatch!");
