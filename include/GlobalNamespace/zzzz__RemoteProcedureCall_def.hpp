...
// Write type traits
MARK_REF_T(::GlobalNamespace::RemoteProcedureCall*);
MARK_GEN_REF_T_PTR(::GlobalNamespace::RemoteProcedureCall_TypeWrapper_1);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RemoteProcedureCall*, "", "RemoteProcedureCall");
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::RemoteProcedureCall_TypeWrapper_1, "", "RemoteProcedureCall/TypeWrapper`1");
...
public:
  ...
  /// @brief Method DeserializeData, addr 0x3281e60, size 0x4, virtual true, abstract: false, final false
  inline void DeserializeData(::LiteNetLib::Utils::NetDataReader* reader, uint32_t protocolVersion);

  /// @brief Method Init, addr 0x3282004, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IRemoteProcedureCall* Init(int64_t syncTime);

  /// @brief Method LiteNetLib.Utils.INetSerializable.Deserialize, addr 0x3281ea8, size 0x44, virtual true, abstract: false, final true
  inline void LiteNetLib_Utils_INetSerializable_Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method LiteNetLib.Utils.INetSerializable.Serialize, addr 0x3281e64, size 0x44, virtual true, abstract: false, final true
  ...
  /// @brief Method Release, addr 0x3281eec, size 0x4, virtual true, abstract: false, final false
  inline void Release();

  /// @brief Method SerializeData, addr 0x3281e5c, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x328200c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_syncTime, addr 0x3281e4c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_syncTime, addr 0x3281e54, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::RemoteProcedureCall) == 0x18, "Size mismatch!");
