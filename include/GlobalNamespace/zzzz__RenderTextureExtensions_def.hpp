...
public:
  // Declarations
  /// @brief Method GetTexture2D, addr 0x570edd0, size 0x130, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::RenderTextureExtensions) == 0x10, "Size mismatch!");
