...
// Write type traits
MARK_REF_T(::GlobalNamespace::RenderTextureFromPostEffect*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RenderTextureFromPostEffect*, "", "RenderTextureFromPostEffect");
...
public:
  ...
  /// @brief Method Awake, addr 0x5e0be90, size 0x54, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::RenderTextureFromPostEffect* New_ctor();

  /// @brief Method OnRenderImage, addr 0x5e0bee4, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e0c0ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_targetTexture, addr 0x5e0be88, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::RenderTextureFromPostEffect) == 0x30, "Size mismatch!");
