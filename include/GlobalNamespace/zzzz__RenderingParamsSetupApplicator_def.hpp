...
// Write type traits
MARK_REF_T(::GlobalNamespace::RenderingParamsSetupApplicator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RenderingParamsSetupApplicator*, "", "RenderingParamsSetupApplicator");
...
public:
  ...
  /// @brief Method Apply, addr 0x57dfa58, size 0x18, virtual true, abstract: false, final true
  inline void Apply(::GlobalNamespace::SceneType sceneType, ::StringW optionalEnvironmentSerializedName);

  /// @brief Method ApplyGraphicsSettings, addr 0x57dfa70, size 0x30, virtual false, abstract: false, final false
  inline void ApplyGraphicsSettings(::GlobalNamespace::SceneType sceneType, ::StringW optionalEnvironmentSerializedName);

  /// @brief Method ApplyMainSettings, addr 0x57dfaa0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57dfbd0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::RenderingParamsSetupApplicator) == 0x20, "Size mismatch!");
