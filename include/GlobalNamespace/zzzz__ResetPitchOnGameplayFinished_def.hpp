...
// Write type traits
MARK_REF_T(::GlobalNamespace::ResetPitchOnGameplayFinished*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ResetPitchOnGameplayFinished*, "", "ResetPitchOnGameplayFinished");
...
static_assert(sizeof(::GlobalNamespace::ResetPitchOnGameplayFinished) == 0x20, "Size mismatch!");
