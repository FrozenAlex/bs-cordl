...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::ResettableRandom::*)()>(&::GlobalNamespace::ResettableRandom::Finalize)> {
  constexpr static std::size_t size = 0xc4;
  constexpr static std::size_t addrs = 0x570f040;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::GlobalNamespace::ResettableRandom*>(), { ::i2c::class_of<::GlobalNamespace::ResettableRandom*>(), 1 }));
    return ___internal_method;
  }
};
...
inline void GlobalNamespace::ResettableRandom::Finalize() {
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::ResettableRandom*>(), 1 })));
