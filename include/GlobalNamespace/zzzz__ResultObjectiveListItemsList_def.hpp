...
// Write type traits
MARK_REF_T(::GlobalNamespace::ResultObjectiveListItemsList*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ResultObjectiveListItemsList*, "", "ResultObjectiveListItemsList");
...
public:
  ...
  /// @brief Method .ctor, addr 0x596b758, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ResultObjectiveListItemsList) == 0x48, "Size mismatch!");
