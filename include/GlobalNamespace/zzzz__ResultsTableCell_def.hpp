...
// Write type traits
MARK_REF_T(::GlobalNamespace::ResultsTableCell*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ResultsTableCell*, "", "ResultsTableCell");
...
public:
  ...
  /// @brief Method SetData, addr 0x57b672c, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57b6ab4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ResultsTableCell) == 0xa8, "Size mismatch!");
