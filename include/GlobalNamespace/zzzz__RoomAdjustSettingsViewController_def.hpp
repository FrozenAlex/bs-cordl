...
// Write type traits
MARK_REF_T(::GlobalNamespace::RoomAdjustSettingsViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RoomAdjustSettingsViewController*, "", "RoomAdjustSettingsViewController");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x5a19878, size 0x478, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method Move, addr 0x5a19e64, size 0x5c, virtual false, abstract: false, final false
  inline void Move(::UnityEngine::Vector3 move);

  static inline ::GlobalNamespace::RoomAdjustSettingsViewController* New_ctor();

  /// @brief Method RefreshRoomOffsetValuePicker, addr 0x5a19f70, size 0xd4, virtual false, abstract: false, final false
  inline void RefreshRoomOffsetValuePicker(::GlobalNamespace::StepValuePicker* stepValuePicker, float_t value);

  /// @brief Method RefreshTexts, addr 0x5a19cf0, size 0x174, virtual false, abstract: false, final false
  inline void RefreshTexts();

  /// @brief Method ResetRoom, addr 0x5a19f20, size 0x50, virtual false, abstract: false, final false
  inline void ResetRoom();

  /// @brief Method Rotate, addr 0x5a19ec0, size 0x60, virtual false, abstract: false, final false
  inline void Rotate(float_t rotation);

  /// @brief Method <DidActivate>b__10_0, addr 0x5a1a048, size 0x14, virtual false, abstract: false, final false
  inline void _DidActivate_b__10_0();

  /// @brief Method <DidActivate>b__10_1, addr 0x5a1a05c, size 0x14, virtual false, abstract: false, final false
  inline void _DidActivate_b__10_1();

  /// @brief Method <DidActivate>b__10_2, addr 0x5a1a070, size 0x14, virtual false, abstract: false, final false
  inline void _DidActivate_b__10_2();

  /// @brief Method <DidActivate>b__10_3, addr 0x5a1a084, size 0x14, virtual false, abstract: false, final false
  inline void _DidActivate_b__10_3();

  /// @brief Method <DidActivate>b__10_4, addr 0x5a1a098, size 0x14, virtual false, abstract: false, final false
  inline void _DidActivate_b__10_4();

  /// @brief Method <DidActivate>b__10_5, addr 0x5a1a0ac, size 0x14, virtual false, abstract: false, final false
  inline void _DidActivate_b__10_5();

  /// @brief Method <DidActivate>b__10_6, addr 0x5a1a0c0, size 0x8, virtual false, abstract: false, final false
  inline void _DidActivate_b__10_6();

  /// @brief Method <DidActivate>b__10_7, addr 0x5a1a0c8, size 0x8, virtual false, abstract: false, final false
  inline void _DidActivate_b__10_7();

  /// @brief Method <DidActivate>b__10_8, addr 0x5a1a0d0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a1a044, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::RoomAdjustSettingsViewController) == 0xb0, "Size mismatch!");
