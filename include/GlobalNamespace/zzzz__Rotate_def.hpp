...
public:
  ...
  /// @brief Method Awake, addr 0x57123d0, size 0xd0, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::Rotate* New_ctor();

  /// @brief Method OnBecameInvisible, addr 0x5712588, size 0xc, virtual false, abstract: false, final false
  inline void OnBecameInvisible();

  /// @brief Method OnBecameVisible, addr 0x57124a0, size 0x20, virtual false, abstract: false, final false
  inline void OnBecameVisible();

  /// @brief Method Randomize, addr 0x57124c0, size 0xc8, virtual false, abstract: false, final false
  inline void Randomize();

  /// @brief Method Update, addr 0x5712594, size 0xf8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x571268c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
