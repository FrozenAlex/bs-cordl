...
// Write type traits
MARK_REF_T(::GlobalNamespace::RumbleHapticFeedbackPlayer*);
MARK_REF_T(::GlobalNamespace::RumbleHapticFeedbackPlayer_RumbleData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RumbleHapticFeedbackPlayer*, "", "RumbleHapticFeedbackPlayer");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RumbleHapticFeedbackPlayer_RumbleData*, "", "RumbleHapticFeedbackPlayer/RumbleData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5717f18, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::RumbleHapticFeedbackPlayer_RumbleData) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method CanPlayHapticPreset, addr 0x57179dc, size 0x3c, virtual true, abstract: false, final true
  inline bool CanPlayHapticPreset(::Libraries::HM::HMLib::VR::HapticPresetSO* hapticPreset, ::UnityEngine::XR::XRNode node);

  /// @brief Method GetRumble, addr 0x5717810, size 0x1cc, virtual false, abstract: false, final false
  inline ::GlobalNamespace::RumbleHapticFeedbackPlayer_RumbleData* GetRumble(::UnityEngine::XR::XRNode node, ::System::Object* preset);

  /// @brief Method LateUpdate, addr 0x5717a18, size 0x4, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::RumbleHapticFeedbackPlayer* New_ctor();

  /// @brief Method PlayHapticFeedback, addr 0x57156f0, size 0xe0, virtual true, abstract: false, final true
  inline void PlayHapticFeedback(::UnityEngine::XR::XRNode node, ::Libraries::HM::HMLib::VR::HapticPresetSO* hapticPreset);

  /// @brief Method UpdateRumbles, addr 0x5717a1c, size 0x4fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5717f1c, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::RumbleHapticFeedbackPlayer) == 0x30, "Size mismatch!");
