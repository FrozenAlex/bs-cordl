...
// Write type traits
MARK_REF_T(::GlobalNamespace::RuntimeLightWithIds*);
MARK_REF_T(::GlobalNamespace::RuntimeLightWithIds_LightIntensitiesWithId*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RuntimeLightWithIds*, "", "RuntimeLightWithIds");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RuntimeLightWithIds_LightIntensitiesWithId*, "", "RuntimeLightWithIds/LightIntensitiesWithId");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5870fa8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t lightId, float_t lightIntensity);

  /// @brief Method get_intensity, addr 0x5870f98, size 0x8, virtual false, abstract: false, final false
  inline float_t get_intensity();

  /// @brief Method set_intensity, addr 0x5870fa0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::RuntimeLightWithIds_LightIntensitiesWithId) == 0x38, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies ColorMixAndWeightingApproach, LightWithIds, RuntimeLightWithIds::LightIntensitiesWithId
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__lightIntensityData, put = __cordl_internal_set__lightIntensityData)) ::ArrayW<::GlobalNamespace::RuntimeLightWithIds_LightIntensitiesWithId*>
      _lightIntensityData;
  ...
  /// @brief Method GetLightWithIds, addr 0x5870e00, size 0x198, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessColor, addr 0x5870dc0, size 0x40, virtual false, abstract: false, final false
  inline ::UnityEngine::Color ProcessColor(::UnityEngine::Color color, float_t intensity);

  /// @brief Method ProcessNewColorData, addr 0x5870c70, size 0x150, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::RuntimeLightWithIds_LightIntensitiesWithId*> const& __cordl_internal_get__lightIntensityData() const;

  constexpr ::ArrayW<::GlobalNamespace::RuntimeLightWithIds_LightIntensitiesWithId*>& __cordl_internal_get__lightIntensityData();
  ...
  constexpr void __cordl_internal_set__lightIntensityData(::ArrayW<::GlobalNamespace::RuntimeLightWithIds_LightIntensitiesWithId*> value);
  ...
  /// @brief Method .ctor, addr 0x586d248, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mixType, addr 0x5870c68, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::RuntimeLightWithIds) == 0x50, "Size mismatch!");
