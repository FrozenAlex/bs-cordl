...
// Write type traits
MARK_REF_T(::GlobalNamespace::RuntimeLightWithLightGroupIds*);
MARK_REF_T(::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RuntimeLightWithLightGroupIds*, "", "RuntimeLightWithLightGroupIds");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId*, "", "RuntimeLightWithLightGroupIds/LightIntensitiesWithId");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5871168, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t lightId, float_t intensity);

  /// @brief Method get_intensity, addr 0x58712dc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_intensity();

  /// @brief Method set_intensity, addr 0x58712e4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId) == 0x38, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies LightGroup, LightWithIds, RuntimeLightWithLightGroupIds::LightIntensitiesWithId
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__lightGroupList, put = __cordl_internal_set__lightGroupList)) ::ArrayW<::UnityW<::GlobalNamespace::LightGroup>> _lightGroupList;
  ...
  /// @brief Method Awake, addr 0x5870fb4, size 0x1b4, virtual true, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method GetLightWithIds, addr 0x58712c0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessColor, addr 0x58712a0, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::Color ProcessColor(::UnityEngine::Color color, float_t intensity);

  /// @brief Method ProcessNewColorData, addr 0x5871174, size 0x12c, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightGroup>> const& __cordl_internal_get__lightGroupList() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightGroup>>& __cordl_internal_get__lightGroupList();

  constexpr ::ArrayW<::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId*> const& __cordl_internal_get__lightIntensityData() const;

  constexpr ::ArrayW<::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId*>& __cordl_internal_get__lightIntensityData();
  ...
  constexpr void __cordl_internal_set__lightGroupList(::ArrayW<::UnityW<::GlobalNamespace::LightGroup>> value);

  constexpr void __cordl_internal_set__lightIntensityData(::ArrayW<::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId*> value);
  ...
  /// @brief Method .ctor, addr 0x58712c8, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId*> ____lightIntensityData;
...
static_assert(sizeof(::GlobalNamespace::RuntimeLightWithLightGroupIds) == 0x58, "Size mismatch!");
