...
public:
  ...
  /// @brief Method .ctor, addr 0x58739a4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_sqrtRadius, addr 0x5873994, size 0x8, virtual false, abstract: false, final false
  inline float_t get_sqrtRadius();

  /// @brief Method set_sqrtRadius, addr 0x587399c, size 0x8, virtual false, abstract: false, final false
