...
public:
  ...
  __declspec(property(get = __cordl_internal_get__burnMarksEmissionModules, put = __cordl_internal_set__burnMarksEmissionModules)) ::ArrayW<::UnityEngine::ParticleSystem_EmissionModule>
      _burnMarksEmissionModules;

  /// @brief Field _burnMarksPS, offset 0x88, size 0x8
  __declspec(property(get = __cordl_internal_get__burnMarksPS, put = __cordl_internal_set__burnMarksPS)) ::ArrayW<::UnityW<::UnityEngine::ParticleSystem>> _burnMarksPS;
  ...
  constexpr ::ArrayW<::UnityEngine::ParticleSystem_EmissionModule>& __cordl_internal_get__burnMarksEmissionModules();

  constexpr ::ArrayW<::UnityW<::UnityEngine::ParticleSystem>> const& __cordl_internal_get__burnMarksPS() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::ParticleSystem>>& __cordl_internal_get__burnMarksPS();
  ...
  constexpr ::ArrayW<::UnityEngine::Vector3> const& __cordl_internal_get__prevBurnMarkPos() const;

  constexpr ::ArrayW<::UnityEngine::Vector3>& __cordl_internal_get__prevBurnMarkPos();
  ...
  constexpr void __cordl_internal_set__burnMarksEmissionModules(::ArrayW<::UnityEngine::ParticleSystem_EmissionModule> value);

  constexpr void __cordl_internal_set__burnMarksPS(::ArrayW<::UnityW<::UnityEngine::ParticleSystem>> value);
  ...
  constexpr void __cordl_internal_set__prevBurnMarkPos(::ArrayW<::UnityEngine::Vector3> value);
...
public:
  ...
  ::ArrayW<::UnityW<::UnityEngine::ParticleSystem>> ____burnMarksPS;

  /// @brief Field _burnMarksEmissionModules, offset: 0x90, size: 0x8, def value: None
  ::ArrayW<::UnityEngine::ParticleSystem_EmissionModule> ____burnMarksEmissionModules;
...
static_assert(sizeof(::GlobalNamespace::SaberBurnMarkSparkles) == 0x128, "Size mismatch!");
