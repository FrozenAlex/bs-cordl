...
// Write type traits
MARK_REF_T(::GlobalNamespace::SafeAreaRectChecker*);
MARK_REF_T(::GlobalNamespace::SafeAreaRectChecker_InitData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SafeAreaRectChecker*, "", "SafeAreaRectChecker");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SafeAreaRectChecker_InitData*, "", "SafeAreaRectChecker/InitData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x59fbaf0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SafeAreaRectChecker_InitData) == 0x18, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__corners, put = __cordl_internal_set__corners)) ::ArrayW<::UnityEngine::Vector3> _corners;
  ...
  /// @brief Method Start, addr 0x59fb7d4, size 0x64, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x59fb838, size 0x250, virtual false, abstract: false, final false
  inline void Update();
  ...
  constexpr ::ArrayW<::UnityEngine::Vector3> const& __cordl_internal_get__corners() const;

  constexpr ::ArrayW<::UnityEngine::Vector3>& __cordl_internal_get__corners();
  ...
  constexpr void __cordl_internal_set__corners(::ArrayW<::UnityEngine::Vector3> value);
  ...
  /// @brief Method .ctor, addr 0x59fba88, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SafeAreaRectChecker) == 0x60, "Size mismatch!");
