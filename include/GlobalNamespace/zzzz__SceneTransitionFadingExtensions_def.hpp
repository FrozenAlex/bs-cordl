...
public:
  // Declarations
  /// @brief Method ShouldFadeOnSceneTransition, addr 0x5e0c64c, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SceneTransitionFadingExtensions) == 0x10, "Size mismatch!");
