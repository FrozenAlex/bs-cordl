...
public:
  ...
  /// @brief Method .ctor, addr 0x3695ea8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_executionOrder, addr 0x3695ecc, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_executionOrder();

  /// @brief Method get_maxCutScore, addr 0x3694dc0, size 0x1c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CompareTo, addr 0x3695ee8, size 0xb8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x36957d8, size 0x7c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ComputeMaxMultipliedScoreForBeatmap, addr 0x3694ddc, size 0x9fc, virtual false, abstract: false, final false
  static inline int32_t ComputeMaxMultipliedScoreForBeatmap(::GlobalNamespace::IReadonlyBeatmapData* beatmapData);

  /// @brief Method ComputeQuickInaccurateMaxMultipliedScoreForBeatmap, addr 0x3694d08, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetModifiedScoreForGameplayModifiersScoreMultiplier, addr 0x36958fc, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNoteScoreDefinition, addr 0x3694c80, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3695980, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
