...
// Write type traits
MARK_REF_T(::GlobalNamespace::ScoreMultiplierUIController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ScoreMultiplierUIController*, "", "ScoreMultiplierUIController");
// Dependencies TMPro.TextMeshProUGUI, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__multiplierTexts, put = __cordl_internal_set__multiplierTexts)) ::ArrayW<::UnityW<::TMPro::TextMeshProUGUI>> _multiplierTexts;
  ...
  constexpr ::ArrayW<::UnityW<::TMPro::TextMeshProUGUI>> const& __cordl_internal_get__multiplierTexts() const;

  constexpr ::ArrayW<::UnityW<::TMPro::TextMeshProUGUI>>& __cordl_internal_get__multiplierTexts();
  ...
  constexpr void __cordl_internal_set__multiplierTexts(::ArrayW<::UnityW<::TMPro::TextMeshProUGUI>> value);
...
static_assert(sizeof(::GlobalNamespace::ScoreMultiplierUIController) == 0x50, "Size mismatch!");
