...
// Write type traits
MARK_REF_T(::GlobalNamespace::ScoreSyncStateManager*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ScoreSyncStateManager*, "", "ScoreSyncStateManager");
// Dependencies MultiplayerSyncStateManager`5<TStateTable, TType, TState, TSerializable, TDeltaSerializable>, StandardScoreSyncState, StandardScoreSyncState::Score
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method Interpolate, addr 0x5b938d8, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b939dc, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_deltaMessageType, addr 0x5b938d0, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::NetworkMessageType get_deltaMessageType();

  /// @brief Method get_deltaSerializablePool, addr 0x5b938c0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_deltaUpdateFrequencyMs, addr 0x5b93898, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_deltaUpdateFrequencyMs();

  /// @brief Method get_fullStateUpdateFrequencyMs, addr 0x5b938a0, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_fullStateUpdateFrequencyMs();

  /// @brief Method get_localBufferSize, addr 0x5b938a8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_localBufferSize();

  /// @brief Method get_messageType, addr 0x5b938c8, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::NetworkMessageType get_messageType();

  /// @brief Method get_remoteBufferSize, addr 0x5b938b0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_remoteBufferSize();

  /// @brief Method get_serializablePool, addr 0x5b938b8, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ScoreSyncStateManager) == 0x40, "Size mismatch!");
