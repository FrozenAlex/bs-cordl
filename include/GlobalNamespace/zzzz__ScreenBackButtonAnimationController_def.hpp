...
MARK_REF_T(::GlobalNamespace::ScreenBackButtonAnimationController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ScreenBackButtonAnimationController_AnimationType, "", "ScreenBackButtonAnimationController/AnimationType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ScreenBackButtonAnimationController*, "", "ScreenBackButtonAnimationController");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::ScreenBackButtonAnimationController_AnimationType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method Awake, addr 0x3234d4c, size 0x1c, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::ScreenBackButtonAnimationController* New_ctor();

  /// @brief Method StartAnimation, addr 0x3234d68, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3234de0, size 0x27c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ScreenBackButtonAnimationController) == 0x30, "Size mismatch!");
