...
MARK_REF_T(::GlobalNamespace::ScreenCaptureCache*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ScreenCaptureCache_ScreenshotType, "", "ScreenCaptureCache/ScreenshotType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ScreenCaptureCache*, "", "ScreenCaptureCache");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::ScreenCaptureCache_ScreenshotType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetLastScreenshot, addr 0x5f44584, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method StoreScreenshot, addr 0x5f44288, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f44600, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ScreenCaptureCache) == 0x18, "Size mismatch!");
