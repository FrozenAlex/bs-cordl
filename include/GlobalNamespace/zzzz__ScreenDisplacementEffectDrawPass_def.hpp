...
public:
  ...
  /// @brief Method .ctor, addr 0x5e0e75c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Dispose, addr 0x5e0d198, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  static inline ::GlobalNamespace::ScreenDisplacementEffectDrawPass* New_ctor(::UnityEngine::LayerMask layerMask);

  /// @brief Method RecordRenderGraph, addr 0x5e0daac, size 0x9dc, virtual true, abstract: false, final false
  inline void RecordRenderGraph(::UnityEngine::Rendering::RenderGraphModule::RenderGraph* renderGraph, ::UnityEngine::Rendering::ContextContainer* frameData);

  /// @brief Method Render, addr 0x5e0e488, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e0d090, size 0xd0, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ScreenDisplacementEffectDrawPass) == 0xc0, "Size mismatch!");
