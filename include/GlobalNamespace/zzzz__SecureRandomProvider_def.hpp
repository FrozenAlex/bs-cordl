...
public:
  ...
  /// @brief Method FillBuffer, addr 0x333ce74, size 0x104, virtual false, abstract: false, final false
  inline void FillBuffer();

  /// @brief Method GetByte, addr 0x333cc74, size 0x94, virtual false, abstract: false, final false
  inline uint8_t GetByte();

  /// @brief Method GetBytes, addr 0x333cb60, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x333cdf4, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetByte, addr 0x333cc10, size 0x64, virtual false, abstract: false, final false
  static inline uint8_t GetByte();

  /// @brief Method GetBytes, addr 0x333cab8, size 0xa8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> GetBytes(int32_t length);

  /// @brief Method GetBytes, addr 0x333cd08, size 0x78, virtual false, abstract: false, final false
  static inline void GetBytes(::ArrayW<uint8_t> buffer);

  /// @brief Method GetBytes, addr 0x332cf5c, size 0x84, virtual false, abstract: false, final false
