...
// Write type traits
MARK_REF_T(::GlobalNamespace::SelectAvatarSystemCell*);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x57b7644, size 0x66c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x57b7cb0, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x57b7cb8, size 0x2c4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x57b7f7c, size 0x8, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
static_assert(sizeof(::GlobalNamespace::SelectAvatarSystemCell__ReloadIsCreated_d__17) == 0x40, "Size mismatch!");
...
public:
  ...
  /// @brief Method Activate, addr 0x57b74a0, size 0xb0, virtual false, abstract: false, final false
  inline void Activate();

  /// @brief Method Deactivate, addr 0x57b7550, size 0x8c, virtual false, abstract: false, final false
  inline void Deactivate();

  /// @brief Method HandleLoadedSelectionViewDidPressCreateButton, addr 0x57b761c, size 0x20, virtual false, abstract: false, final false
  inline void HandleLoadedSelectionViewDidPressCreateButton();

  /// @brief Method HandleLoadedSelectionViewDidPressEditButton, addr 0x57b75fc, size 0x20, virtual false, abstract: false, final false
  inline void HandleLoadedSelectionViewDidPressEditButton();

  /// @brief Method HandleLoadedSelectionViewDidPressPreferredButton, addr 0x57b75dc, size 0x20, virtual false, abstract: false, final false
  inline void HandleLoadedSelectionViewDidPressPreferredButton();

  /// @brief Method Load, addr 0x57b720c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x57b72b8, size 0x4, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method ReloadIsCreated, addr 0x57b7400, size 0xa0, virtual false, abstract: false, final false
  inline void ReloadIsCreated();

  /// @brief Method SetSelectedAvatarSystem, addr 0x57b7354, size 0xac, virtual false, abstract: false, final false
  inline void SetSelectedAvatarSystem(::BeatSaber::AvatarCore::IAvatarSystemMetadata* avatarSystem);

  /// @brief Method TryActivateOnEnable, addr 0x57b72bc, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57b763c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didRequestCreationOfAvatarEvent, addr 0x57b708c, size 0xc0, virtual false, abstract: false, final false
  inline void add_didRequestCreationOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method add_didRequestEditOfAvatarEvent, addr 0x57b6f0c, size 0xc0, virtual false, abstract: false, final false
  inline void add_didRequestEditOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method add_didSetAvatarSystemPreferredEvent, addr 0x57b6d8c, size 0xc0, virtual false, abstract: false, final false
  inline void add_didSetAvatarSystemPreferredEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method remove_didRequestCreationOfAvatarEvent, addr 0x57b714c, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didRequestCreationOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method remove_didRequestEditOfAvatarEvent, addr 0x57b6fcc, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didRequestEditOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method remove_didSetAvatarSystemPreferredEvent, addr 0x57b6e4c, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SelectAvatarSystemCell) == 0xb8, "Size mismatch!");
