...
public:
  ...
  /// @brief Method MoveNext, addr 0x5a1d46c, size 0x66c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5a1dad8, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5a1dae0, size 0x2c4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5a1dda4, size 0x8, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Activate, addr 0x5a16da4, size 0xb0, virtual false, abstract: false, final false
  inline void Activate();

  /// @brief Method Deactivate, addr 0x5a16e54, size 0x8c, virtual false, abstract: false, final false
  inline void Deactivate();

  /// @brief Method HandleLoadedSelectionViewDidPressCreateButton, addr 0x5a1d444, size 0x20, virtual false, abstract: false, final false
  inline void HandleLoadedSelectionViewDidPressCreateButton();

  /// @brief Method HandleLoadedSelectionViewDidPressEditButton, addr 0x5a1d424, size 0x20, virtual false, abstract: false, final false
  inline void HandleLoadedSelectionViewDidPressEditButton();

  /// @brief Method HandleLoadedSelectionViewDidPressPreferredButton, addr 0x5a1d404, size 0x20, virtual false, abstract: false, final false
  inline void HandleLoadedSelectionViewDidPressPreferredButton();

  /// @brief Method Load, addr 0x5a17488, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x5a1d368, size 0x4, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method ReloadIsCreated, addr 0x5a16d04, size 0xa0, virtual false, abstract: false, final false
  inline void ReloadIsCreated();

  /// @brief Method SetSelectedAvatarSystem, addr 0x5a16c58, size 0xac, virtual false, abstract: false, final false
  inline void SetSelectedAvatarSystem(::BeatSaber::AvatarCore::IAvatarSystemMetadata* avatarSystem);

  /// @brief Method TryActivateOnEnable, addr 0x5a1d36c, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a1d464, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didRequestCreationOfAvatarEvent, addr 0x5a17248, size 0xc0, virtual false, abstract: false, final false
  inline void add_didRequestCreationOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method add_didRequestEditOfAvatarEvent, addr 0x5a17308, size 0xc0, virtual false, abstract: false, final false
  inline void add_didRequestEditOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method add_didSetAvatarSystemPreferredEvent, addr 0x5a173c8, size 0xc0, virtual false, abstract: false, final false
  inline void add_didSetAvatarSystemPreferredEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method remove_didRequestCreationOfAvatarEvent, addr 0x5a1d2a8, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didRequestCreationOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method remove_didRequestEditOfAvatarEvent, addr 0x5a1d1e8, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didRequestEditOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method remove_didSetAvatarSystemPreferredEvent, addr 0x5a1d128, size 0xc0, virtual false, abstract: false, final false
