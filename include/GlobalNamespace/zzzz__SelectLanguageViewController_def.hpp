...
// Write type traits
MARK_REF_T(::GlobalNamespace::SelectLanguageViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SelectLanguageViewController*, "", "SelectLanguageViewController");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x583355c, size 0x138, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HandleLanguageSettingsControllerOndropDownValueDidChange, addr 0x58337b0, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5833694, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58337e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didChangeLanguageEvent, addr 0x58333dc, size 0xc0, virtual false, abstract: false, final false
  inline void add_didChangeLanguageEvent(::System::Action_1<::BGLib::Polyglot::LocalizationLanguage>* value);

  /// @brief Method remove_didChangeLanguageEvent, addr 0x583349c, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SelectLanguageViewController) == 0x98, "Size mismatch!");
