...
// Write type traits
MARK_REF_T(::GlobalNamespace::SelectLevelPackDestination*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SelectLevelPackDestination*, "", "SelectLevelPackDestination");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3648cec, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SelectLevelPackDestination) == 0x18, "Size mismatch!");
