...
public:
  ...
  /// @brief Method DidActivate, addr 0x5960158, size 0xa4, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::SelectModifiersViewController* New_ctor();

  /// @brief Method Setup, addr 0x5960140, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59601fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_gameplayModifiers, addr 0x5960128, size 0x18, virtual false, abstract: false, final false
