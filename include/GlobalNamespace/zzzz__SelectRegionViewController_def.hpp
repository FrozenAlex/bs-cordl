...
public:
  ...
  /// @brief Method <DidActivate>b__3_1, addr 0x5964304, size 0xc, virtual false, abstract: false, final false
  inline ::StringW _DidActivate_b__3_1(::GlobalNamespace::RegionToLocalizationKeyPair p);

  /// @brief Method .ctor, addr 0x5964300, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DidActivate, addr 0x5963e78, size 0x248, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HandleRegionSelectionDropdownDidSelectCell, addr 0x59641a8, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x59640c0, size 0xe8, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method <DidActivate>b__3_0, addr 0x5964230, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59641ec, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();
