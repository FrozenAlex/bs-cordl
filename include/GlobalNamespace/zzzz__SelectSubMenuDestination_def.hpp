...
MARK_REF_T(::GlobalNamespace::SelectSubMenuDestination*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SelectSubMenuDestination_Destination, "", "SelectSubMenuDestination/Destination");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SelectSubMenuDestination*, "", "SelectSubMenuDestination");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::SelectSubMenuDestination_Destination) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3703b98, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SelectSubMenuDestination) == 0x18, "Size mismatch!");
