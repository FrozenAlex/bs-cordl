...
// Write type traits
MARK_REF_T(::GlobalNamespace::SelectableCellSelectableStateController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SelectableCellSelectableStateController*, "", "SelectableCellSelectableStateController");
...
public:
  // Declarations
  /// @brief Method HandleSelectableCellHighlightDidChange, addr 0x643eec4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSelectableCellInteractableDidChange, addr 0x643ee30, size 0x94, virtual false, abstract: false, final false
  inline void HandleSelectableCellInteractableDidChange(::HMUI::Interactable* interactableCell, bool interactable);

  /// @brief Method HandleSelectableCellSelectionStateDidChange, addr 0x643eec8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x643ecd8, size 0x158, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x643eafc, size 0x168, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method ResolveState, addr 0x643ec64, size 0x74, virtual false, abstract: false, final false
  inline void ResolveState(::HMUI::SelectableCell* selectableCell, ::HMUI::SelectableCell_TransitionType transitionType);

  /// @brief Method .ctor, addr 0x643eecc, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SelectableCellSelectableStateController) == 0x40, "Size mismatch!");
