...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::SelectableStateController_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::SelectableStateController_1, "", "SelectableStateController`1");
