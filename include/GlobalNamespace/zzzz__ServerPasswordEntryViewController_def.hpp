...
public:
  ...
  /// @brief Method DidActivate, addr 0x5960838, size 0x108, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x5960940, size 0xc4, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleJoinClicked, addr 0x5960a04, size 0x38, virtual false, abstract: false, final false
  inline void HandleJoinClicked();

  /// @brief Method HandleUIKeyboardOkButtonWasPressed, addr 0x5960a3c, size 0x38, virtual false, abstract: false, final false
  inline void HandleUIKeyboardOkButtonWasPressed();

  static inline ::GlobalNamespace::ServerPasswordEntryViewController* New_ctor();

  /// @brief Method Setup, addr 0x5960830, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5960a74, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x59606b0, size 0xc0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_2<::GlobalNamespace::INetworkPlayer*, ::StringW>* value);

  /// @brief Method remove_didFinishEvent, addr 0x5960770, size 0xc0, virtual false, abstract: false, final false
