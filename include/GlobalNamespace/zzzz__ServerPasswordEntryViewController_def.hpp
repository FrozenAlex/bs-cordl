...
// Write type traits
MARK_REF_T(::GlobalNamespace::ServerPasswordEntryViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ServerPasswordEntryViewController*, "", "ServerPasswordEntryViewController");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x5831170, size 0x108, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x5831278, size 0xc4, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleJoinClicked, addr 0x583133c, size 0x38, virtual false, abstract: false, final false
  inline void HandleJoinClicked();

  /// @brief Method HandleUIKeyboardOkButtonWasPressed, addr 0x5831374, size 0x38, virtual false, abstract: false, final false
  inline void HandleUIKeyboardOkButtonWasPressed();

  static inline ::GlobalNamespace::ServerPasswordEntryViewController* New_ctor();

  /// @brief Method Setup, addr 0x5831168, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58313ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x5830fe8, size 0xc0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_2<::GlobalNamespace::INetworkPlayer*, ::StringW>* value);

  /// @brief Method remove_didFinishEvent, addr 0x58310a8, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ServerPasswordEntryViewController) == 0x98, "Size mismatch!");
