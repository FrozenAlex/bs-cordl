...
// Write type traits
MARK_REF_T(::GlobalNamespace::ServerPlayerListViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ServerPlayerListViewController*, "", "ServerPlayerListViewController");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x5831988, size 0x414, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x58322fc, size 0x390, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleKickPlayer, addr 0x58326ec, size 0x1c, virtual false, abstract: false, final false
  inline void HandleKickPlayer(::StringW userId);

  /// @brief Method HandleLobbyGameStateControllerLobbyStateChanged, addr 0x5832690, size 0x4, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerLobbyStateChanged(::GlobalNamespace::MultiplayerLobbyState _);

  /// @brief Method HandleLobbyPlayerPermissionChanged, addr 0x5832694, size 0x4, virtual false, abstract: false, final false
  inline void HandleLobbyPlayerPermissionChanged();

  /// @brief Method HandleLobbyPlayersDataDidChange, addr 0x583268c, size 0x4, virtual false, abstract: false, final false
  inline void HandleLobbyPlayersDataDidChange(::StringW userId);

  /// @brief Method HandleOpenPlatformInvitePanel, addr 0x5832708, size 0xcc, virtual false, abstract: false, final false
  inline void HandleOpenPlatformInvitePanel();

  /// @brief Method HandleSelectSuggestedGameplayModifiers, addr 0x58326d0, size 0x1c, virtual false, abstract: false, final false
  inline void HandleSelectSuggestedGameplayModifiers(::GlobalNamespace::GameplayModifiers* gameplayModifiers);

  /// @brief Method HandleSelectSuggestedLevel, addr 0x5832698, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDataToTable, addr 0x58320b4, size 0x248, virtual false, abstract: false, final false
  inline void SetDataToTable();

  /// @brief Method TrySetInviteButtonEnabled, addr 0x5831d9c, size 0x318, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58327d4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didOpenInvitePanelEvent, addr 0x5831830, size 0xac, virtual false, abstract: false, final false
  inline void add_didOpenInvitePanelEvent(::System::Action* value);

  /// @brief Method add_kickPlayerEvent, addr 0x58316b0, size 0xc0, virtual false, abstract: false, final false
  inline void add_kickPlayerEvent(::System::Action_1<::StringW>* value);

  /// @brief Method add_selectSuggestedBeatmapEvent, addr 0x58313b0, size 0xc0, virtual false, abstract: false, final false
  inline void add_selectSuggestedBeatmapEvent(::System::Action_1<::GlobalNamespace::BeatmapKey>* value);

  /// @brief Method add_selectSuggestedGameplayModifiersEvent, addr 0x5831530, size 0xc0, virtual false, abstract: false, final false
  inline void add_selectSuggestedGameplayModifiersEvent(::System::Action_1<::GlobalNamespace::GameplayModifiers*>* value);

  /// @brief Method remove_didOpenInvitePanelEvent, addr 0x58318dc, size 0xac, virtual false, abstract: false, final false
  inline void remove_didOpenInvitePanelEvent(::System::Action* value);

  /// @brief Method remove_kickPlayerEvent, addr 0x5831770, size 0xc0, virtual false, abstract: false, final false
  inline void remove_kickPlayerEvent(::System::Action_1<::StringW>* value);

  /// @brief Method remove_selectSuggestedBeatmapEvent, addr 0x5831470, size 0xc0, virtual false, abstract: false, final false
  inline void remove_selectSuggestedBeatmapEvent(::System::Action_1<::GlobalNamespace::BeatmapKey>* value);

  /// @brief Method remove_selectSuggestedGameplayModifiersEvent, addr 0x58315f0, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ServerPlayerListViewController) == 0xe0, "Size mismatch!");
