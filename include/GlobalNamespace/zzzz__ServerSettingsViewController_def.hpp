...
// Write type traits
MARK_REF_T(::GlobalNamespace::ServerSettingsViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ServerSettingsViewController*, "", "ServerSettingsViewController");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x57ac234, size 0x260, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x57ac494, size 0x64, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleEnabledChanged, addr 0x57ac4f8, size 0x1c, virtual false, abstract: false, final false
  inline void HandleEnabledChanged(bool newValue);

  /// @brief Method HandleForceGameliftChanged, addr 0x57ac53c, size 0x1c, virtual false, abstract: false, final false
  inline void HandleForceGameliftChanged(bool newValue);

  /// @brief Method HandleHostnameChanged, addr 0x57ac514, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57ac558, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
