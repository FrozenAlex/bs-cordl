...
public:
  ...
  /// @brief Method Start, addr 0x58b9eac, size 0x40, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x58b9eec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SetBlocksBladeSaberGlowColor) == 0x38, "Size mismatch!");
