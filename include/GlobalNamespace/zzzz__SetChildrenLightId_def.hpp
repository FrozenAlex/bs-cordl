...
// Write type traits
MARK_REF_T(::GlobalNamespace::SetChildrenLightId*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SetChildrenLightId*, "", "SetChildrenLightId");
...
public:
  ...
  /// @brief Method .ctor, addr 0x572c24c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SetChildrenLightId) == 0x20, "Size mismatch!");
