...
// Write type traits
MARK_REF_T(::GlobalNamespace::SetSaberBladeParams*);
MARK_REF_T(::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SetSaberBladeParams*, "", "SetSaberBladeParams");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*, "", "SetSaberBladeParams/PropertyTintColorPair");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58ba098, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__propertyTintColorPairs, put = __cordl_internal_set__propertyTintColorPairs)) ::ArrayW<::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*>
  ...
  /// @brief Method Start, addr 0x58b9f5c, size 0x138, virtual false, abstract: false, final false
  inline void Start();
  ...
  constexpr ::ArrayW<::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*> const& __cordl_internal_get__propertyTintColorPairs() const;

  constexpr ::ArrayW<::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*>& __cordl_internal_get__propertyTintColorPairs();
  ...
  constexpr void __cordl_internal_set__propertyTintColorPairs(::ArrayW<::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*> value);

  constexpr void __cordl_internal_set__saber(::UnityW<::GlobalNamespace::SaberTypeObject> value);

  /// @brief Method .ctor, addr 0x58ba094, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SetSaberBladeParams) == 0x40, "Size mismatch!");
