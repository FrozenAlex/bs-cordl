...
// Write type traits
MARK_REF_T(::GlobalNamespace::SetSaberGlowColor*);
MARK_REF_T(::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SetSaberGlowColor*, "", "SetSaberGlowColor");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*, "", "SetSaberGlowColor/PropertyTintColorPair");
...
public:
  ...
  /// @brief Method .ctor, addr 0x59e9188, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__propertyTintColorPairs, put = __cordl_internal_set__propertyTintColorPairs)) ::ArrayW<::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*>
  ...
  /// @brief Method SetColors, addr 0x59e8fa8, size 0x158, virtual false, abstract: false, final false
  inline void SetColors();

  /// @brief Method Start, addr 0x59e9100, size 0x84, virtual false, abstract: false, final false
  inline void Start();
  ...
  constexpr ::ArrayW<::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*> const& __cordl_internal_get__propertyTintColorPairs() const;

  constexpr ::ArrayW<::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*>& __cordl_internal_get__propertyTintColorPairs();
  ...
  constexpr void __cordl_internal_set__propertyTintColorPairs(::ArrayW<::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*> value);
  ...
  /// @brief Method .ctor, addr 0x59e9184, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_saberType, addr 0x59e8a48, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SetSaberGlowColor) == 0x50, "Size mismatch!");
