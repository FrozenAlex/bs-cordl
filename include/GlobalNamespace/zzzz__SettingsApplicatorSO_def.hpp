...
// Write type traits
MARK_REF_T(::GlobalNamespace::SettingsApplicatorSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SettingsApplicatorSO*, "", "SettingsApplicatorSO");
...
static_assert(sizeof(::GlobalNamespace::SettingsApplicatorSO) == 0x68, "Size mismatch!");
