...
static_assert(sizeof(::GlobalNamespace::SettingsIO__LoadAsync_d__15) == 0x148, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::SettingsIO__SaveAsync_d__14) == 0x138, "Size mismatch!");
