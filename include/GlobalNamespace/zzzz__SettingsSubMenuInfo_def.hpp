...
// Write type traits
MARK_REF_T(::GlobalNamespace::SettingsSubMenuInfo*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SettingsSubMenuInfo*, "", "SettingsSubMenuInfo");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5a12920, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_localizedMenuName, addr 0x5a12914, size 0xc, virtual false, abstract: false, final false
  inline ::StringW get_localizedMenuName();

  /// @brief Method get_viewController, addr 0x5a1290c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SettingsSubMenuInfo) == 0x20, "Size mismatch!");
