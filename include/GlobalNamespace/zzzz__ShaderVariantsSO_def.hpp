...
// Write type traits
MARK_REF_T(::GlobalNamespace::ShaderVariant_ShaderVariantsSO_Variant*);
MARK_REF_T(::GlobalNamespace::ShaderVariantsSO*);
MARK_REF_T(::GlobalNamespace::ShaderVariantsSO_ShaderVariant*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ShaderVariant_ShaderVariantsSO_Variant*, "", "ShaderVariantsSO/ShaderVariant/Variant");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ShaderVariantsSO*, "", "ShaderVariantsSO");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ShaderVariantsSO_ShaderVariant*, "", "ShaderVariantsSO/ShaderVariant");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5f474cc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Rendering::PassType passType, ::StringW keywords);

  /// @brief Method get_keywords, addr 0x5f474c4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_keywords();

  /// @brief Method get_passType, addr 0x5f474bc, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ShaderVariant_ShaderVariantsSO_Variant) == 0x20, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies ShaderVariantsSO::ShaderVariant::Variant, System.Object
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__variants, put = __cordl_internal_set__variants)) ::ArrayW<::GlobalNamespace::ShaderVariant_ShaderVariantsSO_Variant*> _variants;

  __declspec(property(get = get_shader)) ::UnityW<::UnityEngine::Shader> shader;

  __declspec(property(get = get_variants)) ::ArrayW<::GlobalNamespace::ShaderVariant_ShaderVariantsSO_Variant*> variants;

  static inline ::GlobalNamespace::ShaderVariantsSO_ShaderVariant* New_ctor(::UnityEngine::Shader* shader, ::ArrayW<::GlobalNamespace::ShaderVariant_ShaderVariantsSO_Variant*> variants);
  ...
  constexpr ::ArrayW<::GlobalNamespace::ShaderVariant_ShaderVariantsSO_Variant*> const& __cordl_internal_get__variants() const;

  constexpr ::ArrayW<::GlobalNamespace::ShaderVariant_ShaderVariantsSO_Variant*>& __cordl_internal_get__variants();
  ...
  /// @brief Method .ctor, addr 0x5f474b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Shader* shader, ::ArrayW<::GlobalNamespace::ShaderVariant_ShaderVariantsSO_Variant*> variants);

  /// @brief Method get_shader, addr 0x5f474ac, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_shader();

  /// @brief Method get_variants, addr 0x5f474a4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ShaderVariantsSO_ShaderVariant) == 0x20, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies PersistentScriptableObject, ShaderVariantsSO::ShaderVariant
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__shaderVariants, put = __cordl_internal_set__shaderVariants)) ::ArrayW<::GlobalNamespace::ShaderVariantsSO_ShaderVariant*> _shaderVariants;

  __declspec(property(get = get_shaderVariants)) ::ArrayW<::GlobalNamespace::ShaderVariantsSO_ShaderVariant*> shaderVariants;

  /// @brief Method Init, addr 0x5f47494, size 0x8, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::ShaderVariantsSO_ShaderVariant*> const& __cordl_internal_get__shaderVariants() const;

  constexpr ::ArrayW<::GlobalNamespace::ShaderVariantsSO_ShaderVariant*>& __cordl_internal_get__shaderVariants();

  constexpr void __cordl_internal_set__shaderVariants(::ArrayW<::GlobalNamespace::ShaderVariantsSO_ShaderVariant*> value);

  /// @brief Method .ctor, addr 0x5f4749c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_shaderVariants, addr 0x5f4748c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ShaderVariantsSO) == 0x20, "Size mismatch!");
