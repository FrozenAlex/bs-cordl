...
public:
  ...
  /// @brief Method InstallBindings, addr 0x590edc0, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x590eea4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
