...
// Write type traits
MARK_REF_T(::GlobalNamespace::ShaderWarmupSceneSetup*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ShaderWarmupSceneSetup*, "", "ShaderWarmupSceneSetup");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x57f2cb0, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57f2d94, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ShaderWarmupSceneSetup) == 0x30, "Size mismatch!");
