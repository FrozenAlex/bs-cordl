...
// Write type traits
MARK_REF_T(::GlobalNamespace::ShaderWarmupSceneStart*);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x57f2dfc, size 0xb8, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::ShaderWarmupSceneStart__Start_d__2* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x57f2eb4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x57f2ebc, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x57f2ef4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x57f2df8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x57f2dec, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ShaderWarmupSceneStart__Start_d__2) == 0x28, "Size mismatch!");
...
public:
  ...
  /// @brief Method Start, addr 0x57f2d98, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57f2df4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ShaderWarmupSceneStart) == 0x30, "Size mismatch!");
