...
// Write type traits
MARK_REF_T(::GlobalNamespace::SharedSpatialAnchorCoreBuildingBlock*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SharedSpatialAnchorCoreBuildingBlock*, "", "SharedSpatialAnchorCoreBuildingBlock");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58f767c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SharedSpatialAnchorCoreBuildingBlock) == 0x40, "Size mismatch!");
