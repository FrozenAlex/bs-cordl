...
// Write type traits
MARK_REF_T(::GlobalNamespace::SharedSpatialAnchorErrorHandler*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SharedSpatialAnchorErrorHandler*, "", "SharedSpatialAnchorErrorHandler");
...
public:
  ...
  /// @brief Method Awake, addr 0x58f76c0, size 0xa8, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method LogWarning, addr 0x58f77e4, size 0xac, virtual false, abstract: false, final false
  inline void LogWarning(::StringW msg);

  static inline ::GlobalNamespace::SharedSpatialAnchorErrorHandler* New_ctor();

  /// @brief Method OnAnchorCreate, addr 0x58f7768, size 0x7c, virtual false, abstract: false, final false
  inline void OnAnchorCreate(::GlobalNamespace::OVRSpatialAnchor* _, ::GlobalNamespace::OVRSpatialAnchor_OperationResult result);

  /// @brief Method OnAnchorErase, addr 0x58f7a1c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnAnchorEraseAll, addr 0x58f79ac, size 0x70, virtual false, abstract: false, final false
  inline void OnAnchorEraseAll(::GlobalNamespace::OVRSpatialAnchor_OperationResult result);

  /// @brief Method OnAnchorShare, addr 0x58f7890, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSharedSpatialAnchorLoad, addr 0x58f790c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58f7ad0, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SharedSpatialAnchorErrorHandler) == 0x38, "Size mismatch!");
