...
// Write type traits
MARK_REF_T(::GlobalNamespace::ShowTextOnGameEventController*);
MARK_REF_T(::GlobalNamespace::ShowTextOnGameEventController_EventTextBinding*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ShowTextOnGameEventController*, "", "ShowTextOnGameEventController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ShowTextOnGameEventController_EventTextBinding*, "", "ShowTextOnGameEventController/EventTextBinding");
...
public:
  ...
  /// @brief Method Deinit, addr 0x58b5cfc, size 0x8c, virtual false, abstract: false, final false
  inline void Deinit();

  /// @brief Method HandleGameEvent, addr 0x58b5d8c, size 0x38, virtual false, abstract: false, final false
  inline void HandleGameEvent();

  /// @brief Method Init, addr 0x58b5c04, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58b5e44, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__eventTextBindings, put = __cordl_internal_set__eventTextBindings)) ::ArrayW<::GlobalNamespace::ShowTextOnGameEventController_EventTextBinding*>
      _eventTextBindings;

  /// @brief Field _textFadeTransitions, offset 0x20, size 0x8
  __declspec(property(get = __cordl_internal_get__textFadeTransitions, put = __cordl_internal_set__textFadeTransitions)) ::UnityW<::GlobalNamespace::TextFadeTransitions> _textFadeTransitions;

  /// @brief Method Awake, addr 0x58b5ba4, size 0x60, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::ShowTextOnGameEventController* New_ctor();

  /// @brief Method OnDestroy, addr 0x58b5cac, size 0x50, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::ShowTextOnGameEventController_EventTextBinding*>& __cordl_internal_get__eventTextBindings();

  constexpr ::UnityW<::GlobalNamespace::TextFadeTransitions> const& __cordl_internal_get__textFadeTransitions() const;

  constexpr ::UnityW<::GlobalNamespace::TextFadeTransitions>& __cordl_internal_get__textFadeTransitions();

  constexpr void __cordl_internal_set__eventTextBindings(::ArrayW<::GlobalNamespace::ShowTextOnGameEventController_EventTextBinding*> value);

  constexpr void __cordl_internal_set__textFadeTransitions(::UnityW<::GlobalNamespace::TextFadeTransitions> value);

  /// @brief Method .ctor, addr 0x58b5d88, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ShowTextOnGameEventController) == 0x30, "Size mismatch!");
