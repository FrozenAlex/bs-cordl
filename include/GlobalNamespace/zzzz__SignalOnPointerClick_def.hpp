...
// Write type traits
MARK_REF_T(::GlobalNamespace::SignalOnPointerClick*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SignalOnPointerClick*, "", "SignalOnPointerClick");
...
public:
  ...
  /// @brief Method OnPointerClick, addr 0x5859e80, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5859e9c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SignalOnPointerClick) == 0x28, "Size mismatch!");
