...
public:
  ...
  /// @brief Method OnDestroy, addr 0x5859f88, size 0x130, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RaiseSignal, addr 0x585a0b8, size 0x1c, virtual false, abstract: false, final false
  inline void RaiseSignal(bool newValue);

  /// @brief Method Start, addr 0x5859ea0, size 0xe8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x585a0d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
