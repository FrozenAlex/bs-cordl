...
// Write type traits
MARK_REF_T(::GlobalNamespace::SignalOnUIButtonClick*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SignalOnUIButtonClick*, "", "SignalOnUIButtonClick");
...
static_assert(sizeof(::GlobalNamespace::SignalOnUIButtonClick) == 0x30, "Size mismatch!");
