...
// Write type traits
MARK_REF_T(::GlobalNamespace::SimpleAudioPlayer*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SimpleAudioPlayer*, "", "SimpleAudioPlayer");
...
public:
  ...
  /// @brief Method FadeIn, addr 0x5780348, size 0x3c, virtual false, abstract: false, final false
  inline void FadeIn(float_t duration);

  /// @brief Method FadeOut, addr 0x57804bc, size 0x38, virtual true, abstract: false, final false
  inline void FadeOut(float_t duration);

  static inline ::GlobalNamespace::SimpleAudioPlayer* New_ctor();

  /// @brief Method PauseCurrentChannel, addr 0x57804f4, size 0x18, virtual true, abstract: false, final false
  inline void PauseCurrentChannel();

  /// @brief Method Start, addr 0x57802cc, size 0x7c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UnPauseCurrentChannel, addr 0x578050c, size 0x18, virtual true, abstract: false, final false
  inline void UnPauseCurrentChannel();

  /// @brief Method Update, addr 0x5780384, size 0x138, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5780524, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_activeAudioClip, addr 0x57802c4, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SimpleAudioPlayer) == 0x40, "Size mismatch!");
