...
class SimpleDialogPromptViewController___c__DisplayClass5_0;
}
namespace System {
...
// Write type traits
MARK_REF_T(::GlobalNamespace::SimpleDialogPromptViewController*);
...
class CORDL_TYPE SimpleDialogPromptViewController___c__DisplayClass5_0 : public ::System::Object {
public:
  // Declarations
  ...
  /// @brief Method <DidActivate>b__0, addr 0x57acf18, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57acd28, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::SimpleDialogPromptViewController___c__DisplayClass5_0, ___buttonNum) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SimpleDialogPromptViewController___c__DisplayClass5_0, _____4__this) == 0x18, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::SimpleDialogPromptViewController___c__DisplayClass5_0) == 0x20, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies HMUI.ViewController, TMPro.TextMeshProUGUI, UnityEngine.UI.Button
namespace GlobalNamespace {
// Is value type: false
...
public:
  // Declarations
  using __c__DisplayClass5_0 = ::GlobalNamespace::SimpleDialogPromptViewController___c__DisplayClass5_0;
  ...
  /// @brief Method DidActivate, addr 0x57acbb8, size 0x170, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x57acd2c, size 0xc, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method Init, addr 0x57acd38, size 0x10, virtual false, abstract: false, final false
  inline void Init(::StringW title, ::StringW message, ::StringW buttonText, ::System::Action_1<int32_t>* didFinishAction);

  /// @brief Method Init, addr 0x57acf0c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x57acd48, size 0x1c4, virtual false, abstract: false, final false
  ...
  constexpr ::System::Action_1<int32_t>* const& __cordl_internal_get__didFinishAction() const;
  ...
  /// @brief Method .ctor, addr 0x57a7b60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SimpleDialogPromptViewController) == 0xa0, "Size mismatch!");
