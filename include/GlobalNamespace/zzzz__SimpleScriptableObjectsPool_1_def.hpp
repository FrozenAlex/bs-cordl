...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::SimpleScriptableObjectsPool_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::SimpleScriptableObjectsPool_1, "", "SimpleScriptableObjectsPool`1");
