...
// Write type traits
MARK_REF_T(::GlobalNamespace::SimpleTextTableCell*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SimpleTextTableCell*, "", "SimpleTextTableCell");
...
public:
  ...
  /// @brief Method .ctor, addr 0x572ef9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_text, addr 0x572ef7c, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method set_text, addr 0x572ef5c, size 0x20, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::SimpleTextTableCell, ____text) == 0x78, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::SimpleTextTableCell) == 0x80, "Size mismatch!");
