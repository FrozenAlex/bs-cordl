...
// Write type traits
MARK_REF_T(::GlobalNamespace::SimpleValueMissionObjectiveChecker*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SimpleValueMissionObjectiveChecker*, "", "SimpleValueMissionObjectiveChecker");
...
public:
  // Declarations
  /// @brief Method CheckAndUpdateStatus, addr 0x587d910, size 0xfc, virtual false, abstract: false, final false
  inline void CheckAndUpdateStatus();

  static inline ::GlobalNamespace::SimpleValueMissionObjectiveChecker* New_ctor();

  /// @brief Method .ctor, addr 0x587da10, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SimpleValueMissionObjectiveChecker) == 0x50, "Size mismatch!");
