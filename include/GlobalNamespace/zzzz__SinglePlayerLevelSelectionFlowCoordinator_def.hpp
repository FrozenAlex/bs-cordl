...
public:
  ...
  /// @brief Method <StartLevelOrShow360Prompt>b__0, addr 0x59358ec, size 0xd0, virtual false, abstract: false, final false
  inline void _StartLevelOrShow360Prompt_b__0(int32_t _);

  /// @brief Method <StartLevelOrShow360Prompt>b__1, addr 0x59359bc, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5935750, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ActionButtonWasPressed, addr 0x5935360, size 0xc, virtual true, abstract: false, final false
  inline void ActionButtonWasPressed();

  /// @brief Method BackButtonWasPressed, addr 0x59357d0, size 0x64, virtual true, abstract: false, final false
  inline void BackButtonWasPressed(::HMUI::ViewController* topViewController);

  /// @brief Method DismissPracticeViewController, addr 0x5935834, size 0xb8, virtual false, abstract: false, final false
  inline void DismissPracticeViewController(::System::Action* finishedCallback, bool immediately);

  /// @brief Method HandleBasicLevelCompletionResults, addr 0x59349e0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method HandlePracticeViewControllerDidPressPlayButton, addr 0x5935754, size 0xc, virtual false, abstract: false, final false
  inline void HandlePracticeViewControllerDidPressPlayButton();

  /// @brief Method HandleStandardLevelDidFinish, addr 0x5935760, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleStandardLevelWasRestarted, addr 0x59357cc, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method LevelSelectionFlowCoordinatorDidActivate, addr 0x5934f60, size 0xc0, virtual true, abstract: false, final true
  inline void LevelSelectionFlowCoordinatorDidActivate(bool firstActivation, bool addedToHierarchy);

  /// @brief Method LevelSelectionFlowCoordinatorDidDeactivate, addr 0x5935020, size 0xb8, virtual true, abstract: false, final true
  inline void LevelSelectionFlowCoordinatorDidDeactivate(bool removedFromHierarchy);

  /// @brief Method LevelSelectionFlowCoordinatorTopViewControllerWillChange, addr 0x59350d8, size 0x288, virtual true, abstract: false, final false
  ...
  /// @brief Method PracticeButtonWasPressed, addr 0x5935630, size 0x88, virtual true, abstract: false, final false
  inline void PracticeButtonWasPressed();

  /// @brief Method ProcessLevelCompletionResultsAfterLevelDidFinish, addr 0x5934f5c, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method SelectionDidChange, addr 0x59356b8, size 0x98, virtual true, abstract: false, final false
  inline void SelectionDidChange(::GlobalNamespace::BeatmapLevelPack* pack, ::by_ref<::GlobalNamespace::BeatmapKey> beatmapKey);

  /// @brief Method SetupGameplaySetupViewController, addr 0x5934598, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidActivate, addr 0x5934f54, size 0x4, virtual true, abstract: false, final false
  inline void SinglePlayerLevelSelectionFlowCoordinatorDidActivate(bool firstActivation, bool addedToHierarchy);

  /// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate, addr 0x5934f58, size 0x4, virtual true, abstract: false, final false
  inline void SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate(bool removedFromHierarchy);

  /// @brief Method StartLevel, addr 0x5925eec, size 0x2ac, virtual false, abstract: false, final false
  inline void StartLevel(::System::Action* beforeSceneSwitchCallback, bool practice);

  /// @brief Method StartLevelOrShow360Prompt, addr 0x593536c, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5934cfc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x5923028, size 0xc0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::SinglePlayerLevelSelectionFlowCoordinator>>* value);

  /// @brief Method get_enableCustomLevels, addr 0x5934ed0, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method get_gameplayModifiers, addr 0x5934ee8, size 0x24, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers();

  /// @brief Method get_hideGameplaySetup, addr 0x5934f0c, size 0x8, virtual true, abstract: false, final false
  inline bool get_hideGameplaySetup();

  /// @brief Method get_initialLeftScreenViewController, addr 0x5934f24, size 0x30, virtual true, abstract: false, final false
  inline ::UnityW<::HMUI::ViewController> get_initialLeftScreenViewController();

  /// @brief Method get_initialTopScreenViewController, addr 0x5934f1c, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::HMUI::ViewController> get_initialTopScreenViewController();

  /// @brief Method get_isInPracticeView, addr 0x5934e38, size 0x78, virtual false, abstract: false, final false
  inline bool get_isInPracticeView();

  /// @brief Method get_leaderboardViewController, addr 0x5934f14, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::LeaderboardViewController> get_leaderboardViewController();

  /// @brief Method get_playerSettings, addr 0x5934eb0, size 0x20, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettings* get_playerSettings();

  /// @brief Method remove_didFinishEvent, addr 0x59238c0, size 0xc0, virtual false, abstract: false, final false
