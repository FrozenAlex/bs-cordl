...
// Write type traits
MARK_REF_T(::GlobalNamespace::SliderControllerBase*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SliderControllerBase*, "", "SliderControllerBase");
...
public:
  ...
  /// @brief Method AnimateCutout, addr 0x583f198, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x583fb94, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SliderControllerBase) == 0x38, "Size mismatch!");
