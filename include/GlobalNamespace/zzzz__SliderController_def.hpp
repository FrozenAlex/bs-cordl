...
namespace GlobalNamespace {
class SliderController__DissolveCoroutine_d__72;
}
namespace GlobalNamespace {
class SliderData;
}
...
MARK_REF_T(::GlobalNamespace::Pool_SliderController_Long*);
MARK_REF_T(::GlobalNamespace::Pool_SliderController_Medium*);
MARK_REF_T(::GlobalNamespace::Pool_SliderController_Short*);
MARK_REF_T(::GlobalNamespace::SliderController*);
MARK_REF_T(::GlobalNamespace::SliderController_Pool*);
MARK_REF_T(::GlobalNamespace::SliderController__DissolveCoroutine_d__72*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SliderController_LengthType, "", "SliderController/LengthType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::Pool_SliderController_Long*, "", "SliderController/Pool/Long");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::Pool_SliderController_Medium*, "", "SliderController/Pool/Medium");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::Pool_SliderController_Short*, "", "SliderController/Pool/Short");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SliderController*, "", "SliderController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SliderController_Pool*, "", "SliderController/Pool");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SliderController__DissolveCoroutine_d__72*, "", "SliderController/<DissolveCoroutine>d__72");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::SliderController_LengthType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x59766c8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::Pool_SliderController_Short) == 0x40, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5976704, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::Pool_SliderController_Medium) == 0x40, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5976740, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::Pool_SliderController_Long) == 0x40, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetLengthFromSliderData, addr 0x5976624, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPool, addr 0x5976574, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5976568, size 0xc, virtual false, abstract: false, final false
...
namespace GlobalNamespace {
// Is value type: false
// CS Name: SliderController/<DissolveCoroutine>d__72
class CORDL_TYPE SliderController__DissolveCoroutine_d__72 : public ::System::Object {
public:
  // Declarations
  ...
  /// @brief Method MoveNext, addr 0x5976780, size 0x35c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::SliderController__DissolveCoroutine_d__72* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x5976adc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5976ae4, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5976b1c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x597677c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5975b08, size 0x8, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::SliderController__DissolveCoroutine_d__72, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController__DissolveCoroutine_d__72, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController__DissolveCoroutine_d__72, _____4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController__DissolveCoroutine_d__72, ___duration) == 0x28, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::SliderController__DissolveCoroutine_d__72) == 0x30, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies SliderController::LengthType, SliderControllerBase, SliderSpawnData, UnityEngine.Color
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  using _DissolveCoroutine_d__72 = ::GlobalNamespace::SliderController__DissolveCoroutine_d__72;

  /// @brief Field _attractingSaber, offset 0xfc, size 0x1
  ...
  /// @brief Field _closeSmoothedSaberInteractionPos, offset 0x110, size 0x8
  ...
  /// @brief Field _lengthType, offset 0xb0, size 0x4
  ...
  /// @brief Field _sliderData, offset 0xb8, size 0x8
  ...
  /// @brief Field _sliderDidDissolve, offset 0x98, size 0x8
  ...
  /// @brief Field _sliderDidFinishMovement, offset 0x88, size 0x8
  ...
  /// @brief Field _sliderDidStartDissolving, offset 0x90, size 0x8
  ...
  /// @brief Field _sliderDuration, offset 0xe8, size 0x4
  ...
  /// @brief Field _sliderHeadDidMovePastCutMark, offset 0xa0, size 0x8
  __declspec(property(
  ...
  /// @brief Field _sliderSpawnData, offset 0xc0, size 0x20
  ...
  /// @brief Field _sliderTailDidMovePastCutMark, offset 0xa8, size 0x8
  __declspec(property(
  ...
  /// @brief Field _timeHelper, offset 0x80, size 0x8
  ...
  /// @brief Field _zDistanceBetweenNotes, offset 0x104, size 0x4
  ...
  /// @brief Method Awake, addr 0x5974330, size 0x1e4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Dissolve, addr 0x5975b10, size 0x58, virtual true, abstract: false, final true
  inline void Dissolve(float_t duration);

  /// @brief Method DissolveCoroutine, addr 0x5975aa4, size 0x64, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* DissolveCoroutine(float_t duration);

  /// @brief Method FixedUpdate, addr 0x5975110, size 0x9c, virtual false, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method GetSaberInteractionPoint, addr 0x5974208, size 0x50, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetSaberInteractionPoint(::GlobalNamespace::Saber* saber);

  /// @brief Method HandleFadeInDidStart, addr 0x59762e4, size 0x8, virtual false, abstract: false, final false
  inline void HandleFadeInDidStart();

  /// @brief Method HandleHeadDidMovePastCutMark, addr 0x5975e50, size 0x1b4, virtual false, abstract: false, final false
  inline void HandleHeadDidMovePastCutMark();

  /// @brief Method HandleMovementDidFinish, addr 0x5975cb8, size 0x198, virtual false, abstract: false, final false
  inline void HandleMovementDidFinish();

  /// @brief Method HandleNoteWasCut, addr 0x5976254, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleNoteWasMissed, addr 0x59761d8, size 0x4c, virtual false, abstract: false, final false
  inline void HandleNoteWasMissed(::GlobalNamespace::NoteController* noteController);

  /// @brief Method HandleTailDidMovePastCutMark, addr 0x5976034, size 0x1a4, virtual false, abstract: false, final false
  inline void HandleTailDidMovePastCutMark();

  /// @brief Method Hide, addr 0x5975b88, size 0x2c, virtual true, abstract: false, final true
  inline void Hide(bool hide);

  /// @brief Method Init, addr 0x5972f3c, size 0x478, virtual false, abstract: false, final false
  ...
  /// @brief Method IsNoteStartOfThisSlider, addr 0x5975bc4, size 0xf4, virtual false, abstract: false, final false
  inline bool IsNoteStartOfThisSlider(::GlobalNamespace::NoteData* noteData);

  /// @brief Method ManualUpdate, addr 0x5974f70, size 0x1a0, virtual false, abstract: false, final false
  inline void ManualUpdate();

  static inline ::GlobalNamespace::SliderController* New_ctor();

  /// @brief Method OnDestroy, addr 0x597494c, size 0x370, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Pause, addr 0x5975bb4, size 0x10, virtual true, abstract: false, final true
  inline void Pause(bool pause);

  /// @brief Method SetSaberAttraction, addr 0x597417c, size 0x8c, virtual false, abstract: false, final false
  inline void SetSaberAttraction(bool saberAttraction);

  /// @brief Method Start, addr 0x5974718, size 0x188, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5974f6c, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateMaterialPropertyBlock, addr 0x5974258, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5976374, size 0x1f0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_closeSmoothedSaberInteractionPos, addr 0x5972f2c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::FixedUpdateVector3SmoothValue* get_closeSmoothedSaberInteractionPos();

  /// @brief Method get_initColor, addr 0x5972f00, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_initColor();

  /// @brief Method get_jumpOffsetY, addr 0x5972f24, size 0x8, virtual false, abstract: false, final false
  inline float_t get_jumpOffsetY();

  /// @brief Method get_lengthType, addr 0x5972e70, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SliderController_LengthType get_lengthType();

  /// @brief Method get_randomValue, addr 0x5972f0c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_randomValue();

  /// @brief Method get_saberInteractionParam, addr 0x5972e8c, size 0x40, virtual false, abstract: false, final false
  inline float_t get_saberInteractionParam();

  /// @brief Method get_sliderData, addr 0x5972e78, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SliderData* get_sliderData();

  /// @brief Method get_sliderDidDissolveEvent, addr 0x5972e58, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ILazyCopyHashSet_1<::GlobalNamespace::ISliderDidDissolveEvent*>* get_sliderDidDissolveEvent();

  /// @brief Method get_sliderDidFinishJumpEvent, addr 0x5972e48, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ILazyCopyHashSet_1<::GlobalNamespace::ISliderDidFinishJumpEvent*>* get_sliderDidFinishJumpEvent();

  /// @brief Method get_sliderDidStartDissolvingEvent, addr 0x5972e50, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_sliderDuration, addr 0x5972f1c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_sliderDuration();

  /// @brief Method get_sliderHeadDidMovePastCutMark, addr 0x5972e60, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_sliderIntensityEffect, addr 0x5972f34, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::SliderIntensityEffect> get_sliderIntensityEffect();

  /// @brief Method get_sliderMeshController, addr 0x5972ef0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::SliderMeshController> get_sliderMeshController();

  /// @brief Method get_sliderMovement, addr 0x5972ef8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::SliderMovement> get_sliderMovement();

  /// @brief Method get_sliderSpawnData, addr 0x5972e80, size 0xc, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SliderSpawnData get_sliderSpawnData();

  /// @brief Method get_sliderTailDidMovePastCutMark, addr 0x5972e68, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_zDistanceBetweenNotes, addr 0x5972f14, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field _sliderDidFinishMovement, offset: 0x88, size: 0x8, def value: None
  ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISliderDidFinishJumpEvent*>* ____sliderDidFinishMovement;

  /// @brief Field _sliderDidStartDissolving, offset: 0x90, size: 0x8, def value: None
  ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISliderDidStartDissolvingEvent*>* ____sliderDidStartDissolving;

  /// @brief Field _sliderDidDissolve, offset: 0x98, size: 0x8, def value: None
  ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISliderDidDissolveEvent*>* ____sliderDidDissolve;

  /// @brief Field _sliderHeadDidMovePastCutMark, offset: 0xa0, size: 0x8, def value: None
  ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISliderHeadDidMovePastCutMarkEvent*>* ____sliderHeadDidMovePastCutMark;

  /// @brief Field _sliderTailDidMovePastCutMark, offset: 0xa8, size: 0x8, def value: None
  ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISliderTailDidMovePastCutMarkEvent*>* ____sliderTailDidMovePastCutMark;

  /// @brief Field _lengthType, offset: 0xb0, size: 0x4, def value: None
  ::GlobalNamespace::SliderController_LengthType ____lengthType;

  /// @brief Field _sliderData, offset: 0xb8, size: 0x8, def value: None
  ::GlobalNamespace::SliderData* ____sliderData;

  /// @brief Field _sliderSpawnData, offset: 0xc0, size: 0x20, def value: None
  ::GlobalNamespace::SliderSpawnData ____sliderSpawnData;

  /// @brief Field _saber, offset: 0xe0, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::Saber> ____saber;

  /// @brief Field _sliderDuration, offset: 0xe8, size: 0x4, def value: None
  float_t ____sliderDuration;

  /// @brief Field _initColor, offset: 0xec, size: 0x10, def value: None
  ::UnityEngine::Color ____initColor;

  /// @brief Field _attractingSaber, offset: 0xfc, size: 0x1, def value: None
  bool ____attractingSaber;

  /// @brief Field _randomValue, offset: 0x100, size: 0x4, def value: None
  float_t ____randomValue;

  /// @brief Field _zDistanceBetweenNotes, offset: 0x104, size: 0x4, def value: None
  float_t ____zDistanceBetweenNotes;

  /// @brief Field _jumpOffsetY, offset: 0x108, size: 0x4, def value: None
  float_t ____jumpOffsetY;

  /// @brief Field _closeSmoothedSaberInteractionPos, offset: 0x110, size: 0x8, def value: None
...
static_assert(offsetof(::GlobalNamespace::SliderController, ____timeHelper) == 0x80, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____sliderDidFinishMovement) == 0x88, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____sliderDidStartDissolving) == 0x90, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____sliderDidDissolve) == 0x98, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____sliderHeadDidMovePastCutMark) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____sliderTailDidMovePastCutMark) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____lengthType) == 0xb0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____sliderData) == 0xb8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____sliderSpawnData) == 0xc0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____saber) == 0xe0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____sliderDuration) == 0xe8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____initColor) == 0xec, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____attractingSaber) == 0xfc, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____randomValue) == 0x100, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____zDistanceBetweenNotes) == 0x104, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____jumpOffsetY) == 0x108, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____closeSmoothedSaberInteractionPos) == 0x110, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::SliderController) == 0x118, "Size mismatch!");
