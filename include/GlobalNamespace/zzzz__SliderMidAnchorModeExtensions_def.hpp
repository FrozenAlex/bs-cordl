...
public:
  // Declarations
  /// @brief Method OppositeDirection, addr 0x325ac78, size 0x1c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SliderMidAnchorModeExtensions) == 0x10, "Size mismatch!");
