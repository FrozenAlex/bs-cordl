...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x5792424, size 0x14, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SliderSpawnData) == 0x20, "Size mismatch!");
