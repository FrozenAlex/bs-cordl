...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::GlobalNamespace::SliderSpawnInfoNetSerializable* (*)()>(&::GlobalNamespace::SliderSpawnInfoNetSerializable::Obtain)> {
  ...
  constexpr static std::size_t addrs = 0x36c16b0;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::GlobalNamespace::SliderSpawnInfoNetSerializable* (
  ...
  constexpr static std::size_t addrs = 0x36c171c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::SliderSpawnInfoNetSerializable*>(), { "Init",
                                                                                                                                      {},
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::SliderSpawnInfoNetSerializable::*)()>(&::GlobalNamespace::SliderSpawnInfoNetSerializable::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x36c1828;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::SliderSpawnInfoNetSerializable::*)(::LiteNetLib::Utils::NetDataWriter*)>(
  ...
  constexpr static std::size_t addrs = 0x36c1880;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::GlobalNamespace::SliderSpawnInfoNetSerializable*>(), { ::i2c::class_of<::GlobalNamespace::SliderSpawnInfoNetSerializable*>(), 10 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::SliderSpawnInfoNetSerializable::*)(::LiteNetLib::Utils::NetDataReader*)>(
  ...
  constexpr static std::size_t addrs = 0x36c1c64;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::GlobalNamespace::SliderSpawnInfoNetSerializable*>(), { ::i2c::class_of<::GlobalNamespace::SliderSpawnInfoNetSerializable*>(), 11 }));
    return ___internal_method;
  }
};
...
inline ::GlobalNamespace::SliderSpawnInfoNetSerializable* GlobalNamespace::SliderSpawnInfoNetSerializable::Obtain() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::SliderSpawnInfoNetSerializable*>(), { "Obtain", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::SliderSpawnInfoNetSerializable*>(nullptr, ___internal_method);
}
  ...
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::SliderSpawnInfoNetSerializable*>(), { "Init",
                                                                                                                                    ...
                                                                                                                                    { ::i2c::type_of<::GlobalNamespace::ColorType>(),
                                                                                                                                      ...
                                                                                                                                      ::i2c::type_of<float_t>(),
                                                                                                                                      ::i2c::type_of<float_t>() } })));
  return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::SliderSpawnInfoNetSerializable*>(
...
inline void GlobalNamespace::SliderSpawnInfoNetSerializable::Serialize(::LiteNetLib::Utils::NetDataWriter* writer) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::SliderSpawnInfoNetSerializable*>(), 10 })));
...
inline void GlobalNamespace::SliderSpawnInfoNetSerializable::Deserialize(::LiteNetLib::Utils::NetDataReader* reader) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::SliderSpawnInfoNetSerializable*>(), 11 })));
...
inline ::GlobalNamespace::SliderSpawnInfoNetSerializable* GlobalNamespace::SliderSpawnInfoNetSerializable::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::SliderSpawnInfoNetSerializable*>());
}
// Ctor Parameters []
