...
public:
  ...
  /// @brief Method ActivateSmoothCameraIfNeeded, addr 0x59eebfc, size 0x8c, virtual false, abstract: false, final false
  inline void ActivateSmoothCameraIfNeeded();

  /// @brief Method HandleDidActivate, addr 0x59eec8c, size 0x40, virtual false, abstract: false, final false
  inline void HandleDidActivate();

  /// @brief Method HandleDidDeactivate, addr 0x59eeccc, size 0x4, virtual false, abstract: false, final false
  inline void HandleDidDeactivate();

  static inline ::GlobalNamespace::SmoothCameraController* New_ctor();

  /// @brief Method OnDestroy, addr 0x59eec88, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x59eebf8, size 0x4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x59eecd0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
