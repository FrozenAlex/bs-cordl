...
public:
  ...
  /// @brief Method Awake, addr 0x5999c88, size 0x150, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method GetPositionForValue, addr 0x599a06c, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 GetPositionForValue(int32_t value);

  /// @brief Method HandleBeatmapEvent, addr 0x5999fa0, size 0xcc, virtual false, abstract: false, final false
  inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData* basicBeatmapEventData);

  static inline ::GlobalNamespace::SmoothStepPositionEventEffect* New_ctor();

  /// @brief Method OnDestroy, addr 0x5999f00, size 0xa0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetPosition, addr 0x599a0bc, size 0x48, virtual false, abstract: false, final false
  inline void SetPosition(::UnityEngine::Vector3 position);

  /// @brief Method Start, addr 0x5999dd8, size 0x128, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x599a104, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SmoothStepPositionEventEffect) == 0x78, "Size mismatch!");
