...
public:
  ...
  /// @brief Method <ProcessLevelCompletionResultsAfterLevelDidFinish>b__0, addr 0x5813f90, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5813b5c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SoloFreePlayFlowCoordinator___c__DisplayClass18_0) == 0x48, "Size mismatch!");
...
public:
  ...
  /// @brief Method <HandleStandardLevelWasRestarted>b__0, addr 0x5813fd8, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5813cd8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <HandleResultsViewControllerRestartButtonPressed>b__0, addr 0x5814028, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5813e18, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method HandleResultsViewControllerContinueButtonPressed, addr 0x5813cdc, size 0x40, virtual false, abstract: false, final false
  inline void HandleResultsViewControllerContinueButtonPressed(::GlobalNamespace::ResultsViewController* viewController);

  /// @brief Method HandleResultsViewControllerRestartButtonPressed, addr 0x5813d1c, size 0xfc, virtual false, abstract: false, final false
  inline void HandleResultsViewControllerRestartButtonPressed(::GlobalNamespace::ResultsViewController* resultsViewController);

  /// @brief Method HandleStandardLevelWasRestarted, addr 0x5813bc8, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method IsNewHighScore, addr 0x5813b60, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessLevelCompletionResultsAfterLevelDidFinish, addr 0x5813888, size 0x2d4, virtual true, abstract: false, final false
  ...
  /// @brief Method Refresh, addr 0x5813b88, size 0x40, virtual true, abstract: false, final false
  inline void Refresh();

  /// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidActivate, addr 0x58135a4, size 0x1a8, virtual true, abstract: false, final false
  inline void SinglePlayerLevelSelectionFlowCoordinatorDidActivate(bool firstActivation, bool addedToHierarchy);

  /// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate, addr 0x581374c, size 0x13c, virtual true, abstract: false, final false
  inline void SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate(bool removedFromHierarchy);

  /// @brief Method __SetupFromDestination, addr 0x5813e1c, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5813f88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_gameMode, addr 0x5813508, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_gameMode();

  /// @brief Method get_leaderboardViewController, addr 0x581354c, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::LeaderboardViewController> get_leaderboardViewController();

  /// @brief Method get_mainTitle, addr 0x581355c, size 0x48, virtual true, abstract: false, final false
  inline ::StringW get_mainTitle();

  /// @brief Method get_showBackButtonForMainViewController, addr 0x5813554, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SoloFreePlayFlowCoordinator) == 0x168, "Size mismatch!");
