...
// Write type traits
MARK_REF_T(::GlobalNamespace::SongPackMasksModelItem*);
...
public:
  ...
  /// @brief Method <GetSongPackMask>b__7_0, addr 0x3739628, size 0x20, virtual false, abstract: false, final false
  inline ::StringW _GetSongPackMask_b__7_0(::GlobalNamespace::PackDefinitionSO* pack);

  /// @brief Method .ctor, addr 0x3739624, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SongPackMasksModelItem___c) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetSongPackMask, addr 0x3739158, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x37395cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_containsMultiplePacks, addr 0x37392f0, size 0x10, virtual false, abstract: false, final false
  inline bool get_containsMultiplePacks();

  /// @brief Method get_serializedName, addr 0x373913c, size 0x1c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SongPackMasksModelItem) == 0x30, "Size mismatch!");
