...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x5782d54, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SongRunningHelper_QueuedSongParams) == 0x38, "Size mismatch!");
...
public:
  ...
  /// @brief Method <StartLevel>g__HandleLevelDidFinishCallback|0, addr 0x5782d88, size 0x45c, virtual false, abstract: false, final false
  ...
  /// @brief Method <StartLevel>g__HandleLevelEnded|1, addr 0x57831e4, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5782d84, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SongRunningHelper___c__DisplayClass14_0) == 0x60, "Size mismatch!");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5783458, size 0x89c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::SongRunningHelper__StartLevel_d__14* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x5783cf4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5783cfc, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5783d34, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5783454, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5782cbc, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SongRunningHelper__StartLevel_d__14) == 0x68, "Size mismatch!");
...
public:
  ...
  /// @brief Method EnqueueLevel, addr 0x57829f0, size 0x250, virtual false, abstract: false, final false
  inline bool EnqueueLevel(::GlobalNamespace::SongRunningHelper_QueuedSongParams queuedSongParams);

  /// @brief Method FindBeatmapLevelPackBeatmaps, addr 0x57827d8, size 0x218, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::BeatmapLevel*> FindBeatmapLevelPackBeatmaps(::StringW packId, bool ignoreCase);

  /// @brief Method HandlePauseControllerCanPause, addr 0x5782cc4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method StartLevel, addr 0x5782c40, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5782ce0, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SongsRunning, addr 0x5782794, size 0x44, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SongRunningHelper) == 0x88, "Size mismatch!");
