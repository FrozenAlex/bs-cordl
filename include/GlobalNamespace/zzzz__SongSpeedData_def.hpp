...
// Write type traits
MARK_REF_T(::GlobalNamespace::SongSpeedData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SongSpeedData*, "", "SongSpeedData");
...
static_assert(sizeof(::GlobalNamespace::SongSpeedData) == 0x18, "Size mismatch!");
