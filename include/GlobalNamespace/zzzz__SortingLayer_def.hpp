...
// Write type traits
MARK_REF_T(::GlobalNamespace::SortingLayer*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SortingLayer*, "", "SortingLayer");
...
static_assert(sizeof(::GlobalNamespace::SortingLayer) == 0x28, "Size mismatch!");
