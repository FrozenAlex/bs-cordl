...
// Write type traits
MARK_REF_T(::GlobalNamespace::SpawnChevronObjectPoolsInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SpawnChevronObjectPoolsInstaller*, "", "SpawnChevronObjectPoolsInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x5866688, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5866710, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SpawnChevronObjectPoolsInstaller) == 0x30, "Size mismatch!");
