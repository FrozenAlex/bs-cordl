...
// Write type traits
MARK_REF_T(::GlobalNamespace::SpawnRotationChevronManager*);
MARK_REF_T(::GlobalNamespace::SpawnRotationChevronManager_DirectionData*);
MARK_VAL_T(::GlobalNamespace::SpawnRotationChevronManager_QueuedDirectionData);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SpawnRotationChevronManager*, "", "SpawnRotationChevronManager");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SpawnRotationChevronManager_DirectionData*, "", "SpawnRotationChevronManager/DirectionData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SpawnRotationChevronManager_QueuedDirectionData, "", "SpawnRotationChevronManager/QueuedDirectionData");
