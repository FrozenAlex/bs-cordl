...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::SpawnRotationChevronManager_DirectionData::*)()>(
  ...
  constexpr static std::size_t addrs = 0x599f0dc;
...
inline ::GlobalNamespace::SpawnRotationChevronManager_DirectionData* GlobalNamespace::SpawnRotationChevronManager_DirectionData::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::SpawnRotationChevronManager_DirectionData*>());
}
// Ctor Parameters []
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::SpawnRotationChevronManager_QueuedDirectionData::*)(float_t, float_t, int32_t)>(
  ...
  constexpr static std::size_t addrs = 0x599f0d0;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::SpawnRotationChevronManager::*)()>(&::GlobalNamespace::SpawnRotationChevronManager::Update)> {
  ...
  constexpr static std::size_t addrs = 0x599e480;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::SpawnRotationChevronManager::*)(::GlobalNamespace::BeatmapObjectData*)>(
  ...
  constexpr static std::size_t addrs = 0x599f00c;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::SpawnRotationChevronManager::*)(float_t, float_t, int32_t)>(
  ...
  constexpr static std::size_t addrs = 0x599ec20;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::SpawnRotationChevronManager*>(),
                                                             { "SpawnDirectionData", {}, { ::i2c::type_of<float_t>(), ::i2c::type_of<float_t>(), ::i2c::type_of<int32_t>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::SpawnRotationChevronManager::*)()>(&::GlobalNamespace::SpawnRotationChevronManager::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x599f0e0;
...
constexpr void GlobalNamespace::SpawnRotationChevronManager::__cordl_internal_set__fadeInLightAmountCurve(::UnityEngine::AnimationCurve* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____fadeInLightAmountCurve = value;
}
...
constexpr void GlobalNamespace::SpawnRotationChevronManager::__cordl_internal_set__fadeOutLightAmountCurve(::UnityEngine::AnimationCurve* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____fadeOutLightAmountCurve = value;
}
...
constexpr void GlobalNamespace::SpawnRotationChevronManager::__cordl_internal_set__spawnRotationDataCallbackWrapper(::GlobalNamespace::BeatmapDataCallbackWrapper* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____spawnRotationDataCallbackWrapper = value;
}
...
constexpr void GlobalNamespace::SpawnRotationChevronManager::__cordl_internal_set__beatmapObjectDataCallbackWrapper(::GlobalNamespace::BeatmapDataCallbackWrapper* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____beatmapObjectDataCallbackWrapper = value;
}
...
constexpr void GlobalNamespace::SpawnRotationChevronManager::__cordl_internal_set__directionToDataDictionary(
  ...
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____directionToDataDictionary = value;
}
...
constexpr void GlobalNamespace::SpawnRotationChevronManager::__cordl_internal_set__activeDirections(::System::Collections::Generic::HashSet_1<int32_t>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____activeDirections = value;
}
...
constexpr void GlobalNamespace::SpawnRotationChevronManager::__cordl_internal_set__reusableDirectionsList(::System::Collections::Generic::List_1<int32_t>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____reusableDirectionsList = value;
}
...
constexpr void GlobalNamespace::SpawnRotationChevronManager::__cordl_internal_set__queuedDirectionData(
  ...
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____queuedDirectionData = value;
}
...
inline ::GlobalNamespace::SpawnRotationChevronManager* GlobalNamespace::SpawnRotationChevronManager::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::SpawnRotationChevronManager*>());
}
// Ctor Parameters []
