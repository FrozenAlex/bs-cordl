...
// Write type traits
MARK_REF_T(::GlobalNamespace::SpawnRotationChevron*);
MARK_REF_T(::GlobalNamespace::SpawnRotationChevron_Pool*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SpawnRotationChevron*, "", "SpawnRotationChevron");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SpawnRotationChevron_Pool*, "", "SpawnRotationChevron/Pool");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58667a0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SpawnRotationChevron_Pool) == 0x40, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies LightWithIdMonoBehaviour, TubeBloomPrePassLight, UnityEngine.Color
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x5866714, size 0xc, virtual true, abstract: false, final false
  inline void ColorWasSet(::UnityEngine::Color color);

  static inline ::GlobalNamespace::SpawnRotationChevron* New_ctor();

  /// @brief Method SetLightAmount, addr 0x586678c, size 0x8, virtual false, abstract: false, final false
  inline void SetLightAmount(float_t amount);

  /// @brief Method UpdateLights, addr 0x5866720, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5866794, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SpawnRotationChevron) == 0x58, "Size mismatch!");
