...
// Write type traits
MARK_REF_T(::GlobalNamespace::SpectrogramRow*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SpectrogramRow*, "", "SpectrogramRow");
...
public:
  ...
  /// @brief Method Awake, addr 0x5868234, size 0xcc, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::SpectrogramRow* New_ctor();

  /// @brief Method Update, addr 0x5868300, size 0x120, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5868420, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SpectrogramRow) == 0x38, "Size mismatch!");
