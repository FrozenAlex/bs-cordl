...
// Write type traits
MARK_REF_T(::GlobalNamespace::SphereCuttableBySaber*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SphereCuttableBySaber*, "", "SphereCuttableBySaber");
...
public:
  ...
  /// @brief Method Awake, addr 0x58ba434, size 0x2c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Cut, addr 0x58ba460, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58ba494, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_canBeCut, addr 0x58ba42c, size 0x8, virtual true, abstract: false, final false
  inline bool get_canBeCut();

  /// @brief Method get_radius, addr 0x58ba3dc, size 0x18, virtual true, abstract: false, final false
  inline float_t get_radius();

  /// @brief Method set_canBeCut, addr 0x58ba3f4, size 0x38, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SphereCuttableBySaber) == 0x38, "Size mismatch!");
