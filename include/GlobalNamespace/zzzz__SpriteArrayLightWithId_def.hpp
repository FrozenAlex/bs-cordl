...
MARK_REF_T(::GlobalNamespace::SpriteArrayLightWithId*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SpriteArrayLightWithId_MultiplyColorByAlphaType, "", "SpriteArrayLightWithId/MultiplyColorByAlphaType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SpriteArrayLightWithId*, "", "SpriteArrayLightWithId");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::SpriteArrayLightWithId_MultiplyColorByAlphaType) == 0x4, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies LightWithIdMonoBehaviour, SpriteArrayLightWithId::MultiplyColorByAlphaType, UnityEngine.SpriteRenderer
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__spriteRenderers, put = __cordl_internal_set__spriteRenderers)) ::ArrayW<::UnityW<::UnityEngine::SpriteRenderer>> _spriteRenderers;

  __declspec(property(get = get_color)) ::UnityEngine::Color color;

  /// @brief Method ColorWasSet, addr 0x572c280, size 0x1a4, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::SpriteRenderer>> const& __cordl_internal_get__spriteRenderers() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::SpriteRenderer>>& __cordl_internal_get__spriteRenderers();
  ...
  /// @brief Method .ctor, addr 0x572c424, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x572c250, size 0x30, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::UnityW<::UnityEngine::SpriteRenderer>> ____spriteRenderers;
...
static_assert(sizeof(::GlobalNamespace::SpriteArrayLightWithId) == 0x60, "Size mismatch!");
