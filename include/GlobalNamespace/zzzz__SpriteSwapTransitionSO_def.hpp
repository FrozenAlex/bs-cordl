...
// Write type traits
MARK_REF_T(::GlobalNamespace::SpriteSwapTransitionSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SpriteSwapTransitionSO*, "", "SpriteSwapTransitionSO");
...
public:
  ...
  /// @brief Method .ctor, addr 0x643f088, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_disabledSprite, addr 0x643f070, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_disabledSprite();

  /// @brief Method get_highlightedSprite, addr 0x643f060, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_highlightedSprite();

  /// @brief Method get_normalSprite, addr 0x643f058, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_normalSprite();

  /// @brief Method get_pressedSprite, addr 0x643f068, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_pressedSprite();

  /// @brief Method get_selectedAndHighlightedSprite, addr 0x643f080, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_selectedAndHighlightedSprite();

  /// @brief Method get_selectedSprite, addr 0x643f078, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SpriteSwapTransitionSO) == 0x50, "Size mismatch!");
