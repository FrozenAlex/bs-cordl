...
public:
  // Declarations
  /// @brief Method Dispatch, addr 0x3277a30, size 0xb0, virtual false, abstract: false, final false
  static inline void Dispatch(::GlobalNamespace::IStandaloneMonobehavior* standaloneMonoBehavior, ::System::Action* action);

  /// @brief Method DispatchAsync, addr 0x3277ae0, size 0xb4, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::StandaloneMonobehaviorExtensions) == 0x10, "Size mismatch!");
