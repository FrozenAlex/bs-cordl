...
// Write type traits
MARK_REF_T(::GlobalNamespace::StandardGameplayInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::StandardGameplayInstaller*, "", "StandardGameplayInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x59f6c20, size 0x3f0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59f7010, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::StandardGameplayInstaller) == 0x38, "Size mismatch!");
