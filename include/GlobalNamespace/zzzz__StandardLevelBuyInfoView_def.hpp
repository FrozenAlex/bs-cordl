...
// Write type traits
MARK_REF_T(::GlobalNamespace::StandardLevelBuyInfoView*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::StandardLevelBuyInfoView*, "", "StandardLevelBuyInfoView");
...
public:
  ...
  /// @brief Method RefreshView, addr 0x5a1df98, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a1e024, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_buyLevelButton, addr 0x5a1df80, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Button> get_buyLevelButton();

  /// @brief Method get_buyPackButton, addr 0x5a1df90, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Button> get_buyPackButton();

  /// @brief Method get_openPackButton, addr 0x5a1df88, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::StandardLevelBuyInfoView) == 0x48, "Size mismatch!");
