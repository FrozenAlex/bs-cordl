...
// Write type traits
MARK_REF_T(::GlobalNamespace::StandardLevelNoTransitionInstallerData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::StandardLevelNoTransitionInstallerData*, "", "StandardLevelNoTransitionInstallerData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x57ed37c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_backButtonText, addr 0x57ed35c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_backButtonText();

  /// @brief Method get_beatmapCharacteristic, addr 0x57ed30c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BeatmapCharacteristicSO> get_beatmapCharacteristic();

  /// @brief Method get_beatmapDifficulty, addr 0x57ed31c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDifficulty get_beatmapDifficulty();

  /// @brief Method get_beatmapLevel, addr 0x57ecd40, size 0xd0, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BeatmapLevelSO> get_beatmapLevel();

  /// @brief Method get_colorScheme, addr 0x57ece10, size 0xd4, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::ColorSchemeSO> get_colorScheme();

  /// @brief Method get_environmentInfo, addr 0x57ebc7c, size 0xd4, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> get_environmentInfo();

  /// @brief Method get_gameplayModifiers, addr 0x57ed32c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers();

  /// @brief Method get_playerSpecificSettings, addr 0x57ed33c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettings* get_playerSpecificSettings();

  /// @brief Method get_practiceSettings, addr 0x57ed34c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PracticeSettings* get_practiceSettings();

  /// @brief Method get_useTestNoteCutSoundEffects, addr 0x57ed36c, size 0x8, virtual false, abstract: false, final false
  inline bool get_useTestNoteCutSoundEffects();

  /// @brief Method set_backButtonText, addr 0x57ed364, size 0x8, virtual false, abstract: false, final false
  inline void set_backButtonText(::StringW value);

  /// @brief Method set_beatmapCharacteristic, addr 0x57ed314, size 0x8, virtual false, abstract: false, final false
  inline void set_beatmapCharacteristic(::GlobalNamespace::BeatmapCharacteristicSO* value);

  /// @brief Method set_beatmapDifficulty, addr 0x57ed324, size 0x8, virtual false, abstract: false, final false
  inline void set_beatmapDifficulty(::GlobalNamespace::BeatmapDifficulty value);

  /// @brief Method set_gameplayModifiers, addr 0x57ed334, size 0x8, virtual false, abstract: false, final false
  inline void set_gameplayModifiers(::GlobalNamespace::GameplayModifiers* value);

  /// @brief Method set_playerSpecificSettings, addr 0x57ed344, size 0x8, virtual false, abstract: false, final false
  inline void set_playerSpecificSettings(::GlobalNamespace::PlayerSpecificSettings* value);

  /// @brief Method set_practiceSettings, addr 0x57ed354, size 0x8, virtual false, abstract: false, final false
  inline void set_practiceSettings(::GlobalNamespace::PracticeSettings* value);

  /// @brief Method set_useTestNoteCutSoundEffects, addr 0x57ed374, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::StandardLevelNoTransitionInstallerData) == 0x80, "Size mismatch!");
