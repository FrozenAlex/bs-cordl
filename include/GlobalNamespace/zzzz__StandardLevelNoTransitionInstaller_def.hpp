...
// Write type traits
MARK_REF_T(::GlobalNamespace::StandardLevelNoTransitionInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::StandardLevelNoTransitionInstaller*, "", "StandardLevelNoTransitionInstaller");
...
static_assert(sizeof(::GlobalNamespace::StandardLevelNoTransitionInstaller) == 0x48, "Size mismatch!");
