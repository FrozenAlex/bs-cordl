...
public:
  ...
  /// @brief Method Deserialize, addr 0x32baec4, size 0x78, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  static inline ::GlobalNamespace::StandardScoreSyncStateDeltaNetSerializable* New_ctor();

  /// @brief Method Release, addr 0x32baf3c, size 0xb0, virtual true, abstract: false, final true
  inline void Release();

  /// @brief Method Serialize, addr 0x32bade0, size 0xe4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32bafec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_baseId, addr 0x32bad98, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::SyncStateId get_baseId();

  /// @brief Method get_delta, addr 0x32badb8, size 0x14, virtual true, abstract: false, final true
  inline ::GlobalNamespace::StandardScoreSyncState get_delta();

  /// @brief Method get_pool, addr 0x32bad54, size 0x44, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::IPacketPool_1<::GlobalNamespace::StandardScoreSyncStateDeltaNetSerializable*>* get_pool();

  /// @brief Method get_timeOffsetMs, addr 0x32bada8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_baseId, addr 0x32bada0, size 0x8, virtual true, abstract: false, final true
  inline void set_baseId(::GlobalNamespace::SyncStateId value);

  /// @brief Method set_delta, addr 0x32badcc, size 0x14, virtual true, abstract: false, final true
  inline void set_delta(::GlobalNamespace::StandardScoreSyncState value);

  /// @brief Method set_timeOffsetMs, addr 0x32badb0, size 0x8, virtual true, abstract: false, final true
