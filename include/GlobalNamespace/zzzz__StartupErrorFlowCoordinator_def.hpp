...
// Write type traits
MARK_REF_T(::GlobalNamespace::StartupErrorFlowCoordinator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::StartupErrorFlowCoordinator*, "", "StartupErrorFlowCoordinator");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x58db840, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58db8c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::StartupErrorFlowCoordinator) == 0xc0, "Size mismatch!");
