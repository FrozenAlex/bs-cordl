...
// Write type traits
MARK_REF_T(::GlobalNamespace::StartupErrorScenesTransitionSetupDataSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::StartupErrorScenesTransitionSetupDataSO*, "", "StartupErrorScenesTransitionSetupDataSO");
...
static_assert(sizeof(::GlobalNamespace::StartupErrorScenesTransitionSetupDataSO) == 0x28, "Size mismatch!");
