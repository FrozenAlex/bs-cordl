...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::StartupErrorScenesTransitionSetupDataSO::*)(::GlobalNamespace::StartupErrorSceneSetupData*)>(
    &::GlobalNamespace::StartupErrorScenesTransitionSetupDataSO::Init)> {
  constexpr static std::size_t size = 0xc4;
  constexpr static std::size_t addrs = 0x57f2bb4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::StartupErrorScenesTransitionSetupDataSO*>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::StartupErrorScenesTransitionSetupDataSO::*)()>(&::GlobalNamespace::StartupErrorScenesTransitionSetupDataSO::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x57f2c78;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::StartupErrorScenesTransitionSetupDataSO*>(), { ".ctor", {}, {} })));
    return ___internal_method;
  }
};
...
inline ::GlobalNamespace::StartupErrorScenesTransitionSetupDataSO* GlobalNamespace::StartupErrorScenesTransitionSetupDataSO::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::StartupErrorScenesTransitionSetupDataSO*>());
}
// Ctor Parameters []
