...
MARK_GEN_REF_T_PTR(::GlobalNamespace::StateBuffer_3_InterpolationDelegate);
MARK_GEN_REF_T_PTR(::GlobalNamespace::StateBuffer_3_SmoothingDelegate);
MARK_GEN_VAL_T(::GlobalNamespace::StateBuffer_3_TimestampedStateTable);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::StateBuffer_3, "", "StateBuffer`3");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__buffer, put = __cordl_internal_set__buffer)) ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>> _buffer;
  ...
  constexpr ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>> const& __cordl_internal_get__buffer() const;

  constexpr ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>>& __cordl_internal_get__buffer();
  ...
  constexpr void __cordl_internal_set__buffer(::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>> value);
...
public:
  ...
  ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>> ____buffer;
