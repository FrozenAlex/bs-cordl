...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::StaticBatchableMesh::*)()>(&::GlobalNamespace::StaticBatchableMesh::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x33078c0;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::StaticBatchableMesh*>(), { ".ctor", {}, {} })));
...
inline ::GlobalNamespace::StaticBatchableMesh* GlobalNamespace::StaticBatchableMesh::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::StaticBatchableMesh*>());
}
// Ctor Parameters []
