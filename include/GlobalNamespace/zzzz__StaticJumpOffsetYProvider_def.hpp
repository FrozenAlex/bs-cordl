...
// Write type traits
MARK_REF_T(::GlobalNamespace::StaticJumpOffsetYProvider*);
MARK_REF_T(::GlobalNamespace::StaticJumpOffsetYProvider_InitData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::StaticJumpOffsetYProvider*, "", "StaticJumpOffsetYProvider");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::StaticJumpOffsetYProvider_InitData*, "", "StaticJumpOffsetYProvider/InitData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5843058, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::StaticJumpOffsetYProvider_InitData) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5843054, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_jumpOffsetY, addr 0x584303c, size 0x18, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::StaticJumpOffsetYProvider) == 0x18, "Size mismatch!");
