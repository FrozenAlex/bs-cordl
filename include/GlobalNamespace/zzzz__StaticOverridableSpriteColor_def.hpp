...
// Write type traits
MARK_REF_T(::GlobalNamespace::StaticOverridableSpriteColor*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::StaticOverridableSpriteColor*, "", "StaticOverridableSpriteColor");
...
static_assert(sizeof(::GlobalNamespace::StaticOverridableSpriteColor) == 0x40, "Size mismatch!");
