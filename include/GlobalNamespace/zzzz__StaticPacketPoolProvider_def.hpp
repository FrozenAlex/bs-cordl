...
public:
  ...
  /// @brief Method TryGetPacketPool, addr 0x3277908, size 0x98, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::StaticPacketPoolProvider) == 0x10, "Size mismatch!");
