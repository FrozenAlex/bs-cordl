...
public:
  ...
  /// @brief Method .ctor, addr 0x373fb78, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x373fb94, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW levelId, uint32_t appId);

  /// @brief Method get_appId, addr 0x373fb7c, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_appId();

  /// @brief Method get_levelDepotData, addr 0x373fb8c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SteamLevelProductCollectionModel_LevelDepotData* get_levelDepotData();

  /// @brief Method get_levelId, addr 0x373fb84, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method .ctor, addr 0x373fbb8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method get_bundleId, addr 0x373fba0, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_bundleId();

  /// @brief Method get_levelPackId, addr 0x373fba8, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_levelPackId();

  /// @brief Method get_levelProductsData, addr 0x373fbb0, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method .ctor, addr 0x373fc50, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_redirectedBundleId, addr 0x373fc40, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_redirectedBundleId();

  /// @brief Method get_shouldOwnLevelPackId, addr 0x373fc38, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_shouldOwnLevelPackId();

  /// @brief Method get_targetLevelPackId, addr 0x373fc30, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_targetLevelPackId();

  /// @brief Method get_validUntilDate, addr 0x373fc48, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetLevelPackProductData, addr 0x373fac0, size 0x5c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SteamLevelProductCollectionModel_LevelPackProductData* GetLevelPackProductData(::StringW levelPackId);

  /// @brief Method GetLevelPackRedirectionData, addr 0x373fb1c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLevelProductData, addr 0x373fa64, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x373f110, size 0x900, virtual false, abstract: false, final false
  ...
  /// @brief Method get_levelProductDataCount, addr 0x373f108, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_levelProductDataCount();

  /// @brief Method get_levelProductsData, addr 0x373fa10, size 0x54, virtual false, abstract: false, final false
