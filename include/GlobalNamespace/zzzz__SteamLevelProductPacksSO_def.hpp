...
// Write type traits
MARK_REF_T(::GlobalNamespace::SteamLevelProductPacksSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SteamLevelProductPacksSO*, "", "SteamLevelProductPacksSO");
// Dependencies PersistentScriptableObject, SteamLevelProductCollectionModel::LevelPackRedirectionData
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = get_levelPackRedirectionData)) ::ArrayW<::GlobalNamespace::SteamLevelProductCollectionModel_LevelPackRedirectionData*> levelPackRedirectionData;
  ...
  /// @brief Method ILevelPackProductDataContainer<SteamLevelProductCollectionModel.LevelPackProductData,SteamLevelProductCollectionModel.LevelProductData>.SetLevelPackProductData, addr 0x3685ebc,
  ...
  constexpr ::ArrayW<::GlobalNamespace::SteamLevelProductCollectionModel_LevelPackRedirectionData*> const& __cordl_internal_get__levelPackRedirectionData() const;

  constexpr ::ArrayW<::GlobalNamespace::SteamLevelProductCollectionModel_LevelPackRedirectionData*>& __cordl_internal_get__levelPackRedirectionData();
...
static_assert(sizeof(::GlobalNamespace::SteamLevelProductPacksSO) == 0x28, "Size mismatch!");
