...
// Write type traits
MARK_REF_T(::GlobalNamespace::SteamNetworkPlayerModel*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SteamNetworkPlayerModel*, "", "SteamNetworkPlayerModel");
...
static_assert(sizeof(::GlobalNamespace::SteamNetworkPlayerModel) == 0xa8, "Size mismatch!");
