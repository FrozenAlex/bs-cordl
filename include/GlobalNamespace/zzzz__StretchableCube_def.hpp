...
// Write type traits
MARK_REF_T(::GlobalNamespace::StretchableCube*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::StretchableCube*, "", "StretchableCube");
...
public:
  ...
  __declspec(property(get = getStaticF_normals, put = setStaticF_normals)) ::ArrayW<::UnityEngine::Vector3> normals;
  ...
  __declspec(property(get = getStaticF_triangles, put = setStaticF_triangles)) ::ArrayW<int32_t> triangles;
  ...
  /// @brief Method Awake, addr 0x583b084, size 0x74, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CreateBox, addr 0x583b0f8, size 0x148, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> CreateBox();

  static inline ::GlobalNamespace::StretchableCube* New_ctor();

  /// @brief Method OnDestroy, addr 0x583b240, size 0xc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RecalculateUVs, addr 0x583b24c, size 0x1f4, virtual false, abstract: false, final false
  inline void RecalculateUVs(::ArrayW<::UnityEngine::Vector2> uvs);

  /// @brief Method RefreshUVs, addr 0x583b440, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x583b4d8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  static inline ::ArrayW<::UnityEngine::Vector3> getStaticF_normals();
  ...
  static inline ::ArrayW<int32_t> getStaticF_triangles();

  static inline ::UnityEngine::Vector3 getStaticF_up();

  static inline ::ArrayW<::UnityEngine::Vector3> getStaticF_vertices();
  ...
  static inline void setStaticF_normals(::ArrayW<::UnityEngine::Vector3> value);
  ...
  static inline void setStaticF_triangles(::ArrayW<int32_t> value);

  static inline void setStaticF_up(::UnityEngine::Vector3 value);

  static inline void setStaticF_vertices(::ArrayW<::UnityEngine::Vector3> value);
...
static_assert(sizeof(::GlobalNamespace::StretchableCube) == 0x30, "Size mismatch!");
