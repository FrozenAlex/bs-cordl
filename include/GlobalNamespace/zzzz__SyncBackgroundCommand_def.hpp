...
public:
  ...
  /// @brief Method Execute, addr 0x331eba0, size 0x180, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x331ed20, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_resultTask, addr 0x331eb50, size 0x50, virtual false, abstract: false, final false
