...
// Write type traits
MARK_REF_T(::GlobalNamespace::TabBarViewController*);
MARK_REF_T(::GlobalNamespace::TabBarViewController_TabBarItem*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TabBarViewController*, "", "TabBarViewController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TabBarViewController_TabBarItem*, "", "TabBarViewController/TabBarItem");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5964798, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::TabBarViewController_TabBarItem) == 0x20, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies HMUI.ViewController, TabBarViewController::TabBarItem
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__items, put = __cordl_internal_set__items)) ::ArrayW<::GlobalNamespace::TabBarViewController_TabBarItem*> _items;

  /// @brief Field _labels, offset 0x88, size 0x8
  __declspec(property(get = __cordl_internal_get__labels, put = __cordl_internal_set__labels)) ::ArrayW<::StringW> _labels;
  ...
  /// @brief Method Clear, addr 0x5964528, size 0x58, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method DidActivate, addr 0x5964580, size 0xe0, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HandleDidSelectCell, addr 0x5964744, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5964660, size 0xe4, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SelectItem, addr 0x5964510, size 0x18, virtual false, abstract: false, final false
  inline void SelectItem(int32_t index);

  /// @brief Method Setup, addr 0x596435c, size 0x1b4, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::TabBarViewController_TabBarItem*> const& __cordl_internal_get__items() const;

  constexpr ::ArrayW<::GlobalNamespace::TabBarViewController_TabBarItem*>& __cordl_internal_get__items();

  constexpr ::ArrayW<::StringW> const& __cordl_internal_get__labels() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get__labels();
  ...
  constexpr void __cordl_internal_set__items(::ArrayW<::GlobalNamespace::TabBarViewController_TabBarItem*> value);

  constexpr void __cordl_internal_set__labels(::ArrayW<::StringW> value);
  ...
  /// @brief Method .ctor, addr 0x5964794, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_selectedCellNumber, addr 0x5964344, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_selectedCellNumber();

  /// @brief Method get_sizeToFit, addr 0x596432c, size 0x18, virtual false, abstract: false, final false
  inline bool get_sizeToFit();

  /// @brief Method set_sizeToFit, addr 0x5964310, size 0x1c, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::StringW> ____labels;

  /// @brief Field _items, offset: 0x90, size: 0x8, def value: None
  ::ArrayW<::GlobalNamespace::TabBarViewController_TabBarItem*> ____items;
...
static_assert(sizeof(::GlobalNamespace::TabBarViewController) == 0xa0, "Size mismatch!");
