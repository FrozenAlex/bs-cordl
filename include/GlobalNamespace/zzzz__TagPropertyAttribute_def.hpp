...
// Write type traits
MARK_REF_T(::GlobalNamespace::TagPropertyAttribute*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TagPropertyAttribute*, "", "TagPropertyAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x33077e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::TagPropertyAttribute) == 0x18, "Size mismatch!");
