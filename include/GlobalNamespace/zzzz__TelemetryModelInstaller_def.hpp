...
// Write type traits
MARK_REF_T(::GlobalNamespace::TelemetryModelInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TelemetryModelInstaller*, "", "TelemetryModelInstaller");
...
public:
  // Declarations
  /// @brief Method InstallBindings, addr 0x37741e4, size 0x74, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::GlobalNamespace::TelemetryModelInstaller* New_ctor();

  /// @brief Method .ctor, addr 0x3774258, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::TelemetryModelInstaller) == 0x28, "Size mismatch!");
