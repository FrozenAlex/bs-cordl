...
// Write type traits
MARK_REF_T(::GlobalNamespace::TestAnalyticsModel*);
...
public:
  ...
  /// @brief Method <LogEvent>b__3_0, addr 0x31c38e4, size 0xa4, virtual false, abstract: false, final false
  inline ::StringW _LogEvent_b__3_0(::System::Collections::Generic::KeyValuePair_2<::StringW, ::StringW> kvp);

  /// @brief Method .ctor, addr 0x31c38e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::TestAnalyticsModel___c) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method OpenDataPrivacyPage, addr 0x31c2fa0, size 0x4, virtual true, abstract: false, final true
  inline void OpenDataPrivacyPage();

  /// @brief Method .ctor, addr 0x31c3888, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_supportsOpenDataPrivacyPage, addr 0x31c2f98, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief IL2CPP Metadata Type Index
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23182 };

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::TestAnalyticsModel) == 0x10, "Size mismatch!");
