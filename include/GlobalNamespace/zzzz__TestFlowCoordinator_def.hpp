...
// Write type traits
MARK_REF_T(::GlobalNamespace::TestFlowCoordinator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TestFlowCoordinator*, "", "TestFlowCoordinator");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x593640c, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5936430, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::TestFlowCoordinator) == 0xd8, "Size mismatch!");
