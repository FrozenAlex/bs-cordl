...
public:
  ...
  /// @brief Method Start, addr 0x572eb78, size 0x118, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x572ec90, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
