...
// Write type traits
MARK_REF_T(::GlobalNamespace::TextMeshProInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TextMeshProInstaller*, "", "TextMeshProInstaller");
...
static_assert(sizeof(::GlobalNamespace::TextMeshProInstaller) == 0x48, "Size mismatch!");
