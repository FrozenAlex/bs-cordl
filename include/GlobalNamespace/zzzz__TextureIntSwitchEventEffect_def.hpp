...
// Write type traits
MARK_REF_T(::GlobalNamespace::TextureIntSwitchEventEffect*);
MARK_VAL_T(::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TextureIntSwitchEventEffect*, "", "TextureIntSwitchEventEffect");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple, "", "TextureIntSwitchEventEffect/TextureValueTuple");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple) == 0x10, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies BasicBeatmapEventType, TextureIntSwitchEventEffect::TextureValueTuple, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__textureValueTuples, put = __cordl_internal_set__textureValueTuples)) ::ArrayW<::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple>
      _textureValueTuples;
  ...
  /// @brief Method HandleBasicBeatmapEventData, addr 0x599a9ec, size 0x14, virtual false, abstract: false, final false
  inline void HandleBasicBeatmapEventData(::GlobalNamespace::BasicBeatmapEventData* data);

  /// @brief Method Initialize, addr 0x599a6f8, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x599a9d0, size 0x1c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetTextureByIndex, addr 0x599a900, size 0xd0, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple> const& __cordl_internal_get__textureValueTuples() const;

  constexpr ::ArrayW<::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple>& __cordl_internal_get__textureValueTuples();
  ...
  constexpr void __cordl_internal_set__textureValueTuples(::ArrayW<::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple> value);
  ...
  /// @brief Method .ctor, addr 0x599aa00, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::TextureIntSwitchEventEffect) == 0x60, "Size mismatch!");
