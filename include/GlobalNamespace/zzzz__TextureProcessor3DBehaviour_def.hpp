...
// Write type traits
MARK_REF_T(::GlobalNamespace::TextureProcessor3DBehaviour*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TextureProcessor3DBehaviour*, "", "TextureProcessor3DBehaviour");
...
public:
  ...
  /// @brief Method OnPlayableDestroy, addr 0x57e7164, size 0x7a8, virtual true, abstract: false, final false
  inline void OnPlayableDestroy(::UnityEngine::Playables::Playable playable);

  /// @brief Method ProcessFrame, addr 0x57e6d60, size 0x404, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57e790c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::TextureProcessor3DBehaviour) == 0x100, "Size mismatch!");
