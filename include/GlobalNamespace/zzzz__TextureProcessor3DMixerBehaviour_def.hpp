...
// Write type traits
MARK_REF_T(::GlobalNamespace::TextureProcessor3DMixerBehaviour*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TextureProcessor3DMixerBehaviour*, "", "TextureProcessor3DMixerBehaviour");
...
public:
  ...
  /// @brief Method ProcessFrame, addr 0x5906484, size 0xa5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5906ee0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::TextureProcessor3DMixerBehaviour) == 0x18, "Size mismatch!");
