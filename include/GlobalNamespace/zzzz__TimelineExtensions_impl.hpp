...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::GlobalNamespace::TimelineExtensions___c__DisplayClass0_0::*)(::UnityEngine::Timeline::IMarker*)>(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::TimelineExtensions___c__DisplayClass0_0*>(),
                                                                                           { "<JumpToTimelineMarker>b__0", {}, { ::i2c::type_of<::UnityEngine::Timeline::IMarker*>() } })));
    return ___internal_method;
  }
};
...
inline ::GlobalNamespace::TimelineExtensions___c__DisplayClass0_0* GlobalNamespace::TimelineExtensions___c__DisplayClass0_0::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::TimelineExtensions___c__DisplayClass0_0*>());
}
// Ctor Parameters []
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (*)(::UnityEngine::Playables::PlayableDirector*, ::System::Type*)>(&::GlobalNamespace::TimelineExtensions::JumpToTimelineMarker)> {
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::TimelineExtensions*>(),
                                                             { "JumpToTimelineMarker", {}, { ::i2c::type_of<::UnityEngine::Playables::PlayableDirector*>(), ::i2c::type_of<::System::Type*>() } })));
    return ___internal_method;
  }
};
inline void GlobalNamespace::TimelineExtensions::JumpToTimelineMarker(::UnityEngine::Playables::PlayableDirector* playableDirector, ::System::Type* markerType) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::TimelineExtensions*>(),
                                                           { "JumpToTimelineMarker", {}, { ::i2c::type_of<::UnityEngine::Playables::PlayableDirector*>(), ::i2c::type_of<::System::Type*>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(nullptr, ___internal_method, playableDirector, markerType);
}
// Ctor Parameters []
