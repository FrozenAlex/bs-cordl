...
public:
  ...
  /// @brief Method OnNotify, addr 0x5713f64, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5714008, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_timelinePauseEvent, addr 0x5713e0c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_timelinePauseEvent, addr 0x5713eb8, size 0xac, virtual false, abstract: false, final false
