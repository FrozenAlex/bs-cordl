...
public:
  // Declarations
  /// @brief Method FindTrackAssetByName, addr 0x57e847c, size 0x3cc, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::TimelineUtils) == 0x10, "Size mismatch!");
