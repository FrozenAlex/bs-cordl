...
// Dependencies TrackLaneRing, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  // Declarations
  __declspec(property(get = get_Rings)) ::ArrayW<::UnityW<::GlobalNamespace::TrackLaneRing>> Rings;
  ...
  __declspec(property(get = __cordl_internal_get__rings, put = __cordl_internal_set__rings)) ::ArrayW<::UnityW<::GlobalNamespace::TrackLaneRing>> _rings;
  ...
  /// @brief Method FixedUpdate, addr 0x59a08e0, size 0x68, virtual false, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method LateUpdate, addr 0x59a0948, size 0x7c, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::TrackLaneRingsManager* New_ctor();

  /// @brief Method OnDrawGizmosSelected, addr 0x59a09c4, size 0x27c, virtual false, abstract: false, final false
  inline void OnDrawGizmosSelected();

  /// @brief Method Start, addr 0x59a061c, size 0x2c4, virtual false, abstract: false, final false
  inline void Start();
  ...
  constexpr ::ArrayW<::UnityW<::GlobalNamespace::TrackLaneRing>> const& __cordl_internal_get__rings() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::TrackLaneRing>>& __cordl_internal_get__rings();
  ...
  constexpr void __cordl_internal_set__rings(::ArrayW<::UnityW<::GlobalNamespace::TrackLaneRing>> value);
  ...
  /// @brief Method .ctor, addr 0x59a0c40, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Rings, addr 0x59a0614, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::GlobalNamespace::TrackLaneRing>> get_Rings();

  /// @brief Method get_ringPositionStep, addr 0x59a060c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::UnityW<::GlobalNamespace::TrackLaneRing>> ____rings;
...
static_assert(sizeof(::GlobalNamespace::TrackLaneRingsManager) == 0x58, "Size mismatch!");
