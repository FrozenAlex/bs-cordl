...
MARK_REF_T(::GlobalNamespace::TrackLaneRingsRotationEffectSpawner*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TrackLaneRingsRotationEffectSpawner_RotationStepType, "", "TrackLaneRingsRotationEffectSpawner/RotationStepType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TrackLaneRingsRotationEffectSpawner*, "", "TrackLaneRingsRotationEffectSpawner");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
public:
  ...
  /// @brief Method HandleBeatmapEvent, addr 0x5869c84, size 0xe4, virtual false, abstract: false, final false
  inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData* basicBeatmapEventData);

  static inline ::GlobalNamespace::TrackLaneRingsRotationEffectSpawner* New_ctor();

  /// @brief Method OnDestroy, addr 0x5869c68, size 0x1c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x5869b40, size 0x128, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5869d68, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::TrackLaneRingsRotationEffectSpawner) == 0x58, "Size mismatch!");
