...
// Write type traits
MARK_REF_T(::GlobalNamespace::TransformLayouter*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TransformLayouter*, "", "TransformLayouter");
...
public:
  ...
  /// @brief Method .ctor, addr 0x585952c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::TransformLayouter) == 0x20, "Size mismatch!");
