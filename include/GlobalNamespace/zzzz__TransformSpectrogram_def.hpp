...
// Write type traits
MARK_REF_T(::GlobalNamespace::TransformSpectrogram*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TransformSpectrogram*, "", "TransformSpectrogram");
// Dependencies LightAxis, UnityEngine.MonoBehaviour, UnityEngine.Transform, UnityEngine.Vector3
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__defaultPositions, put = __cordl_internal_set__defaultPositions)) ::ArrayW<::UnityEngine::Vector3> _defaultPositions;
  ...
  /// @brief Method Awake, addr 0x586867c, size 0x184, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::TransformSpectrogram* New_ctor();

  /// @brief Method Update, addr 0x5868800, size 0x270, virtual false, abstract: false, final false
  inline void Update();
  ...
  constexpr ::ArrayW<::UnityEngine::Vector3> const& __cordl_internal_get__defaultPositions() const;

  constexpr ::ArrayW<::UnityEngine::Vector3>& __cordl_internal_get__defaultPositions();
  ...
  constexpr void __cordl_internal_set__defaultPositions(::ArrayW<::UnityEngine::Vector3> value);
  ...
  /// @brief Method .ctor, addr 0x5868a70, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::UnityEngine::Vector3> ____defaultPositions;
...
static_assert(sizeof(::GlobalNamespace::TransformSpectrogram) == 0x60, "Size mismatch!");
