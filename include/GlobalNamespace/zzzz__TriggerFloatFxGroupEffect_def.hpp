...
// Write type traits
MARK_REF_T(::GlobalNamespace::TriggerFloatFxGroupEffect*);
MARK_REF_T(::GlobalNamespace::TriggerFloatFxGroupEffect_InitData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TriggerFloatFxGroupEffect*, "", "TriggerFloatFxGroupEffect");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TriggerFloatFxGroupEffect_InitData*, "", "TriggerFloatFxGroupEffect/InitData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x598ebac, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::TriggerFloatFxGroupEffect_InitData) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method Cleanup, addr 0x598e930, size 0x1c, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method HandleFloatFxBeatmapEventCallback, addr 0x598eb74, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x598ea30, size 0x144, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::TriggerFloatFxGroupEffect) == 0x28, "Size mismatch!");
