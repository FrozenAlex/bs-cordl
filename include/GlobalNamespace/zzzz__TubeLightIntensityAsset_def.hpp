...
// Write type traits
MARK_REF_T(::GlobalNamespace::TubeLightIntensityAsset*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TubeLightIntensityAsset*, "", "TubeLightIntensityAsset");
...
public:
  ...
  /// @brief Method CreatePlayable, addr 0x57e8df0, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57e8ea4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_clipCaps, addr 0x57e8de8, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::TubeLightIntensityAsset) == 0x20, "Size mismatch!");
