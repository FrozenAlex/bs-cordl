...
// Write type traits
MARK_REF_T(::GlobalNamespace::TubeLightIntensityBehaviour*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TubeLightIntensityBehaviour*, "", "TubeLightIntensityBehaviour");
// Dependencies DirectionalLight, TubeBloomPrePassLight, UnityEngine.Playables.PlayableBehaviour
namespace GlobalNamespace {
// Is value type: false
...
static_assert(sizeof(::GlobalNamespace::TubeLightIntensityBehaviour) == 0x58, "Size mismatch!");
