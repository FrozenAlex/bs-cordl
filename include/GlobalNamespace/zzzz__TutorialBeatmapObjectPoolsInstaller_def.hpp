...
// Write type traits
MARK_REF_T(::GlobalNamespace::TutorialBeatmapObjectPoolsInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TutorialBeatmapObjectPoolsInstaller*, "", "TutorialBeatmapObjectPoolsInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x58c8190, size 0x198, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58c8328, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::TutorialBeatmapObjectPoolsInstaller) == 0x40, "Size mismatch!");
