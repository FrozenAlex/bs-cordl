...
// Write type traits
MARK_REF_T(::GlobalNamespace::TutorialInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TutorialInstaller*, "", "TutorialInstaller");
...
public:
  ...
  /// @brief Field _effectPoolsManualInstaller, offset 0x40, size 0x8
  ...
  /// @brief Field _environmentSceneSetupData, offset 0x50, size 0x8
  ...
  /// @brief Field _sceneSetupData, offset 0x48, size 0x8
...
static_assert(offsetof(::GlobalNamespace::TutorialInstaller, ____playerHeightDetectorPrefab) == 0x38, "Offset mismatch!");
...
static_assert(offsetof(::GlobalNamespace::TutorialInstaller, ____environmentSceneSetupData) == 0x50, "Offset mismatch!");
