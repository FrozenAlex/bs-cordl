...
// Write type traits
MARK_REF_T(::GlobalNamespace::TutorialPause*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TutorialPause*, "", "TutorialPause");
...
public:
  ...
  /// @brief Method Pause, addr 0x58c200c, size 0xa4, virtual true, abstract: false, final true
  inline void Pause();

  /// @brief Method Resume, addr 0x58c20cc, size 0xa0, virtual true, abstract: false, final true
  inline void Resume();

  /// @brief Method WillResume, addr 0x58c20b0, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x58c216c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didPauseEvent, addr 0x58c1c04, size 0xac, virtual true, abstract: false, final true
  inline void add_didPauseEvent(::System::Action* value);

  /// @brief Method add_didResumeEvent, addr 0x58c1eb4, size 0xac, virtual true, abstract: false, final true
  inline void add_didResumeEvent(::System::Action* value);

  /// @brief Method add_willResumeEvent, addr 0x58c1d5c, size 0xac, virtual true, abstract: false, final true
  inline void add_willResumeEvent(::System::Action* value);

  /// @brief Method get_isPaused, addr 0x58c1bfc, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_didPauseEvent, addr 0x58c1cb0, size 0xac, virtual true, abstract: false, final true
  inline void remove_didPauseEvent(::System::Action* value);

  /// @brief Method remove_didResumeEvent, addr 0x58c1f60, size 0xac, virtual true, abstract: false, final true
  inline void remove_didResumeEvent(::System::Action* value);

  /// @brief Method remove_willResumeEvent, addr 0x58c1e08, size 0xac, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::TutorialPause) == 0x48, "Size mismatch!");
