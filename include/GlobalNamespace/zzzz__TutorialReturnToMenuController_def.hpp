...
// Write type traits
MARK_REF_T(::GlobalNamespace::TutorialReturnToMenuController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TutorialReturnToMenuController*, "", "TutorialReturnToMenuController");
...
public:
  ...
  /// @brief Method ReturnToMenu, addr 0x587d5e4, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x587d614, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::TutorialReturnToMenuController) == 0x28, "Size mismatch!");
