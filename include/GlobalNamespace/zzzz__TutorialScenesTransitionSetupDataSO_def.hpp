...
MARK_REF_T(::GlobalNamespace::TutorialScenesTransitionSetupDataSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TutorialScenesTransitionSetupDataSO_TutorialEndStateType, "", "TutorialScenesTransitionSetupDataSO/TutorialEndStateType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TutorialScenesTransitionSetupDataSO*, "", "TutorialScenesTransitionSetupDataSO");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::TutorialScenesTransitionSetupDataSO_TutorialEndStateType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method Finish, addr 0x57f2c80, size 0x28, virtual false, abstract: false, final false
  inline void Finish(::GlobalNamespace::TutorialScenesTransitionSetupDataSO_TutorialEndStateType endState);

  /// @brief Method Init, addr 0x57f13b8, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57f2ca8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x57f12f8, size 0xc0, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method remove_didFinishEvent, addr 0x57f03b0, size 0xc0, virtual false, abstract: false, final false
  inline void
...
static_assert(sizeof(::GlobalNamespace::TutorialScenesTransitionSetupDataSO) == 0x30, "Size mismatch!");
