...
public:
  ...
  /// @brief Method MoveNext, addr 0x59fd8a0, size 0x138, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x59fd9d8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x59fd9e0, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x59fda18, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x59fd89c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x59fd890, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CloseKeyboard, addr 0x59fd428, size 0xa0, virtual false, abstract: false, final false
  inline void CloseKeyboard();

  /// @brief Method HandleKeyboardOkButton, addr 0x59fd728, size 0x168, virtual false, abstract: false, final false
  inline void HandleKeyboardOkButton();

  static inline ::GlobalNamespace::UIKeyboardManager* New_ctor();

  /// @brief Method OnDestroy, addr 0x59fd0c8, size 0x100, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x59fd038, size 0x90, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x59fcfa8, size 0x90, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OpenKeyboardFor, addr 0x59fd1c8, size 0x200, virtual false, abstract: false, final false
  inline void OpenKeyboardFor(::HMUI::InputFieldView* input);

  /// @brief Method ProcessMousePress, addr 0x59fd5b8, size 0x170, virtual false, abstract: false, final false
  inline void ProcessMousePress(::UnityEngine::GameObject* currentOverGo);

  /// @brief Method ShouldCloseKeyboard, addr 0x59fd560, size 0x58, virtual false, abstract: false, final false
  inline bool ShouldCloseKeyboard(::UnityEngine::GameObject* root);

  /// @brief Method Start, addr 0x59fceb4, size 0xf4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method SummonSystemKeyboardAndWaitForResponse, addr 0x59fd3c8, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* SummonSystemKeyboardAndWaitForResponse(::HMUI::InputFieldView* input);

  /// @brief Method TransferKeyboardTo, addr 0x59fd4c8, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59fd898, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_keyboard, addr 0x59fceac, size 0x8, virtual false, abstract: false, final false
