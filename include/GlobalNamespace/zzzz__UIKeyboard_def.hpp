...
public:
  ...
  /// @brief Method <Awake>b__4, addr 0x58cffe4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58cff60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x58cf4a0, size 0xac0, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::UIKeyboard* New_ctor();

  /// @brief Method <Awake>b__21_0, addr 0x58cff68, size 0x1c, virtual false, abstract: false, final false
  inline void _Awake_b__21_0();

  /// @brief Method <Awake>b__21_1, addr 0x58cff84, size 0x20, virtual false, abstract: false, final false
  inline void _Awake_b__21_1();

  /// @brief Method <Awake>b__21_2, addr 0x58cffa4, size 0x20, virtual false, abstract: false, final false
  inline void _Awake_b__21_2();

  /// @brief Method <Awake>b__21_3, addr 0x58cffc4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58cff64, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_cancelButtonWasPressedEvent, addr 0x58cf1f0, size 0xac, virtual false, abstract: false, final false
  inline void add_cancelButtonWasPressedEvent(::System::Action* value);

  /// @brief Method add_deleteButtonWasPressedEvent, addr 0x58cef40, size 0xac, virtual false, abstract: false, final false
  inline void add_deleteButtonWasPressedEvent(::System::Action* value);

  /// @brief Method add_okButtonWasPressedEvent, addr 0x58cf098, size 0xac, virtual false, abstract: false, final false
  inline void add_okButtonWasPressedEvent(::System::Action* value);

  /// @brief Method add_textKeyWasPressedEvent, addr 0x58cedc0, size 0xc0, virtual false, abstract: false, final false
  inline void add_textKeyWasPressedEvent(::System::Action_1<char16_t>* value);

  /// @brief Method remove_cancelButtonWasPressedEvent, addr 0x58cf29c, size 0xac, virtual false, abstract: false, final false
  inline void remove_cancelButtonWasPressedEvent(::System::Action* value);

  /// @brief Method remove_deleteButtonWasPressedEvent, addr 0x58cefec, size 0xac, virtual false, abstract: false, final false
  inline void remove_deleteButtonWasPressedEvent(::System::Action* value);

  /// @brief Method remove_okButtonWasPressedEvent, addr 0x58cf144, size 0xac, virtual false, abstract: false, final false
  inline void remove_okButtonWasPressedEvent(::System::Action* value);

  /// @brief Method remove_textKeyWasPressedEvent, addr 0x58cee80, size 0xc0, virtual false, abstract: false, final false
  inline void remove_textKeyWasPressedEvent(::System::Action_1<char16_t>* value);

  /// @brief Method set_enableOkButtonInteractivity, addr 0x58cf348, size 0xa4, virtual false, abstract: false, final false
  inline void set_enableOkButtonInteractivity(bool value);

  /// @brief Method set_hideCancelButton, addr 0x58cf3ec, size 0xb4, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::UIKeyboard) == 0x60, "Size mismatch!");
