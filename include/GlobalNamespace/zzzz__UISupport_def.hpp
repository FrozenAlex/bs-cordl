...
// Write type traits
MARK_REF_T(::GlobalNamespace::UISupport*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::UISupport*, "", "UISupport");
...
public:
  // Declarations
  /// @brief Method Initialize, addr 0x64c8ba8, size 0x7c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::UISupport) == 0x10, "Size mismatch!");
