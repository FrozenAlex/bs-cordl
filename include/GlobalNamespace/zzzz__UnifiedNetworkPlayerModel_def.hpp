...
MARK_REF_T(::GlobalNamespace::UnifiedNetworkPlayerModel__get_otherPlayers_d__69*);
...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::UnifiedNetworkPlayerModel__get_otherPlayers_d__69*, "", "UnifiedNetworkPlayerModel/<get_otherPlayers>d__69");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::UnifiedNetworkPlayerModel__get_otherPlayers_d__69) == 0x38, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::UnifiedNetworkPlayerModel) == 0x78, "Size mismatch!");
