...
public:
  ...
  // Ctor Parameters [CppParam { name: "FilePathsData", ty: "::ArrayW<uint8_t>", modifiers: "", def_value: None }, CppParam { name: "TypesData", ty: "::ArrayW<uint8_t>", modifiers: "", def_value: None
  // }, CppParam { name: "TotalTypes", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "TotalFiles", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "IsEditorOnly",
  // ty: "bool", modifiers: "", def_value: None }]
  constexpr UnitySourceGeneratedAssemblyMonoScriptTypes_v1_MonoScriptData(::ArrayW<uint8_t> FilePathsData, ::ArrayW<uint8_t> TypesData, int32_t TotalTypes, int32_t TotalFiles,
...
public:
  ...
  /// @brief Method Get, addr 0x31f35dc, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31f3698, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief IL2CPP Metadata Type Index
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23280 };
