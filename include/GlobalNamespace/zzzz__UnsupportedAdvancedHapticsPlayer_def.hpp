...
// Write type traits
MARK_REF_T(::GlobalNamespace::UnsupportedAdvancedHapticsPlayer*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::UnsupportedAdvancedHapticsPlayer*, "", "UnsupportedAdvancedHapticsPlayer");
...
public:
  ...
  /// @brief Method CanPlayHapticPreset, addr 0x5714010, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method PlayHapticFeedback, addr 0x571400c, size 0x4, virtual true, abstract: false, final true
  inline void PlayHapticFeedback(::UnityEngine::XR::XRNode node, ::Libraries::HM::HMLib::VR::HapticPresetSO* hapticPreset);

  /// @brief Method .ctor, addr 0x5714018, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::UnsupportedAdvancedHapticsPlayer) == 0x10, "Size mismatch!");
