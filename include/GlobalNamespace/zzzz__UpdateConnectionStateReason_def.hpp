...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::UpdateConnectionStateReason, "", "UpdateConnectionStateReason");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::UpdateConnectionStateReason) == 0x4, "Size mismatch!");
