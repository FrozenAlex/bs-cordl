...
public:
  ...
  /// @brief Method MoveNext, addr 0x57131d0, size 0x180, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::VFXController__MainCoroutine_d__9* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x5713350, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5713358, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5713390, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x57131cc, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x57131c0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x5713010, size 0x24, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method MainCoroutine, addr 0x5713148, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Play, addr 0x5713034, size 0x114, virtual false, abstract: false, final false
  inline void Play();
  ...
  /// @brief Method .ctor, addr 0x57131c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_animation, addr 0x5713000, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Animation> get_animation();

  /// @brief Method get_particleSystems, addr 0x5713008, size 0x8, virtual false, abstract: false, final false
