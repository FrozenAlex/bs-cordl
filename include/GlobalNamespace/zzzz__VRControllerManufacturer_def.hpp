...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::VRControllerManufacturer, "", "VRControllerManufacturer");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::VRControllerManufacturer) == 0x4, "Size mismatch!");
