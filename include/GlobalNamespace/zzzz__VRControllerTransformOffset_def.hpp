...
// Write type traits
MARK_REF_T(::GlobalNamespace::VRControllerTransformOffset*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::VRControllerTransformOffset*, "", "VRControllerTransformOffset");
...
public:
  ...
  /// @brief Method .ctor, addr 0x585e024, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::VRControllerTransformOffset) == 0x20, "Size mismatch!");
