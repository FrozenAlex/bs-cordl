...
// Write type traits
MARK_REF_T(::GlobalNamespace::VRPlatformEventsDebugger*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::VRPlatformEventsDebugger*, "", "VRPlatformEventsDebugger");
...
static_assert(sizeof(::GlobalNamespace::VRPlatformEventsDebugger) == 0x18, "Size mismatch!");
