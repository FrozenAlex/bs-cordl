...
// Write type traits
MARK_REF_T(::GlobalNamespace::VRRenderingParamsSetup*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::VRRenderingParamsSetup*, "", "VRRenderingParamsSetup");
...
public:
  ...
  /// @brief Method OnEnable, addr 0x57dfeb0, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57dff88, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::VRRenderingParamsSetup) == 0x38, "Size mismatch!");
