...
// Write type traits
MARK_REF_T(::GlobalNamespace::VariableMovementDataProviderDebugWindow*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::VariableMovementDataProviderDebugWindow*, "", "VariableMovementDataProviderDebugWindow");
...
public:
  ...
  /// @brief Method OnGUI, addr 0x5792d3c, size 0xbf8, virtual false, abstract: false, final false
  inline void OnGUI();
  ...
  /// @brief Method .ctor, addr 0x5793934, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::VariableMovementDataProviderDebugWindow) == 0x30, "Size mismatch!");
