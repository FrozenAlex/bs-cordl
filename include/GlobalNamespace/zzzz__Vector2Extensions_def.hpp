...
// Write type traits
MARK_REF_T(::GlobalNamespace::Vector2Extensions*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::Vector2Extensions*, "", "Vector2Extensions");
...
static_assert(sizeof(::GlobalNamespace::Vector2Extensions) == 0x10, "Size mismatch!");
