...
// Write type traits
MARK_REF_T(::GlobalNamespace::VertexPath*);
MARK_VAL_T(::GlobalNamespace::VertexPath_Vertex);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::VertexPath*, "", "VertexPath");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::VertexPath_Vertex, "", "VertexPath/Vertex");
...
static_assert(sizeof(::GlobalNamespace::VertexPath_Vertex) == 0x24, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies System.Object, UnityEngine.Vector3, VertexPath::Vertex
namespace GlobalNamespace {
// Is value type: false
// CS Name: VertexPath
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__anchorVertexMap, put = __cordl_internal_set__anchorVertexMap)) ::ArrayW<int32_t> _anchorVertexMap;
  ...
  __declspec(property(get = __cordl_internal_get__cumulativeLengthAtEachVertex, put = __cordl_internal_set__cumulativeLengthAtEachVertex)) ::ArrayW<float_t> _cumulativeLengthAtEachVertex;
  ...
  __declspec(property(get = __cordl_internal_get__localVertices, put = __cordl_internal_set__localVertices)) ::ArrayW<::GlobalNamespace::VertexPath_Vertex> _localVertices;
  ...
  /// @brief Method AddVertex, addr 0x5901b08, size 0x544, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPoint, addr 0x5901ad0, size 0x38, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 GetPoint(int32_t index);

  /// @brief Method GetVertex, addr 0x5901a70, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method SplitBezierPathIntoFixNumberOfSegments, addr 0x59014e8, size 0x550, virtual false, abstract: false, final false
  inline void SplitBezierPathIntoFixNumberOfSegments(::GlobalNamespace::BezierPath* bezierPath, int32_t numberOfVertexSegments);

  /// @brief Method TimeAtPoint, addr 0x5901a38, size 0x38, virtual false, abstract: false, final false
  inline float_t TimeAtPoint(int32_t pointIndex);

  /// @brief Method UpdateByBezierPath, addr 0x5901048, size 0x47c, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<int32_t>& __cordl_internal_get__anchorVertexMap();

  constexpr ::ArrayW<float_t> const& __cordl_internal_get__cumulativeLengthAtEachVertex() const;

  constexpr ::ArrayW<float_t>& __cordl_internal_get__cumulativeLengthAtEachVertex();

  constexpr float_t const& __cordl_internal_get__length() const;

  constexpr float_t& __cordl_internal_get__length();

  constexpr ::ArrayW<::GlobalNamespace::VertexPath_Vertex> const& __cordl_internal_get__localVertices() const;

  constexpr ::ArrayW<::GlobalNamespace::VertexPath_Vertex>& __cordl_internal_get__localVertices();

  constexpr int32_t const& __cordl_internal_get_vertexCount() const;

  constexpr int32_t& __cordl_internal_get_vertexCount();

  constexpr void __cordl_internal_set__anchorVertexMap(::ArrayW<int32_t> value);

  constexpr void __cordl_internal_set__cumulativeLengthAtEachVertex(::ArrayW<float_t> value);

  constexpr void __cordl_internal_set__length(float_t value);

  constexpr void __cordl_internal_set__localVertices(::ArrayW<::GlobalNamespace::VertexPath_Vertex> value);

  constexpr void __cordl_internal_set_vertexCount(int32_t value);

  /// @brief Method .ctor, addr 0x5900f64, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(int32_t numberOfPathSegments);

  static inline ::UnityEngine::Vector3 getStaticF__back();

  /// @brief Method get_length, addr 0x59014e0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::GlobalNamespace::VertexPath_Vertex> ____localVertices;
  ...
  ::ArrayW<float_t> ____cumulativeLengthAtEachVertex;

  /// @brief Field _anchorVertexMap, offset: 0x30, size: 0x8, def value: None
  ::ArrayW<int32_t> ____anchorVertexMap;
...
static_assert(sizeof(::GlobalNamespace::VertexPath) == 0x38, "Size mismatch!");
