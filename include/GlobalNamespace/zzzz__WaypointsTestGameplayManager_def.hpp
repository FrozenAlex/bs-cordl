...
// Write type traits
MARK_REF_T(::GlobalNamespace::WaypointsTestGameplayManager*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::WaypointsTestGameplayManager*, "", "WaypointsTestGameplayManager");
...
public:
  ...
  /// @brief Method GetBar, addr 0x31efdc4, size 0x1b8, virtual false, abstract: false, final false
  inline ::StringW GetBar(float_t songTime);

  /// @brief Method LateUpdate, addr 0x31ef224, size 0xba0, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::WaypointsTestGameplayManager* New_ctor();

  /// @brief Method OnDestroy, addr 0x31eff7c, size 0x320, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDrawGizmos, addr 0x31f029c, size 0x248, virtual false, abstract: false, final false
  inline void OnDrawGizmos();

  /// @brief Method Start, addr 0x31ef1cc, size 0x58, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x31f04e4, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::WaypointsTestGameplayManager) == 0xa0, "Size mismatch!");
