...
// Write type traits
MARK_REF_T(::GlobalNamespace::WaypointsTestMenuViewController*);
MARK_REF_T(::GlobalNamespace::WaypointsTestMenuViewController__CheckBeatmaps_d__18*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::WaypointsTestMenuViewController*, "", "WaypointsTestMenuViewController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::WaypointsTestMenuViewController__CheckBeatmaps_d__18*, "", "WaypointsTestMenuViewController/<CheckBeatmaps>d__18");
...
static_assert(sizeof(::GlobalNamespace::WaypointsTestMenuViewController__CheckBeatmaps_d__18) == 0xa0, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::WaypointsTestMenuViewController) == 0x98, "Size mismatch!");
