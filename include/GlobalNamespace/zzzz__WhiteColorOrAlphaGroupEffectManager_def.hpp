...
public:
  ...
  /// @brief Method OnDestroy, addr 0x585a414, size 0x104, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x585a1a4, size 0x270, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x585a518, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
