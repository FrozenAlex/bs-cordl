...
// Write type traits
MARK_REF_T(::GlobalNamespace::WhiteColorOrAlphaGroupEffect*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::WhiteColorOrAlphaGroupEffect*, "", "WhiteColorOrAlphaGroupEffect");
// Dependencies LightColorGroupEffect, UnityEngine.Color
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method GetColor, addr 0x585a144, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x585a108, size 0x3c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::WhiteColorOrAlphaGroupEffect) == 0xb8, "Size mismatch!");
