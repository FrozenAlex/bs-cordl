...
public:
  ...
  /// @brief Method MoveNext, addr 0x5875cbc, size 0x140, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::HMUI::AlphabetScrollbar__PointerMoveInsideCoroutine_d__18* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x5875dfc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5875e04, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5875e3c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5875cb8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5875c0c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x5874da4, size 0x1c, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method GetPointerCharacterIndex, addr 0x5875724, size 0x2e0, virtual false, abstract: false, final false
  inline int32_t GetPointerCharacterIndex(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method InitText, addr 0x5875060, size 0xc0, virtual false, abstract: false, final false
  inline void InitText(::TMPro::TextMeshProUGUI* text, char16_t character);

  static inline ::HMUI::AlphabetScrollbar* New_ctor();

  /// @brief Method OnPointerDown, addr 0x5875634, size 0xf0, virtual true, abstract: false, final true
  inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerEnter, addr 0x5875a0c, size 0x20, virtual true, abstract: false, final true
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerExit, addr 0x5875a8c, size 0x24, virtual true, abstract: false, final true
  inline void OnPointerExit(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerUp, addr 0x5875a04, size 0x8, virtual true, abstract: false, final true
  inline void OnPointerUp(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method PointerMoveInsideCoroutine, addr 0x5875a2c, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* PointerMoveInsideCoroutine(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method PrepareTransforms, addr 0x5875120, size 0x514, virtual false, abstract: false, final false
  inline void PrepareTransforms();

  /// @brief Method RefreshHighlight, addr 0x5875ab0, size 0x15c, virtual false, abstract: false, final false
  inline void RefreshHighlight();

  /// @brief Method SetData, addr 0x5874dc0, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5875c14, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
