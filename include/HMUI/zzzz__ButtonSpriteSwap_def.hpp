...
// Write type traits
MARK_REF_T(::HMUI::ButtonSpriteSwap*);
DEFINE_IL2CPP_CLASS(::HMUI::ButtonSpriteSwap*, "HMUI", "ButtonSpriteSwap");
...
public:
  ...
  /// @brief Method Awake, addr 0x5881c5c, size 0xb4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleButtonSelectionStateDidChange, addr 0x5881ff8, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5881e38, size 0x100, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEnable, addr 0x5881e18, size 0x20, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RefreshVisualState, addr 0x5881df8, size 0x20, virtual false, abstract: false, final false
  inline void RefreshVisualState();

  /// @brief Method Start, addr 0x5881dd0, size 0x28, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x58820bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::HMUI::ButtonSpriteSwap) == 0x58, "Size mismatch!");
