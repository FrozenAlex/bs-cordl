...
// Write type traits
MARK_REF_T(::HMUI::CurvedCanvasSettingsHelper*);
DEFINE_IL2CPP_CLASS(::HMUI::CurvedCanvasSettingsHelper*, "HMUI", "CurvedCanvasSettingsHelper");
...
public:
  ...
  /// @brief Method GetCurvedCanvasSettings, addr 0x5879434, size 0x1fc, virtual false, abstract: false, final false
  inline ::UnityW<::HMUI::CurvedCanvasSettings> GetCurvedCanvasSettings(::UnityEngine::Canvas* canvas);

  /// @brief Method GetCurvedCanvasSettingsForCanvas, addr 0x5879630, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x5879420, size 0x14, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x58797b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::HMUI::CurvedCanvasSettingsHelper) == 0x30, "Size mismatch!");
