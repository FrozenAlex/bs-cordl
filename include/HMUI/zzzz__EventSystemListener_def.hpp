...
public:
  ...
  /// @brief Method OnPointerEnter, addr 0x5879ed8, size 0x1c, virtual true, abstract: false, final true
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerExit, addr 0x5879ef4, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5879f10, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_pointerDidEnterEvent, addr 0x5879bd8, size 0xc0, virtual false, abstract: false, final false
  inline void add_pointerDidEnterEvent(::System::Action_1<::UnityEngine::EventSystems::PointerEventData*>* value);

  /// @brief Method add_pointerDidExitEvent, addr 0x5879d58, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_pointerDidEnterEvent, addr 0x5879c98, size 0xc0, virtual false, abstract: false, final false
  inline void remove_pointerDidEnterEvent(::System::Action_1<::UnityEngine::EventSystems::PointerEventData*>* value);

  /// @brief Method remove_pointerDidExitEvent, addr 0x5879e18, size 0xc0, virtual false, abstract: false, final false
