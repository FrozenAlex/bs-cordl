...
// Write type traits
MARK_REF_T(::HMUI::FloatRectOffset*);
DEFINE_IL2CPP_CLASS(::HMUI::FloatRectOffset*, "HMUI", "FloatRectOffset");
...
public:
  ...
  /// @brief Method .ctor, addr 0x587c440, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::HMUI::FloatRectOffset) == 0x20, "Size mismatch!");
