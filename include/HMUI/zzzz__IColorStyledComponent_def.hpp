...
// Write type traits
MARK_REF_T(::HMUI::IColorStyledComponent*);
DEFINE_IL2CPP_CLASS(::HMUI::IColorStyledComponent*, "HMUI", "IColorStyledComponent");
// Dependencies
namespace HMUI {
// Is value type: false
...
public:
  ...
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23397 };
