...
// Write type traits
MARK_REF_T(::HMUI::InteractableTextMeshPro*);
DEFINE_IL2CPP_CLASS(::HMUI::InteractableTextMeshPro*, "HMUI", "InteractableTextMeshPro");
...
public:
  ...
  /// @brief Method OnCanvasGroupChanged, addr 0x5879868, size 0x1e8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5879a50, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::HMUI::InteractableTextMeshPro) == 0x38, "Size mismatch!");
