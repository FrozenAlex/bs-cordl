...
// Write type traits
MARK_REF_T(::HMUI::InteractableTiltEffect*);
DEFINE_IL2CPP_CLASS(::HMUI::InteractableTiltEffect*, "HMUI", "InteractableTiltEffect");
...
public:
  ...
  /// @brief Method ComputeNewTargetRotation, addr 0x573d1b0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnPointerEnter, addr 0x573d244, size 0x50, virtual true, abstract: false, final true
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerMove, addr 0x573d294, size 0x50, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x573d2e4, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_effectStrengthMultiplier, addr 0x573d23c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_effectStrengthMultiplier, addr 0x573d180, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::HMUI::InteractableTiltEffect) == 0x40, "Size mismatch!");
