...
// Write type traits
MARK_REF_T(::HMUI::ItemForFocussedScrolling*);
DEFINE_IL2CPP_CLASS(::HMUI::ItemForFocussedScrolling*, "HMUI", "ItemForFocussedScrolling");
...
public:
  ...
  /// @brief Method .ctor, addr 0x574277c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::HMUI::ItemForFocussedScrolling) == 0x20, "Size mismatch!");
