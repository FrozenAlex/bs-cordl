...
MARK_REF_T(::HMUI::NavigationController*);
MARK_REF_T(::HMUI::NavigationController___c__DisplayClass10_0*);
MARK_REF_T(::HMUI::NavigationController___c__DisplayClass8_0*);
DEFINE_IL2CPP_CLASS(::HMUI::NavigationController_Alignment, "HMUI", "NavigationController/Alignment");
DEFINE_IL2CPP_CLASS(::HMUI::NavigationController_Orientation, "HMUI", "NavigationController/Orientation");
DEFINE_IL2CPP_CLASS(::HMUI::NavigationController*, "HMUI", "NavigationController");
DEFINE_IL2CPP_CLASS(::HMUI::NavigationController___c__DisplayClass10_0*, "HMUI", "NavigationController/<>c__DisplayClass10_0");
DEFINE_IL2CPP_CLASS(::HMUI::NavigationController___c__DisplayClass8_0*, "HMUI", "NavigationController/<>c__DisplayClass8_0");
// Dependencies
namespace HMUI {
// Is value type: true
...
static_assert(sizeof(::HMUI::NavigationController_Orientation) == 0x4, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_endPositions, put = __cordl_internal_set_endPositions)) ::ArrayW<float_t> endPositions;
  ...
  __declspec(property(get = __cordl_internal_get_startPositions, put = __cordl_internal_set_startPositions)) ::ArrayW<float_t> startPositions;

  static inline ::HMUI::NavigationController___c__DisplayClass10_0* New_ctor();

  /// @brief Method <PopViewControllers>g__AnimationLayouter|0, addr 0x32f14b0, size 0x2ac, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<float_t> const& __cordl_internal_get_endPositions() const;

  constexpr ::ArrayW<float_t>& __cordl_internal_get_endPositions();

  constexpr float_t const& __cordl_internal_get_moveOffset() const;

  constexpr float_t& __cordl_internal_get_moveOffset();

  constexpr ::ArrayW<float_t> const& __cordl_internal_get_startPositions() const;

  constexpr ::ArrayW<float_t>& __cordl_internal_get_startPositions();

  constexpr void __cordl_internal_set___4__this(::UnityW<::HMUI::NavigationController> value);

  constexpr void __cordl_internal_set_endPositions(::ArrayW<float_t> value);

  constexpr void __cordl_internal_set_moveOffset(float_t value);

  constexpr void __cordl_internal_set_startPositions(::ArrayW<float_t> value);

  /// @brief Method .ctor, addr 0x32f1404, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <PushViewController>g__AnimationLayouter|0, addr 0x32f175c, size 0x2e8, virtual false, abstract: false, final false
  inline void _PushViewController_g__AnimationLayouter_0(float_t t, ::ArrayW<::HMUI::ViewController*> viewControllers);
  ...
  /// @brief Method .ctor, addr 0x32f1400, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::HMUI::NavigationController___c__DisplayClass8_0) == 0x30, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetNewPositionsForViewControllers, addr 0x32f0f24, size 0x490, virtual false, abstract: false, final false
  inline ::ArrayW<float_t> GetNewPositionsForViewControllers(::System::Collections::Generic::List_1<::UnityW<::HMUI::ViewController>>* viewControllers,
                                                             ::System::Collections::Generic::HashSet_1<::UnityW<::HMUI::ViewController>>* fixedViewControllers, float_t fixedEndPos);

  /// @brief Method LayoutViewControllers, addr 0x32f0e00, size 0x124, virtual true, abstract: false, final false
  ...
  /// @brief Method PopViewController, addr 0x32ef234, size 0x10, virtual false, abstract: false, final false
  inline void PopViewController(::System::Action* finishedCallback, bool immediately);

  /// @brief Method PopViewControllers, addr 0x32ef3a8, size 0x23c, virtual false, abstract: false, final false
  inline void PopViewControllers(int32_t numberOfViewControllersToPop, ::System::Action* finishedCallback, bool immediately);

  /// @brief Method PositionVector, addr 0x32f13e0, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 PositionVector(float_t pos);

  /// @brief Method PushViewController, addr 0x32eef90, size 0x114, virtual false, abstract: false, final false
  inline void PushViewController(::HMUI::ViewController* viewController, ::System::Action* finishedCallback, bool immediately);

  /// @brief Method SetupViewControllerRect, addr 0x32f13b4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32f14a4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::HMUI::NavigationController) == 0xa0, "Size mismatch!");
