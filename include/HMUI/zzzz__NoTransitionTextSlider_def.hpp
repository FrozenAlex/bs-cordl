...
public:
  ...
  /// @brief Method DoStateTransition, addr 0x588cb6c, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x588cbac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_selectionStateDidChangeEvent, addr 0x588c9ec, size 0xc0, virtual false, abstract: false, final false
  inline void add_selectionStateDidChangeEvent(::System::Action_1<::HMUI::NoTransitionTextSlider_SelectionState>* value);

  /// @brief Method get_selectionState, addr 0x588c9e4, size 0x8, virtual false, abstract: false, final false
  inline ::HMUI::NoTransitionTextSlider_SelectionState get_selectionState();

  /// @brief Method remove_selectionStateDidChangeEvent, addr 0x588caac, size 0xc0, virtual false, abstract: false, final false
