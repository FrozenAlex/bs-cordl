...
public:
  ...
  /// @brief Method DoStateTransition, addr 0x57425e8, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method SetSelectionState, addr 0x574264c, size 0x20, virtual false, abstract: false, final false
  inline void SetSelectionState(::HMUI::UISelectionState state);

  /// @brief Method Start, addr 0x5742534, size 0xb4, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method <Start>b__6_0, addr 0x5742674, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x574266c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_selectionStateDidChangeEvent, addr 0x57423b4, size 0xc0, virtual false, abstract: false, final false
  inline void add_selectionStateDidChangeEvent(::System::Action_1<::HMUI::UISelectionState>* value);

  /// @brief Method get_selectionState, addr 0x57423ac, size 0x8, virtual false, abstract: false, final false
  inline ::HMUI::UISelectionState get_selectionState();

  /// @brief Method remove_selectionStateDidChangeEvent, addr 0x5742474, size 0xc0, virtual false, abstract: false, final false
