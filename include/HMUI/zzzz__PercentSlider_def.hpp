...
// Write type traits
MARK_REF_T(::HMUI::PercentSlider*);
DEFINE_IL2CPP_CLASS(::HMUI::PercentSlider*, "HMUI", "PercentSlider");
...
public:
  ...
  /// @brief Method TextForValue, addr 0x5739168, size 0xa8, virtual true, abstract: false, final false
  inline ::StringW TextForValue(float_t value);

  /// @brief Method .ctor, addr 0x5739210, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::HMUI::PercentSlider) == 0x170, "Size mismatch!");
