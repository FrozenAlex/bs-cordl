...
public:
  // Declarations
  /// @brief Method GetFlipAndSymmetry, addr 0x57426d8, size 0xa4, virtual false, abstract: false, final false
...
static_assert(sizeof(::HMUI::RoundedCornersDirectionExtensions) == 0x10, "Size mismatch!");
