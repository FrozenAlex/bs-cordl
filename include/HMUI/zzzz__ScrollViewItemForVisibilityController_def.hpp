...
public:
  // Declarations
  /// @brief Method GetWorldCorners, addr 0x5744cbc, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5744d28, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
