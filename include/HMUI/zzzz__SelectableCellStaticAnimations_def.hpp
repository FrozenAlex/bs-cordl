...
// Write type traits
MARK_REF_T(::HMUI::SelectableCellStaticAnimations*);
DEFINE_IL2CPP_CLASS(::HMUI::SelectableCellStaticAnimations*, "HMUI", "SelectableCellStaticAnimations");
...
public:
  ...
  /// @brief Method Awake, addr 0x588b99c, size 0xec, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleHighlightDidChange, addr 0x588bbf4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSelectionDidChange, addr 0x588bbf0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x588bb04, size 0xec, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RefreshVisuals, addr 0x588ba8c, size 0x78, virtual false, abstract: false, final false
  inline void RefreshVisuals();

  /// @brief Method Start, addr 0x588ba88, size 0x4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x588bbf8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::HMUI::SelectableCellStaticAnimations) == 0x48, "Size mismatch!");
