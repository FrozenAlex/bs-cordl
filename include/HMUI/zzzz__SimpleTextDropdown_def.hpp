...
// Write type traits
MARK_REF_T(::HMUI::SimpleTextDropdown*);
DEFINE_IL2CPP_CLASS(::HMUI::SimpleTextDropdown*, "HMUI", "SimpleTextDropdown");
...
public:
  ...
  /// @brief Method CellForIdx, addr 0x57469b4, size 0x1dc, virtual true, abstract: false, final true
  inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView* tableView, int32_t idx);

  /// @brief Method CellSize, addr 0x57468fc, size 0x8, virtual true, abstract: false, final true
  inline float_t CellSize(int32_t idx);

  /// @brief Method HandleDidSelectCellWithIdx, addr 0x5746c8c, size 0x160, virtual false, abstract: false, final false
  inline void HandleDidSelectCellWithIdx(::HMUI::DropdownWithTableView* dropdownWithTableView, int32_t idx);

  /// @brief Method LazyInit, addr 0x574640c, size 0xc4, virtual false, abstract: false, final false
  inline void LazyInit();

  static inline ::HMUI::SimpleTextDropdown* New_ctor();

  /// @brief Method NumberOfCells, addr 0x5746904, size 0xb0, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method OnDestroy, addr 0x57464d0, size 0x90, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SelectCellWithIdx, addr 0x5746708, size 0x1f4, virtual true, abstract: false, final false
  inline void SelectCellWithIdx(int32_t idx);

  /// @brief Method SetTexts, addr 0x5746560, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5746dec, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::HMUI::SimpleTextDropdown) == 0x80, "Size mismatch!");
