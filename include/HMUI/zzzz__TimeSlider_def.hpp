...
MARK_REF_T(::HMUI::TimeSlider*);
DEFINE_IL2CPP_CLASS(::HMUI::TimeSlider_TimeType, "HMUI", "TimeSlider/TimeType");
DEFINE_IL2CPP_CLASS(::HMUI::TimeSlider*, "HMUI", "TimeSlider");
// Dependencies
namespace HMUI {
// Is value type: true
...
static_assert(sizeof(::HMUI::TimeSlider_TimeType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method FormatTimeSpan, addr 0x58807ec, size 0x25c, virtual false, abstract: false, final false
  static inline ::StringW FormatTimeSpan(::System::TimeSpan ts);

  static inline ::HMUI::TimeSlider* New_ctor();

  /// @brief Method SetBounds, addr 0x5880580, size 0x10, virtual false, abstract: false, final false
  inline void SetBounds(bool valuesValid, float_t lowerValue, float_t upperValue);

  /// @brief Method TextForValue, addr 0x5880590, size 0x25c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5880a48, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::HMUI::TimeSlider) == 0x180, "Size mismatch!");
