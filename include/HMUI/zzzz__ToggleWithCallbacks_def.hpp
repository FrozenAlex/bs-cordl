...
MARK_REF_T(::HMUI::ToggleWithCallbacks*);
DEFINE_IL2CPP_CLASS(::HMUI::ToggleWithCallbacks_SelectionState, "HMUI", "ToggleWithCallbacks/SelectionState");
DEFINE_IL2CPP_CLASS(::HMUI::ToggleWithCallbacks*, "HMUI", "ToggleWithCallbacks");
// Dependencies
namespace HMUI {
// Is value type: true
...
static_assert(sizeof(::HMUI::ToggleWithCallbacks_SelectionState) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method DoStateTransition, addr 0x574ba18, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x574ba60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_stateDidChangeEvent, addr 0x5746fe4, size 0xc0, virtual false, abstract: false, final false
  inline void add_stateDidChangeEvent(::System::Action_1<::HMUI::ToggleWithCallbacks_SelectionState>* value);

  /// @brief Method get_selectionState, addr 0x5747420, size 0x78, virtual false, abstract: false, final false
  inline ::HMUI::ToggleWithCallbacks_SelectionState get_selectionState();

  /// @brief Method remove_stateDidChangeEvent, addr 0x5747358, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::HMUI::ToggleWithCallbacks) == 0x130, "Size mismatch!");
