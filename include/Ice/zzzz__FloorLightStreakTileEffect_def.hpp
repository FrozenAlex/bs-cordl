...
// Write type traits
MARK_REF_T(::Ice::FloorLightStreakTileEffect*);
MARK_REF_T(::Ice::FloorLightStreakTileEffect_Element*);
DEFINE_IL2CPP_CLASS(::Ice::FloorLightStreakTileEffect*, "Ice", "FloorLightStreakTileEffect");
DEFINE_IL2CPP_CLASS(::Ice::FloorLightStreakTileEffect_Element*, "Ice", "FloorLightStreakTileEffect/Element");
...
public:
  ...
  /// @brief Method ManualUpdate, addr 0x31f3c04, size 0x68, virtual false, abstract: false, final false
  inline void ManualUpdate(float_t deltaTime);

  static inline ::Ice::FloorLightStreakTileEffect_Element* New_ctor();

  /// @brief Method Setup, addr 0x31f3d3c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31f4114, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x31f41e4, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method get_currentTileY, addr 0x31f41dc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_currentTileY();

  /// @brief Method get_lineIndex, addr 0x31f41d4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Ice::FloorLightStreakTileEffect_Element) == 0x38, "Size mismatch!");
...
public:
  ...
  /// @brief Method CreateNewElement, addr 0x31f4010, size 0x104, virtual false, abstract: false, final false
  inline ::Ice::FloorLightStreakTileEffect_Element* CreateNewElement();

  /// @brief Method DespawnAll, addr 0x31f3f14, size 0xfc, virtual true, abstract: false, final false
  inline void DespawnAll();

  /// @brief Method HandleElementDidMoveToNextTile, addr 0x31f4118, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method SpawnEffect, addr 0x31f3c6c, size 0xd0, virtual false, abstract: false, final false
  inline void SpawnEffect(int32_t x, ::UnityEngine::Color color);

  /// @brief Method Start, addr 0x31f3988, size 0xc8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x31f3a50, size 0x1b4, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x31f41c4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Ice::FloorLightStreakTileEffect) == 0x40, "Size mismatch!");
