...
public:
  ...
  /// @brief Method ManualUpdate, addr 0x32859fc, size 0x68, virtual false, abstract: false, final false
  inline void ManualUpdate(float_t deltaTime);

  static inline ::Ice::FloorLightStreakTileEffect_Element* New_ctor();

  /// @brief Method Setup, addr 0x3285b34, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3285f0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x3285fdc, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method get_currentTileY, addr 0x3285fd4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_currentTileY();

  /// @brief Method get_lineIndex, addr 0x3285fcc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateNewElement, addr 0x3285e08, size 0x104, virtual false, abstract: false, final false
  inline ::Ice::FloorLightStreakTileEffect_Element* CreateNewElement();

  /// @brief Method DespawnAll, addr 0x3285d0c, size 0xfc, virtual true, abstract: false, final false
  inline void DespawnAll();

  /// @brief Method HandleElementDidMoveToNextTile, addr 0x3285f10, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method SpawnEffect, addr 0x3285a64, size 0xd0, virtual false, abstract: false, final false
  inline void SpawnEffect(int32_t x, ::UnityEngine::Color color);

  /// @brief Method Start, addr 0x3285780, size 0xc8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x3285848, size 0x1b4, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3285fbc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
