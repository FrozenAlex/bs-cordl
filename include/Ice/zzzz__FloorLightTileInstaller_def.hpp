...
// Write type traits
MARK_REF_T(::Ice::FloorLightTileInstaller*);
DEFINE_IL2CPP_CLASS(::Ice::FloorLightTileInstaller*, "Ice", "FloorLightTileInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x31f4668, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31f46f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Ice::FloorLightTileInstaller) == 0x28, "Size mismatch!");
