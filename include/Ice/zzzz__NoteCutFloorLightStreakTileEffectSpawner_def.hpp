...
// Write type traits
MARK_REF_T(::Ice::NoteCutFloorLightStreakTileEffectSpawner*);
DEFINE_IL2CPP_CLASS(::Ice::NoteCutFloorLightStreakTileEffectSpawner*, "Ice", "NoteCutFloorLightStreakTileEffectSpawner");
...
static_assert(sizeof(::Ice::NoteCutFloorLightStreakTileEffectSpawner) == 0x48, "Size mismatch!");
