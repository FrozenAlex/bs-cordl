...
DEFINE_IL2CPP_CLASS(::IgnoranceCore::IgnoranceChannelTypes, "IgnoranceCore", "IgnoranceChannelTypes");
// Dependencies
namespace IgnoranceCore {
// Is value type: true
...
static_assert(sizeof(::IgnoranceCore::IgnoranceChannelTypes) == 0x4, "Size mismatch!");
