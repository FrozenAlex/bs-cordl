...
DEFINE_IL2CPP_CLASS(::IgnoranceCore::IgnoranceConnectionEvent, "IgnoranceCore", "IgnoranceConnectionEvent");
// Dependencies
namespace IgnoranceCore {
// Is value type: true
...
static_assert(sizeof(::IgnoranceCore::IgnoranceConnectionEvent) == 0x10, "Size mismatch!");
