...
DEFINE_IL2CPP_CLASS(::IgnoranceCore::IgnoranceOutgoingPacket, "IgnoranceCore", "IgnoranceOutgoingPacket");
...
static_assert(sizeof(::IgnoranceCore::IgnoranceOutgoingPacket) == 0x10, "Size mismatch!");
