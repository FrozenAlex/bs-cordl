...
// Write type traits
MARK_GEN_REF_T_PTR(::IntervalTree::IntervalTreeNode_2);
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_items, put = __cordl_internal_set_items)) ::ArrayW<::IntervalTree::RangeValuePair_2<TKey, TValue>> items;
  ...
  constexpr ::ArrayW<::IntervalTree::RangeValuePair_2<TKey, TValue>> const& __cordl_internal_get_items() const;

  constexpr ::ArrayW<::IntervalTree::RangeValuePair_2<TKey, TValue>>& __cordl_internal_get_items();
  ...
  constexpr void __cordl_internal_set_items(::ArrayW<::IntervalTree::RangeValuePair_2<TKey, TValue>> value);
