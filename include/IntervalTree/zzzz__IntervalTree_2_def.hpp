...
namespace IntervalTree {
template <typename TKey, typename TValue> class IntervalTree_2___c__DisplayClass19_0;
}
namespace IntervalTree {
template <typename TKey, typename TValue> class IntervalTree_2___c__DisplayClass20_0;
}
namespace IntervalTree {
template <typename TKey, typename TValue> class IntervalTree_2___c__DisplayClass23_0;
}
namespace IntervalTree {
template <typename TKey, typename TValue> class IntervalTree_2___c__DisplayClass24_0;
}
namespace IntervalTree {
template <typename TKey, typename TValue> class IntervalTree_2___c;
}
namespace IntervalTree {
...
// Write type traits
MARK_GEN_REF_T_PTR(::IntervalTree::IntervalTree_2);
MARK_GEN_REF_T_PTR(::IntervalTree::IntervalTree_2___c);
MARK_GEN_REF_T_PTR(::IntervalTree::IntervalTree_2___c__DisplayClass19_0);
MARK_GEN_REF_T_PTR(::IntervalTree::IntervalTree_2___c__DisplayClass20_0);
MARK_GEN_REF_T_PTR(::IntervalTree::IntervalTree_2___c__DisplayClass23_0);
MARK_GEN_REF_T_PTR(::IntervalTree::IntervalTree_2___c__DisplayClass24_0);
DEFINE_IL2CPP_GEN_CLASS_PTR(::IntervalTree::IntervalTree_2, "IntervalTree", "IntervalTree`2");
DEFINE_IL2CPP_GEN_CLASS_PTR(::IntervalTree::IntervalTree_2___c, "IntervalTree", "IntervalTree`2/<>c");
DEFINE_IL2CPP_GEN_CLASS_PTR(::IntervalTree::IntervalTree_2___c__DisplayClass19_0, "IntervalTree", "IntervalTree`2/<>c__DisplayClass19_0");
...
// Is value type: false
// CS Name: IntervalTree.IntervalTree`2/<>c<TKey,TValue>
class CORDL_TYPE IntervalTree_2___c : public ::System::Object {
public:
  // Declarations
  /// @brief Field <>9, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF___9, put = setStaticF___9)) ::IntervalTree::IntervalTree_2___c<TKey, TValue>* __9;

  /// @brief Field <>9__10_0, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF___9__10_0, put = setStaticF___9__10_0)) ::System::Func_2<::IntervalTree::RangeValuePair_2<TKey, TValue>, TValue>* __9__10_0;

  static inline ::IntervalTree::IntervalTree_2___c<TKey, TValue>* New_ctor();
  ...
  static inline ::IntervalTree::IntervalTree_2___c<TKey, TValue>* getStaticF___9();

  static inline ::System::Func_2<::IntervalTree::RangeValuePair_2<TKey, TValue>, TValue>* getStaticF___9__10_0();

  static inline void setStaticF___9(::IntervalTree::IntervalTree_2___c<TKey, TValue>* value);
...
public:
  ...
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23025 };
...
template <typename TKey, typename TValue>
// Is value type: false
// CS Name: IntervalTree.IntervalTree`2/<>c__DisplayClass19_0<TKey,TValue>
class CORDL_TYPE IntervalTree_2___c__DisplayClass19_0 : public ::System::Object {
public:
  // Declarations
...
template <typename TKey, typename TValue>
// Is value type: false
// CS Name: IntervalTree.IntervalTree`2/<>c__DisplayClass20_0<TKey,TValue>
class CORDL_TYPE IntervalTree_2___c__DisplayClass20_0 : public ::System::Object {
public:
  // Declarations
  ...
  constexpr ::System::Collections::Generic::IEnumerable_1<TValue>* const& __cordl_internal_get_items() const;
...
template <typename TKey, typename TValue>
// Is value type: false
// CS Name: IntervalTree.IntervalTree`2/<>c__DisplayClass23_0<TKey,TValue>
class CORDL_TYPE IntervalTree_2___c__DisplayClass23_0 : public ::System::Object {
public:
  // Declarations
...
template <typename TKey, typename TValue>
// Is value type: false
// CS Name: IntervalTree.IntervalTree`2/<>c__DisplayClass24_0<TKey,TValue>
class CORDL_TYPE IntervalTree_2___c__DisplayClass24_0 : public ::System::Object {
public:
  // Declarations
  /// @brief Field <>4__this, offset 0x10, size 0x8
  __declspec(property(get = __cordl_internal_get___4__this, put = __cordl_internal_set___4__this)) ::IntervalTree::IntervalTree_2<TKey, TValue>* __4__this;
...
public:
  // Declarations
  using __c = ::IntervalTree::IntervalTree_2___c<TKey, TValue>;

  using __c__DisplayClass19_0 = ::IntervalTree::IntervalTree_2___c__DisplayClass19_0<TKey, TValue>;

  using __c__DisplayClass20_0 = ::IntervalTree::IntervalTree_2___c__DisplayClass20_0<TKey, TValue>;

  using __c__DisplayClass23_0 = ::IntervalTree::IntervalTree_2___c__DisplayClass23_0<TKey, TValue>;

  using __c__DisplayClass24_0 = ::IntervalTree::IntervalTree_2___c__DisplayClass24_0<TKey, TValue>;
  ...
  constexpr ::System::Collections::Generic::List_1<::IntervalTree::RangeValuePair_2<TKey, TValue>>* const& __cordl_internal_get_items() const;

  constexpr ::System::Collections::Generic::List_1<::IntervalTree::RangeValuePair_2<TKey, TValue>>*& __cordl_internal_get_items();

  constexpr ::IntervalTree::IntervalTreeNode_2<TKey, TValue>* const& __cordl_internal_get_root() const;
