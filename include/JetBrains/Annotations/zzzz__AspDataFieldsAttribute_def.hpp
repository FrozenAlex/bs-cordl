...
// Write type traits
MARK_REF_T(::JetBrains::Annotations::AspDataFieldsAttribute*);
DEFINE_IL2CPP_CLASS(::JetBrains::Annotations::AspDataFieldsAttribute*, "JetBrains.Annotations", "AspDataFieldsAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6e366a8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::JetBrains::Annotations::AspDataFieldsAttribute) == 0x10, "Size mismatch!");
