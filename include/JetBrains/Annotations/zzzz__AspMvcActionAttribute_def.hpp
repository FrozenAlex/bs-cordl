...
// Write type traits
MARK_REF_T(::JetBrains::Annotations::AspMvcActionAttribute*);
DEFINE_IL2CPP_CLASS(::JetBrains::Annotations::AspMvcActionAttribute*, "JetBrains.Annotations", "AspMvcActionAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce686c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6ce6870, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW anonymousProperty);

  /// @brief Method get_AnonymousProperty, addr 0x6ce6878, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_AnonymousProperty();

  /// @brief Method set_AnonymousProperty, addr 0x6ce6880, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::JetBrains::Annotations::AspMvcActionAttribute) == 0x18, "Size mismatch!");
