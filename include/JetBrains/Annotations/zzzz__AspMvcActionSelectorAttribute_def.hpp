...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce68e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::JetBrains::Annotations::AspMvcActionSelectorAttribute) == 0x10, "Size mismatch!");
