...
// Write type traits
MARK_REF_T(::JetBrains::Annotations::AspMvcAreaMasterLocationFormatAttribute*);
DEFINE_IL2CPP_CLASS(::JetBrains::Annotations::AspMvcAreaMasterLocationFormatAttribute*, "JetBrains.Annotations", "AspMvcAreaMasterLocationFormatAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce67dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW format);

  /// @brief Method get_Format, addr 0x6ce67e4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Format();

  /// @brief Method set_Format, addr 0x6ce67ec, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::JetBrains::Annotations::AspMvcAreaMasterLocationFormatAttribute) == 0x18, "Size mismatch!");
