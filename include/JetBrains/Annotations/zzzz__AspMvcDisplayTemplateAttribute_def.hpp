...
// Write type traits
MARK_REF_T(::JetBrains::Annotations::AspMvcDisplayTemplateAttribute*);
DEFINE_IL2CPP_CLASS(::JetBrains::Annotations::AspMvcDisplayTemplateAttribute*, "JetBrains.Annotations", "AspMvcDisplayTemplateAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce68d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::JetBrains::Annotations::AspMvcDisplayTemplateAttribute) == 0x10, "Size mismatch!");
