...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::JetBrains::Annotations::AspMvcDisplayTemplateAttribute::*)()>(&::JetBrains::Annotations::AspMvcDisplayTemplateAttribute::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x6e365d8;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::JetBrains::Annotations::AspMvcDisplayTemplateAttribute*>(), { ".ctor", {}, {} })));
...
inline ::JetBrains::Annotations::AspMvcDisplayTemplateAttribute* JetBrains::Annotations::AspMvcDisplayTemplateAttribute::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::JetBrains::Annotations::AspMvcDisplayTemplateAttribute*>());
}
// Ctor Parameters []
