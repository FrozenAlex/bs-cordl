...
// Write type traits
MARK_REF_T(::JetBrains::Annotations::AspMvcPartialViewAttribute*);
DEFINE_IL2CPP_CLASS(::JetBrains::Annotations::AspMvcPartialViewAttribute*, "JetBrains.Annotations", "AspMvcPartialViewAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6e365d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::JetBrains::Annotations::AspMvcPartialViewAttribute) == 0x10, "Size mismatch!");
