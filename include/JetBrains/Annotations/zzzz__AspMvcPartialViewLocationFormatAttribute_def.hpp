...
// Write type traits
MARK_REF_T(::JetBrains::Annotations::AspMvcPartialViewLocationFormatAttribute*);
DEFINE_IL2CPP_CLASS(::JetBrains::Annotations::AspMvcPartialViewLocationFormatAttribute*, "JetBrains.Annotations", "AspMvcPartialViewLocationFormatAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce683c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW format);

  /// @brief Method get_Format, addr 0x6ce6844, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Format();

  /// @brief Method set_Format, addr 0x6ce684c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::JetBrains::Annotations::AspMvcPartialViewLocationFormatAttribute) == 0x18, "Size mismatch!");
