...
// Write type traits
MARK_REF_T(::JetBrains::Annotations::AspMvcViewComponentViewAttribute*);
DEFINE_IL2CPP_CLASS(::JetBrains::Annotations::AspMvcViewComponentViewAttribute*, "JetBrains.Annotations", "AspMvcViewComponentViewAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6e365ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::JetBrains::Annotations::AspMvcViewComponentViewAttribute) == 0x10, "Size mismatch!");
