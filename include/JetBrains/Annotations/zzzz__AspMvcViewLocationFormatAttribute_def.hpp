...
// Write type traits
MARK_REF_T(::JetBrains::Annotations::AspMvcViewLocationFormatAttribute*);
DEFINE_IL2CPP_CLASS(::JetBrains::Annotations::AspMvcViewLocationFormatAttribute*, "JetBrains.Annotations", "AspMvcViewLocationFormatAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce6854, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW format);

  /// @brief Method get_Format, addr 0x6ce685c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Format();

  /// @brief Method set_Format, addr 0x6ce6864, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::JetBrains::Annotations::AspMvcViewLocationFormatAttribute) == 0x18, "Size mismatch!");
