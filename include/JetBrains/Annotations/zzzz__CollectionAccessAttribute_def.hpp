...
public:
  ...
  /// @brief Method .ctor, addr 0x6e3662c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::JetBrains::Annotations::CollectionAccessType collectionAccessType);

  /// @brief Method get_CollectionAccessType, addr 0x6e36634, size 0x8, virtual false, abstract: false, final false
  inline ::JetBrains::Annotations::CollectionAccessType get_CollectionAccessType();

  /// @brief Method set_CollectionAccessType, addr 0x6e3663c, size 0x8, virtual false, abstract: false, final false
