...
// Write type traits
MARK_REF_T(::JetBrains::Annotations::ProvidesContextAttribute*);
DEFINE_IL2CPP_CLASS(::JetBrains::Annotations::ProvidesContextAttribute*, "JetBrains.Annotations", "ProvidesContextAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce6784, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::JetBrains::Annotations::ProvidesContextAttribute) == 0x10, "Size mismatch!");
