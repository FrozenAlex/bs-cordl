...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::JetBrains::Annotations::ProvidesContextAttribute::*)()>(&::JetBrains::Annotations::ProvidesContextAttribute::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x6ce6784;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::JetBrains::Annotations::ProvidesContextAttribute*>(), { ".ctor", {}, {} })));
...
inline ::JetBrains::Annotations::ProvidesContextAttribute* JetBrains::Annotations::ProvidesContextAttribute::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::JetBrains::Annotations::ProvidesContextAttribute*>());
}
// Ctor Parameters []
