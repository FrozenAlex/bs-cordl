...
// Write type traits
MARK_REF_T(::JetBrains::Annotations::RazorSectionAttribute*);
DEFINE_IL2CPP_CLASS(::JetBrains::Annotations::RazorSectionAttribute*, "JetBrains.Annotations", "RazorSectionAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6e36628, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::JetBrains::Annotations::RazorSectionAttribute) == 0x10, "Size mismatch!");
