...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce65dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW formatParameterName);

  /// @brief Method get_FormatParameterName, addr 0x6ce65e4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FormatParameterName();

  /// @brief Method set_FormatParameterName, addr 0x6ce65ec, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::JetBrains::Annotations::StringFormatMethodAttribute) == 0x18, "Size mismatch!");
