...
// Write type traits
MARK_REF_T(::JetBrains::Annotations::ValueProviderAttribute*);
DEFINE_IL2CPP_CLASS(::JetBrains::Annotations::ValueProviderAttribute*, "JetBrains.Annotations", "ValueProviderAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce65f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_Name, addr 0x6ce65fc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method set_Name, addr 0x6ce6604, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::JetBrains::Annotations::ValueProviderAttribute) == 0x18, "Size mismatch!");
