...
DEFINE_IL2CPP_CLASS(::LIV::SDK::Unity::INVALIDATION_FLAGS, "LIV.SDK.Unity", "INVALIDATION_FLAGS");
// Dependencies
namespace LIV::SDK::Unity {
// Is value type: true
...
static_assert(sizeof(::LIV::SDK::Unity::INVALIDATION_FLAGS) == 0x4, "Size mismatch!");
