...
// Write type traits
MARK_REF_T(::LIV::SDK::Unity::LIV*);
MARK_REF_T(::LIV::SDK::Unity::LIV__WaitForUnityEndOfFrame_d__68*);
DEFINE_IL2CPP_CLASS(::LIV::SDK::Unity::LIV*, "LIV.SDK.Unity", "LIV");
DEFINE_IL2CPP_CLASS(::LIV::SDK::Unity::LIV__WaitForUnityEndOfFrame_d__68*, "LIV.SDK.Unity", "LIV/<WaitForUnityEndOfFrame>d__68");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x576aff4, size 0x108, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::LIV::SDK::Unity::LIV__WaitForUnityEndOfFrame_d__68* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x576b1c4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x576b1cc, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x576b204, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x576aff0, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x576a690, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::LIV::SDK::Unity::LIV__WaitForUnityEndOfFrame_d__68) == 0x28, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__excludeBehaviours, put = __cordl_internal_set__excludeBehaviours)) ::ArrayW<::StringW> _excludeBehaviours;

  /// @brief Field _excludeBehavioursCandidate, offset 0xc0, size 0x8
  __declspec(property(get = __cordl_internal_get__excludeBehavioursCandidate, put = __cordl_internal_set__excludeBehavioursCandidate)) ::ArrayW<::StringW> _excludeBehavioursCandidate;
  ...
  __declspec(property(get = get_excludeBehaviours, put = set_excludeBehaviours)) ::ArrayW<::StringW> excludeBehaviours;
  ...
  /// @brief Method Activate, addr 0x576a698, size 0x18, virtual false, abstract: false, final false
  inline void Activate();

  /// @brief Method CreateAssets, addr 0x576a9f0, size 0x6c, virtual false, abstract: false, final false
  inline void CreateAssets();

  /// @brief Method DestroyAssets, addr 0x576aac4, size 0x20, virtual false, abstract: false, final false
  inline void DestroyAssets();

  /// @brief Method Invalidate, addr 0x576a5bc, size 0x78, virtual false, abstract: false, final false
  inline void Invalidate();

  static inline ::LIV::SDK::Unity::LIV* New_ctor();

  /// @brief Method OnDisable, addr 0x576a634, size 0x8, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x576a554, size 0xc, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnSDKActivate, addr 0x576a6bc, size 0xb4, virtual false, abstract: false, final false
  inline void OnSDKActivate();

  /// @brief Method OnSDKDeactivate, addr 0x576a770, size 0xbc, virtual false, abstract: false, final false
  inline void OnSDKDeactivate();

  /// @brief Method OnSDKReadyChanged, addr 0x576a6b0, size 0xc, virtual false, abstract: false, final false
  inline void OnSDKReadyChanged(bool value);

  /// @brief Method StartRenderCoroutine, addr 0x576aa5c, size 0x44, virtual false, abstract: false, final false
  inline void StartRenderCoroutine();

  /// @brief Method StopRenderCoroutine, addr 0x576aaa0, size 0x24, virtual false, abstract: false, final false
  inline void StopRenderCoroutine();

  /// @brief Method SubmitSDKOutput, addr 0x576a82c, size 0x1c4, virtual false, abstract: false, final false
  inline void SubmitSDKOutput();

  /// @brief Method Update, addr 0x576a5a4, size 0x18, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateSDKReady, addr 0x576a560, size 0x44, virtual false, abstract: false, final false
  inline void UpdateSDKReady();

  /// @brief Method WaitForUnityEndOfFrame, addr 0x576a63c, size 0x54, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::StringW> const& __cordl_internal_get__excludeBehaviours() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get__excludeBehaviours();

  constexpr ::ArrayW<::StringW> const& __cordl_internal_get__excludeBehavioursCandidate() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get__excludeBehavioursCandidate();
  ...
  constexpr void __cordl_internal_set__excludeBehaviours(::ArrayW<::StringW> value);

  constexpr void __cordl_internal_set__excludeBehavioursCandidate(::ArrayW<::StringW> value);
  ...
  /// @brief Method .ctor, addr 0x576aeb8, size 0x138, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_HMDCamera, addr 0x576a14c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> get_HMDCamera();

  /// @brief Method get_MRCameraPrefab, addr 0x576a24c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> get_MRCameraPrefab();

  /// @brief Method get__isReady, addr 0x576a434, size 0x78, virtual false, abstract: false, final false
  inline bool get__isReady();

  /// @brief Method get_disableStandardAssets, addr 0x576a2dc, size 0x8, virtual false, abstract: false, final false
  inline bool get_disableStandardAssets();

  /// @brief Method get_excludeBehaviours, addr 0x576a2fc, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW> get_excludeBehaviours();

  /// @brief Method get_fixPostEffectsAlpha, addr 0x576a324, size 0x8, virtual false, abstract: false, final false
  inline bool get_fixPostEffectsAlpha();

  /// @brief Method get_isActive, addr 0x576a42c, size 0x8, virtual false, abstract: false, final false
  inline bool get_isActive();

  /// @brief Method get_isValid, addr 0x576a334, size 0xf8, virtual false, abstract: false, final false
  inline bool get_isValid();

  /// @brief Method get_render, addr 0x576a54c, size 0x8, virtual false, abstract: false, final false
  inline ::LIV::SDK::Unity::SDKRender* get_render();

  /// @brief Method get_spectatorLayerMask, addr 0x576a2ec, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::LayerMask get_spectatorLayerMask();

  /// @brief Method get_stage, addr 0x5769dfc, size 0x90, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_stage();

  /// @brief Method get_stageLocalToWorldMatrix, addr 0x5769f3c, size 0x100, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 get_stageLocalToWorldMatrix();

  /// @brief Method get_stageTransform, addr 0x576a13c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_stageTransform();

  /// @brief Method get_stageWorldToLocalMatrix, addr 0x576a03c, size 0x100, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 get_stageWorldToLocalMatrix();

  /// @brief Method get_trackedSpaceOrigin, addr 0x5769f34, size 0x4, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_trackedSpaceOrigin();

  /// @brief Method set_HMDCamera, addr 0x576a154, size 0xf8, virtual false, abstract: false, final false
  inline void set_HMDCamera(::UnityEngine::Camera* value);

  /// @brief Method set_MRCameraPrefab, addr 0x576a254, size 0x88, virtual false, abstract: false, final false
  inline void set_MRCameraPrefab(::UnityEngine::Camera* value);

  /// @brief Method set_disableStandardAssets, addr 0x576a2e4, size 0x8, virtual false, abstract: false, final false
  inline void set_disableStandardAssets(bool value);

  /// @brief Method set_excludeBehaviours, addr 0x576a304, size 0x20, virtual false, abstract: false, final false
  inline void set_excludeBehaviours(::ArrayW<::StringW> value);

  /// @brief Method set_fixPostEffectsAlpha, addr 0x576a32c, size 0x8, virtual false, abstract: false, final false
  inline void set_fixPostEffectsAlpha(bool value);

  /// @brief Method set_spectatorLayerMask, addr 0x576a2f4, size 0x8, virtual false, abstract: false, final false
  inline void set_spectatorLayerMask(::UnityEngine::LayerMask value);

  /// @brief Method set_stage, addr 0x5769e8c, size 0x94, virtual false, abstract: false, final false
  inline void set_stage(::UnityEngine::Transform* value);

  /// @brief Method set_stageTransform, addr 0x576a144, size 0x8, virtual false, abstract: false, final false
  inline void set_stageTransform(::UnityEngine::Transform* value);

  /// @brief Method set_trackedSpaceOrigin, addr 0x5769f38, size 0x4, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::StringW> ____excludeBehaviours;
  ...
  ::ArrayW<::StringW> ____excludeBehavioursCandidate;
...
static_assert(sizeof(::LIV::SDK::Unity::LIV) == 0xd8, "Size mismatch!");
