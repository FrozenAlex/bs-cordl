...
DEFINE_IL2CPP_CLASS(::LIV::SDK::Unity::RENDERING_PIPELINE, "LIV.SDK.Unity", "RENDERING_PIPELINE");
// Dependencies
namespace LIV::SDK::Unity {
// Is value type: true
...
static_assert(sizeof(::LIV::SDK::Unity::RENDERING_PIPELINE) == 0x4, "Size mismatch!");
