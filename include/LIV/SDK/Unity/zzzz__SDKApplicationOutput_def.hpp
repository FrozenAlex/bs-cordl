...
DEFINE_IL2CPP_CLASS(::LIV::SDK::Unity::SDKApplicationOutput, "LIV.SDK.Unity", "SDKApplicationOutput");
...
static_assert(sizeof(::LIV::SDK::Unity::SDKApplicationOutput) == 0x48, "Size mismatch!");
