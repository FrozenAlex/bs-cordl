...
// Write type traits
MARK_REF_T(::LIV::SDK::Unity::SDKBridge*);
MARK_GEN_VAL_T(::LIV::SDK::Unity::SDKBridge_SDKInjection_1);
DEFINE_IL2CPP_CLASS(::LIV::SDK::Unity::SDKBridge*, "LIV.SDK.Unity", "SDKBridge");
DEFINE_IL2CPP_GEN_CLASS(::LIV::SDK::Unity::SDKBridge_SDKInjection_1, "LIV.SDK.Unity", "SDKBridge/SDKInjection`1");
// Dependencies
namespace LIV::SDK::Unity {
// cpp template
template <typename T>
...
public:
  ...
  template <typename T> static inline void AddStructToFrame(::by_ref<T> mystruct, uint64_t tag);

  /// @brief Method AddStructToGlobalChannel, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> static inline int32_t AddStructToGlobalChannel(::by_ref<T> mystruct, int32_t channel, uint64_t tag);

  /// @brief Method AddStructToLocalChannel, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> static inline int32_t AddStructToLocalChannel(::by_ref<T> mystruct, int32_t channel, uint64_t tag);
  ...
  static inline bool GetResolution(::by_ref<::LIV::SDK::Unity::SDKResolution> sdkResolution);

  /// @brief Method GetStructFromGlobalChannel, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> static inline bool GetStructFromGlobalChannel(::by_ref<T> mystruct, int32_t channel, uint64_t tag);

  /// @brief Method GetStructFromLocalChannel, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> static inline bool GetStructFromLocalChannel(::by_ref<T> mystruct, int32_t channel, uint64_t tag);
  ...
  static inline bool UpdateInputFrame(::by_ref<::LIV::SDK::Unity::SDKInputFrame> setframe);
...
// Non member Declarations
static_assert(sizeof(::LIV::SDK::Unity::SDKBridge) == 0x10, "Size mismatch!");
