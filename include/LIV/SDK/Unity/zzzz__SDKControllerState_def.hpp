...
DEFINE_IL2CPP_CLASS(::LIV::SDK::Unity::SDKControllerState, "LIV.SDK.Unity", "SDKControllerState");
...
static_assert(sizeof(::LIV::SDK::Unity::SDKControllerState) == 0x8c, "Size mismatch!");
