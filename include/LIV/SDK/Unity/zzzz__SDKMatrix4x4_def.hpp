...
DEFINE_IL2CPP_CLASS(::LIV::SDK::Unity::SDKMatrix4x4, "LIV.SDK.Unity", "SDKMatrix4x4");
// Dependencies
namespace LIV::SDK::Unity {
// Is value type: true
...
public:
  // Declarations
  /// @brief Method Perspective, addr 0x5770660, size 0xac, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKMatrix4x4 Perspective(float_t vFov, float_t aspect, float_t zNear, float_t zFar);

  /// @brief Method Rotate, addr 0x5770850, size 0x94, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKMatrix4x4 Rotate(::LIV::SDK::Unity::SDKQuaternion value);

  /// @brief Method Scale, addr 0x57708e4, size 0x2c, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKMatrix4x4 Scale(::LIV::SDK::Unity::SDKVector3 value);

  /// @brief Method TRS, addr 0x5770910, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5770a10, size 0x4a0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Translate, addr 0x5770808, size 0x48, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKMatrix4x4 Translate(::LIV::SDK::Unity::SDKVector3 value);

  /// @brief Method get_identity, addr 0x5770634, size 0x2c, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKMatrix4x4 get_identity();

  /// @brief Method op_Implicit, addr 0x576f6b8, size 0x44, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKMatrix4x4 op_Implicit___LIV__SDK__Unity__SDKMatrix4x4(::UnityEngine::Matrix4x4 v);

  /// @brief Method op_Implicit, addr 0x576e338, size 0x44, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 op_Implicit___UnityEngine__Matrix4x4(::LIV::SDK::Unity::SDKMatrix4x4 v);

  /// @brief Method op_Multiply, addr 0x577070c, size 0xa4, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKMatrix4x4 op_Multiply(::LIV::SDK::Unity::SDKMatrix4x4 lhs, ::LIV::SDK::Unity::SDKMatrix4x4 rhs);

  /// @brief Method op_Multiply, addr 0x57707b0, size 0x58, virtual false, abstract: false, final false
...
static_assert(sizeof(::LIV::SDK::Unity::SDKMatrix4x4) == 0x40, "Size mismatch!");
