...
// Write type traits
MARK_REF_T(::LIV::SDK::Unity::SDKRender*);
DEFINE_IL2CPP_CLASS(::LIV::SDK::Unity::SDKRender*, "LIV.SDK.Unity", "SDKRender");
...
static_assert(sizeof(::LIV::SDK::Unity::SDKRender) == 0x340, "Size mismatch!");
