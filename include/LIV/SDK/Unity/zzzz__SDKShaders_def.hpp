...
// Write type traits
MARK_REF_T(::LIV::SDK::Unity::SDKShaders*);
DEFINE_IL2CPP_CLASS(::LIV::SDK::Unity::SDKShaders*, "LIV.SDK.Unity", "SDKShaders");
...
static_assert(sizeof(::LIV::SDK::Unity::SDKShaders) == 0x10, "Size mismatch!");
