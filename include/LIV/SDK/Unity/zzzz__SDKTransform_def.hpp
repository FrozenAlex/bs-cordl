...
DEFINE_IL2CPP_CLASS(::LIV::SDK::Unity::SDKTransform, "LIV.SDK.Unity", "SDKTransform");
...
public:
  // Declarations
  /// @brief Method ToString, addr 0x5771f34, size 0x114, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x577149c, size 0x14, virtual false, abstract: false, final false
...
static_assert(sizeof(::LIV::SDK::Unity::SDKTransform) == 0x28, "Size mismatch!");
