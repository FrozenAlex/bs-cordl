...
DEFINE_IL2CPP_CLASS(::LIV::SDK::Unity::SDKVector3, "LIV.SDK.Unity", "SDKVector3");
// Dependencies
namespace LIV::SDK::Unity {
// Is value type: true
...
public:
  // Declarations
  /// @brief Method ToString, addr 0x57701dc, size 0xd8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_forward, addr 0x5770168, size 0x10, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKVector3 get_forward();

  /// @brief Method get_one, addr 0x5770158, size 0x10, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKVector3 get_one();

  /// @brief Method get_right, addr 0x5770188, size 0x10, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKVector3 get_right();

  /// @brief Method get_up, addr 0x5770178, size 0x10, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKVector3 get_up();

  /// @brief Method get_zero, addr 0x5770148, size 0x10, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKVector3 get_zero();

  /// @brief Method op_Addition, addr 0x577019c, size 0x10, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKVector3 op_Addition(::LIV::SDK::Unity::SDKVector3 lhs, ::LIV::SDK::Unity::SDKVector3 rhs);

  /// @brief Method op_Implicit, addr 0x576f6b0, size 0x4, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKVector3 op_Implicit___LIV__SDK__Unity__SDKVector3(::UnityEngine::Vector3 v);

  /// @brief Method op_Implicit, addr 0x5770198, size 0x4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 op_Implicit___UnityEngine__Vector3(::LIV::SDK::Unity::SDKVector3 v);

  /// @brief Method op_Multiply, addr 0x57701bc, size 0x10, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKVector3 op_Multiply(::LIV::SDK::Unity::SDKVector3 lhs, ::LIV::SDK::Unity::SDKVector3 rhs);

  /// @brief Method op_Multiply, addr 0x57701cc, size 0x10, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKVector3 op_Multiply(::LIV::SDK::Unity::SDKVector3 lhs, float_t rhs);

  /// @brief Method op_Subtraction, addr 0x57701ac, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::LIV::SDK::Unity::SDKVector3) == 0xc, "Size mismatch!");
