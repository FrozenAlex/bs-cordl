...
DEFINE_IL2CPP_CLASS(::LIV::SDK::Unity::TEXTURE_COLOR_SPACE, "LIV.SDK.Unity", "TEXTURE_COLOR_SPACE");
// Dependencies
namespace LIV::SDK::Unity {
// Is value type: true
...
static_assert(sizeof(::LIV::SDK::Unity::TEXTURE_COLOR_SPACE) == 0x4, "Size mismatch!");
