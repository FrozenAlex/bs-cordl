...
// Write type traits
MARK_REF_T(::Libraries::HM::HMLib::VR::HapticPresetSO*);
DEFINE_IL2CPP_CLASS(::Libraries::HM::HMLib::VR::HapticPresetSO*, "Libraries.HM.HMLib.VR", "HapticPresetSO");
...
static_assert(sizeof(::Libraries::HM::HMLib::VR::HapticPresetSO) == 0x58, "Size mismatch!");
