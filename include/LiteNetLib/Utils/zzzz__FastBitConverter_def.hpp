...
// Write type traits
MARK_REF_T(::LiteNetLib::Utils::FastBitConverter*);
...
DEFINE_IL2CPP_CLASS(::LiteNetLib::Utils::FastBitConverter*, "LiteNetLib.Utils", "FastBitConverter");
DEFINE_IL2CPP_CLASS(::LiteNetLib::Utils::FastBitConverter_ConverterHelperDouble, "LiteNetLib.Utils", "FastBitConverter/ConverterHelperDouble");
DEFINE_IL2CPP_CLASS(::LiteNetLib::Utils::FastBitConverter_ConverterHelperFloat, "LiteNetLib.Utils", "FastBitConverter/ConverterHelperFloat");
// Dependencies
namespace LiteNetLib::Utils {
// Is value type: true
...
static_assert(sizeof(::LiteNetLib::Utils::FastBitConverter_ConverterHelperDouble) == 0x8, "Size mismatch!");
...
// Non member Declarations
static_assert(sizeof(::LiteNetLib::Utils::FastBitConverter_ConverterHelperFloat) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetBytes, addr 0x58aa18c, size 0x8, virtual false, abstract: false, final false
  static inline void GetBytes(::ArrayW<uint8_t> bytes, int32_t startIndex, double_t value);

  /// @brief Method GetBytes, addr 0x58aa194, size 0x8, virtual false, abstract: false, final false
  static inline void GetBytes(::ArrayW<uint8_t> bytes, int32_t startIndex, float_t value);

  /// @brief Method GetBytes, addr 0x58aa19c, size 0x4, virtual false, abstract: false, final false
  static inline void GetBytes(::ArrayW<uint8_t> bytes, int32_t startIndex, int16_t value);

  /// @brief Method GetBytes, addr 0x58a4c38, size 0x4, virtual false, abstract: false, final false
  static inline void GetBytes(::ArrayW<uint8_t> bytes, int32_t startIndex, int32_t value);

  /// @brief Method GetBytes, addr 0x58a0ef8, size 0x4, virtual false, abstract: false, final false
  static inline void GetBytes(::ArrayW<uint8_t> bytes, int32_t startIndex, int64_t value);

  /// @brief Method GetBytes, addr 0x58a47f4, size 0x4, virtual false, abstract: false, final false
  static inline void GetBytes(::ArrayW<uint8_t> bytes, int32_t startIndex, uint16_t value);

  /// @brief Method GetBytes, addr 0x58aa1a0, size 0x4, virtual false, abstract: false, final false
  static inline void GetBytes(::ArrayW<uint8_t> bytes, int32_t startIndex, uint32_t value);

  /// @brief Method GetBytes, addr 0x58aa1a4, size 0x4, virtual false, abstract: false, final false
  static inline void GetBytes(::ArrayW<uint8_t> bytes, int32_t startIndex, uint64_t value);

  /// @brief Method WriteLittleEndian, addr 0x58aa144, size 0x48, virtual false, abstract: false, final false
  static inline void WriteLittleEndian(::ArrayW<uint8_t> buffer, int32_t offset, int16_t data);

  /// @brief Method WriteLittleEndian, addr 0x58aa0c4, size 0x80, virtual false, abstract: false, final false
  static inline void WriteLittleEndian(::ArrayW<uint8_t> buffer, int32_t offset, int32_t data);

  /// @brief Method WriteLittleEndian, addr 0x58a9fd4, size 0xf0, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::LiteNetLib::Utils::FastBitConverter) == 0x10, "Size mismatch!");
