...
// Write type traits
MARK_GEN_REF_T_PTR(::LiteNetLib::Utils::INetImmutableSerializable_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::LiteNetLib::Utils::INetImmutableSerializable_1, "LiteNetLib.Utils", "INetImmutableSerializable`1");
// Dependencies
namespace LiteNetLib::Utils {
// cpp template
template <typename T>
