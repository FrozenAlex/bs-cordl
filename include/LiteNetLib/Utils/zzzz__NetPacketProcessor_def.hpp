...
MARK_GEN_REF_T_PTR(::LiteNetLib::Utils::NetPacketProcessor_HashCache_1);
MARK_REF_T(::LiteNetLib::Utils::NetPacketProcessor_SubscribeDelegate*);
MARK_GEN_REF_T_PTR(::LiteNetLib::Utils::NetPacketProcessor___c__DisplayClass25_0_1);
MARK_GEN_REF_T_PTR(::LiteNetLib::Utils::NetPacketProcessor___c__DisplayClass26_0_2);
MARK_GEN_REF_T_PTR(::LiteNetLib::Utils::NetPacketProcessor___c__DisplayClass27_0_1);
MARK_GEN_REF_T_PTR(::LiteNetLib::Utils::NetPacketProcessor___c__DisplayClass28_0_2);
MARK_GEN_REF_T_PTR(::LiteNetLib::Utils::NetPacketProcessor___c__DisplayClass29_0_2);
MARK_GEN_REF_T_PTR(::LiteNetLib::Utils::NetPacketProcessor___c__DisplayClass30_0_1);
MARK_GEN_REF_T_PTR(::LiteNetLib::Utils::NetPacketProcessor___c__DisplayClass31_0_2);
MARK_GEN_REF_T_PTR(::LiteNetLib::Utils::NetPacketProcessor___c__DisplayClass32_0_1);
DEFINE_IL2CPP_CLASS(::LiteNetLib::Utils::NetPacketProcessor*, "LiteNetLib.Utils", "NetPacketProcessor");
DEFINE_IL2CPP_GEN_CLASS_PTR(::LiteNetLib::Utils::NetPacketProcessor_HashCache_1, "LiteNetLib.Utils", "NetPacketProcessor/HashCache`1");
DEFINE_IL2CPP_CLASS(::LiteNetLib::Utils::NetPacketProcessor_SubscribeDelegate*, "LiteNetLib.Utils", "NetPacketProcessor/SubscribeDelegate");
DEFINE_IL2CPP_GEN_CLASS_PTR(::LiteNetLib::Utils::NetPacketProcessor___c__DisplayClass25_0_1, "LiteNetLib.Utils", "NetPacketProcessor/<>c__DisplayClass25_0`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::LiteNetLib::Utils::NetPacketProcessor___c__DisplayClass26_0_2, "LiteNetLib.Utils", "NetPacketProcessor/<>c__DisplayClass26_0`2");
DEFINE_IL2CPP_GEN_CLASS_PTR(::LiteNetLib::Utils::NetPacketProcessor___c__DisplayClass27_0_1, "LiteNetLib.Utils", "NetPacketProcessor/<>c__DisplayClass27_0`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::LiteNetLib::Utils::NetPacketProcessor___c__DisplayClass28_0_2, "LiteNetLib.Utils", "NetPacketProcessor/<>c__DisplayClass28_0`2");
DEFINE_IL2CPP_GEN_CLASS_PTR(::LiteNetLib::Utils::NetPacketProcessor___c__DisplayClass29_0_2, "LiteNetLib.Utils", "NetPacketProcessor/<>c__DisplayClass29_0`2");
DEFINE_IL2CPP_GEN_CLASS_PTR(::LiteNetLib::Utils::NetPacketProcessor___c__DisplayClass30_0_1, "LiteNetLib.Utils", "NetPacketProcessor/<>c__DisplayClass30_0`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::LiteNetLib::Utils::NetPacketProcessor___c__DisplayClass31_0_2, "LiteNetLib.Utils", "NetPacketProcessor/<>c__DisplayClass31_0`2");
DEFINE_IL2CPP_GEN_CLASS_PTR(::LiteNetLib::Utils::NetPacketProcessor___c__DisplayClass32_0_1, "LiteNetLib.Utils", "NetPacketProcessor/<>c__DisplayClass32_0`1");
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x5768484, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x57684ac, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x5768470, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5768328, size 0x148, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetCallbackFromData, addr 0x57680e8, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadAllPackets, addr 0x576822c, size 0x54, virtual false, abstract: false, final false
  inline void ReadAllPackets(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method ReadAllPackets, addr 0x5768288, size 0x58, virtual false, abstract: false, final false
  inline void ReadAllPackets(::LiteNetLib::Utils::NetDataReader* reader, ::System::Object* userData);

  /// @brief Method ReadPacket, addr 0x5768280, size 0x8, virtual false, abstract: false, final false
  inline void ReadPacket(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method ReadPacket, addr 0x57682e0, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5767e34, size 0xfc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5767f38, size 0x108, virtual false, abstract: false, final false
...
static_assert(sizeof(::LiteNetLib::Utils::NetPacketProcessor) == 0x28, "Size mismatch!");
