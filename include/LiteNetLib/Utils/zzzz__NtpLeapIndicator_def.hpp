...
DEFINE_IL2CPP_CLASS(::LiteNetLib::Utils::NtpLeapIndicator, "LiteNetLib.Utils", "NtpLeapIndicator");
// Dependencies
namespace LiteNetLib::Utils {
// Is value type: true
...
static_assert(sizeof(::LiteNetLib::Utils::NtpLeapIndicator) == 0x4, "Size mismatch!");
