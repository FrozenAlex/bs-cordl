...
DEFINE_IL2CPP_CLASS(::LiteNetLib::ConnectRequestResult, "LiteNetLib", "ConnectRequestResult");
// Dependencies
namespace LiteNetLib {
// Is value type: true
...
static_assert(sizeof(::LiteNetLib::ConnectRequestResult) == 0x4, "Size mismatch!");
