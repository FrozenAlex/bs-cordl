...
public:
  ...
  /// @brief Method .ctor, addr 0x589dfdc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x589dfe4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x589e008, size 0x24, virtual false, abstract: false, final false
