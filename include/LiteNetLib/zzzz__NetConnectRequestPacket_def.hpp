...
// Write type traits
MARK_REF_T(::LiteNetLib::NetConnectRequestPacket*);
DEFINE_IL2CPP_CLASS(::LiteNetLib::NetConnectRequestPacket*, "LiteNetLib", "NetConnectRequestPacket");
...
public:
  ...
  /// @brief Method FromData, addr 0x575d07c, size 0x15c, virtual false, abstract: false, final false
  static inline ::LiteNetLib::NetConnectRequestPacket* FromData(::LiteNetLib::NetPacket* packet);

  /// @brief Method GetProtocolId, addr 0x575cfd4, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t GetProtocolId(::LiteNetLib::NetPacket* packet);

  /// @brief Method Make, addr 0x5760150, size 0x148, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_TargetAddress() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_TargetAddress();
  ...
  /// @brief Method .ctor, addr 0x5760130, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<uint8_t> ___TargetAddress;
...
static_assert(sizeof(::LiteNetLib::NetConnectRequestPacket) == 0x30, "Size mismatch!");
