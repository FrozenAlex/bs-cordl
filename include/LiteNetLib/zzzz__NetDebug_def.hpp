...
// Write type traits
MARK_REF_T(::LiteNetLib::NetDebug*);
DEFINE_IL2CPP_CLASS(::LiteNetLib::NetDebug*, "LiteNetLib", "NetDebug");
...
public:
  ...
  /// @brief Method Write, addr 0x5759478, size 0x70, virtual false, abstract: false, final false
  static inline void Write(::LiteNetLib::NetLogLevel level, ::StringW str, ::ArrayW<::System::Object*> args);

  /// @brief Method Write, addr 0x575940c, size 0x6c, virtual false, abstract: false, final false
  static inline void Write(::StringW str, ::ArrayW<::System::Object*> args);

  /// @brief Method WriteError, addr 0x5755668, size 0x6c, virtual false, abstract: false, final false
  static inline void WriteError(::StringW str, ::ArrayW<::System::Object*> args);

  /// @brief Method WriteForce, addr 0x5759554, size 0x70, virtual false, abstract: false, final false
  static inline void WriteForce(::LiteNetLib::NetLogLevel level, ::StringW str, ::ArrayW<::System::Object*> args);

  /// @brief Method WriteForce, addr 0x57594e8, size 0x6c, virtual false, abstract: false, final false
  static inline void WriteForce(::StringW str, ::ArrayW<::System::Object*> args);

  /// @brief Method WriteLogic, addr 0x57591f4, size 0x218, virtual false, abstract: false, final false
...
static_assert(sizeof(::LiteNetLib::NetDebug) == 0x10, "Size mismatch!");
