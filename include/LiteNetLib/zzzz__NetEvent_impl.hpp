...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::LiteNetLib::NetEvent::*)(::LiteNetLib::NetManager*)>(&::LiteNetLib::NetEvent::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5759a80;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::LiteNetLib::NetEvent*>(), { ".ctor", {}, { ::i2c::type_of<::LiteNetLib::NetManager*>() } })));
...
constexpr void LiteNetLib::NetEvent::__cordl_internal_set_ConnectionRequest(::LiteNetLib::ConnectionRequest* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->___ConnectionRequest = value;
}
...
inline ::LiteNetLib::NetEvent* LiteNetLib::NetEvent::New_ctor(::LiteNetLib::NetManager* manager) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::LiteNetLib::NetEvent*>(manager));
}
// Ctor Parameters []
