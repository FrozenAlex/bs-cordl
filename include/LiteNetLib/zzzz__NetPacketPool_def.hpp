...
public:
  ...
  /// @brief Method GetPacket, addr 0x589f620, size 0x174, virtual false, abstract: false, final false
  inline ::LiteNetLib::NetPacket* GetPacket(int32_t size);

  /// @brief Method GetWithData, addr 0x58a31bc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWithProperty, addr 0x58a1990, size 0x8c, virtual false, abstract: false, final false
  inline ::LiteNetLib::NetPacket* GetWithProperty(::LiteNetLib::PacketProperty property);

  /// @brief Method GetWithProperty, addr 0x58a0e34, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method Recycle, addr 0x589e178, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x589eecc, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();
