...
// Write type traits
MARK_REF_T(::LiteNetLib::NetPacket*);
DEFINE_IL2CPP_CLASS(::LiteNetLib::NetPacket*, "LiteNetLib", "NetPacket");
...
public:
  ...
  /// @brief Method FromBytes, addr 0x575ce88, size 0x120, virtual false, abstract: false, final false
  inline bool FromBytes(::ArrayW<uint8_t> data, int32_t start, int32_t packetSize);

  /// @brief Method GetHeaderSize, addr 0x5759724, size 0x68, virtual false, abstract: false, final false
  inline int32_t GetHeaderSize();

  /// @brief Method GetHeaderSize, addr 0x575ea7c, size 0x2c, virtual false, abstract: false, final false
  static inline int32_t GetHeaderSize(::LiteNetLib::PacketProperty property);

  /// @brief Method MarkFragmented, addr 0x575fe84, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x575ffc4, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::LiteNetLib::PacketProperty property, int32_t size);

  /// @brief Method .ctor, addr 0x575ff60, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(int32_t size);

  static inline int32_t getStaticF_LastProperty();

  /// @brief Method get_ChannelId, addr 0x575feb4, size 0x2c, virtual false, abstract: false, final false
  inline uint8_t get_ChannelId();

  /// @brief Method get_ConnectionNumber, addr 0x575fe0c, size 0x2c, virtual false, abstract: false, final false
  inline uint8_t get_ConnectionNumber();

  /// @brief Method get_FragmentId, addr 0x575ff0c, size 0xc, virtual false, abstract: false, final false
  inline uint16_t get_FragmentId();

  /// @brief Method get_FragmentPart, addr 0x575ff28, size 0xc, virtual false, abstract: false, final false
  inline uint16_t get_FragmentPart();

  /// @brief Method get_FragmentsTotal, addr 0x575ff44, size 0xc, virtual false, abstract: false, final false
  inline uint16_t get_FragmentsTotal();

  /// @brief Method get_IsFragmented, addr 0x575fe58, size 0x2c, virtual false, abstract: false, final false
  inline bool get_IsFragmented();

  /// @brief Method get_Property, addr 0x575cfa8, size 0x2c, virtual false, abstract: false, final false
  inline ::LiteNetLib::PacketProperty get_Property();

  /// @brief Method get_Sequence, addr 0x575fe38, size 0xc, virtual false, abstract: false, final false
  inline uint16_t get_Sequence();

  static inline void setStaticF_LastProperty(int32_t value);

  /// @brief Method set_ChannelId, addr 0x575fee0, size 0x2c, virtual false, abstract: false, final false
  inline void set_ChannelId(uint8_t value);

  /// @brief Method set_ConnectionNumber, addr 0x575c524, size 0x34, virtual false, abstract: false, final false
  inline void set_ConnectionNumber(uint8_t value);

  /// @brief Method set_FragmentId, addr 0x575ff18, size 0x10, virtual false, abstract: false, final false
  inline void set_FragmentId(uint16_t value);

  /// @brief Method set_FragmentPart, addr 0x575ff34, size 0x10, virtual false, abstract: false, final false
  inline void set_FragmentPart(uint16_t value);

  /// @brief Method set_FragmentsTotal, addr 0x575ff50, size 0x10, virtual false, abstract: false, final false
  inline void set_FragmentsTotal(uint16_t value);

  /// @brief Method set_Property, addr 0x575eaa8, size 0x34, virtual false, abstract: false, final false
  inline void set_Property(::LiteNetLib::PacketProperty value);

  /// @brief Method set_Sequence, addr 0x575fe44, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::LiteNetLib::NetPacket) == 0x28, "Size mismatch!");
