...
// Write type traits
MARK_REF_T(::LiteNetLib::NetStatistics*);
DEFINE_IL2CPP_CLASS(::LiteNetLib::NetStatistics*, "LiteNetLib", "NetStatistics");
...
public:
  ...
  /// @brief Method AddBytesReceived, addr 0x58a1808, size 0x20, virtual false, abstract: false, final false
  inline void AddBytesReceived(int64_t bytesReceived);

  /// @brief Method AddBytesSent, addr 0x589f7e0, size 0x20, virtual false, abstract: false, final false
  inline void AddBytesSent(int64_t bytesSent);

  /// @brief Method AddPacketLoss, addr 0x58a76e4, size 0x20, virtual false, abstract: false, final false
  inline void AddPacketLoss(int64_t packetLoss);

  /// @brief Method IncrementPacketLoss, addr 0x58a76c8, size 0x1c, virtual false, abstract: false, final false
  inline void IncrementPacketLoss();

  /// @brief Method IncrementPacketsReceived, addr 0x58a17ec, size 0x1c, virtual false, abstract: false, final false
  inline void IncrementPacketsReceived();

  /// @brief Method IncrementPacketsSent, addr 0x589f7c4, size 0x1c, virtual false, abstract: false, final false
  inline void IncrementPacketsSent();

  static inline ::LiteNetLib::NetStatistics* New_ctor();

  /// @brief Method Reset, addr 0x58a7668, size 0x60, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method ToString, addr 0x58a7704, size 0x2a8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x589ef58, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BytesReceived, addr 0x58a75dc, size 0x1c, virtual false, abstract: false, final false
  inline int64_t get_BytesReceived();

  /// @brief Method get_BytesSent, addr 0x58a75c0, size 0x1c, virtual false, abstract: false, final false
  inline int64_t get_BytesSent();

  /// @brief Method get_PacketLoss, addr 0x58a75f8, size 0x1c, virtual false, abstract: false, final false
  inline int64_t get_PacketLoss();

  /// @brief Method get_PacketLossPercent, addr 0x58a7614, size 0x54, virtual false, abstract: false, final false
  inline int64_t get_PacketLossPercent();

  /// @brief Method get_PacketsReceived, addr 0x58a75a4, size 0x1c, virtual false, abstract: false, final false
  inline int64_t get_PacketsReceived();

  /// @brief Method get_PacketsSent, addr 0x58a7588, size 0x1c, virtual false, abstract: false, final false
...
static_assert(sizeof(::LiteNetLib::NetStatistics) == 0x38, "Size mismatch!");
