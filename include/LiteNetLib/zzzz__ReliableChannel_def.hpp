...
// Write type traits
MARK_REF_T(::LiteNetLib::ReliableChannel*);
MARK_VAL_T(::LiteNetLib::ReliableChannel_PendingPacket);
DEFINE_IL2CPP_CLASS(::LiteNetLib::ReliableChannel*, "LiteNetLib", "ReliableChannel");
DEFINE_IL2CPP_CLASS(::LiteNetLib::ReliableChannel_PendingPacket, "LiteNetLib", "ReliableChannel/PendingPacket");
// Dependencies
namespace LiteNetLib {
// Is value type: true
...
public:
  // Declarations
  /// @brief Method Clear, addr 0x58a8a88, size 0x40, virtual false, abstract: false, final false
  inline bool Clear(::LiteNetLib::NetPeer* peer);

  /// @brief Method Init, addr 0x58a8f0c, size 0xc, virtual false, abstract: false, final false
  inline void Init(::LiteNetLib::NetPacket* packet);

  /// @brief Method ToString, addr 0x58a9430, size 0x78, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TrySend, addr 0x58a8f18, size 0x78, virtual false, abstract: false, final false
...
static_assert(sizeof(::LiteNetLib::ReliableChannel_PendingPacket) == 0x18, "Size mismatch!");

} // namespace LiteNetLib
// Dependencies LiteNetLib.BaseChannel, LiteNetLib.DeliveryMethod, LiteNetLib.NetPacket, LiteNetLib.ReliableChannel::PendingPacket
namespace LiteNetLib {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__earlyReceived, put = __cordl_internal_set__earlyReceived)) ::ArrayW<bool> _earlyReceived;
  ...
  __declspec(property(get = __cordl_internal_get__pendingPackets, put = __cordl_internal_set__pendingPackets)) ::ArrayW<::LiteNetLib::ReliableChannel_PendingPacket> _pendingPackets;

  /// @brief Field _receivedPackets, offset 0x38, size 0x8
  __declspec(property(get = __cordl_internal_get__receivedPackets, put = __cordl_internal_set__receivedPackets)) ::ArrayW<::LiteNetLib::NetPacket*> _receivedPackets;
  ...
  /// @brief Method ProcessAck, addr 0x58a8764, size 0x324, virtual false, abstract: false, final false
  inline void ProcessAck(::LiteNetLib::NetPacket* packet);

  /// @brief Method ProcessPacket, addr 0x58a8f90, size 0x4a0, virtual true, abstract: false, final false
  inline bool ProcessPacket(::LiteNetLib::NetPacket* packet);

  /// @brief Method SendNextPackets, addr 0x58a8ac8, size 0x444, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<bool> const& __cordl_internal_get__earlyReceived() const;

  constexpr ::ArrayW<bool>& __cordl_internal_get__earlyReceived();
  ...
  constexpr ::ArrayW<::LiteNetLib::ReliableChannel_PendingPacket> const& __cordl_internal_get__pendingPackets() const;

  constexpr ::ArrayW<::LiteNetLib::ReliableChannel_PendingPacket>& __cordl_internal_get__pendingPackets();

  constexpr ::ArrayW<::LiteNetLib::NetPacket*> const& __cordl_internal_get__receivedPackets() const;

  constexpr ::ArrayW<::LiteNetLib::NetPacket*>& __cordl_internal_get__receivedPackets();
  ...
  constexpr void __cordl_internal_set__earlyReceived(::ArrayW<bool> value);
  ...
  constexpr void __cordl_internal_set__pendingPackets(::ArrayW<::LiteNetLib::ReliableChannel_PendingPacket> value);

  constexpr void __cordl_internal_set__receivedPackets(::ArrayW<::LiteNetLib::NetPacket*> value);
  ...
  /// @brief Method .ctor, addr 0x58a5120, size 0x198, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::LiteNetLib::ReliableChannel_PendingPacket> ____pendingPackets;

  /// @brief Field _receivedPackets, offset: 0x38, size: 0x8, def value: None
  ::ArrayW<::LiteNetLib::NetPacket*> ____receivedPackets;

  /// @brief Field _earlyReceived, offset: 0x40, size: 0x8, def value: None
  ::ArrayW<bool> ____earlyReceived;
...
static_assert(sizeof(::LiteNetLib::ReliableChannel) == 0x68, "Size mismatch!");
