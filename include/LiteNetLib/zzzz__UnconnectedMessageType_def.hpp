...
DEFINE_IL2CPP_CLASS(::LiteNetLib::UnconnectedMessageType, "LiteNetLib", "UnconnectedMessageType");
// Dependencies
namespace LiteNetLib {
// Is value type: true
...
static_assert(sizeof(::LiteNetLib::UnconnectedMessageType) == 0x4, "Size mismatch!");
