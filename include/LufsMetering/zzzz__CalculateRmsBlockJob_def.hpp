...
public:
  ...
  /// @brief Method Create, addr 0x5837bf4, size 0xc, virtual false, abstract: false, final false
  static inline ::LufsMetering::CalculateRmsBlockJob Create(::Unity::Collections::NativeArray_1<float_t> inputData);

  /// @brief Method Execute, addr 0x5837c00, size 0xc8, virtual true, abstract: false, final true
  inline void Execute();
...
static_assert(sizeof(::LufsMetering::CalculateRmsBlockJob) == 0x18, "Size mismatch!");
