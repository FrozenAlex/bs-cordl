...
public:
  ...
  /// @brief Method Execute, addr 0x5837960, size 0x294, virtual true, abstract: false, final true
  inline void Execute(int32_t i);

  /// @brief Method .ctor, addr 0x583794c, size 0x14, virtual false, abstract: false, final false
