...
DEFINE_IL2CPP_CLASS(::LufsMetering::FilterCoefficients, "LufsMetering", "FilterCoefficients");
// Dependencies
namespace LufsMetering {
// Is value type: true
...
static_assert(sizeof(::LufsMetering::FilterCoefficients) == 0x18, "Size mismatch!");
