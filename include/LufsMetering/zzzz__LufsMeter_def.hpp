...
public:
  ...
  /// @brief Method <IntegratedLoudness>b__5_0, addr 0x3265ea8, size 0x8, virtual false, abstract: false, final false
  inline float_t _IntegratedLoudness_b__5_0(float_t g, float_t z);

  /// @brief Method .ctor, addr 0x3265ea4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AnalyzeClipLoudness, addr 0x3264ed4, size 0xc4, virtual false, abstract: false, final false
  inline ::LufsMetering::LoudnessData AnalyzeClipLoudness(::UnityEngine::AudioClip* clip);

  /// @brief Method IntegratedLoudness, addr 0x3264f98, size 0xe10, virtual false, abstract: false, final false
  inline ::LufsMetering::LoudnessData IntegratedLoudness(::ArrayW<float_t> interleavedData, int32_t numChannels, int32_t rate);

  /// @brief Method MomentaryLoudness, addr 0x3262bb8, size 0x780, virtual false, abstract: false, final false
  ...
  /// @brief Method SwapData, addr 0x3265da8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32634f8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
