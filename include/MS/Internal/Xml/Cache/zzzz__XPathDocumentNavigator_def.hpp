...
public:
  ...
  /// @brief Method Clone, addr 0x613a23c, size 0x78, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathNavigator* Clone();

  /// @brief Method GetPositionHashCode, addr 0x613ab8c, size 0xc, virtual false, abstract: false, final false
  inline int32_t GetPositionHashCode();

  /// @brief Method HasLineInfo, addr 0x613a99c, size 0x44, virtual true, abstract: false, final true
  inline bool HasLineInfo();

  /// @brief Method IsSamePosition, addr 0x613a8e0, size 0xac, virtual true, abstract: false, final false
  inline bool IsSamePosition(::System::Xml::XPath::XPathNavigator* other);

  /// @brief Method MoveToFirstNamespace, addr 0x613a450, size 0xe8, virtual true, abstract: false, final false
  inline bool MoveToFirstNamespace(::System::Xml::XPath::XPathNamespaceScope namespaceScope);

  /// @brief Method MoveToNextNamespace, addr 0x613a71c, size 0x11c, virtual true, abstract: false, final false
  inline bool MoveToNextNamespace(::System::Xml::XPath::XPathNamespaceScope scope);

  /// @brief Method MoveToParent, addr 0x613a858, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6139df0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_LineNumber, addr 0x613a9e0, size 0x8c, virtual true, abstract: false, final true
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x613aa90, size 0xb4, virtual true, abstract: false, final true
  inline int32_t get_LinePosition();

  /// @brief Method get_LocalName, addr 0x613a2f8, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_NameTable, addr 0x613a3f4, size 0x44, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_NamespaceURI, addr 0x613a34c, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW get_NamespaceURI();

  /// @brief Method get_NodeType, addr 0x613a2b4, size 0x38, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathNodeType get_NodeType();

  /// @brief Method get_Prefix, addr 0x613a3a0, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_UnderlyingObject, addr 0x613a98c, size 0x10, virtual true, abstract: false, final false
  inline ::System::Object* get_UnderlyingObject();

  /// @brief Method get_Value, addr 0x6139e6c, size 0x1ec, virtual true, abstract: false, final false
