...
public:
  // Declarations
  /// @brief Method GetInScopeNamespaces, addr 0x613a5a8, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLocalNamespaces, addr 0x613a538, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLocation, addr 0x613ac74, size 0x38, virtual false, abstract: false, final false
  static inline int32_t GetLocation(::ArrayW<::MS::Internal::Xml::Cache::XPathNode> pageNode, int32_t idxNode);

  /// @brief Method GetNonDescendant, addr 0x613a058, size 0x7c, virtual false, abstract: false, final false
  static inline bool GetNonDescendant(::by_ref<::ArrayW<::MS::Internal::Xml::Cache::XPathNode>> pageNode, ::by_ref<int32_t> idxNode);

  /// @brief Method GetParent, addr 0x613a884, size 0x5c, virtual false, abstract: false, final false
  static inline bool GetParent(::by_ref<::ArrayW<::MS::Internal::Xml::Cache::XPathNode>> pageNode, ::by_ref<int32_t> idxNode);

  /// @brief Method GetTextFollowing, addr 0x613a0d4, size 0x168, virtual false, abstract: false, final false
