...
public:
  ...
  /// @brief Method OnCallbackWithContext, addr 0x58f8848, size 0x78, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method IsActionTriggered, addr 0x58f866c, size 0x4c, virtual false, abstract: false, final false
  static inline bool IsActionTriggered(::Meta::XR::BuildingBlocks::ControllerButtonsMapper_ButtonClickAction buttonClickAction);

  /// @brief Method IsLegacyInputActionTriggered, addr 0x58f86b8, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsNewInputSystemActionTriggered, addr 0x58f87b0, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x58f82dc, size 0x258, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x58f8084, size 0x258, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Update, addr 0x58f8534, size 0x138, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x58f8844, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ButtonClickActions, addr 0x58f8074, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ButtonClickActions, addr 0x58f807c, size 0x8, virtual false, abstract: false, final false
