...
// Write type traits
MARK_REF_T(::Meta::XR::BuildingBlocks::PassthroughProjectionSurfaceBuildingBlock*);
DEFINE_IL2CPP_CLASS(::Meta::XR::BuildingBlocks::PassthroughProjectionSurfaceBuildingBlock*, "Meta.XR.BuildingBlocks", "PassthroughProjectionSurfaceBuildingBlock");
...
static_assert(sizeof(::Meta::XR::BuildingBlocks::PassthroughProjectionSurfaceBuildingBlock) == 0x28, "Size mismatch!");
