...
// Write type traits
MARK_REF_T(::Meta::XR::BuildingBlocks::RoomMeshEvent*);
DEFINE_IL2CPP_CLASS(::Meta::XR::BuildingBlocks::RoomMeshEvent*, "Meta.XR.BuildingBlocks", "RoomMeshEvent");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5a3127c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Meta::XR::BuildingBlocks::RoomMeshEvent) == 0x28, "Size mismatch!");
