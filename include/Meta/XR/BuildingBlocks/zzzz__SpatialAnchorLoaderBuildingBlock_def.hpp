...
public:
  ...
  /// @brief Method Awake, addr 0x58f9f38, size 0x5c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method LoadAnchorsFromDefaultLocalStorage, addr 0x58fa11c, size 0x210, virtual true, abstract: false, final false
  inline void LoadAnchorsFromDefaultLocalStorage();

  /// @brief Method LoadAndInstantiateAnchors, addr 0x58fa0ec, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58fa528, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Meta::XR::BuildingBlocks::SpatialAnchorLoaderBuildingBlock) == 0x30, "Size mismatch!");
