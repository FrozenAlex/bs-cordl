...
// Write type traits
MARK_REF_T(::Meta::XR::BuildingBlocks::SpatialAnchorLocalStorageManagerBuildingBlock*);
DEFINE_IL2CPP_CLASS(::Meta::XR::BuildingBlocks::SpatialAnchorLocalStorageManagerBuildingBlock*, "Meta.XR.BuildingBlocks", "SpatialAnchorLocalStorageManagerBuildingBlock");
...
static_assert(sizeof(::Meta::XR::BuildingBlocks::SpatialAnchorLocalStorageManagerBuildingBlock) == 0x28, "Size mismatch!");
