...
// Write type traits
MARK_REF_T(::Meta::XR::BuildingBlocks::VariantCheckpoint*);
DEFINE_IL2CPP_CLASS(::Meta::XR::BuildingBlocks::VariantCheckpoint*, "Meta.XR.BuildingBlocks", "VariantCheckpoint");
...
static_assert(sizeof(::Meta::XR::BuildingBlocks::VariantCheckpoint) == 0x20, "Size mismatch!");
