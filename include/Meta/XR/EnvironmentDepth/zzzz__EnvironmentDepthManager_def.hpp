...
// Write type traits
MARK_REF_T(::Meta::XR::EnvironmentDepth::EnvironmentDepthManager*);
MARK_REF_T(::Meta::XR::EnvironmentDepth::EnvironmentDepthManager_Mask*);
DEFINE_IL2CPP_CLASS(::Meta::XR::EnvironmentDepth::EnvironmentDepthManager*, "Meta.XR.EnvironmentDepth", "EnvironmentDepthManager");
DEFINE_IL2CPP_CLASS(::Meta::XR::EnvironmentDepth::EnvironmentDepthManager_Mask*, "Meta.XR.EnvironmentDepth", "EnvironmentDepthManager/Mask");
...
public:
  ...
  /// @brief Method ApplyMask, addr 0x59027b8, size 0x928, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x5901b8c, size 0x8c, virtual false, abstract: false, final false
  inline void Dispose();
  ...
  constexpr ::ArrayW<::UnityEngine::Matrix4x4> const& __cordl_internal_get__mvpMatrices() const;

  constexpr ::ArrayW<::UnityEngine::Matrix4x4>& __cordl_internal_get__mvpMatrices();
  ...
  /// @brief Method .ctor, addr 0x5902574, size 0x244, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::UnityEngine::Matrix4x4> ____mvpMatrices;
...
static_assert(sizeof(::Meta::XR::EnvironmentDepth::EnvironmentDepthManager_Mask) == 0x38, "Size mismatch!");

} // namespace Meta::XR::EnvironmentDepth
// Dependencies Meta.XR.EnvironmentDepth.DepthFrameDesc, Meta.XR.EnvironmentDepth.OcclusionShadersMode, UnityEngine.Matrix4x4, UnityEngine.MonoBehaviour, UnityEngine.RenderTargetSetup
namespace Meta::XR::EnvironmentDepth {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__reprojectionMatrices, put = __cordl_internal_set__reprojectionMatrices)) ::ArrayW<::UnityEngine::Matrix4x4> _reprojectionMatrices;

  /// @brief Field frameDescriptors, offset 0xa8, size 0x8
  __declspec(property(get = __cordl_internal_get_frameDescriptors, put = __cordl_internal_set_frameDescriptors)) ::ArrayW<::Meta::XR::EnvironmentDepth::DepthFrameDesc> frameDescriptors;
  ...
  /// @brief Method Awake, addr 0x59015a0, size 0xbc, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CacheCameraRig, addr 0x59024d4, size 0xa0, virtual false, abstract: false, final false
  inline void CacheCameraRig();

  /// @brief Method CreateProvider, addr 0x5900db4, size 0x2ec, virtual false, abstract: false, final false
  static inline ::Meta::XR::EnvironmentDepth::IDepthProvider* CreateProvider();

  /// @brief Method GetTrackingSpaceWorldToLocalMatrix, addr 0x5901f68, size 0x144, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 GetTrackingSpaceWorldToLocalMatrix();

  /// @brief Method Log, addr 0x59033c4, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method OnBeforeRender, addr 0x5901c18, size 0x350, virtual false, abstract: false, final false
  inline void OnBeforeRender();

  /// @brief Method OnDestroy, addr 0x5901aa4, size 0xe8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x5901914, size 0x190, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x590165c, size 0x21c, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method PreprocessDepthTexture, addr 0x59030e0, size 0x2e4, virtual false, abstract: false, final false
  inline void PreprocessDepthTexture(::UnityEngine::RenderTexture* depthTexture);

  /// @brief Method ResetDepthTextureIfAvailable, addr 0x5901878, size 0x9c, virtual false, abstract: false, final false
  inline void ResetDepthTextureIfAvailable();

  /// @brief Method SetOcclusionShaderKeywords, addr 0x5901214, size 0x1b0, virtual false, abstract: false, final false
  static inline void SetOcclusionShaderKeywords(::Meta::XR::EnvironmentDepth::OcclusionShadersMode mode);

  /// @brief Method TryFetchDepthTexture, addr 0x59020ac, size 0x2e4, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityEngine::Matrix4x4> const& __cordl_internal_get__reprojectionMatrices() const;

  constexpr ::ArrayW<::UnityEngine::Matrix4x4>& __cordl_internal_get__reprojectionMatrices();

  constexpr ::ArrayW<::Meta::XR::EnvironmentDepth::DepthFrameDesc> const& __cordl_internal_get_frameDescriptors() const;

  constexpr ::ArrayW<::Meta::XR::EnvironmentDepth::DepthFrameDesc>& __cordl_internal_get_frameDescriptors();
  ...
  constexpr void __cordl_internal_set__reprojectionMatrices(::ArrayW<::UnityEngine::Matrix4x4> value);

  constexpr void __cordl_internal_set_frameDescriptors(::ArrayW<::Meta::XR::EnvironmentDepth::DepthFrameDesc> value);

  constexpr void __cordl_internal_set_onDepthTextureUpdate(::System::Action_1<::UnityW<::UnityEngine::RenderTexture>>* value);

  /// @brief Method .ctor, addr 0x59034e8, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_onDepthTextureUpdate, addr 0x5900bb0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsDepthAvailable, addr 0x5901170, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDepthAvailable();

  /// @brief Method get_IsSupported, addr 0x59010a4, size 0xcc, virtual false, abstract: false, final false
  static inline bool get_IsSupported();

  /// @brief Method get_MaskBias, addr 0x59014fc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_MaskBias();

  /// @brief Method get_MaskMeshFilters, addr 0x5900ba0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::MeshFilter>>* get_MaskMeshFilters();

  /// @brief Method get_OcclusionShadersMode, addr 0x5901180, size 0x8, virtual false, abstract: false, final false
  inline ::Meta::XR::EnvironmentDepth::OcclusionShadersMode get_OcclusionShadersMode();

  /// @brief Method get_RemoveHands, addr 0x59013c4, size 0x8, virtual false, abstract: false, final false
  inline bool get_RemoveHands();

  /// @brief Method get_provider, addr 0x5900d30, size 0x84, virtual false, abstract: false, final false
  static inline ::Meta::XR::EnvironmentDepth::IDepthProvider* get_provider();

  /// @brief Method remove_onDepthTextureUpdate, addr 0x5900c70, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsDepthAvailable, addr 0x5901178, size 0x8, virtual false, abstract: false, final false
  inline void set_IsDepthAvailable(bool value);

  /// @brief Method set_MaskBias, addr 0x5901504, size 0x9c, virtual false, abstract: false, final false
  inline void set_MaskBias(float_t value);

  /// @brief Method set_MaskMeshFilters, addr 0x5900ba8, size 0x8, virtual false, abstract: false, final false
  inline void set_MaskMeshFilters(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::MeshFilter>>* value);

  /// @brief Method set_OcclusionShadersMode, addr 0x5901188, size 0x8c, virtual false, abstract: false, final false
  inline void set_OcclusionShadersMode(::Meta::XR::EnvironmentDepth::OcclusionShadersMode value);

  /// @brief Method set_RemoveHands, addr 0x59013cc, size 0x130, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::Meta::XR::EnvironmentDepth::DepthFrameDesc> ___frameDescriptors;
  ...
  ::ArrayW<::UnityEngine::Matrix4x4> ____reprojectionMatrices;
...
static_assert(sizeof(::Meta::XR::EnvironmentDepth::EnvironmentDepthManager) == 0xd0, "Size mismatch!");
