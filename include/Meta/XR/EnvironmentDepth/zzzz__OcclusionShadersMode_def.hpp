...
DEFINE_IL2CPP_CLASS(::Meta::XR::EnvironmentDepth::OcclusionShadersMode, "Meta.XR.EnvironmentDepth", "OcclusionShadersMode");
// Dependencies
namespace Meta::XR::EnvironmentDepth {
// Is value type: true
...
static_assert(sizeof(::Meta::XR::EnvironmentDepth::OcclusionShadersMode) == 0x4, "Size mismatch!");
