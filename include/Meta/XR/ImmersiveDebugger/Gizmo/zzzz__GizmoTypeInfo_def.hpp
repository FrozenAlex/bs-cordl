...
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::Gizmo::GizmoTypeInfo, "Meta.XR.ImmersiveDebugger.Gizmo", "GizmoTypeInfo");
// Dependencies
namespace Meta::XR::ImmersiveDebugger::Gizmo {
// Is value type: true
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x5934168, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Gizmo::GizmoTypeInfo) == 0x8, "Size mismatch!");
