...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::Hierarchy::Manager*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::Hierarchy::Manager*, "Meta.XR.ImmersiveDebugger.Hierarchy", "Manager");
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Hierarchy::Manager) == 0x28, "Size mismatch!");
