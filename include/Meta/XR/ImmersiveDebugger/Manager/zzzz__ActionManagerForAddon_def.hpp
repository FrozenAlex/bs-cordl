...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::Manager::ActionManagerForAddon*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::Manager::ActionManagerForAddon*, "Meta.XR.ImmersiveDebugger.Manager", "ActionManagerForAddon");
...
public:
  ...
  /// @brief Method RegisterSpecialisedWidget, addr 0x592bbfc, size 0x268, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x592bea8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TelemetryAnnotation, addr 0x592be64, size 0x44, virtual true, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Manager::ActionManagerForAddon) == 0x28, "Size mismatch!");
