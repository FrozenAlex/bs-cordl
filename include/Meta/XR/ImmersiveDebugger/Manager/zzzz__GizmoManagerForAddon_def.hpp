...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::Manager::GizmoManagerForAddon*);
...
public:
  ...
  /// @brief Method <RegisterSpecialisedWidget>g__GetState|1, addr 0x592cb58, size 0x6c, virtual false, abstract: false, final false
  inline bool _RegisterSpecialisedWidget_g__GetState_1();

  /// @brief Method <RegisterSpecialisedWidget>g__OnStateChanged|0, addr 0x592cadc, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x592c9f8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Manager::GizmoManagerForAddon___c__DisplayClass1_0) == 0x38, "Size mismatch!");
...
public:
  ...
  /// @brief Method RegisterSpecialisedWidget, addr 0x592c300, size 0x6f8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x592ca40, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TelemetryAnnotation, addr 0x592c9fc, size 0x44, virtual true, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Manager::GizmoManagerForAddon) == 0x30, "Size mismatch!");
