...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::Manager::ManagerUtils*);
MARK_GEN_REF_T_PTR(::Meta::XR::ImmersiveDebugger::Manager::ManagerUtils_RegisterMember_1);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::Manager::ManagerUtils*, "Meta.XR.ImmersiveDebugger.Manager", "ManagerUtils");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Meta::XR::ImmersiveDebugger::Manager::ManagerUtils_RegisterMember_1, "Meta.XR.ImmersiveDebugger.Manager", "ManagerUtils/RegisterMember`1");
...
// Non member Declarations
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Manager::ManagerUtils) == 0x10, "Size mismatch!");
