...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::Manager::Tweak*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::Manager::Tweak*, "Meta.XR.ImmersiveDebugger.Manager", "Tweak");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5a616c0, size 0x28, virtual false, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Manager::Tweak) == 0x40, "Size mismatch!");
