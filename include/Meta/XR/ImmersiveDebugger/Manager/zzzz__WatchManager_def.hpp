...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::Manager::WatchManager*);
...
public:
  ...
  /// @brief Method <ProcessType>b__4_0, addr 0x5a6511c, size 0x8, virtual false, abstract: false, final false
  inline bool _ProcessType_b__4_0(::System::Reflection::MemberInfo* info, ::Meta::XR::ImmersiveDebugger::DebugMember* _);

  /// @brief Method <ProcessType>b__4_1, addr 0x5a65124, size 0x2c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a65118, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Manager::WatchManager___c) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetCountPerType, addr 0x5a64f94, size 0x98, virtual true, abstract: false, final true
  inline int32_t GetCountPerType(::System::Type* type);

  /// @brief Method IsMemberValidForWatch, addr 0x5a636bc, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessType, addr 0x5a64ac8, size 0x418, virtual true, abstract: false, final true
  inline void ProcessType(::System::Type* type);

  /// @brief Method ProcessTypeFromHierarchy, addr 0x5a64f18, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessTypeFromInspector, addr 0x5a64ee0, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method Setup, addr 0x5a64ac0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5a6502c, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TelemetryAnnotation, addr 0x5a64f50, size 0x44, virtual true, abstract: false, final true
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Manager::WatchManager) == 0x28, "Size mismatch!");
