...
public:
  ...
  /// @brief Method <ProcessType>b__4_0, addr 0x592dbd4, size 0x8, virtual false, abstract: false, final false
  inline bool _ProcessType_b__4_0(::System::Reflection::MemberInfo* info, ::Meta::XR::ImmersiveDebugger::DebugMember* _);

  /// @brief Method <ProcessType>b__4_1, addr 0x592dbdc, size 0x2c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x592dbd0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetCountPerType, addr 0x592da4c, size 0x98, virtual true, abstract: false, final true
  inline int32_t GetCountPerType(::System::Type* type);

  /// @brief Method IsMemberValidForWatch, addr 0x592c174, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessType, addr 0x592d580, size 0x418, virtual true, abstract: false, final true
  inline void ProcessType(::System::Type* type);

  /// @brief Method ProcessTypeFromHierarchy, addr 0x592d9d0, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessTypeFromInspector, addr 0x592d998, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method Setup, addr 0x592d578, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x592dae4, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TelemetryAnnotation, addr 0x592da08, size 0x44, virtual true, abstract: false, final true
