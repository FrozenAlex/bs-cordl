...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Background*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Background*, "Meta.XR.ImmersiveDebugger.UserInterface.Generic", "Background");
...
public:
  ...
  /// @brief Method Setup, addr 0x5a55074, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a55114, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_Color, addr 0x5a54ffc, size 0x20, virtual false, abstract: false, final false
  inline void set_Color(::UnityEngine::Color value);

  /// @brief Method set_PixelDensityMultiplier, addr 0x5a5501c, size 0x34, virtual false, abstract: false, final false
  inline void set_PixelDensityMultiplier(float_t value);

  /// @brief Method set_RaycastTarget, addr 0x5a55050, size 0x24, virtual false, abstract: false, final false
  inline void set_RaycastTarget(bool value);

  /// @brief Method set_Sprite, addr 0x5a54fe4, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Background) == 0x78, "Size mismatch!");
