...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ButtonWithIcon*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ButtonWithIcon*, "Meta.XR.ImmersiveDebugger.UserInterface.Generic", "ButtonWithIcon");
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ButtonWithIcon) == 0xa8, "Size mismatch!");
