...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Button*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Button*, "Meta.XR.ImmersiveDebugger.UserInterface.Generic", "Button");
...
public:
  ...
  /// @brief Method Init, addr 0x5a55120, size 0x4c, virtual false, abstract: false, final false
  static inline void Init();

  static inline ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Button* New_ctor();

  /// @brief Method OnHoverChanged, addr 0x5a55348, size 0x20, virtual true, abstract: false, final false
  inline void OnHoverChanged();

  /// @brief Method OnPointerClick, addr 0x5a552d4, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a554a0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::GlobalNamespace::OVRHapticsClip* getStaticF__hapticsClip();

  /// @brief Method get_Callback, addr 0x5a552c4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action* get_Callback();

  /// @brief Method get_HapticsClip, addr 0x5a5516c, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Callback, addr 0x5a552cc, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Button) == 0x88, "Size mismatch!");
