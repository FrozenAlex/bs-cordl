...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller*, "Meta.XR.ImmersiveDebugger.UserInterface.Generic", "Controller");
...
public:
  ...
  /// @brief Method Append, addr 0x591c98c, size 0xf0, virtual false, abstract: false, final false
  inline void Append(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller* controller);

  /// @brief Method Clear, addr 0x591ca7c, size 0xa0, virtual false, abstract: false, final false
  inline void Clear(bool destroy);

  /// @brief Method GetVec2FromLayout, addr 0x591cb88, size 0x34, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 GetVec2FromLayout(::UnityEngine::TextAnchor anchor);

  /// @brief Method Hide, addr 0x5910bec, size 0x14, virtual false, abstract: false, final false
  inline void Hide();
  ...
  /// @brief Method OnDestroy, addr 0x591d068, size 0x8c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnTransparencyChanged, addr 0x5911938, size 0x4, virtual true, abstract: false, final false
  inline void OnTransparencyChanged();

  /// @brief Method OnVisibilityChanged, addr 0x591cb40, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method RefreshLayout, addr 0x5910bc0, size 0x14, virtual false, abstract: false, final false
  inline void RefreshLayout();

  /// @brief Method RefreshLayoutPostChildren, addr 0x591cec0, size 0x1a8, virtual true, abstract: false, final false
  inline void RefreshLayoutPostChildren();

  /// @brief Method RefreshLayoutPreChildren, addr 0x591cbbc, size 0x304, virtual true, abstract: false, final false
  inline void RefreshLayoutPreChildren();

  /// @brief Method Remove, addr 0x5917704, size 0x154, virtual false, abstract: false, final false
  inline void Remove(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller* controller, bool destroy);

  /// @brief Method SetHeight, addr 0x5910b80, size 0x40, virtual false, abstract: false, final false
  inline void SetHeight(float_t height);

  /// @brief Method SetWidth, addr 0x591d0f4, size 0x40, virtual false, abstract: false, final false
  inline void SetWidth(float_t width);

  /// @brief Method Setup, addr 0x5914064, size 0x21c, virtual true, abstract: false, final false
  ...
  /// @brief Method Show, addr 0x5910bd4, size 0x18, virtual false, abstract: false, final false
  inline void Show();

  /// @brief Method ToggleVisibility, addr 0x5913808, size 0x48, virtual false, abstract: false, final false
  inline void ToggleVisibility();

  /// @brief Method UpdateRefreshLayout, addr 0x591c74c, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59156e8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_OnVisibilityChangedEvent, addr 0x59121d4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Children, addr 0x591c73c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller>>* get_Children();

  /// @brief Method get_GameObject, addr 0x591c72c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_GameObject();

  /// @brief Method get_LayoutStyle, addr 0x591c744, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::LayoutStyle> get_LayoutStyle();

  /// @brief Method get_Owner, addr 0x591c6fc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller> get_Owner();

  /// @brief Method get_RectTransform, addr 0x591c71c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_RectTransform();

  /// @brief Method get_Transform, addr 0x591c70c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_Transform();

  /// @brief Method get_Transparent, addr 0x591c984, size 0x8, virtual false, abstract: false, final false
  inline bool get_Transparent();

  /// @brief Method get_Visibility, addr 0x591cb1c, size 0x8, virtual false, abstract: false, final false
  inline bool get_Visibility();

  /// @brief Method remove_OnVisibilityChangedEvent, addr 0x591c8c4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_GameObject, addr 0x591c734, size 0x8, virtual false, abstract: false, final false
  inline void set_GameObject(::UnityEngine::GameObject* value);

  /// @brief Method set_LayoutStyle, addr 0x590d9e0, size 0xdc, virtual false, abstract: false, final false
  inline void set_LayoutStyle(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::LayoutStyle* value);

  /// @brief Method set_Owner, addr 0x591c704, size 0x8, virtual false, abstract: false, final false
  inline void set_Owner(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller* value);

  /// @brief Method set_RectTransform, addr 0x591c724, size 0x8, virtual false, abstract: false, final false
  inline void set_RectTransform(::UnityEngine::RectTransform* value);

  /// @brief Method set_Transform, addr 0x591c714, size 0x8, virtual false, abstract: false, final false
  inline void set_Transform(::UnityEngine::Transform* value);

  /// @brief Method set_Transparent, addr 0x5912b2c, size 0x24, virtual false, abstract: false, final false
  inline void set_Transparent(bool value);

  /// @brief Method set_Visibility, addr 0x591cb24, size 0x1c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller) == 0x70, "Size mismatch!");
