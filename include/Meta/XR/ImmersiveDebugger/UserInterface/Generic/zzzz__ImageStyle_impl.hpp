...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle::*)()>(
  ...
  constexpr static std::size_t addrs = 0x5a5c8f8;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle*>(), { ".ctor", {}, {} })));
...
inline void Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle::_ctor() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle*>(), { ".ctor", {}, {} })));
...
inline ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle* Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle*>());
}
// Ctor Parameters []
