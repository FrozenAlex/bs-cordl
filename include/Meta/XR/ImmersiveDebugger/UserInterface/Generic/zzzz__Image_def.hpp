...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Image*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Image*, "Meta.XR.ImmersiveDebugger.UserInterface.Generic", "Image");
...
public:
  ...
  /// @brief Method Setup, addr 0x5a5833c, size 0x54, virtual false, abstract: false, final false
  inline void Setup(::Meta::XR::ImmersiveDebugger::Manager::WatchTexture* watchTexture);

  /// @brief Method Update, addr 0x5a583b0, size 0xe8, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateSize, addr 0x5a582a4, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a584a4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Texture, addr 0x5a581fc, size 0x4, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> get_Texture();

  /// @brief Method set_Texture, addr 0x5a58200, size 0xa4, virtual true, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Image) == 0x88, "Size mismatch!");
