...
public:
  ...
  /// @brief Method OnDisable, addr 0x5921c1c, size 0x1c, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnHoverChanged, addr 0x591de20, size 0x4, virtual true, abstract: false, final false
  inline void OnHoverChanged();

  /// @brief Method OnPointerClick, addr 0x592344c, size 0x4, virtual true, abstract: false, final false
  inline void OnPointerClick();

  /// @brief Method OnPointerEnter, addr 0x5923410, size 0x20, virtual false, abstract: false, final false
  inline void OnPointerEnter();

  /// @brief Method OnPointerExit, addr 0x5923430, size 0x1c, virtual false, abstract: false, final false
  inline void OnPointerExit();

  /// @brief Method PlayHaptics, addr 0x591de24, size 0x134, virtual false, abstract: false, final false
  inline void PlayHaptics(::GlobalNamespace::OVRHapticsClip* hapticsClip);

  /// @brief Method Setup, addr 0x591e23c, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x591df64, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Hover, addr 0x59233e4, size 0x8, virtual false, abstract: false, final false
  inline bool get_Hover();

  /// @brief Method set_Hover, addr 0x59233ec, size 0x24, virtual false, abstract: false, final false
