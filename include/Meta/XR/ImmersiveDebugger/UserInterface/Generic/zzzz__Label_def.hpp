...
public:
  ...
  /// @brief Method Setup, addr 0x5a584c0, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a585b0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Content, addr 0x5a55da8, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_Content();

  /// @brief Method get_Text, addr 0x5a584b0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Text> get_Text();

  /// @brief Method get_TextStyle, addr 0x5a585a8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::TextStyle> get_TextStyle();

  /// @brief Method set_Content, addr 0x5a55df4, size 0x20, virtual false, abstract: false, final false
  inline void set_Content(::StringW value);

  /// @brief Method set_Text, addr 0x5a584b8, size 0x8, virtual false, abstract: false, final false
  inline void set_Text(::UnityEngine::UI::Text* value);

  /// @brief Method set_TextStyle, addr 0x5a55ce4, size 0x80, virtual false, abstract: false, final false
