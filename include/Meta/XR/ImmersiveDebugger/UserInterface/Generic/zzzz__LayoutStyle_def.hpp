...
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::LayoutStyle_Direction, "Meta.XR.ImmersiveDebugger.UserInterface.Generic", "LayoutStyle/Direction");
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::LayoutStyle_Layout, "Meta.XR.ImmersiveDebugger.UserInterface.Generic", "LayoutStyle/Layout");
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::LayoutStyle_Layout) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::LayoutStyle_Direction) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method SetHeight, addr 0x592542c, size 0x28, virtual false, abstract: false, final false
  inline bool SetHeight(float_t height);

  /// @brief Method SetIndent, addr 0x592547c, size 0x40, virtual false, abstract: false, final false
  inline bool SetIndent(float_t value);

  /// @brief Method SetWidth, addr 0x5925454, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59254bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BottomMargin, addr 0x5925408, size 0x1c, virtual false, abstract: false, final false
  inline float_t get_BottomMargin();

  /// @brief Method get_BottomRightMargin, addr 0x591fef4, size 0x2c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_BottomRightMargin();

  /// @brief Method get_LeftMargin, addr 0x59253dc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_LeftMargin();

  /// @brief Method get_RightMargin, addr 0x59253ec, size 0x1c, virtual false, abstract: false, final false
  inline float_t get_RightMargin();

  /// @brief Method get_TopLeftMargin, addr 0x5925424, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_TopLeftMargin();

  /// @brief Method get_TopMargin, addr 0x59253e4, size 0x8, virtual false, abstract: false, final false
