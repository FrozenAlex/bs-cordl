...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::OverlayCanvasPanel*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::OverlayCanvasPanel*, "Meta.XR.ImmersiveDebugger.UserInterface.Generic", "OverlayCanvasPanel");
...
public:
  ...
  /// @brief Method Setup, addr 0x5921074, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5921274, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::OverlayCanvasPanel) == 0xc8, "Size mismatch!");
