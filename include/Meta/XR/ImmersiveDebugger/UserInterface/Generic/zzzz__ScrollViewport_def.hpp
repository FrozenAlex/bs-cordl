...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ScrollViewport*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ScrollViewport*, "Meta.XR.ImmersiveDebugger.UserInterface.Generic", "ScrollViewport");
...
public:
  ...
  /// @brief Method Setup, addr 0x5921e18, size 0x1b8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5921fd0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Flex, addr 0x5921e10, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ScrollViewport) == 0x88, "Size mismatch!");
