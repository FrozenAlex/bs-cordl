...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Style*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Style*, "Meta.XR.ImmersiveDebugger.UserInterface.Generic", "Style");
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Style) == 0x20, "Size mismatch!");
