...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::TextStyle*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::TextStyle*, "Meta.XR.ImmersiveDebugger.UserInterface.Generic", "TextStyle");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5a5ca0c, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::TextStyle) == 0x40, "Size mismatch!");
