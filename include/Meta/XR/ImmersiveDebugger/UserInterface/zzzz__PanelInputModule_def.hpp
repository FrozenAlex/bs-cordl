...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::UserInterface::PanelInputModule*);
MARK_REF_T(::Meta::XR::ImmersiveDebugger::UserInterface::PanelInputModule_RaycastComparer*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::PanelInputModule*, "Meta.XR.ImmersiveDebugger.UserInterface", "PanelInputModule");
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::PanelInputModule_RaycastComparer*, "Meta.XR.ImmersiveDebugger.UserInterface", "PanelInputModule/RaycastComparer");
...
public:
  ...
  /// @brief Method Compare, addr 0x591b2c8, size 0x234, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x591b2c4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::PanelInputModule_RaycastComparer) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method Awake, addr 0x591a320, size 0xac, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method ChooseBestController, addr 0x591ae24, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeControllerState, addr 0x591ac7c, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMouseStateFromRaycast, addr 0x591a734, size 0x548, virtual false, abstract: false, final false
  ...
  /// @brief Method IsModuleSupported, addr 0x591a3d4, size 0x8, virtual true, abstract: false, final false
  inline bool IsModuleSupported();

  static inline ::Meta::XR::ImmersiveDebugger::UserInterface::PanelInputModule* New_ctor();

  /// @brief Method Process, addr 0x591ad4c, size 0xd8, virtual true, abstract: false, final false
  inline void Process();

  /// @brief Method Raycast, addr 0x591a474, size 0x244, virtual false, abstract: false, final false
  inline bool Raycast(::UnityEngine::EventSystems::PointerEventData* data, ::by_ref<::UnityEngine::EventSystems::RaycastResult> raycast);

  /// @brief Method RegisterRaycaster, addr 0x591a120, size 0x11c, virtual false, abstract: false, final false
  static inline void RegisterRaycaster(::Meta::XR::ImmersiveDebugger::UserInterface::PanelRaycaster* raycaster);

  /// @brief Method SetDebugInterface, addr 0x591a318, size 0x8, virtual false, abstract: false, final false
  inline void SetDebugInterface(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Interface* debugInterface);

  /// @brief Method ShouldActivateModule, addr 0x591a3cc, size 0x8, virtual true, abstract: false, final false
  inline bool ShouldActivateModule();

  /// @brief Method UnregisterRaycaster, addr 0x591a23c, size 0xdc, virtual false, abstract: false, final false
  static inline void UnregisterRaycaster(::Meta::XR::ImmersiveDebugger::UserInterface::PanelRaycaster* raycaster);

  /// @brief Method Update, addr 0x591a3dc, size 0x98, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateRayTransform, addr 0x591af4c, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x591b180, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::PanelInputModule) == 0x118, "Size mismatch!");
