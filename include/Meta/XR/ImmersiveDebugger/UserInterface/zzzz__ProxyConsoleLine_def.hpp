...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine*, "Meta.XR.ImmersiveDebugger.UserInterface", "ProxyConsoleLine");
...
public:
  ...
  /// @brief Method Fill, addr 0x5a490b4, size 0x50, virtual true, abstract: false, final false
  inline void Fill();
  ...
  /// @brief Method .ctor, addr 0x5a49104, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Entry, addr 0x5a490a4, size 0x8, virtual false, abstract: false, final false
  inline ::Meta::XR::ImmersiveDebugger::UserInterface::LogEntry* get_Entry();

  /// @brief Method set_Entry, addr 0x5a490ac, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine) == 0x20, "Size mismatch!");
