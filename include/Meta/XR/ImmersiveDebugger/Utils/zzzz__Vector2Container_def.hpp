...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::Utils::Vector2Container*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::Utils::Vector2Container*, "Meta.XR.ImmersiveDebugger.Utils", "Vector2Container");
...
public:
  ...
  /// @brief Method .ctor, addr 0x590d484, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Utils::Vector2Container) == 0x20, "Size mismatch!");
