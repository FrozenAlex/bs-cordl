...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::CustomIntegrationConfigBase*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::CustomIntegrationConfigBase*, "Meta.XR.ImmersiveDebugger", "CustomIntegrationConfigBase");
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::CustomIntegrationConfigBase) == 0x20, "Size mismatch!");
