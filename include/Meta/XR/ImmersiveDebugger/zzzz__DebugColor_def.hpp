...
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::DebugColor, "Meta.XR.ImmersiveDebugger", "DebugColor");
// Dependencies
namespace Meta::XR::ImmersiveDebugger {
// Is value type: true
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::DebugColor) == 0x4, "Size mismatch!");
