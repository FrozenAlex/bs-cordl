...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::DebugData*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::DebugData*, "Meta.XR.ImmersiveDebugger", "DebugData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5906960, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::DebugData) == 0x20, "Size mismatch!");
