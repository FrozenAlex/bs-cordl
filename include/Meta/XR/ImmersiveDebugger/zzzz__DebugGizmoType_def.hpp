...
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::DebugGizmoType, "Meta.XR.ImmersiveDebugger", "DebugGizmoType");
// Dependencies
namespace Meta::XR::ImmersiveDebugger {
// Is value type: true
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::DebugGizmoType) == 0x4, "Size mismatch!");
