...
public:
  ...
  /// @brief Method Add, addr 0x5a3cef0, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x5a3d12c, size 0x88, virtual false, abstract: false, final false
