...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::InspectedItemBase*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::InspectedItemBase*, "Meta.XR.ImmersiveDebugger", "InspectedItemBase");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5905d30, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Valid, addr 0x5905d20, size 0x8, virtual false, abstract: false, final false
  inline bool get_Valid();

  /// @brief Method get_Visible, addr 0x590537c, size 0x20, virtual false, abstract: false, final false
  inline bool get_Visible();

  /// @brief Method set_Valid, addr 0x5905d28, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::InspectedItemBase) == 0x28, "Size mismatch!");
