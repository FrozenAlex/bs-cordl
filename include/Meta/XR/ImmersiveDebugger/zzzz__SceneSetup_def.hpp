...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::SceneSetup*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::SceneSetup*, "Meta.XR.ImmersiveDebugger", "SceneSetup");
...
public:
  // Declarations
  /// @brief Method OnLoad, addr 0x5907494, size 0x5c, virtual false, abstract: false, final false
  static inline void OnLoad();

  /// @brief Method SetupImmersiveDebugger, addr 0x59074f0, size 0x34c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::SceneSetup) == 0x10, "Size mismatch!");
