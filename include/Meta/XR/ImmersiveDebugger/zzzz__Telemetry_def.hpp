...
public:
  ...
  /// @brief Method Init, addr 0x5a3f68c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x5a403b8, size 0x8, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnFocusLost, addr 0x5a403b0, size 0x8, virtual false, abstract: false, final false
  inline void OnFocusLost();

  /// @brief Method OnStart, addr 0x5a3f968, size 0x30, virtual false, abstract: false, final false
  inline void OnStart();

  /// @brief Method SendComponentTracked, addr 0x5a3f9bc, size 0x9f4, virtual false, abstract: false, final false
  inline void SendComponentTracked(::Meta::XR::ImmersiveDebugger::Telemetry_State state);

  /// @brief Method SendStart, addr 0x5a3f998, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a3f7b4, size 0x1b4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FetchPanel, addr 0x5a3f3f8, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeHash, addr 0x5a3ed84, size 0x68, virtual false, abstract: false, final false
  static inline ::StringW GetTypeHash(::System::Type* type);

  /// @brief Method IsTypeCustom, addr 0x5a3edec, size 0x18c, virtual false, abstract: false, final false
  static inline bool IsTypeCustom(::System::Type* type);

  /// @brief Method OnButtonClicked, addr 0x5a3f144, size 0x2b4, virtual false, abstract: false, final false
  static inline void OnButtonClicked(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Button* button);

  /// @brief Method OnPanelActiveStateChanged, addr 0x5a3ef78, size 0x1cc, virtual false, abstract: false, final false
