...
// Write type traits
MARK_REF_T(::Meta::XR::InputActions::RuntimeSettings*);
DEFINE_IL2CPP_CLASS(::Meta::XR::InputActions::RuntimeSettings*, "Meta.XR.InputActions", "RuntimeSettings");
...
static_assert(sizeof(::Meta::XR::InputActions::RuntimeSettings) == 0x28, "Size mismatch!");
