...
// Write type traits
MARK_REF_T(::Meta::XR::InputActions::UserInputActionSet*);
DEFINE_IL2CPP_CLASS(::Meta::XR::InputActions::UserInputActionSet*, "Meta.XR.InputActions", "UserInputActionSet");
...
public:
  ...
  /// @brief Method ToString, addr 0x5e4cb4c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e4cb54, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Meta::XR::InputActions::UserInputActionSet) == 0x20, "Size mismatch!");
