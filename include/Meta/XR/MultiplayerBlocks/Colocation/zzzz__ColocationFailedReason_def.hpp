...
DEFINE_IL2CPP_CLASS(::Meta::XR::MultiplayerBlocks::Colocation::ColocationFailedReason, "Meta.XR.MultiplayerBlocks.Colocation", "ColocationFailedReason");
// Dependencies
namespace Meta::XR::MultiplayerBlocks::Colocation {
// Is value type: true
...
static_assert(sizeof(::Meta::XR::MultiplayerBlocks::Colocation::ColocationFailedReason) == 0x4, "Size mismatch!");
