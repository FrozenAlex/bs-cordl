...
// Write type traits
MARK_REF_T(::Meta::XR::MultiplayerBlocks::Colocation::INetworkData*);
DEFINE_IL2CPP_CLASS(::Meta::XR::MultiplayerBlocks::Colocation::INetworkData*, "Meta.XR.MultiplayerBlocks.Colocation", "INetworkData");
// Dependencies
namespace Meta::XR::MultiplayerBlocks::Colocation {
// Is value type: false
