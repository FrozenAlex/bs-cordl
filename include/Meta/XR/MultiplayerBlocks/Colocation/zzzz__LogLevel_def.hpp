...
DEFINE_IL2CPP_CLASS(::Meta::XR::MultiplayerBlocks::Colocation::LogLevel, "Meta.XR.MultiplayerBlocks.Colocation", "LogLevel");
// Dependencies
namespace Meta::XR::MultiplayerBlocks::Colocation {
// Is value type: true
...
static_assert(sizeof(::Meta::XR::MultiplayerBlocks::Colocation::LogLevel) == 0x4, "Size mismatch!");
