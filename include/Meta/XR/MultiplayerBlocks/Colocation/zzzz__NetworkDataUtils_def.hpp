...
public:
  // Declarations
  /// @brief Method GetAllPlayersColocatedWith, addr 0x5a79890, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAllPlayersFromColocationGroupId, addr 0x5a795e0, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOculusIdOfColocatedGroupOwnerFromColocationGroupId, addr 0x5a79400, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPlayerFromOculusId, addr 0x5a79c18, size 0x104, virtual false, abstract: false, final false
