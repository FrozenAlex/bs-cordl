...
DEFINE_IL2CPP_CLASS(::Meta::XR::MultiplayerBlocks::Shared::AvatarStreamLOD, "Meta.XR.MultiplayerBlocks.Shared", "AvatarStreamLOD");
// Dependencies
namespace Meta::XR::MultiplayerBlocks::Shared {
// Is value type: true
...
static_assert(sizeof(::Meta::XR::MultiplayerBlocks::Shared::AvatarStreamLOD) == 0x4, "Size mismatch!");
