...
// Write type traits
MARK_REF_T(::Meta::XR::MultiplayerBlocks::Shared::ColocationController*);
DEFINE_IL2CPP_CLASS(::Meta::XR::MultiplayerBlocks::Shared::ColocationController*, "Meta.XR.MultiplayerBlocks.Shared", "ColocationController");
...
public:
  ...
  /// @brief Method Awake, addr 0x5a6cc98, size 0xd8, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x5a6cf50, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Meta::XR::MultiplayerBlocks::Shared::ColocationController) == 0x30, "Size mismatch!");
