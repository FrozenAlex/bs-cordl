...
DEFINE_IL2CPP_CLASS(::Meta::XR::MultiplayerBlocks::Shared::MatchInfo, "Meta.XR.MultiplayerBlocks.Shared", "MatchInfo");
// Dependencies
namespace Meta::XR::MultiplayerBlocks::Shared {
// Is value type: true
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x5a700dc, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::MultiplayerBlocks::Shared::MatchInfo) == 0x18, "Size mismatch!");
