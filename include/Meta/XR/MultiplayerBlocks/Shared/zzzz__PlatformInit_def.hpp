...
// Write type traits
MARK_REF_T(::Meta::XR::MultiplayerBlocks::Shared::PlatformInit*);
MARK_REF_T(::Meta::XR::MultiplayerBlocks::Shared::PlatformInit___c__DisplayClass5_0*);
MARK_REF_T(::Meta::XR::MultiplayerBlocks::Shared::PlatformInit___c__DisplayClass5_1*);
...
public:
  ...
  /// @brief Method <GetEntitlementInformation>g__CheckEntitlement|1, addr 0x5a75184, size 0x234, virtual false, abstract: false, final false
  inline void _GetEntitlementInformation_g__CheckEntitlement_1(::Oculus::Platform::Message* msg);

  /// @brief Method <GetEntitlementInformation>g__GetAccessTokenComplete|2, addr 0x5a753b8, size 0x2d8, virtual false, abstract: false, final false
  inline void _GetEntitlementInformation_g__GetAccessTokenComplete_2(::Oculus::Platform::Message_1<::StringW>* msg);

  /// @brief Method <GetEntitlementInformation>g__InitializeComplete|0, addr 0x5a74f90, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a74f8c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetEntitlementInformation>b__3, addr 0x5a75694, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a75690, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Meta::XR::MultiplayerBlocks::Shared::PlatformInit___c__DisplayClass5_1) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetEntitlementInformation, addr 0x5a7070c, size 0x360, virtual false, abstract: false, final false
  ...
  /// @brief Method get_status, addr 0x5a74ef0, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_status, addr 0x5a74f3c, size 0x50, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::Meta::XR::MultiplayerBlocks::Shared::PlatformInit) == 0x10, "Size mismatch!");
