...
// Write type traits
MARK_REF_T(::Meta::XR::Samples::Telemetry::SampleTelemetryEvents*);
MARK_REF_T(::Meta::XR::Samples::Telemetry::SampleTelemetryEvents_AnnotationTypes*);
MARK_REF_T(::Meta::XR::Samples::Telemetry::SampleTelemetryEvents_EventTypes*);
...
static_assert(sizeof(::Meta::XR::Samples::Telemetry::SampleTelemetryEvents_EventTypes) == 0x10, "Size mismatch!");
...
// Non member Declarations
static_assert(sizeof(::Meta::XR::Samples::Telemetry::SampleTelemetryEvents_AnnotationTypes) == 0x10, "Size mismatch!");
...
// Non member Declarations
static_assert(sizeof(::Meta::XR::Samples::Telemetry::SampleTelemetryEvents) == 0x10, "Size mismatch!");
