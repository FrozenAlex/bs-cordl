...
// Write type traits
MARK_REF_T(::Meta::XR::Samples::SampleMetadata*);
DEFINE_IL2CPP_CLASS(::Meta::XR::Samples::SampleMetadata*, "Meta.XR.Samples", "SampleMetadata");
...
public:
  ...
  /// @brief Method Awake, addr 0x5d164b8, size 0x40, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::Meta::XR::Samples::SampleMetadata* New_ctor();

  /// @brief Method OnDestroy, addr 0x5d164f8, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEditorShutdown, addr 0x5d168d8, size 0xc, virtual false, abstract: false, final false
  inline void OnEditorShutdown();

  /// @brief Method SendEvent, addr 0x5d1658c, size 0x34c, virtual false, abstract: false, final false
  inline void SendEvent(int32_t eventType);

  /// @brief Method Start, addr 0x5d164fc, size 0x90, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5d168e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Meta::XR::Samples::SampleMetadata) == 0x28, "Size mismatch!");
