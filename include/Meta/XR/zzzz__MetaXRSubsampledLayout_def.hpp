...
// Write type traits
MARK_REF_T(::Meta::XR::MetaXRSubsampledLayout*);
DEFINE_IL2CPP_CLASS(::Meta::XR::MetaXRSubsampledLayout*, "Meta.XR", "MetaXRSubsampledLayout");
...
public:
  // Declarations
  /// @brief Method MetaSetSubsampledLayout, addr 0x5d1641c, size 0x7c, virtual false, abstract: false, final false
  static inline void MetaSetSubsampledLayout(bool enabled);

  static inline ::Meta::XR::MetaXRSubsampledLayout* New_ctor();

  /// @brief Method OnInstanceCreate, addr 0x5d163fc, size 0x20, virtual true, abstract: false, final false
  inline bool OnInstanceCreate(uint64_t xrInstance);

  /// @brief Method .ctor, addr 0x5d16498, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
