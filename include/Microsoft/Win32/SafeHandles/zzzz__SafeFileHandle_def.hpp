...
public:
  ...
  /// @brief Method ReleaseHandle, addr 0x5ac2fe4, size 0x7c, virtual true, abstract: false, final false
  inline bool ReleaseHandle();

  /// @brief Method .ctor, addr 0x5ac2fa8, size 0x2c, virtual false, abstract: false, final false
