...
// Write type traits
MARK_REF_T(::MidiParser::MidiTrack*);
DEFINE_IL2CPP_CLASS(::MidiParser::MidiTrack*, "MidiParser", "MidiTrack");
...
public:
  ...
  /// @brief Method .ctor, addr 0x594747c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::MidiParser::MidiTrack) == 0x20, "Size mismatch!");
