...
// Write type traits
MARK_REF_T(::ModestTree::Util::ValuePair*);
DEFINE_IL2CPP_CLASS(::ModestTree::Util::ValuePair*, "ModestTree.Util", "ValuePair");
...
static_assert(sizeof(::ModestTree::Util::ValuePair) == 0x10, "Size mismatch!");
