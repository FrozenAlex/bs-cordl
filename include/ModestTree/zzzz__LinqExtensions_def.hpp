...
// Write type traits
MARK_REF_T(::ModestTree::LinqExtensions*);
MARK_GEN_REF_T_PTR(::ModestTree::LinqExtensions__Yield_d__0_1);
MARK_GEN_REF_T_PTR(::ModestTree::LinqExtensions___c__8_1);
MARK_GEN_REF_T_PTR(::ModestTree::LinqExtensions___c__DisplayClass10_0_1);
DEFINE_IL2CPP_CLASS(::ModestTree::LinqExtensions*, "ModestTree", "LinqExtensions");
...
// Non member Declarations
static_assert(sizeof(::ModestTree::LinqExtensions) == 0x10, "Size mismatch!");
