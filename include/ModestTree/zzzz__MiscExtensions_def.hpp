...
public:
  ...
  /// @brief Method Fmt, addr 0x6e37544, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method Join, addr 0x6e383b0, size 0x68, virtual false, abstract: false, final false
...
static_assert(sizeof(::ModestTree::MiscExtensions) == 0x10, "Size mismatch!");
