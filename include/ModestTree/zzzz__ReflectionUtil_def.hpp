...
public:
  // Declarations
  /// @brief Method CreateArray, addr 0x6cea8c8, size 0x254, virtual false, abstract: false, final false
  static inline ::System::Array* CreateArray(::System::Type* elementType, ::System::Collections::Generic::List_1<::System::Object*>* instances);

  /// @brief Method CreateGenericList, addr 0x6ceab1c, size 0x3a0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToDebugString, addr 0x6ceaff8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method ToDebugString, addr 0x6ceaebc, size 0x13c, virtual false, abstract: false, final false
...
static_assert(sizeof(::ModestTree::ReflectionUtil) == 0x10, "Size mismatch!");
