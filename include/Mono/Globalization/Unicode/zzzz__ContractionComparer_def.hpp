...
public:
  ...
  /// @brief Method Compare, addr 0x5aac2e8, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5aac384, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
