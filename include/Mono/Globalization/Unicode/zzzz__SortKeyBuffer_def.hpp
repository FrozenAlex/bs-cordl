...
public:
  ...
  /// @brief Method AppendBufferPrimitive, addr 0x597dc2c, size 0xcc, virtual false, abstract: false, final false
  inline void AppendBufferPrimitive(uint8_t value, ::by_ref<::ArrayW<uint8_t>> buf, ::by_ref<int32_t> bidx);

  /// @brief Method AppendCJKExtension, addr 0x597a088, size 0x84, virtual false, abstract: false, final false
  inline void AppendCJKExtension(uint8_t lv1msb, uint8_t lv1lsb);

  /// @brief Method AppendKana, addr 0x597a1c0, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendLevel5, addr 0x597dcf8, size 0x90, virtual false, abstract: false, final false
  inline void AppendLevel5(uint8_t category, uint8_t lv1);

  /// @brief Method AppendNormal, addr 0x5979f58, size 0x130, virtual false, abstract: false, final false
  inline void AppendNormal(uint8_t category, uint8_t lv1, uint8_t lv2, uint8_t lv3);

  /// @brief Method GetOptimizedLength, addr 0x597e1bc, size 0x64, virtual false, abstract: false, final false
  inline int32_t GetOptimizedLength(::ArrayW<uint8_t> data, int32_t len, uint8_t defaultValue);

  /// @brief Method GetResult, addr 0x597dd88, size 0x434, virtual false, abstract: false, final false
  inline ::System::Globalization::SortKey* GetResult();

  /// @brief Method GetResultAndReset, addr 0x5979944, size 0x24, virtual false, abstract: false, final false
  inline ::System::Globalization::SortKey* GetResultAndReset();

  /// @brief Method Initialize, addr 0x5979444, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x597dc18, size 0x14, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x5979440, size 0x4, virtual false, abstract: false, final false
