...
public:
  ...
  /// @brief Method <Authenticate>b__1_0, addr 0x5e9edec, size 0x44, virtual false, abstract: false, final false
  inline ::Mono::Http::NtlmSession* _Authenticate_b__1_0(::System::Net::HttpWebRequest* x);

  /// @brief Method .ctor, addr 0x5e9ede8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Authenticate, addr 0x5e9e924, size 0x390, virtual true, abstract: false, final true
  ...
  /// @brief Method PreAuthenticate, addr 0x5e9ecb4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Net::Authorization* PreAuthenticate(::System::Net::WebRequest* webRequest, ::System::Net::ICredentials* credentials);

  /// @brief Method .ctor, addr 0x5e9ed00, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AuthenticationType, addr 0x5e9ecbc, size 0x44, virtual true, abstract: false, final true
