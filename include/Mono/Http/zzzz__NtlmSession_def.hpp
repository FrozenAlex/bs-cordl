...
public:
  ...
  /// @brief Method Authenticate, addr 0x5e9e4bc, size 0x468, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e9e4b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
