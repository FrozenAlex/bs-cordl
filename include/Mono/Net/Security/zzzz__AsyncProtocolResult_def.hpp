...
public:
  ...
  /// @brief Method .ctor, addr 0x5e9607c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::ExceptionServices::ExceptionDispatchInfo* error);

  /// @brief Method .ctor, addr 0x5e96074, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t result);

  /// @brief Method get_Error, addr 0x5e9606c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::ExceptionServices::ExceptionDispatchInfo* get_Error();

  /// @brief Method get_UserResult, addr 0x5e96064, size 0x8, virtual false, abstract: false, final false
