...
public:
  ...
  /// @brief Method ToString, addr 0x5fd0adc, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fd0a3c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CurrentSize, addr 0x5fd0a2c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_CurrentSize();

  /// @brief Method get_UserBuffer, addr 0x5fd0a24, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Net::Security::BufferOffsetSize* get_UserBuffer();

  /// @brief Method set_CurrentSize, addr 0x5fd0a34, size 0x8, virtual false, abstract: false, final false
