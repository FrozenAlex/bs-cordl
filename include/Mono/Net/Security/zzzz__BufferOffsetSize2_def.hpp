...
public:
  ...
  /// @brief Method AppendData, addr 0x5fcee9c, size 0x60, virtual false, abstract: false, final false
  inline void AppendData(::ArrayW<uint8_t> buffer, int32_t offset, int32_t size);

  /// @brief Method MakeRoom, addr 0x5fceddc, size 0xc0, virtual false, abstract: false, final false
  inline void MakeRoom(int32_t size);

  static inline ::Mono::Net::Security::BufferOffsetSize2* New_ctor(int32_t size);

  /// @brief Method Reset, addr 0x5fced7c, size 0x60, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x5fced08, size 0x74, virtual false, abstract: false, final false
