...
public:
  // Declarations
  /// @brief Method FromCapiPrivateKeyBlob, addr 0x5a9adb4, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RSA* FromCapiPrivateKeyBlob(::ArrayW<uint8_t> blob);

  /// @brief Method FromCapiPrivateKeyBlob, addr 0x5a9adbc, size 0x224, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RSA* FromCapiPrivateKeyBlob(::ArrayW<uint8_t> blob, int32_t offset);

  /// @brief Method GetParametersFromCapiPrivateKeyBlob, addr 0x5a9afe0, size 0x590, virtual false, abstract: false, final false
  ...
  /// @brief Method ToHex, addr 0x5a9b570, size 0x150, virtual false, abstract: false, final false
  static inline ::StringW ToHex(::ArrayW<uint8_t> input);

  /// @brief Method ToInt32LE, addr 0x5a9ac10, size 0x74, virtual false, abstract: false, final false
  static inline int32_t ToInt32LE(::ArrayW<uint8_t> bytes, int32_t offset);

  /// @brief Method ToUInt32LE, addr 0x5a9ac84, size 0x74, virtual false, abstract: false, final false
  static inline uint32_t ToUInt32LE(::ArrayW<uint8_t> bytes, int32_t offset);

  /// @brief Method Trim, addr 0x5a9acf8, size 0xbc, virtual false, abstract: false, final false
