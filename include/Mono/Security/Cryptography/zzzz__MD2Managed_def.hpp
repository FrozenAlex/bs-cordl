...
public:
  ...
  /// @brief Method HashCore, addr 0x5a9bb60, size 0xdc, virtual true, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t> array, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x5a9bea4, size 0xf0, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> HashFinal();

  /// @brief Method Initialize, addr 0x5a9bb00, size 0x60, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method MD2Transform, addr 0x5a9bc3c, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method Padding, addr 0x5a9b838, size 0x2c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a9b78c, size 0xac, virtual false, abstract: false, final false
  inline void _ctor();
