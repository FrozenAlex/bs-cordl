...
public:
  ...
  /// @brief Method CBC, addr 0x5abc62c, size 0x164, virtual true, abstract: false, final false
  inline void CBC(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output);

  /// @brief Method CFB, addr 0x5abc790, size 0x1c8, virtual true, abstract: false, final false
  inline void CFB(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output);

  /// @brief Method CTS, addr 0x5abc9a4, size 0x4c, virtual true, abstract: false, final false
  inline void CTS(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output);

  /// @brief Method CheckInput, addr 0x5abc9f0, size 0x13c, virtual false, abstract: false, final false
  inline void CheckInput(::ArrayW<uint8_t> inputBuffer, int32_t inputOffset, int32_t inputCount);

  /// @brief Method Dispose, addr 0x5abc3b8, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method FinalDecrypt, addr 0x5abd40c, size 0x29c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> FinalDecrypt(::ArrayW<uint8_t> inputBuffer, int32_t inputOffset, int32_t inputCount);

  /// @brief Method FinalEncrypt, addr 0x5abd174, size 0x298, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> FinalEncrypt(::ArrayW<uint8_t> inputBuffer, int32_t inputOffset, int32_t inputCount);

  /// @brief Method Finalize, addr 0x5abc2f8, size 0x50, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method InternalTransformBlock, addr 0x5abcd50, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method OFB, addr 0x5abc958, size 0x4c, virtual true, abstract: false, final false
  inline void OFB(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output);

  /// @brief Method Random, addr 0x5abcf08, size 0xbc, virtual false, abstract: false, final false
  inline void Random(::ArrayW<uint8_t> buffer, int32_t start, int32_t length);

  /// @brief Method System.IDisposable.Dispose, addr 0x5abc348, size 0x70, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method ThrowBadPaddingException, addr 0x5abcfc4, size 0x174, virtual false, abstract: false, final false
  inline void ThrowBadPaddingException(::System::Security::Cryptography::PaddingMode padding, int32_t length, int32_t position);

  /// @brief Method Transform, addr 0x5abc428, size 0x170, virtual true, abstract: false, final false
  inline void Transform(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output);

  /// @brief Method TransformBlock, addr 0x5abcb2c, size 0x200, virtual true, abstract: false, final false
  ...
  /// @brief Method TransformFinalBlock, addr 0x5abd6a8, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5abc064, size 0x294, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::SymmetricAlgorithm* symmAlgo, bool encryption, ::ArrayW<uint8_t> rgbIV);

  /// @brief Method get_CanTransformMultipleBlocks, addr 0x5abc410, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanTransformMultipleBlocks();

  /// @brief Method get_InputBlockSize, addr 0x5abc418, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_InputBlockSize();

  /// @brief Method get_KeepLastBlock, addr 0x5abcd2c, size 0x24, virtual false, abstract: false, final false
  inline bool get_KeepLastBlock();

  /// @brief Method get_OutputBlockSize, addr 0x5abc420, size 0x8, virtual true, abstract: false, final false
