...
public:
  ...
  /// @brief Method ToString, addr 0x59631c8, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5963134, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::Interface::AlertDescription description);

  /// @brief Method get_Description, addr 0x596312c, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::Interface::AlertDescription get_Description();

  /// @brief Method get_Level, addr 0x5963124, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::Interface::AlertLevel get_Level();

  /// @brief Method inferAlertLevel, addr 0x5963184, size 0x44, virtual false, abstract: false, final false
