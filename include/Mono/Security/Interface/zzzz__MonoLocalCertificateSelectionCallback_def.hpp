...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x5a99c9c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a99c1c, size 0x80, virtual false, abstract: false, final false
