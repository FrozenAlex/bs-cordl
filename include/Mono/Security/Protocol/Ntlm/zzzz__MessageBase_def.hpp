...
public:
  ...
  /// @brief Method CheckHeader, addr 0x5961a90, size 0x114, virtual false, abstract: false, final false
  inline bool CheckHeader(::ArrayW<uint8_t> message);

  /// @brief Method Decode, addr 0x5961908, size 0x188, virtual true, abstract: false, final false
  ...
  /// @brief Method PrepareMessage, addr 0x5961800, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59617e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t messageType);

  static inline ::ArrayW<uint8_t> getStaticF_header();

  /// @brief Method get_Flags, addr 0x59617e8, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::Protocol::Ntlm::NtlmFlags get_Flags();

  /// @brief Method get_Type, addr 0x59617f8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Type();

  static inline void setStaticF_header(::ArrayW<uint8_t> value);

  /// @brief Method set_Flags, addr 0x59617f0, size 0x8, virtual false, abstract: false, final false
