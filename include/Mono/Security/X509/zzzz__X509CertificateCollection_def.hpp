...
public:
  ...
  /// @brief Method MoveNext, addr 0x5a8ae5c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerator.MoveNext, addr 0x5a92f78, size 0xa4, virtual true, abstract: false, final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5a9301c, size 0xa8, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5a92ed0, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5a92d70, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::X509::X509CertificateCollection* mappings);

  /// @brief Method get_Current, addr 0x5a8aad0, size 0xf8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x5a87550, size 0x70, virtual false, abstract: false, final false
  inline int32_t Add(::Mono::Security::X509::X509Certificate* value);

  /// @brief Method AddRange, addr 0x5a92b3c, size 0xd0, virtual false, abstract: false, final false
  inline void AddRange(::Mono::Security::X509::X509CertificateCollection* value);

  /// @brief Method Compare, addr 0x5a92e60, size 0x70, virtual false, abstract: false, final false
  inline bool Compare(::ArrayW<uint8_t> array1, ::ArrayW<uint8_t> array2);

  /// @brief Method Contains, addr 0x5a92c0c, size 0x18, virtual false, abstract: false, final false
  inline bool Contains(::Mono::Security::X509::X509Certificate* value);

  /// @brief Method GetEnumerator, addr 0x5a8aa74, size 0x5c, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509CertificateCollection_X509CertificateEnumerator* GetEnumerator();

  /// @brief Method GetHashCode, addr 0x5a92e44, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IndexOf, addr 0x5a92c24, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x5a92e24, size 0x20, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method .ctor, addr 0x5a873b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Item, addr 0x5a92a98, size 0xa4, virtual false, abstract: false, final false
