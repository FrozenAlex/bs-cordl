...
public:
  ...
  /// @brief Method GetObjectData, addr 0x595c218, size 0x68, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetUnsignedBigInteger, addr 0x595b15c, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method PEM, addr 0x595afc4, size 0x198, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> PEM(::StringW type, ::ArrayW<uint8_t> data);

  /// @brief Method Parse, addr 0x595a6ac, size 0x918, virtual false, abstract: false, final false
  inline void Parse(::ArrayW<uint8_t> data);

  /// @brief Method VerifySignature, addr 0x595bf8c, size 0x188, virtual false, abstract: false, final false
  inline bool VerifySignature(::System::Security::Cryptography::AsymmetricAlgorithm* aa);

  /// @brief Method VerifySignature, addr 0x595bd90, size 0xd0, virtual false, abstract: false, final false
  inline bool VerifySignature(::System::Security::Cryptography::DSA* dsa);

  /// @brief Method VerifySignature, addr 0x595be60, size 0x12c, virtual false, abstract: false, final false
  inline bool VerifySignature(::System::Security::Cryptography::RSA* rsa);

  /// @brief Method WasCurrent, addr 0x595bcb4, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5950c08, size 0x198, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> data);

  static inline ::StringW getStaticF_encoding_error();

  /// @brief Method get_DSA, addr 0x5954418, size 0x294, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::DSA* get_DSA();

  /// @brief Method get_Extensions, addr 0x595b204, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509ExtensionCollection* get_Extensions();

  /// @brief Method get_Hash, addr 0x595b20c, size 0x240, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> get_Hash();

  /// @brief Method get_IsCurrent, addr 0x595bc50, size 0x64, virtual false, abstract: false, final false
  inline bool get_IsCurrent();

  /// @brief Method get_IsSelfSigned, addr 0x595c114, size 0x104, virtual false, abstract: false, final false
  inline bool get_IsSelfSigned();

  /// @brief Method get_IssuerName, addr 0x595b44c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_IssuerName();

  /// @brief Method get_KeyAlgorithm, addr 0x595b454, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_KeyAlgorithm();

  /// @brief Method get_KeyAlgorithmParameters, addr 0x595b45c, size 0x74, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_KeyAlgorithmParameters();

  /// @brief Method get_PublicKey, addr 0x595b4d8, size 0x74, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_PublicKey();

  /// @brief Method get_RSA, addr 0x595b54c, size 0x180, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::RSA* get_RSA();

  /// @brief Method get_RawData, addr 0x595b6dc, size 0x74, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_RawData();

  /// @brief Method get_SerialNumber, addr 0x595b750, size 0x74, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_SerialNumber();

  /// @brief Method get_Signature, addr 0x595b7c4, size 0x46c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_Signature();

  /// @brief Method get_SubjectName, addr 0x595bc30, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_SubjectName();

  /// @brief Method get_ValidFrom, addr 0x595bc38, size 0x8, virtual true, abstract: false, final false
  inline ::System::DateTime get_ValidFrom();

  /// @brief Method get_ValidUntil, addr 0x595bc40, size 0x8, virtual true, abstract: false, final false
  inline ::System::DateTime get_ValidUntil();

  /// @brief Method get_Version, addr 0x595bc48, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DSA, addr 0x595b1f4, size 0x10, virtual false, abstract: false, final false
  inline void set_DSA(::System::Security::Cryptography::DSA* value);

  /// @brief Method set_KeyAlgorithmParameters, addr 0x595b4d0, size 0x8, virtual true, abstract: false, final false
  inline void set_KeyAlgorithmParameters(::ArrayW<uint8_t> value);

  /// @brief Method set_RSA, addr 0x595b6cc, size 0x10, virtual true, abstract: false, final false
