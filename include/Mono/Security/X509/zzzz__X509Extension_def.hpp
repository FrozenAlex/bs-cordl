...
public:
  ...
  /// @brief Method Decode, addr 0x5a94118, size 0x4, virtual true, abstract: false, final false
  inline void Decode();

  /// @brief Method Encode, addr 0x5a9411c, size 0x4, virtual true, abstract: false, final false
  inline void Encode();

  /// @brief Method Equals, addr 0x5a94130, size 0x12c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x5a9425c, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5a944b8, size 0xdc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method WriteLine, addr 0x5a94278, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a93cf8, size 0x2bc, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::ASN1* asn1);

  /// @brief Method .ctor, addr 0x5a93fb4, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::X509::X509Extension* extension);

  /// @brief Method get_Critical, addr 0x5a94128, size 0x8, virtual false, abstract: false, final false
  inline bool get_Critical();

  /// @brief Method get_Oid, addr 0x5a94120, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Oid();

  /// @brief Method get_Value, addr 0x5a940ec, size 0x2c, virtual false, abstract: false, final false
