...
public:
  ...
  /// @brief Method Add, addr 0x5a84b78, size 0x98, virtual false, abstract: false, final false
  inline ::Mono::Security::ASN1* Add(::Mono::Security::ASN1* asn1);

  /// @brief Method CompareArray, addr 0x5a84af8, size 0x70, virtual false, abstract: false, final false
  inline bool CompareArray(::ArrayW<uint8_t> array1, ::ArrayW<uint8_t> array2);

  /// @brief Method CompareValue, addr 0x5a84b68, size 0x10, virtual false, abstract: false, final false
  inline bool CompareValue(::ArrayW<uint8_t> value);

  /// @brief Method Decode, addr 0x5a84880, size 0x110, virtual false, abstract: false, final false
  inline void Decode(::ArrayW<uint8_t> asn1, ::by_ref<int32_t> anPos, int32_t anLength);

  /// @brief Method DecodeTLV, addr 0x5a85278, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method Element, addr 0x5a854dc, size 0x15c, virtual false, abstract: false, final false
  inline ::Mono::Security::ASN1* Element(int32_t index, uint8_t anTag);

  /// @brief Method GetBytes, addr 0x5a84c10, size 0x668, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5a85638, size 0x31c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a84728, size 0x158, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> data);

  /// @brief Method .ctor, addr 0x5a84710, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(uint8_t tag);

  /// @brief Method .ctor, addr 0x5a8471c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(uint8_t tag, ::ArrayW<uint8_t> data);

  /// @brief Method get_Count, addr 0x5a84990, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x5a8539c, size 0x140, virtual false, abstract: false, final false
  inline ::Mono::Security::ASN1* get_Item(int32_t index);

  /// @brief Method get_Length, addr 0x5a849b4, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_Length();

  /// @brief Method get_Tag, addr 0x5a849ac, size 0x8, virtual false, abstract: false, final false
  inline uint8_t get_Tag();

  /// @brief Method get_Value, addr 0x5a849cc, size 0x90, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> get_Value();

  /// @brief Method set_Value, addr 0x5a84a5c, size 0x9c, virtual false, abstract: false, final false
