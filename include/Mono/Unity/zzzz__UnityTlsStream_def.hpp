...
public:
  // Declarations
  /// @brief Method CreateContext, addr 0x5e957a8, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e94ca0, size 0x98, virtual false, abstract: false, final false
