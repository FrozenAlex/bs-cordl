...
public:
  ...
  /// @brief Method Dispose, addr 0x59735b0, size 0x28, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GFree, addr 0x5973564, size 0xc, virtual false, abstract: false, final false
  static inline void GFree(::System::IntPtr ptr);

  /// @brief Method StringToUtf8, addr 0x5973550, size 0x14, virtual false, abstract: false, final false
  static inline ::System::IntPtr StringToUtf8(::StringW str);

  /// @brief Method StringToUtf8_icall, addr 0x597354c, size 0x4, virtual false, abstract: false, final false
  static inline ::System::IntPtr StringToUtf8_icall(::by_ref<::StringW> str);

  /// @brief Method .ctor, addr 0x5973344, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW str);

  /// @brief Method get_Value, addr 0x5973570, size 0x40, virtual false, abstract: false, final false
