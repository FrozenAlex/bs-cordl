...
public:
  ...
  /// @brief Method EnsureInitialized, addr 0x5e8f130, size 0x150, virtual false, abstract: false, final false
  static inline void EnsureInitialized();

  /// @brief Method GetX509Pal, addr 0x5e8f084, size 0x54, virtual false, abstract: false, final false
  static inline ::Mono::X509PalImpl* GetX509Pal();

  /// @brief Method Import, addr 0x5e8f64c, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method Import, addr 0x5e8f540, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method Import, addr 0x5e8f2e0, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method Mono.ISystemCertificateProvider.Import, addr 0x5e8f648, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method Mono.ISystemCertificateProvider.Import, addr 0x5e8f53c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateImpl*
  Mono_ISystemCertificateProvider_Import(::ArrayW<uint8_t> data, ::Microsoft::Win32::SafeHandles::SafePasswordHandle* password,
  ...
  /// @brief Method .ctor, addr 0x5e8f770, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_X509Pal, addr 0x5e8f280, size 0x60, virtual false, abstract: false, final false
