...
public:
  ...
  /// @brief Method .ctor, addr 0x5c74284, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x5c7428c, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Bson::BsonEmpty) == 0x20, "Size mismatch!");
