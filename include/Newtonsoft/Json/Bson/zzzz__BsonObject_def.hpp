...
public:
  ...
  /// @brief Method Add, addr 0x5da9f30, size 0x11c, virtual false, abstract: false, final false
  inline void Add(::StringW name, ::Newtonsoft::Json::Bson::BsonToken* token);

  /// @brief Method GetEnumerator, addr 0x5da7d54, size 0x88, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x5daa06c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5daa070, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Type, addr 0x5daa064, size 0x8, virtual true, abstract: false, final false
