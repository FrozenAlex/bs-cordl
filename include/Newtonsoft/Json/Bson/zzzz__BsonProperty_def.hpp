...
public:
  ...
  /// @brief Method .ctor, addr 0x5c740b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Name, addr 0x5c74508, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Bson::BsonString* get_Name();

  /// @brief Method get_Value, addr 0x5c74518, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Bson::BsonToken* get_Value();

  /// @brief Method set_Name, addr 0x5c74510, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::Newtonsoft::Json::Bson::BsonString* value);

  /// @brief Method set_Value, addr 0x5c74520, size 0x8, virtual false, abstract: false, final false
