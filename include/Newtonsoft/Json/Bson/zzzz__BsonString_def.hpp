...
public:
  ...
  /// @brief Method .ctor, addr 0x5daa050, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* value, bool includeLength);

  /// @brief Method get_ByteCount, addr 0x5daa3ac, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ByteCount();

  /// @brief Method get_IncludeLength, addr 0x5daa3bc, size 0x8, virtual false, abstract: false, final false
  inline bool get_IncludeLength();

  /// @brief Method set_ByteCount, addr 0x5daa3b4, size 0x8, virtual false, abstract: false, final false
