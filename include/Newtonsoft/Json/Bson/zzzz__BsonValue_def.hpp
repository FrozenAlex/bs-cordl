...
public:
  ...
  /// @brief Method .ctor, addr 0x5c74310, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* value, ::Newtonsoft::Json::Bson::BsonType type);

  /// @brief Method get_Type, addr 0x5c74324, size 0x8, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Bson::BsonType get_Type();

  /// @brief Method get_Value, addr 0x5c7431c, size 0x8, virtual false, abstract: false, final false
