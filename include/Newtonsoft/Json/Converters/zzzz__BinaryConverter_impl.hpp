...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Newtonsoft::Json::Converters::BinaryConverter::*)(
  ...
  constexpr static std::size_t addrs = 0x5d91e5c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Converters::BinaryConverter*>(), { ::i2c::class_of<::Newtonsoft::Json::Converters::BinaryConverter*>(), 4 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::ArrayW<uint8_t> (::Newtonsoft::Json::Converters::BinaryConverter::*)(::System::Object*)>(
    &::Newtonsoft::Json::Converters::BinaryConverter::GetByteArray)> {
  constexpr static std::size_t size = 0x1e8;
  constexpr static std::size_t addrs = 0x5d91eb0;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Converters::BinaryConverter*>(), { "GetByteArray", {}, { ::i2c::type_of<::System::Object*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (*)(::System::Type*)>(&::Newtonsoft::Json::Converters::BinaryConverter::EnsureReflectionObject)> {
  ...
  constexpr static std::size_t addrs = 0x5d92098;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Converters::BinaryConverter*>(), { "EnsureReflectionObject", {}, { ::i2c::type_of<::System::Type*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Converters::BinaryConverter*>(), { ::i2c::class_of<::Newtonsoft::Json::Converters::BinaryConverter*>(), 5 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::ArrayW<uint8_t> (::Newtonsoft::Json::Converters::BinaryConverter::*)(::Newtonsoft::Json::JsonReader*)>(
    &::Newtonsoft::Json::Converters::BinaryConverter::ReadByteArray)> {
  constexpr static std::size_t size = 0x2b0;
  constexpr static std::size_t addrs = 0x5d9261c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Converters::BinaryConverter*>(), { "ReadByteArray", {}, { ::i2c::type_of<::Newtonsoft::Json::JsonReader*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::Newtonsoft::Json::Converters::BinaryConverter::*)(::System::Type*)>(&::Newtonsoft::Json::Converters::BinaryConverter::CanConvert)> {
  ...
  constexpr static std::size_t addrs = 0x5d928cc;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Converters::BinaryConverter*>(), { ::i2c::class_of<::Newtonsoft::Json::Converters::BinaryConverter*>(), 6 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Newtonsoft::Json::Converters::BinaryConverter::*)()>(&::Newtonsoft::Json::Converters::BinaryConverter::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5d929c4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Converters::BinaryConverter*>(), { ".ctor", {}, {} })));
    return ___internal_method;
  }
};
inline void Newtonsoft::Json::Converters::BinaryConverter::setStaticF__reflectionObject(::Newtonsoft::Json::Utilities::ReflectionObject* value) {
  ::cordl_internals::setStaticField<::Newtonsoft::Json::Utilities::ReflectionObject*, "_reflectionObject", ::Newtonsoft::Json::Converters::BinaryConverter*>(
...
inline void Newtonsoft::Json::Converters::BinaryConverter::WriteJson(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value, ::Newtonsoft::Json::JsonSerializer* serializer) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Newtonsoft::Json::Converters::BinaryConverter*>(), 4 })));
...
inline ::System::Object* Newtonsoft::Json::Converters::BinaryConverter::ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, ::System::Object* existingValue,
  ...
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Newtonsoft::Json::Converters::BinaryConverter*>(), 5 })));
...
inline bool Newtonsoft::Json::Converters::BinaryConverter::CanConvert(::System::Type* objectType) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Newtonsoft::Json::Converters::BinaryConverter*>(), 6 })));
