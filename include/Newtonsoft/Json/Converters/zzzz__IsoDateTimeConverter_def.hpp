...
public:
  ...
  /// @brief Method ReadJson, addr 0x5d972a8, size 0x4b4, virtual true, abstract: false, final false
  inline ::System::Object* ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, ::System::Object* existingValue, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method WriteJson, addr 0x5d97050, size 0x258, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d9775c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Culture, addr 0x5d96fdc, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Globalization::CultureInfo* get_Culture();

  /// @brief Method get_DateTimeFormat, addr 0x5d96f98, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_DateTimeFormat();

  /// @brief Method get_DateTimeStyles, addr 0x5d96f88, size 0x8, virtual false, abstract: false, final false
  inline ::System::Globalization::DateTimeStyles get_DateTimeStyles();

  /// @brief Method set_Culture, addr 0x5d97048, size 0x8, virtual false, abstract: false, final false
  inline void set_Culture(::System::Globalization::CultureInfo* value);

  /// @brief Method set_DateTimeFormat, addr 0x5d96fb8, size 0x24, virtual false, abstract: false, final false
  inline void set_DateTimeFormat(::StringW value);

  /// @brief Method set_DateTimeStyles, addr 0x5d96f90, size 0x8, virtual false, abstract: false, final false
