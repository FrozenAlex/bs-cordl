...
public:
  ...
  /// @brief Method .ctor, addr 0x5c66c54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XAttribute* attribute);

  /// @brief Method get_Attribute, addr 0x5c677cc, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XAttribute* get_Attribute();

  /// @brief Method get_LocalName, addr 0x5c6789c, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_NamespaceUri, addr 0x5c678c0, size 0x2c, virtual true, abstract: false, final false
  inline ::StringW get_NamespaceUri();

  /// @brief Method get_ParentNode, addr 0x5c678ec, size 0x44, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Converters::IXmlNode* get_ParentNode();

  /// @brief Method get_Value, addr 0x5c67848, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x5c67864, size 0x38, virtual true, abstract: false, final false
