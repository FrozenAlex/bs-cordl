...
public:
  ...
  /// @brief Method AppendChild, addr 0x5d9bd44, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method WrapNode, addr 0x5d9b62c, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d9a7ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNode* node);

  /// @brief Method get_Attributes, addr 0x5d9b7c8, size 0x400, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* get_Attributes();

  /// @brief Method get_ChildNodes, addr 0x5d9b224, size 0x408, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* get_ChildNodes();

  /// @brief Method get_HasAttributes, addr 0x5d9bbc8, size 0xb4, virtual false, abstract: false, final false
  inline bool get_HasAttributes();

  /// @brief Method get_HasChildNodes, addr 0x5d9b7a8, size 0x20, virtual true, abstract: false, final false
  inline bool get_HasChildNodes();

  /// @brief Method get_LocalName, addr 0x5d9b204, size 0x20, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_NamespaceUri, addr 0x5d9bdf4, size 0x20, virtual true, abstract: false, final true
  inline ::StringW get_NamespaceUri();

  /// @brief Method get_NodeType, addr 0x5d9b1e8, size 0x1c, virtual true, abstract: false, final true
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_ParentNode, addr 0x5d9bc7c, size 0xac, virtual true, abstract: false, final true
  inline ::Newtonsoft::Json::Converters::IXmlNode* get_ParentNode();

  /// @brief Method get_Value, addr 0x5d9bd28, size 0x1c, virtual true, abstract: false, final true
  inline ::StringW get_Value();

  /// @brief Method get_WrappedNode, addr 0x5d9b1e0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* get_WrappedNode();

  /// @brief Convert to "::Newtonsoft::Json::Converters::IXmlNode"
  constexpr ::Newtonsoft::Json::Converters::IXmlNode* i___Newtonsoft__Json__Converters__IXmlNode() noexcept;

  /// @brief Method set_Value, addr 0x5d9ae24, size 0x1c, virtual true, abstract: false, final true
