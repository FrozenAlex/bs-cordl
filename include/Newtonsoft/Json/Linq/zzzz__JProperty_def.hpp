...
public:
  ...
  /// @brief Method MoveNext, addr 0x5c3e534, size 0x54, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::Newtonsoft::Json::Linq::JPropertyList_JProperty__GetEnumerator_d__1* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<Newtonsoft.Json.Linq.JToken>.get_Current, addr 0x5c3e588, size 0x8, virtual true, abstract: false, final true
  inline ::Newtonsoft::Json::Linq::JToken* System_Collections_Generic_IEnumerator_Newtonsoft_Json_Linq_JToken__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5c3e590, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5c3e5c8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5c3e530, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5c3e3c4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x5c3e3d0, size 0x8, virtual true, abstract: false, final true
  inline void Add(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method Clear, addr 0x5c3e3d8, size 0x8, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method Contains, addr 0x5c3e3e0, size 0x10, virtual true, abstract: false, final true
  inline bool Contains(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method CopyTo, addr 0x5c3e3f0, size 0x64, virtual true, abstract: false, final true
  inline void CopyTo(::ArrayW<::Newtonsoft::Json::Linq::JToken*> array, int32_t arrayIndex);

  /// @brief Method GetEnumerator, addr 0x5c3e370, size 0x54, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::Newtonsoft::Json::Linq::JToken*>* GetEnumerator();

  /// @brief Method IndexOf, addr 0x5c3dcc0, size 0x10, virtual true, abstract: false, final true
  inline int32_t IndexOf(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method Insert, addr 0x5c3e488, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method Remove, addr 0x5c3e454, size 0x1c, virtual true, abstract: false, final true
  inline bool Remove(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method RemoveAt, addr 0x5c3e498, size 0x10, virtual true, abstract: false, final true
  inline void RemoveAt(int32_t index);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x5c3e3cc, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5c3d91c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x5c3e470, size 0x10, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly, addr 0x5c3e480, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsReadOnly();

  /// @brief Method get_Item, addr 0x5c3e4a8, size 0x44, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Item, addr 0x5c3e4ec, size 0x44, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5c3e5d0, size 0x6a0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5c3ec70, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5c3ecf0, size 0x274, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5c3ef64, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
  ...
  // "::ArrayW<::Newtonsoft::Json::JsonConverter*>", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty:
...
public:
  ...
  /// @brief Method ClearItems, addr 0x5c3ded4, size 0xac, virtual true, abstract: false, final false
  inline void ClearItems();

  /// @brief Method CloneToken, addr 0x5c3e02c, size 0x6c, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* CloneToken(::Newtonsoft::Json::Linq::JsonCloneSettings* settings);

  /// @brief Method ContainsItem, addr 0x5c3ddec, size 0x20, virtual true, abstract: false, final false
  inline bool ContainsItem(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method DeepEquals, addr 0x5c3df80, size 0xac, virtual true, abstract: false, final false
  inline bool DeepEquals(::Newtonsoft::Json::Linq::JToken* node);

  /// @brief Method GetDeepHashCode, addr 0x5c3e124, size 0x50, virtual true, abstract: false, final false
  inline int32_t GetDeepHashCode();

  /// @brief Method GetItem, addr 0x5c3d9a0, size 0x54, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* GetItem(int32_t index);

  /// @brief Method IndexOfItem, addr 0x5c3dc94, size 0x2c, virtual true, abstract: false, final false
  inline int32_t IndexOfItem(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method InsertItem, addr 0x5c3dcd0, size 0x11c, virtual true, abstract: false, final false
  inline bool InsertItem(int32_t index, ::Newtonsoft::Json::Linq::JToken* item, bool skipParentCheck, bool copyAnnotations);

  /// @brief Method Load, addr 0x5c3e174, size 0x8, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JProperty* Load(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method Load, addr 0x5c3e17c, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadAsync, addr 0x5c3d790, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadAsync, addr 0x5c3d79c, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method MergeItem, addr 0x5c3de0c, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method RemoveItem, addr 0x5c3db3c, size 0xac, virtual true, abstract: false, final false
  inline bool RemoveItem(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method RemoveItemAt, addr 0x5c3dbe8, size 0xac, virtual true, abstract: false, final false
  inline void RemoveItemAt(int32_t index);

  /// @brief Method SetItem, addr 0x5c3d9f4, size 0x148, virtual true, abstract: false, final false
  inline void SetItem(int32_t index, ::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method WriteTo, addr 0x5c3e0a4, size 0x80, virtual true, abstract: false, final false
  inline void WriteTo(::Newtonsoft::Json::JsonWriter* writer, ::ArrayW<::Newtonsoft::Json::JsonConverter*> converters);

  /// @brief Method WriteToAsync, addr 0x5c3d6b0, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteToAsync, addr 0x5c3d578, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteValueAsync, addr 0x5c3d664, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c3692c, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x5c3e0a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::ArrayW<::System::Object*> content);

  /// @brief Method .ctor, addr 0x5c3b038, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::System::Object* content);

  /// @brief Method .ctor, addr 0x5c3d8a0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Linq::JProperty* other);

  /// @brief Method .ctor, addr 0x5c3d920, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Linq::JProperty* other, ::Newtonsoft::Json::Linq::JsonCloneSettings* settings);

  /// @brief Method get_ChildrenTokens, addr 0x5c3d890, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::Newtonsoft::Json::Linq::JToken*>* get_ChildrenTokens();

  /// @brief Method get_Name, addr 0x5c3d898, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Type, addr 0x5c3e098, size 0x8, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JTokenType get_Type();

  /// @brief Method get_Value, addr 0x5c3654c, size 0x18, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* get_Value();

  /// @brief Method set_Value, addr 0x5c3a0a4, size 0x84, virtual false, abstract: false, final false
