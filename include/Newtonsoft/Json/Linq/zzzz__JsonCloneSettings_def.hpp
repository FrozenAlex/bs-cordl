...
public:
  ...
  /// @brief Method .ctor, addr 0x5c408c4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::Newtonsoft::Json::Linq::JsonCloneSettings* getStaticF_SkipCopyAnnotations();

  /// @brief Method get_CopyAnnotations, addr 0x5c408d0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_CopyAnnotations, addr 0x5c408d8, size 0x8, virtual false, abstract: false, final false
