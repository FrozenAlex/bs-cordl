...
public:
  // Declarations
  /// @brief Method GetKeyForItem, addr 0x5d62ea4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d612dc, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
