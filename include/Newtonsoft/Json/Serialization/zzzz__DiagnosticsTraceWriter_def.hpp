...
public:
  ...
  /// @brief Method GetTraceEventType, addr 0x5d3c4b0, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method Trace, addr 0x5d3c518, size 0x460, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5d3c978, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_LevelFilter, addr 0x5d3c4a0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_LevelFilter, addr 0x5d3c4a8, size 0x8, virtual false, abstract: false, final false
