...
public:
  ...
  /// @brief Method CreateTemporaryDictionary, addr 0x5d3e6f8, size 0x26c, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionary* CreateTemporaryDictionary();

  /// @brief Method CreateWrapper, addr 0x5d3e460, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d36fec, size 0x9ac, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* underlyingType);

  /// @brief Method get_DictionaryKeyResolver, addr 0x5d3e2bc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Func_2<::StringW, ::StringW>* get_DictionaryKeyResolver();

  /// @brief Method get_DictionaryKeyType, addr 0x5d3e2cc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_DictionaryKeyType();

  /// @brief Method get_DictionaryValueType, addr 0x5d3e2d4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_DictionaryValueType();

  /// @brief Method get_HasParameterizedCreator, addr 0x5d3e3cc, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasParameterizedCreator();

  /// @brief Method get_HasParameterizedCreatorInternal, addr 0x5d3e3dc, size 0x84, virtual false, abstract: false, final false
  inline bool get_HasParameterizedCreatorInternal();

  /// @brief Method get_KeyContract, addr 0x5d3e2dc, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonContract* get_KeyContract();

  /// @brief Method get_OverrideCreator, addr 0x5d3e3bc, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>* get_OverrideCreator();

  /// @brief Method get_ParameterizedCreator, addr 0x5d3e2f4, size 0xc8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>* get_ParameterizedCreator();

  /// @brief Method get_ShouldCreateWrapper, addr 0x5d3e2ec, size 0x8, virtual false, abstract: false, final false
  inline bool get_ShouldCreateWrapper();

  /// @brief Method set_DictionaryKeyResolver, addr 0x5d3e2c4, size 0x8, virtual false, abstract: false, final false
  inline void set_DictionaryKeyResolver(::System::Func_2<::StringW, ::StringW>* value);

  /// @brief Method set_HasParameterizedCreator, addr 0x5d3e3d4, size 0x8, virtual false, abstract: false, final false
  inline void set_HasParameterizedCreator(bool value);

  /// @brief Method set_KeyContract, addr 0x5d3e2e4, size 0x8, virtual false, abstract: false, final false
  inline void set_KeyContract(::Newtonsoft::Json::Serialization::JsonContract* value);

  /// @brief Method set_OverrideCreator, addr 0x5d3e3c4, size 0x8, virtual false, abstract: false, final false
