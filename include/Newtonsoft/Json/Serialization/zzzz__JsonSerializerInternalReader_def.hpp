...
public:
  ...
  /// @brief Method .ctor, addr 0x5d4c83c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <CreateObjectUsingCreatorWithParameters>b__38_0, addr 0x5d4c89c, size 0x14, virtual false, abstract: false, final false
  inline ::StringW _CreateObjectUsingCreatorWithParameters_b__38_0(::Newtonsoft::Json::Serialization::JsonProperty* p);

  /// @brief Method <CreateObjectUsingCreatorWithParameters>b__38_2, addr 0x5d4c8b0, size 0x14, virtual false, abstract: false, final false
  inline ::StringW _CreateObjectUsingCreatorWithParameters_b__38_2(::Newtonsoft::Json::Serialization::JsonProperty* p);

  /// @brief Method <PopulateObject>b__42_0, addr 0x5d4c8c4, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonProperty* _PopulateObject_b__42_0(::Newtonsoft::Json::Serialization::JsonProperty* m);

  /// @brief Method <PopulateObject>b__42_1, addr 0x5d4c8cc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d4c898, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <CreateObjectUsingCreatorWithParameters>b__1, addr 0x5d4c8d8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d4c8d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddReference, addr 0x5d496a4, size 0x3dc, virtual false, abstract: false, final false
  inline void AddReference(::Newtonsoft::Json::JsonReader* reader, ::StringW id, ::System::Object* value);

  /// @brief Method CalculatePropertyDetails, addr 0x5d49044, size 0x578, virtual false, abstract: false, final false
  inline bool CalculatePropertyDetails(::Newtonsoft::Json::Serialization::JsonProperty* property, ::by_ref<::Newtonsoft::Json::JsonConverter*> propertyConverter,
                                       ...
                                       ::Newtonsoft::Json::JsonReader* reader, ::System::Object* target, ::by_ref<bool> useExistingValue, ::by_ref<::System::Object*> currentValue,
                                       ::by_ref<::Newtonsoft::Json::Serialization::JsonContract*> propertyContract, ::by_ref<bool> gottenCurrentValue, ::by_ref<bool> ignoredValue);

  /// @brief Method CheckPropertyName, addr 0x5d44188, size 0x11c, virtual false, abstract: false, final false
  inline bool CheckPropertyName(::Newtonsoft::Json::JsonReader* reader, ::StringW memberName);

  /// @brief Method CoerceEmptyStringToNull, addr 0x5d45930, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDynamic, addr 0x5d46d44, size 0x658, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateISerializable, addr 0x5d4739c, size 0x6b8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateISerializableItem, addr 0x5d3ef8c, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateJObject, addr 0x5d43e30, size 0x358, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* CreateJObject(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method CreateJToken, addr 0x5d43a80, size 0x3b0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateList, addr 0x5d44d18, size 0x690, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewDictionary, addr 0x5d46afc, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewList, addr 0x5d481bc, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewObject, addr 0x5d468bc, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateObject, addr 0x5d442a4, size 0xa74, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateObjectUsingCreatorWithParameters, addr 0x5d4a044, size 0x172c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateValueInternal, addr 0x5d434c8, size 0x4dc, virtual false, abstract: false, final false
  ...
  /// @brief Method Deserialize, addr 0x5d42ce0, size 0x358, virtual false, abstract: false, final false
  inline ::System::Object* Deserialize(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, bool checkAdditionalContent);

  /// @brief Method DeserializeConvertable, addr 0x5d430a4, size 0x424, virtual false, abstract: false, final false
  ...
  /// @brief Method EndProcessProperty, addr 0x5d4be00, size 0x48c, virtual false, abstract: false, final false
  ...
  /// @brief Method EnsureArrayContract, addr 0x5d48040, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method EnsureType, addr 0x5d453a8, size 0x588, virtual false, abstract: false, final false
  ...
  /// @brief Method GetContract, addr 0x5d42c24, size 0xbc, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonContract* GetContract(::System::Type* type);

  /// @brief Method GetContractSafe, addr 0x5d42bd0, size 0x54, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonContract* GetContractSafe(::System::Type* type);

  /// @brief Method GetConverter, addr 0x5d43038, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetExpectedDescription, addr 0x5d459f8, size 0xd8, virtual false, abstract: false, final false
  inline ::StringW GetExpectedDescription(::Newtonsoft::Json::Serialization::JsonContract* contract);

  /// @brief Method GetInternalSerializer, addr 0x5d43a14, size 0x6c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonSerializerProxy* GetInternalSerializer();

  /// @brief Method HandleError, addr 0x5d439a4, size 0x70, virtual false, abstract: false, final false
  inline void HandleError(::Newtonsoft::Json::JsonReader* reader, bool readPastError, int32_t initialDepth);

  /// @brief Method HasFlag, addr 0x5d49698, size 0xc, virtual false, abstract: false, final false
  inline bool HasFlag(::Newtonsoft::Json::DefaultValueHandling value, ::Newtonsoft::Json::DefaultValueHandling flag);

  /// @brief Method HasNoDefinedType, addr 0x5d467fc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDeserialized, addr 0x5d49cc0, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDeserializing, addr 0x5d49a80, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method Populate, addr 0x5d40c48, size 0x548, virtual false, abstract: false, final false
  inline void Populate(::Newtonsoft::Json::JsonReader* reader, ::System::Object* target);

  /// @brief Method PopulateDictionary, addr 0x5d416b8, size 0xa4c, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateList, addr 0x5d41190, size 0x528, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateMultidimensionalArray, addr 0x5d4845c, size 0x708, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateObject, addr 0x5d42104, size 0xacc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadExtensionDataValue, addr 0x5d4c28c, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadMetadataProperties, addr 0x5d4620c, size 0x5f0, virtual false, abstract: false, final false
  inline bool ReadMetadataProperties(::Newtonsoft::Json::JsonReader* reader, ::by_ref<::System::Type*> objectType, ::by_ref<::Newtonsoft::Json::Serialization::JsonContract*> contract,
                                     ::Newtonsoft::Json::Serialization::JsonProperty* member, ::Newtonsoft::Json::Serialization::JsonContainerContract* containerContract,
                                     ::Newtonsoft::Json::Serialization::JsonProperty* containerMember, ::System::Object* existingValue, ::by_ref<::System::Object*> newValue, ::by_ref<::StringW> id);

  /// @brief Method ReadMetadataPropertiesToken, addr 0x5d45ad0, size 0x73c, virtual false, abstract: false, final false
  inline bool ReadMetadataPropertiesToken(::Newtonsoft::Json::Linq::JTokenReader* reader, ::by_ref<::System::Type*> objectType, ::by_ref<::Newtonsoft::Json::Serialization::JsonContract*> contract,
                                          ::Newtonsoft::Json::Serialization::JsonProperty* member, ::Newtonsoft::Json::Serialization::JsonContainerContract* containerContract,
                                          ::Newtonsoft::Json::Serialization::JsonProperty* containerMember, ::System::Object* existingValue, ::by_ref<::System::Object*> newValue,
                                          ::by_ref<::StringW> id);

  /// @brief Method ResolvePropertyAndCreatorValues, addr 0x5d4b770, size 0x690, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveTypeName, addr 0x5d47a54, size 0x5ec, virtual false, abstract: false, final false
  inline void ResolveTypeName(::Newtonsoft::Json::JsonReader* reader, ::by_ref<::System::Type*> objectType, ::by_ref<::Newtonsoft::Json::Serialization::JsonContract*> contract,
                              ::Newtonsoft::Json::Serialization::JsonProperty* member, ::Newtonsoft::Json::Serialization::JsonContainerContract* containerContract,
                              ::Newtonsoft::Json::Serialization::JsonProperty* containerMember, ::StringW qualifiedTypeName);

  /// @brief Method SetExtensionData, addr 0x5d4c358, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPropertyPresence, addr 0x5d4c728, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPropertyValue, addr 0x5d48b64, size 0x4e0, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldDeserialize, addr 0x5d4c4c4, size 0x264, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldSetPropertyValue, addr 0x5d495bc, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method ThrowUnexpectedEndException, addr 0x5d49f00, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d40c44, size 0x4, virtual false, abstract: false, final false
