...
public:
  ...
  /// @brief Method CalculatePropertyValues, addr 0x5d51b10, size 0x438, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckForCircularReference, addr 0x5d50bc8, size 0x4f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetContract, addr 0x5d4d874, size 0xd0, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonContract* GetContract(::System::Object* value);

  /// @brief Method GetContractSafe, addr 0x5d4cc00, size 0x10, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonContract* GetContractSafe(::System::Object* value);

  /// @brief Method GetInternalSerializer, addr 0x5d4d78c, size 0x68, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonSerializerProxy* GetInternalSerializer();

  /// @brief Method GetPropertyName, addr 0x5d51f48, size 0x4f4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetReference, addr 0x5d510b8, size 0x1f4, virtual false, abstract: false, final false
  inline ::StringW GetReference(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value);

  /// @brief Method HandleError, addr 0x5d4d714, size 0x78, virtual false, abstract: false, final false
  inline void HandleError(::Newtonsoft::Json::JsonWriter* writer, int32_t initialDepth);

  /// @brief Method HasCreatorParameter, addr 0x5d528fc, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method HasFlag, addr 0x5d50bbc, size 0xc, virtual false, abstract: false, final false
  inline bool HasFlag(::Newtonsoft::Json::DefaultValueHandling value, ::Newtonsoft::Json::DefaultValueHandling flag);

  /// @brief Method HasFlag, addr 0x5d50ae0, size 0xc, virtual false, abstract: false, final false
  inline bool HasFlag(::Newtonsoft::Json::PreserveReferencesHandling value, ::Newtonsoft::Json::PreserveReferencesHandling flag);

  /// @brief Method HasFlag, addr 0x5d52c28, size 0xc, virtual false, abstract: false, final false
  inline bool HasFlag(::Newtonsoft::Json::TypeNameHandling value, ::Newtonsoft::Json::TypeNameHandling flag);

  /// @brief Method IsSpecified, addr 0x5d5269c, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSerialized, addr 0x5d517a0, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSerializing, addr 0x5d51588, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveIsReference, addr 0x5d50a20, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method Serialize, addr 0x5d4c984, size 0x27c, virtual false, abstract: false, final false
  inline void Serialize(::Newtonsoft::Json::JsonWriter* jsonWriter, ::System::Object* value, ::System::Type* objectType);

  /// @brief Method SerializeConvertable, addr 0x5d4df28, size 0x52c, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeDictionary, addr 0x5d4f528, size 0x880, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeDynamic, addr 0x5d4fda8, size 0x7d4, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeISerializable, addr 0x5d5057c, size 0x4a4, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeList, addr 0x5d4eb9c, size 0x6f8, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeMultidimensionalArray, addr 0x5d4f294, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeMultidimensionalArray, addr 0x5d52ed4, size 0x388, virtual false, abstract: false, final false
  inline void SerializeMultidimensionalArray(::Newtonsoft::Json::JsonWriter* writer, ::System::Array* values, ::Newtonsoft::Json::Serialization::JsonArrayContract* contract,
                                             ::Newtonsoft::Json::Serialization::JsonProperty* member, int32_t initialDepth, ::ArrayW<int32_t> indices);

  /// @brief Method SerializeObject, addr 0x5d4e454, size 0x748, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializePrimitive, addr 0x5d4d944, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeString, addr 0x5d4f4a8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeValue, addr 0x5d4d05c, size 0x6b8, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldSerialize, addr 0x5d5243c, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldWriteDynamicProperty, addr 0x5d53340, size 0xc8, virtual false, abstract: false, final false
  inline bool ShouldWriteDynamicProperty(::System::Object* memberValue);

  /// @brief Method ShouldWriteProperty, addr 0x5d50aec, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldWriteReference, addr 0x5d4cc10, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldWriteType, addr 0x5d4dac0, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryConvertToString, addr 0x5d512ac, size 0xf8, virtual false, abstract: false, final false
  static inline bool TryConvertToString(::System::Object* value, ::System::Type* type, ::by_ref<::StringW> s);

  /// @brief Method WriteObjectStart, addr 0x5d519b8, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteReference, addr 0x5d4cdc4, size 0x298, virtual false, abstract: false, final false
  inline void WriteReference(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value);

  /// @brief Method WriteReferenceIdProperty, addr 0x5d529c8, size 0x260, virtual false, abstract: false, final false
  inline void WriteReferenceIdProperty(::Newtonsoft::Json::JsonWriter* writer, ::System::Type* type, ::System::Object* value);

  /// @brief Method WriteStartArray, addr 0x5d52c34, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteTypeProperty, addr 0x5d4dc90, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d4c8f8, size 0x8c, virtual false, abstract: false, final false
