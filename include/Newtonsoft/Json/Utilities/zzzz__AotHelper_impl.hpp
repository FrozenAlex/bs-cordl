...
template <typename T> inline void Newtonsoft::Json::Utilities::AotHelper___c__2_1<T>::_ctor() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Utilities::AotHelper___c__2_1<T>*>(), { ".ctor", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
template <typename T> inline void Newtonsoft::Json::Utilities::AotHelper___c__2_1<T>::_EnsureList_b__2_0() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Utilities::AotHelper___c__2_1<T>*>(), { "<EnsureList>b__2_0", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
...
inline void Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey, TValue>::setStaticF___9(::Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey, TValue>* value) {
  ::cordl_internals::setStaticField<::Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey, TValue>*, "<>9", ::Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey, TValue>*>(
...
template <typename TKey, typename TValue> inline void Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey, TValue>::_ctor() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey, TValue>*>(), { ".ctor", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
template <typename TKey, typename TValue> inline void Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey, TValue>::_EnsureDictionary_b__3_0() {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey, TValue>*>(), { "<EnsureDictionary>b__3_0", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (*)(::System::Action*)>(&::Newtonsoft::Json::Utilities::AotHelper::Ensure)> {
  ...
  constexpr static std::size_t addrs = 0x5d15c18;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Utilities::AotHelper*>(), { "Ensure", {}, { ::i2c::type_of<::System::Action*>() } })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (*)()>(&::Newtonsoft::Json::Utilities::AotHelper::IsFalse)> {
  ...
  constexpr static std::size_t addrs = 0x5d15d94;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Utilities::AotHelper*>(), { "IsFalse", {}, {} })));
    return ___internal_method;
  }
};
...
template <typename T> inline void Newtonsoft::Json::Utilities::AotHelper::EnsureType() {
  static auto* ___internal_method_base =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Utilities::AotHelper*>(), { "EnsureType", { ::i2c::class_of<T>() }, {} })));
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::make_generic(___internal_method_base, { ::i2c::class_of<T>() })));
  return ::cordl_internals::RunMethodRethrow<void>(nullptr, ___internal_method);
}
template <typename T> inline void Newtonsoft::Json::Utilities::AotHelper::EnsureList() {
  static auto* ___internal_method_base =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Utilities::AotHelper*>(), { "EnsureList", { ::i2c::class_of<T>() }, {} })));
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::make_generic(___internal_method_base, { ::i2c::class_of<T>() })));
  return ::cordl_internals::RunMethodRethrow<void>(nullptr, ___internal_method);
}
template <typename TKey, typename TValue> inline void Newtonsoft::Json::Utilities::AotHelper::EnsureDictionary() {
  static auto* ___internal_method_base = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Utilities::AotHelper*>(), { "EnsureDictionary", { ::i2c::class_of<TKey>(), ::i2c::class_of<TValue>() }, {} })));
