...
public:
  ...
  /// @brief Method MoveNext, addr 0x5d16e0c, size 0x3e8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5d171f4, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Encode, addr 0x5d16720, size 0x1a0, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t> buffer, int32_t index, int32_t count);

  /// @brief Method EncodeAsync, addr 0x5d16b44, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method Flush, addr 0x5d16a88, size 0xbc, virtual false, abstract: false, final false
  inline void Flush();

  /// @brief Method FlushAsync, addr 0x5d16cb4, size 0x158, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method FulfillFromLeftover, addr 0x5d168c0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method StoreLeftOverBytes, addr 0x5d1697c, size 0x10c, virtual false, abstract: false, final false
  inline void StoreLeftOverBytes(::ArrayW<uint8_t> buffer, int32_t index, ::by_ref<int32_t> count);

  /// @brief Method ValidateEncode, addr 0x5d1665c, size 0xc4, virtual false, abstract: false, final false
  inline void ValidateEncode(::ArrayW<uint8_t> buffer, int32_t index, int32_t count);

  /// @brief Method WriteChars, addr 0x5d1695c, size 0x20, virtual false, abstract: false, final false
  inline void WriteChars(::ArrayW<char16_t> chars, int32_t index, int32_t count);

  /// @brief Method WriteCharsAsync, addr 0x5d16c28, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d165d0, size 0x8c, virtual false, abstract: false, final false
