...
public:
  // Declarations
  /// @brief Method ByteArrayCompare, addr 0x5d29a94, size 0x7c, virtual false, abstract: false, final false
  static inline int32_t ByteArrayCompare(::ArrayW<uint8_t> a1, ::ArrayW<uint8_t> a2);

  /// @brief Method CreateArgumentOutOfRangeException, addr 0x5d1dab8, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLocalName, addr 0x5d29bc8, size 0x20, virtual false, abstract: false, final false
  static inline ::StringW GetLocalName(::StringW qualifiedName);

  /// @brief Method GetPrefix, addr 0x5d29b10, size 0x20, virtual false, abstract: false, final false
  static inline ::StringW GetPrefix(::StringW qualifiedName);

  /// @brief Method GetQualifiedNameParts, addr 0x5d29b30, size 0x98, virtual false, abstract: false, final false
  static inline void GetQualifiedNameParts(::StringW qualifiedName, ::by_ref<::StringW> prefix, ::by_ref<::StringW> localName);

  /// @brief Method GetRegexOptions, addr 0x5d29be8, size 0x84, virtual false, abstract: false, final false
  static inline ::System::Text::RegularExpressions::RegexOptions GetRegexOptions(::StringW optionsText);

  /// @brief Method ToString, addr 0x5d299ec, size 0xa8, virtual false, abstract: false, final false
  static inline ::StringW ToString(::System::Object* value);

  /// @brief Method ValueEquals, addr 0x5d296e0, size 0x30c, virtual false, abstract: false, final false
  static inline bool ValueEquals(::System::Object* objA, ::System::Object* objB);

  /// @brief Method Assert, addr 0x5d296dc, size 0x4, virtual false, abstract: false, final false
