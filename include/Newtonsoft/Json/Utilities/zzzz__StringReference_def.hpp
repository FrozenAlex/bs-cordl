...
public:
  ...
  /// @brief Method ToString, addr 0x5d2f3d0, size 0x10, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x5d2f3c4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<char16_t> chars, int32_t startIndex, int32_t length);

  /// @brief Method get_Chars, addr 0x5d2f3ac, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<char16_t> get_Chars();

  /// @brief Method get_Item, addr 0x5d2f37c, size 0x30, virtual false, abstract: false, final false
  inline char16_t get_Item(int32_t i);

  /// @brief Method get_Length, addr 0x5d2f3bc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Length();

  /// @brief Method get_StartIndex, addr 0x5d2f3b4, size 0x8, virtual false, abstract: false, final false
