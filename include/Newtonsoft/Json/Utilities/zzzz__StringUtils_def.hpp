...
public:
  ...
  /// @brief Method CreateStringWriter, addr 0x5bf9ba8, size 0xcc, virtual false, abstract: false, final false
  static inline ::System::IO::StringWriter* CreateStringWriter(int32_t capacity);

  /// @brief Method EndsWith, addr 0x5bfa2d4, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatWith, addr 0x5bf9634, size 0xac, virtual false, abstract: false, final false
  static inline ::StringW FormatWith(::StringW format, ::System::IFormatProvider* provider, ::System::Object* arg0);

  /// @brief Method FormatWith, addr 0x5bf9750, size 0xe0, virtual false, abstract: false, final false
  static inline ::StringW FormatWith(::StringW format, ::System::IFormatProvider* provider, ::System::Object* arg0, ::System::Object* arg1);

  /// @brief Method FormatWith, addr 0x5bf9830, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatWith, addr 0x5bf993c, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatWith, addr 0x5bf96e0, size 0x70, virtual false, abstract: false, final false
  static inline ::StringW FormatWith(::StringW format, ::System::IFormatProvider* provider, ::ArrayW<::System::Object*> args);

  /// @brief Method IndexOf, addr 0x5bfa274, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t IndexOf(::StringW s, char16_t c);

  /// @brief Method IsHighSurrogate, addr 0x5bfa20c, size 0x34, virtual false, abstract: false, final false
  static inline bool IsHighSurrogate(char16_t c);

  /// @brief Method IsLowSurrogate, addr 0x5bfa240, size 0x34, virtual false, abstract: false, final false
  static inline bool IsLowSurrogate(char16_t c);

  /// @brief Method IsNullOrEmpty, addr 0x5bf9618, size 0x1c, virtual false, abstract: false, final false
  static inline bool IsNullOrEmpty(::StringW value);

  /// @brief Method IsWhiteSpace, addr 0x5bf9ac8, size 0xe0, virtual false, abstract: false, final false
  static inline bool IsWhiteSpace(::StringW s);

  /// @brief Method Replace, addr 0x5bfa290, size 0x14, virtual false, abstract: false, final false
  static inline ::StringW Replace(::StringW s, ::StringW oldValue, ::StringW newValue);

  /// @brief Method StartsWith, addr 0x5bfa2a4, size 0x30, virtual false, abstract: false, final false
  static inline bool StartsWith(::StringW source, char16_t value);

  /// @brief Method ToCamelCase, addr 0x5bf9d2c, size 0x1b0, virtual false, abstract: false, final false
  static inline ::StringW ToCamelCase(::StringW s);

  /// @brief Method ToCharAsUnicode, addr 0x5bf9c74, size 0xb8, virtual false, abstract: false, final false
  static inline void ToCharAsUnicode(char16_t c, ::ArrayW<char16_t> buffer);

  /// @brief Method ToKebabCase, addr 0x5bfa204, size 0x8, virtual false, abstract: false, final false
  static inline ::StringW ToKebabCase(::StringW s);

  /// @brief Method ToLower, addr 0x5bf9edc, size 0x84, virtual false, abstract: false, final false
  static inline char16_t ToLower(char16_t c);

  /// @brief Method ToSeparatedCase, addr 0x5bf9f68, size 0x29c, virtual false, abstract: false, final false
  static inline ::StringW ToSeparatedCase(::StringW s, char16_t separator);

  /// @brief Method ToSnakeCase, addr 0x5bf9f60, size 0x8, virtual false, abstract: false, final false
  static inline ::StringW ToSnakeCase(::StringW s);

  /// @brief Method Trim, addr 0x5bfa308, size 0x194, virtual false, abstract: false, final false
