...
public:
  ...
  __declspec(property(get = __cordl_internal_get__ConverterParameters_k__BackingField, put = __cordl_internal_set__ConverterParameters_k__BackingField)) ::ArrayW<::System::Object*>
  ...
  /// @brief Method .ctor, addr 0x5b9c9b8, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* converterType);

  /// @brief Method .ctor, addr 0x5b9ca3c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* converterType, ::ArrayW<::System::Object*> converterParameters);

  /// @brief Method get_ConverterParameters, addr 0x5b9c9b0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*> get_ConverterParameters();

  /// @brief Method get_ConverterType, addr 0x5b9c9a8, size 0x8, virtual false, abstract: false, final false
