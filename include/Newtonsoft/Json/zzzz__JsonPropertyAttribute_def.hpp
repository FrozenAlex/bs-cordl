...
// Newtonsoft.Json.TypeNameHandling, System.Attribute, System.Nullable`1<T>, System.Object
namespace Newtonsoft::Json {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__ItemConverterParameters_k__BackingField, put = __cordl_internal_set__ItemConverterParameters_k__BackingField)) ::ArrayW<::System::Object*>
  ...
  __declspec(property(get = __cordl_internal_get__NamingStrategyParameters_k__BackingField, put = __cordl_internal_set__NamingStrategyParameters_k__BackingField)) ::ArrayW<::System::Object*>
  ...
  /// @brief Method .ctor, addr 0x5cd3fd0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5cd3fd4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW propertyName);

  /// @brief Method get_DefaultValueHandling, addr 0x5cd39a0, size 0x44, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::DefaultValueHandling get_DefaultValueHandling();

  /// @brief Method get_IsReference, addr 0x5cd3c10, size 0x44, virtual false, abstract: false, final false
  inline bool get_IsReference();

  /// @brief Method get_ItemConverterParameters, addr 0x5cd38d4, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*> get_ItemConverterParameters();

  /// @brief Method get_ItemConverterType, addr 0x5cd38c4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_ItemConverterType();

  /// @brief Method get_ItemIsReference, addr 0x5cd3f30, size 0x44, virtual false, abstract: false, final false
  inline bool get_ItemIsReference();

  /// @brief Method get_ItemReferenceLoopHandling, addr 0x5cd3df8, size 0x44, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::ReferenceLoopHandling get_ItemReferenceLoopHandling();

  /// @brief Method get_ItemTypeNameHandling, addr 0x5cd3e94, size 0x44, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::TypeNameHandling get_ItemTypeNameHandling();

  /// @brief Method get_NamingStrategyParameters, addr 0x5cd38f4, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*> get_NamingStrategyParameters();

  /// @brief Method get_NamingStrategyType, addr 0x5cd38e4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_NamingStrategyType();

  /// @brief Method get_NullValueHandling, addr 0x5cd3904, size 0x44, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::NullValueHandling get_NullValueHandling();

  /// @brief Method get_ObjectCreationHandling, addr 0x5cd3ad8, size 0x44, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::ObjectCreationHandling get_ObjectCreationHandling();

  /// @brief Method get_Order, addr 0x5cd3cb0, size 0x44, virtual false, abstract: false, final false
  inline int32_t get_Order();

  /// @brief Method get_PropertyName, addr 0x5cd3de8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_PropertyName();

  /// @brief Method get_ReferenceLoopHandling, addr 0x5cd3a3c, size 0x44, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::ReferenceLoopHandling get_ReferenceLoopHandling();

  /// @brief Method get_Required, addr 0x5cd3d4c, size 0x44, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Required get_Required();

  /// @brief Method get_TypeNameHandling, addr 0x5cd3b74, size 0x44, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::TypeNameHandling get_TypeNameHandling();

  /// @brief Method set_DefaultValueHandling, addr 0x5cd39e4, size 0x58, virtual false, abstract: false, final false
  inline void set_DefaultValueHandling(::Newtonsoft::Json::DefaultValueHandling value);

  /// @brief Method set_IsReference, addr 0x5cd3c54, size 0x5c, virtual false, abstract: false, final false
  inline void set_IsReference(bool value);

  /// @brief Method set_ItemConverterParameters, addr 0x5cd38dc, size 0x8, virtual false, abstract: false, final false
  inline void set_ItemConverterParameters(::ArrayW<::System::Object*> value);

  /// @brief Method set_ItemConverterType, addr 0x5cd38cc, size 0x8, virtual false, abstract: false, final false
  inline void set_ItemConverterType(::System::Type* value);

  /// @brief Method set_ItemIsReference, addr 0x5cd3f74, size 0x5c, virtual false, abstract: false, final false
  inline void set_ItemIsReference(bool value);

  /// @brief Method set_ItemReferenceLoopHandling, addr 0x5cd3e3c, size 0x58, virtual false, abstract: false, final false
  inline void set_ItemReferenceLoopHandling(::Newtonsoft::Json::ReferenceLoopHandling value);

  /// @brief Method set_ItemTypeNameHandling, addr 0x5cd3ed8, size 0x58, virtual false, abstract: false, final false
  inline void set_ItemTypeNameHandling(::Newtonsoft::Json::TypeNameHandling value);

  /// @brief Method set_NamingStrategyParameters, addr 0x5cd38fc, size 0x8, virtual false, abstract: false, final false
  inline void set_NamingStrategyParameters(::ArrayW<::System::Object*> value);

  /// @brief Method set_NamingStrategyType, addr 0x5cd38ec, size 0x8, virtual false, abstract: false, final false
  inline void set_NamingStrategyType(::System::Type* value);

  /// @brief Method set_NullValueHandling, addr 0x5cd3948, size 0x58, virtual false, abstract: false, final false
  inline void set_NullValueHandling(::Newtonsoft::Json::NullValueHandling value);

  /// @brief Method set_ObjectCreationHandling, addr 0x5cd3b1c, size 0x58, virtual false, abstract: false, final false
  inline void set_ObjectCreationHandling(::Newtonsoft::Json::ObjectCreationHandling value);

  /// @brief Method set_Order, addr 0x5cd3cf4, size 0x58, virtual false, abstract: false, final false
  inline void set_Order(int32_t value);

  /// @brief Method set_PropertyName, addr 0x5cd3df0, size 0x8, virtual false, abstract: false, final false
  inline void set_PropertyName(::StringW value);

  /// @brief Method set_ReferenceLoopHandling, addr 0x5cd3a80, size 0x58, virtual false, abstract: false, final false
  inline void set_ReferenceLoopHandling(::Newtonsoft::Json::ReferenceLoopHandling value);

  /// @brief Method set_Required, addr 0x5cd3d90, size 0x58, virtual false, abstract: false, final false
  inline void set_Required(::Newtonsoft::Json::Required value);

  /// @brief Method set_TypeNameHandling, addr 0x5cd3bb8, size 0x58, virtual false, abstract: false, final false
