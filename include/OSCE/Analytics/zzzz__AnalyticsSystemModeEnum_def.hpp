...
DEFINE_IL2CPP_CLASS(::OSCE::Analytics::AnalyticsSystemModeEnum, "OSCE.Analytics", "AnalyticsSystemModeEnum");
// Dependencies
namespace OSCE::Analytics {
// Is value type: true
...
static_assert(sizeof(::OSCE::Analytics::AnalyticsSystemModeEnum) == 0x4, "Size mismatch!");
