...
public:
  ...
  __declspec(property(get = getStaticF__pooledObjects, put = setStaticF__pooledObjects)) ::ArrayW<T> _pooledObjects;
  ...
  static inline ::ArrayW<T> getStaticF__pooledObjects();
  ...
  static inline void setStaticF__pooledObjects(::ArrayW<T> value);
