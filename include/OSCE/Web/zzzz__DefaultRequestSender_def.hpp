...
// Write type traits
MARK_REF_T(::OSCE::Web::DefaultRequestSender*);
DEFINE_IL2CPP_CLASS(::OSCE::Web::DefaultRequestSender*, "OSCE.Web", "DefaultRequestSender");
...
static_assert(sizeof(::OSCE::Web::DefaultRequestSender) == 0x18, "Size mismatch!");
