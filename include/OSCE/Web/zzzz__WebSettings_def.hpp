...
// Write type traits
MARK_REF_T(::OSCE::Web::WebSettings*);
DEFINE_IL2CPP_CLASS(::OSCE::Web::WebSettings*, "OSCE.Web", "WebSettings");
...
static_assert(sizeof(::OSCE::Web::WebSettings) == 0x10, "Size mismatch!");
