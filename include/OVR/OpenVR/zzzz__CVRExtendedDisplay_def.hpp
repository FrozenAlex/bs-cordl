...
public:
  ...
  /// @brief Method GetDXGIOutputInfo, addr 0x5e3f9f8, size 0x28, virtual false, abstract: false, final false
  inline void GetDXGIOutputInfo(::by_ref<int32_t> pnAdapterIndex, ::by_ref<int32_t> pnAdapterOutputIndex);

  /// @brief Method GetEyeOutputViewport, addr 0x5e3f9c8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWindowBounds, addr 0x5e3f998, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e3f89c, size 0xfc, virtual false, abstract: false, final false
