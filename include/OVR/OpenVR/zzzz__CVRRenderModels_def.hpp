...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x5e42618, size 0x10c, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::StringW pchRenderModelName, ::StringW pchComponentName, ::by_ref<::OVR::OpenVR::VRControllerState_t_Packed> pControllerState,
  ...
  /// @brief Method EndInvoke, addr 0x5e42724, size 0x30, virtual true, abstract: false, final false
  inline bool EndInvoke(::by_ref<::OVR::OpenVR::VRControllerState_t_Packed> pControllerState, ::by_ref<::OVR::OpenVR::RenderModel_ControllerMode_State_t> pState,
                        ::by_ref<::OVR::OpenVR::RenderModel_ComponentState_t> pComponentState, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x5e42604, size 0x14, virtual true, abstract: false, final false
  inline bool Invoke(::StringW pchRenderModelName, ::StringW pchComponentName, ::by_ref<::OVR::OpenVR::VRControllerState_t_Packed> pControllerState,
                     ::by_ref<::OVR::OpenVR::RenderModel_ControllerMode_State_t> pState, ::by_ref<::OVR::OpenVR::RenderModel_ComponentState_t> pComponentState);

  static inline ::OVR::OpenVR::CVRRenderModels__GetComponentStatePacked* New_ctor(::System::Object* object, ::System::IntPtr method);

  /// @brief Method .ctor, addr 0x5e42584, size 0x80, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::OVR::OpenVR::CVRRenderModels_GetComponentStateUnion) == 0x8, "Size mismatch!");
...
public:
  ...
  /// @brief Method FreeRenderModel, addr 0x5e421c4, size 0x20, virtual false, abstract: false, final false
  inline void FreeRenderModel(::System::IntPtr pRenderModel);

  /// @brief Method FreeTexture, addr 0x5e42204, size 0x20, virtual false, abstract: false, final false
  inline void FreeTexture(::System::IntPtr pTexture);

  /// @brief Method FreeTextureD3D11, addr 0x5e42264, size 0x20, virtual false, abstract: false, final false
  inline void FreeTextureD3D11(::System::IntPtr pD3D11Texture2D);

  /// @brief Method GetComponentButtonMask, addr 0x5e42304, size 0x20, virtual false, abstract: false, final false
  inline uint64_t GetComponentButtonMask(::StringW pchRenderModelName, ::StringW pchComponentName);

  /// @brief Method GetComponentCount, addr 0x5e422c4, size 0x20, virtual false, abstract: false, final false
  inline uint32_t GetComponentCount(::StringW pchRenderModelName);

  /// @brief Method GetComponentName, addr 0x5e422e4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentRenderModelName, addr 0x5e42324, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentState, addr 0x5e42364, size 0x134, virtual false, abstract: false, final false
  inline bool GetComponentState(::StringW pchRenderModelName, ::StringW pchComponentName, ::by_ref<::OVR::OpenVR::VRControllerState_t> pControllerState,
                                ::by_ref<::OVR::OpenVR::RenderModel_ControllerMode_State_t> pState, ::by_ref<::OVR::OpenVR::RenderModel_ComponentState_t> pComponentState);

  /// @brief Method GetComponentStateForDevicePath, addr 0x5e42344, size 0x20, virtual false, abstract: false, final false
  inline bool GetComponentStateForDevicePath(::StringW pchRenderModelName, ::StringW pchComponentName, uint64_t devicePath, ::by_ref<::OVR::OpenVR::RenderModel_ControllerMode_State_t> pState,
                                             ::by_ref<::OVR::OpenVR::RenderModel_ComponentState_t> pComponentState);

  /// @brief Method GetRenderModelCount, addr 0x5e422a4, size 0x20, virtual false, abstract: false, final false
  inline uint32_t GetRenderModelCount();

  /// @brief Method GetRenderModelErrorNameFromEnum, addr 0x5e424f8, size 0x8c, virtual false, abstract: false, final false
  inline ::StringW GetRenderModelErrorNameFromEnum(::OVR::OpenVR::EVRRenderModelError error);

  /// @brief Method GetRenderModelName, addr 0x5e42284, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRenderModelOriginalPath, addr 0x5e424d8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRenderModelThumbnailURL, addr 0x5e424b8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadIntoTextureD3D11_Async, addr 0x5e42244, size 0x20, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRRenderModelError LoadIntoTextureD3D11_Async(int32_t textureId, ::System::IntPtr pDstTexture);

  /// @brief Method LoadRenderModel_Async, addr 0x5e421a4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadTextureD3D11_Async, addr 0x5e42224, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadTexture_Async, addr 0x5e421e4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderModelHasComponent, addr 0x5e42498, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e420a4, size 0x100, virtual false, abstract: false, final false
