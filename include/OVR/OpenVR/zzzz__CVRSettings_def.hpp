...
public:
  ...
  /// @brief Method GetBool, addr 0x5d0cb34, size 0x20, virtual false, abstract: false, final false
  inline bool GetBool(::StringW pchSection, ::StringW pchSettingsKey, ::by_ref<::OVR::OpenVR::EVRSettingsError> peError);

  /// @brief Method GetFloat, addr 0x5d0cb74, size 0x20, virtual false, abstract: false, final false
  inline float_t GetFloat(::StringW pchSection, ::StringW pchSettingsKey, ::by_ref<::OVR::OpenVR::EVRSettingsError> peError);

  /// @brief Method GetInt32, addr 0x5d0cb54, size 0x20, virtual false, abstract: false, final false
  inline int32_t GetInt32(::StringW pchSection, ::StringW pchSettingsKey, ::by_ref<::OVR::OpenVR::EVRSettingsError> peError);

  /// @brief Method GetSettingsErrorNameFromEnum, addr 0x5d0ca00, size 0x8c, virtual false, abstract: false, final false
  inline ::StringW GetSettingsErrorNameFromEnum(::OVR::OpenVR::EVRSettingsError eError);

  /// @brief Method GetString, addr 0x5d0cb94, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveKeyInSection, addr 0x5d0cbd4, size 0x20, virtual false, abstract: false, final false
  inline void RemoveKeyInSection(::StringW pchSection, ::StringW pchSettingsKey, ::by_ref<::OVR::OpenVR::EVRSettingsError> peError);

  /// @brief Method RemoveSection, addr 0x5d0cbb4, size 0x20, virtual false, abstract: false, final false
  inline void RemoveSection(::StringW pchSection, ::by_ref<::OVR::OpenVR::EVRSettingsError> peError);

  /// @brief Method SetBool, addr 0x5d0cab0, size 0x24, virtual false, abstract: false, final false
  inline void SetBool(::StringW pchSection, ::StringW pchSettingsKey, bool bValue, ::by_ref<::OVR::OpenVR::EVRSettingsError> peError);

  /// @brief Method SetFloat, addr 0x5d0caf4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method SetInt32, addr 0x5d0cad4, size 0x20, virtual false, abstract: false, final false
  inline void SetInt32(::StringW pchSection, ::StringW pchSettingsKey, int32_t nValue, ::by_ref<::OVR::OpenVR::EVRSettingsError> peError);

  /// @brief Method SetString, addr 0x5d0cb14, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method Sync, addr 0x5d0ca8c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d0c900, size 0x100, virtual false, abstract: false, final false
