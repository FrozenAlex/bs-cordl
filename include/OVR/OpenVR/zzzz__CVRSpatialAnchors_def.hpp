...
public:
  ...
  /// @brief Method CreateSpatialAnchorFromDescriptor, addr 0x5d0d6b0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSpatialAnchorFromPose, addr 0x5d0d6d4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSpatialAnchorDescriptor, addr 0x5d0d718, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSpatialAnchorPose, addr 0x5d0d6f8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d0d5bc, size 0xf4, virtual false, abstract: false, final false
