...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::CameraVideoStreamFrameHeader_t, "OVR.OpenVR", "CameraVideoStreamFrameHeader_t");
...
static_assert(sizeof(::OVR::OpenVR::CameraVideoStreamFrameHeader_t) == 0x64, "Size mismatch!");
