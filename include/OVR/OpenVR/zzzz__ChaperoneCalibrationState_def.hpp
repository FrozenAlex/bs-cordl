...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::ChaperoneCalibrationState, "OVR.OpenVR", "ChaperoneCalibrationState");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::ChaperoneCalibrationState) == 0x4, "Size mismatch!");
