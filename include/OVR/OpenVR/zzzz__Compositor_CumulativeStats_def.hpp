...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::Compositor_CumulativeStats, "OVR.OpenVR", "Compositor_CumulativeStats");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::Compositor_CumulativeStats) == 0x3c, "Size mismatch!");
