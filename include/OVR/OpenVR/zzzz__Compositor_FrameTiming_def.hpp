...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::Compositor_FrameTiming, "OVR.OpenVR", "Compositor_FrameTiming");
...
static_assert(sizeof(::OVR::OpenVR::Compositor_FrameTiming) == 0xb0, "Size mismatch!");
