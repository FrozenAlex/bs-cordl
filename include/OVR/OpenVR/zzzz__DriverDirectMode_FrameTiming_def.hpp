...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::DriverDirectMode_FrameTiming, "OVR.OpenVR", "DriverDirectMode_FrameTiming");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::DriverDirectMode_FrameTiming) == 0x14, "Size mismatch!");
