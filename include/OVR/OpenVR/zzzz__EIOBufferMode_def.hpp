...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EIOBufferMode, "OVR.OpenVR", "EIOBufferMode");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
public:
  ...
  /// @brief Field Create value: I32(512)
...
static_assert(sizeof(::OVR::OpenVR::EIOBufferMode) == 0x4, "Size mismatch!");
