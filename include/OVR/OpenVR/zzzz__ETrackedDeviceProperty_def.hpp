...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::ETrackedDeviceProperty, "OVR.OpenVR", "ETrackedDeviceProperty");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::ETrackedDeviceProperty) == 0x4, "Size mismatch!");
