...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::ETrackingUniverseOrigin, "OVR.OpenVR", "ETrackingUniverseOrigin");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::ETrackingUniverseOrigin) == 0x4, "Size mismatch!");
