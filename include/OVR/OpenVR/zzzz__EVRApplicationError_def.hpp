...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EVRApplicationError, "OVR.OpenVR", "EVRApplicationError");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::EVRApplicationError) == 0x4, "Size mismatch!");
