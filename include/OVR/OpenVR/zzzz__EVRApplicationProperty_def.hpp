...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EVRApplicationProperty, "OVR.OpenVR", "EVRApplicationProperty");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::EVRApplicationProperty) == 0x4, "Size mismatch!");
