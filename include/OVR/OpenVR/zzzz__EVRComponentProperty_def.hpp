...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EVRComponentProperty, "OVR.OpenVR", "EVRComponentProperty");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::EVRComponentProperty) == 0x4, "Size mismatch!");
