...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EVRCompositorTimingMode, "OVR.OpenVR", "EVRCompositorTimingMode");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::EVRCompositorTimingMode) == 0x4, "Size mismatch!");
