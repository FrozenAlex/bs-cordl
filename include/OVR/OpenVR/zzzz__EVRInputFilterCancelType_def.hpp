...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EVRInputFilterCancelType, "OVR.OpenVR", "EVRInputFilterCancelType");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::EVRInputFilterCancelType) == 0x4, "Size mismatch!");
