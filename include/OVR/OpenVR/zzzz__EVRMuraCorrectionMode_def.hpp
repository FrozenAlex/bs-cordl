...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EVRMuraCorrectionMode, "OVR.OpenVR", "EVRMuraCorrectionMode");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::EVRMuraCorrectionMode) == 0x4, "Size mismatch!");
