...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EVRNotificationStyle, "OVR.OpenVR", "EVRNotificationStyle");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::EVRNotificationStyle) == 0x4, "Size mismatch!");
