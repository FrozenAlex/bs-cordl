...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EVRNotificationType, "OVR.OpenVR", "EVRNotificationType");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
public:
  ...
  /// @brief Field Persistent value: I32(1)
  ...
  /// @brief Field Transient_SystemWithUserValue value: I32(2)
...
static_assert(sizeof(::OVR::OpenVR::EVRNotificationType) == 0x4, "Size mismatch!");
