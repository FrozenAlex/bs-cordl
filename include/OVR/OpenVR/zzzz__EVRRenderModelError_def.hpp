...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EVRRenderModelError, "OVR.OpenVR", "EVRRenderModelError");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::EVRRenderModelError) == 0x4, "Size mismatch!");
