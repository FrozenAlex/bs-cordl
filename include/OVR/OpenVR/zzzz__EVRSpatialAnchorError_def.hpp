...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EVRSpatialAnchorError, "OVR.OpenVR", "EVRSpatialAnchorError");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::EVRSpatialAnchorError) == 0x4, "Size mismatch!");
