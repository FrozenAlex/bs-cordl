...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EVRTrackedCameraError, "OVR.OpenVR", "EVRTrackedCameraError");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::EVRTrackedCameraError) == 0x4, "Size mismatch!");
