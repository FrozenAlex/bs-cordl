...
// Write type traits
MARK_REF_T(::OVR::OpenVR::IVRNotifications__CreateNotification*);
MARK_REF_T(::OVR::OpenVR::IVRNotifications__RemoveNotification*);
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x5d041cc, size 0x140, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x5d0430c, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method Invoke, addr 0x5d041b4, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d04148, size 0x6c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x5d043bc, size 0x58, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(uint32_t notificationId, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x5d04414, size 0x24, virtual true, abstract: false, final false
  inline ::OVR::OpenVR::EVRNotificationError EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x5d043a8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d0433c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
// Non member Declarations
static_assert(sizeof(::OVR::OpenVR::IVRNotifications__RemoveNotification) == 0x80, "Size mismatch!");
...
static_assert(sizeof(::OVR::OpenVR::IVRNotifications) == 0x10, "Size mismatch!");
