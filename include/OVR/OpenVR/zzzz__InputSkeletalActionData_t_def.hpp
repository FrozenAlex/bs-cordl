...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::InputSkeletalActionData_t, "OVR.OpenVR", "InputSkeletalActionData_t");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::InputSkeletalActionData_t) == 0x18, "Size mismatch!");
