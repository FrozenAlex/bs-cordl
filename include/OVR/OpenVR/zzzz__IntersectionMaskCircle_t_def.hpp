...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::IntersectionMaskCircle_t, "OVR.OpenVR", "IntersectionMaskCircle_t");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::IntersectionMaskCircle_t) == 0xc, "Size mismatch!");
