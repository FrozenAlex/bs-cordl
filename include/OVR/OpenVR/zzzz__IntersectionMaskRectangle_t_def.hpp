...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::IntersectionMaskRectangle_t, "OVR.OpenVR", "IntersectionMaskRectangle_t");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::IntersectionMaskRectangle_t) == 0x10, "Size mismatch!");
