...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::NotificationBitmap_t, "OVR.OpenVR", "NotificationBitmap_t");
...
static_assert(sizeof(::OVR::OpenVR::NotificationBitmap_t) == 0x18, "Size mismatch!");
