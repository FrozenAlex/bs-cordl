...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::RenderModel_ComponentState_t, "OVR.OpenVR", "RenderModel_ComponentState_t");
...
static_assert(sizeof(::OVR::OpenVR::RenderModel_ComponentState_t) == 0x64, "Size mismatch!");
