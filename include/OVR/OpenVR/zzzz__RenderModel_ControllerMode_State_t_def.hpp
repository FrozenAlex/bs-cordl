...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::RenderModel_ControllerMode_State_t, "OVR.OpenVR", "RenderModel_ControllerMode_State_t");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::RenderModel_ControllerMode_State_t) == 0x1, "Size mismatch!");
