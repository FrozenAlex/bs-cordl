...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::RenderModel_TextureMap_t_Packed, "OVR.OpenVR", "RenderModel_TextureMap_t_Packed");
...
static_assert(sizeof(::OVR::OpenVR::RenderModel_TextureMap_t_Packed) == 0xc, "Size mismatch!");
