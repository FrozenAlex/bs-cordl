...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::RenderModel_Vertex_t, "OVR.OpenVR", "RenderModel_Vertex_t");
...
static_assert(sizeof(::OVR::OpenVR::RenderModel_Vertex_t) == 0x20, "Size mismatch!");
