...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::SpatialAnchorPose_t, "OVR.OpenVR", "SpatialAnchorPose_t");
...
static_assert(sizeof(::OVR::OpenVR::SpatialAnchorPose_t) == 0x30, "Size mismatch!");
