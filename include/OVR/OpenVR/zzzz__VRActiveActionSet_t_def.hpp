...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VRActiveActionSet_t, "OVR.OpenVR", "VRActiveActionSet_t");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::VRActiveActionSet_t) == 0x20, "Size mismatch!");
