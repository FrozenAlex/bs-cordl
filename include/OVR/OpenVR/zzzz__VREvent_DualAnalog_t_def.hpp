...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VREvent_DualAnalog_t, "OVR.OpenVR", "VREvent_DualAnalog_t");
...
static_assert(sizeof(::OVR::OpenVR::VREvent_DualAnalog_t) == 0x14, "Size mismatch!");
