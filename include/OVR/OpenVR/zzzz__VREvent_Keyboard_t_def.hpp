...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VREvent_Keyboard_t, "OVR.OpenVR", "VREvent_Keyboard_t");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
public:
  ...
  /// @brief Method get_cNewInput, addr 0x5d0dbd0, size 0xf0, virtual false, abstract: false, final false
...
static_assert(sizeof(::OVR::OpenVR::VREvent_Keyboard_t) == 0x10, "Size mismatch!");
