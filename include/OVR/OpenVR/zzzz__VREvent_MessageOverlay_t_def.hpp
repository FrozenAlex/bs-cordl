...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VREvent_MessageOverlay_t, "OVR.OpenVR", "VREvent_MessageOverlay_t");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
public:
  ...
  // Ctor Parameters []
  // @brief default ctor
  constexpr VREvent_MessageOverlay_t();
...
static_assert(sizeof(::OVR::OpenVR::VREvent_MessageOverlay_t) == 0x4, "Size mismatch!");
