...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VREvent_Notification_t, "OVR.OpenVR", "VREvent_Notification_t");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::VREvent_Notification_t) == 0x10, "Size mismatch!");
