...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VREvent_Screenshot_t, "OVR.OpenVR", "VREvent_Screenshot_t");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::VREvent_Screenshot_t) == 0x8, "Size mismatch!");
