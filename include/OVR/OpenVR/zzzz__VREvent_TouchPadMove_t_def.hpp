...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VREvent_TouchPadMove_t, "OVR.OpenVR", "VREvent_TouchPadMove_t");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::VREvent_TouchPadMove_t) == 0x18, "Size mismatch!");
