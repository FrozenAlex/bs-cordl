...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VRMessageOverlayResponse, "OVR.OpenVR", "VRMessageOverlayResponse");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::VRMessageOverlayResponse) == 0x4, "Size mismatch!");
