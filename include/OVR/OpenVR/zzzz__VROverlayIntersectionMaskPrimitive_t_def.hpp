...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VROverlayIntersectionMaskPrimitive_t, "OVR.OpenVR", "VROverlayIntersectionMaskPrimitive_t");
...
static_assert(sizeof(::OVR::OpenVR::VROverlayIntersectionMaskPrimitive_t) == 0x14, "Size mismatch!");
