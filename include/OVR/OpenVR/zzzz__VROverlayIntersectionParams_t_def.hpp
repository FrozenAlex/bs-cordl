...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VROverlayIntersectionParams_t, "OVR.OpenVR", "VROverlayIntersectionParams_t");
...
static_assert(sizeof(::OVR::OpenVR::VROverlayIntersectionParams_t) == 0x1c, "Size mismatch!");
