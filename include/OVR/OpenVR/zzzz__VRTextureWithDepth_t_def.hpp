...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VRTextureWithDepth_t, "OVR.OpenVR", "VRTextureWithDepth_t");
...
static_assert(sizeof(::OVR::OpenVR::VRTextureWithDepth_t) == 0x50, "Size mismatch!");
