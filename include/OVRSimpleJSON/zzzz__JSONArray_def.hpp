...
class JSONArray__get_Children_d__24;
}
namespace OVRSimpleJSON {
struct JSONNodeType;
}
...
// Write type traits
MARK_REF_T(::OVRSimpleJSON::JSONArray*);
...
namespace OVRSimpleJSON {
// Is value type: false
// CS Name: OVRSimpleJSON.JSONArray/<get_Children>d__24
class CORDL_TYPE JSONArray__get_Children_d__24 : public ::System::Object {
public:
  // Declarations
  __declspec(property(
  ...
  /// @brief Method MoveNext, addr 0x5e23db4, size 0x1a8, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::OVRSimpleJSON::JSONArray__get_Children_d__24* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<OVRSimpleJSON.JSONNode>.GetEnumerator, addr 0x5e23fec, size 0x98, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<OVRSimpleJSON.JSONNode>.get_Current, addr 0x5e23fa4, size 0x8, virtual true, abstract: false, final true
  inline ::OVRSimpleJSON::JSONNode* System_Collections_Generic_IEnumerator_OVRSimpleJSON_JSONNode__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x5e24084, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5e23fac, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5e23fe4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5e23d58, size 0x5c, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x5e23f5c, size 0x48, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x5e23bc0, size 0x20, virtual false, abstract: false, final false
...
static_assert(offsetof(::OVRSimpleJSON::JSONArray__get_Children_d__24, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::OVRSimpleJSON::JSONArray__get_Children_d__24, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::OVRSimpleJSON::JSONArray__get_Children_d__24, _____l__initialThreadId) == 0x20, "Offset mismatch!");

static_assert(offsetof(::OVRSimpleJSON::JSONArray__get_Children_d__24, _____4__this) == 0x28, "Offset mismatch!");

static_assert(offsetof(::OVRSimpleJSON::JSONArray__get_Children_d__24, _____7__wrap1) == 0x30, "Offset mismatch!");
...
public:
  // Declarations
  using _get_Children_d__24 = ::OVRSimpleJSON::JSONArray__get_Children_d__24;
  ...
  /// @brief Method Add, addr 0x5e235c4, size 0x120, virtual true, abstract: false, final false
  inline void Add(::StringW aKey, ::OVRSimpleJSON::JSONNode* aItem);

  /// @brief Method Clear, addr 0x5e2381c, size 0x78, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method Clone, addr 0x5e23894, size 0x218, virtual true, abstract: false, final false
  inline ::OVRSimpleJSON::JSONNode* Clone();

  /// @brief Method GetEnumerator, addr 0x5e23040, size 0x80, virtual true, abstract: false, final false
  inline ::OVRSimpleJSON::JSONNode_Enumerator GetEnumerator();

  static inline ::OVRSimpleJSON::JSONArray* New_ctor();

  /// @brief Method Remove, addr 0x5e236e4, size 0xcc, virtual true, abstract: false, final false
  inline ::OVRSimpleJSON::JSONNode* Remove(int32_t aIndex);

  /// @brief Method Remove, addr 0x5e237b0, size 0x6c, virtual true, abstract: false, final false
  inline ::OVRSimpleJSON::JSONNode* Remove(::OVRSimpleJSON::JSONNode* aNode);

  /// @brief Method WriteToStringBuilder, addr 0x5e23be0, size 0x178, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e23aac, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Children, addr 0x5e23b50, size 0x70, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::OVRSimpleJSON::JSONNode*>* get_Children();

  /// @brief Method get_Count, addr 0x5e23574, size 0x50, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Inline, addr 0x5e23020, size 0x8, virtual true, abstract: false, final false
  inline bool get_Inline();

  /// @brief Method get_IsArray, addr 0x5e23038, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsArray();

  /// @brief Method get_Item, addr 0x5e230c0, size 0xc8, virtual true, abstract: false, final false
  inline ::OVRSimpleJSON::JSONNode* get_Item(int32_t aIndex);

  /// @brief Method get_Item, addr 0x5e233f8, size 0x5c, virtual true, abstract: false, final false
  inline ::OVRSimpleJSON::JSONNode* get_Item(::StringW aKey);

  /// @brief Method get_Tag, addr 0x5e23030, size 0x8, virtual true, abstract: false, final false
  inline ::OVRSimpleJSON::JSONNodeType get_Tag();

  /// @brief Method set_Inline, addr 0x5e23028, size 0x8, virtual true, abstract: false, final false
  inline void set_Inline(bool value);

  /// @brief Method set_Item, addr 0x5e231ec, size 0x180, virtual true, abstract: false, final false
  inline void set_Item(int32_t aIndex, ::OVRSimpleJSON::JSONNode* value);

  /// @brief Method set_Item, addr 0x5e23454, size 0x120, virtual true, abstract: false, final false
...
static_assert(sizeof(::OVRSimpleJSON::JSONArray) == 0x20, "Size mismatch!");
