...
DEFINE_IL2CPP_CLASS(::OVRSimpleJSON::JSONContainerType, "OVRSimpleJSON", "JSONContainerType");
// Dependencies
namespace OVRSimpleJSON {
// Is value type: true
...
static_assert(sizeof(::OVRSimpleJSON::JSONContainerType) == 0x4, "Size mismatch!");
