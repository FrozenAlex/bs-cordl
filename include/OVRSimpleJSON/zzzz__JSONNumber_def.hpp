...
public:
  ...
  /// @brief Method Clear, addr 0x5e260c8, size 0x8, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method Clone, addr 0x5e25d78, size 0x68, virtual true, abstract: false, final false
  inline ::OVRSimpleJSON::JSONNode* Clone();

  /// @brief Method Equals, addr 0x5e25f6c, size 0x13c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetEnumerator, addr 0x5e25b38, size 0x14, virtual true, abstract: false, final false
  inline ::OVRSimpleJSON::JSONNode_Enumerator GetEnumerator();

  /// @brief Method GetHashCode, addr 0x5e260a8, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsNumeric, addr 0x5e25e78, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteToStringBuilder, addr 0x5e25de0, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e25d08, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::StringW aData);

  /// @brief Method .ctor, addr 0x5e25ca4, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(double_t aData);

  /// @brief Method get_AsDouble, addr 0x5e25c44, size 0x8, virtual true, abstract: false, final false
  inline double_t get_AsDouble();

  /// @brief Method get_AsLong, addr 0x5e25c54, size 0x20, virtual true, abstract: false, final false
  inline int64_t get_AsLong();

  /// @brief Method get_AsULong, addr 0x5e25c80, size 0x18, virtual true, abstract: false, final false
  inline uint64_t get_AsULong();

  /// @brief Method get_IsNumber, addr 0x5e25b30, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsNumber();

  /// @brief Method get_Tag, addr 0x5e25b28, size 0x8, virtual true, abstract: false, final false
  inline ::OVRSimpleJSON::JSONNodeType get_Tag();

  /// @brief Method get_Value, addr 0x5e25b4c, size 0x68, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_AsDouble, addr 0x5e25c4c, size 0x8, virtual true, abstract: false, final false
  inline void set_AsDouble(double_t value);

  /// @brief Method set_AsLong, addr 0x5e25c74, size 0xc, virtual true, abstract: false, final false
  inline void set_AsLong(int64_t value);

  /// @brief Method set_AsULong, addr 0x5e25c98, size 0xc, virtual true, abstract: false, final false
  inline void set_AsULong(uint64_t value);

  /// @brief Method set_Value, addr 0x5e25bb4, size 0x90, virtual true, abstract: false, final false
