...
public:
  ...
  /// @brief Method Awake, addr 0x5dae730, size 0x70, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::Oculus::Haptics::HapticSource* New_ctor();

  /// @brief Method OnAfterDeserialize, addr 0x5dae94c, size 0x10, virtual true, abstract: false, final true
  inline void OnAfterDeserialize();

  /// @brief Method OnBeforeSerialize, addr 0x5dae948, size 0x4, virtual true, abstract: false, final true
  inline void OnBeforeSerialize();

  /// @brief Method OnDestroy, addr 0x5dae95c, size 0x14, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Pause, addr 0x5dae830, size 0x14, virtual false, abstract: false, final false
  inline void Pause();

  /// @brief Method Play, addr 0x5dae7f8, size 0x1c, virtual false, abstract: false, final false
  inline void Play();

  /// @brief Method Play, addr 0x5dae814, size 0x1c, virtual false, abstract: false, final false
  inline void Play(::Oculus::Haptics::Controller controller);

  /// @brief Method Resume, addr 0x5dae844, size 0x14, virtual false, abstract: false, final false
  inline void Resume();

  /// @brief Method Seek, addr 0x5dae86c, size 0x14, virtual false, abstract: false, final false
  inline void Seek(float_t time);

  /// @brief Method Stop, addr 0x5dae858, size 0x14, virtual false, abstract: false, final false
  inline void Stop();

  /// @brief Method SyncSerializedFieldsToPlayer, addr 0x5dae7a0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dae970, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_amplitude, addr 0x5dae8dc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_amplitude();

  /// @brief Method get_clipDuration, addr 0x5dae898, size 0x14, virtual false, abstract: false, final false
  inline float_t get_clipDuration();

  /// @brief Method get_frequencyShift, addr 0x5dae900, size 0x8, virtual false, abstract: false, final false
  inline float_t get_frequencyShift();

  /// @brief Method get_loop, addr 0x5dae8b4, size 0x8, virtual false, abstract: false, final false
  inline bool get_loop();

  /// @brief Method get_priority, addr 0x5dae924, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_priority();

  /// @brief Convert to "::UnityEngine::ISerializationCallbackReceiver"
  constexpr ::UnityEngine::ISerializationCallbackReceiver* i___UnityEngine__ISerializationCallbackReceiver() noexcept;

  /// @brief Method set_amplitude, addr 0x5dae8e4, size 0x1c, virtual false, abstract: false, final false
  inline void set_amplitude(float_t value);

  /// @brief Method set_clip, addr 0x5dae880, size 0x18, virtual false, abstract: false, final false
  inline void set_clip(::Oculus::Haptics::HapticClip* value);

  /// @brief Method set_controller, addr 0x5dae8ac, size 0x8, virtual false, abstract: false, final false
  inline void set_controller(::Oculus::Haptics::Controller value);

  /// @brief Method set_frequencyShift, addr 0x5dae908, size 0x1c, virtual false, abstract: false, final false
  inline void set_frequencyShift(float_t value);

  /// @brief Method set_loop, addr 0x5dae8bc, size 0x20, virtual false, abstract: false, final false
  inline void set_loop(bool value);

  /// @brief Method set_priority, addr 0x5dae92c, size 0x1c, virtual false, abstract: false, final false
