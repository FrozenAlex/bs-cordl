...
// Write type traits
MARK_REF_T(::Oculus::Haptics::Utils*);
DEFINE_IL2CPP_CLASS(::Oculus::Haptics::Utils*, "Oculus.Haptics", "Utils");
...
public:
  // Declarations
  /// @brief Method ControllerToFfiController, addr 0x5c77a88, size 0x84, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::Ffi_Controller ControllerToFfiController(::Oculus::Haptics::Controller controller);

  /// @brief Method Map, addr 0x5c783f4, size 0x28, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Haptics::Utils) == 0x10, "Size mismatch!");
