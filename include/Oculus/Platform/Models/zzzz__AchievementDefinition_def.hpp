...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::AchievementDefinition*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::AchievementDefinition*, "Oculus.Platform.Models", "AchievementDefinition");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5de9150, size 0x90, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::AchievementDefinition) == 0x30, "Size mismatch!");
