...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::AchievementProgressList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::AchievementProgressList*, "Oculus.Platform.Models", "AchievementProgressList");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dd4fa8, size 0x1f0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::AchievementProgressList) == 0x28, "Size mismatch!");
