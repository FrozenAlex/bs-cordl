...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::AchievementUpdate*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::AchievementUpdate*, "Oculus.Platform.Models", "AchievementUpdate");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dd5274, size 0x7c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::AchievementUpdate) == 0x20, "Size mismatch!");
