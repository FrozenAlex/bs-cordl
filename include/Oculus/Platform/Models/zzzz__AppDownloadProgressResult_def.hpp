...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::AppDownloadProgressResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::AppDownloadProgressResult*, "Oculus.Platform.Models", "AppDownloadProgressResult");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5c9f438, size 0x84, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::AppDownloadProgressResult) == 0x28, "Size mismatch!");
