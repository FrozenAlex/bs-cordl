...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::ApplicationInviteList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::ApplicationInviteList*, "Oculus.Platform.Models", "ApplicationInviteList");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5c9f6ec, size 0x1f0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::ApplicationInviteList) == 0x28, "Size mismatch!");
