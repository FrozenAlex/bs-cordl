...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::AssetDetails*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::AssetDetails*, "Oculus.Platform.Models", "AssetDetails");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dd5ad0, size 0x108, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::AssetDetails) == 0x50, "Size mismatch!");
