...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::AssetFileDeleteResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::AssetFileDeleteResult*, "Oculus.Platform.Models", "AssetFileDeleteResult");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb360c, size 0xa4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::AssetFileDeleteResult) == 0x30, "Size mismatch!");
