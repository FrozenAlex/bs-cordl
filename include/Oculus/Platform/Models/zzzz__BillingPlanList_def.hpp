...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::BillingPlanList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::BillingPlanList*, "Oculus.Platform.Models", "BillingPlanList");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb3c7c, size 0x1dc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::BillingPlanList) == 0x28, "Size mismatch!");
