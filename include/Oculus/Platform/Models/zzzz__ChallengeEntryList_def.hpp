...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::ChallengeEntryList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::ChallengeEntryList*, "Oculus.Platform.Models", "ChallengeEntryList");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb49f4, size 0x21c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::ChallengeEntryList) == 0x30, "Size mismatch!");
