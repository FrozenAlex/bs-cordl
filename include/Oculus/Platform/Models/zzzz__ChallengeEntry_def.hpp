...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::ChallengeEntry*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::ChallengeEntry*, "Oculus.Platform.Models", "ChallengeEntry");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb4780, size 0x104, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::ChallengeEntry) == 0x48, "Size mismatch!");
