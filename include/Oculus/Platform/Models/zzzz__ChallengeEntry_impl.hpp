...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Oculus::Platform::Models::ChallengeEntry::*)(::System::IntPtr)>(&::Oculus::Platform::Models::ChallengeEntry::_ctor)> {
  constexpr static std::size_t size = 0x104;
  constexpr static std::size_t addrs = 0x5dea714;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Oculus::Platform::Models::ChallengeEntry*>(), { ".ctor", {}, { ::i2c::type_of<::System::IntPtr>() } })));
...
constexpr ::ArrayW<uint8_t>& Oculus::Platform::Models::ChallengeEntry::__cordl_internal_get_ExtraData() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___ExtraData;
}
constexpr ::ArrayW<uint8_t> const& Oculus::Platform::Models::ChallengeEntry::__cordl_internal_get_ExtraData() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___ExtraData;
}
constexpr void Oculus::Platform::Models::ChallengeEntry::__cordl_internal_set_ExtraData(::ArrayW<uint8_t> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::Oculus::Platform::Models::User* const& Oculus::Platform::Models::ChallengeEntry::__cordl_internal_get_User() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___User;
}
...
inline ::Oculus::Platform::Models::ChallengeEntry* Oculus::Platform::Models::ChallengeEntry::New_ctor(::System::IntPtr o) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Oculus::Platform::Models::ChallengeEntry*>(o));
}
// Ctor Parameters []
