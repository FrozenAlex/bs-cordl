...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::ChallengeList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::ChallengeList*, "Oculus.Platform.Models", "ChallengeList");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb4564, size 0x21c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::ChallengeList) == 0x30, "Size mismatch!");
