...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::Challenge*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::Challenge*, "Oculus.Platform.Models", "Challenge");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb40c4, size 0x1c4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::Challenge) == 0x70, "Size mismatch!");
