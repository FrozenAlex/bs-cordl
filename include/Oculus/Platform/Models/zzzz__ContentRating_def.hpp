...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::ContentRating*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::ContentRating*, "Oculus.Platform.Models", "ContentRating");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_Descriptors, put = __cordl_internal_set_Descriptors)) ::ArrayW<::StringW> Descriptors;

  /// @brief Field InteractiveElements, offset 0x28, size 0x8
  __declspec(property(get = __cordl_internal_get_InteractiveElements, put = __cordl_internal_set_InteractiveElements)) ::ArrayW<::StringW> InteractiveElements;
  ...
  constexpr ::ArrayW<::StringW> const& __cordl_internal_get_Descriptors() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get_Descriptors();

  constexpr ::ArrayW<::StringW> const& __cordl_internal_get_InteractiveElements() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get_InteractiveElements();
  ...
  constexpr void __cordl_internal_set_Descriptors(::ArrayW<::StringW> value);

  constexpr void __cordl_internal_set_InteractiveElements(::ArrayW<::StringW> value);

  constexpr void __cordl_internal_set_RatingDefinitionUri(::StringW value);

  /// @brief Method .ctor, addr 0x5deaba4, size 0x1d8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::ContentRating) == 0x38, "Size mismatch!");
