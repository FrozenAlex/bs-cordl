...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::CowatchViewer*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::CowatchViewer*, "Oculus.Platform.Models", "CowatchViewer");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5deadf0, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::CowatchViewer) == 0x20, "Size mismatch!");
