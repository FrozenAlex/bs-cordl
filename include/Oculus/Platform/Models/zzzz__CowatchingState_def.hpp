...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::CowatchingState*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::CowatchingState*, "Oculus.Platform.Models", "CowatchingState");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dead7c, size 0x74, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::CowatchingState) == 0x18, "Size mismatch!");
