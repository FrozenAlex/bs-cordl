...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::Destination*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::Destination*, "Oculus.Platform.Models", "Destination");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5deb120, size 0xa0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::Destination) == 0x30, "Size mismatch!");
