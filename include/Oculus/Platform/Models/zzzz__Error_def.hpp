...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::Error*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::Error*, "Oculus.Platform.Models", "Error");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5deb3bc, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::Error) == 0x20, "Size mismatch!");
