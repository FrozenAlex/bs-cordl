...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::InstalledApplicationList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::InstalledApplicationList*, "Oculus.Platform.Models", "InstalledApplicationList");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb573c, size 0x1dc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::InstalledApplicationList) == 0x28, "Size mismatch!");
