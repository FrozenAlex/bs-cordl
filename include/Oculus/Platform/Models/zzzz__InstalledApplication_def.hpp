...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::InstalledApplication*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::InstalledApplication*, "Oculus.Platform.Models", "InstalledApplication");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb568c, size 0xb0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::InstalledApplication) == 0x38, "Size mismatch!");
