...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::InvitePanelResultInfo*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::InvitePanelResultInfo*, "Oculus.Platform.Models", "InvitePanelResultInfo");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb5918, size 0x74, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::InvitePanelResultInfo) == 0x18, "Size mismatch!");
