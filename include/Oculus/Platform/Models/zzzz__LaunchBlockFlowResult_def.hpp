...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::LaunchBlockFlowResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::LaunchBlockFlowResult*, "Oculus.Platform.Models", "LaunchBlockFlowResult");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb5a1c, size 0x88, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::LaunchBlockFlowResult) == 0x18, "Size mismatch!");
