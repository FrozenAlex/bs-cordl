...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::LaunchFriendRequestFlowResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::LaunchFriendRequestFlowResult*, "Oculus.Platform.Models", "LaunchFriendRequestFlowResult");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb5bc0, size 0x88, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::LaunchFriendRequestFlowResult) == 0x18, "Size mismatch!");
