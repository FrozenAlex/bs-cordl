...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::LaunchInvitePanelFlowResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::LaunchInvitePanelFlowResult*, "Oculus.Platform.Models", "LaunchInvitePanelFlowResult");
...
static_assert(sizeof(::Oculus::Platform::Models::LaunchInvitePanelFlowResult) == 0x18, "Size mismatch!");
