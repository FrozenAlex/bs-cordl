...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::LaunchUnblockFlowResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::LaunchUnblockFlowResult*, "Oculus.Platform.Models", "LaunchUnblockFlowResult");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb5d70, size 0x88, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::LaunchUnblockFlowResult) == 0x18, "Size mismatch!");
