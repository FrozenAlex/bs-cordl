...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::LeaderboardEntryList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::LeaderboardEntryList*, "Oculus.Platform.Models", "LeaderboardEntryList");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb61d8, size 0x21c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::LeaderboardEntryList) == 0x30, "Size mismatch!");
