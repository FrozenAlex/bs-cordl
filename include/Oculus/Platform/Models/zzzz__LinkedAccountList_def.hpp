...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::LinkedAccountList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::LinkedAccountList*, "Oculus.Platform.Models", "LinkedAccountList");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb6484, size 0x1dc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::LinkedAccountList) == 0x28, "Size mismatch!");
