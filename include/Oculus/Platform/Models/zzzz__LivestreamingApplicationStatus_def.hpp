...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::LivestreamingApplicationStatus*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::LivestreamingApplicationStatus*, "Oculus.Platform.Models", "LivestreamingApplicationStatus");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dec5f4, size 0x74, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::LivestreamingApplicationStatus) == 0x18, "Size mismatch!");
