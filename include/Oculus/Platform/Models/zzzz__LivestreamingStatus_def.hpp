...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::LivestreamingStatus*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::LivestreamingStatus*, "Oculus.Platform.Models", "LivestreamingStatus");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb6744, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::LivestreamingStatus) == 0x20, "Size mismatch!");
