...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::ManagedInfo*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::ManagedInfo*, "Oculus.Platform.Models", "ManagedInfo");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dec828, size 0x100, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::ManagedInfo) == 0x60, "Size mismatch!");
