...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::NetSyncConnection*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::NetSyncConnection*, "Oculus.Platform.Models", "NetSyncConnection");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb6a08, size 0xb0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::NetSyncConnection) == 0x38, "Size mismatch!");
