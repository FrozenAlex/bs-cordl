...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::NetSyncSessionList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::NetSyncSessionList*, "Oculus.Platform.Models", "NetSyncSessionList");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb6b6c, size 0x1dc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::NetSyncSessionList) == 0x28, "Size mismatch!");
