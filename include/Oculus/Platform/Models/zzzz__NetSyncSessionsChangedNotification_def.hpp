...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::NetSyncSessionsChangedNotification*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::NetSyncSessionsChangedNotification*, "Oculus.Platform.Models", "NetSyncSessionsChangedNotification");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5deccdc, size 0xb4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::NetSyncSessionsChangedNotification) == 0x20, "Size mismatch!");
