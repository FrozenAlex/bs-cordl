...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::NetSyncSetSessionPropertyResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::NetSyncSetSessionPropertyResult*, "Oculus.Platform.Models", "NetSyncSetSessionPropertyResult");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5decd90, size 0xa4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::NetSyncSetSessionPropertyResult) == 0x18, "Size mismatch!");
