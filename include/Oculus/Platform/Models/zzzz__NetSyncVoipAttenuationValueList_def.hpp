...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::NetSyncVoipAttenuationValueList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::NetSyncVoipAttenuationValueList*, "Oculus.Platform.Models", "NetSyncVoipAttenuationValueList");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb6f20, size 0x1dc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::NetSyncVoipAttenuationValueList) == 0x28, "Size mismatch!");
