...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::NetSyncVoipAttenuationValue*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::NetSyncVoipAttenuationValue*, "Oculus.Platform.Models", "NetSyncVoipAttenuationValue");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dece34, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::NetSyncVoipAttenuationValue) == 0x18, "Size mismatch!");
