...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::PaidOffer*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::PaidOffer*, "Oculus.Platform.Models", "PaidOffer");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5de9980, size 0xb4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::PaidOffer) == 0x20, "Size mismatch!");
