...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::PartyUpdateNotification*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::PartyUpdateNotification*, "Oculus.Platform.Models", "PartyUpdateNotification");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5ded36c, size 0xd0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::PartyUpdateNotification) == 0x48, "Size mismatch!");
