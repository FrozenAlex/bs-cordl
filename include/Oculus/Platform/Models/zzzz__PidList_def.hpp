...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::PidList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::PidList*, "Oculus.Platform.Models", "PidList");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb7518, size 0x1dc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::PidList) == 0x28, "Size mismatch!");
