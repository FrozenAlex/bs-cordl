...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::Price*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::Price*, "Oculus.Platform.Models", "Price");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5ded100, size 0x90, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::Price) == 0x28, "Size mismatch!");
