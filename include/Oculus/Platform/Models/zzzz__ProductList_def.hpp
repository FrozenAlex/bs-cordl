...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::ProductList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::ProductList*, "Oculus.Platform.Models", "ProductList");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb7a18, size 0x1fc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::ProductList) == 0x28, "Size mismatch!");
