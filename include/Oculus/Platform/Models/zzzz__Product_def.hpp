...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::Product*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::Product*, "Oculus.Platform.Models", "Product");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5ded7c8, size 0x1e4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::Product) == 0x78, "Size mismatch!");
