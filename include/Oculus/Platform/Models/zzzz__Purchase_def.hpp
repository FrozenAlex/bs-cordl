...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::Purchase*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::Purchase*, "Oculus.Platform.Models", "Purchase");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb7c14, size 0xd0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::Purchase) == 0x48, "Size mismatch!");
