...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::SdkAccountList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::SdkAccountList*, "Oculus.Platform.Models", "SdkAccountList");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb8044, size 0x1dc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::SdkAccountList) == 0x28, "Size mismatch!");
