...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::SdkAccount*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::SdkAccount*, "Oculus.Platform.Models", "SdkAccount");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb7fc4, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::SdkAccount) == 0x20, "Size mismatch!");
