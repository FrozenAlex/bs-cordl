...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::SendInvitesResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::SendInvitesResult*, "Oculus.Platform.Models", "SendInvitesResult");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dee1b4, size 0xa8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::SendInvitesResult) == 0x18, "Size mismatch!");
