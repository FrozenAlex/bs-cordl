...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::SupplementaryMetric*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::SupplementaryMetric*, "Oculus.Platform.Models", "SupplementaryMetric");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb6158, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::SupplementaryMetric) == 0x20, "Size mismatch!");
