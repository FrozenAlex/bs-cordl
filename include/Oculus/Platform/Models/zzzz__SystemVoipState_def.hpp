...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::SystemVoipState*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::SystemVoipState*, "Oculus.Platform.Models", "SystemVoipState");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dee2cc, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::SystemVoipState) == 0x18, "Size mismatch!");
