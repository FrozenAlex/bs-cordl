...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::UserDataStoreUpdateResponse*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::UserDataStoreUpdateResponse*, "Oculus.Platform.Models", "UserDataStoreUpdateResponse");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb879c, size 0x74, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::UserDataStoreUpdateResponse) == 0x18, "Size mismatch!");
