...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::UserProof*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::UserProof*, "Oculus.Platform.Models", "UserProof");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb8810, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::UserProof) == 0x18, "Size mismatch!");
