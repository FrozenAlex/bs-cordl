...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::UserReportID*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::UserReportID*, "Oculus.Platform.Models", "UserReportID");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dee814, size 0x84, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::UserReportID) == 0x20, "Size mismatch!");
