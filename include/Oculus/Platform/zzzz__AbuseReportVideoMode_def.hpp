...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::AbuseReportVideoMode, "Oculus.Platform", "AbuseReportVideoMode");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::AbuseReportVideoMode) == 0x4, "Size mismatch!");
