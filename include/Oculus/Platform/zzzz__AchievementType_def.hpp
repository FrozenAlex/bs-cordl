...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::AchievementType, "Oculus.Platform", "AchievementType");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::AchievementType) == 0x4, "Size mismatch!");
