...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::AppInstallResult, "Oculus.Platform", "AppInstallResult");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::AppInstallResult) == 0x4, "Size mismatch!");
