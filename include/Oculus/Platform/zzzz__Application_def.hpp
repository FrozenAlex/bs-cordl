...
public:
  // Declarations
  /// @brief Method CancelAppDownload, addr 0x5de08fc, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AppDownloadResult*>* CancelAppDownload();

  /// @brief Method CheckAppDownloadProgress, addr 0x5de0a54, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AppDownloadProgressResult*>* CheckAppDownloadProgress();

  /// @brief Method GetVersion, addr 0x5de0bac, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::ApplicationVersion*>* GetVersion();

  /// @brief Method InstallAppUpdateAndRelaunch, addr 0x5de0d04, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method LaunchOtherApp, addr 0x5de0e74, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method StartAppDownload, addr 0x5de0fec, size 0x158, virtual false, abstract: false, final false
