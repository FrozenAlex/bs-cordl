...
// Write type traits
MARK_REF_T(::Oculus::Platform::Avatar*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Avatar*, "Oculus.Platform", "Avatar");
...
public:
  // Declarations
  /// @brief Method LaunchAvatarEditor, addr 0x5de23f8, size 0x170, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Avatar) == 0x10, "Size mismatch!");
