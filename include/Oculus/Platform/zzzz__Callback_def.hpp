...
// Write type traits
MARK_REF_T(::Oculus::Platform::Callback*);
MARK_REF_T(::Oculus::Platform::Callback_RequestCallback*);
MARK_GEN_REF_T_PTR(::Oculus::Platform::Callback_RequestCallback_1);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Callback*, "Oculus.Platform", "Callback");
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Callback_RequestCallback*, "Oculus.Platform", "Callback/RequestCallback");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Oculus::Platform::Callback_RequestCallback_1, "Oculus.Platform", "Callback/RequestCallback`1");
...
public:
  ...
  /// @brief Method HandleMessage, addr 0x5db16b4, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5db16b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5db0f20, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Callback_RequestCallback) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method AddRequest, addr 0x5db0f28, size 0xfc, virtual false, abstract: false, final false
  static inline void AddRequest(::Oculus::Platform::Request* request);

  /// @brief Method FlushJoinIntentNotificationQueue, addr 0x5db14e0, size 0xa4, virtual false, abstract: false, final false
  static inline void FlushJoinIntentNotificationQueue();

  /// @brief Method HandleMessage, addr 0x5db1178, size 0x22c, virtual false, abstract: false, final false
  static inline void HandleMessage(::Oculus::Platform::Message* msg);

  /// @brief Method OnApplicationQuit, addr 0x5db1430, size 0xb0, virtual false, abstract: false, final false
  static inline void OnApplicationQuit();

  /// @brief Method RunCallbacks, addr 0x5db1024, size 0x70, virtual false, abstract: false, final false
  static inline void RunCallbacks();

  /// @brief Method RunLimitedCallbacks, addr 0x5db13a4, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetNotificationCallback, addr 0x5db0e04, size 0x11c, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::Oculus::Platform::Callback) == 0x10, "Size mismatch!");
