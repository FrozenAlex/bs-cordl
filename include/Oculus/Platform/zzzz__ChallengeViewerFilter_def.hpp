...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::ChallengeViewerFilter, "Oculus.Platform", "ChallengeViewerFilter");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::ChallengeViewerFilter) == 0x4, "Size mismatch!");
