...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::ChallengeVisibility, "Oculus.Platform", "ChallengeVisibility");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::ChallengeVisibility) == 0x4, "Size mismatch!");
