...
public:
  // Declarations
  /// @brief Method Create, addr 0x5ca63c0, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method DeclineInvite, addr 0x5ca6538, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* DeclineInvite(uint64_t challengeID);

  /// @brief Method Delete, addr 0x5ca66a0, size 0x154, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* Delete(uint64_t challengeID);

  /// @brief Method Get, addr 0x5ca67fc, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Get(uint64_t challengeID);

  /// @brief Method GetEntries, addr 0x5ca6964, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesAfterRank, addr 0x5ca6aec, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesByIds, addr 0x5ca6c6c, size 0x19c, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::ChallengeEntryList*>* GetEntriesByIds(uint64_t challengeID, int32_t limit, ::Oculus::Platform::LeaderboardStartAt startAt,
                                                                                                                ::ArrayW<uint64_t> userIDs);

  /// @brief Method GetList, addr 0x5ca6e08, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextChallenges, addr 0x5ca60a0, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextEntries, addr 0x5ca5d80, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousChallenges, addr 0x5ca6230, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousEntries, addr 0x5ca5f10, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method Join, addr 0x5ca6f80, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Join(uint64_t challengeID);

  /// @brief Method Leave, addr 0x5ca70e8, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Leave(uint64_t challengeID);

  /// @brief Method UpdateInfo, addr 0x5ca7250, size 0x178, virtual false, abstract: false, final false
