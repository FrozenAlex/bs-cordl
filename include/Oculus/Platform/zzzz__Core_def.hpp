...
// Write type traits
MARK_REF_T(::Oculus::Platform::Core*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Core*, "Oculus.Platform", "Core");
...
public:
  ...
  /// @brief Method AsyncInitialize, addr 0x5ca4478, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method AsyncInitialize, addr 0x5ca3ecc, size 0x32c, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::PlatformInitialize*>* AsyncInitialize(::StringW appId);

  /// @brief Method ForceInitialized, addr 0x5ca3c04, size 0x60, virtual false, abstract: false, final false
  static inline void ForceInitialized();

  /// @brief Method GetAppIDFromConfig, addr 0x5ca3e1c, size 0xb0, virtual false, abstract: false, final false
  static inline ::StringW GetAppIDFromConfig();

  /// @brief Method Initialize, addr 0x5ca4844, size 0x348, virtual false, abstract: false, final false
  static inline void Initialize(::StringW appId);

  /// @brief Method IsInitialized, addr 0x5ca3ba8, size 0x5c, virtual false, abstract: false, final false
  static inline bool IsInitialized();

  static inline ::Oculus::Platform::Core* New_ctor();

  /// @brief Method .ctor, addr 0x5ca4d38, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method getAppID, addr 0x5ca3c64, size 0x1b8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Core) == 0x10, "Size mismatch!");
