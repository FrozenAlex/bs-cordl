...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::InitConfigOptions, "Oculus.Platform", "InitConfigOptions");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::InitConfigOptions) == 0x4, "Size mismatch!");
