...
public:
  ...
  /// @brief Method AddSuggestedUser, addr 0x5dd0a28, size 0x6c, virtual false, abstract: false, final false
  inline void AddSuggestedUser(uint64_t userID);

  /// @brief Method ClearSuggestedUsers, addr 0x5dd0a94, size 0x5c, virtual false, abstract: false, final false
  inline void ClearSuggestedUsers();

  /// @brief Method Finalize, addr 0x5dd0afc, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd09cc, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x5dd0af0, size 0xc, virtual false, abstract: false, final false
