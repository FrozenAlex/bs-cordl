...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::KeyValuePairType, "Oculus.Platform", "KeyValuePairType");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::KeyValuePairType) == 0x4, "Size mismatch!");
