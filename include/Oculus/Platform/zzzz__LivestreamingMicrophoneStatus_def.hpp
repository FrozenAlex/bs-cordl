...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::LivestreamingMicrophoneStatus, "Oculus.Platform", "LivestreamingMicrophoneStatus");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
public:
  ...
  /// @brief Field MicrophoneOff value: I32(2)
  static ::Oculus::Platform::LivestreamingMicrophoneStatus const MicrophoneOff;

  /// @brief Field MicrophoneOn value: I32(1)
...
static_assert(sizeof(::Oculus::Platform::LivestreamingMicrophoneStatus) == 0x4, "Size mismatch!");
