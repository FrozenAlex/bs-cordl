...
// Write type traits
MARK_REF_T(::Oculus::Platform::Livestreaming*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Livestreaming*, "Oculus.Platform", "Livestreaming");
...
public:
  // Declarations
  /// @brief Method SetStatusUpdateNotificationCallback, addr 0x5caffac, size 0x7c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Livestreaming) == 0x10, "Size mismatch!");
