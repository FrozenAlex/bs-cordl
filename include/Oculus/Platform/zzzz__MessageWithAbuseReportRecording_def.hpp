...
public:
  // Declarations
  /// @brief Method GetAbuseReportRecording, addr 0x5dd4ab8, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AbuseReportRecording* GetAbuseReportRecording();

  /// @brief Method GetDataFromMessage, addr 0x5dd4afc, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd4a5c, size 0x5c, virtual false, abstract: false, final false
