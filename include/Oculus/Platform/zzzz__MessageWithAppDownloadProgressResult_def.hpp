...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithAppDownloadProgressResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithAppDownloadProgressResult*, "Oculus.Platform", "MessageWithAppDownloadProgressResult");
...
public:
  // Declarations
  /// @brief Method GetAppDownloadProgressResult, addr 0x5c9f35c, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AppDownloadProgressResult* GetAppDownloadProgressResult();

  /// @brief Method GetDataFromMessage, addr 0x5c9f3a0, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9cb4c, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithAppDownloadProgressResult) == 0x30, "Size mismatch!");
