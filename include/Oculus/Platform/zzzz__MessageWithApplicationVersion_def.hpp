...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithApplicationVersion*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithApplicationVersion*, "Oculus.Platform", "MessageWithApplicationVersion");
...
public:
  // Declarations
  /// @brief Method GetApplicationVersion, addr 0x5dd5870, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ApplicationVersion* GetApplicationVersion();

  /// @brief Method GetDataFromMessage, addr 0x5dd58b4, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd2bf4, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithApplicationVersion) == 0x30, "Size mismatch!");
