...
public:
  // Declarations
  /// @brief Method GetAssetFileDeleteResult, addr 0x5c9fd24, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetFileDeleteResult* GetAssetFileDeleteResult();

  /// @brief Method GetDataFromMessage, addr 0x5c9fd68, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9cd74, size 0x5c, virtual false, abstract: false, final false
