...
public:
  // Declarations
  /// @brief Method GetAssetFileDownloadCancelResult, addr 0x5c9fe04, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetFileDownloadCancelResult* GetAssetFileDownloadCancelResult();

  /// @brief Method GetDataFromMessage, addr 0x5c9fe48, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9cdd0, size 0x5c, virtual false, abstract: false, final false
