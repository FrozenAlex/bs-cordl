...
public:
  // Declarations
  /// @brief Method GetBlockedUserList, addr 0x5dd6118, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::BlockedUserList* GetBlockedUserList();

  /// @brief Method GetDataFromMessage, addr 0x5dd615c, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd2ed4, size 0x5c, virtual false, abstract: false, final false
