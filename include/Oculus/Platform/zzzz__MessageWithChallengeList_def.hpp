...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithChallengeList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithChallengeList*, "Oculus.Platform", "MessageWithChallengeList");
...
public:
  // Declarations
  /// @brief Method GetChallengeList, addr 0x5ca0344, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ChallengeList* GetChallengeList();

  /// @brief Method GetDataFromMessage, addr 0x5ca0388, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9cff8, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithChallengeList) == 0x30, "Size mismatch!");
