...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithCowatchingState*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithCowatchingState*, "Oculus.Platform", "MessageWithCowatchingState");
...
public:
  // Declarations
  /// @brief Method GetCowatchingState, addr 0x5dd6658, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::CowatchingState* GetCowatchingState();

  /// @brief Method GetDataFromMessage, addr 0x5dd669c, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd30fc, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithCowatchingState) == 0x30, "Size mismatch!");
