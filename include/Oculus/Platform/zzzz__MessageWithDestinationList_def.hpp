...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithDestinationList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithDestinationList*, "Oculus.Platform", "MessageWithDestinationList");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dd677c, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::DestinationList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetDestinationList, addr 0x5dd6738, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd3158, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithDestinationList) == 0x30, "Size mismatch!");
