...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithGroupPresenceLeaveIntent*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithGroupPresenceLeaveIntent*, "Oculus.Platform", "MessageWithGroupPresenceLeaveIntent");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dd693c, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::GroupPresenceLeaveIntent* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetGroupPresenceLeaveIntent, addr 0x5dd68f8, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd3210, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithGroupPresenceLeaveIntent) == 0x30, "Size mismatch!");
