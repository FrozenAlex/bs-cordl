...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithInvitePanelResultInfo*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithInvitePanelResultInfo*, "Oculus.Platform", "MessageWithInvitePanelResultInfo");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ca0bc4, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::InvitePanelResultInfo* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetInvitePanelResultInfo, addr 0x5ca0b80, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9d2d8, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithInvitePanelResultInfo) == 0x30, "Size mismatch!");
