...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ca0e64, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LaunchInvitePanelFlowResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLaunchInvitePanelFlowResult, addr 0x5ca0e20, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9d3ec, size 0x5c, virtual false, abstract: false, final false
