...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithLaunchInvitePanelFlowResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithLaunchInvitePanelFlowResult*, "Oculus.Platform", "MessageWithLaunchInvitePanelFlowResult");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dd6df8, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LaunchInvitePanelFlowResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLaunchInvitePanelFlowResult, addr 0x5dd6db4, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd3380, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithLaunchInvitePanelFlowResult) == 0x30, "Size mismatch!");
