...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithLaunchUnblockFlowResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithLaunchUnblockFlowResult*, "Oculus.Platform", "MessageWithLaunchUnblockFlowResult");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dd7014, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LaunchUnblockFlowResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLaunchUnblockFlowResult, addr 0x5dd6fd0, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd33dc, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithLaunchUnblockFlowResult) == 0x30, "Size mismatch!");
