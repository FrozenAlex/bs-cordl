...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithLivestreamingStartResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithLivestreamingStartResult*, "Oculus.Platform", "MessageWithLivestreamingStartResult");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dd752c, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingStartResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLivestreamingStartResult, addr 0x5dd74e8, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd748c, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithLivestreamingStartResult) == 0x30, "Size mismatch!");
