...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithLivestreamingStatus*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithLivestreamingStatus*, "Oculus.Platform", "MessageWithLivestreamingStatus");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ca1678, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingStatus* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLivestreamingStatus, addr 0x5ca1634, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9d614, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithLivestreamingStatus) == 0x30, "Size mismatch!");
