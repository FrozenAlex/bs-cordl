...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithNetSyncConnection*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithNetSyncConnection*, "Oculus.Platform", "MessageWithNetSyncConnection");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ca1974, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncConnection* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetNetSyncConnection, addr 0x5ca1930, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9d6cc, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithNetSyncConnection) == 0x30, "Size mismatch!");
