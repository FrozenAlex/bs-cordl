...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dd7908, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncConnection* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetNetSyncConnection, addr 0x5dd78c4, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd3660, size 0x5c, virtual false, abstract: false, final false
