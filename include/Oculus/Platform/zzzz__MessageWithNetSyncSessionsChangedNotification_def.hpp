...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithNetSyncSessionsChangedNotification*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithNetSyncSessionsChangedNotification*, "Oculus.Platform", "MessageWithNetSyncSessionsChangedNotification");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ca1b90, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncSessionsChangedNotification* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetNetSyncSessionsChangedNotification, addr 0x5ca1b4c, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9d728, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithNetSyncSessionsChangedNotification) == 0x30, "Size mismatch!");
