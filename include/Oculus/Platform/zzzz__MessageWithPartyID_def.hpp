...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithPartyID*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithPartyID*, "Oculus.Platform", "MessageWithPartyID");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ca2240, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PartyID* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetPartyID, addr 0x5ca21fc, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ca21a0, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithPartyID) == 0x30, "Size mismatch!");
