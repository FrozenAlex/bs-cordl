...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithParty*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithParty*, "Oculus.Platform", "MessageWithParty");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dd7fb8, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Party* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetParty, addr 0x5dd7f74, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd7f18, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithParty) == 0x30, "Size mismatch!");
