...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithProductList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithProductList*, "Oculus.Platform", "MessageWithProductList");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ca24e0, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ProductList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetProductList, addr 0x5ca249c, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9d8f4, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithProductList) == 0x30, "Size mismatch!");
