...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithPurchaseList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithPurchaseList*, "Oculus.Platform", "MessageWithPurchaseList");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ca26a0, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PurchaseList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetPurchaseList, addr 0x5ca265c, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9d9ac, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithPurchaseList) == 0x30, "Size mismatch!");
