...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithPushNotificationResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithPushNotificationResult*, "Oculus.Platform", "MessageWithPushNotificationResult");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dd8714, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PushNotificationResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetPushNotificationResult, addr 0x5dd86d0, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd399c, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithPushNotificationResult) == 0x30, "Size mismatch!");
