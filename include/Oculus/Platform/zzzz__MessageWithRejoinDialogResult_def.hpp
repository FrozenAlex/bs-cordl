...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithRejoinDialogResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithRejoinDialogResult*, "Oculus.Platform", "MessageWithRejoinDialogResult");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dd87f4, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::RejoinDialogResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetRejoinDialogResult, addr 0x5dd87b0, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd39f8, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithRejoinDialogResult) == 0x30, "Size mismatch!");
