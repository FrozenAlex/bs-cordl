...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithSdkAccountList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithSdkAccountList*, "Oculus.Platform", "MessageWithSdkAccountList");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ca2940, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::SdkAccountList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetSdkAccountList, addr 0x5ca28fc, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9dac0, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithSdkAccountList) == 0x30, "Size mismatch!");
