...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithShareMediaResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithShareMediaResult*, "Oculus.Platform", "MessageWithShareMediaResult");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dd8a94, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ShareMediaResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetShareMediaResult, addr 0x5dd8a50, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd3b0c, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithShareMediaResult) == 0x30, "Size mismatch!");
