...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithUserCapabilityList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithUserCapabilityList*, "Oculus.Platform", "MessageWithUserCapabilityList");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ca2ffc, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserCapabilityList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetUserCapabilityList, addr 0x5ca2fb8, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9dda0, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithUserCapabilityList) == 0x30, "Size mismatch!");
