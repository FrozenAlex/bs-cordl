...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithUserList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithUserList*, "Oculus.Platform", "MessageWithUserList");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dd8eb0, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetUserList, addr 0x5dd8e6c, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd3cd8, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithUserList) == 0x30, "Size mismatch!");
