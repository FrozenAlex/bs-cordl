...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ca3218, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserReportID* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetUserReportID, addr 0x5ca31d4, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ca3178, size 0x5c, virtual false, abstract: false, final false
