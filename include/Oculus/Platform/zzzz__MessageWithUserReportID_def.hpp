...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithUserReportID*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithUserReportID*, "Oculus.Platform", "MessageWithUserReportID");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dd91ac, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserReportID* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetUserReportID, addr 0x5dd9168, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd910c, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithUserReportID) == 0x30, "Size mismatch!");
