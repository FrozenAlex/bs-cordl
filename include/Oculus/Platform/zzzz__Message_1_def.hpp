...
// Write type traits
MARK_GEN_REF_T_PTR(::Oculus::Platform::Message_1);
MARK_GEN_REF_T_PTR(::Oculus::Platform::Message_1_Callback);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Oculus::Platform::Message_1, "Oculus.Platform", "Message`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Oculus::Platform::Message_1_Callback, "Oculus.Platform", "Message`1/Callback");
