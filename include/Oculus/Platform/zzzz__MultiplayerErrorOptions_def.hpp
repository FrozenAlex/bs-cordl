...
// Write type traits
MARK_REF_T(::Oculus::Platform::MultiplayerErrorOptions*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MultiplayerErrorOptions*, "Oculus.Platform", "MultiplayerErrorOptions");
...
public:
  ...
  /// @brief Method Finalize, addr 0x5dd9580, size 0x94, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::MultiplayerErrorOptions* New_ctor();

  /// @brief Method SetErrorKey, addr 0x5dd9508, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd94ac, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x5dd9574, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MultiplayerErrorOptions) == 0x18, "Size mismatch!");
