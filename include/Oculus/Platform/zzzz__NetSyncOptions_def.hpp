...
// Write type traits
MARK_REF_T(::Oculus::Platform::NetSyncOptions*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::NetSyncOptions*, "Oculus.Platform", "NetSyncOptions");
...
public:
  ...
  /// @brief Method Finalize, addr 0x5ca382c, size 0x94, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::NetSyncOptions* New_ctor();

  /// @brief Method SetVoipGroup, addr 0x5ca36dc, size 0x6c, virtual false, abstract: false, final false
  inline void SetVoipGroup(::StringW value);

  /// @brief Method SetVoipStreamDefault, addr 0x5ca3748, size 0x6c, virtual false, abstract: false, final false
  inline void SetVoipStreamDefault(::Oculus::Platform::NetSyncVoipStreamMode value);

  /// @brief Method SetZoneId, addr 0x5ca37b4, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ca3680, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x5ca3820, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::NetSyncOptions) == 0x18, "Size mismatch!");
