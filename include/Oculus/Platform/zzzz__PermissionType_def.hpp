...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::PermissionType, "Oculus.Platform", "PermissionType");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::PermissionType) == 0x4, "Size mismatch!");
