...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::PlatformInternal_MessageTypeInternal, "Oculus.Platform", "PlatformInternal/MessageTypeInternal");
...
static_assert(sizeof(::Oculus::Platform::PlatformInternal_MessageTypeInternal) == 0x4, "Size mismatch!");
...
public:
  // Declarations
  /// @brief Method SetHttpTransferUpdateCallback, addr 0x5cb131c, size 0x7c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method GetLinkedAccounts, addr 0x5cb1398, size 0x1a4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CrashApplication, addr 0x5cb10b8, size 0x50, virtual false, abstract: false, final false
  static inline void CrashApplication();

  /// @brief Method InitializeStandaloneAsync, addr 0x5cb1108, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseMessageHandle, addr 0x5c9df10, size 0x868, virtual false, abstract: false, final false
