...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::RichPresenceExtraContext, "Oculus.Platform", "RichPresenceExtraContext");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::RichPresenceExtraContext) == 0x4, "Size mismatch!");
