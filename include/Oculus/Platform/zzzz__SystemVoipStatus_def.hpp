...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::SystemVoipStatus, "Oculus.Platform", "SystemVoipStatus");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::SystemVoipStatus) == 0x4, "Size mismatch!");
