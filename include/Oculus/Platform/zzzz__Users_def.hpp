...
public:
  // Declarations
  /// @brief Method Get, addr 0x5dde1a0, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::User*>* Get(uint64_t userID);

  /// @brief Method GetAccessToken, addr 0x5dde308, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::StringW>* GetAccessToken();

  /// @brief Method GetBlockedUsers, addr 0x5dde460, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::BlockedUserList*>* GetBlockedUsers();

  /// @brief Method GetLinkedAccounts, addr 0x5dde5b8, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLoggedInUser, addr 0x5dde734, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::User*>* GetLoggedInUser();

  /// @brief Method GetLoggedInUserFriends, addr 0x5dde88c, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::UserList*>* GetLoggedInUserFriends();

  /// @brief Method GetLoggedInUserLocale, addr 0x5dde0b8, size 0xe8, virtual false, abstract: false, final false
  static inline ::StringW GetLoggedInUserLocale();

  /// @brief Method GetLoggedInUserManagedInfo, addr 0x5dde9e4, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::User*>* GetLoggedInUserManagedInfo();

  /// @brief Method GetNextBlockedUserListPage, addr 0x5ddf38c, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextUserCapabilityListPage, addr 0x5ddf76c, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextUserListPage, addr 0x5ddf57c, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOrgScopedID, addr 0x5ddeb3c, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::OrgScopedID*>* GetOrgScopedID(uint64_t userID);

  /// @brief Method GetSdkAccounts, addr 0x5ddeca4, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::SdkAccountList*>* GetSdkAccounts();

  /// @brief Method GetUserProof, addr 0x5ddedfc, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::UserProof*>* GetUserProof();

  /// @brief Method LaunchBlockFlow, addr 0x5ddef54, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::LaunchBlockFlowResult*>* LaunchBlockFlow(uint64_t userID);

  /// @brief Method LaunchFriendRequestFlow, addr 0x5ddf0bc, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method LaunchUnblockFlow, addr 0x5ddf224, size 0x168, virtual false, abstract: false, final false
