...
// Write type traits
MARK_REF_T(::Oculus::Platform::VoipAudioSourceHiLevel*);
MARK_REF_T(::Oculus::Platform::VoipAudioSourceHiLevel_FilterReadDelegate*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::VoipAudioSourceHiLevel*, "Oculus.Platform", "VoipAudioSourceHiLevel");
DEFINE_IL2CPP_CLASS(::Oculus::Platform::VoipAudioSourceHiLevel_FilterReadDelegate*, "Oculus.Platform", "VoipAudioSourceHiLevel/FilterReadDelegate");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_scratchBuffer, put = __cordl_internal_set_scratchBuffer)) ::ArrayW<float_t> scratchBuffer;

  /// @brief Method Awake, addr 0x5de8654, size 0x84, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::Oculus::Platform::VoipAudioSourceHiLevel_FilterReadDelegate* New_ctor();

  /// @brief Method OnAudioFilterRead, addr 0x5de86d8, size 0x4c0, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<float_t> const& __cordl_internal_get_scratchBuffer() const;

  constexpr ::ArrayW<float_t>& __cordl_internal_get_scratchBuffer();

  constexpr void __cordl_internal_set_parent(::UnityW<::Oculus::Platform::VoipAudioSourceHiLevel> value);

  constexpr void __cordl_internal_set_scratchBuffer(::ArrayW<float_t> value);

  /// @brief Method .ctor, addr 0x5de8b98, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<float_t> ___scratchBuffer;
...
static_assert(sizeof(::Oculus::Platform::VoipAudioSourceHiLevel_FilterReadDelegate) == 0x30, "Size mismatch!");
...
public:
  ...
  /// @brief Method Awake, addr 0x5de7fa0, size 0x2d4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CreatePCMSource, addr 0x5de828c, size 0x50, virtual true, abstract: false, final false
  inline void CreatePCMSource();

  /// @brief Method MSToElements, addr 0x5de82e0, size 0x6c, virtual false, abstract: false, final false
  static inline int32_t MSToElements(int32_t ms);

  static inline ::Oculus::Platform::VoipAudioSourceHiLevel* New_ctor();

  /// @brief Method SampleRateToEnum, addr 0x5de7f5c, size 0x44, virtual false, abstract: false, final false
  inline ::Oculus::Platform::VoipSampleRate SampleRateToEnum(int32_t rate);

  /// @brief Method Start, addr 0x5de8274, size 0x18, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Stop, addr 0x5de7f58, size 0x4, virtual false, abstract: false, final false
  inline void Stop();

  /// @brief Method Update, addr 0x5de834c, size 0x304, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5de8650, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_senderID, addr 0x5de7ea0, size 0xb8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::VoipAudioSourceHiLevel) == 0x40, "Size mismatch!");
