...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::VoipSampleRate, "Oculus.Platform", "VoipSampleRate");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::VoipSampleRate) == 0x4, "Size mismatch!");
