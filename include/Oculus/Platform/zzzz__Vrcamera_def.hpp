...
public:
  // Declarations
  /// @brief Method SetGetDataChannelMessageUpdateNotificationCallback, addr 0x5de6f54, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetGetSurfaceUpdateNotificationCallback, addr 0x5de6fd0, size 0x7c, virtual false, abstract: false, final false
