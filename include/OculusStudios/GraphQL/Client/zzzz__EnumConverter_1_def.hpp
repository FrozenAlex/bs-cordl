...
// Write type traits
MARK_GEN_REF_T_PTR(::OculusStudios::GraphQL::Client::EnumConverter_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::OculusStudios::GraphQL::Client::EnumConverter_1, "OculusStudios.GraphQL.Client", "EnumConverter`1");
