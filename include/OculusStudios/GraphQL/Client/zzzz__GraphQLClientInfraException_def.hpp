...
public:
  ...
  /// @brief Method .ctor, addr 0x5f1a7e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5f1a7e8, size 0x4, virtual false, abstract: false, final false
