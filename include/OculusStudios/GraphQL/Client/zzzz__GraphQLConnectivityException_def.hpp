...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::Client::GraphQLConnectivityException*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::Client::GraphQLConnectivityException*, "OculusStudios.GraphQL.Client", "GraphQLConnectivityException");
...
static_assert(sizeof(::OculusStudios::GraphQL::Client::GraphQLConnectivityException) == 0x90, "Size mismatch!");
