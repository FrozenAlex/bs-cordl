...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::Client::GraphQLMutation*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::Client::GraphQLMutation*, "OculusStudios.GraphQL.Client", "GraphQLMutation");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5df1824, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::OculusStudios::GraphQL::Client::GraphQLMutation) == 0x48, "Size mismatch!");
