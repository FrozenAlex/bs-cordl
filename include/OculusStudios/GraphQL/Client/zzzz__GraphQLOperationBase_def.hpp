...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::Client::GraphQLOperationBase*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::Client::GraphQLOperationBase*, "OculusStudios.GraphQL.Client", "GraphQLOperationBase");
...
public:
  ...
  /// @brief Method GetParams, addr 0x5de7898, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5de7814, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::OculusStudios::GraphQL::Client::GraphQLOperationBase) == 0x18, "Size mismatch!");
