...
public:
  ...
  /// @brief Method GetParams, addr 0x5f1d82c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5f1d7a8, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
