...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::Client::GraphQLRequestExceptionRateLimitExceeded*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::Client::GraphQLRequestExceptionRateLimitExceeded*, "OculusStudios.GraphQL.Client", "GraphQLRequestExceptionRateLimitExceeded");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5f1a69c, size 0x4, virtual false, abstract: false, final false
...
static_assert(sizeof(::OculusStudios::GraphQL::Client::GraphQLRequestExceptionRateLimitExceeded) == 0x98, "Size mismatch!");
