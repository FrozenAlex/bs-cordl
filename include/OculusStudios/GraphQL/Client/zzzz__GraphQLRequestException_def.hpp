...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::Client::GraphQLRequestException*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::Client::GraphQLRequestException*, "OculusStudios.GraphQL.Client", "GraphQLRequestException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5de4860, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5de46c0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(int32_t errorCode, ::StringW message);

  /// @brief Method .ctor, addr 0x5de4864, size 0x4, virtual false, abstract: false, final false
...
static_assert(sizeof(::OculusStudios::GraphQL::Client::GraphQLRequestException) == 0x98, "Size mismatch!");
