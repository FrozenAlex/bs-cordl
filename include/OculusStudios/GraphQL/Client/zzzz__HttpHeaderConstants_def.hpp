...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::Client::HttpHeaderConstants*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::Client::HttpHeaderConstants*, "OculusStudios.GraphQL.Client", "HttpHeaderConstants");
...
static_assert(sizeof(::OculusStudios::GraphQL::Client::HttpHeaderConstants) == 0x10, "Size mismatch!");
