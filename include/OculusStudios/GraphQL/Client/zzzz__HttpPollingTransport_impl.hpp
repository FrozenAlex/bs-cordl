...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::OculusStudios::GraphQL::Client::HttpPollingTransport___c__DisplayClass12_0::*)()>(
  ...
  constexpr static std::size_t addrs = 0x5f223b4;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::OculusStudios::GraphQL::Client::HttpPollingTransport___c__DisplayClass12_0::*)()>(
  ...
  constexpr static std::size_t addrs = 0x5f223b8;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::OculusStudios::GraphQL::Client::HttpPollingTransport__ExecuteAsync_d__12::*)()>(
  ...
  constexpr static std::size_t addrs = 0x5f223d4;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::OculusStudios::GraphQL::Client::HttpPollingTransport__ExecuteAsync_d__12::*)(::System::Runtime::CompilerServices::IAsyncStateMachine*)>(
  ...
  constexpr static std::size_t addrs = 0x5f22998;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::OculusStudios::GraphQL::Client::HttpPollingTransport__StartHttpPollingAsync_d__13::*)()>(
  ...
  constexpr static std::size_t addrs = 0x5f22a18;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::OculusStudios::GraphQL::Client::HttpPollingTransport__StartHttpPollingAsync_d__13::*)(
  ...
  constexpr static std::size_t addrs = 0x5f22e74;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::OculusStudios::GraphQL::Client::HttpPollingTransport::*)(::StringW)>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x5f220b4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::OculusStudios::GraphQL::Client::HttpPollingTransport*>(), { "set_Endpoint", {}, { ::i2c::type_of<::StringW>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::StringW (::OculusStudios::GraphQL::Client::HttpPollingTransport::*)()>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x5f220bc;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::OculusStudios::GraphQL::Client::HttpPollingTransport::*)(::StringW)>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x5f220c4;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::OculusStudios::GraphQL::Client::HttpTransport* (
  ...
  constexpr static std::size_t addrs = 0x5f220cc;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{},
        (::i2c::find_method(
            ::i2c::class_of<::OculusStudios::GraphQL::Client::HttpPollingTransport*>(),
            { "GetHttpTransport", {}, { ::i2c::type_of<::StringW>(), ::i2c::type_of<::StringW>(), ::i2c::type_of<::System::Collections::Generic::IDictionary_2<::StringW, ::StringW>*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Threading::Tasks::Task_1<::OculusStudios::GraphQL::Client::GraphQLResponseStream*>* (
  ...
  constexpr static std::size_t addrs = 0x5f2215c;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::OculusStudios::GraphQL::Client::HttpPollingTransport::*)(
  ...
  constexpr static std::size_t addrs = 0x5f22250;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::OculusStudios::GraphQL::Client::HttpPollingTransport*>(),
                                                { "StartHttpPollingAsync",
                                                  {},
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::OculusStudios::GraphQL::Client::HttpPollingTransport::*)()>(&::OculusStudios::GraphQL::Client::HttpPollingTransport::Dispose)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x5f22318;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::OculusStudios::GraphQL::Client::HttpPollingTransport::*)()>(&::OculusStudios::GraphQL::Client::HttpPollingTransport::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5f2231c;
...
constexpr void OculusStudios::GraphQL::Client::HttpPollingTransport::__cordl_internal_set__httpTransport(::OculusStudios::GraphQL::Client::HttpTransport* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____httpTransport = value;
}
inline void OculusStudios::GraphQL::Client::HttpPollingTransport::setStaticF_TOTAL_NUM_POLL_REQUESTS(int32_t value) {
  ::cordl_internals::setStaticField<int32_t, "TOTAL_NUM_POLL_REQUESTS", ::OculusStudios::GraphQL::Client::HttpPollingTransport*>(std::forward<int32_t>(value));
}
inline int32_t OculusStudios::GraphQL::Client::HttpPollingTransport::getStaticF_TOTAL_NUM_POLL_REQUESTS() {
  return ::cordl_internals::getStaticField<int32_t, "TOTAL_NUM_POLL_REQUESTS", ::OculusStudios::GraphQL::Client::HttpPollingTransport*>();
}
...
OculusStudios::GraphQL::Client::HttpPollingTransport::GetHttpTransport(::StringW endpoint, ::StringW accessToken,
  ...
  static auto* ___internal_method = THROW_UNLESS(
      ...
      (::i2c::find_method(
          ::i2c::class_of<::OculusStudios::GraphQL::Client::HttpPollingTransport*>(),
          { "GetHttpTransport", {}, { ::i2c::type_of<::StringW>(), ::i2c::type_of<::StringW>(), ::i2c::type_of<::System::Collections::Generic::IDictionary_2<::StringW, ::StringW>*>() } })));
  return ::cordl_internals::RunMethodRethrow<::OculusStudios::GraphQL::Client::HttpTransport*>(this, ___internal_method, endpoint, accessToken, customAppHeaders);
}
...
OculusStudios::GraphQL::Client::HttpPollingTransport::ExecuteAsync(::OculusStudios::GraphQL::Client::GraphQLRequest* graphQLRequest,
  ...
  static auto* ___internal_method = THROW_UNLESS(
      ...
      (::i2c::find_method(
          ::i2c::class_of<::OculusStudios::GraphQL::Client::HttpPollingTransport*>(),
          { "ExecuteAsync", {}, { ::i2c::type_of<::OculusStudios::GraphQL::Client::GraphQLRequest*>(), ::i2c::type_of<::OculusStudios::GraphQL::Client::MinimalMainThreadExecutor*>() } })));
  return ::cordl_internals::RunMethodRethrow<::System::Threading::Tasks::Task_1<::OculusStudios::GraphQL::Client::GraphQLResponseStream*>*>(this, ___internal_method, graphQLRequest, executor);
}
  ...
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::OculusStudios::GraphQL::Client::HttpPollingTransport*>(),
                                              { "StartHttpPollingAsync",
                                                ...
                                                { ::i2c::type_of<::OculusStudios::GraphQL::Client::GraphQLLiveQuery*>(), ::i2c::type_of<::OculusStudios::GraphQL::Client::GraphQLResponseStream*>(),
                                                  ::i2c::type_of<::OculusStudios::GraphQL::Client::MinimalMainThreadExecutor*>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, liveQuery, operation, executor);
}
...
inline ::OculusStudios::GraphQL::Client::HttpPollingTransport* OculusStudios::GraphQL::Client::HttpPollingTransport::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::OculusStudios::GraphQL::Client::HttpPollingTransport*>());
}
