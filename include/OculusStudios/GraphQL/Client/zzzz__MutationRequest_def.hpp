...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::Client::MutationRequest*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::Client::MutationRequest*, "OculusStudios.GraphQL.Client", "MutationRequest");
...
public:
  ...
  /// @brief Method GetCodeGenInfo, addr 0x5de87a4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method PerformRequest, addr 0x5de8784, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5de8708, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::OculusStudios::GraphQL::Client::GraphQLMutationOperation* mutation, bool forceRequestWhenOffline);

  /// @brief Method add_performRequestCalled, addr 0x5de8588, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_performRequestCalled, addr 0x5de8648, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::OculusStudios::GraphQL::Client::MutationRequest) == 0x68, "Size mismatch!");
