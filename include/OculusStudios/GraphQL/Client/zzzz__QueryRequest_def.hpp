...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::Client::QueryRequest*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::Client::QueryRequest*, "OculusStudios.GraphQL.Client", "QueryRequest");
...
public:
  ...
  /// @brief Method GetCodeGenInfo, addr 0x5f1e9f8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method PerformRequest, addr 0x5f1e9d0, size 0x20, virtual true, abstract: false, final false
  inline void PerformRequest();

  /// @brief Method SupportsClientMutationId, addr 0x5f1e9f0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f1e954, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::OculusStudios::GraphQL::Client::GraphQLQueryOperation* query, bool forceRequestWhenOffline);

  /// @brief Method add_performRequestCalled, addr 0x5f1e7d4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_performRequestCalled, addr 0x5f1e894, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::OculusStudios::GraphQL::Client::QueryRequest) == 0x68, "Size mismatch!");
