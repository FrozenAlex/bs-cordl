...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::ClientInterface::ApplicationSuspendedException*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::ClientInterface::ApplicationSuspendedException*, "OculusStudios.GraphQL.ClientInterface", "ApplicationSuspendedException");
...
static_assert(sizeof(::OculusStudios::GraphQL::ClientInterface::ApplicationSuspendedException) == 0x90, "Size mismatch!");
