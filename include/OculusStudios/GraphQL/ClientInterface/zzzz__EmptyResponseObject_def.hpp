...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::ClientInterface::EmptyResponseObject*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::ClientInterface::EmptyResponseObject*, "OculusStudios.GraphQL.ClientInterface", "EmptyResponseObject");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5f27da0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::OculusStudios::GraphQL::ClientInterface::EmptyResponseObject) == 0x10, "Size mismatch!");
