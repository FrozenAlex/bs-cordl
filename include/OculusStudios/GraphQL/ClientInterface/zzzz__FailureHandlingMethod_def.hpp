...
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::ClientInterface::FailureHandlingMethod, "OculusStudios.GraphQL.ClientInterface", "FailureHandlingMethod");
// Dependencies
namespace OculusStudios::GraphQL::ClientInterface {
// Is value type: true
...
static_assert(sizeof(::OculusStudios::GraphQL::ClientInterface::FailureHandlingMethod) == 0x4, "Size mismatch!");
