...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::ClientInterface::GraphErrorCodeExtensions*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::ClientInterface::GraphErrorCodeExtensions*, "OculusStudios.GraphQL.ClientInterface", "GraphErrorCodeExtensions");
...
static_assert(sizeof(::OculusStudios::GraphQL::ClientInterface::GraphErrorCodeExtensions) == 0x10, "Size mismatch!");
