...
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::ClientInterface::GraphErrorCode, "OculusStudios.GraphQL.ClientInterface", "GraphErrorCode");
// Dependencies
namespace OculusStudios::GraphQL::ClientInterface {
// Is value type: true
...
static_assert(sizeof(::OculusStudios::GraphQL::ClientInterface::GraphErrorCode) == 0x4, "Size mismatch!");
