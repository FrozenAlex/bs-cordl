...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::ClientInterface::IFragmentModel*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::ClientInterface::IFragmentModel*, "OculusStudios.GraphQL.ClientInterface", "IFragmentModel");
// Dependencies
namespace OculusStudios::GraphQL::ClientInterface {
// Is value type: false
