...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::ClientInterface::IGraphQLClientEvents*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::ClientInterface::IGraphQLClientEvents*, "OculusStudios.GraphQL.ClientInterface", "IGraphQLClientEvents");
// Dependencies
namespace OculusStudios::GraphQL::ClientInterface {
// Is value type: false
