...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::ClientInterface::IQueryRequest*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::ClientInterface::IQueryRequest*, "OculusStudios.GraphQL.ClientInterface", "IQueryRequest");
// Dependencies
namespace OculusStudios::GraphQL::ClientInterface {
// Is value type: false
