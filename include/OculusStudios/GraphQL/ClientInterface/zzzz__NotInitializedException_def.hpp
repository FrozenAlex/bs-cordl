...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::ClientInterface::NotInitializedException*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::ClientInterface::NotInitializedException*, "OculusStudios.GraphQL.ClientInterface", "NotInitializedException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5df1eb8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5df1f10, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x5df1f7c, size 0x74, virtual false, abstract: false, final false
...
static_assert(sizeof(::OculusStudios::GraphQL::ClientInterface::NotInitializedException) == 0x90, "Size mismatch!");
