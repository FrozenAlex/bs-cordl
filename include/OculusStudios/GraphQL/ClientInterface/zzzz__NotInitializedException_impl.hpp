...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::OculusStudios::GraphQL::ClientInterface::NotInitializedException::*)()>(
  ...
  constexpr static std::size_t addrs = 0x5f27edc;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::OculusStudios::GraphQL::ClientInterface::NotInitializedException*>(), { ".ctor", {}, {} })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::OculusStudios::GraphQL::ClientInterface::NotInitializedException::*)(::StringW)>(
  ...
  constexpr static std::size_t addrs = 0x5f27f34;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::OculusStudios::GraphQL::ClientInterface::NotInitializedException*>(), { ".ctor", {}, { ::i2c::type_of<::StringW>() } })));
    return ___internal_method;
  }
};
//  Writing Method size for method: ::OculusStudios::GraphQL::ClientInterface::NotInitializedException._ctor
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::OculusStudios::GraphQL::ClientInterface::NotInitializedException::*)(::StringW, ::System::Exception*)>(
  ...
  constexpr static std::size_t addrs = 0x5f27fa0;
...
inline void OculusStudios::GraphQL::ClientInterface::NotInitializedException::_ctor() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::OculusStudios::GraphQL::ClientInterface::NotInitializedException*>(), { ".ctor", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
inline void OculusStudios::GraphQL::ClientInterface::NotInitializedException::_ctor(::StringW message) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::OculusStudios::GraphQL::ClientInterface::NotInitializedException*>(), { ".ctor", {}, { ::i2c::type_of<::StringW>() } })));
...
inline ::OculusStudios::GraphQL::ClientInterface::NotInitializedException* OculusStudios::GraphQL::ClientInterface::NotInitializedException::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::OculusStudios::GraphQL::ClientInterface::NotInitializedException*>());
}
inline ::OculusStudios::GraphQL::ClientInterface::NotInitializedException* OculusStudios::GraphQL::ClientInterface::NotInitializedException::New_ctor(::StringW message) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::OculusStudios::GraphQL::ClientInterface::NotInitializedException*>(message));
}
inline ::OculusStudios::GraphQL::ClientInterface::NotInitializedException* OculusStudios::GraphQL::ClientInterface::NotInitializedException::New_ctor(::StringW message, ::System::Exception* inner) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::OculusStudios::GraphQL::ClientInterface::NotInitializedException*>(message, inner));
}
// Ctor Parameters []
