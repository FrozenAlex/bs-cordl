...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::ClientInterface::RequestStateExtensions*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::ClientInterface::RequestStateExtensions*, "OculusStudios.GraphQL.ClientInterface", "RequestStateExtensions");
...
public:
  // Declarations
  /// @brief Method ToVerboseLogFormat, addr 0x5df32b0, size 0x104, virtual false, abstract: false, final false
...
static_assert(sizeof(::OculusStudios::GraphQL::ClientInterface::RequestStateExtensions) == 0x10, "Size mismatch!");
