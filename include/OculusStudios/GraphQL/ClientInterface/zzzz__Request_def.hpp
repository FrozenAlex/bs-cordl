...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::ClientInterface::Request*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::ClientInterface::Request*, "OculusStudios.GraphQL.ClientInterface", "Request");
...
public:
  ...
  /// @brief Method Cancel, addr 0x5f292ac, size 0x28, virtual false, abstract: false, final false
  inline void Cancel();
  ...
  /// @brief Method GetFailureHandlingMethod, addr 0x5f289a4, size 0x8, virtual true, abstract: false, final false
  inline ::OculusStudios::GraphQL::ClientInterface::FailureHandlingMethod GetFailureHandlingMethod();

  /// @brief Method GetLastException, addr 0x5f289ac, size 0x90, virtual true, abstract: false, final false
  inline ::System::Exception* GetLastException();

  /// @brief Method GetTimeoutMs, addr 0x5f2899c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method OnRequestStateChanged, addr 0x5f28f88, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterException, addr 0x5f29188, size 0xd4, virtual false, abstract: false, final false
  inline void RegisterException(::System::Exception* e);

  /// @brief Method RegisterRawResponseData, addr 0x5f290b4, size 0xd4, virtual false, abstract: false, final false
  inline void RegisterRawResponseData(::StringW json);

  /// @brief Method ResetStateForUserInitiatedRetry, addr 0x5f28a3c, size 0x3dc, virtual false, abstract: false, final false
  inline void ResetStateForUserInitiatedRetry();

  /// @brief Method SetRequestId, addr 0x5f28e18, size 0x64, virtual false, abstract: false, final false
  inline void SetRequestId(int64_t newRequestId);

  /// @brief Method SetRequestState, addr 0x5f28e7c, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method System.IDisposable.Dispose, addr 0x5f2925c, size 0x50, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5f28858, size 0x144, virtual false, abstract: false, final false
  inline void _ctor(bool forceRequestWhenOffline, ::OculusStudios::GraphQL::ClientInterface::RequestType requestType);

  /// @brief Method add_onRequestStateUpdated, addr 0x5f28650, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_attempts, addr 0x5f28850, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::OculusStudios::GraphQL::ClientInterface::AttemptData*>* get_attempts();

  /// @brief Method get_attemptsPerformed, addr 0x5f28804, size 0x4c, virtual false, abstract: false, final false
  inline int32_t get_attemptsPerformed();

  /// @brief Method get_cancellationToken, addr 0x5f287d0, size 0x24, virtual false, abstract: false, final false
  inline ::System::Threading::CancellationToken get_cancellationToken();

  /// @brief Method get_requestId, addr 0x5f287f4, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_requestId();

  /// @brief Method get_requestState, addr 0x5f287fc, size 0x8, virtual false, abstract: false, final false
  inline ::OculusStudios::GraphQL::ClientInterface::RequestState get_requestState();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method remove_onRequestStateUpdated, addr 0x5f28710, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::OculusStudios::GraphQL::ClientInterface::Request) == 0x58, "Size mismatch!");
