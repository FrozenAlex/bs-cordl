...
// Write type traits
MARK_REF_T(::OculusStudios::HierarchyIcons::Defines*);
DEFINE_IL2CPP_CLASS(::OculusStudios::HierarchyIcons::Defines*, "OculusStudios.HierarchyIcons", "Defines");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5f29524, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::OculusStudios::HierarchyIcons::Defines) == 0x10, "Size mismatch!");
