...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::OculusStudios::Platform::Core::MockedEntitlements___c__DisplayClass5_0::*)()>(
  ...
  constexpr static std::size_t addrs = 0x5df4b10;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::OculusStudios::Platform::Core::MockedEntitlements___c__DisplayClass5_0*>(), { ".ctor", {}, {} })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::OculusStudios::Platform::Core::MockedEntitlements___c__DisplayClass5_0::*)(::OculusStudios::Platform::Core::Product*)>(
  ...
  constexpr static std::size_t addrs = 0x5df4b14;
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::OculusStudios::Platform::Core::MockedEntitlements___c__DisplayClass5_0*>(),
                                                                                           { "<GetAllProductsAsync>b__0", {}, { ::i2c::type_of<::OculusStudios::Platform::Core::Product*>() } })));
    return ___internal_method;
  }
};
...
inline ::OculusStudios::Platform::Core::MockedEntitlements___c__DisplayClass5_0* OculusStudios::Platform::Core::MockedEntitlements___c__DisplayClass5_0::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::OculusStudios::Platform::Core::MockedEntitlements___c__DisplayClass5_0*>());
}
// Ctor Parameters []
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::OculusStudios::Platform::Core::MockedEntitlements__GetAllProductsAsync_d__5::*)()>(
  ...
  constexpr static std::size_t addrs = 0x5df4be0;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::OculusStudios::Platform::Core::MockedEntitlements__GetAllProductsAsync_d__5>(), { "MoveNext", {}, {} })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::OculusStudios::Platform::Core::MockedEntitlements__GetAllProductsAsync_d__5::*)(
  ...
  constexpr static std::size_t addrs = 0x5df5c24;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::OculusStudios::Platform::Core::MockedEntitlements::*)(::OculusStudios::Platform::Core::PlatformInitParams*)>(
  ...
  constexpr static std::size_t addrs = 0x5df4904;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Threading::Tasks::Task_1<::System::Collections::Generic::IReadOnlyList_1<::OculusStudios::Platform::Core::Product*>*>* (
  ...
  constexpr static std::size_t addrs = 0x5df49c4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::OculusStudios::Platform::Core::MockedEntitlements*>(), { "GetAllProductsAsync", {}, {} })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::OculusStudios::Platform::Core::MockedEntitlements::*)(
  ...
  constexpr static std::size_t addrs = 0x5df4a98;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{},
                     (::i2c::find_method(::i2c::class_of<::OculusStudios::Platform::Core::MockedEntitlements*>(),
...
OculusStudios::Platform::Core::MockedEntitlements::GetAllProductsAsync() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::OculusStudios::Platform::Core::MockedEntitlements*>(), { "GetAllProductsAsync", {}, {} })));
...
inline ::OculusStudios::Platform::Core::MockedEntitlements* OculusStudios::Platform::Core::MockedEntitlements::New_ctor(::OculusStudios::Platform::Core::PlatformInitParams* initParams) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::OculusStudios::Platform::Core::MockedEntitlements*>(initParams));
}
