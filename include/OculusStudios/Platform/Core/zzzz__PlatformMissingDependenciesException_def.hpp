...
// Write type traits
MARK_REF_T(::OculusStudios::Platform::Core::PlatformMissingDependenciesException*);
DEFINE_IL2CPP_CLASS(::OculusStudios::Platform::Core::PlatformMissingDependenciesException*, "OculusStudios.Platform.Core", "PlatformMissingDependenciesException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5df4150, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5df41a8, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x5df4214, size 0x74, virtual false, abstract: false, final false
...
static_assert(sizeof(::OculusStudios::Platform::Core::PlatformMissingDependenciesException) == 0x90, "Size mismatch!");
