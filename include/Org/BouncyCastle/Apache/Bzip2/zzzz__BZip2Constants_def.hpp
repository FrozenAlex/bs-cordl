...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Apache::Bzip2::BZip2Constants*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Apache::Bzip2::BZip2Constants*, "Org.BouncyCastle.Apache.Bzip2", "BZip2Constants");
...
public:
  ...
  __declspec(property(get = getStaticF_rNums, put = setStaticF_rNums)) ::ArrayW<int32_t> rNums;

  static inline ::Org::BouncyCastle::Apache::Bzip2::BZip2Constants* New_ctor();

  /// @brief Method .ctor, addr 0x3599104, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<int32_t> getStaticF_rNums();

  static inline void setStaticF_rNums(::ArrayW<int32_t> value);
...
static_assert(sizeof(::Org::BouncyCastle::Apache::Bzip2::BZip2Constants) == 0x10, "Size mismatch!");
