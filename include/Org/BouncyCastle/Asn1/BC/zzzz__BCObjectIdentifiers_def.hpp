...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::BC::BCObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::BC::BCObjectIdentifiers*, "Org.BouncyCastle.Asn1.BC", "BCObjectIdentifiers");
...
public:
  ...
  __declspec(property(get = getStaticF_bc, put = setStaticF_bc)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* bc;

  /// @brief Field bc_exch, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_bc_exch, put = setStaticF_bc_exch)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* bc_exch;

  /// @brief Field bc_ext, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_bc_ext, put = setStaticF_bc_ext)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* bc_ext;

  /// @brief Field bc_pbe, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_bc_pbe, put = setStaticF_bc_pbe)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* bc_pbe;

  /// @brief Field bc_pbe_sha1, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_bc_pbe_sha1, put = setStaticF_bc_pbe_sha1)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* bc_pbe_sha1;

  /// @brief Field bc_pbe_sha1_pkcs12, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_bc_pbe_sha1_pkcs12, put = setStaticF_bc_pbe_sha1_pkcs12)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* bc_pbe_sha1_pkcs12;

  /// @brief Field bc_pbe_sha1_pkcs12_aes128_cbc, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_bc_pbe_sha1_pkcs12_aes128_cbc, put = setStaticF_bc_pbe_sha1_pkcs12_aes128_cbc)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* bc_pbe_sha1_pkcs12_aes128_cbc;

  /// @brief Field bc_pbe_sha1_pkcs12_aes192_cbc, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_bc_pbe_sha1_pkcs12_aes192_cbc, put = setStaticF_bc_pbe_sha1_pkcs12_aes192_cbc)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* bc_pbe_sha1_pkcs12_aes192_cbc;

  /// @brief Field bc_pbe_sha1_pkcs12_aes256_cbc, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_bc_pbe_sha1_pkcs12_aes256_cbc, put = setStaticF_bc_pbe_sha1_pkcs12_aes256_cbc)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* bc_pbe_sha1_pkcs12_aes256_cbc;

  /// @brief Field bc_pbe_sha1_pkcs5, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_bc_pbe_sha1_pkcs5, put = setStaticF_bc_pbe_sha1_pkcs5)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* bc_pbe_sha1_pkcs5;

  /// @brief Field bc_pbe_sha224, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_bc_pbe_sha224, put = setStaticF_bc_pbe_sha224)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* bc_pbe_sha224;

  /// @brief Field bc_pbe_sha256, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_bc_pbe_sha256, put = setStaticF_bc_pbe_sha256)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* bc_pbe_sha256;

  /// @brief Field bc_pbe_sha256_pkcs12, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_bc_pbe_sha256_pkcs12, put = setStaticF_bc_pbe_sha256_pkcs12)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* bc_pbe_sha256_pkcs12;

  /// @brief Field bc_pbe_sha256_pkcs12_aes128_cbc, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_bc_pbe_sha256_pkcs12_aes128_cbc,
  ...
  __declspec(property(get = getStaticF_bc_pbe_sha256_pkcs12_aes192_cbc,
  ...
  __declspec(property(get = getStaticF_bc_pbe_sha256_pkcs12_aes256_cbc,
  ...
  __declspec(property(get = getStaticF_bc_pbe_sha256_pkcs5, put = setStaticF_bc_pbe_sha256_pkcs5)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* bc_pbe_sha256_pkcs5;

  /// @brief Field bc_pbe_sha384, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_bc_pbe_sha384, put = setStaticF_bc_pbe_sha384)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* bc_pbe_sha384;

  /// @brief Field bc_pbe_sha512, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_bc_pbe_sha512, put = setStaticF_bc_pbe_sha512)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* bc_pbe_sha512;

  /// @brief Field bc_sig, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_bc_sig, put = setStaticF_bc_sig)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* bc_sig;

  /// @brief Field linkedCertificate, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_linkedCertificate, put = setStaticF_linkedCertificate)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* linkedCertificate;

  /// @brief Field newHope, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_newHope, put = setStaticF_newHope)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* newHope;

  /// @brief Field sphincs256, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sphincs256, put = setStaticF_sphincs256)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sphincs256;

  /// @brief Field sphincs256_with_BLAKE512, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sphincs256_with_BLAKE512, put = setStaticF_sphincs256_with_BLAKE512)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sphincs256_with_BLAKE512;

  /// @brief Field sphincs256_with_SHA3_512, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sphincs256_with_SHA3_512, put = setStaticF_sphincs256_with_SHA3_512)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sphincs256_with_SHA3_512;

  /// @brief Field sphincs256_with_SHA512, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sphincs256_with_SHA512, put = setStaticF_sphincs256_with_SHA512)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sphincs256_with_SHA512;

  /// @brief Field xmss, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_xmss, put = setStaticF_xmss)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* xmss;

  /// @brief Field xmss_mt, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_xmss_mt, put = setStaticF_xmss_mt)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* xmss_mt;

  /// @brief Field xmss_mt_with_SHA256, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_xmss_mt_with_SHA256, put = setStaticF_xmss_mt_with_SHA256)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* xmss_mt_with_SHA256;

  /// @brief Field xmss_mt_with_SHA512, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_xmss_mt_with_SHA512, put = setStaticF_xmss_mt_with_SHA512)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* xmss_mt_with_SHA512;

  /// @brief Field xmss_mt_with_SHAKE128, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_xmss_mt_with_SHAKE128, put = setStaticF_xmss_mt_with_SHAKE128)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* xmss_mt_with_SHAKE128;

  /// @brief Field xmss_mt_with_SHAKE256, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_xmss_mt_with_SHAKE256, put = setStaticF_xmss_mt_with_SHAKE256)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* xmss_mt_with_SHAKE256;

  /// @brief Field xmss_with_SHA256, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_xmss_with_SHA256, put = setStaticF_xmss_with_SHA256)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* xmss_with_SHA256;

  /// @brief Field xmss_with_SHA512, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_xmss_with_SHA512, put = setStaticF_xmss_with_SHA512)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* xmss_with_SHA512;

  /// @brief Field xmss_with_SHAKE128, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_xmss_with_SHAKE128, put = setStaticF_xmss_with_SHAKE128)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* xmss_with_SHAKE128;

  /// @brief Field xmss_with_SHAKE256, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_xmss_with_SHAKE256, put = setStaticF_xmss_with_SHAKE256)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* xmss_with_SHAKE256;

  static inline ::Org::BouncyCastle::Asn1::BC::BCObjectIdentifiers* New_ctor();

  /// @brief Method .ctor, addr 0x33421e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::BC::BCObjectIdentifiers) == 0x10, "Size mismatch!");
