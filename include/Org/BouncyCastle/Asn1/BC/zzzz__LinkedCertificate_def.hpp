...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::BC::LinkedCertificate*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::BC::LinkedCertificate*, "Org.BouncyCastle.Asn1.BC", "LinkedCertificate");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x33427a4, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3342864, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33425cc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::DigestInfo* digest, ::Org::BouncyCastle::Asn1::X509::GeneralName* certLocation);

  /// @brief Method .ctor, addr 0x33425d8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33425e4, size 0x1c0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CACerts, addr 0x334285c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralNames* get_CACerts();

  /// @brief Method get_CertIssuer, addr 0x3342854, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_CertIssuer();

  /// @brief Method get_CertLocation, addr 0x334284c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_CertLocation();

  /// @brief Method get_Digest, addr 0x3342844, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::BC::LinkedCertificate) == 0x30, "Size mismatch!");
