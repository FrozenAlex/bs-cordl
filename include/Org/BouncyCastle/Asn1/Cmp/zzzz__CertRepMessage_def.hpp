...
public:
  ...
  /// @brief Method GetCAPubs, addr 0x3344330, size 0x100, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Cmp::CmpCertificate*> GetCAPubs();

  /// @brief Method GetInstance, addr 0x33440d8, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cmp::CertRepMessage* GetInstance(::System::Object* obj);

  /// @brief Method GetResponse, addr 0x3344430, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x33446ac, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x334425c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3343fe0, size 0xf8, virtual false, abstract: false, final false
