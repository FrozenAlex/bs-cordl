...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cmp::CertResponse*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cmp::CertResponse*, "Org.BouncyCastle.Asn1.Cmp", "CertResponse");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3289aa8, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x328a058, size 0x1ac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3289fb0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerInteger* certReqId, ::Org::BouncyCastle::Asn1::Cmp::PkiStatusInfo* status);

  /// @brief Method .ctor, addr 0x3289fbc, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3289ce4, size 0x148, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CertReqID, addr 0x328a040, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_CertReqID();

  /// @brief Method get_CertifiedKeyPair, addr 0x328a050, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::CertifiedKeyPair* get_CertifiedKeyPair();

  /// @brief Method get_Status, addr 0x328a048, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cmp::CertResponse) == 0x30, "Size mismatch!");
