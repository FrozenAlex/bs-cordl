...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cmp::CertStatus*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cmp::CertStatus*, "Org.BouncyCastle.Asn1.Cmp", "CertStatus");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3288b94, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cmp::CertStatus* GetInstance(::System::Object* obj);

  static inline ::Org::BouncyCastle::Asn1::Cmp::CertStatus* New_ctor(::ArrayW<uint8_t> certHash, ::Org::BouncyCastle::Math::BigInteger* certReqId);
  ...
  /// @brief Method ToAsn1Object, addr 0x328a404, size 0x180, virtual true, abstract: false, final false
  ...
  constexpr ::Org::BouncyCastle::Asn1::Cmp::PkiStatusInfo* const& __cordl_internal_get_statusInfo() const;
  ...
  /// @brief Method .ctor, addr 0x328a2a0, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> certHash, ::Org::BouncyCastle::Math::BigInteger* certReqId);

  /// @brief Method .ctor, addr 0x328a340, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> certHash, ::Org::BouncyCastle::Math::BigInteger* certReqId, ::Org::BouncyCastle::Asn1::Cmp::PkiStatusInfo* statusInfo);

  /// @brief Method .ctor, addr 0x328a204, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CertHash, addr 0x328a3ec, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_CertHash();

  /// @brief Method get_CertReqID, addr 0x328a3f4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_CertReqID();

  /// @brief Method get_StatusInfo, addr 0x328a3fc, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cmp::CertStatus) == 0x28, "Size mismatch!");
