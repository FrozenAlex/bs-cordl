...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cmp::InfoTypeAndValue*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cmp::InfoTypeAndValue*, "Org.BouncyCastle.Asn1.Cmp", "InfoTypeAndValue");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x334673c, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3346c9c, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3346c7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* infoType);

  /// @brief Method .ctor, addr 0x3346c84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* infoType, ::Org::BouncyCastle::Asn1::Asn1Encodable* optionalValue);

  /// @brief Method .ctor, addr 0x3346bb4, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_InfoType, addr 0x3346c8c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_InfoType();

  /// @brief Method get_InfoValue, addr 0x3346c94, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cmp::InfoTypeAndValue) == 0x20, "Size mismatch!");
