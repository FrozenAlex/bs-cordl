...
public:
  ...
  /// @brief Method GetBodyForType, addr 0x328d5cc, size 0x158, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Encodable* GetBodyForType(int32_t type, ::Org::BouncyCastle::Asn1::Asn1Encodable* o);

  /// @brief Method GetInstance, addr 0x328d3f4, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x328e498, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x328d578, size 0x54, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* tagged);

  /// @brief Method .ctor, addr 0x328d724, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(int32_t type, ::Org::BouncyCastle::Asn1::Asn1Encodable* content);

  /// @brief Method get_Content, addr 0x328e490, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Content();

  /// @brief Method get_Type, addr 0x328e488, size 0x8, virtual true, abstract: false, final false
