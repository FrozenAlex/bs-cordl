...
public:
  ...
  /// @brief Method GetInstance, addr 0x334a1c0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x3345f50, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cmp::PkiFreeText* GetInstance(::System::Object* obj);

  /// @brief Method GetStringAt, addr 0x334a62c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x334a630, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x334a4e4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerUtf8String* p);

  /// @brief Method .ctor, addr 0x334a1d4, size 0x310, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Count, addr 0x334a56c, size 0x20, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x334a58c, size 0xa0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerUtf8String* get_Item(int32_t index);

  /// @brief Method get_Size, addr 0x334a54c, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cmp::PkiFreeText) == 0x18, "Size mismatch!");
