...
public:
  ...
  /// @brief Method GetGeneralInfo, addr 0x334ab78, size 0x104, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Cmp::InfoTypeAndValue*> GetGeneralInfo();

  /// @brief Method GetInstance, addr 0x334a910, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x334ac7c, size 0x230, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x334ab14, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x334aa94, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x334a638, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FreeText, addr 0x334ab70, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::PkiFreeText* get_FreeText();

  /// @brief Method get_MessageTime, addr 0x334ab38, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_MessageTime();

  /// @brief Method get_ProtectionAlg, addr 0x334ab40, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_ProtectionAlg();

  /// @brief Method get_Pvno, addr 0x334ab20, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Pvno();

  /// @brief Method get_RecipKID, addr 0x334ab50, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_RecipKID();

  /// @brief Method get_RecipNonce, addr 0x334ab68, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_RecipNonce();

  /// @brief Method get_Recipient, addr 0x334ab30, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_Recipient();

  /// @brief Method get_Sender, addr 0x334ab28, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_Sender();

  /// @brief Method get_SenderKID, addr 0x334ab48, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_SenderKID();

  /// @brief Method get_SenderNonce, addr 0x334ab60, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_SenderNonce();

  /// @brief Method get_TransactionID, addr 0x334ab58, size 0x8, virtual true, abstract: false, final false
