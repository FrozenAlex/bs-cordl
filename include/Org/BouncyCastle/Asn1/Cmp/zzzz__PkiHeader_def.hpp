...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cmp::PkiHeader*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cmp::PkiHeader*, "Org.BouncyCastle.Asn1.Cmp", "PkiHeader");
...
public:
  ...
  /// @brief Method GetGeneralInfo, addr 0x32900f8, size 0x104, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Cmp::InfoTypeAndValue*> GetGeneralInfo();

  /// @brief Method GetInstance, addr 0x328fe90, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32901fc, size 0x230, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3290094, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3290014, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x328fbb8, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FreeText, addr 0x32900f0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::PkiFreeText* get_FreeText();

  /// @brief Method get_MessageTime, addr 0x32900b8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_MessageTime();

  /// @brief Method get_ProtectionAlg, addr 0x32900c0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_ProtectionAlg();

  /// @brief Method get_Pvno, addr 0x32900a0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Pvno();

  /// @brief Method get_RecipKID, addr 0x32900d0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_RecipKID();

  /// @brief Method get_RecipNonce, addr 0x32900e8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_RecipNonce();

  /// @brief Method get_Recipient, addr 0x32900b0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_Recipient();

  /// @brief Method get_Sender, addr 0x32900a8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_Sender();

  /// @brief Method get_SenderKID, addr 0x32900c8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_SenderKID();

  /// @brief Method get_SenderNonce, addr 0x32900e0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_SenderNonce();

  /// @brief Method get_TransactionID, addr 0x32900d8, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cmp::PkiHeader) == 0x70, "Size mismatch!");
