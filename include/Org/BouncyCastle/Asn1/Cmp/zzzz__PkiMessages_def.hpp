...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cmp::PkiMessages*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cmp::PkiMessages*, "Org.BouncyCastle.Asn1.Cmp", "PkiMessages");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3348a8c, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x334bf2c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToPkiMessageArray, addr 0x334be34, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x334bdcc, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Cmp::PkiMessage*> msgs);

  /// @brief Method .ctor, addr 0x334bdc4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cmp::PkiMessages) == 0x18, "Size mismatch!");
