...
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cmp::PkiStatus, "Org.BouncyCastle.Asn1.Cmp", "PkiStatus");
// Dependencies
namespace Org::BouncyCastle::Asn1::Cmp {
// Is value type: true
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cmp::PkiStatus) == 0x4, "Size mismatch!");
