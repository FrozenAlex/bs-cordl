...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cmp::PollReqContent*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cmp::PollReqContent*, "Org.BouncyCastle.Asn1.Cmp", "PollReqContent");
...
public:
  ...
  /// @brief Method GetCertReqIDs, addr 0x3291eb0, size 0x13c, virtual true, abstract: false, final false
  inline ::ArrayW<::ArrayW<::Org::BouncyCastle::Asn1::DerInteger*>> GetCertReqIDs();

  /// @brief Method GetInstance, addr 0x328e188, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method SequenceToDerIntegerArray, addr 0x3291fec, size 0xf8, virtual false, abstract: false, final false
  static inline ::ArrayW<::Org::BouncyCastle::Asn1::DerInteger*> SequenceToDerIntegerArray(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method ToAsn1Object, addr 0x32920e4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3291ea8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cmp::PollReqContent) == 0x18, "Size mismatch!");
