...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cmp::PopoDecKeyChallContent*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cmp::PopoDecKeyChallContent*, "Org.BouncyCastle.Asn1.Cmp", "PopoDecKeyChallContent");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x328d748, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32921ec, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToChallengeArray, addr 0x32920f4, size 0xf8, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Cmp::Challenge*> ToChallengeArray();
  ...
  /// @brief Method .ctor, addr 0x32920ec, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cmp::PopoDecKeyChallContent) == 0x18, "Size mismatch!");
