...
public:
  ...
  /// @brief Method GetInstance, addr 0x33487c0, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x334d240, size 0x1d8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x334d0b8, size 0x160, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_BadSinceDate, addr 0x334d230, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_BadSinceDate();

  /// @brief Method get_CertID, addr 0x334d220, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Crmf::CertId* get_CertID();

  /// @brief Method get_CrlDetails, addr 0x334d238, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_CrlDetails();

  /// @brief Method get_Status, addr 0x334d218, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::PkiStatusEncodable* get_Status();

  /// @brief Method get_WillBeRevokedAt, addr 0x334d228, size 0x8, virtual true, abstract: false, final false
