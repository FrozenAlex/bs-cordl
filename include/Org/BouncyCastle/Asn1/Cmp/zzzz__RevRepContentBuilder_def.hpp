...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cmp::RevRepContentBuilder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cmp::RevRepContentBuilder*, "Org.BouncyCastle.Asn1.Cmp", "RevRepContentBuilder");
...
public:
  ...
  /// @brief Method Add, addr 0x329326c, size 0x28, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::RevRepContentBuilder* Add(::Org::BouncyCastle::Asn1::Cmp::PkiStatusInfo* status);

  /// @brief Method Add, addr 0x3293294, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method AddCrl, addr 0x329333c, size 0x28, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::RevRepContentBuilder* AddCrl(::Org::BouncyCastle::Asn1::X509::CertificateList* crl);

  /// @brief Method Build, addr 0x3293364, size 0x1d4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3293538, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cmp::RevRepContentBuilder) == 0x28, "Size mismatch!");
