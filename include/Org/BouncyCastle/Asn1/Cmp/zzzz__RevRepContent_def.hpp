...
public:
  ...
  /// @brief Method GetCrls, addr 0x334dab8, size 0x104, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::X509::CertificateList*> GetCrls();

  /// @brief Method GetInstance, addr 0x334863c, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cmp::RevRepContent* GetInstance(::System::Object* obj);

  /// @brief Method GetRevCerts, addr 0x334d9b4, size 0x104, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Crmf::CertId*> GetRevCerts();

  /// @brief Method GetStatus, addr 0x334d8bc, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x334dbbc, size 0x130, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x334d7e4, size 0xd8, virtual false, abstract: false, final false
