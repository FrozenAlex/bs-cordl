...
public:
  ...
  /// @brief Method GetInstance, addr 0x328da40, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x329372c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToRevDetailsArray, addr 0x3293634, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32935cc, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Cmp::RevDetails*> revDetails);

  /// @brief Method .ctor, addr 0x32935c4, size 0x8, virtual false, abstract: false, final false
