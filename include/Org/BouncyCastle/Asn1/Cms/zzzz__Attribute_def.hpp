...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cms::Attribute*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cms::Attribute*, "Org.BouncyCastle.Asn1.Cms", "Attribute");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3293c20, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3293f14, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3293efc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* attrType, ::Org::BouncyCastle::Asn1::Asn1Set* attrValues);

  /// @brief Method .ctor, addr 0x3293da4, size 0x158, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_AttrType, addr 0x3293f04, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_AttrType();

  /// @brief Method get_AttrValues, addr 0x3293f0c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cms::Attribute) == 0x20, "Size mismatch!");
