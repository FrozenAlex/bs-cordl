...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cms::Attributes*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cms::Attributes*, "Org.BouncyCastle.Asn1.Cms", "Attributes");
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cms::Attributes) == 0x18, "Size mismatch!");
