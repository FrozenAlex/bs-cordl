...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cms::CmsAttributes*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cms::CmsAttributes*, "Org.BouncyCastle.Asn1.Cms", "CmsAttributes");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3353fe4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cms::CmsAttributes) == 0x10, "Size mismatch!");
