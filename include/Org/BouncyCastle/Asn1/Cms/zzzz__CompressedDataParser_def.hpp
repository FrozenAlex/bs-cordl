...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cms::CompressedDataParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cms::CompressedDataParser*, "Org.BouncyCastle.Asn1.Cms", "CompressedDataParser");
...
public:
  ...
  /// @brief Method GetEncapContentInfo, addr 0x3299e04, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3299b34, size 0x2c0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1SequenceParser* seq);

  /// @brief Method get_CompressionAlgorithmIdentifier, addr 0x3299dfc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_CompressionAlgorithmIdentifier();

  /// @brief Method get_Version, addr 0x3299df4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cms::CompressedDataParser) == 0x28, "Size mismatch!");
