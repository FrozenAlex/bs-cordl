...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cms::ContentInfoParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cms::ContentInfoParser*, "Org.BouncyCastle.Asn1.Cms", "ContentInfoParser");
...
public:
  ...
  /// @brief Method GetContent, addr 0x3354ca8, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3352288, size 0x1d8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1SequenceParser* seq);

  /// @brief Method get_ContentType, addr 0x3354ca0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cms::ContentInfoParser) == 0x20, "Size mismatch!");
