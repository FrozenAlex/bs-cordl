...
public:
  ...
  /// @brief Method GetInstance, addr 0x329d074, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x329d088, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x329d218, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x329ce60, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x329cee0, size 0x194, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_EncryptedKey, addr 0x329d210, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_EncryptedKey();

  /// @brief Method get_KekID, addr 0x329d200, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::KekIdentifier* get_KekID();

  /// @brief Method get_KeyEncryptionAlgorithm, addr 0x329d208, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_KeyEncryptionAlgorithm();

  /// @brief Method get_Version, addr 0x329d1f8, size 0x8, virtual false, abstract: false, final false
