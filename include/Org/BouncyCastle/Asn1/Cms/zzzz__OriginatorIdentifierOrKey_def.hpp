...
public:
  ...
  /// @brief Method GetInstance, addr 0x335838c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x3359570, size 0x2ac, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x33599f8, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3359560, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Object* id);

  /// @brief Method .ctor, addr 0x3359410, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* id);

  /// @brief Method .ctor, addr 0x3359568, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* id);

  /// @brief Method .ctor, addr 0x3359408, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber* id);

  /// @brief Method .ctor, addr 0x33594f0, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::OriginatorPublicKey* id);

  /// @brief Method .ctor, addr 0x3359480, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::SubjectKeyIdentifier* id);

  /// @brief Method get_ID, addr 0x335981c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_ID();

  /// @brief Method get_IssuerAndSerialNumber, addr 0x3359824, size 0x80, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber* get_IssuerAndSerialNumber();

  /// @brief Method get_OriginatorKey, addr 0x3359940, size 0x4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::OriginatorPublicKey* get_OriginatorKey();

  /// @brief Method get_OriginatorPublicKey, addr 0x3359944, size 0xa0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::OriginatorPublicKey* get_OriginatorPublicKey();

  /// @brief Method get_SubjectKeyIdentifier, addr 0x33598a4, size 0x9c, virtual false, abstract: false, final false
