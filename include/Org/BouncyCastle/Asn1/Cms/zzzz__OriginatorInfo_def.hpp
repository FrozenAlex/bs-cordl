...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cms::OriginatorInfo*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cms::OriginatorInfo*, "Org.BouncyCastle.Asn1.Cms", "OriginatorInfo");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3351260, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x3351bcc, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3359c98, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3359a14, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Set* certs, ::Org::BouncyCastle::Asn1::Asn1Set* crls);

  /// @brief Method .ctor, addr 0x3359a1c, size 0x26c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Certificates, addr 0x3359c88, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_Certificates();

  /// @brief Method get_Crls, addr 0x3359c90, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cms::OriginatorInfo) == 0x20, "Size mismatch!");
