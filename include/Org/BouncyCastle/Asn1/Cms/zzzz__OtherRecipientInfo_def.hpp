...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cms::OtherRecipientInfo*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cms::OtherRecipientInfo*, "Org.BouncyCastle.Asn1.Cms", "OtherRecipientInfo");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x335a21c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x335a230, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x335a2e0, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x335a168, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oriType, ::Org::BouncyCastle::Asn1::Asn1Encodable* oriValue);

  /// @brief Method .ctor, addr 0x335a170, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_OriType, addr 0x335a2d0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_OriType();

  /// @brief Method get_OriValue, addr 0x335a2d8, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cms::OtherRecipientInfo) == 0x20, "Size mismatch!");
