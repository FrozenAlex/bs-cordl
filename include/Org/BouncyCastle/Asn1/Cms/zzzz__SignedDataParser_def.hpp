...
public:
  ...
  /// @brief Method GetCertificates, addr 0x335d704, size 0x264, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1SetParser* GetCertificates();

  /// @brief Method GetCrls, addr 0x335d968, size 0x2c0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1SetParser* GetCrls();

  /// @brief Method GetDigestAlgorithms, addr 0x335d514, size 0xe4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1SetParser* GetDigestAlgorithms();

  /// @brief Method GetEncapContentInfo, addr 0x335d5f8, size 0x10c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::ContentInfoParser* GetEncapContentInfo();

  /// @brief Method GetInstance, addr 0x335d248, size 0x198, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cms::SignedDataParser* GetInstance(::System::Object* o);

  /// @brief Method GetSignerInfos, addr 0x335dc28, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x335d3e0, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1SequenceParser* seq);

  /// @brief Method get_Version, addr 0x335d50c, size 0x8, virtual false, abstract: false, final false
