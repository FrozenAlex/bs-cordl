...
public:
  ...
  /// @brief Method GetInstance, addr 0x32a36cc, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32a4148, size 0x208, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32a3850, size 0x6b0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x32a3f00, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32a403c, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::SignerIdentifier* sid, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* digAlgorithm,
  ...
  /// @brief Method get_AuthenticatedAttributes, addr 0x32a4120, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_AuthenticatedAttributes();

  /// @brief Method get_DigestAlgorithm, addr 0x32a4128, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestAlgorithm();

  /// @brief Method get_DigestEncryptionAlgorithm, addr 0x32a4138, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestEncryptionAlgorithm();

  /// @brief Method get_EncryptedDigest, addr 0x32a4130, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_EncryptedDigest();

  /// @brief Method get_SignerID, addr 0x32a4118, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::SignerIdentifier* get_SignerID();

  /// @brief Method get_UnauthenticatedAttributes, addr 0x32a4140, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_UnauthenticatedAttributes();

  /// @brief Method get_Version, addr 0x32a4110, size 0x8, virtual false, abstract: false, final false
