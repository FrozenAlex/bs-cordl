...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cms::SignerInfo*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cms::SignerInfo*, "Org.BouncyCastle.Asn1.Cms", "SignerInfo");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x335e14c, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x335ebc8, size 0x208, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x335e2d0, size 0x6b0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x335e980, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x335eabc, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::SignerIdentifier* sid, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* digAlgorithm,
  ...
  /// @brief Method get_AuthenticatedAttributes, addr 0x335eba0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_AuthenticatedAttributes();

  /// @brief Method get_DigestAlgorithm, addr 0x335eba8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestAlgorithm();

  /// @brief Method get_DigestEncryptionAlgorithm, addr 0x335ebb8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestEncryptionAlgorithm();

  /// @brief Method get_EncryptedDigest, addr 0x335ebb0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_EncryptedDigest();

  /// @brief Method get_SignerID, addr 0x335eb98, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::SignerIdentifier* get_SignerID();

  /// @brief Method get_UnauthenticatedAttributes, addr 0x335ebc0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_UnauthenticatedAttributes();

  /// @brief Method get_Version, addr 0x335eb90, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cms::SignerInfo) == 0x48, "Size mismatch!");
