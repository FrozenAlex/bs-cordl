...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cms::Time*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cms::Time*, "Org.BouncyCastle.Asn1.Cms", "Time");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x32a4350, size 0x28, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cms::Time* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool explicitly);

  /// @brief Method GetInstance, addr 0x32a4378, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32a4aac, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32a4684, size 0x19c, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTime date);

  /// @brief Method .ctor, addr 0x32a4548, size 0x13c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Object* time);

  /// @brief Method get_Date, addr 0x32a48f0, size 0x1bc, virtual false, abstract: false, final false
  inline ::System::DateTime get_Date();

  /// @brief Method get_TimeString, addr 0x32a4820, size 0xd0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cms::Time) == 0x18, "Size mismatch!");
