...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Crmf::CertReqMsg*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Crmf::CertReqMsg*, "Org.BouncyCastle.Asn1.Crmf", "CertReqMsg");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x32a6d8c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x32a6974, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Crmf::CertReqMsg* GetInstance(::System::Object* obj);

  /// @brief Method GetRegInfo, addr 0x32a6e7c, size 0x100, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Crmf::AttributeTypeAndValue*> GetRegInfo();

  static inline ::Org::BouncyCastle::Asn1::Crmf::CertReqMsg* New_ctor(::Org::BouncyCastle::Asn1::Crmf::CertRequest* certReq, ::Org::BouncyCastle::Asn1::Crmf::ProofOfPossession* popo,
  ...
  /// @brief Method ToAsn1Object, addr 0x32a6f7c, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32a6da0, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::CertRequest* certReq, ::Org::BouncyCastle::Asn1::Crmf::ProofOfPossession* popo,
                    ::ArrayW<::Org::BouncyCastle::Asn1::Crmf::AttributeTypeAndValue*> regInfo);

  /// @brief Method .ctor, addr 0x32a6a1c, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CertReq, addr 0x32a6e6c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Crmf::CertRequest* get_CertReq();

  /// @brief Method get_Popo, addr 0x32a6e74, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Crmf::CertReqMsg) == 0x28, "Size mismatch!");
