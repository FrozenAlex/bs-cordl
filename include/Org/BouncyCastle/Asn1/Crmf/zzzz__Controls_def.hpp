...
public:
  ...
  /// @brief Method GetInstance, addr 0x3361cb0, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3362cbc, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToAttributeTypeAndValueArray, addr 0x3362bc4, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3362b5c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Crmf::AttributeTypeAndValue*> atvs);

  /// @brief Method .ctor, addr 0x3362b54, size 0x8, virtual false, abstract: false, final false
