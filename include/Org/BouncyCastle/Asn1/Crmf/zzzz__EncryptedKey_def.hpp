...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Crmf::EncryptedKey*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Crmf::EncryptedKey*, "Org.BouncyCastle.Asn1.Crmf", "EncryptedKey");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x33632bc, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x336351c, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3363448, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::EncryptedValue* encryptedValue);

  /// @brief Method .ctor, addr 0x3363440, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::EnvelopedData* envelopedData);

  /// @brief Method get_IsEncryptedValue, addr 0x33634f0, size 0x10, virtual true, abstract: false, final false
  inline bool get_IsEncryptedValue();

  /// @brief Method get_Value, addr 0x3363500, size 0x1c, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Crmf::EncryptedKey) == 0x20, "Size mismatch!");
