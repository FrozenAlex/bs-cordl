...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Crmf::EncryptedValue*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Crmf::EncryptedValue*, "Org.BouncyCastle.Asn1.Crmf", "EncryptedValue");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3363450, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3363858, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33637c8, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33635a0, size 0x228, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_EncSymmKey, addr 0x3363838, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_EncSymmKey();

  /// @brief Method get_EncValue, addr 0x3363850, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_EncValue();

  /// @brief Method get_IntendedAlg, addr 0x3363828, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_IntendedAlg();

  /// @brief Method get_KeyAlg, addr 0x3363840, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_KeyAlg();

  /// @brief Method get_SymmAlg, addr 0x3363830, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_SymmAlg();

  /// @brief Method get_ValueHint, addr 0x3363848, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Crmf::EncryptedValue) == 0x40, "Size mismatch!");
