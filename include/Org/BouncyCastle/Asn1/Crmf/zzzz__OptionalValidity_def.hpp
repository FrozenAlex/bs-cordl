...
public:
  ...
  /// @brief Method GetInstance, addr 0x32a7ca4, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32a91f8, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32a91e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::Time* notBefore, ::Org::BouncyCastle::Asn1::X509::Time* notAfter);

  /// @brief Method .ctor, addr 0x32a8ef0, size 0x2f0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_NotAfter, addr 0x32a91f0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::Time* get_NotAfter();

  /// @brief Method get_NotBefore, addr 0x32a91e8, size 0x8, virtual true, abstract: false, final false
