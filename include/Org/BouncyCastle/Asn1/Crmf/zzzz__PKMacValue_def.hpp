...
public:
  ...
  /// @brief Method GetInstance, addr 0x3364a44, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x33648c0, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3364b08, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3364af0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algID, ::Org::BouncyCastle::Asn1::DerBitString* macValue);

  /// @brief Method .ctor, addr 0x3364a58, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::PbmParameter* pbmParams, ::Org::BouncyCastle::Asn1::DerBitString* macValue);

  /// @brief Method .ctor, addr 0x336480c, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_AlgID, addr 0x3364af8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_AlgID();

  /// @brief Method get_MacValue, addr 0x3364b00, size 0x8, virtual true, abstract: false, final false
