...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Crmf::PkiArchiveOptions*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Crmf::PkiArchiveOptions*, "Org.BouncyCastle.Asn1.Crmf", "PkiArchiveOptions");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3363d38, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3364150, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3364010, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(bool archiveRemGenPrivKey);

  /// @brief Method .ctor, addr 0x3364000, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::EncryptedKey* encKey);

  /// @brief Method .ctor, addr 0x3364008, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* keyGenParameters);

  /// @brief Method .ctor, addr 0x3363ebc, size 0x144, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* tagged);

  /// @brief Method get_Type, addr 0x3364080, size 0xc8, virtual true, abstract: false, final false
  inline int32_t get_Type();

  /// @brief Method get_Value, addr 0x3364148, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Crmf::PkiArchiveOptions) == 0x18, "Size mismatch!");
