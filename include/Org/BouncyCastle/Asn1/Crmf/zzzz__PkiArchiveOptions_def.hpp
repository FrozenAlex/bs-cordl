...
public:
  ...
  /// @brief Method GetInstance, addr 0x32a92b8, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32a96d0, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32a9590, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(bool archiveRemGenPrivKey);

  /// @brief Method .ctor, addr 0x32a9580, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::EncryptedKey* encKey);

  /// @brief Method .ctor, addr 0x32a9588, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* keyGenParameters);

  /// @brief Method .ctor, addr 0x32a943c, size 0x144, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* tagged);

  /// @brief Method get_Type, addr 0x32a9600, size 0xc8, virtual true, abstract: false, final false
  inline int32_t get_Type();

  /// @brief Method get_Value, addr 0x32a96c8, size 0x8, virtual true, abstract: false, final false
