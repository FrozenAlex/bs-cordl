...
public:
  ...
  /// @brief Method GetInstance, addr 0x32a988c, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Crmf::PkiPublicationInfo* GetInstance(::System::Object* obj);

  /// @brief Method GetPubInfos, addr 0x32a9a18, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32a9c9c, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32a982c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Action, addr 0x32a9a10, size 0x8, virtual true, abstract: false, final false
