...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Crmf::PopoPrivKey*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Crmf::PopoPrivKey*, "Org.BouncyCastle.Asn1.Crmf", "PopoPrivKey");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3364e9c, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3364f4c, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3364f2c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::SubsequentMessage* msg);

  /// @brief Method .ctor, addr 0x3364bf8, size 0x18c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj);

  /// @brief Method get_Type, addr 0x3364f3c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Type();

  /// @brief Method get_Value, addr 0x3364f44, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Crmf::PopoPrivKey) == 0x20, "Size mismatch!");
