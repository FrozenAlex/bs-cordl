...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Crmf::ProofOfPossession*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Crmf::ProofOfPossession*, "Org.BouncyCastle.Asn1.Crmf", "ProofOfPossession");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3361688, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3365a38, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33659a4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3365a0c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::PopoSigningKey* Poposk);

  /// @brief Method .ctor, addr 0x3365864, size 0x140, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* tagged);

  /// @brief Method .ctor, addr 0x3365a1c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t type, ::Org::BouncyCastle::Asn1::Crmf::PopoPrivKey* privkey);

  /// @brief Method get_Object, addr 0x3365a30, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Object();

  /// @brief Method get_Type, addr 0x3365a28, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Crmf::ProofOfPossession) == 0x20, "Size mismatch!");
