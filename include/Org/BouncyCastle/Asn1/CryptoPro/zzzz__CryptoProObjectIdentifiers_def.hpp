...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::CryptoPro::CryptoProObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::CryptoPro::CryptoProObjectIdentifiers*, "Org.BouncyCastle.Asn1.CryptoPro", "CryptoProObjectIdentifiers");
...
public:
  ...
  __declspec(property(get = getStaticF_GostElSgDH3410Default, put = setStaticF_GostElSgDH3410Default)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostElSgDH3410Default;

  /// @brief Field GostElSgDH3410x1, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostElSgDH3410x1, put = setStaticF_GostElSgDH3410x1)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostElSgDH3410x1;

  /// @brief Field GostR28147Cbc, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR28147Cbc, put = setStaticF_GostR28147Cbc)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR28147Cbc;

  /// @brief Field GostR3410x2001, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR3410x2001, put = setStaticF_GostR3410x2001)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR3410x2001;

  /// @brief Field GostR3410x2001CryptoProA, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR3410x2001CryptoProA, put = setStaticF_GostR3410x2001CryptoProA)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR3410x2001CryptoProA;

  /// @brief Field GostR3410x2001CryptoProB, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR3410x2001CryptoProB, put = setStaticF_GostR3410x2001CryptoProB)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR3410x2001CryptoProB;

  /// @brief Field GostR3410x2001CryptoProC, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR3410x2001CryptoProC, put = setStaticF_GostR3410x2001CryptoProC)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR3410x2001CryptoProC;

  /// @brief Field GostR3410x2001CryptoProXchA, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR3410x2001CryptoProXchA, put = setStaticF_GostR3410x2001CryptoProXchA)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR3410x2001CryptoProXchA;

  /// @brief Field GostR3410x2001CryptoProXchB, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR3410x2001CryptoProXchB, put = setStaticF_GostR3410x2001CryptoProXchB)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR3410x2001CryptoProXchB;

  /// @brief Field GostR3410x94, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR3410x94, put = setStaticF_GostR3410x94)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR3410x94;

  /// @brief Field GostR3410x94CryptoProA, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR3410x94CryptoProA, put = setStaticF_GostR3410x94CryptoProA)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR3410x94CryptoProA;

  /// @brief Field GostR3410x94CryptoProB, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR3410x94CryptoProB, put = setStaticF_GostR3410x94CryptoProB)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR3410x94CryptoProB;

  /// @brief Field GostR3410x94CryptoProC, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR3410x94CryptoProC, put = setStaticF_GostR3410x94CryptoProC)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR3410x94CryptoProC;

  /// @brief Field GostR3410x94CryptoProD, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR3410x94CryptoProD, put = setStaticF_GostR3410x94CryptoProD)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR3410x94CryptoProD;

  /// @brief Field GostR3410x94CryptoProXchA, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR3410x94CryptoProXchA, put = setStaticF_GostR3410x94CryptoProXchA)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR3410x94CryptoProXchA;

  /// @brief Field GostR3410x94CryptoProXchB, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR3410x94CryptoProXchB, put = setStaticF_GostR3410x94CryptoProXchB)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR3410x94CryptoProXchB;

  /// @brief Field GostR3410x94CryptoProXchC, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR3410x94CryptoProXchC, put = setStaticF_GostR3410x94CryptoProXchC)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR3410x94CryptoProXchC;

  /// @brief Field GostR3411, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR3411, put = setStaticF_GostR3411)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR3411;

  /// @brief Field GostR3411Hmac, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR3411Hmac, put = setStaticF_GostR3411Hmac)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR3411Hmac;

  /// @brief Field GostR3411x94CryptoProParamSet, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR3411x94CryptoProParamSet, put = setStaticF_GostR3411x94CryptoProParamSet)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR3411x94CryptoProParamSet;

  /// @brief Field GostR3411x94WithGostR3410x2001, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR3411x94WithGostR3410x2001, put = setStaticF_GostR3411x94WithGostR3410x2001)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR3411x94WithGostR3410x2001;

  /// @brief Field GostR3411x94WithGostR3410x94, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_GostR3411x94WithGostR3410x94, put = setStaticF_GostR3411x94WithGostR3410x94)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GostR3411x94WithGostR3410x94;

  /// @brief Field ID_Gost28147_89_CryptoPro_A_ParamSet, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_ID_Gost28147_89_CryptoPro_A_ParamSet,
  ...
  /// @brief Method .ctor, addr 0x3366bb8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::CryptoPro::CryptoProObjectIdentifiers) == 0x10, "Size mismatch!");
