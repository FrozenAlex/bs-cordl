...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::CryptoPro::Gost28147Parameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::CryptoPro::Gost28147Parameters*, "Org.BouncyCastle.Asn1.CryptoPro", "Gost28147Parameters");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x32aef44, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x32aef58, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32af1f4, size 0xf0, virtual true, abstract: false, final false
  ...
  constexpr ::Org::BouncyCastle::Asn1::DerObjectIdentifier* const& __cordl_internal_get_paramSet() const;
  ...
  /// @brief Method .ctor, addr 0x32af0c8, size 0x12c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::CryptoPro::Gost28147Parameters) == 0x20, "Size mismatch!");
