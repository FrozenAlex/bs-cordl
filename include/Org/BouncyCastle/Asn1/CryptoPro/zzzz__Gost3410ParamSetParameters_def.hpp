...
public:
  ...
  /// @brief Method GetInstance, addr 0x336aa20, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x336aa34, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x336acfc, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x336a410, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x336aba4, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_A, addr 0x336ace8, size 0x14, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_A();

  /// @brief Method get_KeySize, addr 0x336acb8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_KeySize();

  /// @brief Method get_P, addr 0x336acc0, size 0x14, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_P();

  /// @brief Method get_Q, addr 0x336acd4, size 0x14, virtual false, abstract: false, final false
