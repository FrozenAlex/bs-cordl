...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::CryptoPro::Gost3410PublicKeyAlgParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::CryptoPro::Gost3410PublicKeyAlgParameters*, "Org.BouncyCastle.Asn1.CryptoPro", "Gost3410PublicKeyAlgParameters");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x32b03fc, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x32b0410, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32b0724, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32b0680, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32b0688, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* publicKeyParamSet, ::Org::BouncyCastle::Asn1::DerObjectIdentifier* digestParamSet,
                    ::Org::BouncyCastle::Asn1::DerObjectIdentifier* encryptionParamSet);

  /// @brief Method .ctor, addr 0x32b04b0, size 0x1d0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_DigestParamSet, addr 0x32b0714, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_DigestParamSet();

  /// @brief Method get_EncryptionParamSet, addr 0x32b071c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_EncryptionParamSet();

  /// @brief Method get_PublicKeyParamSet, addr 0x32b070c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::CryptoPro::Gost3410PublicKeyAlgParameters) == 0x28, "Size mismatch!");
