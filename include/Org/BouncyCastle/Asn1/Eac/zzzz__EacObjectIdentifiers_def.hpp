...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Eac::EacObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Eac::EacObjectIdentifiers*, "Org.BouncyCastle.Asn1.Eac", "EacObjectIdentifiers");
...
public:
  ...
  /// @brief Method .ctor, addr 0x336b948, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Eac::EacObjectIdentifiers) == 0x10, "Size mismatch!");
