...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::EdEC::EdECObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::EdEC::EdECObjectIdentifiers*, "Org.BouncyCastle.Asn1.EdEC", "EdECObjectIdentifiers");
...
public:
  ...
  /// @brief Method .ctor, addr 0x32b1068, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::EdEC::EdECObjectIdentifiers) == 0x10, "Size mismatch!");
