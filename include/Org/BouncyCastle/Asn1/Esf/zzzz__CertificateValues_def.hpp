...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Esf::CertificateValues*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Esf::CertificateValues*, "Org.BouncyCastle.Asn1.Esf", "CertificateValues");
...
public:
  ...
  /// @brief Method GetCertificates, addr 0x32b1748, size 0x118, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::X509::X509CertificateStructure*> GetCertificates();

  /// @brief Method GetInstance, addr 0x32b106c, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32b1860, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32b150c, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::X509::X509CertificateStructure*> certificates);

  /// @brief Method .ctor, addr 0x32b15c0, size 0x188, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* certificates);

  /// @brief Method .ctor, addr 0x32b11f0, size 0x31c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Esf::CertificateValues) == 0x18, "Size mismatch!");
