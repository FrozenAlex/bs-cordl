...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Esf::CommitmentTypeQualifier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Esf::CommitmentTypeQualifier*, "Org.BouncyCastle.Asn1.Esf", "CommitmentTypeQualifier");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x336cc48, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x336cddc, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x336c990, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* commitmentTypeIdentifier);

  /// @brief Method .ctor, addr 0x336c998, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x336ca10, size 0x238, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CommitmentTypeIdentifier, addr 0x336cdcc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_CommitmentTypeIdentifier();

  /// @brief Method get_Qualifier, addr 0x336cdd4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Esf::CommitmentTypeQualifier) == 0x20, "Size mismatch!");
