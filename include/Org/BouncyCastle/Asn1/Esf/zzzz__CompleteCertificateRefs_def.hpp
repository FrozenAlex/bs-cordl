...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs*, "Org.BouncyCastle.Asn1.Esf", "CompleteCertificateRefs");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x32b24b0, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs* GetInstance(::System::Object* obj);

  /// @brief Method GetOtherCertIDs, addr 0x32b2d0c, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32b2e30, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32b2ad0, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Esf::OtherCertID*> otherCertIDs);

  /// @brief Method .ctor, addr 0x32b2b84, size 0x188, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* otherCertIDs);

  /// @brief Method .ctor, addr 0x32b2634, size 0x318, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs) == 0x18, "Size mismatch!");
