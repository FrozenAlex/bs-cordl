...
public:
  ...
  /// @brief Method GetCrlOcspRefs, addr 0x32b3694, size 0x124, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Esf::CrlOcspRef*> GetCrlOcspRefs();

  /// @brief Method GetInstance, addr 0x32b2e38, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32b37b8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32b3458, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Esf::CrlOcspRef*> crlOcspRefs);

  /// @brief Method .ctor, addr 0x32b350c, size 0x188, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* crlOcspRefs);

  /// @brief Method .ctor, addr 0x32b2fbc, size 0x318, virtual false, abstract: false, final false
