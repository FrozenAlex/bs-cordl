...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Esf::CrlIdentifier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Esf::CrlIdentifier*, "Org.BouncyCastle.Asn1.Esf", "CrlIdentifier");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x32b37c0, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32b3c88, size 0x198, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32b3b44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509Name* crlIssuer, ::System::DateTime crlIssuedTime);

  /// @brief Method .ctor, addr 0x32b3b4c, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32b3944, size 0x200, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CrlIssuedTime, addr 0x32b3c60, size 0x18, virtual false, abstract: false, final false
  inline ::System::DateTime get_CrlIssuedTime();

  /// @brief Method get_CrlIssuer, addr 0x32b3c58, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_CrlIssuer();

  /// @brief Method get_CrlNumber, addr 0x32b3c78, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Esf::CrlIdentifier) == 0x28, "Size mismatch!");
