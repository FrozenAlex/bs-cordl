...
public:
  ...
  /// @brief Method GetHashValue, addr 0x3371b84, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetHashValue();

  /// @brief Method GetInstance, addr 0x3371830, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3371f2c, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3371dc4, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* hashAlgorithm, ::ArrayW<uint8_t> hashValue);

  /// @brief Method .ctor, addr 0x3371ea4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3371bc0, size 0x204, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_HashAlgorithm, addr 0x3371f24, size 0x8, virtual false, abstract: false, final false
