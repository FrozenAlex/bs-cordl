...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Esf::OtherRevVals*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Esf::OtherRevVals*, "Org.BouncyCastle.Asn1.Esf", "OtherRevVals");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x32b7930, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32b7d58, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32b7cb0, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32b7ab4, size 0x1fc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_OtherRevValType, addr 0x32b7d48, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_OtherRevValType();

  /// @brief Method get_OtherRevValsObject, addr 0x32b7d50, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Esf::OtherRevVals) == 0x20, "Size mismatch!");
