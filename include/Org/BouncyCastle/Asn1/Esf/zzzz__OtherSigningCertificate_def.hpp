...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Esf::OtherSigningCertificate*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Esf::OtherSigningCertificate*, "Org.BouncyCastle.Asn1.Esf", "OtherSigningCertificate");
...
public:
  ...
  /// @brief Method GetCerts, addr 0x3372f38, size 0x124, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Esf::OtherCertID*> GetCerts();

  /// @brief Method GetInstance, addr 0x33728c8, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Esf::OtherSigningCertificate* GetInstance(::System::Object* obj);

  /// @brief Method GetPolicies, addr 0x337305c, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3373188, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3372c04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Esf::OtherCertID*> certs);

  /// @brief Method .ctor, addr 0x3372c0c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3372ce0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* certs);

  /// @brief Method .ctor, addr 0x3372ce8, size 0x250, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* certs, ::System::Collections::IEnumerable* policies);

  /// @brief Method .ctor, addr 0x3372a4c, size 0x1b8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Esf::OtherSigningCertificate) == 0x20, "Size mismatch!");
