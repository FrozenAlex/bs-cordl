...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Esf::RevocationValues*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Esf::RevocationValues*, "Org.BouncyCastle.Asn1.Esf", "RevocationValues");
...
public:
  ...
  /// @brief Method GetCrlVals, addr 0x3374034, size 0x128, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::X509::CertificateList*> GetCrlVals();

  /// @brief Method GetInstance, addr 0x33732dc, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Esf::RevocationValues* GetInstance(::System::Object* obj);

  /// @brief Method GetOcspVals, addr 0x337415c, size 0x128, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Ocsp::BasicOcspResponse*> GetOcspVals();

  static inline ::Org::BouncyCastle::Asn1::Esf::RevocationValues* New_ctor(::ArrayW<::Org::BouncyCastle::Asn1::X509::CertificateList*> crlVals,
  ...
  /// @brief Method ToAsn1Object, addr 0x337428c, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3373d6c, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::X509::CertificateList*> crlVals, ::ArrayW<::Org::BouncyCastle::Asn1::Ocsp::BasicOcspResponse*> ocspVals,
                    ::Org::BouncyCastle::Asn1::Esf::OtherRevVals* otherRevVals);

  /// @brief Method .ctor, addr 0x3373e08, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x337337c, size 0x9f0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_OtherRevVals, addr 0x3374284, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Esf::RevocationValues) == 0x28, "Size mismatch!");
