...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Esf::SignerAttribute*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Esf::SignerAttribute*, "Org.BouncyCastle.Asn1.Esf", "SignerAttribute");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x32ba72c, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32baa10, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32ba9f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AttributeCertificate* certifiedAttributes);

  /// @brief Method .ctor, addr 0x32ba9f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* claimedAttributes);

  /// @brief Method .ctor, addr 0x32ba87c, size 0x174, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* obj);

  /// @brief Method get_CertifiedAttributes, addr 0x32baa08, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AttributeCertificate* get_CertifiedAttributes();

  /// @brief Method get_ClaimedAttributes, addr 0x32baa00, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Esf::SignerAttribute) == 0x20, "Size mismatch!");
