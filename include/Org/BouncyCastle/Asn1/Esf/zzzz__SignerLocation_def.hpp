...
public:
  ...
  /// @brief Method GetInstance, addr 0x3375b08, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Esf::SignerLocation* GetInstance(::System::Object* obj);

  /// @brief Method GetPostal, addr 0x3375bb8, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3375de4, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3375ab4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3375a30, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3375994, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X500::DirectoryString* countryName, ::Org::BouncyCastle::Asn1::X500::DirectoryString* localityName,
                    ::Org::BouncyCastle::Asn1::Asn1Sequence* postalAddress);

  /// @brief Method .ctor, addr 0x3375590, size 0x404, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Country, addr 0x3375ba8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X500::DirectoryString* get_Country();

  /// @brief Method get_CountryName, addr 0x3375cbc, size 0x90, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerUtf8String* get_CountryName();

  /// @brief Method get_Locality, addr 0x3375bb0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X500::DirectoryString* get_Locality();

  /// @brief Method get_LocalityName, addr 0x3375d4c, size 0x90, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerUtf8String* get_LocalityName();

  /// @brief Method get_PostalAddress, addr 0x3375ddc, size 0x8, virtual false, abstract: false, final false
