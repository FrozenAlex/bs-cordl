...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Ess::ContentHints*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Ess::ContentHints*, "Org.BouncyCastle.Asn1.Ess", "ContentHints");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x33761e8, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3376518, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33764f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* contentType);

  /// @brief Method .ctor, addr 0x3376500, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3376370, size 0x188, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_ContentDescription, addr 0x3376510, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerUtf8String* get_ContentDescription();

  /// @brief Method get_ContentType, addr 0x3376508, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Ess::ContentHints) == 0x20, "Size mismatch!");
