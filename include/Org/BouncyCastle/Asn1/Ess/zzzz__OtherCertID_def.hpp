...
public:
  ...
  /// @brief Method GetCertHash, addr 0x32bce80, size 0xf8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetCertHash();

  /// @brief Method GetInstance, addr 0x32bc93c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32bcf80, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32bccb0, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algId, ::ArrayW<uint8_t> digest);

  /// @brief Method .ctor, addr 0x32bcd14, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32bcac4, size 0x1ec, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_AlgorithmHash, addr 0x32bcd84, size 0xfc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_AlgorithmHash();

  /// @brief Method get_IssuerSerial, addr 0x32bcf78, size 0x8, virtual false, abstract: false, final false
