...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::GM::GMObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::GM::GMObjectIdentifiers*, "Org.BouncyCastle.Asn1.GM", "GMObjectIdentifiers");
...
public:
  ...
  __declspec(property(get = getStaticF_hmac_sm3, put = setStaticF_hmac_sm3)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* hmac_sm3;

  /// @brief Field id_sm9PublicKey, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_id_sm9PublicKey, put = setStaticF_id_sm9PublicKey)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* id_sm9PublicKey;

  /// @brief Field sm1_cbc, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm1_cbc, put = setStaticF_sm1_cbc)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm1_cbc;

  /// @brief Field sm1_cfb1, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm1_cfb1, put = setStaticF_sm1_cfb1)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm1_cfb1;

  /// @brief Field sm1_cfb128, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm1_cfb128, put = setStaticF_sm1_cfb128)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm1_cfb128;

  /// @brief Field sm1_cfb8, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm1_cfb8, put = setStaticF_sm1_cfb8)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm1_cfb8;

  /// @brief Field sm1_ecb, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm1_ecb, put = setStaticF_sm1_ecb)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm1_ecb;

  /// @brief Field sm1_ofb128, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm1_ofb128, put = setStaticF_sm1_ofb128)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm1_ofb128;

  /// @brief Field sm2encrypt, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2encrypt, put = setStaticF_sm2encrypt)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2encrypt;

  /// @brief Field sm2encrypt_recommendedParameters, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2encrypt_recommendedParameters,
  ...
  __declspec(property(get = getStaticF_sm2encrypt_specifiedParameters, put = setStaticF_sm2encrypt_specifiedParameters)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2encrypt_specifiedParameters;

  /// @brief Field sm2encrypt_with_blake2b512, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2encrypt_with_blake2b512, put = setStaticF_sm2encrypt_with_blake2b512)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2encrypt_with_blake2b512;

  /// @brief Field sm2encrypt_with_blake2s256, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2encrypt_with_blake2s256, put = setStaticF_sm2encrypt_with_blake2s256)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2encrypt_with_blake2s256;

  /// @brief Field sm2encrypt_with_md5, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2encrypt_with_md5, put = setStaticF_sm2encrypt_with_md5)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2encrypt_with_md5;

  /// @brief Field sm2encrypt_with_rmd160, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2encrypt_with_rmd160, put = setStaticF_sm2encrypt_with_rmd160)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2encrypt_with_rmd160;

  /// @brief Field sm2encrypt_with_sha1, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2encrypt_with_sha1, put = setStaticF_sm2encrypt_with_sha1)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2encrypt_with_sha1;

  /// @brief Field sm2encrypt_with_sha224, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2encrypt_with_sha224, put = setStaticF_sm2encrypt_with_sha224)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2encrypt_with_sha224;

  /// @brief Field sm2encrypt_with_sha256, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2encrypt_with_sha256, put = setStaticF_sm2encrypt_with_sha256)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2encrypt_with_sha256;

  /// @brief Field sm2encrypt_with_sha384, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2encrypt_with_sha384, put = setStaticF_sm2encrypt_with_sha384)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2encrypt_with_sha384;

  /// @brief Field sm2encrypt_with_sha512, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2encrypt_with_sha512, put = setStaticF_sm2encrypt_with_sha512)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2encrypt_with_sha512;

  /// @brief Field sm2encrypt_with_sm3, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2encrypt_with_sm3, put = setStaticF_sm2encrypt_with_sm3)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2encrypt_with_sm3;

  /// @brief Field sm2encrypt_with_whirlpool, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2encrypt_with_whirlpool, put = setStaticF_sm2encrypt_with_whirlpool)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2encrypt_with_whirlpool;

  /// @brief Field sm2exchange, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2exchange, put = setStaticF_sm2exchange)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2exchange;

  /// @brief Field sm2p256v1, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2p256v1, put = setStaticF_sm2p256v1)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2p256v1;

  /// @brief Field sm2sign, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2sign, put = setStaticF_sm2sign)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2sign;

  /// @brief Field sm2sign_with_blake2b512, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2sign_with_blake2b512, put = setStaticF_sm2sign_with_blake2b512)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2sign_with_blake2b512;

  /// @brief Field sm2sign_with_blake2s256, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2sign_with_blake2s256, put = setStaticF_sm2sign_with_blake2s256)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2sign_with_blake2s256;

  /// @brief Field sm2sign_with_rmd160, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2sign_with_rmd160, put = setStaticF_sm2sign_with_rmd160)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2sign_with_rmd160;

  /// @brief Field sm2sign_with_sha1, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2sign_with_sha1, put = setStaticF_sm2sign_with_sha1)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2sign_with_sha1;

  /// @brief Field sm2sign_with_sha224, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2sign_with_sha224, put = setStaticF_sm2sign_with_sha224)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2sign_with_sha224;

  /// @brief Field sm2sign_with_sha256, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2sign_with_sha256, put = setStaticF_sm2sign_with_sha256)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2sign_with_sha256;

  /// @brief Field sm2sign_with_sha384, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2sign_with_sha384, put = setStaticF_sm2sign_with_sha384)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2sign_with_sha384;

  /// @brief Field sm2sign_with_sha512, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2sign_with_sha512, put = setStaticF_sm2sign_with_sha512)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2sign_with_sha512;

  /// @brief Field sm2sign_with_sm3, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2sign_with_sm3, put = setStaticF_sm2sign_with_sm3)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2sign_with_sm3;

  /// @brief Field sm2sign_with_whirlpool, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm2sign_with_whirlpool, put = setStaticF_sm2sign_with_whirlpool)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm2sign_with_whirlpool;

  /// @brief Field sm3, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm3, put = setStaticF_sm3)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm3;

  /// @brief Field sm5, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm5, put = setStaticF_sm5)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm5;

  /// @brief Field sm6_cbc, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm6_cbc, put = setStaticF_sm6_cbc)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm6_cbc;

  /// @brief Field sm6_cfb128, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm6_cfb128, put = setStaticF_sm6_cfb128)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm6_cfb128;

  /// @brief Field sm6_ecb, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm6_ecb, put = setStaticF_sm6_ecb)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm6_ecb;

  /// @brief Field sm6_ofb128, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm6_ofb128, put = setStaticF_sm6_ofb128)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm6_ofb128;

  /// @brief Field sm9encrypt, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm9encrypt, put = setStaticF_sm9encrypt)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm9encrypt;

  /// @brief Field sm9keyagreement, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm9keyagreement, put = setStaticF_sm9keyagreement)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm9keyagreement;

  /// @brief Field sm9sign, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm9sign, put = setStaticF_sm9sign)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm9sign;

  /// @brief Field sm_scheme, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sm_scheme, put = setStaticF_sm_scheme)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sm_scheme;

  /// @brief Field sms4_cbc, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sms4_cbc, put = setStaticF_sms4_cbc)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sms4_cbc;

  /// @brief Field sms4_ccm, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sms4_ccm, put = setStaticF_sms4_ccm)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sms4_ccm;

  /// @brief Field sms4_cfb1, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sms4_cfb1, put = setStaticF_sms4_cfb1)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sms4_cfb1;

  /// @brief Field sms4_cfb128, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sms4_cfb128, put = setStaticF_sms4_cfb128)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sms4_cfb128;

  /// @brief Field sms4_cfb8, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sms4_cfb8, put = setStaticF_sms4_cfb8)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sms4_cfb8;

  /// @brief Field sms4_ctr, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sms4_ctr, put = setStaticF_sms4_ctr)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sms4_ctr;

  /// @brief Field sms4_ecb, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sms4_ecb, put = setStaticF_sms4_ecb)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sms4_ecb;

  /// @brief Field sms4_gcm, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sms4_gcm, put = setStaticF_sms4_gcm)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sms4_gcm;

  /// @brief Field sms4_ocb, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sms4_ocb, put = setStaticF_sms4_ocb)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sms4_ocb;

  /// @brief Field sms4_ofb128, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sms4_ofb128, put = setStaticF_sms4_ofb128)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sms4_ofb128;

  /// @brief Field sms4_wrap, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sms4_wrap, put = setStaticF_sms4_wrap)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sms4_wrap;

  /// @brief Field sms4_wrap_pad, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sms4_wrap_pad, put = setStaticF_sms4_wrap_pad)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sms4_wrap_pad;

  /// @brief Field sms4_xts, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_sms4_xts, put = setStaticF_sms4_xts)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* sms4_xts;

  /// @brief Field ssf33_cbc, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_ssf33_cbc, put = setStaticF_ssf33_cbc)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* ssf33_cbc;

  /// @brief Field ssf33_cfb1, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_ssf33_cfb1, put = setStaticF_ssf33_cfb1)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* ssf33_cfb1;

  /// @brief Field ssf33_cfb128, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_ssf33_cfb128, put = setStaticF_ssf33_cfb128)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* ssf33_cfb128;

  /// @brief Field ssf33_cfb8, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_ssf33_cfb8, put = setStaticF_ssf33_cfb8)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* ssf33_cfb8;

  /// @brief Field ssf33_ecb, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_ssf33_ecb, put = setStaticF_ssf33_ecb)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* ssf33_ecb;

  /// @brief Field ssf33_ofb128, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_ssf33_ofb128, put = setStaticF_ssf33_ofb128)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* ssf33_ofb128;

  /// @brief Field wapip192v1, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_wapip192v1, put = setStaticF_wapip192v1)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* wapip192v1;

  static inline ::Org::BouncyCastle::Asn1::GM::GMObjectIdentifiers* New_ctor();

  /// @brief Method .ctor, addr 0x337b030, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::GM::GMObjectIdentifiers) == 0x10, "Size mismatch!");
