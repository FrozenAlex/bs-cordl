...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Iana::IanaObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Iana::IanaObjectIdentifiers*, "Org.BouncyCastle.Asn1.Iana", "IanaObjectIdentifiers");
...
public:
  ...
  /// @brief Method .ctor, addr 0x337b864, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Iana::IanaObjectIdentifiers) == 0x10, "Size mismatch!");
