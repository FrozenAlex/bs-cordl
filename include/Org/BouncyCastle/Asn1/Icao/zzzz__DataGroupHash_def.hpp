...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Icao::DataGroupHash*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Icao::DataGroupHash*, "Org.BouncyCastle.Asn1.Icao", "DataGroupHash");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x33907fc, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3390a08, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3390978, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(int32_t dataGroupNumber, ::Org::BouncyCastle::Asn1::Asn1OctetString* dataGroupHashValue);

  /// @brief Method .ctor, addr 0x339089c, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_DataGroupHashValue, addr 0x3390a00, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_DataGroupHashValue();

  /// @brief Method get_DataGroupNumber, addr 0x33909e8, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Icao::DataGroupHash) == 0x20, "Size mismatch!");
