...
public:
  ...
  /// @brief Method GetInstance, addr 0x344b27c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x344b488, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x344b3f8, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(int32_t dataGroupNumber, ::Org::BouncyCastle::Asn1::Asn1OctetString* dataGroupHashValue);

  /// @brief Method .ctor, addr 0x344b31c, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_DataGroupHashValue, addr 0x344b480, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_DataGroupHashValue();

  /// @brief Method get_DataGroupNumber, addr 0x344b468, size 0x18, virtual false, abstract: false, final false
