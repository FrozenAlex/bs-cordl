...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Icao::LdsVersionInfo*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Icao::LdsVersionInfo*, "Org.BouncyCastle.Asn1.Icao", "LdsVersionInfo");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3391424, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Icao::LdsVersionInfo* GetInstance(::System::Object* obj);

  /// @brief Method GetLdsVersion, addr 0x3391a08, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW GetLdsVersion();

  /// @brief Method GetUnicodeVersion, addr 0x3391a24, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3391a40, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33918a0, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::StringW ldsVersion, ::StringW unicodeVersion);

  /// @brief Method .ctor, addr 0x339192c, size 0xdc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Icao::LdsVersionInfo) == 0x20, "Size mismatch!");
