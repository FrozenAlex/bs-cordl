...
MARK_REF_T(::Org::BouncyCastle::Asn1::IsisMtt::Ocsp::RequestedCertificate*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::IsisMtt::Ocsp::RequestedCertificate_Choice, "Org.BouncyCastle.Asn1.IsisMtt.Ocsp", "RequestedCertificate/Choice");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::IsisMtt::Ocsp::RequestedCertificate*, "Org.BouncyCastle.Asn1.IsisMtt.Ocsp", "RequestedCertificate");
// Dependencies
namespace Org::BouncyCastle::Asn1::IsisMtt::Ocsp {
// Is value type: true
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::IsisMtt::Ocsp::RequestedCertificate_Choice) == 0x4, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_attributeCert, put = __cordl_internal_set_attributeCert)) ::ArrayW<uint8_t> attributeCert;
  ...
  __declspec(property(get = __cordl_internal_get_publicKeyCert, put = __cordl_internal_set_publicKeyCert)) ::ArrayW<uint8_t> publicKeyCert;

  /// @brief Convert operator to "::Org::BouncyCastle::Asn1::IAsn1Choice"
  constexpr operator ::Org::BouncyCastle::Asn1::IAsn1Choice*() noexcept;

  /// @brief Method GetCertificateBytes, addr 0x3392498, size 0x100, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetCertificateBytes();

  /// @brief Method GetInstance, addr 0x3392364, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x339206c, size 0x1e8, virtual false, abstract: false, final false
  ...
  static inline ::Org::BouncyCastle::Asn1::IsisMtt::Ocsp::RequestedCertificate* New_ctor(::Org::BouncyCastle::Asn1::IsisMtt::Ocsp::RequestedCertificate_Choice type,
                                                                                         ::ArrayW<uint8_t> certificateOctets);

  /// @brief Method ToAsn1Object, addr 0x3392598, size 0xec, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_attributeCert() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_attributeCert();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_publicKeyCert() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_publicKeyCert();

  constexpr void __cordl_internal_set_attributeCert(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_cert(::Org::BouncyCastle::Asn1::X509::X509CertificateStructure* value);

  constexpr void __cordl_internal_set_publicKeyCert(::ArrayW<uint8_t> value);

  /// @brief Method .ctor, addr 0x3392254, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509CertificateStructure* certificate);

  /// @brief Method .ctor, addr 0x339225c, size 0x108, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* tagged);

  /// @brief Method .ctor, addr 0x33923d8, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::IsisMtt::Ocsp::RequestedCertificate_Choice type, ::ArrayW<uint8_t> certificateOctets);

  /// @brief Method get_Type, addr 0x3392478, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<uint8_t> ___publicKeyCert;

  /// @brief Field attributeCert, offset: 0x20, size: 0x8, def value: None
  ::ArrayW<uint8_t> ___attributeCert;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::IsisMtt::Ocsp::RequestedCertificate) == 0x28, "Size mismatch!");
