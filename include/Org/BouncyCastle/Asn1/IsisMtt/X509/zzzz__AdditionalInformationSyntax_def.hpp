...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::IsisMtt::X509::AdditionalInformationSyntax*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::IsisMtt::X509::AdditionalInformationSyntax*, "Org.BouncyCastle.Asn1.IsisMtt.X509", "AdditionalInformationSyntax");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x344d104, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x344d2cc, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x344d250, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X500::DirectoryString* information);

  /// @brief Method .ctor, addr 0x344d258, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW information);

  /// @brief Method get_Information, addr 0x344d2c4, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::IsisMtt::X509::AdditionalInformationSyntax) == 0x18, "Size mismatch!");
