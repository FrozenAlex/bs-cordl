...
public:
  ...
  /// @brief Method GetInstance, addr 0x344ed2c, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x344f0cc, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x344efb0, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor(::StringW currency, int32_t amount, int32_t exponent);

  /// @brief Method .ctor, addr 0x344ee90, size 0x120, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Amount, addr 0x344f09c, size 0x18, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Amount();

  /// @brief Method get_Currency, addr 0x344f080, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_Currency();

  /// @brief Method get_Exponent, addr 0x344f0b4, size 0x18, virtual true, abstract: false, final false
