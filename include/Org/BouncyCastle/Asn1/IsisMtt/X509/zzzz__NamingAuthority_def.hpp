...
public:
  ...
  /// @brief Method GetInstance, addr 0x344db3c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x344f1e8, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x344fa44, size 0x1a0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x344fa38, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x344f36c, size 0x5c8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NamingAuthorityID, addr 0x344fa20, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_NamingAuthorityID();

  /// @brief Method get_NamingAuthorityText, addr 0x344fa28, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X500::DirectoryString* get_NamingAuthorityText();

  /// @brief Method get_NamingAuthorityUrl, addr 0x344fa30, size 0x8, virtual true, abstract: false, final false
