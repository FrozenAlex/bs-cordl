...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::IsisMtt::X509::ProfessionInfo*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::IsisMtt::X509::ProfessionInfo*, "Org.BouncyCastle.Asn1.IsisMtt.X509", "ProfessionInfo");
...
public:
  ...
  __declspec(property(get = getStaticF_Notar, put = setStaticF_Notar)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Notar;

  /// @brief Field Notariatsverwalter, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Notariatsverwalter, put = setStaticF_Notariatsverwalter)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Notariatsverwalter;

  /// @brief Field Notariatsverwalterin, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Notariatsverwalterin, put = setStaticF_Notariatsverwalterin)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Notariatsverwalterin;

  /// @brief Field Notarin, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Notarin, put = setStaticF_Notarin)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Notarin;

  /// @brief Field Notarvertreter, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Notarvertreter, put = setStaticF_Notarvertreter)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Notarvertreter;

  /// @brief Field Notarvertreterin, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Notarvertreterin, put = setStaticF_Notarvertreterin)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Notarvertreterin;

  /// @brief Field Patentanwalt, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Patentanwalt, put = setStaticF_Patentanwalt)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Patentanwalt;

  /// @brief Field Patentanwltin, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Patentanwltin, put = setStaticF_Patentanwltin)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Patentanwltin;

  /// @brief Field Rechtsanwalt, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Rechtsanwalt, put = setStaticF_Rechtsanwalt)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Rechtsanwalt;

  /// @brief Field Rechtsanwltin, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Rechtsanwltin, put = setStaticF_Rechtsanwltin)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Rechtsanwltin;

  /// @brief Field Rechtsbeistand, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Rechtsbeistand, put = setStaticF_Rechtsbeistand)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Rechtsbeistand;
  ...
  __declspec(property(get = getStaticF_Steuerberater, put = setStaticF_Steuerberater)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Steuerberater;

  /// @brief Field Steuerberaterin, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Steuerberaterin, put = setStaticF_Steuerberaterin)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Steuerberaterin;

  /// @brief Field Steuerbevollmchtigte, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Steuerbevollmchtigte, put = setStaticF_Steuerbevollmchtigte)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Steuerbevollmchtigte;

  /// @brief Field Steuerbevollmchtigter, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Steuerbevollmchtigter, put = setStaticF_Steuerbevollmchtigter)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Steuerbevollmchtigter;

  /// @brief Field VereidigteBuchprferin, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_VereidigteBuchprferin, put = setStaticF_VereidigteBuchprferin)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* VereidigteBuchprferin;

  /// @brief Field VereidigterBuchprfer, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_VereidigterBuchprfer, put = setStaticF_VereidigterBuchprfer)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* VereidigterBuchprfer;

  /// @brief Field Wirtschaftsprfer, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Wirtschaftsprfer, put = setStaticF_Wirtschaftsprfer)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Wirtschaftsprfer;

  /// @brief Field Wirtschaftsprferin, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Wirtschaftsprferin, put = setStaticF_Wirtschaftsprferin)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Wirtschaftsprferin;
  ...
  /// @brief Method GetInstance, addr 0x344dfe4, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::IsisMtt::X509::ProfessionInfo* GetInstance(::System::Object* obj);

  /// @brief Method GetProfessionItems, addr 0x3450f60, size 0x118, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::X500::DirectoryString*> GetProfessionItems();

  /// @brief Method GetProfessionOids, addr 0x3451078, size 0x168, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::DerObjectIdentifier*> GetProfessionOids();

  static inline ::Org::BouncyCastle::Asn1::IsisMtt::X509::ProfessionInfo* New_ctor(::Org::BouncyCastle::Asn1::IsisMtt::X509::NamingAuthority* namingAuthority,
  ...
  /// @brief Method ToAsn1Object, addr 0x3450d84, size 0x1cc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  constexpr ::Org::BouncyCastle::Asn1::Asn1OctetString* const& __cordl_internal_get_addProfessionInfo() const;
  ...
  constexpr ::Org::BouncyCastle::Asn1::Asn1Sequence* const& __cordl_internal_get_professionItems() const;

  constexpr ::Org::BouncyCastle::Asn1::Asn1Sequence*& __cordl_internal_get_professionItems();

  constexpr ::Org::BouncyCastle::Asn1::Asn1Sequence* const& __cordl_internal_get_professionOids() const;
  ...
  /// @brief Method .ctor, addr 0x3450cd8, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::IsisMtt::X509::NamingAuthority* namingAuthority, ::ArrayW<::Org::BouncyCastle::Asn1::X500::DirectoryString*> professionItems,
  ...
  /// @brief Method .ctor, addr 0x345042c, size 0x8ac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AddProfessionInfo, addr 0x3450f50, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_AddProfessionInfo();

  /// @brief Method get_NamingAuthority, addr 0x3450f58, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::IsisMtt::X509::NamingAuthority* get_NamingAuthority();

  /// @brief Method get_RegistrationNumber, addr 0x34511e0, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::IsisMtt::X509::ProfessionInfo) == 0x38, "Size mismatch!");
