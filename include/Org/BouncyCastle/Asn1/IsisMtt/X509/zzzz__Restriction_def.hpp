...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::IsisMtt::X509::Restriction*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::IsisMtt::X509::Restriction*, "Org.BouncyCastle.Asn1.IsisMtt.X509", "Restriction");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3451944, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3451b0c, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3451a90, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X500::DirectoryString* restriction);

  /// @brief Method .ctor, addr 0x3451a98, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW restriction);

  /// @brief Method get_RestrictionString, addr 0x3451b04, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::IsisMtt::X509::Restriction) == 0x18, "Size mismatch!");
