...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::IsisMtt::IsisMttObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::IsisMtt::IsisMttObjectIdentifiers*, "Org.BouncyCastle.Asn1.IsisMtt", "IsisMttObjectIdentifiers");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3397730, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::IsisMtt::IsisMttObjectIdentifiers) == 0x10, "Size mismatch!");
