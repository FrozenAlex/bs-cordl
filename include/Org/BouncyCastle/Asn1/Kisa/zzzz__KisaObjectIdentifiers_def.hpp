...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Kisa::KisaObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Kisa::KisaObjectIdentifiers*, "Org.BouncyCastle.Asn1.Kisa", "KisaObjectIdentifiers");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3397804, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Kisa::KisaObjectIdentifiers) == 0x10, "Size mismatch!");
