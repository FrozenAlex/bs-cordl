...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Microsoft::MicrosoftObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Microsoft::MicrosoftObjectIdentifiers*, "Org.BouncyCastle.Asn1.Microsoft", "MicrosoftObjectIdentifiers");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3397a24, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Microsoft::MicrosoftObjectIdentifiers) == 0x10, "Size mismatch!");
