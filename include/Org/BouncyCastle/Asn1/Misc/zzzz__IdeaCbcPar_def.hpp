...
public:
  ...
  /// @brief Method GetIV, addr 0x33981f4, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetIV();

  /// @brief Method GetInstance, addr 0x3397f60, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x339820c, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x339818c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> iv);

  /// @brief Method .ctor, addr 0x33980a4, size 0xe8, virtual false, abstract: false, final false
