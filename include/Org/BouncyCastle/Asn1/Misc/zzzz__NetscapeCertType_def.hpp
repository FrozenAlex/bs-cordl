...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Misc::NetscapeCertType*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Misc::NetscapeCertType*, "Org.BouncyCastle.Asn1.Misc", "NetscapeCertType");
...
public:
  ...
  /// @brief Method ToString, addr 0x3398dfc, size 0xb0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x3398d5c, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerBitString* usage);

  /// @brief Method .ctor, addr 0x3398cf0, size 0x6c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Misc::NetscapeCertType) == 0x20, "Size mismatch!");
