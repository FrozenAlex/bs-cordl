  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{},
                     (::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Asn1::Misc::VerisignCzagExtension*>(), { ".ctor", {}, { ::i2c::type_of<::Org::BouncyCastle::Asn1::DerIA5String*>() } })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::StringW (::Org::BouncyCastle::Asn1::Misc::VerisignCzagExtension::*)()>(&::Org::BouncyCastle::Asn1::Misc::VerisignCzagExtension::ToString)> {
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Asn1::Misc::VerisignCzagExtension*>(),
                                                                                          { ::i2c::class_of<::Org::BouncyCastle::Asn1::Misc::VerisignCzagExtension*>(), 3 }));
    return ___internal_method;
  }
};
...
inline ::StringW Org::BouncyCastle::Asn1::Misc::VerisignCzagExtension::ToString() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Org::BouncyCastle::Asn1::Misc::VerisignCzagExtension*>(), 3 })));
...
inline ::Org::BouncyCastle::Asn1::Misc::VerisignCzagExtension* Org::BouncyCastle::Asn1::Misc::VerisignCzagExtension::New_ctor(::Org::BouncyCastle::Asn1::DerIA5String* str) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Org::BouncyCastle::Asn1::Misc::VerisignCzagExtension*>(str));
}
// Ctor Parameters []
