...
public:
  ...
  /// @brief Method GetInstance, addr 0x33992c0, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x33994ac, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3399448, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Challenge, addr 0x33994bc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerIA5String* get_Challenge();

  /// @brief Method get_SubjectPublicKeyInfo, addr 0x33994b4, size 0x8, virtual false, abstract: false, final false
