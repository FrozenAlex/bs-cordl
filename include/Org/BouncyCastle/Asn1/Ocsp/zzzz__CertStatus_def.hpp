...
public:
  ...
  /// @brief Method GetInstance, addr 0x34568b0, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3456a44, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3456700, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3456784, size 0x118, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* choice);

  /// @brief Method .ctor, addr 0x3456768, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::RevokedInfo* info);

  /// @brief Method .ctor, addr 0x3456778, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t tagNo, ::Org::BouncyCastle::Asn1::Asn1Encodable* value);

  /// @brief Method get_Status, addr 0x3456a3c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Status();

  /// @brief Method get_TagNo, addr 0x3456a34, size 0x8, virtual false, abstract: false, final false
