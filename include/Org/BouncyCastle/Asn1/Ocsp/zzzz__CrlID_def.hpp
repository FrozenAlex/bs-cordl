...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Ocsp::CrlID*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Ocsp::CrlID*, "Org.BouncyCastle.Asn1.Ocsp", "CrlID");
...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x3456e58, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3456ab0, size 0x390, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CrlNum, addr 0x3456e48, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_CrlNum();

  /// @brief Method get_CrlTime, addr 0x3456e50, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_CrlTime();

  /// @brief Method get_CrlUrl, addr 0x3456e40, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Ocsp::CrlID) == 0x28, "Size mismatch!");
