...
public:
  ...
  /// @brief Method GetInstance, addr 0x339e40c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x339e174, size 0x1e8, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Ocsp::ResponderID* GetInstance(::System::Object* obj);

  /// @brief Method GetKeyHash, addr 0x339e434, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x339e578, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x339e35c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* id);

  /// @brief Method .ctor, addr 0x339e3b4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509Name* id);

  /// @brief Method get_Name, addr 0x339e4c0, size 0xb8, virtual true, abstract: false, final false
