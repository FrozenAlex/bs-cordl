...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Ocsp::ResponderID*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Ocsp::ResponderID*, "Org.BouncyCastle.Asn1.Ocsp", "ResponderID");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3458e8c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x3458bf4, size 0x1e8, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Ocsp::ResponderID* GetInstance(::System::Object* obj);

  /// @brief Method GetKeyHash, addr 0x3458eb4, size 0x8c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GetKeyHash();
  ...
  /// @brief Method ToAsn1Object, addr 0x3458ff8, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3458ddc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* id);

  /// @brief Method .ctor, addr 0x3458e34, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509Name* id);

  /// @brief Method get_Name, addr 0x3458f40, size 0xb8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Ocsp::ResponderID) == 0x18, "Size mismatch!");
