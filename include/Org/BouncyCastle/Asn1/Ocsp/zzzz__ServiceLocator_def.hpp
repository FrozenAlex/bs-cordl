...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Ocsp::ServiceLocator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Ocsp::ServiceLocator*, "Org.BouncyCastle.Asn1.Ocsp", "ServiceLocator");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x339f670, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x339f684, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x339f950, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x339f8e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509Name* issuer);

  /// @brief Method .ctor, addr 0x339f8e8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509Name* issuer, ::Org::BouncyCastle::Asn1::Asn1Object* locator);

  /// @brief Method .ctor, addr 0x339f808, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Issuer, addr 0x339f940, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_Issuer();

  /// @brief Method get_Locator, addr 0x339f948, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Ocsp::ServiceLocator) == 0x20, "Size mismatch!");
