...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Oiw::ElGamalParameter*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Oiw::ElGamalParameter*, "Org.BouncyCastle.Asn1.Oiw", "ElGamalParameter");
...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x33a0d74, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33a0bdc, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* p, ::Org::BouncyCastle::Math::BigInteger* g);

  /// @brief Method .ctor, addr 0x33a0c68, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_G, addr 0x33a0d5c, size 0x18, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G();

  /// @brief Method get_P, addr 0x33a0d44, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Oiw::ElGamalParameter) == 0x20, "Size mismatch!");
