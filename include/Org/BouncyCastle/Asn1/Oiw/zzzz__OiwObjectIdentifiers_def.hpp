...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Oiw::OiwObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Oiw::OiwObjectIdentifiers*, "Org.BouncyCastle.Asn1.Oiw", "OiwObjectIdentifiers");
...
public:
  ...
  /// @brief Method .ctor, addr 0x33a118c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Oiw::OiwObjectIdentifiers) == 0x10, "Size mismatch!");
