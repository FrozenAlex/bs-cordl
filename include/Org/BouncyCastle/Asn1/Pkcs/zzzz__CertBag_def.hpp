...
public:
  ...
  /// @brief Method GetInstance, addr 0x345c360, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x345c55c, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345c544, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* certID, ::Org::BouncyCastle::Asn1::Asn1Object* certValue);

  /// @brief Method .ctor, addr 0x345c400, size 0x144, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CertID, addr 0x345c54c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_CertID();

  /// @brief Method get_CertValue, addr 0x345c554, size 0x8, virtual true, abstract: false, final false
