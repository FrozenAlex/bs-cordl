...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Pkcs::ContentInfo*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Pkcs::ContentInfo*, "Org.BouncyCastle.Asn1.Pkcs", "ContentInfo");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x33a1778, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x33a29f4, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33a29dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* contentType, ::Org::BouncyCastle::Asn1::Asn1Encodable* content);

  /// @brief Method .ctor, addr 0x33a287c, size 0x160, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Content, addr 0x33a29ec, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Content();

  /// @brief Method get_ContentType, addr 0x33a29e4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Pkcs::ContentInfo) == 0x20, "Size mismatch!");
