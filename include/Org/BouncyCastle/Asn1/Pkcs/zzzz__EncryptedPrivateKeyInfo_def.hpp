...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Pkcs::EncryptedPrivateKeyInfo*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Pkcs::EncryptedPrivateKeyInfo*, "Org.BouncyCastle.Asn1.Pkcs", "EncryptedPrivateKeyInfo");
...
public:
  ...
  /// @brief Method GetEncryptedData, addr 0x33a3be4, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetEncryptedData();

  /// @brief Method GetInstance, addr 0x33a3a58, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Pkcs::EncryptedPrivateKeyInfo* GetInstance(::System::Object* obj);

  static inline ::Org::BouncyCastle::Asn1::Pkcs::EncryptedPrivateKeyInfo* New_ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algId, ::ArrayW<uint8_t> encoding);

  static inline ::Org::BouncyCastle::Asn1::Pkcs::EncryptedPrivateKeyInfo* New_ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method ToAsn1Object, addr 0x33a3c00, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33a39e8, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algId, ::ArrayW<uint8_t> encoding);

  /// @brief Method .ctor, addr 0x33a3910, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_EncryptionAlgorithm, addr 0x33a3bdc, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Pkcs::EncryptedPrivateKeyInfo) == 0x20, "Size mismatch!");
