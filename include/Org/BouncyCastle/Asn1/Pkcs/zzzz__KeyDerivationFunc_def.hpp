...
public:
  ...
  /// @brief Method .ctor, addr 0x345f2b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* id, ::Org::BouncyCastle::Asn1::Asn1Encodable* parameters);

  /// @brief Method .ctor, addr 0x345f2ac, size 0x4, virtual false, abstract: false, final false
