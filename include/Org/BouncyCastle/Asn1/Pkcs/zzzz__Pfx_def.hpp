...
public:
  ...
  /// @brief Method GetInstance, addr 0x3460b44, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3460cec, size 0x1b4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3460cd4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Pkcs::ContentInfo* contentInfo, ::Org::BouncyCastle::Asn1::Pkcs::MacData* macData);

  /// @brief Method .ctor, addr 0x3460be4, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_AuthSafe, addr 0x3460cdc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Pkcs::ContentInfo* get_AuthSafe();

  /// @brief Method get_MacData, addr 0x3460ce4, size 0x8, virtual false, abstract: false, final false
