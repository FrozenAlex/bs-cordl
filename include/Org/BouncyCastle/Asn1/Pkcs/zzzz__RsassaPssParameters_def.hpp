...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Pkcs::RsassaPssParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Pkcs::RsassaPssParameters*, "Org.BouncyCastle.Asn1.Pkcs", "RsassaPssParameters");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x33aa390, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x33aa78c, size 0x320, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33aa6f4, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33aa760, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33aa514, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HashAlgorithm, addr 0x33aa76c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_HashAlgorithm();

  /// @brief Method get_MaskGenAlgorithm, addr 0x33aa774, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_MaskGenAlgorithm();

  /// @brief Method get_SaltLength, addr 0x33aa77c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_SaltLength();

  /// @brief Method get_TrailerField, addr 0x33aa784, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Pkcs::RsassaPssParameters) == 0x30, "Size mismatch!");
