...
public:
  ...
  /// @brief Method GetInstance, addr 0x3465b34, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x34661f8, size 0x19c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34661b8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3465bd4, size 0x5e4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Certificates, addr 0x34661e0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_Certificates();

  /// @brief Method get_ContentInfo, addr 0x34661d8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Pkcs::ContentInfo* get_ContentInfo();

  /// @brief Method get_Crls, addr 0x34661e8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_Crls();

  /// @brief Method get_DigestAlgorithms, addr 0x34661d0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_DigestAlgorithms();

  /// @brief Method get_SignerInfos, addr 0x34661f0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_SignerInfos();

  /// @brief Method get_Version, addr 0x34661c8, size 0x8, virtual false, abstract: false, final false
