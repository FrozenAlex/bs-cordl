...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Pkcs::SignedData*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Pkcs::SignedData*, "Org.BouncyCastle.Asn1.Pkcs", "SignedData");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x33ab0b4, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x33ab778, size 0x19c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33ab738, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33ab154, size 0x5e4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Certificates, addr 0x33ab760, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_Certificates();

  /// @brief Method get_ContentInfo, addr 0x33ab758, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Pkcs::ContentInfo* get_ContentInfo();

  /// @brief Method get_Crls, addr 0x33ab768, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_Crls();

  /// @brief Method get_DigestAlgorithms, addr 0x33ab750, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_DigestAlgorithms();

  /// @brief Method get_SignerInfos, addr 0x33ab770, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_SignerInfos();

  /// @brief Method get_Version, addr 0x33ab748, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Pkcs::SignedData) == 0x40, "Size mismatch!");
