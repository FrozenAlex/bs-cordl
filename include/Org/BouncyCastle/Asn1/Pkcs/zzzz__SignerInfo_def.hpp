...
public:
  ...
  /// @brief Method GetInstance, addr 0x3466394, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3466c0c, size 0x208, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3466518, size 0x6a8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x3466bc0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AuthenticatedAttributes, addr 0x3466be4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_AuthenticatedAttributes();

  /// @brief Method get_DigestAlgorithm, addr 0x3466bec, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestAlgorithm();

  /// @brief Method get_DigestEncryptionAlgorithm, addr 0x3466bfc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestEncryptionAlgorithm();

  /// @brief Method get_EncryptedDigest, addr 0x3466bf4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_EncryptedDigest();

  /// @brief Method get_IssuerAndSerialNumber, addr 0x3466bdc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Pkcs::IssuerAndSerialNumber* get_IssuerAndSerialNumber();

  /// @brief Method get_UnauthenticatedAttributes, addr 0x3466c04, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_UnauthenticatedAttributes();

  /// @brief Method get_Version, addr 0x3466bd4, size 0x8, virtual false, abstract: false, final false
