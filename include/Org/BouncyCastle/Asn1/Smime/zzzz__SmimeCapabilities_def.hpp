...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Smime::SmimeCapabilities*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Smime::SmimeCapabilities*, "Org.BouncyCastle.Asn1.Smime", "SmimeCapabilities");
...
public:
  ...
  /// @brief Method DoGetCapabilitiesForOid, addr 0x35471d0, size 0x5d0, virtual false, abstract: false, final false
  inline void DoGetCapabilitiesForOid(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capability, ::System::Collections::IList* list);

  /// @brief Method GetCapabilities, addr 0x3547158, size 0x78, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* GetCapabilities(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capability);

  /// @brief Method GetCapabilitiesForOid, addr 0x35477a0, size 0x80, virtual false, abstract: false, final false
  inline ::System::Collections::IList* GetCapabilitiesForOid(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capability);

  /// @brief Method GetInstance, addr 0x3546f64, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3547964, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3547150, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Smime::SmimeCapabilities) == 0x18, "Size mismatch!");
