...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Smime::SmimeCapabilityVector*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Smime::SmimeCapabilityVector*, "Org.BouncyCastle.Asn1.Smime", "SmimeCapabilityVector");
...
public:
  ...
  /// @brief Method AddCapability, addr 0x348db58, size 0x7c, virtual false, abstract: false, final false
  inline void AddCapability(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capability);

  /// @brief Method AddCapability, addr 0x348dd0c, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method AddCapability, addr 0x348dbd4, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1EncodableVector, addr 0x348de14, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x348de1c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Smime::SmimeCapabilityVector) == 0x18, "Size mismatch!");
