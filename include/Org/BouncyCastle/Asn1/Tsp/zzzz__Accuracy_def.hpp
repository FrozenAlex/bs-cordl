...
public:
  ...
  /// @brief Method GetInstance, addr 0x354c7ec, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x354c8a4, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x354c40c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x354c4e0, size 0x30c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Micros, addr 0x354c89c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Micros();

  /// @brief Method get_Millis, addr 0x354c894, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Millis();

  /// @brief Method get_Seconds, addr 0x354c88c, size 0x8, virtual false, abstract: false, final false
