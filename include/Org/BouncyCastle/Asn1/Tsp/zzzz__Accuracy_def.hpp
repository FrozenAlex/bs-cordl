...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Tsp::Accuracy*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Tsp::Accuracy*, "Org.BouncyCastle.Asn1.Tsp", "Accuracy");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3491d6c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3491e24, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x349198c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3491a60, size 0x30c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Micros, addr 0x3491e1c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Micros();

  /// @brief Method get_Millis, addr 0x3491e14, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Millis();

  /// @brief Method get_Seconds, addr 0x3491e0c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Tsp::Accuracy) == 0x28, "Size mismatch!");
