...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Tsp::MessageImprint*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Tsp::MessageImprint*, "Org.BouncyCastle.Asn1.Tsp", "MessageImprint");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_hashedMessage, put = __cordl_internal_set_hashedMessage)) ::ArrayW<uint8_t> hashedMessage;

  /// @brief Method GetHashedMessage, addr 0x354cb7c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetHashedMessage();

  /// @brief Method GetInstance, addr 0x354c9e0, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Tsp::MessageImprint* GetInstance(::System::Object* obj);

  static inline ::Org::BouncyCastle::Asn1::Tsp::MessageImprint* New_ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* hashAlgorithm, ::ArrayW<uint8_t> hashedMessage);

  static inline ::Org::BouncyCastle::Asn1::Tsp::MessageImprint* New_ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method ToAsn1Object, addr 0x354cb84, size 0x11c, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_hashedMessage() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_hashedMessage();

  constexpr void __cordl_internal_set_hashAlgorithm(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* value);

  constexpr void __cordl_internal_set_hashedMessage(::ArrayW<uint8_t> value);

  /// @brief Method .ctor, addr 0x354cb6c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* hashAlgorithm, ::ArrayW<uint8_t> hashedMessage);

  /// @brief Method .ctor, addr 0x354ca80, size 0xec, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_HashAlgorithm, addr 0x354cb74, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<uint8_t> ___hashedMessage;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Tsp::MessageImprint) == 0x20, "Size mismatch!");
