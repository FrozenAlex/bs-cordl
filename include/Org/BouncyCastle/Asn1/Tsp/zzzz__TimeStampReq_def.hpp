...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Tsp::TimeStampReq*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Tsp::TimeStampReq*, "Org.BouncyCastle.Asn1.Tsp", "TimeStampReq");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3492220, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x34926ec, size 0x1e0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3492628, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34922c0, size 0x368, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CertReq, addr 0x34926dc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBoolean* get_CertReq();

  /// @brief Method get_Extensions, addr 0x34926e4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_Extensions();

  /// @brief Method get_MessageImprint, addr 0x34926c4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Tsp::MessageImprint* get_MessageImprint();

  /// @brief Method get_Nonce, addr 0x34926d4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Nonce();

  /// @brief Method get_ReqPolicy, addr 0x34926cc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_ReqPolicy();

  /// @brief Method get_Version, addr 0x34926bc, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Tsp::TimeStampReq) == 0x40, "Size mismatch!");
