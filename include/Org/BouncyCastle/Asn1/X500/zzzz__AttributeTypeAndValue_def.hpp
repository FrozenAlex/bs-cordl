...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X500::AttributeTypeAndValue*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X500::AttributeTypeAndValue*, "Org.BouncyCastle.Asn1.X500", "AttributeTypeAndValue");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3498818, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3498918, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3498734, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x3498900, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* type, ::Org::BouncyCastle::Asn1::Asn1Encodable* value);

  /// @brief Method get_Type, addr 0x3498908, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Type();

  /// @brief Method get_Value, addr 0x3498910, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X500::AttributeTypeAndValue) == 0x20, "Size mismatch!");
