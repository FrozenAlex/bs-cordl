...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X500::Rdn*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X500::Rdn*, "Org.BouncyCastle.Asn1.X500", "Rdn");
...
public:
  ...
  /// @brief Method GetFirst, addr 0x34990a4, size 0x50, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X500::AttributeTypeAndValue* GetFirst();

  /// @brief Method GetInstance, addr 0x3498dc4, size 0x9c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X500::Rdn* GetInstance(::System::Object* obj);

  /// @brief Method GetTypesAndValues, addr 0x34990f4, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x34991ec, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3498fec, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::X500::AttributeTypeAndValue*> aAndVs);

  /// @brief Method .ctor, addr 0x3498f84, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X500::AttributeTypeAndValue* attrTAndV);

  /// @brief Method .ctor, addr 0x3498e60, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid, ::Org::BouncyCastle::Asn1::Asn1Encodable* value);

  /// @brief Method .ctor, addr 0x3498dbc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Set* values);

  /// @brief Method get_Count, addr 0x3499088, size 0x1c, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsMultiValued, addr 0x349905c, size 0x2c, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X500::Rdn) == 0x18, "Size mismatch!");
