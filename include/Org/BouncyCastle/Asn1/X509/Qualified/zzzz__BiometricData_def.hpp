...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::Qualified::BiometricData*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::Qualified::BiometricData*, "Org.BouncyCastle.Asn1.X509.Qualified", "BiometricData");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3553c74, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35540a4, size 0x1ac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3553dd8, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x3554078, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x355406c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::Qualified::TypeOfBiometricData* typeOfBiometricData, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* hashAlgorithm,
                    ::Org::BouncyCastle::Asn1::Asn1OctetString* biometricDataHash, ::Org::BouncyCastle::Asn1::DerIA5String* sourceDataUri);

  /// @brief Method get_BiometricDataHash, addr 0x3554094, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_BiometricDataHash();

  /// @brief Method get_HashAlgorithm, addr 0x355408c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_HashAlgorithm();

  /// @brief Method get_SourceDataUri, addr 0x355409c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerIA5String* get_SourceDataUri();

  /// @brief Method get_TypeOfBiometricData, addr 0x3554084, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::Qualified::BiometricData) == 0x30, "Size mismatch!");
