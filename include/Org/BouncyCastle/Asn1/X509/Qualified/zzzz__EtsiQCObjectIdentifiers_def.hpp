...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::Qualified::EtsiQCObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::Qualified::EtsiQCObjectIdentifiers*, "Org.BouncyCastle.Asn1.X509.Qualified", "EtsiQCObjectIdentifiers");
...
public:
  ...
  /// @brief Method .ctor, addr 0x34999b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::Qualified::EtsiQCObjectIdentifiers) == 0x10, "Size mismatch!");
