...
public:
  ...
  /// @brief Method GetInstance, addr 0x349d05c, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::AttributeCertificate* GetInstance(::System::Object* obj);

  /// @brief Method GetSignatureOctets, addr 0x349d410, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x349d42c, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x349d268, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x349d0fc, size 0x16c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_ACInfo, addr 0x349d3f8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AttributeCertificateInfo* get_ACInfo();

  /// @brief Method get_SignatureAlgorithm, addr 0x349d400, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_SignatureAlgorithm();

  /// @brief Method get_SignatureValue, addr 0x349d408, size 0x8, virtual false, abstract: false, final false
