...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::CertPolicyID*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::CertPolicyID*, "Org.BouncyCastle.Asn1.X509", "CertPolicyID");
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::CertPolicyID) == 0x20, "Size mismatch!");
