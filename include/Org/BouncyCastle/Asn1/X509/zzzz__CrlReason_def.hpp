...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::CrlReason*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::CrlReason*, "Org.BouncyCastle.Asn1.X509", "CrlReason");
...
public:
  ...
  __declspec(property(get = getStaticF_ReasonString, put = setStaticF_ReasonString)) ::ArrayW<::StringW> ReasonString;
  ...
  /// @brief Method ToString, addr 0x359bb7c, size 0xdc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x359bafc, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerEnumerated* reason);

  /// @brief Method .ctor, addr 0x359ba90, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(int32_t reason);

  static inline ::ArrayW<::StringW> getStaticF_ReasonString();

  static inline void setStaticF_ReasonString(::ArrayW<::StringW> value);
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::CrlReason) == 0x20, "Size mismatch!");
