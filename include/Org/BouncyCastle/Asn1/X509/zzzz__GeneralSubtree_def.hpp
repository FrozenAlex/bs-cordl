...
public:
  ...
  /// @brief Method GetInstance, addr 0x35a00c4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x35a0144, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35a0278, size 0x18c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a0074, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralName* baseName);

  /// @brief Method .ctor, addr 0x359ffc0, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x359fd8c, size 0x234, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Base, addr 0x35a01e4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_Base();

  /// @brief Method get_Maximum, addr 0x35a0264, size 0x14, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Maximum();

  /// @brief Method get_Minimum, addr 0x35a01ec, size 0x78, virtual false, abstract: false, final false
