...
public:
  ...
  /// @brief Method GetInstance, addr 0x35a0404, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35a0920, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a08b8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::IssuerSerial* baseCertificateID);

  /// @brief Method .ctor, addr 0x35a08c8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::IssuerSerial* baseCertificateID, int32_t version);

  /// @brief Method .ctor, addr 0x35a08dc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralNames* entityName);

  /// @brief Method .ctor, addr 0x35a08ec, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralNames* entityName, int32_t version);

  /// @brief Method .ctor, addr 0x35a08f8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::ObjectDigestInfo* objectDigestInfo);

  /// @brief Method .ctor, addr 0x35a0604, size 0x1c4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x35a07c8, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* tagObj);

  /// @brief Method get_BaseCertificateID, addr 0x35a0908, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::IssuerSerial* get_BaseCertificateID();

  /// @brief Method get_EntityName, addr 0x35a0910, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralNames* get_EntityName();

  /// @brief Method get_ObjectDigestInfo, addr 0x35a0918, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::ObjectDigestInfo* get_ObjectDigestInfo();

  /// @brief Method get_Version, addr 0x35a08d4, size 0x8, virtual false, abstract: false, final false
