...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::IetfAttrSyntax*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::IetfAttrSyntax*, "Org.BouncyCastle.Asn1.X509", "IetfAttrSyntax");
...
public:
  ...
  /// @brief Method GetValues, addr 0x365bb68, size 0x368, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*> GetValues();

  static inline ::Org::BouncyCastle::Asn1::X509::IetfAttrSyntax* New_ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method ToAsn1Object, addr 0x365bed0, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x365b4e4, size 0x674, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_PolicyAuthority, addr 0x365bb58, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralNames* get_PolicyAuthority();

  /// @brief Method get_ValueType, addr 0x365bb60, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::IetfAttrSyntax) == 0x28, "Size mismatch!");
