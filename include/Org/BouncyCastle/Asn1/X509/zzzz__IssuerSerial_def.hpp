...
public:
  ...
  /// @brief Method GetInstance, addr 0x35a0890, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x35a1528, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35a1874, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a1854, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralNames* issuer, ::Org::BouncyCastle::Asn1::DerInteger* serial);

  /// @brief Method .ctor, addr 0x35a16ac, size 0x1a8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Issuer, addr 0x35a185c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralNames* get_Issuer();

  /// @brief Method get_IssuerUid, addr 0x35a186c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_IssuerUid();

  /// @brief Method get_Serial, addr 0x35a1864, size 0x8, virtual false, abstract: false, final false
