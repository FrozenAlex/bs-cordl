...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::IssuerSerial*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::IssuerSerial*, "Org.BouncyCastle.Asn1.X509", "IssuerSerial");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x365b310, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x365bfa8, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x365c2f4, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x365c2d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralNames* issuer, ::Org::BouncyCastle::Asn1::DerInteger* serial);

  /// @brief Method .ctor, addr 0x365c12c, size 0x1a8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Issuer, addr 0x365c2dc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralNames* get_Issuer();

  /// @brief Method get_IssuerUid, addr 0x365c2ec, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_IssuerUid();

  /// @brief Method get_Serial, addr 0x365c2e4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::IssuerSerial) == 0x28, "Size mismatch!");
