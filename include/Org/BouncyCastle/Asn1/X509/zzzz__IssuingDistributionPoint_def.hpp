...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::IssuingDistributionPoint*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::IssuingDistributionPoint*, "Org.BouncyCastle.Asn1.X509", "IssuingDistributionPoint");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x35a19f4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x35a1a08, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35a2180, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToString, addr 0x35a2188, size 0x2ec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a1e4c, size 0x304, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a1b8c, size 0x2c0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method appendObject, addr 0x35a2474, size 0xe4, virtual false, abstract: false, final false
  inline void appendObject(::System::Text::StringBuilder* buf, ::StringW sep, ::StringW name, ::StringW val);

  /// @brief Method get_DistributionPoint, addr 0x35a2170, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::DistributionPointName* get_DistributionPoint();

  /// @brief Method get_IsIndirectCrl, addr 0x35a2160, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsIndirectCrl();

  /// @brief Method get_OnlyContainsAttributeCerts, addr 0x35a2168, size 0x8, virtual false, abstract: false, final false
  inline bool get_OnlyContainsAttributeCerts();

  /// @brief Method get_OnlyContainsCACerts, addr 0x35a2158, size 0x8, virtual false, abstract: false, final false
  inline bool get_OnlyContainsCACerts();

  /// @brief Method get_OnlyContainsUserCerts, addr 0x35a2150, size 0x8, virtual false, abstract: false, final false
  inline bool get_OnlyContainsUserCerts();

  /// @brief Method get_OnlySomeReasons, addr 0x35a2178, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::IssuingDistributionPoint) == 0x38, "Size mismatch!");
