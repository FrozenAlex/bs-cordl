...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::KeyPurposeID*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::KeyPurposeID*, "Org.BouncyCastle.Asn1.X509", "KeyPurposeID");
...
public:
  ...
  /// @brief Method .ctor, addr 0x35a2558, size 0x6c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::KeyPurposeID) == 0x20, "Size mismatch!");
