...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::NameConstraints*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::NameConstraints*, "Org.BouncyCastle.Asn1.X509", "NameConstraints");
...
public:
  ...
  /// @brief Method CreateSequence, addr 0x35a3144, size 0x2b4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerSequence* CreateSequence(::System::Collections::IList* subtrees);

  /// @brief Method GetInstance, addr 0x35a2c78, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35a3408, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a3108, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* permitted, ::System::Collections::ArrayList* excluded);

  /// @brief Method .ctor, addr 0x35a310c, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* permitted, ::System::Collections::IList* excluded);

  /// @brief Method .ctor, addr 0x35a2dfc, size 0x30c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_ExcludedSubtrees, addr 0x35a3400, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Sequence* get_ExcludedSubtrees();

  /// @brief Method get_PermittedSubtrees, addr 0x35a33f8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::NameConstraints) == 0x20, "Size mismatch!");
