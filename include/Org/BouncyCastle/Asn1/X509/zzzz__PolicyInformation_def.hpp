...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::PolicyInformation*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::PolicyInformation*, "Org.BouncyCastle.Asn1.X509", "PolicyInformation");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x365f360, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x365f410, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x365f350, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* policyIdentifier);

  /// @brief Method .ctor, addr 0x365f358, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x365f1c4, size 0x18c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_PolicyIdentifier, addr 0x365f400, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_PolicyIdentifier();

  /// @brief Method get_PolicyQualifiers, addr 0x365f408, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::PolicyInformation) == 0x20, "Size mismatch!");
