...
public:
  ...
  /// @brief Method GetInstance, addr 0x365fe50, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x365ff00, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x365fc50, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::StringW cps);

  /// @brief Method .ctor, addr 0x365fc48, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x365fcf4, size 0x15c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_PolicyQualifierId, addr 0x365fef0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_PolicyQualifierId();

  /// @brief Method get_Qualifier, addr 0x365fef8, size 0x8, virtual true, abstract: false, final false
