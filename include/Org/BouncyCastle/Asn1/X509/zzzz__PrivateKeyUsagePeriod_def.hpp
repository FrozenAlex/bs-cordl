...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::PrivateKeyUsagePeriod*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::PrivateKeyUsagePeriod*, "Org.BouncyCastle.Asn1.X509", "PrivateKeyUsagePeriod");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x35a5570, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35a5a58, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a5764, size 0x2e4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_NotAfter, addr 0x35a5a50, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_NotAfter();

  /// @brief Method get_NotBefore, addr 0x35a5a48, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::PrivateKeyUsagePeriod) == 0x20, "Size mismatch!");
