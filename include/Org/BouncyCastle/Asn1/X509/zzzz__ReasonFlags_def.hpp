...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::ReasonFlags*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::ReasonFlags*, "Org.BouncyCastle.Asn1.X509", "ReasonFlags");
...
public:
  ...
  /// @brief Method .ctor, addr 0x359c86c, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerBitString* reasons);

  /// @brief Method .ctor, addr 0x35a5b18, size 0x6c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::ReasonFlags) == 0x20, "Size mismatch!");
