...
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::Target*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::Target_Choice, "Org.BouncyCastle.Asn1.X509", "Target/Choice");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::Target*, "Org.BouncyCastle.Asn1.X509", "Target");
// Dependencies
namespace Org::BouncyCastle::Asn1::X509 {
// Is value type: true
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::Target_Choice) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x35a7f14, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35a821c, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a8098, size 0x100, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* tagObj);

  /// @brief Method .ctor, addr 0x35a8198, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::Target_Choice type, ::Org::BouncyCastle::Asn1::X509::GeneralName* name);

  /// @brief Method get_TargetGroup, addr 0x35a820c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_TargetGroup();

  /// @brief Method get_TargetName, addr 0x35a8214, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::Target) == 0x20, "Size mismatch!");
