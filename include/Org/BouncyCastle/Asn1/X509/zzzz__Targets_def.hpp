...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::Targets*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::Targets*, "Org.BouncyCastle.Asn1.X509", "Targets");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x35a8580, size 0x17c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::Targets* GetInstance(::System::Object* obj);

  /// @brief Method GetTargets, addr 0x35a8848, size 0x114, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::X509::Target*> GetTargets();

  static inline ::Org::BouncyCastle::Asn1::X509::Targets* New_ctor(::ArrayW<::Org::BouncyCastle::Asn1::X509::Target*> targets);

  static inline ::Org::BouncyCastle::Asn1::X509::Targets* New_ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* targets);

  /// @brief Method ToAsn1Object, addr 0x35a895c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a87d0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::X509::Target*> targets);

  /// @brief Method .ctor, addr 0x35a8840, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::Targets) == 0x18, "Size mismatch!");
