...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X9::DHDomainParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X9::DHDomainParameters*, "Org.BouncyCastle.Asn1.X9", "DHDomainParameters");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3672810, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x3672824, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X9::DHDomainParameters* GetInstance(::System::Object* obj);

  /// @brief Method GetNext, addr 0x3672c2c, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3672f30, size 0x1d8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3672b80, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36729a8, size 0x1d8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_G, addr 0x3672f10, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_G();

  /// @brief Method get_J, addr 0x3672f20, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_J();

  /// @brief Method get_P, addr 0x3672f08, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_P();

  /// @brief Method get_Q, addr 0x3672f18, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Q();

  /// @brief Method get_ValidationParms, addr 0x3672f28, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X9::DHDomainParameters) == 0x38, "Size mismatch!");
