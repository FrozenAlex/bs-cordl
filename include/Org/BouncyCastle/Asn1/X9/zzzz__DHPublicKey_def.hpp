...
public:
  ...
  /// @brief Method GetInstance, addr 0x35b8688, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x35b869c, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35b8878, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b8818, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerInteger* y);

  /// @brief Method get_Y, addr 0x35b8870, size 0x8, virtual false, abstract: false, final false
