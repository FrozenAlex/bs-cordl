...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X9::DHValidationParms*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X9::DHValidationParms*, "Org.BouncyCastle.Asn1.X9", "DHValidationParms");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3673300, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x3672d84, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3673508, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3673478, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerBitString* seed, ::Org::BouncyCastle::Asn1::DerInteger* pgenCounter);

  /// @brief Method .ctor, addr 0x3673314, size 0x164, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_PgenCounter, addr 0x3673500, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_PgenCounter();

  /// @brief Method get_Seed, addr 0x36734f8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X9::DHValidationParms) == 0x20, "Size mismatch!");
