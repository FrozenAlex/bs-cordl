...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X9::KeySpecificInfo*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X9::KeySpecificInfo*, "Org.BouncyCastle.Asn1.X9", "KeySpecificInfo");
...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x36741a8, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3673ec8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* algorithm, ::Org::BouncyCastle::Asn1::Asn1OctetString* counter);

  /// @brief Method .ctor, addr 0x3673ed0, size 0x2c8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Algorithm, addr 0x3674198, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Algorithm();

  /// @brief Method get_Counter, addr 0x36741a0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X9::KeySpecificInfo) == 0x20, "Size mismatch!");
