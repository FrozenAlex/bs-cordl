...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Asn1Exception*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Asn1Exception*, "Org.BouncyCastle.Asn1", "Asn1Exception");
...
public:
  ...
  /// @brief Method .ctor, addr 0x35c2dc4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35c2dcc, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35c2df0, size 0x24, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Asn1Exception) == 0x90, "Size mismatch!");
