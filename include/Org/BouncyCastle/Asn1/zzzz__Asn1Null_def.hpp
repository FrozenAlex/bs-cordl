...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Asn1Null*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Asn1Null*, "Org.BouncyCastle.Asn1", "Asn1Null");
...
public:
  ...
  /// @brief Method ToString, addr 0x3680dcc, size 0x44, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x3680dc8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Asn1Null) == 0x10, "Size mismatch!");
