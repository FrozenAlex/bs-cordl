...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Asn1OutputStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Asn1OutputStream*, "Org.BouncyCastle.Asn1", "Asn1OutputStream");
...
public:
  ...
  /// @brief Method WriteObject, addr 0x36818b4, size 0x16c, virtual true, abstract: false, final false
  inline void WriteObject(::System::Object* obj);

  /// @brief Method .ctor, addr 0x36818b0, size 0x4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Asn1OutputStream) == 0x30, "Size mismatch!");
