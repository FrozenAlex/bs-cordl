...
public:
  ...
  /// @brief Method .ctor, addr 0x3681a20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3681a28, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3681a4c, size 0x24, virtual false, abstract: false, final false
