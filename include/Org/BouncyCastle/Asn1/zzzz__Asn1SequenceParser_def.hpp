...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Asn1SequenceParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Asn1SequenceParser*, "Org.BouncyCastle.Asn1", "Asn1SequenceParser");
// Dependencies
namespace Org::BouncyCastle::Asn1 {
// Is value type: false
