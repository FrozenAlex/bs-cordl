...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Asn1TaggedObjectParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Asn1TaggedObjectParser*, "Org.BouncyCastle.Asn1", "Asn1TaggedObjectParser");
// Dependencies
namespace Org::BouncyCastle::Asn1 {
// Is value type: false
