...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x3684794, size 0x11c, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Asn1GetHashCode, addr 0x36848b0, size 0x2c, virtual true, abstract: false, final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method GetInstance, addr 0x3684580, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x36845f4, size 0x100, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1TaggedObject* GetInstance(::System::Object* obj);

  /// @brief Method GetObject, addr 0x3674668, size 0x18, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* GetObject();

  /// @brief Method GetObjectParser, addr 0x36848f4, size 0x124, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* GetObjectParser(int32_t tag, bool isExplicit);

  /// @brief Method IsConstructed, addr 0x3684420, size 0x160, virtual false, abstract: false, final false
  static inline bool IsConstructed(bool isExplicit, ::Org::BouncyCastle::Asn1::Asn1Object* obj);

  /// @brief Method IsEmpty, addr 0x36848ec, size 0x8, virtual false, abstract: false, final false
  inline bool IsEmpty();

  /// @brief Method IsExplicit, addr 0x36848e4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x3684a18, size 0x170, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3684708, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(bool explicitly, int32_t tagNo, ::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method .ctor, addr 0x36846f4, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t tagNo, ::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method get_TagNo, addr 0x36848dc, size 0x8, virtual true, abstract: false, final true
