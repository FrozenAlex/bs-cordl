...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Asn1Tags*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Asn1Tags*, "Org.BouncyCastle.Asn1", "Asn1Tags");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3684b88, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Asn1Tags) == 0x10, "Size mismatch!");
