...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::BerApplicationSpecificParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::BerApplicationSpecificParser*, "Org.BouncyCastle.Asn1", "BerApplicationSpecificParser");
...
public:
  ...
  /// @brief Method ReadObject, addr 0x35ca87c, size 0x1c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x35c5404, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x35c53f8, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::BerApplicationSpecificParser) == 0x20, "Size mismatch!");
