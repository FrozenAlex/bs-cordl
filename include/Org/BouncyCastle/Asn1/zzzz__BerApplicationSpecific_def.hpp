...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::BerApplicationSpecific*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::BerApplicationSpecific*, "Org.BouncyCastle.Asn1", "BerApplicationSpecific");
...
public:
  ...
  /// @brief Method .ctor, addr 0x35ca878, size 0x4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::BerApplicationSpecific) == 0x20, "Size mismatch!");
