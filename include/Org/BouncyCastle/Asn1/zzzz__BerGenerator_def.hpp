...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::BerGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::BerGenerator*, "Org.BouncyCastle.Asn1", "BerGenerator");
...
public:
  ...
  /// @brief Method AddObject, addr 0x36855dc, size 0x84, virtual true, abstract: false, final false
  inline void AddObject(::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method Close, addr 0x368566c, size 0x4, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method GetRawOutputStream, addr 0x3685664, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteBerBody, addr 0x36857a4, size 0x14, virtual false, abstract: false, final false
  inline void WriteBerBody(::System::IO::Stream* contentStream);

  /// @brief Method WriteBerEnd, addr 0x3685670, size 0x98, virtual false, abstract: false, final false
  inline void WriteBerEnd();

  /// @brief Method WriteBerHeader, addr 0x368574c, size 0x58, virtual false, abstract: false, final false
  inline void WriteBerHeader(int32_t tag);

  /// @brief Method WriteHdr, addr 0x3685708, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36855b8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* outStream);

  /// @brief Method .ctor, addr 0x36855c4, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::BerGenerator) == 0x20, "Size mismatch!");
