...
public:
  ...
  /// @brief Method GetOctetStream, addr 0x35cc438, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method ToAsn1Object, addr 0x35c5590, size 0x15c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x35c5588, size 0x8, virtual false, abstract: false, final false
