...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::BerOctetStringParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::BerOctetStringParser*, "Org.BouncyCastle.Asn1", "BerOctetStringParser");
...
public:
  ...
  /// @brief Method GetOctetStream, addr 0x3686eb8, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method ToAsn1Object, addr 0x3680010, size 0x15c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3680008, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::BerOctetStringParser) == 0x18, "Size mismatch!");
