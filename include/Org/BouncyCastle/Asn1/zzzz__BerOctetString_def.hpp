...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::BerOctetString*);
MARK_REF_T(::Org::BouncyCastle::Asn1::BerOctetString_ChunkEnumerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::BerOctetString*, "Org.BouncyCastle.Asn1", "BerOctetString");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::BerOctetString_ChunkEnumerator*, "Org.BouncyCastle.Asn1", "BerOctetString/ChunkEnumerator");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_octets, put = __cordl_internal_set_octets)) ::ArrayW<uint8_t> octets;

  /// @brief Convert operator to "::System::Collections::IEnumerator"
  constexpr operator ::System::Collections::IEnumerator*() noexcept;

  /// @brief Method MoveNext, addr 0x3686690, size 0x12c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::Org::BouncyCastle::Asn1::BerOctetString_ChunkEnumerator* New_ctor(::ArrayW<uint8_t> octets, int32_t chunkSize);

  /// @brief Method Reset, addr 0x36867bc, size 0xc, virtual true, abstract: false, final true
  inline void Reset();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_octets() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_octets();
  ...
  constexpr void __cordl_internal_set_octets(::ArrayW<uint8_t> value);

  /// @brief Method .ctor, addr 0x3686218, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> octets, int32_t chunkSize);

  /// @brief Method get_Current, addr 0x368664c, size 0x44, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::BerOctetString_ChunkEnumerator) == 0x30, "Size mismatch!");

} // namespace Org::BouncyCastle::Asn1
// Dependencies Org.BouncyCastle.Asn1.Asn1OctetString, Org.BouncyCastle.Asn1.DerOctetString
namespace Org::BouncyCastle::Asn1 {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_octs, put = __cordl_internal_set_octs)) ::ArrayW<::Org::BouncyCastle::Asn1::Asn1OctetString*> octs;

  /// @brief Convert operator to "::System::Collections::IEnumerable"
  constexpr operator ::System::Collections::IEnumerable*() noexcept;

  /// @brief Method Encode, addr 0x3686230, size 0x3cc, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method FromSequence, addr 0x3680efc, size 0x124, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::BerOctetString* FromSequence(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method GetEnumerator, addr 0x368619c, size 0x7c, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method GetObjects, addr 0x368622c, size 0x4, virtual false, abstract: false, final false
  ...
  static inline ::Org::BouncyCastle::Asn1::BerOctetString* New_ctor(::ArrayW<::Org::BouncyCastle::Asn1::Asn1OctetString*> octs, int32_t chunkSize);

  static inline ::Org::BouncyCastle::Asn1::BerOctetString* New_ctor(::ArrayW<uint8_t> str);

  static inline ::Org::BouncyCastle::Asn1::BerOctetString* New_ctor(::ArrayW<uint8_t> str, int32_t chunkSize);

  static inline ::Org::BouncyCastle::Asn1::BerOctetString* New_ctor(::ArrayW<uint8_t> str, ::ArrayW<::Org::BouncyCastle::Asn1::Asn1OctetString*> octs, int32_t chunkSize);

  /// @brief Method ToBytes, addr 0x3685d00, size 0xe0, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> ToBytes(::ArrayW<::Org::BouncyCastle::Asn1::Asn1OctetString*> octs);

  /// @brief Method ToOctetStringArray, addr 0x3685de0, size 0x1f8, virtual false, abstract: false, final false
  static inline ::ArrayW<::Org::BouncyCastle::Asn1::Asn1OctetString*> ToOctetStringArray(::System::Collections::IEnumerable* e);

  constexpr int32_t const& __cordl_internal_get_chunkSize() const;

  constexpr int32_t& __cordl_internal_get_chunkSize();

  constexpr ::ArrayW<::Org::BouncyCastle::Asn1::Asn1OctetString*> const& __cordl_internal_get_octs() const;

  constexpr ::ArrayW<::Org::BouncyCastle::Asn1::Asn1OctetString*>& __cordl_internal_get_octs();

  constexpr void __cordl_internal_set_chunkSize(int32_t value);

  constexpr void __cordl_internal_set_octs(::ArrayW<::Org::BouncyCastle::Asn1::Asn1OctetString*> value);

  /// @brief Method .ctor, addr 0x3685fd8, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* e);

  /// @brief Method .ctor, addr 0x367e8dc, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Asn1OctetString*> octs);

  /// @brief Method .ctor, addr 0x36860f0, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Asn1OctetString*> octs, int32_t chunkSize);

  /// @brief Method .ctor, addr 0x3686048, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> str);

  /// @brief Method .ctor, addr 0x36860c8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> str, int32_t chunkSize);

  /// @brief Method .ctor, addr 0x3686170, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> str, ::ArrayW<::Org::BouncyCastle::Asn1::Asn1OctetString*> octs, int32_t chunkSize);
...
public:
  ...
  ::ArrayW<::Org::BouncyCastle::Asn1::Asn1OctetString*> ___octs;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::BerOctetString) == 0x28, "Size mismatch!");
