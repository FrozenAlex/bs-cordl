...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::BerOutputStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::BerOutputStream*, "Org.BouncyCastle.Asn1", "BerOutputStream");
...
public:
  ...
  /// @brief Method WriteObject, addr 0x35cc4cc, size 0x16c, virtual true, abstract: false, final false
  inline void WriteObject(::System::Object* obj);

  /// @brief Method .ctor, addr 0x35cabe0, size 0x4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::BerOutputStream) == 0x30, "Size mismatch!");
