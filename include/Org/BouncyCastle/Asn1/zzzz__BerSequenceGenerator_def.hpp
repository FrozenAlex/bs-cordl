...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::BerSequenceGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::BerSequenceGenerator*, "Org.BouncyCastle.Asn1", "BerSequenceGenerator");
...
public:
  ...
  /// @brief Method .ctor, addr 0x35ccf80, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* outStream);

  /// @brief Method .ctor, addr 0x35ccf94, size 0x1c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::BerSequenceGenerator) == 0x20, "Size mismatch!");
