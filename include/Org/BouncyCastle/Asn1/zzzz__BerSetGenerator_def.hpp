...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::BerSetGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::BerSetGenerator*, "Org.BouncyCastle.Asn1", "BerSetGenerator");
...
public:
  ...
  /// @brief Method .ctor, addr 0x35cdb8c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* outStream);

  /// @brief Method .ctor, addr 0x35cdba0, size 0x1c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::BerSetGenerator) == 0x20, "Size mismatch!");
