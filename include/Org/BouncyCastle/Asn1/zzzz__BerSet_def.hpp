...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::BerSet*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::BerSet*, "Org.BouncyCastle.Asn1", "BerSet");
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::BerSet) == 0x18, "Size mismatch!");
