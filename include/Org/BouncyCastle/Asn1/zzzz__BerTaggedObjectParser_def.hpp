...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::BerTaggedObjectParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::BerTaggedObjectParser*, "Org.BouncyCastle.Asn1", "BerTaggedObjectParser");
...
public:
  ...
  /// @brief Method GetObjectParser, addr 0x35ce410, size 0x94, virtual true, abstract: false, final true
  ...
  /// @brief Method ToAsn1Object, addr 0x35c5490, size 0xf8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x35ce36c, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(int32_t baseTag, int32_t tagNumber, ::System::IO::Stream* contentStream);

  /// @brief Method .ctor, addr 0x35c5480, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(bool constructed, int32_t tagNumber, ::Org::BouncyCastle::Asn1::Asn1StreamParser* parser);

  /// @brief Method get_IsConstructed, addr 0x35ce400, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsConstructed();

  /// @brief Method get_TagNo, addr 0x35ce408, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::BerTaggedObjectParser) == 0x20, "Size mismatch!");
