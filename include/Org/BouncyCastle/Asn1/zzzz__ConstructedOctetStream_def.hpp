...
public:
  ...
  /// @brief Method GetNextParser, addr 0x35ce990, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x35ce7d0, size 0x1c0, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadByte, addr 0x35cea94, size 0x168, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35cc4a0, size 0x2c, virtual false, abstract: false, final false
