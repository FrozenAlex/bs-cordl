...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x34585ac, size 0xd0, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Asn1GetHashCode, addr 0x345867c, size 0x60, virtual true, abstract: false, final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method Encode, addr 0x345858c, size 0x20, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method FromOctetString, addr 0x3457ef4, size 0x1b4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerEnumerated* FromOctetString(::ArrayW<uint8_t> enc);

  /// @brief Method GetInstance, addr 0x3457db0, size 0x144, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerEnumerated* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool isExplicit);

  /// @brief Method GetInstance, addr 0x3457b10, size 0xec, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerEnumerated* GetInstance(::System::Object* obj);

  /// @brief Method HasValue, addr 0x3458494, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3458308, size 0x128, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> bytes);

  /// @brief Method .ctor, addr 0x3458270, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* val);

  /// @brief Method .ctor, addr 0x34580a8, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(int32_t val);

  /// @brief Method .ctor, addr 0x345818c, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(int64_t val);

  static inline ::ArrayW<::Org::BouncyCastle::Asn1::DerEnumerated*> getStaticF_cache();

  /// @brief Method get_IntValueExact, addr 0x345850c, size 0x80, virtual false, abstract: false, final false
  inline int32_t get_IntValueExact();

  /// @brief Method get_Value, addr 0x3458430, size 0x64, virtual false, abstract: false, final false
