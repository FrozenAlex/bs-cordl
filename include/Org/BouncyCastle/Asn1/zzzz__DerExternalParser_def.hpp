...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::DerExternalParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::DerExternalParser*, "Org.BouncyCastle.Asn1", "DerExternalParser");
...
public:
  ...
  /// @brief Method ReadObject, addr 0x368abc4, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x368abe0, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3680268, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::DerExternalParser) == 0x18, "Size mismatch!");
