...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::DerNumericString*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::DerNumericString*, "Org.BouncyCastle.Asn1", "DerNumericString");
...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x368cb44, size 0xa8, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Encode, addr 0x368cb14, size 0x30, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method GetInstance, addr 0x368c89c, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x368c7b0, size 0xec, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerNumericString* GetInstance(::System::Object* obj);

  /// @brief Method GetOctets, addr 0x368cb08, size 0xc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetOctets();

  /// @brief Method GetString, addr 0x368cb00, size 0x8, virtual true, abstract: false, final false
  inline ::StringW GetString();

  /// @brief Method IsNumericString, addr 0x368ca70, size 0x90, virtual false, abstract: false, final false
  static inline bool IsNumericString(::StringW str);

  static inline ::Org::BouncyCastle::Asn1::DerNumericString* New_ctor(::ArrayW<uint8_t> str);
  ...
  /// @brief Method .ctor, addr 0x3680bf4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> str);

  /// @brief Method .ctor, addr 0x368ca68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW str);

  /// @brief Method .ctor, addr 0x368c9a4, size 0xc4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::DerNumericString) == 0x18, "Size mismatch!");
