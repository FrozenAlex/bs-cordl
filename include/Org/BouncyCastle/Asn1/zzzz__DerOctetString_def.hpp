...
public:
  // Declarations
  /// @brief Method Encode, addr 0x35cb1f4, size 0x1c, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method Encode, addr 0x35cb210, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35cb184, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method .ctor, addr 0x35cb0cc, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::IAsn1Convertible* obj);

  /// @brief Method .ctor, addr 0x35c0f54, size 0x4, virtual false, abstract: false, final false
