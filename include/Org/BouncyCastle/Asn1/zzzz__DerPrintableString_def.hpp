...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x35d26b4, size 0xa8, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Encode, addr 0x35d2684, size 0x30, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method GetInstance, addr 0x35d23c0, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x35d22d4, size 0xec, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerPrintableString* GetInstance(::System::Object* obj);

  /// @brief Method GetOctets, addr 0x35d2678, size 0xc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetOctets();

  /// @brief Method GetString, addr 0x35d2670, size 0x8, virtual true, abstract: false, final false
  inline ::StringW GetString();

  /// @brief Method IsPrintableString, addr 0x35d2594, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35c619c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> str);

  /// @brief Method .ctor, addr 0x35d258c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW str);

  /// @brief Method .ctor, addr 0x35d24c8, size 0xc4, virtual false, abstract: false, final false
