...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::DerSequenceParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::DerSequenceParser*, "Org.BouncyCastle.Asn1", "DerSequenceParser");
...
public:
  ...
  /// @brief Method ReadObject, addr 0x368d3a0, size 0x1c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x368d3bc, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3683c48, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::DerSequenceParser) == 0x18, "Size mismatch!");
