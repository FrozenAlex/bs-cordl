...
public:
  ...
  /// @brief Method Encode, addr 0x35cc63c, size 0x390, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method FromVector, addr 0x35c4d3c, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35cc638, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35c72c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Encodable* element);

  /// @brief Method .ctor, addr 0x35b9f44, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1EncodableVector* elementVector);

  /// @brief Method .ctor, addr 0x35b9818, size 0x4, virtual false, abstract: false, final false
