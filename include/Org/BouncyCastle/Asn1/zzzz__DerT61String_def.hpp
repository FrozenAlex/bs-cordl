...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::DerT61String*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::DerT61String*, "Org.BouncyCastle.Asn1", "DerT61String");
...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x368d910, size 0xa8, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Encode, addr 0x368d8d4, size 0x30, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method GetInstance, addr 0x368d770, size 0x104, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerT61String* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool isExplicit);

  /// @brief Method GetInstance, addr 0x368d684, size 0xec, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerT61String* GetInstance(::System::Object* obj);

  /// @brief Method GetOctets, addr 0x368d904, size 0xc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetOctets();

  /// @brief Method GetString, addr 0x368d8cc, size 0x8, virtual true, abstract: false, final false
  inline ::StringW GetString();

  static inline ::Org::BouncyCastle::Asn1::DerT61String* New_ctor(::ArrayW<uint8_t> str);
  ...
  /// @brief Method .ctor, addr 0x3680c44, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> str);

  /// @brief Method .ctor, addr 0x368d874, size 0x58, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::DerT61String) == 0x18, "Size mismatch!");
