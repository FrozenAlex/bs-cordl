...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::DerUniversalString*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::DerUniversalString*, "Org.BouncyCastle.Asn1", "DerUniversalString");
...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x368dddc, size 0xd0, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Encode, addr 0x368ddc0, size 0x1c, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method GetInstance, addr 0x368daa4, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x368d9b8, size 0xec, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerUniversalString* GetInstance(::System::Object* obj);

  /// @brief Method GetOctets, addr 0x368dd48, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetOctets();

  /// @brief Method GetString, addr 0x368dbb0, size 0x198, virtual true, abstract: false, final false
  inline ::StringW GetString();

  static inline ::Org::BouncyCastle::Asn1::DerUniversalString* New_ctor(::ArrayW<uint8_t> str);
  ...
  /// @brief Method .ctor, addr 0x3680c68, size 0x58, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::DerUniversalString) == 0x18, "Size mismatch!");
