...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x368ebe4, size 0xa8, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Encode, addr 0x368ec8c, size 0x50, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method GetInstance, addr 0x368ea90, size 0xf4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerUtf8String* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool isExplicit);

  /// @brief Method GetInstance, addr 0x368e9a4, size 0xec, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerUtf8String* GetInstance(::System::Object* obj);

  /// @brief Method GetString, addr 0x368ebdc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3680ce0, size 0x54, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> str);

  /// @brief Method .ctor, addr 0x368eb84, size 0x58, virtual false, abstract: false, final false
