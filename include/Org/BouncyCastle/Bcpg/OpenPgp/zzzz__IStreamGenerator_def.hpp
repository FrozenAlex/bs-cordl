...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::IStreamGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::IStreamGenerator*, "Org.BouncyCastle.Bcpg.OpenPgp", "IStreamGenerator");
// Dependencies
namespace Org::BouncyCastle::Bcpg::OpenPgp {
// Is value type: false
