...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::PgpCompressedDataGenerator*);
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::PgpCompressedDataGenerator_SafeCBZip2OutputStream*);
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::PgpCompressedDataGenerator_SafeZOutputStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::PgpCompressedDataGenerator*, "Org.BouncyCastle.Bcpg.OpenPgp", "PgpCompressedDataGenerator");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::PgpCompressedDataGenerator_SafeCBZip2OutputStream*, "Org.BouncyCastle.Bcpg.OpenPgp", "PgpCompressedDataGenerator/SafeCBZip2OutputStream");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::PgpCompressedDataGenerator_SafeZOutputStream*, "Org.BouncyCastle.Bcpg.OpenPgp", "PgpCompressedDataGenerator/SafeZOutputStream");
...
public:
  // Declarations
  /// @brief Method Close, addr 0x34bd2d8, size 0x4, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method .ctor, addr 0x34bd20c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::PgpCompressedDataGenerator_SafeCBZip2OutputStream) == 0xf8, "Size mismatch!");
...
public:
  // Declarations
  /// @brief Method Close, addr 0x34bd33c, size 0x30, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method .ctor, addr 0x34bd204, size 0x8, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::PgpCompressedDataGenerator_SafeZOutputStream) == 0x60, "Size mismatch!");
...
public:
  ...
  /// @brief Method Close, addr 0x34bd214, size 0xbc, virtual true, abstract: false, final true
  inline void Close();
  ...
  /// @brief Method Open, addr 0x34bcdf0, size 0x150, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr);

  /// @brief Method Open, addr 0x34bd09c, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34bccf4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::CompressionAlgorithmTag algorithm);

  /// @brief Method .ctor, addr 0x34bccfc, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::CompressionAlgorithmTag algorithm, int32_t compression);

  /// @brief Method doOpen, addr 0x34bcf40, size 0x15c, virtual false, abstract: false, final false
  inline void doOpen();
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::PgpCompressedDataGenerator) == 0x28, "Size mismatch!");
