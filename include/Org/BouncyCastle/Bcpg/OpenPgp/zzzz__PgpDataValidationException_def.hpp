...
public:
  ...
  /// @brief Method .ctor, addr 0x34c0cb4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x34c0cb8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34c0cbc, size 0x4, virtual false, abstract: false, final false
