...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::PgpDataValidationException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::PgpDataValidationException*, "Org.BouncyCastle.Bcpg.OpenPgp", "PgpDataValidationException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x357b734, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x357b738, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x357b73c, size 0x4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::PgpDataValidationException) == 0x90, "Size mismatch!");
