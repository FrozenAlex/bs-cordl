...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyValidationException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyValidationException*, "Org.BouncyCastle.Bcpg.OpenPgp", "PgpKeyValidationException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3581f54, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3581f58, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3581f5c, size 0x4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyValidationException) == 0x90, "Size mismatch!");
