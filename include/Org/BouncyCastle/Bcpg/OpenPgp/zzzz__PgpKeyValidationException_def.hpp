...
public:
  ...
  /// @brief Method .ctor, addr 0x34c74d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x34c74d8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34c74dc, size 0x4, virtual false, abstract: false, final false
