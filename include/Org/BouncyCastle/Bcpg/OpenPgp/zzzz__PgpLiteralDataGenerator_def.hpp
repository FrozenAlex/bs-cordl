...
public:
  ...
  /// @brief Method Close, addr 0x34c7c40, size 0x40, virtual true, abstract: false, final true
  inline void Close();
  ...
  /// @brief Method Open, addr 0x34c7bbc, size 0x84, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr, char16_t format, ::System::IO::FileInfo* file);

  /// @brief Method Open, addr 0x34c7838, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method Open, addr 0x34c7a04, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteHeader, addr 0x34c76f0, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34c76e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x34c76e8, size 0x8, virtual false, abstract: false, final false
