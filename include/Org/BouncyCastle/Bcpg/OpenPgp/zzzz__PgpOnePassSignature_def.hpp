...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature*, "Org.BouncyCastle.Bcpg.OpenPgp", "PgpOnePassSignature");
...
public:
  ...
  /// @brief Method Cast, addr 0x3583688, size 0xcc, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Bcpg::OnePassSignaturePacket* Cast(::Org::BouncyCastle::Bcpg::Packet* packet);

  /// @brief Method Encode, addr 0x3584150, size 0x38, virtual false, abstract: false, final false
  inline void Encode(::System::IO::Stream* outStr);

  /// @brief Method GetEncoded, addr 0x35840d4, size 0x7c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetEncoded();

  /// @brief Method InitVerify, addr 0x3583770, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x35839f4, size 0xdc, virtual false, abstract: false, final false
  inline void Update(uint8_t b);

  /// @brief Method Update, addr 0x3583cd0, size 0x120, virtual false, abstract: false, final false
  inline void Update(::ArrayW<uint8_t> bytes);

  /// @brief Method Update, addr 0x3583df0, size 0x124, virtual false, abstract: false, final false
  inline void Update(::ArrayW<uint8_t> bytes, int32_t off, int32_t length);

  /// @brief Method Verify, addr 0x3583f14, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3583364, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgInput);

  /// @brief Method .ctor, addr 0x3583754, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::OnePassSignaturePacket* sigPack);

  /// @brief Method doCanonicalUpdateByte, addr 0x3583ad0, size 0xec, virtual false, abstract: false, final false
  inline void doCanonicalUpdateByte(uint8_t b);

  /// @brief Method doUpdateCRLF, addr 0x3583bbc, size 0x114, virtual false, abstract: false, final false
  inline void doUpdateCRLF();

  /// @brief Method get_HashAlgorithm, addr 0x35840a4, size 0x18, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm();

  /// @brief Method get_KeyAlgorithm, addr 0x35840bc, size 0x18, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_KeyAlgorithm();

  /// @brief Method get_KeyId, addr 0x3584074, size 0x18, virtual false, abstract: false, final false
  inline int64_t get_KeyId();

  /// @brief Method get_SignatureType, addr 0x358408c, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature) == 0x30, "Size mismatch!");
