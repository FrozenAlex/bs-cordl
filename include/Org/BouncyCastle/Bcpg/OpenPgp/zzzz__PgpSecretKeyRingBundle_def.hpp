...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::PgpSecretKeyRingBundle*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::PgpSecretKeyRingBundle*, "Org.BouncyCastle.Bcpg.OpenPgp", "PgpSecretKeyRingBundle");
...
public:
  ...
  /// @brief Method AddSecretKeyRing, addr 0x34de998, size 0x2c8, virtual false, abstract: false, final false
  ...
  /// @brief Method Contains, addr 0x34de4f8, size 0x18, virtual false, abstract: false, final false
  inline bool Contains(int64_t keyID);

  /// @brief Method Encode, addr 0x34de58c, size 0x40c, virtual false, abstract: false, final false
  inline void Encode(::System::IO::Stream* outStr);

  /// @brief Method GetEncoded, addr 0x34de510, size 0x7c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetEncoded();

  /// @brief Method GetKeyRings, addr 0x34dd41c, size 0xe8, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerable* GetKeyRings();

  /// @brief Method GetKeyRings, addr 0x34dd504, size 0xc, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerable* GetKeyRings(::StringW userId);

  /// @brief Method GetKeyRings, addr 0x34ddd28, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerable* GetKeyRings(::StringW userId, bool matchPartial);

  /// @brief Method GetKeyRings, addr 0x34dd510, size 0x818, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerable* GetKeyRings(::StringW userId, bool matchPartial, bool ignoreCase);

  /// @brief Method GetSecretKey, addr 0x34ddd30, size 0x330, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSecretKey* GetSecretKey(int64_t keyId);

  /// @brief Method GetSecretKeyRing, addr 0x34de060, size 0x498, virtual false, abstract: false, final false
  ...
  static inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSecretKeyRingBundle* New_ctor(::ArrayW<uint8_t> encoding);
  ...
  /// @brief Method RemoveSecretKeyRing, addr 0x34dec60, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34dcd6c, size 0x560, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* e);

  /// @brief Method .ctor, addr 0x34dcc78, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> encoding);

  /// @brief Method .ctor, addr 0x34dccec, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* inputStream);

  /// @brief Method .ctor, addr 0x34dcc70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IDictionary* secretRings, ::System::Collections::IList* order);

  /// @brief Method get_Count, addr 0x34dd374, size 0xa8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Size, addr 0x34dd2cc, size 0xa8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::PgpSecretKeyRingBundle) == 0x20, "Size mismatch!");
