...
public:
  ...
  /// @brief Method Generate, addr 0x34e0e9c, size 0x82c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignature* Generate();

  /// @brief Method GenerateCertification, addr 0x34d62e8, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCertification, addr 0x34e1ec0, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCertification, addr 0x34e1ef0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCertification, addr 0x34e1cf0, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateOnePassVersion, addr 0x34e0dd4, size 0xc8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature* GenerateOnePassVersion(bool isNested);

  /// @brief Method GetEncodedPublicKey, addr 0x34e1f08, size 0xfc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetEncodedPublicKey(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey* pubKey);

  /// @brief Method InitSign, addr 0x34d61d8, size 0x8, virtual false, abstract: false, final false
  inline void InitSign(int32_t sigType, ::Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey* key);

  /// @brief Method InitSign, addr 0x34e07d4, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetHashedSubpackets, addr 0x34d61e0, size 0x84, virtual false, abstract: false, final false
  inline void SetHashedSubpackets(::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignatureSubpacketVector* hashedPackets);

  /// @brief Method SetUnhashedSubpackets, addr 0x34d6264, size 0x84, virtual false, abstract: false, final false
  inline void SetUnhashedSubpackets(::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignatureSubpacketVector* unhashedPackets);

  /// @brief Method Update, addr 0x34e0c10, size 0x18, virtual false, abstract: false, final false
  inline void Update(::ArrayW<uint8_t> b);

  /// @brief Method Update, addr 0x34e0c28, size 0x1ac, virtual false, abstract: false, final false
  inline void Update(::ArrayW<uint8_t> b, int32_t off, int32_t len);

  /// @brief Method Update, addr 0x34e0a40, size 0x14, virtual false, abstract: false, final false
  inline void Update(uint8_t b);

  /// @brief Method UpdateWithIdData, addr 0x34e1c08, size 0xe8, virtual false, abstract: false, final false
  inline void UpdateWithIdData(int32_t header, ::ArrayW<uint8_t> idBytes);

  /// @brief Method UpdateWithPublicKey, addr 0x34e1b38, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34d60cc, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method doCanonicalUpdateByte, addr 0x34e0a54, size 0x64, virtual false, abstract: false, final false
  inline void doCanonicalUpdateByte(uint8_t b);

  /// @brief Method doUpdateByte, addr 0x34e0ab8, size 0x138, virtual false, abstract: false, final false
  inline void doUpdateByte(uint8_t b);

  /// @brief Method doUpdateCRLF, addr 0x34e0bf0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method insertSubpacket, addr 0x34e1718, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method packetPresent, addr 0x34e16c8, size 0x50, virtual false, abstract: false, final false
