...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::WrappedGeneratorStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::WrappedGeneratorStream*, "Org.BouncyCastle.Bcpg.OpenPgp", "WrappedGeneratorStream");
...
public:
  ...
  /// @brief Method Close, addr 0x34e6d40, size 0xa4, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method .ctor, addr 0x34e6d14, size 0x2c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::WrappedGeneratorStream) == 0x38, "Size mismatch!");
