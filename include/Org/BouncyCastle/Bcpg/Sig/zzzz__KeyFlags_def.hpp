...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::Sig::KeyFlags*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::Sig::KeyFlags*, "Org.BouncyCastle.Bcpg.Sig", "KeyFlags");
...
public:
  ...
  /// @brief Method IntToByteArray, addr 0x3690f20, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3691008, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(bool critical, int32_t flags);

  /// @brief Method .ctor, addr 0x3690ff0, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t> data);

  /// @brief Method get_Flags, addr 0x3691040, size 0x58, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::Sig::KeyFlags) == 0x20, "Size mismatch!");
