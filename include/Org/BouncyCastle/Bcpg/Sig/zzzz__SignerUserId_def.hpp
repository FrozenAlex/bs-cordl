...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::Sig::SignerUserId*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::Sig::SignerUserId*, "Org.BouncyCastle.Bcpg.Sig", "SignerUserId");
...
public:
  // Declarations
  /// @brief Method GetId, addr 0x35d75e4, size 0xa0, virtual false, abstract: false, final false
  inline ::StringW GetId();

  static inline ::Org::BouncyCastle::Bcpg::Sig::SignerUserId* New_ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t> data);

  static inline ::Org::BouncyCastle::Bcpg::Sig::SignerUserId* New_ctor(bool critical, ::StringW userId);

  /// @brief Method UserIdToBytes, addr 0x35d74ec, size 0xa8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> UserIdToBytes(::StringW id);

  /// @brief Method .ctor, addr 0x35d7594, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t> data);

  /// @brief Method .ctor, addr 0x35d75ac, size 0x38, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::Sig::SignerUserId) == 0x20, "Size mismatch!");
