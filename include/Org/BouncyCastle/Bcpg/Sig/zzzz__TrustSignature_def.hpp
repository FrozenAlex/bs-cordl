...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::Sig::TrustSignature*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::Sig::TrustSignature*, "Org.BouncyCastle.Bcpg.Sig", "TrustSignature");
...
public:
  ...
  /// @brief Method IntToByteArray, addr 0x35d7684, size 0x80, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> IntToByteArray(int32_t v1, int32_t v2);

  static inline ::Org::BouncyCastle::Bcpg::Sig::TrustSignature* New_ctor(bool critical, int32_t depth, int32_t trustAmount);

  static inline ::Org::BouncyCastle::Bcpg::Sig::TrustSignature* New_ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t> data);

  /// @brief Method .ctor, addr 0x35d771c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(bool critical, int32_t depth, int32_t trustAmount);

  /// @brief Method .ctor, addr 0x35d7704, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t> data);

  /// @brief Method get_Depth, addr 0x35d7758, size 0x28, virtual false, abstract: false, final false
  inline int32_t get_Depth();

  /// @brief Method get_TrustAmount, addr 0x35d7780, size 0x2c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::Sig::TrustSignature) == 0x20, "Size mismatch!");
