...
public:
  ...
  /// @brief Method GetEncoded, addr 0x3698464, size 0xb8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GetEncoded();

  static inline ::Org::BouncyCastle::Bcpg::BcpgObject* New_ctor();

  /// @brief Method .ctor, addr 0x36985b4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
