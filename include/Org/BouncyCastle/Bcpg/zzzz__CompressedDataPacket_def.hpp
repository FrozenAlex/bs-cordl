...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::CompressedDataPacket*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::CompressedDataPacket*, "Org.BouncyCastle.Bcpg", "CompressedDataPacket");
...
public:
  ...
  /// @brief Method .ctor, addr 0x35dcee0, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method get_Algorithm, addr 0x35de7e4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::CompressedDataPacket) == 0x20, "Size mismatch!");
