...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::ECSecretBcpgKey*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::ECSecretBcpgKey*, "Org.BouncyCastle.Bcpg", "ECSecretBcpgKey");
...
public:
  ...
  /// @brief Method Encode, addr 0x35df918, size 0x24, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetEncoded, addr 0x35df890, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35df77c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x35df7e4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method get_Format, addr 0x35df84c, size 0x44, virtual true, abstract: false, final true
  inline ::StringW get_Format();

  /// @brief Method get_X, addr 0x35df93c, size 0x18, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::ECSecretBcpgKey) == 0x18, "Size mismatch!");
