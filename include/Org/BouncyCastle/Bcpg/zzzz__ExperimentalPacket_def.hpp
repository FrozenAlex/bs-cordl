...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::ExperimentalPacket*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::ExperimentalPacket*, "Org.BouncyCastle.Bcpg", "ExperimentalPacket");
// Dependencies Org.BouncyCastle.Bcpg.ContainedPacket, Org.BouncyCastle.Bcpg.PacketTag
namespace Org::BouncyCastle::Bcpg {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_contents, put = __cordl_internal_set_contents)) ::ArrayW<uint8_t> contents;
  ...
  /// @brief Method Encode, addr 0x35dff04, size 0x24, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetContents, addr 0x35dfe8c, size 0x78, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_contents() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_contents();
  ...
  constexpr void __cordl_internal_set_contents(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_tag(::Org::BouncyCastle::Bcpg::PacketTag value);

  /// @brief Method .ctor, addr 0x35dd680, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::PacketTag tag, ::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method get_Tag, addr 0x35dfe84, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::ExperimentalPacket) == 0x20, "Size mismatch!");
