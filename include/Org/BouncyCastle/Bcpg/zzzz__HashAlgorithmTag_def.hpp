...
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::HashAlgorithmTag, "Org.BouncyCastle.Bcpg", "HashAlgorithmTag");
// Dependencies
namespace Org::BouncyCastle::Bcpg {
// Is value type: true
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::HashAlgorithmTag) == 0x4, "Size mismatch!");
