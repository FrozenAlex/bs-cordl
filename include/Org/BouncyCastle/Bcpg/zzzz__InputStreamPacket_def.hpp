...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::InputStreamPacket*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::InputStreamPacket*, "Org.BouncyCastle.Bcpg", "InputStreamPacket");
...
public:
  ...
  /// @brief Method GetInputStream, addr 0x369925c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36961fc, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::InputStreamPacket) == 0x18, "Size mismatch!");
