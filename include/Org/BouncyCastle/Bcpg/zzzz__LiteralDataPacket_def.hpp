...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::LiteralDataPacket*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::LiteralDataPacket*, "Org.BouncyCastle.Bcpg", "LiteralDataPacket");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_fileName, put = __cordl_internal_set_fileName)) ::ArrayW<uint8_t> fileName;
  ...
  /// @brief Method GetRawFileName, addr 0x35dff44, size 0x60, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_fileName() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_fileName();
  ...
  constexpr void __cordl_internal_set_fileName(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_format(int32_t value);

  constexpr void __cordl_internal_set_modDate(int64_t value);

  /// @brief Method .ctor, addr 0x35dcfb8, size 0x1a8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method get_FileName, addr 0x35dff38, size 0xc, virtual false, abstract: false, final false
  inline ::StringW get_FileName();

  /// @brief Method get_Format, addr 0x35dff28, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Format();

  /// @brief Method get_ModificationTime, addr 0x35dff30, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::LiteralDataPacket) == 0x30, "Size mismatch!");
