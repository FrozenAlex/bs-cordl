...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::ModDetectionCodePacket*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::ModDetectionCodePacket*, "Org.BouncyCastle.Bcpg", "ModDetectionCodePacket");
...
public:
  ...
  /// @brief Method Encode, addr 0x369aba0, size 0x20, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetDigest, addr 0x369ab28, size 0x78, virtual false, abstract: false, final false
  ...
  static inline ::Org::BouncyCastle::Bcpg::ModDetectionCodePacket* New_ctor(::ArrayW<uint8_t> digest);
  ...
  /// @brief Method .ctor, addr 0x369804c, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x369aa44, size 0xe4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::ModDetectionCodePacket) == 0x18, "Size mismatch!");
