...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::OnePassSignaturePacket*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OnePassSignaturePacket*, "Org.BouncyCastle.Bcpg", "OnePassSignaturePacket");
...
public:
  ...
  /// @brief Method Encode, addr 0x35e0264, size 0x178, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35dc8c4, size 0x190, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x35e0224, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HashAlgorithm, addr 0x35e0254, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm();

  /// @brief Method get_KeyAlgorithm, addr 0x35e024c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_KeyAlgorithm();

  /// @brief Method get_KeyId, addr 0x35e025c, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_KeyId();

  /// @brief Method get_SignatureType, addr 0x35e0244, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OnePassSignaturePacket) == 0x30, "Size mismatch!");
