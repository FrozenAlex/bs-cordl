...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::Packet*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::Packet*, "Org.BouncyCastle.Bcpg", "Packet");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3699258, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::Packet) == 0x10, "Size mismatch!");
