...
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag, "Org.BouncyCastle.Bcpg", "PublicKeyAlgorithmTag");
// Dependencies
namespace Org::BouncyCastle::Bcpg {
// Is value type: true
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag) == 0x4, "Size mismatch!");
