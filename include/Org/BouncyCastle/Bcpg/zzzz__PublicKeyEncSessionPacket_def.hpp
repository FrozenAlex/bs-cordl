...
public:
  ...
  /// @brief Method Encode, addr 0x369afec, size 0x194, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetEncSessionKey, addr 0x369afe4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3696204, size 0x308, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x369aeb4, size 0x118, virtual false, abstract: false, final false
  inline void _ctor(int64_t keyId, ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag algorithm, ::ArrayW<::ArrayW<uint8_t>> data);

  /// @brief Method get_Algorithm, addr 0x369afdc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_Algorithm();

  /// @brief Method get_KeyId, addr 0x369afd4, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_KeyId();

  /// @brief Method get_Version, addr 0x369afcc, size 0x8, virtual false, abstract: false, final false
