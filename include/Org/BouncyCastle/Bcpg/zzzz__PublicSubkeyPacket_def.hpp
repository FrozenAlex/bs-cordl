...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::PublicSubkeyPacket*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::PublicSubkeyPacket*, "Org.BouncyCastle.Bcpg", "PublicSubkeyPacket");
...
public:
  // Declarations
  /// @brief Method Encode, addr 0x35e0a54, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35e0a50, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35dd590, size 0x4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::PublicSubkeyPacket) == 0x30, "Size mismatch!");
