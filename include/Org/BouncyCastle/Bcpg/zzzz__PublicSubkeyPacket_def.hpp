...
public:
  // Declarations
  /// @brief Method Encode, addr 0x369b4d4, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3698010, size 0x4, virtual false, abstract: false, final false
