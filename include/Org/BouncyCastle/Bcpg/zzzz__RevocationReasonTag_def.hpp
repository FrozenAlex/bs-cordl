...
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::RevocationReasonTag, "Org.BouncyCastle.Bcpg", "RevocationReasonTag");
// Dependencies
namespace Org::BouncyCastle::Bcpg {
// Is value type: true
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::RevocationReasonTag) == 0x1, "Size mismatch!");
