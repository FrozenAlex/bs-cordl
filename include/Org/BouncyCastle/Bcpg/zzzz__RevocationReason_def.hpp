...
public:
  // Declarations
  /// @brief Method CreateData, addr 0x35d7020, size 0xb0, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> CreateData(::Org::BouncyCastle::Bcpg::RevocationReasonTag reason, ::StringW description);

  /// @brief Method GetRevocationDescription, addr 0x35d70f8, size 0xb8, virtual true, abstract: false, final false
  inline ::StringW GetRevocationDescription();

  /// @brief Method GetRevocationReason, addr 0x35d70d0, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35d6fcc, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(bool isCritical, bool isLongLength, ::ArrayW<uint8_t> data);

  /// @brief Method .ctor, addr 0x35d6fe4, size 0x3c, virtual false, abstract: false, final false
