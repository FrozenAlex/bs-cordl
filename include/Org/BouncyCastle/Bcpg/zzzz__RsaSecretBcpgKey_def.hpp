...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::RsaSecretBcpgKey*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::RsaSecretBcpgKey*, "Org.BouncyCastle.Bcpg", "RsaSecretBcpgKey");
...
public:
  ...
  /// @brief Method Encode, addr 0x369bc44, size 0x130, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetEncoded, addr 0x369bbbc, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369b764, size 0x198, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x369b8fc, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CrtCoefficient, addr 0x369bb70, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_CrtCoefficient();

  /// @brief Method get_Format, addr 0x369bb78, size 0x44, virtual true, abstract: false, final true
  inline ::StringW get_Format();

  /// @brief Method get_Modulus, addr 0x369bae8, size 0x30, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Modulus();

  /// @brief Method get_PrimeExponentP, addr 0x369bb60, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_PrimeExponentP();

  /// @brief Method get_PrimeExponentQ, addr 0x369bb68, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_PrimeExponentQ();

  /// @brief Method get_PrimeP, addr 0x369bb30, size 0x18, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_PrimeP();

  /// @brief Method get_PrimeQ, addr 0x369bb48, size 0x18, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_PrimeQ();

  /// @brief Method get_PrivateExponent, addr 0x369bb18, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::RsaSecretBcpgKey) == 0x48, "Size mismatch!");
