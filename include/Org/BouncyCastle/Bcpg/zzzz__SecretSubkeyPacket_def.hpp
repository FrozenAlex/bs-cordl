...
public:
  // Declarations
  /// @brief Method Encode, addr 0x35e1a0c, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35dcedc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x35e1a04, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35e1a08, size 0x4, virtual false, abstract: false, final false
