...
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::SignatureSubpacketTag, "Org.BouncyCastle.Bcpg", "SignatureSubpacketTag");
// Dependencies
namespace Org::BouncyCastle::Bcpg {
// Is value type: true
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::SignatureSubpacketTag) == 0x4, "Size mismatch!");
