...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::SymmetricEncIntegrityPacket*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::SymmetricEncIntegrityPacket*, "Org.BouncyCastle.Bcpg", "SymmetricEncIntegrityPacket");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3698014, size 0x38, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::SymmetricEncIntegrityPacket) == 0x20, "Size mismatch!");
