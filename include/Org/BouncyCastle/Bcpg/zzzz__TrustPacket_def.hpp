...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::TrustPacket*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::TrustPacket*, "Org.BouncyCastle.Bcpg", "TrustPacket");
...
public:
  ...
  /// @brief Method Encode, addr 0x369d874, size 0x20, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetLevelAndTrustAmount, addr 0x369d7fc, size 0x78, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_levelAndTrustAmount() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_levelAndTrustAmount();

  constexpr void __cordl_internal_set_levelAndTrustAmount(::ArrayW<uint8_t> value);

  /// @brief Method .ctor, addr 0x3697be0, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x369d784, size 0x78, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<uint8_t> ___levelAndTrustAmount;
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::TrustPacket) == 0x18, "Size mismatch!");
