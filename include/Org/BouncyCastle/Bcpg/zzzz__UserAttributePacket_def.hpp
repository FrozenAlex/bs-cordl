...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::UserAttributePacket*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::UserAttributePacket*, "Org.BouncyCastle.Bcpg", "UserAttributePacket");
// Dependencies Org.BouncyCastle.Bcpg.ContainedPacket, Org.BouncyCastle.Bcpg.UserAttributeSubpacket
namespace Org::BouncyCastle::Bcpg {
// Is value type: false
...
public:
  ...
  /// @brief Method Encode, addr 0x35e2e2c, size 0xdc, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetSubpackets, addr 0x35e2e24, size 0x8, virtual false, abstract: false, final false
  ...
  static inline ::Org::BouncyCastle::Bcpg::UserAttributePacket* New_ctor(::ArrayW<::Org::BouncyCastle::Bcpg::UserAttributeSubpacket*> subpackets);

  constexpr ::ArrayW<::Org::BouncyCastle::Bcpg::UserAttributeSubpacket*> const& __cordl_internal_get_subpackets() const;

  constexpr ::ArrayW<::Org::BouncyCastle::Bcpg::UserAttributeSubpacket*>& __cordl_internal_get_subpackets();

  constexpr void __cordl_internal_set_subpackets(::ArrayW<::Org::BouncyCastle::Bcpg::UserAttributeSubpacket*> value);

  /// @brief Method .ctor, addr 0x35dd264, size 0x32c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x35e2e1c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::Org::BouncyCastle::Bcpg::UserAttributeSubpacket*> ___subpackets;
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::UserAttributePacket) == 0x18, "Size mismatch!");
