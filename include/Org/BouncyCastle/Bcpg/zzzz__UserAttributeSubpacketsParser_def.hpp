...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::UserAttributeSubpacketsParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::UserAttributeSubpacketsParser*, "Org.BouncyCastle.Bcpg", "UserAttributeSubpacketsParser");
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::UserAttributeSubpacketsParser) == 0x18, "Size mismatch!");
