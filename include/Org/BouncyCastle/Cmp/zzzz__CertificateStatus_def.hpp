...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cmp::CertificateStatus*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cmp::CertificateStatus*, "Org.BouncyCastle.Cmp", "CertificateStatus");
...
public:
  ...
  /// @brief Method IsVerified, addr 0x369e5ac, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369de14, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CertRequestId, addr 0x369e580, size 0x2c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_CertRequestId();

  /// @brief Method get_PkiStatusInfo, addr 0x369e564, size 0x1c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cmp::CertificateStatus) == 0x20, "Size mismatch!");
