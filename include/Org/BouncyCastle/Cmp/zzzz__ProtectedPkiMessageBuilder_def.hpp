...
public:
  ...
  /// @brief Method AddCmpCertificate, addr 0x35e4d24, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddGeneralInfo, addr 0x35e4b7c, size 0xc0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cmp::ProtectedPkiMessageBuilder* AddGeneralInfo(::Org::BouncyCastle::Asn1::Cmp::InfoTypeAndValue* genInfo);

  /// @brief Method Build, addr 0x35e5abc, size 0x230, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cmp::ProtectedPkiMessage* Build(::Org::BouncyCastle::Crypto::IMacFactory* factory);

  /// @brief Method Build, addr 0x35e4de4, size 0x2ec, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cmp::ProtectedPkiMessage* Build(::Org::BouncyCastle::Crypto::ISignatureFactory* signatureFactory);

  /// @brief Method CalculateSignature, addr 0x35e53c0, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method FinalizeHeader, addr 0x35e50d0, size 0x2f0, virtual false, abstract: false, final false
  inline void FinalizeHeader(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algorithmIdentifier);

  /// @brief Method FinalizeMessage, addr 0x35e5748, size 0x374, virtual false, abstract: false, final false
  ...
  /// @brief Method SetBody, addr 0x35e4d1c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cmp::ProtectedPkiMessageBuilder* SetBody(::Org::BouncyCastle::Asn1::Cmp::PkiBody* body);

  /// @brief Method SetFreeText, addr 0x35e4b4c, size 0x30, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cmp::ProtectedPkiMessageBuilder* SetFreeText(::Org::BouncyCastle::Asn1::Cmp::PkiFreeText* freeText);

  /// @brief Method SetMessageTime, addr 0x35e4c3c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetRecipKID, addr 0x35e4c68, size 0x2c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cmp::ProtectedPkiMessageBuilder* SetRecipKID(::ArrayW<uint8_t> id);

  /// @brief Method SetRecipNonce, addr 0x35e4c94, size 0x30, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cmp::ProtectedPkiMessageBuilder* SetRecipNonce(::ArrayW<uint8_t> nonce);

  /// @brief Method SetSenderKID, addr 0x35e4cc4, size 0x2c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cmp::ProtectedPkiMessageBuilder* SetSenderKID(::ArrayW<uint8_t> id);

  /// @brief Method SetSenderNonce, addr 0x35e4cf0, size 0x2c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cmp::ProtectedPkiMessageBuilder* SetSenderNonce(::ArrayW<uint8_t> nonce);

  /// @brief Method SetTransactionId, addr 0x35e4b20, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35e4a58, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35e49dc, size 0x7c, virtual false, abstract: false, final false
