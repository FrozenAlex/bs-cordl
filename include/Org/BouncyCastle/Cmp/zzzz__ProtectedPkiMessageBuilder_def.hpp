...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cmp::ProtectedPkiMessageBuilder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cmp::ProtectedPkiMessageBuilder*, "Org.BouncyCastle.Cmp", "ProtectedPkiMessageBuilder");
...
public:
  ...
  /// @brief Method AddCmpCertificate, addr 0x369f7a4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddGeneralInfo, addr 0x369f5fc, size 0xc0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cmp::ProtectedPkiMessageBuilder* AddGeneralInfo(::Org::BouncyCastle::Asn1::Cmp::InfoTypeAndValue* genInfo);

  /// @brief Method Build, addr 0x36a053c, size 0x230, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cmp::ProtectedPkiMessage* Build(::Org::BouncyCastle::Crypto::IMacFactory* factory);

  /// @brief Method Build, addr 0x369f864, size 0x2ec, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cmp::ProtectedPkiMessage* Build(::Org::BouncyCastle::Crypto::ISignatureFactory* signatureFactory);

  /// @brief Method CalculateSignature, addr 0x369fe40, size 0x388, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> CalculateSignature(::Org::BouncyCastle::Crypto::IStreamCalculator* signer, ::Org::BouncyCastle::Asn1::Cmp::PkiHeader* header, ::Org::BouncyCastle::Asn1::Cmp::PkiBody* body);

  /// @brief Method FinalizeHeader, addr 0x369fb50, size 0x2f0, virtual false, abstract: false, final false
  inline void FinalizeHeader(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algorithmIdentifier);

  /// @brief Method FinalizeMessage, addr 0x36a01c8, size 0x374, virtual false, abstract: false, final false
  ...
  /// @brief Method SetBody, addr 0x369f79c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cmp::ProtectedPkiMessageBuilder* SetBody(::Org::BouncyCastle::Asn1::Cmp::PkiBody* body);

  /// @brief Method SetFreeText, addr 0x369f5cc, size 0x30, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cmp::ProtectedPkiMessageBuilder* SetFreeText(::Org::BouncyCastle::Asn1::Cmp::PkiFreeText* freeText);

  /// @brief Method SetMessageTime, addr 0x369f6bc, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetRecipKID, addr 0x369f6e8, size 0x2c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cmp::ProtectedPkiMessageBuilder* SetRecipKID(::ArrayW<uint8_t> id);

  /// @brief Method SetRecipNonce, addr 0x369f714, size 0x30, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cmp::ProtectedPkiMessageBuilder* SetRecipNonce(::ArrayW<uint8_t> nonce);

  /// @brief Method SetSenderKID, addr 0x369f744, size 0x2c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cmp::ProtectedPkiMessageBuilder* SetSenderKID(::ArrayW<uint8_t> id);

  /// @brief Method SetSenderNonce, addr 0x369f770, size 0x2c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cmp::ProtectedPkiMessageBuilder* SetSenderNonce(::ArrayW<uint8_t> nonce);

  /// @brief Method SetTransactionId, addr 0x369f5a0, size 0x2c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cmp::ProtectedPkiMessageBuilder* SetTransactionId(::ArrayW<uint8_t> tid);
  ...
  /// @brief Method .ctor, addr 0x369f4d8, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369f45c, size 0x7c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cmp::ProtectedPkiMessageBuilder) == 0x30, "Size mismatch!");
