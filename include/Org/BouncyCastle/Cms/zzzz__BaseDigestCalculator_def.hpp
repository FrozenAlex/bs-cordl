...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::BaseDigestCalculator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::BaseDigestCalculator*, "Org.BouncyCastle.Cms", "BaseDigestCalculator");
...
public:
  ...
  /// @brief Method GetDigest, addr 0x35e5fb4, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x35e5fac, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::BaseDigestCalculator) == 0x18, "Size mismatch!");
