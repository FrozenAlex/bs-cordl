...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::CmsAuthEnvelopedData*);
MARK_REF_T(::Org::BouncyCastle::Cms::CmsAuthEnvelopedData_AuthEnvelopedSecureReadable*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsAuthEnvelopedData*, "Org.BouncyCastle.Cms", "CmsAuthEnvelopedData");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsAuthEnvelopedData_AuthEnvelopedSecureReadable*, "Org.BouncyCastle.Cms", "CmsAuthEnvelopedData/AuthEnvelopedSecureReadable");
...
public:
  ...
  /// @brief Method GetReadable, addr 0x35ea270, size 0x48, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x35ea248, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Cms::CmsAuthEnvelopedData* parent);

  /// @brief Method get_Algorithm, addr 0x35ea250, size 0x18, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_Algorithm();

  /// @brief Method get_CryptoObject, addr 0x35ea268, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsAuthEnvelopedData_AuthEnvelopedSecureReadable) == 0x18, "Size mismatch!");
...
public:
  ...
  static inline ::Org::BouncyCastle::Cms::CmsAuthEnvelopedData* New_ctor(::ArrayW<uint8_t> authEnvData);
  ...
  /// @brief Method .ctor, addr 0x35ea100, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> authEnvData);

  /// @brief Method .ctor, addr 0x35ea224, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* authEnvData);

  /// @brief Method .ctor, addr 0x35ea124, size 0x100, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsAuthEnvelopedData) == 0x48, "Size mismatch!");
