...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::CmsAuthEnvelopedGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsAuthEnvelopedGenerator*, "Org.BouncyCastle.Cms", "CmsAuthEnvelopedGenerator");
...
public:
  ...
  /// @brief Method .ctor, addr 0x35ea3a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsAuthEnvelopedGenerator) == 0x10, "Size mismatch!");
