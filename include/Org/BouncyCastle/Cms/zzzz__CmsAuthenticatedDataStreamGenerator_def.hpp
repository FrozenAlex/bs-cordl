...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::CmsAuthenticatedDataStreamGenerator*);
MARK_REF_T(::Org::BouncyCastle::Cms::CmsAuthenticatedDataStreamGenerator_CmsAuthenticatedDataOutputStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsAuthenticatedDataStreamGenerator*, "Org.BouncyCastle.Cms", "CmsAuthenticatedDataStreamGenerator");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsAuthenticatedDataStreamGenerator_CmsAuthenticatedDataOutputStream*, "Org.BouncyCastle.Cms",
...
public:
  ...
  /// @brief Method Close, addr 0x35e9fb0, size 0x150, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method Write, addr 0x35e9f90, size 0x20, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t> bytes, int32_t off, int32_t len);

  /// @brief Method WriteByte, addr 0x35e9f70, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35e9d5c, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsAuthenticatedDataStreamGenerator_CmsAuthenticatedDataOutputStream) == 0x58, "Size mismatch!");
...
public:
  ...
  /// @brief Method Open, addr 0x35e9dac, size 0xe0, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr, ::StringW encryptionOid);

  /// @brief Method Open, addr 0x35e9e8c, size 0xe4, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr, ::StringW encryptionOid, int32_t keySize);

  /// @brief Method Open, addr 0x35e9520, size 0x83c, virtual false, abstract: false, final false
  ...
  /// @brief Method Open, addr 0x35e8f24, size 0x5fc, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr, ::StringW macOid, ::Org::BouncyCastle::Crypto::CipherKeyGenerator* keyGen);

  /// @brief Method SetBerEncodeRecipients, addr 0x35e8f1c, size 0x8, virtual false, abstract: false, final false
  inline void SetBerEncodeRecipients(bool berEncodeRecipientSet);

  /// @brief Method SetBufferSize, addr 0x35e8f14, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35e8f0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35e8f10, size 0x4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsAuthenticatedDataStreamGenerator) == 0x30, "Size mismatch!");
