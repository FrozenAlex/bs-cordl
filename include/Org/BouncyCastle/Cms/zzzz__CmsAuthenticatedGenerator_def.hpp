...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::CmsAuthenticatedGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsAuthenticatedGenerator*, "Org.BouncyCastle.Cms", "CmsAuthenticatedGenerator");
...
public:
  ...
  /// @brief Method .ctor, addr 0x36a1fdc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36a2034, size 0x68, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsAuthenticatedGenerator) == 0x28, "Size mismatch!");
