...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::CmsCompressedDataGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsCompressedDataGenerator*, "Org.BouncyCastle.Cms", "CmsCompressedDataGenerator");
...
public:
  // Declarations
  /// @brief Method Generate, addr 0x35ea8b0, size 0x3b4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35ea8ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsCompressedDataGenerator) == 0x10, "Size mismatch!");
