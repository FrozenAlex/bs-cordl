...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::CmsCompressedDataStreamGenerator*);
MARK_REF_T(::Org::BouncyCastle::Cms::CmsCompressedDataStreamGenerator_CmsCompressedOutputStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsCompressedDataStreamGenerator*, "Org.BouncyCastle.Cms", "CmsCompressedDataStreamGenerator");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsCompressedDataStreamGenerator_CmsCompressedOutputStream*, "Org.BouncyCastle.Cms", "CmsCompressedDataStreamGenerator/CmsCompressedOutputStream");
...
public:
  ...
  /// @brief Method Close, addr 0x36a5e28, size 0xc0, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method Write, addr 0x36a5e08, size 0x20, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t> bytes, int32_t off, int32_t len);

  /// @brief Method WriteByte, addr 0x36a5de8, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a5da8, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsCompressedDataStreamGenerator_CmsCompressedOutputStream) == 0x50, "Size mismatch!");
...
public:
  ...
  /// @brief Method Open, addr 0x36a5a74, size 0x80, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStream, ::StringW compressionOID);

  /// @brief Method Open, addr 0x36a5af4, size 0x2b4, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStream, ::StringW contentOID, ::StringW compressionOID);

  /// @brief Method SetBufferSize, addr 0x36a5a6c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a5a68, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsCompressedDataStreamGenerator) == 0x18, "Size mismatch!");
