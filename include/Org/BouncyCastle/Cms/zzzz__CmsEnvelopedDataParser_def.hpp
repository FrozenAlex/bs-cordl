...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::CmsEnvelopedDataParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsEnvelopedDataParser*, "Org.BouncyCastle.Cms", "CmsEnvelopedDataParser");
...
public:
  ...
  /// @brief Method GetRecipientInfos, addr 0x35ed730, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::RecipientInformationStore* GetRecipientInfos();

  /// @brief Method GetUnprotectedAttributes, addr 0x35ed738, size 0x258, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::AttributeTable* GetUnprotectedAttributes();

  static inline ::Org::BouncyCastle::Cms::CmsEnvelopedDataParser* New_ctor(::ArrayW<uint8_t> envelopedData);
  ...
  constexpr ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* const& __cordl_internal_get__encAlg() const;

  constexpr ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*& __cordl_internal_get__encAlg();

  constexpr ::Org::BouncyCastle::Asn1::Cms::AttributeTable* const& __cordl_internal_get__unprotectedAttributes() const;

  constexpr ::Org::BouncyCastle::Asn1::Cms::AttributeTable*& __cordl_internal_get__unprotectedAttributes();

  constexpr ::Org::BouncyCastle::Asn1::Cms::EnvelopedDataParser* const& __cordl_internal_get_envelopedData() const;
  ...
  /// @brief Method .ctor, addr 0x35ed358, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> envelopedData);

  /// @brief Method .ctor, addr 0x35ed3cc, size 0x2f8, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* envelopedData);

  /// @brief Method get_EncryptionAlgOid, addr 0x35ed6cc, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_EncryptionAlgOid();

  /// @brief Method get_EncryptionAlgParams, addr 0x35ed6f8, size 0x38, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* get_EncryptionAlgParams();

  /// @brief Method get_EncryptionAlgorithmID, addr 0x35ed6c4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsEnvelopedDataParser) == 0x48, "Size mismatch!");
