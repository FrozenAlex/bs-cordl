...
public:
  ...
  /// @brief Method GetEncoded, addr 0x36a6114, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetEncoded();

  /// @brief Method GetRecipientInfos, addr 0x36a6094, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::RecipientInformationStore* GetRecipientInfos();

  /// @brief Method GetUnprotectedAttributes, addr 0x36a60a4, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a5f0c, size 0x130, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::ContentInfo* contentInfo);

  /// @brief Method .ctor, addr 0x36a5ee8, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> envelopedData);

  /// @brief Method .ctor, addr 0x36a603c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* envelopedData);

  /// @brief Method get_ContentInfo, addr 0x36a609c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* get_ContentInfo();

  /// @brief Method get_EncryptionAlgOid, addr 0x36a6068, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_EncryptionAlgOid();

  /// @brief Method get_EncryptionAlgorithmID, addr 0x36a6060, size 0x8, virtual false, abstract: false, final false
