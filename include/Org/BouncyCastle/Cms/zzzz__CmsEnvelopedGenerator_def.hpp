...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::CmsEnvelopedGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsEnvelopedGenerator*, "Org.BouncyCastle.Cms", "CmsEnvelopedGenerator");
...
public:
  ...
  __declspec(property(get = getStaticF_Aes128Cbc, put = setStaticF_Aes128Cbc)) ::StringW Aes128Cbc;

  /// @brief Field Aes128Wrap, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Aes128Wrap, put = setStaticF_Aes128Wrap)) ::StringW Aes128Wrap;

  /// @brief Field Aes192Cbc, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Aes192Cbc, put = setStaticF_Aes192Cbc)) ::StringW Aes192Cbc;

  /// @brief Field Aes192Wrap, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Aes192Wrap, put = setStaticF_Aes192Wrap)) ::StringW Aes192Wrap;

  /// @brief Field Aes256Cbc, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Aes256Cbc, put = setStaticF_Aes256Cbc)) ::StringW Aes256Cbc;

  /// @brief Field Aes256Wrap, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Aes256Wrap, put = setStaticF_Aes256Wrap)) ::StringW Aes256Wrap;

  /// @brief Field Camellia128Cbc, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Camellia128Cbc, put = setStaticF_Camellia128Cbc)) ::StringW Camellia128Cbc;

  /// @brief Field Camellia128Wrap, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Camellia128Wrap, put = setStaticF_Camellia128Wrap)) ::StringW Camellia128Wrap;

  /// @brief Field Camellia192Cbc, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Camellia192Cbc, put = setStaticF_Camellia192Cbc)) ::StringW Camellia192Cbc;

  /// @brief Field Camellia192Wrap, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Camellia192Wrap, put = setStaticF_Camellia192Wrap)) ::StringW Camellia192Wrap;

  /// @brief Field Camellia256Cbc, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Camellia256Cbc, put = setStaticF_Camellia256Cbc)) ::StringW Camellia256Cbc;

  /// @brief Field Camellia256Wrap, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Camellia256Wrap, put = setStaticF_Camellia256Wrap)) ::StringW Camellia256Wrap;

  /// @brief Field DesEde3Cbc, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_DesEde3Cbc, put = setStaticF_DesEde3Cbc)) ::StringW DesEde3Cbc;

  /// @brief Field DesEde3Wrap, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_DesEde3Wrap, put = setStaticF_DesEde3Wrap)) ::StringW DesEde3Wrap;

  /// @brief Field ECDHSha1Kdf, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_ECDHSha1Kdf, put = setStaticF_ECDHSha1Kdf)) ::StringW ECDHSha1Kdf;

  /// @brief Field ECMqvSha1Kdf, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_ECMqvSha1Kdf, put = setStaticF_ECMqvSha1Kdf)) ::StringW ECMqvSha1Kdf;

  /// @brief Field RC2Cbc, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_RC2Cbc, put = setStaticF_RC2Cbc)) ::StringW RC2Cbc;

  /// @brief Field SeedCbc, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_SeedCbc, put = setStaticF_SeedCbc)) ::StringW SeedCbc;

  /// @brief Field SeedWrap, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_SeedWrap, put = setStaticF_SeedWrap)) ::StringW SeedWrap;
  ...
  /// @brief Method AddKekRecipient, addr 0x36a128c, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method AddKekRecipient, addr 0x36a11fc, size 0x90, virtual false, abstract: false, final false
  inline void AddKekRecipient(::StringW keyAlgorithm, ::Org::BouncyCastle::Crypto::Parameters::KeyParameter* key, ::ArrayW<uint8_t> keyIdentifier);

  /// @brief Method AddKeyAgreementRecipient, addr 0x36a1544, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method AddKeyAgreementRecipients, addr 0x36a166c, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method AddKeyTransRecipient, addr 0x36a0ff0, size 0xec, virtual false, abstract: false, final false
  inline void AddKeyTransRecipient(::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method AddKeyTransRecipient, addr 0x36a10dc, size 0x120, virtual false, abstract: false, final false
  inline void AddKeyTransRecipient(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* pubKey, ::ArrayW<uint8_t> subKeyId);

  /// @brief Method AddPasswordRecipient, addr 0x36a138c, size 0x1b8, virtual false, abstract: false, final false
  inline void AddPasswordRecipient(::Org::BouncyCastle::Cms::CmsPbeKey* pbeKey, ::StringW kekAlgorithmOid);

  /// @brief Method AddRecipientInfoGenerator, addr 0x36a18ac, size 0xb8, virtual false, abstract: false, final false
  inline void AddRecipientInfoGenerator(::Org::BouncyCastle::Cms::RecipientInfoGenerator* recipientInfoGenerator);

  /// @brief Method GenerateAsn1Parameters, addr 0x36a1a98, size 0x240, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* GenerateAsn1Parameters(::StringW encryptionOid, ::ArrayW<uint8_t> encKeyBytes);

  /// @brief Method GetAlgorithmIdentifier, addr 0x36a1964, size 0x134, virtual true, abstract: false, final false
  ...
  constexpr ::System::Collections::IList* const& __cordl_internal_get_recipientInfoGenerators() const;

  constexpr ::System::Collections::IList*& __cordl_internal_get_recipientInfoGenerators();

  constexpr ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator* const& __cordl_internal_get_unprotectedAttributeGenerator() const;
  ...
  /// @brief Method .ctor, addr 0x36a0f10, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36a0f70, size 0x70, virtual false, abstract: false, final false
  ...
  static inline ::ArrayW<int16_t> getStaticF_rc2Table();

  /// @brief Method get_UnprotectedAttributeGenerator, addr 0x36a0fe0, size 0x8, virtual false, abstract: false, final false
  ...
  static inline void setStaticF_rc2Table(::ArrayW<int16_t> value);

  /// @brief Method set_UnprotectedAttributeGenerator, addr 0x36a0fe8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsEnvelopedGenerator) == 0x28, "Size mismatch!");
