...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::CmsPbeKey*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsPbeKey*, "Org.BouncyCastle.Cms", "CmsPbeKey");
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsPbeKey) == 0x28, "Size mismatch!");
