...
public:
  ...
  /// @brief Method ToSignerInfo, addr 0x36b34ec, size 0xbb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36b2418, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36b2204, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DigestAlgorithmID, addr 0x36b3434, size 0xb8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestAlgorithmID();

  /// @brief Method get_SignedAttributes, addr 0x36b4a0c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator* get_SignedAttributes();

  /// @brief Method get_UnsignedAttributes, addr 0x36b4a14, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddSigner, addr 0x36b105c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method AddSigner, addr 0x36b19f8, size 0xbc, virtual false, abstract: false, final false
  inline void AddSigner(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey, ::Org::BouncyCastle::X509::X509Certificate* cert, ::StringW digestOID,
                        ::Org::BouncyCastle::Asn1::Cms::AttributeTable* signedAttr, ::Org::BouncyCastle::Asn1::Cms::AttributeTable* unsignedAttr);

  /// @brief Method AddSigner, addr 0x36b1e10, size 0xbc, virtual false, abstract: false, final false
  inline void AddSigner(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey, ::Org::BouncyCastle::X509::X509Certificate* cert, ::StringW digestOID,
  ...
  /// @brief Method AddSigner, addr 0x36b160c, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method AddSigner, addr 0x36b1ab4, size 0x110, virtual false, abstract: false, final false
  inline void AddSigner(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey, ::Org::BouncyCastle::X509::X509Certificate* cert, ::StringW encryptionOID, ::StringW digestOID,
                        ::Org::BouncyCastle::Asn1::Cms::AttributeTable* signedAttr, ::Org::BouncyCastle::Asn1::Cms::AttributeTable* unsignedAttr);

  /// @brief Method AddSigner, addr 0x36b1ecc, size 0xb8, virtual false, abstract: false, final false
  inline void AddSigner(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey, ::Org::BouncyCastle::X509::X509Certificate* cert, ::StringW encryptionOID, ::StringW digestOID,
                        ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator* signedAttrGen, ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator* unsignedAttrGen);

  /// @brief Method AddSigner, addr 0x36b187c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method AddSigner, addr 0x36b1c44, size 0xbc, virtual false, abstract: false, final false
  inline void AddSigner(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey, ::ArrayW<uint8_t> subjectKeyID, ::StringW digestOID,
                        ::Org::BouncyCastle::Asn1::Cms::AttributeTable* signedAttr, ::Org::BouncyCastle::Asn1::Cms::AttributeTable* unsignedAttr);

  /// @brief Method AddSigner, addr 0x36b1f84, size 0xbc, virtual false, abstract: false, final false
  inline void AddSigner(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey, ::ArrayW<uint8_t> subjectKeyID, ::StringW digestOID,
                        ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator* signedAttrGen, ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator* unsignedAttrGen);

  /// @brief Method AddSigner, addr 0x36b1920, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method AddSigner, addr 0x36b1d00, size 0x110, virtual false, abstract: false, final false
  inline void AddSigner(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey, ::ArrayW<uint8_t> subjectKeyID, ::StringW encryptionOID, ::StringW digestOID,
                        ::Org::BouncyCastle::Asn1::Cms::AttributeTable* signedAttr, ::Org::BouncyCastle::Asn1::Cms::AttributeTable* unsignedAttr);

  /// @brief Method AddSigner, addr 0x36b2040, size 0xb8, virtual false, abstract: false, final false
  inline void AddSigner(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey, ::ArrayW<uint8_t> subjectKeyID, ::StringW encryptionOID, ::StringW digestOID,
                        ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator* signedAttrGen, ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator* unsignedAttrGen);

  /// @brief Method AddSignerInfoGenerator, addr 0x36b20f8, size 0x10c, virtual false, abstract: false, final false
  inline void AddSignerInfoGenerator(::Org::BouncyCastle::Cms::SignerInfoGenerator* signerInfoGenerator);

  /// @brief Method Generate, addr 0x36b255c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::CmsSignedData* Generate(::Org::BouncyCastle::Cms::CmsProcessable* content);

  /// @brief Method Generate, addr 0x36b2564, size 0x7c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::CmsSignedData* Generate(::Org::BouncyCastle::Cms::CmsProcessable* content, bool encapsulate);

  /// @brief Method Generate, addr 0x36b25e0, size 0xe54, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCounterSigners, addr 0x36b4420, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36b0f2c, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36b0fbc, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Security::SecureRandom* rand);

  /// @brief Method doAddSigner, addr 0x36b1744, size 0x138, virtual false, abstract: false, final false
