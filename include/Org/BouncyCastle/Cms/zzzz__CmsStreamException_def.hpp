...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::CmsStreamException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsStreamException*, "Org.BouncyCastle.Cms", "CmsStreamException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x360c744, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x360c74c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x35ffb38, size 0x24, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsStreamException) == 0x90, "Size mismatch!");
