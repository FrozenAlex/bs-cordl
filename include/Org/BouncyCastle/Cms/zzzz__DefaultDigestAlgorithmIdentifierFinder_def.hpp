...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::DefaultDigestAlgorithmIdentifierFinder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::DefaultDigestAlgorithmIdentifierFinder*, "Org.BouncyCastle.Cms", "DefaultDigestAlgorithmIdentifierFinder");
...
public:
  ...
  /// @brief Method .ctor, addr 0x35f9d2c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method find, addr 0x3609c90, size 0x18c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* find(::StringW digAlgName);

  /// @brief Method find, addr 0x35f9d30, size 0x25c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::DefaultDigestAlgorithmIdentifierFinder) == 0x10, "Size mismatch!");
