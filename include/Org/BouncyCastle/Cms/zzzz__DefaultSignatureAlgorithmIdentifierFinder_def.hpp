...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::DefaultSignatureAlgorithmIdentifierFinder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::DefaultSignatureAlgorithmIdentifierFinder*, "Org.BouncyCastle.Cms", "DefaultSignatureAlgorithmIdentifierFinder");
...
public:
  ...
  /// @brief Method CreatePssParams, addr 0x36075f0, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Find, addr 0x3607da0, size 0x58, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* Find(::StringW sigAlgName);

  /// @brief Method Generate, addr 0x36076f4, size 0x6ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3607df8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Cms::DefaultSignatureAlgorithmIdentifierFinder) == 0x10, "Size mismatch!");
