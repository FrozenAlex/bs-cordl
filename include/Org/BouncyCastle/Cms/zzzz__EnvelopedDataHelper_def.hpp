...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::EnvelopedDataHelper*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::EnvelopedDataHelper*, "Org.BouncyCastle.Cms", "EnvelopedDataHelper");
...
public:
  ...
  /// @brief Method CreateContentCipher, addr 0x360dfb4, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyGenerator, addr 0x360e0bc, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateEncryptionAlgID, addr 0x360e028, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x360e0cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Cms::EnvelopedDataHelper) == 0x10, "Size mismatch!");
