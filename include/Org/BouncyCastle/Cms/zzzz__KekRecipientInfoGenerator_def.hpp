...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::KekRecipientInfoGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::KekRecipientInfoGenerator*, "Org.BouncyCastle.Cms", "KekRecipientInfoGenerator");
...
public:
  ...
  /// @brief Method DetermineKeyEncAlg, addr 0x360e154, size 0x4b4, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x360e610, size 0x28c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x360e0d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_KekIdentifier, addr 0x360e0d4, size 0x8, virtual false, abstract: false, final false
  inline void set_KekIdentifier(::Org::BouncyCastle::Asn1::Cms::KekIdentifier* value);

  /// @brief Method set_KeyEncryptionKey, addr 0x360e0dc, size 0x78, virtual false, abstract: false, final false
  inline void set_KeyEncryptionKey(::Org::BouncyCastle::Crypto::Parameters::KeyParameter* value);

  /// @brief Method set_KeyEncryptionKeyOID, addr 0x360e608, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::KekRecipientInfoGenerator) == 0x30, "Size mismatch!");
