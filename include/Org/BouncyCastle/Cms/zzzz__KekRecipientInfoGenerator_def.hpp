...
public:
  ...
  /// @brief Method DetermineKeyEncAlg, addr 0x36c8bd4, size 0x4b4, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x36c9090, size 0x28c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x36c8b50, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_KekIdentifier, addr 0x36c8b54, size 0x8, virtual false, abstract: false, final false
  inline void set_KekIdentifier(::Org::BouncyCastle::Asn1::Cms::KekIdentifier* value);

  /// @brief Method set_KeyEncryptionKey, addr 0x36c8b5c, size 0x78, virtual false, abstract: false, final false
  inline void set_KeyEncryptionKey(::Org::BouncyCastle::Crypto::Parameters::KeyParameter* value);

  /// @brief Method set_KeyEncryptionKeyOID, addr 0x36c9088, size 0x8, virtual false, abstract: false, final false
