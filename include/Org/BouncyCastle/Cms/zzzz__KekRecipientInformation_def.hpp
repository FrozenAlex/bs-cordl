...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::KekRecipientInformation*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::KekRecipientInformation*, "Org.BouncyCastle.Cms", "KekRecipientInformation");
...
public:
  ...
  /// @brief Method GetContentStream, addr 0x360efe4, size 0x344, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35f05c8, size 0xac, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::KekRecipientInformation) == 0x38, "Size mismatch!");
