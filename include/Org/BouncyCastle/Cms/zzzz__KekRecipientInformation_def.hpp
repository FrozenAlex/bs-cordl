...
public:
  ...
  /// @brief Method GetContentStream, addr 0x36c9a64, size 0x344, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36ab048, size 0xac, virtual false, abstract: false, final false
