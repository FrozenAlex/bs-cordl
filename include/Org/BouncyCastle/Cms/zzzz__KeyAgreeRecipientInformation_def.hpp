...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::KeyAgreeRecipientInformation*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::KeyAgreeRecipientInformation*, "Org.BouncyCastle.Cms", "KeyAgreeRecipientInformation");
...
public:
  ...
  /// @brief Method CalculateAgreedWrapKey, addr 0x3610940, size 0x3f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetContentStream, addr 0x361115c, size 0x118, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::CmsTypedStream* GetContentStream(::Org::BouncyCastle::Crypto::ICipherParameters* key);

  /// @brief Method GetPublicKeyFromOriginatorID, addr 0x36108f4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPublicKeyFromOriginatorPublicKey, addr 0x3610830, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSenderPublicKey, addr 0x3610758, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSessionKey, addr 0x3610efc, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadRecipientInfo, addr 0x35f0674, size 0x530, virtual false, abstract: false, final false
  ...
  /// @brief Method UnwrapSessionKey, addr 0x3610d30, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3610710, size 0x48, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::KeyAgreeRecipientInformation) == 0x40, "Size mismatch!");
