...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::PasswordRecipientInformation*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::PasswordRecipientInformation*, "Org.BouncyCastle.Cms", "PasswordRecipientInformation");
...
public:
  ...
  /// @brief Method GetContentStream, addr 0x36141b8, size 0x558, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35f0ba4, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_KeyDerivationAlgorithm, addr 0x36141a0, size 0x18, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::PasswordRecipientInformation) == 0x38, "Size mismatch!");
