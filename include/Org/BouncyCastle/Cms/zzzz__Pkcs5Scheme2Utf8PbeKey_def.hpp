...
public:
  // Declarations
  /// @brief Method GetEncoded, addr 0x36cf3d8, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36cf3d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<char16_t> password, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* keyDerivationAlgorithm);

  /// @brief Method .ctor, addr 0x36cf394, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<char16_t> password, ::ArrayW<uint8_t> salt, int32_t iterationCount);

  /// @brief Method .ctor, addr 0x36cf398, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW password, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* keyDerivationAlgorithm);

  /// @brief Method .ctor, addr 0x36cf350, size 0x44, virtual false, abstract: false, final false
