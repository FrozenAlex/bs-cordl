...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::RecipientID*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::RecipientID*, "Org.BouncyCastle.Cms", "RecipientID");
...
public:
  // Declarations
  __declspec(property(get = get_KeyIdentifier, put = set_KeyIdentifier)) ::ArrayW<uint8_t> KeyIdentifier;
  ...
  /// @brief Method Equals, addr 0x3614ba0, size 0x178, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x3614af0, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x360e988, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_KeyIdentifier, addr 0x3614a90, size 0x60, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> get_KeyIdentifier();

  /// @brief Method set_KeyIdentifier, addr 0x360ef74, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::RecipientID) == 0x90, "Size mismatch!");
