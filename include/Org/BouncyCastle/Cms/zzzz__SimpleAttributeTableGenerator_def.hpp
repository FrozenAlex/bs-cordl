...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::SimpleAttributeTableGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::SimpleAttributeTableGenerator*, "Org.BouncyCastle.Cms", "SimpleAttributeTableGenerator");
...
public:
  ...
  /// @brief Method GetAttributes, addr 0x36d3e10, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36d3e08, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::SimpleAttributeTableGenerator) == 0x18, "Size mismatch!");
