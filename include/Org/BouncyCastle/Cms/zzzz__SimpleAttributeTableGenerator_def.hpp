...
public:
  ...
  /// @brief Method GetAttributes, addr 0x3619390, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3619388, size 0x8, virtual false, abstract: false, final false
