...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crmf::CertificateRequestMessageBuilder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crmf::CertificateRequestMessageBuilder*, "Org.BouncyCastle.Crmf", "CertificateRequestMessageBuilder");
...
public:
  ...
  /// @brief Method AddControl, addr 0x361a31c, size 0xc0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crmf::CertificateRequestMessageBuilder* AddControl(::Org::BouncyCastle::Crmf::IControl* control);

  /// @brief Method AddExtension, addr 0x361a2f0, size 0x2c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crmf::CertificateRequestMessageBuilder* AddExtension(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid, bool critical, ::ArrayW<uint8_t> value);

  /// @brief Method AddExtension, addr 0x361a2c4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method Build, addr 0x361a7e4, size 0x8e4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAuthInfoPKMAC, addr 0x361a764, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crmf::CertificateRequestMessageBuilder* SetAuthInfoPKMAC(::Org::BouncyCastle::Crmf::PKMacBuilder* pkmacFactory, ::ArrayW<char16_t> password);

  /// @brief Method SetAuthInfoSender, addr 0x361a7dc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAuthInfoSender, addr 0x361a76c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method SetIssuer, addr 0x361a148, size 0x30, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crmf::CertificateRequestMessageBuilder* SetIssuer(::Org::BouncyCastle::Asn1::X509::X509Name* issuer);

  /// @brief Method SetProofOfPossessionAgreeMac, addr 0x361a638, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetProofOfPossessionRaVerified, addr 0x361a6a4, size 0xc0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crmf::CertificateRequestMessageBuilder* SetProofOfPossessionRaVerified();

  /// @brief Method SetProofOfPossessionSignKeySigner, addr 0x361a3dc, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetProofOfPossessionSubsequentMessage, addr 0x361a448, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetProofOfPossessionSubsequentMessage, addr 0x361a520, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPublicKey, addr 0x361a118, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSerialNumber, addr 0x361a1a8, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSubject, addr 0x361a178, size 0x30, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crmf::CertificateRequestMessageBuilder* SetSubject(::Org::BouncyCastle::Asn1::X509::X509Name* subject);

  /// @brief Method SetValidity, addr 0x361a240, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x361a04c, size 0xcc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crmf::CertificateRequestMessageBuilder) == 0x70, "Size mismatch!");
