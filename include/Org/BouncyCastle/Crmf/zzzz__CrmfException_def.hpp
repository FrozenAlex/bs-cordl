...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crmf::CrmfException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crmf::CrmfException*, "Org.BouncyCastle.Crmf", "CrmfException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x361bb68, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x361bbc0, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3619f6c, size 0x74, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crmf::CrmfException) == 0x90, "Size mismatch!");
