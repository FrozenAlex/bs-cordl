...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crmf::DefaultPKMacResult*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crmf::DefaultPKMacResult*, "Org.BouncyCastle.Crmf", "DefaultPKMacResult");
...
public:
  ...
  /// @brief Method Collect, addr 0x361d65c, size 0x148, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> Collect();

  /// @brief Method Collect, addr 0x361d7a4, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x361d3e4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crmf::DefaultPKMacResult) == 0x18, "Size mismatch!");
