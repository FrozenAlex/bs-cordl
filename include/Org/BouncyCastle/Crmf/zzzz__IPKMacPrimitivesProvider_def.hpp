...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crmf::IPKMacPrimitivesProvider*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crmf::IPKMacPrimitivesProvider*, "Org.BouncyCastle.Crmf", "IPKMacPrimitivesProvider");
// Dependencies
namespace Org::BouncyCastle::Crmf {
// Is value type: false
