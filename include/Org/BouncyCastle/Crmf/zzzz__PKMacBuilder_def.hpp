...
public:
  ...
  /// @brief Method Build, addr 0x36d87d4, size 0x11c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IMacFactory* Build(::ArrayW<char16_t> password);

  /// @brief Method CheckIterationCountCeiling, addr 0x36d85dc, size 0x19c, virtual false, abstract: false, final false
  inline void CheckIterationCountCeiling(int32_t iterationCount);

  /// @brief Method GenCalculator, addr 0x36d88f0, size 0x420, virtual false, abstract: false, final false
  ...
  /// @brief Method SetIterationCount, addr 0x36d8564, size 0x78, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crmf::PKMacBuilder* SetIterationCount(int32_t iterationCount);

  /// @brief Method SetParameters, addr 0x36d8778, size 0x54, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crmf::PKMacBuilder* SetParameters(::Org::BouncyCastle::Asn1::Cmp::PbmParameter* parameters);

  /// @brief Method SetSaltLength, addr 0x36d8508, size 0x5c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crmf::PKMacBuilder* SetSaltLength(int32_t saltLength);

  /// @brief Method SetSecureRandom, addr 0x36d87cc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36d8264, size 0x140, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36d83a4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36d83b8, size 0x128, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crmf::IPKMacPrimitivesProvider* provider);

  /// @brief Method .ctor, addr 0x36d84e0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36d84f8, size 0x10, virtual false, abstract: false, final false
