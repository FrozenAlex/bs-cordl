...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crmf::PkiArchiveControl*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crmf::PkiArchiveControl*, "Org.BouncyCastle.Crmf", "PkiArchiveControl");
...
public:
  ...
  /// @brief Method GetEnvelopedData, addr 0x36d77b8, size 0x24c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36d42e0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArchiveType, addr 0x36d7758, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_ArchiveType();

  /// @brief Method get_EnvelopedData, addr 0x36d7774, size 0x44, virtual false, abstract: false, final false
  inline bool get_EnvelopedData();

  /// @brief Method get_Type, addr 0x36d76f4, size 0x5c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Type();

  /// @brief Method get_Value, addr 0x36d7750, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Crmf::PkiArchiveControl) == 0x18, "Size mismatch!");
