...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Agreement::JPake::JPakePrimeOrderGroups*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Agreement::JPake::JPakePrimeOrderGroups*, "Org.BouncyCastle.Crypto.Agreement.JPake", "JPakePrimeOrderGroups");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3620c8c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Agreement::JPake::JPakePrimeOrderGroups) == 0x10, "Size mismatch!");
