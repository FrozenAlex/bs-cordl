...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound1Payload*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound1Payload*, "Org.BouncyCastle.Crypto.Agreement.JPake", "JPakeRound1Payload");
...
public:
  ...
  __declspec(property(get = get_KnowledgeProofForX1)) ::ArrayW<::Org::BouncyCastle::Math::BigInteger*> KnowledgeProofForX1;

  __declspec(property(get = get_KnowledgeProofForX2)) ::ArrayW<::Org::BouncyCastle::Math::BigInteger*> KnowledgeProofForX2;
  ...
  __declspec(property(get = __cordl_internal_get_knowledgeProofForX1, put = __cordl_internal_set_knowledgeProofForX1)) ::ArrayW<::Org::BouncyCastle::Math::BigInteger*> knowledgeProofForX1;

  /// @brief Field knowledgeProofForX2, offset 0x30, size 0x8
  __declspec(property(get = __cordl_internal_get_knowledgeProofForX2, put = __cordl_internal_set_knowledgeProofForX2)) ::ArrayW<::Org::BouncyCastle::Math::BigInteger*> knowledgeProofForX2;
  ...
  static inline ::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound1Payload* New_ctor(::StringW participantId, ::Org::BouncyCastle::Math::BigInteger* gx1,
                                                                                            ::Org::BouncyCastle::Math::BigInteger* gx2,
  ...
  constexpr ::ArrayW<::Org::BouncyCastle::Math::BigInteger*> const& __cordl_internal_get_knowledgeProofForX1() const;

  constexpr ::ArrayW<::Org::BouncyCastle::Math::BigInteger*>& __cordl_internal_get_knowledgeProofForX1();

  constexpr ::ArrayW<::Org::BouncyCastle::Math::BigInteger*> const& __cordl_internal_get_knowledgeProofForX2() const;

  constexpr ::ArrayW<::Org::BouncyCastle::Math::BigInteger*>& __cordl_internal_get_knowledgeProofForX2();
  ...
  constexpr void __cordl_internal_set_knowledgeProofForX1(::ArrayW<::Org::BouncyCastle::Math::BigInteger*> value);

  constexpr void __cordl_internal_set_knowledgeProofForX2(::ArrayW<::Org::BouncyCastle::Math::BigInteger*> value);
...
public:
  ...
  ::ArrayW<::Org::BouncyCastle::Math::BigInteger*> ___knowledgeProofForX1;

  /// @brief Field knowledgeProofForX2, offset: 0x30, size: 0x8, def value: None
  ::ArrayW<::Org::BouncyCastle::Math::BigInteger*> ___knowledgeProofForX2;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound1Payload) == 0x38, "Size mismatch!");
