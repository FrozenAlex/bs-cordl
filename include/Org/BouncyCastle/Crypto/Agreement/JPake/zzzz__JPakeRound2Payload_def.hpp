...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound2Payload*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound2Payload*, "Org.BouncyCastle.Crypto.Agreement.JPake", "JPakeRound2Payload");
...
public:
  ...
  __declspec(property(get = get_KnowledgeProofForX2s)) ::ArrayW<::Org::BouncyCastle::Math::BigInteger*> KnowledgeProofForX2s;
  ...
  __declspec(property(get = __cordl_internal_get_knowledgeProofForX2s, put = __cordl_internal_set_knowledgeProofForX2s)) ::ArrayW<::Org::BouncyCastle::Math::BigInteger*> knowledgeProofForX2s;
  ...
  static inline ::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound2Payload* New_ctor(::StringW participantId, ::Org::BouncyCastle::Math::BigInteger* a,
  ...
  constexpr ::ArrayW<::Org::BouncyCastle::Math::BigInteger*> const& __cordl_internal_get_knowledgeProofForX2s() const;

  constexpr ::ArrayW<::Org::BouncyCastle::Math::BigInteger*>& __cordl_internal_get_knowledgeProofForX2s();
  ...
  constexpr void __cordl_internal_set_knowledgeProofForX2s(::ArrayW<::Org::BouncyCastle::Math::BigInteger*> value);

  constexpr void __cordl_internal_set_participantId(::StringW value);

  /// @brief Method .ctor, addr 0x361f778, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method get_A, addr 0x3620db0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_A();

  /// @brief Method get_KnowledgeProofForX2s, addr 0x3620db8, size 0x80, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Math::BigInteger*> get_KnowledgeProofForX2s();

  /// @brief Method get_ParticipantId, addr 0x3620da8, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  ::ArrayW<::Org::BouncyCastle::Math::BigInteger*> ___knowledgeProofForX2s;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound2Payload) == 0x28, "Size mismatch!");
