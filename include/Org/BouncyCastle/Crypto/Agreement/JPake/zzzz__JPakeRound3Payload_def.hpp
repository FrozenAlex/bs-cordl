...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound3Payload*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound3Payload*, "Org.BouncyCastle.Crypto.Agreement.JPake", "JPakeRound3Payload");
...
public:
  ...
  /// @brief Method .ctor, addr 0x36202d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW participantId, ::Org::BouncyCastle::Math::BigInteger* magTag);

  /// @brief Method get_MacTag, addr 0x3620e40, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_MacTag();

  /// @brief Method get_ParticipantId, addr 0x3620e38, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound3Payload) == 0x20, "Size mismatch!");
