...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Agreement::Kdf::ConcatenationKdfGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Agreement::Kdf::ConcatenationKdfGenerator*, "Org.BouncyCastle.Crypto.Agreement.Kdf", "ConcatenationKdfGenerator");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_mOtherInfo, put = __cordl_internal_set_mOtherInfo)) ::ArrayW<uint8_t> mOtherInfo;

  /// @brief Field mShared, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get_mShared, put = __cordl_internal_set_mShared)) ::ArrayW<uint8_t> mShared;

  /// @brief Convert operator to "::Org::BouncyCastle::Crypto::IDerivationFunction"
  constexpr operator ::Org::BouncyCastle::Crypto::IDerivationFunction*() noexcept;

  /// @brief Method GenerateBytes, addr 0x36dc518, size 0x5dc, virtual true, abstract: false, final false
  inline int32_t GenerateBytes(::ArrayW<uint8_t> outBytes, int32_t outOff, int32_t len);

  /// @brief Method Init, addr 0x36dc43c, size 0xd4, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_mOtherInfo() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_mOtherInfo();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_mShared() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_mShared();
  ...
  constexpr void __cordl_internal_set_mOtherInfo(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_mShared(::ArrayW<uint8_t> value);

  /// @brief Method .ctor, addr 0x36dc380, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_Digest, addr 0x36dc510, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Agreement::Kdf::ConcatenationKdfGenerator) == 0x30, "Size mismatch!");
