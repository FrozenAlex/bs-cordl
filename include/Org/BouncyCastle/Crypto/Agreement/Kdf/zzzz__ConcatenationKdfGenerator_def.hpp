...
public:
  ...
  /// @brief Method GenerateBytes, addr 0x3621a98, size 0x5dc, virtual true, abstract: false, final false
  inline int32_t GenerateBytes(::ArrayW<uint8_t> outBytes, int32_t outOff, int32_t len);

  /// @brief Method Init, addr 0x36219bc, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3621900, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_Digest, addr 0x3621a90, size 0x8, virtual true, abstract: false, final false
