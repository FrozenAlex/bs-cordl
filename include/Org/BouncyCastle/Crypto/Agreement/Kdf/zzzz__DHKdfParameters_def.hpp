...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Agreement::Kdf::DHKdfParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Agreement::Kdf::DHKdfParameters*, "Org.BouncyCastle.Crypto.Agreement.Kdf", "DHKdfParameters");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_extraInfo, put = __cordl_internal_set_extraInfo)) ::ArrayW<uint8_t> extraInfo;
  ...
  /// @brief Method GetExtraInfo, addr 0x36dcb2c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetExtraInfo();

  /// @brief Method GetZ, addr 0x36dcb24, size 0x8, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_extraInfo() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_extraInfo();
  ...
  constexpr void __cordl_internal_set_extraInfo(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_keySize(int32_t value);

  constexpr void __cordl_internal_set_z(::ArrayW<uint8_t> value);

  /// @brief Method .ctor, addr 0x36dcaf4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* algorithm, int32_t keySize, ::ArrayW<uint8_t> z);

  /// @brief Method .ctor, addr 0x36dcb04, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Algorithm, addr 0x36dcb14, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Algorithm();

  /// @brief Method get_KeySize, addr 0x36dcb1c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Agreement::Kdf::DHKdfParameters) == 0x30, "Size mismatch!");
