...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Agreement::Kdf::DHKekGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Agreement::Kdf::DHKekGenerator*, "Org.BouncyCastle.Crypto.Agreement.Kdf", "DHKekGenerator");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_partyAInfo, put = __cordl_internal_set_partyAInfo)) ::ArrayW<uint8_t> partyAInfo;
  ...
  /// @brief Method GenerateBytes, addr 0x3622168, size 0x6e8, virtual true, abstract: false, final false
  inline int32_t GenerateBytes(::ArrayW<uint8_t> outBytes, int32_t outOff, int32_t len);

  /// @brief Method Init, addr 0x36220bc, size 0xa4, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_partyAInfo() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_partyAInfo();
  ...
  constexpr void __cordl_internal_set_partyAInfo(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_z(::ArrayW<uint8_t> value);

  /// @brief Method .ctor, addr 0x36220b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_Digest, addr 0x3622160, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Agreement::Kdf::DHKekGenerator) == 0x38, "Size mismatch!");
