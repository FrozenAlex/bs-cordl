...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Agreement::DHStandardGroups*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Agreement::DHStandardGroups*, "Org.BouncyCastle.Crypto.Agreement", "DHStandardGroups");
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Agreement::DHStandardGroups) == 0x10, "Size mismatch!");
