...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Agreement::SM2KeyExchange*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Agreement::SM2KeyExchange*, "Org.BouncyCastle.Crypto.Agreement", "SM2KeyExchange");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_mUserID, put = __cordl_internal_set_mUserID)) ::ArrayW<uint8_t> mUserID;
  ...
  /// @brief Method AddFieldElement, addr 0x36e2bd4, size 0xe0, virtual false, abstract: false, final false
  inline void AddFieldElement(::Org::BouncyCastle::Crypto::IDigest* digest, ::Org::BouncyCastle::Math::EC::ECFieldElement* v);

  /// @brief Method AddUserID, addr 0x36e2cb4, size 0x18c, virtual false, abstract: false, final false
  inline void AddUserID(::Org::BouncyCastle::Crypto::IDigest* digest, ::ArrayW<uint8_t> userID);

  /// @brief Method CalculateInnerHash, addr 0x36e1de8, size 0x220, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> CalculateInnerHash(::Org::BouncyCastle::Crypto::IDigest* digest, ::Org::BouncyCastle::Math::EC::ECPoint* u, ::ArrayW<uint8_t> za, ::ArrayW<uint8_t> zb,
                                              ::Org::BouncyCastle::Math::EC::ECPoint* p1, ::Org::BouncyCastle::Math::EC::ECPoint* p2);

  /// @brief Method CalculateKey, addr 0x36e1698, size 0x1d4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> CalculateKey(int32_t kLen, ::Org::BouncyCastle::Crypto::ICipherParameters* pubParam);

  /// @brief Method CalculateKeyWithConfirmation, addr 0x36e19d8, size 0x410, virtual true, abstract: false, final false
  inline ::ArrayW<::ArrayW<uint8_t>> CalculateKeyWithConfirmation(int32_t kLen, ::ArrayW<uint8_t> confirmationTag, ::Org::BouncyCastle::Crypto::ICipherParameters* pubParam);

  /// @brief Method CalculateU, addr 0x36e2300, size 0x1cc, virtual true, abstract: false, final false
  ...
  /// @brief Method GetZ, addr 0x36e186c, size 0x16c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetZ(::Org::BouncyCastle::Crypto::IDigest* digest, ::ArrayW<uint8_t> userID, ::Org::BouncyCastle::Math::EC::ECPoint* pubPoint);

  /// @brief Method Init, addr 0x36e14b0, size 0x1e8, virtual true, abstract: false, final false
  inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters* privParam);

  /// @brief Method Kdf, addr 0x36e2584, size 0x650, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> Kdf(::Org::BouncyCastle::Math::EC::ECPoint* u, ::ArrayW<uint8_t> za, ::ArrayW<uint8_t> zb, int32_t klen);
  ...
  /// @brief Method Reduce, addr 0x36e24cc, size 0xb8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* Reduce(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method S1, addr 0x36e2008, size 0x17c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> S1(::Org::BouncyCastle::Crypto::IDigest* digest, ::Org::BouncyCastle::Math::EC::ECPoint* u, ::ArrayW<uint8_t> inner);

  /// @brief Method S2, addr 0x36e2184, size 0x17c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> S2(::Org::BouncyCastle::Crypto::IDigest* digest, ::Org::BouncyCastle::Math::EC::ECPoint* u, ::ArrayW<uint8_t> inner);
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_mUserID() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_mUserID();
  ...
  constexpr void __cordl_internal_set_mUserID(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_mW(int32_t value);

  /// @brief Method .ctor, addr 0x36e144c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36e14a8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Agreement::SM2KeyExchange) == 0x58, "Size mismatch!");
