...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Agreement::X25519Agreement*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Agreement::X25519Agreement*, "Org.BouncyCastle.Crypto.Agreement", "X25519Agreement");
...
public:
  ...
  /// @brief Method CalculateAgreement, addr 0x36e2f1c, size 0x98, virtual true, abstract: false, final true
  inline void CalculateAgreement(::Org::BouncyCastle::Crypto::ICipherParameters* publicKey, ::ArrayW<uint8_t> buf, int32_t off);

  /// @brief Method Init, addr 0x36e2e40, size 0x80, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x36e2fb4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AgreementSize, addr 0x36e2ec0, size 0x5c, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Agreement::X25519Agreement) == 0x18, "Size mismatch!");
