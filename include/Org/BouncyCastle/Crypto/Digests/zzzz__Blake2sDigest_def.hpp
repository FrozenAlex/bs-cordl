...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Digests::Blake2sDigest*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Digests::Blake2sDigest*, "Org.BouncyCastle.Crypto.Digests", "Blake2sDigest");
...
public:
  ...
  __declspec(property(get = getStaticF_blake2s_IV, put = setStaticF_blake2s_IV)) ::ArrayW<uint32_t> blake2s_IV;
  ...
  __declspec(property(get = __cordl_internal_get_chainValue, put = __cordl_internal_set_chainValue)) ::ArrayW<uint32_t> chainValue;
  ...
  __declspec(property(get = __cordl_internal_get_internalState, put = __cordl_internal_set_internalState)) ::ArrayW<uint32_t> internalState;
  ...
  /// @brief Method BlockUpdate, addr 0x362ae58, size 0x140, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t> message, int32_t offset, int32_t len);

  /// @brief Method ClearKey, addr 0x362b254, size 0x48, virtual true, abstract: false, final false
  inline void ClearKey();

  /// @brief Method ClearSalt, addr 0x362b29c, size 0x1c, virtual true, abstract: false, final false
  inline void ClearSalt();

  /// @brief Method Compress, addr 0x362a8bc, size 0x59c, virtual false, abstract: false, final false
  inline void Compress(::ArrayW<uint8_t> message, int32_t messagePos);

  /// @brief Method DoFinal, addr 0x362af98, size 0x130, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOffset);

  /// @brief Method G, addr 0x362b12c, size 0xcc, virtual false, abstract: false, final false
  inline void G(uint32_t m1, uint32_t m2, int32_t posA, int32_t posB, int32_t posC, int32_t posD);

  /// @brief Method GetByteLength, addr 0x362b24c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetByteLength();

  /// @brief Method GetDigestSize, addr 0x362b244, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetDigestSize();

  /// @brief Method Init, addr 0x362a078, size 0x29c, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method InitializeInternalState, addr 0x362a6c4, size 0x140, virtual false, abstract: false, final false
  ...
  static inline ::Org::BouncyCastle::Crypto::Digests::Blake2sDigest* New_ctor(::ArrayW<uint8_t> key);

  static inline ::Org::BouncyCastle::Crypto::Digests::Blake2sDigest* New_ctor(::ArrayW<uint8_t> key, int32_t digestBytes, ::ArrayW<uint8_t> salt, ::ArrayW<uint8_t> personalization);

  /// @brief Method Reset, addr 0x362b0c8, size 0x64, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x362a804, size 0xb8, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<uint32_t> const& __cordl_internal_get_chainValue() const;

  constexpr ::ArrayW<uint32_t>& __cordl_internal_get_chainValue();
  ...
  constexpr ::ArrayW<uint32_t> const& __cordl_internal_get_internalState() const;

  constexpr ::ArrayW<uint32_t>& __cordl_internal_get_internalState();
  ...
  constexpr void __cordl_internal_set_chainValue(::ArrayW<uint32_t> value);

  constexpr void __cordl_internal_set_digestLength(int32_t value);

  constexpr void __cordl_internal_set_f0(uint32_t value);

  constexpr void __cordl_internal_set_internalState(::ArrayW<uint32_t> value);
  ...
  /// @brief Method .ctor, addr 0x3629e50, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3629f68, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::Blake2sDigest* digest);

  /// @brief Method .ctor, addr 0x3629e58, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(int32_t digestBits);

  /// @brief Method .ctor, addr 0x362a314, size 0x15c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> key);

  /// @brief Method .ctor, addr 0x362a470, size 0x254, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> key, int32_t digestBytes, ::ArrayW<uint8_t> salt, ::ArrayW<uint8_t> personalization);

  static inline ::ArrayW<uint32_t> getStaticF_blake2s_IV();

  static inline ::System::Object* getStaticF_blake2s_sigma();

  /// @brief Method get_AlgorithmName, addr 0x362b200, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Convert to "::Org::BouncyCastle::Crypto::IDigest"
  constexpr ::Org::BouncyCastle::Crypto::IDigest* i___Org__BouncyCastle__Crypto__IDigest() noexcept;

  /// @brief Method rotr32, addr 0x362b1f8, size 0x8, virtual false, abstract: false, final false
  inline uint32_t rotr32(uint32_t x, int32_t rot);

  static inline void setStaticF_blake2s_IV(::ArrayW<uint32_t> value);
...
public:
  ...
  ::ArrayW<uint32_t> ___internalState;

  /// @brief Field chainValue, offset: 0x48, size: 0x8, def value: None
  ::ArrayW<uint32_t> ___chainValue;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Digests::Blake2sDigest) == 0x60, "Size mismatch!");
