...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x36e61c0, size 0x128, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t length);

  /// @brief Method Copy, addr 0x36e7070, size 0x5c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method CopyIn, addr 0x36e5e48, size 0x140, virtual false, abstract: false, final false
  inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::Dstu7564Digest* digest);

  /// @brief Method DoFinal, addr 0x36e62e8, size 0x28c, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method GetByteLength, addr 0x36e613c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetByteLength();

  /// @brief Method GetDigestSize, addr 0x36e6134, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetDigestSize();

  /// @brief Method MixColumn, addr 0x36e6fac, size 0xbc, virtual false, abstract: false, final false
  static inline uint64_t MixColumn(uint64_t c);

  /// @brief Method MixColumns, addr 0x36e6eec, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method P, addr 0x36e6574, size 0xb4, virtual false, abstract: false, final false
  inline void P(::ArrayW<uint64_t> s);

  /// @brief Method ProcessBlock, addr 0x36e6678, size 0x16c, virtual true, abstract: false, final false
  inline void ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff);

  /// @brief Method Q, addr 0x36e67e4, size 0xd4, virtual false, abstract: false, final false
  inline void Q(::ArrayW<uint64_t> s);

  /// @brief Method Reset, addr 0x36e6628, size 0x50, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x36e70cc, size 0x90, virtual true, abstract: false, final false
  inline void Reset(::Org::BouncyCastle::Utilities::IMemoable* other);

  /// @brief Method Rotate, addr 0x36e7068, size 0x8, virtual false, abstract: false, final false
  static inline uint64_t Rotate(int32_t n, uint64_t x);

  /// @brief Method ShiftRows, addr 0x36e68b8, size 0x47c, virtual false, abstract: false, final false
  inline void ShiftRows(::ArrayW<uint64_t> s);

  /// @brief Method SubBytes, addr 0x36e6d34, size 0x1b8, virtual false, abstract: false, final false
  inline void SubBytes(::ArrayW<uint64_t> s);

  /// @brief Method Update, addr 0x36e6144, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36e5e44, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::Dstu7564Digest* digest);

  /// @brief Method .ctor, addr 0x36e5f88, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x36e60f0, size 0x44, virtual true, abstract: false, final false
