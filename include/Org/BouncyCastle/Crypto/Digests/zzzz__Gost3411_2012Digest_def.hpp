...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Digests::Gost3411_2012Digest*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Digests::Gost3411_2012Digest*, "Org.BouncyCastle.Crypto.Digests", "Gost3411_2012Digest");
...
public:
  ...
  __declspec(property(get = getStaticF_C, put = setStaticF_C)) ::ArrayW<::ArrayW<uint8_t>> C;
  ...
  __declspec(property(get = __cordl_internal_get_N, put = __cordl_internal_set_N)) ::ArrayW<uint8_t> N;

  /// @brief Field Sigma, offset 0x20, size 0x8
  __declspec(property(get = __cordl_internal_get_Sigma, put = __cordl_internal_set_Sigma)) ::ArrayW<uint8_t> Sigma;

  /// @brief Field T, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_T, put = setStaticF_T)) ::ArrayW<::ArrayW<uint64_t>> T;

  /// @brief Field Zero, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Zero, put = setStaticF_Zero)) ::ArrayW<uint8_t> Zero;
  ...
  __declspec(property(get = __cordl_internal_get_tmp, put = __cordl_internal_set_tmp)) ::ArrayW<uint8_t> tmp;
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_N() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_N();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_Sigma() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_Sigma();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_tmp() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_tmp();

  constexpr void __cordl_internal_set_IV(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_Ki(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_N(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_Sigma(::ArrayW<uint8_t> value);
  ...
  static inline ::ArrayW<::ArrayW<uint64_t>> getStaticF_T();
  ...
  static inline void setStaticF_T(::ArrayW<::ArrayW<uint64_t>> value);
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Digests::Gost3411_2012Digest) == 0x58, "Size mismatch!");
