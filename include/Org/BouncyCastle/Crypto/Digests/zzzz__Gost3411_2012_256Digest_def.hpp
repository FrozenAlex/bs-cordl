...
public:
  ...
  /// @brief Method Copy, addr 0x36ead2c, size 0x5c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method DoFinal, addr 0x36eac98, size 0x94, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method GetDigestSize, addr 0x36eac90, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36eab50, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36eabe4, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x36eab0c, size 0x44, virtual true, abstract: false, final false
