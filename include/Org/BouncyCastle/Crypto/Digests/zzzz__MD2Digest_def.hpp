...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Digests::MD2Digest*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Digests::MD2Digest*, "Org.BouncyCastle.Crypto.Digests", "MD2Digest");
...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x36ed69c, size 0x11c, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t length);

  /// @brief Method Copy, addr 0x36ed7b8, size 0x5c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method CopyIn, addr 0x36ed1e0, size 0x9c, virtual false, abstract: false, final false
  inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::MD2Digest* t);

  /// @brief Method DoFinal, addr 0x36ed2d0, size 0xb0, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method GetByteLength, addr 0x36ed2c8, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetByteLength();

  /// @brief Method GetDigestSize, addr 0x36ed2c0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0x36ed4a0, size 0x194, virtual false, abstract: false, final false
  inline void ProcessBlock(::ArrayW<uint8_t> m);

  /// @brief Method ProcessChecksum, addr 0x36ed380, size 0x120, virtual false, abstract: false, final false
  inline void ProcessChecksum(::ArrayW<uint8_t> m);

  /// @brief Method Reset, addr 0x36ed094, size 0xb8, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Reset, addr 0x36ed814, size 0x90, virtual true, abstract: false, final true
  inline void Reset(::Org::BouncyCastle::Utilities::IMemoable* other);

  /// @brief Method Update, addr 0x36ed634, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x36ed010, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36ed14c, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::MD2Digest* t);

  static inline ::ArrayW<uint8_t> getStaticF_S();

  /// @brief Method get_AlgorithmName, addr 0x36ed27c, size 0x44, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Digests::MD2Digest) == 0x40, "Size mismatch!");
