...
public:
  ...
  /// @brief Method Copy, addr 0x36ef3d4, size 0x5c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method CopyIn, addr 0x36ee598, size 0x5c, virtual false, abstract: false, final false
  inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::MD5Digest* t);

  /// @brief Method DoFinal, addr 0x36ee784, size 0x90, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method F, addr 0x36ee874, size 0x10, virtual false, abstract: false, final false
  static inline uint32_t F(uint32_t u, uint32_t v, uint32_t w);

  /// @brief Method G, addr 0x36ee884, size 0x10, virtual false, abstract: false, final false
  static inline uint32_t G(uint32_t u, uint32_t v, uint32_t w);

  /// @brief Method GetDigestSize, addr 0x36ee638, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetDigestSize();

  /// @brief Method H, addr 0x36ee894, size 0xc, virtual false, abstract: false, final false
  static inline uint32_t H(uint32_t u, uint32_t v, uint32_t w);

  /// @brief Method K, addr 0x36ee8a0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x36ee8ac, size 0xb28, virtual true, abstract: false, final false
  inline void ProcessBlock();

  /// @brief Method ProcessLength, addr 0x36ee6c0, size 0xc4, virtual true, abstract: false, final false
  inline void ProcessLength(int64_t bitLength);

  /// @brief Method ProcessWord, addr 0x36ee640, size 0x80, virtual true, abstract: false, final false
  inline void ProcessWord(::ArrayW<uint8_t> input, int32_t inOff);

  /// @brief Method Reset, addr 0x36ee814, size 0x54, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x36ef430, size 0x90, virtual true, abstract: false, final false
  inline void Reset(::Org::BouncyCastle::Utilities::IMemoable* other);

  /// @brief Method RotateLeft, addr 0x36ee868, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36ee4b0, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36ee520, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x36ee5f4, size 0x44, virtual true, abstract: false, final false
