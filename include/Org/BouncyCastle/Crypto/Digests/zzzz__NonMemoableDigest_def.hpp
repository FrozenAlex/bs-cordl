...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x36ef78c, size 0xd0, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0x36ef85c, size 0xc0, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method GetByteLength, addr 0x36ef9c4, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetByteLength();

  /// @brief Method GetDigestSize, addr 0x36ef62c, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetDigestSize();

  static inline ::Org::BouncyCastle::Crypto::Digests::NonMemoableDigest* New_ctor(::Org::BouncyCastle::Crypto::IDigest* baseDigest);

  /// @brief Method Reset, addr 0x36ef91c, size 0xa8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x36ef6d4, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36ef530, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* baseDigest);

  /// @brief Method get_AlgorithmName, addr 0x36ef588, size 0xa4, virtual true, abstract: false, final false
