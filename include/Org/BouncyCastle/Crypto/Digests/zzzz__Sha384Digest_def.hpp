...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Digests::Sha384Digest*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Digests::Sha384Digest*, "Org.BouncyCastle.Crypto.Digests", "Sha384Digest");
...
public:
  ...
  /// @brief Method Copy, addr 0x32c662c, size 0x5c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method DoFinal, addr 0x32c64dc, size 0x108, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method GetDigestSize, addr 0x32c64d4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x32c65e4, size 0x48, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x32c6688, size 0x94, virtual true, abstract: false, final false
  inline void Reset(::Org::BouncyCastle::Utilities::IMemoable* other);

  /// @brief Method .ctor, addr 0x32c63c8, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x32c6424, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::Sha384Digest* t);

  /// @brief Method get_AlgorithmName, addr 0x32c6490, size 0x44, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Digests::Sha384Digest) == 0x88, "Size mismatch!");
