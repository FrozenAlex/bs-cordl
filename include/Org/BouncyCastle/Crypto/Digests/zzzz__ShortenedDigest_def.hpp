...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Digests::ShortenedDigest*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Digests::ShortenedDigest*, "Org.BouncyCastle.Crypto.Digests", "ShortenedDigest");
...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x32c7ef4, size 0xd0, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t length);

  /// @brief Method DoFinal, addr 0x32c7fc4, size 0x17c, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method GetByteLength, addr 0x32c81e8, size 0xa8, virtual true, abstract: false, final true
  inline int32_t GetByteLength();

  /// @brief Method GetDigestSize, addr 0x32c7e34, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x32c8140, size 0xa8, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0x32c7e3c, size 0xb8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32c7b08, size 0x140, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* baseDigest, int32_t length);

  /// @brief Method get_AlgorithmName, addr 0x32c7c48, size 0x1ec, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Digests::ShortenedDigest) == 0x20, "Size mismatch!");
