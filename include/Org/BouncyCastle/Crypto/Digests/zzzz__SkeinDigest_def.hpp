...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Digests::SkeinDigest*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Digests::SkeinDigest*, "Org.BouncyCastle.Crypto.Digests", "SkeinDigest");
...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x32c8ae8, size 0x14, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t len);

  /// @brief Method Copy, addr 0x32c8728, size 0x5c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method DoFinal, addr 0x32c8b48, size 0x14, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t> outBytes, int32_t outOff);

  /// @brief Method GetByteLength, addr 0x32c896c, size 0x2c, virtual true, abstract: false, final true
  inline int32_t GetByteLength();

  /// @brief Method GetDigestSize, addr 0x32c8954, size 0x18, virtual true, abstract: false, final true
  inline int32_t GetDigestSize();

  /// @brief Method Init, addr 0x32c8484, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x32c8a4c, size 0x14, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Reset, addr 0x32c8564, size 0x98, virtual true, abstract: false, final true
  inline void Reset(::Org::BouncyCastle::Utilities::IMemoable* other);

  /// @brief Method Update, addr 0x32c8aa0, size 0x14, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32c8498, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::SkeinDigest* digest);

  /// @brief Method .ctor, addr 0x32c8290, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(int32_t stateSizeBits, int32_t digestSizeBits);

  /// @brief Method get_AlgorithmName, addr 0x32c8784, size 0x1b0, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Digests::SkeinDigest) == 0x18, "Size mismatch!");
