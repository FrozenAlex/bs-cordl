...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Encodings::ISO9796d1Encoding*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Encodings::ISO9796d1Encoding*, "Org.BouncyCastle.Crypto.Encodings", "ISO9796d1Encoding");
...
public:
  ...
  __declspec(property(get = getStaticF_inverse, put = setStaticF_inverse)) ::ArrayW<uint8_t> inverse;
  ...
  __declspec(property(get = getStaticF_shadows, put = setStaticF_shadows)) ::ArrayW<uint8_t> shadows;

  /// @brief Convert operator to "::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher"
  constexpr operator ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher*() noexcept;

  /// @brief Method DecodeBlock, addr 0x32d4c34, size 0x4c8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> DecodeBlock(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen);

  /// @brief Method EncodeBlock, addr 0x32d48ec, size 0x348, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> EncodeBlock(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen);

  /// @brief Method GetInputBlockSize, addr 0x32d46e8, size 0xc8, virtual true, abstract: false, final true
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x32d47b0, size 0xc8, virtual true, abstract: false, final true
  inline int32_t GetOutputBlockSize();

  /// @brief Method GetPadBits, addr 0x32d48d4, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetPadBits();

  /// @brief Method GetUnderlyingCipher, addr 0x32d4524, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init, addr 0x32d452c, size 0x1bc, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0x32d48dc, size 0x10, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, int32_t length);

  /// @brief Method SetPadBits, addr 0x32d4878, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32d4450, size 0xc, virtual false, abstract: false, final false
  ...
  static inline ::ArrayW<uint8_t> getStaticF_inverse();

  static inline ::ArrayW<uint8_t> getStaticF_shadows();

  /// @brief Method get_AlgorithmName, addr 0x32d445c, size 0xc8, virtual true, abstract: false, final true
  ...
  static inline void setStaticF_inverse(::ArrayW<uint8_t> value);

  static inline void setStaticF_shadows(::ArrayW<uint8_t> value);
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Encodings::ISO9796d1Encoding) == 0x30, "Size mismatch!");
