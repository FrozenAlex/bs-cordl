...
public:
  ...
  /// @brief Method DecryptBlock, addr 0x33986d0, size 0x9bc, virtual false, abstract: false, final false
  inline void DecryptBlock(::ArrayW<::ArrayW<uint32_t>> KW);

  /// @brief Method EncryptBlock, addr 0x3397cd0, size 0xa00, virtual false, abstract: false, final false
  inline void EncryptBlock(::ArrayW<::ArrayW<uint32_t>> KW);

  /// @brief Method FFmulX, addr 0x3396c78, size 0x20, virtual false, abstract: false, final false
  static inline uint32_t FFmulX(uint32_t x);

  /// @brief Method FFmulX2, addr 0x3396c98, size 0x1c, virtual false, abstract: false, final false
  static inline uint32_t FFmulX2(uint32_t x);

  /// @brief Method GenerateWorkingKey, addr 0x3396e94, size 0xb18, virtual false, abstract: false, final false
  inline ::ArrayW<::ArrayW<uint32_t>> GenerateWorkingKey(::ArrayW<uint8_t> key, bool forEncryption);

  /// @brief Method GetBlockSize, addr 0x3397b1c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method Init, addr 0x33979b0, size 0x120, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method Inv_Mcol, addr 0x3396d30, size 0x9c, virtual false, abstract: false, final false
  static inline uint32_t Inv_Mcol(uint32_t x);

  /// @brief Method Mcol, addr 0x3396cb4, size 0x7c, virtual false, abstract: false, final false
  static inline uint32_t Mcol(uint32_t x);

  static inline ::Org::BouncyCastle::Crypto::Engines::AesLightEngine* New_ctor();

  /// @brief Method PackBlock, addr 0x339908c, size 0x64, virtual false, abstract: false, final false
  inline void PackBlock(::ArrayW<uint8_t> bytes, int32_t off);

  /// @brief Method ProcessBlock, addr 0x3397b24, size 0x13c, virtual true, abstract: false, final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method Reset, addr 0x33990f0, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Shift, addr 0x3396c70, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t Shift(uint32_t r, int32_t shift);

  /// @brief Method SubWord, addr 0x3396dcc, size 0xc8, virtual false, abstract: false, final false
  static inline uint32_t SubWord(uint32_t x);

  /// @brief Method UnPackBlock, addr 0x3397c60, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33979ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AlgorithmName, addr 0x3397ad0, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x3397b14, size 0x8, virtual true, abstract: false, final false
