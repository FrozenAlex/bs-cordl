...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Engines::AesWrapEngine*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Engines::AesWrapEngine*, "Org.BouncyCastle.Crypto.Engines", "AesWrapEngine");
...
public:
  ...
  /// @brief Method .ctor, addr 0x32df2f0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Engines::AesWrapEngine) == 0x30, "Size mismatch!");
