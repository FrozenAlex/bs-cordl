...
public:
  ...
  /// @brief Method DecryptBlock, addr 0x32dfbb8, size 0x188, virtual false, abstract: false, final false
  inline void DecryptBlock(::ArrayW<uint8_t> src, int32_t srcIndex, ::ArrayW<uint8_t> dst, int32_t dstIndex);

  /// @brief Method EncryptBlock, addr 0x32dfa10, size 0x1a8, virtual false, abstract: false, final false
  inline void EncryptBlock(::ArrayW<uint8_t> src, int32_t srcIndex, ::ArrayW<uint8_t> dst, int32_t dstIndex);

  /// @brief Method F, addr 0x32dfd4c, size 0xa0, virtual false, abstract: false, final false
  inline uint32_t F(uint32_t x);

  /// @brief Method GetBlockSize, addr 0x32dfd44, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetBlockSize();

  /// @brief Method Init, addr 0x32df43c, size 0x144, virtual true, abstract: false, final true
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::BlowfishEngine* New_ctor();

  /// @brief Method ProcessBlock, addr 0x32df8d4, size 0x13c, virtual true, abstract: false, final true
  inline int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method ProcessTable, addr 0x32dfdec, size 0x1b0, virtual false, abstract: false, final false
  inline void ProcessTable(uint32_t xl, uint32_t xr, ::ArrayW<uint32_t> table);

  /// @brief Method Reset, addr 0x32dfd40, size 0x4, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method SetKey, addr 0x32df580, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32df348, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AlgorithmName, addr 0x32df888, size 0x44, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x32df8cc, size 0x8, virtual true, abstract: false, final true
