...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Engines::DesEdeWrapEngine*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Engines::DesEdeWrapEngine*, "Org.BouncyCastle.Crypto.Engines", "DesEdeWrapEngine");
...
public:
  ...
  /// @brief Method CalculateCmsKeyChecksum, addr 0x32ed7cc, size 0x188, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> CalculateCmsKeyChecksum(::ArrayW<uint8_t> key);

  /// @brief Method CheckCmsKeyChecksum, addr 0x32ede18, size 0x84, virtual false, abstract: false, final false
  inline bool CheckCmsKeyChecksum(::ArrayW<uint8_t> key, ::ArrayW<uint8_t> checksum);

  /// @brief Method Init, addr 0x32ed0a0, size 0x3b0, virtual true, abstract: false, final false
  ...
  /// @brief Method Unwrap, addr 0x32ed9fc, size 0x41c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> Unwrap(::ArrayW<uint8_t> input, int32_t inOff, int32_t length);

  /// @brief Method Wrap, addr 0x32ed494, size 0x338, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32edf34, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<uint8_t> getStaticF_IV2();

  /// @brief Method get_AlgorithmName, addr 0x32ed450, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method reverse, addr 0x32ed954, size 0xa8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Engines::DesEdeWrapEngine) == 0x48, "Size mismatch!");
