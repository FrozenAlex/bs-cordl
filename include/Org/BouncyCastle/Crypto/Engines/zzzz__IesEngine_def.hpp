...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Engines::IesEngine*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Engines::IesEngine*, "Org.BouncyCastle.Crypto.Engines", "IesEngine");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_macBuf, put = __cordl_internal_set_macBuf)) ::ArrayW<uint8_t> macBuf;
  ...
  /// @brief Method DecryptBlock, addr 0x32f5c7c, size 0x6b4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> DecryptBlock(::ArrayW<uint8_t> in_enc, int32_t inOff, int32_t inLen, ::ArrayW<uint8_t> z);

  /// @brief Method EncryptBlock, addr 0x32f6490, size 0x5e8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> EncryptBlock(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen, ::ArrayW<uint8_t> z);

  /// @brief Method GenerateKdfBytes, addr 0x32f6330, size 0x160, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateKdfBytes(::Org::BouncyCastle::Crypto::Parameters::KdfParameters* kParam, int32_t length);

  /// @brief Method Init, addr 0x32f5ba8, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x32f6a78, size 0x274, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen);

  constexpr ::Org::BouncyCastle::Crypto::IBasicAgreement* const& __cordl_internal_get_agree() const;

  constexpr ::Org::BouncyCastle::Crypto::IBasicAgreement*& __cordl_internal_get_agree();

  constexpr ::Org::BouncyCastle::Crypto::BufferedBlockCipher* const& __cordl_internal_get_cipher() const;
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_macBuf() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_macBuf();

  constexpr ::Org::BouncyCastle::Crypto::Parameters::IesParameters* const& __cordl_internal_get_param() const;

  constexpr ::Org::BouncyCastle::Crypto::Parameters::IesParameters*& __cordl_internal_get_param();

  constexpr ::Org::BouncyCastle::Crypto::ICipherParameters* const& __cordl_internal_get_privParam() const;

  constexpr ::Org::BouncyCastle::Crypto::ICipherParameters*& __cordl_internal_get_privParam();

  constexpr ::Org::BouncyCastle::Crypto::ICipherParameters* const& __cordl_internal_get_pubParam() const;
  ...
  constexpr void __cordl_internal_set_macBuf(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x32f59b4, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32f5aac, size 0xfc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBasicAgreement* agree, ::Org::BouncyCastle::Crypto::IDerivationFunction* kdf, ::Org::BouncyCastle::Crypto::IMac* mac,
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Engines::IesEngine) == 0x58, "Size mismatch!");
