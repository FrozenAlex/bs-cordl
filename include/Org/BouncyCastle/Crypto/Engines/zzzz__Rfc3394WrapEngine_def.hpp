...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Engines::Rfc3394WrapEngine*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Engines::Rfc3394WrapEngine*, "Org.BouncyCastle.Crypto.Engines", "Rfc3394WrapEngine");
...
public:
  ...
  /// @brief Method Init, addr 0x32de818, size 0x228, virtual true, abstract: false, final false
  ...
  /// @brief Method Unwrap, addr 0x32deea8, size 0x448, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> Unwrap(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen);

  /// @brief Method Wrap, addr 0x32deae4, size 0x3c4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32de78c, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* engine);

  /// @brief Method get_AlgorithmName, addr 0x32dea40, size 0xa4, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Engines::Rfc3394WrapEngine) == 0x30, "Size mismatch!");
