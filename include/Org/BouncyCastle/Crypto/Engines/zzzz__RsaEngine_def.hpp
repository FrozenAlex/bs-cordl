...
public:
  ...
  /// @brief Method GetInputBlockSize, addr 0x33bcd70, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x33bce18, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetOutputBlockSize();

  /// @brief Method Init, addr 0x33bccb4, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x33bcec0, size 0x1a8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33bcc18, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33bcc68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IRsa* rsa);

  /// @brief Method get_AlgorithmName, addr 0x33bcc70, size 0x44, virtual true, abstract: false, final false
