...
public:
  ...
  /// @brief Method AdvanceCounter, addr 0x33a539c, size 0x4c, virtual true, abstract: false, final false
  inline void AdvanceCounter();

  /// @brief Method GenerateKeyStream, addr 0x33a58ec, size 0x88, virtual true, abstract: false, final false
  inline void GenerateKeyStream(::ArrayW<uint8_t> output);

  /// @brief Method Init, addr 0x33a4de4, size 0x38c, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method LimitExceeded, addr 0x33a535c, size 0x40, virtual false, abstract: false, final false
  inline bool LimitExceeded();

  /// @brief Method LimitExceeded, addr 0x33a5664, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method PackTauOrSigma, addr 0x33a4b48, size 0x138, virtual false, abstract: false, final false
  inline void PackTauOrSigma(int32_t keyLength, ::ArrayW<uint32_t> state, int32_t stateOffset);

  /// @brief Method ProcessBytes, addr 0x33a53e8, size 0x27c, virtual true, abstract: false, final false
  inline void ProcessBytes(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t len, ::ArrayW<uint8_t> outBytes, int32_t outOff);

  /// @brief Method Reset, addr 0x33a56a4, size 0x1c, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ResetCounter, addr 0x33a56cc, size 0x2c, virtual true, abstract: false, final false
  inline void ResetCounter();

  /// @brief Method ResetLimitCounter, addr 0x33a56c0, size 0xc, virtual false, abstract: false, final false
  inline void ResetLimitCounter();

  /// @brief Method ReturnByte, addr 0x33a525c, size 0x100, virtual true, abstract: false, final false
  inline uint8_t ReturnByte(uint8_t input);

  /// @brief Method SalsaCore, addr 0x33a5974, size 0x2ac, virtual false, abstract: false, final false
  static inline void SalsaCore(int32_t rounds, ::ArrayW<uint32_t> input, ::ArrayW<uint32_t> x);

  /// @brief Method SetKey, addr 0x33a56f8, size 0x1f4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33a4c80, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33a4ce4, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x33a5178, size 0xe4, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_NonceSize, addr 0x33a5170, size 0x8, virtual true, abstract: false, final false
