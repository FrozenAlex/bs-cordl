...
public:
  // Declarations
  /// @brief Method DecryptBlock, addr 0x33061b0, size 0x171c, virtual true, abstract: false, final false
  inline void DecryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method EncryptBlock, addr 0x3304d44, size 0x146c, virtual true, abstract: false, final false
  inline void EncryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method MakeWorkingKey, addr 0x33038b0, size 0x1494, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33078cc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
