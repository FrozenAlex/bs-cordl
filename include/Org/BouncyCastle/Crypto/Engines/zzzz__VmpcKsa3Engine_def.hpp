...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Engines::VmpcKsa3Engine*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Engines::VmpcKsa3Engine*, "Org.BouncyCastle.Crypto.Engines", "VmpcKsa3Engine");
...
public:
  ...
  /// @brief Method InitKey, addr 0x331466c, size 0x298, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3314904, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0x3314628, size 0x44, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Engines::VmpcKsa3Engine) == 0x38, "Size mismatch!");
