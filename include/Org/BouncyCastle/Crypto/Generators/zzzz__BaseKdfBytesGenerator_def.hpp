...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::BaseKdfBytesGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::BaseKdfBytesGenerator*, "Org.BouncyCastle.Crypto.Generators", "BaseKdfBytesGenerator");
...
public:
  ...
  /// @brief Method GenerateBytes, addr 0x33153d8, size 0x52c, virtual true, abstract: false, final false
  inline int32_t GenerateBytes(::ArrayW<uint8_t> output, int32_t outOff, int32_t length);

  /// @brief Method Init, addr 0x33152b8, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33152ac, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t counterStart, ::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_Digest, addr 0x33153d0, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::BaseKdfBytesGenerator) == 0x30, "Size mismatch!");
