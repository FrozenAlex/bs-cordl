...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::DHKeyGeneratorHelper*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::DHKeyGeneratorHelper*, "Org.BouncyCastle.Crypto.Generators", "DHKeyGeneratorHelper");
...
public:
  ...
  /// @brief Method CalculatePrivate, addr 0x3317248, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculatePublic, addr 0x331741c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x331744c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::DHKeyGeneratorHelper) == 0x10, "Size mismatch!");
