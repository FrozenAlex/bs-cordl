...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::DsaParametersGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::DsaParametersGenerator*, "Org.BouncyCastle.Crypto.Generators", "DsaParametersGenerator");
...
public:
  ...
  /// @brief Method CalculateGenerator_FIPS186_2, addr 0x33d3860, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method CalculateGenerator_FIPS186_3_Unverifiable, addr 0x33d3f28, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method CalculateGenerator_FIPS186_3_Verifiable, addr 0x33d3f34, size 0x2bc, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateParameters, addr 0x33d3174, size 0x30, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::DsaParameters* GenerateParameters();

  /// @brief Method GenerateParameters_FIPS186_2, addr 0x33d31a4, size 0x54c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::DsaParameters* GenerateParameters_FIPS186_2();

  /// @brief Method GenerateParameters_FIPS186_3, addr 0x33d3978, size 0x5b0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::DsaParameters* GenerateParameters_FIPS186_3();

  /// @brief Method GetDefaultN, addr 0x33d2ecc, size 0x14, virtual false, abstract: false, final false
  static inline int32_t GetDefaultN(int32_t L);

  /// @brief Method Hash, addr 0x33d36f0, size 0x12c, virtual false, abstract: false, final false
  static inline void Hash(::Org::BouncyCastle::Crypto::IDigest* d, ::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output);

  /// @brief Method Inc, addr 0x33d381c, size 0x44, virtual false, abstract: false, final false
  static inline void Inc(::ArrayW<uint8_t> buf);

  /// @brief Method Init, addr 0x33d2ee0, size 0x294, virtual true, abstract: false, final false
  inline void Init(::Org::BouncyCastle::Crypto::Parameters::DsaParameterGenerationParameters* parameters);

  /// @brief Method Init, addr 0x33d2e24, size 0x90, virtual true, abstract: false, final false
  inline void Init(int32_t size, int32_t certainty, ::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method IsValidDsaStrength, addr 0x33d2eb4, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33d2dc0, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33d2e1c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::DsaParametersGenerator) == 0x38, "Size mismatch!");
