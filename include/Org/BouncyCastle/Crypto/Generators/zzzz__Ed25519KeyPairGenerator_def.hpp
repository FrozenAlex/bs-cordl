...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::Ed25519KeyPairGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::Ed25519KeyPairGenerator*, "Org.BouncyCastle.Crypto.Generators", "Ed25519KeyPairGenerator");
...
public:
  ...
  /// @brief Method GenerateKeyPair, addr 0x33d4a60, size 0xb4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair();

  /// @brief Method Init, addr 0x33d4a48, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33d4b14, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::Org::BouncyCastle::Crypto::Generators::Ed25519KeyPairGenerator, ___random) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::Ed25519KeyPairGenerator) == 0x18, "Size mismatch!");
