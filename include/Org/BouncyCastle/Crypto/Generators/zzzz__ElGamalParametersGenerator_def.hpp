...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::ElGamalParametersGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::ElGamalParametersGenerator*, "Org.BouncyCastle.Crypto.Generators", "ElGamalParametersGenerator");
...
public:
  ...
  /// @brief Method GenerateParameters, addr 0x331a3d4, size 0xd8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::ElGamalParameters* GenerateParameters();

  /// @brief Method Init, addr 0x331a3c8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x331a4ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::ElGamalParametersGenerator) == 0x20, "Size mismatch!");
