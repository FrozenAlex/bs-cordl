...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::Gost3410KeyPairGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::Gost3410KeyPairGenerator*, "Org.BouncyCastle.Crypto.Generators", "Gost3410KeyPairGenerator");
...
public:
  ...
  /// @brief Method GenerateKeyPair, addr 0x33d5064, size 0x22c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair();

  /// @brief Method Init, addr 0x33d4f30, size 0x134, virtual true, abstract: false, final true
  ...
  constexpr ::Org::BouncyCastle::Crypto::Parameters::Gost3410KeyGenerationParameters* const& __cordl_internal_get_param() const;
  ...
  /// @brief Method .ctor, addr 0x33d5290, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::Gost3410KeyPairGenerator) == 0x18, "Size mismatch!");
