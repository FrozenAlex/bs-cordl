...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::HkdfBytesGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::HkdfBytesGenerator*, "Org.BouncyCastle.Crypto.Generators", "HkdfBytesGenerator");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_currentT, put = __cordl_internal_set_currentT)) ::ArrayW<uint8_t> currentT;
  ...
  /// @brief Method ExpandNext, addr 0x331cdb0, size 0x100, virtual false, abstract: false, final false
  inline void ExpandNext();

  /// @brief Method Extract, addr 0x331cc68, size 0x148, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::KeyParameter* Extract(::ArrayW<uint8_t> salt, ::ArrayW<uint8_t> ikm);

  /// @brief Method GenerateBytes, addr 0x331cecc, size 0x1a4, virtual true, abstract: false, final false
  inline int32_t GenerateBytes(::ArrayW<uint8_t> output, int32_t outOff, int32_t len);

  /// @brief Method Init, addr 0x331ca94, size 0x1d4, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_currentT() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_currentT();
  ...
  constexpr void __cordl_internal_set_currentT(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x331c9a8, size 0xec, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* hash);

  /// @brief Method get_Digest, addr 0x331ceb0, size 0x1c, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::HkdfBytesGenerator) == 0x38, "Size mismatch!");
