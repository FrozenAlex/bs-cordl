...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::Kdf1BytesGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::Kdf1BytesGenerator*, "Org.BouncyCastle.Crypto.Generators", "Kdf1BytesGenerator");
...
public:
  ...
  /// @brief Method .ctor, addr 0x33d7af0, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::Kdf1BytesGenerator) == 0x30, "Size mismatch!");
