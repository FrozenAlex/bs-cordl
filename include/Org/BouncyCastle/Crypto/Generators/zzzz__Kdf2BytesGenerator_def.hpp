...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::Kdf2BytesGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::Kdf2BytesGenerator*, "Org.BouncyCastle.Crypto.Generators", "Kdf2BytesGenerator");
...
public:
  ...
  /// @brief Method .ctor, addr 0x33d7afc, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::Kdf2BytesGenerator) == 0x30, "Size mismatch!");
