...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::KdfCounterBytesGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::KdfCounterBytesGenerator*, "Org.BouncyCastle.Crypto.Generators", "KdfCounterBytesGenerator");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_fixedInputDataCtrPrefix, put = __cordl_internal_set_fixedInputDataCtrPrefix)) ::ArrayW<uint8_t> fixedInputDataCtrPrefix;

  /// @brief Field fixedInputData_afterCtr, offset 0x28, size 0x8
  __declspec(property(get = __cordl_internal_get_fixedInputData_afterCtr, put = __cordl_internal_set_fixedInputData_afterCtr)) ::ArrayW<uint8_t> fixedInputData_afterCtr;
  ...
  __declspec(property(get = __cordl_internal_get_ios, put = __cordl_internal_set_ios)) ::ArrayW<uint8_t> ios;
  ...
  /// @brief Method GenerateBytes, addr 0x33d7f3c, size 0x1e0, virtual true, abstract: false, final true
  inline int32_t GenerateBytes(::ArrayW<uint8_t> output, int32_t outOff, int32_t length);

  /// @brief Method GetMac, addr 0x33d7ea8, size 0x8, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::IMac* GetMac();

  /// @brief Method Init, addr 0x33d7bf4, size 0x2b4, virtual true, abstract: false, final true
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_fixedInputDataCtrPrefix() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_fixedInputDataCtrPrefix();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_fixedInputData_afterCtr() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_fixedInputData_afterCtr();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_ios() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_ios();
  ...
  constexpr void __cordl_internal_set_fixedInputDataCtrPrefix(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_fixedInputData_afterCtr(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_generatedBytes(int32_t value);

  constexpr void __cordl_internal_set_h(int32_t value);

  constexpr void __cordl_internal_set_ios(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x33d7b0c, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IMac* prf);

  /// @brief Method generateNext, addr 0x33d811c, size 0x334, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Digest, addr 0x33d7eb0, size 0x8c, virtual true, abstract: false, final true
...
public:
  ...
  ::ArrayW<uint8_t> ___fixedInputDataCtrPrefix;

  /// @brief Field fixedInputData_afterCtr, offset: 0x28, size: 0x8, def value: None
  ::ArrayW<uint8_t> ___fixedInputData_afterCtr;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::KdfCounterBytesGenerator) == 0x50, "Size mismatch!");
