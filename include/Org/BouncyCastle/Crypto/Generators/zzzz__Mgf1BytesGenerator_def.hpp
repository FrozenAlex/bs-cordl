...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator*, "Org.BouncyCastle.Crypto.Generators", "Mgf1BytesGenerator");
...
public:
  ...
  /// @brief Method GenerateBytes, addr 0x331f2d4, size 0x4c4, virtual true, abstract: false, final true
  inline int32_t GenerateBytes(::ArrayW<uint8_t> output, int32_t outOff, int32_t length);

  /// @brief Method Init, addr 0x331f13c, size 0x13c, virtual true, abstract: false, final true
  inline void Init(::Org::BouncyCastle::Crypto::IDerivationParameters* parameters);

  /// @brief Method ItoOSP, addr 0x331f280, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x331f080, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_Digest, addr 0x331f278, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator) == 0x28, "Size mismatch!");
