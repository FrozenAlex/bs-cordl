...
public:
  ...
  /// @brief Method GenerateDerivedKey, addr 0x3323c28, size 0x354, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateDerivedKey();

  /// @brief Method GenerateDerivedMacParameters, addr 0x3324540, size 0x1a0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedMacParameters(int32_t keySize);

  /// @brief Method GenerateDerivedParameters, addr 0x3323f88, size 0x1ac, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(::StringW algorithm, int32_t keySize);

  /// @brief Method GenerateDerivedParameters, addr 0x3324330, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateDerivedParameters, addr 0x3323f7c, size 0xc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(int32_t keySize);

  /// @brief Method GenerateDerivedParameters, addr 0x3324134, size 0x1fc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3323c20, size 0x8, virtual false, abstract: false, final false
