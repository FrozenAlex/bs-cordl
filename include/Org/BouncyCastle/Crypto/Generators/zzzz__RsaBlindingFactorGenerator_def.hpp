...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::RsaBlindingFactorGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::RsaBlindingFactorGenerator*, "Org.BouncyCastle.Crypto.Generators", "RsaBlindingFactorGenerator");
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::RsaBlindingFactorGenerator) == 0x20, "Size mismatch!");
