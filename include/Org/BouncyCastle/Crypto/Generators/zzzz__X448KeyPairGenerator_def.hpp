...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::X448KeyPairGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::X448KeyPairGenerator*, "Org.BouncyCastle.Crypto.Generators", "X448KeyPairGenerator");
...
public:
  ...
  /// @brief Method GenerateKeyPair, addr 0x3326c64, size 0xb4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair();

  /// @brief Method Init, addr 0x3326c4c, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3326d18, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::X448KeyPairGenerator) == 0x18, "Size mismatch!");
