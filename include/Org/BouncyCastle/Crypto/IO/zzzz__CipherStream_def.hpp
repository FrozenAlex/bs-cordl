...
public:
  ...
  /// @brief Method Close, addr 0x33e200c, size 0x138, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method FillInBuf, addr 0x33e18d0, size 0x44, virtual false, abstract: false, final false
  inline bool FillInBuf();

  /// @brief Method Flush, addr 0x33e2144, size 0x20, virtual true, abstract: false, final false
  inline void Flush();
  ...
  /// @brief Method Read, addr 0x33e1914, size 0x158, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadAndProcessBlock, addr 0x33e1a6c, size 0x230, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> ReadAndProcessBlock();

  /// @brief Method ReadByte, addr 0x33e1834, size 0x9c, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method Seek, addr 0x33e2164, size 0x38, virtual true, abstract: false, final true
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength, addr 0x33e219c, size 0x38, virtual true, abstract: false, final true
  inline void SetLength(int64_t length);

  /// @brief Method Write, addr 0x33e1c9c, size 0x128, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count);

  /// @brief Method WriteByte, addr 0x33e1dc4, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33e179c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanRead, addr 0x33e1edc, size 0x40, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x33e1f5c, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanWrite, addr 0x33e1f1c, size 0x40, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_Length, addr 0x33e1f64, size 0x38, virtual true, abstract: false, final true
  inline int64_t get_Length();

  /// @brief Method get_Position, addr 0x33e1f9c, size 0x38, virtual true, abstract: false, final true
  inline int64_t get_Position();

  /// @brief Method get_ReadCipher, addr 0x33e1824, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBufferedCipher* get_ReadCipher();

  /// @brief Method get_WriteCipher, addr 0x33e182c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBufferedCipher* get_WriteCipher();

  /// @brief Method set_Position, addr 0x33e1fd4, size 0x38, virtual true, abstract: false, final true
