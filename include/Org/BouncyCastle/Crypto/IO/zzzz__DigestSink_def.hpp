...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::IO::DigestSink*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::IO::DigestSink*, "Org.BouncyCastle.Crypto.IO", "DigestSink");
...
public:
  ...
  /// @brief Method Write, addr 0x332783c, size 0xec, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method WriteByte, addr 0x3327784, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3327754, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_Digest, addr 0x332777c, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::IO::DigestSink) == 0x38, "Size mismatch!");
