...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::IO::MacSink*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::IO::MacSink*, "Org.BouncyCastle.Crypto.IO", "MacSink");
...
public:
  ...
  /// @brief Method Write, addr 0x3327fd0, size 0xec, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method WriteByte, addr 0x3327f18, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3327ee8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IMac* mac);

  /// @brief Method get_Mac, addr 0x3327f10, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::IO::MacSink) == 0x38, "Size mismatch!");
