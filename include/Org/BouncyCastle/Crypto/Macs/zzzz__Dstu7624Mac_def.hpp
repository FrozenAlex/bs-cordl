...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x33e6f10, size 0x140, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0x33e70f4, size 0x12c, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method GetMacSize, addr 0x33e6e40, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Init, addr 0x33e6cc8, size 0x134, virtual true, abstract: false, final true
  inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Macs::Dstu7624Mac* New_ctor(int32_t blockSizeBits, int32_t q);

  /// @brief Method Reset, addr 0x33e7220, size 0xdc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0x33e6e48, size 0x80, virtual true, abstract: false, final true
  inline void Update(uint8_t input);

  /// @brief Method Xor, addr 0x33e7050, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33e6bd0, size 0xf8, virtual false, abstract: false, final false
  inline void _ctor(int32_t blockSizeBits, int32_t q);

  /// @brief Method get_AlgorithmName, addr 0x33e6dfc, size 0x44, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Convert to "::Org::BouncyCastle::Crypto::IMac"
  constexpr ::Org::BouncyCastle::Crypto::IMac* i___Org__BouncyCastle__Crypto__IMac() noexcept;

  /// @brief Method processBlock, addr 0x33e6ec8, size 0x48, virtual false, abstract: false, final false
