...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x33e75a0, size 0x20, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0x33e75c0, size 0xf4, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method GetMacSize, addr 0x33e7568, size 0x18, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Init, addr 0x33e7318, size 0x180, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x33e76b4, size 0x20, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0x33e7580, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x33e72fc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Modes::GcmBlockCipher* cipher);

  /// @brief Method .ctor, addr 0x33e730c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Modes::GcmBlockCipher* cipher, int32_t macSizeBits);

  /// @brief Method get_AlgorithmName, addr 0x33e7498, size 0xd0, virtual true, abstract: false, final true
