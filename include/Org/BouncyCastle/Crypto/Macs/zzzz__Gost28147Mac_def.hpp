...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Macs::Gost28147Mac*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Macs::Gost28147Mac*, "Org.BouncyCastle.Crypto.Macs", "Gost28147Mac");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_macIV, put = __cordl_internal_set_macIV)) ::ArrayW<uint8_t> macIV;
  ...
  /// @brief Method BlockUpdate, addr 0x33e804c, size 0x1f8, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len);

  /// @brief Method CM5func, addr 0x33e7e48, size 0xe8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> CM5func(::ArrayW<uint8_t> buf, int32_t bufOff, ::ArrayW<uint8_t> mac);

  /// @brief Method DoFinal, addr 0x33e8244, size 0x14c, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method GenerateWorkingKey, addr 0x33e7784, size 0xfc, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t> GenerateWorkingKey(::ArrayW<uint8_t> userKey);

  /// @brief Method GetMacSize, addr 0x33e7bf4, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Init, addr 0x33e78f4, size 0x284, virtual true, abstract: false, final true
  inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Macs::Gost28147Mac* New_ctor();

  /// @brief Method Reset, addr 0x33e7b78, size 0x38, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0x33e7f30, size 0x11c, virtual true, abstract: false, final true
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_macIV() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_macIV();
  ...
  constexpr void __cordl_internal_set_macIV(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_workingKey(::ArrayW<int32_t> value);

  /// @brief Method .ctor, addr 0x33e76d4, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method bytesToint, addr 0x33e7880, size 0x74, virtual false, abstract: false, final false
  static inline int32_t bytesToint(::ArrayW<uint8_t> input, int32_t inOff);

  /// @brief Method get_AlgorithmName, addr 0x33e7bb0, size 0x44, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method gost28147MacFunc, addr 0x33e7ce4, size 0xe4, virtual false, abstract: false, final false
  inline void gost28147MacFunc(::ArrayW<int32_t> workingKey, ::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method gost28147_mainStep, addr 0x33e7bfc, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method intTobytes, addr 0x33e7dc8, size 0x80, virtual false, abstract: false, final false
  static inline void intTobytes(int32_t num, ::ArrayW<uint8_t> output, int32_t outOff);
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Macs::Gost28147Mac) == 0x48, "Size mismatch!");
