...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Modes::Gcm::Tables64kGcmMultiplier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Modes::Gcm::Tables64kGcmMultiplier*, "Org.BouncyCastle.Crypto.Modes.Gcm", "Tables64kGcmMultiplier");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_M, put = __cordl_internal_set_M)) ::ArrayW<::ArrayW<::ArrayW<uint32_t>>> M;
  ...
  /// @brief Method Init, addr 0x33ee2f4, size 0x4f4, virtual true, abstract: false, final true
  inline void Init(::ArrayW<uint8_t> H);

  /// @brief Method MultiplyH, addr 0x33ee7e8, size 0x154, virtual true, abstract: false, final true
  ...
  constexpr ::ArrayW<::ArrayW<::ArrayW<uint32_t>>> const& __cordl_internal_get_M() const;

  constexpr ::ArrayW<::ArrayW<::ArrayW<uint32_t>>>& __cordl_internal_get_M();
  ...
  /// @brief Method .ctor, addr 0x33ee93c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::ArrayW<::ArrayW<uint32_t>>> ___M;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Modes::Gcm::Tables64kGcmMultiplier) == 0x20, "Size mismatch!");
