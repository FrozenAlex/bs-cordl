...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Modes::Gcm::Tables8kGcmMultiplier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Modes::Gcm::Tables8kGcmMultiplier*, "Org.BouncyCastle.Crypto.Modes.Gcm", "Tables8kGcmMultiplier");
...
public:
  ...
  /// @brief Method Init, addr 0x33ee940, size 0x6b8, virtual true, abstract: false, final true
  inline void Init(::ArrayW<uint8_t> H);

  /// @brief Method MultiplyH, addr 0x33eeff8, size 0x1e8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x33ef1e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Modes::Gcm::Tables8kGcmMultiplier) == 0x20, "Size mismatch!");
