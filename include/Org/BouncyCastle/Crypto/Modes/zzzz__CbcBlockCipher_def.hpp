...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Modes::CbcBlockCipher*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Modes::CbcBlockCipher*, "Org.BouncyCastle.Crypto.Modes", "CbcBlockCipher");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_cbcNextV, put = __cordl_internal_set_cbcNextV)) ::ArrayW<uint8_t> cbcNextV;

  /// @brief Field cbcV, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get_cbcV, put = __cordl_internal_set_cbcV)) ::ArrayW<uint8_t> cbcV;
  ...
  /// @brief Method DecryptBlock, addr 0x33ef648, size 0x1d4, virtual false, abstract: false, final false
  inline int32_t DecryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff);

  /// @brief Method EncryptBlock, addr 0x33ef81c, size 0x1d4, virtual false, abstract: false, final false
  inline int32_t EncryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff);

  /// @brief Method GetBlockSize, addr 0x33ef590, size 0xa8, virtual true, abstract: false, final true
  inline int32_t GetBlockSize();

  /// @brief Method GetUnderlyingCipher, addr 0x33ef1e4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init, addr 0x33ef1ec, size 0x1f4, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0x33ef638, size 0x10, virtual true, abstract: false, final true
  inline int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method Reset, addr 0x33ef3e0, size 0xe0, virtual true, abstract: false, final true
  inline void Reset();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_cbcNextV() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_cbcNextV();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_cbcV() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_cbcV();
  ...
  constexpr void __cordl_internal_set_cbcNextV(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_cbcV(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x33e3ba0, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method get_AlgorithmName, addr 0x33ef4c0, size 0xc8, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x33ef588, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Modes::CbcBlockCipher) == 0x40, "Size mismatch!");
