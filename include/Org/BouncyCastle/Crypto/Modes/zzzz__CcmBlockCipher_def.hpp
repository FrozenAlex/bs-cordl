...
public:
  ...
  /// @brief Method CalculateMac, addr 0x3336254, size 0x8a0, virtual false, abstract: false, final false
  inline int32_t CalculateMac(::ArrayW<uint8_t> data, int32_t dataOff, int32_t dataLen, ::ArrayW<uint8_t> macBlock);

  /// @brief Method DoFinal, addr 0x333565c, size 0xa8, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t> outBytes, int32_t outOff);

  /// @brief Method GetAssociatedTextLength, addr 0x3336b0c, size 0x38, virtual false, abstract: false, final false
  inline int32_t GetAssociatedTextLength();

  /// @brief Method GetBlockSize, addr 0x33354a4, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method GetMac, addr 0x33357e4, size 0x6c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GetMac();

  /// @brief Method GetMacSize, addr 0x3335370, size 0x6c, virtual false, abstract: false, final false
  inline int32_t GetMacSize(bool forEncryption, int32_t requestedMacBits);

  /// @brief Method GetOutputSize, addr 0x3335858, size 0x54, virtual true, abstract: false, final false
  inline int32_t GetOutputSize(int32_t len);

  /// @brief Method GetUnderlyingCipher, addr 0x3335184, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher();

  /// @brief Method GetUpdateOutputSize, addr 0x3335850, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetUpdateOutputSize(int32_t len);

  /// @brief Method HasAssociatedText, addr 0x3336af4, size 0x18, virtual false, abstract: false, final false
  inline bool HasAssociatedText();

  /// @brief Method Init, addr 0x333518c, size 0x1e4, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessAadByte, addr 0x333554c, size 0x20, virtual true, abstract: false, final false
  inline void ProcessAadByte(uint8_t input);

  /// @brief Method ProcessAadBytes, addr 0x333556c, size 0x20, virtual true, abstract: false, final false
  inline void ProcessAadBytes(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t len);

  /// @brief Method ProcessByte, addr 0x333558c, size 0x2c, virtual true, abstract: false, final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t> outBytes, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x33355b8, size 0xa4, virtual true, abstract: false, final false
  inline int32_t ProcessBytes(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t inLen, ::ArrayW<uint8_t> outBytes, int32_t outOff);

  /// @brief Method ProcessPacket, addr 0x33358ac, size 0x100, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> ProcessPacket(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen);

  /// @brief Method ProcessPacket, addr 0x33359ac, size 0x8a8, virtual true, abstract: false, final false
  inline int32_t ProcessPacket(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method Reset, addr 0x3335704, size 0xe0, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x3334f70, size 0x214, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  static inline int32_t getStaticF_BlockSize();

  /// @brief Method get_AlgorithmName, addr 0x33353dc, size 0xc8, virtual true, abstract: false, final false
