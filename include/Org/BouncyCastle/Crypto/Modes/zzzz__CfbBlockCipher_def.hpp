...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Modes::CfbBlockCipher*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Modes::CfbBlockCipher*, "Org.BouncyCastle.Crypto.Modes", "CfbBlockCipher");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_cfbOutV, put = __cordl_internal_set_cfbOutV)) ::ArrayW<uint8_t> cfbOutV;

  /// @brief Field cfbV, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get_cfbV, put = __cordl_internal_set_cfbV)) ::ArrayW<uint8_t> cfbV;
  ...
  /// @brief Method DecryptBlock, addr 0x333718c, size 0x254, virtual false, abstract: false, final false
  inline int32_t DecryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff);

  /// @brief Method EncryptBlock, addr 0x33373e0, size 0x254, virtual false, abstract: false, final false
  inline int32_t EncryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff);

  /// @brief Method GetBlockSize, addr 0x3337174, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetBlockSize();

  /// @brief Method GetUnderlyingCipher, addr 0x3336e14, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init, addr 0x3336e1c, size 0x190, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0x333717c, size 0x10, virtual true, abstract: false, final true
  inline int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method Reset, addr 0x3336fac, size 0xc8, virtual true, abstract: false, final true
  inline void Reset();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_cfbOutV() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_cfbOutV();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_cfbV() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_cfbV();
  ...
  constexpr void __cordl_internal_set_cfbOutV(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_cfbV(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x3336b94, size 0x280, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher, int32_t bitBlockSize);

  /// @brief Method get_AlgorithmName, addr 0x3337074, size 0xf8, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x333716c, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Modes::CfbBlockCipher) == 0x38, "Size mismatch!");
