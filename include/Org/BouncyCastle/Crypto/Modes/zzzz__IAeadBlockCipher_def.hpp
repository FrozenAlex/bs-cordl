...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Modes::IAeadBlockCipher*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Modes::IAeadBlockCipher*, "Org.BouncyCastle.Crypto.Modes", "IAeadBlockCipher");
// Dependencies
namespace Org::BouncyCastle::Crypto::Modes {
// Is value type: false
