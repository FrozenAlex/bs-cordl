...
public:
  ...
  /// @brief Method BuildCipher, addr 0x3401c14, size 0x1a0, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::ICipher* BuildCipher(::System::IO::Stream* stream);

  /// @brief Method GetMaxOutputSize, addr 0x3401bdc, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x34019d4, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmDetails, addr 0x3401bd4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* get_AlgorithmDetails();

  /// @brief Method get_Key, addr 0x3401e30, size 0x8, virtual true, abstract: false, final true
