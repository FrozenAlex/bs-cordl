...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Operators::Asn1KeyWrapper*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Operators::Asn1KeyWrapper*, "Org.BouncyCastle.Crypto.Operators", "Asn1KeyWrapper");
...
public:
  ...
  /// @brief Method Wrap, addr 0x33478b0, size 0xb8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3347530, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::StringW algorithm, ::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method get_AlgorithmDetails, addr 0x334780c, size 0xa4, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Operators::Asn1KeyWrapper) == 0x20, "Size mismatch!");
