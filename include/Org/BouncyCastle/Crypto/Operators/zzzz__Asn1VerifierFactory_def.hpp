...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Operators::Asn1VerifierFactory*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Operators::Asn1VerifierFactory*, "Org.BouncyCastle.Crypto.Operators", "Asn1VerifierFactory");
...
public:
  ...
  /// @brief Method CreateCalculator, addr 0x334bc70, size 0xe4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x334bc60, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x334bb24, size 0x13c, virtual false, abstract: false, final false
  inline void _ctor(::StringW algorithm, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method get_AlgorithmDetails, addr 0x334bc68, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Operators::Asn1VerifierFactory) == 0x20, "Size mismatch!");
