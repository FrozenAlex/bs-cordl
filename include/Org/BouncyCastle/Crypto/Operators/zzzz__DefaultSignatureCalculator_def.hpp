...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Operators::DefaultSignatureCalculator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Operators::DefaultSignatureCalculator*, "Org.BouncyCastle.Crypto.Operators", "DefaultSignatureCalculator");
...
public:
  ...
  /// @brief Method GetResult, addr 0x334ca1c, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x334ba68, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::ISigner* signer);

  /// @brief Method get_Stream, addr 0x334ca14, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Operators::DefaultSignatureCalculator) == 0x18, "Size mismatch!");
