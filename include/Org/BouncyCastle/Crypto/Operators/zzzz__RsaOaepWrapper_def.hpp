...
public:
  ...
  /// @brief Method Unwrap, addr 0x3402d18, size 0x100, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::IBlockResult* Unwrap(::ArrayW<uint8_t> cipherText, int32_t offset, int32_t length);

  /// @brief Method Wrap, addr 0x3402e18, size 0xf8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3402a9c, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmDetails, addr 0x3402d10, size 0x8, virtual true, abstract: false, final true
