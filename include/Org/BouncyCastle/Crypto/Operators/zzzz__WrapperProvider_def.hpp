...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Operators::WrapperProvider*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Operators::WrapperProvider*, "Org.BouncyCastle.Crypto.Operators", "WrapperProvider");
// Dependencies
namespace Org::BouncyCastle::Crypto::Operators {
// Is value type: false
