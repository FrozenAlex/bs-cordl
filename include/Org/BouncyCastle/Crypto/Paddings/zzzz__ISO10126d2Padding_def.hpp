...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Paddings::ISO10126d2Padding*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Paddings::ISO10126d2Padding*, "Org.BouncyCastle.Crypto.Paddings", "ISO10126d2Padding");
...
public:
  ...
  /// @brief Method AddPadding, addr 0x34078b0, size 0xb0, virtual true, abstract: false, final true
  inline int32_t AddPadding(::ArrayW<uint8_t> input, int32_t inOff);

  /// @brief Method Init, addr 0x34077f0, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method PadCount, addr 0x3407960, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x34079dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_PaddingName, addr 0x340786c, size 0x44, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Paddings::ISO10126d2Padding) == 0x18, "Size mismatch!");
