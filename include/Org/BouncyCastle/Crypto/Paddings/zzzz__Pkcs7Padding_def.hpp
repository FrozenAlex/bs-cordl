...
public:
  ...
  /// @brief Method AddPadding, addr 0x34087e8, size 0x4c, virtual true, abstract: false, final true
  inline int32_t AddPadding(::ArrayW<uint8_t> input, int32_t inOff);

  /// @brief Method Init, addr 0x34087a0, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method PadCount, addr 0x3408834, size 0xbc, virtual true, abstract: false, final true
  inline int32_t PadCount(::ArrayW<uint8_t> input);

  /// @brief Method .ctor, addr 0x3407ca8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_PaddingName, addr 0x34087a4, size 0x44, virtual true, abstract: false, final true
