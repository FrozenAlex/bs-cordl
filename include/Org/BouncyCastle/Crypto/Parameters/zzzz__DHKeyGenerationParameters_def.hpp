...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::DHKeyGenerationParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::DHKeyGenerationParameters*, "Org.BouncyCastle.Crypto.Parameters", "DHKeyGenerationParameters");
...
public:
  ...
  /// @brief Method GetStrength, addr 0x3409a30, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34099f4, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x3409a64, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::DHKeyGenerationParameters) == 0x28, "Size mismatch!");
