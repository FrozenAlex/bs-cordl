...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters*, "Org.BouncyCastle.Crypto.Parameters", "DHPrivateKeyParameters");
...
public:
  ...
  /// @brief Method Equals, addr 0x340a518, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x340a5c4, size 0x58, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters* other);

  /// @brief Method GetHashCode, addr 0x340a61c, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x340a4d4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* x, ::Org::BouncyCastle::Crypto::Parameters::DHParameters* parameters);

  /// @brief Method .ctor, addr 0x340a4fc, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_X, addr 0x340a510, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters) == 0x30, "Size mismatch!");
