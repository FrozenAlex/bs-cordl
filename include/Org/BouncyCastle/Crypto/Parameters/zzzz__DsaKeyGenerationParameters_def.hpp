...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::DsaKeyGenerationParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::DsaKeyGenerationParameters*, "Org.BouncyCastle.Crypto.Parameters", "DsaKeyGenerationParameters");
...
public:
  ...
  /// @brief Method .ctor, addr 0x33504ec, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x3350538, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::DsaKeyGenerationParameters) == 0x28, "Size mismatch!");
