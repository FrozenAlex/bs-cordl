...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::DsaParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::DsaParameters*, "Org.BouncyCastle.Crypto.Parameters", "DsaParameters");
...
public:
  ...
  /// @brief Method Equals, addr 0x340b25c, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x340b308, size 0x80, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DsaParameters* other);

  /// @brief Method GetHashCode, addr 0x340b388, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x340b18c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x340b194, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* p, ::Org::BouncyCastle::Math::BigInteger* q, ::Org::BouncyCastle::Math::BigInteger* g,
                    ::Org::BouncyCastle::Crypto::Parameters::DsaValidationParameters* parameters);

  /// @brief Method get_G, addr 0x340b24c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G();

  /// @brief Method get_P, addr 0x340b23c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_P();

  /// @brief Method get_Q, addr 0x340b244, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Q();

  /// @brief Method get_ValidationParameters, addr 0x340b254, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::DsaParameters) == 0x30, "Size mismatch!");
