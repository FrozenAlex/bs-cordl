...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::DsaPublicKeyParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::DsaPublicKeyParameters*, "Org.BouncyCastle.Crypto.Parameters", "DsaPublicKeyParameters");
...
public:
  ...
  /// @brief Method Equals, addr 0x340b798, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x340b844, size 0x58, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DsaPublicKeyParameters* other);

  /// @brief Method GetHashCode, addr 0x340b89c, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method Validate, addr 0x340b5a8, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x340b710, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* y, ::Org::BouncyCastle::Crypto::Parameters::DsaParameters* parameters);

  /// @brief Method get_Y, addr 0x340b790, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::DsaPublicKeyParameters) == 0x28, "Size mismatch!");
