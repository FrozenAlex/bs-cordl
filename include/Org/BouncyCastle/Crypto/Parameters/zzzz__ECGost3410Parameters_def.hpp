...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::ECGost3410Parameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::ECGost3410Parameters*, "Org.BouncyCastle.Crypto.Parameters", "ECGost3410Parameters");
...
public:
  ...
  /// @brief Method .ctor, addr 0x340c57c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x340c4fc, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DigestParamSet, addr 0x340c4ec, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_DigestParamSet();

  /// @brief Method get_EncryptionParamSet, addr 0x340c4f4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_EncryptionParamSet();

  /// @brief Method get_PublicKeyParamSet, addr 0x340c4e4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::ECGost3410Parameters) == 0x60, "Size mismatch!");
