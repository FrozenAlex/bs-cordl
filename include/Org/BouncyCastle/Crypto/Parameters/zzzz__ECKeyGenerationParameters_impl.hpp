...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters::*)(
  ...
  constexpr static std::size_t addrs = 0x3351b78;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{},
        (::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters*>(),
                            { ".ctor", {}, { ::i2c::type_of<::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters*>(), ::i2c::type_of<::Org::BouncyCastle::Security::SecureRandom*>() } })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters::*)(
  ...
  constexpr static std::size_t addrs = 0x3351bc4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{},
                     (::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters*>(),
                                         { ".ctor", {}, { ::i2c::type_of<::Org::BouncyCastle::Asn1::DerObjectIdentifier*>(), ::i2c::type_of<::Org::BouncyCastle::Security::SecureRandom*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* (::Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters::*)()>(
  ...
  constexpr static std::size_t addrs = 0x3351d48;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters*>(), { "get_DomainParameters", {}, {} })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::Org::BouncyCastle::Asn1::DerObjectIdentifier* (::Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters::*)()>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3351d50;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters*>(), { "get_PublicKeyParamSet", {}, {} })));
    return ___internal_method;
  }
};
...
constexpr ::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* const& Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters::__cordl_internal_get_domainParams() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___domainParams;
}
...
constexpr ::Org::BouncyCastle::Asn1::DerObjectIdentifier* const& Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters::__cordl_internal_get_publicKeyParamSet() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___publicKeyParamSet;
}
...
inline void Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters::_ctor(::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* domainParameters,
  ...
  static auto* ___internal_method = THROW_UNLESS(
      ...
      (::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters*>(),
                          { ".ctor", {}, { ::i2c::type_of<::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters*>(), ::i2c::type_of<::Org::BouncyCastle::Security::SecureRandom*>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, domainParameters, random);
}
inline void Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters::_ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* publicKeyParamSet,
                                                                                    ::Org::BouncyCastle::Security::SecureRandom* random) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters*>(),
                                              { ".ctor", {}, { ::i2c::type_of<::Org::BouncyCastle::Asn1::DerObjectIdentifier*>(), ::i2c::type_of<::Org::BouncyCastle::Security::SecureRandom*>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, publicKeyParamSet, random);
}
...
Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters::New_ctor(::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* domainParameters,
                                                                           ::Org::BouncyCastle::Security::SecureRandom* random) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters*>(domainParameters, random));
}
inline ::Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters*
Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters::New_ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* publicKeyParamSet, ::Org::BouncyCastle::Security::SecureRandom* random) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters*>(publicKeyParamSet, random));
}
// Ctor Parameters []
