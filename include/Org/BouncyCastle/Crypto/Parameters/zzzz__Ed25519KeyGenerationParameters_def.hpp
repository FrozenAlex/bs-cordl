...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::Ed25519KeyGenerationParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::Ed25519KeyGenerationParameters*, "Org.BouncyCastle.Crypto.Parameters", "Ed25519KeyGenerationParameters");
...
public:
  ...
  /// @brief Method .ctor, addr 0x340d5a0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::Ed25519KeyGenerationParameters) == 0x20, "Size mismatch!");
