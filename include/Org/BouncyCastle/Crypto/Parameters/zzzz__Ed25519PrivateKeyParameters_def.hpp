...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::Ed25519PrivateKeyParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::Ed25519PrivateKeyParameters*, "Org.BouncyCastle.Crypto.Parameters", "Ed25519PrivateKeyParameters");
...
public:
  ...
  /// @brief Method Encode, addr 0x340d844, size 0x88, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t> buf, int32_t off);

  /// @brief Method GeneratePublicKey, addr 0x340d92c, size 0x16c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::Ed25519PublicKeyParameters* GeneratePublicKey();

  /// @brief Method GetEncoded, addr 0x340d8cc, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method Sign, addr 0x340db70, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method Sign, addr 0x340db50, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x340d684, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> buf, int32_t off);

  /// @brief Method .ctor, addr 0x340d740, size 0x104, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input);

  /// @brief Method .ctor, addr 0x340d5a8, size 0xdc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::Ed25519PrivateKeyParameters) == 0x28, "Size mismatch!");
