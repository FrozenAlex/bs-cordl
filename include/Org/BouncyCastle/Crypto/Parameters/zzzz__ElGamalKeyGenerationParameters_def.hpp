...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::ElGamalKeyGenerationParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::ElGamalKeyGenerationParameters*, "Org.BouncyCastle.Crypto.Parameters", "ElGamalKeyGenerationParameters");
...
public:
  ...
  /// @brief Method GetStrength, addr 0x340ebf4, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x340ebb8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x340ec28, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::ElGamalKeyGenerationParameters) == 0x28, "Size mismatch!");
