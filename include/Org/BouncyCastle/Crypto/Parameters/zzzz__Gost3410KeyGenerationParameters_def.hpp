...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::Gost3410KeyGenerationParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::Gost3410KeyGenerationParameters*, "Org.BouncyCastle.Crypto.Parameters", "Gost3410KeyGenerationParameters");
...
public:
  ...
  /// @brief Method LookupParameters, addr 0x340f3a8, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x340f320, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x340f36c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x340f528, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::Gost3410Parameters* get_Parameters();

  /// @brief Method get_PublicKeyParamSet, addr 0x340f530, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::Gost3410KeyGenerationParameters) == 0x30, "Size mismatch!");
