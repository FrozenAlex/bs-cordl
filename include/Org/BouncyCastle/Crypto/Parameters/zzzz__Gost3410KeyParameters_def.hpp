...
public:
  ...
  /// @brief Method LookupParameters, addr 0x340f578, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x340f540, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(bool isPrivate, ::Org::BouncyCastle::Crypto::Parameters::Gost3410Parameters* parameters);

  /// @brief Method .ctor, addr 0x340f54c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(bool isPrivate, ::Org::BouncyCastle::Asn1::DerObjectIdentifier* publicKeyParamSet);

  /// @brief Method get_Parameters, addr 0x340f6f8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::Gost3410Parameters* get_Parameters();

  /// @brief Method get_PublicKeyParamSet, addr 0x340f700, size 0x8, virtual false, abstract: false, final false
