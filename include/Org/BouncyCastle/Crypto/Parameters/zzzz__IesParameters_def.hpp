...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::IesParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::IesParameters*, "Org.BouncyCastle.Crypto.Parameters", "IesParameters");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_derivation, put = __cordl_internal_set_derivation)) ::ArrayW<uint8_t> derivation;

  /// @brief Field encoding, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get_encoding, put = __cordl_internal_set_encoding)) ::ArrayW<uint8_t> encoding;
  ...
  /// @brief Method GetDerivationV, addr 0x33556a0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetDerivationV();

  /// @brief Method GetEncodingV, addr 0x33556a8, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetEncodingV();

  static inline ::Org::BouncyCastle::Crypto::Parameters::IesParameters* New_ctor(::ArrayW<uint8_t> derivation, ::ArrayW<uint8_t> encoding, int32_t macKeySize);

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_derivation() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_derivation();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_encoding() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_encoding();

  constexpr int32_t const& __cordl_internal_get_macKeySize() const;

  constexpr int32_t& __cordl_internal_get_macKeySize();

  constexpr void __cordl_internal_set_derivation(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_encoding(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_macKeySize(int32_t value);

  /// @brief Method .ctor, addr 0x3355694, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> derivation, ::ArrayW<uint8_t> encoding, int32_t macKeySize);

  /// @brief Method get_MacKeySize, addr 0x33556b0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::IesParameters) == 0x28, "Size mismatch!");
