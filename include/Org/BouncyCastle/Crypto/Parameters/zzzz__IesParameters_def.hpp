...
public:
  ...
  /// @brief Method GetDerivationV, addr 0x3410120, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetDerivationV();

  /// @brief Method GetEncodingV, addr 0x3410128, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3410114, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> derivation, ::ArrayW<uint8_t> encoding, int32_t macKeySize);

  /// @brief Method get_MacKeySize, addr 0x3410130, size 0x8, virtual false, abstract: false, final false
