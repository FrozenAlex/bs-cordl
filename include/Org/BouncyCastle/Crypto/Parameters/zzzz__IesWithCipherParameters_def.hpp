...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::IesWithCipherParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::IesWithCipherParameters*, "Org.BouncyCastle.Crypto.Parameters", "IesWithCipherParameters");
...
public:
  ...
  static inline ::Org::BouncyCastle::Crypto::Parameters::IesWithCipherParameters* New_ctor(::ArrayW<uint8_t> derivation, ::ArrayW<uint8_t> encoding, int32_t macKeySize, int32_t cipherKeySize);
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::IesWithCipherParameters) == 0x28, "Size mismatch!");
