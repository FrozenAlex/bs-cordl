...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::MqvPrivateParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::MqvPrivateParameters*, "Org.BouncyCastle.Crypto.Parameters", "MqvPrivateParameters");
...
public:
  ...
  /// @brief Method .ctor, addr 0x33562b0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33562b8, size 0x1c8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters* staticPrivateKey, ::Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters* ephemeralPrivateKey,
                    ::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters* ephemeralPublicKey);

  /// @brief Method get_EphemeralPrivateKey, addr 0x3356488, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters* get_EphemeralPrivateKey();

  /// @brief Method get_EphemeralPublicKey, addr 0x3356490, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters* get_EphemeralPublicKey();

  /// @brief Method get_StaticPrivateKey, addr 0x3356480, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::MqvPrivateParameters) == 0x28, "Size mismatch!");
