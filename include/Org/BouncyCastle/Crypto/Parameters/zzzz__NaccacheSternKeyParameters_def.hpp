...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::NaccacheSternKeyParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::NaccacheSternKeyParameters*, "Org.BouncyCastle.Crypto.Parameters", "NaccacheSternKeyParameters");
...
public:
  ...
  /// @brief Method .ctor, addr 0x34110d4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_G, addr 0x34110e4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G();

  /// @brief Method get_LowerSigmaBound, addr 0x34110ec, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LowerSigmaBound();

  /// @brief Method get_Modulus, addr 0x34110f4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::NaccacheSternKeyParameters) == 0x30, "Size mismatch!");
