...
public:
  ...
  /// @brief Method .ctor, addr 0x3356654, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_G, addr 0x3356664, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G();

  /// @brief Method get_LowerSigmaBound, addr 0x335666c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LowerSigmaBound();

  /// @brief Method get_Modulus, addr 0x3356674, size 0x8, virtual false, abstract: false, final false
