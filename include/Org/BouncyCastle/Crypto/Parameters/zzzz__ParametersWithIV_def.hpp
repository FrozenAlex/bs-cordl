...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::ParametersWithIV*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::ParametersWithIV*, "Org.BouncyCastle.Crypto.Parameters", "ParametersWithIV");
...
public:
  ...
  static inline ::Org::BouncyCastle::Crypto::Parameters::ParametersWithIV* New_ctor(::Org::BouncyCastle::Crypto::ICipherParameters* parameters, ::ArrayW<uint8_t> iv, int32_t ivOff, int32_t ivLen);
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::ParametersWithIV) == 0x20, "Size mismatch!");
