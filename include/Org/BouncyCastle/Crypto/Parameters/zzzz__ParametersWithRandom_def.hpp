...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::ParametersWithRandom*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::ParametersWithRandom*, "Org.BouncyCastle.Crypto.Parameters", "ParametersWithRandom");
...
public:
  ...
  /// @brief Method GetRandom, addr 0x3356ab8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33569cc, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method .ctor, addr 0x335694c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::ICipherParameters* parameters, ::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method get_Parameters, addr 0x3356ac8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* get_Parameters();

  /// @brief Method get_Random, addr 0x3356ac0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::ParametersWithRandom) == 0x20, "Size mismatch!");
