...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::RsaBlindingParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::RsaBlindingParameters*, "Org.BouncyCastle.Crypto.Parameters", "RsaBlindingParameters");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3356cf8, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BlindingFactor, addr 0x3356d68, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_BlindingFactor();

  /// @brief Method get_PublicKey, addr 0x3356d60, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::RsaBlindingParameters) == 0x20, "Size mismatch!");
