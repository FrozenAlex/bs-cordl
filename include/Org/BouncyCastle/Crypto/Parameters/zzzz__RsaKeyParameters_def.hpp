...
public:
  ...
  /// @brief Method Equals, addr 0x33571d8, size 0xe8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x33572c0, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method Validate, addr 0x3356ea4, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3357010, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Exponent, addr 0x33571d0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Exponent();

  /// @brief Method get_Modulus, addr 0x33571c8, size 0x8, virtual false, abstract: false, final false
