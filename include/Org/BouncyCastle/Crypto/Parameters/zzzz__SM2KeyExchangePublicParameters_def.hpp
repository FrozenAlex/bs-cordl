...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::SM2KeyExchangePublicParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::SM2KeyExchangePublicParameters*, "Org.BouncyCastle.Crypto.Parameters", "SM2KeyExchangePublicParameters");
...
public:
  ...
  constexpr ::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters* const& __cordl_internal_get_mEphemeralPublicKey() const;

  constexpr ::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters*& __cordl_internal_get_mEphemeralPublicKey();

  constexpr ::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters* const& __cordl_internal_get_mStaticPublicKey() const;
  ...
  /// @brief Method .ctor, addr 0x34138fc, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EphemeralPublicKey, addr 0x34139ec, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters* get_EphemeralPublicKey();

  /// @brief Method get_StaticPublicKey, addr 0x34139e4, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::SM2KeyExchangePublicParameters) == 0x20, "Size mismatch!");
