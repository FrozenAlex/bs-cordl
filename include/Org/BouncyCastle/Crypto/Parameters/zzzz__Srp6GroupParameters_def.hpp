...
public:
  ...
  /// @brief Method .ctor, addr 0x34139f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* N, ::Org::BouncyCastle::Math::BigInteger* g);

  /// @brief Method get_G, addr 0x34139fc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G();

  /// @brief Method get_N, addr 0x3413a04, size 0x8, virtual false, abstract: false, final false
