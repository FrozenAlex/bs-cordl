...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::TweakableBlockCipherParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::TweakableBlockCipherParameters*, "Org.BouncyCastle.Crypto.Parameters", "TweakableBlockCipherParameters");
...
public:
  ...
  __declspec(property(get = get_Tweak)) ::ArrayW<uint8_t> Tweak;
  ...
  __declspec(property(get = __cordl_internal_get_tweak, put = __cordl_internal_set_tweak)) ::ArrayW<uint8_t> tweak;

  /// @brief Convert operator to "::Org::BouncyCastle::Crypto::ICipherParameters"
  constexpr operator ::Org::BouncyCastle::Crypto::ICipherParameters*() noexcept;

  static inline ::Org::BouncyCastle::Crypto::Parameters::TweakableBlockCipherParameters* New_ctor(::Org::BouncyCastle::Crypto::Parameters::KeyParameter* key, ::ArrayW<uint8_t> tweak);
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_tweak() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_tweak();
  ...
  /// @brief Method .ctor, addr 0x3358f8c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Parameters::KeyParameter* key, ::ArrayW<uint8_t> tweak);

  /// @brief Method get_Key, addr 0x3359004, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::KeyParameter* get_Key();

  /// @brief Method get_Tweak, addr 0x335900c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::TweakableBlockCipherParameters) == 0x20, "Size mismatch!");
