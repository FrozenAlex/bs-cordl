...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::X25519KeyGenerationParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::X25519KeyGenerationParameters*, "Org.BouncyCastle.Crypto.Parameters", "X25519KeyGenerationParameters");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3413a94, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::X25519KeyGenerationParameters) == 0x20, "Size mismatch!");
