...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::X448PrivateKeyParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::X448PrivateKeyParameters*, "Org.BouncyCastle.Crypto.Parameters", "X448PrivateKeyParameters");
...
public:
  ...
  /// @brief Method Encode, addr 0x3359ab0, size 0x88, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t> buf, int32_t off);

  /// @brief Method GeneratePublicKey, addr 0x3359b98, size 0xa0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::X448PublicKeyParameters* GeneratePublicKey();

  /// @brief Method GenerateSecret, addr 0x3359cf0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEncoded, addr 0x3359b38, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33598f0, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> buf, int32_t off);

  /// @brief Method .ctor, addr 0x33599ac, size 0x104, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input);

  /// @brief Method .ctor, addr 0x335984c, size 0xa4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::X448PrivateKeyParameters) == 0x20, "Size mismatch!");
