...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Prng::BasicEntropySourceProvider*);
MARK_REF_T(::Org::BouncyCastle::Crypto::Prng::BasicEntropySourceProvider_BasicEntropySource*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Prng::BasicEntropySourceProvider*, "Org.BouncyCastle.Crypto.Prng", "BasicEntropySourceProvider");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Prng::BasicEntropySourceProvider_BasicEntropySource*, "Org.BouncyCastle.Crypto.Prng", "BasicEntropySourceProvider/BasicEntropySource");
...
public:
  ...
  /// @brief Method Org.BouncyCastle.Crypto.IEntropySource.GetEntropy, addr 0x3419b8c, size 0x74, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> Org_BouncyCastle_Crypto_IEntropySource_GetEntropy();

  /// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_EntropySize, addr 0x3419c80, size 0x8, virtual true, abstract: false, final true
  inline int32_t Org_BouncyCastle_Crypto_IEntropySource_get_EntropySize();

  /// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_IsPredictionResistant, addr 0x3419b84, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3419b74, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Prng::BasicEntropySourceProvider_BasicEntropySource) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method Get, addr 0x3419b08, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3419afc, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Prng::BasicEntropySourceProvider) == 0x20, "Size mismatch!");
