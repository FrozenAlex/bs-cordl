...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Prng::IDrbgProvider*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Prng::IDrbgProvider*, "Org.BouncyCastle.Crypto.Prng", "IDrbgProvider");
// Dependencies
namespace Org::BouncyCastle::Crypto::Prng {
// Is value type: false
