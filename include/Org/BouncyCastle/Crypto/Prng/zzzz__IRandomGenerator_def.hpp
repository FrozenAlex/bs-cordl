...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Prng::IRandomGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Prng::IRandomGenerator*, "Org.BouncyCastle.Crypto.Prng", "IRandomGenerator");
// Dependencies
namespace Org::BouncyCastle::Crypto::Prng {
// Is value type: false
