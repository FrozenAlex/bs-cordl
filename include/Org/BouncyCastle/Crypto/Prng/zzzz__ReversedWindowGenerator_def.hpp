...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Prng::ReversedWindowGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Prng::ReversedWindowGenerator*, "Org.BouncyCastle.Crypto.Prng", "ReversedWindowGenerator");
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Prng::ReversedWindowGenerator) == 0x28, "Size mismatch!");
