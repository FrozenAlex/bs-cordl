...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Prng::SP800SecureRandom*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Prng::SP800SecureRandom*, "Org.BouncyCastle.Crypto.Prng", "SP800SecureRandom");
...
public:
  ...
  /// @brief Method GenerateSeed, addr 0x3361734, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method NextBytes, addr 0x3361698, size 0x9c, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method NextBytes, addr 0x33613c4, size 0x2d4, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t> bytes);

  /// @brief Method Reseed, addr 0x336173c, size 0x1c8, virtual true, abstract: false, final false
  inline void Reseed(::ArrayW<uint8_t> additionalInput);

  /// @brief Method SetSeed, addr 0x336127c, size 0xa4, virtual true, abstract: false, final false
  inline void SetSeed(::ArrayW<uint8_t> seed);

  /// @brief Method SetSeed, addr 0x3361320, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33611ec, size 0x90, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Prng::SP800SecureRandom) == 0x50, "Size mismatch!");
