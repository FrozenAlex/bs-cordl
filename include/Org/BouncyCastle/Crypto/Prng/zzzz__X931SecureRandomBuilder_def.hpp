...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Prng::X931SecureRandomBuilder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Prng::X931SecureRandomBuilder*, "Org.BouncyCastle.Crypto.Prng", "X931SecureRandomBuilder");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_mDateTimeVector, put = __cordl_internal_set_mDateTimeVector)) ::ArrayW<uint8_t> mDateTimeVector;
  ...
  /// @brief Method Build, addr 0x336354c, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDateTimeVector, addr 0x3363544, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Prng::X931SecureRandomBuilder* SetDateTimeVector(::ArrayW<uint8_t> dateTimeVector);

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_mDateTimeVector() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_mDateTimeVector();
  ...
  constexpr void __cordl_internal_set_mDateTimeVector(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x336346c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33634cc, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Security::SecureRandom* entropySource, bool predictionResistant);

  /// @brief Method .ctor, addr 0x336353c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<uint8_t> ___mDateTimeVector;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Prng::X931SecureRandomBuilder) == 0x28, "Size mismatch!");
