...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Signers::ECGost3410Signer*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Signers::ECGost3410Signer*, "Org.BouncyCastle.Crypto.Signers", "ECGost3410Signer");
...
public:
  ...
  /// @brief Method CreateBasePointMultiplier, addr 0x34212c8, size 0x44, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* CreateBasePointMultiplier();

  /// @brief Method GenerateSignature, addr 0x3420c04, size 0x3bc, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Math::BigInteger*> GenerateSignature(::ArrayW<uint8_t> message);

  /// @brief Method Init, addr 0x34209e4, size 0x1fc, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Signers::ECGost3410Signer* New_ctor();

  /// @brief Method VerifySignature, addr 0x3420fc0, size 0x308, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x342130c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0x34209cc, size 0x18, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_Order, addr 0x3420be0, size 0x24, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Signers::ECGost3410Signer) == 0x28, "Size mismatch!");
