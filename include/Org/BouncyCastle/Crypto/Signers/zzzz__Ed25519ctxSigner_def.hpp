...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner*);
MARK_REF_T(::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner_Buffer*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner*, "Org.BouncyCastle.Crypto.Signers", "Ed25519ctxSigner");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner_Buffer*, "Org.BouncyCastle.Crypto.Signers", "Ed25519ctxSigner/Buffer");
...
public:
  // Declarations
  /// @brief Method GenerateSignature, addr 0x3367438, size 0x190, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateSignature(::Org::BouncyCastle::Crypto::Parameters::Ed25519PrivateKeyParameters* privateKey, ::ArrayW<uint8_t> ctx);

  static inline ::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner_Buffer* New_ctor();

  /// @brief Method Reset, addr 0x3367810, size 0xe0, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method VerifySignature, addr 0x3367644, size 0x1b8, virtual false, abstract: false, final false
  inline bool VerifySignature(::Org::BouncyCastle::Crypto::Parameters::Ed25519PublicKeyParameters* publicKey, ::ArrayW<uint8_t> ctx, ::ArrayW<uint8_t> signature);

  /// @brief Method .ctor, addr 0x3367244, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner_Buffer) == 0x50, "Size mismatch!");
...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x33673a0, size 0x20, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method GenerateSignature, addr 0x33673c0, size 0x78, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateSignature();

  /// @brief Method Init, addr 0x3367290, size 0xf0, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner* New_ctor(::ArrayW<uint8_t> context);

  /// @brief Method Reset, addr 0x33677fc, size 0x14, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x3367380, size 0x20, virtual true, abstract: false, final false
  inline void Update(uint8_t b);

  /// @brief Method VerifySignature, addr 0x33675c8, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33671a4, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> context);

  /// @brief Method get_AlgorithmName, addr 0x336724c, size 0x44, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner) == 0x38, "Size mismatch!");
