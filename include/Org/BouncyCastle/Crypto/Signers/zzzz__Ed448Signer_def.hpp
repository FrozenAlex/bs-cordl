...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Signers::Ed448Signer*);
MARK_REF_T(::Org::BouncyCastle::Crypto::Signers::Ed448Signer_Buffer*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Signers::Ed448Signer*, "Org.BouncyCastle.Crypto.Signers", "Ed448Signer");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Signers::Ed448Signer_Buffer*, "Org.BouncyCastle.Crypto.Signers", "Ed448Signer/Buffer");
...
public:
  // Declarations
  /// @brief Method GenerateSignature, addr 0x3423cd0, size 0x190, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateSignature(::Org::BouncyCastle::Crypto::Parameters::Ed448PrivateKeyParameters* privateKey, ::ArrayW<uint8_t> ctx);

  static inline ::Org::BouncyCastle::Crypto::Signers::Ed448Signer_Buffer* New_ctor();

  /// @brief Method Reset, addr 0x34240a8, size 0xe0, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method VerifySignature, addr 0x3423edc, size 0x1b8, virtual false, abstract: false, final false
  inline bool VerifySignature(::Org::BouncyCastle::Crypto::Parameters::Ed448PublicKeyParameters* publicKey, ::ArrayW<uint8_t> ctx, ::ArrayW<uint8_t> signature);

  /// @brief Method .ctor, addr 0x3423adc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Signers::Ed448Signer_Buffer) == 0x50, "Size mismatch!");
...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x3423c38, size 0x20, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method GenerateSignature, addr 0x3423c58, size 0x78, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateSignature();

  /// @brief Method Init, addr 0x3423b28, size 0xf0, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Signers::Ed448Signer* New_ctor(::ArrayW<uint8_t> context);

  /// @brief Method Reset, addr 0x3424094, size 0x14, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x3423c18, size 0x20, virtual true, abstract: false, final false
  inline void Update(uint8_t b);

  /// @brief Method VerifySignature, addr 0x3423e60, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3423a3c, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> context);

  /// @brief Method get_AlgorithmName, addr 0x3423ae4, size 0x44, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Signers::Ed448Signer) == 0x38, "Size mismatch!");
