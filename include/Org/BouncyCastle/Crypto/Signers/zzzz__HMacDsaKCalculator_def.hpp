...
public:
  ...
  /// @brief Method BitsToInt, addr 0x34267f0, size 0xcc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* BitsToInt(::ArrayW<uint8_t> t);

  /// @brief Method Init, addr 0x34263c4, size 0x42c, virtual true, abstract: false, final true
  inline void Init(::Org::BouncyCastle::Math::BigInteger* n, ::Org::BouncyCastle::Math::BigInteger* d, ::ArrayW<uint8_t> message);

  /// @brief Method Init, addr 0x3426378, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method NextK, addr 0x34268bc, size 0x284, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x342628c, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_IsDeterministic, addr 0x3426370, size 0x8, virtual true, abstract: false, final false
