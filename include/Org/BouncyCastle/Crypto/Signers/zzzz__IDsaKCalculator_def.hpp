...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Signers::IDsaKCalculator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Signers::IDsaKCalculator*, "Org.BouncyCastle.Crypto.Signers", "IDsaKCalculator");
// Dependencies
namespace Org::BouncyCastle::Crypto::Signers {
// Is value type: false
