...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Signers::Iso9796d2PssSigner*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Signers::Iso9796d2PssSigner*, "Org.BouncyCastle.Crypto.Signers", "Iso9796d2PssSigner");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_preBlock, put = __cordl_internal_set_preBlock)) ::ArrayW<uint8_t> preBlock;
  ...
  __declspec(property(get = __cordl_internal_get_preSig, put = __cordl_internal_set_preSig)) ::ArrayW<uint8_t> preSig;
  ...
  __declspec(property(get = __cordl_internal_get_recoveredMessage, put = __cordl_internal_set_recoveredMessage)) ::ArrayW<uint8_t> recoveredMessage;
  ...
  __declspec(property(get = __cordl_internal_get_standardSalt, put = __cordl_internal_set_standardSalt)) ::ArrayW<uint8_t> standardSalt;
  ...
  /// @brief Method BlockUpdate, addr 0x3427f98, size 0x154, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t length);

  /// @brief Method ClearBlock, addr 0x3427588, size 0x20, virtual false, abstract: false, final false
  inline void ClearBlock(::ArrayW<uint8_t> block);

  /// @brief Method GenerateSignature, addr 0x34281ec, size 0x6dc, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateSignature();

  /// @brief Method GetRecoveredMessage, addr 0x3426b40, size 0x8, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> GetRecoveredMessage();

  /// @brief Method HasFullMessage, addr 0x3429004, size 0x8, virtual true, abstract: false, final false
  inline bool HasFullMessage();

  /// @brief Method Init, addr 0x3427080, size 0x488, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method IsSameAs, addr 0x3427508, size 0x80, virtual false, abstract: false, final false
  inline bool IsSameAs(::ArrayW<uint8_t> a, ::ArrayW<uint8_t> b);

  /// @brief Method ItoOSP, addr 0x342900c, size 0x54, virtual false, abstract: false, final false
  inline void ItoOSP(int32_t i, ::ArrayW<uint8_t> sp);

  /// @brief Method LtoOSP, addr 0x34288c8, size 0x94, virtual false, abstract: false, final false
  inline void LtoOSP(int64_t l, ::ArrayW<uint8_t> sp);

  /// @brief Method MaskGeneratorFunction1, addr 0x3427a38, size 0x45c, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x34280ec, size 0x100, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x3427e94, size 0x104, virtual true, abstract: false, final false
  inline void Update(uint8_t input);

  /// @brief Method UpdateWithRecoveredMessage, addr 0x34275a8, size 0x490, virtual true, abstract: false, final false
  inline void UpdateWithRecoveredMessage(::ArrayW<uint8_t> signature);

  /// @brief Method VerifySignature, addr 0x342895c, size 0x6a8, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_preBlock() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_preBlock();

  constexpr int32_t const& __cordl_internal_get_preMStart() const;

  constexpr int32_t& __cordl_internal_get_preMStart();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_preSig() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_preSig();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_recoveredMessage() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_recoveredMessage();

  constexpr int32_t const& __cordl_internal_get_saltLength() const;

  constexpr int32_t& __cordl_internal_get_saltLength();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_standardSalt() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_standardSalt();
  ...
  constexpr void __cordl_internal_set_preBlock(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_preMStart(int32_t value);

  constexpr void __cordl_internal_set_preSig(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_preTLength(int32_t value);

  constexpr void __cordl_internal_set_random(::Org::BouncyCastle::Security::SecureRandom* value);

  constexpr void __cordl_internal_set_recoveredMessage(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_saltLength(int32_t value);

  constexpr void __cordl_internal_set_standardSalt(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_trailer(int32_t value);

  /// @brief Method .ctor, addr 0x3426fb0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3426b48, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x3426fb8, size 0xc8, virtual true, abstract: false, final false
...
public:
  ...
  ::ArrayW<uint8_t> ___standardSalt;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Signers::Iso9796d2PssSigner) == 0x80, "Size mismatch!");
