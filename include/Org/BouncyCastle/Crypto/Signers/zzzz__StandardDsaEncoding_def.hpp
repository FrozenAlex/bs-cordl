...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Signers::StandardDsaEncoding*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Signers::StandardDsaEncoding*, "Org.BouncyCastle.Crypto.Signers", "StandardDsaEncoding");
...
public:
  ...
  /// @brief Method CheckValue, addr 0x3375a9c, size 0x9c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CheckValue(::Org::BouncyCastle::Math::BigInteger* n, ::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method Decode, addr 0x33756fc, size 0x240, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Math::BigInteger*> Decode(::Org::BouncyCastle::Math::BigInteger* n, ::ArrayW<uint8_t> encoding);

  /// @brief Method DecodeValue, addr 0x3375b38, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method Encode, addr 0x337593c, size 0x160, virtual true, abstract: false, final false
  ...
  /// @brief Method EncodeValue, addr 0x3375c04, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3375ce8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Signers::StandardDsaEncoding) == 0x10, "Size mismatch!");
