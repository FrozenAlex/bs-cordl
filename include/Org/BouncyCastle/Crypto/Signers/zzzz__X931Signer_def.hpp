...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Signers::X931Signer*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Signers::X931Signer*, "Org.BouncyCastle.Crypto.Signers", "X931Signer");
...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x3430c74, size 0xd0, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t> input, int32_t off, int32_t len);

  /// @brief Method ClearBlock, addr 0x3430b9c, size 0x20, virtual false, abstract: false, final false
  inline void ClearBlock(::ArrayW<uint8_t> block);

  /// @brief Method CreateSignatureBlock, addr 0x3430f58, size 0x28c, virtual false, abstract: false, final false
  inline void CreateSignatureBlock();

  /// @brief Method GenerateSignature, addr 0x3430dec, size 0x16c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateSignature();

  /// @brief Method Init, addr 0x34309e8, size 0x1b4, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x3430d44, size 0xa8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x3430bbc, size 0xb8, virtual true, abstract: false, final false
  inline void Update(uint8_t b);

  /// @brief Method VerifySignature, addr 0x34311e4, size 0x258, virtual true, abstract: false, final false
  ...
  constexpr ::Org::BouncyCastle::Crypto::Parameters::RsaKeyParameters* const& __cordl_internal_get_kParam() const;
  ...
  /// @brief Method .ctor, addr 0x34309e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher, ::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method .ctor, addr 0x343076c, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x3430878, size 0x168, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Signers::X931Signer) == 0x38, "Size mismatch!");
