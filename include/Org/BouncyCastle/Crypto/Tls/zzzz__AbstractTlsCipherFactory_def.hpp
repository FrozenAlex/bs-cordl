...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::AbstractTlsCipherFactory*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::AbstractTlsCipherFactory*, "Org.BouncyCastle.Crypto.Tls", "AbstractTlsCipherFactory");
...
public:
  ...
  /// @brief Method CreateCipher, addr 0x3431444, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3431480, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::AbstractTlsCipherFactory) == 0x10, "Size mismatch!");
