...
public:
  ...
  /// @brief Method CreateCipher, addr 0x33769c4, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3376a00, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
