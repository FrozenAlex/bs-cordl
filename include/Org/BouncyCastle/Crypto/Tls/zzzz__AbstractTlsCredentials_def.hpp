...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::AbstractTlsCredentials*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::AbstractTlsCredentials*, "Org.BouncyCastle.Crypto.Tls", "AbstractTlsCredentials");
...
public:
  ...
  /// @brief Method .ctor, addr 0x343143c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::AbstractTlsCredentials) == 0x10, "Size mismatch!");
