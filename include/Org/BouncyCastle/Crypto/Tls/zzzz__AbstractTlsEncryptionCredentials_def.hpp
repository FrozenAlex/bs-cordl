...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::AbstractTlsEncryptionCredentials*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::AbstractTlsEncryptionCredentials*, "Org.BouncyCastle.Crypto.Tls", "AbstractTlsEncryptionCredentials");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3432650, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::AbstractTlsEncryptionCredentials) == 0x10, "Size mismatch!");
