...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::AbstractTlsSignerCredentials*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::AbstractTlsSignerCredentials*, "Org.BouncyCastle.Crypto.Tls", "AbstractTlsSignerCredentials");
...
public:
  ...
  /// @brief Method .ctor, addr 0x337901c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SignatureAndHashAlgorithm, addr 0x3378fd0, size 0x4c, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::AbstractTlsSignerCredentials) == 0x10, "Size mismatch!");
