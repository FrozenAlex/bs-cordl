...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::AbstractTlsSigner*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::AbstractTlsSigner*, "Org.BouncyCastle.Crypto.Tls", "AbstractTlsSigner");
...
public:
  ...
  /// @brief Method CreateSigner, addr 0x3433a1c, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateVerifyer, addr 0x3433a34, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateRawSignature, addr 0x34339e0, size 0x1c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateRawSignature(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey, ::ArrayW<uint8_t> md5AndSha1);

  /// @brief Method Init, addr 0x34339d8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method VerifyRawSignature, addr 0x34339fc, size 0x20, virtual true, abstract: false, final false
  inline bool VerifyRawSignature(::ArrayW<uint8_t> sigBytes, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey, ::ArrayW<uint8_t> md5AndSha1);
  ...
  /// @brief Method .ctor, addr 0x3433a4c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::AbstractTlsSigner) == 0x18, "Size mismatch!");
