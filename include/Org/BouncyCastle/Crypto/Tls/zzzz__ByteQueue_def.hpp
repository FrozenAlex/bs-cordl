...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::ByteQueue*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::ByteQueue*, "Org.BouncyCastle.Crypto.Tls", "ByteQueue");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_databuf, put = __cordl_internal_set_databuf)) ::ArrayW<uint8_t> databuf;
  ...
  /// @brief Method AddData, addr 0x3379b4c, size 0x174, virtual false, abstract: false, final false
  inline void AddData(::ArrayW<uint8_t> data, int32_t offset, int32_t len);

  /// @brief Method CopyTo, addr 0x3379cc8, size 0x198, virtual false, abstract: false, final false
  inline void CopyTo(::System::IO::Stream* output, int32_t length);

  static inline ::Org::BouncyCastle::Crypto::Tls::ByteQueue* New_ctor();

  static inline ::Org::BouncyCastle::Crypto::Tls::ByteQueue* New_ctor(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  static inline ::Org::BouncyCastle::Crypto::Tls::ByteQueue* New_ctor(int32_t capacity);

  /// @brief Method NextTwoPow, addr 0x3379a70, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t NextTwoPow(int32_t i);

  /// @brief Method Read, addr 0x3379e60, size 0x220, virtual false, abstract: false, final false
  inline void Read(::ArrayW<uint8_t> buf, int32_t offset, int32_t len, int32_t skip);

  /// @brief Method ReadFrom, addr 0x337a080, size 0x1d4, virtual false, abstract: false, final false
  inline ::System::IO::MemoryStream* ReadFrom(int32_t length);

  /// @brief Method RemoveData, addr 0x337a3ec, size 0x8c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> RemoveData(int32_t len, int32_t skip);

  /// @brief Method RemoveData, addr 0x337a3c0, size 0x2c, virtual false, abstract: false, final false
  inline void RemoveData(::ArrayW<uint8_t> buf, int32_t off, int32_t len, int32_t skip);

  /// @brief Method RemoveData, addr 0x337a254, size 0x16c, virtual false, abstract: false, final false
  inline void RemoveData(int32_t i);

  /// @brief Method Shrink, addr 0x337a478, size 0xf0, virtual false, abstract: false, final false
  inline void Shrink();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_databuf() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_databuf();
  ...
  constexpr void __cordl_internal_set_databuf(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_readOnlyBuf(bool value);

  constexpr void __cordl_internal_set_skipped(int32_t value);

  /// @brief Method .ctor, addr 0x3379a8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3379b38, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method .ctor, addr 0x3379a94, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity);

  /// @brief Method get_Available, addr 0x3379cc0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::ByteQueue) == 0x28, "Size mismatch!");
