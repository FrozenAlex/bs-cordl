...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::CertChainType*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::CertChainType*, "Org.BouncyCastle.Crypto.Tls", "CertChainType");
...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x337aa54, size 0x10, virtual false, abstract: false, final false
  static inline bool IsValid(uint8_t certChainType);

  static inline ::Org::BouncyCastle::Crypto::Tls::CertChainType* New_ctor();

  /// @brief Method .ctor, addr 0x337aa64, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::CertChainType) == 0x10, "Size mismatch!");
