...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::CertificateStatusType*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::CertificateStatusType*, "Org.BouncyCastle.Crypto.Tls", "CertificateStatusType");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3437574, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::CertificateStatusType) == 0x10, "Size mismatch!");
