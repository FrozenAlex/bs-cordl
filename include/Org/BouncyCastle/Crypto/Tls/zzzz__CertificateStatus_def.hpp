...
public:
  ...
  /// @brief Method Encode, addr 0x337c414, size 0x160, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  /// @brief Method GetOcspResponse, addr 0x337c340, size 0xd4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Ocsp::OcspResponse* GetOcspResponse();

  /// @brief Method IsCorrectType, addr 0x337c240, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x337c574, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x337c1ac, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(uint8_t statusType, ::System::Object* response);

  /// @brief Method get_Response, addr 0x337c338, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* get_Response();

  /// @brief Method get_StatusType, addr 0x337c330, size 0x8, virtual true, abstract: false, final false
