...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::CertificateStatus*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::CertificateStatus*, "Org.BouncyCastle.Crypto.Tls", "CertificateStatus");
...
public:
  ...
  /// @brief Method Encode, addr 0x3436e94, size 0x160, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  /// @brief Method GetOcspResponse, addr 0x3436dc0, size 0xd4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Ocsp::OcspResponse* GetOcspResponse();

  /// @brief Method IsCorrectType, addr 0x3436cc0, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x3436ff4, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3436c2c, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(uint8_t statusType, ::System::Object* response);

  /// @brief Method get_Response, addr 0x3436db8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* get_Response();

  /// @brief Method get_StatusType, addr 0x3436db0, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::CertificateStatus) == 0x20, "Size mismatch!");
