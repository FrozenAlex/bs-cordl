...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::CertificateType*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::CertificateType*, "Org.BouncyCastle.Crypto.Tls", "CertificateType");
...
public:
  ...
  /// @brief Method .ctor, addr 0x337caf8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::CertificateType) == 0x10, "Size mismatch!");
