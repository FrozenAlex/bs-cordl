...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::CertificateUrl*);
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::CertificateUrl_ListBuffer16*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::CertificateUrl*, "Org.BouncyCastle.Crypto.Tls", "CertificateUrl");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::CertificateUrl_ListBuffer16*, "Org.BouncyCastle.Crypto.Tls", "CertificateUrl/ListBuffer16");
...
public:
  // Declarations
  /// @brief Method EncodeTo, addr 0x337d074, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x337d008, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::CertificateUrl_ListBuffer16) == 0x50, "Size mismatch!");
...
public:
  ...
  /// @brief Method Encode, addr 0x337cc68, size 0x3a0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x337cafc, size 0x15c, virtual false, abstract: false, final false
  inline void _ctor(uint8_t type, ::System::Collections::IList* urlAndHashList);

  /// @brief Method get_Type, addr 0x337cc58, size 0x8, virtual true, abstract: false, final false
  inline uint8_t get_Type();

  /// @brief Method get_UrlAndHashList, addr 0x337cc60, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::IList* get_UrlAndHashList();

  /// @brief Method parse, addr 0x337d190, size 0x2a0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::CertificateUrl) == 0x20, "Size mismatch!");
