...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::ChangeCipherSpec*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::ChangeCipherSpec*, "Org.BouncyCastle.Crypto.Tls", "ChangeCipherSpec");
...
public:
  ...
  /// @brief Method .ctor, addr 0x337e410, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::ChangeCipherSpec) == 0x10, "Size mismatch!");
