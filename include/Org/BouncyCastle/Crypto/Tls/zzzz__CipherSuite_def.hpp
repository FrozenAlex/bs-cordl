...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::CipherSuite*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::CipherSuite*, "Org.BouncyCastle.Crypto.Tls", "CipherSuite");
...
public:
  // Declarations
  /// @brief Method IsScsv, addr 0x337e414, size 0x14, virtual false, abstract: false, final false
  static inline bool IsScsv(int32_t cipherSuite);

  static inline ::Org::BouncyCastle::Crypto::Tls::CipherSuite* New_ctor();

  /// @brief Method .ctor, addr 0x337e428, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::CipherSuite) == 0x10, "Size mismatch!");
