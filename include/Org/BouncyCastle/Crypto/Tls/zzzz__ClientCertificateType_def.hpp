...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::ClientCertificateType*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::ClientCertificateType*, "Org.BouncyCastle.Crypto.Tls", "ClientCertificateType");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3438eb4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::ClientCertificateType) == 0x10, "Size mismatch!");
