...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::CompressionMethod*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::CompressionMethod*, "Org.BouncyCastle.Crypto.Tls", "CompressionMethod");
...
public:
  ...
  /// @brief Method .ctor, addr 0x337f2dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::CompressionMethod) == 0x10, "Size mismatch!");
