...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::ConnectionEnd*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::ConnectionEnd*, "Org.BouncyCastle.Crypto.Tls", "ConnectionEnd");
...
public:
  ...
  /// @brief Method .ctor, addr 0x337f2e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::ConnectionEnd) == 0x10, "Size mismatch!");
