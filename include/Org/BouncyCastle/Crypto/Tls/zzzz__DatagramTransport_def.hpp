...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::DatagramTransport*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::DatagramTransport*, "Org.BouncyCastle.Crypto.Tls", "DatagramTransport");
// Dependencies
namespace Org::BouncyCastle::Crypto::Tls {
// Is value type: false
