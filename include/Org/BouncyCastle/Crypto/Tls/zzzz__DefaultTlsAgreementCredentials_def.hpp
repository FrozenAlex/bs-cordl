...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::DefaultTlsAgreementCredentials*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::DefaultTlsAgreementCredentials*, "Org.BouncyCastle.Crypto.Tls", "DefaultTlsAgreementCredentials");
...
public:
  ...
  /// @brief Method GenerateAgreement, addr 0x337f590, size 0x1b8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x337f2e8, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certificate, addr 0x337f588, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::DefaultTlsAgreementCredentials) == 0x30, "Size mismatch!");
