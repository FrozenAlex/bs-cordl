...
public:
  ...
  /// @brief Method Accept, addr 0x3381028, size 0x4c, virtual true, abstract: false, final false
  inline bool Accept(::Org::BouncyCastle::Crypto::Parameters::DHParameters* dhParameters);

  /// @brief Method AddDefaultGroup, addr 0x3380d68, size 0xdc, virtual false, abstract: false, final false
  static inline void AddDefaultGroup(::Org::BouncyCastle::Crypto::Parameters::DHParameters* dhParameters);

  /// @brief Method AreGroupsEqual, addr 0x338107c, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method AreParametersEqual, addr 0x33810f4, size 0x34, virtual true, abstract: false, final false
  inline bool AreParametersEqual(::Org::BouncyCastle::Math::BigInteger* a, ::Org::BouncyCastle::Math::BigInteger* b);

  /// @brief Method CheckGroup, addr 0x3381128, size 0x33c, virtual true, abstract: false, final false
  inline bool CheckGroup(::Org::BouncyCastle::Crypto::Parameters::DHParameters* dhParameters);

  /// @brief Method CheckMinimumPrimeBits, addr 0x3381464, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33808ac, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x338101c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* groups, int32_t minimumPrimeBits);

  /// @brief Method .ctor, addr 0x3380fa8, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method get_MinimumPrimeBits, addr 0x3381074, size 0x8, virtual true, abstract: false, final false
