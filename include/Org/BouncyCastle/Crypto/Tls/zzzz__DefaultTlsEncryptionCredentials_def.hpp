...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::DefaultTlsEncryptionCredentials*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::DefaultTlsEncryptionCredentials*, "Org.BouncyCastle.Crypto.Tls", "DefaultTlsEncryptionCredentials");
...
public:
  ...
  /// @brief Method DecryptPreMasterSecret, addr 0x343c158, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x343bf30, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certificate, addr 0x343c150, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::DefaultTlsEncryptionCredentials) == 0x28, "Size mismatch!");
