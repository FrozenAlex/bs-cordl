...
public:
  ...
  /// @brief Method DecryptPreMasterSecret, addr 0x33816d8, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33814b0, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certificate, addr 0x33816d0, size 0x8, virtual true, abstract: false, final false
