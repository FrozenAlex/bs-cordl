...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::DigestInputBuffer*);
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::DigestInputBuffer_DigStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::DigestInputBuffer*, "Org.BouncyCastle.Crypto.Tls", "DigestInputBuffer");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::DigestInputBuffer_DigStream*, "Org.BouncyCastle.Crypto.Tls", "DigestInputBuffer/DigStream");
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::DigestInputBuffer_DigStream) == 0x38, "Size mismatch!");
...
// Non member Declarations
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::DigestInputBuffer) == 0x50, "Size mismatch!");
