...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::DtlsEpoch*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::DtlsEpoch*, "Org.BouncyCastle.Crypto.Tls", "DtlsEpoch");
...
public:
  ...
  /// @brief Method AllocateSequenceNumber, addr 0x338979c, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x338967c, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(int32_t epoch, ::Org::BouncyCastle::Crypto::Tls::TlsCipher* cipher);

  /// @brief Method get_Cipher, addr 0x3389884, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsCipher* get_Cipher();

  /// @brief Method get_Epoch, addr 0x338988c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Epoch();

  /// @brief Method get_ReplayWindow, addr 0x3389894, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::DtlsReplayWindow* get_ReplayWindow();

  /// @brief Method get_SequenceNumber, addr 0x338989c, size 0x2c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::DtlsEpoch) == 0x30, "Size mismatch!");
