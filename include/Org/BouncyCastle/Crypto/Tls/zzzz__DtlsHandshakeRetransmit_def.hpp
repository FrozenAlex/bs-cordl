...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::DtlsHandshakeRetransmit*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::DtlsHandshakeRetransmit*, "Org.BouncyCastle.Crypto.Tls", "DtlsHandshakeRetransmit");
// Dependencies
namespace Org::BouncyCastle::Crypto::Tls {
// Is value type: false
