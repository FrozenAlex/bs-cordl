...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::DtlsProtocol*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::DtlsProtocol*, "Org.BouncyCastle.Crypto.Tls", "DtlsProtocol");
...
public:
  ...
  /// @brief Method ApplyMaxFragmentLengthExtension, addr 0x3384e8c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method EvaluateMaxFragmentLengthExtension, addr 0x3384f08, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCertificate, addr 0x3384fac, size 0x88, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> GenerateCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate* certificate);

  /// @brief Method GenerateSupplementalData, addr 0x3385034, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessFinished, addr 0x3384d5c, size 0x130, virtual true, abstract: false, final false
  inline void ProcessFinished(::ArrayW<uint8_t> body, ::ArrayW<uint8_t> expected_verify_data);

  /// @brief Method ValidateSelectedCipherSuite, addr 0x33850b4, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3384d04, size 0x58, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::DtlsProtocol) == 0x18, "Size mismatch!");
