...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::DtlsReassembler*);
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::DtlsReassembler_Range*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::DtlsReassembler*, "Org.BouncyCastle.Crypto.Tls", "DtlsReassembler");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::DtlsReassembler_Range*, "Org.BouncyCastle.Crypto.Tls", "DtlsReassembler/Range");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3389a10, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t start, int32_t end);

  /// @brief Method get_End, addr 0x338a128, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_End();

  /// @brief Method get_Start, addr 0x338a118, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Start();

  /// @brief Method set_End, addr 0x338a130, size 0x8, virtual false, abstract: false, final false
  inline void set_End(int32_t value);

  /// @brief Method set_Start, addr 0x338a120, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::DtlsReassembler_Range) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method ContributeFragment, addr 0x3389adc, size 0x4f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBodyIfComplete, addr 0x3389a20, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x3389fcc, size 0x14c, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x33898c8, size 0x148, virtual false, abstract: false, final false
  inline void _ctor(uint8_t msg_type, int32_t length);

  /// @brief Method get_MsgType, addr 0x3389a18, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::DtlsReassembler) == 0x28, "Size mismatch!");
