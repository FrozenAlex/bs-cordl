...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::DtlsTransport*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::DtlsTransport*, "Org.BouncyCastle.Crypto.Tls", "DtlsTransport");
...
public:
  ...
  /// @brief Method Close, addr 0x346757c, size 0x20, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method GetReceiveLimit, addr 0x3466e44, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetReceiveLimit();

  /// @brief Method GetSendLimit, addr 0x3466e64, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method Receive, addr 0x3466e84, size 0x3a4, virtual true, abstract: false, final false
  inline int32_t Receive(::ArrayW<uint8_t> buf, int32_t off, int32_t len, int32_t waitMillis);

  /// @brief Method Send, addr 0x3467228, size 0x354, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3466e3c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::DtlsTransport) == 0x18, "Size mismatch!");
