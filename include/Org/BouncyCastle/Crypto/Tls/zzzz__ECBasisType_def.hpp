...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x346759c, size 0x14, virtual false, abstract: false, final false
  static inline bool IsValid(uint8_t ecBasisType);

  static inline ::Org::BouncyCastle::Crypto::Tls::ECBasisType* New_ctor();

  /// @brief Method .ctor, addr 0x34675b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
