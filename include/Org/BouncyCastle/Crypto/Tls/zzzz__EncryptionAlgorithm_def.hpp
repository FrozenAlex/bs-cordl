...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::EncryptionAlgorithm*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::EncryptionAlgorithm*, "Org.BouncyCastle.Crypto.Tls", "EncryptionAlgorithm");
...
public:
  ...
  /// @brief Method .ctor, addr 0x34675bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::EncryptionAlgorithm) == 0x10, "Size mismatch!");
