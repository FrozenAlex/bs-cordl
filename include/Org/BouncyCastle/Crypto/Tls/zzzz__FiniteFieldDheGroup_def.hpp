...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::FiniteFieldDheGroup*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::FiniteFieldDheGroup*, "Org.BouncyCastle.Crypto.Tls", "FiniteFieldDheGroup");
...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x3467684, size 0x10, virtual false, abstract: false, final false
  static inline bool IsValid(uint8_t group);

  static inline ::Org::BouncyCastle::Crypto::Tls::FiniteFieldDheGroup* New_ctor();

  /// @brief Method .ctor, addr 0x3467694, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::FiniteFieldDheGroup) == 0x10, "Size mismatch!");
