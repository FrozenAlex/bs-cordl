...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (*)(uint8_t)>(&::Org::BouncyCastle::Crypto::Tls::FiniteFieldDheGroup::IsValid)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x33acc04;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Crypto::Tls::FiniteFieldDheGroup*>(), { "IsValid", {}, { ::i2c::type_of<uint8_t>() } })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Org::BouncyCastle::Crypto::Tls::FiniteFieldDheGroup::*)()>(&::Org::BouncyCastle::Crypto::Tls::FiniteFieldDheGroup::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x33acc14;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Crypto::Tls::FiniteFieldDheGroup*>(), { ".ctor", {}, {} })));
    return ___internal_method;
  }
};
...
inline ::Org::BouncyCastle::Crypto::Tls::FiniteFieldDheGroup* Org::BouncyCastle::Crypto::Tls::FiniteFieldDheGroup::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Org::BouncyCastle::Crypto::Tls::FiniteFieldDheGroup*>());
}
// Ctor Parameters []
