...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::HandshakeType*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::HandshakeType*, "Org.BouncyCastle.Crypto.Tls", "HandshakeType");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3467698, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::HandshakeType) == 0x10, "Size mismatch!");
