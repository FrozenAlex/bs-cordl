...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::HeartbeatMessageType*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::HeartbeatMessageType*, "Org.BouncyCastle.Crypto.Tls", "HeartbeatMessageType");
...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x3467c28, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34680d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::HeartbeatMessageType) == 0x10, "Size mismatch!");
