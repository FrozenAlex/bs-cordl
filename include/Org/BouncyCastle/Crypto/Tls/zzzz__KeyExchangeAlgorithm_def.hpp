...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::KeyExchangeAlgorithm*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::KeyExchangeAlgorithm*, "Org.BouncyCastle.Crypto.Tls", "KeyExchangeAlgorithm");
...
public:
  ...
  /// @brief Method .ctor, addr 0x33ad658, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::KeyExchangeAlgorithm) == 0x10, "Size mismatch!");
