...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::MacAlgorithm*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::MacAlgorithm*, "Org.BouncyCastle.Crypto.Tls", "MacAlgorithm");
...
public:
  ...
  /// @brief Method .ctor, addr 0x33ad65c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::MacAlgorithm) == 0x10, "Size mismatch!");
