...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::NewSessionTicket*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::NewSessionTicket*, "Org.BouncyCastle.Crypto.Tls", "NewSessionTicket");
...
public:
  // Declarations
  __declspec(property(get = get_Ticket)) ::ArrayW<uint8_t> Ticket;

  __declspec(property(get = get_TicketLifetimeHint)) int64_t TicketLifetimeHint;

  /// @brief Field mTicket, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get_mTicket, put = __cordl_internal_set_mTicket)) ::ArrayW<uint8_t> mTicket;
  ...
  /// @brief Method Encode, addr 0x3468154, size 0x80, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  static inline ::Org::BouncyCastle::Crypto::Tls::NewSessionTicket* New_ctor(int64_t ticketLifetimeHint, ::ArrayW<uint8_t> ticket);

  /// @brief Method Parse, addr 0x34681d4, size 0x9c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Tls::NewSessionTicket* Parse(::System::IO::Stream* input);

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_mTicket() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_mTicket();
  ...
  constexpr void __cordl_internal_set_mTicket(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_mTicketLifetimeHint(int64_t value);

  /// @brief Method .ctor, addr 0x346813c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int64_t ticketLifetimeHint, ::ArrayW<uint8_t> ticket);

  /// @brief Method get_Ticket, addr 0x346814c, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_Ticket();

  /// @brief Method get_TicketLifetimeHint, addr 0x3468144, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::NewSessionTicket) == 0x20, "Size mismatch!");
