...
public:
  ...
  /// @brief Method Equals, addr 0x3468bc8, size 0x20, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* other);

  /// @brief Method Equals, addr 0x3468b3c, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method Get, addr 0x3468bf0, size 0x1f4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* Get(int32_t major, int32_t minor);

  /// @brief Method GetEquivalentTLSVersion, addr 0x34689d4, size 0xc4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* GetEquivalentTLSVersion();

  /// @brief Method GetHashCode, addr 0x3468be8, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetUnknownVersion, addr 0x3468de4, size 0x178, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* GetUnknownVersion(int32_t major, int32_t minor, ::StringW prefix);

  /// @brief Method IsEqualOrEarlierVersionOf, addr 0x3468a98, size 0x54, virtual false, abstract: false, final false
  inline bool IsEqualOrEarlierVersionOf(::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* version);

  /// @brief Method IsLaterVersionOf, addr 0x3468aec, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x3468f5c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3468918, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FullVersion, addr 0x3468928, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_FullVersion();

  /// @brief Method get_IsDtls, addr 0x3468944, size 0x14, virtual false, abstract: false, final false
  inline bool get_IsDtls();

  /// @brief Method get_IsSsl, addr 0x3468958, size 0x68, virtual false, abstract: false, final false
  inline bool get_IsSsl();

  /// @brief Method get_IsTls, addr 0x34689c0, size 0x14, virtual false, abstract: false, final false
  inline bool get_IsTls();

  /// @brief Method get_MajorVersion, addr 0x3468930, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_MajorVersion();

  /// @brief Method get_MinorVersion, addr 0x346893c, size 0x8, virtual false, abstract: false, final false
