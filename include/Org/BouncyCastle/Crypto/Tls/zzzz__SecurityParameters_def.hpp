...
public:
  ...
  /// @brief Method Clear, addr 0x346ad94, size 0x84, virtual true, abstract: false, final false
  inline void Clear();
  ...
  /// @brief Method .ctor, addr 0x346ae78, size 0x30, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CipherSuite, addr 0x346ae20, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_CipherSuite();

  /// @brief Method get_ClientRandom, addr 0x346ae48, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_ClientRandom();

  /// @brief Method get_CompressionAlgorithm, addr 0x346ae28, size 0x8, virtual true, abstract: false, final false
  inline uint8_t get_CompressionAlgorithm();

  /// @brief Method get_Entity, addr 0x346ae18, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Entity();

  /// @brief Method get_IsExtendedMasterSecret, addr 0x346ae70, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsExtendedMasterSecret();

  /// @brief Method get_MasterSecret, addr 0x346ae40, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_MasterSecret();

  /// @brief Method get_PrfAlgorithm, addr 0x346ae30, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_PrfAlgorithm();

  /// @brief Method get_PskIdentity, addr 0x346ae60, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_PskIdentity();

  /// @brief Method get_ServerRandom, addr 0x346ae50, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_ServerRandom();

  /// @brief Method get_SessionHash, addr 0x346ae58, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_SessionHash();

  /// @brief Method get_SrpIdentity, addr 0x346ae68, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_SrpIdentity();

  /// @brief Method get_VerifyDataLength, addr 0x346ae38, size 0x8, virtual true, abstract: false, final false
