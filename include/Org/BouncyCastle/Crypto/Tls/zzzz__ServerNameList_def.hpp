...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::ServerNameList*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::ServerNameList*, "Org.BouncyCastle.Crypto.Tls", "ServerNameList");
...
public:
  ...
  /// @brief Method CheckNameType, addr 0x33b0cec, size 0xac, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> CheckNameType(::ArrayW<uint8_t> nameTypesSeen, uint8_t nameType);

  /// @brief Method Encode, addr 0x33b0858, size 0x494, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  static inline ::Org::BouncyCastle::Crypto::Tls::ServerNameList* New_ctor(::System::Collections::IList* serverNameList);

  /// @brief Method Parse, addr 0x33b0d98, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33b07f8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* serverNameList);

  /// @brief Method get_ServerNames, addr 0x33b0850, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::ServerNameList) == 0x18, "Size mismatch!");
