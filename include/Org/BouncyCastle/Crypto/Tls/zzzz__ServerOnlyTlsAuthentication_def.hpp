...
public:
  ...
  /// @brief Method GetClientCredentials, addr 0x346bac0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x346bac8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
