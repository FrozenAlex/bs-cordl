...
public:
  ...
  /// @brief Method Build, addr 0x346c2e4, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCipherSuite, addr 0x346c498, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::SessionParameters_Builder* SetCipherSuite(int32_t cipherSuite);

  /// @brief Method SetCompressionAlgorithm, addr 0x346c4a0, size 0xc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::SessionParameters_Builder* SetCompressionAlgorithm(uint8_t compressionAlgorithm);

  /// @brief Method SetExtendedMasterSecret, addr 0x346c4ac, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::SessionParameters_Builder* SetExtendedMasterSecret(bool extendedMasterSecret);

  /// @brief Method SetMasterSecret, addr 0x346c4b4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::SessionParameters_Builder* SetMasterSecret(::ArrayW<uint8_t> masterSecret);

  /// @brief Method SetPeerCertificate, addr 0x346c4bc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPskIdentity, addr 0x346c4c4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::SessionParameters_Builder* SetPskIdentity(::ArrayW<uint8_t> pskIdentity);

  /// @brief Method SetServerExtensions, addr 0x346c4d4, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSrpIdentity, addr 0x346c4cc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::SessionParameters_Builder* SetSrpIdentity(::ArrayW<uint8_t> srpIdentity);

  /// @brief Method Validate, addr 0x346c418, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x346c2c0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Clear, addr 0x346bdc8, size 0x88, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Copy, addr 0x346be50, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadServerExtensions, addr 0x346bf38, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x346bcf4, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CipherSuite, addr 0x346bf00, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_CipherSuite();

  /// @brief Method get_CompressionAlgorithm, addr 0x346bf08, size 0x8, virtual false, abstract: false, final false
  inline uint8_t get_CompressionAlgorithm();

  /// @brief Method get_IsExtendedMasterSecret, addr 0x346bf10, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsExtendedMasterSecret();

  /// @brief Method get_MasterSecret, addr 0x346bf18, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> get_MasterSecret();

  /// @brief Method get_PeerCertificate, addr 0x346bf20, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::Certificate* get_PeerCertificate();

  /// @brief Method get_PskIdentity, addr 0x346bf28, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> get_PskIdentity();

  /// @brief Method get_SrpIdentity, addr 0x346bf30, size 0x8, virtual false, abstract: false, final false
