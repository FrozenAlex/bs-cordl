...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::SignerInputBuffer*);
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::SignerInputBuffer_SigStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::SignerInputBuffer*, "Org.BouncyCastle.Crypto.Tls", "SignerInputBuffer");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::SignerInputBuffer_SigStream*, "Org.BouncyCastle.Crypto.Tls", "SignerInputBuffer/SigStream");
...
public:
  ...
  /// @brief Method Write, addr 0x33b20b8, size 0xd0, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method WriteByte, addr 0x33b2000, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33b1fd0, size 0x28, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::SignerInputBuffer_SigStream) == 0x38, "Size mismatch!");
...
public:
  ...
  /// @brief Method UpdateSigner, addr 0x33b1f4c, size 0x84, virtual false, abstract: false, final false
  inline void UpdateSigner(::Org::BouncyCastle::Crypto::ISigner* s);

  /// @brief Method .ctor, addr 0x33b1ff8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::SignerInputBuffer) == 0x50, "Size mismatch!");
