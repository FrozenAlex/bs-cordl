...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::SimulatedTlsSrpIdentityManager*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::SimulatedTlsSrpIdentityManager*, "Org.BouncyCastle.Crypto.Tls", "SimulatedTlsSrpIdentityManager");
...
public:
  ...
  __declspec(property(get = getStaticF_PREFIX_PASSWORD, put = setStaticF_PREFIX_PASSWORD)) ::ArrayW<uint8_t> PREFIX_PASSWORD;

  /// @brief Field PREFIX_SALT, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_PREFIX_SALT, put = setStaticF_PREFIX_SALT)) ::ArrayW<uint8_t> PREFIX_SALT;
  ...
  /// @brief Method GetLoginParameters, addr 0x346cd80, size 0x4b4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsSrpLoginParameters* GetLoginParameters(::ArrayW<uint8_t> identity);

  /// @brief Method GetRfc5054Default, addr 0x346cc08, size 0x16c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Tls::SimulatedTlsSrpIdentityManager* GetRfc5054Default(::Org::BouncyCastle::Crypto::Parameters::Srp6GroupParameters* group, ::ArrayW<uint8_t> seedKey);
  ...
  /// @brief Method .ctor, addr 0x346cd74, size 0xc, virtual false, abstract: false, final false
  ...
  static inline ::ArrayW<uint8_t> getStaticF_PREFIX_PASSWORD();

  static inline ::ArrayW<uint8_t> getStaticF_PREFIX_SALT();
  ...
  static inline void setStaticF_PREFIX_PASSWORD(::ArrayW<uint8_t> value);

  static inline void setStaticF_PREFIX_SALT(::ArrayW<uint8_t> value);
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::SimulatedTlsSrpIdentityManager) == 0x28, "Size mismatch!");
