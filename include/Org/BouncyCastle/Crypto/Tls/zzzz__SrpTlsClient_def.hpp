...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::SrpTlsClient*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::SrpTlsClient*, "Org.BouncyCastle.Crypto.Tls", "SrpTlsClient");
...
public:
  ...
  /// @brief Method CreateSrpKeyExchange, addr 0x346d70c, size 0x90, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* CreateSrpKeyExchange(int32_t keyExchange);

  /// @brief Method GetAuthentication, addr 0x346d6d0, size 0x3c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsAuthentication* GetAuthentication();

  /// @brief Method GetCipherSuites, addr 0x346d4a4, size 0x68, virtual true, abstract: false, final false
  inline ::ArrayW<int32_t> GetCipherSuites();

  /// @brief Method GetClientExtensions, addr 0x346d50c, size 0x34, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionary* GetClientExtensions();

  /// @brief Method GetKeyExchange, addr 0x346d614, size 0xbc, virtual true, abstract: false, final false
  ...
  static inline ::Org::BouncyCastle::Crypto::Tls::SrpTlsClient* New_ctor(::Org::BouncyCastle::Crypto::Tls::TlsCipherFactory* cipherFactory, ::ArrayW<uint8_t> identity, ::ArrayW<uint8_t> password);

  static inline ::Org::BouncyCastle::Crypto::Tls::SrpTlsClient* New_ctor(::ArrayW<uint8_t> identity, ::ArrayW<uint8_t> password);

  /// @brief Method ProcessServerExtensions, addr 0x346d540, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x346d378, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Tls::TlsCipherFactory* cipherFactory, ::Org::BouncyCastle::Crypto::Tls::TlsSrpGroupVerifier* groupVerifier, ::ArrayW<uint8_t> identity,
                    ::ArrayW<uint8_t> password);

  /// @brief Method .ctor, addr 0x346d414, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Tls::TlsCipherFactory* cipherFactory, ::ArrayW<uint8_t> identity, ::ArrayW<uint8_t> password);

  /// @brief Method .ctor, addr 0x346d2d4, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> identity, ::ArrayW<uint8_t> password);

  /// @brief Method get_RequireSrpServerExtension, addr 0x346d49c, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::SrpTlsClient) == 0x68, "Size mismatch!");
