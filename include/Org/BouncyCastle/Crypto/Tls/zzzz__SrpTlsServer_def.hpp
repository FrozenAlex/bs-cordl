...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::SrpTlsServer*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::SrpTlsServer*, "Org.BouncyCastle.Crypto.Tls", "SrpTlsServer");
...
public:
  ...
  /// @brief Method CreateSrpKeyExchange, addr 0x33b3184, size 0x80, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* CreateSrpKeyExchange(int32_t keyExchange);

  /// @brief Method GetCipherSuites, addr 0x33b2e08, size 0x78, virtual true, abstract: false, final false
  inline ::ArrayW<int32_t> GetCipherSuites();

  /// @brief Method GetCredentials, addr 0x33b2fdc, size 0xec, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsCredentials* GetCredentials();

  /// @brief Method GetDsaSignerCredentials, addr 0x33b2d90, size 0x3c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials* GetDsaSignerCredentials();

  /// @brief Method GetKeyExchange, addr 0x33b30c8, size 0xbc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* GetKeyExchange();

  /// @brief Method GetRsaSignerCredentials, addr 0x33b2dcc, size 0x3c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials* GetRsaSignerCredentials();

  /// @brief Method GetSelectedCipherSuite, addr 0x33b2eb4, size 0x128, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessClientExtensions, addr 0x33b2e80, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33b2d80, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33b2d1c, size 0x64, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::SrpTlsServer) == 0xa8, "Size mismatch!");
