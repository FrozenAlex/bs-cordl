...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::SrtpProtectionProfile*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::SrtpProtectionProfile*, "Org.BouncyCastle.Crypto.Tls", "SrtpProtectionProfile");
...
public:
  ...
  /// @brief Method .ctor, addr 0x346dc84, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::SrtpProtectionProfile) == 0x10, "Size mismatch!");
