...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::SupplementalDataEntry*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::SupplementalDataEntry*, "Org.BouncyCastle.Crypto.Tls", "SupplementalDataEntry");
...
public:
  ...
  static inline ::Org::BouncyCastle::Crypto::Tls::SupplementalDataEntry* New_ctor(int32_t dataType, ::ArrayW<uint8_t> data);
  ...
  /// @brief Method .ctor, addr 0x33b3d24, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t dataType, ::ArrayW<uint8_t> data);

  /// @brief Method get_Data, addr 0x33b3d38, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_Data();

  /// @brief Method get_DataType, addr 0x33b3d30, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::SupplementalDataEntry) == 0x20, "Size mismatch!");
