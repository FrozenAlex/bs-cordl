...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsAeadCipher*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsAeadCipher*, "Org.BouncyCastle.Crypto.Tls", "TlsAeadCipher");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_decryptImplicitNonce, put = __cordl_internal_set_decryptImplicitNonce)) ::ArrayW<uint8_t> decryptImplicitNonce;
  ...
  __declspec(property(get = __cordl_internal_get_encryptImplicitNonce, put = __cordl_internal_set_encryptImplicitNonce)) ::ArrayW<uint8_t> encryptImplicitNonce;
  ...
  /// @brief Method DecodeCiphertext, addr 0x33b4ae0, size 0x554, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> DecodeCiphertext(int64_t seqNo, uint8_t type, ::ArrayW<uint8_t> ciphertext, int32_t offset, int32_t len);

  /// @brief Method EncodePlaintext, addr 0x33b4590, size 0x550, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> EncodePlaintext(int64_t seqNo, uint8_t type, ::ArrayW<uint8_t> plaintext, int32_t offset, int32_t len);

  /// @brief Method GetAdditionalData, addr 0x33b5034, size 0x170, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GetAdditionalData(int64_t seqNo, uint8_t type, int32_t len);

  /// @brief Method GetPlaintextLimit, addr 0x33b4580, size 0x10, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_decryptImplicitNonce() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_decryptImplicitNonce();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_encryptImplicitNonce() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_encryptImplicitNonce();
  ...
  constexpr void __cordl_internal_set_decryptImplicitNonce(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_encryptCipher(::Org::BouncyCastle::Crypto::Modes::IAeadBlockCipher* value);

  constexpr void __cordl_internal_set_encryptImplicitNonce(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x33b40c0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33b40c8, size 0x4b8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Tls::TlsContext* context, ::Org::BouncyCastle::Crypto::Modes::IAeadBlockCipher* clientWriteCipher,
...
public:
  ...
  ::ArrayW<uint8_t> ___encryptImplicitNonce;

  /// @brief Field decryptImplicitNonce, offset: 0x38, size: 0x8, def value: None
  ::ArrayW<uint8_t> ___decryptImplicitNonce;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::TlsAeadCipher) == 0x48, "Size mismatch!");
