...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsCredentials*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsCredentials*, "Org.BouncyCastle.Crypto.Tls", "TlsCredentials");
// Dependencies
namespace Org::BouncyCastle::Crypto::Tls {
// Is value type: false
