...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsDeflateCompression*);
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsDeflateCompression_DeflateOutputStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsDeflateCompression*, "Org.BouncyCastle.Crypto.Tls", "TlsDeflateCompression");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsDeflateCompression_DeflateOutputStream*, "Org.BouncyCastle.Crypto.Tls", "TlsDeflateCompression/DeflateOutputStream");
...
public:
  // Declarations
  /// @brief Method Flush, addr 0x33be31c, size 0x4, virtual true, abstract: false, final false
  inline void Flush();
  ...
  /// @brief Method .ctor, addr 0x33be128, size 0x38, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::TlsDeflateCompression_DeflateOutputStream) == 0x60, "Size mismatch!");
...
public:
  ...
  /// @brief Method Compress, addr 0x33be098, size 0x90, virtual true, abstract: false, final false
  inline ::System::IO::Stream* Compress(::System::IO::Stream* output);

  /// @brief Method Decompress, addr 0x33be160, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33bdfe4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33bdfec, size 0xac, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::TlsDeflateCompression) == 0x20, "Size mismatch!");
