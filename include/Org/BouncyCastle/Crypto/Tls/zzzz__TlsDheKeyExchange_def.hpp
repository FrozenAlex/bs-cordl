...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsDheKeyExchange*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsDheKeyExchange*, "Org.BouncyCastle.Crypto.Tls", "TlsDheKeyExchange");
// Dependencies Org.BouncyCastle.Crypto.Tls.TlsDHKeyExchange
namespace Org::BouncyCastle::Crypto::Tls {
// Is value type: false
...
public:
  ...
  /// @brief Method GenerateServerKeyExchange, addr 0x33c0150, size 0x468, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateServerKeyExchange();

  /// @brief Method InitVerifyer, addr 0x33c08a0, size 0x1e0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessServerCredentials, addr 0x33bfff0, size 0x160, virtual true, abstract: false, final false
  inline void ProcessServerCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials* serverCredentials);

  /// @brief Method ProcessServerKeyExchange, addr 0x33c05b8, size 0x2e8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33bff5c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33bffe8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::TlsDheKeyExchange) == 0x68, "Size mismatch!");
