...
public:
  ...
  /// @brief Method GenerateClientKeyExchange, addr 0x33c5b50, size 0x118, virtual true, abstract: false, final false
  inline void GenerateClientKeyExchange(::System::IO::Stream* output);

  /// @brief Method GeneratePremasterSecret, addr 0x33c5d78, size 0x128, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GeneratePremasterSecret();

  /// @brief Method GenerateServerKeyExchange, addr 0x33c5658, size 0x170, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateServerKeyExchange();

  /// @brief Method Init, addr 0x33c500c, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessClientCertificate, addr 0x33c5c68, size 0x48, virtual true, abstract: false, final false
  inline void ProcessClientCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate* clientCertificate);

  /// @brief Method ProcessClientCredentials, addr 0x33c5a48, size 0x108, virtual true, abstract: false, final false
  inline void ProcessClientCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials* clientCredentials);

  /// @brief Method ProcessClientKeyExchange, addr 0x33c5cb0, size 0xc8, virtual true, abstract: false, final false
  inline void ProcessClientKeyExchange(::System::IO::Stream* input);

  /// @brief Method ProcessServerCertificate, addr 0x33c5170, size 0x380, virtual true, abstract: false, final false
  inline void ProcessServerCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate* serverCertificate);

  /// @brief Method ProcessServerKeyExchange, addr 0x33c57c8, size 0x118, virtual true, abstract: false, final false
  inline void ProcessServerKeyExchange(::System::IO::Stream* input);

  /// @brief Method SkipServerCredentials, addr 0x33c50dc, size 0x48, virtual true, abstract: false, final false
  inline void SkipServerCredentials();

  /// @brief Method ValidateCertificateRequest, addr 0x33c5974, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33c4ed8, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_RequiresServerKeyExchange, addr 0x33c563c, size 0x1c, virtual true, abstract: false, final false
