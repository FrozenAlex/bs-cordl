...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsFatalAlertReceived*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsFatalAlertReceived*, "Org.BouncyCastle.Crypto.Tls", "TlsFatalAlertReceived");
...
public:
  ...
  /// @brief Method .ctor, addr 0x33c8f40, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(uint8_t alertDescription);

  /// @brief Method get_AlertDescription, addr 0x33c8f8c, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::TlsFatalAlertReceived) == 0x90, "Size mismatch!");
