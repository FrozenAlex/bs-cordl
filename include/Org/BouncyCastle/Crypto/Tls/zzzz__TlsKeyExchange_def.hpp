...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange*, "Org.BouncyCastle.Crypto.Tls", "TlsKeyExchange");
// Dependencies
namespace Org::BouncyCastle::Crypto::Tls {
// Is value type: false
