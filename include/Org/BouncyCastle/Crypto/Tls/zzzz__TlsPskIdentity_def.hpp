...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsPskIdentity*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsPskIdentity*, "Org.BouncyCastle.Crypto.Tls", "TlsPskIdentity");
// Dependencies
namespace Org::BouncyCastle::Crypto::Tls {
// Is value type: false
