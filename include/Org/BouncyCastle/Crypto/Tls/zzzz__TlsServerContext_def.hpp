...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsServerContext*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsServerContext*, "Org.BouncyCastle.Crypto.Tls", "TlsServerContext");
// Dependencies
namespace Org::BouncyCastle::Crypto::Tls {
// Is value type: false
