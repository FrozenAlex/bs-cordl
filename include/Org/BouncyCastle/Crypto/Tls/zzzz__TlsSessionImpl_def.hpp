...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsSessionImpl*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsSessionImpl*, "Org.BouncyCastle.Crypto.Tls", "TlsSessionImpl");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_mSessionID, put = __cordl_internal_set_mSessionID)) ::ArrayW<uint8_t> mSessionID;
  ...
  /// @brief Method ExportSessionParameters, addr 0x33d1e28, size 0xb0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::SessionParameters* ExportSessionParameters();

  /// @brief Method Invalidate, addr 0x33d1f04, size 0x1c, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_mSessionID() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_mSessionID();
  ...
  constexpr void __cordl_internal_set_mSessionID(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_mSessionParameters(::Org::BouncyCastle::Crypto::Tls::SessionParameters* value);

  /// @brief Method .ctor, addr 0x33d1cf0, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> sessionID, ::Org::BouncyCastle::Crypto::Tls::SessionParameters* sessionParameters);

  /// @brief Method get_IsResumable, addr 0x33d1f20, size 0x2c, virtual true, abstract: false, final false
  inline bool get_IsResumable();

  /// @brief Method get_SessionID, addr 0x33d1ed8, size 0x2c, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::TlsSessionImpl) == 0x28, "Size mismatch!");
