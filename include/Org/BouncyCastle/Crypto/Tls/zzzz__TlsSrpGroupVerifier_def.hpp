...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsSrpGroupVerifier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsSrpGroupVerifier*, "Org.BouncyCastle.Crypto.Tls", "TlsSrpGroupVerifier");
// Dependencies
namespace Org::BouncyCastle::Crypto::Tls {
// Is value type: false
