...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsSrpIdentityManager*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsSrpIdentityManager*, "Org.BouncyCastle.Crypto.Tls", "TlsSrpIdentityManager");
// Dependencies
namespace Org::BouncyCastle::Crypto::Tls {
// Is value type: false
