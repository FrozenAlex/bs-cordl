...
public:
  ...
  /// @brief Method AddSignatureAlgorithmsExtension, addr 0x33d74dc, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateKeyBlock, addr 0x33ca114, size 0x1ac, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> CalculateKeyBlock(::Org::BouncyCastle::Crypto::Tls::TlsContext* context, int32_t size);

  /// @brief Method CalculateKeyBlock_Ssl, addr 0x33d888c, size 0x544, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> CalculateKeyBlock_Ssl(::ArrayW<uint8_t> master_secret, ::ArrayW<uint8_t> random, int32_t size);

  /// @brief Method CalculateMasterSecret, addr 0x33d8dd0, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateMasterSecret_Ssl, addr 0x33d8ff8, size 0x508, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> CalculateMasterSecret_Ssl(::ArrayW<uint8_t> pre_master_secret, ::ArrayW<uint8_t> random);

  /// @brief Method CalculateVerifyData, addr 0x33d9500, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckUint16, addr 0x33c8bd4, size 0x90, virtual false, abstract: false, final false
  static inline void CheckUint16(int32_t i);

  /// @brief Method CheckUint16, addr 0x33d5474, size 0x90, virtual false, abstract: false, final false
  static inline void CheckUint16(int64_t i);

  /// @brief Method CheckUint24, addr 0x33d5510, size 0x90, virtual false, abstract: false, final false
  static inline void CheckUint24(int32_t i);

  /// @brief Method CheckUint24, addr 0x33d55b0, size 0x90, virtual false, abstract: false, final false
  static inline void CheckUint24(int64_t i);

  /// @brief Method CheckUint32, addr 0x33d5650, size 0x90, virtual false, abstract: false, final false
  static inline void CheckUint32(int64_t i);

  /// @brief Method CheckUint48, addr 0x33d56f0, size 0x90, virtual false, abstract: false, final false
  static inline void CheckUint48(int64_t i);

  /// @brief Method CheckUint64, addr 0x33d5790, size 0x58, virtual false, abstract: false, final false
  static inline void CheckUint64(int64_t i);

  /// @brief Method CheckUint8, addr 0x33d5330, size 0x90, virtual false, abstract: false, final false
  static inline void CheckUint8(int32_t i);

  /// @brief Method CheckUint8, addr 0x33d53cc, size 0x90, virtual false, abstract: false, final false
  static inline void CheckUint8(int64_t i);

  /// @brief Method CloneHash, addr 0x33d9660, size 0x348, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::IDigest* CloneHash(uint8_t hashAlgorithm, ::Org::BouncyCastle::Crypto::IDigest* hash);

  /// @brief Method ClonePrfHash, addr 0x33d9a58, size 0xf0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::IDigest* ClonePrfHash(int32_t prfAlgorithm, ::Org::BouncyCastle::Crypto::IDigest* hash);

  /// @brief Method Concat, addr 0x33d81fc, size 0xb0, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> Concat(::ArrayW<uint8_t> a, ::ArrayW<uint8_t> b);

  /// @brief Method CreateHash, addr 0x33c6d44, size 0x1e4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::IDigest* CreateHash(uint8_t hashAlgorithm);

  /// @brief Method CreateHash, addr 0x33c6554, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreatePrfHash, addr 0x33d846c, size 0x9c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::IDigest* CreatePrfHash(int32_t prfAlgorithm);

  /// @brief Method CreateSignatureAlgorithmsExtension, addr 0x33d75e8, size 0xa8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> CreateSignatureAlgorithmsExtension(::System::Collections::IList* supportedSignatureAlgorithms);

  /// @brief Method CreateTlsSigner, addr 0x33cfe68, size 0x134, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Tls::TlsSigner* CreateTlsSigner(uint8_t clientCertificateType);

  /// @brief Method DecodeUint8, addr 0x33c8e58, size 0xdc, virtual false, abstract: false, final false
  static inline uint8_t DecodeUint8(::ArrayW<uint8_t> buf);

  /// @brief Method DecodeUint8ArrayWithUint8Length, addr 0x33c8ce8, size 0x170, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> DecodeUint8ArrayWithUint8Length(::ArrayW<uint8_t> buf);

  /// @brief Method EncodeOpaque8, addr 0x33d3c2c, size 0x98, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> EncodeOpaque8(::ArrayW<uint8_t> buf);

  /// @brief Method EncodeSupportedSignatureAlgorithms, addr 0x33d780c, size 0x5bc, virtual false, abstract: false, final false
  ...
  /// @brief Method EncodeUint16ArrayWithUint16Length, addr 0x33d6280, size 0xa4, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> EncodeUint16ArrayWithUint16Length(::ArrayW<int32_t> uints);

  /// @brief Method EncodeUint8, addr 0x33c8ae0, size 0x98, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> EncodeUint8(uint8_t val);

  /// @brief Method EncodeUint8ArrayWithUint8Length, addr 0x33c8a40, size 0xa0, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> EncodeUint8ArrayWithUint8Length(::ArrayW<uint8_t> uints);

  /// @brief Method GenSsl3Const, addr 0x33d9b48, size 0xf8, virtual false, abstract: false, final false
  static inline ::ArrayW<::ArrayW<uint8_t>> GenSsl3Const();

  /// @brief Method GetAllSignatureAlgorithms, addr 0x33d6cd4, size 0x274, virtual false, abstract: false, final false
  static inline ::System::Collections::IList* GetAllSignatureAlgorithms();

  /// @brief Method GetCipherType, addr 0x33d9c40, size 0xb8, virtual false, abstract: false, final false
  static inline int32_t GetCipherType(int32_t ciphersuite);

  /// @brief Method GetClientCertificateType, addr 0x33cf080, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDefaultDssSignatureAlgorithms, addr 0x33d6f48, size 0x88, virtual false, abstract: false, final false
  static inline ::System::Collections::IList* GetDefaultDssSignatureAlgorithms();

  /// @brief Method GetDefaultECDsaSignatureAlgorithms, addr 0x33d70b8, size 0x88, virtual false, abstract: false, final false
  static inline ::System::Collections::IList* GetDefaultECDsaSignatureAlgorithms();

  /// @brief Method GetDefaultRsaSignatureAlgorithms, addr 0x33d7140, size 0x88, virtual false, abstract: false, final false
  static inline ::System::Collections::IList* GetDefaultRsaSignatureAlgorithms();

  /// @brief Method GetDefaultSupportedSignatureAlgorithms, addr 0x33d71c8, size 0x224, virtual false, abstract: false, final false
  static inline ::System::Collections::IList* GetDefaultSupportedSignatureAlgorithms();

  /// @brief Method GetEncryptionAlgorithm, addr 0x33d9cf8, size 0x11c, virtual false, abstract: false, final false
  static inline int32_t GetEncryptionAlgorithm(int32_t ciphersuite);

  /// @brief Method GetExtensionData, addr 0x33c7fa8, size 0x10c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> GetExtensionData(::System::Collections::IDictionary* extensions, int32_t extensionType);

  /// @brief Method GetHashAlgorithmForPrfAlgorithm, addr 0x33d99a8, size 0xb0, virtual false, abstract: false, final false
  static inline uint8_t GetHashAlgorithmForPrfAlgorithm(int32_t prfAlgorithm);

  /// @brief Method GetKeyExchangeAlgorithm, addr 0x33d9e14, size 0x138, virtual false, abstract: false, final false
  static inline int32_t GetKeyExchangeAlgorithm(int32_t ciphersuite);

  /// @brief Method GetMacAlgorithm, addr 0x33d9f4c, size 0xbc, virtual false, abstract: false, final false
  static inline int32_t GetMacAlgorithm(int32_t ciphersuite);

  /// @brief Method GetMinimumVersion, addr 0x33da008, size 0x118, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* GetMinimumVersion(int32_t ciphersuite);

  /// @brief Method GetOidForHashAlgorithm, addr 0x33cd0c8, size 0x1d8, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetOidForHashAlgorithm(uint8_t hashAlgorithm);

  /// @brief Method GetSignatureAlgorithmsExtension, addr 0x33d7690, size 0x88, virtual false, abstract: false, final false
  static inline ::System::Collections::IList* GetSignatureAlgorithmsExtension(::System::Collections::IDictionary* extensions);

  /// @brief Method GetSignatureAndHashAlgorithm, addr 0x33c642c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUsableSignatureAlgorithms, addr 0x33da544, size 0x524, virtual false, abstract: false, final false
  static inline ::System::Collections::IList* GetUsableSignatureAlgorithms(::System::Collections::IList* sigHashAlgs);

  /// @brief Method HMacHash, addr 0x33d8508, size 0x2e8, virtual false, abstract: false, final false
  ...
  /// @brief Method HasExpectedEmptyExtensionData, addr 0x33d19d4, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method HasSigningCapability, addr 0x33d1cd8, size 0x18, virtual false, abstract: false, final false
  static inline bool HasSigningCapability(uint8_t clientCertificateType);

  /// @brief Method ImportSession, addr 0x33d73ec, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsAeadCipherSuite, addr 0x33da120, size 0x64, virtual false, abstract: false, final false
  static inline bool IsAeadCipherSuite(int32_t ciphersuite);

  /// @brief Method IsBlockCipherSuite, addr 0x33da184, size 0x64, virtual false, abstract: false, final false
  static inline bool IsBlockCipherSuite(int32_t ciphersuite);

  /// @brief Method IsSignatureAlgorithmsExtensionAllowed, addr 0x33d7458, size 0x84, virtual false, abstract: false, final false
  static inline bool IsSignatureAlgorithmsExtensionAllowed(::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* clientVersion);

  /// @brief Method IsSsl, addr 0x33c93a8, size 0xb0, virtual false, abstract: false, final false
  static inline bool IsSsl(::Org::BouncyCastle::Crypto::Tls::TlsContext* context);

  /// @brief Method IsStreamCipherSuite, addr 0x33da1e8, size 0x64, virtual false, abstract: false, final false
  static inline bool IsStreamCipherSuite(int32_t ciphersuite);

  /// @brief Method IsTimeout, addr 0x33daa68, size 0x2c, virtual false, abstract: false, final false
  static inline bool IsTimeout(::System::Net::Sockets::SocketException* e);

  /// @brief Method IsTlsV11, addr 0x33d5874, size 0xdc, virtual false, abstract: false, final false
  static inline bool IsTlsV11(::Org::BouncyCastle::Crypto::Tls::TlsContext* context);

  /// @brief Method IsTlsV11, addr 0x33d57f0, size 0x84, virtual false, abstract: false, final false
  static inline bool IsTlsV11(::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* version);

  /// @brief Method IsTlsV12, addr 0x33ccfec, size 0xdc, virtual false, abstract: false, final false
  static inline bool IsTlsV12(::Org::BouncyCastle::Crypto::Tls::TlsContext* context);

  /// @brief Method IsTlsV12, addr 0x33d5950, size 0x84, virtual false, abstract: false, final false
  static inline bool IsTlsV12(::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* version);

  /// @brief Method IsValidCipherSuiteForSignatureAlgorithms, addr 0x33da24c, size 0x2f8, virtual false, abstract: false, final false
  static inline bool IsValidCipherSuiteForSignatureAlgorithms(int32_t cipherSuite, ::System::Collections::IList* sigAlgs);

  /// @brief Method IsValidCipherSuiteForVersion, addr 0x33d18cc, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidUint16, addr 0x33d5468, size 0xc, virtual false, abstract: false, final false
  static inline bool IsValidUint16(int32_t i);

  /// @brief Method IsValidUint16, addr 0x33d5504, size 0xc, virtual false, abstract: false, final false
  static inline bool IsValidUint16(int64_t i);

  /// @brief Method IsValidUint24, addr 0x33d55a0, size 0x10, virtual false, abstract: false, final false
  static inline bool IsValidUint24(int32_t i);

  /// @brief Method IsValidUint24, addr 0x33d5640, size 0x10, virtual false, abstract: false, final false
  static inline bool IsValidUint24(int64_t i);

  /// @brief Method IsValidUint32, addr 0x33d56e0, size 0x10, virtual false, abstract: false, final false
  static inline bool IsValidUint32(int64_t i);

  /// @brief Method IsValidUint48, addr 0x33d5780, size 0x10, virtual false, abstract: false, final false
  static inline bool IsValidUint48(int64_t i);

  /// @brief Method IsValidUint64, addr 0x33d57e8, size 0x8, virtual false, abstract: false, final false
  static inline bool IsValidUint64(int64_t i);

  /// @brief Method IsValidUint8, addr 0x33d53c0, size 0xc, virtual false, abstract: false, final false
  static inline bool IsValidUint8(int32_t i);

  /// @brief Method IsValidUint8, addr 0x33d545c, size 0xc, virtual false, abstract: false, final false
  static inline bool IsValidUint8(int64_t i);

  static inline ::Org::BouncyCastle::Crypto::Tls::TlsUtilities* New_ctor();

  /// @brief Method PRF, addr 0x33d7f98, size 0x264, virtual false, abstract: false, final false
  ...
  /// @brief Method PRF_legacy, addr 0x33d87f0, size 0x9c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> PRF_legacy(::ArrayW<uint8_t> secret, ::StringW asciiLabel, ::ArrayW<uint8_t> seed, int32_t size);

  /// @brief Method PRF_legacy, addr 0x33d82ac, size 0x1c0, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> PRF_legacy(::ArrayW<uint8_t> secret, ::ArrayW<uint8_t> label, ::ArrayW<uint8_t> labelSeed, int32_t size);

  /// @brief Method ParseSupportedSignatureAlgorithms, addr 0x33d7dc8, size 0x1d0, virtual false, abstract: false, final false
  static inline ::System::Collections::IList* ParseSupportedSignatureAlgorithms(bool allowAnonymous, ::System::IO::Stream* input);

  /// @brief Method ReadAllOrNothing, addr 0x33d6690, size 0xf8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> ReadAllOrNothing(int32_t length, ::System::IO::Stream* input);

  /// @brief Method ReadAsn1Object, addr 0x33d69bc, size 0x120, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Object* ReadAsn1Object(::ArrayW<uint8_t> encoding);

  /// @brief Method ReadDerObject, addr 0x33d6adc, size 0x100, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Object* ReadDerObject(::ArrayW<uint8_t> encoding);

  /// @brief Method ReadFully, addr 0x33d06c8, size 0xec, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> ReadFully(int32_t length, ::System::IO::Stream* input);

  /// @brief Method ReadFully, addr 0x33d6788, size 0x70, virtual false, abstract: false, final false
  static inline void ReadFully(::ArrayW<uint8_t> buf, ::System::IO::Stream* input);

  /// @brief Method ReadOpaque16, addr 0x33cb0f4, size 0x94, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> ReadOpaque16(::System::IO::Stream* input);

  /// @brief Method ReadOpaque24, addr 0x33d67f8, size 0x60, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> ReadOpaque24(::System::IO::Stream* input);

  /// @brief Method ReadOpaque8, addr 0x33c58e0, size 0x94, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> ReadOpaque8(::System::IO::Stream* input);

  /// @brief Method ReadSignatureAlgorithmsExtension, addr 0x33d7718, size 0xf4, virtual false, abstract: false, final false
  static inline ::System::Collections::IList* ReadSignatureAlgorithmsExtension(::ArrayW<uint8_t> extensionData);

  /// @brief Method ReadUint16, addr 0x33d6324, size 0x40, virtual false, abstract: false, final false
  static inline int32_t ReadUint16(::ArrayW<uint8_t> buf, int32_t offset);

  /// @brief Method ReadUint16, addr 0x33d07b4, size 0x84, virtual false, abstract: false, final false
  static inline int32_t ReadUint16(::System::IO::Stream* input);

  /// @brief Method ReadUint16Array, addr 0x33d0838, size 0xd8, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t> ReadUint16Array(int32_t count, ::System::IO::Stream* input);

  /// @brief Method ReadUint24, addr 0x33d6408, size 0x58, virtual false, abstract: false, final false
  static inline int32_t ReadUint24(::ArrayW<uint8_t> buf, int32_t offset);

  /// @brief Method ReadUint24, addr 0x33d6364, size 0xa4, virtual false, abstract: false, final false
  static inline int32_t ReadUint24(::System::IO::Stream* input);

  /// @brief Method ReadUint32, addr 0x33d6528, size 0x6c, virtual false, abstract: false, final false
  static inline int64_t ReadUint32(::ArrayW<uint8_t> buf, int32_t offset);

  /// @brief Method ReadUint32, addr 0x33d6460, size 0xc8, virtual false, abstract: false, final false
  static inline int64_t ReadUint32(::System::IO::Stream* input);

  /// @brief Method ReadUint48, addr 0x33d6608, size 0x88, virtual false, abstract: false, final false
  static inline int64_t ReadUint48(::ArrayW<uint8_t> buf, int32_t offset);

  /// @brief Method ReadUint48, addr 0x33d6594, size 0x74, virtual false, abstract: false, final false
  static inline int64_t ReadUint48(::System::IO::Stream* input);

  /// @brief Method ReadUint8, addr 0x33d6254, size 0x2c, virtual false, abstract: false, final false
  static inline uint8_t ReadUint8(::ArrayW<uint8_t> buf, int32_t offset);

  /// @brief Method ReadUint8, addr 0x33d0910, size 0x5c, virtual false, abstract: false, final false
  static inline uint8_t ReadUint8(::System::IO::Stream* input);

  /// @brief Method ReadUint8Array, addr 0x33d096c, size 0xd8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> ReadUint8Array(int32_t count, ::System::IO::Stream* input);

  /// @brief Method ReadVersion, addr 0x33d6858, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* ReadVersion(::ArrayW<uint8_t> buf, int32_t offset);

  /// @brief Method ReadVersion, addr 0x33d05f8, size 0xd0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* ReadVersion(::System::IO::Stream* input);

  /// @brief Method ReadVersionRaw, addr 0x33d68f8, size 0x40, virtual false, abstract: false, final false
  static inline int32_t ReadVersionRaw(::ArrayW<uint8_t> buf, int32_t offset);

  /// @brief Method ReadVersionRaw, addr 0x33d6938, size 0x84, virtual false, abstract: false, final false
  static inline int32_t ReadVersionRaw(::System::IO::Stream* input);

  /// @brief Method TrackHashAlgorithms, addr 0x33ce87c, size 0x3a8, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateKeyUsage, addr 0x33c5540, size 0xfc, virtual false, abstract: false, final false
  static inline void ValidateKeyUsage(::Org::BouncyCastle::Asn1::X509::X509CertificateStructure* c, int32_t keyUsageBits);

  /// @brief Method VectorOfOne, addr 0x33d6fd0, size 0xe8, virtual false, abstract: false, final false
  static inline ::System::Collections::IList* VectorOfOne(::System::Object* obj);

  /// @brief Method VerifySupportedSignatureAlgorithm, addr 0x33cf908, size 0x560, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteGmtUnixTime, addr 0x33d6bdc, size 0xf8, virtual false, abstract: false, final false
  static inline void WriteGmtUnixTime(::ArrayW<uint8_t> buf, int32_t offset);

  /// @brief Method WriteOpaque16, addr 0x33cac58, size 0x94, virtual false, abstract: false, final false
  static inline void WriteOpaque16(::ArrayW<uint8_t> buf, ::System::IO::Stream* output);

  /// @brief Method WriteOpaque24, addr 0x33d5d84, size 0x94, virtual false, abstract: false, final false
  static inline void WriteOpaque24(::ArrayW<uint8_t> buf, ::System::IO::Stream* output);

  /// @brief Method WriteOpaque8, addr 0x33d182c, size 0xa0, virtual false, abstract: false, final false
  static inline void WriteOpaque8(::ArrayW<uint8_t> buf, ::System::IO::Stream* output);

  /// @brief Method WriteUint16, addr 0x33c98e0, size 0x48, virtual false, abstract: false, final false
  static inline void WriteUint16(int32_t i, ::ArrayW<uint8_t> buf, int32_t offset);

  /// @brief Method WriteUint16, addr 0x33d195c, size 0x50, virtual false, abstract: false, final false
  static inline void WriteUint16(int32_t i, ::System::IO::Stream* output);

  /// @brief Method WriteUint16Array, addr 0x33d60fc, size 0xc0, virtual false, abstract: false, final false
  static inline void WriteUint16Array(::ArrayW<int32_t> uints, ::ArrayW<uint8_t> buf, int32_t offset);

  /// @brief Method WriteUint16Array, addr 0x33d6048, size 0xb4, virtual false, abstract: false, final false
  static inline void WriteUint16Array(::ArrayW<int32_t> uints, ::System::IO::Stream* output);

  /// @brief Method WriteUint16ArrayWithUint16Length, addr 0x33d61bc, size 0x98, virtual false, abstract: false, final false
  static inline void WriteUint16ArrayWithUint16Length(::ArrayW<int32_t> uints, ::ArrayW<uint8_t> buf, int32_t offset);

  /// @brief Method WriteUint16ArrayWithUint16Length, addr 0x33d40c4, size 0x8c, virtual false, abstract: false, final false
  static inline void WriteUint16ArrayWithUint16Length(::ArrayW<int32_t> uints, ::System::IO::Stream* output);

  /// @brief Method WriteUint24, addr 0x33d1b54, size 0x64, virtual false, abstract: false, final false
  static inline void WriteUint24(int32_t i, ::ArrayW<uint8_t> buf, int32_t offset);

  /// @brief Method WriteUint24, addr 0x33d59d4, size 0x68, virtual false, abstract: false, final false
  static inline void WriteUint24(int32_t i, ::System::IO::Stream* output);

  /// @brief Method WriteUint32, addr 0x33d5abc, size 0x80, virtual false, abstract: false, final false
  static inline void WriteUint32(int64_t i, ::ArrayW<uint8_t> buf, int32_t offset);

  /// @brief Method WriteUint32, addr 0x33d5a3c, size 0x80, virtual false, abstract: false, final false
  static inline void WriteUint32(int64_t i, ::System::IO::Stream* output);

  /// @brief Method WriteUint48, addr 0x33d5bec, size 0xb8, virtual false, abstract: false, final false
  static inline void WriteUint48(int64_t i, ::ArrayW<uint8_t> buf, int32_t offset);

  /// @brief Method WriteUint48, addr 0x33d5b3c, size 0xb0, virtual false, abstract: false, final false
  static inline void WriteUint48(int64_t i, ::System::IO::Stream* output);

  /// @brief Method WriteUint64, addr 0x33c9770, size 0xf0, virtual false, abstract: false, final false
  static inline void WriteUint64(int64_t i, ::ArrayW<uint8_t> buf, int32_t offset);

  /// @brief Method WriteUint64, addr 0x33d5ca4, size 0xe0, virtual false, abstract: false, final false
  static inline void WriteUint64(int64_t i, ::System::IO::Stream* output);

  /// @brief Method WriteUint8, addr 0x33c9860, size 0x2c, virtual false, abstract: false, final false
  static inline void WriteUint8(uint8_t i, ::ArrayW<uint8_t> buf, int32_t offset);

  /// @brief Method WriteUint8, addr 0x33d19ac, size 0x28, virtual false, abstract: false, final false
  static inline void WriteUint8(uint8_t i, ::System::IO::Stream* output);

  /// @brief Method WriteUint8Array, addr 0x33d5e50, size 0xc0, virtual false, abstract: false, final false
  static inline void WriteUint8Array(::ArrayW<uint8_t> uints, ::ArrayW<uint8_t> buf, int32_t offset);

  /// @brief Method WriteUint8Array, addr 0x33d5e18, size 0x38, virtual false, abstract: false, final false
  static inline void WriteUint8Array(::ArrayW<uint8_t> uints, ::System::IO::Stream* output);

  /// @brief Method WriteUint8ArrayWithUint8Length, addr 0x33d5fb8, size 0x90, virtual false, abstract: false, final false
  static inline void WriteUint8ArrayWithUint8Length(::ArrayW<uint8_t> uints, ::ArrayW<uint8_t> buf, int32_t offset);

  /// @brief Method WriteUint8ArrayWithUint8Length, addr 0x33d5f10, size 0xa8, virtual false, abstract: false, final false
  static inline void WriteUint8ArrayWithUint8Length(::ArrayW<uint8_t> uints, ::System::IO::Stream* output);

  /// @brief Method WriteVersion, addr 0x33c988c, size 0x54, virtual false, abstract: false, final false
  static inline void WriteVersion(::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* version, ::ArrayW<uint8_t> buf, int32_t offset);

  /// @brief Method WriteVersion, addr 0x33d17d4, size 0x58, virtual false, abstract: false, final false
  static inline void WriteVersion(::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* version, ::System::IO::Stream* output);

  /// @brief Method .ctor, addr 0x33dac30, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
