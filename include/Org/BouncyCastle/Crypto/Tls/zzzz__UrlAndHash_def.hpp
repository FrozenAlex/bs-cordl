...
public:
  ...
  /// @brief Method Encode, addr 0x3495790, size 0x108, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  static inline ::Org::BouncyCastle::Crypto::Tls::UrlAndHash* New_ctor(::StringW url, ::ArrayW<uint8_t> sha1Hash);

  /// @brief Method Parse, addr 0x3495898, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34956b4, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor(::StringW url, ::ArrayW<uint8_t> sha1Hash);

  /// @brief Method get_Sha1Hash, addr 0x3495788, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_Sha1Hash();

  /// @brief Method get_Url, addr 0x3495780, size 0x8, virtual true, abstract: false, final false
