...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::UserMappingType*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::UserMappingType*, "Org.BouncyCastle.Crypto.Tls", "UserMappingType");
...
public:
  ...
  /// @brief Method .ctor, addr 0x33daf9c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::UserMappingType) == 0x10, "Size mismatch!");
