...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Utilities::AlgorithmIdentifierFactory*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Utilities::AlgorithmIdentifierFactory*, "Org.BouncyCastle.Crypto.Utilities", "AlgorithmIdentifierFactory");
...
public:
  ...
  /// @brief Method GenerateEncryptionAlgID, addr 0x33dafb0, size 0x530, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33db608, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Utilities::AlgorithmIdentifierFactory) == 0x10, "Size mismatch!");
