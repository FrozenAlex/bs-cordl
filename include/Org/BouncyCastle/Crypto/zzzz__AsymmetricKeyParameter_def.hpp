...
public:
  ...
  /// @brief Method Equals, addr 0x3409a7c, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x3409b14, size 0x20, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* other);

  /// @brief Method GetHashCode, addr 0x3409b34, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3409a6c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(bool privateKey);

  /// @brief Method get_IsPrivate, addr 0x3409a74, size 0x8, virtual false, abstract: false, final false
