...
public:
  ...
  /// @brief Method DoFinal, addr 0x349996c, size 0xd8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> DoFinal();

  /// @brief Method DoFinal, addr 0x3499a44, size 0x17c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> DoFinal(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen);

  /// @brief Method DoFinal, addr 0x3499bc0, size 0xc0, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method GetBlockSize, addr 0x34993e0, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method GetOutputSize, addr 0x34994a0, size 0xb8, virtual true, abstract: false, final false
  inline int32_t GetOutputSize(int32_t length);

  /// @brief Method GetUpdateOutputSize, addr 0x34993e8, size 0xb8, virtual true, abstract: false, final false
  inline int32_t GetUpdateOutputSize(int32_t length);

  /// @brief Method Init, addr 0x34992d4, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessByte, addr 0x3499628, size 0xf4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> ProcessByte(uint8_t input);

  /// @brief Method ProcessByte, addr 0x3499558, size 0xd0, virtual true, abstract: false, final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x349971c, size 0x168, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t length);

  /// @brief Method ProcessBytes, addr 0x3499884, size 0xe8, virtual true, abstract: false, final false
  inline int32_t ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t length, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method Reset, addr 0x3499c80, size 0xa8, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x3499180, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Modes::IAeadCipher* cipher);

  /// @brief Method get_AlgorithmName, addr 0x3499230, size 0xa4, virtual true, abstract: false, final false
