...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::BufferedAsymmetricBlockCipher*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::BufferedAsymmetricBlockCipher*, "Org.BouncyCastle.Crypto", "BufferedAsymmetricBlockCipher");
...
public:
  ...
  /// @brief Method DoFinal, addr 0x33df7f8, size 0x124, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> DoFinal();

  /// @brief Method DoFinal, addr 0x33df91c, size 0x30, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> DoFinal(::ArrayW<uint8_t> input, int32_t inOff, int32_t length);

  /// @brief Method GetBlockSize, addr 0x33df3b8, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method GetBufferPosition, addr 0x33df30c, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetBufferPosition();

  /// @brief Method GetOutputSize, addr 0x33df460, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetOutputSize(int32_t length);

  /// @brief Method GetUpdateOutputSize, addr 0x33df508, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetUpdateOutputSize(int32_t length);

  /// @brief Method Init, addr 0x33df510, size 0x170, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessByte, addr 0x33df680, size 0x8c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> ProcessByte(uint8_t input);

  /// @brief Method ProcessBytes, addr 0x33df710, size 0xe8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t length);

  /// @brief Method Reset, addr 0x33df94c, size 0x2c, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x33df2a8, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher);

  /// @brief Method get_AlgorithmName, addr 0x33df314, size 0xa4, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::BufferedAsymmetricBlockCipher) == 0x28, "Size mismatch!");
