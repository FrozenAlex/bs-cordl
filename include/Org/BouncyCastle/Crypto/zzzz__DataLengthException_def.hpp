...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::DataLengthException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::DataLengthException*, "Org.BouncyCastle.Crypto", "DataLengthException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x33e0880, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33df70c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x33e0884, size 0x4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::DataLengthException) == 0x90, "Size mismatch!");
