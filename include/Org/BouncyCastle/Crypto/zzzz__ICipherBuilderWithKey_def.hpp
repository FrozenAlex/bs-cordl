...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::ICipherBuilderWithKey*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::ICipherBuilderWithKey*, "Org.BouncyCastle.Crypto", "ICipherBuilderWithKey");
// Dependencies
namespace Org::BouncyCastle::Crypto {
// Is value type: false
