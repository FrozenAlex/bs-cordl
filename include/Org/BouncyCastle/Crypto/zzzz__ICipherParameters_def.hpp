...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::ICipherParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::ICipherParameters*, "Org.BouncyCastle.Crypto", "ICipherParameters");
// Dependencies
namespace Org::BouncyCastle::Crypto {
// Is value type: false
