...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::IDecryptorBuilderProvider*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::IDecryptorBuilderProvider*, "Org.BouncyCastle.Crypto", "IDecryptorBuilderProvider");
// Dependencies
namespace Org::BouncyCastle::Crypto {
// Is value type: false
