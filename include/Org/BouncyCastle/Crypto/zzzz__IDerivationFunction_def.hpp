...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::IDerivationFunction*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::IDerivationFunction*, "Org.BouncyCastle.Crypto", "IDerivationFunction");
// Dependencies
namespace Org::BouncyCastle::Crypto {
// Is value type: false
