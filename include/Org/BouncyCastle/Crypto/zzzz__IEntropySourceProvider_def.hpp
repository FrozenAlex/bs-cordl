...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::IEntropySourceProvider*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::IEntropySourceProvider*, "Org.BouncyCastle.Crypto", "IEntropySourceProvider");
// Dependencies
namespace Org::BouncyCastle::Crypto {
// Is value type: false
