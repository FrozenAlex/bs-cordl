...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::IStreamCalculator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::IStreamCalculator*, "Org.BouncyCastle.Crypto", "IStreamCalculator");
// Dependencies
namespace Org::BouncyCastle::Crypto {
// Is value type: false
