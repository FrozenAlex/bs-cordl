...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::IVerifierFactoryProvider*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::IVerifierFactoryProvider*, "Org.BouncyCastle.Crypto", "IVerifierFactoryProvider");
// Dependencies
namespace Org::BouncyCastle::Crypto {
// Is value type: false
