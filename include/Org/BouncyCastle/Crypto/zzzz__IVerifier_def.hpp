...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::IVerifier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::IVerifier*, "Org.BouncyCastle.Crypto", "IVerifier");
// Dependencies
namespace Org::BouncyCastle::Crypto {
// Is value type: false
...
public:
  ...
  inline bool IsVerified(::ArrayW<uint8_t> data);

  /// @brief Method IsVerified, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
  inline bool IsVerified(::ArrayW<uint8_t> source, int32_t off, int32_t length);
