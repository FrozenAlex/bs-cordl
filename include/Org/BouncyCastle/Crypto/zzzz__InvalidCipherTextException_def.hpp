...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::InvalidCipherTextException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::InvalidCipherTextException*, "Org.BouncyCastle.Crypto", "InvalidCipherTextException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x349b308, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x349b30c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x349b310, size 0x4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::InvalidCipherTextException) == 0x90, "Size mismatch!");
