...
public:
  ...
  /// @brief Method .ctor, addr 0x33e0888, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33e088c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x33e0890, size 0x4, virtual false, abstract: false, final false
