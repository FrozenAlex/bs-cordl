...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::KeyGenerationParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::KeyGenerationParameters*, "Org.BouncyCastle.Crypto", "KeyGenerationParameters");
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::KeyGenerationParameters) == 0x20, "Size mismatch!");
