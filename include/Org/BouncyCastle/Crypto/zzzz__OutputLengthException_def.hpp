...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::OutputLengthException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::OutputLengthException*, "Org.BouncyCastle.Crypto", "OutputLengthException");
// Dependencies Org.BouncyCastle.Crypto.DataLengthException
namespace Org::BouncyCastle::Crypto {
// Is value type: false
...
public:
  ...
  /// @brief Method .ctor, addr 0x349b320, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x349b1c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x349b324, size 0x4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::OutputLengthException) == 0x90, "Size mismatch!");
