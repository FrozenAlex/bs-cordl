...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::StreamBlockCipher*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::StreamBlockCipher*, "Org.BouncyCastle.Crypto", "StreamBlockCipher");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_oneByte, put = __cordl_internal_set_oneByte)) ::ArrayW<uint8_t> oneByte;

  /// @brief Convert operator to "::Org::BouncyCastle::Crypto::IStreamCipher"
  constexpr operator ::Org::BouncyCastle::Crypto::IStreamCipher*() noexcept;

  /// @brief Method Init, addr 0x33e10e0, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBytes, addr 0x33e133c, size 0x154, virtual true, abstract: false, final true
  inline void ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t length, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method Reset, addr 0x33e1490, size 0xa8, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method ReturnByte, addr 0x33e1244, size 0xf8, virtual true, abstract: false, final true
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_oneByte() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_oneByte();
  ...
  /// @brief Method .ctor, addr 0x33e0f6c, size 0x174, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method get_AlgorithmName, addr 0x33e11a0, size 0xa4, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::StreamBlockCipher) == 0x20, "Size mismatch!");
