...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R2Curve*);
MARK_REF_T(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R2Curve_SecP160R2LookupTable*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R2Curve*, "Org.BouncyCastle.Math.EC.Custom.Sec", "SecP160R2Curve");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R2Curve_SecP160R2LookupTable*, "Org.BouncyCastle.Math.EC.Custom.Sec", "SecP160R2Curve/SecP160R2LookupTable");
...
public:
  ...
  /// @brief Method CreatePoint, addr 0x33fa5b0, size 0xd4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> y);

  /// @brief Method Lookup, addr 0x33fa484, size 0x12c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar, addr 0x33fa684, size 0xe8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t index);

  static inline ::Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R2Curve_SecP160R2LookupTable* New_ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R2Curve* outer, ::ArrayW<uint32_t> table,
                                                                                                          int32_t size);
  ...
  /// @brief Method .ctor, addr 0x33fa0a4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R2Curve* outer, ::ArrayW<uint32_t> table, int32_t size);

  /// @brief Method get_Size, addr 0x33fa47c, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R2Curve_SecP160R2LookupTable) == 0x28, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = getStaticF_SECP160R2_AFFINE_ZS, put = setStaticF_SECP160R2_AFFINE_ZS)) ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> SECP160R2_AFFINE_ZS;
  ...
  /// @brief Method CloneCurve, addr 0x33f9ab8, size 0x54, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method CreateCacheSafeLookupTable, addr 0x33f9eec, size 0x1b8, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x33f9d58, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x33f9e5c, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method FromBigInteger, addr 0x33f9be4, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method RandomFieldElement, addr 0x33fa0b0, size 0x94, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElement(::Org::BouncyCastle::Security::SecureRandom* r);

  /// @brief Method RandomFieldElementMult, addr 0x33fa22c, size 0x94, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElementMult(::Org::BouncyCastle::Security::SecureRandom* r);

  /// @brief Method SupportsCoordinateSystem, addr 0x33f9b0c, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33f9884, size 0x22c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> getStaticF_SECP160R2_AFFINE_ZS();

  static inline ::Org::BouncyCastle::Math::BigInteger* getStaticF_q();

  /// @brief Method get_FieldSize, addr 0x33f9b7c, size 0x68, virtual true, abstract: false, final false
  inline int32_t get_FieldSize();

  /// @brief Method get_Infinity, addr 0x33f9b74, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_Q, addr 0x33f9b18, size 0x5c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Q();

  static inline void setStaticF_SECP160R2_AFFINE_ZS(::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> value);
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R2Curve) == 0x58, "Size mismatch!");
