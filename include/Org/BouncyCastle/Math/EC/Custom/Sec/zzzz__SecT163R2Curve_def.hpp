...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Curve*);
MARK_REF_T(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Curve_SecT163R2LookupTable*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Curve*, "Org.BouncyCastle.Math.EC.Custom.Sec", "SecT163R2Curve");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Curve_SecT163R2LookupTable*, "Org.BouncyCastle.Math.EC.Custom.Sec", "SecT163R2Curve/SecT163R2LookupTable");
...
public:
  ...
  /// @brief Method CreatePoint, addr 0x34e7f90, size 0xd4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> y);

  /// @brief Method Lookup, addr 0x34e7e64, size 0x12c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar, addr 0x34e8064, size 0xe8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t index);

  static inline ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Curve_SecT163R2LookupTable* New_ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Curve* outer, ::ArrayW<uint64_t> table,
                                                                                                          int32_t size);
  ...
  /// @brief Method .ctor, addr 0x34e7d3c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Curve* outer, ::ArrayW<uint64_t> table, int32_t size);

  /// @brief Method get_Size, addr 0x34e7e5c, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Curve_SecT163R2LookupTable) == 0x28, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = getStaticF_SECT163R2_AFFINE_ZS, put = setStaticF_SECT163R2_AFFINE_ZS)) ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> SECT163R2_AFFINE_ZS;
  ...
  /// @brief Method CloneCurve, addr 0x34e78e8, size 0x54, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method CreateCacheSafeLookupTable, addr 0x34e7b84, size 0x1b8, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x34e79b4, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x34e7abc, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method FromBigInteger, addr 0x34e7958, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method SupportsCoordinateSystem, addr 0x34e793c, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34e770c, size 0x1d4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> getStaticF_SECT163R2_AFFINE_ZS();

  /// @brief Method get_FieldSize, addr 0x34e7950, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_FieldSize();

  /// @brief Method get_Infinity, addr 0x34e7948, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_IsKoblitz, addr 0x34e7b54, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsKoblitz();

  /// @brief Method get_IsTrinomial, addr 0x34e7b64, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsTrinomial();

  /// @brief Method get_K1, addr 0x34e7b6c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_K1();

  /// @brief Method get_K2, addr 0x34e7b74, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_K2();

  /// @brief Method get_K3, addr 0x34e7b7c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_K3();

  /// @brief Method get_M, addr 0x34e7b5c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_M();

  static inline void setStaticF_SECT163R2_AFFINE_ZS(::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> value);
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Curve) == 0x60, "Size mismatch!");
