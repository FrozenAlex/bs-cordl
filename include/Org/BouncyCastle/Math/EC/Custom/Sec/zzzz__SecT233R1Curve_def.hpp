...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Curve*);
MARK_REF_T(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Curve_SecT233R1LookupTable*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Curve*, "Org.BouncyCastle.Math.EC.Custom.Sec", "SecT233R1Curve");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Curve_SecT233R1LookupTable*, "Org.BouncyCastle.Math.EC.Custom.Sec", "SecT233R1Curve/SecT233R1LookupTable");
...
public:
  ...
  /// @brief Method CreatePoint, addr 0x34f2b18, size 0xd4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> y);

  /// @brief Method Lookup, addr 0x34f2a00, size 0x118, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar, addr 0x34f2bec, size 0xcc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t index);

  static inline ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Curve_SecT233R1LookupTable* New_ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Curve* outer, ::ArrayW<uint64_t> table,
                                                                                                          int32_t size);
  ...
  /// @brief Method .ctor, addr 0x34f28d4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Curve* outer, ::ArrayW<uint64_t> table, int32_t size);

  /// @brief Method get_Size, addr 0x34f29f8, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Curve_SecT233R1LookupTable) == 0x28, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = getStaticF_SECT233R1_AFFINE_ZS, put = setStaticF_SECT233R1_AFFINE_ZS)) ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> SECT233R1_AFFINE_ZS;
  ...
  /// @brief Method CloneCurve, addr 0x34f2484, size 0x54, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method CreateCacheSafeLookupTable, addr 0x34f2724, size 0x1b0, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x34f2554, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x34f265c, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method FromBigInteger, addr 0x34f24f4, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method SupportsCoordinateSystem, addr 0x34f24d8, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34f22a8, size 0x1d4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> getStaticF_SECT233R1_AFFINE_ZS();

  /// @brief Method get_FieldSize, addr 0x34f24ec, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_FieldSize();

  /// @brief Method get_Infinity, addr 0x34f24e4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_IsKoblitz, addr 0x34f26f4, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsKoblitz();

  /// @brief Method get_IsTrinomial, addr 0x34f2704, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsTrinomial();

  /// @brief Method get_K1, addr 0x34f270c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_K1();

  /// @brief Method get_K2, addr 0x34f2714, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_K2();

  /// @brief Method get_K3, addr 0x34f271c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_K3();

  /// @brief Method get_M, addr 0x34f26fc, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_M();

  static inline void setStaticF_SECT233R1_AFFINE_ZS(::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> value);
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Curve) == 0x60, "Size mismatch!");
