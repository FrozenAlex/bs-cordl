...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Endo::GlvTypeAEndomorphism*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Endo::GlvTypeAEndomorphism*, "Org.BouncyCastle.Math.EC.Endo", "GlvTypeAEndomorphism");
...
public:
  ...
  /// @brief Method DecomposeScalar, addr 0x3508e5c, size 0x88, virtual true, abstract: false, final false
  ...
  constexpr ::Org::BouncyCastle::Math::EC::Endo::GlvTypeAParameters* const& __cordl_internal_get_m_parameters() const;
  ...
  /// @brief Method .ctor, addr 0x3508dbc, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* curve, ::Org::BouncyCastle::Math::EC::Endo::GlvTypeAParameters* parameters);

  /// @brief Method get_HasEfficientPointMap, addr 0x3508eec, size 0x8, virtual true, abstract: false, final false
  inline bool get_HasEfficientPointMap();

  /// @brief Method get_PointMap, addr 0x3508ee4, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Endo::GlvTypeAEndomorphism) == 0x20, "Size mismatch!");
