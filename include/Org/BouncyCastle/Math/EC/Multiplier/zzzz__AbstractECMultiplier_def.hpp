...
public:
  ...
  /// @brief Method CheckResult, addr 0x344eb4c, size 0xc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* CheckResult(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method Multiply, addr 0x344ea80, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x344eb58, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
