...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Multiplier::DoubleAddMultiplier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Multiplier::DoubleAddMultiplier*, "Org.BouncyCastle.Math.EC.Multiplier", "DoubleAddMultiplier");
...
public:
  // Declarations
  /// @brief Method MultiplyPositive, addr 0x35095dc, size 0x1c4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35097a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Multiplier::DoubleAddMultiplier) == 0x10, "Size mismatch!");
