...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Multiplier::FixedPointCombMultiplier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Multiplier::FixedPointCombMultiplier*, "Org.BouncyCastle.Math.EC.Multiplier", "FixedPointCombMultiplier");
...
public:
  // Declarations
  /// @brief Method MultiplyPositive, addr 0x344ed24, size 0x2ac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x344f130, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Multiplier::FixedPointCombMultiplier) == 0x10, "Size mismatch!");
