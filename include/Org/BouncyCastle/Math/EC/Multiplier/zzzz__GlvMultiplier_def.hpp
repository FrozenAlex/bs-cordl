...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Multiplier::GlvMultiplier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Multiplier::GlvMultiplier*, "Org.BouncyCastle.Math.EC.Multiplier", "GlvMultiplier");
...
public:
  ...
  /// @brief Method MultiplyPositive, addr 0x344f82c, size 0x270, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x344f790, size 0x9c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Multiplier::GlvMultiplier) == 0x20, "Size mismatch!");
