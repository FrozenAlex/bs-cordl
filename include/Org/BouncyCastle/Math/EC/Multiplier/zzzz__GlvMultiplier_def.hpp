...
public:
  ...
  /// @brief Method MultiplyPositive, addr 0x350a2ac, size 0x270, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x350a210, size 0x9c, virtual false, abstract: false, final false
