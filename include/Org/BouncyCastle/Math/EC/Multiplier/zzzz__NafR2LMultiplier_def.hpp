...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Multiplier::NafR2LMultiplier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Multiplier::NafR2LMultiplier*, "Org.BouncyCastle.Math.EC.Multiplier", "NafR2LMultiplier");
...
public:
  // Declarations
  /// @brief Method MultiplyPositive, addr 0x345037c, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34504c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Multiplier::NafR2LMultiplier) == 0x10, "Size mismatch!");
