...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Multiplier::ReferenceMultiplier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Multiplier::ReferenceMultiplier*, "Org.BouncyCastle.Math.EC.Multiplier", "ReferenceMultiplier");
...
public:
  // Declarations
  /// @brief Method MultiplyPositive, addr 0x350af4c, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x350af5c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Multiplier::ReferenceMultiplier) == 0x10, "Size mismatch!");
