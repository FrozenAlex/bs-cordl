...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities*);
MARK_REF_T(::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities_ConfigureBasepointCallback*);
MARK_REF_T(::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities_MapPointCallback*);
MARK_REF_T(::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities_PrecomputeCallback*);
MARK_REF_T(::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities_PrecomputeWithPointMapCallback*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities*, "Org.BouncyCastle.Math.EC.Multiplier", "WNafUtilities");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities_ConfigureBasepointCallback*, "Org.BouncyCastle.Math.EC.Multiplier", "WNafUtilities/ConfigureBasepointCallback");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities_MapPointCallback*, "Org.BouncyCastle.Math.EC.Multiplier", "WNafUtilities/MapPointCallback");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities_PrecomputeCallback*, "Org.BouncyCastle.Math.EC.Multiplier", "WNafUtilities/PrecomputeCallback");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities_PrecomputeWithPointMapCallback*, "Org.BouncyCastle.Math.EC.Multiplier", "WNafUtilities/PrecomputeWithPointMapCallback");
...
public:
  ...
  /// @brief Method Precompute, addr 0x350c9a0, size 0x19c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x350b9e0, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities_ConfigureBasepointCallback) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method Precompute, addr 0x350cb3c, size 0x370, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* Precompute(::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* existing);
  ...
  /// @brief Method .ctor, addr 0x350c6b0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities_MapPointCallback) == 0x28, "Size mismatch!");
...
public:
  ...
  /// @brief Method CheckExisting, addr 0x350d658, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckTable, addr 0x350d75c, size 0x1c, virtual false, abstract: false, final false
  inline bool CheckTable(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*> table, int32_t reqLen);
  ...
  /// @brief Method Precompute, addr 0x350ceac, size 0x7ac, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* Precompute(::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* existing);
  ...
  /// @brief Method .ctor, addr 0x350c6c0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities_PrecomputeCallback) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method CheckExisting, addr 0x350db70, size 0xa4, virtual false, abstract: false, final false
  inline bool CheckExisting(::Org::BouncyCastle::Math::EC::Multiplier::WNafPreCompInfo* existingWNaf, int32_t width, int32_t reqPreCompLen, bool includeNegated);

  /// @brief Method CheckTable, addr 0x350dc14, size 0x1c, virtual false, abstract: false, final false
  inline bool CheckTable(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*> table, int32_t reqLen);
  ...
  /// @brief Method Precompute, addr 0x350d778, size 0x3f8, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* Precompute(::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* existing);
  ...
  /// @brief Method .ctor, addr 0x350c80c, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities_PrecomputeWithPointMapCallback) == 0x30, "Size mismatch!");

} // namespace Org::BouncyCastle::Math::EC::Multiplier
// Dependencies Org.BouncyCastle.Math.EC.ECPoint, System.Object
namespace Org::BouncyCastle::Math::EC::Multiplier {
// Is value type: false
...
public:
  ...
  __declspec(property(get = getStaticF_DEFAULT_WINDOW_SIZE_CUTOFFS, put = setStaticF_DEFAULT_WINDOW_SIZE_CUTOFFS)) ::ArrayW<int32_t> DEFAULT_WINDOW_SIZE_CUTOFFS;

  /// @brief Field EMPTY_POINTS, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_EMPTY_POINTS, put = setStaticF_EMPTY_POINTS)) ::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*> EMPTY_POINTS;
  ...
  /// @brief Method ConfigureBasepoint, addr 0x350b87c, size 0x164, virtual false, abstract: false, final false
  static inline void ConfigureBasepoint(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method GenerateCompactNaf, addr 0x350a720, size 0x278, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t> GenerateCompactNaf(::Org::BouncyCastle::Math::BigInteger* k);

  /// @brief Method GenerateCompactWindowNaf, addr 0x350b4a8, size 0x30c, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t> GenerateCompactWindowNaf(int32_t width, ::Org::BouncyCastle::Math::BigInteger* k);

  /// @brief Method GenerateJsf, addr 0x350ba74, size 0x298, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> GenerateJsf(::Org::BouncyCastle::Math::BigInteger* g, ::Org::BouncyCastle::Math::BigInteger* h);

  /// @brief Method GenerateNaf, addr 0x350bd94, size 0x18c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> GenerateNaf(::Org::BouncyCastle::Math::BigInteger* k);

  /// @brief Method GenerateWindowNaf, addr 0x350bf20, size 0x2dc, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> GenerateWindowNaf(int32_t width, ::Org::BouncyCastle::Math::BigInteger* k);

  /// @brief Method GetNafWeight, addr 0x350c1fc, size 0x64, virtual false, abstract: false, final false
  static inline int32_t GetNafWeight(::Org::BouncyCastle::Math::BigInteger* k);

  /// @brief Method GetWNafPreCompInfo, addr 0x350c260, size 0x9c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::EC::Multiplier::WNafPreCompInfo* GetWNafPreCompInfo(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method GetWNafPreCompInfo, addr 0x350c2fc, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWindowSize, addr 0x350b310, size 0x68, virtual false, abstract: false, final false
  static inline int32_t GetWindowSize(int32_t bits);

  /// @brief Method GetWindowSize, addr 0x350c440, size 0x74, virtual false, abstract: false, final false
  static inline int32_t GetWindowSize(int32_t bits, int32_t maxWidth);

  /// @brief Method GetWindowSize, addr 0x350c4b4, size 0x74, virtual false, abstract: false, final false
  static inline int32_t GetWindowSize(int32_t bits, ::ArrayW<int32_t> windowSizeCutoffs);

  /// @brief Method GetWindowSize, addr 0x350c378, size 0xc8, virtual false, abstract: false, final false
  static inline int32_t GetWindowSize(int32_t bits, ::ArrayW<int32_t> windowSizeCutoffs, int32_t maxWidth);

  /// @brief Method MapPointWithPrecomp, addr 0x350c528, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method Precompute, addr 0x350b378, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method PrecomputeWithPointMap, addr 0x350c6d0, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method ResizeTable, addr 0x350c81c, size 0x88, virtual false, abstract: false, final false
  static inline ::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*> ResizeTable(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*> a, int32_t length);

  /// @brief Method Trim, addr 0x350b9ec, size 0x88, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t> Trim(::ArrayW<int32_t> a, int32_t length);

  /// @brief Method Trim, addr 0x350bd0c, size 0x88, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> Trim(::ArrayW<uint8_t> a, int32_t length);

  /// @brief Method .ctor, addr 0x350c99c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<int32_t> getStaticF_DEFAULT_WINDOW_SIZE_CUTOFFS();

  static inline ::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*> getStaticF_EMPTY_POINTS();

  static inline int32_t getStaticF_MAX_WIDTH();

  static inline ::StringW getStaticF_PRECOMP_NAME();

  static inline void setStaticF_DEFAULT_WINDOW_SIZE_CUTOFFS(::ArrayW<int32_t> value);

  static inline void setStaticF_EMPTY_POINTS(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*> value);
...
// Non member Declarations
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities) == 0x10, "Size mismatch!");
