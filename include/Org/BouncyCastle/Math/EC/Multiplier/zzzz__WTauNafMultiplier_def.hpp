...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Multiplier::WTauNafMultiplier*);
MARK_REF_T(::Org::BouncyCastle::Math::EC::Multiplier::WTauNafMultiplier_WTauNafCallback*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Multiplier::WTauNafMultiplier*, "Org.BouncyCastle.Math.EC.Multiplier", "WTauNafMultiplier");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Multiplier::WTauNafMultiplier_WTauNafCallback*, "Org.BouncyCastle.Math.EC.Multiplier", "WTauNafMultiplier/WTauNafCallback");
...
public:
  ...
  /// @brief Method Precompute, addr 0x350e430, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x350e3b8, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Multiplier::WTauNafMultiplier_WTauNafCallback) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method MultiplyFromWTnaf, addr 0x350df6c, size 0x44c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::EC::AbstractF2mPoint* MultiplyFromWTnaf(::Org::BouncyCastle::Math::EC::AbstractF2mPoint* p, ::ArrayW<int8_t> u);

  /// @brief Method MultiplyPositive, addr 0x350dc30, size 0x1ec, virtual true, abstract: false, final false
  ...
  /// @brief Method MultiplyWTnaf, addr 0x350de1c, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x350e42c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Multiplier::WTauNafMultiplier) == 0x10, "Size mismatch!");
