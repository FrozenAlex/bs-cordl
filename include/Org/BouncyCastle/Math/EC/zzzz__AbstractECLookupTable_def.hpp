...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::AbstractECLookupTable*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::AbstractECLookupTable*, "Org.BouncyCastle.Math.EC", "AbstractECLookupTable");
...
public:
  ...
  /// @brief Method LookupVar, addr 0x33e69cc, size 0xc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t index);

  static inline ::Org::BouncyCastle::Math::EC::AbstractECLookupTable* New_ctor();

  /// @brief Method .ctor, addr 0x33e65cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::AbstractECLookupTable) == 0x10, "Size mismatch!");
