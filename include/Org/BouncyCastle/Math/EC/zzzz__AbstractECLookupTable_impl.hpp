...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::Org::BouncyCastle::Math::EC::ECPoint* (::Org::BouncyCastle::Math::EC::AbstractECLookupTable::*)(int32_t)>(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Math::EC::AbstractECLookupTable*>(),
                                                                                          { ::i2c::class_of<::Org::BouncyCastle::Math::EC::AbstractECLookupTable*>(), 7 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::Org::BouncyCastle::Math::EC::AbstractECLookupTable::*)()>(&::Org::BouncyCastle::Math::EC::AbstractECLookupTable::get_Size)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Math::EC::AbstractECLookupTable*>(),
                                                                                          { ::i2c::class_of<::Org::BouncyCastle::Math::EC::AbstractECLookupTable*>(), 8 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::Org::BouncyCastle::Math::EC::ECPoint* (::Org::BouncyCastle::Math::EC::AbstractECLookupTable::*)(int32_t)>(
  ...
  constexpr static std::size_t addrs = 0x33e69cc;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Math::EC::AbstractECLookupTable*>(),
                                                                                          { ::i2c::class_of<::Org::BouncyCastle::Math::EC::AbstractECLookupTable*>(), 9 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Org::BouncyCastle::Math::EC::AbstractECLookupTable::*)()>(&::Org::BouncyCastle::Math::EC::AbstractECLookupTable::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x33e65cc;
...
inline ::Org::BouncyCastle::Math::EC::ECPoint* Org::BouncyCastle::Math::EC::AbstractECLookupTable::Lookup(int32_t index) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Org::BouncyCastle::Math::EC::AbstractECLookupTable*>(), 7 })));
...
inline int32_t Org::BouncyCastle::Math::EC::AbstractECLookupTable::get_Size() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Org::BouncyCastle::Math::EC::AbstractECLookupTable*>(), 8 })));
...
inline ::Org::BouncyCastle::Math::EC::ECPoint* Org::BouncyCastle::Math::EC::AbstractECLookupTable::LookupVar(int32_t index) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Org::BouncyCastle::Math::EC::AbstractECLookupTable*>(), 9 })));
  return ::cordl_internals::RunMethodRethrow<::Org::BouncyCastle::Math::EC::ECPoint*>(this, ___internal_method, index);
}
...
inline ::Org::BouncyCastle::Math::EC::AbstractECLookupTable* Org::BouncyCastle::Math::EC::AbstractECLookupTable::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Org::BouncyCastle::Math::EC::AbstractECLookupTable*>());
}
...
constexpr ::Org::BouncyCastle::Math::EC::ECLookupTable* Org::BouncyCastle::Math::EC::AbstractECLookupTable::i___Org__BouncyCastle__Math__EC__ECLookupTable() noexcept {
  return static_cast<::Org::BouncyCastle::Math::EC::ECLookupTable*>(static_cast<void*>(this));
}
// Ctor Parameters []
