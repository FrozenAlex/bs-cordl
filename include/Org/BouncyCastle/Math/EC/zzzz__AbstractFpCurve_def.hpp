...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::AbstractFpCurve*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::AbstractFpCurve*, "Org.BouncyCastle.Math.EC", "AbstractFpCurve");
...
public:
  // Declarations
  /// @brief Method DecompressPoint, addr 0x34a18e8, size 0x17c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* DecompressPoint(int32_t yTilde, ::Org::BouncyCastle::Math::BigInteger* X1);

  /// @brief Method ImplRandomFieldElement, addr 0x34a16e4, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplRandomFieldElementMult, addr 0x34a1860, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidFieldElement, addr 0x34a14d0, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method RandomFieldElement, addr 0x34a15c0, size 0x124, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElement(::Org::BouncyCastle::Security::SecureRandom* r);

  /// @brief Method RandomFieldElementMult, addr 0x34a173c, size 0x124, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElementMult(::Org::BouncyCastle::Security::SecureRandom* r);

  /// @brief Method .ctor, addr 0x34a1458, size 0x78, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::AbstractFpCurve) == 0x50, "Size mismatch!");
