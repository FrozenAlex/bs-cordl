...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::AbstractFpFieldElement*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::AbstractFpFieldElement*, "Org.BouncyCastle.Math.EC", "AbstractFpFieldElement");
...
public:
  ...
  /// @brief Method .ctor, addr 0x34a4048, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::AbstractFpFieldElement) == 0x10, "Size mismatch!");
