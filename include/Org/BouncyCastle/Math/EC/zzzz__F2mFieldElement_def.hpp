...
public:
  ...
  /// @brief Method Add, addr 0x3524838, size 0xe0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* Add(::Org::BouncyCastle::Math::EC::ECFieldElement* b);

  /// @brief Method AddOne, addr 0x3524a74, size 0x8c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* AddOne();

  /// @brief Method CheckFieldElements, addr 0x35246a4, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method Divide, addr 0x352585c, size 0x40, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* Divide(::Org::BouncyCastle::Math::EC::ECFieldElement* b);

  /// @brief Method Equals, addr 0x352652c, size 0xb8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x35265e4, size 0xcc, virtual true, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Math::EC::F2mFieldElement* other);

  /// @brief Method GetHashCode, addr 0x35266b0, size 0x90, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Invert, addr 0x3525f6c, size 0x94, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* Invert();

  /// @brief Method Multiply, addr 0x3524c14, size 0xdc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* Multiply(::Org::BouncyCastle::Math::EC::ECFieldElement* b);

  /// @brief Method MultiplyMinusProduct, addr 0x352517c, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method MultiplyPlusProduct, addr 0x352518c, size 0x1a8, virtual true, abstract: false, final false
  ...
  /// @brief Method Negate, addr 0x352589c, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method Sqrt, addr 0x3526444, size 0x58, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* Sqrt();

  /// @brief Method Square, addr 0x35258a0, size 0x94, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* Square();

  /// @brief Method SquareMinusProduct, addr 0x3525ac4, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method SquarePlusProduct, addr 0x3525ad4, size 0x160, virtual true, abstract: false, final false
  ...
  /// @brief Method SquarePow, addr 0x3525d84, size 0xb4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* SquarePow(int32_t pow);

  /// @brief Method Subtract, addr 0x3524c08, size 0xc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* Subtract(::Org::BouncyCastle::Math::EC::ECFieldElement* b);

  /// @brief Method TestBitZero, addr 0x35243c8, size 0x3c, virtual true, abstract: false, final false
  inline bool TestBitZero();

  /// @brief Method ToBigInteger, addr 0x3524434, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3524208, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(int32_t m, int32_t k, ::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method .ctor, addr 0x35216c0, size 0x200, virtual false, abstract: false, final false
  inline void _ctor(int32_t m, int32_t k1, int32_t k2, int32_t k3, ::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method .ctor, addr 0x35220d4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(int32_t m, ::ArrayW<int32_t> ks, ::Org::BouncyCastle::Math::EC::LongArray* x);

  /// @brief Method get_BitLength, addr 0x3524218, size 0x14, virtual true, abstract: false, final false
  inline int32_t get_BitLength();

  /// @brief Method get_FieldName, addr 0x3524658, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_FieldName();

  /// @brief Method get_FieldSize, addr 0x352469c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_FieldSize();

  /// @brief Method get_IsOne, addr 0x35242c8, size 0x14, virtual true, abstract: false, final false
  inline bool get_IsOne();

  /// @brief Method get_IsZero, addr 0x352434c, size 0x14, virtual true, abstract: false, final false
  inline bool get_IsZero();

  /// @brief Method get_K1, addr 0x35264ac, size 0x28, virtual false, abstract: false, final false
  inline int32_t get_K1();

  /// @brief Method get_K2, addr 0x35264d4, size 0x2c, virtual false, abstract: false, final false
  inline int32_t get_K2();

  /// @brief Method get_K3, addr 0x3526500, size 0x2c, virtual false, abstract: false, final false
  inline int32_t get_K3();

  /// @brief Method get_M, addr 0x35264a4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_M();

  /// @brief Method get_Representation, addr 0x352649c, size 0x8, virtual false, abstract: false, final false
