...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::ScaleXPointMap*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::ScaleXPointMap*, "Org.BouncyCastle.Math.EC", "ScaleXPointMap");
...
public:
  ...
  /// @brief Method Map, addr 0x3473df8, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3473df0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::ScaleXPointMap) == 0x18, "Size mismatch!");
