...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::ScaleYNegateXPointMap*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::ScaleYNegateXPointMap*, "Org.BouncyCastle.Math.EC", "ScaleYNegateXPointMap");
...
public:
  ...
  /// @brief Method Map, addr 0x3473e28, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3473e20, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::ScaleYNegateXPointMap) == 0x18, "Size mismatch!");
