...
public:
  ...
  /// @brief Method Map, addr 0x352e8a8, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x352e8a0, size 0x8, virtual false, abstract: false, final false
