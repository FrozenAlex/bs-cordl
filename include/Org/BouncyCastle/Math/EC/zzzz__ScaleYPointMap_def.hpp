...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::ScaleYPointMap*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::ScaleYPointMap*, "Org.BouncyCastle.Math.EC", "ScaleYPointMap");
...
public:
  ...
  /// @brief Method Map, addr 0x352e8d8, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x352e8d0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::ScaleYPointMap) == 0x18, "Size mismatch!");
