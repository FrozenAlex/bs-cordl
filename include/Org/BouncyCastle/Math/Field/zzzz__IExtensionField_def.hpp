...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::Field::IExtensionField*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::Field::IExtensionField*, "Org.BouncyCastle.Math.Field", "IExtensionField");
// Dependencies
namespace Org::BouncyCastle::Math::Field {
// Is value type: false
