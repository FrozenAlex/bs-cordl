...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::Field::IFiniteField*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::Field::IFiniteField*, "Org.BouncyCastle.Math.Field", "IFiniteField");
// Dependencies
namespace Org::BouncyCastle::Math::Field {
// Is value type: false
