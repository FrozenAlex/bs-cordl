...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::Primes*);
MARK_REF_T(::Org::BouncyCastle::Math::Primes_MROutput*);
MARK_REF_T(::Org::BouncyCastle::Math::Primes_STOutput*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::Primes*, "Org.BouncyCastle.Math", "Primes");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::Primes_MROutput*, "Org.BouncyCastle.Math", "Primes/MROutput");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::Primes_STOutput*, "Org.BouncyCastle.Math", "Primes/STOutput");
...
public:
  ...
  /// @brief Method ProbablyPrime, addr 0x356da98, size 0x50, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::Primes_MROutput* ProbablyPrime();

  /// @brief Method ProvablyCompositeNotPrimePower, addr 0x356db4c, size 0x54, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::Primes_MROutput* ProvablyCompositeNotPrimePower();

  /// @brief Method ProvablyCompositeWithFactor, addr 0x356daf4, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x356dae8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(bool provablyComposite, ::Org::BouncyCastle::Math::BigInteger* factor);

  /// @brief Method get_Factor, addr 0x356dba0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Factor();

  /// @brief Method get_IsNotPrimePower, addr 0x356dbb0, size 0x20, virtual false, abstract: false, final false
  inline bool get_IsNotPrimePower();

  /// @brief Method get_IsProvablyComposite, addr 0x356dba8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Math::Primes_MROutput) == 0x20, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = get_PrimeSeed)) ::ArrayW<uint8_t> PrimeSeed;
  ...
  __declspec(property(get = __cordl_internal_get_mPrimeSeed, put = __cordl_internal_set_mPrimeSeed)) ::ArrayW<uint8_t> mPrimeSeed;

  static inline ::Org::BouncyCastle::Math::Primes_STOutput* New_ctor(::Org::BouncyCastle::Math::BigInteger* prime, ::ArrayW<uint8_t> primeSeed, int32_t primeGenCounter);
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_mPrimeSeed() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_mPrimeSeed();
  ...
  constexpr void __cordl_internal_set_mPrimeSeed(::ArrayW<uint8_t> value);

  /// @brief Method .ctor, addr 0x356dbd0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* prime, ::ArrayW<uint8_t> primeSeed, int32_t primeGenCounter);

  /// @brief Method get_Prime, addr 0x356dbdc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Prime();

  /// @brief Method get_PrimeGenCounter, addr 0x356dbec, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_PrimeGenCounter();

  /// @brief Method get_PrimeSeed, addr 0x356dbe4, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> get_PrimeSeed();
...
static_assert(sizeof(::Org::BouncyCastle::Math::Primes_STOutput) == 0x28, "Size mismatch!");
...
public:
  ...
  /// @brief Method CheckCandidate, addr 0x356c544, size 0x80, virtual false, abstract: false, final false
  static inline void CheckCandidate(::Org::BouncyCastle::Math::BigInteger* n, ::StringW name);

  /// @brief Method EnhancedMRProbablePrimeTest, addr 0x356c0ac, size 0x498, virtual false, abstract: false, final false
  ...
  /// @brief Method Extract32, addr 0x356d658, size 0xc0, virtual false, abstract: false, final false
  static inline uint32_t Extract32(::ArrayW<uint8_t> bs);

  /// @brief Method GenerateSTRandomPrime, addr 0x356b8d0, size 0x1a4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::Primes_STOutput* GenerateSTRandomPrime(::Org::BouncyCastle::Crypto::IDigest* hash, int32_t length, ::ArrayW<uint8_t> inputSeed);

  /// @brief Method HasAnySmallFactors, addr 0x356c5c4, size 0x7c, virtual false, abstract: false, final false
  static inline bool HasAnySmallFactors(::Org::BouncyCastle::Math::BigInteger* candidate);

  /// @brief Method Hash, addr 0x356d4cc, size 0x138, virtual false, abstract: false, final false
  static inline void Hash(::Org::BouncyCastle::Crypto::IDigest* d, ::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output, int32_t outPos);

  /// @brief Method HashGen, addr 0x356d87c, size 0x180, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::BigInteger* HashGen(::Org::BouncyCastle::Crypto::IDigest* d, ::ArrayW<uint8_t> seed, int32_t count);

  /// @brief Method ImplHasAnySmallFactors, addr 0x356c640, size 0x920, virtual false, abstract: false, final false
  static inline bool ImplHasAnySmallFactors(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method ImplMRProbablePrimeToBase, addr 0x356d198, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSTRandomPrime, addr 0x356ba74, size 0x638, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::Primes_STOutput* ImplSTRandomPrime(::Org::BouncyCastle::Crypto::IDigest* d, int32_t length, ::ArrayW<uint8_t> primeSeed);

  /// @brief Method Inc, addr 0x356d604, size 0x54, virtual false, abstract: false, final false
  static inline void Inc(::ArrayW<uint8_t> seed, int32_t c);

  /// @brief Method IsMRProbablePrime, addr 0x356cf60, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method IsMRProbablePrimeToBase, addr 0x356d308, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPrime32, addr 0x356d718, size 0x164, virtual false, abstract: false, final false
  static inline bool IsPrime32(uint32_t x);

  static inline ::Org::BouncyCastle::Math::Primes* New_ctor();

  /// @brief Method .ctor, addr 0x356da94, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::Org::BouncyCastle::Math::Primes) == 0x10, "Size mismatch!");
