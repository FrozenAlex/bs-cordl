...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Ocsp::CertificateStatus*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Ocsp::CertificateStatus*, "Org.BouncyCastle.Ocsp", "CertificateStatus");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3571824, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Ocsp::CertificateStatus) == 0x10, "Size mismatch!");
