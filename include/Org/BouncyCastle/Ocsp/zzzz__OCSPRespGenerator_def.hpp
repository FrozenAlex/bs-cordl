...
public:
  // Declarations
  /// @brief Method Generate, addr 0x34b99a8, size 0x2f0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34b9c98, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
