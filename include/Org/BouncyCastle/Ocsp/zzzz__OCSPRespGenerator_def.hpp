...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Ocsp::OCSPRespGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Ocsp::OCSPRespGenerator*, "Org.BouncyCastle.Ocsp", "OCSPRespGenerator");
...
public:
  // Declarations
  /// @brief Method Generate, addr 0x3574428, size 0x2f0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3574718, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Ocsp::OCSPRespGenerator) == 0x10, "Size mismatch!");
