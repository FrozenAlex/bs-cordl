...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Ocsp::OcscpRespStatus*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Ocsp::OcscpRespStatus*, "Org.BouncyCastle.Ocsp", "OcscpRespStatus");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3574720, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Ocsp::OcscpRespStatus) == 0x10, "Size mismatch!");
