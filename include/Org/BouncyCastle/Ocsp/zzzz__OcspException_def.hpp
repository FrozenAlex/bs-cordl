...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Ocsp::OcspException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Ocsp::OcspException*, "Org.BouncyCastle.Ocsp", "OcspException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x34b6da8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x34b6e00, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34b3724, size 0x74, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Ocsp::OcspException) == 0x90, "Size mismatch!");
