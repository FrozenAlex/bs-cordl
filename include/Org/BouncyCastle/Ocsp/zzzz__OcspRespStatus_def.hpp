...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Ocsp::OcspRespStatus*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Ocsp::OcspRespStatus*, "Org.BouncyCastle.Ocsp", "OcspRespStatus");
...
public:
  ...
  /// @brief Method .ctor, addr 0x34b9c9c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Ocsp::OcspRespStatus) == 0x10, "Size mismatch!");
