...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Ocsp::OcspUtilities*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Ocsp::OcspUtilities*, "Org.BouncyCastle.Ocsp", "OcspUtilities");
...
public:
  ...
  /// @brief Method GetAlgorithmName, addr 0x356e4b8, size 0x190, virtual false, abstract: false, final false
  static inline ::StringW GetAlgorithmName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetAlgorithmOid, addr 0x3573c60, size 0x21c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetAlgorithmOid(::StringW algorithmName);

  /// @brief Method GetSigAlgID, addr 0x35709f4, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3576c94, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AlgNames, addr 0x3570cdc, size 0x114, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Ocsp::OcspUtilities) == 0x10, "Size mismatch!");
