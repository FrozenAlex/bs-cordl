...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Ocsp::Req*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Ocsp::Req*, "Org.BouncyCastle.Ocsp", "Req");
...
public:
  ...
  /// @brief Method GetCertID, addr 0x34bc218, size 0x6c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Ocsp::CertificateID* GetCertID();

  /// @brief Method GetX509Extensions, addr 0x34bc29c, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34b7330, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::Request* req);

  /// @brief Method get_SingleRequestExtensions, addr 0x34bc284, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Ocsp::Req) == 0x18, "Size mismatch!");
