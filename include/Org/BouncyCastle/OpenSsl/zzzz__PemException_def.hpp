...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::OpenSsl::PemException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::OpenSsl::PemException*, "Org.BouncyCastle.OpenSsl", "PemException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x34e8670, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34e8694, size 0x24, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::OpenSsl::PemException) == 0x90, "Size mismatch!");
