...
public:
  ...
  /// @brief Method WriteObject, addr 0x34ebef4, size 0x15c, virtual false, abstract: false, final false
  inline void WriteObject(::System::Object* obj);

  /// @brief Method WriteObject, addr 0x34ec050, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34ebef0, size 0x4, virtual false, abstract: false, final false
