...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::OpenSsl::Pkcs8Generator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::OpenSsl::Pkcs8Generator*, "Org.BouncyCastle.OpenSsl", "Pkcs8Generator");
...
public:
  ...
  __declspec(property(put = set_Password)) ::ArrayW<char16_t> Password;
  ...
  /// @brief Method Generate, addr 0x34ec100, size 0x270, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x34ec0cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privKey);

  /// @brief Method .ctor, addr 0x34ec0d4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IterationCount, addr 0x34ec0f8, size 0x8, virtual false, abstract: false, final false
  inline void set_IterationCount(int32_t value);

  /// @brief Method set_Password, addr 0x34ec0f0, size 0x8, virtual false, abstract: false, final false
  inline void set_Password(::ArrayW<char16_t> value);

  /// @brief Method set_SecureRandom, addr 0x34ec0e8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::OpenSsl::Pkcs8Generator) == 0x38, "Size mismatch!");
