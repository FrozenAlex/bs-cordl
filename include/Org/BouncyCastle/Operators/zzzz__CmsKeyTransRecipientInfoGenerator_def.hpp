...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Operators::CmsKeyTransRecipientInfoGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Operators::CmsKeyTransRecipientInfoGenerator*, "Org.BouncyCastle.Operators", "CmsKeyTransRecipientInfoGenerator");
...
public:
  ...
  static inline ::Org::BouncyCastle::Operators::CmsKeyTransRecipientInfoGenerator* New_ctor(::ArrayW<uint8_t> subjectKeyID, ::Org::BouncyCastle::Crypto::IKeyWrapper* keyWrapper);
...
static_assert(sizeof(::Org::BouncyCastle::Operators::CmsKeyTransRecipientInfoGenerator) == 0x48, "Size mismatch!");
