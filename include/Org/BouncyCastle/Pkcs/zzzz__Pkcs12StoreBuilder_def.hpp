...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Pkcs::Pkcs12StoreBuilder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Pkcs::Pkcs12StoreBuilder*, "Org.BouncyCastle.Pkcs", "Pkcs12StoreBuilder");
...
public:
  ...
  /// @brief Method Build, addr 0x34fba48, size 0x8c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Pkcs::Pkcs12Store* Build();

  static inline ::Org::BouncyCastle::Pkcs::Pkcs12StoreBuilder* New_ctor();

  /// @brief Method SetCertAlgorithm, addr 0x34fbad4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Pkcs::Pkcs12StoreBuilder* SetCertAlgorithm(::Org::BouncyCastle::Asn1::DerObjectIdentifier* certAlgorithm);

  /// @brief Method SetKeyAlgorithm, addr 0x34fbadc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Pkcs::Pkcs12StoreBuilder* SetKeyAlgorithm(::Org::BouncyCastle::Asn1::DerObjectIdentifier* keyAlgorithm);

  /// @brief Method SetKeyAlgorithm, addr 0x34fbae4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetUseDerEncoding, addr 0x34fbaf0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34fb9d8, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Pkcs::Pkcs12StoreBuilder) == 0x38, "Size mismatch!");
