...
public:
  ...
  /// @brief Method Equals, addr 0x35b5928, size 0xe0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x35b58c8, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b58b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> id);

  /// @brief Method .ctor, addr 0x35b5888, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* pubKey);

  /// @brief Method get_Id, addr 0x35b58c0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Clear, addr 0x35b5a08, size 0x10c, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method GetEnumerator, addr 0x35b5b14, size 0xa8, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* GetEnumerator();

  static inline ::Org::BouncyCastle::Pkcs::Pkcs12Store_IgnoresCaseHashtable* New_ctor();

  /// @brief Method Remove, addr 0x35b5c64, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b63ec, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x35b6344, size 0xa8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x35b5ebc, size 0x184, virtual false, abstract: false, final false
  inline ::System::Object* get_Item(::StringW alias);

  /// @brief Method get_Keys, addr 0x35b5bbc, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* get_Keys();

  /// @brief Method get_Values, addr 0x35b629c, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* get_Values();

  /// @brief Convert to "::System::Collections::IEnumerable"
  constexpr ::System::Collections::IEnumerable* i___System__Collections__IEnumerable() noexcept;

  /// @brief Method set_Item, addr 0x35b6040, size 0x25c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CalculatePbeMac, addr 0x35af678, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method ContainsAlias, addr 0x35b0454, size 0x58, virtual false, abstract: false, final false
  inline bool ContainsAlias(::StringW alias);

  /// @brief Method CreateSubjectKeyID, addr 0x35ad15c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method CryptPbeData, addr 0x35af808, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method DeleteEntry, addr 0x35b1d1c, size 0x560, virtual false, abstract: false, final false
  inline void DeleteEntry(::StringW alias);

  /// @brief Method GetAliasesTable, addr 0x35afc54, size 0x710, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionary* GetAliasesTable();

  /// @brief Method GetCertificate, addr 0x35b04ac, size 0x254, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Pkcs::X509CertificateEntry* GetCertificate(::StringW alias);

  /// @brief Method GetCertificateAlias, addr 0x35b0700, size 0x6e0, virtual false, abstract: false, final false
  inline ::StringW GetCertificateAlias(::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method GetCertificateChain, addr 0x35b0de0, size 0xa9c, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Pkcs::X509CertificateEntry*> GetCertificateChain(::StringW alias);

  /// @brief Method GetKey, addr 0x35afa5c, size 0xe8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Pkcs::AsymmetricKeyEntry* GetKey(::StringW alias);

  /// @brief Method IsCertificateEntry, addr 0x35afb44, size 0x9c, virtual false, abstract: false, final false
  inline bool IsCertificateEntry(::StringW alias);

  /// @brief Method IsEntryOfType, addr 0x35b227c, size 0x104, virtual false, abstract: false, final false
  inline bool IsEntryOfType(::StringW alias, ::System::Type* entryType);

  /// @brief Method IsKeyEntry, addr 0x35afbe0, size 0x74, virtual false, abstract: false, final false
  inline bool IsKeyEntry(::StringW alias);

  /// @brief Method Load, addr 0x35ad468, size 0x1958, virtual false, abstract: false, final false
  inline void Load(::System::IO::Stream* input, ::ArrayW<char16_t> password);

  /// @brief Method LoadKeyBag, addr 0x35aedc0, size 0x86c, virtual true, abstract: false, final false
  inline void LoadKeyBag(::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* privKeyInfo, ::Org::BouncyCastle::Asn1::Asn1Set* bagAttributes);

  /// @brief Method LoadPkcs8ShroudedKeyBag, addr 0x35af62c, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method Save, addr 0x35b2434, size 0x3454, virtual false, abstract: false, final false
  inline void Save(::System::IO::Stream* stream, ::ArrayW<char16_t> password, ::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method SetCertificateEntry, addr 0x35b187c, size 0x21c, virtual false, abstract: false, final false
  inline void SetCertificateEntry(::StringW alias, ::Org::BouncyCastle::Pkcs::X509CertificateEntry* certEntry);

  /// @brief Method SetKeyEntry, addr 0x35b1a98, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method Size, addr 0x35b2380, size 0x4, virtual false, abstract: false, final false
  inline int32_t Size();
  ...
  /// @brief Method .ctor, addr 0x35ad3cc, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35ad438, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input, ::ArrayW<char16_t> password);

  /// @brief Method .ctor, addr 0x35ad1d4, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35ad2c8, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Aliases, addr 0x35b0364, size 0xf0, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerable* get_Aliases();

  /// @brief Method get_Count, addr 0x35b2384, size 0xb0, virtual false, abstract: false, final false
  inline int32_t get_Count();
