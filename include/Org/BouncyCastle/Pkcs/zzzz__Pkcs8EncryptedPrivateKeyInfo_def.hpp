...
public:
  ...
  /// @brief Method DecryptPrivateKeyInfo, addr 0x35b6bec, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEncoded, addr 0x35b6bd4, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetEncoded();

  /// @brief Method GetEncryptedData, addr 0x35b6bac, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Structure, addr 0x35b6ba4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b6b88, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> encryptedPrivateKeyInfo);

  /// @brief Method .ctor, addr 0x35b6b80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Pkcs::EncryptedPrivateKeyInfo* encryptedPrivateKeyInfo);

  /// @brief Method parseBytes, addr 0x35b6a3c, size 0x120, virtual false, abstract: false, final false
