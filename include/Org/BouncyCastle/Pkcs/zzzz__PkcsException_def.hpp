...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Pkcs::PkcsException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Pkcs::PkcsException*, "Org.BouncyCastle.Pkcs", "PkcsException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x34fc9f8, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34fc560, size 0x74, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Pkcs::PkcsException) == 0x90, "Size mismatch!");
