...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Pkcs::X509CertificateEntry*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Pkcs::X509CertificateEntry*, "Org.BouncyCastle.Pkcs", "X509CertificateEntry");
...
public:
  ...
  /// @brief Method Equals, addr 0x35b88a0, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x35b894c, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b87c4, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method .ctor, addr 0x35b8840, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::X509::X509Certificate* cert, ::System::Collections::Hashtable* attributes);

  /// @brief Method .ctor, addr 0x35b886c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::X509::X509Certificate* cert, ::System::Collections::IDictionary* attributes);

  /// @brief Method get_Certificate, addr 0x35b8898, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Pkcs::X509CertificateEntry) == 0x20, "Size mismatch!");
