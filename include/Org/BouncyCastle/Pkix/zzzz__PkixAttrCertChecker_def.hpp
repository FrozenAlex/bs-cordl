...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Pkix::PkixAttrCertChecker*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Pkix::PkixAttrCertChecker*, "Org.BouncyCastle.Pkix", "PkixAttrCertChecker");
...
public:
  ...
  /// @brief Method .ctor, addr 0x34fdf24, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Pkix::PkixAttrCertChecker) == 0x10, "Size mismatch!");
