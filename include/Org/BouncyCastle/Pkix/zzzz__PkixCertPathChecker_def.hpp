...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Pkix::PkixCertPathChecker*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Pkix::PkixCertPathChecker*, "Org.BouncyCastle.Pkix", "PkixCertPathChecker");
...
public:
  ...
  /// @brief Method Clone, addr 0x3509768, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3509764, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Pkix::PkixCertPathChecker) == 0x10, "Size mismatch!");
