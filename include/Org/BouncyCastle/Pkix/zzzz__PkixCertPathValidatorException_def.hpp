...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Pkix::PkixCertPathValidatorException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Pkix::PkixCertPathValidatorException*, "Org.BouncyCastle.Pkix", "PkixCertPathValidatorException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3515630, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x351563c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3501a78, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* cause);

  /// @brief Method .ctor, addr 0x350b570, size 0x194, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* cause, ::Org::BouncyCastle::Pkix::PkixCertPath* certPath, int32_t index);

  /// @brief Method get_CertPath, addr 0x351567c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Pkix::PkixCertPath* get_CertPath();

  /// @brief Method get_Index, addr 0x3515684, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Index();

  /// @brief Method get_Message, addr 0x3515648, size 0x34, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Pkix::PkixCertPathValidatorException) == 0xa8, "Size mismatch!");
