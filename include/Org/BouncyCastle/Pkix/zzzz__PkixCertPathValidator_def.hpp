...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Pkix::PkixCertPathValidator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Pkix::PkixCertPathValidator*, "Org.BouncyCastle.Pkix", "PkixCertPathValidator");
...
public:
  // Declarations
  /// @brief Method CheckCertificate, addr 0x35c6748, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method Validate, addr 0x35c41ec, size 0x1e04, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35c3c2c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Pkix::PkixCertPathValidator) == 0x10, "Size mismatch!");
