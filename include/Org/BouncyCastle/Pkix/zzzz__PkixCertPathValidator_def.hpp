...
public:
  // Declarations
  /// @brief Method CheckCertificate, addr 0x350bcc8, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method Validate, addr 0x350976c, size 0x1e04, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35091ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
