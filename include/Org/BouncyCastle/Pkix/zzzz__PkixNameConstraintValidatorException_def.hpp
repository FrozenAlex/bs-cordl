...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Pkix::PkixNameConstraintValidatorException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Pkix::PkixNameConstraintValidatorException*, "Org.BouncyCastle.Pkix", "PkixNameConstraintValidatorException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x35da604, size 0x6c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Pkix::PkixNameConstraintValidatorException) == 0x90, "Size mismatch!");
