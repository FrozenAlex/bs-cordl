...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Pkix::Rfc3281CertPathUtilities*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Pkix::Rfc3281CertPathUtilities*, "Org.BouncyCastle.Pkix", "Rfc3281CertPathUtilities");
...
public:
  // Declarations
  /// @brief Method AdditionalChecks, addr 0x352ec94, size 0x75c, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckCrl, addr 0x352e464, size 0x830, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckCrls, addr 0x352d7e0, size 0xc84, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessAttrCert1, addr 0x352fc5c, size 0xc2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessAttrCert2, addr 0x352fb24, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessAttrCert3, addr 0x352fa1c, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessAttrCert4, addr 0x352f5c8, size 0x454, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessAttrCert5, addr 0x352f3f0, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessAttrCert7, addr 0x352d10c, size 0x6d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3530888, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Pkix::Rfc3281CertPathUtilities) == 0x10, "Size mismatch!");
