...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Security::Certificates::CertificateEncodingException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Security::Certificates::CertificateEncodingException*, "Org.BouncyCastle.Security.Certificates", "CertificateEncodingException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3530e44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3530e4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW msg);

  /// @brief Method .ctor, addr 0x3530e54, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Security::Certificates::CertificateEncodingException) == 0x90, "Size mismatch!");
