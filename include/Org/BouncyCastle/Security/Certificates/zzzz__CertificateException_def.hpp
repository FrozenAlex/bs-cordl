...
public:
  ...
  /// @brief Method .ctor, addr 0x35eb8ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35eb8b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35eb8bc, size 0x8, virtual false, abstract: false, final false
