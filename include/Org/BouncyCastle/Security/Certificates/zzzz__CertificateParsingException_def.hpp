...
public:
  ...
  /// @brief Method .ctor, addr 0x35eb90c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35eb914, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35eb91c, size 0x8, virtual false, abstract: false, final false
