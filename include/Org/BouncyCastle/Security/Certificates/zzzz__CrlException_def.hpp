...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Security::Certificates::CrlException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Security::Certificates::CrlException*, "Org.BouncyCastle.Security.Certificates", "CrlException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3530ea4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3530eac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW msg);

  /// @brief Method .ctor, addr 0x3530eb4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Security::Certificates::CrlException) == 0x90, "Size mismatch!");
