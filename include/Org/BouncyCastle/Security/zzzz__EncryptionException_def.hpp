...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Security::EncryptionException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Security::EncryptionException*, "Org.BouncyCastle.Security", "EncryptionException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x35a1864, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35a1888, size 0x24, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Security::EncryptionException) == 0x90, "Size mismatch!");
