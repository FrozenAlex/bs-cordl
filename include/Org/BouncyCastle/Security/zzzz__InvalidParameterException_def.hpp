...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Security::InvalidParameterException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Security::InvalidParameterException*, "Org.BouncyCastle.Security", "InvalidParameterException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x35415e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35415e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35415f0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Security::InvalidParameterException) == 0x90, "Size mismatch!");
