...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Security::NoSuchAlgorithmException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Security::NoSuchAlgorithmException*, "Org.BouncyCastle.Security", "NoSuchAlgorithmException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x354434c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3544354, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x354435c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Security::NoSuchAlgorithmException) == 0x90, "Size mismatch!");
