...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Security::ParameterUtilities*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Security::ParameterUtilities*, "Org.BouncyCastle.Security", "ParameterUtilities");
...
public:
  ...
  /// @brief Method AddAlgorithm, addr 0x3600530, size 0x1cc, virtual false, abstract: false, final false
  static inline void AddAlgorithm(::StringW canonicalName, ::ArrayW<::System::Object*> aliases);

  /// @brief Method AddBasicIVSizeEntries, addr 0x36006fc, size 0x15c, virtual false, abstract: false, final false
  static inline void AddBasicIVSizeEntries(int32_t size, ::ArrayW<::StringW> algorithms);

  /// @brief Method CreateIV, addr 0x3601840, size 0x6c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> CreateIV(::Org::BouncyCastle::Security::SecureRandom* random, int32_t ivLength);

  /// @brief Method CreateIVOctetString, addr 0x360179c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyParameter, addr 0x360098c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyParameter, addr 0x3600d5c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyParameter, addr 0x3600ce4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyParameter, addr 0x3600a0c, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method FindBasicIVSize, addr 0x3601298, size 0x198, virtual false, abstract: false, final false
  static inline int32_t FindBasicIVSize(::StringW canonicalName);

  /// @brief Method GenerateParameters, addr 0x3601430, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateParameters, addr 0x36014a4, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCanonicalAlgorithmName, addr 0x3600858, size 0x134, virtual false, abstract: false, final false
  static inline ::StringW GetCanonicalAlgorithmName(::StringW algorithm);

  /// @brief Method GetCipherParameters, addr 0x3600de8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCipherParameters, addr 0x3600e64, size 0x434, virtual false, abstract: false, final false
  ...
  /// @brief Method WithRandom, addr 0x36018ac, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35fede4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Security::ParameterUtilities) == 0x10, "Size mismatch!");
