...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Security::PasswordException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Security::PasswordException*, "Org.BouncyCastle.Security", "PasswordException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x34e8628, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34e864c, size 0x24, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Security::PasswordException) == 0x90, "Size mismatch!");
