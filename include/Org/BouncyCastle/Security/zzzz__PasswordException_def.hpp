...
public:
  ...
  /// @brief Method .ctor, addr 0x35a30a8, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35a30cc, size 0x24, virtual false, abstract: false, final false
