...
public:
  ...
  /// @brief Method CreatePrng, addr 0x341af00, size 0x1c0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Prng::DigestRandomGenerator* CreatePrng(::StringW digestName, bool autoSeed);

  /// @brief Method GenerateSeed, addr 0x341b45c, size 0xa4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateSeed(int32_t length);

  /// @brief Method GetInstance, addr 0x341b0c0, size 0x5c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Security::SecureRandom* GetInstance(::StringW algorithm);

  /// @brief Method GetInstance, addr 0x341b11c, size 0x188, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Security::SecureRandom* GetInstance(::StringW algorithm, bool autoSeed);

  /// @brief Method GetNextBytes, addr 0x3419c00, size 0x80, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> GetNextBytes(::Org::BouncyCastle::Security::SecureRandom* secureRandom, int32_t length);

  /// @brief Method GetSeed, addr 0x341b318, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method Next, addr 0x341b66c, size 0x20, virtual true, abstract: false, final false
  inline int32_t Next();

  /// @brief Method Next, addr 0x341b68c, size 0xe4, virtual true, abstract: false, final false
  inline int32_t Next(int32_t maxValue);

  /// @brief Method Next, addr 0x341b770, size 0xc0, virtual true, abstract: false, final false
  inline int32_t Next(int32_t minValue, int32_t maxValue);

  /// @brief Method NextBytes, addr 0x341b830, size 0xb8, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t> buf);

  /// @brief Method NextBytes, addr 0x341b8e8, size 0xd0, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method NextCounterValue, addr 0x341ae3c, size 0x68, virtual false, abstract: false, final false
  static inline int64_t NextCounterValue();

  /// @brief Method NextDouble, addr 0x341b9b8, size 0xb0, virtual true, abstract: false, final false
  inline double_t NextDouble();

  /// @brief Method NextInt, addr 0x341ba68, size 0x70, virtual true, abstract: false, final false
  inline int32_t NextInt();

  /// @brief Method NextLong, addr 0x341bad8, size 0x88, virtual true, abstract: false, final false
  inline int64_t NextLong();

  /// @brief Method SetSeed, addr 0x341b500, size 0xb4, virtual true, abstract: false, final false
  inline void SetSeed(::ArrayW<uint8_t> seed);

  /// @brief Method SetSeed, addr 0x341b5b4, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34114b8, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x341b2a4, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Prng::IRandomGenerator* generator);

  /// @brief Method .ctor, addr 0x341b3bc, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Master, addr 0x341aea4, size 0x5c, virtual false, abstract: false, final false
