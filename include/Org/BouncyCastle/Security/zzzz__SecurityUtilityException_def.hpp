...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Security::SecurityUtilityException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Security::SecurityUtilityException*, "Org.BouncyCastle.Security", "SecurityUtilityException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3552604, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3552598, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x355265c, size 0x74, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Security::SecurityUtilityException) == 0x90, "Size mismatch!");
