...
public:
  ...
  /// @brief Method .ctor, addr 0x360d150, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x360d158, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x360d160, size 0x8, virtual false, abstract: false, final false
