...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Security::SignerUtilities*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Security::SignerUtilities*, "Org.BouncyCastle.Security", "SignerUtilities");
...
public:
  ...
  /// @brief Method GetDefaultX509Parameters, addr 0x355df00, size 0x2a8, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Encodable* GetDefaultX509Parameters(::StringW algorithm);

  /// @brief Method GetDefaultX509Parameters, addr 0x355de9c, size 0x64, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Encodable* GetDefaultX509Parameters(::Org::BouncyCastle::Asn1::DerObjectIdentifier* id);

  /// @brief Method GetEncodingName, addr 0x355f518, size 0x100, virtual false, abstract: false, final false
  static inline ::StringW GetEncodingName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetObjectIdentifier, addr 0x355db78, size 0x250, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetObjectIdentifier(::StringW mechanism);

  /// @brief Method GetPssX509Parameters, addr 0x355e1a8, size 0x21c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Encodable* GetPssX509Parameters(::StringW digestName);

  /// @brief Method GetSigner, addr 0x355e428, size 0x10f0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::ISigner* GetSigner(::StringW algorithm);

  /// @brief Method GetSigner, addr 0x355e3c4, size 0x64, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::ISigner* GetSigner(::Org::BouncyCastle::Asn1::DerObjectIdentifier* id);

  /// @brief Method InitSigner, addr 0x355f6a4, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method InitSigner, addr 0x355f618, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35526e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Algorithms, addr 0x355ddc8, size 0xd4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Security::SignerUtilities) == 0x10, "Size mismatch!");
