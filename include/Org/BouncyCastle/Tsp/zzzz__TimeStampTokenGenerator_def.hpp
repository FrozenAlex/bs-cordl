...
public:
  ...
  /// @brief Method Generate, addr 0x361ddc8, size 0x6a0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAccuracyMicros, addr 0x36200dc, size 0x8, virtual false, abstract: false, final false
  inline void SetAccuracyMicros(int32_t accuracyMicros);

  /// @brief Method SetAccuracyMillis, addr 0x36200d4, size 0x8, virtual false, abstract: false, final false
  inline void SetAccuracyMillis(int32_t accuracyMillis);

  /// @brief Method SetAccuracySeconds, addr 0x36200cc, size 0x8, virtual false, abstract: false, final false
  inline void SetAccuracySeconds(int32_t accuracySeconds);

  /// @brief Method SetCertificates, addr 0x36200bc, size 0x8, virtual false, abstract: false, final false
  inline void SetCertificates(::Org::BouncyCastle::X509::Store::IX509Store* certificates);

  /// @brief Method SetCrls, addr 0x36200c4, size 0x8, virtual false, abstract: false, final false
  inline void SetCrls(::Org::BouncyCastle::X509::Store::IX509Store* crls);

  /// @brief Method SetOrdering, addr 0x36200e4, size 0x8, virtual false, abstract: false, final false
  inline void SetOrdering(bool ordering);

  /// @brief Method SetTsa, addr 0x36200ec, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x361fc84, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x361fc90, size 0x42c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* key, ::Org::BouncyCastle::X509::X509Certificate* cert, ::StringW digestOID, ::StringW tsaPolicyOID,
