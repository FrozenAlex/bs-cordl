...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Tsp::TspAlgorithms*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Tsp::TspAlgorithms*, "Org.BouncyCastle.Tsp", "TspAlgorithms");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3565d24, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Tsp::TspAlgorithms) == 0x10, "Size mismatch!");
