...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Collections::LinkedDictionaryEnumerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Collections::LinkedDictionaryEnumerator*, "Org.BouncyCastle.Utilities.Collections", "LinkedDictionaryEnumerator");
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::Collections::LinkedDictionaryEnumerator) == 0x20, "Size mismatch!");
