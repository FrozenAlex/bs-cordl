...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Collections::UnmodifiableDictionaryProxy*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Collections::UnmodifiableDictionaryProxy*, "Org.BouncyCastle.Utilities.Collections", "UnmodifiableDictionaryProxy");
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::Collections::UnmodifiableDictionaryProxy) == 0x18, "Size mismatch!");
