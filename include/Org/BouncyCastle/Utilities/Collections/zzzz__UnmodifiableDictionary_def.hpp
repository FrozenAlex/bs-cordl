...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Collections::UnmodifiableDictionary*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Collections::UnmodifiableDictionary*, "Org.BouncyCastle.Utilities.Collections", "UnmodifiableDictionary");
...
public:
  ...
  /// @brief Method Add, addr 0x356b75c, size 0x38, virtual true, abstract: false, final false
  inline void Add(::System::Object* k, ::System::Object* v);

  /// @brief Method Clear, addr 0x356b794, size 0x38, virtual true, abstract: false, final false
  inline void Clear();
  ...
  /// @brief Method Remove, addr 0x356b7dc, size 0x38, virtual true, abstract: false, final false
  inline void Remove(::System::Object* k);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x356b7cc, size 0x10, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method .ctor, addr 0x356b758, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_IsReadOnly, addr 0x356b814, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x356b81c, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Item, addr 0x356b82c, size 0x38, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::Collections::UnmodifiableDictionary) == 0x10, "Size mismatch!");
