...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Collections::UnmodifiableList*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Collections::UnmodifiableList*, "Org.BouncyCastle.Utilities.Collections", "UnmodifiableList");
...
public:
  ...
  /// @brief Method Add, addr 0x356bf28, size 0x38, virtual true, abstract: false, final false
  inline int32_t Add(::System::Object* o);

  /// @brief Method Clear, addr 0x356bf60, size 0x38, virtual true, abstract: false, final false
  inline void Clear();
  ...
  /// @brief Method Insert, addr 0x356bf98, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x356bfd8, size 0x38, virtual true, abstract: false, final false
  inline void Remove(::System::Object* o);

  /// @brief Method RemoveAt, addr 0x356c010, size 0x38, virtual true, abstract: false, final false
  inline void RemoveAt(int32_t i);

  /// @brief Method .ctor, addr 0x356bf24, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_IsReadOnly, addr 0x356bfd0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x356c048, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Item, addr 0x356c058, size 0x38, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::Collections::UnmodifiableList) == 0x10, "Size mismatch!");
