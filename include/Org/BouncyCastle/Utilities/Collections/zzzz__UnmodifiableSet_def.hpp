...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Collections::UnmodifiableSet*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Collections::UnmodifiableSet*, "Org.BouncyCastle.Utilities.Collections", "UnmodifiableSet");
...
public:
  ...
  /// @brief Method Add, addr 0x356c6b8, size 0x38, virtual true, abstract: false, final false
  inline void Add(::System::Object* o);

  /// @brief Method AddAll, addr 0x356c6f0, size 0x38, virtual true, abstract: false, final false
  inline void AddAll(::System::Collections::IEnumerable* e);

  /// @brief Method Clear, addr 0x356c728, size 0x38, virtual true, abstract: false, final false
  inline void Clear();
  ...
  /// @brief Method Remove, addr 0x356c768, size 0x38, virtual true, abstract: false, final false
  inline void Remove(::System::Object* o);

  /// @brief Method RemoveAll, addr 0x356c7a0, size 0x38, virtual true, abstract: false, final false
  inline void RemoveAll(::System::Collections::IEnumerable* e);

  /// @brief Method .ctor, addr 0x356c6b4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_IsReadOnly, addr 0x356c760, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::Collections::UnmodifiableSet) == 0x10, "Size mismatch!");
