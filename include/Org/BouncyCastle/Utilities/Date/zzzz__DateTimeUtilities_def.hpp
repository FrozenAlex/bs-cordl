...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Date::DateTimeUtilities*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Date::DateTimeUtilities*, "Org.BouncyCastle.Utilities.Date", "DateTimeUtilities");
...
public:
  ...
  /// @brief Method CurrentUnixMs, addr 0x3627a80, size 0x8c, virtual false, abstract: false, final false
  static inline int64_t CurrentUnixMs();

  /// @brief Method DateTimeToUnixMs, addr 0x3627834, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method UnixMsToDateTime, addr 0x36279c0, size 0xc0, virtual false, abstract: false, final false
  static inline ::System::DateTime UnixMsToDateTime(int64_t unixMs);

  /// @brief Method .ctor, addr 0x3627830, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::Date::DateTimeUtilities) == 0x10, "Size mismatch!");
