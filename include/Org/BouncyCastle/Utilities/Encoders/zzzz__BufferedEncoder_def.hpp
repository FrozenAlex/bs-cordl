...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Encoders::BufferedEncoder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Encoders::BufferedEncoder*, "Org.BouncyCastle.Utilities.Encoders", "BufferedEncoder");
...
public:
  ...
  /// @brief Method ProcessByte, addr 0x356eba8, size 0x12c, virtual false, abstract: false, final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t> outBytes, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x356ecd4, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x356ea74, size 0x134, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::Encoders::BufferedEncoder) == 0x28, "Size mismatch!");
