...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Encoders::HexTranslator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Encoders::HexTranslator*, "Org.BouncyCastle.Utilities.Encoders", "HexTranslator");
...
public:
  ...
  __declspec(property(get = getStaticF_hexTable, put = setStaticF_hexTable)) ::ArrayW<uint8_t> hexTable;
  ...
  static inline void setStaticF_hexTable(::ArrayW<uint8_t> value);
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::Encoders::HexTranslator) == 0x10, "Size mismatch!");
