...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Encoders::IEncoder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Encoders::IEncoder*, "Org.BouncyCastle.Utilities.Encoders", "IEncoder");
// Dependencies
namespace Org::BouncyCastle::Utilities::Encoders {
// Is value type: false
