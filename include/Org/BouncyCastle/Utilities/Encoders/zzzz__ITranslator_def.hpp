...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Encoders::ITranslator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Encoders::ITranslator*, "Org.BouncyCastle.Utilities.Encoders", "ITranslator");
// Dependencies
namespace Org::BouncyCastle::Utilities::Encoders {
// Is value type: false
