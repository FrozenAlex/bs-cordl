...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Encoders::UrlBase64Encoder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Encoders::UrlBase64Encoder*, "Org.BouncyCastle.Utilities.Encoders", "UrlBase64Encoder");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3570edc, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::Encoders::UrlBase64Encoder) == 0x28, "Size mismatch!");
