...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::IO::Pem::PemHeader*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::IO::Pem::PemHeader*, "Org.BouncyCastle.Utilities.IO.Pem", "PemHeader");
...
public:
  ...
  /// @brief Method Equals, addr 0x362bb80, size 0xfc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x362bb1c, size 0x50, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetHashCode, addr 0x362bb6c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x362bb04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::StringW val);

  /// @brief Method get_Name, addr 0x362bb0c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Value, addr 0x362bb14, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::IO::Pem::PemHeader) == 0x20, "Size mismatch!");
