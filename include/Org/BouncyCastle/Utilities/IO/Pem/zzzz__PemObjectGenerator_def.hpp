...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::IO::Pem::PemObjectGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::IO::Pem::PemObjectGenerator*, "Org.BouncyCastle.Utilities.IO.Pem", "PemObjectGenerator");
// Dependencies
namespace Org::BouncyCastle::Utilities::IO::Pem {
// Is value type: false
