...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::IO::MemoryOutputStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::IO::MemoryOutputStream*, "Org.BouncyCastle.Utilities.IO", "MemoryOutputStream");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3571334, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CanRead, addr 0x357132c, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::IO::MemoryOutputStream) == 0x50, "Size mismatch!");
