...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::IO::NullOutputStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::IO::NullOutputStream*, "Org.BouncyCastle.Utilities.IO", "NullOutputStream");
...
public:
  ...
  /// @brief Method Write, addr 0x3571340, size 0x4, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count);

  /// @brief Method WriteByte, addr 0x357133c, size 0x4, virtual true, abstract: false, final false
  inline void WriteByte(uint8_t b);

  /// @brief Method .ctor, addr 0x3571344, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::IO::NullOutputStream) == 0x30, "Size mismatch!");
