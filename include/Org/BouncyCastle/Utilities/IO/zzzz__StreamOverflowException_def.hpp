...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::IO::StreamOverflowException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::IO::StreamOverflowException*, "Org.BouncyCastle.Utilities.IO", "StreamOverflowException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3571468, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3571470, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3571494, size 0x24, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::IO::StreamOverflowException) == 0x90, "Size mismatch!");
