...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::IO::TeeInputStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::IO::TeeInputStream*, "Org.BouncyCastle.Utilities.IO", "TeeInputStream");
...
public:
  ...
  /// @brief Method Close, addr 0x3571ad4, size 0x9c, virtual true, abstract: false, final false
  inline void Close();

  static inline ::Org::BouncyCastle::Utilities::IO::TeeInputStream* New_ctor(::System::IO::Stream* input, ::System::IO::Stream* tee);

  /// @brief Method Read, addr 0x3571b70, size 0x78, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method ReadByte, addr 0x3571be8, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3571aa8, size 0x2c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::IO::TeeInputStream) == 0x40, "Size mismatch!");
