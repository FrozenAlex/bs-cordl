...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Zlib::InfCodes*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Zlib::InfCodes*, "Org.BouncyCastle.Utilities.Zlib", "InfCodes");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3575d34, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method free, addr 0x3575ddc, size 0x4, virtual false, abstract: false, final false
  inline void free(::Org::BouncyCastle::Utilities::Zlib::ZStream* z);

  static inline ::ArrayW<int32_t> getStaticF_inflate_mask();

  /// @brief Method inflate_fast, addr 0x35780b8, size 0x8fc, virtual false, abstract: false, final false
  ...
  /// @brief Method init, addr 0x3577144, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method proc, addr 0x3577510, size 0xa64, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::Zlib::InfCodes) == 0x58, "Size mismatch!");
