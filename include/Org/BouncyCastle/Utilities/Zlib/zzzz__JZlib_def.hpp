...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Zlib::JZlib*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Zlib::JZlib*, "Org.BouncyCastle.Utilities.Zlib", "JZlib");
...
public:
  ...
  /// @brief Method .ctor, addr 0x357a140, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method version, addr 0x357a0fc, size 0x44, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::Zlib::JZlib) == 0x10, "Size mismatch!");
