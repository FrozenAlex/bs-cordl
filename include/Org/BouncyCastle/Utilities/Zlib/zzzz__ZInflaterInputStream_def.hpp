...
public:
  ...
  /// @brief Method Close, addr 0x357b924, size 0x7c, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Flush, addr 0x357b900, size 0x20, virtual true, abstract: false, final false
  inline void Flush();
  ...
  /// @brief Method Read, addr 0x357b77c, size 0x168, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t> b, int32_t off, int32_t len);

  /// @brief Method ReadByte, addr 0x357b9bc, size 0x58, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method Seek, addr 0x357b770, size 0x8, virtual true, abstract: false, final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength, addr 0x357b778, size 0x4, virtual true, abstract: false, final false
  inline void SetLength(int64_t value);

  /// @brief Method Write, addr 0x357b76c, size 0x4, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t> b, int32_t off, int32_t len);

  /// @brief Method WriteByte, addr 0x357b920, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x357b628, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* inp);

  /// @brief Method .ctor, addr 0x357b630, size 0x104, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* inp, bool nowrap);

  /// @brief Method get_CanRead, addr 0x357b740, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x357b748, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanWrite, addr 0x357b750, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_Length, addr 0x357b758, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_Position, addr 0x357b760, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_Position();

  /// @brief Method set_Position, addr 0x357b768, size 0x4, virtual true, abstract: false, final false
