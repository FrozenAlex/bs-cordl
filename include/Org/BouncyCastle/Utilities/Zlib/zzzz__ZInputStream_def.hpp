...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Zlib::ZInputStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Zlib::ZInputStream*, "Org.BouncyCastle.Utilities.Zlib", "ZInputStream");
...
public:
  ...
  /// @brief Method Close, addr 0x357bd6c, size 0x98, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Flush, addr 0x357be04, size 0x4, virtual true, abstract: false, final true
  inline void Flush();

  /// @brief Method GetDefaultZStream, addr 0x357ba14, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x357bec0, size 0x1d0, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t> b, int32_t off, int32_t len);

  /// @brief Method ReadByte, addr 0x357c090, size 0x58, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method Seek, addr 0x357c0e8, size 0x38, virtual true, abstract: false, final true
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength, addr 0x357c120, size 0x38, virtual true, abstract: false, final true
  inline void SetLength(int64_t value);

  /// @brief Method Write, addr 0x357c188, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x357ba84, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input);

  /// @brief Method .ctor, addr 0x357bc28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input, int32_t level);

  /// @brief Method .ctor, addr 0x357bc30, size 0x11c, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input, int32_t level, bool nowrap);

  /// @brief Method .ctor, addr 0x357bab4, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input, bool nowrap);

  /// @brief Method .ctor, addr 0x357bae4, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input, ::Org::BouncyCastle::Utilities::Zlib::ZStream* z);

  /// @brief Method get_CanRead, addr 0x357bd4c, size 0x10, virtual true, abstract: false, final true
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x357bd5c, size 0x8, virtual true, abstract: false, final true
  inline bool get_CanSeek();

  /// @brief Method get_CanWrite, addr 0x357bd64, size 0x8, virtual true, abstract: false, final true
  inline bool get_CanWrite();

  /// @brief Method get_FlushMode, addr 0x357be08, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_FlushMode();

  /// @brief Method get_Length, addr 0x357be18, size 0x38, virtual true, abstract: false, final true
  inline int64_t get_Length();

  /// @brief Method get_Position, addr 0x357be50, size 0x38, virtual true, abstract: false, final true
  inline int64_t get_Position();

  /// @brief Method get_TotalIn, addr 0x357c158, size 0x18, virtual true, abstract: false, final false
  inline int64_t get_TotalIn();

  /// @brief Method get_TotalOut, addr 0x357c170, size 0x18, virtual true, abstract: false, final false
  inline int64_t get_TotalOut();

  /// @brief Method set_FlushMode, addr 0x357be10, size 0x8, virtual true, abstract: false, final false
  inline void set_FlushMode(int32_t value);

  /// @brief Method set_Position, addr 0x357be88, size 0x38, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::Zlib::ZInputStream) == 0x60, "Size mismatch!");
