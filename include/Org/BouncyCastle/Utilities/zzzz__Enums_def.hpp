...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Enums*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Enums*, "Org.BouncyCastle.Utilities", "Enums");
...
public:
  // Declarations
  /// @brief Method GetArbitraryValue, addr 0x3639e6c, size 0xd4, virtual false, abstract: false, final false
  static inline ::System::Enum* GetArbitraryValue(::System::Type* enumType);

  /// @brief Method GetEnumValue, addr 0x3639bec, size 0x19c, virtual false, abstract: false, final false
  static inline ::System::Enum* GetEnumValue(::System::Type* enumType, ::StringW s);

  /// @brief Method GetEnumValues, addr 0x3639da4, size 0xc8, virtual false, abstract: false, final false
  static inline ::System::Array* GetEnumValues(::System::Type* enumType);

  /// @brief Method IsEnumType, addr 0x3639d88, size 0x1c, virtual false, abstract: false, final false
  static inline bool IsEnumType(::System::Type* t);

  static inline ::Org::BouncyCastle::Utilities::Enums* New_ctor();

  /// @brief Method .ctor, addr 0x3639f40, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::Enums) == 0x10, "Size mismatch!");
