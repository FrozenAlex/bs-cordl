...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::X509::Store::IX509Selector*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::X509::Store::IX509Selector*, "Org.BouncyCastle.X509.Store", "IX509Selector");
// Dependencies
namespace Org::BouncyCastle::X509::Store {
// Is value type: false
