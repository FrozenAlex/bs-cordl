...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::X509::Store::IX509StoreParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::X509::Store::IX509StoreParameters*, "Org.BouncyCastle.X509.Store", "IX509StoreParameters");
// Dependencies
namespace Org::BouncyCastle::X509::Store {
// Is value type: false
