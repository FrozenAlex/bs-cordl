...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::X509::Store::NoSuchStoreException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::X509::Store::NoSuchStoreException*, "Org.BouncyCastle.X509.Store", "NoSuchStoreException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3581bf0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3581bf4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3581bf8, size 0x4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::X509::Store::NoSuchStoreException) == 0x90, "Size mismatch!");
