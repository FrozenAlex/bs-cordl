...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::X509::Store::X509CollectionStoreParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::X509::Store::X509CollectionStoreParameters*, "Org.BouncyCastle.X509.Store", "X509CollectionStoreParameters");
...
public:
  ...
  /// @brief Method GetCollection, addr 0x363dfe0, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x363e03c, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x363df28, size 0xb8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::X509::Store::X509CollectionStoreParameters) == 0x18, "Size mismatch!");
