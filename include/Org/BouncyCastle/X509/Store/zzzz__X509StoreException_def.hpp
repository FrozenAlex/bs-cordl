...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::X509::Store::X509StoreException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::X509::Store::X509StoreException*, "Org.BouncyCastle.X509.Store", "X509StoreException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3581ab8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3581b10, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3581b7c, size 0x74, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::X509::Store::X509StoreException) == 0x90, "Size mismatch!");
