...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::X509::IX509AttributeCertificate*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::X509::IX509AttributeCertificate*, "Org.BouncyCastle.X509", "IX509AttributeCertificate");
// Dependencies
namespace Org::BouncyCastle::X509 {
// Is value type: false
