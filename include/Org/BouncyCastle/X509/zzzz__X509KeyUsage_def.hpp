...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x364b2f0, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x364b2e8, size 0x8, virtual false, abstract: false, final false
