...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::X509::X509V1CertificateGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::X509::X509V1CertificateGenerator*, "Org.BouncyCastle.X509", "X509V1CertificateGenerator");
...
public:
  ...
  /// @brief Method Generate, addr 0x3594264, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::X509Certificate* Generate(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey);

  /// @brief Method Generate, addr 0x359426c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x35942ec, size 0x488, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateJcaObject, addr 0x3594774, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x3593d78, size 0x5c, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SetIssuerDN, addr 0x3593ec0, size 0x18, virtual false, abstract: false, final false
  inline void SetIssuerDN(::Org::BouncyCastle::Asn1::X509::X509Name* issuer);

  /// @brief Method SetNotAfter, addr 0x3593f50, size 0x78, virtual false, abstract: false, final false
  inline void SetNotAfter(::System::DateTime date);

  /// @brief Method SetNotBefore, addr 0x3593ed8, size 0x78, virtual false, abstract: false, final false
  inline void SetNotBefore(::System::DateTime date);

  /// @brief Method SetPublicKey, addr 0x3593fe0, size 0x110, virtual false, abstract: false, final false
  inline void SetPublicKey(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method SetSerialNumber, addr 0x3593dd4, size 0xec, virtual false, abstract: false, final false
  inline void SetSerialNumber(::Org::BouncyCastle::Math::BigInteger* serialNumber);

  /// @brief Method SetSignatureAlgorithm, addr 0x35940f0, size 0x174, virtual false, abstract: false, final false
  inline void SetSignatureAlgorithm(::StringW signatureAlgorithm);

  /// @brief Method SetSubjectDN, addr 0x3593fc8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3593d1c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SignatureAlgNames, addr 0x3594848, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::X509::X509V1CertificateGenerator) == 0x30, "Size mismatch!");
