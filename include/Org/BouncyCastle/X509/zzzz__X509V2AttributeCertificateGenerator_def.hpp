...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::X509::X509V2AttributeCertificateGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::X509::X509V2AttributeCertificateGenerator*, "Org.BouncyCastle.X509", "X509V2AttributeCertificateGenerator");
...
public:
  ...
  /// @brief Method AddAttribute, addr 0x3596218, size 0x48, virtual false, abstract: false, final false
  inline void AddAttribute(::Org::BouncyCastle::X509::X509Attribute* attribute);

  /// @brief Method AddExtension, addr 0x359633c, size 0x98, virtual false, abstract: false, final false
  inline void AddExtension(::StringW oid, bool critical, ::ArrayW<uint8_t> extensionValue);

  /// @brief Method AddExtension, addr 0x35962a4, size 0x98, virtual false, abstract: false, final false
  inline void AddExtension(::StringW oid, bool critical, ::Org::BouncyCastle::Asn1::Asn1Encodable* extensionValue);

  /// @brief Method Generate, addr 0x35963d4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x35963dc, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x359645c, size 0x570, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x3595e94, size 0x6c, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SetHolder, addr 0x3595f00, size 0x24, virtual false, abstract: false, final false
  inline void SetHolder(::Org::BouncyCastle::X509::AttributeCertificateHolder* holder);

  /// @brief Method SetIssuer, addr 0x3595f24, size 0x2c, virtual false, abstract: false, final false
  inline void SetIssuer(::Org::BouncyCastle::X509::AttributeCertificateIssuer* issuer);

  /// @brief Method SetIssuerUniqueId, addr 0x3596260, size 0x44, virtual false, abstract: false, final false
  inline void SetIssuerUniqueId(::ArrayW<bool> iui);

  /// @brief Method SetNotAfter, addr 0x3596040, size 0x78, virtual false, abstract: false, final false
  inline void SetNotAfter(::System::DateTime date);

  /// @brief Method SetNotBefore, addr 0x3595fc8, size 0x78, virtual false, abstract: false, final false
  inline void SetNotBefore(::System::DateTime date);

  /// @brief Method SetSerialNumber, addr 0x3595f50, size 0x78, virtual false, abstract: false, final false
  inline void SetSerialNumber(::Org::BouncyCastle::Math::BigInteger* serialNumber);

  /// @brief Method SetSignatureAlgorithm, addr 0x35960b8, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3595e08, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SignatureAlgNames, addr 0x35969cc, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::X509::X509V2AttributeCertificateGenerator) == 0x38, "Size mismatch!");
