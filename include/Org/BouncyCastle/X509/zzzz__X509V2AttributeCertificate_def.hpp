...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::X509::X509V2AttributeCertificate*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::X509::X509V2AttributeCertificate*, "Org.BouncyCastle.X509", "X509V2AttributeCertificate");
...
public:
  ...
  /// @brief Method CheckSignature, addr 0x364fd0c, size 0x4d0, virtual true, abstract: false, final false
  inline void CheckSignature(::Org::BouncyCastle::Crypto::IVerifierFactory* verifier);

  /// @brief Method CheckValidity, addr 0x364f91c, size 0x70, virtual true, abstract: false, final false
  inline void CheckValidity();

  /// @brief Method CheckValidity, addr 0x364f98c, size 0x1ec, virtual true, abstract: false, final false
  inline void CheckValidity(::System::DateTime date);

  /// @brief Method Equals, addr 0x36507b8, size 0xb8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetAttributes, addr 0x3650218, size 0x164, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::X509::X509Attribute*> GetAttributes();

  /// @brief Method GetAttributes, addr 0x365037c, size 0x43c, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::X509::X509Attribute*> GetAttributes(::StringW oid);

  /// @brief Method GetEncoded, addr 0x36501dc, size 0x18, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GetEncoded();

  /// @brief Method GetHashCode, addr 0x3650870, size 0x18, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetIssuerUniqueID, addr 0x364f6a4, size 0x104, virtual true, abstract: false, final false
  inline ::ArrayW<bool> GetIssuerUniqueID();

  /// @brief Method GetObject, addr 0x364f318, size 0x128, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::AttributeCertificate* GetObject(::System::IO::Stream* input);

  /// @brief Method GetSignature, addr 0x364fb90, size 0x28, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GetSignature();

  /// @brief Method GetX509Extensions, addr 0x36501f4, size 0x24, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* GetX509Extensions();

  /// @brief Method IsValid, addr 0x364f818, size 0x104, virtual true, abstract: false, final false
  ...
  static inline ::Org::BouncyCastle::X509::X509V2AttributeCertificate* New_ctor(::ArrayW<uint8_t> encoded);

  /// @brief Method Verify, addr 0x364fbb8, size 0x80, virtual true, abstract: false, final false
  inline void Verify(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* key);

  /// @brief Method Verify, addr 0x364fc38, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3642924, size 0x168, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AttributeCertificate* cert);

  /// @brief Method .ctor, addr 0x364f440, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* encIn);

  /// @brief Method .ctor, addr 0x364f460, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> encoded);

  /// @brief Method get_Holder, addr 0x364f53c, size 0xe8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::X509::AttributeCertificateHolder* get_Holder();

  /// @brief Method get_IsValidNow, addr 0x364f7a8, size 0x70, virtual true, abstract: false, final false
  inline bool get_IsValidNow();

  /// @brief Method get_Issuer, addr 0x364f624, size 0x70, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::X509::AttributeCertificateIssuer* get_Issuer();

  /// @brief Method get_NotAfter, addr 0x364f69c, size 0x8, virtual true, abstract: false, final false
  inline ::System::DateTime get_NotAfter();

  /// @brief Method get_NotBefore, addr 0x364f694, size 0x8, virtual true, abstract: false, final false
  inline ::System::DateTime get_NotBefore();

  /// @brief Method get_SerialNumber, addr 0x364f510, size 0x2c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_SerialNumber();

  /// @brief Method get_SignatureAlgorithm, addr 0x364fb78, size 0x18, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_SignatureAlgorithm();

  /// @brief Method get_Version, addr 0x364f4dc, size 0x34, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::X509::X509V2AttributeCertificate) == 0x28, "Size mismatch!");
