...
// Write type traits
MARK_REF_T(::Priority_Queue::FastPriorityQueueNode*);
DEFINE_IL2CPP_CLASS(::Priority_Queue::FastPriorityQueueNode*, "Priority_Queue", "FastPriorityQueueNode");
...
static_assert(sizeof(::Priority_Queue::FastPriorityQueueNode) == 0x18, "Size mismatch!");
