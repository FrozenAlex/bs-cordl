...
// Write type traits
MARK_REF_T(::Priority_Queue::StablePriorityQueueNode*);
DEFINE_IL2CPP_CLASS(::Priority_Queue::StablePriorityQueueNode*, "Priority_Queue", "StablePriorityQueueNode");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3254d60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_InsertionIndex, addr 0x3254d50, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_InsertionIndex();

  /// @brief Method set_InsertionIndex, addr 0x3254d58, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Priority_Queue::StablePriorityQueueNode) == 0x20, "Size mismatch!");
