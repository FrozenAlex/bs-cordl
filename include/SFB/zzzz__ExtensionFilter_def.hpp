...
DEFINE_IL2CPP_CLASS(::SFB::ExtensionFilter, "SFB", "ExtensionFilter");
// Dependencies
namespace SFB {
// Is value type: true
...
public:
  ...
  inline void _ctor(::StringW filterName, ::ArrayW<::StringW> filterExtensions);
...
static_assert(sizeof(::SFB::ExtensionFilter) == 0x10, "Size mismatch!");
