...
// Write type traits
MARK_GEN_REF_T_PTR(::StyledUITemplates::OverridableData_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::StyledUITemplates::OverridableData_1, "StyledUITemplates", "OverridableData`1");
...
public:
  ...
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23597 };
