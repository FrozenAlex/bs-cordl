...
// Write type traits
MARK_REF_T(::StyledUITemplates::OverridableFloat*);
DEFINE_IL2CPP_CLASS(::StyledUITemplates::OverridableFloat*, "StyledUITemplates", "OverridableFloat");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5e04f8c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::StyledUITemplates::OverridableFloat) == 0x18, "Size mismatch!");
