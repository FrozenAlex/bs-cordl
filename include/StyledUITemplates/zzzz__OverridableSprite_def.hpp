...
// Write type traits
MARK_REF_T(::StyledUITemplates::OverridableSprite*);
DEFINE_IL2CPP_CLASS(::StyledUITemplates::OverridableSprite*, "StyledUITemplates", "OverridableSprite");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5f3b220, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::StyledUITemplates::OverridableSprite) == 0x20, "Size mismatch!");
