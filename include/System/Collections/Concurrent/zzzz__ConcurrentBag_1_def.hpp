...
template <typename T> class ConcurrentBag_1_Enumerator;
}
namespace System::Collections::Concurrent {
...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Collections::Concurrent::ConcurrentBag_1);
MARK_GEN_REF_T_PTR(::System::Collections::Concurrent::ConcurrentBag_1_Enumerator);
MARK_GEN_REF_T_PTR(::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Concurrent::ConcurrentBag_1, "System.Collections.Concurrent", "ConcurrentBag`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Concurrent::ConcurrentBag_1_Enumerator, "System.Collections.Concurrent", "ConcurrentBag`1/Enumerator");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue, "System.Collections.Concurrent", "ConcurrentBag`1/WorkStealingQueue");
// Dependencies System.Object
namespace System::Collections::Concurrent {
// cpp template
template <typename T>
// Is value type: false
// CS Name: System.Collections.Concurrent.ConcurrentBag`1/WorkStealingQueue<T>
class CORDL_TYPE ConcurrentBag_1_WorkStealingQueue : public ::System::Object {
public:
  // Declarations
  ...
  __declspec(property(get = __cordl_internal_get__nextQueue, put = __cordl_internal_set__nextQueue)) ::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>* _nextQueue;
  ...
  inline int32_t DangerousCopyTo(::ArrayW<T> array, int32_t arrayIndex);
  ...
  inline void LocalPush(T item, ::by_ref<int64_t> emptyToNonEmptyListTransitionCount);

  static inline ::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>* New_ctor(::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>* nextQueue);

  /// @brief Method TryLocalPop, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline bool TryLocalPop(::by_ref<T> result);

  /// @brief Method TrySteal, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline bool TrySteal(::by_ref<T> result, bool take);
  ...
  constexpr ::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>* const& __cordl_internal_get__nextQueue() const;

  constexpr ::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>*& __cordl_internal_get__nextQueue();
  ...
  constexpr void __cordl_internal_set__nextQueue(::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>* value);
  ...
  inline void _ctor(::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>* nextQueue);
...
public:
  ...
  ::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>* ____nextQueue;
...
template <typename T>
// Is value type: false
// CS Name: System.Collections.Concurrent.ConcurrentBag`1/Enumerator<T>
class CORDL_TYPE ConcurrentBag_1_Enumerator : public ::System::Object {
public:
  // Declarations
  ...
  static inline ::System::Collections::Concurrent::ConcurrentBag_1_Enumerator<T>* New_ctor(::ArrayW<T> array);
...
public:
  // Declarations
  using Enumerator = ::System::Collections::Concurrent::ConcurrentBag_1_Enumerator<T>;

  using WorkStealingQueue = ::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>;
  ...
  __declspec(property(get = __cordl_internal_get__locals,
                      put = __cordl_internal_set__locals)) ::System::Threading::ThreadLocal_1<::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>*>* _locals;

  /// @brief Field _workStealingQueues, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get__workStealingQueues,
                      put = __cordl_internal_set__workStealingQueues)) ::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>* _workStealingQueues;
  ...
  inline int32_t CopyFromEachQueueToArray(::ArrayW<T> array, int32_t index);
  ...
  inline ::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>* CreateWorkStealingQueueForCurrentThread();

  /// @brief Method FreezeBag, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline void FreezeBag(::by_ref<bool> lockTaken);

  /// @brief Method GetCurrentThreadWorkStealingQueue, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline ::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>* GetCurrentThreadWorkStealingQueue(bool forceCreate);
  ...
  inline ::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>* GetUnownedWorkStealingQueue();
  ...
  inline bool TryStealFromTo(::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>* startInclusive,
  ...
  inline bool TryTake(::by_ref<T> result);
  ...
  constexpr ::System::Threading::ThreadLocal_1<::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>*>* const& __cordl_internal_get__locals() const;

  constexpr ::System::Threading::ThreadLocal_1<::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>*>*& __cordl_internal_get__locals();

  constexpr ::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>* const& __cordl_internal_get__workStealingQueues() const;

  constexpr ::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>*& __cordl_internal_get__workStealingQueues();

  constexpr void __cordl_internal_set__emptyToNonEmptyListTransitionCount(int64_t value);

  constexpr void __cordl_internal_set__locals(::System::Threading::ThreadLocal_1<::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>*>* value);

  constexpr void __cordl_internal_set__workStealingQueues(::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>* value);
...
public:
  ...
  ::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>* ____workStealingQueues;
