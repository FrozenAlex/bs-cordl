...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Collections::Concurrent::IProducerConsumerCollection_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Concurrent::IProducerConsumerCollection_1, "System.Collections.Concurrent", "IProducerConsumerCollection`1");
// Dependencies
namespace System::Collections::Concurrent {
// cpp template
template <typename T>
...
public:
  ...
  inline bool TryTake(::by_ref<T> item);
