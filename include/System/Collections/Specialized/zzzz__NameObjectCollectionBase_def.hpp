...
public:
  ...
  /// @brief Method .ctor, addr 0x62b1b3c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x62b201c, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x62b20ec, size 0x80, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x62b1bac, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Specialized::NameObjectCollectionBase* coll);

  /// @brief Method get_Current, addr 0x62b216c, size 0x98, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method BaseAdd, addr 0x62acff0, size 0x144, virtual false, abstract: false, final false
  inline void BaseAdd(::StringW name, ::System::Object* value);

  /// @brief Method BaseGet, addr 0x62ad6b0, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Object* BaseGet(int32_t index);

  /// @brief Method BaseGet, addr 0x62acfd8, size 0x18, virtual false, abstract: false, final false
  inline ::System::Object* BaseGet(::StringW name);

  /// @brief Method BaseGetKey, addr 0x62ad7ec, size 0xa8, virtual false, abstract: false, final false
  inline ::StringW BaseGetKey(int32_t index);

  /// @brief Method BaseRemove, addr 0x62ad3f8, size 0x208, virtual false, abstract: false, final false
  inline void BaseRemove(::StringW name);

  /// @brief Method BaseSet, addr 0x62ad350, size 0xa0, virtual false, abstract: false, final false
  inline void BaseSet(::StringW name, ::System::Object* value);

  /// @brief Method FindEntry, addr 0x62b1a80, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Collections::Specialized::NameObjectCollectionBase_NameObjectEntry* FindEntry(::StringW key);

  /// @brief Method GetEnumerator, addr 0x62b1b44, size 0x68, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method GetObjectData, addr 0x62b0bc8, size 0x5a8, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDeserialization, addr 0x62b1330, size 0x748, virtual true, abstract: false, final false
  inline void OnDeserialization(::System::Object* sender);

  /// @brief Method Reset, addr 0x62b0a58, size 0xb0, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x62b0b08, size 0xc0, virtual false, abstract: false, final false
  inline void Reset(int32_t capacity);

  /// @brief Method System.Collections.ICollection.CopyTo, addr 0x62b1bf0, size 0x300, virtual true, abstract: false, final true
  inline void System_Collections_ICollection_CopyTo(::System::Array* array, int32_t index);

  /// @brief Method System.Collections.ICollection.get_IsSynchronized, addr 0x62b1f5c, size 0x8, virtual true, abstract: false, final true
  inline bool System_Collections_ICollection_get_IsSynchronized();

  /// @brief Method System.Collections.ICollection.get_SyncRoot, addr 0x62b1ef0, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x62ac988, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x62aca54, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity);

  /// @brief Method .ctor, addr 0x62acb7c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity, ::System::Collections::IEqualityComparer* equalityComparer);

  /// @brief Method .ctor, addr 0x62ad8ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::DBNull* dummy);

  /// @brief Method .ctor, addr 0x62b09d0, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEqualityComparer* equalityComparer);

  /// @brief Method .ctor, addr 0x62acc0c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  static inline ::System::StringComparer* getStaticF_defaultComparer();

  /// @brief Method get_Count, addr 0x62b1bd0, size 0x20, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly, addr 0x62b1b34, size 0x8, virtual false, abstract: false, final false
