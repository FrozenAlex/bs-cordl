...
public:
  ...
  /// @brief Method Add, addr 0x63e9620, size 0x94, virtual true, abstract: false, final false
  inline void Add(::StringW key, ::StringW value);

  /// @brief Method GetEnumerator, addr 0x63e96b4, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63e95c0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
