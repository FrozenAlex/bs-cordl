...
public:
  ...
  /// @brief Method Compare, addr 0x5aa8dd4, size 0xe0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5aa8cec, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5aa8d60, size 0x74, virtual false, abstract: false, final false
