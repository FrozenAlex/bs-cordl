...
public:
  ...
  /// @brief Method Clone, addr 0x5be6004, size 0x4, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method MoveNext, addr 0x5be6008, size 0xe0, virtual true, abstract: false, final false
  inline bool MoveNext();

  static inline ::System::Collections::Stack_StackEnumerator* New_ctor(::System::Collections::Stack* stack);

  /// @brief Method Reset, addr 0x5be6174, size 0x7c, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x5be5dc0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Stack* stack);

  /// @brief Method get_Current, addr 0x5be60e8, size 0x8c, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Clear, addr 0x5be59f0, size 0x30, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method Clone, addr 0x5be5a20, size 0x90, virtual true, abstract: false, final false
  inline ::System::Object* Clone();

  /// @brief Method CopyTo, addr 0x5be5ab0, size 0x2a8, virtual true, abstract: false, final false
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method GetEnumerator, addr 0x5be5d58, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method Peek, addr 0x5be5de4, size 0x84, virtual true, abstract: false, final false
  inline ::System::Object* Peek();

  /// @brief Method Pop, addr 0x5be5e68, size 0x94, virtual true, abstract: false, final false
  inline ::System::Object* Pop();

  /// @brief Method Push, addr 0x5be5efc, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5be5858, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5be58ac, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(int32_t initialCapacity);

  /// @brief Method get_Count, addr 0x5be5974, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsSynchronized, addr 0x5be597c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsSynchronized();

  /// @brief Method get_SyncRoot, addr 0x5be5984, size 0x6c, virtual true, abstract: false, final false
