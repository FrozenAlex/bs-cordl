...
public:
  ...
  /// @brief Method Equals, addr 0x627e2ec, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x627e36c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x627e2dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  static inline ::System::ComponentModel::DefaultEventAttribute* getStaticF_Default();

  /// @brief Method get_Name, addr 0x627e2e4, size 0x8, virtual false, abstract: false, final false
