...
public:
  ...
  /// @brief Method Equals, addr 0x63abd5c, size 0x110, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x63abe6c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63abd44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW value);

  /// @brief Method .ctor, addr 0x63abd4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* value);

  /// @brief Method .ctor, addr 0x63abd14, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(bool value);

  /// @brief Method .ctor, addr 0x63abce4, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(double_t value);

  /// @brief Method .ctor, addr 0x63abc84, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(int32_t value);

  /// @brief Method .ctor, addr 0x63abcb4, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(int64_t value);

  /// @brief Method get_Value, addr 0x63abd54, size 0x8, virtual true, abstract: false, final false
