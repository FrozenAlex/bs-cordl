...
public:
  ...
  /// @brief Method Equals, addr 0x627e994, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x627ea2c, size 0x88, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsDefaultAttribute, addr 0x627eab4, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x627e984, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Visible, addr 0x627e98c, size 0x8, virtual false, abstract: false, final false
