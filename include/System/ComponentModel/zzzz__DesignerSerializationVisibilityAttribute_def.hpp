...
public:
  ...
  /// @brief Method Equals, addr 0x6272ef0, size 0xd8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x6272fc8, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsDefaultAttribute, addr 0x6272fd0, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6272ee0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Visibility, addr 0x6272ee8, size 0x8, virtual false, abstract: false, final false
