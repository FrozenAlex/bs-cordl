...
public:
  ...
  /// @brief Method MoveNext, addr 0x627fff4, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x6280018, size 0xc, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x627fa60, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Array* array, int32_t count);

  /// @brief Method get_Current, addr 0x6280024, size 0x5c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Add, addr 0x627f1a0, size 0xc8, virtual false, abstract: false, final false
  inline int32_t Add(::System::ComponentModel::EventDescriptor* value);

  /// @brief Method Clear, addr 0x627f368, size 0x48, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Contains, addr 0x627f3b0, size 0x18, virtual false, abstract: false, final false
  inline bool Contains(::System::ComponentModel::EventDescriptor* value);

  /// @brief Method EnsureEventsOwned, addr 0x627f0dc, size 0xb0, virtual false, abstract: false, final false
  inline void EnsureEventsOwned();

  /// @brief Method EnsureSize, addr 0x627f268, size 0x100, virtual false, abstract: false, final false
  inline void EnsureSize(int32_t sizeNeeded);

  /// @brief Method Find, addr 0x627f6d4, size 0x108, virtual true, abstract: false, final false
  inline ::System::ComponentModel::EventDescriptor* Find(::StringW name, bool ignoreCase);

  /// @brief Method GetEnumerator, addr 0x627f9d8, size 0x88, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method IndexOf, addr 0x627f3c8, size 0x64, virtual false, abstract: false, final false
  inline int32_t IndexOf(::System::ComponentModel::EventDescriptor* value);

  /// @brief Method Insert, addr 0x627f7dc, size 0xe8, virtual false, abstract: false, final false
  inline void Insert(int32_t index, ::System::ComponentModel::EventDescriptor* value);

  /// @brief Method InternalSort, addr 0x627f468, size 0x26c, virtual false, abstract: false, final false
  inline void InternalSort(::ArrayW<::StringW> names);

  /// @brief Method InternalSort, addr 0x627fa70, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x627f8c4, size 0x68, virtual false, abstract: false, final false
  inline void Remove(::System::ComponentModel::EventDescriptor* value);

  /// @brief Method RemoveAt, addr 0x627f92c, size 0xac, virtual false, abstract: false, final false
  inline void RemoveAt(int32_t index);

  /// @brief Method System.Collections.ICollection.CopyTo, addr 0x627f42c, size 0x3c, virtual true, abstract: false, final true
  inline void System_Collections_ICollection_CopyTo(::System::Array* array, int32_t index);

  /// @brief Method System.Collections.ICollection.get_Count, addr 0x627fb08, size 0x8, virtual true, abstract: false, final true
  inline int32_t System_Collections_ICollection_get_Count();

  /// @brief Method System.Collections.ICollection.get_IsSynchronized, addr 0x627faf8, size 0x8, virtual true, abstract: false, final true
  inline bool System_Collections_ICollection_get_IsSynchronized();

  /// @brief Method System.Collections.ICollection.get_SyncRoot, addr 0x627fb00, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_ICollection_get_SyncRoot();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x627fb10, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IList.Add, addr 0x627fc90, size 0x90, virtual true, abstract: false, final true
  inline int32_t System_Collections_IList_Add(::System::Object* value);

  /// @brief Method System.Collections.IList.Clear, addr 0x627fdbc, size 0x4, virtual true, abstract: false, final true
  inline void System_Collections_IList_Clear();

  /// @brief Method System.Collections.IList.Contains, addr 0x627fd20, size 0x9c, virtual true, abstract: false, final true
  inline bool System_Collections_IList_Contains(::System::Object* value);

  /// @brief Method System.Collections.IList.IndexOf, addr 0x627fdc0, size 0x90, virtual true, abstract: false, final true
  inline int32_t System_Collections_IList_IndexOf(::System::Object* value);

  /// @brief Method System.Collections.IList.Insert, addr 0x627fe50, size 0x98, virtual true, abstract: false, final true
  inline void System_Collections_IList_Insert(int32_t index, ::System::Object* value);

  /// @brief Method System.Collections.IList.Remove, addr 0x627fee8, size 0x90, virtual true, abstract: false, final true
  inline void System_Collections_IList_Remove(::System::Object* value);

  /// @brief Method System.Collections.IList.RemoveAt, addr 0x627ff78, size 0x4, virtual true, abstract: false, final true
  inline void System_Collections_IList_RemoveAt(int32_t index);

  /// @brief Method System.Collections.IList.get_IsFixedSize, addr 0x627ff84, size 0x8, virtual true, abstract: false, final true
  inline bool System_Collections_IList_get_IsFixedSize();

  /// @brief Method System.Collections.IList.get_IsReadOnly, addr 0x627ff7c, size 0x8, virtual true, abstract: false, final true
  inline bool System_Collections_IList_get_IsReadOnly();

  /// @brief Method System.Collections.IList.get_Item, addr 0x627fb14, size 0x10, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IList_get_Item(int32_t index);

  /// @brief Method System.Collections.IList.set_Item, addr 0x627fb24, size 0x16c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x627ef5c, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::System::ComponentModel::EventDescriptor*> events);

  /// @brief Method .ctor, addr 0x627f024, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Count, addr 0x627f048, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x627f058, size 0x84, virtual true, abstract: false, final false
  inline ::System::ComponentModel::EventDescriptor* get_Item(int32_t index);

  /// @brief Method get_Item, addr 0x627f18c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Count, addr 0x627f050, size 0x8, virtual false, abstract: false, final false
