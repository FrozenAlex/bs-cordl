...
public:
  ...
  /// @brief Method Equals, addr 0x62734a0, size 0xe0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x6273580, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsDefaultAttribute, addr 0x6273588, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6273490, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsReadOnly, addr 0x6273498, size 0x8, virtual false, abstract: false, final false
