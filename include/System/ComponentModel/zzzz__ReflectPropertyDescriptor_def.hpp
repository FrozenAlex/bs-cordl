...
public:
  ...
  /// @brief Method CanResetValue, addr 0x6290f70, size 0x28c, virtual true, abstract: false, final false
  inline bool CanResetValue(::System::Object* component);

  /// @brief Method ExtenderCanResetValue, addr 0x628fdb4, size 0x2a0, virtual false, abstract: false, final false
  inline bool ExtenderCanResetValue(::System::ComponentModel::IExtenderProvider* provider, ::System::Object* component);

  /// @brief Method ExtenderGetReceiverType, addr 0x62901a0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* ExtenderGetReceiverType();

  /// @brief Method ExtenderGetType, addr 0x62901a8, size 0x10, virtual false, abstract: false, final false
  inline ::System::Type* ExtenderGetType(::System::ComponentModel::IExtenderProvider* provider);

  /// @brief Method ExtenderGetValue, addr 0x6290054, size 0x14c, virtual false, abstract: false, final false
  inline ::System::Object* ExtenderGetValue(::System::ComponentModel::IExtenderProvider* provider, ::System::Object* component);

  /// @brief Method ExtenderResetValue, addr 0x62901b8, size 0x4c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtenderSetValue, addr 0x6290680, size 0x478, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtenderShouldSerializeValue, addr 0x6290af8, size 0x478, virtual false, abstract: false, final false
  inline bool ExtenderShouldSerializeValue(::System::ComponentModel::IExtenderProvider* provider, ::System::Object* component);

  /// @brief Method FillAttributes, addr 0x62911fc, size 0xa2c, virtual true, abstract: false, final false
  inline void FillAttributes(::System::Collections::IList* attributes);

  /// @brief Method GetValue, addr 0x62921a0, size 0x2f8, virtual true, abstract: false, final false
  ...
  /// @brief Method OnValueChanged, addr 0x6292498, size 0xa4, virtual true, abstract: false, final false
  inline void OnValueChanged(::System::Object* component, ::System::EventArgs* e);

  /// @brief Method ResetValue, addr 0x629253c, size 0x3fc, virtual true, abstract: false, final false
  inline void ResetValue(::System::Object* component);

  /// @brief Method SetValue, addr 0x6292938, size 0x5fc, virtual true, abstract: false, final false
  inline void SetValue(::System::Object* component, ::System::Object* value);

  /// @brief Method ShouldSerializeValue, addr 0x6292f34, size 0x340, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x628e8b0, size 0x290, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* componentClass, ::StringW name, ::System::Type* type, ::ArrayW<::System::Attribute*> attributes);

  /// @brief Method .ctor, addr 0x628eb40, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x628ec34, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AmbientValue, addr 0x628ed00, size 0x168, virtual false, abstract: false, final false
  inline ::System::Object* get_AmbientValue();

  /// @brief Method get_ComponentType, addr 0x628ee68, size 0x8, virtual true, abstract: false, final false
  inline ::System::Type* get_ComponentType();

  /// @brief Method get_DefaultValue, addr 0x628ee70, size 0x260, virtual false, abstract: false, final false
  inline ::System::Object* get_DefaultValue();

  /// @brief Method get_GetMethodValue, addr 0x628f0d0, size 0x3d8, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_GetMethodValue();

  /// @brief Method get_IsExtender, addr 0x628f4a8, size 0x30, virtual false, abstract: false, final false
  inline bool get_IsExtender();

  /// @brief Method get_IsReadOnly, addr 0x628f4d8, size 0xec, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_PropertyType, addr 0x628fa04, size 0x8, virtual true, abstract: false, final false
  inline ::System::Type* get_PropertyType();

  /// @brief Method get_ResetMethodValue, addr 0x628fa0c, size 0x1d4, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_ResetMethodValue();

  /// @brief Method get_SetMethodValue, addr 0x628f5c4, size 0x440, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_SetMethodValue();

  /// @brief Method get_ShouldSerializeMethodValue, addr 0x628fbe0, size 0x1d4, virtual false, abstract: false, final false
