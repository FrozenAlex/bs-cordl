...
public:
  ...
  /// @brief Method IsModified, addr 0x5e16f30, size 0x3c, virtual true, abstract: false, final false
  inline bool IsModified();

  /// @brief Method Reset, addr 0x5e16f6c, size 0x3c, virtual true, abstract: false, final false
  inline void Reset(::System::Configuration::ConfigurationElement* parentElement);

  /// @brief Method ResetModified, addr 0x5e16fa8, size 0x3c, virtual true, abstract: false, final false
  inline void ResetModified();

  /// @brief Method get_Properties, addr 0x5e16ef4, size 0x3c, virtual true, abstract: false, final false
