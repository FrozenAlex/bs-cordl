...
public:
  ...
  /// @brief Method DeserializeSection, addr 0x5e17150, size 0x3c, virtual true, abstract: false, final false
  inline void DeserializeSection(::System::Xml::XmlReader* xmlReader);

  /// @brief Method IsModified, addr 0x5e1718c, size 0x3c, virtual true, abstract: false, final false
  inline bool IsModified();

  static inline ::System::Configuration::IgnoreSection* New_ctor();

  /// @brief Method Reset, addr 0x5e171c8, size 0x3c, virtual true, abstract: false, final false
  inline void Reset(::System::Configuration::ConfigurationElement* parentSection);

  /// @brief Method ResetModified, addr 0x5e17204, size 0x3c, virtual true, abstract: false, final false
  inline void ResetModified();

  /// @brief Method SerializeSection, addr 0x5e17240, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e170d8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Properties, addr 0x5e17114, size 0x3c, virtual true, abstract: false, final false
