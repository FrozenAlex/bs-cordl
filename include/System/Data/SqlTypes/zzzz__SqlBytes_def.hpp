...
public:
  ...
  /// @brief Method CopyStreamToBuffer, addr 0x5f4668c, size 0x154, virtual false, abstract: false, final false
  inline void CopyStreamToBuffer();

  /// @brief Method FStream, addr 0x5f4667c, size 0x10, virtual false, abstract: false, final false
  inline bool FStream();

  /// @brief Method GetXsdType, addr 0x5f46de8, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method SetBuffer, addr 0x5f46a58, size 0x28, virtual false, abstract: false, final false
  inline void SetBuffer(::ArrayW<uint8_t> buffer);

  /// @brief Method SetNull, addr 0x5f46544, size 0x10, virtual false, abstract: false, final false
  inline void SetNull();

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x5f46e78, size 0x38, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.GetSchema, addr 0x5f46a80, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchema* System_Xml_Serialization_IXmlSerializable_GetSchema();

  /// @brief Method System.Xml.Serialization.IXmlSerializable.ReadXml, addr 0x5f46a88, size 0x1e8, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_ReadXml(::System::Xml::XmlReader* r);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.WriteXml, addr 0x5f46c70, size 0x178, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5f46534, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5f46554, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> buffer);

  /// @brief Method .ctor, addr 0x5f46584, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::SqlTypes::SqlBinary value);

  /// @brief Method get_Buffer, addr 0x5f46654, size 0x28, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> get_Buffer();

  /// @brief Method get_IsNull, addr 0x5f46644, size 0x10, virtual true, abstract: false, final true
  inline bool get_IsNull();

  /// @brief Method get_Length, addr 0x5f467e0, size 0x6c, virtual false, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_Null, addr 0x5f46eb0, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlBytes* get_Null();

  /// @brief Method get_Value, addr 0x5f4684c, size 0x1e4, virtual false, abstract: false, final false
