...
public:
  ...
  /// @brief Method CopyStreamToBuffer, addr 0x607ffa8, size 0x148, virtual false, abstract: false, final false
  inline void CopyStreamToBuffer();

  /// @brief Method FStream, addr 0x607ff98, size 0x10, virtual false, abstract: false, final false
  inline bool FStream();

  /// @brief Method GetXsdType, addr 0x60805e0, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method SetBuffer, addr 0x6080334, size 0x28, virtual false, abstract: false, final false
  inline void SetBuffer(::ArrayW<char16_t> buffer);

  /// @brief Method SetNull, addr 0x607fdb4, size 0x10, virtual false, abstract: false, final false
  inline void SetNull();

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x6080670, size 0x38, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.GetSchema, addr 0x608035c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchema* System_Xml_Serialization_IXmlSerializable_GetSchema();

  /// @brief Method System.Xml.Serialization.IXmlSerializable.ReadXml, addr 0x6080364, size 0x138, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_ReadXml(::System::Xml::XmlReader* r);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.WriteXml, addr 0x608049c, size 0x144, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x607fda4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x607fdc4, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<char16_t> buffer);

  /// @brief Method .ctor, addr 0x607fdf4, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::SqlTypes::SqlString value);

  /// @brief Method get_Buffer, addr 0x607ff70, size 0x28, virtual false, abstract: false, final false
  inline ::ArrayW<char16_t> get_Buffer();

  /// @brief Method get_IsNull, addr 0x607ff60, size 0x10, virtual true, abstract: false, final true
  inline bool get_IsNull();

  /// @brief Method get_Length, addr 0x60800f0, size 0x6c, virtual false, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_Null, addr 0x60806a8, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlChars* get_Null();

  /// @brief Method get_Value, addr 0x608015c, size 0x1d8, virtual false, abstract: false, final false
