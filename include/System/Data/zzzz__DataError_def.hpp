...
public:
  ...
  /// @brief Method Clear, addr 0x601c0dc, size 0x70, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Clear, addr 0x601be84, size 0xac, virtual false, abstract: false, final false
  inline void Clear(::System::Data::DataColumn* column);

  /// @brief Method GetColumnError, addr 0x601c07c, size 0x60, virtual false, abstract: false, final false
  inline ::StringW GetColumnError(::System::Data::DataColumn* column);

  /// @brief Method GetColumnsInError, addr 0x601c14c, size 0xf4, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*> GetColumnsInError();

  /// @brief Method IndexOf, addr 0x601bf30, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetColumnError, addr 0x601bda0, size 0xe4, virtual false, abstract: false, final false
  inline void SetColumnError(::System::Data::DataColumn* column, ::StringW error);

  /// @brief Method SetText, addr 0x601bd30, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x601bcf8, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x601bd10, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(::StringW rowError);

  /// @brief Method get_HasErrors, addr 0x601bd70, size 0x30, virtual false, abstract: false, final false
  inline bool get_HasErrors();

  /// @brief Method get_Text, addr 0x601bd4c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Text();

  /// @brief Method set_Text, addr 0x601bd54, size 0x1c, virtual false, abstract: false, final false
