...
public:
  ...
  /// @brief Method Add, addr 0x5eeed94, size 0x278, virtual false, abstract: false, final false
  inline void Add(::System::Data::DataTable* table);

  /// @brief Method ArrayAdd, addr 0x5eef208, size 0x20, virtual false, abstract: false, final false
  inline void ArrayAdd(::System::Data::DataTable* table);

  /// @brief Method AssignName, addr 0x5eef310, size 0x48, virtual false, abstract: false, final false
  inline ::StringW AssignName();

  /// @brief Method BaseAdd, addr 0x5eef0f4, size 0x114, virtual false, abstract: false, final false
  inline void BaseAdd(::System::Data::DataTable* table);

  /// @brief Method BaseGroupSwitch, addr 0x5eef6a8, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method BaseRemove, addr 0x5eef824, size 0x78, virtual false, abstract: false, final false
  inline void BaseRemove(::System::Data::DataTable* table);

  /// @brief Method CanRemove, addr 0x5eef89c, size 0x45c, virtual false, abstract: false, final false
  inline bool CanRemove(::System::Data::DataTable* table, bool fThrowException);

  /// @brief Method Clear, addr 0x5eefe0c, size 0x2b0, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Contains, addr 0x5eef42c, size 0x18, virtual false, abstract: false, final false
  inline bool Contains(::StringW name);

  /// @brief Method Contains, addr 0x5ef022c, size 0x128, virtual false, abstract: false, final false
  inline bool Contains(::StringW name, bool caseSensitive);

  /// @brief Method Contains, addr 0x5ef00bc, size 0x170, virtual false, abstract: false, final false
  inline bool Contains(::StringW name, ::StringW tableNamespace, bool checkProperty, bool caseSensitive);

  /// @brief Method GetTable, addr 0x5eeeb48, size 0x118, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* GetTable(::StringW name, ::StringW ns);

  /// @brief Method GetTableSmart, addr 0x5eeec60, size 0x134, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* GetTableSmart(::StringW name, ::StringW ns);

  /// @brief Method IndexOf, addr 0x5ef0354, size 0xe8, virtual false, abstract: false, final false
  inline int32_t IndexOf(::System::Data::DataTable* table);

  /// @brief Method IndexOf, addr 0x5ef043c, size 0x18, virtual false, abstract: false, final false
  inline int32_t IndexOf(::StringW tableName);

  /// @brief Method IndexOf, addr 0x5ef0454, size 0x60, virtual false, abstract: false, final false
  inline int32_t IndexOf(::StringW tableName, ::StringW tableNamespace, bool chekforNull);

  /// @brief Method InternalIndexOf, addr 0x5eee7f4, size 0x1cc, virtual false, abstract: false, final false
  inline int32_t InternalIndexOf(::StringW tableName);

  /// @brief Method InternalIndexOf, addr 0x5eee9c0, size 0x188, virtual false, abstract: false, final false
  inline int32_t InternalIndexOf(::StringW tableName, ::StringW tableNamespace);

  /// @brief Method MakeName, addr 0x5eef358, size 0xd4, virtual false, abstract: false, final false
  inline ::StringW MakeName(int32_t index);

  static inline ::System::Data::DataTableCollection* New_ctor(::System::Data::DataSet* dataSet);

  /// @brief Method OnCollectionChanged, addr 0x5eef228, size 0xe8, virtual false, abstract: false, final false
  inline void OnCollectionChanged(::System::ComponentModel::CollectionChangeEventArgs* ccevent);

  /// @brief Method OnCollectionChanging, addr 0x5eef00c, size 0xe8, virtual false, abstract: false, final false
  inline void OnCollectionChanging(::System::ComponentModel::CollectionChangeEventArgs* ccevent);

  /// @brief Method RegisterName, addr 0x5eef444, size 0x264, virtual false, abstract: false, final false
  inline void RegisterName(::StringW name, ::StringW tbNamespace);

  /// @brief Method Remove, addr 0x5ef0504, size 0x1d8, virtual false, abstract: false, final false
  inline void Remove(::System::Data::DataTable* table);

  /// @brief Method ReplaceFromInference, addr 0x5ef04b4, size 0x50, virtual false, abstract: false, final false
  inline void ReplaceFromInference(::System::Collections::Generic::List_1<::System::Data::DataTable*>* tableList);

  /// @brief Method UnregisterName, addr 0x5eefcf8, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5eee444, size 0x160, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataSet* dataSet);

  static inline int32_t getStaticF_s_objectTypeCount();

  /// @brief Method get_Item, addr 0x5eee5b4, size 0x140, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* get_Item(int32_t index);

  /// @brief Method get_Item, addr 0x5eee6f4, size 0x100, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* get_Item(::StringW name);

  /// @brief Method get_Item, addr 0x5ee7044, size 0x10c, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* get_Item(::StringW name, ::StringW tableNamespace);

  /// @brief Method get_List, addr 0x5eee5a4, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::ArrayList* get_List();

  /// @brief Method get_ObjectID, addr 0x5eee5ac, size 0x8, virtual false, abstract: false, final false
