...
public:
  ...
  /// @brief Method ChildRelationCollectionChanged, addr 0x602d6e0, size 0xc0, virtual false, abstract: false, final false
  inline void ChildRelationCollectionChanged(::System::Object* sender, ::System::ComponentModel::CollectionChangeEventArgs* e);

  /// @brief Method CleanUp, addr 0x602d7a0, size 0x18, virtual false, abstract: false, final false
  inline void CleanUp(bool updateListeners);

  /// @brief Method ColumnCollectionChanged, addr 0x602d878, size 0xd0, virtual false, abstract: false, final false
  inline void ColumnCollectionChanged(::System::Object* sender, ::System::ComponentModel::CollectionChangeEventArgs* e);

  /// @brief Method IndexListChanged, addr 0x602da24, size 0xc0, virtual false, abstract: false, final false
  inline void IndexListChanged(::System::ComponentModel::ListChangedEventArgs* e);

  /// @brief Method MaintainDataView, addr 0x602d948, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method ParentRelationCollectionChanged, addr 0x602d7b8, size 0xc0, virtual false, abstract: false, final false
  inline void ParentRelationCollectionChanged(::System::Object* sender, ::System::ComponentModel::CollectionChangeEventArgs* e);

  /// @brief Method RegisterListChangedEvent, addr 0x602ceb4, size 0xe0, virtual false, abstract: false, final false
  inline void RegisterListChangedEvent(::System::Data::Index* index);

  /// @brief Method RegisterListener, addr 0x602dae4, size 0x238, virtual false, abstract: false, final false
  inline void RegisterListener(::System::Data::DataTable* table);

  /// @brief Method RegisterMetaDataEvents, addr 0x6029d34, size 0x1e4, virtual false, abstract: false, final false
  inline void RegisterMetaDataEvents(::System::Data::DataTable* table);

  /// @brief Method UnregisterListChangedEvent, addr 0x602cdbc, size 0xf8, virtual false, abstract: false, final false
  inline void UnregisterListChangedEvent();

  /// @brief Method UnregisterMetaDataEvents, addr 0x602aa1c, size 0x8, virtual false, abstract: false, final false
  inline void UnregisterMetaDataEvents();

  /// @brief Method UnregisterMetaDataEvents, addr 0x602dd1c, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6029cac, size 0x88, virtual false, abstract: false, final false
