...
public:
  ...
  /// @brief Method SetDataTable, addr 0x602e088, size 0x14, virtual false, abstract: false, final false
  inline void SetDataTable(::System::Data::DataTable* table);

  /// @brief Method SetDataViewManager, addr 0x602e074, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x602e04c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ApplyDefaultSort, addr 0x602e06c, size 0x8, virtual false, abstract: false, final false
  inline bool get_ApplyDefaultSort();

  /// @brief Method get_RowFilter, addr 0x602e09c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_RowFilter();

  /// @brief Method get_RowStateFilter, addr 0x602e0a4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::DataViewRowState get_RowStateFilter();

  /// @brief Method get_Sort, addr 0x602e0ac, size 0x8, virtual false, abstract: false, final false
