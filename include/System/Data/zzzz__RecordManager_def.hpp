...
public:
  ...
  /// @brief Method Clear, addr 0x5f0b16c, size 0x20c, virtual false, abstract: false, final false
  inline void Clear(bool clearAll);

  /// @brief Method CopyRecord, addr 0x5f0b3b0, size 0x33c, virtual false, abstract: false, final false
  inline int32_t CopyRecord(::System::Data::DataTable* src, int32_t record, int32_t copy);

  /// @brief Method FreeRecord, addr 0x5f0afa4, size 0x164, virtual false, abstract: false, final false
  inline void FreeRecord(::by_ref<int32_t> record);

  /// @brief Method GrowRecordCapacity, addr 0x5f0ac98, size 0x100, virtual false, abstract: false, final false
  inline void GrowRecordCapacity();

  /// @brief Method ImportRecord, addr 0x5f0b3a8, size 0x8, virtual false, abstract: false, final false
  inline int32_t ImportRecord(::System::Data::DataTable* src, int32_t record);

  /// @brief Method NewCapacity, addr 0x5f0ad98, size 0x14, virtual false, abstract: false, final false
  static inline int32_t NewCapacity(int32_t capacity);

  /// @brief Method NewRecordBase, addr 0x5f0aec8, size 0xdc, virtual false, abstract: false, final false
  inline int32_t NewRecordBase();

  static inline ::System::Data::RecordManager* New_ctor(::System::Data::DataTable* table);

  /// @brief Method NormalizedMinimumCapacity, addr 0x5f0adac, size 0x34, virtual false, abstract: false, final false
  inline int32_t NormalizedMinimumCapacity(int32_t capacity);

  /// @brief Method SetRowCache, addr 0x5f0b6ec, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f0abd8, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table);

  /// @brief Method get_Item, addr 0x5f0b378, size 0x30, virtual false, abstract: false, final false
  inline ::System::Data::DataRow* get_Item(int32_t record);

  /// @brief Method get_LastFreeRecord, addr 0x5f0ae70, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LastFreeRecord();

  /// @brief Method get_MinimumCapacity, addr 0x5f0ae78, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MinimumCapacity();

  /// @brief Method get_RecordCapacity, addr 0x5f0aec0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_RecordCapacity();

  /// @brief Method set_Item, addr 0x5f0b108, size 0x64, virtual false, abstract: false, final false
  inline void set_Item(int32_t record, ::System::Data::DataRow* value);

  /// @brief Method set_MinimumCapacity, addr 0x5f0ae80, size 0x40, virtual false, abstract: false, final false
  inline void set_MinimumCapacity(int32_t value);

  /// @brief Method set_RecordCapacity, addr 0x5f0ade0, size 0x90, virtual false, abstract: false, final false
