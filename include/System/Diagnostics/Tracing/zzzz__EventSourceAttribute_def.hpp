...
public:
  ...
  /// @brief Method .ctor, addr 0x5aa6ff8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_Guid, addr 0x5aa6fe8, size 0x8, virtual false, abstract: false, final false
  inline void set_Guid(::StringW value);

  /// @brief Method set_Name, addr 0x5aa6ff0, size 0x8, virtual false, abstract: false, final false
