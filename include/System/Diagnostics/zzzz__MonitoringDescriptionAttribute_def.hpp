...
public:
  ...
  /// @brief Method .ctor, addr 0x625e9f0, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::StringW description);

  /// @brief Method get_Description, addr 0x625ea54, size 0x8, virtual true, abstract: false, final false
