...
// Write type traits
MARK_REF_T(::System::Diagnostics::ProcessThreadTimes*);
DEFINE_IL2CPP_CLASS(::System::Diagnostics::ProcessThreadTimes*, "System.Diagnostics", "ProcessThreadTimes");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6394dd0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TotalProcessorTime, addr 0x63951b4, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Diagnostics::ProcessThreadTimes) == 0x30, "Size mismatch!");
