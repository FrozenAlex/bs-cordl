...
public:
  ...
  /// @brief Method GetTimestamp, addr 0x639093c, size 0x4, virtual false, abstract: false, final false
  static inline int64_t GetTimestamp();

  static inline ::System::Diagnostics::Stopwatch* New_ctor();

  /// @brief Method Reset, addr 0x6398c3c, size 0xc, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Restart, addr 0x6398cc4, size 0x64, virtual false, abstract: false, final false
  inline void Restart();

  /// @brief Method Start, addr 0x63988f4, size 0x6c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartNew, addr 0x6398894, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Diagnostics::Stopwatch* StartNew();

  /// @brief Method Stop, addr 0x6398c48, size 0x7c, virtual false, abstract: false, final false
  inline void Stop();
  ...
  /// @brief Method .ctor, addr 0x63988f0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Elapsed, addr 0x6398960, size 0xf8, virtual false, abstract: false, final false
  inline ::System::TimeSpan get_Elapsed();

  /// @brief Method get_ElapsedMilliseconds, addr 0x6398acc, size 0x168, virtual false, abstract: false, final false
  inline int64_t get_ElapsedMilliseconds();

  /// @brief Method get_ElapsedTicks, addr 0x6398a58, size 0x74, virtual false, abstract: false, final false
  inline int64_t get_ElapsedTicks();

  /// @brief Method get_IsRunning, addr 0x6398c34, size 0x8, virtual false, abstract: false, final false
