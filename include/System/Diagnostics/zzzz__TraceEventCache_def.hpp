...
public:
  ...
  /// @brief Method GetProcessId, addr 0x62569b4, size 0x54, virtual false, abstract: false, final false
  static inline int32_t GetProcessId();

  /// @brief Method GetThreadId, addr 0x6256a7c, size 0x20, virtual false, abstract: false, final false
  static inline int32_t GetThreadId();

  /// @brief Method InitProcessInfo, addr 0x6256b08, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Callstack, addr 0x62568e0, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_Callstack();

  /// @brief Method get_DateTime, addr 0x6256918, size 0x98, virtual false, abstract: false, final false
  inline ::System::DateTime get_DateTime();

  /// @brief Method get_LogicalOperationStack, addr 0x6256900, size 0x18, virtual false, abstract: false, final false
  inline ::System::Collections::Stack* get_LogicalOperationStack();

  /// @brief Method get_ProcessId, addr 0x62569b0, size 0x4, virtual false, abstract: false, final false
  inline int32_t get_ProcessId();

  /// @brief Method get_ThreadId, addr 0x6256a08, size 0x74, virtual false, abstract: false, final false
  inline ::StringW get_ThreadId();

  /// @brief Method get_Timestamp, addr 0x6256a9c, size 0x68, virtual false, abstract: false, final false
