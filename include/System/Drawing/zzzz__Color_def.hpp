...
public:
  ...
  /// @brief Method Equals, addr 0x5f94814, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x5f948a8, size 0x44, virtual true, abstract: false, final true
  inline bool Equals(::System::Drawing::Color other);

  /// @brief Method GetHashCode, addr 0x5f948ec, size 0xa4, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x5f94564, size 0x26c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_A, addr 0x5f944a8, size 0x14, virtual false, abstract: false, final false
  inline uint8_t get_A();

  /// @brief Method get_B, addr 0x5f94498, size 0x10, virtual false, abstract: false, final false
  inline uint8_t get_B();

  /// @brief Method get_G, addr 0x5f94484, size 0x14, virtual false, abstract: false, final false
  inline uint8_t get_G();

  /// @brief Method get_IsKnownColor, addr 0x5f944bc, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsKnownColor();

  /// @brief Method get_Name, addr 0x5f944c8, size 0x9c, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_R, addr 0x5f9443c, size 0x14, virtual false, abstract: false, final false
  inline uint8_t get_R();

  /// @brief Method get_Value, addr 0x5f94450, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x5f947d0, size 0x44, virtual false, abstract: false, final false
