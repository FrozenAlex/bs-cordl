...
public:
  ...
  /// @brief Method Equals, addr 0x60ce040, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x60ce0f0, size 0x30, virtual true, abstract: false, final true
  inline bool Equals(::System::Drawing::RectangleF other);

  /// @brief Method GetHashCode, addr 0x60ce148, size 0x100, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x60ce248, size 0x1c8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_Height, addr 0x60ce038, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Height();

  /// @brief Method get_Width, addr 0x60ce030, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Width();

  /// @brief Method get_X, addr 0x60ce020, size 0x8, virtual false, abstract: false, final false
  inline float_t get_X();

  /// @brief Method get_Y, addr 0x60ce028, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x60ce120, size 0x28, virtual false, abstract: false, final false
