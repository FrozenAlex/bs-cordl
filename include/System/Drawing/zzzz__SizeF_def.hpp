...
public:
  ...
  /// @brief Method Equals, addr 0x60ce654, size 0x84, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x60ce6d8, size 0x18, virtual true, abstract: false, final true
  inline bool Equals(::System::Drawing::SizeF other);

  /// @brief Method GetHashCode, addr 0x60ce6f0, size 0x84, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x60ce774, size 0x118, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_Height, addr 0x60ce64c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Height();

  /// @brief Method get_Width, addr 0x60ce644, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x60ce634, size 0x10, virtual false, abstract: false, final false
