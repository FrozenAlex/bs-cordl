...
public:
  ...
  /// @brief Method Equals, addr 0x60ce42c, size 0x7c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x60ce4a8, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::System::Drawing::Size other);

  /// @brief Method GetHashCode, addr 0x60ce4b8, size 0x64, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x60ce51c, size 0x118, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_Height, addr 0x60ce424, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Height();

  /// @brief Method get_Width, addr 0x60ce41c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x60ce410, size 0xc, virtual false, abstract: false, final false
