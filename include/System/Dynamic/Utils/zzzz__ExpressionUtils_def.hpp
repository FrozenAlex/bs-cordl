...
public:
  // Declarations
  /// @brief Method GetParametersForValidation, addr 0x5fc18d0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method RequiresCanRead, addr 0x5fc20c0, size 0x8, virtual false, abstract: false, final false
  static inline void RequiresCanRead(::System::Linq::Expressions::Expression* expression, ::StringW paramName);

  /// @brief Method RequiresCanRead, addr 0x5fc1c3c, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method TryQuote, addr 0x5fc1f9c, size 0x124, virtual false, abstract: false, final false
  static inline bool TryQuote(::System::Type* parameterType, ::by_ref<::System::Linq::Expressions::Expression*> argument);

  /// @brief Method ValidateArgumentCount, addr 0x5fc2294, size 0xd8, virtual false, abstract: false, final false
  static inline void ValidateArgumentCount(::System::Linq::Expressions::LambdaExpression* lambda);

  /// @brief Method ValidateArgumentCount, addr 0x5fc196c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateArgumentTypes, addr 0x5fc1618, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateOneArgument, addr 0x5fc1a18, size 0x224, virtual false, abstract: false, final false
