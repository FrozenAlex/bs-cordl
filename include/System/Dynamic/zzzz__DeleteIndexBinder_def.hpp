...
public:
  // Declarations
  /// @brief Method Bind, addr 0x5fbb260, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method FallbackDeleteIndex, addr 0x5fbb320, size 0x10, virtual false, abstract: false, final false
