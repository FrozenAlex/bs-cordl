...
public:
  // Declarations
  /// @brief Method Bind, addr 0x5fc0f5c, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method FallbackInvoke, addr 0x5fc0f4c, size 0x10, virtual false, abstract: false, final false
