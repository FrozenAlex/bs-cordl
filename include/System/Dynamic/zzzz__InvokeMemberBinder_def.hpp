...
public:
  ...
  /// @brief Method Bind, addr 0x5fc1028, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method FallbackInvokeMember, addr 0x5fbfc54, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IgnoreCase, addr 0x5fc1020, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreCase();

  /// @brief Method get_Name, addr 0x5fc1018, size 0x8, virtual false, abstract: false, final false
