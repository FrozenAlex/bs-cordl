...
public:
  // Declarations
  /// @brief Method Bind, addr 0x5fc13dc, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method FallbackUnaryOperation, addr 0x5fc13cc, size 0x10, virtual false, abstract: false, final false
