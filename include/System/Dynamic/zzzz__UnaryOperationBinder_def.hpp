...
public:
  // Declarations
  /// @brief Method Bind, addr 0x5e88544, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method FallbackUnaryOperation, addr 0x5e88534, size 0x10, virtual false, abstract: false, final false
