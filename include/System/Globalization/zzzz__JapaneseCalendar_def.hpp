...
public:
  ...
  /// @brief Method EnglishEraNames, addr 0x5a8b4b8, size 0xdc, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW> EnglishEraNames();

  /// @brief Method EraNames, addr 0x5a8b3dc, size 0xdc, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW> EraNames();

  /// @brief Method GetDayOfMonth, addr 0x5a9018c, size 0x14, virtual true, abstract: false, final false
  inline int32_t GetDayOfMonth(::System::DateTime time);

  /// @brief Method GetDayOfWeek, addr 0x5a901a0, size 0x14, virtual true, abstract: false, final false
  inline ::System::DayOfWeek GetDayOfWeek(::System::DateTime time);

  /// @brief Method GetDaysInMonth, addr 0x5a90164, size 0x14, virtual true, abstract: false, final false
  inline int32_t GetDaysInMonth(int32_t year, int32_t month, int32_t era);

  /// @brief Method GetDaysInYear, addr 0x5a90178, size 0x14, virtual true, abstract: false, final false
  inline int32_t GetDaysInYear(int32_t year, int32_t era);

  /// @brief Method GetDefaultInstance, addr 0x5a8fee8, size 0xb0, virtual false, abstract: false, final false
  static inline ::System::Globalization::Calendar* GetDefaultInstance();

  /// @brief Method GetEra, addr 0x5a901d8, size 0x14, virtual true, abstract: false, final false
  inline int32_t GetEra(::System::DateTime time);

  /// @brief Method GetEraInfo, addr 0x5a8fa44, size 0x49c, virtual false, abstract: false, final false
  static inline ::ArrayW<::System::Globalization::EraInfo*> GetEraInfo();

  /// @brief Method GetErasFromRegistry, addr 0x5a8fee0, size 0x8, virtual false, abstract: false, final false
  static inline ::ArrayW<::System::Globalization::EraInfo*> GetErasFromRegistry();

  /// @brief Method GetMonth, addr 0x5a901ec, size 0x14, virtual true, abstract: false, final false
  inline int32_t GetMonth(::System::DateTime time);

  /// @brief Method GetMonthsInYear, addr 0x5a901b4, size 0x24, virtual true, abstract: false, final false
  inline int32_t GetMonthsInYear(int32_t year, int32_t era);

  /// @brief Method GetYear, addr 0x5a90200, size 0x14, virtual true, abstract: false, final false
  inline int32_t GetYear(::System::DateTime time);

  /// @brief Method IsLeapYear, addr 0x5a90214, size 0x14, virtual true, abstract: false, final false
  inline bool IsLeapYear(int32_t year, int32_t era);

  /// @brief Method IsValidYear, addr 0x5a9038c, size 0x28, virtual true, abstract: false, final false
  inline bool IsValidYear(int32_t year, int32_t era);

  static inline ::System::Globalization::JapaneseCalendar* New_ctor();

  /// @brief Method ToDateTime, addr 0x5a90228, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method ToFourDigitYear, addr 0x5a90248, size 0x130, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a8ff98, size 0x1c4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Eras, addr 0x5a90378, size 0x14, virtual true, abstract: false, final false
  inline ::ArrayW<int32_t> get_Eras();

  /// @brief Method get_ID, addr 0x5a9015c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ID();

  /// @brief Method get_MaxSupportedDateTime, addr 0x5a8f9e8, size 0x5c, virtual true, abstract: false, final false
  inline ::System::DateTime get_MaxSupportedDateTime();

  /// @brief Method get_MinSupportedDateTime, addr 0x5a8f98c, size 0x5c, virtual true, abstract: false, final false
  inline ::System::DateTime get_MinSupportedDateTime();

  /// @brief Method get_TwoDigitYearMax, addr 0x5a903b4, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method set_TwoDigitYearMax, addr 0x5a903f8, size 0x124, virtual true, abstract: false, final false
