...
public:
  ...
  /// @brief Method AddNonLetter, addr 0x5a936d8, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method AddTitlecaseLetter, addr 0x5a93574, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method ChangeCase, addr 0x5a93828, size 0xf4, virtual false, abstract: false, final false
  inline void ChangeCase(::System::ReadOnlySpan_1<char16_t> source, ::System::Span_1<char16_t> destination, bool toUpper);

  /// @brief Method Clone, addr 0x5a92390, size 0x88, virtual true, abstract: false, final false
  inline ::System::Object* Clone();

  /// @brief Method Equals, addr 0x5a93100, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x5a931a8, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsAscii, addr 0x5a9247c, size 0x10, virtual false, abstract: false, final false
  static inline bool IsAscii(char16_t c);

  /// @brief Method IsLetterCategory, addr 0x5a936b0, size 0xc, virtual false, abstract: false, final false
  static inline bool IsLetterCategory(::System::Globalization::UnicodeCategory uc);

  /// @brief Method IsWordSeparator, addr 0x5a936bc, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDeserialized, addr 0x5a92210, size 0xf0, virtual false, abstract: false, final false
  inline void OnDeserialized();

  /// @brief Method OnDeserialized, addr 0x5a92300, size 0x4, virtual false, abstract: false, final false
  inline void OnDeserialized(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnDeserializing, addr 0x5a92208, size 0x8, virtual false, abstract: false, final false
  inline void OnDeserializing(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnSerializing, addr 0x5a92304, size 0x84, virtual false, abstract: false, final false
  inline void OnSerializing(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method SetReadOnlyState, addr 0x5a92418, size 0x8, virtual false, abstract: false, final false
  inline void SetReadOnlyState(bool readOnly);

  /// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization, addr 0x5a9378c, size 0x4, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::System::Object* sender);

  /// @brief Method ToLower, addr 0x5a929fc, size 0x54, virtual true, abstract: false, final false
  inline ::StringW ToLower(::StringW str);

  /// @brief Method ToLower, addr 0x5a92420, size 0x5c, virtual true, abstract: false, final false
  inline char16_t ToLower(char16_t c);

  /// @brief Method ToLowerAsciiInvariant, addr 0x5a92588, size 0x18, virtual false, abstract: false, final false
  static inline char16_t ToLowerAsciiInvariant(char16_t c);

  /// @brief Method ToLowerInternal, addr 0x5a92a50, size 0xa4, virtual false, abstract: false, final false
  inline ::StringW ToLowerInternal(::StringW str);

  /// @brief Method ToLowerInternal, addr 0x5a925a0, size 0x45c, virtual false, abstract: false, final false
  inline char16_t ToLowerInternal(char16_t c);

  /// @brief Method ToString, addr 0x5a931c4, size 0x5c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToTitleCase, addr 0x5a93220, size 0x354, virtual false, abstract: false, final false
  inline ::StringW ToTitleCase(::StringW str);

  /// @brief Method ToUpper, addr 0x5a93008, size 0x54, virtual true, abstract: false, final false
  inline ::StringW ToUpper(::StringW str);

  /// @brief Method ToUpper, addr 0x5a92af4, size 0x60, virtual true, abstract: false, final false
  inline char16_t ToUpper(char16_t c);

  /// @brief Method ToUpperAsciiInvariant, addr 0x5a92b54, size 0x1c, virtual false, abstract: false, final false
  static inline char16_t ToUpperAsciiInvariant(char16_t c);

  /// @brief Method ToUpperAsciiInvariant, addr 0x5a93790, size 0x98, virtual false, abstract: false, final false
  inline void ToUpperAsciiInvariant(::System::ReadOnlySpan_1<char16_t> source, ::System::Span_1<char16_t> destination);

  /// @brief Method ToUpperInternal, addr 0x5a9305c, size 0xa4, virtual false, abstract: false, final false
  inline ::StringW ToUpperInternal(::StringW str);

  /// @brief Method ToUpperInternal, addr 0x5a92b70, size 0x498, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a9391c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5a921e8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CultureName, addr 0x5a92388, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_CultureName();

  /// @brief Method get_Invariant, addr 0x5a92144, size 0xa4, virtual false, abstract: false, final false
  static inline ::System::Globalization::TextInfo* get_Invariant();

  /// @brief Method get_IsAsciiCasingSameAsInvariant, addr 0x5a9248c, size 0xfc, virtual false, abstract: false, final false
