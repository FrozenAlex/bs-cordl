...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x62b40fc, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x62b4630, size 0x24, virtual true, abstract: false, final false
  inline int32_t EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x62b4934, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62b407c, size 0x80, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x62b4464, size 0x74, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::ArrayW<uint8_t> array, int32_t offset, int32_t count, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x62b479c, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x62b4948, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62b43e4, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  ...
  /// @brief Method BeginRead, addr 0x62b3e08, size 0x274, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginWrite, addr 0x62b4170, size 0x274, virtual true, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x62b3620, size 0xb8, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndRead, addr 0x62b44d8, size 0x158, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* asyncResult);

  /// @brief Method EndWrite, addr 0x62b4654, size 0x148, virtual true, abstract: false, final false
  inline void EndWrite(::System::IAsyncResult* asyncResult);

  /// @brief Method Finalize, addr 0x62b35cc, size 0x54, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Flush, addr 0x62b3d00, size 0xb0, virtual true, abstract: false, final false
  inline void Flush();
  ...
  /// @brief Method Read, addr 0x62b38a8, size 0x1d0, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t> array, int32_t offset, int32_t count);

  /// @brief Method ReadAsyncMemory, addr 0x62b31a0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadCore, addr 0x62b2cd4, size 0x128, virtual false, abstract: false, final false
  inline int32_t ReadCore(::System::Span_1<uint8_t> destination);

  /// @brief Method ReadInternal, addr 0x62b37ec, size 0x40, virtual false, abstract: false, final false
  inline int32_t ReadInternal(::ArrayW<uint8_t> array, int32_t offset, int32_t count);

  /// @brief Method Seek, addr 0x62b47a8, size 0x38, virtual true, abstract: false, final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength, addr 0x62b47e0, size 0x38, virtual true, abstract: false, final false
  inline void SetLength(int64_t value);

  /// @brief Method Write, addr 0x62b3b24, size 0x1dc, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t> array, int32_t offset, int32_t count);

  /// @brief Method WriteAsyncMemory, addr 0x62b3288, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteCore, addr 0x62b2fa0, size 0x9c, virtual false, abstract: false, final false
  inline void WriteCore(::System::ReadOnlySpan_1<uint8_t> source);

  /// @brief Method WriteInternal, addr 0x62b3a78, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62b332c, size 0x158, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* compressedStream, ::System::IO::Compression::CompressionMode mode, bool leaveOpen, bool gzip);

  /// @brief Method .ctor, addr 0x62b35c4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62b28cc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62b3320, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* stream, ::System::IO::Compression::CompressionMode mode);

  /// @brief Method .ctor, addr 0x62b281c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* stream, ::System::IO::Compression::CompressionMode mode, bool leaveOpen, int32_t windowsBits);

  /// @brief Method get_CanRead, addr 0x62b4818, size 0x34, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x62b484c, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanWrite, addr 0x62b4854, size 0x38, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_Length, addr 0x62b488c, size 0x38, virtual true, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_Position, addr 0x62b48c4, size 0x38, virtual true, abstract: false, final false
  inline int64_t get_Position();

  /// @brief Method set_Position, addr 0x62b48fc, size 0x38, virtual true, abstract: false, final false
