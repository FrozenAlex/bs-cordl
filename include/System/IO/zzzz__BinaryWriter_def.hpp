...
public:
  ...
  /// @brief Method Close, addr 0x5c13720, size 0x10, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x5c13784, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x5c13730, size 0x54, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method DisposeAsync, addr 0x5c137b4, size 0x1b0, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::ValueTask DisposeAsync();

  /// @brief Method Flush, addr 0x5c13794, size 0x20, virtual true, abstract: false, final false
  inline void Flush();
  ...
  /// @brief Method Write, addr 0x5c139f4, size 0x78, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t> buffer);

  /// @brief Method Write, addr 0x5c13a6c, size 0x20, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t> buffer, int32_t index, int32_t count);

  /// @brief Method Write, addr 0x5c13a8c, size 0xf0, virtual true, abstract: false, final false
  inline void Write(char16_t ch);

  /// @brief Method Write, addr 0x5c13b7c, size 0xa4, virtual true, abstract: false, final false
  inline void Write(::ArrayW<char16_t> chars);

  /// @brief Method Write, addr 0x5c140e0, size 0x298, virtual true, abstract: false, final false
  inline void Write(::StringW value);

  /// @brief Method Write, addr 0x5c13964, size 0x50, virtual true, abstract: false, final false
  inline void Write(bool value);

  /// @brief Method Write, addr 0x5c13c20, size 0x48, virtual true, abstract: false, final false
  inline void Write(double_t value);

  /// @brief Method Write, addr 0x5c14098, size 0x48, virtual true, abstract: false, final false
  inline void Write(float_t value);

  /// @brief Method Write, addr 0x5c13c68, size 0x68, virtual true, abstract: false, final false
  inline void Write(int16_t value);

  /// @brief Method Write, addr 0x5c13d38, size 0xa0, virtual true, abstract: false, final false
  inline void Write(int32_t value);

  /// @brief Method Write, addr 0x5c13e78, size 0x110, virtual true, abstract: false, final false
  inline void Write(int64_t value);

  /// @brief Method Write, addr 0x5c139d4, size 0x20, virtual true, abstract: false, final false
  inline void Write(int8_t value);

  /// @brief Method Write, addr 0x5c13cd0, size 0x68, virtual true, abstract: false, final false
  inline void Write(uint16_t value);

  /// @brief Method Write, addr 0x5c13dd8, size 0xa0, virtual true, abstract: false, final false
  inline void Write(uint32_t value);

  /// @brief Method Write, addr 0x5c13f88, size 0x110, virtual true, abstract: false, final false
  inline void Write(uint64_t value);

  /// @brief Method Write, addr 0x5c139b4, size 0x20, virtual true, abstract: false, final false
  inline void Write(uint8_t value);

  /// @brief Method Write7BitEncodedInt, addr 0x5c14378, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c13414, size 0x104, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5c13518, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* output);

  /// @brief Method .ctor, addr 0x5c13718, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* output, ::System::Text::Encoding* encoding);

  /// @brief Method .ctor, addr 0x5c135b8, size 0x160, virtual false, abstract: false, final false
