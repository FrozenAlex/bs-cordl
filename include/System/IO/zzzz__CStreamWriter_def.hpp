...
public:
  ...
  /// @brief Method InternalWriteChar, addr 0x5c1e5d0, size 0x88, virtual false, abstract: false, final false
  inline void InternalWriteChar(char16_t val);

  /// @brief Method InternalWriteChars, addr 0x5c1e6e0, size 0x90, virtual false, abstract: false, final false
  inline void InternalWriteChars(::ArrayW<char16_t> buffer, int32_t n);

  /// @brief Method InternalWriteString, addr 0x5c1e658, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x5c1e048, size 0x3d0, virtual true, abstract: false, final false
  inline void Write(::ArrayW<char16_t> buffer, int32_t index, int32_t count);

  /// @brief Method Write, addr 0x5c1e770, size 0x24, virtual true, abstract: false, final false
  inline void Write(::ArrayW<char16_t> val);

  /// @brief Method Write, addr 0x5c1e794, size 0xd0, virtual true, abstract: false, final false
  inline void Write(::StringW val);

  /// @brief Method Write, addr 0x5c1e418, size 0x1b8, virtual true, abstract: false, final false
  inline void Write(char16_t val);

  /// @brief Method WriteLine, addr 0x5c1e864, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c1df10, size 0x138, virtual false, abstract: false, final false
