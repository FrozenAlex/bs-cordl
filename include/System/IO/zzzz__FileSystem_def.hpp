...
public:
  // Declarations
  /// @brief Method CopyDanglingSymlink, addr 0x5befd3c, size 0x16c, virtual false, abstract: false, final false
  static inline bool CopyDanglingSymlink(::StringW sourceFullPath, ::StringW destFullPath);

  /// @brief Method CopyFile, addr 0x5befea8, size 0x3c0, virtual false, abstract: false, final false
  static inline void CopyFile(::StringW sourceFullPath, ::StringW destFullPath, bool overwrite);

  /// @brief Method CreateDirectory, addr 0x5bf0c28, size 0x5a4, virtual false, abstract: false, final false
  static inline void CreateDirectory(::StringW fullPath);

  /// @brief Method DeleteFile, addr 0x5bf082c, size 0x1a8, virtual false, abstract: false, final false
  static inline void DeleteFile(::StringW fullPath);

  /// @brief Method DirectoryExists, addr 0x5bf0268, size 0x1c, virtual false, abstract: false, final false
  static inline bool DirectoryExists(::System::ReadOnlySpan_1<char16_t> fullPath);

  /// @brief Method DirectoryExists, addr 0x5bf1450, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method FileExists, addr 0x5bf13d4, size 0x7c, virtual false, abstract: false, final false
  static inline bool FileExists(::System::ReadOnlySpan_1<char16_t> fullPath);

  /// @brief Method FileExists, addr 0x5bf0b14, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributes, addr 0x5bf1e70, size 0x8c, virtual false, abstract: false, final false
  static inline ::System::IO::FileAttributes GetAttributes(::StringW fullPath);

  /// @brief Method GetLogicalDrives, addr 0x5bf2020, size 0x4, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW> GetLogicalDrives();

  /// @brief Method LinkOrCopyFile, addr 0x5bf0284, size 0x18c, virtual false, abstract: false, final false
  static inline void LinkOrCopyFile(::StringW sourceFullPath, ::StringW destFullPath);

  /// @brief Method MoveFile, addr 0x5bf0710, size 0x11c, virtual false, abstract: false, final false
  static inline void MoveFile(::StringW sourceFullPath, ::StringW destFullPath);

  /// @brief Method RemoveDirectory, addr 0x5bf145c, size 0xc0, virtual false, abstract: false, final false
  static inline void RemoveDirectory(::StringW fullPath, bool recursive);

  /// @brief Method RemoveDirectoryInternal, addr 0x5bf15a8, size 0x68c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceFile, addr 0x5bf05a0, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldIgnoreDirectory, addr 0x5bf1cf8, size 0x84, virtual false, abstract: false, final false
