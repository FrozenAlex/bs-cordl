...
public:
  ...
  /// @brief Method Dispose, addr 0x5bf6ab8, size 0x28, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x5bf6a64, size 0x54, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::System::IO::PinnedBufferMemoryStream* New_ctor(::ArrayW<uint8_t> array);

  /// @brief Method Read, addr 0x5bf6580, size 0x4, virtual true, abstract: false, final false
  inline int32_t Read(::System::Span_1<uint8_t> buffer);

  /// @brief Method Write, addr 0x5bf6784, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bf627c, size 0xbc, virtual false, abstract: false, final false
