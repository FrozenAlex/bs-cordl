...
// Write type traits
MARK_REF_T(::System::IO::StreamHelpers*);
DEFINE_IL2CPP_CLASS(::System::IO::StreamHelpers*, "System.IO", "StreamHelpers");
...
public:
  // Declarations
  /// @brief Method ValidateCopyToArgs, addr 0x5abcb0c, size 0x220, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::IO::StreamHelpers) == 0x10, "Size mismatch!");
