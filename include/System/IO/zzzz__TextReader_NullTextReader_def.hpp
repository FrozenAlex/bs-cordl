...
public:
  ...
  /// @brief Method Read, addr 0x5ac7760, size 0x8, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<char16_t> buffer, int32_t index, int32_t count);

  /// @brief Method ReadLine, addr 0x5ac7768, size 0x8, virtual true, abstract: false, final false
  inline ::StringW ReadLine();

  /// @brief Method .ctor, addr 0x5ac7708, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
