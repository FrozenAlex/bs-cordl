...
public:
  ...
  /// @brief Method Close, addr 0x5ac7770, size 0x1c, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x5ac778c, size 0xc4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  static inline ::GlobalNamespace::TextReader_SyncTextReader* New_ctor(::System::IO::TextReader* t);

  /// @brief Method Peek, addr 0x5ac7850, size 0x1c, virtual true, abstract: false, final false
  inline int32_t Peek();

  /// @brief Method Read, addr 0x5ac786c, size 0x1c, virtual true, abstract: false, final false
  inline int32_t Read();

  /// @brief Method Read, addr 0x5ac7888, size 0x1c, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<char16_t> buffer, int32_t index, int32_t count);

  /// @brief Method ReadAsync, addr 0x5ac78e4, size 0x1cc, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<char16_t> buffer, int32_t index, int32_t count);

  /// @brief Method ReadLine, addr 0x5ac78a4, size 0x20, virtual true, abstract: false, final false
  inline ::StringW ReadLine();

  /// @brief Method ReadToEnd, addr 0x5ac78c4, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ac7630, size 0x64, virtual false, abstract: false, final false
