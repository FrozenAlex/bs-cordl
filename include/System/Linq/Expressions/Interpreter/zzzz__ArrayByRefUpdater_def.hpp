...
public:
  ...
  /// @brief Method UndefineTemps, addr 0x5e6e004, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x5e6df4c, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e6df3c, size 0x10, virtual false, abstract: false, final false
