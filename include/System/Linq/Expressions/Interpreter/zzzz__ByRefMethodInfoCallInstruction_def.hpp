...
public:
  ...
  /// @brief Method Run, addr 0x5e4e3c8, size 0x4f4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5e4e350, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ProducedStack, addr 0x5e4e360, size 0x68, virtual true, abstract: false, final false
