...
public:
  // Declarations
  /// @brief Method ConvertNull, addr 0x5e7f45c, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e7f2fc, size 0x8, virtual false, abstract: false, final false
