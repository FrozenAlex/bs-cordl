...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::CastInstruction_CastInstructionNoT::*)(::System::Type*)>(
  ...
  constexpr static std::size_t addrs = 0x5e7f2ec;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::CastInstruction_CastInstructionNoT*>(), { ".ctor", {}, { ::i2c::type_of<::System::Type*>() } })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Linq::Expressions::Interpreter::CastInstruction* (*)(::System::Type*)>(
  ...
  constexpr static std::size_t addrs = 0x5e7f21c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::CastInstruction_CastInstructionNoT*>(), { "Create", {}, { ::i2c::type_of<::System::Type*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::CastInstruction_CastInstructionNoT::*)(::System::Linq::Expressions::Interpreter::InterpretedFrame*)>(
    &::GlobalNamespace::CastInstruction_CastInstructionNoT::ConvertNull)> {
...
inline int32_t GlobalNamespace::CastInstruction_CastInstructionNoT::Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::CastInstruction_CastInstructionNoT*>(), 8 })));
...
inline void GlobalNamespace::CastInstruction_CastInstructionNoT::ConvertNull(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::CastInstruction_CastInstructionNoT*>(), 11 })));
