...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::System::Linq::Expressions::Interpreter::CastReferenceToEnumInstruction::*)(::System::Type*)>(
  ...
  constexpr static std::size_t addrs = 0x5e7f534;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Linq::Expressions::Interpreter::CastReferenceToEnumInstruction*>(), { ".ctor", {}, { ::i2c::type_of<::System::Type*>() } })));
...
inline int32_t System::Linq::Expressions::Interpreter::CastReferenceToEnumInstruction::Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame) {
  auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Linq::Expressions::Interpreter::CastReferenceToEnumInstruction*>(), 8 })));
