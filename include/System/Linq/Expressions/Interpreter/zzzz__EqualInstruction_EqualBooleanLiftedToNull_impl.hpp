...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::GlobalNamespace::EqualInstruction_EqualBooleanLiftedToNull::*)(::System::Linq::Expressions::Interpreter::InterpretedFrame*)>(
  ...
  constexpr static std::size_t addrs = 0x5e53218;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::EqualInstruction_EqualBooleanLiftedToNull::*)()>(
  ...
  constexpr static std::size_t addrs = 0x5e52980;
...
inline int32_t GlobalNamespace::EqualInstruction_EqualBooleanLiftedToNull::Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::EqualInstruction_EqualBooleanLiftedToNull*>(), 8 })));
