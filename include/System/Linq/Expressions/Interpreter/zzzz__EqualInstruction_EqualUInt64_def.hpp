...
public:
  ...
  /// @brief Method Run, addr 0x5e52fcc, size 0xa8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5e529d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
