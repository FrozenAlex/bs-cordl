...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::GlobalNamespace::ExclusiveOrInstruction_ExclusiveOrUInt32::*)(::System::Linq::Expressions::Interpreter::InterpretedFrame*)>(
  ...
  constexpr static std::size_t addrs = 0x5f8d294;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::ExclusiveOrInstruction_ExclusiveOrUInt32::*)()>(&::GlobalNamespace::ExclusiveOrInstruction_ExclusiveOrUInt32::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5f8d340;
...
inline int32_t GlobalNamespace::ExclusiveOrInstruction_ExclusiveOrUInt32::Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::ExclusiveOrInstruction_ExclusiveOrUInt32*>(), 8 })));
