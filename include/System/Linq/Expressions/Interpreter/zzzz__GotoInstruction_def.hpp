...
public:
  ...
  /// @brief Method Create, addr 0x5e4f374, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method Run, addr 0x5e4f4d4, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e4f360, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ConsumedStack, addr 0x5e4f350, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5e4f30c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5e4f358, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::GotoInstruction) == 0x18, "Size mismatch!");
