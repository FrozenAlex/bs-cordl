...
public:
  ...
  /// @brief Method Run, addr 0x5f8e380, size 0xa4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f8e1f0, size 0x8, virtual false, abstract: false, final false
