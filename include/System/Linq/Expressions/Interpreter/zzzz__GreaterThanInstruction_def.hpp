...
public:
  ...
  /// @brief Method Create, addr 0x5e54a88, size 0x8c0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e54a80, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ConsumedStack, addr 0x5e54a2c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5e54a3c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5e54a34, size 0x8, virtual true, abstract: false, final false
