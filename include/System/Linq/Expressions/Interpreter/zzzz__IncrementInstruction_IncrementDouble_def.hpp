...
public:
  ...
  /// @brief Method Run, addr 0x5e5733c, size 0x88, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5e56ee8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
