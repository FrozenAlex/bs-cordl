...
public:
  ...
  /// @brief Method UndefineTemps, addr 0x5e6e778, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x5e6e504, size 0x274, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e6e4e8, size 0x1c, virtual false, abstract: false, final false
