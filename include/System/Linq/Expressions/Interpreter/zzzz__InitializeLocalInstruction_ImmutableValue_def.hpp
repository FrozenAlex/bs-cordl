...
public:
  ...
  /// @brief Method BoxIfIndexMatches, addr 0x5e726f4, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method Run, addr 0x5e72688, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e7267c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t index, ::System::Object* defaultValue);

  /// @brief Method get_InstructionName, addr 0x5e72778, size 0x44, virtual true, abstract: false, final false
