...
public:
  // Declarations
  /// @brief Method ToString, addr 0x5f99b28, size 0x7c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x5f96dd4, size 0x8, virtual false, abstract: false, final false
