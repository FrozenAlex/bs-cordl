...
public:
  ...
  /// @brief Method BoxIfIndexMatches, addr 0x5faa730, size 0x88, virtual true, abstract: false, final true
  ...
  /// @brief Method Run, addr 0x5faa6a8, size 0x88, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5faa654, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t index);

  /// @brief Method get_InstructionName, addr 0x5faa664, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5faa65c, size 0x8, virtual true, abstract: false, final false
