...
public:
  ...
  /// @brief Method Equals, addr 0x5fac128, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x5fac1b4, size 0x2c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x5fac10c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t localIndex, ::System::Linq::Expressions::ParameterExpression* parameter);

  /// @brief Method get_Index, addr 0x5fac118, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Index();

  /// @brief Method get_Parameter, addr 0x5fac120, size 0x8, virtual false, abstract: false, final false
