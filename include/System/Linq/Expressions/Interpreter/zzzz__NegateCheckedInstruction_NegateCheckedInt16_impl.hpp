...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt16::*)(::System::Linq::Expressions::Interpreter::InterpretedFrame*)>(
  ...
  constexpr static std::size_t addrs = 0x5e76638;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt16::*)()>(
  ...
  constexpr static std::size_t addrs = 0x5e7656c;
...
inline int32_t GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt16::Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt16*>(), 8 })));
