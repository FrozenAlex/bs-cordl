...
public:
  ...
  /// @brief Method Create, addr 0x5e763cc, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e763c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ConsumedStack, addr 0x5e76374, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5e76384, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5e7637c, size 0x8, virtual true, abstract: false, final false
