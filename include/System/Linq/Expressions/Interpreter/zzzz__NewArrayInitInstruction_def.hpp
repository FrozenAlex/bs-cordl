...
public:
  ...
  /// @brief Method Run, addr 0x5f857f8, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f85798, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* elementType, int32_t elementCount);

  /// @brief Method get_ConsumedStack, addr 0x5f857a4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5f857b4, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5f857ac, size 0x8, virtual true, abstract: false, final false
