...
public:
  ...
  /// @brief Method Run, addr 0x5e77928, size 0xac, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5e776fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
