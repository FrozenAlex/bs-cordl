...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::GlobalNamespace::NotInstruction_NotInt64::*)(::System::Linq::Expressions::Interpreter::InterpretedFrame*)>(
  ...
  constexpr static std::size_t addrs = 0x5e78ba0;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::GlobalNamespace::NotInstruction_NotInt64*>(), { ::i2c::class_of<::GlobalNamespace::NotInstruction_NotInt64*>(), 8 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::NotInstruction_NotInt64::*)()>(&::GlobalNamespace::NotInstruction_NotInt64::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5e78b08;
...
inline int32_t GlobalNamespace::NotInstruction_NotInt64::Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::NotInstruction_NotInt64*>(), 8 })));
