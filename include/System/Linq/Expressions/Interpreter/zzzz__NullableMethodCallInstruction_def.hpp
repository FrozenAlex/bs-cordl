...
public:
  ...
  /// @brief Method Create, addr 0x5e7e4d0, size 0x360, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateGetValue, addr 0x5e7e87c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e7e4cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ConsumedStack, addr 0x5e7e478, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5e7e488, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5e7e480, size 0x8, virtual true, abstract: false, final false
