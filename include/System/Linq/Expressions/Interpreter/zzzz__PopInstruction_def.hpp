...
public:
  ...
  /// @brief Method Run, addr 0x5fb5594, size 0x24, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb5544, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Linq::Expressions::Interpreter::PopInstruction* getStaticF_Instance();

  /// @brief Method get_ConsumedStack, addr 0x5fb5548, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5fb5550, size 0x44, virtual true, abstract: false, final false
