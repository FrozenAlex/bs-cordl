...
public:
  ...
  /// @brief Method Run, addr 0x5e7e168, size 0x60, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method ToString, addr 0x5e7e1c8, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e7e10c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_ConsumedStack, addr 0x5e7e114, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5e7e124, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5e7e11c, size 0x8, virtual true, abstract: false, final false
