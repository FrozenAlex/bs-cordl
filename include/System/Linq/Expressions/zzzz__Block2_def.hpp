...
public:
  ...
  /// @brief Method GetExpression, addr 0x5e38660, size 0xa4, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x5e3876c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5e38774, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e38638, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Expression* arg0, ::System::Linq::Expressions::Expression* arg1);

  /// @brief Method get_ExpressionCount, addr 0x5e38764, size 0x8, virtual true, abstract: false, final false
