...
public:
  ...
  /// @brief Method GetExpression, addr 0x5e38838, size 0xb4, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x5e388f4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5e388fc, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e38800, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x5e388ec, size 0x8, virtual true, abstract: false, final false
