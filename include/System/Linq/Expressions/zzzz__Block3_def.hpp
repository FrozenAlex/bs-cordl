...
public:
  ...
  /// @brief Method GetExpression, addr 0x5f716d0, size 0xb4, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x5f7178c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f71794, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f71698, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x5f71784, size 0x8, virtual true, abstract: false, final false
