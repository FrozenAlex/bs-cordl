...
public:
  ...
  /// @brief Method MoveNext, addr 0x5e39a2c, size 0xc4, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::Linq::Expressions::BlockExpressionList__GetEnumerator_d__18* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Linq.Expressions.Expression>.get_Current, addr 0x5e39af0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5e39af8, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5e39b30, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5e39a28, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5e39a1c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x5e39764, size 0x28, virtual true, abstract: false, final true
  inline void Add(::System::Linq::Expressions::Expression* item);

  /// @brief Method Clear, addr 0x5e3978c, size 0x28, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method Contains, addr 0x5e397b4, size 0x18, virtual true, abstract: false, final true
  inline bool Contains(::System::Linq::Expressions::Expression* item);

  /// @brief Method CopyTo, addr 0x5e397cc, size 0x190, virtual true, abstract: false, final true
  inline void CopyTo(::ArrayW<::System::Linq::Expressions::Expression*> array, int32_t index);

  /// @brief Method GetEnumerator, addr 0x5e399c8, size 0x54, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::System::Linq::Expressions::Expression*>* GetEnumerator();

  /// @brief Method IndexOf, addr 0x5e3963c, size 0x88, virtual true, abstract: false, final true
  inline int32_t IndexOf(::System::Linq::Expressions::Expression* item);

  /// @brief Method Insert, addr 0x5e396c4, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method Remove, addr 0x5e399a0, size 0x28, virtual true, abstract: false, final true
  inline bool Remove(::System::Linq::Expressions::Expression* item);

  /// @brief Method RemoveAt, addr 0x5e396ec, size 0x28, virtual true, abstract: false, final true
  inline void RemoveAt(int32_t index);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x5e39a24, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5e38630, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::BlockExpression* provider, ::System::Linq::Expressions::Expression* arg0);

  /// @brief Method get_Count, addr 0x5e3995c, size 0x1c, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly, addr 0x5e39978, size 0x28, virtual true, abstract: false, final true
  inline bool get_IsReadOnly();

  /// @brief Method get_Item, addr 0x5e39714, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Item, addr 0x5e3973c, size 0x28, virtual true, abstract: false, final true
