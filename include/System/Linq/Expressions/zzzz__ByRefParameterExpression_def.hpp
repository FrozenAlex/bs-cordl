...
public:
  // Declarations
  /// @brief Method GetIsByRef, addr 0x5f81a9c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f819dc, size 0x28, virtual false, abstract: false, final false
