...
public:
  ...
  /// @brief Method GetConversion, addr 0x5e226fc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e226d8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NodeType, addr 0x5e22704, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Type, addr 0x5e2270c, size 0x1c, virtual true, abstract: false, final true
