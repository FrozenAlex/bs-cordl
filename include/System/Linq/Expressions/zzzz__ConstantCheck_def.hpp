...
public:
  // Declarations
  /// @brief Method AnalyzeTypeIs, addr 0x5e39cc4, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method AnalyzeTypeIs, addr 0x5e39cac, size 0x18, virtual false, abstract: false, final false
