...
public:
  ...
  /// @brief Method ValidateBinary, addr 0x5e43d90, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateChildType, addr 0x5e44e68, size 0xfc, virtual false, abstract: false, final false
  static inline void ValidateChildType(::System::Type* before, ::System::Type* after, ::StringW methodName);

  /// @brief Method ValidateUnary, addr 0x5e44d6c, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method Visit, addr 0x5e43a60, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method Visit, addr 0x5e43a3c, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method VisitLoop, addr 0x5e44340, size 0x84, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitLoop(::System::Linq::Expressions::LoopExpression* node);

  /// @brief Method VisitMember, addr 0x5e44480, size 0x30, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitMember(::System::Linq::Expressions::MemberExpression* node);

  /// @brief Method VisitMethodCall, addr 0x5e44648, size 0xa4, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitMethodCall(::System::Linq::Expressions::MethodCallExpression* node);

  /// @brief Method VisitNewArray, addr 0x5e446ec, size 0x28, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitNewArray(::System::Linq::Expressions::NewArrayExpression* node);

  /// @brief Method VisitParameter, addr 0x5e4488c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitParameter(::System::Linq::Expressions::ParameterExpression* node);

  /// @brief Method VisitParameters, addr 0x5e43ca4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method VisitTry, addr 0x5e44958, size 0x104, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitTry(::System::Linq::Expressions::TryExpression* node);

  /// @brief Method VisitTypeBinary, addr 0x5e44b6c, size 0x30, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitTypeBinary(::System::Linq::Expressions::TypeBinaryExpression* node);

  /// @brief Method VisitUnary, addr 0x5e44c6c, size 0x3c, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitUnary(::System::Linq::Expressions::UnaryExpression* node);

  /// @brief Method .ctor, addr 0x5e41484, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
