...
public:
  ...
  /// @brief Method .ctor, addr 0x5e3a09c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x5e3a294, size 0x8, virtual true, abstract: false, final true
