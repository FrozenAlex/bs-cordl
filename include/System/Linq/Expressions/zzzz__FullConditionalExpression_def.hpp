...
public:
  ...
  /// @brief Method GetFalse, addr 0x5e3a28c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e3a0c4, size 0x24, virtual false, abstract: false, final false
