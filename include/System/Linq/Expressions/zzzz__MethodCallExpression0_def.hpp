...
public:
  ...
  /// @brief Method GetArgument, addr 0x5e46ab8, size 0x4c, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetArgument(int32_t index);

  static inline ::System::Linq::Expressions::MethodCallExpression0* New_ctor(::System::Reflection::MethodInfo* method);

  /// @brief Method Rewrite, addr 0x5e46b0c, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e46ab4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* method);

  /// @brief Method get_ArgumentCount, addr 0x5e46b04, size 0x8, virtual true, abstract: false, final false
