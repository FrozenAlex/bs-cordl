...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::System::Linq::Expressions::MethodCallExpression1::*)(::System::Reflection::MethodInfo*, ::System::Linq::Expressions::Expression*)>(
  ...
  constexpr static std::size_t addrs = 0x5e46b6c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Linq::Expressions::MethodCallExpression1*>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Linq::Expressions::Expression* (::System::Linq::Expressions::MethodCallExpression1::*)(int32_t)>(
  ...
  constexpr static std::size_t addrs = 0x5e46b90;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::System::Linq::Expressions::MethodCallExpression1*>(), { ::i2c::class_of<::System::Linq::Expressions::MethodCallExpression1*>(), 14 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::System::Linq::Expressions::MethodCallExpression1::*)()>(&::System::Linq::Expressions::MethodCallExpression1::get_ArgumentCount)> {
  ...
  constexpr static std::size_t addrs = 0x5e46c34;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::System::Linq::Expressions::MethodCallExpression1*>(), { ::i2c::class_of<::System::Linq::Expressions::MethodCallExpression1*>(), 15 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Linq::Expressions::MethodCallExpression* (
  ...
  constexpr static std::size_t addrs = 0x5e46c3c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::System::Linq::Expressions::MethodCallExpression1*>(), { ::i2c::class_of<::System::Linq::Expressions::MethodCallExpression1*>(), 13 }));
    return ___internal_method;
  }
};
...
inline ::System::Linq::Expressions::Expression* System::Linq::Expressions::MethodCallExpression1::GetArgument(int32_t index) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Linq::Expressions::MethodCallExpression1*>(), 14 })));
...
inline int32_t System::Linq::Expressions::MethodCallExpression1::get_ArgumentCount() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Linq::Expressions::MethodCallExpression1*>(), 15 })));
...
System::Linq::Expressions::MethodCallExpression1::Rewrite(::System::Linq::Expressions::Expression* instance,
  ...
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Linq::Expressions::MethodCallExpression1*>(), 13 })));
