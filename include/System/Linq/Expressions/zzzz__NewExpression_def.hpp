...
public:
  ...
  /// @brief Method GetArgument, addr 0x5e484c8, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method get_Constructor, addr 0x5e484c0, size 0x8, virtual false, abstract: false, final false
