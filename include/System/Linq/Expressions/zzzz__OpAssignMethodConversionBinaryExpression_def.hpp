...
public:
  ...
  /// @brief Method GetConversion, addr 0x5e227b0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e22728, size 0x48, virtual false, abstract: false, final false
