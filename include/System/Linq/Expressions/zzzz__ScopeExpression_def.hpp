...
public:
  ...
  /// @brief Method GetOrMakeVariables, addr 0x5e38f90, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method ReuseOrValidateVariables, addr 0x5e38fe4, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e38f6c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::ParameterExpression*>* variables);

  /// @brief Method get_VariablesList, addr 0x5e38fdc, size 0x8, virtual false, abstract: false, final false
