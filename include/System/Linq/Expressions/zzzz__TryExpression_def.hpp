...
public:
  ...
  /// @brief Method Accept, addr 0x5e48d84, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x5e44a5c, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e48cc8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Body, addr 0x5e48d64, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Body();

  /// @brief Method get_Fault, addr 0x5e48d7c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Fault();

  /// @brief Method get_Finally, addr 0x5e48d74, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Finally();

  /// @brief Method get_Handlers, addr 0x5e48d6c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::CatchBlock*>* get_Handlers();

  /// @brief Method get_NodeType, addr 0x5e48d5c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Type, addr 0x5e48d54, size 0x8, virtual true, abstract: false, final true
