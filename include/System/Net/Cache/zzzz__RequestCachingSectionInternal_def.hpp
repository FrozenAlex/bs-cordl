...
// Write type traits
MARK_REF_T(::System::Net::Cache::RequestCachingSectionInternal*);
DEFINE_IL2CPP_CLASS(::System::Net::Cache::RequestCachingSectionInternal*, "System.Net.Cache", "RequestCachingSectionInternal");
...
public:
  ...
  /// @brief Method .ctor, addr 0x634ffd4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Net::Cache::RequestCachingSectionInternal) == 0x18, "Size mismatch!");
