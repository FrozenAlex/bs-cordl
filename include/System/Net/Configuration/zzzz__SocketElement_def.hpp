...
public:
  ...
  /// @brief Method .ctor, addr 0x62316e8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Properties, addr 0x6231724, size 0x3c, virtual true, abstract: false, final false
