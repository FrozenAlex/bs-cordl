...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Net::Http::Headers::ElementTryParser_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Net::Http::Headers::ElementTryParser_1, "System.Net.Http.Headers", "ElementTryParser`1");
...
public:
  ...
  inline bool Invoke(::System::Net::Http::Headers::Lexer* lexer, ::by_ref<T> parsedValue, ::by_ref<::System::Net::Http::Headers::Token> token);
