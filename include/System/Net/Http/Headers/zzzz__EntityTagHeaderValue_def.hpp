...
public:
  ...
  /// @brief Method Equals, addr 0x60def60, size 0xb4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x60df014, size 0x4c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::Net::Http::Headers::EntityTagHeaderValue* New_ctor();

  /// @brief Method System.ICloneable.Clone, addr 0x60def5c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x60df450, size 0x68, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x60df39c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParse, addr 0x60df060, size 0xf4, virtual false, abstract: false, final false
  static inline bool TryParse(::StringW input, ::by_ref<::System::Net::Http::Headers::EntityTagHeaderValue*> parsedValue);

  /// @brief Method TryParseElement, addr 0x60df154, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60def38, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Net::Http::Headers::EntityTagHeaderValue* getStaticF_any();

  /// @brief Method get_IsWeak, addr 0x60def3c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsWeak();

  /// @brief Method get_Tag, addr 0x60def4c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsWeak, addr 0x60def44, size 0x8, virtual false, abstract: false, final false
  inline void set_IsWeak(bool value);

  /// @brief Method set_Tag, addr 0x60def54, size 0x8, virtual false, abstract: false, final false
