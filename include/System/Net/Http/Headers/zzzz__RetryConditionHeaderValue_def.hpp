...
// Write type traits
MARK_REF_T(::System::Net::Http::Headers::RetryConditionHeaderValue*);
DEFINE_IL2CPP_CLASS(::System::Net::Http::Headers::RetryConditionHeaderValue*, "System.Net.Http.Headers", "RetryConditionHeaderValue");
...
public:
  ...
  /// @brief Method Equals, addr 0x5faebe8, size 0x1b0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x5faed98, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method System.ICloneable.Clone, addr 0x5faebe4, size 0x4, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x5faf01c, size 0x18c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x5faee34, size 0x1e8, virtual false, abstract: false, final false
  static inline bool TryParse(::StringW input, ::by_ref<::System::Net::Http::Headers::RetryConditionHeaderValue*> parsedValue);
  ...
  /// @brief Method .ctor, addr 0x5faea60, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTimeOffset date);

  /// @brief Method .ctor, addr 0x5faeac4, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::System::TimeSpan delta);

  /// @brief Method get_Date, addr 0x5faeba8, size 0x14, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::System::DateTimeOffset> get_Date();

  /// @brief Method get_Delta, addr 0x5faebd0, size 0xc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::System::TimeSpan> get_Delta();

  /// @brief Convert to "::System::ICloneable"
  constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

  /// @brief Method set_Date, addr 0x5faebbc, size 0x14, virtual false, abstract: false, final false
  inline void set_Date(::System::Nullable_1<::System::DateTimeOffset> value);

  /// @brief Method set_Delta, addr 0x5faebdc, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::Http::Headers::RetryConditionHeaderValue) == 0x38, "Size mismatch!");
