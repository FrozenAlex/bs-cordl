...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Net::Http::Headers::TryParseDelegate_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Net::Http::Headers::TryParseDelegate_1, "System.Net.Http.Headers", "TryParseDelegate`1");
...
public:
  ...
  inline bool Invoke(::StringW value, ::by_ref<T> result);
