...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Net::Http::Headers::TryParseListDelegate_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Net::Http::Headers::TryParseListDelegate_1, "System.Net.Http.Headers", "TryParseListDelegate`1");
...
public:
  ...
  inline bool Invoke(::StringW value, int32_t minimalCount, ::by_ref<::System::Collections::Generic::List_1<T>*> result);
