...
public:
  ...
  /// @brief Method CreateContentReadStreamAsync, addr 0x60d3254, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method SerializeToStreamAsync, addr 0x60d3314, size 0x24, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* SerializeToStreamAsync(::System::IO::Stream* stream, ::System::Net::TransportContext* context);

  /// @brief Method TryComputeLength, addr 0x60d3338, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60d31f0, size 0x60, virtual false, abstract: false, final false
