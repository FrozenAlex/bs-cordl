...
DEFINE_IL2CPP_CLASS(::System::Net::Http::ClientCertificateOption, "System.Net.Http", "ClientCertificateOption");
// Dependencies
namespace System::Net::Http {
// Is value type: true
...
static_assert(sizeof(::System::Net::Http::ClientCertificateOption) == 0x4, "Size mismatch!");
