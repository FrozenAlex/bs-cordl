...
DEFINE_IL2CPP_CLASS(::System::Net::Http::HttpCompletionOption, "System.Net.Http", "HttpCompletionOption");
// Dependencies
namespace System::Net::Http {
// Is value type: true
...
static_assert(sizeof(::System::Net::Http::HttpCompletionOption) == 0x4, "Size mismatch!");
