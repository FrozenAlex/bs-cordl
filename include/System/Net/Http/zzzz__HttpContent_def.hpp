...
namespace System::Net::Http {
struct HttpContent__ReadAsByteArrayAsync_d__19;
}
namespace System::Net::Http {
...
MARK_VAL_T(::System::Net::Http::HttpContent__CreateContentReadStreamAsync_d__12);
MARK_VAL_T(::System::Net::Http::HttpContent__LoadIntoBufferAsync_d__17);
MARK_VAL_T(::System::Net::Http::HttpContent__ReadAsByteArrayAsync_d__19);
MARK_VAL_T(::System::Net::Http::HttpContent__ReadAsStreamAsync_d__18);
...
DEFINE_IL2CPP_CLASS(::System::Net::Http::HttpContent__CreateContentReadStreamAsync_d__12, "System.Net.Http", "HttpContent/<CreateContentReadStreamAsync>d__12");
DEFINE_IL2CPP_CLASS(::System::Net::Http::HttpContent__LoadIntoBufferAsync_d__17, "System.Net.Http", "HttpContent/<LoadIntoBufferAsync>d__17");
DEFINE_IL2CPP_CLASS(::System::Net::Http::HttpContent__ReadAsByteArrayAsync_d__19, "System.Net.Http", "HttpContent/<ReadAsByteArrayAsync>d__19");
DEFINE_IL2CPP_CLASS(::System::Net::Http::HttpContent__ReadAsStreamAsync_d__18, "System.Net.Http", "HttpContent/<ReadAsStreamAsync>d__18");
DEFINE_IL2CPP_CLASS(::System::Net::Http::HttpContent__ReadAsStringAsync_d__20, "System.Net.Http", "HttpContent/<ReadAsStringAsync>d__20");
...
public:
  ...
  /// @brief Method CheckOverflow, addr 0x5f9cfa8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x5f9d0e8, size 0x48, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count);

  /// @brief Method WriteByte, addr 0x5f9d0b8, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f9cb6c, size 0x28, virtual false, abstract: false, final false
...
namespace System::Net::Http {
// Is value type: true
// CS Name: System.Net.Http.HttpContent/<CreateContentReadStreamAsync>d__12
struct CORDL_TYPE HttpContent__CreateContentReadStreamAsync_d__12 {
public:
  // Declarations
  /// @brief Convert operator to "::System::Runtime::CompilerServices::IAsyncStateMachine"
  constexpr operator ::System::Runtime::CompilerServices::IAsyncStateMachine*();

  /// @brief Method MoveNext, addr 0x5f9d130, size 0x224, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5f9d354, size 0x80, virtual true, abstract: false, final true
...
// Non member Declarations
static_assert(offsetof(::System::Net::Http::HttpContent__CreateContentReadStreamAsync_d__12, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::System::Net::Http::HttpContent__CreateContentReadStreamAsync_d__12, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::System::Net::Http::HttpContent__CreateContentReadStreamAsync_d__12, __4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::System::Net::Http::HttpContent__CreateContentReadStreamAsync_d__12, __u__1) == 0x28, "Offset mismatch!");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5f9d3d4, size 0x2bc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5f9d690, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5f9d6fc, size 0x3c4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5f9dac0, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
// Non member Declarations
static_assert(offsetof(::System::Net::Http::HttpContent__ReadAsStreamAsync_d__18, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::System::Net::Http::HttpContent__ReadAsStreamAsync_d__18, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::System::Net::Http::HttpContent__ReadAsStreamAsync_d__18, __4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::System::Net::Http::HttpContent__ReadAsStreamAsync_d__18, __u__1) == 0x28, "Offset mismatch!");
...
namespace System::Net::Http {
// Is value type: true
// CS Name: System.Net.Http.HttpContent/<ReadAsByteArrayAsync>d__19
struct CORDL_TYPE HttpContent__ReadAsByteArrayAsync_d__19 {
public:
  // Declarations
  /// @brief Convert operator to "::System::Runtime::CompilerServices::IAsyncStateMachine"
  constexpr operator ::System::Runtime::CompilerServices::IAsyncStateMachine*();

  /// @brief Method MoveNext, addr 0x5f9db40, size 0x248, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5f9dd88, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
// Non member Declarations
static_assert(offsetof(::System::Net::Http::HttpContent__ReadAsByteArrayAsync_d__19, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::System::Net::Http::HttpContent__ReadAsByteArrayAsync_d__19, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::System::Net::Http::HttpContent__ReadAsByteArrayAsync_d__19, __4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::System::Net::Http::HttpContent__ReadAsByteArrayAsync_d__19, __u__1) == 0x28, "Offset mismatch!");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5f9de08, size 0x3cc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5f9e358, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
static_assert(sizeof(::System::Net::Http::HttpContent__ReadAsStringAsync_d__20) == 0x38, "Size mismatch!");
...
public:
  ...
  using _CreateContentReadStreamAsync_d__12 = ::System::Net::Http::HttpContent__CreateContentReadStreamAsync_d__12;

  using _LoadIntoBufferAsync_d__17 = ::System::Net::Http::HttpContent__LoadIntoBufferAsync_d__17;

  using _ReadAsByteArrayAsync_d__19 = ::System::Net::Http::HttpContent__ReadAsByteArrayAsync_d__19;

  using _ReadAsStreamAsync_d__18 = ::System::Net::Http::HttpContent__ReadAsStreamAsync_d__18;
  ...
  /// @brief Method CopyToAsync, addr 0x5f99cec, size 0x8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* CopyToAsync(::System::IO::Stream* stream);

  /// @brief Method CopyToAsync, addr 0x5f9c990, size 0x98, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* CopyToAsync(::System::IO::Stream* stream, ::System::Net::TransportContext* context);

  /// @brief Method CreateContentReadStreamAsync, addr 0x5f9ca28, size 0xe4, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::System::IO::Stream*>* CreateContentReadStreamAsync();

  /// @brief Method CreateFixedMemoryStream, addr 0x5f9cb0c, size 0x60, virtual false, abstract: false, final false
  static inline ::System::Net::Http::HttpContent_FixedMemoryStream* CreateFixedMemoryStream(int64_t maxBufferSize);

  /// @brief Method Dispose, addr 0x5f9cb94, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x5f9cba4, size 0x34, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetEncodingFromBuffer, addr 0x5f9cda8, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadIntoBufferAsync, addr 0x5f9cbd8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* LoadIntoBufferAsync();

  /// @brief Method LoadIntoBufferAsync, addr 0x5f99c2c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAsByteArrayAsync, addr 0x5f9ccc4, size 0xe4, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::ArrayW<uint8_t>>* ReadAsByteArrayAsync();

  /// @brief Method ReadAsStreamAsync, addr 0x5f9cbe0, size 0xe4, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::System::IO::Stream*>* ReadAsStreamAsync();

  /// @brief Method ReadAsStringAsync, addr 0x5f9c754, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeToStreamAsync_internal, addr 0x5f9cf9c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method StartsWith, addr 0x5f9cf28, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f9a3b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Headers, addr 0x5f97a9c, size 0x68, virtual false, abstract: false, final false
  inline ::System::Net::Http::Headers::HttpContentHeaders* get_Headers();

  /// @brief Method get_LoadedBufferLength, addr 0x5f9c92c, size 0x64, virtual false, abstract: false, final false
