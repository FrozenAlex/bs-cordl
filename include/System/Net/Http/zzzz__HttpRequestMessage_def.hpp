...
public:
  ...
  /// @brief Method Dispose, addr 0x60d7b10, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x60d7b20, size 0x34, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method IsAllowedAbsoluteUri, addr 0x60d79b8, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method SetIsUsed, addr 0x60d4328, size 0x1c, virtual false, abstract: false, final false
  inline bool SetIsUsed();

  /// @brief Method ToString, addr 0x60d7b54, size 0x288, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60d77e0, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x60d3f1c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Http::HttpMethod* method, ::System::Uri* requestUri);

  /// @brief Method get_Content, addr 0x60d7934, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Http::HttpContent* get_Content();

  /// @brief Method get_Headers, addr 0x60d0234, size 0x64, virtual false, abstract: false, final false
  inline ::System::Net::Http::Headers::HttpRequestHeaders* get_Headers();

  /// @brief Method get_Method, addr 0x60d79a8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Http::HttpMethod* get_Method();

  /// @brief Method get_RequestUri, addr 0x60d79b0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Uri* get_RequestUri();

  /// @brief Method get_Version, addr 0x60d01cc, size 0x68, virtual false, abstract: false, final false
  inline ::System::Version* get_Version();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_Content, addr 0x60d793c, size 0x8, virtual false, abstract: false, final false
  inline void set_Content(::System::Net::Http::HttpContent* value);

  /// @brief Method set_Method, addr 0x60d7884, size 0xb0, virtual false, abstract: false, final false
  inline void set_Method(::System::Net::Http::HttpMethod* value);

  /// @brief Method set_RequestUri, addr 0x60d0aa4, size 0xcc, virtual false, abstract: false, final false
