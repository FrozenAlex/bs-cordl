...
public:
  // Declarations
  /// @brief Method IsSecureWebSocketScheme, addr 0x5f95a64, size 0x54, virtual false, abstract: false, final false
  static inline bool IsSecureWebSocketScheme(::StringW scheme);

  /// @brief Method IsSupportedSecureScheme, addr 0x5f959f4, size 0x70, virtual false, abstract: false, final false
