...
// Write type traits
MARK_REF_T(::System::Net::Mail::DotAtomReader*);
DEFINE_IL2CPP_CLASS(::System::Net::Mail::DotAtomReader*, "System.Net.Mail", "DotAtomReader");
...
public:
  // Declarations
  /// @brief Method ReadReverse, addr 0x622de3c, size 0x230, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::Mail::DotAtomReader) == 0x10, "Size mismatch!");
