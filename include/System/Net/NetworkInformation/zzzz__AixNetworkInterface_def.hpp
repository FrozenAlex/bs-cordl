...
// Write type traits
MARK_REF_T(::System::Net::NetworkInformation::AixNetworkInterface*);
DEFINE_IL2CPP_CLASS(::System::Net::NetworkInformation::AixNetworkInterface*, "System.Net.NetworkInformation", "AixNetworkInterface");
...
public:
  ...
  /// @brief Method GetIPProperties, addr 0x634ca24, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x634c8b0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, uint32_t ifa_flags, int32_t ifru_mtu);

  /// @brief Method get_OperationalStatus, addr 0x634caa4, size 0x14, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Net::NetworkInformation::AixNetworkInterface) == 0x40, "Size mismatch!");
