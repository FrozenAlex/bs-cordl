...
// Write type traits
MARK_REF_T(::System::Net::NetworkInformation::GatewayIPAddressInformation*);
DEFINE_IL2CPP_CLASS(::System::Net::NetworkInformation::GatewayIPAddressInformation*, "System.Net.NetworkInformation", "GatewayIPAddressInformation");
...
public:
  ...
  /// @brief Method .ctor, addr 0x62112cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Net::NetworkInformation::GatewayIPAddressInformation) == 0x10, "Size mismatch!");
