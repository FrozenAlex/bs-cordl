...
// Write type traits
MARK_REF_T(::System::Net::NetworkInformation::IPInterfaceProperties*);
DEFINE_IL2CPP_CLASS(::System::Net::NetworkInformation::IPInterfaceProperties*, "System.Net.NetworkInformation", "IPInterfaceProperties");
...
public:
  ...
  /// @brief Method .ctor, addr 0x62119d8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Net::NetworkInformation::IPInterfaceProperties) == 0x10, "Size mismatch!");
