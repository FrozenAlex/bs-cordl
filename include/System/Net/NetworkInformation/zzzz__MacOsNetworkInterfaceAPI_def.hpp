...
// Write type traits
MARK_REF_T(::System::Net::NetworkInformation::MacOsNetworkInterfaceAPI*);
DEFINE_IL2CPP_CLASS(::System::Net::NetworkInformation::MacOsNetworkInterfaceAPI*, "System.Net.NetworkInformation", "MacOsNetworkInterfaceAPI");
...
public:
  ...
  /// @brief Method GetAllNetworkInterfaces, addr 0x6215624, size 0x994, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6215618, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6213c2c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::NetworkInformation::MacOsNetworkInterfaceAPI) == 0x18, "Size mismatch!");
