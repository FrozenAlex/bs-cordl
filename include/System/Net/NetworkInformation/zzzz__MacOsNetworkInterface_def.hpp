...
public:
  ...
  /// @brief Method GetIPProperties, addr 0x6216114, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62160f0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, uint32_t ifa_flags);

  /// @brief Method get_OperationalStatus, addr 0x6216184, size 0x14, virtual true, abstract: false, final false
