...
// Write type traits
MARK_REF_T(::System::Net::NetworkInformation::MibIPGlobalProperties*);
DEFINE_IL2CPP_CLASS(::System::Net::NetworkInformation::MibIPGlobalProperties*, "System.Net.NetworkInformation", "MibIPGlobalProperties");
...
public:
  ...
  __declspec(property(get = getStaticF_wsChars, put = setStaticF_wsChars)) ::ArrayW<char16_t> wsChars;
  ...
  /// @brief Method .ctor, addr 0x6216578, size 0x168, virtual false, abstract: false, final false
  inline void _ctor(::StringW procDir);

  static inline ::ArrayW<char16_t> getStaticF_wsChars();

  static inline void setStaticF_wsChars(::ArrayW<char16_t> value);
...
static_assert(sizeof(::System::Net::NetworkInformation::MibIPGlobalProperties) == 0x40, "Size mismatch!");
