...
public:
  ...
  /// @brief Method Create, addr 0x634cacc, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PlatformNeedsLibCWorkaround, addr 0x634f614, size 0x4c, virtual false, abstract: false, final false
