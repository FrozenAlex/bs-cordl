...
// Write type traits
MARK_REF_T(::System::Net::NetworkInformation::UnixNetworkInterfaceFactoryPal*);
DEFINE_IL2CPP_CLASS(::System::Net::NetworkInformation::UnixNetworkInterfaceFactoryPal*, "System.Net.NetworkInformation", "UnixNetworkInterfaceFactoryPal");
...
public:
  // Declarations
  /// @brief Method Create, addr 0x6216238, size 0xf4, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::NetworkInformation::UnixNetworkInterfaceFactoryPal) == 0x10, "Size mismatch!");
