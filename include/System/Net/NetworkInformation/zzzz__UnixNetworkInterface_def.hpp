...
// Write type traits
MARK_REF_T(::System::Net::NetworkInformation::UnixNetworkInterface*);
DEFINE_IL2CPP_CLASS(::System::Net::NetworkInformation::UnixNetworkInterface*, "System.Net.NetworkInformation", "UnixNetworkInterface");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_macAddress, put = __cordl_internal_set_macAddress)) ::ArrayW<uint8_t> macAddress;
  ...
  /// @brief Method AddAddress, addr 0x6213a40, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetLinkLayerInfo, addr 0x6213af4, size 0xc, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_macAddress() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_macAddress();
  ...
  constexpr void __cordl_internal_set_macAddress(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_name(::StringW value);

  constexpr void __cordl_internal_set_type(::System::Net::NetworkInformation::NetworkInterfaceType value);

  /// @brief Method .ctor, addr 0x6213b08, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_Name, addr 0x6216a94, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NetworkInterfaceType, addr 0x6216a9c, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Net::NetworkInformation::UnixNetworkInterface) == 0x38, "Size mismatch!");
