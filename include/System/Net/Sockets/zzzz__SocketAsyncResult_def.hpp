...
public:
  ...
  /// @brief Method <Complete>b__27_0, addr 0x622cc74, size 0x7c, virtual false, abstract: false, final false
  inline void _Complete_b__27_0(::System::Object* state);

  /// @brief Method .ctor, addr 0x622cc70, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CheckIfThrowDelayedException, addr 0x622cb64, size 0xa0, virtual false, abstract: false, final false
  inline void CheckIfThrowDelayedException();

  /// @brief Method Complete, addr 0x6227b18, size 0x1f4, virtual false, abstract: false, final false
  inline void Complete();

  /// @brief Method Complete, addr 0x6227300, size 0x8, virtual false, abstract: false, final false
  inline void Complete(::System::Exception* e);

  /// @brief Method Complete, addr 0x622cc10, size 0xc, virtual false, abstract: false, final false
  inline void Complete(::System::Exception* e, bool synch);

  /// @brief Method Complete, addr 0x6227308, size 0x8, virtual false, abstract: false, final false
  inline void Complete(::System::Net::Sockets::Socket* s);

  /// @brief Method Complete, addr 0x6227580, size 0xc, virtual false, abstract: false, final false
  inline void Complete(::System::Net::Sockets::Socket* s, int32_t total);

  /// @brief Method Complete, addr 0x622cc08, size 0x8, virtual false, abstract: false, final false
  inline void Complete(bool synch);

  /// @brief Method Complete, addr 0x6228634, size 0x8, virtual false, abstract: false, final false
  inline void Complete(int32_t total);

  /// @brief Method CompleteDisposed, addr 0x622cc04, size 0x4, virtual true, abstract: false, final false
  inline void CompleteDisposed();

  /// @brief Method Init, addr 0x622ca04, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x622c74c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x622cacc, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ErrorCode, addr 0x622cadc, size 0x88, virtual false, abstract: false, final false
  inline ::System::Net::Sockets::SocketError get_ErrorCode();

  /// @brief Method get_Handle, addr 0x622c9dc, size 0x28, virtual false, abstract: false, final false
