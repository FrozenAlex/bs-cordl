...
public:
  ...
  /// @brief Method Authenticate, addr 0x641fa84, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method DoAuthenticate, addr 0x641fb88, size 0x480, virtual false, abstract: false, final false
  ...
  /// @brief Method EnsureModules, addr 0x641f818, size 0x264, virtual false, abstract: false, final false
  static inline void EnsureModules();

  /// @brief Method PreAuthenticate, addr 0x6420008, size 0x4cc, virtual false, abstract: false, final false
