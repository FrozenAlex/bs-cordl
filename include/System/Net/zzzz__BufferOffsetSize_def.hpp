...
public:
  ...
  /// @brief Method .ctor, addr 0x62d3e8c, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> buffer, bool copyBuffer);

  /// @brief Method .ctor, addr 0x62d3de8, size 0xa4, virtual false, abstract: false, final false
