...
public:
  ...
  /// @brief Method IsEqualTo, addr 0x6413c64, size 0x24, virtual false, abstract: false, final false
  inline bool IsEqualTo(::StringW value);

  /// @brief Method .ctor, addr 0x6413fe0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::System::Net::CookieToken token);

  /// @brief Method get_Token, addr 0x6413fec, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  __declspec(property(get = getStaticF_RecognizedServerAttributes, put = setStaticF_RecognizedServerAttributes)) ::ArrayW<::System::Net::CookieTokenizer_RecognizedAttribute>
  ...
  /// @brief Method Extract, addr 0x64136d4, size 0x58, virtual false, abstract: false, final false
  inline ::StringW Extract();

  /// @brief Method FindNext, addr 0x641372c, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method Next, addr 0x6413948, size 0x130, virtual false, abstract: false, final false
  inline ::System::Net::CookieToken Next(bool first, bool parseResponseCookies);

  /// @brief Method Reset, addr 0x6413a78, size 0x30, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method TokenFromName, addr 0x6413aa8, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6413658, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EndOfCookie, addr 0x6413674, size 0x8, virtual false, abstract: false, final false
  inline bool get_EndOfCookie();

  /// @brief Method get_Eof, addr 0x6413684, size 0x10, virtual false, abstract: false, final false
  inline bool get_Eof();

  /// @brief Method get_Name, addr 0x6413694, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Quoted, addr 0x64136a4, size 0x8, virtual false, abstract: false, final false
  inline bool get_Quoted();

  /// @brief Method get_Token, addr 0x64136b4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::CookieToken get_Token();

  /// @brief Method get_Value, addr 0x64136c4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_EndOfCookie, addr 0x641367c, size 0x8, virtual false, abstract: false, final false
  inline void set_EndOfCookie(bool value);

  /// @brief Method set_Name, addr 0x641369c, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_Quoted, addr 0x64136ac, size 0x8, virtual false, abstract: false, final false
  inline void set_Quoted(bool value);

  /// @brief Method set_Token, addr 0x64136bc, size 0x8, virtual false, abstract: false, final false
  inline void set_Token(::System::Net::CookieToken value);

  /// @brief Method set_Value, addr 0x64136cc, size 0x8, virtual false, abstract: false, final false
