...
public:
  ...
  /// @brief Method ParseMultiValue, addr 0x62d3fb4, size 0x210, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW> ParseMultiValue(::StringW value);

  /// @brief Method ParseSingleValue, addr 0x62d3f4c, size 0x68, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW> ParseSingleValue(::StringW value);

  /// @brief Method .ctor, addr 0x62d098c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Item, addr 0x62ce470, size 0xe4, virtual false, abstract: false, final false
