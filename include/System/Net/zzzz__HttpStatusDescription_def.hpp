...
public:
  // Declarations
  /// @brief Method Get, addr 0x63f0020, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW Get(::System::Net::HttpStatusCode code);

  /// @brief Method Get, addr 0x63f0024, size 0x930, virtual false, abstract: false, final false
