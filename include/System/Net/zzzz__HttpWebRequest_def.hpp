...
public:
  ...
  /// @brief Method CheckAuthorization, addr 0x61f42b4, size 0x34c, virtual false, abstract: false, final false
  inline bool CheckAuthorization(::System::Net::WebResponse* response, ::System::Net::HttpStatusCode code);

  /// @brief Method Reset, addr 0x61f4c14, size 0x94, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method ToString, addr 0x61f4df4, size 0x120, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x61f033c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::HttpWebRequest* request, bool isProxy);

  /// @brief Method get_IsCompleted, addr 0x61f4dc4, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsCompleted();

  /// @brief Method get_IsNtlmAuthenticated, addr 0x61f4dd4, size 0x20, virtual false, abstract: false, final false
  inline bool get_IsNtlmAuthenticated();

  /// @brief Method get_NtlmAuthState, addr 0x61f4dcc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x61f4f14, size 0xefc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x61f5e60, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
// Dependencies System.Runtime.CompilerServices.AsyncTaskMethodBuilder`1<TResult>, System.Runtime.CompilerServices.ConfiguredTaskAwaitable::ConfiguredTaskAwaiter,
// System.Runtime.CompilerServices.ConfiguredTaskAwaitable`1::ConfiguredTaskAwaiter<TResult>, System.Threading.CancellationToken, System.ValueTuple`5<T1, T2, T3, T4, T5>
namespace System::Net {
// Is value type: true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x61f5ee0, size 0x7ec, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x61f69bc, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x61f6a3c, size 0x450, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x61f6e8c, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Abort, addr 0x61f2c60, size 0x110, virtual true, abstract: false, final false
  inline void Abort();

  /// @brief Method BeginGetRequestStream, addr 0x61f20dc, size 0xbc, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginGetRequestStream(::System::AsyncCallback* callback, ::System::Object* state);

  /// @brief Method BeginGetResponse, addr 0x61f284c, size 0x1b4, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginGetResponse(::System::AsyncCallback* callback, ::System::Object* state);

  /// @brief Method CheckAuthorization, addr 0x61f429c, size 0x18, virtual false, abstract: false, final false
  inline bool CheckAuthorization(::System::Net::WebResponse* response, ::System::Net::HttpStatusCode code);

  /// @brief Method CheckFinalStatus, addr 0x61f4800, size 0x414, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckRequestStarted, addr 0x61f039c, size 0x58, virtual false, abstract: false, final false
  inline void CheckRequestStarted();

  /// @brief Method CreateRequestAbortedException, addr 0x61f2014, size 0xc8, virtual false, abstract: false, final false
  static inline ::System::Net::WebException* CreateRequestAbortedException();

  /// @brief Method DoContinueDelegate, addr 0x61f2de0, size 0x1c, virtual false, abstract: false, final false
  inline void DoContinueDelegate(int32_t statusCode, ::System::Net::WebHeaderCollection* headers);

  /// @brief Method DoPreAuthenticate, addr 0x61f3ae0, size 0x224, virtual false, abstract: false, final false
  inline void DoPreAuthenticate();

  /// @brief Method EndGetRequestStream, addr 0x61f2198, size 0x130, virtual true, abstract: false, final false
  inline ::System::IO::Stream* EndGetRequestStream(::System::IAsyncResult* asyncResult);

  /// @brief Method EndGetResponse, addr 0x61f2a00, size 0x130, virtual true, abstract: false, final false
  inline ::System::Net::WebResponse* EndGetResponse(::System::IAsyncResult* asyncResult);

  /// @brief Method FlattenException, addr 0x61f25d8, size 0xc4, virtual false, abstract: false, final false
  static inline ::System::Exception* FlattenException(::System::Exception* e);

  /// @brief Method GetHeaders, addr 0x61f3394, size 0x6c0, virtual false, abstract: false, final false
  inline ::StringW GetHeaders();

  /// @brief Method GetObjectData, addr 0x61f2da8, size 0x38, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method GetRequestHeaders, addr 0x61f3d04, size 0x324, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetRequestHeaders();

  /// @brief Method GetRequestStreamAsync, addr 0x61f2350, size 0x9c, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::System::IO::Stream*>* GetRequestStreamAsync();

  /// @brief Method GetResponse, addr 0x61f2b30, size 0x128, virtual true, abstract: false, final false
  inline ::System::Net::WebResponse* GetResponse();

  /// @brief Method GetResponseFromData, addr 0x61f24dc, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRewriteHandler, addr 0x61f4600, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method GetServicePoint, addr 0x61f0e88, size 0x130, virtual false, abstract: false, final false
  inline ::System::Net::ServicePoint* GetServicePoint();

  /// @brief Method GetWebException, addr 0x61f22c8, size 0x88, virtual false, abstract: false, final false
  inline ::System::Net::WebException* GetWebException(::System::Exception* e);

  /// @brief Method GetWebException, addr 0x61f269c, size 0x1b0, virtual false, abstract: false, final false
  static inline ::System::Net::WebException* GetWebException(::System::Exception* e, bool aborted);

  /// @brief Method HandleNtlmAuth, addr 0x61f4028, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method MyGetRequestStreamAsync, addr 0x61f1c68, size 0x384, virtual false, abstract: false, final false
  ...
  /// @brief Method MyGetResponseAsync, addr 0x61f23ec, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method Redirect, addr 0x61f2e7c, size 0x518, virtual false, abstract: false, final false
  inline bool Redirect(::System::Net::HttpStatusCode code, ::System::Net::WebResponse* response);

  /// @brief Method ResetAuthorization, addr 0x61f01ec, size 0x10, virtual false, abstract: false, final false
  inline void ResetAuthorization();

  /// @brief Method RewriteRedirectToGet, addr 0x61f2dfc, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method SendRequest, addr 0x61f1898, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x61f2d70, size 0x38, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo,
                                                                       ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method TryGetHostUri, addr 0x61f0934, size 0xd8, virtual false, abstract: false, final false
  inline bool TryGetHostUri(::StringW hostName, ::by_ref<::System::Uri*> hostUri);

  /// @brief Method <GetRewriteHandler>b__271_0, addr 0x61f4ca8, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61f4d88, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x61f0224, size 0x118, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method .ctor, addr 0x61efc84, size 0x194, virtual false, abstract: false, final false
  inline void _ctor(::System::Uri* uri);

  /// @brief Method .ctor, addr 0x61f01fc, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Aborted, addr 0x61f1fec, size 0x28, virtual false, abstract: false, final false
  inline bool get_Aborted();

  /// @brief Method get_Address, addr 0x61f0350, size 0x8, virtual false, abstract: false, final false
  inline ::System::Uri* get_Address();

  /// @brief Method get_AllowWriteStreamBuffering, addr 0x61f0360, size 0x8, virtual true, abstract: false, final false
  inline bool get_AllowWriteStreamBuffering();

  /// @brief Method get_AuthUri, addr 0x61f1150, size 0x8, virtual false, abstract: false, final false
  inline ::System::Uri* get_AuthUri();

  /// @brief Method get_AutomaticDecompression, addr 0x61f0370, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::DecompressionMethods get_AutomaticDecompression();

  /// @brief Method get_ClientCertificates, addr 0x61f0518, size 0x68, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateCollection* get_ClientCertificates();

  /// @brief Method get_ContentLength, addr 0x61f0588, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_ContentLength();

  /// @brief Method get_Credentials, addr 0x61f063c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Net::ICredentials* get_Credentials();

  /// @brief Method get_DefaultMaximumErrorResponseLength, addr 0x61f064c, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t get_DefaultMaximumErrorResponseLength();

  /// @brief Method get_DefaultMaximumResponseHeadersLength, addr 0x61f0a90, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t get_DefaultMaximumResponseHeadersLength();

  /// @brief Method get_ExpectContinue, addr 0x61f1140, size 0x8, virtual false, abstract: false, final false
  inline bool get_ExpectContinue();

  /// @brief Method get_Headers, addr 0x61f06a8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Net::WebHeaderCollection* get_Headers();

  /// @brief Method get_Host, addr 0x61f06b0, size 0x10c, virtual false, abstract: false, final false
  inline ::StringW get_Host();

  /// @brief Method get_InternalAllowBuffering, addr 0x61f03f4, size 0x14, virtual false, abstract: false, final false
  inline bool get_InternalAllowBuffering();

  /// @brief Method get_KeepAlive, addr 0x61f0a0c, size 0x8, virtual false, abstract: false, final false
  inline bool get_KeepAlive();

  /// @brief Method get_Method, addr 0x61f0af4, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Method();

  /// @brief Method get_MethodWithBuffer, addr 0x61f0408, size 0x100, virtual false, abstract: false, final false
  inline bool get_MethodWithBuffer();

  /// @brief Method get_ProtocolVersion, addr 0x61f0d2c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Version* get_ProtocolVersion();

  /// @brief Method get_Proxy, addr 0x61f0e54, size 0x8, virtual true, abstract: false, final false
  inline ::System::Net::IWebProxy* get_Proxy();

  /// @brief Method get_ProxyQuery, addr 0x61f1158, size 0x30, virtual false, abstract: false, final false
  inline bool get_ProxyQuery();

  /// @brief Method get_ReadWriteTimeout, addr 0x61f0aec, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ReadWriteTimeout();

  /// @brief Method get_RequestUri, addr 0x61f0fb8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Uri* get_RequestUri();

  /// @brief Method get_SendChunked, addr 0x61f0fc0, size 0x8, virtual false, abstract: false, final false
  inline bool get_SendChunked();

  /// @brief Method get_ServerCertValidationCallback, addr 0x61f1188, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::ServerCertValidationCallback* get_ServerCertValidationCallback();

  /// @brief Method get_ServerCertificateValidationCallback, addr 0x61f1190, size 0x18, virtual false, abstract: false, final false
  inline ::System::Net::Security::RemoteCertificateValidationCallback* get_ServerCertificateValidationCallback();

  /// @brief Method get_ServicePoint, addr 0x61f0fec, size 0x4, virtual false, abstract: false, final false
  inline ::System::Net::ServicePoint* get_ServicePoint();

  /// @brief Method get_ServicePointNoLock, addr 0x61f0ff0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::ServicePoint* get_ServicePointNoLock();

  /// @brief Method get_ThrowOnError, addr 0x61f0624, size 0x8, virtual false, abstract: false, final false
  inline bool get_ThrowOnError();

  /// @brief Method get_Timeout, addr 0x61f0ff8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Timeout();

  /// @brief Method get_TlsProvider, addr 0x61f0508, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Net::Security::MobileTlsProvider* get_TlsProvider();

  /// @brief Method get_TlsSettings, addr 0x61f0510, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::Interface::MonoTlsSettings* get_TlsSettings();

  /// @brief Method get_TransferEncoding, addr 0x61f105c, size 0x60, virtual false, abstract: false, final false
  inline ::StringW get_TransferEncoding();

  /// @brief Method get_UnsafeAuthenticatedConnectionSharing, addr 0x61f1138, size 0x8, virtual false, abstract: false, final false
  inline bool get_UnsafeAuthenticatedConnectionSharing();

  /// @brief Method get_UseDefaultCredentials, addr 0x61f10bc, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method set_AllowAutoRedirect, addr 0x61f0358, size 0x8, virtual true, abstract: false, final false
  inline void set_AllowAutoRedirect(bool value);

  /// @brief Method set_AllowWriteStreamBuffering, addr 0x61f0368, size 0x8, virtual true, abstract: false, final false
  inline void set_AllowWriteStreamBuffering(bool value);

  /// @brief Method set_AutomaticDecompression, addr 0x61f0378, size 0x24, virtual false, abstract: false, final false
  inline void set_AutomaticDecompression(::System::Net::DecompressionMethods value);

  /// @brief Method set_ConnectionGroupName, addr 0x61f0580, size 0x8, virtual true, abstract: false, final false
  inline void set_ConnectionGroupName(::StringW value);

  /// @brief Method set_ContentLength, addr 0x61f0590, size 0x8c, virtual true, abstract: false, final false
  inline void set_ContentLength(int64_t value);

  /// @brief Method set_CookieContainer, addr 0x61f0634, size 0x8, virtual true, abstract: false, final false
  inline void set_CookieContainer(::System::Net::CookieContainer* value);

  /// @brief Method set_Credentials, addr 0x61f0644, size 0x8, virtual true, abstract: false, final false
  inline void set_Credentials(::System::Net::ICredentials* value);

  /// @brief Method set_ExpectContinue, addr 0x61f1148, size 0x8, virtual false, abstract: false, final false
  inline void set_ExpectContinue(bool value);

  /// @brief Method set_FinishedReading, addr 0x61f2c58, size 0x8, virtual false, abstract: false, final false
  inline void set_FinishedReading(bool value);

  /// @brief Method set_Host, addr 0x61f07bc, size 0x178, virtual false, abstract: false, final false
  inline void set_Host(::StringW value);

  /// @brief Method set_InternalContentLength, addr 0x61f061c, size 0x8, virtual false, abstract: false, final false
  inline void set_InternalContentLength(int64_t value);

  /// @brief Method set_KeepAlive, addr 0x61f0a14, size 0x8, virtual false, abstract: false, final false
  inline void set_KeepAlive(bool value);

  /// @brief Method set_MaximumAutomaticRedirections, addr 0x61f0a1c, size 0x74, virtual false, abstract: false, final false
  inline void set_MaximumAutomaticRedirections(int32_t value);

  /// @brief Method set_Method, addr 0x61f0afc, size 0x228, virtual true, abstract: false, final false
  inline void set_Method(::StringW value);

  /// @brief Method set_PreAuthenticate, addr 0x61f0d24, size 0x8, virtual true, abstract: false, final false
  inline void set_PreAuthenticate(bool value);

  /// @brief Method set_ProtocolVersion, addr 0x61f0d34, size 0x120, virtual false, abstract: false, final false
  inline void set_ProtocolVersion(::System::Version* value);

  /// @brief Method set_Proxy, addr 0x61f0e5c, size 0x2c, virtual true, abstract: false, final false
  inline void set_Proxy(::System::Net::IWebProxy* value);

  /// @brief Method set_SendChunked, addr 0x61f0fc8, size 0x24, virtual false, abstract: false, final false
  inline void set_SendChunked(bool value);

  /// @brief Method set_ServerCertificateValidationCallback, addr 0x61f11a8, size 0x78, virtual false, abstract: false, final false
  inline void set_ServerCertificateValidationCallback(::System::Net::Security::RemoteCertificateValidationCallback* value);

  /// @brief Method set_ThrowOnError, addr 0x61f062c, size 0x8, virtual false, abstract: false, final false
  inline void set_ThrowOnError(bool value);

  /// @brief Method set_Timeout, addr 0x61f1000, size 0x5c, virtual true, abstract: false, final false
