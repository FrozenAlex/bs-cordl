...
public:
  ...
  /// @brief Method .ctor, addr 0x64060b4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AddressList, addr 0x64060a4, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Net::IPAddress*> get_AddressList();

  /// @brief Method get_HostName, addr 0x640608c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_HostName();

  /// @brief Method set_AddressList, addr 0x64060ac, size 0x8, virtual false, abstract: false, final false
  inline void set_AddressList(::ArrayW<::System::Net::IPAddress*> value);

  /// @brief Method set_Aliases, addr 0x640609c, size 0x8, virtual false, abstract: false, final false
  inline void set_Aliases(::ArrayW<::StringW> value);

  /// @brief Method set_HostName, addr 0x6406094, size 0x8, virtual false, abstract: false, final false
