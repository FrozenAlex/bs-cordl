...
public:
  ...
  /// @brief Method .ctor, addr 0x63f64cc, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_InvalidStatusCode, addr 0x63f64b8, size 0x14, virtual false, abstract: false, final false
  inline bool get_InvalidStatusCode();

  /// @brief Method get_PermanentFailure, addr 0x63f64a4, size 0x14, virtual false, abstract: false, final false
  inline bool get_PermanentFailure();

  /// @brief Method get_PositiveCompletion, addr 0x63f647c, size 0x14, virtual false, abstract: false, final false
  inline bool get_PositiveCompletion();

  /// @brief Method get_PositiveIntermediate, addr 0x63f6468, size 0x14, virtual false, abstract: false, final false
  inline bool get_PositiveIntermediate();

  /// @brief Method get_TransientFailure, addr 0x63f6490, size 0x14, virtual false, abstract: false, final false
