...
public:
  ...
  /// @brief Method Add, addr 0x6408d14, size 0x2c0, virtual false, abstract: false, final false
  inline void Add(::StringW header);

  /// @brief Method Add, addr 0x6408b6c, size 0x1a8, virtual true, abstract: false, final false
  inline void Add(::StringW name, ::StringW value);

  /// @brief Method AddInternal, addr 0x64084cc, size 0x4c, virtual false, abstract: false, final false
  inline void AddInternal(::StringW name, ::StringW value);

  /// @brief Method AllowMultiValues, addr 0x64081fc, size 0xac, virtual false, abstract: false, final false
  static inline bool AllowMultiValues(::StringW name);

  /// @brief Method ChangeInternal, addr 0x6408518, size 0x4c, virtual false, abstract: false, final false
  inline void ChangeInternal(::StringW name, ::StringW value);

  /// @brief Method CheckBadChars, addr 0x64085ac, size 0x3d8, virtual false, abstract: false, final false
  static inline ::StringW CheckBadChars(::StringW name, bool isHeaderValue);

  /// @brief Method ContainsNonAsciiChars, addr 0x6408984, size 0x74, virtual false, abstract: false, final false
  static inline bool ContainsNonAsciiChars(::StringW token);

  /// @brief Method Get, addr 0x640a258, size 0x40, virtual true, abstract: false, final false
  inline ::StringW Get(int32_t index);

  /// @brief Method Get, addr 0x6409e9c, size 0x30c, virtual true, abstract: false, final false
  inline ::StringW Get(::StringW name);

  /// @brief Method GetAsString, addr 0x64097b0, size 0x2a8, virtual false, abstract: false, final false
  static inline ::StringW GetAsString(::System::Collections::Specialized::NameValueCollection* cc, bool winInetCompat, bool forTrace);

  /// @brief Method GetEnumerator, addr 0x640a1a8, size 0x80, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method GetKey, addr 0x640a2d8, size 0x40, virtual true, abstract: false, final false
  inline ::StringW GetKey(int32_t index);

  /// @brief Method GetObjectData, addr 0x6409d14, size 0x17c, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method GetValues, addr 0x640953c, size 0x214, virtual true, abstract: false, final false
  inline ::ArrayW<::StringW> GetValues(::StringW header);

  /// @brief Method GetValues, addr 0x640a298, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method NormalizeCommonHeaders, addr 0x6408054, size 0x104, virtual false, abstract: false, final false
  inline void NormalizeCommonHeaders();

  /// @brief Method OnDeserialization, addr 0x6409d10, size 0x4, virtual true, abstract: false, final false
  inline void OnDeserialization(::System::Object* sender);

  /// @brief Method Remove, addr 0x64083d0, size 0xfc, virtual false, abstract: false, final false
  inline void Remove(::System::Net::HttpRequestHeader header);

  /// @brief Method Remove, addr 0x6409410, size 0x12c, virtual true, abstract: false, final false
  inline void Remove(::StringW name);

  /// @brief Method RemoveInternal, addr 0x6408564, size 0x48, virtual false, abstract: false, final false
  inline void RemoveInternal(::StringW name);

  /// @brief Method Set, addr 0x6408fd4, size 0x224, virtual true, abstract: false, final false
  inline void Set(::StringW name, ::StringW value);

  /// @brief Method SetInternal, addr 0x64091f8, size 0x218, virtual false, abstract: false, final false
  inline void SetInternal(::StringW name, ::StringW value);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x6409e90, size 0xc, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo,
                                                                       ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method ThrowOnRestrictedHeader, addr 0x64089f8, size 0x174, virtual false, abstract: false, final false
  inline void ThrowOnRestrictedHeader(::StringW headerName);

  /// @brief Method ToString, addr 0x6409750, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6402c04, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6409b48, size 0x1c8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method .ctor, addr 0x6409a58, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AllowHttpRequestHeader, addr 0x640838c, size 0x44, virtual false, abstract: false, final false
  inline bool get_AllowHttpRequestHeader();

  /// @brief Method get_Count, addr 0x640a228, size 0x30, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_InnerCollection, addr 0x6408158, size 0xa4, virtual false, abstract: false, final false
