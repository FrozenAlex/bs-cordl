...
public:
  ...
  /// @brief Method Close, addr 0x62d2f70, size 0x4, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x62d2f74, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x62d2fe4, size 0x88, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetObjectData, addr 0x62d2f6c, size 0x4, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method GetResponseStream, addr 0x62d3074, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x62d2f60, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x62c96b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x62d2f5c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method get_Headers, addr 0x62d30bc, size 0x24, virtual true, abstract: false, final false
  inline ::System::Net::WebHeaderCollection* get_Headers();

  /// @brief Method get_IsFromCache, addr 0x62d306c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsFromCache();

  /// @brief Method get_ResponseUri, addr 0x62d3098, size 0x24, virtual true, abstract: false, final false
