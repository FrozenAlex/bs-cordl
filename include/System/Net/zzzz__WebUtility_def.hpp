...
public:
  ...
  /// @brief Method AddByte, addr 0x640d934, size 0xa4, virtual false, abstract: false, final false
  inline void AddByte(uint8_t b);

  /// @brief Method AddChar, addr 0x640d9d8, size 0x60, virtual false, abstract: false, final false
  inline void AddChar(char16_t ch);

  /// @brief Method FlushBytes, addr 0x640dbc0, size 0x60, virtual false, abstract: false, final false
  inline void FlushBytes();

  /// @brief Method GetString, addr 0x640da38, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x640d894, size 0x6c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetNextUnicodeScalarValueFromUtf16Surrogate, addr 0x640d5e4, size 0xa4, virtual false, abstract: false, final false
  static inline int32_t GetNextUnicodeScalarValueFromUtf16Surrogate(::by_ref<char16_t*> pch, ::by_ref<int32_t> charsRemaining);

  /// @brief Method HexToInt, addr 0x640d900, size 0x34, virtual false, abstract: false, final false
  static inline int32_t HexToInt(char16_t h);

  /// @brief Method HtmlEncode, addr 0x640cf18, size 0x128, virtual false, abstract: false, final false
  static inline ::StringW HtmlEncode(::StringW value);

  /// @brief Method HtmlEncode, addr 0x640d158, size 0x3a0, virtual false, abstract: false, final false
  static inline void HtmlEncode(::StringW value, ::System::IO::TextWriter* output);

  /// @brief Method IndexOfHtmlEncodingChars, addr 0x640d040, size 0x118, virtual false, abstract: false, final false
  static inline int32_t IndexOfHtmlEncodingChars(::StringW s, int32_t startPos);

  /// @brief Method UrlDecode, addr 0x640da88, size 0x7c, virtual false, abstract: false, final false
  static inline ::StringW UrlDecode(::StringW encodedValue);

  /// @brief Method UrlDecodeInternal, addr 0x640d688, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HtmlEncodeConformance, addr 0x640d4f8, size 0xec, virtual false, abstract: false, final false
