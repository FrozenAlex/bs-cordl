...
public:
  ...
  /// @brief Method ToString, addr 0x5b864b4, size 0x2ec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b864b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
