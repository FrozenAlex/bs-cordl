...
public:
  ...
  /// @brief Method ToString, addr 0x5a4ec88, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a4ec84, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
