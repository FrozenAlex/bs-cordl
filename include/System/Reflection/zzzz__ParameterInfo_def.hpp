...
public:
  ...
  /// @brief Method GetCustomAttributes, addr 0x5a44a00, size 0xfc, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Object*> GetCustomAttributes(::System::Type* attributeType, bool inherit);

  /// @brief Method GetCustomAttributes, addr 0x5a44968, size 0x98, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Object*> GetCustomAttributes(bool inherit);

  /// @brief Method GetRealObject, addr 0x5a44afc, size 0x26c, virtual true, abstract: false, final true
  inline ::System::Object* GetRealObject(::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method IsDefined, addr 0x5a448f4, size 0x74, virtual true, abstract: false, final false
  inline bool IsDefined(::System::Type* attributeType, bool inherit);

  static inline ::System::Reflection::ParameterInfo* New_ctor();

  /// @brief Method ToString, addr 0x5a44d68, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a4484c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Attributes, addr 0x5a44850, size 0x8, virtual true, abstract: false, final false
  inline ::System::Reflection::ParameterAttributes get_Attributes();

  /// @brief Method get_DefaultValue, addr 0x5a448cc, size 0x28, virtual true, abstract: false, final false
  inline ::System::Object* get_DefaultValue();

  /// @brief Method get_IsIn, addr 0x5a44878, size 0x1c, virtual false, abstract: false, final false
  inline bool get_IsIn();

  /// @brief Method get_IsOptional, addr 0x5a44894, size 0x1c, virtual false, abstract: false, final false
  inline bool get_IsOptional();

  /// @brief Method get_IsOut, addr 0x5a448b0, size 0x1c, virtual false, abstract: false, final false
  inline bool get_IsOut();

  /// @brief Method get_Member, addr 0x5a44858, size 0x8, virtual true, abstract: false, final false
  inline ::System::Reflection::MemberInfo* get_Member();

  /// @brief Method get_Name, addr 0x5a44860, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_ParameterType, addr 0x5a44868, size 0x8, virtual true, abstract: false, final false
  inline ::System::Type* get_ParameterType();

  /// @brief Method get_Position, addr 0x5a44870, size 0x8, virtual true, abstract: false, final false
