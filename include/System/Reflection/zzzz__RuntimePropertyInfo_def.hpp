...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x5a55a60, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a5591c, size 0x144, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CachePropertyInfo, addr 0x5a54e6c, size 0x40, virtual false, abstract: false, final false
  inline void CachePropertyInfo(::System::Reflection::PInfo flags);

  /// @brief Method FormatNameAndSig, addr 0x5a54c04, size 0x194, virtual false, abstract: false, final false
  inline ::StringW FormatNameAndSig(bool serialization);

  /// @brief Method GetCustomAttributes, addr 0x5a55424, size 0x70, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Object*> GetCustomAttributes(::System::Type* attributeType, bool inherit);

  /// @brief Method GetCustomAttributes, addr 0x5a553c4, size 0x60, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Object*> GetCustomAttributes(bool inherit);

  /// @brief Method GetDeclaringTypeInternal, addr 0x5a54aec, size 0x88, virtual false, abstract: false, final false
  inline ::System::RuntimeType* GetDeclaringTypeInternal();

  /// @brief Method GetGetMethod, addr 0x5a550b0, size 0x84, virtual true, abstract: false, final false
  inline ::System::Reflection::MethodInfo* GetGetMethod(bool nonPublic);

  /// @brief Method GetIndexParameters, addr 0x5a55134, size 0x19c, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Reflection::ParameterInfo*> GetIndexParameters();

  /// @brief Method GetObjectData, addr 0x5a54d98, size 0xcc, virtual true, abstract: false, final true
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetPropertyFromHandle, addr 0x5a55898, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRuntimeModule, addr 0x5a54ac4, size 0x28, virtual false, abstract: false, final false
  inline ::System::Reflection::RuntimeModule* GetRuntimeModule();

  /// @brief Method GetSetMethod, addr 0x5a552d0, size 0x84, virtual true, abstract: false, final false
  inline ::System::Reflection::MethodInfo* GetSetMethod(bool nonPublic);

  /// @brief Method GetValue, addr 0x5a55494, size 0x20, virtual true, abstract: false, final false
  inline ::System::Object* GetValue(::System::Object* obj, ::ArrayW<::System::Object*> index);

  /// @brief Method GetValue, addr 0x5a554b4, size 0x1c8, virtual true, abstract: false, final false
  ...
  /// @brief Method IsDefined, addr 0x5a55354, size 0x70, virtual true, abstract: false, final false
  inline bool IsDefined(::System::Type* attributeType, bool inherit);

  static inline ::System::Reflection::RuntimePropertyInfo* New_ctor();

  /// @brief Method SerializationToString, addr 0x5a54e64, size 0x8, virtual false, abstract: false, final false
  inline ::StringW SerializationToString();

  /// @brief Method SetValue, addr 0x5a5567c, size 0x1f0, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5a54bfc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a55918, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BindingFlags, addr 0x5a54ab8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Reflection::BindingFlags get_BindingFlags();

  /// @brief Method get_CanRead, addr 0x5a54eac, size 0x4c, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanWrite, addr 0x5a54ef8, size 0x4c, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_DeclaringType, addr 0x5a5501c, size 0x40, virtual true, abstract: false, final false
  inline ::System::Type* get_DeclaringType();

  /// @brief Method get_MetadataToken, addr 0x5a5586c, size 0x14, virtual true, abstract: false, final false
  inline int32_t get_MetadataToken();

  /// @brief Method get_Module, addr 0x5a54ac0, size 0x4, virtual true, abstract: false, final false
  inline ::System::Reflection::Module* get_Module();

  /// @brief Method get_Name, addr 0x5a5505c, size 0x54, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_PropertyType, addr 0x5a54f44, size 0x9c, virtual true, abstract: false, final false
  inline ::System::Type* get_PropertyType();

  /// @brief Method get_ReflectedType, addr 0x5a54fe0, size 0x3c, virtual true, abstract: false, final false
  inline ::System::Type* get_ReflectedType();

  /// @brief Method get_ReflectedTypeInternal, addr 0x5a54b74, size 0x88, virtual false, abstract: false, final false
  inline ::System::RuntimeType* get_ReflectedTypeInternal();

  /// @brief Method get_metadata_token, addr 0x5a55880, size 0x14, virtual false, abstract: false, final false
  static inline int32_t get_metadata_token(::System::Reflection::RuntimePropertyInfo* monoProperty);

  /// @brief Method get_property_info, addr 0x5a54ab4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method internal_from_handle_type, addr 0x5a55894, size 0x4, virtual false, abstract: false, final false
