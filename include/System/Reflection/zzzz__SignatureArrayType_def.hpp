...
public:
  ...
  /// @brief Method GetArrayRank, addr 0x5b7d134, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetArrayRank();

  /// @brief Method IsArrayImpl, addr 0x5b7d104, size 0x8, virtual true, abstract: false, final true
  inline bool IsArrayImpl();

  /// @brief Method IsByRefImpl, addr 0x5b7d10c, size 0x8, virtual true, abstract: false, final true
  inline bool IsByRefImpl();

  /// @brief Method IsPointerImpl, addr 0x5b7d114, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b7d078, size 0x54, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::SignatureType* elementType, int32_t rank, bool isMultiDim);

  /// @brief Method get_IsSZArray, addr 0x5b7d11c, size 0x10, virtual true, abstract: false, final true
  inline bool get_IsSZArray();

  /// @brief Method get_IsVariableBoundArray, addr 0x5b7d12c, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsVariableBoundArray();

  /// @brief Method get_Suffix, addr 0x5b7d13c, size 0xd4, virtual true, abstract: false, final true
