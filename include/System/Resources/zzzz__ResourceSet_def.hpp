...
public:
  ...
  /// @brief Method CommonInit, addr 0x5b78bf8, size 0x60, virtual false, abstract: false, final false
  inline void CommonInit();

  /// @brief Method Dispose, addr 0x5b74d48, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x5b6f464, size 0xc0, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetCaseInsensitiveObjectInternal, addr 0x5b79098, size 0x2d8, virtual false, abstract: false, final false
  inline ::System::Object* GetCaseInsensitiveObjectInternal(::StringW name);

  /// @brief Method GetEnumerator, addr 0x5b78c58, size 0x4, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionaryEnumerator* GetEnumerator();

  /// @brief Method GetEnumeratorHelper, addr 0x5b78c5c, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionaryEnumerator* GetEnumeratorHelper();

  /// @brief Method GetObject, addr 0x5b79370, size 0x4, virtual true, abstract: false, final false
  inline ::System::Object* GetObject(::StringW name);

  /// @brief Method GetObject, addr 0x5b79374, size 0x40, virtual true, abstract: false, final false
  inline ::System::Object* GetObject(::StringW name, bool ignoreCase);

  /// @brief Method GetObjectInternal, addr 0x5b78e00, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Object* GetObjectInternal(::StringW name);

  /// @brief Method GetString, addr 0x5b78ccc, size 0x134, virtual true, abstract: false, final false
  inline ::StringW GetString(::StringW name);

  /// @brief Method GetString, addr 0x5b78ec0, size 0x1d8, virtual true, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x5b78cc8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b78bf4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5b6f0f8, size 0x4, virtual false, abstract: false, final false
