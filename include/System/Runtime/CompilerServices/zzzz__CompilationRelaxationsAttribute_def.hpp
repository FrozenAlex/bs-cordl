...
public:
  ...
  /// @brief Method .ctor, addr 0x5b6e97c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::CompilerServices::CompilationRelaxations relaxations);

  /// @brief Method .ctor, addr 0x5b6e974, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t relaxations);

  /// @brief Method get_CompilationRelaxations, addr 0x5b6e984, size 0x8, virtual false, abstract: false, final false
