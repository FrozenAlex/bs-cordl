...
public:
  ...
  /// @brief Method .ctor, addr 0x5a338ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* stateMachineType);

  /// @brief Method get_StateMachineType, addr 0x5a34824, size 0x8, virtual false, abstract: false, final false
