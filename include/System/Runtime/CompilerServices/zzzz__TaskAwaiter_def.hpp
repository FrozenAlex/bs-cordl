...
public:
  ...
  /// @brief Method <OutputWaitEtwEvents>b__0, addr 0x5b6d094, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b6d090, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetResult, addr 0x5b6cc68, size 0x8, virtual false, abstract: false, final false
  inline void GetResult();

  /// @brief Method HandleNonSuccessAndDebuggerNotification, addr 0x5b6cca0, size 0x6c, virtual false, abstract: false, final false
  static inline void HandleNonSuccessAndDebuggerNotification(::System::Threading::Tasks::Task* task);

  /// @brief Method OnCompleted, addr 0x5b6c850, size 0x10, virtual true, abstract: false, final true
  inline void OnCompleted(::System::Action* continuation);

  /// @brief Method OnCompletedInternal, addr 0x5b6cbb8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method OutputWaitEtwEvents, addr 0x5b6ce48, size 0x248, virtual false, abstract: false, final false
  static inline ::System::Action* OutputWaitEtwEvents(::System::Threading::Tasks::Task* task, ::System::Action* continuation);

  /// @brief Method ThrowForNonSuccess, addr 0x5b6cd0c, size 0x13c, virtual false, abstract: false, final false
  static inline void ThrowForNonSuccess(::System::Threading::Tasks::Task* task);

  /// @brief Method UnsafeOnCompleted, addr 0x5b6c9f4, size 0x10, virtual true, abstract: false, final true
  inline void UnsafeOnCompleted(::System::Action* continuation);

  /// @brief Method ValidateEnd, addr 0x5b6cc70, size 0x30, virtual false, abstract: false, final false
  static inline void ValidateEnd(::System::Threading::Tasks::Task* task);

  /// @brief Method .ctor, addr 0x5b6cb98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Threading::Tasks::Task* task);

  /// @brief Method get_IsCompleted, addr 0x5b6cba0, size 0x18, virtual false, abstract: false, final false
