...
template <typename TResult> inline void System::Runtime::CompilerServices::ValueTaskAwaiter_1<TResult>::_ctor(::System::Threading::Tasks::ValueTask_1<TResult> value) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Runtime::CompilerServices::ValueTaskAwaiter_1<TResult>>(),
...
template <typename TResult> inline bool System::Runtime::CompilerServices::ValueTaskAwaiter_1<TResult>::get_IsCompleted() {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Runtime::CompilerServices::ValueTaskAwaiter_1<TResult>>(), { "get_IsCompleted", {}, {} })));
...
template <typename TResult> inline TResult System::Runtime::CompilerServices::ValueTaskAwaiter_1<TResult>::GetResult() {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Runtime::CompilerServices::ValueTaskAwaiter_1<TResult>>(), { "GetResult", {}, {} })));
...
template <typename TResult> inline void System::Runtime::CompilerServices::ValueTaskAwaiter_1<TResult>::OnCompleted(::System::Action* continuation) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Runtime::CompilerServices::ValueTaskAwaiter_1<TResult>>(), { "OnCompleted", {}, { ::i2c::type_of<::System::Action*>() } })));
...
template <typename TResult> inline void System::Runtime::CompilerServices::ValueTaskAwaiter_1<TResult>::UnsafeOnCompleted(::System::Action* continuation) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{},
                   (::i2c::find_method(::i2c::class_of<::System::Runtime::CompilerServices::ValueTaskAwaiter_1<TResult>>(), { "UnsafeOnCompleted", {}, { ::i2c::type_of<::System::Action*>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(*this, ___internal_method, continuation);
}
...
System::Runtime::CompilerServices::ValueTaskAwaiter_1<TResult>::i___System__Runtime__CompilerServices__ICriticalNotifyCompletion() {
  return static_cast<::System::Runtime::CompilerServices::ICriticalNotifyCompletion*>(static_cast<void*>(::i2c::to_object<true>(*this, false)));
}
