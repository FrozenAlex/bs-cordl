...
public:
  ...
  /// @brief Method <.cctor>b__9_0, addr 0x5b6cb28, size 0x70, virtual false, abstract: false, final false
  inline void __cctor_b__9_0(::System::Object* state);

  /// @brief Method .ctor, addr 0x5b6cb24, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetResult, addr 0x5b6c55c, size 0x160, virtual false, abstract: false, final false
  inline void GetResult();

  /// @brief Method OnCompleted, addr 0x5b6c6bc, size 0x194, virtual true, abstract: false, final true
  inline void OnCompleted(::System::Action* continuation);

  /// @brief Method UnsafeOnCompleted, addr 0x5b6c860, size 0x194, virtual true, abstract: false, final true
  inline void UnsafeOnCompleted(::System::Action* continuation);

  /// @brief Method .ctor, addr 0x5b6c408, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsCompleted, addr 0x5b6c410, size 0x14c, virtual false, abstract: false, final false
