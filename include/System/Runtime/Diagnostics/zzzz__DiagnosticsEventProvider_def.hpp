...
DEFINE_IL2CPP_CLASS(::System::Runtime::Diagnostics::DiagnosticsEventProvider_WriteEventErrorCode, "System.Runtime.Diagnostics", "DiagnosticsEventProvider/WriteEventErrorCode");
...
static_assert(sizeof(::System::Runtime::Diagnostics::DiagnosticsEventProvider_WriteEventErrorCode) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method Deregister, addr 0x604a6e8, size 0x20, virtual false, abstract: false, final false
  inline void Deregister();

  /// @brief Method Dispose, addr 0x604a634, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x604a6a4, size 0x44, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EtwEnableCallBack, addr 0x604a758, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method EtwRegister, addr 0x604a51c, size 0x118, virtual false, abstract: false, final false
  inline void EtwRegister();

  /// @brief Method Finalize, addr 0x604a708, size 0x50, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method IsEnabled, addr 0x604a778, size 0x8, virtual false, abstract: false, final false
  inline bool IsEnabled();

  /// @brief Method IsEnabled, addr 0x604a780, size 0x44, virtual false, abstract: false, final false
  inline bool IsEnabled(uint8_t level, int64_t keywords);

  /// @brief Method IsEventEnabled, addr 0x604a7c4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetActivityId, addr 0x604aa38, size 0xc, virtual false, abstract: false, final false
  static inline void SetActivityId(::by_ref<::System::Guid> id);

  /// @brief Method SetLastError, addr 0x604a810, size 0x94, virtual false, abstract: false, final false
  static inline void SetLastError(int32_t error);

  /// @brief Method WriteEvent, addr 0x604a8a4, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteEvent, addr 0x604aa44, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x604a4d4, size 0x48, virtual false, abstract: false, final false
