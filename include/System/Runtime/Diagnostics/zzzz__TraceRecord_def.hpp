...
// Write type traits
MARK_REF_T(::System::Runtime::Diagnostics::TraceRecord*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Diagnostics::TraceRecord*, "System.Runtime.Diagnostics", "TraceRecord");
...
public:
  ...
  /// @brief Method WriteTo, addr 0x60512ec, size 0x4, virtual true, abstract: false, final false
  inline void WriteTo(::System::Xml::XmlWriter* writer);

  /// @brief Method .ctor, addr 0x604c47c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Runtime::Diagnostics::TraceRecord) == 0x10, "Size mismatch!");
