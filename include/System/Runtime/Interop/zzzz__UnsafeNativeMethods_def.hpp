...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6183354, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61832d4, size 0x80, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method EventActivityIdControl, addr 0x6183114, size 0x84, virtual false, abstract: false, final false
  static inline uint32_t EventActivityIdControl(::ByRefConst<int32_t> ControlCode, ::by_ref<::System::Guid> ActivityId);

  /// @brief Method EventEnabled, addr 0x6182fe8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method EventRegister, addr 0x6182ec0, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method EventUnregister, addr 0x6182f68, size 0x80, virtual false, abstract: false, final false
  static inline uint32_t EventUnregister(::ByRefConst<int64_t> registrationHandle);

  /// @brief Method EventWrite, addr 0x6183074, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterEventSource, addr 0x6182d14, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReportEvent, addr 0x6183198, size 0x13c, virtual false, abstract: false, final false
