...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::System::Runtime::Interop::UnsafeNativeMethods_EtwEnableCallback::*)(::System::Object*, ::System::IntPtr)>(
  ...
  constexpr static std::size_t addrs = 0x604a43c;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::System::Runtime::Interop::UnsafeNativeMethods_EtwEnableCallback::*)(
  ...
  constexpr static std::size_t addrs = 0x604a4bc;
...
inline void System::Runtime::Interop::UnsafeNativeMethods_EtwEnableCallback::Invoke(::by_ref<::System::Guid> sourceId, ::ByRefConst<int32_t> isEnabled, ::ByRefConst<uint8_t> level,
  ...
  auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Runtime::Interop::UnsafeNativeMethods_EtwEnableCallback*>(), 13 })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<uint32_t (*)(::by_ref<::System::Guid>, ::ByRefConst<::System::Runtime::Interop::UnsafeNativeMethods_EtwEnableCallback*>, ::ByRefConst<void*>,
  ...
  constexpr static std::size_t addrs = 0x604a028;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Runtime::Interop::UnsafeNativeMethods*>(),
                                                { "EventRegister",
                                                  {},
                                                  { ::i2c::type_of<::by_ref<::System::Guid>>(), ::i2c::type_of<::ByRefConst<::System::Runtime::Interop::UnsafeNativeMethods_EtwEnableCallback*>>(),
                                                    ::i2c::type_of<::ByRefConst<void*>>(), ::i2c::type_of<::by_ref<int64_t>>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<uint32_t (*)(::ByRefConst<int64_t>)>(&::System::Runtime::Interop::UnsafeNativeMethods::EventUnregister)> {
  constexpr static std::size_t size = 0x80;
  constexpr static std::size_t addrs = 0x604a0d0;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Runtime::Interop::UnsafeNativeMethods*>(), { "EventUnregister", {}, { ::i2c::type_of<::ByRefConst<int64_t>>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (*)(::ByRefConst<int64_t>, ::by_ref<::System::Runtime::Diagnostics::EventDescriptor>)>(
  ...
  constexpr static std::size_t addrs = 0x604a150;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<uint32_t (*)(::ByRefConst<int64_t>, ::by_ref<::System::Runtime::Diagnostics::EventDescriptor>, ::ByRefConst<uint32_t>,
  ...
  constexpr static std::size_t addrs = 0x604a1dc;
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Runtime::Interop::UnsafeNativeMethods*>(),
                                                { "EventWrite",
                                                  {},
                                                  { ::i2c::type_of<::ByRefConst<int64_t>>(), ::i2c::type_of<::by_ref<::System::Runtime::Diagnostics::EventDescriptor>>(),
                                                    ::i2c::type_of<::ByRefConst<uint32_t>>(), ::i2c::type_of<::ByRefConst<::System::Runtime::Interop::UnsafeNativeMethods_EventData*>>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<uint32_t (*)(::ByRefConst<int32_t>, ::by_ref<::System::Guid>)>(&::System::Runtime::Interop::UnsafeNativeMethods::EventActivityIdControl)> {
  ...
  constexpr static std::size_t addrs = 0x604a27c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Runtime::Interop::UnsafeNativeMethods*>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (*)(::System::Runtime::InteropServices::SafeHandle*, uint16_t, uint16_t, uint32_t, ::ArrayW<uint8_t>, uint16_t, uint32_t,
  ...
  constexpr static std::size_t addrs = 0x604a300;
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Runtime::Interop::UnsafeNativeMethods*>(),
                                                             { "ReportEvent",
                                                               {},
                                                               { ::i2c::type_of<::System::Runtime::InteropServices::SafeHandle*>(), ::i2c::type_of<uint16_t>(), ::i2c::type_of<uint16_t>(),
                                                                 ::i2c::type_of<uint32_t>(), ::i2c::type_of<::ArrayW<uint8_t>>(), ::i2c::type_of<uint16_t>(), ::i2c::type_of<uint32_t>(),
                                                                 ::i2c::type_of<::System::Runtime::InteropServices::HandleRef>(), ::i2c::type_of<::ArrayW<uint8_t>>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Runtime::Interop::SafeEventLogWriteHandle* (*)(::StringW, ::StringW)>(
  ...
  constexpr static std::size_t addrs = 0x6049e7c;
...
inline uint32_t System::Runtime::Interop::UnsafeNativeMethods::EventRegister(::by_ref<::System::Guid> providerId,
...
inline uint32_t System::Runtime::Interop::UnsafeNativeMethods::EventWrite(::ByRefConst<int64_t> registrationHandle, ::by_ref<::System::Runtime::Diagnostics::EventDescriptor> eventDescriptor,
...
inline bool System::Runtime::Interop::UnsafeNativeMethods::ReportEvent(::System::Runtime::InteropServices::SafeHandle* hEventLog, uint16_t type, uint16_t category, uint32_t eventID,
                                                                       ::ArrayW<uint8_t> userSID, uint16_t numStrings, uint32_t dataLen, ::System::Runtime::InteropServices::HandleRef strings,
