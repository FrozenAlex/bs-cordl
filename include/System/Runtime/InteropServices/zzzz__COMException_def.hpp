...
public:
  ...
  /// @brief Method ToString, addr 0x5a30294, size 0x1f4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x5a30288, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5a3028c, size 0x8, virtual false, abstract: false, final false
