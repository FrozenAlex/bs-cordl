...
public:
  ...
  /// @brief Method Create, addr 0x5a2fca8, size 0x1c, virtual false, abstract: false, final false
  static inline ::System::Runtime::InteropServices::OSPlatform Create(::StringW osPlatform);

  /// @brief Method Equals, addr 0x5a2fd44, size 0xb4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x5a2fd34, size 0x10, virtual false, abstract: false, final false
  inline bool Equals(::StringW other);

  /// @brief Method Equals, addr 0x5a2fcc4, size 0x70, virtual true, abstract: false, final true
  inline bool Equals(::System::Runtime::InteropServices::OSPlatform other);

  /// @brief Method GetHashCode, addr 0x5a2fdf8, size 0x18, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x5a2fe10, size 0x20, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x5a2fbf4, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Linux, addr 0x5a2fae0, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Runtime::InteropServices::OSPlatform get_Linux();

  /// @brief Method get_OSX, addr 0x5a2fb3c, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Runtime::InteropServices::OSPlatform get_OSX();

  /// @brief Method get_Windows, addr 0x5a2fb98, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x5a2fe30, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::InteropServices::OSPlatform) == 0x8, "Size mismatch!");
