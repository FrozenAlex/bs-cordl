...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Runtime::InteropServices::CallingConvention (::System::Runtime::InteropServices::UnmanagedFunctionPointerAttribute::*)()>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x5b67fa4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Runtime::InteropServices::UnmanagedFunctionPointerAttribute*>(), { "get_CallingConvention", {}, {} })));
    return ___internal_method;
  }
};
