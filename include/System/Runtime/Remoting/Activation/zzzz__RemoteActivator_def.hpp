...
public:
  ...
  /// @brief Method Activate, addr 0x5a01df8, size 0x444, virtual true, abstract: false, final true
  ...
  /// @brief Method get_NextActivator, addr 0x5a0223c, size 0x38, virtual true, abstract: false, final true
