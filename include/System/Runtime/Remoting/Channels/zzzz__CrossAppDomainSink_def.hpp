...
public:
  ...
  /// @brief Method AsyncProcessMessage, addr 0x5a00658, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetSink, addr 0x59ffc3c, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessMessageInDomain, addr 0x59fff34, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method SendAsyncMessage, addr 0x5a00724, size 0x11c, virtual false, abstract: false, final false
  inline void SendAsyncMessage(::System::Object* data);

  /// @brief Method SyncProcessMessage, addr 0x5a001e4, size 0x3ac, virtual true, abstract: false, final false
  ...
  /// @brief Method <AsyncProcessMessage>b__10_0, addr 0x5a00934, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59fff24, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_TargetDomainId, addr 0x59fff2c, size 0x8, virtual false, abstract: false, final false
