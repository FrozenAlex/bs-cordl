...
public:
  ...
  /// @brief Method GetInOutArgs, addr 0x5b3b7d8, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b3b614, size 0x1c4, virtual false, abstract: false, final false
