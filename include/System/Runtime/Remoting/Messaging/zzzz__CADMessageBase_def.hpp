...
public:
  ...
  /// @brief Method GetLogicalCallContext, addr 0x5a06468, size 0x94, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Messaging::LogicalCallContext* GetLogicalCallContext(::System::Collections::ArrayList* args);

  /// @brief Method GetMethod, addr 0x5a04a18, size 0x84, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodBase* GetMethod();

  /// @brief Method GetSignature, addr 0x5a04a9c, size 0x1c0, virtual false, abstract: false, final false
  static inline ::ArrayW<::System::Type*> GetSignature(::System::Reflection::MethodBase* methodBase, bool load);

  /// @brief Method IsPossibleToIgnoreMarshal, addr 0x5a05620, size 0x17c, virtual false, abstract: false, final false
  static inline bool IsPossibleToIgnoreMarshal(::System::Object* obj);

  /// @brief Method MarshalArgument, addr 0x5a0579c, size 0x16c, virtual false, abstract: false, final false
  inline ::System::Object* MarshalArgument(::System::Object* arg, ::by_ref<::System::Collections::ArrayList*> args);

  /// @brief Method MarshalArguments, addr 0x5a06054, size 0xf4, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*> MarshalArguments(::ArrayW<::System::Object*> arguments, ::by_ref<::System::Collections::ArrayList*> args);

  /// @brief Method MarshalProperties, addr 0x5a04c5c, size 0x6e4, virtual false, abstract: false, final false
  ...
  /// @brief Method SaveLogicalCallContext, addr 0x5a0623c, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method UnmarshalArgument, addr 0x5a05908, size 0x74c, virtual false, abstract: false, final false
  inline ::System::Object* UnmarshalArgument(::System::Object* arg, ::System::Collections::ArrayList* args);

  /// @brief Method UnmarshalArguments, addr 0x5a06148, size 0xf4, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*> UnmarshalArguments(::ArrayW<::System::Object*> arguments, ::System::Collections::ArrayList* args);

  /// @brief Method UnmarshalProperties, addr 0x5a054e0, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a04998, size 0x80, virtual false, abstract: false, final false
