...
public:
  ...
  /// @brief Method Create, addr 0x5a00590, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method GetArgs, addr 0x5a0683c, size 0x10, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*> GetArgs(::System::Collections::ArrayList* args);

  /// @brief Method GetArguments, addr 0x5a066f4, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a06504, size 0x1f0, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Remoting::Messaging::IMethodCallMessage* callMsg);

  /// @brief Method get_PropertiesCount, addr 0x5a0684c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_PropertiesCount();

  /// @brief Method get_Uri, addr 0x5a064fc, size 0x8, virtual false, abstract: false, final false
