...
public:
  // Declarations
  /// @brief Method LogicalGetData, addr 0x5b3a28c, size 0x40, virtual false, abstract: false, final false
  static inline ::System::Object* LogicalGetData(::StringW name);

  /// @brief Method LogicalSetData, addr 0x5b3a2dc, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCurrentCallContext, addr 0x5b3a284, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Object* SetCurrentCallContext(::System::Runtime::Remoting::Messaging::LogicalCallContext* ctx);

  /// @brief Method SetLogicalCallContext, addr 0x5b25828, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b3a280, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
