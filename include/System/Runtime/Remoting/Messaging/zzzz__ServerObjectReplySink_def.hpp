...
public:
  ...
  /// @brief Method AsyncProcessMessage, addr 0x5a0f2d0, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method SyncProcessMessage, addr 0x5a0f1fc, size 0xd4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5a0f1f4, size 0x8, virtual false, abstract: false, final false
