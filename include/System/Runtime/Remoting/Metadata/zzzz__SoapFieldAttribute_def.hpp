...
public:
  ...
  /// @brief Method IsInteropXmlElement, addr 0x5a0229c, size 0x8, virtual false, abstract: false, final false
  inline bool IsInteropXmlElement();

  static inline ::System::Runtime::Remoting::Metadata::SoapFieldAttribute* New_ctor();

  /// @brief Method SetReflectionObject, addr 0x5a022a4, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a02290, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_XmlElementName, addr 0x5a02294, size 0x8, virtual false, abstract: false, final false
