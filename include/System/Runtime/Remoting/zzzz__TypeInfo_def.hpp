...
public:
  ...
  /// @brief Method CanCastTo, addr 0x59f4c70, size 0x24c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x59f2748, size 0x364, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_TypeName, addr 0x59f4c68, size 0x8, virtual true, abstract: false, final true
