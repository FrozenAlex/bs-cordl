...
public:
  ...
  /// @brief Method ToString, addr 0x5b2cad0, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b2c9d0, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName, ::StringW assemblyName, ::StringW objectUrl);

  /// @brief Method get_ApplicationUrl, addr 0x5b2cab8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ApplicationUrl();

  /// @brief Method get_ObjectType, addr 0x5b2cac0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_ObjectType();

  /// @brief Method get_ObjectUrl, addr 0x5b2cac8, size 0x8, virtual false, abstract: false, final false
