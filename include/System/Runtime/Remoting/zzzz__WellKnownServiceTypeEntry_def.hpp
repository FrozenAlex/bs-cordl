...
public:
  ...
  /// @brief Method ToString, addr 0x59f50ec, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59f4fe0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Mode, addr 0x59f50d4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::WellKnownObjectMode get_Mode();

  /// @brief Method get_ObjectType, addr 0x59f50dc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_ObjectType();

  /// @brief Method get_ObjectUri, addr 0x59f50e4, size 0x8, virtual false, abstract: false, final false
