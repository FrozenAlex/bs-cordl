...
public:
  ...
  /// @brief Method Read, addr 0x5a1d6e0, size 0x3cc, virtual true, abstract: false, final true
  inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser* input);

  /// @brief Method Set, addr 0x5a1d3bc, size 0x40, virtual false, abstract: false, final false
  inline void Set(int32_t objectId, int32_t rank, ::ArrayW<int32_t> lengthA, ::ArrayW<int32_t> lowerBoundA, ::System::Runtime::Serialization::Formatters::Binary::BinaryTypeEnum binaryTypeEnum,
                  ::System::Object* typeInformation, ::System::Runtime::Serialization::Formatters::Binary::BinaryArrayTypeEnum binaryArrayTypeEnum, int32_t assemId);

  /// @brief Method Write, addr 0x5a1d3fc, size 0x2e4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5a1d3b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5a1d3b4, size 0x8, virtual false, abstract: false, final false
