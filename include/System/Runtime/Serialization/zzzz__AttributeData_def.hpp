...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::AttributeData*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::AttributeData*, "System.Runtime.Serialization", "AttributeData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x614ddac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Runtime::Serialization::AttributeData) == 0x30, "Size mismatch!");
