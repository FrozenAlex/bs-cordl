...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::BooleanDataContract*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::BooleanDataContract*, "System.Runtime.Serialization", "BooleanDataContract");
...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x601b0ac, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x601b058, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x601af34, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ReadMethodName, addr 0x601b014, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x601afd0, size 0x44, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::BooleanDataContract) == 0x30, "Size mismatch!");
