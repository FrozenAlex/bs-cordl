...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::DataContractResolver*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::DataContractResolver*, "System.Runtime.Serialization", "DataContractResolver");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6143b00, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Runtime::Serialization::DataContractResolver) == 0x10, "Size mismatch!");
