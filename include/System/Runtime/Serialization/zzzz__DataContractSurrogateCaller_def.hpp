...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::DataContractSurrogateCaller*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::DataContractSurrogateCaller*, "System.Runtime.Serialization", "DataContractSurrogateCaller");
...
public:
  // Declarations
  /// @brief Method GetDataContractType, addr 0x6017134, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDeserializedObject, addr 0x6017314, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetObjectToSerialize, addr 0x6017220, size 0xf4, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::DataContractSurrogateCaller) == 0x10, "Size mismatch!");
