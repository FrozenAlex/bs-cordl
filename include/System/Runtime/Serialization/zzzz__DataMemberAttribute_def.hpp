...
public:
  ...
  /// @brief Method .ctor, addr 0x600c670, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_EmitDefaultValue, addr 0x600c6bc, size 0x8, virtual false, abstract: false, final false
  inline bool get_EmitDefaultValue();

  /// @brief Method get_IsNameSetExplicitly, addr 0x600c69c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNameSetExplicitly();

  /// @brief Method get_IsRequired, addr 0x600c6ac, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsRequired();

  /// @brief Method get_Name, addr 0x600c684, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Order, addr 0x600c6a4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Order();

  /// @brief Method set_IsRequired, addr 0x600c6b4, size 0x8, virtual false, abstract: false, final false
  inline void set_IsRequired(bool value);

  /// @brief Method set_Name, addr 0x600c68c, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::DataMemberAttribute) == 0x28, "Size mismatch!");
