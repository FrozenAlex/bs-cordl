...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::ENTITYDataContract*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::ENTITYDataContract*, "System.Runtime.Serialization", "ENTITYDataContract");
...
public:
  ...
  /// @brief Method .ctor, addr 0x601d608, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Runtime::Serialization::ENTITYDataContract) == 0x30, "Size mismatch!");
