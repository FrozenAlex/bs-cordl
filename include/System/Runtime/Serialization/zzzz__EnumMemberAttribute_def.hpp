...
public:
  ...
  /// @brief Method get_IsValueSetExplicitly, addr 0x600fba0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsValueSetExplicitly();

  /// @brief Method get_Value, addr 0x600fb98, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::EnumMemberAttribute) == 0x20, "Size mismatch!");
