...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::GYearDataContract*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::GYearDataContract*, "System.Runtime.Serialization", "GYearDataContract");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6155fc0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Runtime::Serialization::GYearDataContract) == 0x30, "Size mismatch!");
