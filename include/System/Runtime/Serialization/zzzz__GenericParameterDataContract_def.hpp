...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::GenericParameterDataContract*);
MARK_REF_T(::System::Runtime::Serialization::GenericParameterDataContract_GenericParameterDataContractCriticalHelper*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::GenericParameterDataContract*, "System.Runtime.Serialization", "GenericParameterDataContract");
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::GenericParameterDataContract_GenericParameterDataContractCriticalHelper*, "System.Runtime.Serialization",
...
public:
  ...
  /// @brief Method .ctor, addr 0x614de60, size 0xa4, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::GenericParameterDataContract_GenericParameterDataContractCriticalHelper) == 0x50, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6140fcc, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_IsBuiltInDataContract, addr 0x614df04, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::GenericParameterDataContract) == 0x30, "Size mismatch!");
