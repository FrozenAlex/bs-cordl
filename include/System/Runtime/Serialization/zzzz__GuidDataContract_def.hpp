...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x61570c4, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x615703c, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6156ec4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6156f2c, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDictionaryString* name, ::System::Xml::XmlDictionaryString* ns);

  /// @brief Method get_ReadMethodName, addr 0x6156ff8, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x6156fb4, size 0x44, virtual true, abstract: false, final false
