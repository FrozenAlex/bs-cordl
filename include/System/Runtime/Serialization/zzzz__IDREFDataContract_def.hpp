...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::IDREFDataContract*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::IDREFDataContract*, "System.Runtime.Serialization", "IDREFDataContract");
...
public:
  ...
  /// @brief Method .ctor, addr 0x61563d0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Runtime::Serialization::IDREFDataContract) == 0x30, "Size mismatch!");
