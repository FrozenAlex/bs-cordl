...
public:
  ...
  /// @brief Method Clear, addr 0x6149500, size 0x4c, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method GetData, addr 0x614940c, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6149260, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_FactoryTypeName, addr 0x61493dc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FactoryTypeName();

  /// @brief Method get_FactoryTypeNamespace, addr 0x61493ec, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FactoryTypeNamespace();

  /// @brief Method get_Members, addr 0x61493fc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::System::Runtime::Serialization::ISerializableDataMember*>* get_Members();

  /// @brief Method set_FactoryTypeName, addr 0x61493e4, size 0x8, virtual false, abstract: false, final false
  inline void set_FactoryTypeName(::StringW value);

  /// @brief Method set_FactoryTypeNamespace, addr 0x61493f4, size 0x8, virtual false, abstract: false, final false
  inline void set_FactoryTypeNamespace(::StringW value);

  /// @brief Method set_Members, addr 0x6149404, size 0x8, virtual false, abstract: false, final false
