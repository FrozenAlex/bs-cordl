...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x6154e18, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x6154dc4, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6154c70, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6154cd8, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDictionaryString* name, ::System::Xml::XmlDictionaryString* ns);

  /// @brief Method get_ReadMethodName, addr 0x6154d80, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x6154d3c, size 0x44, virtual true, abstract: false, final false
