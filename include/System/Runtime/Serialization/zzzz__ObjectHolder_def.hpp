...
public:
  ...
  /// @brief Method AddDependency, addr 0x5a170e4, size 0x80, virtual false, abstract: false, final false
  inline void AddDependency(int64_t dependentObject);

  /// @brief Method AddFixup, addr 0x5a17024, size 0xc0, virtual false, abstract: false, final false
  inline void AddFixup(::System::Runtime::Serialization::FixupHolder* fixup, ::System::Runtime::Serialization::ObjectManager* manager);

  /// @brief Method DecrementFixupsRemaining, addr 0x5a15d1c, size 0x24, virtual false, abstract: false, final false
  inline void DecrementFixupsRemaining(::System::Runtime::Serialization::ObjectManager* manager);

  /// @brief Method IncrementDescendentFixups, addr 0x5a17920, size 0x10, virtual false, abstract: false, final false
  inline void IncrementDescendentFixups(int32_t amount);

  /// @brief Method MarkForCompletionWhenAvailable, addr 0x5a15db8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveDependency, addr 0x5a15d40, size 0x14, virtual false, abstract: false, final false
  inline void RemoveDependency(int64_t id);

  /// @brief Method SetFlags, addr 0x5a14abc, size 0xc0, virtual false, abstract: false, final false
  inline void SetFlags();

  /// @brief Method SetObjectValue, addr 0x5a149bc, size 0x100, virtual false, abstract: false, final false
  inline void SetObjectValue(::System::Object* obj, ::System::Runtime::Serialization::ObjectManager* manager);

  /// @brief Method UpdateData, addr 0x5a16858, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateDescendentDependencyChain, addr 0x5a17930, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a15fec, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a16684, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a1430c, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(int64_t objID);

  /// @brief Method get_CanObjectValueChange, addr 0x5a146cc, size 0x20, virtual false, abstract: false, final false
  inline bool get_CanObjectValueChange();

  /// @brief Method get_CanSurrogatedObjectValueChange, addr 0x5a14928, size 0x94, virtual false, abstract: false, final false
  inline bool get_CanSurrogatedObjectValueChange();

  /// @brief Method get_CompletelyFixed, addr 0x5a146ac, size 0x20, virtual false, abstract: false, final false
  inline bool get_CompletelyFixed();

  /// @brief Method get_ContainerID, addr 0x5a17a28, size 0x18, virtual false, abstract: false, final false
  inline int64_t get_ContainerID();

  /// @brief Method get_DependentObjects, addr 0x5a17b14, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::LongList* get_DependentObjects();

  /// @brief Method get_DirectlyDependentObjects, addr 0x5a17acc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_DirectlyDependentObjects();

  /// @brief Method get_HasISerializable, addr 0x5a15c2c, size 0xc, virtual false, abstract: false, final false
  inline bool get_HasISerializable();

  /// @brief Method get_HasSurrogate, addr 0x5a1491c, size 0xc, virtual false, abstract: false, final false
  inline bool get_HasSurrogate();

  /// @brief Method get_IsIncompleteObjectReference, addr 0x5a146ec, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsIncompleteObjectReference();

  /// @brief Method get_ObjectValue, addr 0x5a17af4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_ObjectValue();

  /// @brief Method get_Reachable, addr 0x5a17ad4, size 0x8, virtual false, abstract: false, final false
  inline bool get_Reachable();

  /// @brief Method get_RequiresDelayedFixup, addr 0x5a16848, size 0x10, virtual false, abstract: false, final false
  inline bool get_RequiresDelayedFixup();

  /// @brief Method get_RequiresSerInfoFixup, addr 0x5a16e8c, size 0x18, virtual false, abstract: false, final false
  inline bool get_RequiresSerInfoFixup();

  /// @brief Method get_RequiresValueTypeFixup, addr 0x5a14e24, size 0xc, virtual false, abstract: false, final false
  inline bool get_RequiresValueTypeFixup();

  /// @brief Method get_SerializationInfo, addr 0x5a17afc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::SerializationInfo* get_SerializationInfo();

  /// @brief Method get_Surrogate, addr 0x5a17b0c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::ISerializationSurrogate* get_Surrogate();

  /// @brief Method get_TotalDependentObjects, addr 0x5a169d8, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_TotalDependentObjects();

  /// @brief Method get_TypeLoadException, addr 0x5a17ae4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::TypeLoadExceptionHolder* get_TypeLoadException();

  /// @brief Method get_TypeLoadExceptionReachable, addr 0x5a15d54, size 0x10, virtual false, abstract: false, final false
  inline bool get_TypeLoadExceptionReachable();

  /// @brief Method get_ValueFixup, addr 0x5a17b24, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::ValueTypeFixupInfo* get_ValueFixup();

  /// @brief Method get_ValueTypeFixupPerformed, addr 0x5a14e30, size 0x38, virtual false, abstract: false, final false
  inline bool get_ValueTypeFixupPerformed();

  /// @brief Method set_DependentObjects, addr 0x5a17b1c, size 0x8, virtual false, abstract: false, final false
  inline void set_DependentObjects(::System::Runtime::Serialization::LongList* value);

  /// @brief Method set_IsIncompleteObjectReference, addr 0x5a15644, size 0x10, virtual false, abstract: false, final false
  inline void set_IsIncompleteObjectReference(bool value);

  /// @brief Method set_Reachable, addr 0x5a17adc, size 0x8, virtual false, abstract: false, final false
  inline void set_Reachable(bool value);

  /// @brief Method set_RequiresSerInfoFixup, addr 0x5a14e04, size 0x20, virtual false, abstract: false, final false
  inline void set_RequiresSerInfoFixup(bool value);

  /// @brief Method set_SerializationInfo, addr 0x5a17b04, size 0x8, virtual false, abstract: false, final false
  inline void set_SerializationInfo(::System::Runtime::Serialization::SerializationInfo* value);

  /// @brief Method set_TypeLoadException, addr 0x5a17aec, size 0x8, virtual false, abstract: false, final false
  inline void set_TypeLoadException(::System::Runtime::Serialization::TypeLoadExceptionHolder* value);

  /// @brief Method set_ValueTypeFixupPerformed, addr 0x5a15d64, size 0x14, virtual false, abstract: false, final false
