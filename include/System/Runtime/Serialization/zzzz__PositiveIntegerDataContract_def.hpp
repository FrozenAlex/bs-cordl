...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::PositiveIntegerDataContract*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::PositiveIntegerDataContract*, "System.Runtime.Serialization", "PositiveIntegerDataContract");
...
public:
  ...
  /// @brief Method .ctor, addr 0x601c074, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Runtime::Serialization::PositiveIntegerDataContract) == 0x30, "Size mismatch!");
