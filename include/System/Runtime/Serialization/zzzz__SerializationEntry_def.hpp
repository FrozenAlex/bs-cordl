...
public:
  ...
  /// @brief Method .ctor, addr 0x5a0fd6c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW entryName, ::System::Object* entryValue, ::System::Type* entryType);

  /// @brief Method get_Name, addr 0x5a0fd80, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Value, addr 0x5a0fd78, size 0x8, virtual false, abstract: false, final false
