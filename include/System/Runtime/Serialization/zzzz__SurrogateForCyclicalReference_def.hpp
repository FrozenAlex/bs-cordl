...
public:
  ...
  /// @brief Method GetObjectData, addr 0x5b4b34c, size 0xd4, virtual true, abstract: false, final true
  ...
  /// @brief Method SetObjectData, addr 0x5b4b420, size 0xe8, virtual true, abstract: false, final true
