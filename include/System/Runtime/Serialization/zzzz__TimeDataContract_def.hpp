...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::TimeDataContract*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::TimeDataContract*, "System.Runtime.Serialization", "TimeDataContract");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6155e20, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Runtime::Serialization::TimeDataContract) == 0x30, "Size mismatch!");
