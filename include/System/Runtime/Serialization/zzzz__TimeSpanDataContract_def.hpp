...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::TimeSpanDataContract*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::TimeSpanDataContract*, "System.Runtime.Serialization", "TimeSpanDataContract");
...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x601df04, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x601de7c, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x601dd04, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x601dd6c, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDictionaryString* name, ::System::Xml::XmlDictionaryString* ns);

  /// @brief Method get_ReadMethodName, addr 0x601de38, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x601ddf4, size 0x44, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::TimeSpanDataContract) == 0x30, "Size mismatch!");
