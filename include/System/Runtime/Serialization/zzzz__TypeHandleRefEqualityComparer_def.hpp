...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::TypeHandleRefEqualityComparer*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::TypeHandleRefEqualityComparer*, "System.Runtime.Serialization", "TypeHandleRefEqualityComparer");
...
public:
  ...
  /// @brief Method Equals, addr 0x600abc0, size 0x28, virtual true, abstract: false, final true
  inline bool Equals(::System::Runtime::Serialization::TypeHandleRef* x, ::System::Runtime::Serialization::TypeHandleRef* y);

  /// @brief Method GetHashCode, addr 0x600abe8, size 0x14, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6007450, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Runtime::Serialization::TypeHandleRefEqualityComparer) == 0x10, "Size mismatch!");
