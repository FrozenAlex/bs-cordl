...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::UnsignedByteDataContract*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::UnsignedByteDataContract*, "System.Runtime.Serialization", "UnsignedByteDataContract");
...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x6154370, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x6154314, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61541f0, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ReadMethodName, addr 0x61542d0, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x615428c, size 0x44, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::UnsignedByteDataContract) == 0x30, "Size mismatch!");
