...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::XmlDataContractInterpreter*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::XmlDataContractInterpreter*, "System.Runtime.Serialization", "XmlDataContractInterpreter");
...
public:
  ...
  /// @brief Method CreateXmlSerializable, addr 0x603c724, size 0x138, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::IXmlSerializable* CreateXmlSerializable();

  /// @brief Method GetConstructor, addr 0x603c85c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x603c71c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::XmlDataContractInterpreter) == 0x18, "Size mismatch!");
