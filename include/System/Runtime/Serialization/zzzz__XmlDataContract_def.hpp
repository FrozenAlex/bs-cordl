...
public:
  ...
  /// @brief Method .ctor, addr 0x615a100, size 0x564, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_CreateXmlSerializableDelegate, addr 0x615aed4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::CreateXmlSerializableDelegate* get_CreateXmlSerializableDelegate();

  /// @brief Method get_HasRoot, addr 0x615aeb4, size 0x8, virtual true, abstract: false, final false
  inline bool get_HasRoot();

  /// @brief Method get_IsAnonymous, addr 0x615a6a0, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsAnonymous();

  /// @brief Method get_KnownDataContracts, addr 0x615ad9c, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method get_TopLevelElementName, addr 0x615aec4, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlDictionaryString* get_TopLevelElementName();

  /// @brief Method get_TopLevelElementNamespace, addr 0x615aecc, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlDictionaryString* get_TopLevelElementNamespace();

  /// @brief Method set_CreateXmlSerializableDelegate, addr 0x615aedc, size 0x8, virtual false, abstract: false, final false
  inline void set_CreateXmlSerializableDelegate(::System::Runtime::Serialization::CreateXmlSerializableDelegate* value);

  /// @brief Method set_HasRoot, addr 0x615aebc, size 0x8, virtual true, abstract: false, final false
  inline void set_HasRoot(bool value);

  /// @brief Method set_XsdType, addr 0x615aeac, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Equals, addr 0x615a97c, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateCreateXmlSerializableDelegate, addr 0x615a818, size 0x78, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::CreateXmlSerializableDelegate* GenerateCreateXmlSerializableDelegate();

  /// @brief Method GetHashCode, addr 0x615aac8, size 0x14, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::Runtime::Serialization::XmlDataContract* New_ctor(::System::Type* type);

  /// @brief Method ReadXmlValue, addr 0x615abcc, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x615aadc, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method <GenerateCreateXmlSerializableDelegate>b__39_0, addr 0x615ad48, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x615a050, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_CanContainReferences, addr 0x615a890, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanContainReferences();

  /// @brief Method get_CreateXmlSerializableDelegate, addr 0x615a704, size 0x114, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::CreateXmlSerializableDelegate* get_CreateXmlSerializableDelegate();

  /// @brief Method get_HasRoot, addr 0x615a6b0, size 0x1c, virtual true, abstract: false, final false
  inline bool get_HasRoot();

  /// @brief Method get_IsAnonymous, addr 0x615a680, size 0x20, virtual false, abstract: false, final false
  inline bool get_IsAnonymous();

  /// @brief Method get_IsBuiltInDataContract, addr 0x615a898, size 0xe4, virtual true, abstract: false, final false
  inline bool get_IsBuiltInDataContract();

  /// @brief Method get_KnownDataContracts, addr 0x615a664, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*, ::System::Runtime::Serialization::DataContract*>* get_KnownDataContracts();

  /// @brief Method get_TopLevelElementName, addr 0x615a6cc, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlDictionaryString* get_TopLevelElementName();

  /// @brief Method get_TopLevelElementNamespace, addr 0x615a6e8, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlDictionaryString* get_TopLevelElementNamespace();
