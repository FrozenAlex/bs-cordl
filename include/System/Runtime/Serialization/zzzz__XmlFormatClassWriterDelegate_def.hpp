...
CORDL_MODULE_EXPORT(XmlFormatClassWriterDelegate)
...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::XmlFormatClassWriterDelegate*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::XmlFormatClassWriterDelegate*, "System.Runtime.Serialization", "XmlFormatClassWriterDelegate");
...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6023cf8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6023bb0, size 0x148, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::XmlFormatClassWriterDelegate) == 0x80, "Size mismatch!");
