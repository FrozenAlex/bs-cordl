...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::XmlFormatCollectionReaderDelegate*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::XmlFormatCollectionReaderDelegate*, "System.Runtime.Serialization", "XmlFormatCollectionReaderDelegate");
...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x602310c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6022fc4, size 0x148, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::XmlFormatCollectionReaderDelegate) == 0x80, "Size mismatch!");
