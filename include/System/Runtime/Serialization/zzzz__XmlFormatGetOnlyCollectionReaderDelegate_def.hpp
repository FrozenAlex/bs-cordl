...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::XmlFormatGetOnlyCollectionReaderDelegate*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::XmlFormatGetOnlyCollectionReaderDelegate*, "System.Runtime.Serialization", "XmlFormatGetOnlyCollectionReaderDelegate");
...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x615c100, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x615bfb8, size 0x148, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::XmlFormatGetOnlyCollectionReaderDelegate) == 0x80, "Size mismatch!");
