...
public:
  ...
  /// @brief Method ArgumentOutOfRange, addr 0x617df3c, size 0xac, virtual false, abstract: false, final false
  inline ::System::ArgumentOutOfRangeException* ArgumentOutOfRange(::StringW paramName, ::System::Object* actualValue, ::StringW message);

  /// @brief Method BreakOnException, addr 0x617ecf0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method TraceHandledException, addr 0x617dfe8, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x617df34, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::ExceptionTrace) == 0x20, "Size mismatch!");
