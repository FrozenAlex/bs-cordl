...
// Write type traits
MARK_REF_T(::System::Security::AccessControl::AuthorizationRule*);
DEFINE_IL2CPP_CLASS(::System::Security::AccessControl::AuthorizationRule*, "System.Security.AccessControl", "AuthorizationRule");
...
public:
  ...
  /// @brief Method .ctor, addr 0x59e09a0, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AccessMask, addr 0x59e0bd4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::AccessControl::AuthorizationRule) == 0x28, "Size mismatch!");
