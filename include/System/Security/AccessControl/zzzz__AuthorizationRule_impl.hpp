...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::System::Security::AccessControl::AuthorizationRule::*)(
  ...
  constexpr static std::size_t addrs = 0x59e09a0;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Security::AccessControl::AuthorizationRule*>(),
                                                { ".ctor",
                                                  {},
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::System::Security::AccessControl::AuthorizationRule::*)()>(&::System::Security::AccessControl::AuthorizationRule::get_AccessMask)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x59e0bd4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Security::AccessControl::AuthorizationRule*>(), { "get_AccessMask", {}, {} })));
    return ___internal_method;
  }
};
  ...
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Security::AccessControl::AuthorizationRule*>(),
                                              { ".ctor",
                                                ...
                                                { ::i2c::type_of<::System::Security::Principal::IdentityReference*>(), ::i2c::type_of<int32_t>(), ::i2c::type_of<bool>(),
                                                  ::i2c::type_of<::System::Security::AccessControl::InheritanceFlags>(), ::i2c::type_of<::System::Security::AccessControl::PropagationFlags>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, identity, accessMask, isInherited, inheritanceFlags, propagationFlags);
}
...
inline ::System::Security::AccessControl::AuthorizationRule* System::Security::AccessControl::AuthorizationRule::New_ctor(::System::Security::Principal::IdentityReference* identity,
                                                                                                                          ...
                                                                                                                          ::System::Security::AccessControl::InheritanceFlags inheritanceFlags,
                                                                                                                          ::System::Security::AccessControl::PropagationFlags propagationFlags) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::System::Security::AccessControl::AuthorizationRule*>(identity, accessMask, isInherited, inheritanceFlags, propagationFlags));
}
// Ctor Parameters []
