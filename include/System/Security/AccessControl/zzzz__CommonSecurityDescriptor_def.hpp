...
// Write type traits
MARK_REF_T(::System::Security::AccessControl::CommonSecurityDescriptor*);
DEFINE_IL2CPP_CLASS(::System::Security::AccessControl::CommonSecurityDescriptor*, "System.Security.AccessControl", "CommonSecurityDescriptor");
...
public:
  ...
  /// @brief Method CheckAclConsistency, addr 0x59e33d4, size 0xbc, virtual false, abstract: false, final false
  inline void CheckAclConsistency(::System::Security::AccessControl::CommonAcl* acl);

  /// @brief Method Init, addr 0x59e31a8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59e31a0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DiscretionaryAcl, addr 0x59e335c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::DiscretionaryAcl* get_DiscretionaryAcl();

  /// @brief Method get_IsContainer, addr 0x59e3498, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsContainer();

  /// @brief Method get_IsDS, addr 0x59e34a0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDS();

  /// @brief Method set_DiscretionaryAcl, addr 0x59e3258, size 0x104, virtual false, abstract: false, final false
  inline void set_DiscretionaryAcl(::System::Security::AccessControl::DiscretionaryAcl* value);

  /// @brief Method set_Group, addr 0x59e3490, size 0x8, virtual true, abstract: false, final false
  inline void set_Group(::System::Security::Principal::SecurityIdentifier* value);

  /// @brief Method set_Owner, addr 0x59e34a8, size 0x8, virtual true, abstract: false, final false
  inline void set_Owner(::System::Security::Principal::SecurityIdentifier* value);

  /// @brief Method set_SystemAcl, addr 0x59e3228, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::AccessControl::CommonSecurityDescriptor) == 0x38, "Size mismatch!");
