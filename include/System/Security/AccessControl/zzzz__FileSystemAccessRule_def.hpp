...
public:
  ...
  /// @brief Method .ctor, addr 0x5b1b1d0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FileSystemRights, addr 0x5b1b1d4, size 0x8, virtual false, abstract: false, final false
