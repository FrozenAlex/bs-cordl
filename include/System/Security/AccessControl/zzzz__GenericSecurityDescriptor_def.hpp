...
// Write type traits
MARK_REF_T(::System::Security::AccessControl::GenericSecurityDescriptor*);
DEFINE_IL2CPP_CLASS(::System::Security::AccessControl::GenericSecurityDescriptor*, "System.Security.AccessControl", "GenericSecurityDescriptor");
...
public:
  ...
  /// @brief Method .ctor, addr 0x59e31a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Security::AccessControl::GenericSecurityDescriptor) == 0x10, "Size mismatch!");
