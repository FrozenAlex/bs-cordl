...
// Write type traits
MARK_REF_T(::System::Security::AccessControl::SystemAcl*);
DEFINE_IL2CPP_CLASS(::System::Security::AccessControl::SystemAcl*, "System.Security.AccessControl", "SystemAcl");
...
public:
  // Declarations
  /// @brief Method ApplyCanonicalSortToExplicitAces, addr 0x5b1c618, size 0x20, virtual true, abstract: false, final false
  inline void ApplyCanonicalSortToExplicitAces();

  /// @brief Method GetAceInsertPosition, addr 0x5b1c638, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Security::AccessControl::SystemAcl) == 0x20, "Size mismatch!");
