...
// Write type traits
MARK_REF_T(::System::Security::Authentication::ExtendedProtection::ExtendedProtectionPolicyTypeConverter*);
DEFINE_IL2CPP_CLASS(::System::Security::Authentication::ExtendedProtection::ExtendedProtectionPolicyTypeConverter*, "System.Security.Authentication.ExtendedProtection",
...
public:
  // Declarations
  /// @brief Method CanConvertTo, addr 0x625f02c, size 0x38, virtual true, abstract: false, final false
  inline bool CanConvertTo(::System::ComponentModel::ITypeDescriptorContext* context, ::System::Type* destinationType);

  /// @brief Method ConvertTo, addr 0x625f064, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x625f09c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Security::Authentication::ExtendedProtection::ExtendedProtectionPolicyTypeConverter) == 0x10, "Size mismatch!");
