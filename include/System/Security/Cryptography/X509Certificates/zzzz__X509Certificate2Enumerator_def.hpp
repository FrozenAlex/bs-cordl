...
public:
  ...
  /// @brief Method MoveNext, addr 0x63a165c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerator.MoveNext, addr 0x63a17a8, size 0xa4, virtual true, abstract: false, final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x63a184c, size 0xa8, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x63a1700, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x63a141c, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* collection);

  /// @brief Method get_Current, addr 0x63a1564, size 0xf8, virtual false, abstract: false, final false
