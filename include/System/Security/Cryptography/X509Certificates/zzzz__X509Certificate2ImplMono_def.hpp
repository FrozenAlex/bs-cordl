...
public:
  ...
  /// @brief Method Clone, addr 0x63a1bf4, size 0x68, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateImpl* Clone();

  /// @brief Method GetDSAPrivateKey, addr 0x63a2314, size 0x90, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::DSA* GetDSAPrivateKey();

  /// @brief Method GetRSAPrivateKey, addr 0x63a2284, size 0x90, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::RSA* GetRSAPrivateKey();

  /// @brief Method GetRawCertData, addr 0x63a1c78, size 0x38, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GetRawCertData();

  /// @brief Method ImportPkcs12, addr 0x63a1b9c, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportPkcs12, addr 0x63a23a4, size 0x738, virtual false, abstract: false, final false
  ...
  /// @brief Method Verify, addr 0x63a2c24, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63a19c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::X509::X509Certificate* cert);

  /// @brief Method .ctor, addr 0x63a19cc, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509Certificate2ImplMono* other);

  /// @brief Method .ctor, addr 0x63a1a54, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Cert, addr 0x63a1c5c, size 0x1c, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Certificate* get_Cert();

  /// @brief Method get_HasPrivateKey, addr 0x63a1cb0, size 0x24, virtual true, abstract: false, final false
  inline bool get_HasPrivateKey();

  /// @brief Method get_IntermediateCertificates, addr 0x63a2d54, size 0x8, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateImplCollection* get_IntermediateCertificates();

  /// @brief Method get_IsValid, addr 0x63a19b0, size 0x10, virtual true, abstract: false, final false
  inline bool get_IsValid();

  /// @brief Method get_MonoCertificate, addr 0x63a2d5c, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Certificate* get_MonoCertificate();

  /// @brief Method get_PrivateKey, addr 0x63a1cd4, size 0x418, virtual true, abstract: false, final false
  ...
  /// @brief Method set_PrivateKey, addr 0x63a20ec, size 0x198, virtual true, abstract: false, final false
