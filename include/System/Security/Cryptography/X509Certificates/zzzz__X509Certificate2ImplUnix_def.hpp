...
public:
  ...
  /// @brief Method AppendPrivateKeyInfo, addr 0x63a3228, size 0xb0, virtual true, abstract: false, final true
  inline void AppendPrivateKeyInfo(::System::Text::StringBuilder* sb);

  /// @brief Method EnsureCertData, addr 0x63a2e24, size 0x84, virtual false, abstract: false, final false
  inline void EnsureCertData();

  /// @brief Method GetNameInfo, addr 0x63a3114, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x63a19c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Extensions, addr 0x63a3148, size 0x18, virtual true, abstract: false, final true
  ...
  /// @brief Method get_Issuer, addr 0x63a2f94, size 0x28, virtual true, abstract: false, final true
  inline ::StringW get_Issuer();

  /// @brief Method get_IssuerName, addr 0x63a2f54, size 0x18, virtual true, abstract: false, final true
  inline ::System::Security::Cryptography::X509Certificates::X500DistinguishedName* get_IssuerName();

  /// @brief Method get_KeyAlgorithm, addr 0x63a2ea8, size 0x18, virtual true, abstract: false, final true
  inline ::StringW get_KeyAlgorithm();

  /// @brief Method get_KeyAlgorithmParameters, addr 0x63a2ec0, size 0x18, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> get_KeyAlgorithmParameters();

  /// @brief Method get_NotAfter, addr 0x63a3160, size 0x64, virtual true, abstract: false, final true
  inline ::System::DateTime get_NotAfter();

  /// @brief Method get_NotBefore, addr 0x63a31c4, size 0x64, virtual true, abstract: false, final true
  inline ::System::DateTime get_NotBefore();

  /// @brief Method get_PublicKeyValue, addr 0x63a2ed8, size 0x18, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> get_PublicKeyValue();

  /// @brief Method get_RawData, addr 0x63a2fbc, size 0x18, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> get_RawData();

  /// @brief Method get_SerialNumber, addr 0x63a2ef0, size 0x18, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> get_SerialNumber();

  /// @brief Method get_SignatureAlgorithm, addr 0x63a2f08, size 0x18, virtual true, abstract: false, final true
  inline ::StringW get_SignatureAlgorithm();

  /// @brief Method get_Subject, addr 0x63a2f6c, size 0x28, virtual true, abstract: false, final true
  inline ::StringW get_Subject();

  /// @brief Method get_SubjectName, addr 0x63a2f3c, size 0x18, virtual true, abstract: false, final true
  inline ::System::Security::Cryptography::X509Certificates::X500DistinguishedName* get_SubjectName();

  /// @brief Method get_Thumbprint, addr 0x63a2fd4, size 0x140, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> get_Thumbprint();

  /// @brief Method get_Version, addr 0x63a2f20, size 0x1c, virtual true, abstract: false, final true
