...
public:
  ...
  /// @brief Method CopyWithPrivateKey, addr 0x63a18f4, size 0xb8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x63a19ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
