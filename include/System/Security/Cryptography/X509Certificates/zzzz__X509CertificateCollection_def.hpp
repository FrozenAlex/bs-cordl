...
public:
  ...
  /// @brief Method MoveNext, addr 0x63a3890, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerator.MoveNext, addr 0x63a3744, size 0xa4, virtual true, abstract: false, final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x63a37e8, size 0xa8, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x63a369c, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x63a34d4, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509CertificateCollection* mappings);

  /// @brief Method get_Current, addr 0x63a35a4, size 0xf8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddRange, addr 0x63a3304, size 0xd0, virtual false, abstract: false, final false
  inline void AddRange(::System::Security::Cryptography::X509Certificates::X509CertificateCollection* value);

  /// @brief Method GetEnumerator, addr 0x63a3478, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateCollection_X509CertificateEnumerator* GetEnumerator();

  /// @brief Method GetHashCode, addr 0x63a3588, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x639fd88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x63a32d8, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509CertificateCollection* value);

  /// @brief Method get_Item, addr 0x63a33d4, size 0xa4, virtual false, abstract: false, final false
