...
public:
  ...
  /// @brief Method Add, addr 0x63a2b50, size 0xd4, virtual false, abstract: false, final false
  inline void Add(::System::Security::Cryptography::X509Certificates::X509CertificateImpl* impl, bool takeOwnership);

  /// @brief Method Clone, addr 0x63a19f8, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateImplCollection* Clone();

  /// @brief Method Dispose, addr 0x63a3bc8, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x63a3c38, size 0x1e4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x63a3e1c, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63a2adc, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x63a3934, size 0x1e0, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509CertificateImplCollection* other);

  /// @brief Method get_Count, addr 0x63a3b14, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x63a3b64, size 0x64, virtual false, abstract: false, final false
