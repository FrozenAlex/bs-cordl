...
public:
  ...
  /// @brief Method Dispose, addr 0x59d5728, size 0x74, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x59d6e68, size 0x4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Equals, addr 0x59d6cf4, size 0x174, virtual true, abstract: false, final true
  inline bool Equals(::System::Object* obj);

  /// @brief Method Finalize, addr 0x59d6e6c, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x59d6c7c, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method ThrowIfContextInvalid, addr 0x59d6bbc, size 0x3c, virtual false, abstract: false, final false
  inline void ThrowIfContextInvalid();

  /// @brief Method .ctor, addr 0x59d6ec0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
