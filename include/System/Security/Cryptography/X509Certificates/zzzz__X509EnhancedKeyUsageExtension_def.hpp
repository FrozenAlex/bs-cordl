...
public:
  ...
  /// @brief Method CopyFrom, addr 0x63a8624, size 0x1c4, virtual true, abstract: false, final false
  inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData* asnEncodedData);

  /// @brief Method Decode, addr 0x63a8064, size 0x270, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::AsnDecodeStatus Decode(::ArrayW<uint8_t> extension);

  /// @brief Method Encode, addr 0x63a845c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x63a87e8, size 0x318, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63a7f14, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x63a7fa4, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::AsnEncodedData* encodedEnhancedKeyUsages, bool critical);

  /// @brief Method .ctor, addr 0x63a82d4, size 0x188, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::OidCollection* enhancedKeyUsages, bool critical);

  /// @brief Method get_EnhancedKeyUsages, addr 0x63a8520, size 0x104, virtual false, abstract: false, final false
