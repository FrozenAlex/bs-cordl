...
public:
  ...
  /// @brief Method Add, addr 0x63a91a4, size 0x70, virtual false, abstract: false, final false
  inline int32_t Add(::System::Security::Cryptography::X509Certificates::X509Extension* extension);

  /// @brief Method GetEnumerator, addr 0x63a930c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.ICollection.CopyTo, addr 0x63a9214, size 0xf8, virtual true, abstract: false, final true
  inline void System_Collections_ICollection_CopyTo(::System::Array* array, int32_t index);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x63a93bc, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x63a8d74, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<uint8_t> getStaticF_Empty();

  /// @brief Method get_Count, addr 0x63a8dd0, size 0x20, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsSynchronized, addr 0x63a8df0, size 0x20, virtual true, abstract: false, final true
  inline bool get_IsSynchronized();

  /// @brief Method get_Item, addr 0x63a8e14, size 0x390, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Extension* get_Item(::StringW oid);

  /// @brief Method get_SyncRoot, addr 0x63a8e10, size 0x4, virtual true, abstract: false, final true
