...
public:
  ...
  /// @brief Method MoveNext, addr 0x63a9648, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x63a96ec, size 0xa8, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x63a95a0, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x63a9388, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* list);

  /// @brief Method get_Current, addr 0x63a94a8, size 0xf8, virtual false, abstract: false, final false
