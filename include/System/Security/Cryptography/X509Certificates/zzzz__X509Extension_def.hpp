...
public:
  ...
  /// @brief Method CopyFrom, addr 0x626ee14, size 0x128, virtual true, abstract: false, final false
  inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData* asnEncodedData);

  /// @brief Method FormatUnkownData, addr 0x626ecc8, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x626e168, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x626eddc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid, ::ArrayW<uint8_t> rawData, bool critical);

  /// @brief Method get_Critical, addr 0x626ee04, size 0x8, virtual false, abstract: false, final false
  inline bool get_Critical();

  /// @brief Method set_Critical, addr 0x626ee0c, size 0x8, virtual false, abstract: false, final false
