...
public:
  ...
  /// @brief Method BasicConstraintsExtension, addr 0x639b474, size 0x108, virtual false, abstract: false, final false
  inline ::StringW BasicConstraintsExtension(bool multiLine);

  /// @brief Method CopyFrom, addr 0x639b044, size 0x100, virtual true, abstract: false, final false
  inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData* asnEncodedData);

  /// @brief Method Default, addr 0x639b180, size 0x124, virtual false, abstract: false, final false
  inline ::StringW Default(bool multiLine);

  /// @brief Method EnhancedKeyUsageExtension, addr 0x639b57c, size 0x10c, virtual false, abstract: false, final false
  inline ::StringW EnhancedKeyUsageExtension(bool multiLine);

  /// @brief Method Format, addr 0x639b144, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW Format(bool multiLine);

  /// @brief Method KeyUsageExtension, addr 0x639b688, size 0x10c, virtual false, abstract: false, final false
  inline ::StringW KeyUsageExtension(bool multiLine);

  /// @brief Method NetscapeCertType, addr 0x639bcac, size 0x3fc, virtual false, abstract: false, final false
  ...
  /// @brief Method SubjectAltName, addr 0x639b8a0, size 0x40c, virtual false, abstract: false, final false
  inline ::StringW SubjectAltName(bool multiLine);

  /// @brief Method SubjectKeyIdentifierExtension, addr 0x639b794, size 0x10c, virtual false, abstract: false, final false
  inline ::StringW SubjectKeyIdentifierExtension(bool multiLine);

  /// @brief Method ToString, addr 0x639b2a4, size 0x1d0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x639ad68, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x639af64, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::AsnEncodedData* asnEncodedData);

  /// @brief Method .ctor, addr 0x639ad6c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid, ::ArrayW<uint8_t> rawData);

  /// @brief Method .ctor, addr 0x639aec4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::Oid* oid, ::ArrayW<uint8_t> rawData);

  /// @brief Method get_Oid, addr 0x639b034, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::Oid* get_Oid();

  /// @brief Method get_RawData, addr 0x639b03c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> get_RawData();

  /// @brief Method set_Oid, addr 0x639aeec, size 0x78, virtual false, abstract: false, final false
  inline void set_Oid(::System::Security::Cryptography::Oid* value);

  /// @brief Method set_RawData, addr 0x639ade0, size 0xe4, virtual false, abstract: false, final false
