...
public:
  ...
  /// @brief Method .ctor, addr 0x5af75f0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5af7614, size 0xb8, virtual false, abstract: false, final false
