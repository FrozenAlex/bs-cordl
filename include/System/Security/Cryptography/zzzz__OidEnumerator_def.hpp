...
public:
  ...
  /// @brief Method MoveNext, addr 0x639ad10, size 0x4c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::Security::Cryptography::OidEnumerator* New_ctor(::System::Security::Cryptography::OidCollection* oids);

  /// @brief Method Reset, addr 0x639ad5c, size 0xc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x639ad0c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x639ab2c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::OidCollection* oids);

  /// @brief Method get_Current, addr 0x639acf0, size 0x1c, virtual false, abstract: false, final false
