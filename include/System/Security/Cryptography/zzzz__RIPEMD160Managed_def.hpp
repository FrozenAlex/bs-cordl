...
public:
  ...
  /// @brief Method F, addr 0x59c618c, size 0xc, virtual false, abstract: false, final false
  static inline uint32_t F(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method G, addr 0x59c6198, size 0x10, virtual false, abstract: false, final false
  static inline uint32_t G(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method H, addr 0x59c61a8, size 0xc, virtual false, abstract: false, final false
  static inline uint32_t H(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method HashCore, addr 0x59c4808, size 0x4, virtual true, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t> rgb, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x59c4980, size 0x4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> HashFinal();

  /// @brief Method I, addr 0x59c61b4, size 0x10, virtual false, abstract: false, final false
  static inline uint32_t I(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method Initialize, addr 0x59c47c4, size 0x44, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method InitializeState, addr 0x59c4740, size 0x84, virtual false, abstract: false, final false
  inline void InitializeState();

  /// @brief Method J, addr 0x59c61c4, size 0xc, virtual false, abstract: false, final false
  static inline uint32_t J(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method MDTransform, addr 0x59c4b0c, size 0x1680, virtual false, abstract: false, final false
  ...
  /// @brief Method _EndHash, addr 0x59c4984, size 0x188, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> _EndHash();

  /// @brief Method _HashData, addr 0x59c480c, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59bfc8c, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();
