...
// { name: "DP", ty: "::ArrayW<uint8_t>", modifiers: "", def_value: Some("{}") }, CppParam { name: "DQ", ty: "::ArrayW<uint8_t>", modifiers: "", def_value: Some("{}") }, CppParam { name: "InverseQ",
// ty: "::ArrayW<uint8_t>", modifiers: "", def_value: Some("{}") }, CppParam { name: "D", ty: "::ArrayW<uint8_t>", modifiers: "", def_value: Some("{}") }]
constexpr ::System::Security::Cryptography::RSAParameters::RSAParameters(::ArrayW<uint8_t> Exponent, ::ArrayW<uint8_t> Modulus, ::ArrayW<uint8_t> P, ::ArrayW<uint8_t> Q, ::ArrayW<uint8_t> DP,
                                                                         ::ArrayW<uint8_t> DQ, ::ArrayW<uint8_t> InverseQ, ::ArrayW<uint8_t> D) noexcept {
