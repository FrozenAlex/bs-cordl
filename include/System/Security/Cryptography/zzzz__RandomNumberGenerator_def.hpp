...
public:
  ...
  /// @brief Method Create, addr 0x5af87c4, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RandomNumberGenerator* Create();

  /// @brief Method Dispose, addr 0x5af881c, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x5af888c, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5af87c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
