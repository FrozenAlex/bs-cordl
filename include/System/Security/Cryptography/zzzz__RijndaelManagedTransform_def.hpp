...
public:
  ...
  /// @brief Method Dec, addr 0x5afbd28, size 0x1d8, virtual false, abstract: false, final false
  inline void Dec(int32_t* decryptindex, int32_t* decryptKeyExpansion, int32_t* iT, int32_t* iTF, int32_t* work, int32_t* temp);

  /// @brief Method DecryptData, addr 0x5afad58, size 0xaec, virtual false, abstract: false, final false
  inline int32_t DecryptData(::ArrayW<uint8_t> inputBuffer, int32_t inputOffset, int32_t inputCount, ::by_ref<::ArrayW<uint8_t>> outputBuffer, int32_t outputOffset,
                             ::System::Security::Cryptography::PaddingMode paddingMode, bool fLast);

  /// @brief Method Dispose, addr 0x5af9db4, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x5af9dbc, size 0xbc, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Enc, addr 0x5afbb58, size 0x1d0, virtual false, abstract: false, final false
  inline void Enc(int32_t* encryptindex, int32_t* encryptKeyExpansion, int32_t* T, int32_t* TF, int32_t* work, int32_t* temp);

  /// @brief Method EncryptData, addr 0x5afa140, size 0xc18, virtual false, abstract: false, final false
  inline int32_t EncryptData(::ArrayW<uint8_t> inputBuffer, int32_t inputOffset, int32_t inputCount, ::by_ref<::ArrayW<uint8_t>> outputBuffer, int32_t outputOffset,
                             ::System::Security::Cryptography::PaddingMode paddingMode, bool fLast);

  /// @brief Method GenerateKeyExpansion, addr 0x5af9864, size 0x550, virtual false, abstract: false, final false
  inline void GenerateKeyExpansion(::ArrayW<uint8_t> rgbKey);

  /// @brief Method MulX, addr 0x5afbfd0, size 0x24, virtual false, abstract: false, final false
  static inline int32_t MulX(int32_t x);

  static inline ::System::Security::Cryptography::RijndaelManagedTransform* New_ctor(::ArrayW<uint8_t> rgbKey, ::System::Security::Cryptography::CipherMode mode, ::ArrayW<uint8_t> rgbIV,
                                                                                     int32_t blockSize, int32_t feedbackSize, ::System::Security::Cryptography::PaddingMode PaddingValue,
                                                                                     ::System::Security::Cryptography::RijndaelManagedTransformMode transformMode);

  /// @brief Method Reset, addr 0x5afbaf8, size 0x60, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SubWord, addr 0x5afbf08, size 0xc8, virtual false, abstract: false, final false
  static inline int32_t SubWord(int32_t a);

  /// @brief Method TransformBlock, addr 0x5af9e90, size 0x2b0, virtual true, abstract: false, final true
  ...
  /// @brief Method TransformFinalBlock, addr 0x5afb844, size 0x2b4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5af926c, size 0x5f8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> rgbKey, ::System::Security::Cryptography::CipherMode mode, ::ArrayW<uint8_t> rgbIV, int32_t blockSize, int32_t feedbackSize,
  ...
  /// @brief Method get_CanTransformMultipleBlocks, addr 0x5af9e88, size 0x8, virtual true, abstract: false, final true
  inline bool get_CanTransformMultipleBlocks();

  /// @brief Method get_InputBlockSize, addr 0x5af9e78, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_InputBlockSize();

  /// @brief Method get_OutputBlockSize, addr 0x5af9e80, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method rot1, addr 0x5afbffc, size 0x8, virtual false, abstract: false, final false
  static inline int32_t rot1(int32_t val);

  /// @brief Method rot2, addr 0x5afbff4, size 0x8, virtual false, abstract: false, final false
  static inline int32_t rot2(int32_t val);

  /// @brief Method rot3, addr 0x5afbf00, size 0x8, virtual false, abstract: false, final false
