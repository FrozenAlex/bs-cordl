...
public:
  ...
  /// @brief Method .ctor, addr 0x5b02820, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_DeformatterAlgorithm, addr 0x5b0283c, size 0x8, virtual false, abstract: false, final false
  inline void set_DeformatterAlgorithm(::StringW value);

  /// @brief Method set_DigestAlgorithm, addr 0x5b0282c, size 0x8, virtual false, abstract: false, final false
  inline void set_DigestAlgorithm(::StringW value);

  /// @brief Method set_FormatterAlgorithm, addr 0x5b02834, size 0x8, virtual false, abstract: false, final false
  inline void set_FormatterAlgorithm(::StringW value);

  /// @brief Method set_KeyAlgorithm, addr 0x5b02824, size 0x8, virtual false, abstract: false, final false
