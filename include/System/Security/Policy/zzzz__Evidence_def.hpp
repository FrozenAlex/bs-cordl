...
public:
  ...
  /// @brief Method MoveNext, addr 0x59b8218, size 0x12c, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x59b8344, size 0x124, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x59b820c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerator* hostenum, ::System::Collections::IEnumerator* assemblyenum);

  /// @brief Method get_Current, addr 0x59b8468, size 0xa8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CopyTo, addr 0x59b80ac, size 0xc4, virtual true, abstract: false, final true
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method GetEnumerator, addr 0x59b8170, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x59b8040, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x59b8044, size 0x5c, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsSynchronized, addr 0x59b80a0, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsSynchronized();

  /// @brief Method get_SyncRoot, addr 0x59b80a8, size 0x4, virtual true, abstract: false, final true
