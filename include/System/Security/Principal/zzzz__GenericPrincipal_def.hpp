...
public:
  ...
  __declspec(property(get = __cordl_internal_get_m_roles, put = __cordl_internal_set_m_roles)) ::ArrayW<::StringW> m_roles;

  static inline ::System::Security::Principal::GenericPrincipal* New_ctor(::System::Security::Principal::IIdentity* identity, ::ArrayW<::StringW> roles);
  ...
  constexpr ::ArrayW<::StringW> const& __cordl_internal_get_m_roles() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get_m_roles();
  ...
  /// @brief Method .ctor, addr 0x59d75e8, size 0x134, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Principal::GenericPrincipal) == 0x38, "Size mismatch!");
