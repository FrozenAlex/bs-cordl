...
public:
  // Declarations
  /// @brief Method EnsureElevatedPermissions, addr 0x59b644c, size 0x4, virtual false, abstract: false, final false
  static inline void EnsureElevatedPermissions();

  /// @brief Method get_SecurityEnabled, addr 0x59b2f9c, size 0x8, virtual false, abstract: false, final false
