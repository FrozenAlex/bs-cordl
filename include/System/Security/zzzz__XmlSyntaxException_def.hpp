...
public:
  ...
  /// @brief Method .ctor, addr 0x59b2244, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x59b225c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x59b224c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t lineNumber);

  /// @brief Method .ctor, addr 0x59b2254, size 0x8, virtual false, abstract: false, final false
