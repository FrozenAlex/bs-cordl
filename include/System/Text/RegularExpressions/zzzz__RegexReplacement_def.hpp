...
public:
  ...
  /// @brief Method GetOrCreate, addr 0x638ca58, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method Replace, addr 0x638cf60, size 0x3a0, virtual false, abstract: false, final false
  inline ::StringW Replace(::System::Text::RegularExpressions::Regex* regex, ::StringW input, int32_t count, int32_t startat);

  /// @brief Method ReplacementImpl, addr 0x638cb8c, size 0x1a0, virtual false, abstract: false, final false
  inline void ReplacementImpl(::System::Text::StringBuilder* sb, ::System::Text::RegularExpressions::Match* match);

  /// @brief Method ReplacementImplRTL, addr 0x638cd2c, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6387f74, size 0x4e0, virtual false, abstract: false, final false
  inline void _ctor(::StringW rep, ::System::Text::RegularExpressions::RegexNode* concat, ::System::Collections::Hashtable* _caps);

  /// @brief Method get_Pattern, addr 0x638cb84, size 0x8, virtual false, abstract: false, final false
