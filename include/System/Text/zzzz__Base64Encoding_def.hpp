...
// Write type traits
MARK_REF_T(::System::Text::Base64Encoding*);
DEFINE_IL2CPP_CLASS(::System::Text::Base64Encoding*, "System.Text", "Base64Encoding");
...
public:
  ...
  __declspec(property(get = getStaticF_val2byte, put = setStaticF_val2byte)) ::ArrayW<uint8_t> val2byte;
  ...
  /// @brief Method GetByteCount, addr 0x5ff0654, size 0x49c, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::ArrayW<char16_t> chars, int32_t index, int32_t count);

  /// @brief Method GetBytes, addr 0x5ff0af0, size 0x62c, virtual true, abstract: false, final false
  inline int32_t GetBytes(::ArrayW<char16_t> chars, int32_t charIndex, int32_t charCount, ::ArrayW<uint8_t> bytes, int32_t byteIndex);

  /// @brief Method GetBytes, addr 0x5ff111c, size 0x614, virtual true, abstract: false, final false
  inline int32_t GetBytes(::ArrayW<uint8_t> chars, int32_t charIndex, int32_t charCount, ::ArrayW<uint8_t> bytes, int32_t byteIndex);

  /// @brief Method GetCharCount, addr 0x5ff1864, size 0x14, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t> bytes, int32_t index, int32_t count);

  /// @brief Method GetChars, addr 0x5ff1878, size 0x4fc, virtual true, abstract: false, final false
  inline int32_t GetChars(::ArrayW<uint8_t> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t> chars, int32_t charIndex);

  /// @brief Method GetChars, addr 0x5fee85c, size 0x4fc, virtual false, abstract: false, final false
  inline int32_t GetChars(::ArrayW<uint8_t> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<uint8_t> chars, int32_t charIndex);

  /// @brief Method GetMaxByteCount, addr 0x5ff0504, size 0x120, virtual true, abstract: false, final false
  inline int32_t GetMaxByteCount(int32_t charCount);

  /// @brief Method GetMaxCharCount, addr 0x5ff1730, size 0x134, virtual true, abstract: false, final false
  inline int32_t GetMaxCharCount(int32_t byteCount);

  /// @brief Method IsValidLeadBytes, addr 0x5ff0624, size 0x1c, virtual false, abstract: false, final false
  inline bool IsValidLeadBytes(int32_t v1, int32_t v2, int32_t v3, int32_t v4);

  /// @brief Method IsValidTailBytes, addr 0x5ff0640, size 0x14, virtual false, abstract: false, final false
  inline bool IsValidTailBytes(int32_t v3, int32_t v4);

  static inline ::System::Text::Base64Encoding* New_ctor();

  /// @brief Method .ctor, addr 0x5ff1d74, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<uint8_t> getStaticF_char2val();

  static inline ::ArrayW<uint8_t> getStaticF_val2byte();

  static inline ::StringW getStaticF_val2char();

  static inline void setStaticF_char2val(::ArrayW<uint8_t> value);

  static inline void setStaticF_val2byte(::ArrayW<uint8_t> value);
...
static_assert(sizeof(::System::Text::Base64Encoding) == 0x38, "Size mismatch!");
