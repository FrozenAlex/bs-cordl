...
public:
  ...
  /// @brief Method CreateFallbackBuffer, addr 0x5b91058, size 0x64, virtual true, abstract: false, final false
  inline ::System::Text::DecoderFallbackBuffer* CreateFallbackBuffer();

  /// @brief Method Equals, addr 0x5b910f4, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x5b91174, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x5b90fe8, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b8fc70, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5b90ee4, size 0x104, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x5b90d6c, size 0x178, virtual false, abstract: false, final false
  inline void _ctor(::StringW replacement);

  /// @brief Method get_DefaultString, addr 0x5b91050, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_DefaultString();

  /// @brief Method get_MaxCharCount, addr 0x5b910dc, size 0x18, virtual true, abstract: false, final false
