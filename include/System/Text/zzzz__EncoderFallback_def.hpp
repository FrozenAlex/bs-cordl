...
public:
  ...
  /// @brief Method .ctor, addr 0x5acf1ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ExceptionFallback, addr 0x5acfdf4, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReplacementFallback, addr 0x5ace7a0, size 0x9c, virtual false, abstract: false, final false
