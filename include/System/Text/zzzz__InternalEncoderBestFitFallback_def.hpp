...
public:
  ...
  /// @brief Method CreateFallbackBuffer, addr 0x5acf1b0, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Text::EncoderFallbackBuffer* CreateFallbackBuffer();

  /// @brief Method Equals, addr 0x5acf32c, size 0xcc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x5acf3f8, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5acf1a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::Encoding* encoding);

  /// @brief Method get_MaxCharCount, addr 0x5acf324, size 0x8, virtual true, abstract: false, final false
