...
DEFINE_IL2CPP_CLASS(::System::Text::SurrogateChar, "System.Text", "SurrogateChar");
// Dependencies
namespace System::Text {
// Is value type: true
...
public:
  ...
  /// @brief Method .ctor, addr 0x6121f0c, size 0x128, virtual false, abstract: false, final false
  inline void _ctor(int32_t ch);

  /// @brief Method .ctor, addr 0x612b9f0, size 0x1ec, virtual false, abstract: false, final false
  inline void _ctor(char16_t lowChar, char16_t highChar);

  /// @brief Method get_Char, addr 0x612bbec, size 0x20, virtual false, abstract: false, final false
  inline int32_t get_Char();

  /// @brief Method get_HighChar, addr 0x612bbe4, size 0x8, virtual false, abstract: false, final false
  inline char16_t get_HighChar();

  /// @brief Method get_LowChar, addr 0x612bbdc, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Text::SurrogateChar) == 0x4, "Size mismatch!");
