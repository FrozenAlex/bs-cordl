...
public:
  ...
  /// @brief Method NotifyWorkItemProgress, addr 0x5b8c1ec, size 0x4, virtual true, abstract: false, final false
  inline void NotifyWorkItemProgress();

  /// @brief Method PublishUnobservedTaskException, addr 0x5b8b1e0, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method TryDequeue, addr 0x5b8c1e4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method TryRunInline, addr 0x5b8216c, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b8c1f8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Current, addr 0x5b86208, size 0xac, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::TaskScheduler* get_Current();

  /// @brief Method get_Default, addr 0x5b8c1fc, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::TaskScheduler* get_Default();

  /// @brief Method get_Id, addr 0x5b85c58, size 0x9c, virtual false, abstract: false, final false
  inline int32_t get_Id();

  /// @brief Method get_InternalCurrent, addr 0x5b85268, size 0xd4, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::TaskScheduler* get_InternalCurrent();

  /// @brief Method get_RequiresAtomicStartTransition, addr 0x5b8c1f0, size 0x8, virtual true, abstract: false, final false
