...
public:
  ...
  /// @brief Method System.IAsyncResult.get_AsyncState, addr 0x5b7f3c0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_IAsyncResult_get_AsyncState();

  /// @brief Method System.IAsyncResult.get_AsyncWaitHandle, addr 0x5b7f3e4, size 0xa8, virtual true, abstract: false, final true
  inline ::System::Threading::WaitHandle* System_IAsyncResult_get_AsyncWaitHandle();

  /// @brief Method System.IAsyncResult.get_CompletedSynchronously, addr 0x5b7f3c8, size 0x8, virtual true, abstract: false, final true
  inline bool System_IAsyncResult_get_CompletedSynchronously();

  /// @brief Method System.IAsyncResult.get_IsCompleted, addr 0x5b7f3d0, size 0x14, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b7f1cc, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <InvokeCallbackWhenTaskCompletes>b__0, addr 0x5b7f48c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b7f3b4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Begin, addr 0x5b7f088, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method End, addr 0x5b7f2d8, size 0xd8, virtual false, abstract: false, final false
  static inline void End(::System::IAsyncResult* asyncResult);

  /// @brief Method InvokeCallbackWhenTaskCompletes, addr 0x5b7f1d8, size 0x100, virtual false, abstract: false, final false
