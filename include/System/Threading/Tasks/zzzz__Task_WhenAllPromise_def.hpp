...
// Write type traits
MARK_REF_T(::GlobalNamespace::Task_WhenAllPromise*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::Task_WhenAllPromise*, "System.Threading.Tasks", "Task/WhenAllPromise");
// Dependencies System.Threading.Tasks.Task, System.Threading.Tasks.Task`1<TResult>, System.Threading.Tasks.VoidTaskResult
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_m_tasks, put = __cordl_internal_set_m_tasks)) ::ArrayW<::System::Threading::Tasks::Task*> m_tasks;

  /// @brief Convert operator to "::System::Threading::Tasks::ITaskCompletionAction"
  constexpr operator ::System::Threading::Tasks::ITaskCompletionAction*() noexcept;

  /// @brief Method Invoke, addr 0x5cc1478, size 0x334, virtual true, abstract: false, final true
  inline void Invoke(::System::Threading::Tasks::Task* ignored);

  static inline ::GlobalNamespace::Task_WhenAllPromise* New_ctor(::ArrayW<::System::Threading::Tasks::Task*> tasks);

  constexpr int32_t const& __cordl_internal_get_m_count() const;

  constexpr int32_t& __cordl_internal_get_m_count();

  constexpr ::ArrayW<::System::Threading::Tasks::Task*> const& __cordl_internal_get_m_tasks() const;

  constexpr ::ArrayW<::System::Threading::Tasks::Task*>& __cordl_internal_get_m_tasks();

  constexpr void __cordl_internal_set_m_count(int32_t value);

  constexpr void __cordl_internal_set_m_tasks(::ArrayW<::System::Threading::Tasks::Task*> value);

  /// @brief Method .ctor, addr 0x5cc02fc, size 0x194, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::System::Threading::Tasks::Task*> tasks);

  /// @brief Method get_InvokeMayRunArbitraryCode, addr 0x5cc1824, size 0x8, virtual true, abstract: false, final true
  inline bool get_InvokeMayRunArbitraryCode();

  /// @brief Method get_ShouldNotifyDebuggerOfWaitCompletion, addr 0x5cc17ac, size 0x78, virtual true, abstract: false, final false
...
public:
  ...
  ::ArrayW<::System::Threading::Tasks::Task*> ___m_tasks;
...
static_assert(sizeof(::GlobalNamespace::Task_WhenAllPromise) == 0x68, "Size mismatch!");
