...
public:
  ...
  /// @brief Method <.cctor>b__26_0, addr 0x5ca5a50, size 0x70, virtual false, abstract: false, final false
  inline void __cctor_b__26_0(::System::Object* obj);

  /// @brief Method .ctor, addr 0x5ca5a4c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Equals, addr 0x5ca5658, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method Equals, addr 0x5ca5648, size 0x10, virtual false, abstract: false, final false
  inline bool Equals(::System::Threading::CancellationToken other);

  /// @brief Method GetHashCode, addr 0x5ca5708, size 0x78, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method InternalRegisterWithoutEC, addr 0x5ca5248, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method Register, addr 0x5ca4f74, size 0xfc, virtual false, abstract: false, final false
  inline ::System::Threading::CancellationTokenRegistration Register(::System::Action* callback);

  /// @brief Method Register, addr 0x5ca51a8, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method Register, addr 0x5ca5070, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method ThrowIfCancellationRequested, addr 0x5ca5850, size 0x84, virtual false, abstract: false, final false
  inline void ThrowIfCancellationRequested();

  /// @brief Method ThrowOperationCanceledException, addr 0x5ca58d4, size 0x58, virtual false, abstract: false, final false
  inline void ThrowOperationCanceledException();

  /// @brief Method .ctor, addr 0x5ca4ed0, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(bool canceled);

  /// @brief Method .ctor, addr 0x5ca4ec8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanBeCanceled, addr 0x5ca4eb8, size 0x10, virtual false, abstract: false, final false
  inline bool get_CanBeCanceled();

  /// @brief Method get_IsCancellationRequested, addr 0x5ca4e80, size 0x24, virtual false, abstract: false, final false
  inline bool get_IsCancellationRequested();

  /// @brief Method get_None, addr 0x5ca4e78, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Threading::CancellationToken get_None();

  /// @brief Method op_Equality, addr 0x5ca5780, size 0x68, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Threading::CancellationToken left, ::System::Threading::CancellationToken right);

  /// @brief Method op_Inequality, addr 0x5ca57e8, size 0x68, virtual false, abstract: false, final false
