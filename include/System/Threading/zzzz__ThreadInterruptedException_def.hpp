...
public:
  ...
  /// @brief Method .ctor, addr 0x5caffb0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5cb002c, size 0x8, virtual false, abstract: false, final false
