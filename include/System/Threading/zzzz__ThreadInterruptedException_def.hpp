...
public:
  ...
  /// @brief Method .ctor, addr 0x5b780b8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5b78134, size 0x8, virtual false, abstract: false, final false
