...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x5b6d2b8, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::System::Threading::ThreadStart* New_ctor(::System::Object* object, ::System::IntPtr method);

  /// @brief Method .ctor, addr 0x5b6d250, size 0x68, virtual false, abstract: false, final false
