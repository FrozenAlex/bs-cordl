...
public:
  // Declarations
  /// @brief Method GetTime, addr 0x5ca6a2c, size 0x4, virtual false, abstract: false, final false
  static inline uint32_t GetTime();

  /// @brief Method UpdateTimeOut, addr 0x5ca6b28, size 0x34, virtual false, abstract: false, final false
