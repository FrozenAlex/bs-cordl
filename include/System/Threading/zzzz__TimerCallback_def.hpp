...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x5cb6c38, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5cb6af4, size 0x144, virtual false, abstract: false, final false
