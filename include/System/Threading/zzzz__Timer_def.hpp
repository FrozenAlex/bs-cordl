...
public:
  ...
  /// @brief Method Compare, addr 0x5cb6104, size 0x88, virtual true, abstract: false, final true
  inline int32_t Compare(::System::Threading::Timer* tx, ::System::Threading::Timer* ty);

  /// @brief Method System.Collections.IComparer.Compare, addr 0x5cb605c, size 0xa8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Add, addr 0x5cb6850, size 0x104, virtual false, abstract: false, final false
  inline void Add(::System::Threading::Timer* timer);

  /// @brief Method Change, addr 0x5cb5e3c, size 0x188, virtual false, abstract: false, final false
  inline void Change(::System::Threading::Timer* timer, int64_t new_next_run);

  /// @brief Method FireTimer, addr 0x5cb69d0, size 0xc8, virtual false, abstract: false, final false
  inline void FireTimer(::System::Threading::Timer* timer);

  /// @brief Method InitScheduler, addr 0x5cb618c, size 0xf4, virtual false, abstract: false, final false
  inline void InitScheduler();

  /// @brief Method InternalRemove, addr 0x5cb6830, size 0x20, virtual false, abstract: false, final false
  inline void InternalRemove(::System::Threading::Timer* timer);

  static inline ::System::Threading::Timer_Scheduler* New_ctor();

  /// @brief Method Remove, addr 0x5cb5d6c, size 0xcc, virtual false, abstract: false, final false
  inline void Remove(::System::Threading::Timer* timer);

  /// @brief Method RunSchedulerLoop, addr 0x5cb63bc, size 0x388, virtual false, abstract: false, final false
  inline int32_t RunSchedulerLoop();

  /// @brief Method SchedulerThread, addr 0x5cb6298, size 0x124, virtual false, abstract: false, final false
  inline void SchedulerThread();

  /// @brief Method TimerCB, addr 0x5cb6954, size 0x7c, virtual false, abstract: false, final false
  static inline void TimerCB(::System::Object* o);

  /// @brief Method WakeupScheduler, addr 0x5cb6280, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5cb67a0, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Threading::Timer_Scheduler* getStaticF_instance();

  /// @brief Method get_Instance, addr 0x5cb6744, size 0x5c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Change, addr 0x5cb5c54, size 0xe0, virtual false, abstract: false, final false
  inline bool Change(::System::TimeSpan dueTime, ::System::TimeSpan period);

  /// @brief Method Change, addr 0x5cb5c34, size 0x20, virtual false, abstract: false, final false
  inline bool Change(int32_t dueTime, int32_t period);

  /// @brief Method Change, addr 0x5cb5a74, size 0x1c0, virtual false, abstract: false, final false
  inline bool Change(int64_t dueTime, int64_t period, bool first);

  /// @brief Method Dispose, addr 0x5cb5d34, size 0x38, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DisposeAsync, addr 0x5cb5fc4, size 0x94, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::ValueTask DisposeAsync();

  /// @brief Method GetTimeMonotonic, addr 0x5cb5e38, size 0x4, virtual false, abstract: false, final false
  static inline int64_t GetTimeMonotonic();

  /// @brief Method Init, addr 0x5cb5920, size 0x68, virtual false, abstract: false, final false
  inline void Init(::System::Threading::TimerCallback* callback, ::System::Object* state, int64_t dueTime, int64_t period);

  /// @brief Method KeepRootedWhileScheduled, addr 0x5cb6058, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5cb5988, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5cb5914, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Threading::TimerCallback* callback, ::System::Object* state, int32_t dueTime, int32_t period);

  /// @brief Method get_scheduler, addr 0x5cb5880, size 0x94, virtual false, abstract: false, final false
