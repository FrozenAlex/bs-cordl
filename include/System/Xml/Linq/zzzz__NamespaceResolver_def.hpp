...
public:
  ...
  /// @brief Method .ctor, addr 0x6069cf0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Add, addr 0x6069bfc, size 0x94, virtual false, abstract: false, final false
  inline void Add(::StringW prefix, ::System::Xml::Linq::XNamespace* ns);

  /// @brief Method AddFirst, addr 0x6069aac, size 0x90, virtual false, abstract: false, final false
  inline void AddFirst(::StringW prefix, ::System::Xml::Linq::XNamespace* ns);

  /// @brief Method GetPrefixOfNamespace, addr 0x60699d4, size 0xd8, virtual false, abstract: false, final false
  inline ::StringW GetPrefixOfNamespace(::System::Xml::Linq::XNamespace* ns, bool allowDefaultNamespace);

  /// @brief Method PopScope, addr 0x6069c90, size 0x60, virtual false, abstract: false, final false
  inline void PopScope();

  /// @brief Method PushScope, addr 0x6069bec, size 0x10, virtual false, abstract: false, final false
