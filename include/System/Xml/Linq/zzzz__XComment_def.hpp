...
public:
  ...
  /// @brief Method CloneNode, addr 0x6063d60, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteTo, addr 0x6063cf4, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6063b88, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XComment* other);

  /// @brief Method .ctor, addr 0x6063b2c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::StringW value);

  /// @brief Method get_NodeType, addr 0x6063be4, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Value, addr 0x6063bec, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x6063bf4, size 0x100, virtual false, abstract: false, final false
