...
public:
  ...
  /// @brief Method ToString, addr 0x61a03bc, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61a0330, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XDeclaration* other);

  /// @brief Method .ctor, addr 0x61a0324, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW version, ::StringW encoding, ::StringW standalone);

  /// @brief Method get_Encoding, addr 0x61a0394, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Encoding();

  /// @brief Method get_Standalone, addr 0x61a03a4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Standalone();

  /// @brief Method get_Version, addr 0x61a03b4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Version();

  /// @brief Method set_Encoding, addr 0x61a039c, size 0x8, virtual false, abstract: false, final false
  inline void set_Encoding(::StringW value);

  /// @brief Method set_Standalone, addr 0x61a03ac, size 0x8, virtual false, abstract: false, final false
