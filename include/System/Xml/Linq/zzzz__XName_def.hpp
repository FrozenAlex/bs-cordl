...
public:
  ...
  /// @brief Method Equals, addr 0x606a490, size 0xc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Get, addr 0x6069e4c, size 0x13c, virtual false, abstract: false, final false
  static inline ::System::Xml::Linq::XName* Get(::StringW expandedName);

  /// @brief Method Get, addr 0x606a468, size 0x1c, virtual false, abstract: false, final false
  static inline ::System::Xml::Linq::XName* Get(::StringW localName, ::StringW namespaceName);

  /// @brief Method GetHashCode, addr 0x606a49c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method System.IEquatable<System.Xml.Linq.XName>.Equals, addr 0x606a4a4, size 0xc, virtual true, abstract: false, final true
  inline bool System_IEquatable_System_Xml_Linq_XName__Equals(::System::Xml::Linq::XName* other);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x606a4b0, size 0x38, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method ToString, addr 0x6069db4, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x606a4e8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6069cf4, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XNamespace* ns, ::StringW localName);

  /// @brief Method get_LocalName, addr 0x6069da4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Namespace, addr 0x6069dac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XNamespace* get_Namespace();

  /// @brief Method get_NamespaceName, addr 0x6063034, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x606296c, size 0xc, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Xml::Linq::XName* left, ::System::Xml::Linq::XName* right);

  /// @brief Method op_Implicit, addr 0x606a484, size 0xc, virtual false, abstract: false, final false
