...
public:
  ...
  /// @brief Method .ctor, addr 0x607f55c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TokenizedType, addr 0x608a4cc, size 0x8, virtual true, abstract: false, final false
