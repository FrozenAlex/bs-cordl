...
public:
  ...
  /// @brief Method TryParseValue, addr 0x61be274, size 0x1cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61b8d0c, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TypeCode, addr 0x61be440, size 0x8, virtual true, abstract: false, final false
