...
public:
  ...
  /// @brief Method ConstructPos, addr 0x63173d0, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method ExpandTree, addr 0x6316fac, size 0x420, virtual true, abstract: false, final false
  ...
  /// @brief Method GetResolvedSymbols, addr 0x6316f90, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6316f88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::NamespaceList* namespaceList, ::System::Object* particle);

  /// @brief Method get_IsNullable, addr 0x6317408, size 0x38, virtual true, abstract: false, final false
