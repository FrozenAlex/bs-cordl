...
public:
  ...
  /// @brief Method AddChoice, addr 0x61dfb6c, size 0xdc, virtual false, abstract: false, final false
  inline void AddChoice();

  /// @brief Method AddLeafNode, addr 0x61df9f4, size 0xf4, virtual false, abstract: false, final false
  inline void AddLeafNode(::System::Xml::Schema::SyntaxTreeNode* node);

  /// @brief Method AddLeafRange, addr 0x61dff84, size 0xe0, virtual false, abstract: false, final false
  inline void AddLeafRange(::System::Decimal min, ::System::Decimal max);

  /// @brief Method AddName, addr 0x61df954, size 0xa0, virtual false, abstract: false, final false
  inline void AddName(::System::Xml::XmlQualifiedName* name, ::System::Object* particle);

  /// @brief Method AddNamespaceList, addr 0x61dfae8, size 0x84, virtual false, abstract: false, final false
  inline void AddNamespaceList(::System::Xml::Schema::NamespaceList* namespaceList, ::System::Object* particle);

  /// @brief Method AddPlus, addr 0x61dfedc, size 0x54, virtual false, abstract: false, final false
  inline void AddPlus();

  /// @brief Method AddQMark, addr 0x61dff30, size 0x54, virtual false, abstract: false, final false
  inline void AddQMark();

  /// @brief Method AddSequence, addr 0x61dfc48, size 0xdc, virtual false, abstract: false, final false
  inline void AddSequence();

  /// @brief Method AddStar, addr 0x61dfd24, size 0x54, virtual false, abstract: false, final false
  inline void AddStar();

  /// @brief Method BuildTransitionTable, addr 0x61e0bdc, size 0x588, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateTotalFollowposForRangeNodes, addr 0x61e05c4, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckCMUPAWithLeafRangeNodes, addr 0x61e09f0, size 0x164, virtual false, abstract: false, final false
  inline void CheckCMUPAWithLeafRangeNodes(::System::Xml::Schema::BitSet* curpos);

  /// @brief Method CheckUniqueParticleAttribution, addr 0x61e11fc, size 0x1b0, virtual false, abstract: false, final false
  inline void CheckUniqueParticleAttribution(::System::Xml::Schema::BitSet* curpos);

  /// @brief Method CheckUniqueParticleAttribution, addr 0x61e0b54, size 0x88, virtual false, abstract: false, final false
  inline void CheckUniqueParticleAttribution(::System::Xml::Schema::BitSet* firstpos, ::ArrayW<::System::Xml::Schema::BitSet*> followpos);

  /// @brief Method CloseGroup, addr 0x61df7c4, size 0x158, virtual false, abstract: false, final false
  inline void CloseGroup();

  /// @brief Method Closure, addr 0x61dfd78, size 0x164, virtual false, abstract: false, final false
  inline void Closure(::System::Xml::Schema::InteriorNode* node);

  /// @brief Method CompleteValidation, addr 0x61df6b4, size 0x38, virtual true, abstract: false, final false
  inline bool CompleteValidation(::System::Xml::Schema::ValidationState* context);

  /// @brief Method Exists, addr 0x61df91c, size 0x38, virtual false, abstract: false, final false
  inline bool Exists(::System::Xml::XmlQualifiedName* name);

  /// @brief Method Finish, addr 0x61e0064, size 0x560, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::ContentValidator* Finish(bool useDFA);

  /// @brief Method GetApplicableMinMaxFollowPos, addr 0x61e087c, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method InitValidation, addr 0x61df644, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method OpenGroup, addr 0x61df7a0, size 0x24, virtual false, abstract: false, final false
  inline void OpenGroup();

  /// @brief Method Start, addr 0x61df6ec, size 0xb4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method ValidateElement, addr 0x61df67c, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61df5c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::XmlSchemaContentType contentType);

  /// @brief Method .ctor, addr 0x61df5cc, size 0x78, virtual false, abstract: false, final false
