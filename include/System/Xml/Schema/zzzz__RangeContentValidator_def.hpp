...
public:
  ...
  /// @brief Method CompleteValidation, addr 0x607aa04, size 0x14, virtual true, abstract: false, final false
  inline bool CompleteValidation(::System::Xml::Schema::ValidationState* context);

  /// @brief Method ExpectedElements, addr 0x607aa18, size 0x28c, virtual true, abstract: false, final false
  inline ::System::Collections::ArrayList* ExpectedElements(::System::Xml::Schema::ValidationState* context, bool isRequiredOnly);

  /// @brief Method ExpectedParticles, addr 0x607aca4, size 0x22c, virtual true, abstract: false, final false
  ...
  /// @brief Method InitValidation, addr 0x6079fe0, size 0x1c0, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateElement, addr 0x607a1a0, size 0x864, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6079f28, size 0xb8, virtual false, abstract: false, final false
