...
public:
  ...
  /// @brief Method EndElement, addr 0x63143dc, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method PopKS, addr 0x63147e4, size 0xa4, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::KeySequence* PopKS();

  /// @brief Method PushKS, addr 0x6314424, size 0x2dc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6314268, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::Asttree* axisTree, ::System::Xml::Schema::ConstraintStruct* cs);

  /// @brief Method get_lastDepth, addr 0x6314330, size 0xac, virtual false, abstract: false, final false
