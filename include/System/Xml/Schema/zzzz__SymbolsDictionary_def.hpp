...
public:
  ...
  /// @brief Method AddName, addr 0x6315940, size 0x104, virtual false, abstract: false, final false
  inline int32_t AddName(::System::Xml::XmlQualifiedName* name, ::System::Object* particle);

  /// @brief Method AddNamespaceList, addr 0x6315a44, size 0x370, virtual false, abstract: false, final false
  inline void AddNamespaceList(::System::Xml::Schema::NamespaceList* list, ::System::Object* particle, bool allowLocal);

  /// @brief Method AddWildcard, addr 0x6315db4, size 0x160, virtual false, abstract: false, final false
  inline void AddWildcard(::StringW wildcard, ::System::Object* particle);

  /// @brief Method Exists, addr 0x63166d4, size 0x30, virtual false, abstract: false, final false
  inline bool Exists(::System::Xml::XmlQualifiedName* name);

  /// @brief Method GetNamespaceListSymbols, addr 0x6315f14, size 0x730, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* GetNamespaceListSymbols(::System::Xml::Schema::NamespaceList* list);

  /// @brief Method GetParticle, addr 0x6316704, size 0x34, virtual false, abstract: false, final false
  inline ::System::Object* GetParticle(int32_t symbol);

  /// @brief Method NameOf, addr 0x6316738, size 0x630, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x631588c, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x6315924, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsUpaEnforced, addr 0x6315930, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsUpaEnforced();

  /// @brief Method get_Item, addr 0x6316644, size 0x90, virtual false, abstract: false, final false
  inline int32_t get_Item(::System::Xml::XmlQualifiedName* name);

  /// @brief Method set_IsUpaEnforced, addr 0x6315938, size 0x8, virtual false, abstract: false, final false
