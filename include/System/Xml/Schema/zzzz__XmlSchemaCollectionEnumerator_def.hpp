...
public:
  ...
  /// @brief Method MoveNext, addr 0x6225e48, size 0xa4, virtual false, abstract: false, final false
  inline bool MoveNext();

  static inline ::System::Xml::Schema::XmlSchemaCollectionEnumerator* New_ctor(::System::Collections::Hashtable* collection);

  /// @brief Method System.Collections.IEnumerator.MoveNext, addr 0x6226318, size 0xa4, virtual true, abstract: false, final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x6226270, size 0xa8, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x62263bc, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6225bb4, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Hashtable* collection);

  /// @brief Method get_Current, addr 0x6225d68, size 0xe0, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* get_Current();

  /// @brief Method get_CurrentNode, addr 0x62263c0, size 0xdc, virtual false, abstract: false, final false
