...
public:
  ...
  /// @brief Method .ctor, addr 0x60ed648, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Content, addr 0x60ed630, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContent* get_Content();

  /// @brief Method get_HasMixedAttribute, addr 0x60ed640, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasMixedAttribute();

  /// @brief Method get_IsMixed, addr 0x60ed618, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsMixed();

  /// @brief Method set_Content, addr 0x60ed638, size 0x8, virtual true, abstract: false, final false
  inline void set_Content(::System::Xml::Schema::XmlSchemaContent* value);

  /// @brief Method set_IsMixed, addr 0x60ed620, size 0x10, virtual false, abstract: false, final false
