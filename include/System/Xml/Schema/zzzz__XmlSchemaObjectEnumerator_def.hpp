...
public:
  ...
  /// @brief Method MoveNext, addr 0x60f19a4, size 0xa4, virtual false, abstract: false, final false
  inline bool MoveNext();

  static inline ::System::Xml::Schema::XmlSchemaObjectEnumerator* New_ctor(::System::Collections::IEnumerator* enumerator);

  /// @brief Method System.Collections.IEnumerator.MoveNext, addr 0x60f1be8, size 0xa4, virtual true, abstract: false, final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x60f1b40, size 0xa8, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x60f1c8c, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x60f199c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerator* enumerator);

  /// @brief Method get_Current, addr 0x60f1a48, size 0xf8, virtual false, abstract: false, final false
