...
public:
  ...
  /// @brief Method AddAnnotation, addr 0x622c89c, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x622c7c4, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AttributeGroups, addr 0x622c884, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_AttributeGroups();

  /// @brief Method get_Groups, addr 0x622c894, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_Groups();

  /// @brief Method get_Items, addr 0x622c87c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Items();

  /// @brief Method get_SchemaTypes, addr 0x622c88c, size 0x8, virtual false, abstract: false, final false
