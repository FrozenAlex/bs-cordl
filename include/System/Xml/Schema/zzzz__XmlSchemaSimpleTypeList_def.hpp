...
public:
  ...
  /// @brief Method Clone, addr 0x62342e0, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62343a0, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BaseItemType, addr 0x62342d0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSimpleType* get_BaseItemType();

  /// @brief Method get_ItemType, addr 0x62342c0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSimpleType* get_ItemType();

  /// @brief Method get_ItemTypeName, addr 0x6234224, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_ItemTypeName();

  /// @brief Method set_BaseItemType, addr 0x62342d8, size 0x8, virtual false, abstract: false, final false
  inline void set_BaseItemType(::System::Xml::Schema::XmlSchemaSimpleType* value);

  /// @brief Method set_ItemType, addr 0x62342c8, size 0x8, virtual false, abstract: false, final false
  inline void set_ItemType(::System::Xml::Schema::XmlSchemaSimpleType* value);

  /// @brief Method set_ItemTypeName, addr 0x623422c, size 0x94, virtual false, abstract: false, final false
