...
public:
  ...
  /// @brief Method Clone, addr 0x60fb620, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60fb6e0, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BaseType, addr 0x60fb608, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSimpleType* get_BaseType();

  /// @brief Method get_BaseTypeName, addr 0x60fb56c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_BaseTypeName();

  /// @brief Method get_Facets, addr 0x60fb618, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Facets();

  /// @brief Method set_BaseType, addr 0x60fb610, size 0x8, virtual false, abstract: false, final false
  inline void set_BaseType(::System::Xml::Schema::XmlSchemaSimpleType* value);

  /// @brief Method set_BaseTypeName, addr 0x60fb574, size 0x94, virtual false, abstract: false, final false
