...
public:
  ...
  /// @brief Method Clone, addr 0x60fb79c, size 0x178, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObject* Clone();

  static inline ::System::Xml::Schema::XmlSchemaSimpleTypeUnion* New_ctor();

  /// @brief Method SetBaseMemberTypes, addr 0x60fb794, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60fb914, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BaseMemberTypes, addr 0x60fb78c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Xml::Schema::XmlSchemaSimpleType*> get_BaseMemberTypes();

  /// @brief Method get_BaseTypes, addr 0x60fb774, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_BaseTypes();

  /// @brief Method get_MemberTypes, addr 0x60fb77c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Xml::XmlQualifiedName*> get_MemberTypes();

  /// @brief Method set_MemberTypes, addr 0x60fb784, size 0x8, virtual false, abstract: false, final false
