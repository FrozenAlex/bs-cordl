...
public:
  ...
  /// @brief Method GetBuiltInComplexType, addr 0x60fbbb0, size 0x254, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaComplexType* GetBuiltInComplexType(::System::Xml::XmlQualifiedName* qualifiedName);

  /// @brief Method GetBuiltInSimpleType, addr 0x60fba84, size 0xd0, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaSimpleType* GetBuiltInSimpleType(::System::Xml::XmlQualifiedName* qualifiedName);

  /// @brief Method GetBuiltInSimpleType, addr 0x60fbb54, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaSimpleType* GetBuiltInSimpleType(::System::Xml::Schema::XmlTypeCode typeCode);

  /// @brief Method IsDerivedFrom, addr 0x60fbffc, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDerivedFromDatatype, addr 0x60fc214, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetBaseSchemaType, addr 0x60fbfb4, size 0x8, virtual false, abstract: false, final false
  inline void SetBaseSchemaType(::System::Xml::Schema::XmlSchemaType* value);

  /// @brief Method SetContentType, addr 0x60fbff4, size 0x8, virtual false, abstract: false, final false
  inline void SetContentType(::System::Xml::Schema::XmlSchemaContentType value);

  /// @brief Method SetDatatype, addr 0x60fbfc4, size 0x8, virtual false, abstract: false, final false
  inline void SetDatatype(::System::Xml::Schema::XmlSchemaDatatype* value);

  /// @brief Method SetDerivedBy, addr 0x60fbfbc, size 0x8, virtual false, abstract: false, final false
  inline void SetDerivedBy(::System::Xml::Schema::XmlSchemaDerivationMethod value);

  /// @brief Method SetFinalResolved, addr 0x60fbfac, size 0x8, virtual false, abstract: false, final false
  inline void SetFinalResolved(::System::Xml::Schema::XmlSchemaDerivationMethod value);

  /// @brief Method SetQualifiedName, addr 0x60fbfa0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60fb210, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BaseXmlSchemaType, addr 0x60fbe2c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaType* get_BaseXmlSchemaType();

  /// @brief Method get_Datatype, addr 0x60fbe3c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDatatype* get_Datatype();

  /// @brief Method get_DerivedBy, addr 0x60fbe34, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_DerivedBy();

  /// @brief Method get_ElementDecl, addr 0x60fbfcc, size 0xc, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaElementDecl* get_ElementDecl();

  /// @brief Method get_Final, addr 0x60fbe14, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_Final();

  /// @brief Method get_FinalResolved, addr 0x60fbe24, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_FinalResolved();

  /// @brief Method get_IsMixed, addr 0x60fbe44, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsMixed();

  /// @brief Method get_Name, addr 0x60fbe04, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameAttribute, addr 0x60fc2f4, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_NameAttribute();

  /// @brief Method get_QualifiedName, addr 0x60fad60, size 0xc, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_QualifiedName();

  /// @brief Method get_Redefined, addr 0x60fbfe4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaType* get_Redefined();

  /// @brief Method get_SchemaContentType, addr 0x60fbf98, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContentType get_SchemaContentType();

  /// @brief Method get_TypeCode, addr 0x60fbe50, size 0xcc, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_ValueConverter, addr 0x60fbf1c, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlValueConverter* get_ValueConverter();

  /// @brief Method set_ElementDecl, addr 0x60fbfd8, size 0xc, virtual false, abstract: false, final false
  inline void set_ElementDecl(::System::Xml::Schema::SchemaElementDecl* value);

  /// @brief Method set_Final, addr 0x60fbe1c, size 0x8, virtual false, abstract: false, final false
  inline void set_Final(::System::Xml::Schema::XmlSchemaDerivationMethod value);

  /// @brief Method set_IsMixed, addr 0x60fbe4c, size 0x4, virtual true, abstract: false, final false
  inline void set_IsMixed(bool value);

  /// @brief Method set_Name, addr 0x60fbe0c, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_NameAttribute, addr 0x60fc2fc, size 0x8, virtual true, abstract: false, final false
  inline void set_NameAttribute(::StringW value);

  /// @brief Method set_Redefined, addr 0x60fbfec, size 0x8, virtual false, abstract: false, final false
