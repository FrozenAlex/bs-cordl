...
public:
  // Declarations
  /// @brief Method GetObjectData, addr 0x60fc30c, size 0x8, virtual true, abstract: false, final false
  ...
  static inline ::System::Xml::Schema::XmlSchemaValidationException* New_ctor(::StringW res, ::ArrayW<::StringW> args, ::System::Exception* innerException, ::StringW sourceUri, int32_t lineNumber,
  ...
  /// @brief Method .ctor, addr 0x60fc314, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x60fc304, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x60fc328, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg, ::StringW sourceUri, int32_t lineNumber, int32_t linePosition);

  /// @brief Method .ctor, addr 0x60fc474, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60fc3fc, size 0x78, virtual false, abstract: false, final false
