...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x61b3428, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_MemberName, addr 0x61b3408, size 0x20, virtual false, abstract: false, final false
