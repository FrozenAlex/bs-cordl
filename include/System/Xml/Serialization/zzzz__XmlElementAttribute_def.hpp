...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x62ee2b4, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62ee228, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::StringW elementName);

  /// @brief Method .ctor, addr 0x62ee238, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::StringW elementName, ::System::Type* type);

  /// @brief Method get_DataType, addr 0x62ee24c, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_DataType();

  /// @brief Method get_ElementName, addr 0x62ee26c, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_ElementName();

  /// @brief Method get_Form, addr 0x62ee28c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaForm get_Form();

  /// @brief Method get_IsNullable, addr 0x62ee29c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNullable();

  /// @brief Method get_Namespace, addr 0x62ee294, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_Order, addr 0x62ee2a4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Order();

  /// @brief Method get_Type, addr 0x62ee2ac, size 0x8, virtual false, abstract: false, final false
