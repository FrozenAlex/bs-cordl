...
public:
  ...
  /// @brief Method .ctor, addr 0x61bd0d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x61c0fac, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Callback, addr 0x61c0fb8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlSerializationCollectionFixupCallback* get_Callback();

  /// @brief Method get_Collection, addr 0x61c0fc0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_Collection();

  /// @brief Method get_CollectionItems, addr 0x61c0fd0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_CollectionItems();

  /// @brief Method get_Id, addr 0x61c0fc8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_Id();

  /// @brief Method set_CollectionItems, addr 0x61c0fd8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x61c0fe0, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* o, ::System::Xml::Serialization::XmlSerializationFixupCallback* callback, int32_t count);

  /// @brief Method get_Callback, addr 0x61c1058, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlSerializationFixupCallback* get_Callback();

  /// @brief Method get_Ids, addr 0x61c1060, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW> get_Ids();

  /// @brief Method get_Source, addr 0x61c1068, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x61bf4dc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Array* list, int32_t index, ::StringW id);

  /// @brief Method get_Collection, addr 0x61c1070, size 0x8, virtual false, abstract: false, final false
  inline ::System::Array* get_Collection();

  /// @brief Method get_Id, addr 0x61c1080, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Id();

  /// @brief Method get_Index, addr 0x61c1078, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddFixup, addr 0x61bceb0, size 0xb8, virtual false, abstract: false, final false
  inline void AddFixup(::System::Xml::Serialization::XmlSerializationReader_CollectionFixup* fixup);

  /// @brief Method AddFixup, addr 0x61bcfac, size 0x44, virtual false, abstract: false, final false
  inline void AddFixup(::System::Xml::Serialization::XmlSerializationReader_CollectionItemFixup* fixup);

  /// @brief Method AddFixup, addr 0x61bcf68, size 0x44, virtual false, abstract: false, final false
  inline void AddFixup(::System::Xml::Serialization::XmlSerializationReader_Fixup* fixup);

  /// @brief Method AddReadCallback, addr 0x61bcff0, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddTarget, addr 0x61bd0d4, size 0xa8, virtual false, abstract: false, final false
  inline void AddTarget(::StringW id, ::System::Object* o);

  /// @brief Method CreateReadOnlyCollectionException, addr 0x61bd340, size 0xc8, virtual false, abstract: false, final false
  inline ::System::Exception* CreateReadOnlyCollectionException(::StringW name);

  /// @brief Method CreateUnknownConstantException, addr 0x61bd408, size 0xd8, virtual false, abstract: false, final false
  inline ::System::Exception* CreateUnknownConstantException(::StringW value, ::System::Type* enumType);

  /// @brief Method CreateUnknownNodeException, addr 0x61bd4e0, size 0xa0, virtual false, abstract: false, final false
  inline ::System::Exception* CreateUnknownNodeException();

  /// @brief Method CreateUnknownTypeException, addr 0x61bd580, size 0x174, virtual false, abstract: false, final false
  inline ::System::Exception* CreateUnknownTypeException(::System::Xml::XmlQualifiedName* type);

  /// @brief Method CurrentTag, addr 0x61bd17c, size 0x1c4, virtual false, abstract: false, final false
  inline ::StringW CurrentTag();

  /// @brief Method EnsureArrayIndex, addr 0x61bd6f4, size 0x8c, virtual false, abstract: false, final false
  inline ::System::Array* EnsureArrayIndex(::System::Array* a, int32_t index, ::System::Type* elementType);

  /// @brief Method EnsureArrayList, addr 0x61bcd50, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* EnsureArrayList(::System::Collections::ArrayList* list);

  /// @brief Method EnsureHashtable, addr 0x61bcdb0, size 0x64, virtual false, abstract: false, final false
  inline ::System::Collections::Hashtable* EnsureHashtable(::System::Collections::Hashtable* hash);

  /// @brief Method GetCallbackInfo, addr 0x61be5a4, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNullAttr, addr 0x61bd780, size 0xb0, virtual false, abstract: false, final false
  inline bool GetNullAttr();

  /// @brief Method GetTarget, addr 0x61bd830, size 0xc8, virtual false, abstract: false, final false
  inline ::System::Object* GetTarget(::StringW id);

  /// @brief Method GetXsiType, addr 0x61bd914, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x61bc9fc, size 0x354, virtual false, abstract: false, final false
  inline void Initialize(::System::Xml::XmlReader* reader, ::System::Xml::Serialization::XmlSerializer* eventSource);

  /// @brief Method IsXmlnsAttribute, addr 0x61bdb34, size 0xa4, virtual false, abstract: false, final false
  inline bool IsXmlnsAttribute(::StringW name);

  static inline ::System::Xml::Serialization::XmlSerializationReader* New_ctor();

  /// @brief Method OnUnknownNode, addr 0x61c080c, size 0x288, virtual false, abstract: false, final false
  inline void OnUnknownNode(::System::Xml::XmlNode* node, ::System::Object* o, ::StringW qnames);

  /// @brief Method ParseWsdlArrayType, addr 0x61bdbd8, size 0x190, virtual false, abstract: false, final false
  inline void ParseWsdlArrayType(::System::Xml::XmlAttribute* attr);

  /// @brief Method ReadElementQualifiedName, addr 0x61bdd68, size 0xd0, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* ReadElementQualifiedName();

  /// @brief Method ReadEndElement, addr 0x61be064, size 0xa8, virtual false, abstract: false, final false
  inline void ReadEndElement();

  /// @brief Method ReadList, addr 0x61be694, size 0x4ec, virtual false, abstract: false, final false
  inline bool ReadList(::by_ref<::System::Object*> resultList);

  /// @brief Method ReadNull, addr 0x61be10c, size 0xd0, virtual false, abstract: false, final false
  inline bool ReadNull();

  /// @brief Method ReadNullableQualifiedName, addr 0x61be210, size 0x28, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* ReadNullableQualifiedName();

  /// @brief Method ReadNullableString, addr 0x61be238, size 0x48, virtual false, abstract: false, final false
  inline ::StringW ReadNullableString();

  /// @brief Method ReadReferencedElement, addr 0x61be280, size 0x58, virtual false, abstract: false, final false
  inline ::System::Object* ReadReferencedElement();

  /// @brief Method ReadReferencedElement, addr 0x61be2d8, size 0x2cc, virtual false, abstract: false, final false
  inline ::System::Object* ReadReferencedElement(::StringW name, ::StringW ns);

  /// @brief Method ReadReferencedElements, addr 0x61bf4ec, size 0xd54, virtual false, abstract: false, final false
  inline void ReadReferencedElements();

  /// @brief Method ReadReferencingElement, addr 0x61c02d8, size 0x64, virtual false, abstract: false, final false
  inline ::System::Object* ReadReferencingElement(::by_ref<::StringW> fixupReference);

  /// @brief Method ReadReferencingElement, addr 0x61c033c, size 0x330, virtual false, abstract: false, final false
  inline ::System::Object* ReadReferencingElement(::StringW name, ::StringW ns, bool elementCanBeType, ::by_ref<::StringW> fixupReference);

  /// @brief Method ReadReferencingElement, addr 0x61bf4d0, size 0xc, virtual false, abstract: false, final false
  inline ::System::Object* ReadReferencingElement(::StringW name, ::StringW ns, ::by_ref<::StringW> fixupReference);

  /// @brief Method ReadSerializable, addr 0x61c066c, size 0x198, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::IXmlSerializable* ReadSerializable(::System::Xml::Serialization::IXmlSerializable* serializable);

  /// @brief Method ReadTypedPrimitive, addr 0x61beb80, size 0x950, virtual false, abstract: false, final false
  inline ::System::Object* ReadTypedPrimitive(::System::Xml::XmlQualifiedName* qname, bool reportUnknown);

  /// @brief Method ReadTypedPrimitive, addr 0x61c0804, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* ReadTypedPrimitive(::System::Xml::XmlQualifiedName* type);

  /// @brief Method ReadXmlDocument, addr 0x61c0afc, size 0x120, virtual false, abstract: false, final false
  inline ::System::Xml::XmlDocument* ReadXmlDocument(bool wrapped);

  /// @brief Method ReadXmlNode, addr 0x61c0a94, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNode* ReadXmlNode(bool wrapped);

  /// @brief Method ShrinkArray, addr 0x61c0c1c, size 0x90, virtual false, abstract: false, final false
  inline ::System::Array* ShrinkArray(::System::Array* a, int32_t length, ::System::Type* elementType, bool isNullable);

  /// @brief Method TargetReady, addr 0x61bd8f8, size 0x1c, virtual false, abstract: false, final false
  inline bool TargetReady(::StringW id);

  /// @brief Method ToXmlQualifiedName, addr 0x61bde38, size 0x22c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* ToXmlQualifiedName(::StringW value);

  /// @brief Method UnknownAttribute, addr 0x61c0cac, size 0x164, virtual false, abstract: false, final false
  inline void UnknownAttribute(::System::Object* o, ::System::Xml::XmlAttribute* attr, ::StringW qnames);

  /// @brief Method UnknownElement, addr 0x61c0e10, size 0x164, virtual false, abstract: false, final false
  inline void UnknownElement(::System::Object* o, ::System::Xml::XmlElement* elem, ::StringW qnames);

  /// @brief Method UnknownNode, addr 0x61be1dc, size 0x34, virtual false, abstract: false, final false
  inline void UnknownNode(::System::Object* o);

  /// @brief Method UnknownNode, addr 0x61c0f74, size 0x38, virtual false, abstract: false, final false
  inline void UnknownNode(::System::Object* o, ::StringW qnames);

  /// @brief Method UnreferencedObject, addr 0x61c0240, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61bce14, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Document, addr 0x61bce18, size 0x90, virtual false, abstract: false, final false
  inline ::System::Xml::XmlDocument* get_Document();

  /// @brief Method get_Reader, addr 0x61bcea8, size 0x8, virtual false, abstract: false, final false
