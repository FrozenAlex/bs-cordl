...
public:
  ...
  /// @brief Method FindElement, addr 0x6306dc0, size 0x688, virtual false, abstract: false, final false
  ...
  /// @brief Method SetChoice, addr 0x630b674, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x630b648, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ChoiceMember, addr 0x630b654, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ChoiceMember();

  /// @brief Method get_ChoiceTypeData, addr 0x630b664, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::TypeData* get_ChoiceTypeData();

  /// @brief Method get_ElementInfo, addr 0x63059f8, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapElementInfoList* get_ElementInfo();

  /// @brief Method get_IsXmlTextCollector, addr 0x630b684, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsXmlTextCollector();

  /// @brief Method set_ChoiceMember, addr 0x630b65c, size 0x8, virtual false, abstract: false, final false
  inline void set_ChoiceMember(::StringW value);

  /// @brief Method set_ChoiceTypeData, addr 0x630b66c, size 0x8, virtual false, abstract: false, final false
  inline void set_ChoiceTypeData(::System::Xml::Serialization::TypeData* value);

  /// @brief Method set_ElementInfo, addr 0x630b64c, size 0x8, virtual false, abstract: false, final false
  inline void set_ElementInfo(::System::Xml::Serialization::XmlTypeMapElementInfoList* value);

  /// @brief Method set_IsXmlTextCollector, addr 0x630b68c, size 0x8, virtual false, abstract: false, final false
