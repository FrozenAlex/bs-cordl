...
public:
  ...
  /// @brief Method .ctor, addr 0x61d2810, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_FlatArrayIndex, addr 0x61d2800, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_FlatArrayIndex();

  /// @brief Method set_FlatArrayIndex, addr 0x61d2808, size 0x8, virtual false, abstract: false, final false
