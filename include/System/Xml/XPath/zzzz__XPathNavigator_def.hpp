...
public:
  ...
  /// @brief Method GetNamespacesInScope, addr 0x61a9824, size 0x268, virtual true, abstract: false, final false
  ...
  /// @brief Method IsText, addr 0x61a9b7c, size 0x10, virtual false, abstract: false, final false
  static inline bool IsText(::System::Xml::XPath::XPathNodeType type);

  /// @brief Method LookupNamespace, addr 0x61a947c, size 0x1ac, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method LookupPrefix, addr 0x61a9628, size 0x1fc, virtual true, abstract: false, final false
  ...
  /// @brief Method MoveToNamespace, addr 0x61a9a94, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method System.ICloneable.Clone, addr 0x61a946c, size 0x10, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x61a7d34, size 0xc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ValueAs, addr 0x61a9180, size 0x2ec, virtual true, abstract: false, final false
  inline ::System::Object* ValueAs(::System::Type* returnType, ::System::Xml::IXmlNamespaceResolver* nsResolver);

  /// @brief Method .ctor, addr 0x61a9b8c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_SchemaInfo, addr 0x61a9b30, size 0x4c, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::IXmlSchemaInfo* get_SchemaInfo();

  /// @brief Method get_TypedValue, addr 0x61a7ecc, size 0x2d8, virtual true, abstract: false, final false
  inline ::System::Object* get_TypedValue();

  /// @brief Method get_UnderlyingObject, addr 0x61a9a8c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* get_UnderlyingObject();

  /// @brief Method get_ValueAsBoolean, addr 0x61a838c, size 0x2c4, virtual true, abstract: false, final false
  inline bool get_ValueAsBoolean();

  /// @brief Method get_ValueAsDateTime, addr 0x61a8650, size 0x2cc, virtual true, abstract: false, final false
  inline ::System::DateTime get_ValueAsDateTime();

  /// @brief Method get_ValueAsDouble, addr 0x61a891c, size 0x2cc, virtual true, abstract: false, final false
  inline double_t get_ValueAsDouble();

  /// @brief Method get_ValueAsInt, addr 0x61a8be8, size 0x2cc, virtual true, abstract: false, final false
  inline int32_t get_ValueAsInt();

  /// @brief Method get_ValueAsLong, addr 0x61a8eb4, size 0x2cc, virtual true, abstract: false, final false
  inline int64_t get_ValueAsLong();

  /// @brief Method get_ValueType, addr 0x61a81a4, size 0x1e8, virtual true, abstract: false, final false
  inline ::System::Type* get_ValueType();

  /// @brief Method get_XmlType, addr 0x61a7d40, size 0x18c, virtual true, abstract: false, final false
