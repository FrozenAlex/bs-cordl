...
public:
  // Declarations
  /// @brief Method Encode, addr 0x6052c88, size 0x13c, virtual false, abstract: false, final false
  static inline ::StringW Encode(::ArrayW<uint8_t> inArray, int32_t offsetIn, int32_t count);

  /// @brief Method Encode, addr 0x6052b58, size 0x130, virtual false, abstract: false, final false
  static inline int32_t Encode(::ArrayW<uint8_t> inArray, int32_t offsetIn, int32_t count, ::ArrayW<char16_t> outArray);

  /// @brief Method Encode, addr 0x60529b8, size 0x1a0, virtual false, abstract: false, final false
