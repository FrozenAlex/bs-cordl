...
// Write type traits
MARK_REF_T(::System::Xml::GuidArrayHelperWithDictionaryString*);
DEFINE_IL2CPP_CLASS(::System::Xml::GuidArrayHelperWithDictionaryString*, "System.Xml", "GuidArrayHelperWithDictionaryString");
...
public:
  ...
  /// @brief Method ReadArray, addr 0x60f7a68, size 0x38, virtual true, abstract: false, final false
  inline int32_t ReadArray(::System::Xml::XmlDictionaryReader* reader, ::System::Xml::XmlDictionaryString* localName, ::System::Xml::XmlDictionaryString* namespaceUri, ::ArrayW<::System::Guid> array,
                           int32_t offset, int32_t count);

  /// @brief Method WriteArray, addr 0x60f7aa0, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60f7adc, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Xml::GuidArrayHelperWithDictionaryString) == 0x10, "Size mismatch!");
