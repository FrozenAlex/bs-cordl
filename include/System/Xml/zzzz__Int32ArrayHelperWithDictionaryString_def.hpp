...
// Write type traits
MARK_REF_T(::System::Xml::Int32ArrayHelperWithDictionaryString*);
DEFINE_IL2CPP_CLASS(::System::Xml::Int32ArrayHelperWithDictionaryString*, "System.Xml", "Int32ArrayHelperWithDictionaryString");
...
public:
  ...
  /// @brief Method ReadArray, addr 0x5fbdd30, size 0x38, virtual true, abstract: false, final false
  inline int32_t ReadArray(::System::Xml::XmlDictionaryReader* reader, ::System::Xml::XmlDictionaryString* localName, ::System::Xml::XmlDictionaryString* namespaceUri, ::ArrayW<int32_t> array,
                           int32_t offset, int32_t count);

  /// @brief Method WriteArray, addr 0x5fbdd68, size 0x3c, virtual true, abstract: false, final false
  inline void WriteArray(::System::Xml::XmlDictionaryWriter* writer, ::StringW prefix, ::System::Xml::XmlDictionaryString* localName, ::System::Xml::XmlDictionaryString* namespaceUri,
                         ::ArrayW<int32_t> array, int32_t offset, int32_t count);

  /// @brief Method .ctor, addr 0x5fbdda4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Xml::Int32ArrayHelperWithDictionaryString) == 0x10, "Size mismatch!");
