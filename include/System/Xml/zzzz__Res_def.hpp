...
public:
  // Declarations
  /// @brief Method GetString, addr 0x619b240, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW GetString(::StringW name);

  /// @brief Method GetString, addr 0x619c8e8, size 0x10, virtual false, abstract: false, final false
