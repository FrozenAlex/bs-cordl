...
public:
  ...
  /// @brief Method ReadArray, addr 0x5fbe0d8, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteArray, addr 0x5fbe110, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fbe14c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
