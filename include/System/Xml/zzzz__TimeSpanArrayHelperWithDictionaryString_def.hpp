...
// Write type traits
MARK_REF_T(::System::Xml::TimeSpanArrayHelperWithDictionaryString*);
DEFINE_IL2CPP_CLASS(::System::Xml::TimeSpanArrayHelperWithDictionaryString*, "System.Xml", "TimeSpanArrayHelperWithDictionaryString");
...
public:
  ...
  /// @brief Method ReadArray, addr 0x5fbee40, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteArray, addr 0x5fbee78, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fbeeb4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Xml::TimeSpanArrayHelperWithDictionaryString) == 0x10, "Size mismatch!");
