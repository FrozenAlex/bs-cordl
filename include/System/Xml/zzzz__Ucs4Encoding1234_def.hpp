...
public:
  ...
  /// @brief Method GetPreamble, addr 0x61a2fd8, size 0x7c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GetPreamble();

  static inline ::System::Xml::Ucs4Encoding1234* New_ctor();

  /// @brief Method .ctor, addr 0x61a2d74, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_EncodingName, addr 0x61a2f94, size 0x44, virtual true, abstract: false, final false
