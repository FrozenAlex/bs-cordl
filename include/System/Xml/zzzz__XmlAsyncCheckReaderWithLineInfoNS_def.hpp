...
public:
  ...
  /// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x61ad3ac, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace, addr 0x61ad460, size 0xb8, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW prefix);

  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x61ad518, size 0xb8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x61abf20, size 0x9c, virtual false, abstract: false, final false
