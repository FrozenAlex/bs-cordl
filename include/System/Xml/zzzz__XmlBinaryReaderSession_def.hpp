...
// Write type traits
MARK_REF_T(::System::Xml::XmlBinaryReaderSession*);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlBinaryReaderSession*, "System.Xml", "XmlBinaryReaderSession");
...
public:
  ...
  /// @brief Method TryLookup, addr 0x5fd5530, size 0xb8, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Xml::XmlBinaryReaderSession) == 0x20, "Size mismatch!");
