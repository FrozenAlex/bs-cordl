...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x617a1dc, size 0xd8, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method Item, addr 0x617a134, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x617a128, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNode* container);

  /// @brief Method get_Count, addr 0x617a190, size 0x4c, virtual true, abstract: false, final false
