...
public:
  // Declarations
  /// @brief Method CDataNormalize, addr 0x6199ac4, size 0x1f8, virtual false, abstract: false, final false
  static inline ::StringW CDataNormalize(::StringW value);

  /// @brief Method NonCDataNormalize, addr 0x61997b4, size 0x310, virtual false, abstract: false, final false
