...
public:
  ...
  /// @brief Method CreateAllDateTimeFormats, addr 0x619ed78, size 0x478, virtual false, abstract: false, final false
  static inline void CreateAllDateTimeFormats();

  /// @brief Method CreateException, addr 0x61a0408, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateException, addr 0x61a0550, size 0x78, virtual false, abstract: false, final false
  static inline ::System::Exception* CreateException(::StringW res, ::ArrayW<::StringW> args, ::System::Xml::ExceptionType exceptionType);

  /// @brief Method CreateException, addr 0x619b6f0, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateException, addr 0x61a0040, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateInvalidCharException, addr 0x61a0298, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateInvalidCharException, addr 0x61a08f0, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::Exception* CreateInvalidCharException(char16_t invChar, char16_t nextChar);

  /// @brief Method CreateInvalidCharException, addr 0x61a095c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateInvalidHighSurrogateCharException, addr 0x61a071c, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Exception* CreateInvalidHighSurrogateCharException(char16_t hi);

  /// @brief Method CreateInvalidHighSurrogateCharException, addr 0x61a0778, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateInvalidHighSurrogateCharException, addr 0x61a07e8, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateInvalidNameArgumentException, addr 0x61a0c54, size 0xd0, virtual false, abstract: false, final false
  static inline ::System::ArgumentException* CreateInvalidNameArgumentException(::StringW name, ::StringW argumentName);

  /// @brief Method CreateInvalidNameCharException, addr 0x619b244, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateInvalidSurrogatePairException, addr 0x61a0638, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::Exception* CreateInvalidSurrogatePairException(char16_t low, char16_t hi);

  /// @brief Method CreateInvalidSurrogatePairException, addr 0x61a06a4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateInvalidSurrogatePairException, addr 0x61a0118, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method DecodeName, addr 0x619a6e8, size 0x8b0, virtual false, abstract: false, final false
  static inline ::StringW DecodeName(::StringW name);

  /// @brief Method DoubleToInt64Bits, addr 0x619fe18, size 0x8, virtual false, abstract: false, final false
  static inline int64_t DoubleToInt64Bits(double_t value);

  /// @brief Method EncodeLocalName, addr 0x619a688, size 0x60, virtual false, abstract: false, final false
  static inline ::StringW EncodeLocalName(::StringW name);

  /// @brief Method EncodeName, addr 0x6199cbc, size 0x60, virtual false, abstract: false, final false
  static inline ::StringW EncodeName(::StringW name);

  /// @brief Method EncodeName, addr 0x6199d1c, size 0x96c, virtual false, abstract: false, final false
  static inline ::StringW EncodeName(::StringW name, bool first, bool local);

  /// @brief Method FromBinHexString, addr 0x619afc4, size 0x5c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> FromBinHexString(::StringW s);

  /// @brief Method FromBinHexString, addr 0x619b020, size 0x6c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> FromBinHexString(::StringW s, bool allowOddCount);

  /// @brief Method FromHex, addr 0x619af98, size 0x2c, virtual false, abstract: false, final false
  static inline int32_t FromHex(char16_t digit);

  /// @brief Method IsNegativeZero, addr 0x619c284, size 0x80, virtual false, abstract: false, final false
  static inline bool IsNegativeZero(double_t value);

  /// @brief Method SplitString, addr 0x619fda4, size 0x74, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW> SplitString(::StringW value);

  /// @brief Method StrEqual, addr 0x619fc10, size 0xb4, virtual false, abstract: false, final false
  static inline bool StrEqual(::ArrayW<char16_t> chars, int32_t strPos1, int32_t strLen1, ::StringW str2);

  /// @brief Method SwitchToLocalTime, addr 0x619c740, size 0xd4, virtual false, abstract: false, final false
  static inline ::System::DateTime SwitchToLocalTime(::System::DateTime value);

  /// @brief Method SwitchToUtcTime, addr 0x619c814, size 0xd4, virtual false, abstract: false, final false
  static inline ::System::DateTime SwitchToUtcTime(::System::DateTime value);

  /// @brief Method ToBinHexString, addr 0x619b08c, size 0x60, virtual false, abstract: false, final false
  static inline ::StringW ToBinHexString(::ArrayW<uint8_t> inArray);

  /// @brief Method ToBoolean, addr 0x619c9a8, size 0x1c4, virtual false, abstract: false, final false
  static inline bool ToBoolean(::StringW s);

  /// @brief Method ToByte, addr 0x619db2c, size 0x28, virtual false, abstract: false, final false
  static inline uint8_t ToByte(::StringW s);

  /// @brief Method ToChar, addr 0x619ce1c, size 0xb8, virtual false, abstract: false, final false
  static inline char16_t ToChar(::StringW s);

  /// @brief Method ToDateTime, addr 0x619f1f0, size 0x60, virtual false, abstract: false, final false
  static inline ::System::DateTime ToDateTime(::StringW s);

  /// @brief Method ToDateTime, addr 0x619f2fc, size 0x23c, virtual false, abstract: false, final false
  static inline ::System::DateTime ToDateTime(::StringW s, ::System::Xml::XmlDateTimeSerializationMode dateTimeOption);

  /// @brief Method ToDateTime, addr 0x619f250, size 0xac, virtual false, abstract: false, final false
  static inline ::System::DateTime ToDateTime(::StringW s, ::ArrayW<::StringW> formats);

  /// @brief Method ToDateTimeOffset, addr 0x619f538, size 0xcc, virtual false, abstract: false, final false
  static inline ::System::DateTimeOffset ToDateTimeOffset(::StringW s);

  /// @brief Method ToDecimal, addr 0x619d074, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Decimal ToDecimal(::StringW s);

  /// @brief Method ToDouble, addr 0x619e510, size 0x110, virtual false, abstract: false, final false
  static inline double_t ToDouble(::StringW s);

  /// @brief Method ToGuid, addr 0x619f604, size 0x2c, virtual false, abstract: false, final false
  static inline ::System::Guid ToGuid(::StringW s);

  /// @brief Method ToInt16, addr 0x619d64c, size 0x28, virtual false, abstract: false, final false
  static inline int16_t ToInt16(::StringW s);

  /// @brief Method ToInt32, addr 0x619d7ec, size 0x28, virtual false, abstract: false, final false
  static inline int32_t ToInt32(::StringW s);

  /// @brief Method ToInt64, addr 0x619d98c, size 0x28, virtual false, abstract: false, final false
  static inline int64_t ToInt64(::StringW s);

  /// @brief Method ToInteger, addr 0x619d290, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Decimal ToInteger(::StringW s);

  /// @brief Method ToSByte, addr 0x619d4ac, size 0x28, virtual false, abstract: false, final false
  static inline int8_t ToSByte(::StringW s);

  /// @brief Method ToSingle, addr 0x619e1ac, size 0x110, virtual false, abstract: false, final false
  static inline float_t ToSingle(::StringW s);

  /// @brief Method ToString, addr 0x619c510, size 0x230, virtual false, abstract: false, final false
  static inline ::StringW ToString(::System::DateTime value, ::System::Xml::XmlDateTimeSerializationMode dateTimeOption);

  /// @brief Method ToString, addr 0x619c464, size 0xac, virtual false, abstract: false, final false
  static inline ::StringW ToString(::System::DateTime value, ::StringW format);

  /// @brief Method ToString, addr 0x619c8f8, size 0x8c, virtual false, abstract: false, final false
  static inline ::StringW ToString(::System::DateTimeOffset value);

  /// @brief Method ToString, addr 0x619bf64, size 0xa0, virtual false, abstract: false, final false
  static inline ::StringW ToString(::System::Decimal value);

  /// @brief Method ToString, addr 0x619c984, size 0x24, virtual false, abstract: false, final false
  static inline ::StringW ToString(::System::Guid value);

  /// @brief Method ToString, addr 0x619c428, size 0x3c, virtual false, abstract: false, final false
  static inline ::StringW ToString(::System::TimeSpan value);

  /// @brief Method ToString, addr 0x619beb4, size 0x78, virtual false, abstract: false, final false
  static inline ::StringW ToString(bool value);

  /// @brief Method ToString, addr 0x619bf2c, size 0x38, virtual false, abstract: false, final false
  static inline ::StringW ToString(char16_t value);

  /// @brief Method ToString, addr 0x619c304, size 0x124, virtual false, abstract: false, final false
  static inline ::StringW ToString(double_t value);

  /// @brief Method ToString, addr 0x619c15c, size 0x128, virtual false, abstract: false, final false
  static inline ::StringW ToString(float_t value);

  /// @brief Method ToString, addr 0x619c030, size 0x2c, virtual false, abstract: false, final false
  static inline ::StringW ToString(int16_t value);

  /// @brief Method ToString, addr 0x619c05c, size 0x2c, virtual false, abstract: false, final false
  static inline ::StringW ToString(int32_t value);

  /// @brief Method ToString, addr 0x619c088, size 0x28, virtual false, abstract: false, final false
  static inline ::StringW ToString(int64_t value);

  /// @brief Method ToString, addr 0x619c004, size 0x2c, virtual false, abstract: false, final false
  static inline ::StringW ToString(int8_t value);

  /// @brief Method ToString, addr 0x619c0dc, size 0x2c, virtual false, abstract: false, final false
  static inline ::StringW ToString(uint16_t value);

  /// @brief Method ToString, addr 0x619c108, size 0x2c, virtual false, abstract: false, final false
  static inline ::StringW ToString(uint32_t value);

  /// @brief Method ToString, addr 0x619c134, size 0x28, virtual false, abstract: false, final false
  static inline ::StringW ToString(uint64_t value);

  /// @brief Method ToString, addr 0x619c0b0, size 0x2c, virtual false, abstract: false, final false
  static inline ::StringW ToString(uint8_t value);

  /// @brief Method ToTimeSpan, addr 0x619eaa4, size 0x184, virtual false, abstract: false, final false
  static inline ::System::TimeSpan ToTimeSpan(::StringW s);

  /// @brief Method ToUInt16, addr 0x619dccc, size 0x28, virtual false, abstract: false, final false
  static inline uint16_t ToUInt16(::StringW s);

  /// @brief Method ToUInt32, addr 0x619de6c, size 0x28, virtual false, abstract: false, final false
  static inline uint32_t ToUInt32(::StringW s);

  /// @brief Method ToUInt64, addr 0x619e00c, size 0x28, virtual false, abstract: false, final false
  static inline uint64_t ToUInt64(::StringW s);

  /// @brief Method ToUri, addr 0x619f818, size 0x1c0, virtual false, abstract: false, final false
  static inline ::System::Uri* ToUri(::StringW s);

  /// @brief Method ToXPathDouble, addr 0x619e874, size 0x230, virtual false, abstract: false, final false
  static inline double_t ToXPathDouble(::System::Object* o);

  /// @brief Method TrimString, addr 0x619cb6c, size 0x70, virtual false, abstract: false, final false
  static inline ::StringW TrimString(::StringW value);

  /// @brief Method TrimStringEnd, addr 0x619fd34, size 0x70, virtual false, abstract: false, final false
  static inline ::StringW TrimStringEnd(::StringW value);

  /// @brief Method TrimStringStart, addr 0x619fcc4, size 0x70, virtual false, abstract: false, final false
  static inline ::StringW TrimStringStart(::StringW value);

  /// @brief Method TryToBoolean, addr 0x619cbdc, size 0x240, virtual false, abstract: false, final false
  static inline ::System::Exception* TryToBoolean(::StringW s, ::by_ref<bool> result);

  /// @brief Method TryToByte, addr 0x619db54, size 0x178, virtual false, abstract: false, final false
  static inline ::System::Exception* TryToByte(::StringW s, ::by_ref<uint8_t> result);

  /// @brief Method TryToChar, addr 0x619ced4, size 0x1a0, virtual false, abstract: false, final false
  static inline ::System::Exception* TryToChar(::StringW s, ::by_ref<char16_t> result);

  /// @brief Method TryToDecimal, addr 0x619d0e8, size 0x1a8, virtual false, abstract: false, final false
  static inline ::System::Exception* TryToDecimal(::StringW s, ::by_ref<::System::Decimal> result);

  /// @brief Method TryToDouble, addr 0x619e620, size 0x254, virtual false, abstract: false, final false
  static inline ::System::Exception* TryToDouble(::StringW s, ::by_ref<double_t> result);

  /// @brief Method TryToGuid, addr 0x619f630, size 0x1e8, virtual false, abstract: false, final false
  static inline ::System::Exception* TryToGuid(::StringW s, ::by_ref<::System::Guid> result);

  /// @brief Method TryToInt16, addr 0x619d674, size 0x178, virtual false, abstract: false, final false
  static inline ::System::Exception* TryToInt16(::StringW s, ::by_ref<int16_t> result);

  /// @brief Method TryToInt32, addr 0x619d814, size 0x178, virtual false, abstract: false, final false
  static inline ::System::Exception* TryToInt32(::StringW s, ::by_ref<int32_t> result);

  /// @brief Method TryToInt64, addr 0x619d9b4, size 0x178, virtual false, abstract: false, final false
  static inline ::System::Exception* TryToInt64(::StringW s, ::by_ref<int64_t> result);

  /// @brief Method TryToInteger, addr 0x619d304, size 0x1a8, virtual false, abstract: false, final false
  static inline ::System::Exception* TryToInteger(::StringW s, ::by_ref<::System::Decimal> result);

  /// @brief Method TryToSByte, addr 0x619d4d4, size 0x178, virtual false, abstract: false, final false
  static inline ::System::Exception* TryToSByte(::StringW s, ::by_ref<int8_t> result);

  /// @brief Method TryToSingle, addr 0x619e2bc, size 0x254, virtual false, abstract: false, final false
  static inline ::System::Exception* TryToSingle(::StringW s, ::by_ref<float_t> result);

  /// @brief Method TryToTimeSpan, addr 0x619ec28, size 0xb8, virtual false, abstract: false, final false
  static inline ::System::Exception* TryToTimeSpan(::StringW s, ::by_ref<::System::TimeSpan> result);

  /// @brief Method TryToUInt16, addr 0x619dcf4, size 0x178, virtual false, abstract: false, final false
  static inline ::System::Exception* TryToUInt16(::StringW s, ::by_ref<uint16_t> result);

  /// @brief Method TryToUInt32, addr 0x619de94, size 0x178, virtual false, abstract: false, final false
  static inline ::System::Exception* TryToUInt32(::StringW s, ::by_ref<uint32_t> result);

  /// @brief Method TryToUInt64, addr 0x619e034, size 0x178, virtual false, abstract: false, final false
  static inline ::System::Exception* TryToUInt64(::StringW s, ::by_ref<uint64_t> result);

  /// @brief Method TryToUri, addr 0x619f9d8, size 0x238, virtual false, abstract: false, final false
  static inline ::System::Exception* TryToUri(::StringW s, ::by_ref<::System::Uri*> result);

  /// @brief Method TryVerifyNCName, addr 0x619b990, size 0xac, virtual false, abstract: false, final false
  static inline ::System::Exception* TryVerifyNCName(::StringW name);

  /// @brief Method TryVerifyNMTOKEN, addr 0x619bcb4, size 0x128, virtual false, abstract: false, final false
  static inline ::System::Exception* TryVerifyNMTOKEN(::StringW name);

  /// @brief Method TryVerifyName, addr 0x619b30c, size 0x154, virtual false, abstract: false, final false
  static inline ::System::Exception* TryVerifyName(::StringW name);

  /// @brief Method TryVerifyNormalizedString, addr 0x619bddc, size 0xd8, virtual false, abstract: false, final false
  static inline ::System::Exception* TryVerifyNormalizedString(::StringW str);

  /// @brief Method TryVerifyTOKEN, addr 0x619bb74, size 0x140, virtual false, abstract: false, final false
  static inline ::System::Exception* TryVerifyTOKEN(::StringW token);

  /// @brief Method VerifyCharData, addr 0x619fe20, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method VerifyNCName, addr 0x619b7d4, size 0x5c, virtual false, abstract: false, final false
  static inline ::StringW VerifyNCName(::StringW name);

  /// @brief Method VerifyNCName, addr 0x619b830, size 0x160, virtual false, abstract: false, final false
  static inline ::StringW VerifyNCName(::StringW name, ::System::Xml::ExceptionType exceptionType);

  /// @brief Method VerifyName, addr 0x619b0ec, size 0x154, virtual false, abstract: false, final false
  static inline ::StringW VerifyName(::StringW name);

  /// @brief Method VerifyQName, addr 0x619b5c8, size 0x128, virtual false, abstract: false, final false
  static inline ::StringW VerifyQName(::StringW name, ::System::Xml::ExceptionType exceptionType);

  /// @brief Method VerifyTOKEN, addr 0x619ba3c, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AllDateTimeFormats, addr 0x619ece0, size 0x98, virtual false, abstract: false, final false
