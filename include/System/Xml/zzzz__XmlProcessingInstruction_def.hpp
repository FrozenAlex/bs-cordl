...
public:
  ...
  /// @brief Method CloneNode, addr 0x62c51a8, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteContentTo, addr 0x62c5208, size 0x4, virtual true, abstract: false, final false
  inline void WriteContentTo(::System::Xml::XmlWriter* w);

  /// @brief Method WriteTo, addr 0x62c51e0, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62c508c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW target, ::StringW data, ::System::Xml::XmlDocument* doc);

  /// @brief Method get_InnerText, addr 0x62c5194, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_InnerText();

  /// @brief Method get_LocalName, addr 0x62c50dc, size 0xc, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Name, addr 0x62c50bc, size 0x20, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NodeType, addr 0x62c51a0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Value, addr 0x62c50e8, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method get_XPLocalName, addr 0x62c520c, size 0xc, virtual true, abstract: false, final false
  inline ::StringW get_XPLocalName();

  /// @brief Method get_XPNodeType, addr 0x62c5218, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathNodeType get_XPNodeType();

  /// @brief Method set_Data, addr 0x62c50f4, size 0xa0, virtual false, abstract: false, final false
  inline void set_Data(::StringW value);

  /// @brief Method set_InnerText, addr 0x62c519c, size 0x4, virtual true, abstract: false, final false
  inline void set_InnerText(::StringW value);

  /// @brief Method set_Value, addr 0x62c50f0, size 0x4, virtual true, abstract: false, final false
