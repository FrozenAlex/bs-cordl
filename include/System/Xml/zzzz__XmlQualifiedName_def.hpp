...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x62df7a4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62df358, size 0x80, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Atomize, addr 0x62df498, size 0x54, virtual false, abstract: false, final false
  inline void Atomize(::System::Xml::XmlNameTable* nameTable);

  /// @brief Method Clone, addr 0x62df69c, size 0x80, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* Clone();

  /// @brief Method Equals, addr 0x62df114, size 0xe8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method GetHashCode, addr 0x62dee24, size 0xd0, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetHashCodeDelegate, addr 0x62deef4, size 0x170, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlQualifiedName_HashCodeOfStringDelegate* GetHashCodeDelegate();

  /// @brief Method GetHashCodeOfString, addr 0x62df3d8, size 0x18, virtual false, abstract: false, final false
  static inline int32_t GetHashCodeOfString(::StringW s, int32_t length, int64_t additionalEntropy);

  /// @brief Method Init, addr 0x62df3f0, size 0xc, virtual false, abstract: false, final false
  inline void Init(::StringW name, ::StringW ns);

  /// @brief Method IsRandomizedHashingDisabled, addr 0x62df350, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x62df4ec, size 0x1b0, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlQualifiedName* Parse(::StringW s, ::System::Xml::IXmlNamespaceResolver* nsmgr, ::by_ref<::StringW> prefix);

  /// @brief Method SetNamespace, addr 0x62df3fc, size 0x8, virtual false, abstract: false, final false
  inline void SetNamespace(::StringW ns);

  /// @brief Method ToString, addr 0x62df0a0, size 0x74, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x62df2d0, size 0x80, virtual false, abstract: false, final false
  static inline ::StringW ToString(::StringW name, ::StringW ns);

  /// @brief Method Verify, addr 0x62df404, size 0x94, virtual false, abstract: false, final false
  inline void Verify();
  ...
  /// @brief Method .ctor, addr 0x62deda8, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x62dee00, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x62dedc0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsEmpty, addr 0x62df064, size 0x3c, virtual false, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_Name, addr 0x62dee1c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Namespace, addr 0x62dee14, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method op_Equality, addr 0x62df270, size 0x60, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Xml::XmlQualifiedName* a, ::System::Xml::XmlQualifiedName* b);

  /// @brief Method op_Inequality, addr 0x62df1fc, size 0x74, virtual false, abstract: false, final false
