...
public:
  ...
  /// @brief Method WriteChars, addr 0x60522a8, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6052284, size 0x24, virtual false, abstract: false, final false
