...
public:
  ...
  /// @brief Method GetCharBuffer, addr 0x612595c, size 0x98, virtual false, abstract: false, final false
  inline ::ArrayW<char16_t> GetCharBuffer(int32_t charCount);

  /// @brief Method GetCharEntityBuffer, addr 0x6125900, size 0x5c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetCharEntityBuffer();

  /// @brief Method InternalWriteBase64Text, addr 0x612754c, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOutput, addr 0x6125798, size 0x98, virtual false, abstract: false, final false
  inline void SetOutput(::System::IO::Stream* stream, bool ownsStream, ::System::Text::Encoding* encoding);

  /// @brief Method ToBase16, addr 0x6126d7c, size 0xd0, virtual false, abstract: false, final false
  inline int32_t ToBase16(::ArrayW<uint8_t> chars, int32_t offset, uint32_t value);

  /// @brief Method UnsafeWriteEscapedText, addr 0x61264fc, size 0x110, virtual false, abstract: false, final false
  inline void UnsafeWriteEscapedText(char16_t* chars, int32_t count);

  /// @brief Method WriteAmpersandCharEntity, addr 0x61269f0, size 0xdc, virtual false, abstract: false, final false
  inline void WriteAmpersandCharEntity();

  /// @brief Method WriteApostropheCharEntity, addr 0x6126acc, size 0xf8, virtual false, abstract: false, final false
  inline void WriteApostropheCharEntity();

  /// @brief Method WriteBase64Text, addr 0x61274f8, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteBoolText, addr 0x6126e94, size 0xac, virtual true, abstract: false, final false
  inline void WriteBoolText(bool value);

  /// @brief Method WriteCData, addr 0x6125b3c, size 0x1ec, virtual true, abstract: false, final false
  inline void WriteCData(::StringW text);

  /// @brief Method WriteCharEntity, addr 0x6126e4c, size 0x48, virtual true, abstract: false, final false
  inline void WriteCharEntity(int32_t ch);

  /// @brief Method WriteComment, addr 0x6125e84, size 0x30, virtual true, abstract: false, final false
  inline void WriteComment(::StringW text);

  /// @brief Method WriteDateTimeText, addr 0x612714c, size 0xac, virtual true, abstract: false, final false
  inline void WriteDateTimeText(::System::DateTime value);

  /// @brief Method WriteDecimalText, addr 0x6126f40, size 0xb4, virtual true, abstract: false, final false
  inline void WriteDecimalText(::System::Decimal value);

  /// @brief Method WriteDeclaration, addr 0x61259f4, size 0x148, virtual true, abstract: false, final false
  inline void WriteDeclaration();

  /// @brief Method WriteDoubleText, addr 0x6126ff4, size 0xac, virtual true, abstract: false, final false
  inline void WriteDoubleText(double_t value);

  /// @brief Method WriteEndAttribute, addr 0x612649c, size 0x1c, virtual true, abstract: false, final false
  inline void WriteEndAttribute();

  /// @brief Method WriteEndComment, addr 0x6125de4, size 0xa0, virtual false, abstract: false, final false
  inline void WriteEndComment();

  /// @brief Method WriteEndElement, addr 0x6126030, size 0x68, virtual true, abstract: false, final false
  inline void WriteEndElement(::StringW prefix, ::StringW localName);

  /// @brief Method WriteEndElement, addr 0x6126098, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteEndStartElement, addr 0x6126018, size 0x18, virtual true, abstract: false, final false
  inline void WriteEndStartElement(bool isEmpty);

  /// @brief Method WriteEscapedText, addr 0x612664c, size 0x1c4, virtual true, abstract: false, final false
  inline void WriteEscapedText(::ArrayW<uint8_t> chars, int32_t offset, int32_t count);

  /// @brief Method WriteEscapedText, addr 0x612660c, size 0x40, virtual true, abstract: false, final false
  inline void WriteEscapedText(::ArrayW<char16_t> s, int32_t offset, int32_t count);

  /// @brief Method WriteEscapedText, addr 0x61264d8, size 0x24, virtual true, abstract: false, final false
  inline void WriteEscapedText(::StringW s);

  /// @brief Method WriteEscapedText, addr 0x61264b8, size 0x20, virtual true, abstract: false, final false
  inline void WriteEscapedText(::System::Xml::XmlDictionaryString* s);

  /// @brief Method WriteFloatText, addr 0x61270a0, size 0xac, virtual true, abstract: false, final false
  inline void WriteFloatText(float_t value);

  /// @brief Method WriteGreaterThanCharEntity, addr 0x6126930, size 0xc0, virtual false, abstract: false, final false
  inline void WriteGreaterThanCharEntity();

  /// @brief Method WriteGuidText, addr 0x61274bc, size 0x3c, virtual true, abstract: false, final false
  inline void WriteGuidText(::System::Guid value);

  /// @brief Method WriteHexCharEntity, addr 0x6126cbc, size 0xc0, virtual false, abstract: false, final false
  inline void WriteHexCharEntity(int32_t ch);

  /// @brief Method WriteInt32Text, addr 0x61272b8, size 0xac, virtual true, abstract: false, final false
  inline void WriteInt32Text(int32_t value);

  /// @brief Method WriteInt64Text, addr 0x6127364, size 0xac, virtual true, abstract: false, final false
  inline void WriteInt64Text(int64_t value);

  /// @brief Method WriteLessThanCharEntity, addr 0x6126870, size 0xc0, virtual false, abstract: false, final false
  inline void WriteLessThanCharEntity();

  /// @brief Method WriteLocalName, addr 0x6125f3c, size 0x4, virtual false, abstract: false, final false
  inline void WriteLocalName(::StringW localName);

  /// @brief Method WriteLocalName, addr 0x6126014, size 0x4, virtual false, abstract: false, final false
  inline void WriteLocalName(::ArrayW<uint8_t> localNameBuffer, int32_t localNameOffset, int32_t localNameLength);

  /// @brief Method WritePrefix, addr 0x6125f0c, size 0x30, virtual false, abstract: false, final false
  inline void WritePrefix(::StringW prefix);

  /// @brief Method WritePrefix, addr 0x6125fd8, size 0x3c, virtual false, abstract: false, final false
  inline void WritePrefix(::ArrayW<uint8_t> prefixBuffer, int32_t prefixOffset, int32_t prefixLength);

  /// @brief Method WriteQualifiedName, addr 0x6127c94, size 0x54, virtual true, abstract: false, final false
  inline void WriteQualifiedName(::StringW prefix, ::System::Xml::XmlDictionaryString* localName);

  /// @brief Method WriteQuoteCharEntity, addr 0x6126bc4, size 0xf8, virtual false, abstract: false, final false
  inline void WriteQuoteCharEntity();

  /// @brief Method WriteStartAttribute, addr 0x6126370, size 0x74, virtual true, abstract: false, final false
  inline void WriteStartAttribute(::StringW prefix, ::StringW localName);

  /// @brief Method WriteStartAttribute, addr 0x61263e4, size 0x20, virtual true, abstract: false, final false
  inline void WriteStartAttribute(::StringW prefix, ::System::Xml::XmlDictionaryString* localName);

  /// @brief Method WriteStartAttribute, addr 0x6126404, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteStartComment, addr 0x6125d28, size 0xbc, virtual false, abstract: false, final false
  inline void WriteStartComment();

  /// @brief Method WriteStartElement, addr 0x6125eb4, size 0x58, virtual true, abstract: false, final false
  inline void WriteStartElement(::StringW prefix, ::StringW localName);

  /// @brief Method WriteStartElement, addr 0x6125f40, size 0x1c, virtual true, abstract: false, final false
  inline void WriteStartElement(::StringW prefix, ::System::Xml::XmlDictionaryString* localName);

  /// @brief Method WriteStartElement, addr 0x6125f5c, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteStartXmlnsAttribute, addr 0x6126124, size 0x100, virtual false, abstract: false, final false
  inline void WriteStartXmlnsAttribute();

  /// @brief Method WriteText, addr 0x6126810, size 0x4, virtual false, abstract: false, final false
  inline void WriteText(int32_t ch);

  /// @brief Method WriteText, addr 0x6126818, size 0x40, virtual true, abstract: false, final false
  inline void WriteText(::ArrayW<char16_t> chars, int32_t offset, int32_t count);

  /// @brief Method WriteText, addr 0x6126814, size 0x4, virtual true, abstract: false, final false
  inline void WriteText(::ArrayW<uint8_t> chars, int32_t offset, int32_t count);

  /// @brief Method WriteText, addr 0x6126858, size 0x4, virtual true, abstract: false, final false
  inline void WriteText(::StringW value);

  /// @brief Method WriteText, addr 0x612685c, size 0x14, virtual true, abstract: false, final false
  inline void WriteText(::System::Xml::XmlDictionaryString* value);

  /// @brief Method WriteTimeSpanText, addr 0x6127bf0, size 0xa4, virtual true, abstract: false, final false
  inline void WriteTimeSpanText(::System::TimeSpan value);

  /// @brief Method WriteUInt64Text, addr 0x6127410, size 0xac, virtual true, abstract: false, final false
  inline void WriteUInt64Text(uint64_t value);

  /// @brief Method WriteUniqueIdText, addr 0x61271f8, size 0xc0, virtual true, abstract: false, final false
  inline void WriteUniqueIdText(::System::Xml::UniqueId* value);

  /// @brief Method WriteXmlnsAttribute, addr 0x6126224, size 0x84, virtual true, abstract: false, final false
  inline void WriteXmlnsAttribute(::StringW prefix, ::StringW ns);

  /// @brief Method WriteXmlnsAttribute, addr 0x61262a8, size 0x20, virtual true, abstract: false, final false
  inline void WriteXmlnsAttribute(::StringW prefix, ::System::Xml::XmlDictionaryString* ns);

  /// @brief Method WriteXmlnsAttribute, addr 0x61262c8, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6125734, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x612588c, size 0x74, virtual false, abstract: false, final false
