...
public:
  ...
  /// @brief Method Close, addr 0x6168e10, size 0x4, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Create, addr 0x6169b40, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlWriter* Create(::System::IO::Stream* output, ::System::Xml::XmlWriterSettings* settings);

  /// @brief Method Create, addr 0x616a114, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlWriter* Create(::System::IO::TextWriter* output, ::System::Xml::XmlWriterSettings* settings);

  /// @brief Method Dispose, addr 0x6169ae8, size 0x14, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6169afc, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteAttributeString, addr 0x6168d08, size 0x5c, virtual false, abstract: false, final false
  inline void WriteAttributeString(::StringW localName, ::StringW ns, ::StringW value);

  /// @brief Method WriteAttributeString, addr 0x6168d64, size 0x5c, virtual false, abstract: false, final false
  inline void WriteAttributeString(::StringW localName, ::StringW value);

  /// @brief Method WriteAttributeString, addr 0x6168dc0, size 0x50, virtual false, abstract: false, final false
  inline void WriteAttributeString(::StringW prefix, ::StringW localName, ::StringW ns, ::StringW value);

  /// @brief Method WriteAttributes, addr 0x616934c, size 0x278, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteBinHex, addr 0x61677ac, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteElementString, addr 0x6169a84, size 0x64, virtual false, abstract: false, final false
  inline void WriteElementString(::StringW localName, ::StringW ns, ::StringW value);

  /// @brief Method WriteElementString, addr 0x6169a78, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteNode, addr 0x61695c4, size 0x4b4, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteQualifiedName, addr 0x6168e30, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteStartElement, addr 0x6168cf0, size 0x18, virtual false, abstract: false, final false
  inline void WriteStartElement(::StringW localName);

  /// @brief Method WriteStartElement, addr 0x6168cd8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteValue, addr 0x6168f80, size 0x18, virtual true, abstract: false, final false
  inline void WriteValue(::StringW value);

  /// @brief Method WriteValue, addr 0x6169018, size 0x84, virtual true, abstract: false, final false
  inline void WriteValue(::System::DateTime value);

  /// @brief Method WriteValue, addr 0x616919c, size 0x88, virtual true, abstract: false, final false
  inline void WriteValue(::System::Decimal value);

  /// @brief Method WriteValue, addr 0x6168f98, size 0x80, virtual true, abstract: false, final false
  inline void WriteValue(bool value);

  /// @brief Method WriteValue, addr 0x616909c, size 0x80, virtual true, abstract: false, final false
  inline void WriteValue(double_t value);

  /// @brief Method WriteValue, addr 0x616911c, size 0x80, virtual true, abstract: false, final false
  inline void WriteValue(float_t value);

  /// @brief Method WriteValue, addr 0x6169224, size 0x94, virtual true, abstract: false, final false
  inline void WriteValue(int32_t value);

  /// @brief Method WriteValue, addr 0x61692b8, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x616114c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_XmlLang, addr 0x6168e1c, size 0x14, virtual true, abstract: false, final false
  inline ::StringW get_XmlLang();

  /// @brief Method get_XmlSpace, addr 0x6168e14, size 0x8, virtual true, abstract: false, final false
