...
public:
  ...
  /// @brief Method AddAttributePSVI, addr 0x62ab8d4, size 0x154, virtual false, abstract: false, final false
  inline ::System::Xml::AttributePSVIInfo* AddAttributePSVI(int32_t attIndex);

  /// @brief Method CachingCallBack, addr 0x62ac260, size 0x24, virtual false, abstract: false, final false
  inline void CachingCallBack(::System::Xml::XsdCachingReader* cachingReader);

  /// @brief Method ClearAttributesInfo, addr 0x62a9f24, size 0x3c, virtual false, abstract: false, final false
  inline void ClearAttributesInfo();

  /// @brief Method Close, addr 0x62a9f80, size 0x34, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method CreateDummyTextNode, addr 0x62aa304, size 0x88, virtual false, abstract: false, final false
  inline ::System::Xml::ValidatingReaderNodeData* CreateDummyTextNode(::StringW attributeValue, int32_t depth);

  /// @brief Method GetAttribute, addr 0x62a9150, size 0xe8, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(int32_t i);

  /// @brief Method GetAttribute, addr 0x62a8d70, size 0x6c, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW name);

  /// @brief Method GetAttribute, addr 0x62a8f50, size 0xcc, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW name, ::StringW namespaceURI);

  /// @brief Method GetAttributePSVI, addr 0x62a9598, size 0x78, virtual false, abstract: false, final false
  inline ::System::Xml::AttributePSVIInfo* GetAttributePSVI(::StringW localName, ::StringW ns);

  /// @brief Method GetAttributePSVI, addr 0x62a92f0, size 0x190, virtual false, abstract: false, final false
  inline ::System::Xml::AttributePSVIInfo* GetAttributePSVI(::StringW name);

  /// @brief Method GetCachingReader, addr 0x62ab7f8, size 0xdc, virtual false, abstract: false, final false
  inline ::System::Xml::XsdCachingReader* GetCachingReader();

  /// @brief Method GetDefaultAttribute, addr 0x62a901c, size 0x134, virtual false, abstract: false, final false
  inline ::System::Xml::ValidatingReaderNodeData* GetDefaultAttribute(::StringW attrLocalName, ::StringW ns, bool updatePosition);

  /// @brief Method GetDefaultAttribute, addr 0x62a8ddc, size 0x174, virtual false, abstract: false, final false
  inline ::System::Xml::ValidatingReaderNodeData* GetDefaultAttribute(::StringW name, bool updatePosition);

  /// @brief Method GetIsDefault, addr 0x62aa57c, size 0x308, virtual false, abstract: false, final false
  inline void GetIsDefault();

  /// @brief Method GetMemberType, addr 0x62aa9dc, size 0x114, virtual false, abstract: false, final false
  inline void GetMemberType();

  /// @brief Method GetOriginalAtomicValueStringOfElement, addr 0x62ab790, size 0x68, virtual false, abstract: false, final false
  inline ::StringW GetOriginalAtomicValueStringOfElement();

  /// @brief Method GetStringValue, addr 0x62aafc0, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Object* GetStringValue();

  /// @brief Method HasLineInfo, addr 0x62aabe4, size 0x8, virtual true, abstract: false, final true
  inline bool HasLineInfo();

  /// @brief Method Init, addr 0x62a5374, size 0x338, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method InternalReadContentAsObject, addr 0x62a619c, size 0x18, virtual false, abstract: false, final false
  inline ::System::Object* InternalReadContentAsObject();

  /// @brief Method InternalReadContentAsObject, addr 0x62a5ec8, size 0x14, virtual false, abstract: false, final false
  inline ::System::Object* InternalReadContentAsObject(bool unwrapTypedValue);

  /// @brief Method InternalReadContentAsObject, addr 0x62a78d0, size 0x21c, virtual false, abstract: false, final false
  inline ::System::Object* InternalReadContentAsObject(bool unwrapTypedValue, ::by_ref<::StringW> originalStringValue);

  /// @brief Method InternalReadElementContentAsObject, addr 0x62a7d40, size 0x18, virtual false, abstract: false, final false
  inline ::System::Object* InternalReadElementContentAsObject(::by_ref<::System::Xml::Schema::XmlSchemaType*> xmlType);

  /// @brief Method InternalReadElementContentAsObject, addr 0x62abdbc, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalReadElementContentAsObject, addr 0x62abdd0, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsXSDRoot, addr 0x62ab5bc, size 0x24, virtual false, abstract: false, final false
  inline bool IsXSDRoot(::StringW localName, ::StringW ns);

  /// @brief Method LookupNamespace, addr 0x62aa168, size 0xb8, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method MoveToAttribute, addr 0x62a9238, size 0xb8, virtual true, abstract: false, final false
  inline bool MoveToAttribute(::StringW name);

  /// @brief Method MoveToAttribute, addr 0x62a9480, size 0x118, virtual true, abstract: false, final false
  inline bool MoveToAttribute(::StringW name, ::StringW ns);

  /// @brief Method MoveToAttribute, addr 0x62a9610, size 0x1a4, virtual true, abstract: false, final false
  inline void MoveToAttribute(int32_t i);

  /// @brief Method MoveToElement, addr 0x62a9a74, size 0x54, virtual true, abstract: false, final false
  inline bool MoveToElement();

  /// @brief Method MoveToFirstAttribute, addr 0x62a97b4, size 0x15c, virtual true, abstract: false, final false
  inline bool MoveToFirstAttribute();

  /// @brief Method MoveToNextAttribute, addr 0x62a9910, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessElementEvent, addr 0x62aafdc, size 0x488, virtual false, abstract: false, final false
  inline void ProcessElementEvent();

  /// @brief Method ProcessEndElementEvent, addr 0x62ab464, size 0x158, virtual false, abstract: false, final false
  inline void ProcessEndElementEvent();

  /// @brief Method ProcessInlineSchema, addr 0x62a9e74, size 0xb0, virtual false, abstract: false, final false
  inline void ProcessInlineSchema();

  /// @brief Method ProcessReaderEvent, addr 0x62a9c4c, size 0x228, virtual false, abstract: false, final false
  inline void ProcessReaderEvent();

  /// @brief Method Read, addr 0x62a9ac8, size 0x184, virtual true, abstract: false, final false
  inline bool Read();

  /// @brief Method ReadAheadForMemberType, addr 0x62ac020, size 0x240, virtual false, abstract: false, final false
  inline void ReadAheadForMemberType();

  /// @brief Method ReadAttributeValue, addr 0x62aa258, size 0xac, virtual true, abstract: false, final false
  inline bool ReadAttributeValue();

  /// @brief Method ReadContentAs, addr 0x62a753c, size 0x394, virtual true, abstract: false, final false
  inline ::System::Object* ReadContentAs(::System::Type* returnType, ::System::Xml::IXmlNamespaceResolver* namespaceResolver);

  /// @brief Method ReadContentAsBase64, addr 0x62aa38c, size 0xb4, virtual true, abstract: false, final false
  inline int32_t ReadContentAsBase64(::ArrayW<uint8_t> buffer, int32_t index, int32_t count);

  /// @brief Method ReadContentAsBinHex, addr 0x62aa440, size 0xb4, virtual true, abstract: false, final false
  inline int32_t ReadContentAsBinHex(::ArrayW<uint8_t> buffer, int32_t index, int32_t count);

  /// @brief Method ReadContentAsBoolean, addr 0x62a5edc, size 0x2c0, virtual true, abstract: false, final false
  inline bool ReadContentAsBoolean();

  /// @brief Method ReadContentAsDateTime, addr 0x62a621c, size 0x2c4, virtual true, abstract: false, final false
  inline ::System::DateTime ReadContentAsDateTime();

  /// @brief Method ReadContentAsDecimal, addr 0x62a6a68, size 0x2c4, virtual true, abstract: false, final false
  inline ::System::Decimal ReadContentAsDecimal();

  /// @brief Method ReadContentAsDouble, addr 0x62a64e0, size 0x2c4, virtual true, abstract: false, final false
  inline double_t ReadContentAsDouble();

  /// @brief Method ReadContentAsFloat, addr 0x62a67a4, size 0x2c4, virtual true, abstract: false, final false
  inline float_t ReadContentAsFloat();

  /// @brief Method ReadContentAsInt, addr 0x62a6d2c, size 0x2c4, virtual true, abstract: false, final false
  inline int32_t ReadContentAsInt();

  /// @brief Method ReadContentAsLong, addr 0x62a6ff0, size 0x2c4, virtual true, abstract: false, final false
  inline int64_t ReadContentAsLong();

  /// @brief Method ReadContentAsObject, addr 0x62a5dfc, size 0xcc, virtual true, abstract: false, final false
  inline ::System::Object* ReadContentAsObject();

  /// @brief Method ReadContentAsString, addr 0x62a72b4, size 0x288, virtual true, abstract: false, final false
  inline ::StringW ReadContentAsString();

  /// @brief Method ReadElementContentAsBoolean, addr 0x62a7aec, size 0x254, virtual true, abstract: false, final false
  inline bool ReadElementContentAsBoolean();

  /// @brief Method ReadElementContentAsDateTime, addr 0x62a7d58, size 0x258, virtual true, abstract: false, final false
  inline ::System::DateTime ReadElementContentAsDateTime();

  /// @brief Method ReadElementContentAsDecimal, addr 0x62a8460, size 0x258, virtual true, abstract: false, final false
  inline ::System::Decimal ReadElementContentAsDecimal();

  /// @brief Method ReadElementContentAsDouble, addr 0x62a7fb0, size 0x258, virtual true, abstract: false, final false
  inline double_t ReadElementContentAsDouble();

  /// @brief Method ReadElementContentAsFloat, addr 0x62a8208, size 0x258, virtual true, abstract: false, final false
  inline float_t ReadElementContentAsFloat();

  /// @brief Method ReadElementContentAsInt, addr 0x62a86b8, size 0x258, virtual true, abstract: false, final false
  inline int32_t ReadElementContentAsInt();

  /// @brief Method ReadElementContentAsLong, addr 0x62a8910, size 0x258, virtual true, abstract: false, final false
  inline int64_t ReadElementContentAsLong();

  /// @brief Method ReadElementContentAsString, addr 0x62a8b68, size 0x200, virtual true, abstract: false, final false
  inline ::StringW ReadElementContentAsString();

  /// @brief Method ReadTillEndElement, addr 0x62abb90, size 0x22c, virtual false, abstract: false, final false
  inline ::System::Object* ReadTillEndElement();

  /// @brief Method ResolveEntity, addr 0x62aa220, size 0x38, virtual true, abstract: false, final false
  inline void ResolveEntity();

  /// @brief Method ReturnBoxedValue, addr 0x62aba28, size 0x168, virtual false, abstract: false, final false
  inline ::System::Object* ReturnBoxedValue(::System::Object* typedValue, ::System::Xml::Schema::XmlSchemaType* xmlType, bool unWrap);

  /// @brief Method SetupValidator, addr 0x62a56ac, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method Skip, addr 0x62a9fe8, size 0x178, virtual true, abstract: false, final false
  inline void Skip();

  /// @brief Method SwitchReader, addr 0x62abf9c, size 0x84, virtual false, abstract: false, final false
  inline void SwitchReader();

  /// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x62aad54, size 0xcc, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace, addr 0x62aae20, size 0xd0, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW prefix);

  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x62aaef0, size 0xd0, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupPrefix(::StringW namespaceName);

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_IsDefault, addr 0x62aa4f4, size 0x88, virtual true, abstract: false, final true
  inline bool System_Xml_Schema_IXmlSchemaInfo_get_IsDefault();

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_IsNil, addr 0x62aa884, size 0x48, virtual true, abstract: false, final true
  inline bool System_Xml_Schema_IXmlSchemaInfo_get_IsNil();

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_MemberType, addr 0x62aa95c, size 0x80, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaSimpleType* System_Xml_Schema_IXmlSchemaInfo_get_MemberType();

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_SchemaAttribute, addr 0x62aaba0, size 0x44, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaAttribute* System_Xml_Schema_IXmlSchemaInfo_get_SchemaAttribute();

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_SchemaElement, addr 0x62aab4c, size 0x54, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaElement* System_Xml_Schema_IXmlSchemaInfo_get_SchemaElement();

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_SchemaType, addr 0x62aaaf0, size 0x5c, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaType* System_Xml_Schema_IXmlSchemaInfo_get_SchemaType();

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_Validity, addr 0x62aa8cc, size 0x90, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaValidity System_Xml_Schema_IXmlSchemaInfo_get_Validity();

  /// @brief Method ValidateAttributes, addr 0x62ab5e0, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62a589c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62a51e0, size 0x194, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlReader* reader, ::System::Xml::XmlResolver* xmlResolver, ::System::Xml::XmlReaderSettings* readerSettings,
                    ::System::Xml::Schema::XmlSchemaObject* partialValidationType);

  static inline ::System::Type* getStaticF_TypeOfString();

  /// @brief Method get_AttributeCount, addr 0x62a8d68, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_AttributeCount();

  /// @brief Method get_AttributeSchemaInfo, addr 0x62a5de4, size 0x18, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaInfo* get_AttributeSchemaInfo();

  /// @brief Method get_AttributeXmlType, addr 0x62a61e0, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaType* get_AttributeXmlType();

  /// @brief Method get_BaseURI, addr 0x62a5c44, size 0x20, virtual true, abstract: false, final false
  inline ::StringW get_BaseURI();

  /// @brief Method get_Depth, addr 0x62a5c08, size 0x3c, virtual true, abstract: false, final false
  inline int32_t get_Depth();

  /// @brief Method get_EOF, addr 0x62a9f60, size 0x20, virtual true, abstract: false, final false
  inline bool get_EOF();

  /// @brief Method get_ElementXmlType, addr 0x62a61b4, size 0x2c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaType* get_ElementXmlType();

  /// @brief Method get_IsDefault, addr 0x62a5c84, size 0x34, virtual true, abstract: false, final false
  inline bool get_IsDefault();

  /// @brief Method get_IsEmptyElement, addr 0x62a5c64, size 0x20, virtual true, abstract: false, final false
  inline bool get_IsEmptyElement();

  /// @brief Method get_LineNumber, addr 0x62aabec, size 0xb4, virtual true, abstract: false, final true
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x62aaca0, size 0xb4, virtual true, abstract: false, final true
  inline int32_t get_LinePosition();

  /// @brief Method get_LocalName, addr 0x62a5b18, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Name, addr 0x62a5a00, size 0x118, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameTable, addr 0x62aa160, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_NamespaceURI, addr 0x62a5b54, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW get_NamespaceURI();

  /// @brief Method get_NodeType, addr 0x62a5978, size 0x88, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Prefix, addr 0x62a5b90, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_QuoteChar, addr 0x62a5cb8, size 0x20, virtual true, abstract: false, final false
  inline char16_t get_QuoteChar();

  /// @brief Method get_ReadState, addr 0x62a9fb4, size 0x34, virtual true, abstract: false, final false
  inline ::System::Xml::ReadState get_ReadState();

  /// @brief Method get_SchemaInfo, addr 0x62a5d18, size 0x4, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::IXmlSchemaInfo* get_SchemaInfo();

  /// @brief Method get_Settings, addr 0x62a58a4, size 0xd4, virtual true, abstract: false, final false
  inline ::System::Xml::XmlReaderSettings* get_Settings();

  /// @brief Method get_Value, addr 0x62a5bcc, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method get_ValueType, addr 0x62a5d1c, size 0xc8, virtual true, abstract: false, final false
  inline ::System::Type* get_ValueType();

  /// @brief Method get_XmlLang, addr 0x62a5cf8, size 0x20, virtual true, abstract: false, final false
  inline ::StringW get_XmlLang();

  /// @brief Method get_XmlSpace, addr 0x62a5cd8, size 0x20, virtual true, abstract: false, final false
