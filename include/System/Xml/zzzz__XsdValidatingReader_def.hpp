...
public:
  ...
  /// @brief Method AddAttributePSVI, addr 0x6172a3c, size 0x154, virtual false, abstract: false, final false
  inline ::System::Xml::AttributePSVIInfo* AddAttributePSVI(int32_t attIndex);

  /// @brief Method CachingCallBack, addr 0x61733c8, size 0x24, virtual false, abstract: false, final false
  inline void CachingCallBack(::System::Xml::XsdCachingReader* cachingReader);

  /// @brief Method ClearAttributesInfo, addr 0x617108c, size 0x3c, virtual false, abstract: false, final false
  inline void ClearAttributesInfo();

  /// @brief Method Close, addr 0x61710e8, size 0x34, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method CreateDummyTextNode, addr 0x617146c, size 0x88, virtual false, abstract: false, final false
  inline ::System::Xml::ValidatingReaderNodeData* CreateDummyTextNode(::StringW attributeValue, int32_t depth);

  /// @brief Method GetAttribute, addr 0x61702b8, size 0xe8, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(int32_t i);

  /// @brief Method GetAttribute, addr 0x616fed8, size 0x6c, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW name);

  /// @brief Method GetAttribute, addr 0x61700b8, size 0xcc, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW name, ::StringW namespaceURI);

  /// @brief Method GetAttributePSVI, addr 0x6170700, size 0x78, virtual false, abstract: false, final false
  inline ::System::Xml::AttributePSVIInfo* GetAttributePSVI(::StringW localName, ::StringW ns);

  /// @brief Method GetAttributePSVI, addr 0x6170458, size 0x190, virtual false, abstract: false, final false
  inline ::System::Xml::AttributePSVIInfo* GetAttributePSVI(::StringW name);

  /// @brief Method GetCachingReader, addr 0x6172960, size 0xdc, virtual false, abstract: false, final false
  inline ::System::Xml::XsdCachingReader* GetCachingReader();

  /// @brief Method GetDefaultAttribute, addr 0x6170184, size 0x134, virtual false, abstract: false, final false
  inline ::System::Xml::ValidatingReaderNodeData* GetDefaultAttribute(::StringW attrLocalName, ::StringW ns, bool updatePosition);

  /// @brief Method GetDefaultAttribute, addr 0x616ff44, size 0x174, virtual false, abstract: false, final false
  inline ::System::Xml::ValidatingReaderNodeData* GetDefaultAttribute(::StringW name, bool updatePosition);

  /// @brief Method GetIsDefault, addr 0x61716e4, size 0x308, virtual false, abstract: false, final false
  inline void GetIsDefault();

  /// @brief Method GetMemberType, addr 0x6171b44, size 0x114, virtual false, abstract: false, final false
  inline void GetMemberType();

  /// @brief Method GetOriginalAtomicValueStringOfElement, addr 0x61728f8, size 0x68, virtual false, abstract: false, final false
  inline ::StringW GetOriginalAtomicValueStringOfElement();

  /// @brief Method GetStringValue, addr 0x6172128, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Object* GetStringValue();

  /// @brief Method HasLineInfo, addr 0x6171d4c, size 0x8, virtual true, abstract: false, final true
  inline bool HasLineInfo();

  /// @brief Method Init, addr 0x616c4dc, size 0x338, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method InternalReadContentAsObject, addr 0x616d304, size 0x18, virtual false, abstract: false, final false
  inline ::System::Object* InternalReadContentAsObject();

  /// @brief Method InternalReadContentAsObject, addr 0x616d030, size 0x14, virtual false, abstract: false, final false
  inline ::System::Object* InternalReadContentAsObject(bool unwrapTypedValue);

  /// @brief Method InternalReadContentAsObject, addr 0x616ea38, size 0x21c, virtual false, abstract: false, final false
  inline ::System::Object* InternalReadContentAsObject(bool unwrapTypedValue, ::by_ref<::StringW> originalStringValue);

  /// @brief Method InternalReadElementContentAsObject, addr 0x616eea8, size 0x18, virtual false, abstract: false, final false
  inline ::System::Object* InternalReadElementContentAsObject(::by_ref<::System::Xml::Schema::XmlSchemaType*> xmlType);

  /// @brief Method InternalReadElementContentAsObject, addr 0x6172f24, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalReadElementContentAsObject, addr 0x6172f38, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsXSDRoot, addr 0x6172724, size 0x24, virtual false, abstract: false, final false
  inline bool IsXSDRoot(::StringW localName, ::StringW ns);

  /// @brief Method LookupNamespace, addr 0x61712d0, size 0xb8, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method MoveToAttribute, addr 0x61703a0, size 0xb8, virtual true, abstract: false, final false
  inline bool MoveToAttribute(::StringW name);

  /// @brief Method MoveToAttribute, addr 0x61705e8, size 0x118, virtual true, abstract: false, final false
  inline bool MoveToAttribute(::StringW name, ::StringW ns);

  /// @brief Method MoveToAttribute, addr 0x6170778, size 0x1a4, virtual true, abstract: false, final false
  inline void MoveToAttribute(int32_t i);

  /// @brief Method MoveToElement, addr 0x6170bdc, size 0x54, virtual true, abstract: false, final false
  inline bool MoveToElement();

  /// @brief Method MoveToFirstAttribute, addr 0x617091c, size 0x15c, virtual true, abstract: false, final false
  inline bool MoveToFirstAttribute();

  /// @brief Method MoveToNextAttribute, addr 0x6170a78, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessElementEvent, addr 0x6172144, size 0x488, virtual false, abstract: false, final false
  inline void ProcessElementEvent();

  /// @brief Method ProcessEndElementEvent, addr 0x61725cc, size 0x158, virtual false, abstract: false, final false
  inline void ProcessEndElementEvent();

  /// @brief Method ProcessInlineSchema, addr 0x6170fdc, size 0xb0, virtual false, abstract: false, final false
  inline void ProcessInlineSchema();

  /// @brief Method ProcessReaderEvent, addr 0x6170db4, size 0x228, virtual false, abstract: false, final false
  inline void ProcessReaderEvent();

  /// @brief Method Read, addr 0x6170c30, size 0x184, virtual true, abstract: false, final false
  inline bool Read();

  /// @brief Method ReadAheadForMemberType, addr 0x6173188, size 0x240, virtual false, abstract: false, final false
  inline void ReadAheadForMemberType();

  /// @brief Method ReadAttributeValue, addr 0x61713c0, size 0xac, virtual true, abstract: false, final false
  inline bool ReadAttributeValue();

  /// @brief Method ReadContentAs, addr 0x616e6a4, size 0x394, virtual true, abstract: false, final false
  inline ::System::Object* ReadContentAs(::System::Type* returnType, ::System::Xml::IXmlNamespaceResolver* namespaceResolver);

  /// @brief Method ReadContentAsBase64, addr 0x61714f4, size 0xb4, virtual true, abstract: false, final false
  inline int32_t ReadContentAsBase64(::ArrayW<uint8_t> buffer, int32_t index, int32_t count);

  /// @brief Method ReadContentAsBinHex, addr 0x61715a8, size 0xb4, virtual true, abstract: false, final false
  inline int32_t ReadContentAsBinHex(::ArrayW<uint8_t> buffer, int32_t index, int32_t count);

  /// @brief Method ReadContentAsBoolean, addr 0x616d044, size 0x2c0, virtual true, abstract: false, final false
  inline bool ReadContentAsBoolean();

  /// @brief Method ReadContentAsDateTime, addr 0x616d384, size 0x2c4, virtual true, abstract: false, final false
  inline ::System::DateTime ReadContentAsDateTime();

  /// @brief Method ReadContentAsDecimal, addr 0x616dbd0, size 0x2c4, virtual true, abstract: false, final false
  inline ::System::Decimal ReadContentAsDecimal();

  /// @brief Method ReadContentAsDouble, addr 0x616d648, size 0x2c4, virtual true, abstract: false, final false
  inline double_t ReadContentAsDouble();

  /// @brief Method ReadContentAsFloat, addr 0x616d90c, size 0x2c4, virtual true, abstract: false, final false
  inline float_t ReadContentAsFloat();

  /// @brief Method ReadContentAsInt, addr 0x616de94, size 0x2c4, virtual true, abstract: false, final false
  inline int32_t ReadContentAsInt();

  /// @brief Method ReadContentAsLong, addr 0x616e158, size 0x2c4, virtual true, abstract: false, final false
  inline int64_t ReadContentAsLong();

  /// @brief Method ReadContentAsObject, addr 0x616cf64, size 0xcc, virtual true, abstract: false, final false
  inline ::System::Object* ReadContentAsObject();

  /// @brief Method ReadContentAsString, addr 0x616e41c, size 0x288, virtual true, abstract: false, final false
  inline ::StringW ReadContentAsString();

  /// @brief Method ReadElementContentAsBoolean, addr 0x616ec54, size 0x254, virtual true, abstract: false, final false
  inline bool ReadElementContentAsBoolean();

  /// @brief Method ReadElementContentAsDateTime, addr 0x616eec0, size 0x258, virtual true, abstract: false, final false
  inline ::System::DateTime ReadElementContentAsDateTime();

  /// @brief Method ReadElementContentAsDecimal, addr 0x616f5c8, size 0x258, virtual true, abstract: false, final false
  inline ::System::Decimal ReadElementContentAsDecimal();

  /// @brief Method ReadElementContentAsDouble, addr 0x616f118, size 0x258, virtual true, abstract: false, final false
  inline double_t ReadElementContentAsDouble();

  /// @brief Method ReadElementContentAsFloat, addr 0x616f370, size 0x258, virtual true, abstract: false, final false
  inline float_t ReadElementContentAsFloat();

  /// @brief Method ReadElementContentAsInt, addr 0x616f820, size 0x258, virtual true, abstract: false, final false
  inline int32_t ReadElementContentAsInt();

  /// @brief Method ReadElementContentAsLong, addr 0x616fa78, size 0x258, virtual true, abstract: false, final false
  inline int64_t ReadElementContentAsLong();

  /// @brief Method ReadElementContentAsString, addr 0x616fcd0, size 0x200, virtual true, abstract: false, final false
  inline ::StringW ReadElementContentAsString();

  /// @brief Method ReadTillEndElement, addr 0x6172cf8, size 0x22c, virtual false, abstract: false, final false
  inline ::System::Object* ReadTillEndElement();

  /// @brief Method ResolveEntity, addr 0x6171388, size 0x38, virtual true, abstract: false, final false
  inline void ResolveEntity();

  /// @brief Method ReturnBoxedValue, addr 0x6172b90, size 0x168, virtual false, abstract: false, final false
  inline ::System::Object* ReturnBoxedValue(::System::Object* typedValue, ::System::Xml::Schema::XmlSchemaType* xmlType, bool unWrap);

  /// @brief Method SetupValidator, addr 0x616c814, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method Skip, addr 0x6171150, size 0x178, virtual true, abstract: false, final false
  inline void Skip();

  /// @brief Method SwitchReader, addr 0x6173104, size 0x84, virtual false, abstract: false, final false
  inline void SwitchReader();

  /// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x6171ebc, size 0xcc, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace, addr 0x6171f88, size 0xd0, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW prefix);

  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x6172058, size 0xd0, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupPrefix(::StringW namespaceName);

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_IsDefault, addr 0x617165c, size 0x88, virtual true, abstract: false, final true
  inline bool System_Xml_Schema_IXmlSchemaInfo_get_IsDefault();

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_IsNil, addr 0x61719ec, size 0x48, virtual true, abstract: false, final true
  inline bool System_Xml_Schema_IXmlSchemaInfo_get_IsNil();

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_MemberType, addr 0x6171ac4, size 0x80, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaSimpleType* System_Xml_Schema_IXmlSchemaInfo_get_MemberType();

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_SchemaAttribute, addr 0x6171d08, size 0x44, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaAttribute* System_Xml_Schema_IXmlSchemaInfo_get_SchemaAttribute();

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_SchemaElement, addr 0x6171cb4, size 0x54, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaElement* System_Xml_Schema_IXmlSchemaInfo_get_SchemaElement();

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_SchemaType, addr 0x6171c58, size 0x5c, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaType* System_Xml_Schema_IXmlSchemaInfo_get_SchemaType();

  /// @brief Method System.Xml.Schema.IXmlSchemaInfo.get_Validity, addr 0x6171a34, size 0x90, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchemaValidity System_Xml_Schema_IXmlSchemaInfo_get_Validity();

  /// @brief Method ValidateAttributes, addr 0x6172748, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x616ca04, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x616c348, size 0x194, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlReader* reader, ::System::Xml::XmlResolver* xmlResolver, ::System::Xml::XmlReaderSettings* readerSettings,
                    ::System::Xml::Schema::XmlSchemaObject* partialValidationType);

  static inline ::System::Type* getStaticF_TypeOfString();

  /// @brief Method get_AttributeCount, addr 0x616fed0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_AttributeCount();

  /// @brief Method get_AttributeSchemaInfo, addr 0x616cf4c, size 0x18, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaInfo* get_AttributeSchemaInfo();

  /// @brief Method get_AttributeXmlType, addr 0x616d348, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaType* get_AttributeXmlType();

  /// @brief Method get_BaseURI, addr 0x616cdac, size 0x20, virtual true, abstract: false, final false
  inline ::StringW get_BaseURI();

  /// @brief Method get_Depth, addr 0x616cd70, size 0x3c, virtual true, abstract: false, final false
  inline int32_t get_Depth();

  /// @brief Method get_EOF, addr 0x61710c8, size 0x20, virtual true, abstract: false, final false
  inline bool get_EOF();

  /// @brief Method get_ElementXmlType, addr 0x616d31c, size 0x2c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaType* get_ElementXmlType();

  /// @brief Method get_IsDefault, addr 0x616cdec, size 0x34, virtual true, abstract: false, final false
  inline bool get_IsDefault();

  /// @brief Method get_IsEmptyElement, addr 0x616cdcc, size 0x20, virtual true, abstract: false, final false
  inline bool get_IsEmptyElement();

  /// @brief Method get_LineNumber, addr 0x6171d54, size 0xb4, virtual true, abstract: false, final true
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x6171e08, size 0xb4, virtual true, abstract: false, final true
  inline int32_t get_LinePosition();

  /// @brief Method get_LocalName, addr 0x616cc80, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Name, addr 0x616cb68, size 0x118, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameTable, addr 0x61712c8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_NamespaceURI, addr 0x616ccbc, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW get_NamespaceURI();

  /// @brief Method get_NodeType, addr 0x616cae0, size 0x88, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Prefix, addr 0x616ccf8, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_QuoteChar, addr 0x616ce20, size 0x20, virtual true, abstract: false, final false
  inline char16_t get_QuoteChar();

  /// @brief Method get_ReadState, addr 0x617111c, size 0x34, virtual true, abstract: false, final false
  inline ::System::Xml::ReadState get_ReadState();

  /// @brief Method get_SchemaInfo, addr 0x616ce80, size 0x4, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::IXmlSchemaInfo* get_SchemaInfo();

  /// @brief Method get_Settings, addr 0x616ca0c, size 0xd4, virtual true, abstract: false, final false
  inline ::System::Xml::XmlReaderSettings* get_Settings();

  /// @brief Method get_Value, addr 0x616cd34, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method get_ValueType, addr 0x616ce84, size 0xc8, virtual true, abstract: false, final false
  inline ::System::Type* get_ValueType();

  /// @brief Method get_XmlLang, addr 0x616ce60, size 0x20, virtual true, abstract: false, final false
  inline ::StringW get_XmlLang();

  /// @brief Method get_XmlSpace, addr 0x616ce40, size 0x20, virtual true, abstract: false, final false
