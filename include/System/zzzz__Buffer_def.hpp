...
public:
  // Declarations
  /// @brief Method BlockCopy, addr 0x5c709ac, size 0x1a8, virtual false, abstract: false, final false
  static inline void BlockCopy(::System::Array* src, int32_t srcOffset, ::System::Array* dst, int32_t dstOffset, int32_t count);

  /// @brief Method ByteLength, addr 0x5c70918, size 0x94, virtual false, abstract: false, final false
  static inline int32_t ByteLength(::System::Array* array);

  /// @brief Method IndexOfByte, addr 0x5c70694, size 0x124, virtual false, abstract: false, final false
  static inline int32_t IndexOfByte(uint8_t* src, uint8_t value, int32_t index, int32_t count);

  /// @brief Method InternalBlockCopy, addr 0x5c70690, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalMemcpy, addr 0x5c70910, size 0x8, virtual false, abstract: false, final false
  static inline void InternalMemcpy(uint8_t* dest, uint8_t* src, int32_t count);

  /// @brief Method Memcpy, addr 0x5c70814, size 0xfc, virtual false, abstract: false, final false
  static inline void Memcpy(uint8_t* dest, uint8_t* src, int32_t len);

  /// @brief Method Memcpy, addr 0x5c707e0, size 0x34, virtual false, abstract: false, final false
  static inline void Memcpy(uint8_t* pDest, int32_t destIndex, ::ArrayW<uint8_t> src, int32_t srcIndex, int32_t len);

  /// @brief Method Memmove, addr 0x5c70c50, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method MemoryCopy, addr 0x5c70b54, size 0xfc, virtual false, abstract: false, final false
  static inline void MemoryCopy(void* source, void* destination, int64_t destinationSizeInBytes, int64_t sourceBytesToCopy);

  /// @brief Method ZeroMemory, addr 0x5c707bc, size 0x24, virtual false, abstract: false, final false
  static inline void ZeroMemory(uint8_t* src, int64_t len);

  /// @brief Method _ByteLength, addr 0x5c707b8, size 0x4, virtual false, abstract: false, final false
  static inline int32_t _ByteLength(::System::Array* array);

  /// @brief Method memcpy1, addr 0x5c70d90, size 0xb4, virtual false, abstract: false, final false
  static inline void memcpy1(uint8_t* dest, uint8_t* src, int32_t size);

  /// @brief Method memcpy2, addr 0x5c70d0c, size 0x84, virtual false, abstract: false, final false
  static inline void memcpy2(uint8_t* dest, uint8_t* src, int32_t size);

  /// @brief Method memcpy4, addr 0x5c70c78, size 0x94, virtual false, abstract: false, final false
