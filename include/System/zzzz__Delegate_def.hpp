...
public:
  ...
  /// @brief Method AllocDelegateLike_internal, addr 0x5b56620, size 0x24, virtual false, abstract: false, final false
  static inline ::System::MulticastDelegate* AllocDelegateLike_internal(::System::Delegate* d);

  /// @brief Method Clone, addr 0x5b55f30, size 0x4, virtual true, abstract: false, final false
  inline ::System::Object* Clone();

  /// @brief Method Combine, addr 0x5b51494, size 0x13c, virtual false, abstract: false, final false
  static inline ::System::Delegate* Combine(::System::Delegate* a, ::System::Delegate* b);

  /// @brief Method Combine, addr 0x5b564e4, size 0x64, virtual false, abstract: false, final false
  static inline ::System::Delegate* Combine(::ArrayW<::System::Delegate*> delegates);

  /// @brief Method CombineImpl, addr 0x5b56548, size 0x50, virtual true, abstract: false, final false
  inline ::System::Delegate* CombineImpl(::System::Delegate* d);

  /// @brief Method CreateDelegate, addr 0x5b5552c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDelegate, addr 0x5b54ce8, size 0x844, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDelegate, addr 0x5b5554c, size 0x14, virtual false, abstract: false, final false
  static inline ::System::Delegate* CreateDelegate(::System::Type* type, ::System::Reflection::MethodInfo* method);

  /// @brief Method CreateDelegate, addr 0x5b55538, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDelegate, addr 0x5b55560, size 0xc, virtual false, abstract: false, final false
  static inline ::System::Delegate* CreateDelegate(::System::Type* type, ::System::Object* target, ::StringW method);

  /// @brief Method CreateDelegate, addr 0x5b5556c, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Delegate* CreateDelegate(::System::Type* type, ::System::Object* target, ::StringW method, bool ignoreCase);

  /// @brief Method CreateDelegate, addr 0x5b55a5c, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDelegate, addr 0x5b55a50, size 0xc, virtual false, abstract: false, final false
  static inline ::System::Delegate* CreateDelegate(::System::Type* type, ::System::Type* target, ::StringW method);

  /// @brief Method CreateDelegate, addr 0x5b5597c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDelegate_internal, addr 0x5b54838, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method DynamicInvoke, addr 0x5b55b24, size 0xc, virtual false, abstract: false, final false
  inline ::System::Object* DynamicInvoke(::ArrayW<::System::Object*> args);

  /// @brief Method DynamicInvokeImpl, addr 0x5b55c30, size 0x300, virtual true, abstract: false, final false
  inline ::System::Object* DynamicInvokeImpl(::ArrayW<::System::Object*> args);

  /// @brief Method Equals, addr 0x5b55f38, size 0x18c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetCandidateMethod, addr 0x5b55574, size 0x408, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x5b560c4, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetInvocationList, addr 0x5b56450, size 0x94, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Delegate*> GetInvocationList();

  /// @brief Method GetMethodImpl, addr 0x5b5611c, size 0xd4, virtual true, abstract: false, final false
  inline ::System::Reflection::MethodInfo* GetMethodImpl();

  /// @brief Method GetObjectData, addr 0x5b561f0, size 0x4, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetVirtualMethod_internal, addr 0x5b5482c, size 0x4, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* GetVirtualMethod_internal();

  /// @brief Method InitializeDelegateData, addr 0x5b55b30, size 0x100, virtual false, abstract: false, final false
  inline void InitializeDelegateData();

  /// @brief Method Remove, addr 0x5b51678, size 0x138, virtual false, abstract: false, final false
  static inline ::System::Delegate* Remove(::System::Delegate* source, ::System::Delegate* value);

  /// @brief Method RemoveImpl, addr 0x5b56598, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method arg_type_match, addr 0x5b5483c, size 0x174, virtual false, abstract: false, final false
  static inline bool arg_type_match(::System::Type* delArgType, ::System::Type* argType);

  /// @brief Method arg_type_match_this, addr 0x5b549b0, size 0x118, virtual false, abstract: false, final false
  static inline bool arg_type_match_this(::System::Type* delArgType, ::System::Type* argType, bool boxedThis);

  /// @brief Method get_Method, addr 0x5b54820, size 0xc, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_Method();

  /// @brief Method get_Target, addr 0x5b54830, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x5b565bc, size 0x28, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Delegate* d1, ::System::Delegate* d2);

  /// @brief Method op_Inequality, addr 0x5b565e4, size 0x3c, virtual false, abstract: false, final false
  static inline bool op_Inequality(::System::Delegate* d1, ::System::Delegate* d2);

  /// @brief Method return_type_match, addr 0x5b54ac8, size 0x220, virtual false, abstract: false, final false
