...
public:
  ...
  /// @brief Method Equals, addr 0x5c3f8b4, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::System::Index other);

  /// @brief Method Equals, addr 0x5c3f838, size 0x7c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method FromStart, addr 0x5c3f7f8, size 0x14, virtual false, abstract: false, final false
  static inline ::System::Index FromStart(int32_t value);

  /// @brief Method GetHashCode, addr 0x5c3f8c4, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetOffset, addr 0x5c3f824, size 0x14, virtual false, abstract: false, final false
  inline int32_t GetOffset(int32_t length);

  /// @brief Method ToString, addr 0x5c3f8e0, size 0x28, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToStringFromEnd, addr 0x5c3f908, size 0x180, virtual false, abstract: false, final false
  inline ::StringW ToStringFromEnd();

  /// @brief Method .ctor, addr 0x5c3f7f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t value);

  /// @brief Method get_IsFromEnd, addr 0x5c3f818, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsFromEnd();

  /// @brief Method get_Value, addr 0x5c3f80c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x5c3f8cc, size 0x14, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Index) == 0x4, "Size mismatch!");
