...
public:
  ...
  /// @brief Method .ctor, addr 0x5c3fb14, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5c3fb74, size 0x8, virtual false, abstract: false, final false
