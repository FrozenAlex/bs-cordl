...
public:
  // Declarations
  /// @brief Method CheckIriUnicodeRange, addr 0x636d654, size 0x6b0, virtual false, abstract: false, final false
  static inline bool CheckIriUnicodeRange(char16_t highSurr, char16_t lowSurr, ::by_ref<bool> surrogatePair, bool isQuery);

  /// @brief Method CheckIriUnicodeRange, addr 0x636d5fc, size 0x58, virtual false, abstract: false, final false
  static inline bool CheckIriUnicodeRange(char16_t unicode, bool isQuery);

  /// @brief Method CheckIsReserved, addr 0x636dd04, size 0x138, virtual false, abstract: false, final false
  static inline bool CheckIsReserved(char16_t ch, ::System::UriComponents component);

  /// @brief Method EscapeUnescapeIri, addr 0x636de3c, size 0x830, virtual false, abstract: false, final false
