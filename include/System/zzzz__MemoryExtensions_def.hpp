...
public:
  // Declarations
  /// @brief Method AsSpan, addr 0x5b0ecf8, size 0x58, virtual false, abstract: false, final false
  static inline ::System::ReadOnlySpan_1<char16_t> AsSpan(::StringW text);

  /// @brief Method AsSpan, addr 0x5b0ed50, size 0x80, virtual false, abstract: false, final false
  static inline ::System::ReadOnlySpan_1<char16_t> AsSpan(::StringW text, int32_t start);

  /// @brief Method AsSpan, addr 0x5b0edd0, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method Contains, addr 0x5b0e7ac, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method EndsWith, addr 0x5b0e9e8, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method EqualsOrdinal, addr 0x5b0e5f4, size 0xf8, virtual false, abstract: false, final false
  static inline bool EqualsOrdinal(::System::ReadOnlySpan_1<char16_t> span, ::System::ReadOnlySpan_1<char16_t> value);

  /// @brief Method EqualsOrdinalIgnoreCase, addr 0x5b0e6ec, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToUpperInvariant, addr 0x5b0e850, size 0x198, virtual false, abstract: false, final false
  static inline int32_t ToUpperInvariant(::System::ReadOnlySpan_1<char16_t> source, ::System::Span_1<char16_t> destination);

  /// @brief Method Trim, addr 0x5b05494, size 0x10, virtual false, abstract: false, final false
  static inline ::System::ReadOnlySpan_1<char16_t> Trim(::System::ReadOnlySpan_1<char16_t> span);

  /// @brief Method TrimEnd, addr 0x5b0ef54, size 0x104, virtual false, abstract: false, final false
  static inline ::System::ReadOnlySpan_1<char16_t> TrimEnd(::System::ReadOnlySpan_1<char16_t> span);

  /// @brief Method TrimStart, addr 0x5b0ee64, size 0xf0, virtual false, abstract: false, final false
