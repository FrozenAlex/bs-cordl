...
public:
  ...
  /// @brief Method .ctor, addr 0x5b0f0e4, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5b0f168, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW className, ::StringW methodName);

  /// @brief Method .ctor, addr 0x5b0f194, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x5b0f144, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method get_Message, addr 0x5b0f19c, size 0xf0, virtual true, abstract: false, final false
