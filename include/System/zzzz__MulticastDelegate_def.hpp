...
public:
  ...
  /// @brief Method CombineImpl, addr 0x5b5b1a4, size 0x264, virtual true, abstract: false, final true
  inline ::System::Delegate* CombineImpl(::System::Delegate* follow);

  /// @brief Method DynamicInvokeImpl, addr 0x5b5aed0, size 0x98, virtual true, abstract: false, final true
  inline ::System::Object* DynamicInvokeImpl(::ArrayW<::System::Object*> args);

  /// @brief Method Equals, addr 0x5b5af68, size 0x120, virtual true, abstract: false, final true
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x5b5b088, size 0x4, virtual true, abstract: false, final true
  inline int32_t GetHashCode();

  /// @brief Method GetInvocationList, addr 0x5b5b0d4, size 0xd0, virtual true, abstract: false, final true
  inline ::ArrayW<::System::Delegate*> GetInvocationList();

  /// @brief Method GetMethodImpl, addr 0x5b5b08c, size 0x48, virtual true, abstract: false, final false
  inline ::System::Reflection::MethodInfo* GetMethodImpl();

  /// @brief Method GetObjectData, addr 0x5b5aecc, size 0x4, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method LastIndexOf, addr 0x5b5b408, size 0x130, virtual false, abstract: false, final false
  inline int32_t LastIndexOf(::ArrayW<::System::Delegate*> haystack, ::ArrayW<::System::Delegate*> needle);

  /// @brief Method RemoveImpl, addr 0x5b5b538, size 0x2f4, virtual true, abstract: false, final true
