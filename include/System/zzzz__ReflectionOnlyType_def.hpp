...
public:
  ...
  /// @brief Method .ctor, addr 0x5b4df70, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TypeHandle, addr 0x5b4dfc4, size 0x50, virtual true, abstract: false, final false
