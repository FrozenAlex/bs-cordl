...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x6239880, size 0x2cc, virtual false, abstract: false, final false
  static inline bool IsValid(char16_t* name, uint16_t start, ::by_ref<int32_t> returnedEnd, bool notImplicitFile);

  /// @brief Method ParseCanonicalName, addr 0x623987c, size 0x4, virtual false, abstract: false, final false
