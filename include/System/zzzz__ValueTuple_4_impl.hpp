...
template <typename T1, typename T2, typename T3, typename T4> inline void System::ValueTuple_4<T1, T2, T3, T4>::_ctor(T1 item1, T2 item2, T3 item3, T4 item4) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::ValueTuple_4<T1, T2, T3, T4>>(),
...
template <typename T1, typename T2, typename T3, typename T4> inline bool System::ValueTuple_4<T1, T2, T3, T4>::Equals(::System::Object* obj) {
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::ValueTuple_4<T1, T2, T3, T4>>(), 0 })));
...
template <typename T1, typename T2, typename T3, typename T4> inline bool System::ValueTuple_4<T1, T2, T3, T4>::Equals(::System::ValueTuple_4<T1, T2, T3, T4> other) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::ValueTuple_4<T1, T2, T3, T4>>(), { "Equals", {}, { ::i2c::type_of<::System::ValueTuple_4<T1, T2, T3, T4>>() } })));
...
inline bool System::ValueTuple_4<T1, T2, T3, T4>::System_Collections_IStructuralEquatable_Equals(::System::Object* other, ::System::Collections::IEqualityComparer* comparer) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{},
      (::i2c::find_method(::i2c::class_of<::System::ValueTuple_4<T1, T2, T3, T4>>(),
...
template <typename T1, typename T2, typename T3, typename T4> inline int32_t System::ValueTuple_4<T1, T2, T3, T4>::System_IComparable_CompareTo(::System::Object* other) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::ValueTuple_4<T1, T2, T3, T4>>(), { "System.IComparable.CompareTo", {}, { ::i2c::type_of<::System::Object*>() } })));
...
template <typename T1, typename T2, typename T3, typename T4> inline int32_t System::ValueTuple_4<T1, T2, T3, T4>::CompareTo(::System::ValueTuple_4<T1, T2, T3, T4> other) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::ValueTuple_4<T1, T2, T3, T4>>(), { "CompareTo", {}, { ::i2c::type_of<::System::ValueTuple_4<T1, T2, T3, T4>>() } })));
  return ::cordl_internals::RunMethodRethrow<int32_t>(*this, ___internal_method, other);
}
template <typename T1, typename T2, typename T3, typename T4>
...
template <typename T1, typename T2, typename T3, typename T4> inline int32_t System::ValueTuple_4<T1, T2, T3, T4>::GetHashCode() {
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::ValueTuple_4<T1, T2, T3, T4>>(), 2 })));
...
inline int32_t System::ValueTuple_4<T1, T2, T3, T4>::System_Collections_IStructuralEquatable_GetHashCode(::System::Collections::IEqualityComparer* comparer) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::ValueTuple_4<T1, T2, T3, T4>>(),
...
template <typename T1, typename T2, typename T3, typename T4> inline int32_t System::ValueTuple_4<T1, T2, T3, T4>::GetHashCodeCore(::System::Collections::IEqualityComparer* comparer) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::ValueTuple_4<T1, T2, T3, T4>>(), { "GetHashCodeCore", {}, { ::i2c::type_of<::System::Collections::IEqualityComparer*>() } })));
  return ::cordl_internals::RunMethodRethrow<int32_t>(*this, ___internal_method, comparer);
}
template <typename T1, typename T2, typename T3, typename T4>
...
template <typename T1, typename T2, typename T3, typename T4> inline ::StringW System::ValueTuple_4<T1, T2, T3, T4>::ToString() {
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::ValueTuple_4<T1, T2, T3, T4>>(), 3 })));
...
template <typename T1, typename T2, typename T3, typename T4> inline ::StringW System::ValueTuple_4<T1, T2, T3, T4>::System_IValueTupleInternal_ToStringEnd() {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::ValueTuple_4<T1, T2, T3, T4>>(), { "System.IValueTupleInternal.ToStringEnd", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<::StringW>(*this, ___internal_method);
}
template <typename T1, typename T2, typename T3, typename T4> inline int32_t System::ValueTuple_4<T1, T2, T3, T4>::System_Runtime_CompilerServices_ITuple_get_Length() {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::ValueTuple_4<T1, T2, T3, T4>>(), { "System.Runtime.CompilerServices.ITuple.get_Length", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<int32_t>(*this, ___internal_method);
}
...
template <typename T1, typename T2, typename T3, typename T4> constexpr ::System::IComparable* System::ValueTuple_4<T1, T2, T3, T4>::i___System__IComparable() {
  return static_cast<::System::IComparable*>(static_cast<void*>(::i2c::to_object<true>(*this, false)));
}
...
template <typename T1, typename T2, typename T3, typename T4> constexpr ::System::IValueTupleInternal* System::ValueTuple_4<T1, T2, T3, T4>::i___System__IValueTupleInternal() {
  return static_cast<::System::IValueTupleInternal*>(static_cast<void*>(::i2c::to_object<true>(*this, false)));
}
