...
template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6> inline bool System::ValueTuple_6<T1, T2, T3, T4, T5, T6>::Equals(::System::Object* obj) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>(), 0 })));
...
inline bool System::ValueTuple_6<T1, T2, T3, T4, T5, T6>::Equals(::System::ValueTuple_6<T1, T2, T3, T4, T5, T6> other) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{},
                   (::i2c::find_method(::i2c::class_of<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>(), { "Equals", {}, { ::i2c::type_of<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>() } })));
...
inline bool System::ValueTuple_6<T1, T2, T3, T4, T5, T6>::System_Collections_IStructuralEquatable_Equals(::System::Object* other, ::System::Collections::IEqualityComparer* comparer) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{},
      (::i2c::find_method(::i2c::class_of<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>(),
...
inline int32_t System::ValueTuple_6<T1, T2, T3, T4, T5, T6>::System_IComparable_CompareTo(::System::Object* other) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>(), { "System.IComparable.CompareTo", {}, { ::i2c::type_of<::System::Object*>() } })));
...
inline int32_t System::ValueTuple_6<T1, T2, T3, T4, T5, T6>::CompareTo(::System::ValueTuple_6<T1, T2, T3, T4, T5, T6> other) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{},
                   (::i2c::find_method(::i2c::class_of<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>(), { "CompareTo", {}, { ::i2c::type_of<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>() } })));
  return ::cordl_internals::RunMethodRethrow<int32_t>(*this, ___internal_method, other);
}
template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
...
template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6> inline int32_t System::ValueTuple_6<T1, T2, T3, T4, T5, T6>::GetHashCode() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>(), 2 })));
...
inline int32_t System::ValueTuple_6<T1, T2, T3, T4, T5, T6>::System_Collections_IStructuralEquatable_GetHashCode(::System::Collections::IEqualityComparer* comparer) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>(),
...
inline int32_t System::ValueTuple_6<T1, T2, T3, T4, T5, T6>::GetHashCodeCore(::System::Collections::IEqualityComparer* comparer) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{},
                   (::i2c::find_method(::i2c::class_of<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>(), { "GetHashCodeCore", {}, { ::i2c::type_of<::System::Collections::IEqualityComparer*>() } })));
  return ::cordl_internals::RunMethodRethrow<int32_t>(*this, ___internal_method, comparer);
}
template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
...
template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6> inline ::StringW System::ValueTuple_6<T1, T2, T3, T4, T5, T6>::ToString() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>(), 3 })));
  return ::cordl_internals::RunMethodRethrow<::StringW>(*this, ___internal_method);
}
template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6> inline ::StringW System::ValueTuple_6<T1, T2, T3, T4, T5, T6>::System_IValueTupleInternal_ToStringEnd() {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>(), { "System.IValueTupleInternal.ToStringEnd", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<::StringW>(*this, ___internal_method);
}
template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
inline int32_t System::ValueTuple_6<T1, T2, T3, T4, T5, T6>::System_Runtime_CompilerServices_ITuple_get_Length() {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>(), { "System.Runtime.CompilerServices.ITuple.get_Length", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<int32_t>(*this, ___internal_method);
}
...
template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6> constexpr System::ValueTuple_6<T1, T2, T3, T4, T5, T6>::operator ::System::IComparable*() {
  return static_cast<::System::IComparable*>(static_cast<void*>(::i2c::to_object<true>(*this, false)));
}
/// @brief Convert to "::System::IComparable"
template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6> constexpr ::System::IComparable* System::ValueTuple_6<T1, T2, T3, T4, T5, T6>::i___System__IComparable() {
  return static_cast<::System::IComparable*>(static_cast<void*>(::i2c::to_object<true>(*this, false)));
}
...
template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
constexpr ::System::IComparable_1<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>*
System::ValueTuple_6<T1, T2, T3, T4, T5, T6>::i___System__IComparable_1___System__ValueTuple_6_T1_T2_T3_T4_T5_T6__() {
  return static_cast<::System::IComparable_1<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>*>(static_cast<void*>(::i2c::to_object<true>(*this, false)));
}
/// @brief Convert operator to "::System::IValueTupleInternal"
template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6> constexpr System::ValueTuple_6<T1, T2, T3, T4, T5, T6>::operator ::System::IValueTupleInternal*() {
...
// Some("{}") }, CppParam { name: "Item6", ty: "T6", modifiers: "", def_value: Some("{}") }]
template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
...
// Ctor Parameters []
template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6> constexpr ::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>::ValueTuple_6() {}
