...
public:
  // Declarations
  /// @brief Method AddMaterialReference, addr 0x67f442c, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method AddMaterialReference, addr 0x67f4644, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method Contains, addr 0x67f432c, size 0x100, virtual false, abstract: false, final false
  static inline bool Contains(::ArrayW<::TMPro::MaterialReference> materialReferences, ::TMPro::TMP_FontAsset* fontAsset);

  /// @brief Method .ctor, addr 0x67f42b0, size 0x7c, virtual false, abstract: false, final false
