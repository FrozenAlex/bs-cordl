...
public:
  ...
  /// @brief Method ComputePaddingForProperties, addr 0x69972f0, size 0x2f4, virtual false, abstract: false, final false
  static inline float_t ComputePaddingForProperties(::UnityEngine::Material* mat);

  /// @brief Method GetFontExtent, addr 0x6996968, size 0x50, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 GetFontExtent(::UnityEngine::Material* material);

  /// @brief Method GetPadding, addr 0x6996b54, size 0x79c, virtual false, abstract: false, final false
  static inline float_t GetPadding(::UnityEngine::Material* material, bool enableExtraPadding, bool isBold);

  /// @brief Method GetPadding, addr 0x69975e4, size 0x838, virtual false, abstract: false, final false
  static inline float_t GetPadding(::ArrayW<::UnityEngine::Material*> materials, bool enableExtraPadding, bool isBold);

  /// @brief Method GetShaderPropertyIDs, addr 0x698d650, size 0xdc4, virtual false, abstract: false, final false
  static inline void GetShaderPropertyIDs();

  /// @brief Method IsMaskingEnabled, addr 0x69969b8, size 0x19c, virtual false, abstract: false, final false
  static inline bool IsMaskingEnabled(::UnityEngine::Material* material);

  /// @brief Method UpdateShaderRatios, addr 0x699653c, size 0x42c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ShaderRef_MobileBitmap, addr 0x69962b4, size 0x108, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Shader> get_ShaderRef_MobileBitmap();

  /// @brief Method get_ShaderRef_MobileSDF, addr 0x69961ac, size 0x108, virtual false, abstract: false, final false
