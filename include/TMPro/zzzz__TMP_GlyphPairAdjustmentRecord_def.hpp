...
public:
  ...
  /// @brief Method .ctor, addr 0x681acd0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x681acf4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord glyphPairAdjustmentRecord);

  /// @brief Method get_featureLookupFlags, addr 0x681acc0, size 0x8, virtual false, abstract: false, final false
  inline ::TMPro::FontFeatureLookupFlags get_featureLookupFlags();

  /// @brief Method get_firstAdjustmentRecord, addr 0x681ac70, size 0x14, virtual false, abstract: false, final false
  inline ::TMPro::TMP_GlyphAdjustmentRecord get_firstAdjustmentRecord();

  /// @brief Method get_secondAdjustmentRecord, addr 0x681ac98, size 0x14, virtual false, abstract: false, final false
  inline ::TMPro::TMP_GlyphAdjustmentRecord get_secondAdjustmentRecord();

  /// @brief Method set_featureLookupFlags, addr 0x681acc8, size 0x8, virtual false, abstract: false, final false
  inline void set_featureLookupFlags(::TMPro::FontFeatureLookupFlags value);

  /// @brief Method set_firstAdjustmentRecord, addr 0x681ac84, size 0x14, virtual false, abstract: false, final false
  inline void set_firstAdjustmentRecord(::TMPro::TMP_GlyphAdjustmentRecord value);

  /// @brief Method set_secondAdjustmentRecord, addr 0x681acac, size 0x14, virtual false, abstract: false, final false
