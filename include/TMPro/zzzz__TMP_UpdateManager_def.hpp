...
public:
  ...
  /// @brief Method DoRebuilds, addr 0x69a32d4, size 0x268, virtual false, abstract: false, final false
  inline void DoRebuilds();

  /// @brief Method InternalRegisterTextElementForCullingUpdate, addr 0x69a319c, size 0x134, virtual false, abstract: false, final false
  inline void InternalRegisterTextElementForCullingUpdate(::TMPro::TMP_Text* element);

  /// @brief Method InternalRegisterTextElementForGraphicRebuild, addr 0x69a3004, size 0x134, virtual false, abstract: false, final false
  inline void InternalRegisterTextElementForGraphicRebuild(::TMPro::TMP_Text* element);

  /// @brief Method InternalRegisterTextElementForLayoutRebuild, addr 0x69a2e6c, size 0x134, virtual false, abstract: false, final false
  inline void InternalRegisterTextElementForLayoutRebuild(::TMPro::TMP_Text* element);

  /// @brief Method InternalRegisterTextObjectForUpdate, addr 0x69a2cd4, size 0x134, virtual false, abstract: false, final false
  inline void InternalRegisterTextObjectForUpdate(::TMPro::TMP_Text* textObject);

  /// @brief Method InternalUnRegisterTextElementForGraphicRebuild, addr 0x69a36cc, size 0xa8, virtual false, abstract: false, final false
  inline void InternalUnRegisterTextElementForGraphicRebuild(::TMPro::TMP_Text* element);

  /// @brief Method InternalUnRegisterTextElementForLayoutRebuild, addr 0x69a3774, size 0xa8, virtual false, abstract: false, final false
  inline void InternalUnRegisterTextElementForLayoutRebuild(::TMPro::TMP_Text* element);

  /// @brief Method InternalUnRegisterTextObjectForUpdate, addr 0x69a35a0, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnCameraPreCull, addr 0x69a32d0, size 0x4, virtual false, abstract: false, final false
  inline void OnCameraPreCull();

  /// @brief Method RegisterTextElementForCullingUpdate, addr 0x69a3138, size 0x64, virtual false, abstract: false, final false
  static inline void RegisterTextElementForCullingUpdate(::TMPro::TMP_Text* element);

  /// @brief Method RegisterTextElementForGraphicRebuild, addr 0x69a2fa0, size 0x64, virtual false, abstract: false, final false
  static inline void RegisterTextElementForGraphicRebuild(::TMPro::TMP_Text* element);

  /// @brief Method RegisterTextElementForLayoutRebuild, addr 0x69a2e08, size 0x64, virtual false, abstract: false, final false
  static inline void RegisterTextElementForLayoutRebuild(::TMPro::TMP_Text* element);

  /// @brief Method RegisterTextObjectForUpdate, addr 0x69a2c70, size 0x64, virtual false, abstract: false, final false
  static inline void RegisterTextObjectForUpdate(::TMPro::TMP_Text* textObject);

  /// @brief Method UnRegisterTextElementForRebuild, addr 0x69a3648, size 0x84, virtual false, abstract: false, final false
  static inline void UnRegisterTextElementForRebuild(::TMPro::TMP_Text* element);

  /// @brief Method UnRegisterTextObjectForUpdate, addr 0x69a353c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69a2ac0, size 0x1b0, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_instance, addr 0x69a2a1c, size 0xa4, virtual false, abstract: false, final false
