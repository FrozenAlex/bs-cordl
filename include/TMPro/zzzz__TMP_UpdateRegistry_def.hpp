...
public:
  ...
  /// @brief Method InternalRegisterCanvasElementForGraphicRebuild, addr 0x69a3d1c, size 0x17c, virtual false, abstract: false, final false
  inline bool InternalRegisterCanvasElementForGraphicRebuild(::UnityEngine::UI::ICanvasElement* element);

  /// @brief Method InternalRegisterCanvasElementForLayoutRebuild, addr 0x69a3b80, size 0x17c, virtual false, abstract: false, final false
  inline bool InternalRegisterCanvasElementForLayoutRebuild(::UnityEngine::UI::ICanvasElement* element);

  /// @brief Method InternalUnRegisterCanvasElementForGraphicRebuild, addr 0x69a429c, size 0xf0, virtual false, abstract: false, final false
  inline void InternalUnRegisterCanvasElementForGraphicRebuild(::UnityEngine::UI::ICanvasElement* element);

  /// @brief Method InternalUnRegisterCanvasElementForLayoutRebuild, addr 0x69a41ac, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method PerformUpdateForCanvasRendererObjects, addr 0x69a3e98, size 0x274, virtual false, abstract: false, final false
  inline void PerformUpdateForCanvasRendererObjects();

  /// @brief Method PerformUpdateForMeshRendererObjects, addr 0x69a410c, size 0x70, virtual false, abstract: false, final false
  inline void PerformUpdateForMeshRendererObjects();

  /// @brief Method RegisterCanvasElementForGraphicRebuild, addr 0x69a3cfc, size 0x20, virtual false, abstract: false, final false
  static inline void RegisterCanvasElementForGraphicRebuild(::UnityEngine::UI::ICanvasElement* element);

  /// @brief Method RegisterCanvasElementForLayoutRebuild, addr 0x69a3b60, size 0x20, virtual false, abstract: false, final false
  static inline void RegisterCanvasElementForLayoutRebuild(::UnityEngine::UI::ICanvasElement* element);

  /// @brief Method UnRegisterCanvasElementForRebuild, addr 0x69a417c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69a3a10, size 0x150, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::TMPro::TMP_UpdateRegistry* getStaticF_s_Instance();

  /// @brief Method get_instance, addr 0x69a3998, size 0x78, virtual false, abstract: false, final false
