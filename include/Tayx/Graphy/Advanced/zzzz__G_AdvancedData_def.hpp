...
public:
  ...
  /// @brief Method Init, addr 0x62fa824, size 0xd6c, virtual false, abstract: false, final false
  inline void Init();

  static inline ::Tayx::Graphy::Advanced::G_AdvancedData* New_ctor();

  /// @brief Method OnEnable, addr 0x6300794, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RefreshParameters, addr 0x62fc04c, size 0x148, virtual false, abstract: false, final false
  inline void RefreshParameters();

  /// @brief Method RestorePreviousState, addr 0x62f97d0, size 0xc, virtual false, abstract: false, final false
  inline void RestorePreviousState();

  /// @brief Method SetPosition, addr 0x62f80b0, size 0x814, virtual true, abstract: false, final true
  inline void SetPosition(::Tayx::Graphy::GraphyManager_ModulePosition newModulePosition);

  /// @brief Method SetState, addr 0x62f8014, size 0x78, virtual true, abstract: false, final true
  inline void SetState(::Tayx::Graphy::GraphyManager_ModuleState state, bool silentUpdate);

  /// @brief Method Update, addr 0x6300798, size 0x2e4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateParameters, addr 0x62fbab0, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6300a7c, size 0x1a8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Tayx::Graphy::Advanced::G_AdvancedData) == 0xa0, "Size mismatch!");
