...
public:
  ...
  /// @brief Method Awake, addr 0x62fff74, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Init, addr 0x62fa360, size 0x4c4, virtual false, abstract: false, final false
  inline void Init();

  static inline ::Tayx::Graphy::Audio::G_AudioManager* New_ctor();

  /// @brief Method RefreshParameters, addr 0x62fbee8, size 0x164, virtual false, abstract: false, final false
  inline void RefreshParameters();

  /// @brief Method RestorePreviousState, addr 0x62f97c4, size 0xc, virtual false, abstract: false, final false
  inline void RestorePreviousState();

  /// @brief Method SetGraphActive, addr 0x62fff7c, size 0x44, virtual false, abstract: false, final false
  inline void SetGraphActive(bool active);

  /// @brief Method SetPosition, addr 0x62f6fb8, size 0x32c, virtual true, abstract: false, final true
  inline void SetPosition(::Tayx::Graphy::GraphyManager_ModulePosition newModulePosition);

  /// @brief Method SetState, addr 0x62f7bf8, size 0x154, virtual true, abstract: false, final true
  inline void SetState(::Tayx::Graphy::GraphyManager_ModuleState state, bool silentUpdate);

  /// @brief Method Start, addr 0x62fff78, size 0x4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UpdateParameters, addr 0x62f7d70, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63001d4, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();
