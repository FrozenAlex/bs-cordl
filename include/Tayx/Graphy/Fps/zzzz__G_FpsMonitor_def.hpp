...
public:
  ...
  /// @brief Method <Update>b__25_0, addr 0x6438e74, size 0xc, virtual false, abstract: false, final false
  inline int32_t _Update_b__25_0(int16_t x, int16_t y);

  /// @brief Method .ctor, addr 0x6438e70, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x6438a4c, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Init, addr 0x6433614, size 0xb4, virtual false, abstract: false, final false
  inline void Init();

  static inline ::Tayx::Graphy::Fps::G_FpsMonitor* New_ctor();

  /// @brief Method Update, addr 0x6438a50, size 0x3b4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateParameters, addr 0x643877c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6438e04, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AverageFPS, addr 0x6438a1c, size 0x8, virtual false, abstract: false, final false
  inline int16_t get_AverageFPS();

  /// @brief Method get_CurrentFPS, addr 0x6438a0c, size 0x8, virtual false, abstract: false, final false
  inline int16_t get_CurrentFPS();

  /// @brief Method get_OnePercentFPS, addr 0x6438a2c, size 0x8, virtual false, abstract: false, final false
  inline int16_t get_OnePercentFPS();

  /// @brief Method get_Zero1PercentFps, addr 0x6438a3c, size 0x8, virtual false, abstract: false, final false
  inline int16_t get_Zero1PercentFps();

  /// @brief Method set_AverageFPS, addr 0x6438a24, size 0x8, virtual false, abstract: false, final false
  inline void set_AverageFPS(int16_t value);

  /// @brief Method set_CurrentFPS, addr 0x6438a14, size 0x8, virtual false, abstract: false, final false
  inline void set_CurrentFPS(int16_t value);

  /// @brief Method set_OnePercentFPS, addr 0x6438a34, size 0x8, virtual false, abstract: false, final false
  inline void set_OnePercentFPS(int16_t value);

  /// @brief Method set_Zero1PercentFps, addr 0x6438a44, size 0x8, virtual false, abstract: false, final false
