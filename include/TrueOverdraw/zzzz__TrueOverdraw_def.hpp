...
public:
  ...
  /// @brief Method Disable, addr 0x5f3a534, size 0x22c, virtual false, abstract: false, final false
  inline void Disable();

  /// @brief Method Dispose, addr 0x5f3a760, size 0xe4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Enable, addr 0x5f39e30, size 0x2e4, virtual false, abstract: false, final false
  inline void Enable();

  static inline ::TrueOverdraw::TrueOverdraw* New_ctor(::ArrayW<::UnityEngine::Renderer*> renderers);

  /// @brief Method ResolveRendererColor, addr 0x5f3a1c0, size 0x260, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color ResolveRendererColor(::UnityEngine::Renderer* renderer, ::UnityEngine::Material* material);

  /// @brief Method SetGlobalFloats, addr 0x5f3a114, size 0xac, virtual false, abstract: false, final false
  static inline void SetGlobalFloats(float_t trueOverdraw, float_t opaque, float_t transparent);

  /// @brief Method SetMaterialValues, addr 0x5f3a420, size 0x114, virtual false, abstract: false, final false
  static inline void SetMaterialValues(::UnityEngine::Material* material, ::UnityEngine::Color color);

  /// @brief Method SetOverdrawValues, addr 0x5f3a8a8, size 0xc8, virtual false, abstract: false, final false
  static inline void SetOverdrawValues(float_t opaque, float_t transparent);

  /// @brief Method ShowEverything, addr 0x5f3a844, size 0x64, virtual false, abstract: false, final false
  inline void ShowEverything();

  /// @brief Method ShowOnlyOpaque, addr 0x5f3a9d4, size 0x64, virtual false, abstract: false, final false
  inline void ShowOnlyOpaque();

  /// @brief Method ShowOnlyTransparent, addr 0x5f3a970, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f39a78, size 0x3b8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_overdrawType, addr 0x5f39a68, size 0x8, virtual false, abstract: false, final false
  inline ::TrueOverdraw::TrueOverdraw_OverdrawType get_overdrawType();

  /// @brief Method get_renderersLength, addr 0x5f39a50, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method set_overdrawType, addr 0x5f39a70, size 0x8, virtual false, abstract: false, final false
