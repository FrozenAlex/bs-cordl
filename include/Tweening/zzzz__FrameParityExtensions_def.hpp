...
// Write type traits
MARK_REF_T(::Tweening::FrameParityExtensions*);
DEFINE_IL2CPP_CLASS(::Tweening::FrameParityExtensions*, "Tweening", "FrameParityExtensions");
...
static_assert(sizeof(::Tweening::FrameParityExtensions) == 0x10, "Size mismatch!");
