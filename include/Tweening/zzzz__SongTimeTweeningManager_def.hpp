...
// Write type traits
MARK_REF_T(::Tweening::SongTimeTweeningManager*);
DEFINE_IL2CPP_CLASS(::Tweening::SongTimeTweeningManager*, "Tweening", "SongTimeTweeningManager");
...
public:
  ...
  /// @brief Method GetTime, addr 0x59723b0, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5972454, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
