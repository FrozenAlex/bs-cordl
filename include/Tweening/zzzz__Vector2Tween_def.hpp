...
public:
  ...
  /// @brief Method GetValue, addr 0x6306434, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6306340, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6306398, size 0x9c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Tweening::Vector2Tween) == 0x60, "Size mismatch!");
