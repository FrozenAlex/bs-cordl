...
public:
  ...
  /// @brief Method ExpectAliased, addr 0x649fb7c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpectNotAliased, addr 0x649fb80, size 0x4, virtual false, abstract: false, final false
