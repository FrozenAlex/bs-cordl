...
public:
  ...
  /// @brief Method .ctor, addr 0x6352f64, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(double_t a, double_t b);

  /// @brief Method .ctor, addr 0x6352f50, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(float_t a, float_t b, float_t c, float_t d);

  /// @brief Method .ctor, addr 0x6352eb8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int16_t a, int16_t b, int16_t c, int16_t d, int16_t e, int16_t f, int16_t g, int16_t h);

  /// @brief Method .ctor, addr 0x6352f20, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t a, int32_t b, int32_t c, int32_t d);

  /// @brief Method .ctor, addr 0x6352f74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int64_t a, int64_t b);

  /// @brief Method .ctor, addr 0x6352e44, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6352eec, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(uint16_t a, uint16_t b, uint16_t c, uint16_t d, uint16_t e, uint16_t f, uint16_t g, uint16_t h);

  /// @brief Method .ctor, addr 0x6352f38, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(uint32_t a, uint32_t b, uint32_t c, uint32_t d);

  /// @brief Method .ctor, addr 0x6352f84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(uint64_t a, uint64_t b);

  /// @brief Method .ctor, addr 0x6352dc8, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6352e30, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int8_t b);

  /// @brief Method .ctor, addr 0x6352db4, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(uint8_t b);

  /// @brief Method .ctor, addr 0x6352f5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(double_t f);

  /// @brief Method .ctor, addr 0x6352f44, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(float_t f);

  /// @brief Method .ctor, addr 0x6352f6c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int64_t f);

  /// @brief Method .ctor, addr 0x6352f7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(uint64_t f);

  /// @brief Method .ctor, addr 0x6352f8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Burst::Intrinsics::v64 lo, ::Unity::Burst::Intrinsics::v64 hi);

  /// @brief Method .ctor, addr 0x6352eac, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int16_t v);

  /// @brief Method .ctor, addr 0x6352f14, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t v);

  /// @brief Method .ctor, addr 0x6352ee0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(uint16_t v);

  /// @brief Method .ctor, addr 0x6352f2c, size 0xc, virtual false, abstract: false, final false
  ...
  // "Byte15", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "SByte0", ty: "int8_t", modifiers: "", def_value: None }, CppParam { name: "SByte1", ty: "int8_t", modifiers: "",
  // def_value: None }, CppParam { name: "SByte2", ty: "int8_t", modifiers: "", def_value: None }, CppParam { name: "SByte3", ty: "int8_t", modifiers: "", def_value: None }, CppParam { name: "SByte4",
  // ty: "int8_t", modifiers: "", def_value: None }, CppParam { name: "SByte5", ty: "int8_t", modifiers: "", def_value: None }, CppParam { name: "SByte6", ty: "int8_t", modifiers: "", def_value: None
  // }, CppParam { name: "SByte7", ty: "int8_t", modifiers: "", def_value: None }, CppParam { name: "SByte8", ty: "int8_t", modifiers: "", def_value: None }, CppParam { name: "SByte9", ty: "int8_t",
  // modifiers: "", def_value: None }, CppParam { name: "SByte10", ty: "int8_t", modifiers: "", def_value: None }, CppParam { name: "SByte11", ty: "int8_t", modifiers: "", def_value: None }, CppParam
  // { name: "SByte12", ty: "int8_t", modifiers: "", def_value: None }, CppParam { name: "SByte13", ty: "int8_t", modifiers: "", def_value: None }, CppParam { name: "SByte14", ty: "int8_t", modifiers:
  // "", def_value: None }, CppParam { name: "SByte15", ty: "int8_t", modifiers: "", def_value: None }, CppParam { name: "UShort0", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name:
  // "UShort1", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "UShort2", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "UShort3", ty: "uint16_t", modifiers:
  // "", def_value: None }, CppParam { name: "UShort4", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "UShort5", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name:
  // "UShort6", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "UShort7", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "SShort0", ty: "int16_t", modifiers:
  // "", def_value: None }, CppParam { name: "SShort1", ty: "int16_t", modifiers: "", def_value: None }, CppParam { name: "SShort2", ty: "int16_t", modifiers: "", def_value: None }, CppParam { name:
  // "SShort3", ty: "int16_t", modifiers: "", def_value: None }, CppParam { name: "SShort4", ty: "int16_t", modifiers: "", def_value: None }, CppParam { name: "SShort5", ty: "int16_t", modifiers: "",
  // def_value: None }, CppParam { name: "SShort6", ty: "int16_t", modifiers: "", def_value: None }, CppParam { name: "SShort7", ty: "int16_t", modifiers: "", def_value: None }, CppParam { name:
  // "UInt0", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "UInt1", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "UInt2", ty: "uint32_t", modifiers: "",
  // def_value: None }, CppParam { name: "UInt3", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "SInt0", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "SInt1",
  // ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "SInt2", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "SInt3", ty: "int32_t", modifiers: "", def_value: None
  // }, CppParam { name: "ULong0", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "ULong1", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "SLong0", ty:
  // "int64_t", modifiers: "", def_value: None }, CppParam { name: "SLong1", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "Float0", ty: "float_t", modifiers: "", def_value: None
  // }, CppParam { name: "Float1", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "Float2", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "Float3", ty:
  // "float_t", modifiers: "", def_value: None }, CppParam { name: "Double0", ty: "double_t", modifiers: "", def_value: None }, CppParam { name: "Double1", ty: "double_t", modifiers: "", def_value:
  // None }, CppParam { name: "Lo64", ty: "::Unity::Burst::Intrinsics::v64", modifiers: "", def_value: None }, CppParam { name: "Hi64", ty: "::Unity::Burst::Intrinsics::v64", modifiers: "", def_value:
  // None }]
  constexpr v128(uint8_t Byte0, uint8_t Byte1, uint8_t Byte2, uint8_t Byte3, uint8_t Byte4, uint8_t Byte5, uint8_t Byte6, uint8_t Byte7, uint8_t Byte8, uint8_t Byte9, uint8_t Byte10, uint8_t Byte11,
                 uint8_t Byte12, uint8_t Byte13, uint8_t Byte14, uint8_t Byte15, int8_t SByte0, int8_t SByte1, int8_t SByte2, int8_t SByte3, int8_t SByte4, int8_t SByte5, int8_t SByte6, int8_t SByte7,
                 int8_t SByte8, int8_t SByte9, int8_t SByte10, int8_t SByte11, int8_t SByte12, int8_t SByte13, int8_t SByte14, int8_t SByte15, uint16_t UShort0, uint16_t UShort1, uint16_t UShort2,
                 uint16_t UShort3, uint16_t UShort4, uint16_t UShort5, uint16_t UShort6, uint16_t UShort7, int16_t SShort0, int16_t SShort1, int16_t SShort2, int16_t SShort3, int16_t SShort4,
                 int16_t SShort5, int16_t SShort6, int16_t SShort7, uint32_t UInt0, uint32_t UInt1, uint32_t UInt2, uint32_t UInt3, int32_t SInt0, int32_t SInt1, int32_t SInt2, int32_t SInt3,
                 uint64_t ULong0, uint64_t ULong1, int64_t SLong0, int64_t SLong1, float_t Float0, float_t Float1, float_t Float2, float_t Float3, double_t Double0, double_t Double1,
                 ::Unity::Burst::Intrinsics::v64 Lo64, ::Unity::Burst::Intrinsics::v64 Hi64) noexcept;
