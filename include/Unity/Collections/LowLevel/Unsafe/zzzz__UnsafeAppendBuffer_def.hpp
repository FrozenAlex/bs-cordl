...
public:
  ...
  /// @brief Method CheckBounds, addr 0x638b6f0, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadNext, addr 0x638b6d4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x638b6b8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(void* ptr, int32_t length);

  /// @brief Method get_EndOfBuffer, addr 0x638b6c4, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x638b510, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method AsReader, addr 0x638b608, size 0x10, virtual false, abstract: false, final false
  inline ::Unity::Collections::LowLevel::Unsafe::UnsafeAppendBuffer_Reader AsReader();

  /// @brief Method CheckAlignment, addr 0x638b62c, size 0x8c, virtual false, abstract: false, final false
  static inline void CheckAlignment(int32_t alignment);

  /// @brief Method Dispose, addr 0x638b418, size 0xcc, virtual true, abstract: false, final true
  inline ::Unity::Jobs::JobHandle Dispose(::Unity::Jobs::JobHandle inputDeps);

  /// @brief Method Dispose, addr 0x638b37c, size 0x9c, virtual true, abstract: false, final true
  inline void Dispose();
  ...
  /// @brief Method Pop, addr 0x638b590, size 0x78, virtual false, abstract: false, final false
  inline void Pop(void* ptr, int32_t structSize);

  /// @brief Method Reset, addr 0x638b4e4, size 0x8, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method ResizeUninitialized, addr 0x638b4ec, size 0x24, virtual false, abstract: false, final false
  inline void ResizeUninitialized(int32_t length);

  /// @brief Method SetCapacity, addr 0x638b1e0, size 0xfc, virtual false, abstract: false, final false
  inline void SetCapacity(int32_t capacity);

  /// @brief Method .ctor, addr 0x638b1cc, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t initialCapacity, int32_t alignment, ::Unity::Collections::AllocatorManager_AllocatorHandle allocator);

  /// @brief Method .ctor, addr 0x638b2dc, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(void* ptr, int32_t length);

  /// @brief Method get_IsCreated, addr 0x638b36c, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsCreated();

  /// @brief Method get_IsEmpty, addr 0x638b35c, size 0x10, virtual false, abstract: false, final false
