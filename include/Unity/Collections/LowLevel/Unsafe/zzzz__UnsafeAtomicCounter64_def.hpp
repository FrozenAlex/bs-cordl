...
public:
  // Declarations
  /// @brief Method Add, addr 0x64c6358, size 0x5c, virtual false, abstract: false, final false
  inline int64_t Add(int64_t value);

  /// @brief Method AddSat, addr 0x64c6410, size 0x90, virtual false, abstract: false, final false
  inline int64_t AddSat(int64_t value, int64_t max);

  /// @brief Method Reset, addr 0x64c634c, size 0xc, virtual false, abstract: false, final false
  inline void Reset(int64_t value);

  /// @brief Method Sub, addr 0x64c63b4, size 0x5c, virtual false, abstract: false, final false
  inline int64_t Sub(int64_t value);

  /// @brief Method SubSat, addr 0x64c64a0, size 0x90, virtual false, abstract: false, final false
  inline int64_t SubSat(int64_t value, int64_t min);

  /// @brief Method .ctor, addr 0x64c6344, size 0x8, virtual false, abstract: false, final false
