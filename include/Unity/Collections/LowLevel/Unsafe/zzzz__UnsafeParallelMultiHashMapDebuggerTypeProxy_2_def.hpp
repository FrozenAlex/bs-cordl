...
public:
  ...
  GetUniqueKeyArray(::by_ref<::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMap_2<TKey, TValue>> hashMap, ::Unity::Collections::AllocatorManager_AllocatorHandle allocator);
