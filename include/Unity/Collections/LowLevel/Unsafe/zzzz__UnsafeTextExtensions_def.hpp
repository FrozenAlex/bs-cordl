...
public:
  // Declarations
  /// @brief Method AsUnsafeListOfBytes, addr 0x64c79e4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method AsUnsafeListOfBytesRO, addr 0x64c7a28, size 0x5c, virtual false, abstract: false, final false
