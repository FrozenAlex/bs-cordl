...
namespace Unity::Collections {
template <typename T> struct FixedList128Bytes_1_Enumerator;
}
namespace Unity::Collections {
...
public:
  ...
  // Ctor Parameters [CppParam { name: "m_List", ty: "::Unity::Collections::FixedList128Bytes_1<T>", modifiers: "", def_value: None }, CppParam { name: "m_Index", ty: "int32_t", modifiers: "",
  // def_value: None }]
