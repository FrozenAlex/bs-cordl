...
template <typename TKey, typename TValue> inline ::Unity::Collections::KVPair_2<TKey, TValue> Unity::Collections::KVPair_2<TKey, TValue>::get_Null() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Unity::Collections::KVPair_2<TKey, TValue>>(), { "get_Null", {}, {} })));
...
template <typename TKey, typename TValue> inline TKey Unity::Collections::KVPair_2<TKey, TValue>::get_Key() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Unity::Collections::KVPair_2<TKey, TValue>>(), { "get_Key", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<TKey>(*this, ___internal_method);
}
template <typename TKey, typename TValue> inline ::by_ref<TValue> Unity::Collections::KVPair_2<TKey, TValue>::get_Value() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Unity::Collections::KVPair_2<TKey, TValue>>(), { "get_Value", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<::by_ref<TValue>>(*this, ___internal_method);
}
template <typename TKey, typename TValue> inline bool Unity::Collections::KVPair_2<TKey, TValue>::GetKeyValue(::by_ref<TKey> key, ::by_ref<TValue> value) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Unity::Collections::KVPair_2<TKey, TValue>>(),
