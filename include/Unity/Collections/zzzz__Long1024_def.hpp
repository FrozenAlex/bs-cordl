...
public:
  ...
  /// @brief Method ElementAt, addr 0x64a13ac, size 0x50, virtual true, abstract: false, final true
  inline ::by_ref<int64_t> ElementAt(int32_t index);

  /// @brief Method get_Length, addr 0x64a4ae0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Length, addr 0x64a4ae8, size 0x4, virtual true, abstract: false, final true
