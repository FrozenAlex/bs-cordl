...
public:
  ...
  /// @brief Method AllocateBlock, addr 0x64bb88c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method AllocateForEach, addr 0x64bbde8, size 0x4, virtual false, abstract: false, final false
  inline void AllocateForEach(int32_t forEachCount);

  /// @brief Method AsReader, addr 0x64bbacc, size 0x24, virtual false, abstract: false, final false
  inline ::Unity::Collections::NativeStream_Reader AsReader();

  /// @brief Method AsWriter, addr 0x64bbb14, size 0x38, virtual false, abstract: false, final false
  inline ::Unity::Collections::NativeStream_Writer AsWriter();

  /// @brief Method CheckForEachCountGreaterThanZero, addr 0x64bbdec, size 0x70, virtual false, abstract: false, final false
  static inline void CheckForEachCountGreaterThanZero(int32_t forEachCount);

  /// @brief Method CheckRead, addr 0x64bbe5c, size 0x4, virtual false, abstract: false, final false
  inline void CheckRead();

  /// @brief Method Count, addr 0x64bbb8c, size 0x4, virtual false, abstract: false, final false
  inline int32_t Count();

  /// @brief Method Dispose, addr 0x64bbc04, size 0x98, virtual true, abstract: false, final true
  inline ::Unity::Jobs::JobHandle Dispose(::Unity::Jobs::JobHandle inputDeps);

  /// @brief Method Dispose, addr 0x64bbbe4, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method IsEmpty, addr 0x64bba2c, size 0x4, virtual false, abstract: false, final false
  inline bool IsEmpty();

  /// @brief Method ScheduleConstruct, addr 0x64bb988, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64bb860, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(int32_t bufferCount, ::Unity::Collections::AllocatorManager_AllocatorHandle allocator);

  /// @brief Method get_ForEachCount, addr 0x64bba9c, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_ForEachCount();

  /// @brief Method get_IsCreated, addr 0x64bba8c, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Execute, addr 0x64bbe60, size 0x18, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method Execute, addr 0x64bbe78, size 0xc, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method Allocate, addr 0x64bbf74, size 0x4, virtual false, abstract: false, final false
  inline uint8_t* Allocate(int32_t size);

  /// @brief Method BeginForEachIndex, addr 0x64bbee4, size 0x1c, virtual false, abstract: false, final false
  inline void BeginForEachIndex(int32_t foreachIndex);

  /// @brief Method CheckAllocateSize, addr 0x64bc00c, size 0x4, virtual false, abstract: false, final false
  inline void CheckAllocateSize(int32_t size);

  /// @brief Method CheckBeginForEachIndex, addr 0x64bc004, size 0x4, virtual false, abstract: false, final false
  inline void CheckBeginForEachIndex(int32_t foreachIndex);

  /// @brief Method CheckEndForEachIndex, addr 0x64bc008, size 0x4, virtual false, abstract: false, final false
  inline void CheckEndForEachIndex();

  /// @brief Method EndForEachIndex, addr 0x64bbf1c, size 0x4, virtual false, abstract: false, final false
  inline void EndForEachIndex();

  /// @brief Method PatchMinMaxRange, addr 0x64bbee0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64bbb4c, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::by_ref<::Unity::Collections::NativeStream> stream);

  /// @brief Method get_ForEachCount, addr 0x64bbeb0, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_ForEachCount();
...
public:
  ...
  /// @brief Method BeginForEachIndex, addr 0x64bc024, size 0x4, virtual false, abstract: false, final false
  inline int32_t BeginForEachIndex(int32_t foreachIndex);

  /// @brief Method CheckBeginForEachIndex, addr 0x64bc17c, size 0x4, virtual false, abstract: false, final false
  inline void CheckBeginForEachIndex(int32_t forEachIndex);

  /// @brief Method CheckEndForEachIndex, addr 0x64bc180, size 0x88, virtual false, abstract: false, final false
  inline void CheckEndForEachIndex();

  /// @brief Method CheckNotReadingOutOfBounds, addr 0x64bc170, size 0x4, virtual false, abstract: false, final false
  inline void CheckNotReadingOutOfBounds(int32_t size);

  /// @brief Method CheckRead, addr 0x64bc174, size 0x4, virtual false, abstract: false, final false
  inline void CheckRead();

  /// @brief Method CheckReadSize, addr 0x64bc178, size 0x4, virtual false, abstract: false, final false
  inline void CheckReadSize(int32_t size);

  /// @brief Method Count, addr 0x64bc118, size 0x4, virtual false, abstract: false, final false
  inline int32_t Count();

  /// @brief Method EndForEachIndex, addr 0x64bc07c, size 0x4, virtual false, abstract: false, final false
  inline void EndForEachIndex();
  ...
  /// @brief Method ReadUnsafePtr, addr 0x64bc0bc, size 0x5c, virtual false, abstract: false, final false
  inline uint8_t* ReadUnsafePtr(int32_t size);

  /// @brief Method .ctor, addr 0x64bbaf0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::by_ref<::Unity::Collections::NativeStream> stream);

  /// @brief Method get_ForEachCount, addr 0x64bc084, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_ForEachCount();

  /// @brief Method get_RemainingItemCount, addr 0x64bc0b4, size 0x8, virtual false, abstract: false, final false
