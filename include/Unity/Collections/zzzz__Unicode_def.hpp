...
public:
  // Declarations
  /// @brief Method Equals, addr 0x64c14b0, size 0x7c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x64c152c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsAscii, addr 0x64c1564, size 0x10, virtual false, abstract: false, final false
  inline bool IsAscii();

  /// @brief Method IsDigit, addr 0x64c1550, size 0x14, virtual false, abstract: false, final false
  inline bool IsDigit();

  /// @brief Method IsDigit, addr 0x64c1540, size 0x10, virtual false, abstract: false, final false
  static inline bool IsDigit(::Unity::Collections::Unicode_Rune r);

  /// @brief Method IsLatin1, addr 0x64c1574, size 0x10, virtual false, abstract: false, final false
  inline bool IsLatin1();

  /// @brief Method IsWhiteSpace, addr 0x64c1584, size 0x90, virtual false, abstract: false, final false
  inline bool IsWhiteSpace();

  /// @brief Method LengthInUtf8Bytes, addr 0x64c1648, size 0x44, virtual false, abstract: false, final false
  inline int32_t LengthInUtf8Bytes();

  /// @brief Method ToLowerAscii, addr 0x64c1614, size 0x18, virtual false, abstract: false, final false
  inline ::Unity::Collections::Unicode_Rune ToLowerAscii();

  /// @brief Method ToUpperAscii, addr 0x64c162c, size 0x1c, virtual false, abstract: false, final false
  inline ::Unity::Collections::Unicode_Rune ToUpperAscii();

  /// @brief Method .ctor, addr 0x64c1494, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t codepoint);

  /// @brief Method op_Equality, addr 0x64c14a4, size 0xc, virtual false, abstract: false, final false
  static inline bool op_Equality(::Unity::Collections::Unicode_Rune lhs, ::Unity::Collections::Unicode_Rune rhs);

  /// @brief Method op_Implicit, addr 0x64c149c, size 0x8, virtual false, abstract: false, final false
  static inline ::Unity::Collections::Unicode_Rune op_Implicit___Unity__Collections__Unicode_Rune(char16_t codepoint);

  /// @brief Method op_Inequality, addr 0x64c1534, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CountRunes, addr 0x64c1444, size 0x50, virtual false, abstract: false, final false
  static inline int32_t CountRunes(uint8_t* utf8Buffer, int32_t utf8Length, int32_t maxRunes);

  /// @brief Method FindUtf8CharStartInReverse, addr 0x64c0f68, size 0x38, virtual false, abstract: false, final false
  static inline int32_t FindUtf8CharStartInReverse(uint8_t* ptr, ::by_ref<int32_t> index);

  /// @brief Method IsLeadingSurrogate, addr 0x64c1008, size 0x10, virtual false, abstract: false, final false
  static inline bool IsLeadingSurrogate(char16_t c);

  /// @brief Method IsTrailingSurrogate, addr 0x64c1018, size 0x10, virtual false, abstract: false, final false
  static inline bool IsTrailingSurrogate(char16_t c);

  /// @brief Method IsValidCodePoint, addr 0x64c0f3c, size 0xc, virtual false, abstract: false, final false
  static inline bool IsValidCodePoint(int32_t codepoint);

  /// @brief Method NotTrailer, addr 0x64c0f48, size 0x10, virtual false, abstract: false, final false
  static inline bool NotTrailer(uint8_t b);

  /// @brief Method UcsToUcs, addr 0x64c10b0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method UcsToUtf16, addr 0x64c11f0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method UcsToUtf8, addr 0x64c10f0, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method Utf16ToUcs, addr 0x64c1028, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method Utf16ToUtf8, addr 0x64c126c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Utf8ToUcs, addr 0x64be32c, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method Utf8ToUcsReverse, addr 0x64c0fa0, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method Utf8ToUtf16, addr 0x64c13c0, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Utf8ToUtf8, addr 0x64c12f0, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BadRune, addr 0x64c0f60, size 0x8, virtual false, abstract: false, final false
  static inline ::Unity::Collections::Unicode_Rune get_BadRune();

  /// @brief Method get_ReplacementCharacter, addr 0x64c0f58, size 0x8, virtual false, abstract: false, final false
