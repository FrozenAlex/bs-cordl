...
// Write type traits
MARK_REF_T(::Unity::Collections::UnsafeQueueBlockPool*);
DEFINE_IL2CPP_CLASS(::Unity::Collections::UnsafeQueueBlockPool*, "Unity.Collections", "UnsafeQueueBlockPool");
...
static_assert(sizeof(::Unity::Collections::UnsafeQueueBlockPool) == 0x10, "Size mismatch!");
