...
MARK_REF_T(::Unity::Collections::xxHash3_Hash128Long_00000A7A$BurstDirectCall*);
MARK_REF_T(::Unity::Collections::xxHash3_Hash128Long_00000A7A$PostfixBurstDelegate*);
MARK_REF_T(::Unity::Collections::xxHash3_Hash64Long_00000A73$BurstDirectCall*);
MARK_REF_T(::Unity::Collections::xxHash3_Hash64Long_00000A73$PostfixBurstDelegate*);
...
DEFINE_IL2CPP_CLASS(::Unity::Collections::xxHash3_Hash128Long_00000A7A$BurstDirectCall*, "Unity.Collections", "xxHash3/Hash128Long_00000A7A$BurstDirectCall");
DEFINE_IL2CPP_CLASS(::Unity::Collections::xxHash3_Hash128Long_00000A7A$PostfixBurstDelegate*, "Unity.Collections", "xxHash3/Hash128Long_00000A7A$PostfixBurstDelegate");
DEFINE_IL2CPP_CLASS(::Unity::Collections::xxHash3_Hash64Long_00000A73$BurstDirectCall*, "Unity.Collections", "xxHash3/Hash64Long_00000A73$BurstDirectCall");
DEFINE_IL2CPP_CLASS(::Unity::Collections::xxHash3_Hash64Long_00000A73$PostfixBurstDelegate*, "Unity.Collections", "xxHash3/Hash64Long_00000A73$PostfixBurstDelegate");
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x64c3b68, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckKeySize, addr 0x64c5288, size 0xa4, virtual false, abstract: false, final false
  inline void CheckKeySize(int32_t isHash64);

  /// @brief Method ConsumeStripes, addr 0x64c4b74, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method DigestHash128, addr 0x64c4cec, size 0x1a4, virtual false, abstract: false, final false
  inline ::Unity::Mathematics::uint4 DigestHash128();

  /// @brief Method DigestHash64, addr 0x64c5134, size 0x154, virtual false, abstract: false, final false
  inline ::Unity::Mathematics::uint2 DigestHash64();

  /// @brief Method DigestLong, addr 0x64c4e90, size 0x2a4, virtual false, abstract: false, final false
  inline void DigestLong(uint64_t* acc, uint8_t* secret, int32_t isHash64);

  /// @brief Method Reset, addr 0x64c46b8, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x64c48c8, size 0x2a4, virtual false, abstract: false, final false
  inline void Update(void* input, int32_t length);

  /// @brief Method .ctor, addr 0x64c4638, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Acc, addr 0x64c48bc, size 0x4, virtual false, abstract: false, final false
  inline uint64_t* get_Acc();

  /// @brief Method get_Buffer, addr 0x64c4b6c, size 0x8, virtual false, abstract: false, final false
  inline uint8_t* get_Buffer();

  /// @brief Method get_SecretKey, addr 0x64c48c0, size 0x8, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x64c5414, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x64c5478, size 0x24, virtual true, abstract: false, final false
  inline uint64_t EndInvoke(::System::IAsyncResult* _cordl_fixed_empty_name_whitespace);

  /// @brief Method Invoke, addr 0x64c5400, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64c5380, size 0x80, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::Unity::Collections::xxHash3_Hash64Long_00000A73$PostfixBurstDelegate) == 0x80, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetFunctionPointer, addr 0x64c55a8, size 0x18, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetFunctionPointer();

  /// @brief Method GetFunctionPointerDiscard, addr 0x64c549c, size 0x10c, virtual false, abstract: false, final false
  static inline void GetFunctionPointerDiscard(::by_ref<::System::IntPtr> _cordl_fixed_empty_name_whitespace);

  /// @brief Method Invoke, addr 0x64c3740, size 0x1b4, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x64c5654, size 0xc4, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(uint8_t* input, uint8_t* dest, int64_t length, uint8_t* secret, ::by_ref<::Unity::Mathematics::uint4> result,
                                             ::System::AsyncCallback* _cordl_fixed_empty_name_whitespace, ::System::Object* _cordl_fixed_empty_name_whitespace_param_6);

  /// @brief Method EndInvoke, addr 0x64c5718, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* _cordl_fixed_empty_name_whitespace);

  /// @brief Method Invoke, addr 0x64c5640, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64c55c0, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* _cordl_fixed_empty_name_whitespace, ::System::IntPtr _cordl_fixed_empty_name_whitespace_param_1);
...
// Non member Declarations
static_assert(sizeof(::Unity::Collections::xxHash3_Hash128Long_00000A7A$PostfixBurstDelegate) == 0x80, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetFunctionPointer, addr 0x64c5830, size 0x18, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetFunctionPointer();

  /// @brief Method GetFunctionPointerDiscard, addr 0x64c5724, size 0x10c, virtual false, abstract: false, final false
  static inline void GetFunctionPointerDiscard(::by_ref<::System::IntPtr> _cordl_fixed_empty_name_whitespace);

  /// @brief Method Invoke, addr 0x64c3b70, size 0x1e4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Avalanche, addr 0x64c3efc, size 0x20, virtual false, abstract: false, final false
  static inline uint64_t Avalanche(uint64_t h64);

  /// @brief Method AvalancheH64, addr 0x64c3f1c, size 0x38, virtual false, abstract: false, final false
  static inline uint64_t AvalancheH64(uint64_t h64);

  /// @brief Method Avx2Accumulate, addr 0x64c214c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Avx2Accumulate512, addr 0x64c2154, size 0x4, virtual false, abstract: false, final false
  static inline void Avx2Accumulate512(uint64_t* acc, uint8_t* input, uint8_t* dest, uint8_t* secret);

  /// @brief Method Avx2HashLongInternalLoop, addr 0x64c2148, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Avx2ScrambleAcc, addr 0x64c2150, size 0x4, virtual false, abstract: false, final false
  static inline void Avx2ScrambleAcc(uint64_t* acc, uint8_t* secret);

  /// @brief Method DefaultAccumulate, addr 0x64c42e4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method DefaultAccumulate512, addr 0x64c43a0, size 0x50, virtual false, abstract: false, final false
  static inline void DefaultAccumulate512(uint64_t* acc, uint8_t* input, uint8_t* dest, uint8_t* secret, int32_t isHash64);

  /// @brief Method DefaultHashLongInternalLoop, addr 0x64c4130, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method DefaultScrambleAcc, addr 0x64c436c, size 0x34, virtual false, abstract: false, final false
  static inline void DefaultScrambleAcc(uint64_t* acc, uint8_t* secret);

  /// @brief Method EncodeSecretKey, addr 0x64c2e14, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash128, addr 0x64c26f8, size 0xb4, virtual false, abstract: false, final false
  static inline ::Unity::Mathematics::uint4 Hash128(void* input, void* destination, int64_t length);

  /// @brief Method Hash128, addr 0x64c2860, size 0xc0, virtual false, abstract: false, final false
  static inline ::Unity::Mathematics::uint4 Hash128(void* input, void* destination, int64_t length, uint64_t seed);

  /// @brief Method Hash128, addr 0x64c241c, size 0xb0, virtual false, abstract: false, final false
  static inline ::Unity::Mathematics::uint4 Hash128(void* input, int64_t length);

  /// @brief Method Hash128, addr 0x64c27ac, size 0xb4, virtual false, abstract: false, final false
  static inline ::Unity::Mathematics::uint4 Hash128(void* input, int64_t length, uint64_t seed);

  /// @brief Method Hash128Internal, addr 0x64c24cc, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash128Len0To16, addr 0x64c2e48, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash128Len129To240, addr 0x64c3290, size 0x354, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash128Len17To128, addr 0x64c2ed4, size 0x3bc, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash128Len1To3, addr 0x64c38f4, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash128Len4To8, addr 0x64c3994, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash128Len9To16, addr 0x64c3a4c, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash128Long, addr 0x64c2144, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash128Long$BurstManaged, addr 0x64c4500, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash64, addr 0x64c2158, size 0x98, virtual false, abstract: false, final false
  static inline ::Unity::Mathematics::uint2 Hash64(void* input, int64_t length);

  /// @brief Method Hash64, addr 0x64c2380, size 0x9c, virtual false, abstract: false, final false
  static inline ::Unity::Mathematics::uint2 Hash64(void* input, int64_t length, uint64_t seed);

  /// @brief Method Hash64Internal, addr 0x64c21f0, size 0x18c, virtual false, abstract: false, final false
  static inline uint64_t Hash64Internal(uint8_t* input, uint8_t* dest, int64_t length, uint8_t* secret, uint64_t seed);

  /// @brief Method Hash64Len0To16, addr 0x64c2920, size 0x68, virtual false, abstract: false, final false
  static inline uint64_t Hash64Len0To16(uint8_t* input, int64_t length, uint8_t* secret, uint64_t seed);

  /// @brief Method Hash64Len129To240, addr 0x64c2c90, size 0x184, virtual false, abstract: false, final false
  static inline uint64_t Hash64Len129To240(uint8_t* input, int64_t length, uint8_t* secret, uint64_t seed);

  /// @brief Method Hash64Len17To128, addr 0x64c2988, size 0x308, virtual false, abstract: false, final false
  static inline uint64_t Hash64Len17To128(uint8_t* input, int64_t length, uint8_t* secret, uint64_t seed);

  /// @brief Method Hash64Len1To3, addr 0x64c35e4, size 0x6c, virtual false, abstract: false, final false
  static inline uint64_t Hash64Len1To3(uint8_t* input, int64_t len, uint8_t* secret, uint64_t seed);

  /// @brief Method Hash64Len4To8, addr 0x64c3650, size 0x5c, virtual false, abstract: false, final false
  static inline uint64_t Hash64Len4To8(uint8_t* input, int64_t length, uint8_t* secret, uint64_t seed);

  /// @brief Method Hash64Len9To16, addr 0x64c36ac, size 0x94, virtual false, abstract: false, final false
  static inline uint64_t Hash64Len9To16(uint8_t* input, int64_t length, uint8_t* secret, uint64_t seed);

  /// @brief Method Hash64Long, addr 0x64c2140, size 0x4, virtual false, abstract: false, final false
  static inline uint64_t Hash64Long(uint8_t* input, uint8_t* dest, int64_t length, uint8_t* secret);

  /// @brief Method Hash64Long$BurstManaged, addr 0x64c43f0, size 0x110, virtual false, abstract: false, final false
  static inline uint64_t Hash64Long$BurstManaged(uint8_t* input, uint8_t* dest, int64_t length, uint8_t* secret);

  /// @brief Method MergeAcc, addr 0x64c3fd0, size 0x160, virtual false, abstract: false, final false
  static inline uint64_t MergeAcc(uint64_t* acc, uint8_t* secret, uint64_t start);

  /// @brief Method Mix16, addr 0x64c3dec, size 0x54, virtual false, abstract: false, final false
  static inline uint64_t Mix16(uint8_t* input, uint8_t* secret, uint64_t seed);

  /// @brief Method Mix2Acc, addr 0x64c3f88, size 0x48, virtual false, abstract: false, final false
  static inline uint64_t Mix2Acc(uint64_t acc0, uint64_t acc1, uint8_t* secret);

  /// @brief Method Mix32, addr 0x64c3e40, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method Mul128Fold64, addr 0x64c3db0, size 0x3c, virtual false, abstract: false, final false
  static inline uint64_t Mul128Fold64(uint64_t lhs, uint64_t rhs);

  /// @brief Method Mul32To64, addr 0x64c3d74, size 0x8, virtual false, abstract: false, final false
  static inline uint64_t Mul32To64(uint32_t x, uint32_t y);

  /// @brief Method Read32LE, addr 0x64c3d5c, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t Read32LE(void* addr);

  /// @brief Method Read32LE, addr 0x64c3d6c, size 0x8, virtual false, abstract: false, final false
  static inline void Read32LE(void* addr, uint32_t value);

  /// @brief Method Read64LE, addr 0x64c3d54, size 0x8, virtual false, abstract: false, final false
  static inline uint64_t Read64LE(void* addr);

  /// @brief Method RotL32, addr 0x64c3d8c, size 0xc, virtual false, abstract: false, final false
  static inline uint32_t RotL32(uint32_t x, int32_t r);

  /// @brief Method RotL64, addr 0x64c3d98, size 0xc, virtual false, abstract: false, final false
  static inline uint64_t RotL64(uint64_t x, int32_t r);

  /// @brief Method Swap32, addr 0x64c3d84, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t Swap32(uint32_t x);

  /// @brief Method Swap64, addr 0x64c3d7c, size 0x8, virtual false, abstract: false, final false
  static inline uint64_t Swap64(uint64_t x);

  /// @brief Method ToUint2, addr 0x64c237c, size 0x4, virtual false, abstract: false, final false
  static inline ::Unity::Mathematics::uint2 ToUint2(uint64_t u);

  /// @brief Method ToUint4, addr 0x64c3990, size 0x4, virtual false, abstract: false, final false
  static inline ::Unity::Mathematics::uint4 ToUint4(uint64_t ul0, uint64_t ul1);

  /// @brief Method Write64LE, addr 0x64c3d64, size 0x8, virtual false, abstract: false, final false
  static inline void Write64LE(void* addr, uint64_t value);

  /// @brief Method XorShift64, addr 0x64c3da4, size 0xc, virtual false, abstract: false, final false
  static inline uint64_t XorShift64(uint64_t v64, int32_t shift);

  /// @brief Method rrmxmx, addr 0x64c3f54, size 0x34, virtual false, abstract: false, final false
