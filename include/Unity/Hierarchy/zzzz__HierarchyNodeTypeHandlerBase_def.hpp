...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6b2fdac, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x6b2ff3c, size 0x134, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x6b2f06c, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method set_CommandList, addr 0x6b2feb8, size 0x84, virtual false, abstract: false, final false
  static inline void set_CommandList(::Unity::Hierarchy::HierarchyCommandList* value);

  /// @brief Method set_Hierarchy, addr 0x6b2fe34, size 0x84, virtual false, abstract: false, final false
  static inline void set_Hierarchy(::Unity::Hierarchy::Hierarchy* value);

  /// @brief Method set_Ptr, addr 0x6b2fdc0, size 0x74, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ChangesPending, addr 0x6b2fb38, size 0x94, virtual true, abstract: false, final false
  inline bool ChangesPending();

  /// @brief Method ChangesPending_Injected, addr 0x6b2fbcc, size 0x3c, virtual false, abstract: false, final false
  static inline bool ChangesPending_Injected(::System::IntPtr _unity_self);

  /// @brief Method CreateNodeTypeHandlerFromType, addr 0x6b2edb0, size 0x2bc, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x6b2e7d0, size 0x4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method FromIntPtr, addr 0x6b2ed00, size 0xa4, virtual false, abstract: false, final false
  static inline ::Unity::Hierarchy::HierarchyNodeTypeHandlerBase* FromIntPtr(::System::IntPtr handlePtr);

  /// @brief Method GetDefaultNodeFlags, addr 0x6b2e960, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDefaultNodeFlags_Injected, addr 0x6b2ea0c, size 0x54, virtual false, abstract: false, final false
  static inline ::Unity::Hierarchy::HierarchyNodeFlags GetDefaultNodeFlags_Injected(::System::IntPtr _unity_self, ::by_ref<::Unity::Hierarchy::HierarchyNode> node,
                                                                                    ::Unity::Hierarchy::HierarchyNodeFlags defaultFlags);

  /// @brief Method GetNodeTypeName, addr 0x6b2e7d4, size 0x148, virtual true, abstract: false, final false
  inline ::StringW GetNodeTypeName();

  /// @brief Method GetNodeTypeName_Injected, addr 0x6b2e91c, size 0x44, virtual false, abstract: false, final false
  static inline void GetNodeTypeName_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper> ret);

  /// @brief Method Initialize, addr 0x6b2e7cc, size 0x4, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method IntegrateChanges, addr 0x6b2fc08, size 0xac, virtual true, abstract: false, final false
  inline bool IntegrateChanges(::Unity::Hierarchy::HierarchyCommandList* cmdList);

  /// @brief Method IntegrateChanges_Injected, addr 0x6b2fcb4, size 0x44, virtual false, abstract: false, final false
  static inline bool IntegrateChanges_Injected(::System::IntPtr _unity_self, ::System::IntPtr cmdList);

  /// @brief Method Internal_SearchBegin, addr 0x6b2eda4, size 0xc, virtual false, abstract: false, final false
  inline void Internal_SearchBegin(::Unity::Hierarchy::HierarchySearchQueryDescriptor* query);

  /// @brief Method InvokeChangesPending, addr 0x6b2f718, size 0xe0, virtual false, abstract: false, final false
  static inline bool InvokeChangesPending(::System::IntPtr handlePtr);

  /// @brief Method InvokeDispose, addr 0x6b2f41c, size 0x124, virtual false, abstract: false, final false
  static inline void InvokeDispose(::System::IntPtr handlePtr);

  /// @brief Method InvokeGetDefaultNodeFlags, addr 0x6b2f620, size 0xf8, virtual false, abstract: false, final false
  static inline ::Unity::Hierarchy::HierarchyNodeFlags InvokeGetDefaultNodeFlags(::System::IntPtr handlePtr, ::by_ref<::Unity::Hierarchy::HierarchyNode> node,
                                                                                 ::Unity::Hierarchy::HierarchyNodeFlags defaultFlags);

  /// @brief Method InvokeGetNodeTypeName, addr 0x6b2f540, size 0xe0, virtual false, abstract: false, final false
  static inline ::StringW InvokeGetNodeTypeName(::System::IntPtr handlePtr);

  /// @brief Method InvokeInitialize, addr 0x6b2f33c, size 0xe0, virtual false, abstract: false, final false
  static inline void InvokeInitialize(::System::IntPtr handlePtr);

  /// @brief Method InvokeIntegrateChanges, addr 0x6b2f7f8, size 0x178, virtual false, abstract: false, final false
  static inline bool InvokeIntegrateChanges(::System::IntPtr handlePtr, ::System::IntPtr cmdListPtr);

  /// @brief Method InvokeSearchEnd, addr 0x6b2fa58, size 0xe0, virtual false, abstract: false, final false
  static inline void InvokeSearchEnd(::System::IntPtr handlePtr);

  /// @brief Method InvokeSearchMatch, addr 0x6b2f970, size 0xe8, virtual false, abstract: false, final false
  static inline bool InvokeSearchMatch(::System::IntPtr handlePtr, ::by_ref<::Unity::Hierarchy::HierarchyNode> node);

  /// @brief Method SearchBegin, addr 0x6b2ea60, size 0xa4, virtual true, abstract: false, final false
  inline void SearchBegin(::Unity::Hierarchy::HierarchySearchQueryDescriptor* query);

  /// @brief Method SearchBegin_Injected, addr 0x6b2eb04, size 0x44, virtual false, abstract: false, final false
  static inline void SearchBegin_Injected(::System::IntPtr _unity_self, ::Unity::Hierarchy::HierarchySearchQueryDescriptor* query);

  /// @brief Method SearchEnd, addr 0x6b2ec30, size 0x94, virtual true, abstract: false, final false
  inline void SearchEnd();

  /// @brief Method SearchEnd_Injected, addr 0x6b2ecc4, size 0x3c, virtual false, abstract: false, final false
  static inline void SearchEnd_Injected(::System::IntPtr _unity_self);

  /// @brief Method SearchMatch, addr 0x6b2eb48, size 0xa4, virtual true, abstract: false, final false
  inline bool SearchMatch(::by_ref<::Unity::Hierarchy::HierarchyNode> node);

  /// @brief Method SearchMatch_Injected, addr 0x6b2ebec, size 0x44, virtual false, abstract: false, final false
  static inline bool SearchMatch_Injected(::System::IntPtr _unity_self, ::by_ref<::Unity::Hierarchy::HierarchyNode> node);

  /// @brief Method TryGetStaticNodeType, addr 0x6b2f1b4, size 0x188, virtual false, abstract: false, final false
