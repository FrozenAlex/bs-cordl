...
public:
  ...
  inline ::System::IAsyncResult* BeginInvoke(::by_ref<T> jobData, ::System::IntPtr additionalPtr, ::System::IntPtr bufferRangePatchData, ::by_ref<::Unity::Jobs::LowLevel::Unsafe::JobRanges> ranges,
...
public:
  ...
  template <typename T> static inline ::Unity::Jobs::JobHandle ScheduleByRef(::by_ref<T> jobData, int32_t* forEachCount, int32_t innerloopBatchCount, ::Unity::Jobs::JobHandle dependsOn);
