...
DEFINE_IL2CPP_GEN_CLASS(::Unity::Profiling::ProfilerMarker_1, "Unity.Profiling", "ProfilerMarker`1");
DEFINE_IL2CPP_GEN_CLASS(::Unity::Profiling::ProfilerMarker_1_AutoScope, "Unity.Profiling", "ProfilerMarker`1/AutoScope");
// Dependencies
namespace Unity::Profiling {
// cpp template
