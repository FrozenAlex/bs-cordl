...
public:
  ...
  /// @brief Method Equals, addr 0x6a4b398, size 0x68, virtual true, abstract: false, final true
  inline bool Equals(::Unity::Properties::ConversionRegistry_ConverterKey x, ::Unity::Properties::ConversionRegistry_ConverterKey y);

  /// @brief Method GetHashCode, addr 0x6a4b400, size 0x80, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6a4b394, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6a4b1d8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Create, addr 0x6a4b034, size 0xcc, virtual false, abstract: false, final false
  static inline ::Unity::Properties::ConversionRegistry Create();

  /// @brief Method Equals, addr 0x6a4b2fc, size 0xc, virtual true, abstract: false, final true
  inline bool Equals(::Unity::Properties::ConversionRegistry x, ::Unity::Properties::ConversionRegistry y);

  /// @brief Method GetConverter, addr 0x6a4b1e0, size 0x8c, virtual false, abstract: false, final false
  inline ::System::Delegate* GetConverter(::System::Type* source, ::System::Type* destination);

  /// @brief Method GetHashCode, addr 0x6a4b308, size 0x20, virtual true, abstract: false, final true
  inline int32_t GetHashCode(::Unity::Properties::ConversionRegistry obj);

  /// @brief Method Register, addr 0x6a4b100, size 0xd8, virtual false, abstract: false, final false
  inline void Register(::System::Type* source, ::System::Type* destination, ::System::Delegate* converter);

  /// @brief Method TryGetConverter, addr 0x6a4b26c, size 0x90, virtual false, abstract: false, final false
  inline bool TryGetConverter(::System::Type* source, ::System::Type* destination, ::by_ref<::System::Delegate*> converter);

  /// @brief Method .ctor, addr 0x6a4b02c, size 0x8, virtual false, abstract: false, final false
