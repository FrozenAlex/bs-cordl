...
public:
  ...
  /// @brief Method .ctor, addr 0x6a4748c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ReadOnly, addr 0x6a4747c, size 0x8, virtual false, abstract: false, final false
  inline bool get_ReadOnly();

  /// @brief Method set_ReadOnly, addr 0x6a47484, size 0x8, virtual false, abstract: false, final false
