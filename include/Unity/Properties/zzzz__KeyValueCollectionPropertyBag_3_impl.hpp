...
inline ::Unity::Properties::PropertyCollection_1<TDictionary> Unity::Properties::KeyValueCollectionPropertyBag_3<TDictionary, TKey, TValue>::GetProperties() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{},
                   (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Unity::Properties::KeyValueCollectionPropertyBag_3<TDictionary, TKey, TValue>*>(), 12 })));
...
inline ::Unity::Properties::PropertyCollection_1<TDictionary> Unity::Properties::KeyValueCollectionPropertyBag_3<TDictionary, TKey, TValue>::GetProperties(::by_ref<TDictionary> container) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{},
                   (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Unity::Properties::KeyValueCollectionPropertyBag_3<TDictionary, TKey, TValue>*>(), 13 })));
...
inline void Unity::Properties::KeyValueCollectionPropertyBag_3<TDictionary, TKey, TValue>::Unity_Properties_ICollectionPropertyBagAccept_TDictionary__Accept(
  ...
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Unity::Properties::KeyValueCollectionPropertyBag_3<TDictionary, TKey, TValue>*>(),
                                                           { "Unity.Properties.ICollectionPropertyBagAccept<TDictionary>.Accept",
                                                             {},
                                                             { ::i2c::type_of<::Unity::Properties::ICollectionPropertyBagVisitor*>(), ::i2c::type_of<::by_ref<TDictionary>>() } })));
  ...
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Unity::Properties::KeyValueCollectionPropertyBag_3<TDictionary, TKey, TValue>*>(),
                                                           { "Unity.Properties.IDictionaryPropertyBagAccept<TDictionary>.Accept",
                                                             {},
                                                             { ::i2c::type_of<::Unity::Properties::IDictionaryPropertyBagVisitor*>(), ::i2c::type_of<::by_ref<TDictionary>>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, visitor, container);
}
template <typename TDictionary, typename TKey, typename TValue>
inline bool Unity::Properties::KeyValueCollectionPropertyBag_3<TDictionary, TKey, TValue>::Unity_Properties_IKeyedProperties_TDictionary_System_Object__TryGetProperty(
  ...
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{},
      (::i2c::find_method(::i2c::class_of<::Unity::Properties::KeyValueCollectionPropertyBag_3<TDictionary, TKey, TValue>*>(),
