...
public:
  ...
  /// @brief Method GetMessageForType, addr 0x6b96ab4, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b96a34, size 0x80, virtual false, abstract: false, final false
