...
public:
  ...
  /// @brief Method Dispose, addr 0x6a4b010, size 0x1c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x6a4aff0, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Reset, addr 0x6a471fc, size 0x2c, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x6a4722c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Path, addr 0x6a4afa4, size 0x10, virtual false, abstract: false, final false
  inline ::Unity::Properties::PropertyPath get_Path();

  /// @brief Method get_Property, addr 0x6a4afc0, size 0x8, virtual false, abstract: false, final false
  inline ::Unity::Properties::IProperty* get_Property();

  /// @brief Method get_ReadonlyVisit, addr 0x6a4afd0, size 0x8, virtual false, abstract: false, final false
  inline bool get_ReadonlyVisit();

  /// @brief Method get_ReturnCode, addr 0x6a4afe0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Path, addr 0x6a4afb4, size 0xc, virtual false, abstract: false, final false
  inline void set_Path(::Unity::Properties::PropertyPath value);

  /// @brief Method set_Property, addr 0x6a4afc8, size 0x8, virtual false, abstract: false, final false
  inline void set_Property(::Unity::Properties::IProperty* value);

  /// @brief Method set_ReadonlyVisit, addr 0x6a4afd8, size 0x8, virtual false, abstract: false, final false
  inline void set_ReadonlyVisit(bool value);

  /// @brief Method set_ReturnCode, addr 0x6a4afe8, size 0x8, virtual false, abstract: false, final false
