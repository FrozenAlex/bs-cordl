...
public:
  ...
  /// @brief Method <.cctor>b__5_0, addr 0x6b968f8, size 0x44, virtual false, abstract: false, final false
  inline ::Unity::Properties::PropertyContainer_GetPropertyVisitor* __cctor_b__5_0();

  /// @brief Method <.cctor>b__5_1, addr 0x6b9693c, size 0x20, virtual false, abstract: false, final false
  inline void __cctor_b__5_1(::Unity::Properties::PropertyContainer_GetPropertyVisitor* v);

  /// @brief Method .ctor, addr 0x6b968f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Reset, addr 0x6b966a8, size 0x34, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method VisitPath, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
  template <typename TContainer, typename TValue> inline void VisitPath(::Unity::Properties::Property_2<TContainer, TValue>* property, ::by_ref<TContainer> container, ::by_ref<TValue> value);
  ...
  /// @brief Method .ctor, addr 0x6b96708, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  template <typename TContainer> static inline void Accept(::Unity::Properties::IPropertyBagVisitor* visitor, ::by_ref<TContainer> container, ::Unity::Properties::VisitParameters parameters);

  /// @brief Method TryAccept, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename TContainer> static inline bool TryAccept(::Unity::Properties::IPropertyBagVisitor* visitor, ::by_ref<TContainer> container, ::Unity::Properties::VisitParameters parameters);

  /// @brief Method TryAccept, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename TContainer>
  static inline bool TryAccept(::Unity::Properties::IPropertyBagVisitor* visitor, ::by_ref<TContainer> container, ::by_ref<::Unity::Properties::VisitReturnCode> returnCode,
  ...
  template <typename TContainer, typename TValue> static inline bool TryGetValue(::by_ref<TContainer> container, ::StringW name, ::by_ref<TValue> value);
