...
public:
  ...
  /// @brief Method CreateCollabOperationAnalytic, addr 0x6ccda1c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ccd9a4, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
