...
public:
  ...
  /// @brief Method CreateNavmeshBakingAnalytic, addr 0x6ccdd4c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ccdcd4, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEditor::Analytics::NavmeshBakingAnalytic) == 0x38, "Size mismatch!");
