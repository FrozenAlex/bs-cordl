...
public:
  // Declarations
  /// @brief Method CreatePackageManagerResetPackageAnalytic, addr 0x6e1dd78, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e1dce4, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
