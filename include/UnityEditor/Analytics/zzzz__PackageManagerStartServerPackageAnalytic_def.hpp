...
public:
  // Declarations
  /// @brief Method CreatePackageManagerStartServerPackageAnalytic, addr 0x6e1df48, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e1deb4, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
