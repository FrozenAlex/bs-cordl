...
public:
  ...
  /// @brief Method CreateProjectSettingsInformationAnalytic, addr 0x6e1d6d4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e1d65c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
