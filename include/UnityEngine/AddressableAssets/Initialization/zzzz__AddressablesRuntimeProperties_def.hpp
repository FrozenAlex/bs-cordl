...
public:
  ...
  /// @brief Method ClearCachedPropertyValues, addr 0x6329d18, size 0x80, virtual false, abstract: false, final false
  static inline void ClearCachedPropertyValues();

  /// @brief Method EvaluateProperty, addr 0x6329d98, size 0x3dc, virtual false, abstract: false, final false
  static inline ::StringW EvaluateProperty(::StringW name);

  /// @brief Method EvaluateString, addr 0x6315a8c, size 0xf4, virtual false, abstract: false, final false
  static inline ::StringW EvaluateString(::StringW inputString);

  /// @brief Method EvaluateString, addr 0x632a734, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method EvaluateStringInternal, addr 0x632a174, size 0x5c0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAssemblies, addr 0x6329bd0, size 0x1c, virtual false, abstract: false, final false
  static inline ::ArrayW<::System::Reflection::Assembly*> GetAssemblies();

  /// @brief Method GetCachedValueCount, addr 0x6329bec, size 0x84, virtual false, abstract: false, final false
  static inline int32_t GetCachedValueCount();

  /// @brief Method SetPropertyValue, addr 0x6329c70, size 0xa8, virtual false, abstract: false, final false
