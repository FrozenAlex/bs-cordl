...
public:
  ...
  __declspec(property(get = getStaticF___9__12_0, put = setStaticF___9__12_0)) ::System::Func_2<::UnityEngine::ResourceManagement::ResourceProviders::IResourceProvider*, bool>* __9__12_0;

  static inline ::UnityEngine::AddressableAssets::Initialization::InitializationOperation___c* New_ctor();

  /// @brief Method <Execute>b__12_0, addr 0x6467b0c, size 0x8c, virtual false, abstract: false, final false
  inline bool _Execute_b__12_0(::UnityEngine::ResourceManagement::ResourceProviders::IResourceProvider* rp);

  /// @brief Method .ctor, addr 0x6467b08, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::AddressableAssets::Initialization::InitializationOperation___c* getStaticF___9();

  static inline ::System::Func_2<::UnityEngine::ResourceManagement::ResourceProviders::IResourceProvider*, bool>* getStaticF___9__12_0();

  static inline void setStaticF___9(::UnityEngine::AddressableAssets::Initialization::InitializationOperation___c* value);

  static inline void setStaticF___9__12_0(::System::Func_2<::UnityEngine::ResourceManagement::ResourceProviders::IResourceProvider*, bool>* value);
...
public:
  ...
  /// @brief Method <LoadContentCatalog>b__0, addr 0x6467b9c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6467b98, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
namespace UnityEngine::AddressableAssets::Initialization {
// Is value type: false
// CS Name: UnityEngine.AddressableAssets.Initialization.InitializationOperation/<>c__DisplayClass17_0
class CORDL_TYPE InitializationOperation___c__DisplayClass17_0 : public ::System::Object {
public:
  // Declarations
  ...
  /// @brief Method <LoadContentCatalogInternal>b__0, addr 0x6467bf4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6467bf0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::AddressableAssets::Initialization::InitializationOperation___c__DisplayClass17_0, _____4__this) == 0x10, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::AddressableAssets::Initialization::InitializationOperation___c__DisplayClass17_0, ___catalogs) == 0x18, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::AddressableAssets::Initialization::InitializationOperation___c__DisplayClass17_0, ___locMap) == 0x20, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::AddressableAssets::Initialization::InitializationOperation___c__DisplayClass17_0, ___index) == 0x28, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::AddressableAssets::Initialization::InitializationOperation___c__DisplayClass17_0, ___remoteHashLocation) == 0x30, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::AddressableAssets::Initialization::InitializationOperation___c__DisplayClass17_0) == 0x38, "Size mismatch!");
...
public:
  ...
  /// @brief Field m_InitGroupOps, offset 0xd8, size 0x8
  ...
  /// @brief Field m_loadCatalogOp, offset 0xb0, size 0x18
  __declspec(property(
  ...
  /// @brief Method CreateInitializationOperation, addr 0x6451688, size 0x50c, virtual false, abstract: false, final false
  ...
  /// @brief Method Execute, addr 0x6465dcc, size 0xd14, virtual true, abstract: false, final false
  inline void Execute();

  /// @brief Method InvokeWaitForCompletion, addr 0x6465bc4, size 0x208, virtual true, abstract: false, final false
  inline bool InvokeWaitForCompletion();

  /// @brief Method LoadContentCatalog, addr 0x6451b9c, size 0x694, virtual false, abstract: false, final false
  static inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::AddressableAssets::ResourceLocators::IResourceLocator*>
  ...
  /// @brief Method LoadContentCatalog, addr 0x64676e8, size 0x34, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::AddressableAssets::ResourceLocators::IResourceLocator*>
  LoadContentCatalog(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* loc, ::StringW providerSuffix,
                     ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* remoteHashLocation);

  /// @brief Method LoadContentCatalogInternal, addr 0x6466ae0, size 0x240, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::AddressableAssets::ResourceLocators::IResourceLocator*>
  ...
  /// @brief Method LoadOpComplete, addr 0x646771c, size 0x398, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadProvider, addr 0x6466d20, size 0x480, virtual false, abstract: false, final false
  ...
  /// @brief Method OnCatalogDataLoaded, addr 0x64671a0, size 0x548, virtual false, abstract: false, final false
  static inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::AddressableAssets::ResourceLocators::IResourceLocator*>
  ...
  /// @brief Method .ctor, addr 0x6465a9c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::AddressableAssets::AddressablesImpl* aa);

  /// @brief Method get_DebugName, addr 0x6465b80, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_DebugName();

  /// @brief Method get_Progress, addr 0x6465afc, size 0x84, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Field m_loadCatalogOp, offset: 0xb0, size: 0x18, def value: None
  ...
  /// @brief Field m_InitGroupOps, offset: 0xd8, size: 0x8, def value: None
...
static_assert(offsetof(::UnityEngine::AddressableAssets::Initialization::InitializationOperation, ___m_loadCatalogOp) == 0xb0, "Offset mismatch!");
...
static_assert(offsetof(::UnityEngine::AddressableAssets::Initialization::InitializationOperation, ___m_InitGroupOps) == 0xd8, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::AddressableAssets::Initialization::InitializationOperation) == 0xe0, "Size mismatch!");
