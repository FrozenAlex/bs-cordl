...
public:
  ...
  /// @brief Method .ctor, addr 0x6326694, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Data, addr 0x6326674, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_Data();

  /// @brief Method get_Dependencies, addr 0x6326664, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::System::Object*>* get_Dependencies();

  /// @brief Method get_InternalId, addr 0x6326634, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_InternalId();

  /// @brief Method get_Keys, addr 0x6326654, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::System::Object*>* get_Keys();

  /// @brief Method get_Provider, addr 0x6326644, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Provider();

  /// @brief Method get_ResourceType, addr 0x6326684, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_ResourceType();

  /// @brief Method set_Data, addr 0x632667c, size 0x8, virtual false, abstract: false, final false
  inline void set_Data(::System::Object* value);

  /// @brief Method set_Dependencies, addr 0x632666c, size 0x8, virtual false, abstract: false, final false
  inline void set_Dependencies(::System::Collections::Generic::List_1<::System::Object*>* value);

  /// @brief Method set_InternalId, addr 0x632663c, size 0x8, virtual false, abstract: false, final false
  inline void set_InternalId(::StringW value);

  /// @brief Method set_Keys, addr 0x632665c, size 0x8, virtual false, abstract: false, final false
  inline void set_Keys(::System::Collections::Generic::List_1<::System::Object*>* value);

  /// @brief Method set_Provider, addr 0x632664c, size 0x8, virtual false, abstract: false, final false
  inline void set_Provider(::StringW value);

  /// @brief Method set_ResourceType, addr 0x632668c, size 0x8, virtual false, abstract: false, final false
