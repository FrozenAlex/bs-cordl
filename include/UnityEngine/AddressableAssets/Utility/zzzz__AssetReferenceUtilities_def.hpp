...
// Write type traits
MARK_REF_T(::UnityEngine::AddressableAssets::Utility::AssetReferenceUtilities*);
DEFINE_IL2CPP_CLASS(::UnityEngine::AddressableAssets::Utility::AssetReferenceUtilities*, "UnityEngine.AddressableAssets.Utility", "AssetReferenceUtilities");
...
public:
  // Declarations
  /// @brief Method FormatName, addr 0x6322b8c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6322c28, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::AddressableAssets::Utility::AssetReferenceUtilities) == 0x10, "Size mismatch!");
