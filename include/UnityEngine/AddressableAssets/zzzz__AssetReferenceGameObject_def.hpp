...
// Write type traits
MARK_REF_T(::UnityEngine::AddressableAssets::AssetReferenceGameObject*);
DEFINE_IL2CPP_CLASS(::UnityEngine::AddressableAssets::AssetReferenceGameObject*, "UnityEngine.AddressableAssets", "AssetReferenceGameObject");
...
public:
  ...
  /// @brief Method .ctor, addr 0x64586d4, size 0x78, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::AddressableAssets::AssetReferenceGameObject) == 0x40, "Size mismatch!");
