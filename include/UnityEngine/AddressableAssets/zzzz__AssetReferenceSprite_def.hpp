...
// Write type traits
MARK_REF_T(::UnityEngine::AddressableAssets::AssetReferenceSprite*);
DEFINE_IL2CPP_CLASS(::UnityEngine::AddressableAssets::AssetReferenceSprite*, "UnityEngine.AddressableAssets", "AssetReferenceSprite");
...
public:
  ...
  /// @brief Method ValidateAsset, addr 0x645892c, size 0x8, virtual true, abstract: false, final false
  inline bool ValidateAsset(::StringW path);

  /// @brief Method .ctor, addr 0x64588b4, size 0x78, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::AddressableAssets::AssetReferenceSprite) == 0x40, "Size mismatch!");
