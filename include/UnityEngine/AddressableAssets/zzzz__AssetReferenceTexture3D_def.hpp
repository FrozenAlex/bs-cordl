...
// Write type traits
MARK_REF_T(::UnityEngine::AddressableAssets::AssetReferenceTexture3D*);
DEFINE_IL2CPP_CLASS(::UnityEngine::AddressableAssets::AssetReferenceTexture3D*, "UnityEngine.AddressableAssets", "AssetReferenceTexture3D");
...
public:
  ...
  /// @brief Method .ctor, addr 0x631de80, size 0x78, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::AddressableAssets::AssetReferenceTexture3D) == 0x40, "Size mismatch!");
