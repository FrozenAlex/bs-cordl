...
// Write type traits
MARK_REF_T(::UnityEngine::AddressableAssets::AssetReferenceTexture*);
DEFINE_IL2CPP_CLASS(::UnityEngine::AddressableAssets::AssetReferenceTexture*, "UnityEngine.AddressableAssets", "AssetReferenceTexture");
...
public:
  ...
  /// @brief Method .ctor, addr 0x645874c, size 0x78, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::AddressableAssets::AssetReferenceTexture) == 0x40, "Size mismatch!");
