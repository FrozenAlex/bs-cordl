...
public:
  ...
  /// @brief Method CompleteInternal, addr 0x631f304, size 0xa8, virtual false, abstract: false, final false
  inline void CompleteInternal(bool result, bool success, ::StringW errorMsg);

  /// @brief Method Destroy, addr 0x631f5dc, size 0x80, virtual true, abstract: false, final false
  inline void Destroy();

  /// @brief Method DetermineCacheDirsNotInUse, addr 0x6320270, size 0x3f0, virtual false, abstract: false, final false
  inline void DetermineCacheDirsNotInUse(::System::Collections::Generic::HashSet_1<::StringW>* cacheDirsInUse);

  /// @brief Method DetermineCacheDirsNotInUse, addr 0x63206a0, size 0x90, virtual false, abstract: false, final false
  inline void DetermineCacheDirsNotInUse(::System::Object* data);

  /// @brief Method Execute, addr 0x631f740, size 0x210, virtual true, abstract: false, final false
  inline void Execute();

  /// @brief Method GetCacheDirsInUse, addr 0x631f950, size 0x920, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDependencies, addr 0x631f65c, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method InvokeWaitForCompletion, addr 0x631f3ac, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method RemoveCacheEntries, addr 0x631f48c, size 0x150, virtual false, abstract: false, final false
  inline void RemoveCacheEntries();

  /// @brief Method Start, addr 0x631caac, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method UnityEngine.ResourceManagement.IUpdateReceiver.Update, addr 0x6320660, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x631c9e8, size 0xc4, virtual false, abstract: false, final false
