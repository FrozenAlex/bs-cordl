...
public:
  ...
  /// @brief Method UpdateContent, addr 0x6444004, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6443ff8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::AddressableAssets::ResourceLocators::IResourceLocator* loc, ::StringW localHash,
                    ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* remoteCatalogLocation);

  /// @brief Method get_CanUpdateContent, addr 0x6442bf0, size 0x1ac, virtual false, abstract: false, final false
  inline bool get_CanUpdateContent();

  /// @brief Method get_CatalogLocation, addr 0x6443fd8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* get_CatalogLocation();

  /// @brief Method get_ContentUpdateAvailable, addr 0x6443fe8, size 0x8, virtual false, abstract: false, final false
  inline bool get_ContentUpdateAvailable();

  /// @brief Method get_HashLocation, addr 0x6442e88, size 0x124, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* get_HashLocation();

  /// @brief Method get_LocalHash, addr 0x6443fc8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_LocalHash();

  /// @brief Method get_Locator, addr 0x6443fb8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::AddressableAssets::ResourceLocators::IResourceLocator* get_Locator();

  /// @brief Method set_CatalogLocation, addr 0x6443fe0, size 0x8, virtual false, abstract: false, final false
  inline void set_CatalogLocation(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* value);

  /// @brief Method set_ContentUpdateAvailable, addr 0x6443ff0, size 0x8, virtual false, abstract: false, final false
  inline void set_ContentUpdateAvailable(bool value);

  /// @brief Method set_LocalHash, addr 0x6443fd0, size 0x8, virtual false, abstract: false, final false
  inline void set_LocalHash(::StringW value);

  /// @brief Method set_Locator, addr 0x6443fc0, size 0x8, virtual false, abstract: false, final false
