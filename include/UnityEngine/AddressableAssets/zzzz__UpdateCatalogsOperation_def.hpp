...
// Write type traits
MARK_REF_T(::UnityEngine::AddressableAssets::UpdateCatalogsOperation*);
MARK_REF_T(::UnityEngine::AddressableAssets::UpdateCatalogsOperation___c*);
MARK_REF_T(::UnityEngine::AddressableAssets::UpdateCatalogsOperation___c__DisplayClass11_0*);
...
public:
  ...
  /// @brief Method <Start>b__6_0, addr 0x632127c, size 0x8c, virtual false, abstract: false, final false
  inline bool _Start_b__6_0(::UnityEngine::ResourceManagement::ResourceProviders::IResourceProvider* rp);

  /// @brief Method .ctor, addr 0x6321278, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <OnCleanCacheCompleted>b__0, addr 0x6321308, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6321220, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::AddressableAssets::UpdateCatalogsOperation___c__DisplayClass11_0) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method Destroy, addr 0x632092c, size 0x4c, virtual true, abstract: false, final false
  inline void Destroy();

  /// @brief Method Execute, addr 0x6320a5c, size 0x6b0, virtual true, abstract: false, final false
  inline void Execute();

  /// @brief Method GetDependencies, addr 0x6320978, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method InvokeWaitForCompletion, addr 0x6320740, size 0x1ec, virtual true, abstract: false, final false
  ...
  /// @brief Method OnCleanCacheCompleted, addr 0x632110c, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x631ba68, size 0x6e0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x631ba08, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::AddressableAssets::UpdateCatalogsOperation) == 0xe0, "Size mismatch!");
