...
public:
  ...
  /// @brief Method CreateBatchRenderGroupUsageAnalytic, addr 0x6b0008c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b00014, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
