...
public:
  // Declarations
  /// @brief Method CreateSubsystemsAnalyticStart, addr 0x6e1cccc, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e1cc38, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
