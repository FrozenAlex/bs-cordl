...
public:
  // Declarations
  /// @brief Method CreateSubsystemsAnalyticStop, addr 0x6ccd4f8, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ccd464, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
