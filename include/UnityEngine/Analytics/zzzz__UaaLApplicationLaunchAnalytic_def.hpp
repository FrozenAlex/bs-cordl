...
public:
  ...
  /// @brief Method CreateUaaLApplicationLaunchAnalytic, addr 0x69b0d94, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69b0d1c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
