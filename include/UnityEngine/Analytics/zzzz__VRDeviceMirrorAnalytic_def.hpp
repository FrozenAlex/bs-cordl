...
public:
  ...
  /// @brief Method CreateVRDeviceMirrorAnalytic, addr 0x6ccd704, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ccd758, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
