...
public:
  ...
  /// @brief Method CreateVRDeviceMirrorAnalytic, addr 0x6e1cfc0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e1d014, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::Analytics::VRDeviceMirrorAnalytic) == 0x30, "Size mismatch!");
