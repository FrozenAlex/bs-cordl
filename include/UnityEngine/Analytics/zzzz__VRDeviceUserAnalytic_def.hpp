...
public:
  ...
  /// @brief Method CreateVRDeviceUserAnalytic, addr 0x6e1d018, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e1d06c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::Analytics::VRDeviceUserAnalytic) == 0x30, "Size mismatch!");
