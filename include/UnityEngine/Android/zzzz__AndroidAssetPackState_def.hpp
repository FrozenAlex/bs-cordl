...
// Write type traits
MARK_REF_T(::UnityEngine::Android::AndroidAssetPackState*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Android::AndroidAssetPackState*, "UnityEngine.Android", "AndroidAssetPackState");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6a2b7ac, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Android::AndroidAssetPackState) == 0x20, "Size mismatch!");
