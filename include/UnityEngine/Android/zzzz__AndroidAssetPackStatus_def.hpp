...
DEFINE_IL2CPP_CLASS(::UnityEngine::Android::AndroidAssetPackStatus, "UnityEngine.Android", "AndroidAssetPackStatus");
// Dependencies
namespace UnityEngine::Android {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Android::AndroidAssetPackStatus) == 0x4, "Size mismatch!");
