...
// Write type traits
MARK_REF_T(::UnityEngine::Android::AndroidAssetPackUseMobileDataRequestResult*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Android::AndroidAssetPackUseMobileDataRequestResult*, "UnityEngine.Android", "AndroidAssetPackUseMobileDataRequestResult");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6a2b7b8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Android::AndroidAssetPackUseMobileDataRequestResult) == 0x18, "Size mismatch!");
