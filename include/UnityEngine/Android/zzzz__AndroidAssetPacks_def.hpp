...
// Write type traits
MARK_REF_T(::UnityEngine::Android::AndroidAssetPacks*);
MARK_REF_T(::UnityEngine::Android::AndroidAssetPacks_AssetPackManagerDownloadStatusCallback*);
MARK_REF_T(::UnityEngine::Android::AndroidAssetPacks_AssetPackManagerMobileDataConfirmationCallback*);
MARK_REF_T(::UnityEngine::Android::AndroidAssetPacks_AssetPackManagerStatusQueryCallback*);
MARK_REF_T(::UnityEngine::Android::AssetPackManagerDownloadStatusCallback_AndroidAssetPacks___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Android::AndroidAssetPacks*, "UnityEngine.Android", "AndroidAssetPacks");
DEFINE_IL2CPP_CLASS(::UnityEngine::Android::AndroidAssetPacks_AssetPackManagerDownloadStatusCallback*, "UnityEngine.Android", "AndroidAssetPacks/AssetPackManagerDownloadStatusCallback");
DEFINE_IL2CPP_CLASS(::UnityEngine::Android::AndroidAssetPacks_AssetPackManagerMobileDataConfirmationCallback*, "UnityEngine.Android",
...
public:
  ...
  /// @brief Method <.ctor>b__2_0, addr 0x68d738c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW __ctor_b__2_0(::StringW ap);

  /// @brief Method <.ctor>b__2_1, addr 0x68d7394, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Android::AndroidAssetPackStatus __ctor_b__2_1(::StringW ap);

  /// @brief Method .ctor, addr 0x68d7388, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::Android::AssetPackManagerDownloadStatusCallback_AndroidAssetPacks___c) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x68d6e8c, size 0x1f8, virtual false, abstract: false, final false
  inline void _ctor(::System::Action_1<::UnityEngine::Android::AndroidAssetPackInfo*>* callback, ::ArrayW<::StringW> assetPacks);

  /// @brief Method onStatusUpdate, addr 0x68d7084, size 0x274, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Android::AndroidAssetPacks_AssetPackManagerDownloadStatusCallback) == 0x30, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x68d739c, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::System::Action_1<::UnityEngine::Android::AndroidAssetPackUseMobileDataRequestResult*>* callback);

  /// @brief Method onMobileDataConfirmationResult, addr 0x68d7424, size 0x88, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Android::AndroidAssetPacks_AssetPackManagerMobileDataConfirmationCallback) == 0x28, "Size mismatch!");
...
public:
  ...
  /// @brief Field m_Callback, offset 0x20, size 0x8
  __declspec(property(get = __cordl_internal_get_m_Callback, put = __cordl_internal_set_m_Callback)) ::System::Action_2<uint64_t, ::ArrayW<::UnityEngine::Android::AndroidAssetPackState*>>* m_Callback;
  ...
  New_ctor(::System::Action_2<uint64_t, ::ArrayW<::UnityEngine::Android::AndroidAssetPackState*>>* callback, ::ArrayW<::StringW> assetPacks);
  ...
  constexpr ::System::Action_2<uint64_t, ::ArrayW<::UnityEngine::Android::AndroidAssetPackState*>>* const& __cordl_internal_get_m_Callback() const;

  constexpr ::System::Action_2<uint64_t, ::ArrayW<::UnityEngine::Android::AndroidAssetPackState*>>*& __cordl_internal_get_m_Callback();
  ...
  constexpr void __cordl_internal_set_m_Callback(::System::Action_2<uint64_t, ::ArrayW<::UnityEngine::Android::AndroidAssetPackState*>>* value);
  ...
  /// @brief Method .ctor, addr 0x68d74ac, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method onStatusResult, addr 0x68d75ac, size 0x360, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetAssetPackManager, addr 0x68d6b0c, size 0x380, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::Android::AndroidAssetPacks) == 0x10, "Size mismatch!");
