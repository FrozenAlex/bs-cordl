...
// Write type traits
MARK_REF_T(::UnityEngine::Android::AndroidGame*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Android::AndroidGame*, "UnityEngine.Android", "AndroidGame");
...
public:
  // Declarations
  /// @brief Method StopLoading, addr 0x68d72f8, size 0x3c, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Android::AndroidGame) == 0x10, "Size mismatch!");
