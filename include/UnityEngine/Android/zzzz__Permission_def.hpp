...
public:
  ...
  /// @brief Method GetUnityPermissions, addr 0x68d8108, size 0xac, virtual false, abstract: false, final false
  static inline ::UnityEngine::AndroidJavaObject* GetUnityPermissions();

  /// @brief Method HasUserAuthorizedPermission, addr 0x68d81b4, size 0x12c, virtual false, abstract: false, final false
  static inline bool HasUserAuthorizedPermission(::StringW permission);

  /// @brief Method RequestUserPermission, addr 0x68d82e0, size 0x8c, virtual false, abstract: false, final false
  static inline void RequestUserPermission(::StringW permission, ::UnityEngine::Android::PermissionCallbacks* callbacks);

  /// @brief Method RequestUserPermissions, addr 0x68d836c, size 0x140, virtual false, abstract: false, final false
