...
public:
  ...
  /// @brief Method Create, addr 0x6a3f8c8, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandle, addr 0x6a3f900, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal, addr 0x6a3fac4, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal_Injected, addr 0x6a3fe18, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x6a3fb7c, size 0x7c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Animations::AnimationClipPlayable other);

  /// @brief Method GetHandle, addr 0x6a3fb6c, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method SetApplyFootIK, addr 0x6a3fbf8, size 0x44, virtual false, abstract: false, final false
  inline void SetApplyFootIK(bool value);

  /// @brief Method SetApplyFootIKInternal, addr 0x6a3fc3c, size 0x44, virtual false, abstract: false, final false
  static inline void SetApplyFootIKInternal(::by_ref<::UnityEngine::Playables::PlayableHandle> handle, bool value);

  /// @brief Method SetLoopTime, addr 0x6a3fd90, size 0x44, virtual false, abstract: false, final false
  inline void SetLoopTime(bool value);

  /// @brief Method SetLoopTimeInternal, addr 0x6a3fdd4, size 0x44, virtual false, abstract: false, final false
  static inline void SetLoopTimeInternal(::by_ref<::UnityEngine::Playables::PlayableHandle> handle, bool value);

  /// @brief Method SetOverrideLoopTime, addr 0x6a3fd08, size 0x44, virtual false, abstract: false, final false
  inline void SetOverrideLoopTime(bool value);

  /// @brief Method SetOverrideLoopTimeInternal, addr 0x6a3fd4c, size 0x44, virtual false, abstract: false, final false
  static inline void SetOverrideLoopTimeInternal(::by_ref<::UnityEngine::Playables::PlayableHandle> handle, bool value);

  /// @brief Method SetRemoveStartOffset, addr 0x6a3fc80, size 0x44, virtual false, abstract: false, final false
  inline void SetRemoveStartOffset(bool value);

  /// @brief Method SetRemoveStartOffsetInternal, addr 0x6a3fcc4, size 0x44, virtual false, abstract: false, final false
  static inline void SetRemoveStartOffsetInternal(::by_ref<::UnityEngine::Playables::PlayableHandle> handle, bool value);

  /// @brief Method .ctor, addr 0x6a3f9b0, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x6a3fb78, size 0x4, virtual false, abstract: false, final false
