...
public:
  ...
  /// @brief Method Create, addr 0x6a407a0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandle, addr 0x6a4083c, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal, addr 0x6a40a60, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal_Injected, addr 0x6a40c08, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x6a40b64, size 0xa4, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Animations::AnimationMixerPlayable other);

  /// @brief Method GetHandle, addr 0x6a40af0, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method .ctor, addr 0x6a4094c, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x6a40afc, size 0x68, virtual false, abstract: false, final false
