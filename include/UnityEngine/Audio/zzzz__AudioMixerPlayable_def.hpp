...
public:
  ...
  /// @brief Method Create, addr 0x68fbdfc, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateAudioMixerPlayableInternal, addr 0x68fc04c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandle, addr 0x68fbe34, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x68fc130, size 0x7c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Audio::AudioMixerPlayable other);

  /// @brief Method GetHandle, addr 0x68fc0a0, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method .ctor, addr 0x68fbf38, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Explicit, addr 0x68fc0b0, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x68fc0ac, size 0x4, virtual false, abstract: false, final false
