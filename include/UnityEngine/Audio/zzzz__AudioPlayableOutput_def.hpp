...
public:
  ...
  /// @brief Method Create, addr 0x6a50f60, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEvaluateOnSeek, addr 0x6a51538, size 0x3c, virtual false, abstract: false, final false
  inline bool GetEvaluateOnSeek();

  /// @brief Method GetHandle, addr 0x6a512f8, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableOutputHandle GetHandle();

  /// @brief Method GetTarget, addr 0x6a51384, size 0x4, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::AudioSource> GetTarget();

  /// @brief Method InternalGetEvaluateOnSeek, addr 0x6a51574, size 0x3c, virtual false, abstract: false, final false
  static inline bool InternalGetEvaluateOnSeek(::by_ref<::UnityEngine::Playables::PlayableOutputHandle> output);

  /// @brief Method InternalGetTarget, addr 0x6a51388, size 0x120, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::AudioSource> InternalGetTarget(::by_ref<::UnityEngine::Playables::PlayableOutputHandle> output);

  /// @brief Method InternalGetTarget_Injected, addr 0x6a51638, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr InternalGetTarget_Injected(::by_ref<::UnityEngine::Playables::PlayableOutputHandle> output);

  /// @brief Method InternalSetEvaluateOnSeek, addr 0x6a515f4, size 0x44, virtual false, abstract: false, final false
  static inline void InternalSetEvaluateOnSeek(::by_ref<::UnityEngine::Playables::PlayableOutputHandle> output, bool value);

  /// @brief Method InternalSetTarget, addr 0x6a514a8, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalSetTarget_Injected, addr 0x6a51674, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method SetEvaluateOnSeek, addr 0x6a515b0, size 0x44, virtual false, abstract: false, final false
  inline void SetEvaluateOnSeek(bool value);

  /// @brief Method SetTarget, addr 0x6a512f4, size 0x4, virtual false, abstract: false, final false
  inline void SetTarget(::UnityEngine::AudioSource* value);

  /// @brief Method .ctor, addr 0x6a511e0, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Playables::PlayableOutputHandle handle);

  /// @brief Method get_Null, addr 0x6a51160, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Explicit, addr 0x6a51304, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x6a50fc0, size 0x4, virtual false, abstract: false, final false
