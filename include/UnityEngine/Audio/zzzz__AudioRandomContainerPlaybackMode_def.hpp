...
DEFINE_IL2CPP_CLASS(::UnityEngine::Audio::AudioRandomContainerPlaybackMode, "UnityEngine.Audio", "AudioRandomContainerPlaybackMode");
// Dependencies
namespace UnityEngine::Audio {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Audio::AudioRandomContainerPlaybackMode) == 0x4, "Size mismatch!");
