...
public:
  ...
  /// @brief Method .ctor, addr 0x6bae530, size 0xf8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method set_Name, addr 0x6bae528, size 0x8, virtual true, abstract: false, final true
