...
public:
  ...
  /// @brief Method .ctor, addr 0x6bae9dc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_ThrowsException, addr 0x6bae9d4, size 0x8, virtual true, abstract: false, final true
