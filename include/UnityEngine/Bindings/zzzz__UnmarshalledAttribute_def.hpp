...
// Write type traits
MARK_REF_T(::UnityEngine::Bindings::UnmarshalledAttribute*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Bindings::UnmarshalledAttribute*, "UnityEngine.Bindings", "UnmarshalledAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6a5f46c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::Bindings::UnmarshalledAttribute) == 0x10, "Size mismatch!");
