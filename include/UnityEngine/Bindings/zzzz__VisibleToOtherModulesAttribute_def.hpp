...
public:
  ...
  /// @brief Method .ctor, addr 0x6bae3e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6bae3ec, size 0x4, virtual false, abstract: false, final false
