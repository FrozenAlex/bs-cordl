...
public:
  ...
  /// @brief Method Clear, addr 0x6ccd1d0, size 0xc4, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ToString, addr 0x6cc1970, size 0x460, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_gameObject, addr 0x6ccd124, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_gameObject();

  /// @brief Method get_isValid, addr 0x6ccd134, size 0x9c, virtual false, abstract: false, final false
  inline bool get_isValid();

  /// @brief Method set_gameObject, addr 0x6ccd12c, size 0x8, virtual false, abstract: false, final false
