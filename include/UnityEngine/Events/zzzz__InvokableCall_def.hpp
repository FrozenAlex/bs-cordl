...
public:
  ...
  /// @brief Method Find, addr 0x6af5508, size 0x50, virtual true, abstract: false, final false
  inline bool Find(::System::Object* targetObj, ::System::Reflection::MethodInfo* method);

  /// @brief Method Invoke, addr 0x6af54cc, size 0x3c, virtual false, abstract: false, final false
  inline void Invoke();

  /// @brief Method Invoke, addr 0x6af5490, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6af548c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Events::UnityAction* action);

  /// @brief Method .ctor, addr 0x6af53b4, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* target, ::System::Reflection::MethodInfo* theFunction);

  /// @brief Method add_Delegate, addr 0x6af525c, size 0xac, virtual false, abstract: false, final false
  inline void add_Delegate(::UnityEngine::Events::UnityAction* value);

  /// @brief Method remove_Delegate, addr 0x6af5308, size 0xac, virtual false, abstract: false, final false
