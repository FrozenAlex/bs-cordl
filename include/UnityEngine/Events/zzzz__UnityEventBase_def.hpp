...
public:
  ...
  /// @brief Method AddCall, addr 0x69a7e04, size 0x14, virtual false, abstract: false, final false
  inline void AddCall(::UnityEngine::Events::BaseInvokableCall* call);

  /// @brief Method DirtyPersistentCalls, addr 0x69a7988, size 0x28, virtual false, abstract: false, final false
  inline void DirtyPersistentCalls();

  /// @brief Method FindMethod, addr 0x69a68ec, size 0x1c8, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* FindMethod(::UnityEngine::Events::PersistentCall* call);

  /// @brief Method FindMethod, addr 0x69a79b4, size 0x280, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCallsCount, addr 0x69a7dbc, size 0x14, virtual false, abstract: false, final false
  inline int32_t GetCallsCount();
  ...
  /// @brief Method GetValidMethodInfo, addr 0x69a7c34, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method PrepareInvoke, addr 0x69a7e40, size 0x20, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::Events::BaseInvokableCall*>* PrepareInvoke();

  /// @brief Method RebuildPersistentCallsIfNeeded, addr 0x69a7dd0, size 0x34, virtual false, abstract: false, final false
  inline void RebuildPersistentCallsIfNeeded();

  /// @brief Method RemoveAllListeners, addr 0x69a7e2c, size 0x14, virtual false, abstract: false, final false
  inline void RemoveAllListeners();

  /// @brief Method RemoveListener, addr 0x69a7e18, size 0x14, virtual false, abstract: false, final false
  inline void RemoveListener(::System::Object* targetObj, ::System::Reflection::MethodInfo* method);

  /// @brief Method ToString, addr 0x69a7e60, size 0x88, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x69a79b0, size 0x4, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x69a7984, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x69a78f8, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();
