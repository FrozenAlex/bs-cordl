...
public:
  ...
  /// @brief Method Equals, addr 0x69d98cc, size 0x7c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Experimental::Playables::MaterialEffectPlayable other);

  /// @brief Method GetHandle, addr 0x69d98c0, size 0xc, virtual true, abstract: false, final true
