...
public:
  ...
  /// @brief Method Internal_ScriptableRuntimeReflectionSystemWrapper_TickRealtimeProbes, addr 0x69d9cd8, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69d9cc4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_implementation, addr 0x69d9cc8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Experimental::Rendering::IScriptableRuntimeReflectionSystem* get_implementation();

  /// @brief Method set_implementation, addr 0x69d9cd0, size 0x8, virtual false, abstract: false, final false
