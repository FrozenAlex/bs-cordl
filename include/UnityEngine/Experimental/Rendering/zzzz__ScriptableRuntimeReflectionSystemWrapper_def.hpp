...
public:
  ...
  /// @brief Method Internal_ScriptableRuntimeReflectionSystemWrapper_TickRealtimeProbes, addr 0x6b291b8, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b291a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_implementation, addr 0x6b291a8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Experimental::Rendering::IScriptableRuntimeReflectionSystem* get_implementation();

  /// @brief Method set_implementation, addr 0x6b291b0, size 0x8, virtual false, abstract: false, final false
