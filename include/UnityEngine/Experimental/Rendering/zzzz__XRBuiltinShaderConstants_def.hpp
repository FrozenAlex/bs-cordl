...
public:
  ...
  /// @brief Method SetBuiltinShaderConstants, addr 0x673d9ec, size 0x154, virtual false, abstract: false, final false
  static inline void SetBuiltinShaderConstants(::UnityEngine::Rendering::CommandBuffer* cmd);

  /// @brief Method SetBuiltinShaderConstants, addr 0x673db40, size 0x64, virtual false, abstract: false, final false
  static inline void SetBuiltinShaderConstants(::UnityEngine::Rendering::RasterCommandBuffer* cmd);

  /// @brief Method Update, addr 0x673dba4, size 0x704, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateBuiltinShaderConstants, addr 0x673d5e4, size 0x408, virtual false, abstract: false, final false
