...
public:
  ...
  /// @brief Method Equals, addr 0x6e27ea8, size 0x7c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Experimental::Video::VideoClipPlayable other);

  /// @brief Method GetHandle, addr 0x6e27e9c, size 0xc, virtual true, abstract: false, final true
