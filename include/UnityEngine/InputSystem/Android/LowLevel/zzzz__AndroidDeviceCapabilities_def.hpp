...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::Android::LowLevel::AndroidDeviceCapabilities___c*);
...
public:
  ...
  /// @brief Method <ToString>b__8_0, addr 0x646a8a8, size 0x68, virtual false, abstract: false, final false
  inline ::StringW _ToString_b__8_0(::UnityEngine::InputSystem::Android::LowLevel::AndroidAxis i);

  /// @brief Method .ctor, addr 0x646a8a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::InputSystem::Android::LowLevel::AndroidDeviceCapabilities___c) == 0x10, "Size mismatch!");

} // namespace UnityEngine::InputSystem::Android::LowLevel
// Dependencies UnityEngine.InputSystem.Android.LowLevel.AndroidAxis, UnityEngine.InputSystem.Android.LowLevel.AndroidInputSource
namespace UnityEngine::InputSystem::Android::LowLevel {
// Is value type: true
...
public:
  ...
  /// @brief Method FromJson, addr 0x646a298, size 0xc4, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Android::LowLevel::AndroidDeviceCapabilities FromJson(::StringW json);

  /// @brief Method ToJson, addr 0x646a474, size 0x6c, virtual false, abstract: false, final false
  inline ::StringW ToJson();

  /// @brief Method ToString, addr 0x646a4e0, size 0x370, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::Android::LowLevel::AndroidDeviceCapabilities) == 0x28, "Size mismatch!");
