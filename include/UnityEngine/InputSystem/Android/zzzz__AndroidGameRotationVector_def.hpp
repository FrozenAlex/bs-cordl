...
public:
  ...
  /// @brief Method .ctor, addr 0x65a41d4, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::InputSystem::Android::AndroidGameRotationVector) == 0x190, "Size mismatch!");
