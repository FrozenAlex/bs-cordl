...
public:
  ...
  /// @brief Method .ctor, addr 0x646952c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::InputSystem::Android::AndroidMagneticFieldSensor) == 0x190, "Size mismatch!");
