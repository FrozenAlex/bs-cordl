...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::Android::AndroidProximity*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Android::AndroidProximity*, "UnityEngine.InputSystem.Android", "AndroidProximity");
...
public:
  ...
  /// @brief Method .ctor, addr 0x65a4114, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::InputSystem::Android::AndroidProximity) == 0x190, "Size mismatch!");
