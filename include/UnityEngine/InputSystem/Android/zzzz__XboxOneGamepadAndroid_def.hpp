...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::Android::XboxOneGamepadAndroid*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Android::XboxOneGamepadAndroid*, "UnityEngine.InputSystem.Android", "XboxOneGamepadAndroid");
...
public:
  ...
  /// @brief Method .ctor, addr 0x65a4054, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::InputSystem::Android::XboxOneGamepadAndroid) == 0x228, "Size mismatch!");
