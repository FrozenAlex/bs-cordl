...
// Write type traits
MARK_VAL_T(::UnityEngine::InputSystem::Composites::OneModifierComposite_ModifiersOrder);
MARK_REF_T(::UnityEngine::InputSystem::Composites::OneModifierComposite*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Composites::OneModifierComposite_ModifiersOrder, "UnityEngine.InputSystem.Composites", "OneModifierComposite/ModifiersOrder");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Composites::OneModifierComposite*, "UnityEngine.InputSystem.Composites", "OneModifierComposite");
// Dependencies
namespace UnityEngine::InputSystem::Composites {
// Is value type: true
...
public:
  ...
  static ::UnityEngine::InputSystem::Composites::OneModifierComposite_ModifiersOrder const Default;

  /// @brief Field Ordered value: I32(1)
  static ::UnityEngine::InputSystem::Composites::OneModifierComposite_ModifiersOrder const Ordered;
...
static_assert(offsetof(::UnityEngine::InputSystem::Composites::OneModifierComposite_ModifiersOrder, value__) == 0x0, "Offset mismatch!");
...
public:
  // Declarations
  using ModifiersOrder = ::UnityEngine::InputSystem::Composites::OneModifierComposite_ModifiersOrder;
  ...
  __declspec(property(get = __cordl_internal_get_modifiersOrder, put = __cordl_internal_set_modifiersOrder)) ::UnityEngine::InputSystem::Composites::OneModifierComposite_ModifiersOrder modifiersOrder;
  ...
  /// @brief Method DetermineValueTypeAndSize, addr 0x6504868, size 0x444, virtual false, abstract: false, final false
  ...
  /// @brief Method EvaluateMagnitude, addr 0x6504648, size 0x40, virtual true, abstract: false, final false
  inline float_t EvaluateMagnitude(::by_ref<::UnityEngine::InputSystem::InputBindingCompositeContext> context);

  /// @brief Method FinishSetup, addr 0x65047b4, size 0xb4, virtual true, abstract: false, final false
  inline void FinishSetup(::by_ref<::UnityEngine::InputSystem::InputBindingCompositeContext> context);

  /// @brief Method ModifierIsPressed, addr 0x6504688, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValue, addr 0x6504714, size 0xa0, virtual true, abstract: false, final false
  inline void ReadValue(::by_ref<::UnityEngine::InputSystem::InputBindingCompositeContext> context, void* buffer, int32_t bufferSize);

  /// @brief Method ReadValueAsObject, addr 0x6504cac, size 0x50, virtual true, abstract: false, final false
  ...
  constexpr ::UnityEngine::InputSystem::Composites::OneModifierComposite_ModifiersOrder const& __cordl_internal_get_modifiersOrder() const;

  constexpr ::UnityEngine::InputSystem::Composites::OneModifierComposite_ModifiersOrder& __cordl_internal_get_modifiersOrder();
  ...
  constexpr void __cordl_internal_set_modifiersOrder(::UnityEngine::InputSystem::Composites::OneModifierComposite_ModifiersOrder value);

  constexpr void __cordl_internal_set_overrideModifiersNeedToBePressedFirst(bool value);

  /// @brief Method .ctor, addr 0x6504cfc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_valueSizeInBytes, addr 0x6504640, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_valueSizeInBytes();

  /// @brief Method get_valueType, addr 0x6504638, size 0x8, virtual true, abstract: false, final false
...
static_assert(offsetof(::UnityEngine::InputSystem::Composites::OneModifierComposite, ___modifiersOrder) == 0x1c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::InputSystem::Composites::OneModifierComposite, ___m_ValueSizeInBytes) == 0x20, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::InputSystem::Composites::OneModifierComposite, ___m_ValueType) == 0x28, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::InputSystem::Composites::OneModifierComposite, ___m_BindingIsButton) == 0x30, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::InputSystem::Composites::OneModifierComposite) == 0x38, "Size mismatch!");
