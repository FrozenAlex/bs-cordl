...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::Vector2 (::UnityEngine::InputSystem::Composites::Vector2Composite::*)(
  ...
  constexpr static std::size_t addrs = 0x63ca60c;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<float_t (::UnityEngine::InputSystem::Composites::Vector2Composite::*)(::by_ref<::UnityEngine::InputSystem::InputBindingCompositeContext>)>(
  ...
  constexpr static std::size_t addrs = 0x63ca780;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::InputSystem::Composites::Vector2Composite::*)()>(&::UnityEngine::InputSystem::Composites::Vector2Composite::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x63ca7fc;
...
inline ::UnityEngine::Vector2 UnityEngine::InputSystem::Composites::Vector2Composite::ReadValue(::by_ref<::UnityEngine::InputSystem::InputBindingCompositeContext> context) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::InputSystem::Composites::Vector2Composite*>(), 10 })));
...
inline float_t UnityEngine::InputSystem::Composites::Vector2Composite::EvaluateMagnitude(::by_ref<::UnityEngine::InputSystem::InputBindingCompositeContext> context) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::InputSystem::Composites::Vector2Composite*>(), 8 })));
