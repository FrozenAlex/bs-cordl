...
MARK_REF_T(::UnityEngine::InputSystem::Composites::Vector3Composite*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Composites::Vector3Composite_Mode, "UnityEngine.InputSystem.Composites", "Vector3Composite/Mode");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Composites::Vector3Composite*, "UnityEngine.InputSystem.Composites", "Vector3Composite");
// Dependencies
namespace UnityEngine::InputSystem::Composites {
// Is value type: true
...
public:
  ...
  /// @brief Method EvaluateMagnitude, addr 0x63caaac, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadValue, addr 0x63ca844, size 0x268, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63cab3c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::InputSystem::Composites::Vector3Composite) == 0x30, "Size mismatch!");
