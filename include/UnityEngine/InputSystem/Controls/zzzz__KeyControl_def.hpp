...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::Controls::KeyControl*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Controls::KeyControl*, "UnityEngine.InputSystem.Controls", "KeyControl");
...
public:
  ...
  /// @brief Method RefreshConfiguration, addr 0x63b9bfc, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63b9d7c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_keyCode, addr 0x63b9bb0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Key get_keyCode();

  /// @brief Method get_scanCode, addr 0x63b9bc0, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_scanCode();

  /// @brief Method set_keyCode, addr 0x63b9bb8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::Controls::KeyControl) == 0x148, "Size mismatch!");
