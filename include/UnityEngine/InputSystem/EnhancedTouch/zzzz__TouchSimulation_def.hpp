...
public:
  ...
  __declspec(property(get = __cordl_internal_get_m_CurrentDisplayIndices, put = __cordl_internal_set_m_CurrentDisplayIndices)) ::ArrayW<int32_t> m_CurrentDisplayIndices;

  /// @brief Field m_CurrentPositions, offset 0x38, size 0x8
  __declspec(property(get = __cordl_internal_get_m_CurrentPositions, put = __cordl_internal_set_m_CurrentPositions)) ::ArrayW<::UnityEngine::Vector2> m_CurrentPositions;

  /// @brief Field m_LastTouchId, offset 0x58, size 0x4
  ...
  /// @brief Field m_OnDeviceChange, offset 0x60, size 0x8
  ...
  __declspec(property(get = __cordl_internal_get_m_Pointers, put = __cordl_internal_set_m_Pointers)) ::ArrayW<::UnityEngine::InputSystem::Pointer*> m_Pointers;

  /// @brief Field m_TouchIds, offset 0x50, size 0x8
  __declspec(property(get = __cordl_internal_get_m_TouchIds, put = __cordl_internal_set_m_TouchIds)) ::ArrayW<int32_t> m_TouchIds;

  /// @brief Field m_Touches, offset 0x48, size 0x8
  __declspec(property(get = __cordl_internal_get_m_Touches, put = __cordl_internal_set_m_Touches)) ::ArrayW<::UnityEngine::InputSystem::Controls::ButtonControl*> m_Touches;
  ...
  /// @brief Method AddPointer, addr 0x6467a94, size 0x184, virtual false, abstract: false, final false
  inline void AddPointer(::UnityEngine::InputSystem::Pointer* pointer);

  /// @brief Method Destroy, addr 0x64679bc, size 0xd8, virtual false, abstract: false, final false
  static inline void Destroy();

  /// @brief Method Disable, addr 0x64678d4, size 0xe8, virtual false, abstract: false, final false
  static inline void Disable();

  /// @brief Method Enable, addr 0x6467718, size 0x1bc, virtual false, abstract: false, final false
  static inline void Enable();

  /// @brief Method InstallStateChangeMonitors, addr 0x6469038, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDeviceChange, addr 0x646863c, size 0x150, virtual false, abstract: false, final false
  inline void OnDeviceChange(::UnityEngine::InputSystem::InputDevice* device, ::UnityEngine::InputSystem::InputDeviceChange change);

  /// @brief Method OnDisable, addr 0x6468cf8, size 0x15c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x646878c, size 0x3f4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnEvent, addr 0x6468064, size 0x568, virtual false, abstract: false, final false
  inline void OnEvent(::UnityEngine::InputSystem::LowLevel::InputEventPtr eventPtr, ::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method OnSourceControlChangedValue, addr 0x646903c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method RemovePointer, addr 0x6467c18, size 0x1ec, virtual false, abstract: false, final false
  inline void RemovePointer(::UnityEngine::InputSystem::Pointer* pointer);

  /// @brief Method UninstallStateChangeMonitors, addr 0x6469040, size 0x4, virtual false, abstract: false, final false
  inline void UninstallStateChangeMonitors(int32_t startIndex);

  /// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateChangeMonitor.NotifyControlStateChanged, addr 0x6469030, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateChangeMonitor.NotifyTimerExpired, addr 0x6469034, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method UpdateTouch, addr 0x6467e04, size 0x260, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<int32_t> const& __cordl_internal_get_m_CurrentDisplayIndices() const;

  constexpr ::ArrayW<int32_t>& __cordl_internal_get_m_CurrentDisplayIndices();

  constexpr ::ArrayW<::UnityEngine::Vector2> const& __cordl_internal_get_m_CurrentPositions() const;

  constexpr ::ArrayW<::UnityEngine::Vector2>& __cordl_internal_get_m_CurrentPositions();
  ...
  constexpr ::ArrayW<::UnityEngine::InputSystem::Pointer*> const& __cordl_internal_get_m_Pointers() const;

  constexpr ::ArrayW<::UnityEngine::InputSystem::Pointer*>& __cordl_internal_get_m_Pointers();

  constexpr ::ArrayW<int32_t> const& __cordl_internal_get_m_TouchIds() const;

  constexpr ::ArrayW<int32_t>& __cordl_internal_get_m_TouchIds();

  constexpr ::ArrayW<::UnityEngine::InputSystem::Controls::ButtonControl*> const& __cordl_internal_get_m_Touches() const;

  constexpr ::ArrayW<::UnityEngine::InputSystem::Controls::ButtonControl*>& __cordl_internal_get_m_Touches();

  constexpr void __cordl_internal_set__simulatedTouchscreen_k__BackingField(::UnityEngine::InputSystem::Touchscreen* value);

  constexpr void __cordl_internal_set_m_CurrentDisplayIndices(::ArrayW<int32_t> value);

  constexpr void __cordl_internal_set_m_CurrentPositions(::ArrayW<::UnityEngine::Vector2> value);
  ...
  constexpr void __cordl_internal_set_m_Pointers(::ArrayW<::UnityEngine::InputSystem::Pointer*> value);

  constexpr void __cordl_internal_set_m_TouchIds(::ArrayW<int32_t> value);

  constexpr void __cordl_internal_set_m_Touches(::ArrayW<::UnityEngine::InputSystem::Controls::ButtonControl*> value);

  /// @brief Method .ctor, addr 0x6469044, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityW<::UnityEngine::InputSystem::EnhancedTouch::TouchSimulation> getStaticF_s_Instance();

  /// @brief Method get_instance, addr 0x64676cc, size 0x4c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::InputSystem::EnhancedTouch::TouchSimulation> get_instance();

  /// @brief Method get_simulatedTouchscreen, addr 0x64676bc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_simulatedTouchscreen, addr 0x64676c4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::UnityEngine::InputSystem::Pointer*> ___m_Pointers;

  /// @brief Field m_CurrentPositions, offset: 0x38, size: 0x8, def value: None
  ::ArrayW<::UnityEngine::Vector2> ___m_CurrentPositions;

  /// @brief Field m_CurrentDisplayIndices, offset: 0x40, size: 0x8, def value: None
  ::ArrayW<int32_t> ___m_CurrentDisplayIndices;

  /// @brief Field m_Touches, offset: 0x48, size: 0x8, def value: None
  ::ArrayW<::UnityEngine::InputSystem::Controls::ButtonControl*> ___m_Touches;

  /// @brief Field m_TouchIds, offset: 0x50, size: 0x8, def value: None
  ::ArrayW<int32_t> ___m_TouchIds;

  /// @brief Field m_LastTouchId, offset: 0x58, size: 0x4, def value: None
  int32_t ___m_LastTouchId;

  /// @brief Field m_OnDeviceChange, offset: 0x60, size: 0x8, def value: None
...
static_assert(offsetof(::UnityEngine::InputSystem::EnhancedTouch::TouchSimulation, ___m_TouchIds) == 0x50, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::InputSystem::EnhancedTouch::TouchSimulation, ___m_LastTouchId) == 0x58, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::InputSystem::EnhancedTouch::TouchSimulation, ___m_OnDeviceChange) == 0x60, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::InputSystem::EnhancedTouch::TouchSimulation, ___m_OnEvent) == 0x68, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::InputSystem::EnhancedTouch::TouchSimulation) == 0x70, "Size mismatch!");
