...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::HID::HIDParser_HIDItemTypeAndTag, "UnityEngine.InputSystem.HID", "HIDParser/HIDItemTypeAndTag");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::HID::HIDParser*, "UnityEngine.InputSystem.HID", "HIDParser");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateGlobal, "UnityEngine.InputSystem.HID", "HIDParser/HIDItemStateGlobal");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateLocal, "UnityEngine.InputSystem.HID", "HIDParser/HIDItemStateLocal");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::HID::HIDParser_HIDReportData, "UnityEngine.InputSystem.HID", "HIDParser/HIDReportData");
...
public:
  // Declarations
  /// @brief Method FindOrAddReport, addr 0x6462d30, size 0x180, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::HID::HIDParser_HIDReportData) == 0xc, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::InputSystem::HID::HIDParser_HIDItemTypeAndTag) == 0x4, "Size mismatch!");
...
public:
  // Declarations
  /// @brief Method GetUsage, addr 0x6462bb4, size 0x114, virtual false, abstract: false, final false
  inline int32_t GetUsage(int32_t index);

  /// @brief Method Reset, addr 0x6462cc8, size 0x68, virtual false, abstract: false, final false
  static inline void Reset(::by_ref<::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateLocal> state);

  /// @brief Method SetUsage, addr 0x64629d4, size 0x15c, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateLocal) == 0x50, "Size mismatch!");
...
public:
  // Declarations
  /// @brief Method GetPhysicalMax, addr 0x6462f4c, size 0x9c, virtual false, abstract: false, final false
  inline int32_t GetPhysicalMax();

  /// @brief Method GetPhysicalMin, addr 0x6462eb0, size 0x9c, virtual false, abstract: false, final false
  inline int32_t GetPhysicalMin();

  /// @brief Method GetUsagePage, addr 0x6462b30, size 0x84, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateGlobal) == 0x50, "Size mismatch!");
...
public:
  ...
  /// @brief Method ParseReportDescriptor, addr 0x6461e30, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseReportDescriptor, addr 0x6461e98, size 0xad4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadData, addr 0x646296c, size 0x68, virtual false, abstract: false, final false
