...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (*)(::System::Nullable_1<int32_t>, ::UnityEngine::InputSystem::HID::HID_HIDReportType,
  ...
  constexpr static std::size_t addrs = 0x659d898;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::InputSystem::HID::HIDParser_HIDReportData>(),
                                                             { "FindOrAddReport",
                                                               {},
                                                               { ::i2c::type_of<::System::Nullable_1<int32_t>>(), ::i2c::type_of<::UnityEngine::InputSystem::HID::HID_HIDReportType>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (*)(::by_ref<::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateLocal>)>(
  ...
  constexpr static std::size_t addrs = 0x659d830;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateLocal>(),
                                                             { "Reset", {}, { ::i2c::type_of<::by_ref<::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateLocal>>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateLocal::*)(int32_t)>(
  ...
  constexpr static std::size_t addrs = 0x659d53c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateLocal>(), { "SetUsage", {}, { ::i2c::type_of<int32_t>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateLocal::*)(int32_t)>(
  ...
  constexpr static std::size_t addrs = 0x659d71c;
...
inline void UnityEngine::InputSystem::HID::HIDParser_HIDItemStateLocal::Reset(::by_ref<::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateLocal> state) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateLocal>(),
                                                           { "Reset", {}, { ::i2c::type_of<::by_ref<::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateLocal>>() } })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::InputSystem::HID::HID_UsagePage (::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateGlobal::*)(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateGlobal>(),
                                                { "GetUsagePage", {}, { ::i2c::type_of<int32_t>(), ::i2c::type_of<::by_ref<::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateLocal>>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateGlobal::*)()>(
  ...
  constexpr static std::size_t addrs = 0x659da18;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateGlobal>(), { "GetPhysicalMin", {}, {} })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateGlobal::*)()>(
  ...
  constexpr static std::size_t size = 0x9c;
  constexpr static std::size_t addrs = 0x659dab4;
...
UnityEngine::InputSystem::HID::HIDParser_HIDItemStateGlobal::GetUsagePage(int32_t index, ::by_ref<::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateLocal> localItemState) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateGlobal>(),
                                              { "GetUsagePage", {}, { ::i2c::type_of<int32_t>(), ::i2c::type_of<::by_ref<::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateLocal>>() } })));
  return ::cordl_internals::RunMethodRethrow<::UnityEngine::InputSystem::HID::HID_UsagePage>(*this, ___internal_method, index, localItemState);
}
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (*)(::ArrayW<uint8_t>, ::by_ref<::UnityEngine::InputSystem::HID::HID_HIDDeviceDescriptor>)>(
  ...
  constexpr static std::size_t size = 0x68;
  constexpr static std::size_t addrs = 0x659c998;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{},
        (::i2c::find_method(::i2c::class_of<::UnityEngine::InputSystem::HID::HIDParser*>(),
                            { "ParseReportDescriptor", {}, { ::i2c::type_of<::ArrayW<uint8_t>>(), ::i2c::type_of<::by_ref<::UnityEngine::InputSystem::HID::HID_HIDDeviceDescriptor>>() } })));
    return ___internal_method;
  }
};
//  Writing Method size for method: ::UnityEngine::InputSystem::HID::HIDParser.ParseReportDescriptor
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ...
        (::i2c::find_method(
            ...
            { "ParseReportDescriptor", {}, { ::i2c::type_of<uint8_t*>(), ::i2c::type_of<int32_t>(), ::i2c::type_of<::by_ref<::UnityEngine::InputSystem::HID::HID_HIDDeviceDescriptor>>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (*)(int32_t, uint8_t*, uint8_t*)>(&::UnityEngine::InputSystem::HID::HIDParser::ReadData)> {
  constexpr static std::size_t size = 0x68;
  constexpr static std::size_t addrs = 0x659d4d4;
...
inline bool UnityEngine::InputSystem::HID::HIDParser::ParseReportDescriptor(::ArrayW<uint8_t> buffer, ::by_ref<::UnityEngine::InputSystem::HID::HID_HIDDeviceDescriptor> deviceDescriptor) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{},
      (::i2c::find_method(::i2c::class_of<::UnityEngine::InputSystem::HID::HIDParser*>(),
                          { "ParseReportDescriptor", {}, { ::i2c::type_of<::ArrayW<uint8_t>>(), ::i2c::type_of<::by_ref<::UnityEngine::InputSystem::HID::HID_HIDDeviceDescriptor>>() } })));
...
inline bool UnityEngine::InputSystem::HID::HIDParser::ParseReportDescriptor(uint8_t* bufferPtr, int32_t bufferLength,
                                                                            ::by_ref<::UnityEngine::InputSystem::HID::HID_HIDDeviceDescriptor> deviceDescriptor) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{},
      (::i2c::find_method(
          ::i2c::class_of<::UnityEngine::InputSystem::HID::HIDParser*>(),
