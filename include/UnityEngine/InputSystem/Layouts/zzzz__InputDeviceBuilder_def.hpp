...
public:
  ...
  /// @brief Method Dispose, addr 0x64ef640, size 0x90, virtual true, abstract: false, final true
  inline void Dispose();
...
public:
  ...
  /// @brief Method AddChildControl, addr 0x65c29a8, size 0x718, virtual false, abstract: false, final false
  ...
  /// @brief Method AddChildControlIfMissing, addr 0x65c30c0, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method AddChildControls, addr 0x65c1830, size 0x5e8, virtual false, abstract: false, final false
  ...
  /// @brief Method AddChildren, addr 0x65c4694, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method AddControlToNode, addr 0x65c47a4, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method AddParentDisplayNameRecursive, addr 0x65c3a58, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method AddProcessors, addr 0x65c32b4, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyUseStateFrom, addr 0x65c262c, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method ChildControlOverridePath, addr 0x65c316c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeStateLayout, addr 0x65c1e18, size 0x814, virtual false, abstract: false, final false
  static inline void ComputeStateLayout(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method Dispose, addr 0x65c11a4, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method FinalizeControlHierarchy, addr 0x65c0cb4, size 0x240, virtual false, abstract: false, final false
  inline void FinalizeControlHierarchy();

  /// @brief Method FinalizeControlHierarchyRecursive, addr 0x65c3b24, size 0x3e8, virtual false, abstract: false, final false
  ...
  /// @brief Method FindOrLoadLayout, addr 0x65c11ac, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Layouts::InputControlLayout* FindOrLoadLayout(::StringW name);

  /// @brief Method Finish, addr 0x65c0ef4, size 0x230, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* Finish();

  /// @brief Method GetBestMidPoint, addr 0x65c41dc, size 0x4b8, virtual false, abstract: false, final false
  inline uint16_t GetBestMidPoint(::UnityEngine::InputSystem::InputDevice_ControlBitRangeNode parent, uint16_t startOffset);

  /// @brief Method GetControlIndex, addr 0x65c48d8, size 0xb8, virtual false, abstract: false, final false
  inline uint16_t GetControlIndex(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method InsertChildControl, addr 0x65c34dc, size 0x31c, virtual false, abstract: false, final false
  ...
  /// @brief Method InsertChildControlOverride, addr 0x65c27ec, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method InsertControlBitRangeNode, addr 0x65c3f0c, size 0x2d0, virtual false, abstract: false, final false
  ...
  /// @brief Method InstantiateLayout, addr 0x65c120c, size 0x624, virtual false, abstract: false, final false
  ...
  /// @brief Method InstantiateLayout, addr 0x65c0c40, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method Ref, addr 0x65c49d8, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Layouts::InputDeviceBuilder_RefInstance Ref();

  /// @brief Method Reset, addr 0x65c1124, size 0x80, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SetDisplayName, addr 0x65c3858, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method SetFormat, addr 0x65c3200, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x65c0ad8, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method ShiftChildIndicesInHierarchyOneUp, addr 0x65c37f8, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method get_instance, addr 0x65c4990, size 0x48, virtual false, abstract: false, final false
