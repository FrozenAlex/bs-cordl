...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::DeviceConfigurationEvent, "UnityEngine.InputSystem.LowLevel", "DeviceConfigurationEvent");
...
public:
  ...
  /// @brief Method Create, addr 0x65a7768, size 0x70, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::DeviceConfigurationEvent Create(int32_t deviceId, double_t time);

  /// @brief Method ToEventPtr, addr 0x65a7764, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x65a7758, size 0xc, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::DeviceConfigurationEvent) == 0x14, "Size mismatch!");
