...
public:
  ...
  /// @brief Method Create, addr 0x646cc00, size 0x70, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::DeviceConfigurationEvent Create(int32_t deviceId, double_t time);

  /// @brief Method ToEventPtr, addr 0x646cbfc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x646cbf0, size 0xc, virtual true, abstract: false, final true
