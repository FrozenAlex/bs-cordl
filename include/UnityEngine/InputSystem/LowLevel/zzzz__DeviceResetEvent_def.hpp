...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::DeviceResetEvent, "UnityEngine.InputSystem.LowLevel", "DeviceResetEvent");
...
public:
  ...
  /// @brief Method Create, addr 0x65a7864, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x65a7858, size 0xc, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::DeviceResetEvent) == 0x14, "Size mismatch!");
