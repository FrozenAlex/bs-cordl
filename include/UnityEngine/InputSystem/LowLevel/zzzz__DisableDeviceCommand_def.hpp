...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::DisableDeviceCommand, "UnityEngine.InputSystem.LowLevel", "DisableDeviceCommand");
...
public:
  ...
  /// @brief Method Create, addr 0x65a5c88, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x65a5c70, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x65a5c7c, size 0xc, virtual true, abstract: false, final true
  ...
  // Ctor Parameters []
  // @brief default ctor
  constexpr DisableDeviceCommand();
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::DisableDeviceCommand) == 0x8, "Size mismatch!");
