...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::DualMotorRumbleCommand, "UnityEngine.InputSystem.LowLevel", "DualMotorRumbleCommand");
...
public:
  ...
  /// @brief Method Create, addr 0x646aeb4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x646bbe4, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x646bbf0, size 0xc, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::DualMotorRumbleCommand) == 0x10, "Size mismatch!");
