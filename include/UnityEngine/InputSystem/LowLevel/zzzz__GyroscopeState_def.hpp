...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::GyroscopeState, "UnityEngine.InputSystem.LowLevel", "GyroscopeState");
...
public:
  ...
  /// @brief Method get_format, addr 0x646be64, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::Utilities::FourCC get_format();

  /// @brief Method get_kFormat, addr 0x646be58, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::GyroscopeState) == 0xc, "Size mismatch!");
