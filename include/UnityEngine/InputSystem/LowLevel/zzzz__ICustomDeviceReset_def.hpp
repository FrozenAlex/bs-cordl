...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::LowLevel::ICustomDeviceReset*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::ICustomDeviceReset*, "UnityEngine.InputSystem.LowLevel", "ICustomDeviceReset");
// Dependencies
namespace UnityEngine::InputSystem::LowLevel {
// Is value type: false
