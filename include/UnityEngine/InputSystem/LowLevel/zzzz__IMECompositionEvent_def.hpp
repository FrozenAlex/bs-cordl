...
public:
  ...
  /// @brief Method Create, addr 0x65a78f8, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x65a78ec, size 0xc, virtual true, abstract: false, final true
