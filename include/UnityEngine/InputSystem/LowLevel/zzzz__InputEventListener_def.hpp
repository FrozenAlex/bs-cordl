...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::LowLevel::InputEventListener_DisposableObserver*);
MARK_REF_T(::UnityEngine::InputSystem::LowLevel::InputEventListener_ObserverState*);
MARK_VAL_T(::UnityEngine::InputSystem::LowLevel::InputEventListener);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::InputEventListener_DisposableObserver*, "UnityEngine.InputSystem.LowLevel", "InputEventListener/DisposableObserver");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::InputEventListener_ObserverState*, "UnityEngine.InputSystem.LowLevel", "InputEventListener/ObserverState");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::InputEventListener, "UnityEngine.InputSystem.LowLevel", "InputEventListener");
...
public:
  ...
  /// @brief Method <.ctor>b__2_0, addr 0x65a8f6c, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65a8eec, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::InputEventListener_ObserverState) == 0x30, "Size mismatch!");
...
public:
  ...
  /// @brief Method Dispose, addr 0x65a906c, size 0x148, virtual true, abstract: false, final true
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x65a8f68, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::InputEventListener_DisposableObserver) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method Subscribe, addr 0x65a8d90, size 0x15c, virtual true, abstract: false, final true
  ...
  /// @brief Method op_Addition, addr 0x65a36e8, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Subtraction, addr 0x65a39bc, size 0x178, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::InputEventListener
...
#pragma pack(pop)
// Non member Declarations
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::InputEventListener) == 0x1, "Size mismatch!");
