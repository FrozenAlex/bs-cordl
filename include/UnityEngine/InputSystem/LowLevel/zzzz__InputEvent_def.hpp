...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::InputEvent, "UnityEngine.InputSystem.LowLevel", "InputEvent");
...
public:
  ...
  /// @brief Method Equals, addr 0x646d5dc, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextInMemory, addr 0x646d468, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextInMemoryChecked, addr 0x646d484, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x646d228, size 0x240, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x646cadc, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::Utilities::FourCC type, int32_t sizeInBytes, int32_t deviceId, double_t time);

  /// @brief Method get_deviceId, addr 0x646d124, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_deviceId();

  /// @brief Method get_eventId, addr 0x646d104, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_eventId();

  /// @brief Method get_handled, addr 0x646d200, size 0xc, virtual false, abstract: false, final false
  inline bool get_handled();

  /// @brief Method get_internalTime, addr 0x646d1f0, size 0x8, virtual false, abstract: false, final false
  inline double_t get_internalTime();

  /// @brief Method get_sizeInBytes, addr 0x646c2f4, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_sizeInBytes();

  /// @brief Method get_time, addr 0x646d134, size 0x58, virtual false, abstract: false, final false
  inline double_t get_time();

  /// @brief Method get_type, addr 0x646d05c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::FourCC get_type();

  /// @brief Method set_deviceId, addr 0x646d12c, size 0x8, virtual false, abstract: false, final false
  inline void set_deviceId(int32_t value);

  /// @brief Method set_eventId, addr 0x646d110, size 0x14, virtual false, abstract: false, final false
  inline void set_eventId(int32_t value);

  /// @brief Method set_handled, addr 0x646d20c, size 0x1c, virtual false, abstract: false, final false
  inline void set_handled(bool value);

  /// @brief Method set_internalTime, addr 0x646d1f8, size 0x8, virtual false, abstract: false, final false
  inline void set_internalTime(double_t value);

  /// @brief Method set_sizeInBytes, addr 0x646d06c, size 0x98, virtual false, abstract: false, final false
  inline void set_sizeInBytes(uint32_t value);

  /// @brief Method set_time, addr 0x646d18c, size 0x64, virtual false, abstract: false, final false
  inline void set_time(double_t value);

  /// @brief Method set_type, addr 0x646d064, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::InputEvent) == 0x14, "Size mismatch!");
