...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::LowLevel::InputRuntime*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::InputRuntime*, "UnityEngine.InputSystem.LowLevel", "InputRuntime");
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::InputRuntime) == 0x10, "Size mismatch!");
