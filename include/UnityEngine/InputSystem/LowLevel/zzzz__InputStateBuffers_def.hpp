...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::InputStateBuffers_DoubleBuffers, "UnityEngine.InputSystem.LowLevel", "InputStateBuffers/DoubleBuffers");
// Dependencies
namespace UnityEngine::InputSystem::LowLevel {
// Is value type: true
...
public:
  ...
  /// @brief Method GetBackBuffer, addr 0x65b351c, size 0x28, virtual false, abstract: false, final false
  inline void* GetBackBuffer(int32_t deviceIndex);

  /// @brief Method GetFrontBuffer, addr 0x65b3488, size 0x24, virtual false, abstract: false, final false
  inline void* GetFrontBuffer(int32_t deviceIndex);

  /// @brief Method SetBackBuffer, addr 0x65b3794, size 0x20, virtual false, abstract: false, final false
  inline void SetBackBuffer(int32_t deviceIndex, void* ptr);

  /// @brief Method SetFrontBuffer, addr 0x65b3778, size 0x1c, virtual false, abstract: false, final false
  inline void SetFrontBuffer(int32_t deviceIndex, void* ptr);

  /// @brief Method SwapBuffers, addr 0x65b3e50, size 0x34, virtual false, abstract: false, final false
  inline void SwapBuffers(int32_t deviceIndex);

  /// @brief Method get_valid, addr 0x65b3e40, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::InputStateBuffers_DoubleBuffers) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method AllocateAll, addr 0x65b35ac, size 0x100, virtual false, abstract: false, final false
  inline void AllocateAll(::ArrayW<::UnityEngine::InputSystem::InputDevice*> devices, int32_t deviceCount);

  /// @brief Method ComputeSizeOfSingleStateBuffer, addr 0x65b36ac, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method FreeAll, addr 0x65b37b4, size 0xe4, virtual false, abstract: false, final false
  inline void FreeAll();

  /// @brief Method GetBackBufferForDevice, addr 0x65b34ac, size 0x70, virtual false, abstract: false, final false
  static inline void* GetBackBufferForDevice(int32_t deviceIndex);

  /// @brief Method GetDoubleBuffersFor, addr 0x65b3350, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFrontBufferForDevice, addr 0x65b341c, size 0x6c, virtual false, abstract: false, final false
  static inline void* GetFrontBufferForDevice(int32_t deviceIndex);

  /// @brief Method MigrateAll, addr 0x65b3898, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method MigrateDoubleBuffer, addr 0x65b39f8, size 0x224, virtual false, abstract: false, final false
  static inline void MigrateDoubleBuffer(::UnityEngine::InputSystem::LowLevel::InputStateBuffers_DoubleBuffers newBuffer, ::ArrayW<::UnityEngine::InputSystem::InputDevice*> devices,
                                         int32_t deviceCount, ::UnityEngine::InputSystem::LowLevel::InputStateBuffers_DoubleBuffers oldBuffer);

  /// @brief Method MigrateSingleBuffer, addr 0x65b3c1c, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method NextDeviceOffset, addr 0x65b3d50, size 0xf0, virtual false, abstract: false, final false
  static inline uint32_t NextDeviceOffset(uint32_t currentOffset, ::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method SetUpDeviceToBufferMappings, addr 0x65b3718, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::InputStateBuffers_DoubleBuffers SetUpDeviceToBufferMappings(int32_t deviceCount, ::by_ref<uint8_t*> bufferPtr, uint32_t sizePerBuffer,
                                                                                                                  uint32_t mappingTableSizePerBuffer);

  /// @brief Method SwitchTo, addr 0x65b3544, size 0x68, virtual false, abstract: false, final false
