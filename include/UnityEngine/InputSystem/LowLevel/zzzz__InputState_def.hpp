...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::LowLevel::InputState*);
MARK_REF_T(::UnityEngine::InputSystem::LowLevel::InputState_StateChangeMonitorDelegate*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::InputState*, "UnityEngine.InputSystem.LowLevel", "InputState");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::InputState_StateChangeMonitorDelegate*, "UnityEngine.InputSystem.LowLevel", "InputState/StateChangeMonitorDelegate");
...
public:
  ...
  /// @brief Method NotifyControlStateChanged, addr 0x6475bd0, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method NotifyTimerExpired, addr 0x6475bf0, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x647590c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddChangeMonitor, addr 0x6475830, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method AddChangeMonitor, addr 0x64756c0, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method AddChangeMonitorTimeout, addr 0x6475a08, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method Change, addr 0x64752d8, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method IsIntegerFormat, addr 0x6475550, size 0x170, virtual false, abstract: false, final false
  static inline bool IsIntegerFormat(::UnityEngine::InputSystem::Utilities::FourCC format);

  /// @brief Method RemoveChangeMonitor, addr 0x6475910, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveChangeMonitorTimeout, addr 0x6475afc, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onChange, addr 0x64751f8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method get_currentTime, addr 0x6475120, size 0xd8, virtual false, abstract: false, final false
  static inline double_t get_currentTime();

  /// @brief Method get_currentUpdateType, addr 0x6475088, size 0x4c, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::InputUpdateType get_currentUpdateType();

  /// @brief Method get_updateCount, addr 0x64750d4, size 0x4c, virtual false, abstract: false, final false
  static inline uint32_t get_updateCount();

  /// @brief Method remove_onChange, addr 0x6475268, size 0x70, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::InputState) == 0x10, "Size mismatch!");
