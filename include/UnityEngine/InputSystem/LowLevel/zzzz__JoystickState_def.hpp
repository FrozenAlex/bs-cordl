...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::JoystickState_Button, "UnityEngine.InputSystem.LowLevel", "JoystickState/Button");
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::JoystickState_Button) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method get_format, addr 0x646bc08, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::Utilities::FourCC get_format();

  /// @brief Method get_kFormat, addr 0x646bbfc, size 0xc, virtual false, abstract: false, final false
