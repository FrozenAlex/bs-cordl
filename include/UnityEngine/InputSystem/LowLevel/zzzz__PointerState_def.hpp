...
public:
  ...
  /// @brief Method get_format, addr 0x65a699c, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::Utilities::FourCC get_format();

  /// @brief Method get_kFormat, addr 0x65a6990, size 0xc, virtual false, abstract: false, final false
