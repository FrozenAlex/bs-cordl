...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::QueryDimensionsCommand, "UnityEngine.InputSystem.LowLevel", "QueryDimensionsCommand");
...
public:
  ...
  /// @brief Method Create, addr 0x646b5b8, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x646b5a0, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x646b5ac, size 0xc, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::QueryDimensionsCommand) == 0x10, "Size mismatch!");
