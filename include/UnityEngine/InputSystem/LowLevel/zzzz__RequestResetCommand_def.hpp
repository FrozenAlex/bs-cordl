...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::RequestResetCommand, "UnityEngine.InputSystem.LowLevel", "RequestResetCommand");
...
public:
  ...
  /// @brief Method Create, addr 0x65a657c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x65a6564, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x65a6570, size 0xc, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::RequestResetCommand) == 0x8, "Size mismatch!");
