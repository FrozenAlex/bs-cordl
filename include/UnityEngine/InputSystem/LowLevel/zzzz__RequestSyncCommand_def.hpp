...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::RequestSyncCommand, "UnityEngine.InputSystem.LowLevel", "RequestSyncCommand");
...
public:
  ...
  /// @brief Method Create, addr 0x646ba3c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x646ba24, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x646ba30, size 0xc, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::RequestSyncCommand) == 0x8, "Size mismatch!");
