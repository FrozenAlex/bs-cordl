...
template <typename TSource, typename TResult> class SelectObservable_2_Select;
}
...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::InputSystem::LowLevel::SelectObservable_2);
MARK_GEN_REF_T_PTR(::UnityEngine::InputSystem::LowLevel::SelectObservable_2_Select);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::InputSystem::LowLevel::SelectObservable_2, "UnityEngine.InputSystem.LowLevel", "SelectObservable`2");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::InputSystem::LowLevel::SelectObservable_2_Select, "UnityEngine.InputSystem.LowLevel", "SelectObservable`2/Select");
// Dependencies System.Object
namespace UnityEngine::InputSystem::LowLevel {
// cpp template
template <typename TSource, typename TResult>
// Is value type: false
// CS Name: UnityEngine.InputSystem.LowLevel.SelectObservable`2/Select<TSource,TResult>
class CORDL_TYPE SelectObservable_2_Select : public ::System::Object {
public:
  // Declarations
  ...
  static inline ::UnityEngine::InputSystem::LowLevel::SelectObservable_2_Select<TSource, TResult>* New_ctor(::UnityEngine::InputSystem::LowLevel::SelectObservable_2<TSource, TResult>* observable,
  ...
  constexpr ::UnityEngine::InputSystem::LowLevel::SelectObservable_2<TSource, TResult>* const& __cordl_internal_get_m_Observable() const;
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr SelectObservable_2_Select();

public:
  // Ctor Parameters [CppParam { name: "", ty: "SelectObservable_2_Select", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SelectObservable_2_Select(SelectObservable_2_Select&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SelectObservable_2_Select", modifiers: "const&", def_value: None }]
...
public:
  // Declarations
  using Select = ::UnityEngine::InputSystem::LowLevel::SelectObservable_2_Select<TSource, TResult>;
  ...
  constexpr ::System::Func_2<TSource, TResult>* const& __cordl_internal_get_m_Filter() const;
