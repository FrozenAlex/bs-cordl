...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::OnScreen::UGUIOnScreenControlUtils*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::OnScreen::UGUIOnScreenControlUtils*, "UnityEngine.InputSystem.OnScreen", "UGUIOnScreenControlUtils");
...
static_assert(sizeof(::UnityEngine::InputSystem::OnScreen::UGUIOnScreenControlUtils) == 0x10, "Size mismatch!");
