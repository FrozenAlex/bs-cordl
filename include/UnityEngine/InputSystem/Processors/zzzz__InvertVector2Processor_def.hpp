...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::Processors::InvertVector2Processor*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Processors::InvertVector2Processor*, "UnityEngine.InputSystem.Processors", "InvertVector2Processor");
...
public:
  ...
  /// @brief Method Process, addr 0x647c380, size 0x24, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector2 Process(::UnityEngine::Vector2 value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x647c3a4, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x647c458, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::InputSystem::Processors::InvertVector2Processor) == 0x18, "Size mismatch!");
