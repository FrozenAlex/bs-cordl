...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::Processors::InvertVector3Processor*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Processors::InvertVector3Processor*, "UnityEngine.InputSystem.Processors", "InvertVector3Processor");
...
public:
  ...
  /// @brief Method Process, addr 0x647c4a0, size 0x34, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector3 Process(::UnityEngine::Vector3 value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x647c4d4, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x647c5ac, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::InputSystem::Processors::InvertVector3Processor) == 0x18, "Size mismatch!");
