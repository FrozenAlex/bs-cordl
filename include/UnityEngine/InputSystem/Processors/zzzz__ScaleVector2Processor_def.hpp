...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::Processors::ScaleVector2Processor*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Processors::ScaleVector2Processor*, "UnityEngine.InputSystem.Processors", "ScaleVector2Processor");
...
public:
  ...
  /// @brief Method Process, addr 0x65b7738, size 0x10, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector2 Process(::UnityEngine::Vector2 value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x65b7748, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65b77fc, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::InputSystem::Processors::ScaleVector2Processor) == 0x18, "Size mismatch!");
