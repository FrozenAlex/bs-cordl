...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::Processors::StickDeadzoneProcessor*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Processors::StickDeadzoneProcessor*, "UnityEngine.InputSystem.Processors", "StickDeadzoneProcessor");
...
public:
  ...
  /// @brief Method GetDeadZoneAdjustedValue, addr 0x647cfdc, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method Process, addr 0x647cf04, size 0xd8, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector2 Process(::UnityEngine::Vector2 value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x647d04c, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x647d108, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_maxOrDefault, addr 0x647ce90, size 0x74, virtual false, abstract: false, final false
  inline float_t get_maxOrDefault();

  /// @brief Method get_minOrDefault, addr 0x647ce1c, size 0x74, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::Processors::StickDeadzoneProcessor) == 0x18, "Size mismatch!");
