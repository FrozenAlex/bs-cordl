...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::UI::UIPointerType, "UnityEngine.InputSystem.UI", "UIPointerType");
// Dependencies
namespace UnityEngine::InputSystem::UI {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::InputSystem::UI::UIPointerType) == 0x4, "Size mismatch!");
