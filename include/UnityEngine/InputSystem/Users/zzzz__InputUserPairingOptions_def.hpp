...
public:
  ...
  /// @brief Field ForcePlatformUserAccountSelection value: I32(1)
  ...
  /// @brief Field UnpairCurrentDevicesFromUser value: I32(8)
...
static_assert(sizeof(::UnityEngine::InputSystem::Users::InputUserPairingOptions) == 0x4, "Size mismatch!");
