...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::Utilities::ArrayHelpers*);
MARK_GEN_REF_T_PTR(::UnityEngine::InputSystem::Utilities::ArrayHelpers___c__DisplayClass33_0_1);
MARK_GEN_REF_T_PTR(::UnityEngine::InputSystem::Utilities::ArrayHelpers___c__DisplayClass34_0_1);
MARK_GEN_REF_T_PTR(::UnityEngine::InputSystem::Utilities::ArrayHelpers___c__DisplayClass34_1_1);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Utilities::ArrayHelpers*, "UnityEngine.InputSystem.Utilities", "ArrayHelpers");
...
public:
  ...
  template <typename TValue> static inline int32_t Append(::by_ref<::ArrayW<TValue>> array, TValue value);
  ...
  template <typename TValue> static inline int32_t AppendWithCapacity(::by_ref<::ArrayW<TValue>> array, ::by_ref<int32_t> count, TValue value, int32_t capacityIncrement);
  ...
  template <typename TValue> static inline void DuplicateWithCapacity(::by_ref<::ArrayW<TValue>> array, int32_t count, int32_t capacity, int32_t capacityIncrement);

  /// @brief Method EnsureCapacity, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename TValue> static inline void EnsureCapacity(::by_ref<::ArrayW<TValue>> array, int32_t count, int32_t capacity, int32_t capacityIncrement);

  /// @brief Method Erase, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename TValue> static inline bool Erase(::by_ref<::ArrayW<TValue>> array, TValue value);

  /// @brief Method EraseAt, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename TValue> static inline void EraseAt(::by_ref<::ArrayW<TValue>> array, int32_t index);
  ...
  template <typename TValue> static inline void MoveSlice(::ArrayW<TValue> array, int32_t sourceIndex, int32_t destinationIndex, int32_t count);
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::InputSystem::Utilities::ArrayHelpers) == 0x10, "Size mismatch!");
