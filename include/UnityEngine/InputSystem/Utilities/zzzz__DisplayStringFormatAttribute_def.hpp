...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::Utilities::DisplayStringFormatAttribute*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Utilities::DisplayStringFormatAttribute*, "UnityEngine.InputSystem.Utilities", "DisplayStringFormatAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x63bf08c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW formatString);

  /// @brief Method get_formatString, addr 0x63bf07c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_formatString();

  /// @brief Method set_formatString, addr 0x63bf084, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::Utilities::DisplayStringFormatAttribute) == 0x18, "Size mismatch!");
