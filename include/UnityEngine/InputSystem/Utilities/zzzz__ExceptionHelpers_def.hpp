...
public:
  // Declarations
  /// @brief Method IsExceptionIndicatingBugInCode, addr 0x64f9a50, size 0xf0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::Utilities::ExceptionHelpers) == 0x10, "Size mismatch!");
