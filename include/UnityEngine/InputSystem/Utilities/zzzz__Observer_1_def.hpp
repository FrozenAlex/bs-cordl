...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::InputSystem::Utilities::Observer_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::InputSystem::Utilities::Observer_1, "UnityEngine.InputSystem.Utilities", "Observer`1");
