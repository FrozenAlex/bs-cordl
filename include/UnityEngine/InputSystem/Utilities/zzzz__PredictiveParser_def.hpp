...
public:
  // Declarations
  /// @brief Method AcceptInt, addr 0x63c52e8, size 0x58, virtual false, abstract: false, final false
  inline void AcceptInt(::System::ReadOnlySpan_1<char16_t> str);

  /// @brief Method AcceptSingleChar, addr 0x63c5184, size 0x34, virtual false, abstract: false, final false
  inline bool AcceptSingleChar(::System::ReadOnlySpan_1<char16_t> str, char16_t c);

  /// @brief Method AcceptString, addr 0x63c51b8, size 0x130, virtual false, abstract: false, final false
  inline bool AcceptString(::System::ReadOnlySpan_1<char16_t> input, ::by_ref<::System::ReadOnlySpan_1<char16_t>> output);

  /// @brief Method ExpectInt, addr 0x63c4e68, size 0x11c, virtual false, abstract: false, final false
  inline int32_t ExpectInt(::System::ReadOnlySpan_1<char16_t> str);

  /// @brief Method ExpectSingleChar, addr 0x63c4d70, size 0xf8, virtual false, abstract: false, final false
  inline void ExpectSingleChar(::System::ReadOnlySpan_1<char16_t> str, char16_t c);

  /// @brief Method ExpectString, addr 0x63c4f84, size 0x200, virtual false, abstract: false, final false
