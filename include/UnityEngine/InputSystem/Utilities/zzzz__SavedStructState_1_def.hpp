...
MARK_GEN_REF_T_PTR(::UnityEngine::InputSystem::Utilities::SavedStructState_1_TypedRestore);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::InputSystem::Utilities::SavedStructState_1, "UnityEngine.InputSystem.Utilities", "SavedStructState`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::InputSystem::Utilities::SavedStructState_1_TypedRestore, "UnityEngine.InputSystem.Utilities", "SavedStructState`1/TypedRestore");
...
public:
  ...
  inline ::System::IAsyncResult* BeginInvoke(::by_ref<T> state, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
  inline void EndInvoke(::by_ref<T> state, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
  inline void Invoke(::by_ref<T> state);
...
public:
  ...
  static inline ::UnityEngine::InputSystem::Utilities::SavedStructState_1<T>* New_ctor(::by_ref<T> state, ::UnityEngine::InputSystem::Utilities::SavedStructState_1_TypedRestore<T>* restoreAction,
  ...
  /// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline void _ctor(::by_ref<T> state, ::UnityEngine::InputSystem::Utilities::SavedStructState_1_TypedRestore<T>* restoreAction, ::System::Action* staticDisposeCurrentState);
