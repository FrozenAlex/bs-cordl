...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::InputSystem::Utilities::SelectManyObservable_2);
MARK_GEN_REF_T_PTR(::UnityEngine::InputSystem::Utilities::SelectManyObservable_2_Select);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::InputSystem::Utilities::SelectManyObservable_2, "UnityEngine.InputSystem.Utilities", "SelectManyObservable`2");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::InputSystem::Utilities::SelectManyObservable_2_Select, "UnityEngine.InputSystem.Utilities", "SelectManyObservable`2/Select");
