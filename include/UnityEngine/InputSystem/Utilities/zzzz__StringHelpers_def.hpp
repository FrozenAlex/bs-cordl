...
public:
  ...
  /// @brief Method MoveNext, addr 0x6502674, size 0x140, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::InputSystem::Utilities::StringHelpers__Split_d__9* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<System.String>.GetEnumerator, addr 0x65027fc, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.String>.get_Current, addr 0x65027b4, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Collections_Generic_IEnumerator_System_String__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x650289c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x65027bc, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x65027f4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x6502670, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6501d30, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x65028a4, size 0x1fc, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::InputSystem::Utilities::StringHelpers__Tokenize_d__8* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.Utilities.Substring>.GetEnumerator, addr 0x6502b50, size 0x98, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.InputSystem.Utilities.Substring>.get_Current, addr 0x6502aac, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x6502be8, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x6502ab8, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x6502af0, size 0x60, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x65028a0, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method .ctor, addr 0x6501c94, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
public:
  ...
  /// @brief Method CharacterSeparatedListsHaveAtLeastOneCommonElement, addr 0x6501d50, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method Contains, addr 0x6501660, size 0x28, virtual false, abstract: false, final false
  static inline bool Contains(::StringW str, char16_t ch);

  /// @brief Method Contains, addr 0x6501688, size 0x28, virtual false, abstract: false, final false
  static inline bool Contains(::StringW str, ::StringW text, ::System::StringComparison comparison);

  /// @brief Method CountOccurrences, addr 0x6501bb0, size 0x74, virtual false, abstract: false, final false
  static inline int32_t CountOccurrences(::StringW str, char16_t ch);

  /// @brief Method Escape, addr 0x6501334, size 0x1a0, virtual false, abstract: false, final false
  static inline ::StringW Escape(::StringW str, ::StringW chars, ::StringW replacements);

  /// @brief Method ExpandTemplateString, addr 0x6502484, size 0x1ec, virtual false, abstract: false, final false
  static inline ::StringW ExpandTemplateString(::StringW _cordl_template, ::System::Func_2<::StringW, ::StringW>* mapFunc);

  /// @brief Method FromNicifiedMemorySize, addr 0x6501a18, size 0x198, virtual false, abstract: false, final false
  static inline bool FromNicifiedMemorySize(::StringW text, ::by_ref<int64_t> result, int64_t defaultMultiplier);

  /// @brief Method GetPlural, addr 0x65016b0, size 0x1c4, virtual false, abstract: false, final false
  static inline ::StringW GetPlural(::StringW str);

  /// @brief Method InvariantEqualsIgnoreCase, addr 0x6502450, size 0x34, virtual false, abstract: false, final false
  static inline bool InvariantEqualsIgnoreCase(::StringW left, ::StringW right);

  /// @brief Method IsPrintable, addr 0x6502304, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method NicifyMemorySize, addr 0x6501874, size 0x1a4, virtual false, abstract: false, final false
  static inline ::StringW NicifyMemorySize(int64_t numBytes);

  /// @brief Method ParseInt, addr 0x6501fe4, size 0x7c, virtual false, abstract: false, final false
  static inline int32_t ParseInt(::StringW str, int32_t pos);

  /// @brief Method ReadStringFromBuffer, addr 0x65021f0, size 0x18, virtual false, abstract: false, final false
  static inline ::StringW ReadStringFromBuffer(::System::IntPtr buffer, int32_t bufferSize);

  /// @brief Method ReadStringFromBuffer, addr 0x6502208, size 0xfc, virtual false, abstract: false, final false
  static inline ::StringW ReadStringFromBuffer(::System::IntPtr buffer, int32_t bufferSize, ::by_ref<uint32_t> offset);

  /// @brief Method Split, addr 0x6501cb4, size 0x7c, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<::StringW>* Split(::StringW str, ::System::Func_2<char16_t, bool>* predicate);

  /// @brief Method Tokenize, addr 0x6501c24, size 0x70, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::Utilities::Substring>* Tokenize(::StringW str);

  /// @brief Method Unescape, addr 0x65014d4, size 0x18c, virtual false, abstract: false, final false
  static inline ::StringW Unescape(::StringW str, ::StringW chars, ::StringW replacements);

  /// @brief Method WithAllWhitespaceStripped, addr 0x6502370, size 0xe0, virtual false, abstract: false, final false
  static inline ::StringW WithAllWhitespaceStripped(::StringW str);

  /// @brief Method WriteStringToBuffer, addr 0x6502060, size 0x1c, virtual false, abstract: false, final false
  static inline bool WriteStringToBuffer(::StringW text, ::System::IntPtr buffer, int32_t bufferSizeInCharacters);

  /// @brief Method WriteStringToBuffer, addr 0x650207c, size 0x174, virtual false, abstract: false, final false
