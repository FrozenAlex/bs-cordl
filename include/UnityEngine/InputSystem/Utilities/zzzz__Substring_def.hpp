...
public:
  ...
  /// @brief Method Compare, addr 0x63c84a4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareTo, addr 0x63c83f4, size 0x40, virtual true, abstract: false, final true
  inline int32_t CompareTo(::UnityEngine::InputSystem::Utilities::Substring other);

  /// @brief Method Equals, addr 0x63c8284, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x63c8344, size 0xb0, virtual false, abstract: false, final false
  inline bool Equals(::StringW other);

  /// @brief Method Equals, addr 0x63c8434, size 0x70, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::InputSystem::Utilities::InternedString other);

  /// @brief Method Equals, addr 0x63c832c, size 0x18, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::InputSystem::Utilities::Substring other);

  /// @brief Method GetHashCode, addr 0x63c85bc, size 0x50, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method StartsWith, addr 0x63c84d0, size 0x90, virtual false, abstract: false, final false
  inline bool StartsWith(::StringW str);

  /// @brief Method Substr, addr 0x63c8560, size 0x30, virtual false, abstract: false, final false
  inline ::StringW Substr(int32_t index, int32_t length);

  /// @brief Method ToString, addr 0x63c8590, size 0x2c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x63c8240, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(::StringW str);

  /// @brief Method .ctor, addr 0x63c8260, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW str, int32_t index);

  /// @brief Method .ctor, addr 0x63c80e4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW str, int32_t index, int32_t length);

  /// @brief Method get_Item, addr 0x63c8754, size 0x94, virtual false, abstract: false, final false
  inline char16_t get_Item(int32_t index);

  /// @brief Method get_index, addr 0x63c874c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_index();

  /// @brief Method get_isEmpty, addr 0x63c8230, size 0x10, virtual false, abstract: false, final false
  inline bool get_isEmpty();

  /// @brief Method get_length, addr 0x63c8744, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x63c86c8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x63c866c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x63c860c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x63c872c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x63c86f8, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x63c8698, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x63c863c, size 0x30, virtual false, abstract: false, final false
