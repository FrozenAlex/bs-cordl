...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Utilities::Vector2MagnitudeComparer, "UnityEngine.InputSystem.Utilities", "Vector2MagnitudeComparer");
// Dependencies
namespace UnityEngine::InputSystem::Utilities {
// Is value type: true
...
public:
  ...
  /// @brief Method Compare, addr 0x64f925c, size 0x28, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::InputSystem::Utilities::Vector2MagnitudeComparer) == 0x1, "Size mismatch!");
