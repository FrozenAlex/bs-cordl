...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::InputSystem::Utilities::WhereObservable_1);
MARK_GEN_REF_T_PTR(::UnityEngine::InputSystem::Utilities::WhereObservable_1_Where);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::InputSystem::Utilities::WhereObservable_1, "UnityEngine.InputSystem.Utilities", "WhereObservable`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::InputSystem::Utilities::WhereObservable_1_Where, "UnityEngine.InputSystem.Utilities", "WhereObservable`1/Where");
