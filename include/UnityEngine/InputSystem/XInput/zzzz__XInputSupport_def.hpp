...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::XInput::XInputSupport*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::XInput::XInputSupport*, "UnityEngine.InputSystem.XInput", "XInputSupport");
...
public:
  // Declarations
  /// @brief Method Initialize, addr 0x644a0c4, size 0x78, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::XInput::XInputSupport) == 0x10, "Size mismatch!");
