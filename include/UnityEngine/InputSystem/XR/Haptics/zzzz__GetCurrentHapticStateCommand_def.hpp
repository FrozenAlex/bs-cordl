...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::XR::Haptics::GetCurrentHapticStateCommand, "UnityEngine.InputSystem.XR.Haptics", "GetCurrentHapticStateCommand");
...
public:
  ...
  /// @brief Method Create, addr 0x6449ef0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x6449ed0, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_currentState, addr 0x6449ee8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::XR::Haptics::HapticState get_currentState();

  /// @brief Method get_typeStatic, addr 0x6449edc, size 0xc, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::InputSystem::XR::Haptics::GetCurrentHapticStateCommand) == 0x10, "Size mismatch!");
