...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::XR::Haptics::GetHapticCapabilitiesCommand, "UnityEngine.InputSystem.XR.Haptics", "GetHapticCapabilitiesCommand");
...
static_assert(sizeof(::UnityEngine::InputSystem::XR::Haptics::GetHapticCapabilitiesCommand) == 0x1c, "Size mismatch!");
