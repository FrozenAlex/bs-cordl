...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::XR::Haptics::HapticState, "UnityEngine.InputSystem.XR.Haptics", "HapticState");
// Dependencies
namespace UnityEngine::InputSystem::XR::Haptics {
// Is value type: true
...
public:
  ...
  /// @brief Method .ctor, addr 0x6449ea8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(uint32_t samplesQueued, uint32_t samplesAvailable);

  /// @brief Method get_samplesAvailable, addr 0x6449ec0, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_samplesAvailable();

  /// @brief Method get_samplesQueued, addr 0x6449eb0, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_samplesQueued();

  /// @brief Method set_samplesAvailable, addr 0x6449ec8, size 0x8, virtual false, abstract: false, final false
  inline void set_samplesAvailable(uint32_t value);

  /// @brief Method set_samplesQueued, addr 0x6449eb8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::XR::Haptics::HapticState) == 0x8, "Size mismatch!");
