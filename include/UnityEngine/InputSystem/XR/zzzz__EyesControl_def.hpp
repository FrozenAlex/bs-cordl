...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::XR::EyesControl*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::XR::EyesControl*, "UnityEngine.InputSystem.XR", "EyesControl");
...
public:
  ...
  /// @brief Method FinishSetup, addr 0x6448b5c, size 0x1cc, virtual true, abstract: false, final false
  inline void FinishSetup();

  static inline ::UnityEngine::InputSystem::XR::EyesControl* New_ctor();

  /// @brief Method ReadUnprocessedValueFromState, addr 0x6448d28, size 0x1c4, virtual true, abstract: false, final false
  inline ::UnityEngine::InputSystem::XR::Eyes ReadUnprocessedValueFromState(void* statePtr);

  /// @brief Method WriteValueIntoState, addr 0x6448eec, size 0x114, virtual true, abstract: false, final false
  inline void WriteValueIntoState(::UnityEngine::InputSystem::XR::Eyes value, void* statePtr);
  ...
  /// @brief Method .ctor, addr 0x6449000, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_fixationPoint, addr 0x6448b2c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_fixationPoint();

  /// @brief Method get_leftEyeOpenAmount, addr 0x6448b3c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::AxisControl* get_leftEyeOpenAmount();

  /// @brief Method get_leftEyePosition, addr 0x6448aec, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_leftEyePosition();

  /// @brief Method get_leftEyeRotation, addr 0x6448afc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::QuaternionControl* get_leftEyeRotation();

  /// @brief Method get_rightEyeOpenAmount, addr 0x6448b4c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::AxisControl* get_rightEyeOpenAmount();

  /// @brief Method get_rightEyePosition, addr 0x6448b0c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_rightEyePosition();

  /// @brief Method get_rightEyeRotation, addr 0x6448b1c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::QuaternionControl* get_rightEyeRotation();

  /// @brief Method set_fixationPoint, addr 0x6448b34, size 0x8, virtual false, abstract: false, final false
  inline void set_fixationPoint(::UnityEngine::InputSystem::Controls::Vector3Control* value);

  /// @brief Method set_leftEyeOpenAmount, addr 0x6448b44, size 0x8, virtual false, abstract: false, final false
  inline void set_leftEyeOpenAmount(::UnityEngine::InputSystem::Controls::AxisControl* value);

  /// @brief Method set_leftEyePosition, addr 0x6448af4, size 0x8, virtual false, abstract: false, final false
  inline void set_leftEyePosition(::UnityEngine::InputSystem::Controls::Vector3Control* value);

  /// @brief Method set_leftEyeRotation, addr 0x6448b04, size 0x8, virtual false, abstract: false, final false
  inline void set_leftEyeRotation(::UnityEngine::InputSystem::Controls::QuaternionControl* value);

  /// @brief Method set_rightEyeOpenAmount, addr 0x6448b54, size 0x8, virtual false, abstract: false, final false
  inline void set_rightEyeOpenAmount(::UnityEngine::InputSystem::Controls::AxisControl* value);

  /// @brief Method set_rightEyePosition, addr 0x6448b14, size 0x8, virtual false, abstract: false, final false
  inline void set_rightEyePosition(::UnityEngine::InputSystem::Controls::Vector3Control* value);

  /// @brief Method set_rightEyeRotation, addr 0x6448b24, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::XR::EyesControl) == 0x1d0, "Size mismatch!");
