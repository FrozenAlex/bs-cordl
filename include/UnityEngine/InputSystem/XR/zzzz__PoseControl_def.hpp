...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::XR::PoseControl*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::XR::PoseControl*, "UnityEngine.InputSystem.XR", "PoseControl");
// Dependencies UnityEngine.InputSystem.InputControl`1<TValue>, UnityEngine.InputSystem.XR.PoseState
namespace UnityEngine::InputSystem::XR {
// Is value type: false
...
public:
  ...
  /// @brief Method CalculateOptimizedControlDataType, addr 0x6444f04, size 0x220, virtual true, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::FourCC CalculateOptimizedControlDataType();

  /// @brief Method FinishSetup, addr 0x64449c0, size 0x1b8, virtual true, abstract: false, final false
  inline void FinishSetup();

  static inline ::UnityEngine::InputSystem::XR::PoseControl* New_ctor();

  /// @brief Method ReadUnprocessedValueFromState, addr 0x6444b78, size 0x208, virtual true, abstract: false, final false
  inline ::UnityEngine::InputSystem::XR::PoseState ReadUnprocessedValueFromState(void* statePtr);

  /// @brief Method WriteValueIntoState, addr 0x6444d80, size 0x184, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6444910, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_angularVelocity, addr 0x6444900, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_angularVelocity();

  /// @brief Method get_isTracked, addr 0x64448b0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_isTracked();

  /// @brief Method get_position, addr 0x64448d0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_position();

  /// @brief Method get_rotation, addr 0x64448e0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::QuaternionControl* get_rotation();

  /// @brief Method get_trackingState, addr 0x64448c0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::IntegerControl* get_trackingState();

  /// @brief Method get_velocity, addr 0x64448f0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_velocity();

  /// @brief Method set_angularVelocity, addr 0x6444908, size 0x8, virtual false, abstract: false, final false
  inline void set_angularVelocity(::UnityEngine::InputSystem::Controls::Vector3Control* value);

  /// @brief Method set_isTracked, addr 0x64448b8, size 0x8, virtual false, abstract: false, final false
  inline void set_isTracked(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_position, addr 0x64448d8, size 0x8, virtual false, abstract: false, final false
  inline void set_position(::UnityEngine::InputSystem::Controls::Vector3Control* value);

  /// @brief Method set_rotation, addr 0x64448e8, size 0x8, virtual false, abstract: false, final false
  inline void set_rotation(::UnityEngine::InputSystem::Controls::QuaternionControl* value);

  /// @brief Method set_trackingState, addr 0x64448c8, size 0x8, virtual false, abstract: false, final false
  inline void set_trackingState(::UnityEngine::InputSystem::Controls::IntegerControl* value);

  /// @brief Method set_velocity, addr 0x64448f8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::XR::PoseControl) == 0x1a8, "Size mismatch!");
