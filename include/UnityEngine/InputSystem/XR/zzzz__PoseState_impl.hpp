...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (::UnityEngine::InputSystem::XR::PoseState::*)()>(
    &::UnityEngine::InputSystem::XR::PoseState::get_format)> {
  constexpr static std::size_t size = 0x5c;
  constexpr static std::size_t addrs = 0x657f180;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::InputSystem::XR::PoseState>(), { "get_format", {}, {} })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::InputSystem::XR::PoseState::*)(bool, ::UnityEngine::XR::InputTrackingState, ::UnityEngine::Vector3,
                                                                                                           ::UnityEngine::Quaternion, ::UnityEngine::Vector3, ::UnityEngine::Vector3)>(
    &::UnityEngine::InputSystem::XR::PoseState::_ctor)> {
  constexpr static std::size_t size = 0x3c;
  constexpr static std::size_t addrs = 0x657f1dc;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::InputSystem::XR::PoseState>(),
                                                             { ".ctor",
                                                               {},
                                                               { ::i2c::type_of<bool>(), ::i2c::type_of<::UnityEngine::XR::InputTrackingState>(), ::i2c::type_of<::UnityEngine::Vector3>(),
...
inline void UnityEngine::InputSystem::XR::PoseState::setStaticF_s_Format(::UnityEngine::InputSystem::Utilities::FourCC value) {
  ::cordl_internals::setStaticField<::UnityEngine::InputSystem::Utilities::FourCC, "s_Format", ::UnityEngine::InputSystem::XR::PoseState>(
...
inline ::UnityEngine::InputSystem::Utilities::FourCC UnityEngine::InputSystem::XR::PoseState::getStaticF_s_Format() {
  return ::cordl_internals::getStaticField<::UnityEngine::InputSystem::Utilities::FourCC, "s_Format", ::UnityEngine::InputSystem::XR::PoseState>();
}
  ...
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::InputSystem::XR::PoseState>(),
                                                           { ".ctor",
                                                             ...
                                                             { ::i2c::type_of<bool>(), ::i2c::type_of<::UnityEngine::XR::InputTrackingState>(), ::i2c::type_of<::UnityEngine::Vector3>(),
                                                               ::i2c::type_of<::UnityEngine::Quaternion>(), ::i2c::type_of<::UnityEngine::Vector3>(), ::i2c::type_of<::UnityEngine::Vector3>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(*this, ___internal_method, isTracked, trackingState, position, rotation, velocity, angularVelocity);
}
