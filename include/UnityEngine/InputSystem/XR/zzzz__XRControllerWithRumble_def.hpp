...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::XR::XRControllerWithRumble*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::XR::XRControllerWithRumble*, "UnityEngine.InputSystem.XR", "XRControllerWithRumble");
...
public:
  ...
  /// @brief Method SendImpulse, addr 0x64455d4, size 0xac, virtual false, abstract: false, final false
  inline void SendImpulse(float_t amplitude, float_t duration);

  /// @brief Method .ctor, addr 0x644569c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::InputSystem::XR::XRControllerWithRumble) == 0x1a8, "Size mismatch!");
