...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::XR::XRDeviceDescriptor*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::XR::XRDeviceDescriptor*, "UnityEngine.InputSystem.XR", "XRDeviceDescriptor");
...
public:
  ...
  /// @brief Method FromJson, addr 0x6445568, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToJson, addr 0x64486f4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64486fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::InputSystem::XR::XRDeviceDescriptor) == 0x38, "Size mismatch!");
