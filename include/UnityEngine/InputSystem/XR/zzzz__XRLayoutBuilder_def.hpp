...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::XR::XRLayoutBuilder*);
...
public:
  ...
  /// @brief Method <OnFindLayoutForDevice>b__0, addr 0x64486e0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64476f0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::InputSystem::XR::XRLayoutBuilder___c__DisplayClass5_0) == 0x18, "Size mismatch!");

} // namespace UnityEngine::InputSystem::XR
// Dependencies System.Object, UnityEngine.InputSystem.XR.FeatureType
namespace UnityEngine::InputSystem::XR {
// Is value type: false
...
public:
  ...
  __declspec(property(get = getStaticF_poseSubControlNames, put = setStaticF_poseSubControlNames)) ::ArrayW<::StringW> poseSubControlNames;
  ...
  /// @brief Method Build, addr 0x6447a50, size 0xacc, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Layouts::InputControlLayout* Build();

  /// @brief Method ConvertPotentialAliasToName, addr 0x64476f8, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParentControlName, addr 0x64478ac, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW GetParentControlName(::StringW name);

  /// @brief Method GetSizeOfFeature, addr 0x64470e8, size 0xb4, virtual false, abstract: false, final false
  static inline uint32_t GetSizeOfFeature(::UnityEngine::InputSystem::XR::XRFeatureDescriptor featureDescriptor);

  /// @brief Method IsPoseControl, addr 0x64478e8, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSubControl, addr 0x644787c, size 0x30, virtual false, abstract: false, final false
  inline bool IsSubControl(::StringW name);

  static inline ::UnityEngine::InputSystem::XR::XRLayoutBuilder* New_ctor();

  /// @brief Method OnFindLayoutForDevice, addr 0x64472fc, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method SanitizeString, addr 0x644719c, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64476f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<::StringW> getStaticF_poseSubControlNames();

  static inline ::ArrayW<::UnityEngine::InputSystem::XR::FeatureType> getStaticF_poseSubControlTypes();

  static inline void setStaticF_poseSubControlNames(::ArrayW<::StringW> value);

  static inline void setStaticF_poseSubControlTypes(::ArrayW<::UnityEngine::InputSystem::XR::FeatureType> value);
...
static_assert(sizeof(::UnityEngine::InputSystem::XR::XRLayoutBuilder) == 0x28, "Size mismatch!");
