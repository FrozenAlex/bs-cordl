...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::XR::XRUtilities*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::XR::XRUtilities*, "UnityEngine.InputSystem.XR", "XRUtilities");
...
static_assert(sizeof(::UnityEngine::InputSystem::XR::XRUtilities) == 0x10, "Size mismatch!");
