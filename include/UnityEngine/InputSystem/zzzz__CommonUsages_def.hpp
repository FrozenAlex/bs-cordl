...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::CommonUsages*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::CommonUsages*, "UnityEngine.InputSystem", "CommonUsages");
...
static_assert(sizeof(::UnityEngine::InputSystem::CommonUsages) == 0x10, "Size mismatch!");
