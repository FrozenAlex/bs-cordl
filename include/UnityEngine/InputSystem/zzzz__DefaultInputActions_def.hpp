...
public:
  ...
  /// @brief Method Disable, addr 0x6571104, size 0x24, virtual false, abstract: false, final false
  inline void Disable();

  /// @brief Method Enable, addr 0x65710e0, size 0x24, virtual false, abstract: false, final false
  inline void Enable();

  /// @brief Method Get, addr 0x65710c8, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionMap* Get();

  /// @brief Method SetCallbacks, addr 0x6571168, size 0xe48, virtual false, abstract: false, final false
  inline void SetCallbacks(::UnityEngine::InputSystem::DefaultInputActions_IPlayerActions* instance);

  /// @brief Method .ctor, addr 0x6571078, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::DefaultInputActions* wrapper);

  /// @brief Method get_Fire, addr 0x65710b0, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_Fire();

  /// @brief Method get_Look, addr 0x6571098, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_Look();

  /// @brief Method get_Move, addr 0x6571080, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_Move();

  /// @brief Method get_enabled, addr 0x6571128, size 0x2c, virtual false, abstract: false, final false
  inline bool get_enabled();

  /// @brief Method op_Implicit, addr 0x6571154, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Disable, addr 0x65720e4, size 0x24, virtual false, abstract: false, final false
  inline void Disable();

  /// @brief Method Enable, addr 0x65720c0, size 0x24, virtual false, abstract: false, final false
  inline void Enable();

  /// @brief Method Get, addr 0x65720a8, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionMap* Get();

  /// @brief Method SetCallbacks, addr 0x6572148, size 0x2e70, virtual false, abstract: false, final false
  inline void SetCallbacks(::UnityEngine::InputSystem::DefaultInputActions_IUIActions* instance);

  /// @brief Method .ctor, addr 0x6571fb0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::DefaultInputActions* wrapper);

  /// @brief Method get_Cancel, addr 0x6571fe8, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_Cancel();

  /// @brief Method get_Click, addr 0x6572018, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_Click();

  /// @brief Method get_MiddleClick, addr 0x6572048, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_MiddleClick();

  /// @brief Method get_Navigate, addr 0x6571fb8, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_Navigate();

  /// @brief Method get_Point, addr 0x6572000, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_Point();

  /// @brief Method get_RightClick, addr 0x6572060, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_RightClick();

  /// @brief Method get_ScrollWheel, addr 0x6572030, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_ScrollWheel();

  /// @brief Method get_Submit, addr 0x6571fd0, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_Submit();

  /// @brief Method get_TrackedDeviceOrientation, addr 0x6572090, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_TrackedDeviceOrientation();

  /// @brief Method get_TrackedDevicePosition, addr 0x6572078, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_TrackedDevicePosition();

  /// @brief Method get_enabled, addr 0x6572108, size 0x2c, virtual false, abstract: false, final false
  inline bool get_enabled();

  /// @brief Method op_Implicit, addr 0x6572134, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Contains, addr 0x6570b54, size 0x18, virtual true, abstract: false, final true
  inline bool Contains(::UnityEngine::InputSystem::InputAction* action);

  /// @brief Method Disable, addr 0x6570bb4, size 0x18, virtual true, abstract: false, final true
  inline void Disable();

  /// @brief Method Dispose, addr 0x6570a04, size 0x60, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Enable, addr 0x6570b9c, size 0x18, virtual true, abstract: false, final true
  inline void Enable();

  /// @brief Method FindAction, addr 0x6570be4, size 0x1c, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::InputAction* FindAction(::StringW actionNameOrId, bool throwIfNotFound);

  /// @brief Method FindBinding, addr 0x6570c00, size 0x4c, virtual true, abstract: false, final true
  ...
  /// @brief Method GetEnumerator, addr 0x6570b6c, size 0x18, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x6570b84, size 0x18, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6570670, size 0x394, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_GamepadScheme, addr 0x6570d28, size 0xd4, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlScheme get_GamepadScheme();

  /// @brief Method get_JoystickScheme, addr 0x6570ed0, size 0xd4, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlScheme get_JoystickScheme();

  /// @brief Method get_KeyboardMouseScheme, addr 0x6570c54, size 0xd4, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlScheme get_KeyboardMouseScheme();

  /// @brief Method get_Player, addr 0x6570c4c, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::DefaultInputActions_PlayerActions get_Player();

  /// @brief Method get_TouchScheme, addr 0x6570dfc, size 0xd4, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlScheme get_TouchScheme();

  /// @brief Method get_UI, addr 0x6570c50, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::DefaultInputActions_UIActions get_UI();

  /// @brief Method get_XRScheme, addr 0x6570fa4, size 0xd4, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlScheme get_XRScheme();

  /// @brief Method get_asset, addr 0x6570668, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::InputSystem::InputActionAsset> get_asset();

  /// @brief Method get_bindingMask, addr 0x6570a64, size 0x20, virtual true, abstract: false, final true
  inline ::System::Nullable_1<::UnityEngine::InputSystem::InputBinding> get_bindingMask();

  /// @brief Method get_bindings, addr 0x6570bcc, size 0x18, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::InputBinding>* get_bindings();

  /// @brief Method get_controlSchemes, addr 0x6570b3c, size 0x18, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputControlScheme> get_controlSchemes();

  /// @brief Method get_devices, addr 0x6570ac0, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method set_bindingMask, addr 0x6570a84, size 0x3c, virtual true, abstract: false, final true
  inline void set_bindingMask(::System::Nullable_1<::UnityEngine::InputSystem::InputBinding> value);

  /// @brief Method set_devices, addr 0x6570b00, size 0x3c, virtual true, abstract: false, final true
