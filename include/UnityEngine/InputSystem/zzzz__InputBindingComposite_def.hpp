...
public:
  ...
  /// @brief Method MoveNext, addr 0x63cab9c, size 0x1b0, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::InputSystem::InputBindingComposite__GetPartNames_d__12* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<System.String>.GetEnumerator, addr 0x63cad94, size 0x98, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.String>.get_Current, addr 0x63cad4c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Collections_Generic_IEnumerator_System_String__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x63cae2c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x63cad54, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x63cad8c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x63cab98, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x63cab78, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CallFinishSetup, addr 0x63ac7d8, size 0xc, virtual false, abstract: false, final false
  inline void CallFinishSetup(::by_ref<::UnityEngine::InputSystem::InputBindingCompositeContext> context);

  /// @brief Method EvaluateMagnitude, addr 0x63b487c, size 0x8, virtual true, abstract: false, final false
  inline float_t EvaluateMagnitude(::by_ref<::UnityEngine::InputSystem::InputBindingCompositeContext> context);

  /// @brief Method FinishSetup, addr 0x63b4884, size 0x4, virtual true, abstract: false, final false
  inline void FinishSetup(::by_ref<::UnityEngine::InputSystem::InputBindingCompositeContext> context);

  /// @brief Method GetDisplayFormatString, addr 0x63b4b7c, size 0x104, virtual false, abstract: false, final false
  static inline ::StringW GetDisplayFormatString(::StringW composite);

  /// @brief Method GetExpectedControlLayoutName, addr 0x63b49b0, size 0x15c, virtual false, abstract: false, final false
  static inline ::StringW GetExpectedControlLayoutName(::StringW composite, ::StringW part);

  /// @brief Method GetPartNames, addr 0x63b4b0c, size 0x70, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<::StringW>* GetPartNames(::StringW composite);

  /// @brief Method GetValueType, addr 0x63b4888, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63b4c80, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
