...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::InputControlExtensions_Enumerate, "UnityEngine.InputSystem", "InputControlExtensions/Enumerate");
...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder, "UnityEngine.InputSystem", "InputControlExtensions/ControlBuilder");
...
static_assert(sizeof(::UnityEngine::InputSystem::InputControlExtensions_Enumerate) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x63d7de8, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_InputEventControlEnumerator GetEnumerator();

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.InputControl>.GetEnumerator, addr 0x63d86d0, size 0x80, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x63d8750, size 0x80, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method get_eventPtr, addr 0x63d8508, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::InputControlExtensions_InputEventControlCollection) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method CheckCurrent, addr 0x63d8bf4, size 0x1c, virtual false, abstract: false, final false
  inline bool CheckCurrent(uint32_t numBits);

  /// @brief Method CheckDefault, addr 0x63d8bd4, size 0x20, virtual false, abstract: false, final false
  inline bool CheckDefault(uint32_t numBits);

  /// @brief Method Dispose, addr 0x63d8c2c, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x63d7e10, size 0x388, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method Reset, addr 0x63d87d0, size 0x404, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x63d8c3c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method .ctor, addr 0x63d8510, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Current, addr 0x63d8c34, size 0x8, virtual true, abstract: false, final true
  ...
  constexpr InputControlExtensions_InputEventControlEnumerator(::UnityEngine::InputSystem::InputControlExtensions_Enumerate m_Flags, ::UnityEngine::InputSystem::InputDevice* m_Device,
                                                               ...
                                                               uint8_t* m_NoiseMask, ::UnityEngine::InputSystem::LowLevel::InputEventPtr m_EventPtr,
                                                               ::UnityEngine::InputSystem::InputControl* m_CurrentControl, int32_t m_CurrentIndexInStateOffsetToControlIndexMap,
                                                               uint32_t m_CurrentControlStateBitOffset, uint8_t* m_EventState, uint32_t m_CurrentBitOffset, uint32_t m_EndBitOffset,
...
public:
  ...
  /// @brief Method At, addr 0x63d8c54, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method DontReset, addr 0x63d8f68, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder DontReset(bool value);

  /// @brief Method Finish, addr 0x63d900c, size 0x20, virtual false, abstract: false, final false
  inline void Finish();

  /// @brief Method IsButton, addr 0x63d8fd8, size 0x34, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder IsButton(bool value);

  /// @brief Method IsNoisy, addr 0x63d8f0c, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder IsNoisy(bool value);

  /// @brief Method IsSynthetic, addr 0x63d8f34, size 0x34, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder IsSynthetic(bool value);

  /// @brief Method WithAliases, addr 0x63d8e30, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder WithAliases(int32_t startIndex, int32_t count);

  /// @brief Method WithChildren, addr 0x63d8e4c, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder WithChildren(int32_t startIndex, int32_t count);

  /// @brief Method WithDefaultState, addr 0x63d8e84, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithDisplayName, addr 0x63d8d40, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder WithDisplayName(::StringW displayName);

  /// @brief Method WithLayout, addr 0x63d8df8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithMinAndMax, addr 0x63d8ee0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithName, addr 0x63d8cf8, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder WithName(::StringW name);

  /// @brief Method WithParent, addr 0x63d8cdc, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithShortDisplayName, addr 0x63d8d9c, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder WithShortDisplayName(::StringW shortDisplayName);

  /// @brief Method WithStateBlock, addr 0x63d8e68, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithUsages, addr 0x63d8e14, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder WithUsages(int32_t startIndex, int32_t count);

  /// @brief Method get_control, addr 0x63d8c44, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_control();

  /// @brief Method set_control, addr 0x63d8c4c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder) == 0x8, "Size mismatch!");
...
public:
  ...
  /// @brief Method Finish, addr 0x63d93f4, size 0x274, virtual false, abstract: false, final false
  inline void Finish();

  /// @brief Method IsNoisy, addr 0x63d9190, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_DeviceBuilder IsNoisy(bool value);

  /// @brief Method WithChildren, addr 0x63d9158, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_DeviceBuilder WithChildren(int32_t startIndex, int32_t count);

  /// @brief Method WithControlAlias, addr 0x63d925c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithControlTree, addr 0x63d92b4, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method WithControlUsage, addr 0x63d91b8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method WithDisplayName, addr 0x63d9084, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_DeviceBuilder WithDisplayName(::StringW displayName);

  /// @brief Method WithLayout, addr 0x63d913c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithName, addr 0x63d903c, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_DeviceBuilder WithName(::StringW name);

  /// @brief Method WithShortDisplayName, addr 0x63d90e0, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_DeviceBuilder WithShortDisplayName(::StringW shortDisplayName);

  /// @brief Method WithStateBlock, addr 0x63d9174, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithStateOffsetToControlIndexMap, addr 0x63d9298, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_DeviceBuilder WithStateOffsetToControlIndexMap(::ArrayW<uint32_t> map);

  /// @brief Method get_device, addr 0x63d902c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* get_device();

  /// @brief Method set_device, addr 0x63d9034, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x63d96e4, size 0x234, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::InputSystem::InputControlExtensions__GetAllButtonPresses_d__43* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.InputControl>.GetEnumerator, addr 0x63d9970, size 0xa8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::UnityEngine::InputSystem::InputControl*>* System_Collections_Generic_IEnumerable_UnityEngine_InputSystem_InputControl__GetEnumerator();

  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.InputSystem.InputControl>.get_Current, addr 0x63d9928, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x63d9a18, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x63d9930, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x63d9968, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x63d96c0, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x63d9918, size 0x10, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x63d8228, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AccumulateValueInEvent, addr 0x63d77c4, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method AccumulateValueInEvent, addr 0x63d76a8, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildPath, addr 0x63d78e4, size 0x2e0, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckStateIsAtDefault, addr 0x63d64ac, size 0x74, virtual false, abstract: false, final false
  static inline bool CheckStateIsAtDefault(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method CheckStateIsAtDefault, addr 0x63d6b90, size 0xdc, virtual false, abstract: false, final false
  static inline bool CheckStateIsAtDefault(::UnityEngine::InputSystem::InputControl* control, void* statePtr, void* maskPtr);

  /// @brief Method CheckStateIsAtDefaultIgnoringNoise, addr 0x63d6de0, size 0x70, virtual false, abstract: false, final false
  static inline bool CheckStateIsAtDefaultIgnoringNoise(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method CheckStateIsAtDefaultIgnoringNoise, addr 0x63d6e50, size 0xd4, virtual false, abstract: false, final false
  static inline bool CheckStateIsAtDefaultIgnoringNoise(::UnityEngine::InputSystem::InputControl* control, void* statePtr);

  /// @brief Method CompareState, addr 0x63d6c6c, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareState, addr 0x63d700c, size 0xac, virtual false, abstract: false, final false
  static inline bool CompareState(::UnityEngine::InputSystem::InputControl* control, void* statePtr, void* maskPtr);

  /// @brief Method CompareStateIgnoringNoise, addr 0x63d6f24, size 0xe8, virtual false, abstract: false, final false
  static inline bool CompareStateIgnoringNoise(::UnityEngine::InputSystem::InputControl* control, void* statePtr);

  /// @brief Method CopyState, addr 0x63d69ec, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method EnumerateChangedControls, addr 0x63d7d98, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method EnumerateControls, addr 0x63d7bc4, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAllButtonPresses, addr 0x63d8198, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFirstButtonPressOrNull, addr 0x63d4080, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStatePtrFromStateEvent, addr 0x63d66fc, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStatePtrFromStateEventUnchecked, addr 0x63d7228, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method HasButtonPress, addr 0x63d7dd0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method HasValueChangeInEvent, addr 0x63d7164, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method HasValueChangeInState, addr 0x63d70b8, size 0xac, virtual false, abstract: false, final false
  static inline bool HasValueChangeInState(::UnityEngine::InputSystem::InputControl* control, void* statePtr);

  /// @brief Method IsActuated, addr 0x63d6374, size 0x138, virtual false, abstract: false, final false
  static inline bool IsActuated(::UnityEngine::InputSystem::InputControl* control, float_t threshold);

  /// @brief Method IsPressed, addr 0x63d6228, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadDefaultValueAsObject, addr 0x63d65d4, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValueAsObject, addr 0x63d5038, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValueFromEventAsObject, addr 0x63d667c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValueIntoBuffer, addr 0x63d6520, size 0xb4, virtual false, abstract: false, final false
  static inline void ReadValueIntoBuffer(::UnityEngine::InputSystem::InputControl* control, void* buffer, int32_t bufferSize);

  /// @brief Method ResetToDefaultStateInEvent, addr 0x63d7500, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x63d8248, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x63d830c, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteValueFromObjectIntoEvent, addr 0x63d677c, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteValueIntoState, addr 0x63d680c, size 0x1e0, virtual false, abstract: false, final false
