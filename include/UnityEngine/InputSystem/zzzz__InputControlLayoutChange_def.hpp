...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::InputControlLayoutChange, "UnityEngine.InputSystem", "InputControlLayoutChange");
// Dependencies
namespace UnityEngine::InputSystem {
// Is value type: true
...
public:
  ...
  /// @brief Field Replaced value: I32(2)
...
static_assert(sizeof(::UnityEngine::InputSystem::InputControlLayoutChange) == 0x4, "Size mismatch!");
