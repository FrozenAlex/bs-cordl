...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::InputDeviceChange, "UnityEngine.InputSystem", "InputDeviceChange");
// Dependencies
namespace UnityEngine::InputSystem {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::InputSystem::InputDeviceChange) == 0x4, "Size mismatch!");
