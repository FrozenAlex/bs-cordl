...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::InputProcessor_CachingPolicy, "UnityEngine.InputSystem", "InputProcessor/CachingPolicy");
...
static_assert(sizeof(::UnityEngine::InputSystem::InputProcessor_CachingPolicy) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetValueTypeFromType, addr 0x63dcb1c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63dcbf8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::Utilities::TypeTable getStaticF_s_Processors();

  /// @brief Method get_cachingPolicy, addr 0x63dcbf0, size 0x8, virtual true, abstract: false, final false
