...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::PenButton, "UnityEngine.InputSystem", "PenButton");
// Dependencies
namespace UnityEngine::InputSystem {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::InputSystem::PenButton) == 0x4, "Size mismatch!");
