...
public:
  ...
  /// @brief Method FinishSetup, addr 0x655efd8, size 0x70, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x655eef8, size 0x50, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::PressureSensor* New_ctor();

  /// @brief Method OnRemoved, addr 0x655ef48, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x655f048, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::PressureSensor* getStaticF__current_k__BackingField();

  /// @brief Method get_atmosphericPressure, addr 0x655ee4c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::AxisControl* get_atmosphericPressure();

  /// @brief Method get_current, addr 0x655ee5c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_atmosphericPressure, addr 0x655ee54, size 0x8, virtual false, abstract: false, final false
  inline void set_atmosphericPressure(::UnityEngine::InputSystem::Controls::AxisControl* value);

  /// @brief Method set_current, addr 0x655eea8, size 0x50, virtual false, abstract: false, final false
