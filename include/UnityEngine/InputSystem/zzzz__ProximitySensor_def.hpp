...
public:
  ...
  /// @brief Method FinishSetup, addr 0x6424838, size 0x70, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x6424758, size 0x50, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::ProximitySensor* New_ctor();

  /// @brief Method OnRemoved, addr 0x64247a8, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64248a8, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::ProximitySensor* getStaticF__current_k__BackingField();

  /// @brief Method get_current, addr 0x64246bc, size 0x4c, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::ProximitySensor* get_current();

  /// @brief Method get_distance, addr 0x64246ac, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_current, addr 0x6424708, size 0x50, virtual false, abstract: false, final false
  static inline void set_current(::UnityEngine::InputSystem::ProximitySensor* value);

  /// @brief Method set_distance, addr 0x64246b4, size 0x8, virtual false, abstract: false, final false
