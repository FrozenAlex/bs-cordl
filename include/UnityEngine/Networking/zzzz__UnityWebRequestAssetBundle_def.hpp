...
// Write type traits
MARK_REF_T(::UnityEngine::Networking::UnityWebRequestAssetBundle*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Networking::UnityWebRequestAssetBundle*, "UnityEngine.Networking", "UnityWebRequestAssetBundle");
...
static_assert(sizeof(::UnityEngine::Networking::UnityWebRequestAssetBundle) == 0x10, "Size mismatch!");
