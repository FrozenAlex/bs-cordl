...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6cd40cc, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x6cd40ac, size 0x20, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method Finalize, addr 0x6cd4060, size 0x4c, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::UnityEngine::Networking::UploadHandler* New_ctor();

  /// @brief Method ReleaseFromScripting, addr 0x6cd3fd0, size 0x50, virtual false, abstract: false, final false
  inline void ReleaseFromScripting();

  /// @brief Method ReleaseFromScripting_Injected, addr 0x6cd4020, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cd405c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
