...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x69addb0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69add44, size 0x6c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateInternal, addr 0x69adcb8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateOutput, addr 0x69adbc8, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method get_sourceObject, addr 0x69adbc0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Object> get_sourceObject();

  /// @brief Method get_streamName, addr 0x69adbb8, size 0x8, virtual false, abstract: false, final false
