...
DEFINE_IL2CPP_CLASS(::UnityEngine::Playables::PlayableTraversalMode, "UnityEngine.Playables", "PlayableTraversalMode");
// Dependencies
namespace UnityEngine::Playables {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Playables::PlayableTraversalMode) == 0x4, "Size mismatch!");
