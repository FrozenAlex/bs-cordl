...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::ProBuilder::KdTree::KdTree_2);
MARK_GEN_REF_T_PTR(::UnityEngine::ProBuilder::KdTree::KdTree_2__GetEnumerator_d__33);
MARK_GEN_REF_T_PTR(::UnityEngine::ProBuilder::KdTree::KdTree_2___c__DisplayClass33_0);
...
public:
  ...
  inline bool Add(::ArrayW<TKey> point, TValue value);

  /// @brief Method AddNearestNeighbours, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline void AddNearestNeighbours(::UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>* node, ::ArrayW<TKey> target, ::UnityEngine::ProBuilder::KdTree::HyperRect_1<TKey> rect, int32_t depth,
  ...
  inline void AddNodesBalanced(::ArrayW<::UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>*> nodes, int32_t byDimension, int32_t fromIndex, int32_t toIndex);
  ...
  inline ::ArrayW<TKey> FindValue(TValue value);
  ...
  inline ::ArrayW<::UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>*> GetNearestNeighbours(::ArrayW<TKey> point, int32_t count);
  ...
  inline ::ArrayW<::UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>*> RadialSearch(::ArrayW<TKey> center, TKey radius, int32_t count);
  ...
  inline void RemoveAt(::ArrayW<TKey> point);
  ...
  inline void SortNodesArray(::ArrayW<::UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>*> nodes, int32_t byDimension, int32_t fromIndex, int32_t toIndex);
  ...
  inline bool TryFindValue(TValue value, ::by_ref<::ArrayW<TKey>> point);

  /// @brief Method TryFindValueAt, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final true
  inline bool TryFindValueAt(::ArrayW<TKey> point, ::by_ref<TValue> value);
