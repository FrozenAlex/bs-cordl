...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::ProBuilder::KdTree::NearestNeighbourList_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::ProBuilder::KdTree::NearestNeighbourList_2, "UnityEngine.ProBuilder.KdTree", "NearestNeighbourList`2");
