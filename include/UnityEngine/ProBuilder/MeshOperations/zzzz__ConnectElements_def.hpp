...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::MeshOperations::ConnectElements*);
MARK_REF_T(::UnityEngine::ProBuilder::MeshOperations::ConnectElements___c*);
MARK_REF_T(::UnityEngine::ProBuilder::MeshOperations::ConnectElements___c__DisplayClass2_0*);
MARK_REF_T(::UnityEngine::ProBuilder::MeshOperations::ConnectElements___c__DisplayClass3_0*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::MeshOperations::ConnectElements*, "UnityEngine.ProBuilder.MeshOperations", "ConnectElements");
...
public:
  ...
  /// @brief Method <ConnectEdgesInFace>b__5_0, addr 0x65e0cb4, size 0x70, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Vertex*>* _ConnectEdgesInFace_b__5_0(int32_t x);

  /// @brief Method <ConnectEdgesInFace>b__5_1, addr 0x65e0d24, size 0x70, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<int32_t>* _ConnectEdgesInFace_b__5_1(int32_t x);

  /// @brief Method <ConnectEdgesInFace>b__5_2, addr 0x65e0d94, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Edge _ConnectEdgesInFace_b__5_2(::UnityEngine::ProBuilder::WingedEdge* x);

  /// @brief Method <ConnectIndexesPerFace>b__8_0, addr 0x65e0dbc, size 0x70, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Vertex*>* _ConnectIndexesPerFace_b__8_0(int32_t x);

  /// @brief Method <ConnectIndexesPerFace>b__8_1, addr 0x65e0e2c, size 0x70, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<int32_t>* _ConnectIndexesPerFace_b__8_1(int32_t x);

  /// @brief Method <ConnectIndexesPerFace>b__8_2, addr 0x65e0e9c, size 0x70, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<int32_t>* _ConnectIndexesPerFace_b__8_2(int32_t x);

  /// @brief Method <Connect>b__0_0, addr 0x65e0c04, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method <Connect>b__2_1, addr 0x65e0c24, size 0x14, virtual false, abstract: false, final false
  inline int32_t _Connect_b__2_1(::UnityEngine::ProBuilder::Face* x);

  /// @brief Method <Connect>b__2_2, addr 0x65e0c38, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method <Connect>b__3_0, addr 0x65e0c4c, size 0x14, virtual false, abstract: false, final false
  inline int32_t _Connect_b__3_0(::UnityEngine::ProBuilder::Face* x);

  /// @brief Method <Connect>b__3_1, addr 0x65e0c60, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method <Connect>b__3_2, addr 0x65e0c74, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method <Connect>b__3_4, addr 0x65e0cac, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Edge _Connect_b__3_4(::UnityEngine::ProBuilder::EdgeLookup x);

  /// @brief Method <InsertVertices>b__6_0, addr 0x65e0da8, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Edge _InsertVertices_b__6_0(::UnityEngine::ProBuilder::WingedEdge* x);

  /// @brief Method .ctor, addr 0x65e0c00, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Connect>b__0, addr 0x65e0f0c, size 0x64, virtual false, abstract: false, final false
  inline int32_t _Connect_b__0(int32_t x);

  /// @brief Method <Connect>b__3, addr 0x65e0f70, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65de0d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Connect>b__3, addr 0x65e0fb4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65e0ba8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Connect, addr 0x65db450, size 0x2d8, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::ProBuilder::Face*> Connect(::UnityEngine::ProBuilder::ProBuilderMesh* mesh,
                                                                   ::System::Collections::Generic::IEnumerable_1<::UnityEngine::ProBuilder::Face*>* faces);

  /// @brief Method Connect, addr 0x65dd028, size 0x10a8, virtual false, abstract: false, final false
  ...
  /// @brief Method Connect, addr 0x65db728, size 0x1880, virtual false, abstract: false, final false
  ...
  /// @brief Method Connect, addr 0x65dcfa8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method ConnectEdgesInFace, addr 0x65e03bc, size 0x7ec, virtual false, abstract: false, final false
  ...
  /// @brief Method ConnectEdgesInFace, addr 0x65df9b0, size 0xa0c, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::MeshOperations::ConnectFaceRebuildData*>*
  ...
  /// @brief Method ConnectIndexesPerFace, addr 0x65deb30, size 0x8e0, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::MeshOperations::ConnectFaceRebuildData*>*
  ...
  /// @brief Method ConnectIndexesPerFace, addr 0x65de0d4, size 0xa5c, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::MeshOperations::ConnectFaceRebuildData*>*
  ...
  /// @brief Method InsertVertices, addr 0x65df410, size 0x5a0, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::ProBuilder::MeshOperations::ConnectElements) == 0x10, "Size mismatch!");
