...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::MeshOperations::MeshImportSettings*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::MeshOperations::MeshImportSettings*, "UnityEngine.ProBuilder.MeshOperations", "MeshImportSettings");
...
public:
  ...
  /// @brief Method ToString, addr 0x65f0df0, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65f0ecc, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_quads, addr 0x65f0dc0, size 0x8, virtual false, abstract: false, final false
  inline bool get_quads();

  /// @brief Method get_smoothing, addr 0x65f0dd0, size 0x8, virtual false, abstract: false, final false
  inline bool get_smoothing();

  /// @brief Method get_smoothingAngle, addr 0x65f0de0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_smoothingAngle();

  /// @brief Method set_quads, addr 0x65f0dc8, size 0x8, virtual false, abstract: false, final false
  inline void set_quads(bool value);

  /// @brief Method set_smoothing, addr 0x65f0dd8, size 0x8, virtual false, abstract: false, final false
  inline void set_smoothing(bool value);

  /// @brief Method set_smoothingAngle, addr 0x65f0de8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ProBuilder::MeshOperations::MeshImportSettings) == 0x18, "Size mismatch!");
