...
public:
  // Declarations
  /// @brief Method GetBestQuadConnection, addr 0x65f6170, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method GetQuadScore, addr 0x65f5adc, size 0x694, virtual false, abstract: false, final false
  ...
  /// @brief Method ToQuads, addr 0x65f1db8, size 0x800, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ProBuilder::MeshOperations::QuadUtility) == 0x10, "Size mismatch!");
