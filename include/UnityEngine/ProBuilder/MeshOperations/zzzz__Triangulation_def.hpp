...
public:
  ...
  /// @brief Method <Triangulate>b__0, addr 0x65fa46c, size 0x78, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* _Triangulate_b__0(::UnityEngine::Vector2 x);

  /// @brief Method <Triangulate>b__1, addr 0x65fa4e4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65fa464, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Triangulate>b__0, addr 0x65fa55c, size 0x78, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint* _Triangulate_b__0(::UnityEngine::Vector2 x);

  /// @brief Method <Triangulate>b__1, addr 0x65fa5d4, size 0x78, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint* _Triangulate_b__1(::UnityEngine::Vector2 x);
  ...
  /// @brief Method .ctor, addr 0x65fa468, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method SortAndTriangulate, addr 0x65f83d4, size 0x358, virtual false, abstract: false, final false
  ...
  /// @brief Method Triangulate, addr 0x65f9878, size 0xbec, virtual false, abstract: false, final false
  ...
  /// @brief Method Triangulate, addr 0x65f872c, size 0xb84, virtual false, abstract: false, final false
  ...
  /// @brief Method TriangulateVertices, addr 0x65f9700, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method TriangulateVertices, addr 0x65f94c4, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method TriangulateVertices, addr 0x65f92b0, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method get_triangulationContext, addr 0x65f8340, size 0x94, virtual false, abstract: false, final false
