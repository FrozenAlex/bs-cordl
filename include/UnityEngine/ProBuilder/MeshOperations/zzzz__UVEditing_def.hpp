...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::MeshOperations::UVEditing*);
MARK_REF_T(::UnityEngine::ProBuilder::MeshOperations::UVEditing___c*);
MARK_REF_T(::UnityEngine::ProBuilder::MeshOperations::UVEditing___c__DisplayClass0_0*);
MARK_REF_T(::UnityEngine::ProBuilder::MeshOperations::UVEditing___c__DisplayClass4_0*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::MeshOperations::UVEditing*, "UnityEngine.ProBuilder.MeshOperations", "UVEditing");
...
public:
  ...
  /// @brief Method <GetUVs>b__2_0, addr 0x65fdc50, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 _GetUVs_b__2_0(::UnityEngine::Vector4 x);

  /// @brief Method <ProjectFacesAuto>b__8_0, addr 0x65fdc98, size 0x20, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<int32_t>* _ProjectFacesAuto_b__8_0(::UnityEngine::ProBuilder::Face* x);

  /// @brief Method <ProjectFacesAuto>b__8_1, addr 0x65fdcb8, size 0x20, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<int32_t>* _ProjectFacesAuto_b__8_1(::UnityEngine::ProBuilder::Face* x);

  /// @brief Method <ProjectFacesBox>b__11_0, addr 0x65fdcf8, size 0x20, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<int32_t>* _ProjectFacesBox_b__11_0(::UnityEngine::ProBuilder::Face* x);

  /// @brief Method <ProjectFacesBox>b__9_0, addr 0x65fdcd8, size 0x20, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<int32_t>* _ProjectFacesBox_b__9_0(::UnityEngine::ProBuilder::Face* x);

  /// @brief Method <SewUVs>b__4_1, addr 0x65fdc54, size 0x44, virtual false, abstract: false, final false
  inline int32_t _SewUVs_b__4_1(::System::Collections::Generic::KeyValuePair_2<int32_t, int32_t> y);

  /// @brief Method .ctor, addr 0x65fdc4c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AutoStitch>b__0, addr 0x65fdd18, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65fa8c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <SewUVs>b__0, addr 0x65fdd58, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65fc23c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AlignEdges, addr 0x65fa8cc, size 0xa04, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyUVs, addr 0x65fb8b8, size 0x360, virtual false, abstract: false, final false
  static inline void ApplyUVs(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::ArrayW<::UnityEngine::Vector2> uvs, int32_t channel, bool applyToMesh);

  /// @brief Method AutoStitch, addr 0x65fa64c, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method CollapseUVs, addr 0x65fc240, size 0xcc, virtual false, abstract: false, final false
  static inline void CollapseUVs(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::ArrayW<int32_t> indexes);

  /// @brief Method FindMinimalUV, addr 0x65fd1a0, size 0xc4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 FindMinimalUV(::ArrayW<::UnityEngine::Vector2> uvs, ::ArrayW<int32_t> indices, float_t xMin, float_t yMin);

  /// @brief Method FitUVs, addr 0x65fdafc, size 0xfc, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::Vector2> FitUVs(::ArrayW<::UnityEngine::Vector2> uvs);

  /// @brief Method GetUVs, addr 0x65fb2d0, size 0x268, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::Vector2> GetUVs(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, int32_t channel);

  /// @brief Method ProjectFacesAuto, addr 0x65fc710, size 0x3b0, virtual false, abstract: false, final false
  static inline void ProjectFacesAuto(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::ArrayW<::UnityEngine::ProBuilder::Face*> faces, int32_t channel);

  /// @brief Method ProjectFacesBox, addr 0x65fcac0, size 0x6e0, virtual false, abstract: false, final false
  static inline void ProjectFacesBox(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::ArrayW<::UnityEngine::ProBuilder::Face*> faces, int32_t channel);

  /// @brief Method ProjectFacesBox, addr 0x65fd264, size 0x71c, virtual false, abstract: false, final false
  static inline void ProjectFacesBox(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::ArrayW<::UnityEngine::ProBuilder::Face*> faces, ::UnityEngine::Vector2 lowerLeftAnchor, int32_t channel);

  /// @brief Method ProjectFacesSphere, addr 0x65fd980, size 0x17c, virtual false, abstract: false, final false
  static inline void ProjectFacesSphere(::UnityEngine::ProBuilder::ProBuilderMesh* pb, ::ArrayW<int32_t> indexes, int32_t channel);

  /// @brief Method SewUVs, addr 0x65fbc18, size 0x624, virtual false, abstract: false, final false
  static inline void SewUVs(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::ArrayW<int32_t> indexes, float_t delta);

  /// @brief Method SplitUVs, addr 0x65fc30c, size 0x404, virtual false, abstract: false, final false
  ...
  /// @brief Method SplitUVs, addr 0x65fb538, size 0x380, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::ProBuilder::MeshOperations::UVEditing) == 0x10, "Size mismatch!");
