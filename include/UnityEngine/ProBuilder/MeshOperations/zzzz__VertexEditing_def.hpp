...
public:
  // Declarations
  /// @brief Method AlignEdgeWithDirection, addr 0x673b2ec, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method ExplodeVertex, addr 0x673a6d8, size 0xc14, virtual false, abstract: false, final false
  ...
  /// @brief Method MergeVertices, addr 0x673925c, size 0x31c, virtual false, abstract: false, final false
  ...
  /// @brief Method SplitVertices, addr 0x6739578, size 0x8c, virtual false, abstract: false, final false
  static inline void SplitVertices(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::ProBuilder::Edge edge);

  /// @brief Method SplitVertices, addr 0x6739604, size 0x3f0, virtual false, abstract: false, final false
  ...
  /// @brief Method WeldVertices, addr 0x67399f4, size 0xce4, virtual false, abstract: false, final false
