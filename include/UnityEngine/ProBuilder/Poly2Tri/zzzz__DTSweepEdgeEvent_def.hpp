...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::Poly2Tri::DTSweepEdgeEvent*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::Poly2Tri::DTSweepEdgeEvent*, "UnityEngine.ProBuilder.Poly2Tri", "DTSweepEdgeEvent");
...
public:
  ...
  /// @brief Method .ctor, addr 0x66a93c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::ProBuilder::Poly2Tri::DTSweepEdgeEvent) == 0x20, "Size mismatch!");
