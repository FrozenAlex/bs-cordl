...
public:
  ...
  /// @brief Method Compare, addr 0x66a9bf4, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x66a93c4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
