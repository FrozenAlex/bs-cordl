...
public:
  ...
  /// @brief Method <SplitEdge>b__0, addr 0x656ddb8, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x656d350, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::ProBuilder::Poly2Tri::DTSweep___c__DisplayClass21_0) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method BasinAngle, addr 0x656d8c4, size 0x9c, virtual false, abstract: false, final false
  static inline double_t BasinAngle(::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode* node);

  /// @brief Method EdgeEvent, addr 0x656b010, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method EdgeEvent, addr 0x656c340, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method Fill, addr 0x656bb08, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method FillAdvancingFront, addr 0x656beb4, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method FillBasin, addr 0x656d960, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method FillBasinReq, addr 0x656daf4, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method FillEdgeEvent, addr 0x656c314, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method FillLeftAboveEdgeEvent, addr 0x656c638, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method FillLeftBelowEdgeEvent, addr 0x656cd08, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method FillLeftConcaveEdgeEvent, addr 0x656cc00, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method FillLeftConvexEdgeEvent, addr 0x656cad0, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method FillRightAboveEdgeEvent, addr 0x656c528, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method FillRightBelowEdgeEvent, addr 0x656c98c, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method FillRightConcaveEdgeEvent, addr 0x656c744, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method FillRightConvexEdgeEvent, addr 0x656c854, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method FinalizationConvexHull, addr 0x656ab84, size 0x280, virtual false, abstract: false, final false
  static inline void FinalizationConvexHull(::UnityEngine::ProBuilder::Poly2Tri::DTSweepContext* tcx);

  /// @brief Method FinalizationPolygon, addr 0x656aae0, size 0xa4, virtual false, abstract: false, final false
  static inline void FinalizationPolygon(::UnityEngine::ProBuilder::Poly2Tri::DTSweepContext* tcx);

  /// @brief Method FlipEdgeEvent, addr 0x656ce90, size 0x3a0, virtual false, abstract: false, final false
  ...
  /// @brief Method FlipScanEdgeEvent, addr 0x656d630, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method HoleAngle, addr 0x656d800, size 0xc4, virtual false, abstract: false, final false
  static inline double_t HoleAngle(::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode* node);

  /// @brief Method IsEdgeSideOfTriangle, addr 0x656c264, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsShallow, addr 0x656dc7c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method Legalize, addr 0x656bfac, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method NewFrontTriangle, addr 0x656bcd0, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method NextFlipPoint, addr 0x656d524, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method NextFlipTriangle, addr 0x656d480, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method PointEvent, addr 0x656ae14, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method RotateTrianglePair, addr 0x656b304, size 0x488, virtual false, abstract: false, final false
  ...
  /// @brief Method SplitEdge, addr 0x656d230, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method Sweep, addr 0x656a90c, size 0x1d4, virtual false, abstract: false, final false
  static inline void Sweep(::UnityEngine::ProBuilder::Poly2Tri::DTSweepContext* tcx);

  /// @brief Method Triangulate, addr 0x6567a78, size 0x4c, virtual false, abstract: false, final false
  static inline void Triangulate(::UnityEngine::ProBuilder::Poly2Tri::DTSweepContext* tcx);

  /// @brief Method TurnAdvancingFrontConvex, addr 0x656b194, size 0x170, virtual false, abstract: false, final false
