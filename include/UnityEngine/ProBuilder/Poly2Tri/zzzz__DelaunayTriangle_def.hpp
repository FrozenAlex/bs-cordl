...
public:
  ...
  /// @brief Method Area, addr 0x66a54bc, size 0xb8, virtual false, abstract: false, final false
  inline double_t Area();

  /// @brief Method Centroid, addr 0x66a5574, size 0xc8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* Centroid();

  /// @brief Method Contains, addr 0x66a473c, size 0x5c, virtual false, abstract: false, final false
  inline bool Contains(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method EdgeIndex, addr 0x66a4868, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetConstrainedEdgeAcross, addr 0x66a56b4, size 0x1c, virtual false, abstract: false, final false
  inline bool GetConstrainedEdgeAcross(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method GetConstrainedEdgeCCW, addr 0x66a563c, size 0x3c, virtual false, abstract: false, final false
  inline bool GetConstrainedEdgeCCW(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method GetConstrainedEdgeCW, addr 0x66a5678, size 0x3c, virtual false, abstract: false, final false
  inline bool GetConstrainedEdgeCW(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method GetDelaunayEdgeAcross, addr 0x66a580c, size 0x1c, virtual false, abstract: false, final false
  inline bool GetDelaunayEdgeAcross(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method GetDelaunayEdgeCCW, addr 0x66a5794, size 0x3c, virtual false, abstract: false, final false
  inline bool GetDelaunayEdgeCCW(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method GetDelaunayEdgeCW, addr 0x66a57d0, size 0x3c, virtual false, abstract: false, final false
  inline bool GetDelaunayEdgeCW(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method IndexCCWFrom, addr 0x66a4708, size 0x34, virtual false, abstract: false, final false
  inline int32_t IndexCCWFrom(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method IndexCWFrom, addr 0x66a46d4, size 0x34, virtual false, abstract: false, final false
  inline int32_t IndexCWFrom(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method IndexOf, addr 0x66a4624, size 0xb0, virtual false, abstract: false, final false
  inline int32_t IndexOf(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method Legalize, addr 0x66a4e1c, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method MarkConstrainedEdge, addr 0x66a54a4, size 0x18, virtual false, abstract: false, final false
  inline void MarkConstrainedEdge(::UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint* edge);

  /// @brief Method MarkConstrainedEdge, addr 0x66a5434, size 0xc, virtual false, abstract: false, final false
  inline void MarkConstrainedEdge(int32_t index);

  /// @brief Method MarkConstrainedEdge, addr 0x66a5170, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method MarkEdge, addr 0x66a5284, size 0x1b0, virtual false, abstract: false, final false
  inline void MarkEdge(::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle*>* tList);

  /// @brief Method MarkEdge, addr 0x66a51a0, size 0xe4, virtual false, abstract: false, final false
  inline void MarkEdge(::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle* triangle);

  /// @brief Method MarkNeighbor, addr 0x66a4798, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method MarkNeighbor, addr 0x66a4938, size 0x178, virtual false, abstract: false, final false
  inline void MarkNeighbor(::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle* t);

  /// @brief Method MarkNeighborEdges, addr 0x66a4fe8, size 0x128, virtual false, abstract: false, final false
  inline void MarkNeighborEdges();

  /// @brief Method NeighborAcrossFrom, addr 0x66a4cac, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method NeighborCCWFrom, addr 0x66a4c08, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method NeighborCWFrom, addr 0x66a4b64, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method OppositePoint, addr 0x66a4ab0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method PointCCWFrom, addr 0x66a4d30, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method PointCWFrom, addr 0x66a4adc, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method RotateCW, addr 0x66a4db8, size 0x64, virtual false, abstract: false, final false
  inline void RotateCW();

  /// @brief Method SetConstrainedEdgeAcross, addr 0x66a5768, size 0x2c, virtual false, abstract: false, final false
  inline void SetConstrainedEdgeAcross(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p, bool ce);

  /// @brief Method SetConstrainedEdgeCCW, addr 0x66a56d0, size 0x4c, virtual false, abstract: false, final false
  inline void SetConstrainedEdgeCCW(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p, bool ce);

  /// @brief Method SetConstrainedEdgeCW, addr 0x66a571c, size 0x4c, virtual false, abstract: false, final false
  inline void SetConstrainedEdgeCW(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p, bool ce);

  /// @brief Method SetDelaunayEdgeAcross, addr 0x66a58c0, size 0x2c, virtual false, abstract: false, final false
  inline void SetDelaunayEdgeAcross(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p, bool ce);

  /// @brief Method SetDelaunayEdgeCCW, addr 0x66a5828, size 0x4c, virtual false, abstract: false, final false
  inline void SetDelaunayEdgeCCW(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p, bool ce);

  /// @brief Method SetDelaunayEdgeCW, addr 0x66a5874, size 0x4c, virtual false, abstract: false, final false
  inline void SetDelaunayEdgeCW(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p, bool ce);

  /// @brief Method ToString, addr 0x66a4eb4, size 0x134, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66a45c0, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsInterior, addr 0x66a45b0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsInterior();

  /// @brief Method set_IsInterior, addr 0x66a45b8, size 0x8, virtual false, abstract: false, final false
