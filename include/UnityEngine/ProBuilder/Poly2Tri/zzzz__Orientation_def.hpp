...
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::Poly2Tri::Orientation, "UnityEngine.ProBuilder.Poly2Tri", "Orientation");
// Dependencies
namespace UnityEngine::ProBuilder::Poly2Tri {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ProBuilder::Poly2Tri::Orientation) == 0x4, "Size mismatch!");
