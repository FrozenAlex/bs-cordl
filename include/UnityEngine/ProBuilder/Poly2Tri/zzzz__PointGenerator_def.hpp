...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::Poly2Tri::PointGenerator*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::Poly2Tri::PointGenerator*, "UnityEngine.ProBuilder.Poly2Tri", "PointGenerator");
...
public:
  ...
  /// @brief Method UniformDistribution, addr 0x656f294, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method UniformGrid, addr 0x656f460, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x656f5ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::ProBuilder::Poly2Tri::PointGenerator) == 0x10, "Size mismatch!");
