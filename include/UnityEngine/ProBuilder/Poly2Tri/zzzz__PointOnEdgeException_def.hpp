...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::Poly2Tri::PointOnEdgeException*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::Poly2Tri::PointOnEdgeException*, "UnityEngine.ProBuilder.Poly2Tri", "PointOnEdgeException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x66a82f0, size 0x48, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ProBuilder::Poly2Tri::PointOnEdgeException) == 0xa8, "Size mismatch!");
