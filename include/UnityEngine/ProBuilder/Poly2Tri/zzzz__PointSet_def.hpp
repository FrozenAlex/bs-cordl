...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::Poly2Tri::PointSet*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::Poly2Tri::PointSet*, "UnityEngine.ProBuilder.Poly2Tri", "PointSet");
...
public:
  ...
  /// @brief Method AddTriangle, addr 0x656ebf8, size 0xb8, virtual true, abstract: false, final true
  inline void AddTriangle(::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle* t);

  /// @brief Method AddTriangles, addr 0x656ecb0, size 0x334, virtual true, abstract: false, final true
  inline void AddTriangles(::System::Collections::Generic::IEnumerable_1<::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle*>* list);

  /// @brief Method ClearTriangles, addr 0x656efe4, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method Prepare, addr 0x656ea08, size 0x1c8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x656e7d4, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*>* points);

  /// @brief Method get_Points, addr 0x656ebd0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*>* get_Points();

  /// @brief Method get_Triangles, addr 0x656ebe0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle*>* get_Triangles();

  /// @brief Method get_TriangulationMode, addr 0x656ebf0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Points, addr 0x656ebd8, size 0x8, virtual false, abstract: false, final false
  inline void set_Points(::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*>* value);

  /// @brief Method set_Triangles, addr 0x656ebe8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ProBuilder::Poly2Tri::PointSet) == 0x20, "Size mismatch!");
