...
public:
  ...
  /// @brief Method .ctor, addr 0x6568ea4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(double_t x, double_t y, int32_t index);

  /// @brief Method get_Next, addr 0x6568ebc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint* get_Next();

  /// @brief Method get_Previous, addr 0x6568ecc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint* get_Previous();

  /// @brief Method set_Next, addr 0x6568ec4, size 0x8, virtual false, abstract: false, final false
  inline void set_Next(::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint* value);

  /// @brief Method set_Previous, addr 0x6568ed4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint) == 0x40, "Size mismatch!");
