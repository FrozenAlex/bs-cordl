...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext*, "UnityEngine.ProBuilder.Poly2Tri", "TriangulationDebugContext");
...
public:
  ...
  /// @brief Method .ctor, addr 0x656e6f8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext) == 0x18, "Size mismatch!");
