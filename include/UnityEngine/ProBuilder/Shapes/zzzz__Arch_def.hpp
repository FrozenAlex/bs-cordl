...
public:
  ...
  /// @brief Method CopyShape, addr 0x65bf374, size 0xa0, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  /// @brief Method GetFace, addr 0x65bf414, size 0xc8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Vector3> GetFace(::UnityEngine::Vector2 vertex1, ::UnityEngine::Vector2 vertex2, float_t depth);

  static inline ::UnityEngine::ProBuilder::Shapes::Arch* New_ctor();

  /// @brief Method RebuildMesh, addr 0x65bf4dc, size 0xc24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65c0100, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::ProBuilder::Shapes::Arch) == 0x20, "Size mismatch!");
