...
public:
  ...
  /// @brief Method CopyShape, addr 0x65c1fd0, size 0xbc, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Door* New_ctor();

  /// @brief Method RebuildMesh, addr 0x65c208c, size 0x18f0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65c397c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::ProBuilder::Shapes::Door) == 0x18, "Size mismatch!");
