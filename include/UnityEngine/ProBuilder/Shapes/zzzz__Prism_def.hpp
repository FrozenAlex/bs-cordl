...
public:
  // Declarations
  /// @brief Method CopyShape, addr 0x66ffca8, size 0x4, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Prism* New_ctor();

  /// @brief Method RebuildMesh, addr 0x66ffcac, size 0x784, virtual true, abstract: false, final false
  inline ::UnityEngine::Bounds RebuildMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Vector3 size, ::UnityEngine::Quaternion rotation);

  /// @brief Method .ctor, addr 0x6700430, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
