...
public:
  ...
  /// @brief Method .ctor, addr 0x65c5cd4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ProBuilder::Shapes::ShapeAttribute) == 0x18, "Size mismatch!");
