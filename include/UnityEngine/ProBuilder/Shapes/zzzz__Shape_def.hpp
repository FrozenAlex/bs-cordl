...
public:
  ...
  /// @brief Method UpdateBounds, addr 0x6701130, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66fb5cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
