...
public:
  ...
  /// @brief Method BuildCurvedStairs, addr 0x65c71d0, size 0x1090, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildStairs, addr 0x65c8260, size 0xec0, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyShape, addr 0x65c70cc, size 0xb8, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Stairs* New_ctor();

  /// @brief Method RebuildMesh, addr 0x65c7184, size 0x4c, virtual true, abstract: false, final false
  inline ::UnityEngine::Bounds RebuildMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Vector3 size, ::UnityEngine::Quaternion rotation);

  /// @brief Method UpdateBounds, addr 0x65c9120, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65c925c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_sides, addr 0x65c70bc, size 0x8, virtual false, abstract: false, final false
  inline bool get_sides();

  /// @brief Method set_sides, addr 0x65c70c4, size 0x8, virtual false, abstract: false, final false
