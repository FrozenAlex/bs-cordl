...
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::ActionResult_Status, "UnityEngine.ProBuilder", "ActionResult/Status");
...
static_assert(sizeof(::UnityEngine::ProBuilder::ActionResult_Status) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method FromBool, addr 0x6570138, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method ToBool, addr 0x6570128, size 0x10, virtual false, abstract: false, final false
  inline bool ToBool();
  ...
  /// @brief Method .ctor, addr 0x6570108, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::ActionResult_Status status, ::StringW notification);

  /// @brief Method get_NoSelection, addr 0x657023c, size 0x70, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::ActionResult* get_NoSelection();

  /// @brief Method get_Success, addr 0x65701d0, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::ActionResult* get_Success();

  /// @brief Method get_UserCanceled, addr 0x65702ac, size 0x70, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::ActionResult* get_UserCanceled();

  /// @brief Method get_notification, addr 0x65700f8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_notification();

  /// @brief Method get_status, addr 0x65700e8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::ActionResult_Status get_status();

  /// @brief Method op_Implicit, addr 0x6570114, size 0x14, virtual false, abstract: false, final false
  static inline bool op_Implicit_bool(::UnityEngine::ProBuilder::ActionResult* res);

  /// @brief Method set_notification, addr 0x6570100, size 0x8, virtual false, abstract: false, final false
  inline void set_notification(::StringW value);

  /// @brief Method set_status, addr 0x65700f0, size 0x8, virtual false, abstract: false, final false
