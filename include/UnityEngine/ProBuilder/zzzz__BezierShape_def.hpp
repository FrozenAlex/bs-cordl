...
public:
  ...
  /// @brief Method Init, addr 0x66acde0, size 0x268, virtual false, abstract: false, final false
  inline void Init();

  static inline ::UnityEngine::ProBuilder::BezierShape* New_ctor();

  /// @brief Method Refresh, addr 0x66ad048, size 0xd8, virtual false, abstract: false, final false
  inline void Refresh();
  ...
  /// @brief Method .ctor, addr 0x66ad120, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isEditing, addr 0x66acd2c, size 0x8, virtual false, abstract: false, final false
  inline bool get_isEditing();

  /// @brief Method get_mesh, addr 0x66acd3c, size 0x9c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ProBuilder::ProBuilderMesh> get_mesh();

  /// @brief Method set_isEditing, addr 0x66acd34, size 0x8, virtual false, abstract: false, final false
  inline void set_isEditing(bool value);

  /// @brief Method set_mesh, addr 0x66acdd8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ProBuilder::BezierShape) == 0x48, "Size mismatch!");
