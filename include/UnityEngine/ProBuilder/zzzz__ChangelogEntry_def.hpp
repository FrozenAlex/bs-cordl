...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::ChangelogEntry*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::ChangelogEntry*, "UnityEngine.ProBuilder", "ChangelogEntry");
...
public:
  ...
  /// @brief Method ToString, addr 0x6575130, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6575128, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::SemVer* version, ::StringW releaseNotes);

  /// @brief Method get_releaseNotes, addr 0x6575120, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_releaseNotes();

  /// @brief Method get_versionInfo, addr 0x6575118, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ProBuilder::ChangelogEntry) == 0x20, "Size mismatch!");
