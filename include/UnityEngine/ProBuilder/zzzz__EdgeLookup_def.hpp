...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::EdgeLookup___c__DisplayClass16_0*);
...
public:
  ...
  /// @brief Method <GetEdgeLookup>b__0, addr 0x66b3f88, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66b3bf4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::ProBuilder::EdgeLookup___c__DisplayClass16_0) == 0x18, "Size mismatch!");

} // namespace UnityEngine::ProBuilder
// Dependencies UnityEngine.ProBuilder.Edge
namespace UnityEngine::ProBuilder {
// Is value type: true
...
public:
  ...
  /// @brief Method Equals, addr 0x66b36ac, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x66b361c, size 0x90, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ProBuilder::EdgeLookup other);

  /// @brief Method GetEdgeLookup, addr 0x66b3ae4, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEdgeLookupHashSet, addr 0x66b3bf8, size 0x390, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x66b373c, size 0x78, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x66b3944, size 0x1a0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x66b35fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::Edge common, ::UnityEngine::ProBuilder::Edge local);

  /// @brief Method .ctor, addr 0x66b3604, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(int32_t cx, int32_t cy, int32_t x, int32_t y);

  /// @brief Method get_common, addr 0x66b35ec, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Edge get_common();

  /// @brief Method get_local, addr 0x66b35dc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x66b37b4, size 0xcc, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::ProBuilder::EdgeLookup a, ::UnityEngine::ProBuilder::EdgeLookup b);

  /// @brief Method op_Inequality, addr 0x66b3880, size 0xc4, virtual false, abstract: false, final false
  static inline bool op_Inequality(::UnityEngine::ProBuilder::EdgeLookup a, ::UnityEngine::ProBuilder::EdgeLookup b);

  /// @brief Method set_common, addr 0x66b35f4, size 0x8, virtual false, abstract: false, final false
  inline void set_common(::UnityEngine::ProBuilder::Edge value);

  /// @brief Method set_local, addr 0x66b35e4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ProBuilder::EdgeLookup) == 0x10, "Size mismatch!");
