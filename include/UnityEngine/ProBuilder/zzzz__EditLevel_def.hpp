...
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::EditLevel, "UnityEngine.ProBuilder", "EditLevel");
// Dependencies
namespace UnityEngine::ProBuilder {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ProBuilder::EditLevel) == 0x4, "Size mismatch!");
