...
public:
  ...
  /// @brief Method SetMaterial, addr 0x66b0e78, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66b10d8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
