...
public:
  // Declarations
  /// @brief Method FaceRaycast, addr 0x66b7fb4, size 0x5ac, virtual false, abstract: false, final false
  ...
  /// @brief Method FaceRaycast, addr 0x66b72c8, size 0x524, virtual false, abstract: false, final false
  ...
  /// @brief Method FaceRaycast, addr 0x66b7288, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method FaceRaycastBothCullModes, addr 0x66b7a88, size 0x52c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetActiveElementPosition, addr 0x66ba99c, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetActiveElementPosition, addr 0x66ba310, size 0xb4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetActiveElementPosition(::UnityEngine::ProBuilder::ProBuilderMesh* mesh,
                                                                ::System::Collections::Generic::IEnumerable_1<::UnityEngine::ProBuilder::Face*>* faces);

  /// @brief Method GetActiveElementPosition, addr 0x66baa90, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEdgeRotation, addr 0x66b9fec, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEdgeRotation, addr 0x66b9ec0, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFaceRotation, addr 0x66b9818, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFaceRotation, addr 0x66b96ec, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRotation, addr 0x66b9040, size 0x6ac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVertexRotation, addr 0x66ba0c0, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVertexRotation, addr 0x66ba1e0, size 0x130, virtual false, abstract: false, final false
  static inline ::UnityEngine::Quaternion GetVertexRotation(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, int32_t vertex);

  /// @brief Method InverseTransformRay, addr 0x66b8560, size 0x1c0, virtual false, abstract: false, final false
  static inline ::UnityEngine::Ray InverseTransformRay(::UnityEngine::Transform* transform, ::UnityEngine::Ray InWorldRay);

  /// @brief Method MeshRaycast, addr 0x66b88a0, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method MeshRaycast, addr 0x66b8720, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method PointIsOccluded, addr 0x66b8d7c, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method ScreenToGuiPoint, addr 0x66b7238, size 0x50, virtual false, abstract: false, final false
