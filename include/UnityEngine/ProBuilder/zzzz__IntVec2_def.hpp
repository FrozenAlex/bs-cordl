...
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::IntVec2, "UnityEngine.ProBuilder", "IntVec2");
...
public:
  ...
  /// @brief Method Equals, addr 0x66bb378, size 0xc0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* b);

  /// @brief Method Equals, addr 0x66bb20c, size 0x6c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ProBuilder::IntVec2 p);

  /// @brief Method Equals, addr 0x66bb30c, size 0x6c, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::Vector2 p);

  /// @brief Method GetHashCode, addr 0x66bb438, size 0x80, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x66bb134, size 0xb4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x66bb12c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector2 vector);

  /// @brief Method get_x, addr 0x66bb11c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_x();

  /// @brief Method get_y, addr 0x66bb124, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x66bb1e8, size 0x24, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::ProBuilder::IntVec2 a, ::UnityEngine::ProBuilder::IntVec2 b);

  /// @brief Method op_Implicit, addr 0x66bb4bc, size 0x4, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::IntVec2 op_Implicit___UnityEngine__ProBuilder__IntVec2(::UnityEngine::Vector2 p);

  /// @brief Method op_Implicit, addr 0x66bb4b8, size 0x4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 op_Implicit___UnityEngine__Vector2(::UnityEngine::ProBuilder::IntVec2 p);

  /// @brief Method op_Inequality, addr 0x66bb278, size 0x28, virtual false, abstract: false, final false
  static inline bool op_Inequality(::UnityEngine::ProBuilder::IntVec2 a, ::UnityEngine::ProBuilder::IntVec2 b);

  /// @brief Method round, addr 0x66bb2a0, size 0x6c, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ProBuilder::IntVec2) == 0x8, "Size mismatch!");
