...
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::LogOutput, "UnityEngine.ProBuilder", "LogOutput");
// Dependencies
namespace UnityEngine::ProBuilder {
// Is value type: true
...
public:
  ...
  /// @brief Field Console value: I32(1)
  static ::UnityEngine::ProBuilder::LogOutput const Console;

  /// @brief Field File value: I32(2)
...
static_assert(sizeof(::UnityEngine::ProBuilder::LogOutput) == 0x4, "Size mismatch!");
