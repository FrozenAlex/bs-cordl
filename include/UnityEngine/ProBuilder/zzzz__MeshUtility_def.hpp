...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::MeshUtility*);
...
public:
  ...
  /// @brief Method <CollapseSharedVertices>b__11_0, addr 0x66c8710, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66c870c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CollapseSharedVertices, addr 0x66c6fc4, size 0x554, virtual false, abstract: false, final false
  static inline void CollapseSharedVertices(::UnityEngine::Mesh* mesh, ::ArrayW<::UnityEngine::ProBuilder::Vertex*> vertices);

  /// @brief Method Compile, addr 0x66c6670, size 0x318, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyTo, addr 0x66c5264, size 0x46c, virtual false, abstract: false, final false
  static inline void CopyTo(::UnityEngine::Mesh* source, ::UnityEngine::Mesh* destination);

  /// @brief Method DeepCopy, addr 0x66c51fc, size 0x68, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Mesh> DeepCopy(::UnityEngine::Mesh* source);

  /// @brief Method FitToSize, addr 0x66c7518, size 0x334, virtual false, abstract: false, final false
  ...
  /// @brief Method GeneratePerTriangleMesh, addr 0x66c4420, size 0x30c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::ProBuilder::Vertex*> GeneratePerTriangleMesh(::UnityEngine::Mesh* mesh);

  /// @brief Method GenerateTangent, addr 0x66c4c9c, size 0x560, virtual false, abstract: false, final false
  static inline void GenerateTangent(::UnityEngine::Mesh* mesh);

  /// @brief Method GetBounds, addr 0x66c8528, size 0xd0, virtual false, abstract: false, final false
  static inline ::UnityEngine::Bounds GetBounds(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method GetIndexCount, addr 0x66c6494, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPrimitiveCount, addr 0x66c6558, size 0x118, virtual false, abstract: false, final false
  static inline uint32_t GetPrimitiveCount(::UnityEngine::Mesh* mesh);

  /// @brief Method GetVertices, addr 0x66c472c, size 0x570, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::ProBuilder::Vertex*> GetVertices(::UnityEngine::Mesh* mesh);

  /// @brief Method IsUsedInParticleSystem, addr 0x66c8334, size 0xf0, virtual false, abstract: false, final false
  static inline bool IsUsedInParticleSystem(::UnityEngine::ProBuilder::ProBuilderMesh* pbmesh);

  /// @brief Method Print, addr 0x66c56d0, size 0xdb4, virtual false, abstract: false, final false
  ...
  /// @brief Method RestoreParticleSystem, addr 0x66c8498, size 0x90, virtual false, abstract: false, final false
  static inline void RestoreParticleSystem(::UnityEngine::ProBuilder::ProBuilderMesh* pbmesh);

  /// @brief Method SanityCheck, addr 0x66c6484, size 0x10, virtual false, abstract: false, final false
  static inline ::StringW SanityCheck(::UnityEngine::Mesh* mesh);

  /// @brief Method SanityCheck, addr 0x66c7884, size 0x1c, virtual false, abstract: false, final false
  static inline ::StringW SanityCheck(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method SanityCheck, addr 0x66c7f48, size 0x3ec, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::ProBuilder::MeshUtility) == 0x10, "Size mismatch!");
