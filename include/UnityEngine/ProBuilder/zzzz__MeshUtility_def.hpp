...
public:
  ...
  /// @brief Method <CollapseSharedVertices>b__11_0, addr 0x658d268, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x658d264, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CollapseSharedVertices, addr 0x658bb1c, size 0x554, virtual false, abstract: false, final false
  static inline void CollapseSharedVertices(::UnityEngine::Mesh* mesh, ::ArrayW<::UnityEngine::ProBuilder::Vertex*> vertices);

  /// @brief Method Compile, addr 0x658b1c8, size 0x318, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyTo, addr 0x6589dbc, size 0x46c, virtual false, abstract: false, final false
  static inline void CopyTo(::UnityEngine::Mesh* source, ::UnityEngine::Mesh* destination);

  /// @brief Method DeepCopy, addr 0x6589d54, size 0x68, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Mesh> DeepCopy(::UnityEngine::Mesh* source);

  /// @brief Method FitToSize, addr 0x658c070, size 0x334, virtual false, abstract: false, final false
  ...
  /// @brief Method GeneratePerTriangleMesh, addr 0x6588f78, size 0x30c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::ProBuilder::Vertex*> GeneratePerTriangleMesh(::UnityEngine::Mesh* mesh);

  /// @brief Method GenerateTangent, addr 0x65897f4, size 0x560, virtual false, abstract: false, final false
  static inline void GenerateTangent(::UnityEngine::Mesh* mesh);

  /// @brief Method GetBounds, addr 0x658d080, size 0xd0, virtual false, abstract: false, final false
  static inline ::UnityEngine::Bounds GetBounds(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method GetIndexCount, addr 0x658afec, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPrimitiveCount, addr 0x658b0b0, size 0x118, virtual false, abstract: false, final false
  static inline uint32_t GetPrimitiveCount(::UnityEngine::Mesh* mesh);

  /// @brief Method GetVertices, addr 0x6589284, size 0x570, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::ProBuilder::Vertex*> GetVertices(::UnityEngine::Mesh* mesh);

  /// @brief Method IsUsedInParticleSystem, addr 0x658ce8c, size 0xf0, virtual false, abstract: false, final false
  static inline bool IsUsedInParticleSystem(::UnityEngine::ProBuilder::ProBuilderMesh* pbmesh);

  /// @brief Method Print, addr 0x658a228, size 0xdb4, virtual false, abstract: false, final false
  ...
  /// @brief Method RestoreParticleSystem, addr 0x658cff0, size 0x90, virtual false, abstract: false, final false
  static inline void RestoreParticleSystem(::UnityEngine::ProBuilder::ProBuilderMesh* pbmesh);

  /// @brief Method SanityCheck, addr 0x658afdc, size 0x10, virtual false, abstract: false, final false
  static inline ::StringW SanityCheck(::UnityEngine::Mesh* mesh);

  /// @brief Method SanityCheck, addr 0x658c3dc, size 0x1c, virtual false, abstract: false, final false
  static inline ::StringW SanityCheck(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method SanityCheck, addr 0x658caa0, size 0x3ec, virtual false, abstract: false, final false
