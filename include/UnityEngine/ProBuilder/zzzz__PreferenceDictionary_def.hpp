...
public:
  ...
  /// @brief Method Clear, addr 0x66cb160, size 0xf4, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method DeleteKey, addr 0x66ca7f0, size 0x2b8, virtual false, abstract: false, final false
  inline void DeleteKey(::StringW key);

  /// @brief Method Get, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> inline T Get(::StringW key, T fallback);

  /// @brief Method GetBool, addr 0x66caaa8, size 0x94, virtual false, abstract: false, final false
  inline bool GetBool(::StringW key, bool fallback);

  /// @brief Method GetBoolDictionary, addr 0x66cb130, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, bool>* GetBoolDictionary();

  /// @brief Method GetColor, addr 0x66cacdc, size 0xb4, virtual false, abstract: false, final false
  inline ::UnityEngine::Color GetColor(::StringW key, ::UnityEngine::Color fallback);

  /// @brief Method GetColorDictionary, addr 0x66cb150, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::UnityEngine::Color>* GetColorDictionary();

  /// @brief Method GetFloat, addr 0x66cabc4, size 0x90, virtual false, abstract: false, final false
  inline float_t GetFloat(::StringW key, float_t fallback);

  /// @brief Method GetFloatDictionary, addr 0x66cb140, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, float_t>* GetFloatDictionary();

  /// @brief Method GetInt, addr 0x66cab3c, size 0x88, virtual false, abstract: false, final false
  inline int32_t GetInt(::StringW key, int32_t fallback);

  /// @brief Method GetIntDictionary, addr 0x66cb138, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, int32_t>* GetIntDictionary();

  /// @brief Method GetMaterial, addr 0x66cad90, size 0x88, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> GetMaterial(::StringW key, ::UnityEngine::Material* fallback);

  /// @brief Method GetMaterialDictionary, addr 0x66cb158, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::UnityW<::UnityEngine::Material>>* GetMaterialDictionary();

  /// @brief Method GetString, addr 0x66cac54, size 0x88, virtual false, abstract: false, final false
  inline ::StringW GetString(::StringW key, ::StringW fallback);

  /// @brief Method GetStringDictionary, addr 0x66cb148, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>* GetStringDictionary();

  /// @brief Method HasKey, addr 0x66ca640, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnAfterDeserialize, addr 0x66ca0d4, size 0x450, virtual true, abstract: false, final true
  inline void OnAfterDeserialize();

  /// @brief Method OnBeforeSerialize, addr 0x66c9d78, size 0x35c, virtual true, abstract: false, final true
  inline void OnBeforeSerialize();

  /// @brief Method Set, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> inline void Set(::StringW key, T value);

  /// @brief Method SetBool, addr 0x66cae18, size 0x7c, virtual false, abstract: false, final false
  inline void SetBool(::StringW key, bool value);

  /// @brief Method SetColor, addr 0x66cb010, size 0xa4, virtual false, abstract: false, final false
  inline void SetColor(::StringW key, ::UnityEngine::Color value);

  /// @brief Method SetDefaultValues, addr 0x66ca524, size 0x11c, virtual true, abstract: false, final true
  inline void SetDefaultValues();

  /// @brief Method SetFloat, addr 0x66caf10, size 0x84, virtual false, abstract: false, final false
  inline void SetFloat(::StringW key, float_t value);

  /// @brief Method SetInt, addr 0x66cae94, size 0x7c, virtual false, abstract: false, final false
  inline void SetInt(::StringW key, int32_t value);

  /// @brief Method SetMaterial, addr 0x66cb0b4, size 0x7c, virtual false, abstract: false, final false
  inline void SetMaterial(::StringW key, ::UnityEngine::Material* value);

  /// @brief Method SetString, addr 0x66caf94, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66cb254, size 0x2bc, virtual false, abstract: false, final false
  inline void _ctor();
