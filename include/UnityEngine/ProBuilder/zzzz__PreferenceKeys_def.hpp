...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::PreferenceKeys*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::PreferenceKeys*, "UnityEngine.ProBuilder", "PreferenceKeys");
...
static_assert(sizeof(::UnityEngine::ProBuilder::PreferenceKeys) == 0x10, "Size mismatch!");
