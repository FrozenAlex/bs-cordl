...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::RaycastHit*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::RaycastHit*, "UnityEngine.ProBuilder", "RaycastHit");
...
public:
  ...
  /// @brief Method .ctor, addr 0x66d809c, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ProBuilder::RaycastHit) == 0x30, "Size mismatch!");
