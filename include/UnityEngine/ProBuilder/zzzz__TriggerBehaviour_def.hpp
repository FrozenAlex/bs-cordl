...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::TriggerBehaviour*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::TriggerBehaviour*, "UnityEngine.ProBuilder", "TriggerBehaviour");
...
public:
  // Declarations
  /// @brief Method Initialize, addr 0x65b5cb0, size 0x1b0, virtual true, abstract: false, final false
  inline void Initialize();

  static inline ::UnityEngine::ProBuilder::TriggerBehaviour* New_ctor();

  /// @brief Method OnEnterPlayMode, addr 0x65b5e60, size 0x7c, virtual true, abstract: false, final false
  inline void OnEnterPlayMode();

  /// @brief Method OnSceneLoaded, addr 0x65b5edc, size 0x7c, virtual true, abstract: false, final false
  inline void OnSceneLoaded(::UnityEngine::SceneManagement::Scene scene, ::UnityEngine::SceneManagement::LoadSceneMode mode);

  /// @brief Method .ctor, addr 0x65b5f58, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::ProBuilder::TriggerBehaviour) == 0x28, "Size mismatch!");
