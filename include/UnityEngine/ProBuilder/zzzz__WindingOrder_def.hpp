...
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::WindingOrder, "UnityEngine.ProBuilder", "WindingOrder");
// Dependencies
namespace UnityEngine::ProBuilder {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ProBuilder::WindingOrder) == 0x4, "Size mismatch!");
