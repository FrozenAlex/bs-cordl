...
public:
  ...
  /// @brief Method Dispose, addr 0x66fa818, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x66fa7c4, size 0x3c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::ProBuilder::WingedEdgeEnumerator* New_ctor(::UnityEngine::ProBuilder::WingedEdge* start);

  /// @brief Method Reset, addr 0x66fa800, size 0x8, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x66fa810, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x66fa7bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::WingedEdge* start);

  /// @brief Method get_Current, addr 0x66fa808, size 0x8, virtual true, abstract: false, final true
