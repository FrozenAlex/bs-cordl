...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x69a5188, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Create, addr 0x69a507c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69a4fc0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x69a5018, size 0x64, virtual false, abstract: false, final false
