...
public:
  ...
  /// @brief Method IsValid, addr 0x67dc740, size 0xe4, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method .ctor, addr 0x67dc558, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_nullHandle, addr 0x67dc4f8, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RenderGraphModule::RayTracingAccelerationStructureHandle get_nullHandle();

  /// @brief Method op_Implicit, addr 0x67dc650, size 0xf0, virtual false, abstract: false, final false
