...
public:
  ...
  /// @brief Method IsValid, addr 0x66a1298, size 0xe4, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method .ctor, addr 0x66a10b0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_nullHandle, addr 0x66a1050, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RenderGraphModule::RayTracingAccelerationStructureHandle get_nullHandle();

  /// @brief Method op_Implicit, addr 0x66a11a8, size 0xf0, virtual false, abstract: false, final false
