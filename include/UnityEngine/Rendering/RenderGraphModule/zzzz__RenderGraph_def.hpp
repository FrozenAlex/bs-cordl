...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::NRPInfo_PassData_DebugData_RenderGraph_NativeRenderPassInfo*, "UnityEngine.Rendering.RenderGraphModule",
                    "RenderGraph/DebugData/PassData/NRPInfo/NativeRenderPassInfo");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassInfo_NRPInfo_PassData_DebugData_RenderGraph_AttachmentInfo*, "UnityEngine.Rendering.RenderGraphModule",
...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassInfo_NRPInfo_PassData_DebugData_RenderGraph_PassCompatibilityInfo, "UnityEngine.Rendering.RenderGraphModule",
...
public:
  // Declarations
  /// @brief Method Reset, addr 0x6697e94, size 0xe8, virtual false, abstract: false, final false
  inline void Reset();
...
public:
  // Declarations
  /// @brief Method Reset, addr 0x6697f7c, size 0x214, virtual false, abstract: false, final false
  ...
  constexpr RenderGraph_CompiledPassInfo(::StringW name, int32_t index, ::ArrayW<::System::Collections::Generic::List_1<int32_t>*> resourceCreateList,
                                         ...
                                         bool culledByRendererList, bool hasSideEffect, bool enableFoveatedRasterization) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::RenderGraph_CompiledPassInfo) == 0x48, "Size mismatch!");
...
public:
  ...
  /// @brief Method Clear, addr 0x66982dc, size 0xa0, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method InitResourceInfosData, addr 0x669837c, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method InitializeCompilationData, addr 0x6698454, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6698190, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6698640, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x669879c, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x66987bc, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x6698788, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6698644, size 0x144, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x6698924, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x669894c, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x6698910, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66987c8, size 0x148, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  ...
  /// @brief Method .ctor, addr 0x6698ce4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6698ce0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6698c4c, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::DebugData_RenderGraph_PassData) == 0x48, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6698ce8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6698cec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6698cf0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_resourceLists,
  ...
  /// @brief Method Clear, addr 0x6698abc, size 0xdc, virtual false, abstract: false, final false
  inline void Clear();
  ...
  constexpr ::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::Rendering::RenderGraphModule::DebugData_RenderGraph_ResourceData>*> const& __cordl_internal_get_resourceLists() const;

  constexpr ::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::Rendering::RenderGraphModule::DebugData_RenderGraph_ResourceData>*>& __cordl_internal_get_resourceLists();
  ...
  constexpr void __cordl_internal_set_resourceLists(::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::Rendering::RenderGraphModule::DebugData_RenderGraph_ResourceData>*> value);

  /// @brief Method .ctor, addr 0x6698958, size 0x164, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::Rendering::RenderGraphModule::DebugData_RenderGraph_ResourceData>*> ___resourceLists;
...
public:
  ...
  /// @brief Method <BeginProfilingSampler>b__110_0, addr 0x6698d4c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method <EndProfilingSampler>b__111_0, addr 0x6698d8c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6698d48, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_m_ImmediateModeResourceList, put = __cordl_internal_set_m_ImmediateModeResourceList)) ::ArrayW<::System::Collections::Generic::List_1<int32_t>*>
  ...
  /// @brief Method AddPassDebugMetadata, addr 0x6697c28, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method AllGlobals, addr 0x6697b58, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method AllocateCulledPassResources, addr 0x669350c, size 0x36c, virtual false, abstract: false, final false
  ...
  /// @brief Method AreRendererListsEmpty, addr 0x66941a8, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method BeginProfilingSampler, addr 0x6690784, size 0x210, virtual false, abstract: false, final false
  inline void BeginProfilingSampler(::UnityEngine::Rendering::ProfilingSampler* sampler, ::StringW file, int32_t line);

  /// @brief Method BeginRecording, addr 0x668fb14, size 0x2c4, virtual false, abstract: false, final false
  inline void BeginRecording(::by_ref<::UnityEngine::Rendering::RenderGraphModule::RenderGraphParameters> parameters);

  /// @brief Method Cleanup, addr 0x668ef58, size 0x110, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method CleanupDebugData, addr 0x66966a0, size 0x198, virtual false, abstract: false, final false
  inline void CleanupDebugData();

  /// @brief Method ClearCompiledGraph, addr 0x6690bbc, size 0xc, virtual false, abstract: false, final false
  inline void ClearCompiledGraph();

  /// @brief Method ClearCompiledGraph, addr 0x6690bc8, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearGlobalBindings, addr 0x66905a4, size 0x1e0, virtual false, abstract: false, final false
  inline void ClearGlobalBindings();

  /// @brief Method ClearPassDebugMetadata, addr 0x6697d74, size 0x80, virtual false, abstract: false, final false
  inline void ClearPassDebugMetadata();

  /// @brief Method ClearRenderPasses, addr 0x6690c9c, size 0x15c, virtual false, abstract: false, final false
  inline void ClearRenderPasses();

  /// @brief Method CompileNativeRenderGraph, addr 0x668e224, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method CompilePassImmediatly, addr 0x669468c, size 0x800, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileRenderGraph, addr 0x669036c, size 0x128, virtual false, abstract: false, final false
  inline void CompileRenderGraph(int32_t graphHash);

  /// @brief Method ComputeGraphHash, addr 0x6690254, size 0x118, virtual false, abstract: false, final false
  inline int32_t ComputeGraphHash();

  /// @brief Method CountReferences, addr 0x66917c8, size 0x6b4, virtual false, abstract: false, final false
  inline void CountReferences();

  /// @brief Method CreateBuffer, addr 0x6680af4, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateBuffer, addr 0x668fa58, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateGizmoRendererList, addr 0x668f820, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererList, addr 0x668f7c8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererList, addr 0x668f7a4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererLists, addr 0x66930b0, size 0x148, virtual false, abstract: false, final false
  inline void CreateRendererLists();

  /// @brief Method CreateShadowRendererList, addr 0x668f7ec, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSharedTexture, addr 0x668f440, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSkyboxRendererList, addr 0x668f904, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSkyboxRendererList, addr 0x668f938, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSkyboxRendererList, addr 0x668f9a0, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTexture, addr 0x668f424, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTexture, addr 0x668f564, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTextureIfInvalid, addr 0x668f5c8, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateUIOverlayRendererList, addr 0x668f858, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateUIOverlayRendererList, addr 0x668f898, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateWireOverlayRendererList, addr 0x668f8d0, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method CullRendererLists, addr 0x6694460, size 0x118, virtual false, abstract: false, final false
  inline void CullRendererLists();

  /// @brief Method CullUnusedPasses, addr 0x6691e7c, size 0x5b4, virtual false, abstract: false, final false
  inline void CullUnusedPasses();

  /// @brief Method EndFrame, addr 0x668f1e0, size 0xcc, virtual false, abstract: false, final false
  inline void EndFrame();

  /// @brief Method EndProfilingSampler, addr 0x6690994, size 0x210, virtual false, abstract: false, final false
  inline void EndProfilingSampler(::UnityEngine::Rendering::ProfilingSampler* sampler, ::StringW file, int32_t line);

  /// @brief Method EndRecordingAndExecute, addr 0x669000c, size 0x4, virtual false, abstract: false, final false
  inline void EndRecordingAndExecute();

  /// @brief Method Execute, addr 0x6690010, size 0x244, virtual false, abstract: false, final false
  inline void Execute();

  /// @brief Method ExecuteCompiledPass, addr 0x6694e8c, size 0x374, virtual false, abstract: false, final false
  inline void ExecuteCompiledPass(::by_ref<::UnityEngine::Rendering::RenderGraphModule::RenderGraph_CompiledPassInfo> passInfo);

  /// @brief Method ExecuteNativeRenderGraph, addr 0x668e508, size 0x11c, virtual false, abstract: false, final false
  inline void ExecuteNativeRenderGraph();

  /// @brief Method ExecutePassImmediately, addr 0x6690e4c, size 0x1c, virtual false, abstract: false, final false
  inline void ExecutePassImmediately(::UnityEngine::Rendering::RenderGraphModule::RenderGraphPass* pass);

  /// @brief Method ExecuteRenderGraph, addr 0x6690494, size 0x110, virtual false, abstract: false, final false
  inline void ExecuteRenderGraph();

  /// @brief Method FindTextureProducer, addr 0x6692ca0, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCompilerDebugData, addr 0x6696838, size 0x10f8, virtual false, abstract: false, final false
  inline void GenerateCompilerDebugData(::by_ref<::UnityEngine::Rendering::RenderGraphModule::RenderGraph_DebugData*> debugData);

  /// @brief Method GenerateDebugData, addr 0x6696468, size 0x238, virtual false, abstract: false, final false
  inline void GenerateDebugData();

  /// @brief Method GetBufferDesc, addr 0x668faac, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCompiledPassInfos, addr 0x6690ba4, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDebugData, addr 0x668f164, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderGraphModule::RenderGraph_DebugData* GetDebugData(::StringW executionName);

  /// @brief Method GetDefaultProfilingSampler, addr 0x66962f4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::ProfilingSampler* GetDefaultProfilingSampler(::StringW name);

  /// @brief Method GetFirstValidConsumerIndex, addr 0x6692b44, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFirstValidWriteIndex, addr 0x6692ebc, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method GetGlobal, addr 0x6697bac, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderGraphModule::TextureHandle GetGlobal(int32_t globalPropertyId);

  /// @brief Method GetImportedFallback, addr 0x66931f8, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLatestProducerIndex, addr 0x66929d4, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLatestValidReadIndex, addr 0x6692dcc, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLatestValidWriteIndex, addr 0x6692fc0, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRegisteredRenderGraphs, addr 0x668f108, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRenderTargetInfo, addr 0x668f754, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTextureDesc, addr 0x668f708, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWidgetList, addr 0x668f070, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::Rendering::DebugUI_Widget*>* GetWidgetList();

  /// @brief Method ImportBackbuffer, addr 0x668f3c4, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportBackbuffer, addr 0x668f388, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderGraphModule::TextureHandle ImportBackbuffer(::UnityEngine::Rendering::RenderTargetIdentifier rt,
  ...
  /// @brief Method ImportBuffer, addr 0x668fa30, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportRayTracingAccelerationStructure, addr 0x668faf0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportTexture, addr 0x668f2ac, size 0x38, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderGraphModule::TextureHandle ImportTexture(::UnityEngine::Rendering::RTHandle* rt);

  /// @brief Method ImportTexture, addr 0x668f2e4, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderGraphModule::TextureHandle ImportTexture(::UnityEngine::Rendering::RTHandle* rt,
                                                                                  ::UnityEngine::Rendering::RenderGraphModule::ImportResourceParams importParams);

  /// @brief Method ImportTexture, addr 0x668f30c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportTexture, addr 0x668f34c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method InvalidateContext, addr 0x6690df8, size 0x1c, virtual false, abstract: false, final false
  inline void InvalidateContext();

  /// @brief Method IsGlobal, addr 0x6697adc, size 0x7c, virtual false, abstract: false, final false
  inline bool IsGlobal(int32_t globalPropertyId);

  /// @brief Method LogCulledPasses, addr 0x6692430, size 0x440, virtual false, abstract: false, final false
  inline void LogCulledPasses();

  /// @brief Method LogFrameInformation, addr 0x668fe18, size 0x1f4, virtual false, abstract: false, final false
  inline void LogFrameInformation();

  /// @brief Method LogRenderPassBegin, addr 0x6695200, size 0x348, virtual false, abstract: false, final false
  inline void LogRenderPassBegin(::by_ref<::UnityEngine::Rendering::RenderGraphModule::RenderGraph_CompiledPassInfo> passInfo);

  /// @brief Method LogRendererListsCreation, addr 0x6694578, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method OnPassAdded, addr 0x6690e14, size 0x38, virtual false, abstract: false, final false
  inline void OnPassAdded(::UnityEngine::Rendering::RenderGraphModule::RenderGraphPass* pass);

  /// @brief Method PostRenderPassExecute, addr 0x6695854, size 0x3ac, virtual false, abstract: false, final false
  inline void PostRenderPassExecute(::by_ref<::UnityEngine::Rendering::RenderGraphModule::RenderGraph_CompiledPassInfo> passInfo, ::UnityEngine::Rendering::RenderGraphModule::RenderGraphPass* pass,
                                    ::UnityEngine::Rendering::RenderGraphModule::InternalRenderGraphContext* rgContext);

  /// @brief Method PreRenderPassExecute, addr 0x6695548, size 0x30c, virtual false, abstract: false, final false
  ...
  /// @brief Method PreRenderPassSetRenderTargets, addr 0x6695c00, size 0x5a8, virtual false, abstract: false, final false
  ...
  /// @brief Method RefreshSharedTextureDesc, addr 0x668f4b0, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterDebug, addr 0x668f0d4, size 0x20, virtual false, abstract: false, final false
  inline void RegisterDebug(::UnityEngine::Rendering::DebugUI_Panel* panel);

  /// @brief Method ReleaseImmediateModeResources, addr 0x66961a8, size 0x14c, virtual false, abstract: false, final false
  inline void ReleaseImmediateModeResources();

  /// @brief Method ReleaseSharedTexture, addr 0x668f4e4, size 0x80, virtual false, abstract: false, final false
  inline void ReleaseSharedTexture(::UnityEngine::Rendering::RenderGraphModule::TextureHandle texture);

  /// @brief Method RequestCaptureDebugData, addr 0x668e644, size 0x8, virtual false, abstract: false, final false
  inline void RequestCaptureDebugData(::StringW executionName);

  /// @brief Method SetGlobal, addr 0x6697930, size 0x1ac, virtual false, abstract: false, final false
  inline void SetGlobal(::UnityEngine::Rendering::RenderGraphModule::TextureHandle h, int32_t globalPropertyId);

  /// @brief Method TryCullPassAtIndex, addr 0x669437c, size 0xe4, virtual false, abstract: false, final false
  inline void TryCullPassAtIndex(int32_t passIndex);

  /// @brief Method UnRegisterDebug, addr 0x668f0f4, size 0x14, virtual false, abstract: false, final false
  inline void UnRegisterDebug();

  /// @brief Method UpdateAllSharedResourceLastFrameIndex, addr 0x6694078, size 0x130, virtual false, abstract: false, final false
  inline void UpdateAllSharedResourceLastFrameIndex();

  /// @brief Method UpdateCurrentCompiledGraph, addr 0x668fdd8, size 0x40, virtual false, abstract: false, final false
  inline bool UpdateCurrentCompiledGraph(int32_t graphHash, bool forceNoCaching);

  /// @brief Method UpdateImportedResourceLifeTime, addr 0x66962fc, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdatePassSynchronization, addr 0x6692870, size 0x28, virtual false, abstract: false, final false
  inline void UpdatePassSynchronization(::by_ref<::UnityEngine::Rendering::RenderGraphModule::RenderGraph_CompiledPassInfo> currentPassInfo,
                                        ::by_ref<::UnityEngine::Rendering::RenderGraphModule::RenderGraph_CompiledPassInfo> producerPassInfo, int32_t currentPassIndex, int32_t lastProducer,
                                        ::by_ref<int32_t> intLastSyncIndex);

  /// @brief Method UpdateResourceAllocationAndSynchronization, addr 0x6693878, size 0x800, virtual false, abstract: false, final false
  inline void UpdateResourceAllocationAndSynchronization();

  /// @brief Method UpdateResourceSynchronization, addr 0x6692898, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x668e7d4, size 0x784, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method add_onDebugDataCaptured, addr 0x66915e8, size 0xf0, virtual false, abstract: false, final false
  static inline void add_onDebugDataCaptured(::System::Action* value);

  /// @brief Method add_onExecutionRegistered, addr 0x6691228, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onExecutionUnregistered, addr 0x6691408, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onGraphRegistered, addr 0x6690e68, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onGraphUnregistered, addr 0x6691048, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_areAnySettingsActive, addr 0x668f08c, size 0x48, virtual false, abstract: false, final false
  inline bool get_areAnySettingsActive();

  /// @brief Method get_debugParams, addr 0x668f068, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderGraphModule::RenderGraphDebugParams* get_debugParams();

  /// @brief Method get_defaultResources, addr 0x668e7cc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderGraphModule::RenderGraphDefaultResources* get_defaultResources();

  /// @brief Method get_enableValidityChecks, addr 0x668e70c, size 0x5c, virtual false, abstract: false, final false
  static inline bool get_enableValidityChecks();

  /// @brief Method get_isRenderGraphViewerActive, addr 0x668e64c, size 0x5c, virtual false, abstract: false, final false
  static inline bool get_isRenderGraphViewerActive();

  /// @brief Method get_name, addr 0x668e634, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_nativeRenderPassesEnabled, addr 0x668e624, size 0x8, virtual false, abstract: false, final false
  inline bool get_nativeRenderPassesEnabled();

  /// @brief Method remove_onDebugDataCaptured, addr 0x66916d8, size 0xf0, virtual false, abstract: false, final false
  static inline void remove_onDebugDataCaptured(::System::Action* value);

  /// @brief Method remove_onExecutionRegistered, addr 0x6691318, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onExecutionUnregistered, addr 0x66914f8, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onGraphRegistered, addr 0x6690f58, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onGraphUnregistered, addr 0x6691138, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_enableValidityChecks, addr 0x668e768, size 0x64, virtual false, abstract: false, final false
  static inline void set_enableValidityChecks(bool value);

  /// @brief Method set_isRenderGraphViewerActive, addr 0x668e6a8, size 0x64, virtual false, abstract: false, final false
  static inline void set_isRenderGraphViewerActive(bool value);

  /// @brief Method set_name, addr 0x668e63c, size 0x8, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method set_nativeRenderPassesEnabled, addr 0x668e62c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::RenderGraph) == 0xe8, "Size mismatch!");
