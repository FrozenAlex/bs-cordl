...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::UI::DebugUIHandlerGroup::*)(::UnityEngine::Rendering::DebugUI_Widget*)>(
  ...
  constexpr static std::size_t addrs = 0x67fbef0;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::UI::DebugUIHandlerGroup*>(), { ::i2c::class_of<::UnityEngine::Rendering::UI::DebugUIHandlerGroup*>(), 5 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::UnityEngine::Rendering::UI::DebugUIHandlerGroup::*)(bool, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*)>(
  ...
  constexpr static std::size_t addrs = 0x67fbfe4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::UI::DebugUIHandlerGroup*>(), { ::i2c::class_of<::UnityEngine::Rendering::UI::DebugUIHandlerGroup*>(), 6 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> (::UnityEngine::Rendering::UI::DebugUIHandlerGroup::*)()>(
  ...
  constexpr static std::size_t addrs = 0x67fc0a4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::UI::DebugUIHandlerGroup*>(), { ::i2c::class_of<::UnityEngine::Rendering::UI::DebugUIHandlerGroup*>(), 12 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::UI::DebugUIHandlerGroup::*)()>(&::UnityEngine::Rendering::UI::DebugUIHandlerGroup::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x67fc160;
...
inline void UnityEngine::Rendering::UI::DebugUIHandlerGroup::SetWidget(::UnityEngine::Rendering::DebugUI_Widget* widget) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Rendering::UI::DebugUIHandlerGroup*>(), 5 })));
...
inline bool UnityEngine::Rendering::UI::DebugUIHandlerGroup::OnSelection(bool fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget* previous) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Rendering::UI::DebugUIHandlerGroup*>(), 6 })));
...
inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> UnityEngine::Rendering::UI::DebugUIHandlerGroup::Next() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Rendering::UI::DebugUIHandlerGroup*>(), 12 })));
