...
public:
  ...
  /// @brief Method get_IsDX10, addr 0x67a4fe8, size 0x4c, virtual false, abstract: false, final false
  static inline bool get_IsDX10();

  /// @brief Method get_IsOpenGL, addr 0x67a4f48, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsDX10, addr 0x67a5034, size 0x54, virtual false, abstract: false, final false
  static inline void set_IsDX10(bool value);

  /// @brief Method set_IsOpenGL, addr 0x67a4f94, size 0x54, virtual false, abstract: false, final false
