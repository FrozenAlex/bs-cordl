...
public:
  ...
  /// @brief Method Clear, addr 0x69031a0, size 0x80, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Dispose, addr 0x6902d94, size 0x54, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method EnableMSAA, addr 0x6903304, size 0x80, virtual false, abstract: false, final false
  inline void EnableMSAA(bool enable);

  /// @brief Method GetBackBuffer, addr 0x6902e30, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* GetBackBuffer(::UnityEngine::Rendering::CommandBuffer* cmd);

  /// @brief Method GetBufferA, addr 0x6903384, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* GetBufferA();

  /// @brief Method GetFrontBuffer, addr 0x69030b0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method PeekBackBuffer, addr 0x6902de8, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* PeekBackBuffer();

  /// @brief Method ReAllocate, addr 0x6902e48, size 0x268, virtual false, abstract: false, final false
  inline void ReAllocate(::UnityEngine::Rendering::CommandBuffer* cmd);

  /// @brief Method SetCameraSettings, addr 0x6903220, size 0xe4, virtual false, abstract: false, final false
  inline void SetCameraSettings(::UnityEngine::RenderTextureDescriptor desc, ::UnityEngine::FilterMode filterMode);

  /// @brief Method Swap, addr 0x690313c, size 0x64, virtual false, abstract: false, final false
  inline void Swap();
  ...
  /// @brief Method .ctor, addr 0x6902cfc, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method get_backBuffer, addr 0x6902c1c, size 0x70, virtual false, abstract: false, final false
  inline ::by_ref<::UnityEngine::Rendering::Universal::Internal::RenderTargetBufferSystem_SwapBuffer> get_backBuffer();

  /// @brief Method get_frontBuffer, addr 0x6902c8c, size 0x70, virtual false, abstract: false, final false
