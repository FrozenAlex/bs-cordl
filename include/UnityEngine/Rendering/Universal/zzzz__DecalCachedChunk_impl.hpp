...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::Universal::DecalCachedChunk::*)(int32_t)>(
  ...
  constexpr static std::size_t addrs = 0x671a9b4;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::Universal::DecalCachedChunk::*)(int32_t)>(&::UnityEngine::Rendering::Universal::DecalCachedChunk::SetCapacity)> {
  ...
  constexpr static std::size_t addrs = 0x671acb0;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::Universal::DecalCachedChunk::*)()>(&::UnityEngine::Rendering::Universal::DecalCachedChunk::Dispose)> {
  ...
  constexpr static std::size_t addrs = 0x671af34;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::Universal::DecalCachedChunk::*)()>(&::UnityEngine::Rendering::Universal::DecalCachedChunk::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x67190c4;
...
inline void UnityEngine::Rendering::Universal::DecalCachedChunk::RemoveAtSwapBack(int32_t entityIndex) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Rendering::Universal::DecalCachedChunk*>(), 6 })));
...
inline void UnityEngine::Rendering::Universal::DecalCachedChunk::SetCapacity(int32_t newCapacity) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Rendering::Universal::DecalCachedChunk*>(), 7 })));
...
inline void UnityEngine::Rendering::Universal::DecalCachedChunk::Dispose() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Rendering::Universal::DecalCachedChunk*>(), 8 })));
