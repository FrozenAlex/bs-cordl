...
public:
  ...
  /// @brief Method Draw, addr 0x6853dd0, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method Draw, addr 0x68534b0, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawInstanced, addr 0x6853b1c, size 0x2b4, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawInstanced, addr 0x6853240, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method Execute, addr 0x6853790, size 0x1d4, virtual false, abstract: false, final false
  inline void Execute(::by_ref<::UnityEngine::Rendering::Universal::CameraData> cameraData);

  /// @brief Method Execute, addr 0x6853964, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method Execute, addr 0x6852ff4, size 0x74, virtual false, abstract: false, final false
  inline void Execute(::UnityEngine::Rendering::CommandBuffer* cmd);

  /// @brief Method Execute, addr 0x684d79c, size 0x1d4, virtual false, abstract: false, final false
  inline void Execute(::UnityEngine::Rendering::RasterCommandBuffer* cmd);

  /// @brief Method Execute, addr 0x6853068, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMaterial, addr 0x685322c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x684be9c, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method get_overrideMaterial, addr 0x6852fe4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_overrideMaterial();

  static inline void setStaticF_MaxBatchSize(uint32_t value);

  /// @brief Method set_overrideMaterial, addr 0x6852fec, size 0x8, virtual false, abstract: false, final false
