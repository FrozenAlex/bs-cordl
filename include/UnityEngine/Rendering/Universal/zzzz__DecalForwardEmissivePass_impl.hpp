...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::Universal::DecalForwardEmissivePass_PassData::*)()>(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::Universal::DecalForwardEmissivePass_PassData*>(), { ".ctor", {}, {} })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::Universal::DecalForwardEmissivePass___c::*)()>(
  ...
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x6850310;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::Universal::DecalForwardEmissivePass___c*>(), { ".ctor", {}, {} })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::Universal::DecalForwardEmissivePass___c::*)(
  ...
  constexpr static std::size_t addrs = 0x6850314;
...
inline void UnityEngine::Rendering::Universal::DecalForwardEmissivePass___c::setStaticF___9(::UnityEngine::Rendering::Universal::DecalForwardEmissivePass___c* value) {
  ::cordl_internals::setStaticField<::UnityEngine::Rendering::Universal::DecalForwardEmissivePass___c*, "<>9", ::UnityEngine::Rendering::Universal::DecalForwardEmissivePass___c*>(
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::Universal::DecalForwardEmissivePass::*)(::UnityEngine::Rendering::Universal::DecalDrawFowardEmissiveSystem*)>(
  ...
  constexpr static std::size_t addrs = 0x684f4c8;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::Universal::DecalForwardEmissivePass::*)(
  ...
  constexpr static std::size_t addrs = 0x684f7a8;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::Universal::DecalForwardEmissivePass::*)(
  ...
  constexpr static std::size_t addrs = 0x684fa10;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::Rendering::RendererListParams (::UnityEngine::Rendering::Universal::DecalForwardEmissivePass::*)(
  ...
  constexpr static std::size_t addrs = 0x684fa2c;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (*)(::UnityEngine::Rendering::RasterCommandBuffer*, ::UnityEngine::Rendering::Universal::DecalForwardEmissivePass_PassData*,
  ...
  constexpr static std::size_t addrs = 0x684fb60;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{},
                     (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::Universal::DecalForwardEmissivePass*>(),
                                         { "ExecutePass",
                                           {},
                                           { ::i2c::type_of<::UnityEngine::Rendering::RasterCommandBuffer*>(),
                                             ::i2c::type_of<::UnityEngine::Rendering::Universal::DecalForwardEmissivePass_PassData*>(), ::i2c::type_of<::UnityEngine::Rendering::RendererList>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::Universal::DecalForwardEmissivePass::*)(
  ...
  constexpr static std::size_t addrs = 0x684fbc0;
  ...
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{},
                   (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::Universal::DecalForwardEmissivePass*>(),
                                       { "ExecutePass",
                                         {},
                                         { ::i2c::type_of<::UnityEngine::Rendering::RasterCommandBuffer*>(), ::i2c::type_of<::UnityEngine::Rendering::Universal::DecalForwardEmissivePass_PassData*>(),
...
inline void UnityEngine::Rendering::Universal::DecalForwardEmissivePass::RecordRenderGraph(::UnityEngine::Rendering::RenderGraphModule::RenderGraph* renderGraph,
  ...
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Rendering::Universal::DecalForwardEmissivePass*>(), 11 })));
