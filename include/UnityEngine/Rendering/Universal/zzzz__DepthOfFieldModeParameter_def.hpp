...
public:
  ...
  /// @brief Method .ctor, addr 0x6876fe0, size 0x64, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DepthOfFieldModeParameter) == 0x18, "Size mismatch!");
