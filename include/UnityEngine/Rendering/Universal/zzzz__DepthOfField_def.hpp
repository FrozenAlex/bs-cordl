...
public:
  ...
  /// @brief Method IsActive, addr 0x673a5b8, size 0xb8, virtual true, abstract: false, final true
  inline bool IsActive();

  /// @brief Method IsTileCompatible, addr 0x673a670, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x673a678, size 0x250, virtual false, abstract: false, final false
  inline void _ctor();
