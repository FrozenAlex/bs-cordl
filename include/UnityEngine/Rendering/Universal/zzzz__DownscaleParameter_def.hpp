...
public:
  ...
  /// @brief Method .ctor, addr 0x673002c, size 0x64, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DownscaleParameter) == 0x18, "Size mismatch!");
