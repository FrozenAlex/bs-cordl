...
public:
  ...
  /// @brief Method IsActive, addr 0x6877044, size 0xdc, virtual true, abstract: false, final true
  inline bool IsActive();

  /// @brief Method IsTileCompatible, addr 0x6877120, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6877128, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor();
