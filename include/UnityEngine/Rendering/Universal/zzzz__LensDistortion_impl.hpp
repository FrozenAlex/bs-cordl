...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::UnityEngine::Rendering::Universal::LensDistortion::*)()>(&::UnityEngine::Rendering::Universal::LensDistortion::IsActive)> {
  ...
  constexpr static std::size_t addrs = 0x673ab80;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::Universal::LensDistortion*>(), { "IsActive", {}, {} })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::UnityEngine::Rendering::Universal::LensDistortion::*)()>(&::UnityEngine::Rendering::Universal::LensDistortion::IsTileCompatible)> {
  ...
  constexpr static std::size_t addrs = 0x673ac04;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::Universal::LensDistortion*>(), { "IsTileCompatible", {}, {} })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::Universal::LensDistortion::*)()>(&::UnityEngine::Rendering::Universal::LensDistortion::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x673ac0c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::Universal::LensDistortion*>(), { ".ctor", {}, {} })));
    return ___internal_method;
  }
};
