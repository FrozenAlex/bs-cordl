...
public:
  ...
  /// @brief Method .ctor, addr 0x6877774, size 0x64, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::MotionBlurQualityParameter) == 0x18, "Size mismatch!");
