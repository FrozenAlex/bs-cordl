...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::PostProcessParams, "UnityEngine.Rendering.Universal", "PostProcessParams");
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::PostProcessParams) == 0x10, "Size mismatch!");
