...
public:
  ...
  /// @brief Method AddResourceToPool, addr 0x68b0e54, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method Cleanup, addr 0x68b0998, size 0x4bc, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method CreateTextureDesc, addr 0x68b21c4, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCodeWithNameHash, addr 0x68b1068, size 0x58, virtual false, abstract: false, final false
  inline int32_t GetHashCodeWithNameHash(::by_ref<::UnityEngine::Rendering::RenderGraphModule::TextureDesc> texDesc);

  /// @brief Method LogDebugInfo, addr 0x68b1928, size 0x89c, virtual false, abstract: false, final false
  inline void LogDebugInfo();

  static inline ::UnityEngine::Rendering::Universal::RTHandleResourcePool* New_ctor();

  /// @brief Method PurgeUnusedResources, addr 0x68b1320, size 0x608, virtual false, abstract: false, final false
  inline void PurgeUnusedResources(int32_t currentFrameIndex);

  /// @brief Method ShouldReleaseResource, addr 0x68b12a8, size 0x78, virtual false, abstract: false, final false
  static inline bool ShouldReleaseResource(int32_t lastUsedFrameIndex, int32_t currentFrameIndex);

  /// @brief Method TryGetResource, addr 0x68b10c0, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68b2304, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_staleResourceCapacity, addr 0x68b089c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_staleResourceCapacity, addr 0x68b08f8, size 0xa0, virtual false, abstract: false, final false
