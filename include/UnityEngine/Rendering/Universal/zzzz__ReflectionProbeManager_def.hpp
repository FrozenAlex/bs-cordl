...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::CachedProbe_ReflectionProbeManager__dataIndices_e__FixedBuffer, "UnityEngine.Rendering.Universal",
                    "ReflectionProbeManager/CachedProbe/<dataIndices>e__FixedBuffer");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::CachedProbe_ReflectionProbeManager__levels_e__FixedBuffer, "UnityEngine.Rendering.Universal",
...
public:
  ...
  // def_value: None }, CppParam { name: "m_BoxMax", ty: "::ArrayW<::UnityEngine::Vector4>", modifiers: "", def_value: None }, CppParam { name: "m_BoxMin", ty: "::ArrayW<::UnityEngine::Vector4>",
  // modifiers: "", def_value: None }, CppParam { name: "m_ProbePosition", ty: "::ArrayW<::UnityEngine::Vector4>", modifiers: "", def_value: None }, CppParam { name: "m_MipScaleOffset", ty:
  // "::ArrayW<::UnityEngine::Vector4>", modifiers: "", def_value: None }]
