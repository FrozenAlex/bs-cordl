...
public:
  ...
  /// @brief Method .ctor, addr 0x67944b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <SetGlobalTexture>b__6_0, addr 0x6794514, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6794510, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method SetGlobalTexture, addr 0x679399c, size 0x4e4, virtual false, abstract: false, final false
  ...
  /// @brief Method UseDBufferIfValid, addr 0x679422c, size 0x1f8, virtual false, abstract: false, final false
