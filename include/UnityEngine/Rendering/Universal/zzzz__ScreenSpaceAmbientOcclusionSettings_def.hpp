...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_BlurQualityOptions, "UnityEngine.Rendering.Universal",
...
public:
  ...
  /// @brief Method .ctor, addr 0x689d59c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor();
