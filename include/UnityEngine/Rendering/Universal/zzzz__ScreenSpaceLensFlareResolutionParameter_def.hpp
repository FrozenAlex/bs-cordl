...
public:
  ...
  /// @brief Method .ctor, addr 0x673b520, size 0x64, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::ScreenSpaceLensFlareResolutionParameter) == 0x18, "Size mismatch!");
