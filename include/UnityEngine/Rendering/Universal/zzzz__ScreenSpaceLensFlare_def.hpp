...
public:
  ...
  /// @brief Method IsActive, addr 0x6877c9c, size 0x30, virtual true, abstract: false, final true
  inline bool IsActive();

  /// @brief Method IsStreaksActive, addr 0x6877ccc, size 0x30, virtual false, abstract: false, final false
  inline bool IsStreaksActive();

  /// @brief Method IsTileCompatible, addr 0x6877cfc, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x68778ac, size 0x38c, virtual false, abstract: false, final false
  inline void _ctor();
