...
public:
  ...
  /// @brief Method Alloc, addr 0x6870f98, size 0xbc, virtual false, abstract: false, final false
  inline void Alloc(::by_ref<::UnityEngine::RenderTextureDescriptor> desc);

  /// @brief Method GetCurrentTexture, addr 0x6870efc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousTexture, addr 0x6870f08, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* GetPreviousTexture();

  /// @brief Method GetTexture, addr 0x6870e9c, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* GetTexture(int32_t frameIndex);

  /// @brief Method IsAllocated, addr 0x6870f10, size 0x1c, virtual false, abstract: false, final false
  inline bool IsAllocated();

  /// @brief Method IsDirty, addr 0x6870f2c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnCreate, addr 0x6870e8c, size 0x10, virtual true, abstract: false, final false
  inline void OnCreate(::UnityEngine::Rendering::BufferedRTHandleSystem* owner, uint32_t typeId);

  /// @brief Method Reset, addr 0x6871054, size 0x20, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x6871074, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6871128, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
