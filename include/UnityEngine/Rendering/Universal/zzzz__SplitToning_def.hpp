...
public:
  ...
  /// @brief Method IsActive, addr 0x6877f28, size 0x8c, virtual true, abstract: false, final true
  inline bool IsActive();

  /// @brief Method IsTileCompatible, addr 0x6877fb4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6877fbc, size 0xfc, virtual false, abstract: false, final false
  inline void _ctor();
