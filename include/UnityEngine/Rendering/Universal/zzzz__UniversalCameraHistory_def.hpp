...
public:
  // Declarations
  /// @brief Method Reset, addr 0x6785b1c, size 0x2c, virtual false, abstract: false, final false
  inline void Reset();
...
public:
  ...
  /// @brief Method Dispose, addr 0x6785b48, size 0x90, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GatherHistoryRequests, addr 0x6785bd8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValid, addr 0x6785c38, size 0x40, virtual false, abstract: false, final false
  inline bool IsValid(int32_t i);

  /// @brief Method IsValidRequest, addr 0x6785bf8, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method ReleaseUnusedHistory, addr 0x6785c78, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method SwapAndSetReferenceSize, addr 0x6785d34, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6785a28, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_OnGatherHistoryRequests, addr 0x67858d0, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_OnGatherHistoryRequests, addr 0x678597c, size 0xac, virtual true, abstract: false, final true
