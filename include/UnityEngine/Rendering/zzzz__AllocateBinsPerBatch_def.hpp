...
public:
  ...
  /// @brief Method Execute, addr 0x66d4730, size 0x53c, virtual true, abstract: false, final true
  inline void Execute(int32_t batchIndex);

  /// @brief Method IsInstanceFlipped, addr 0x66d4690, size 0xa0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::AllocateBinsPerBatch) == 0x170, "Size mismatch!");
