...
public:
  ...
  /// @brief Method Execute, addr 0x6829638, size 0x2cc, virtual true, abstract: false, final true
  inline void Execute();
...
static_assert(sizeof(::UnityEngine::Rendering::AllocateOrGetLODGroupDataInstancesJob) == 0x50, "Size mismatch!");
