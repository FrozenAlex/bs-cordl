...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6b23ad4, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b2398c, size 0x148, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6b23bb8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b23b4c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6b23bcc, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddBatch, addr 0x6b2306c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDrawCommandBatch, addr 0x6b22f54, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDrawCommandBatch_Injected, addr 0x6b22fe8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x6b22e8c, size 0x44, virtual false, abstract: false, final false
  static inline ::System::IntPtr Create(::UnityEngine::Rendering::BatchRendererGroup* group, void* userContext);

  /// @brief Method Destroy, addr 0x6b22f18, size 0x3c, virtual false, abstract: false, final false
  static inline void Destroy(::System::IntPtr groupHandle);

  /// @brief Method Dispose, addr 0x6b22ed0, size 0x48, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetBufferTarget, addr 0x6b235a0, size 0x28, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::BatchBufferTarget GetBufferTarget();

  /// @brief Method InvokeOnFinishedCulling, addr 0x6b23834, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeOnPerformCulling, addr 0x6b235f0, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method OcclusionTestAABB, addr 0x6b23904, size 0x44, virtual false, abstract: false, final false
  static inline bool OcclusionTestAABB(::System::IntPtr occlusionBuffer, ::UnityEngine::Bounds aabb);

  /// @brief Method OcclusionTestAABB_Injected, addr 0x6b23948, size 0x44, virtual false, abstract: false, final false
  static inline bool OcclusionTestAABB_Injected(::System::IntPtr occlusionBuffer, ::by_ref<::UnityEngine::Bounds> aabb);

  /// @brief Method RegisterMaterials, addr 0x6b23188, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterMaterials_Injected, addr 0x6b232a0, size 0x54, virtual false, abstract: false, final false
  static inline void RegisterMaterials_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper> materialID,
                                                ::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper> batchMaterialID);

  /// @brief Method RegisterMeshes, addr 0x6b23394, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterMeshes_Injected, addr 0x6b234ac, size 0x54, virtual false, abstract: false, final false
  static inline void RegisterMeshes_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper> meshID,
                                             ::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper> batchMeshID);

  /// @brief Method RemoveBatch, addr 0x6b23180, size 0x8, virtual false, abstract: false, final false
  inline void RemoveBatch(::UnityEngine::Rendering::BatchID batchID);

  /// @brief Method RemoveDrawCommandBatch, addr 0x6b230e0, size 0x5c, virtual false, abstract: false, final false
  inline void RemoveDrawCommandBatch(::UnityEngine::Rendering::BatchID batchID);

  /// @brief Method RemoveDrawCommandBatch_Injected, addr 0x6b2313c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method UnregisterMaterial, addr 0x6b232f4, size 0x5c, virtual false, abstract: false, final false
  inline void UnregisterMaterial(::UnityEngine::Rendering::BatchMaterialID material);

  /// @brief Method UnregisterMaterial_Injected, addr 0x6b23350, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method UnregisterMesh, addr 0x6b23500, size 0x5c, virtual false, abstract: false, final false
  inline void UnregisterMesh(::UnityEngine::Rendering::BatchMeshID mesh);

  /// @brief Method UnregisterMesh_Injected, addr 0x6b2355c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b22e20, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Rendering::BatchRendererGroupCreateInfo info);

  /// @brief Method get_BufferTarget, addr 0x6b235c8, size 0x28, virtual false, abstract: false, final false
