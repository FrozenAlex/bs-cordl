...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::BlendShapeBufferLayout, "UnityEngine.Rendering", "BlendShapeBufferLayout");
// Dependencies
namespace UnityEngine::Rendering {
// Is value type: true
...
public:
  ...
  /// @brief Field PerShape value: I32(0)
...
static_assert(sizeof(::UnityEngine::Rendering::BlendShapeBufferLayout) == 0x4, "Size mismatch!");
