...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::Rendering::BlendState (*)()>(&::UnityEngine::Rendering::BlendState::get_defaultValue)> {
  ...
  constexpr static std::size_t addrs = 0x69c6fa4;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::BlendState::*)(bool, bool)>(&::UnityEngine::Rendering::BlendState::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x69c6fec;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::BlendState>(), { ".ctor", {}, { ::i2c::type_of<bool>(), ::i2c::type_of<bool>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::BlendState::*)(::UnityEngine::Rendering::RenderTargetBlendState)>(
  ...
  constexpr static std::size_t addrs = 0x69c7084;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{},
                     (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::BlendState>(), { "set_blendState0", {}, { ::i2c::type_of<::UnityEngine::Rendering::RenderTargetBlendState>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::UnityEngine::Rendering::BlendState::*)(::UnityEngine::Rendering::BlendState)>(&::UnityEngine::Rendering::BlendState::Equals)> {
  ...
  constexpr static std::size_t addrs = 0x69c708c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::BlendState>(), { "Equals", {}, { ::i2c::type_of<::UnityEngine::Rendering::BlendState>() } })));
    return ___internal_method;
  }
};
//  Writing Method size for method: ::UnityEngine::Rendering::BlendState.Equals
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::UnityEngine::Rendering::BlendState::*)(::System::Object*)>(&::UnityEngine::Rendering::BlendState::Equals)> {
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::BlendState>(), { ::i2c::class_of<::UnityEngine::Rendering::BlendState>(), 0 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::UnityEngine::Rendering::BlendState::*)()>(&::UnityEngine::Rendering::BlendState::GetHashCode)> {
  ...
  constexpr static std::size_t addrs = 0x69c7258;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::BlendState>(), { ::i2c::class_of<::UnityEngine::Rendering::BlendState>(), 2 }));
    return ___internal_method;
  }
};
...
inline bool UnityEngine::Rendering::BlendState::Equals(::System::Object* obj) {
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Rendering::BlendState>(), 0 })));
  return ::cordl_internals::RunMethodRethrow<bool>(*this, ___internal_method, obj);
}
inline int32_t UnityEngine::Rendering::BlendState::GetHashCode() {
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Rendering::BlendState>(), 2 })));
...
// Ctor Parameters [CppParam { name: "m_BlendState0", ty: "::UnityEngine::Rendering::RenderTargetBlendState", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_BlendState1", ty:
// "::UnityEngine::Rendering::RenderTargetBlendState", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_BlendState2", ty: "::UnityEngine::Rendering::RenderTargetBlendState", modifiers: "",
// def_value: Some("{}") }, CppParam { name: "m_BlendState3", ty: "::UnityEngine::Rendering::RenderTargetBlendState", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_BlendState4", ty:
// "::UnityEngine::Rendering::RenderTargetBlendState", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_BlendState5", ty: "::UnityEngine::Rendering::RenderTargetBlendState", modifiers: "",
// def_value: Some("{}") }, CppParam { name: "m_BlendState6", ty: "::UnityEngine::Rendering::RenderTargetBlendState", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_BlendState7", ty:
// "::UnityEngine::Rendering::RenderTargetBlendState", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_SeparateMRTBlendStates", ty: "uint8_t", modifiers: "", def_value: Some("{}") },
// CppParam { name: "m_AlphaToMask", ty: "uint8_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Padding", ty: "int16_t", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::Rendering::BlendState::BlendState(::UnityEngine::Rendering::RenderTargetBlendState m_BlendState0, ::UnityEngine::Rendering::RenderTargetBlendState m_BlendState1,
                                                           ...
                                                           ::UnityEngine::Rendering::RenderTargetBlendState m_BlendState6, ::UnityEngine::Rendering::RenderTargetBlendState m_BlendState7,
                                                           uint8_t m_SeparateMRTBlendStates, uint8_t m_AlphaToMask, int16_t m_Padding) noexcept {
