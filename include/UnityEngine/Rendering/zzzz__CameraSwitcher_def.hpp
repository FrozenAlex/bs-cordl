...
public:
  ...
  /// @brief Method GetCameraCount, addr 0x660a47c, size 0x1c, virtual false, abstract: false, final false
  inline int32_t GetCameraCount();

  /// @brief Method GetNextCamera, addr 0x660a52c, size 0x48, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> GetNextCamera();

  static inline ::UnityEngine::Rendering::CameraSwitcher* New_ctor();

  /// @brief Method OnDisable, addr 0x660a498, size 0x94, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x6609dd4, size 0x6a8, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method SetCameraIndex, addr 0x660a574, size 0x224, virtual false, abstract: false, final false
  inline void SetCameraIndex(int32_t index);

  /// @brief Method <OnEnable>b__10_0, addr 0x660a7a4, size 0x8, virtual false, abstract: false, final false
  inline int32_t _OnEnable_b__10_0();

  /// @brief Method <OnEnable>b__10_1, addr 0x660a7ac, size 0x4, virtual false, abstract: false, final false
  inline void _OnEnable_b__10_1(int32_t value);

  /// @brief Method <OnEnable>b__10_2, addr 0x660a7b0, size 0x8, virtual false, abstract: false, final false
  inline int32_t _OnEnable_b__10_2();

  /// @brief Method <OnEnable>b__10_3, addr 0x660a7b8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x660a798, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
