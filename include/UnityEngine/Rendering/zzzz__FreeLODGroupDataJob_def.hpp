...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::FreeLODGroupDataJob, "UnityEngine.Rendering", "FreeLODGroupDataJob");
...
public:
  ...
  /// @brief Method Execute, addr 0x6829bd8, size 0x25c, virtual true, abstract: false, final true
  inline void Execute();
...
static_assert(sizeof(::UnityEngine::Rendering::FreeLODGroupDataJob) == 0x38, "Size mismatch!");
