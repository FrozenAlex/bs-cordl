...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::FrustumPlaneCuller_PlanePacket4::*)(
  ...
  constexpr static std::size_t addrs = 0x66cd840;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{},
                     (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::FrustumPlaneCuller_PlanePacket4>(),
...
inline void UnityEngine::Rendering::FrustumPlaneCuller_PlanePacket4::_ctor(::Unity::Collections::NativeArray_1<::UnityEngine::Plane> planes, int32_t offset, int32_t limit) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::FrustumPlaneCuller_PlanePacket4>(),
                                              { ".ctor", {}, { ::i2c::type_of<::Unity::Collections::NativeArray_1<::UnityEngine::Plane>>(), ::i2c::type_of<int32_t>(), ::i2c::type_of<int32_t>() } })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::FrustumPlaneCuller::*)(::Unity::Jobs::JobHandle)>(&::UnityEngine::Rendering::FrustumPlaneCuller::Dispose)> {
  ...
  constexpr static std::size_t addrs = 0x66cd304;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<uint32_t (*)(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::FrustumPlaneCuller_PlanePacket4>,
  ...
  constexpr static std::size_t addrs = 0x66cd908;
