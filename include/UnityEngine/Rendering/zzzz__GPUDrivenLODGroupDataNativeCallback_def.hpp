...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x69d49b0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69d4930, size 0x80, virtual false, abstract: false, final false
