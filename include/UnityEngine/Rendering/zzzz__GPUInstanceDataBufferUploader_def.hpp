...
public:
  ...
  /// @brief Method CreateResources, addr 0x681a5ac, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x681accc, size 0x48, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method LoadShaders, addr 0x681ac18, size 0xb4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Execute, addr 0x681ad14, size 0xdc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method AllocateUploadHandles, addr 0x681a0e4, size 0x8, virtual false, abstract: false, final false
  inline void AllocateUploadHandles(int32_t handlesLength);

  /// @brief Method Dispose, addr 0x681a844, size 0x15c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetParamUIntOffset, addr 0x681a0d8, size 0xc, virtual false, abstract: false, final false
  inline int32_t GetParamUIntOffset(int32_t parameterIndex);

  /// @brief Method GetUIntPerInstance, addr 0x681a0d0, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetUIntPerInstance();

  /// @brief Method GetUploadBufferPtr, addr 0x681a08c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method SubmitToGpu, addr 0x681a0ec, size 0x4c0, virtual false, abstract: false, final false
  ...
  /// @brief Method SubmitToGpu, addr 0x681a744, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6819e2c, size 0x260, virtual false, abstract: false, final false
