...
public:
  ...
  /// @brief Method BindConstants, addr 0x679be60, size 0x15c, virtual false, abstract: false, final false
  static inline void BindConstants(::UnityEngine::Rendering::CommandBuffer* cmd, ::UnityEngine::ComputeShader* cs);

  /// @brief Method Initialize, addr 0x679baf0, size 0x370, virtual false, abstract: false, final false
