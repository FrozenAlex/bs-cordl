...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::UnityEngine::Rendering::IDebugDisplaySettingsQuery::*)()>(
  ...
  constexpr static std::size_t addrs = 0x662a908;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::UnityEngine::Rendering::IDebugDisplaySettingsQuery::*)()>(&::UnityEngine::Rendering::IDebugDisplaySettingsQuery::get_IsLightingActive)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x662a910;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::UnityEngine::Rendering::IDebugDisplaySettingsQuery::*)(::by_ref<::UnityEngine::Color>)>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x662a918;
...
inline bool UnityEngine::Rendering::IDebugDisplaySettingsQuery::get_AreAnySettingsActive() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Rendering::IDebugDisplaySettingsQuery*>(), 0 })));
  return ::cordl_internals::RunMethodRethrow<bool>(this, ___internal_method);
}
inline bool UnityEngine::Rendering::IDebugDisplaySettingsQuery::get_IsPostProcessingAllowed() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Rendering::IDebugDisplaySettingsQuery*>(), 1 })));
  return ::cordl_internals::RunMethodRethrow<bool>(this, ___internal_method);
}
inline bool UnityEngine::Rendering::IDebugDisplaySettingsQuery::get_IsLightingActive() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Rendering::IDebugDisplaySettingsQuery*>(), 2 })));
  return ::cordl_internals::RunMethodRethrow<bool>(this, ___internal_method);
}
inline bool UnityEngine::Rendering::IDebugDisplaySettingsQuery::TryGetScreenClearColor(::by_ref<::UnityEngine::Color> color) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Rendering::IDebugDisplaySettingsQuery*>(), 3 })));
