...
public:
  ...
  /// @brief Method Matches, addr 0x66ebb04, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66ebaf4, size 0x10, virtual false, abstract: false, final false
