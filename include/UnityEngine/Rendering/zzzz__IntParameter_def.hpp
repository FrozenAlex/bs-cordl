...
public:
  // Declarations
  /// @brief Method Interp, addr 0x66899ac, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6689948, size 0x64, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::IntParameter) == 0x18, "Size mismatch!");
