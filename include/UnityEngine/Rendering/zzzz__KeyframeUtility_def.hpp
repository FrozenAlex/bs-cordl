...
public:
  // Declarations
  /// @brief Method EvalCurveSegmentAndDeriv, addr 0x67c1b98, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method EvalKeyAtTime, addr 0x67c1c64, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method FetchKeyFromIndexClampEdge, addr 0x67c1b08, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method GetKeyframeAndClampEdge, addr 0x67c1a18, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method InterpAnimationCurve, addr 0x67c1d08, size 0x578, virtual false, abstract: false, final false
  ...
  /// @brief Method LerpSingleKeyframe, addr 0x67c19c0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetAnimationCurve, addr 0x67c19ac, size 0x14, virtual false, abstract: false, final false
  static inline void ResetAnimationCurve(::UnityEngine::AnimationCurve* curve);

  /// @brief Method .ctor, addr 0x67c2280, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
