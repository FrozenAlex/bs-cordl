...
public:
  // Declarations
  /// @brief Method EvalCurveSegmentAndDeriv, addr 0x66866f0, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method EvalKeyAtTime, addr 0x66867bc, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method FetchKeyFromIndexClampEdge, addr 0x6686660, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method GetKeyframeAndClampEdge, addr 0x6686570, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method InterpAnimationCurve, addr 0x6686860, size 0x578, virtual false, abstract: false, final false
  ...
  /// @brief Method LerpSingleKeyframe, addr 0x6686518, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetAnimationCurve, addr 0x6686504, size 0x14, virtual false, abstract: false, final false
  static inline void ResetAnimationCurve(::UnityEngine::AnimationCurve* curve);

  /// @brief Method .ctor, addr 0x6686dd8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
