...
public:
  ...
  /// @brief Method HasAModulateByLightColorElement, addr 0x665f7a4, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x665f788, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
