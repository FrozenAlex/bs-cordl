...
public:
  ...
  /// @brief Method .ctor, addr 0x67c4fe0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t value, int32_t max, bool overrideState);

  /// @brief Method get_value, addr 0x67c4fc4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_value();

  /// @brief Method set_value, addr 0x67c4fcc, size 0x14, virtual true, abstract: false, final false
