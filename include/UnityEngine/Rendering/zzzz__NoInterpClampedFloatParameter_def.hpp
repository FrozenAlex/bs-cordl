...
public:
  ...
  /// @brief Method .ctor, addr 0x67c5490, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(float_t value, float_t min, float_t max, bool overrideState);

  /// @brief Method get_value, addr 0x67c546c, size 0x8, virtual true, abstract: false, final false
  inline float_t get_value();

  /// @brief Method set_value, addr 0x67c5474, size 0x1c, virtual true, abstract: false, final false
