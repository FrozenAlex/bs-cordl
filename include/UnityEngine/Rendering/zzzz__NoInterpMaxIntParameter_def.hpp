...
public:
  ...
  /// @brief Method .ctor, addr 0x67c5024, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(int32_t value, int32_t max, bool overrideState);

  /// @brief Method get_value, addr 0x67c5008, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_value();

  /// @brief Method set_value, addr 0x67c5010, size 0x14, virtual true, abstract: false, final false
