...
public:
  // Declarations
  /// @brief Method GetHashCode, addr 0x67c5ee4, size 0x108, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::UnityEngine::Rendering::NoInterpTextureParameter* New_ctor(::UnityEngine::Texture* value, bool overrideState);

  /// @brief Method .ctor, addr 0x67c5e80, size 0x64, virtual false, abstract: false, final false
