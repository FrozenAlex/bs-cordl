...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::OccluderDepthPyramidConstants___InvViewProjMatrix_e__FixedBuffer, "UnityEngine.Rendering",
                    "OccluderDepthPyramidConstants/<_InvViewProjMatrix>e__FixedBuffer");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::OccluderDepthPyramidConstants___MipOffsetAndSize_e__FixedBuffer, "UnityEngine.Rendering",
