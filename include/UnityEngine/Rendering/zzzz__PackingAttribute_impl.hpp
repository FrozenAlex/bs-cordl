...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::PackingAttribute::*)(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{},
        (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::PackingAttribute*>(),
                            { ".ctor",
                              {},
                              { ::i2c::type_of<::ArrayW<::StringW>>(), ::i2c::type_of<::UnityEngine::Rendering::FieldPacking>(), ::i2c::type_of<int32_t>(), ::i2c::type_of<int32_t>(),
                                ::i2c::type_of<float_t>(), ::i2c::type_of<float_t>(), ::i2c::type_of<bool>(), ::i2c::type_of<bool>(), ::i2c::type_of<bool>(), ::i2c::type_of<::StringW>() } })));
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ...
        (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::PackingAttribute*>(),
                            { ".ctor",
                              {},
                              { ::i2c::type_of<::StringW>(), ::i2c::type_of<::UnityEngine::Rendering::FieldPacking>(), ::i2c::type_of<int32_t>(), ::i2c::type_of<int32_t>(), ::i2c::type_of<float_t>(),
                                ::i2c::type_of<float_t>(), ::i2c::type_of<bool>(), ::i2c::type_of<bool>(), ::i2c::type_of<bool>(), ::i2c::type_of<::StringW>() } })));
    return ___internal_method;
  }
};
...
inline void UnityEngine::Rendering::PackingAttribute::_ctor(::ArrayW<::StringW> displayNames, ::UnityEngine::Rendering::FieldPacking packingScheme, int32_t bitSize, int32_t offsetInSource,
                                                            float_t minValue, float_t maxValue, bool isDirection, bool sRGBDisplay, bool checkIsNormalized, ::StringW preprocessor) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::PackingAttribute*>(),
                                                                                         { ".ctor",
                                                                                           {},
                                                                                           { ::i2c::type_of<::ArrayW<::StringW>>(), ::i2c::type_of<::UnityEngine::Rendering::FieldPacking>(),
  ...
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, displayNames, packingScheme, bitSize, offsetInSource, minValue, maxValue, isDirection, sRGBDisplay, checkIsNormalized,
                                                   preprocessor);
}
inline void UnityEngine::Rendering::PackingAttribute::_ctor(::StringW displayName, ::UnityEngine::Rendering::FieldPacking packingScheme, int32_t bitSize, int32_t offsetInSource, float_t minValue,
  ...
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::PackingAttribute*>(),
                                                                                         { ".ctor",
                                                                                           {},
                                                                                           { ::i2c::type_of<::StringW>(), ::i2c::type_of<::UnityEngine::Rendering::FieldPacking>(),
                                                                                             ::i2c::type_of<int32_t>(), ::i2c::type_of<int32_t>(), ::i2c::type_of<float_t>(), ::i2c::type_of<float_t>(),
                                                                                             ::i2c::type_of<bool>(), ::i2c::type_of<bool>(), ::i2c::type_of<bool>(), ::i2c::type_of<::StringW>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, displayName, packingScheme, bitSize, offsetInSource, minValue, maxValue, isDirection, sRGBDisplay, checkIsNormalized,
                                                   preprocessor);
}
inline ::UnityEngine::Rendering::PackingAttribute* UnityEngine::Rendering::PackingAttribute::New_ctor(::ArrayW<::StringW> displayNames, ::UnityEngine::Rendering::FieldPacking packingScheme,
                                                                                                      int32_t bitSize, int32_t offsetInSource, float_t minValue, float_t maxValue, bool isDirection,
                                                                                                      bool sRGBDisplay, bool checkIsNormalized, ::StringW preprocessor) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::UnityEngine::Rendering::PackingAttribute*>(displayNames, packingScheme, bitSize, offsetInSource, minValue, maxValue, isDirection,
                                                                                                       sRGBDisplay, checkIsNormalized, preprocessor));
}
inline ::UnityEngine::Rendering::PackingAttribute* UnityEngine::Rendering::PackingAttribute::New_ctor(::StringW displayName, ::UnityEngine::Rendering::FieldPacking packingScheme, int32_t bitSize,
  ...
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::UnityEngine::Rendering::PackingAttribute*>(displayName, packingScheme, bitSize, offsetInSource, minValue, maxValue, isDirection,
                                                                                                       sRGBDisplay, checkIsNormalized, preprocessor));
}
// Ctor Parameters []
