...
public:
  ...
  /// @brief Method Allocate, addr 0x664ad2c, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method AllocateResourcesIfNeeded, addr 0x6649c94, size 0x148, virtual false, abstract: false, final false
  inline void AllocateResourcesIfNeeded();

  /// @brief Method BlendChunks, addr 0x664abf0, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method Cleanup, addr 0x664ae2c, size 0x38, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method Clear, addr 0x664ad1c, size 0x10, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Deallocate, addr 0x664ad84, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method EnsureTextureValidity, addr 0x664adfc, size 0x30, virtual false, abstract: false, final false
  inline void EnsureTextureValidity();

  /// @brief Method GetPoolDepth, addr 0x6649c70, size 0x18, virtual false, abstract: false, final false
  inline int32_t GetPoolDepth();

  /// @brief Method GetPoolHeight, addr 0x6649c58, size 0x18, virtual false, abstract: false, final false
  inline int32_t GetPoolHeight();

  /// @brief Method GetPoolWidth, addr 0x6649c40, size 0x18, virtual false, abstract: false, final false
  inline int32_t GetPoolWidth();

  /// @brief Method Initialize, addr 0x664998c, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method PerformBlending, addr 0x6649f30, size 0xcc0, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x6649e54, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x6649ddc, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6649c88, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_estimatedVMemCost, addr 0x6649b28, size 0x118, virtual false, abstract: false, final false
  inline int32_t get_estimatedVMemCost();

  /// @brief Method get_isAllocated, addr 0x6649b18, size 0x10, virtual false, abstract: false, final false
