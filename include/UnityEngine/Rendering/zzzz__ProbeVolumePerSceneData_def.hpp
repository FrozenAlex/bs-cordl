...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeVolumePerSceneData_ObsoleteSerializablePerScenarioDataItem, "UnityEngine.Rendering",
...
public:
  ...
  /// @brief Method Clear, addr 0x6653aac, size 0x18, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Initialize, addr 0x6653e30, size 0xc0, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::UnityEngine::Rendering::ProbeVolumePerSceneData* New_ctor();

  /// @brief Method OnDisable, addr 0x6653d74, size 0xb8, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x6653cc4, size 0xb0, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x6653e2c, size 0x4, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method QueueSceneLoading, addr 0x6653bc4, size 0x100, virtual false, abstract: false, final false
  inline void QueueSceneLoading();

  /// @brief Method QueueSceneRemoval, addr 0x6653ac4, size 0x100, virtual false, abstract: false, final false
  inline void QueueSceneRemoval();

  /// @brief Method ResolveCellData, addr 0x6653ef0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6653f8c, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bakingSet, addr 0x6653aa4, size 0x8, virtual false, abstract: false, final false
