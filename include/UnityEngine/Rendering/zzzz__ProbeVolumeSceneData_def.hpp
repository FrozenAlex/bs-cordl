...
public:
  ...
  /// @brief Method SetParentObject, addr 0x6654f34, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6654f2c, size 0x8, virtual false, abstract: false, final false
