...
public:
  ...
  /// @brief Method .ctor, addr 0x6b03b64, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_buildFlags, addr 0x6b03b50, size 0x8, virtual false, abstract: false, final false
  inline void set_buildFlags(::UnityEngine::Rendering::RayTracingAccelerationStructureBuildFlags value);

  /// @brief Method set_relativeOrigin, addr 0x6b03b58, size 0xc, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6b03bc4, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Destroy, addr 0x6b03acc, size 0x48, virtual false, abstract: false, final false
  static inline void Destroy(::UnityEngine::Rendering::RayTracingAccelerationStructure* accelStruct);

  /// @brief Method Destroy_Injected, addr 0x6b03b14, size 0x3c, virtual false, abstract: false, final false
  static inline void Destroy_Injected(::System::IntPtr accelStruct);

  /// @brief Method Dispose, addr 0x6b039dc, size 0x98, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6b03a74, size 0x58, virtual false, abstract: false, final false
