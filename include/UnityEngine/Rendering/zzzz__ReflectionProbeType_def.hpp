...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ReflectionProbeType, "UnityEngine.Rendering", "ReflectionProbeType");
// Dependencies
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::ReflectionProbeType) == 0x4, "Size mismatch!");
