...
public:
  ...
  /// @brief Method .ctor, addr 0x6b03be0, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_settingsList, addr 0x6b03bd8, size 0x8, virtual false, abstract: false, final false
