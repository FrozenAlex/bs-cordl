...
public:
  ...
  /// @brief Method .ctor, addr 0x69cde1c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_isValid, addr 0x69cdde0, size 0x3c, virtual false, abstract: false, final false
