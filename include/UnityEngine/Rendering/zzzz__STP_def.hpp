...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::StpConstantBufferData_STP___StpSetupPerViewConstants_e__FixedBuffer, "UnityEngine.Rendering",
...
public:
  ...
  /// @brief Method Dispose, addr 0x66644bc, size 0x88, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetCurrentHistoryTexture, addr 0x6663c8c, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousHistoryTexture, addr 0x6663c50, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x666411c, size 0x3a0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6664544, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6664bfc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_preTaaCS, addr 0x6664b0c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ComputeShader> get_preTaaCS();

  /// @brief Method get_setupCS, addr 0x6664a94, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ComputeShader> get_setupCS();

  /// @brief Method get_taaCS, addr 0x6664b84, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ComputeShader> get_taaCS();

  /// @brief Method get_version, addr 0x6664a8c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_preTaaCS, addr 0x6664b14, size 0x70, virtual false, abstract: false, final false
  inline void set_preTaaCS(::UnityEngine::ComputeShader* value);

  /// @brief Method set_setupCS, addr 0x6664a9c, size 0x70, virtual false, abstract: false, final false
  inline void set_setupCS(::UnityEngine::ComputeShader* value);

  /// @brief Method set_taaCS, addr 0x6664b8c, size 0x70, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x6664c00, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6664c04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6664c08, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Execute>b__38_0, addr 0x6664c64, size 0x5a4, virtual false, abstract: false, final false
  ...
  /// @brief Method <Execute>b__38_1, addr 0x6665208, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method <Execute>b__38_2, addr 0x6665500, size 0x370, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6664c60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CalculateConvergenceTextureSize, addr 0x6661060, size 0x84, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2Int CalculateConvergenceTextureSize(::UnityEngine::Vector2Int historyTextureSize);

  /// @brief Method CalculateMotionScale, addr 0x66610e4, size 0x98, virtual false, abstract: false, final false
  static inline float_t CalculateMotionScale(float_t deltaTime, float_t lastDeltaTime);

  /// @brief Method ComputeHistoryHash, addr 0x6660fac, size 0xb4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Hash128 ComputeHistoryHash(::by_ref<::UnityEngine::Rendering::STP_HistoryUpdateInfo> info);

  /// @brief Method Execute, addr 0x6661db4, size 0x1e9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtractRotation, addr 0x666117c, size 0x1c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 ExtractRotation(::UnityEngine::Matrix4x4 input);

  /// @brief Method IsSupported, addr 0x6660d38, size 0x68, virtual false, abstract: false, final false
  static inline bool IsSupported();

  /// @brief Method Jit16, addr 0x6660da0, size 0x98, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 Jit16(int32_t frameIndex);

  /// @brief Method PackVector2ToInt, addr 0x6661198, size 0x78, virtual false, abstract: false, final false
  static inline int32_t PackVector2ToInt(::UnityEngine::Vector2 value);

  /// @brief Method PopulateConstantData, addr 0x6661210, size 0xadc, virtual false, abstract: false, final false
  ...
  /// @brief Method UseTexture, addr 0x6661cec, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_debugViewDescriptions, addr 0x6660e38, size 0x5c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::GUIContent*> get_debugViewDescriptions();

  /// @brief Method get_debugViewIndices, addr 0x6660e94, size 0x5c, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t> get_debugViewIndices();

  /// @brief Method get_perViewConfigs, addr 0x6660ef0, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_perViewConfigs, addr 0x6660f4c, size 0x60, virtual false, abstract: false, final false
