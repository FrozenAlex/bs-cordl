...
public:
  ...
  /// @brief Method CompareTo, addr 0x66e034c, size 0x70, virtual true, abstract: false, final true
  inline int32_t CompareTo(::UnityEngine::Rendering::SharedInstanceHandle other);

  /// @brief Method Equals, addr 0x66e02e0, size 0x6c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::SharedInstanceHandle other);

  /// @brief Method GetHashCode, addr 0x66e03bc, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::UnityEngine::Rendering::SharedInstanceHandle getStaticF_Invalid();

  /// @brief Method get_index, addr 0x66e0270, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_index();

  /// @brief Method get_valid, addr 0x66e0280, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method set_index, addr 0x66e0278, size 0x8, virtual false, abstract: false, final false
