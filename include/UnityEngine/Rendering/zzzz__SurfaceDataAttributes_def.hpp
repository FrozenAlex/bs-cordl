...
public:
  ...
  /// @brief Method .ctor, addr 0x679b7f8, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x679b8b4, size 0x1c, virtual false, abstract: false, final false
