...
public:
  // Declarations
  /// @brief Method Interp, addr 0x668a554, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x668a4e4, size 0x70, virtual false, abstract: false, final false
