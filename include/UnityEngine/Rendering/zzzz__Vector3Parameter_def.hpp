...
public:
  // Declarations
  /// @brief Method Interp, addr 0x668a664, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x668a5e4, size 0x80, virtual false, abstract: false, final false
