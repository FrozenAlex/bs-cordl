...
public:
  ...
  /// @brief Method Clear, addr 0x67c76dc, size 0x180, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Dispose, addr 0x67c7ad4, size 0x18, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetComponent, addr 0x67c7a60, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method Reload, addr 0x67c785c, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67c763c, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isValid, addr 0x67c7aec, size 0x8, virtual false, abstract: false, final false
  inline bool get_isValid();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_isValid, addr 0x67c7af4, size 0x8, virtual false, abstract: false, final false
