...
// Write type traits
MARK_REF_T(::UnityEngine::ResourceManagement::AsyncOperations::UnityWebRequestOperation*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::AsyncOperations::UnityWebRequestOperation*, "UnityEngine.ResourceManagement.AsyncOperations", "UnityWebRequestOperation");
...
public:
  ...
  /// @brief Method Execute, addr 0x67e46fc, size 0xa8, virtual true, abstract: false, final false
  inline void Execute();
  ...
  /// @brief Method <Execute>b__2_0, addr 0x67e47a4, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67e469c, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ResourceManagement::AsyncOperations::UnityWebRequestOperation) == 0xa0, "Size mismatch!");
