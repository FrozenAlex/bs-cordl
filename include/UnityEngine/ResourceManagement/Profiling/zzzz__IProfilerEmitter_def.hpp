...
// Write type traits
MARK_REF_T(::UnityEngine::ResourceManagement::Profiling::IProfilerEmitter*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::Profiling::IProfilerEmitter*, "UnityEngine.ResourceManagement.Profiling", "IProfilerEmitter");
// Dependencies
namespace UnityEngine::ResourceManagement::Profiling {
// Is value type: false
