...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::ResourceManagement::Profiling::ProfilerFrameData_2);
...
public:
  ...
  __declspec(property(get = get_Values)) ::ArrayW<T2> Values;

  /// @brief Field m_Array, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get_m_Array, put = __cordl_internal_set_m_Array)) ::ArrayW<T2> m_Array;
  ...
  constexpr ::ArrayW<T2> const& __cordl_internal_get_m_Array() const;

  constexpr ::ArrayW<T2>& __cordl_internal_get_m_Array();
  ...
  constexpr void __cordl_internal_set_m_Array(::ArrayW<T2> value);
