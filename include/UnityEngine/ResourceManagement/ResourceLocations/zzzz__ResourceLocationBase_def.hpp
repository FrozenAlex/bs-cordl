...
// Write type traits
MARK_REF_T(::UnityEngine::ResourceManagement::ResourceLocations::ResourceLocationBase*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::ResourceLocations::ResourceLocationBase*, "UnityEngine.ResourceManagement.ResourceLocations", "ResourceLocationBase");
...
public:
  ...
  /// @brief Method ComputeDependencyHash, addr 0x67dfa54, size 0x1f0, virtual false, abstract: false, final false
  inline void ComputeDependencyHash();

  /// @brief Method Hash, addr 0x67df828, size 0x4c, virtual true, abstract: false, final true
  ...
  /// @brief Method ToString, addr 0x67df874, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67df87c, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Data, addr 0x67df7f8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* get_Data();

  /// @brief Method get_Dependencies, addr 0x67df794, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method get_DependencyHashCode, addr 0x67df818, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_DependencyHashCode();

  /// @brief Method get_HasDependencies, addr 0x67df79c, size 0x5c, virtual true, abstract: false, final true
  inline bool get_HasDependencies();

  /// @brief Method get_InternalId, addr 0x67df784, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_InternalId();

  /// @brief Method get_PrimaryKey, addr 0x67df808, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_PrimaryKey();

  /// @brief Method get_ProviderId, addr 0x67df78c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_ProviderId();

  /// @brief Method get_ResourceType, addr 0x67df820, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Data, addr 0x67df800, size 0x8, virtual false, abstract: false, final false
  inline void set_Data(::System::Object* value);

  /// @brief Method set_PrimaryKey, addr 0x67df810, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ResourceManagement::ResourceLocations::ResourceLocationBase) == 0x50, "Size mismatch!");
