...
// Write type traits
MARK_REF_T(::UnityEngine::ResourceManagement::ResourceProviders::AssetBundleRequestOptions*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::ResourceProviders::AssetBundleRequestOptions*, "UnityEngine.ResourceManagement.ResourceProviders", "AssetBundleRequestOptions");
// Dependencies System.Object, UnityEngine.ResourceManagement.ResourceProviders.AssetLoadMode
namespace UnityEngine::ResourceManagement::ResourceProviders {
// Is value type: false
...
public:
  ...
  /// @brief Method ComputeSize, addr 0x69117a4, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69118c0, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AssetLoadMode, addr 0x6911754, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::ResourceProviders::AssetLoadMode get_AssetLoadMode();

  /// @brief Method get_BundleName, addr 0x6911744, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_BundleName();

  /// @brief Method get_BundleSize, addr 0x6911764, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_BundleSize();

  /// @brief Method get_ChunkedTransfer, addr 0x6911708, size 0x8, virtual false, abstract: false, final false
  inline bool get_ChunkedTransfer();

  /// @brief Method get_ClearOtherCachedVersionsWhenLoaded, addr 0x6911794, size 0x8, virtual false, abstract: false, final false
  inline bool get_ClearOtherCachedVersionsWhenLoaded();

  /// @brief Method get_Crc, addr 0x69116e8, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_Crc();

  /// @brief Method get_Hash, addr 0x69116d8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Hash();

  /// @brief Method get_RedirectLimit, addr 0x6911718, size 0x14, virtual false, abstract: false, final false
  inline int32_t get_RedirectLimit();

  /// @brief Method get_RetryCount, addr 0x6911734, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_RetryCount();

  /// @brief Method get_Timeout, addr 0x69116f8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Timeout();

  /// @brief Method get_UseCrcForCachedBundle, addr 0x6911774, size 0x8, virtual false, abstract: false, final false
  inline bool get_UseCrcForCachedBundle();

  /// @brief Method get_UseUnityWebRequestForLocalBundles, addr 0x6911784, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_AssetLoadMode, addr 0x691175c, size 0x8, virtual false, abstract: false, final false
  inline void set_AssetLoadMode(::UnityEngine::ResourceManagement::ResourceProviders::AssetLoadMode value);

  /// @brief Method set_BundleName, addr 0x691174c, size 0x8, virtual false, abstract: false, final false
  inline void set_BundleName(::StringW value);

  /// @brief Method set_BundleSize, addr 0x691176c, size 0x8, virtual false, abstract: false, final false
  inline void set_BundleSize(int64_t value);

  /// @brief Method set_ChunkedTransfer, addr 0x6911710, size 0x8, virtual false, abstract: false, final false
  inline void set_ChunkedTransfer(bool value);

  /// @brief Method set_ClearOtherCachedVersionsWhenLoaded, addr 0x691179c, size 0x8, virtual false, abstract: false, final false
  inline void set_ClearOtherCachedVersionsWhenLoaded(bool value);

  /// @brief Method set_Crc, addr 0x69116f0, size 0x8, virtual false, abstract: false, final false
  inline void set_Crc(uint32_t value);

  /// @brief Method set_Hash, addr 0x69116e0, size 0x8, virtual false, abstract: false, final false
  inline void set_Hash(::StringW value);

  /// @brief Method set_RedirectLimit, addr 0x691172c, size 0x8, virtual false, abstract: false, final false
  inline void set_RedirectLimit(int32_t value);

  /// @brief Method set_RetryCount, addr 0x691173c, size 0x8, virtual false, abstract: false, final false
  inline void set_RetryCount(int32_t value);

  /// @brief Method set_Timeout, addr 0x6911700, size 0x8, virtual false, abstract: false, final false
  inline void set_Timeout(int32_t value);

  /// @brief Method set_UseCrcForCachedBundle, addr 0x691177c, size 0x8, virtual false, abstract: false, final false
  inline void set_UseCrcForCachedBundle(bool value);

  /// @brief Method set_UseUnityWebRequestForLocalBundles, addr 0x691178c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ResourceManagement::ResourceProviders::AssetBundleRequestOptions) == 0x50, "Size mismatch!");
