...
// Write type traits
MARK_REF_T(::UnityEngine::ResourceManagement::ResourceProviders::InstanceProvider*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::ResourceProviders::InstanceProvider*, "UnityEngine.ResourceManagement.ResourceProviders", "InstanceProvider");
...
public:
  ...
  /// @brief Method ProvideInstance, addr 0x67db6c8, size 0xf0, virtual true, abstract: false, final true
  ...
  /// @brief Method ReleaseInstance, addr 0x67db7b8, size 0x260, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x67dba18, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::ResourceManagement::ResourceProviders::InstanceProvider) == 0x18, "Size mismatch!");
