...
// Write type traits
MARK_REF_T(::UnityEngine::ResourceManagement::ResourceProviders::JsonAssetProvider*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::ResourceProviders::JsonAssetProvider*, "UnityEngine.ResourceManagement.ResourceProviders", "JsonAssetProvider");
...
public:
  // Declarations
  /// @brief Method Convert, addr 0x67dc040, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67dc04c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::ResourceManagement::ResourceProviders::JsonAssetProvider) == 0x20, "Size mismatch!");
