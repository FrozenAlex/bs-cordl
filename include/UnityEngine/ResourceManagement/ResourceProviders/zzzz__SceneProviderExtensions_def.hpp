...
public:
  // Declarations
  /// @brief Method ReleaseScene, addr 0x67dbe30, size 0x210, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ResourceManagement::ResourceProviders::SceneProviderExtensions) == 0x10, "Size mismatch!");
