...
// Write type traits
MARK_REF_T(::UnityEngine::ResourceManagement::ResourceProviders::TextDataProvider*);
MARK_REF_T(::UnityEngine::ResourceManagement::ResourceProviders::TextDataProvider_InternalOp*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::ResourceProviders::TextDataProvider*, "UnityEngine.ResourceManagement.ResourceProviders", "TextDataProvider");
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::ResourceProviders::TextDataProvider_InternalOp*, "UnityEngine.ResourceManagement.ResourceProviders", "TextDataProvider/InternalOp");
...
public:
  ...
  /// @brief Method CompleteOperation, addr 0x691b94c, size 0xa8, virtual false, abstract: false, final false
  inline void CompleteOperation(::StringW text, ::System::Exception* exception);

  /// @brief Method ConvertText, addr 0x691b604, size 0x100, virtual false, abstract: false, final false
  inline ::System::Object* ConvertText(::StringW text);

  /// @brief Method GetPercentComplete, addr 0x691b5ec, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method RequestOperation_completed, addr 0x691b778, size 0x1d4, virtual false, abstract: false, final false
  inline void RequestOperation_completed(::UnityEngine::AsyncOperation* op);

  /// @brief Method SendWebRequest, addr 0x691b9f4, size 0x414, virtual true, abstract: false, final false
  inline void SendWebRequest(::StringW path);

  /// @brief Method Start, addr 0x691b1ac, size 0x440, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitForCompletionHandler, addr 0x691b704, size 0x74, virtual false, abstract: false, final false
  inline bool WaitForCompletionHandler();

  /// @brief Method <SendWebRequest>b__13_0, addr 0x691be08, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x691b1a8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Convert, addr 0x691b11c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Provide, addr 0x691b124, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69188bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IgnoreFailures, addr 0x691b10c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreFailures();

  /// @brief Method set_IgnoreFailures, addr 0x691b114, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ResourceManagement::ResourceProviders::TextDataProvider) == 0x20, "Size mismatch!");
