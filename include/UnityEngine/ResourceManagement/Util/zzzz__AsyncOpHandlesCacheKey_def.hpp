...
// Write type traits
MARK_REF_T(::UnityEngine::ResourceManagement::Util::AsyncOpHandlesCacheKey*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::Util::AsyncOpHandlesCacheKey*, "UnityEngine.ResourceManagement.Util", "AsyncOpHandlesCacheKey");
...
public:
  ...
  /// @brief Method Equals, addr 0x690fbb4, size 0x70, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x690fc24, size 0x8c, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::ResourceManagement::Util::AsyncOpHandlesCacheKey* other);

  /// @brief Method Equals, addr 0x690fcb0, size 0x70, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ResourceManagement::Util::IOperationCacheKey* other);

  /// @brief Method GetHashCode, addr 0x690fb98, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x690718c, size 0xac, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ResourceManagement::Util::AsyncOpHandlesCacheKey) == 0x18, "Size mismatch!");
