...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::ResourceManagement::Util::LinkedListNodeCache_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::ResourceManagement::Util::LinkedListNodeCache_1, "UnityEngine.ResourceManagement.Util", "LinkedListNodeCache`1");
