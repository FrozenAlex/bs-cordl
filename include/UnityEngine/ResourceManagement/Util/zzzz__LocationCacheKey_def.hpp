...
// Write type traits
MARK_REF_T(::UnityEngine::ResourceManagement::Util::LocationCacheKey*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::Util::LocationCacheKey*, "UnityEngine.ResourceManagement.Util", "LocationCacheKey");
...
public:
  ...
  /// @brief Method Equals, addr 0x67d2ae0, size 0x70, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x67d2bc8, size 0x70, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ResourceManagement::Util::IOperationCacheKey* other);

  /// @brief Method Equals, addr 0x67d2b50, size 0x78, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::ResourceManagement::Util::LocationCacheKey* other);

  /// @brief Method GetHashCode, addr 0x67d2a30, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67c9d0c, size 0xa8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ResourceManagement::Util::LocationCacheKey) == 0x20, "Size mismatch!");
