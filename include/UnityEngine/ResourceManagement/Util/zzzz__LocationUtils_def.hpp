...
public:
  // Declarations
  /// @brief Method DependenciesEqual, addr 0x67d30a0, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method LocationEquals, addr 0x67d2c38, size 0x2f8, virtual false, abstract: false, final false
