...
// Write type traits
MARK_REF_T(::UnityEngine::ResourceManagement::Util::UnityWebRequestResult*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::Util::UnityWebRequestResult*, "UnityEngine.ResourceManagement.Util", "UnityWebRequestResult");
// Dependencies System.Object, UnityEngine.Networking.UnityWebRequest::Result
namespace UnityEngine::ResourceManagement::Util {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__Result_k__BackingField,
                      put = __cordl_internal_set__Result_k__BackingField)) ::UnityEngine::Networking::UnityWebRequest_Result _Result_k__BackingField;
  ...
  /// @brief Method ShouldRetryDownloadError, addr 0x67d4b68, size 0x2f4, virtual false, abstract: false, final false
  inline bool ShouldRetryDownloadError();

  /// @brief Method ToString, addr 0x67d4980, size 0x1b8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67d4710, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Networking::UnityWebRequest* request);

  /// @brief Method get_Error, addr 0x67d4b38, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Error();

  /// @brief Method get_Method, addr 0x67d4b58, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Method();

  /// @brief Method get_ResponseCode, addr 0x67d4b48, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_ResponseCode();

  /// @brief Method get_Result, addr 0x67d4b50, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Networking::UnityWebRequest_Result get_Result();

  /// @brief Method get_Url, addr 0x67d4b60, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Url();

  /// @brief Method set_Error, addr 0x67d4b40, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ResourceManagement::Util::UnityWebRequestResult) == 0x38, "Size mismatch!");
