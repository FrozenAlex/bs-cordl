...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::ResourceManagement::ChainOperationTypelessDepedency_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::ResourceManagement::ChainOperationTypelessDepedency_1, "UnityEngine.ResourceManagement", "ChainOperationTypelessDepedency`1");
...
public:
  ...
  /// @brief Method get_WrappedOp, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<TObject> get_WrappedOp();
