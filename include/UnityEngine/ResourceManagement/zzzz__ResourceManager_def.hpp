...
namespace UnityEngine::ResourceManagement {
template <typename TObject> class ResourceManager___c__DisplayClass90_0_1;
}
...
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::ResourceManager_DiagnosticEventType, "UnityEngine.ResourceManagement", "ResourceManager/DiagnosticEventType");
...
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::ResourceManager_DeferredCallbackRegisterRequest, "UnityEngine.ResourceManagement", "ResourceManager/DeferredCallbackRegisterRequest");
// Dependencies
namespace UnityEngine::ResourceManagement {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ResourceManagement::ResourceManager_DiagnosticEventType) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::ResourceManagement::ResourceManager_DeferredCallbackRegisterRequest) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method Destroy, addr 0x6908aec, size 0xb8, virtual true, abstract: false, final false
  inline void Destroy();

  /// @brief Method Execute, addr 0x6908d50, size 0x278, virtual true, abstract: false, final false
  inline void Execute();

  /// @brief Method GetDependencies, addr 0x69088c4, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDownloadStatus, addr 0x69087e4, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x6907aec, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method InstanceScene, addr 0x6908ae4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SceneManagement::Scene InstanceScene();

  /// @brief Method InvokeWaitForCompletion, addr 0x6908bf0, size 0x160, virtual true, abstract: false, final false
  inline bool InvokeWaitForCompletion();
  ...
  /// @brief Method .ctor, addr 0x6908fc8, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DebugName, addr 0x69089a8, size 0x13c, virtual true, abstract: false, final false
  inline ::StringW get_DebugName();

  /// @brief Method get_Progress, addr 0x6908ba4, size 0x4c, virtual true, abstract: false, final false
...
public:
  ...
  template <typename TObject> using __c__DisplayClass90_0_1 = ::UnityEngine::ResourceManagement::ResourceManager___c__DisplayClass90_0_1<TObject>;
  ...
  /// @brief Method Acquire, addr 0x6906db0, size 0x20, virtual false, abstract: false, final false
  inline void Acquire(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle handle);

  /// @brief Method AcquireGroupOpFromCache, addr 0x6906ea0, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method AddOperationToCache, addr 0x6906b2c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddUpdateReceiver, addr 0x6903b74, size 0x78, virtual false, abstract: false, final false
  inline void AddUpdateReceiver(::UnityEngine::ResourceManagement::IUpdateReceiver* receiver);

  /// @brief Method CachedOperationCount, addr 0x6906c44, size 0x58, virtual false, abstract: false, final false
  inline int32_t CachedOperationCount();

  /// @brief Method CalculateLocationsHash, addr 0x6904e28, size 0x408, virtual false, abstract: false, final false
  ...
  /// @brief Method CleanupSceneInstances, addr 0x6907b1c, size 0x370, virtual false, abstract: false, final false
  inline void CleanupSceneInstances(::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method ClearOperationCache, addr 0x6906c9c, size 0x54, virtual false, abstract: false, final false
  inline void ClearOperationCache();

  /// @brief Method CreateCacheKeyForLocation, addr 0x6905a14, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateGenericGroupOperation, addr 0x6906fe8, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x69085e4, size 0x11c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method ExecuteDeferredCallbacks, addr 0x6907e8c, size 0x1cc, virtual false, abstract: false, final false
  inline void ExecuteDeferredCallbacks();

  /// @brief Method GetDefaultTypeForLocation, addr 0x6904d00, size 0x128, virtual false, abstract: false, final false
  inline ::System::Type* GetDefaultTypeForLocation(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* loc);

  /// @brief Method GetOperationFromCache, addr 0x69064c8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetResourceProvider, addr 0x69048cc, size 0x434, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::ResourceProviders::IResourceProvider* GetResourceProvider(::System::Type* t,
                                                                                                      ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* location);

  /// @brief Method IsOperationCached, addr 0x6906bc8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnInstanceOperationDestroy, addr 0x6906620, size 0x168, virtual false, abstract: false, final false
  inline void OnInstanceOperationDestroy(::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation* o);

  /// @brief Method OnObjectAdded, addr 0x69046d0, size 0x78, virtual false, abstract: false, final false
  inline void OnObjectAdded(::System::Object* obj);

  /// @brief Method OnObjectRemoved, addr 0x6904748, size 0x78, virtual false, abstract: false, final false
  inline void OnObjectRemoved(::System::Object* obj);

  /// @brief Method OnOperationDestroyCached, addr 0x6906868, size 0x23c, virtual false, abstract: false, final false
  inline void OnOperationDestroyCached(::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation* o);

  /// @brief Method OnOperationDestroyNonCached, addr 0x6906788, size 0xe0, virtual false, abstract: false, final false
  inline void OnOperationDestroyNonCached(::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation* o);

  /// @brief Method ProvideInstance, addr 0x690784c, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method ProvideResource, addr 0x6905230, size 0x7c0, virtual false, abstract: false, final false
  ...
  /// @brief Method ProvideResourceGroupCached, addr 0x6905bd8, size 0x780, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::System::Collections::Generic::IList_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*>
  ...
  /// @brief Method ProvideScene, addr 0x6907304, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method ProvideScene, addr 0x6907454, size 0x150, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>
  ProvideScene(::UnityEngine::ResourceManagement::ResourceProviders::ISceneProvider* sceneProvider, ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* location,
               ::UnityEngine::SceneManagement::LoadSceneParameters loadSceneParameters, bool activateOnLoad, int32_t priority);

  /// @brief Method ProvideScene, addr 0x69075a4, size 0x158, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>
  ProvideScene(::UnityEngine::ResourceManagement::ResourceProviders::ISceneProvider* sceneProvider, ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* location,
  ...
  /// @brief Method RegisterForCallbacks, addr 0x69047c0, size 0x10c, virtual false, abstract: false, final false
  inline void RegisterForCallbacks();

  /// @brief Method RegisterForDeferredCallback, addr 0x6908058, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x6906cf0, size 0x8, virtual false, abstract: false, final false
  inline void Release(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle handle);

  /// @brief Method ReleaseScene, addr 0x69076fc, size 0x150, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>
  ...
  /// @brief Method RemoveOperationFromCache, addr 0x6906aa4, size 0x88, virtual false, abstract: false, final false
  inline bool RemoveOperationFromCache(::UnityEngine::ResourceManagement::Util::IOperationCacheKey* key);

  /// @brief Method RemoveUpdateReciever, addr 0x6903bec, size 0x148, virtual false, abstract: false, final false
  inline void RemoveUpdateReciever(::UnityEngine::ResourceManagement::IUpdateReceiver* receiver);

  /// @brief Method StartOperation, addr 0x6906358, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method TransformInternalId, addr 0x6903944, size 0xd4, virtual false, abstract: false, final false
  inline ::StringW TransformInternalId(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* location);

  /// @brief Method Update, addr 0x6908274, size 0x370, virtual false, abstract: false, final false
  ...
  /// @brief Method <.ctor>b__53_0, addr 0x69087e0, size 0x4, virtual false, abstract: false, final false
  inline void __ctor_b__53_0(::UnityEngine::ResourceManagement::IUpdateReceiver* x);

  /// @brief Method .ctor, addr 0x6903d5c, size 0x554, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Allocator, addr 0x6903d34, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::Util::IAllocationStrategy* get_Allocator();

  /// @brief Method get_CertificateHandlerInstance, addr 0x6903d4c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Networking::CertificateHandler* get_CertificateHandlerInstance();

  /// @brief Method get_DeferredCallbackCount, addr 0x6903b20, size 0x54, virtual false, abstract: false, final false
  inline int32_t get_DeferredCallbackCount();

  /// @brief Method get_DeferredCompleteCallbacksCount, addr 0x6903ad0, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_DeferredCompleteCallbacksCount();

  /// @brief Method get_ExceptionHandler, addr 0x6903878, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_InstanceOperationCount, addr 0x6903a80, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_InstanceOperationCount();

  /// @brief Method get_InternalIdTransformFunc, addr 0x6903934, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_OperationCacheCount, addr 0x6903a28, size 0x58, virtual false, abstract: false, final false
  inline int32_t get_OperationCacheCount();

  /// @brief Method get_ResourceProviders, addr 0x6903d44, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_WebRequestOverride, addr 0x6903a18, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Allocator, addr 0x6903d3c, size 0x8, virtual false, abstract: false, final false
  inline void set_Allocator(::UnityEngine::ResourceManagement::Util::IAllocationStrategy* value);

  /// @brief Method set_CertificateHandlerInstance, addr 0x6903d54, size 0x8, virtual false, abstract: false, final false
  inline void set_CertificateHandlerInstance(::UnityEngine::Networking::CertificateHandler* value);

  /// @brief Method set_ExceptionHandler, addr 0x69038d4, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method set_InternalIdTransformFunc, addr 0x690393c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_WebRequestOverride, addr 0x6903a20, size 0x8, virtual false, abstract: false, final false
