...
// Write type traits
MARK_REF_T(::UnityEngine::ResourceManagement::WebRequestQueueOperation*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::WebRequestQueueOperation*, "UnityEngine.ResourceManagement", "WebRequestQueueOperation");
...
public:
  ...
  /// @brief Method Complete, addr 0x67cc7e0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67cc7d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Networking::UnityWebRequest* request);

  /// @brief Method get_IsDone, addr 0x67cc7a8, size 0x20, virtual false, abstract: false, final false
  inline bool get_IsDone();

  /// @brief Method get_WebRequest, addr 0x67cc7c8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Networking::UnityWebRequest* get_WebRequest();

  /// @brief Method set_WebRequest, addr 0x67cc7d0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ResourceManagement::WebRequestQueueOperation) == 0x30, "Size mismatch!");
