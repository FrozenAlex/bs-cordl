...
public:
  ...
  /// @brief Method GetActiveScene, addr 0x6af853c, size 0x80, virtual false, abstract: false, final false
  static inline ::UnityEngine::SceneManagement::Scene GetActiveScene();

  /// @brief Method GetActiveScene_Injected, addr 0x6af85bc, size 0x3c, virtual false, abstract: false, final false
  static inline void GetActiveScene_Injected(::by_ref<::UnityEngine::SceneManagement::Scene> ret);

  /// @brief Method GetSceneAt, addr 0x6af8854, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::SceneManagement::Scene GetSceneAt(int32_t index);

  /// @brief Method GetSceneAt_Injected, addr 0x6af88e4, size 0x44, virtual false, abstract: false, final false
  static inline void GetSceneAt_Injected(int32_t index, ::by_ref<::UnityEngine::SceneManagement::Scene> ret);

  /// @brief Method GetSceneByName, addr 0x6af86b4, size 0x15c, virtual false, abstract: false, final false
  static inline ::UnityEngine::SceneManagement::Scene GetSceneByName(::StringW name);

  /// @brief Method GetSceneByName_Injected, addr 0x6af8810, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_ActiveSceneChanged, addr 0x6af991c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_SceneLoaded, addr 0x6af97c8, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_SceneUnloaded, addr 0x6af987c, size 0xa0, virtual false, abstract: false, final false
  static inline void Internal_SceneUnloaded(::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method LoadFirstScene_Internal, addr 0x6af8bf8, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::AsyncOperation* LoadFirstScene_Internal(bool async);

  /// @brief Method LoadScene, addr 0x6af9460, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadScene, addr 0x6af9304, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadScene, addr 0x6af93f8, size 0x68, virtual false, abstract: false, final false
  static inline void LoadScene(int32_t sceneBuildIndex, ::UnityEngine::SceneManagement::LoadSceneMode mode);

  /// @brief Method LoadScene, addr 0x6af939c, size 0x5c, virtual false, abstract: false, final false
  static inline void LoadScene(::StringW sceneName);

  /// @brief Method LoadScene, addr 0x6af9294, size 0x68, virtual false, abstract: false, final false
  static inline void LoadScene(::StringW sceneName, ::UnityEngine::SceneManagement::LoadSceneMode mode);

  /// @brief Method LoadSceneAsync, addr 0x6af94f8, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadSceneAsync, addr 0x6af9560, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadSceneAsync, addr 0x6af96a8, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::AsyncOperation* LoadSceneAsync(::StringW sceneName);

  /// @brief Method LoadSceneAsync, addr 0x6af95d0, size 0x68, virtual false, abstract: false, final false
  static inline ::UnityEngine::AsyncOperation* LoadSceneAsync(::StringW sceneName, ::UnityEngine::SceneManagement::LoadSceneMode mode);

  /// @brief Method LoadSceneAsync, addr 0x6af9638, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadSceneAsyncNameIndexInternal, addr 0x6af8a04, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method MoveGameObjectToScene, addr 0x6af8ae8, size 0xcc, virtual false, abstract: false, final false
  static inline void MoveGameObjectToScene(::UnityEngine::GameObject* go, ::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method MoveGameObjectToScene_Injected, addr 0x6af8bb4, size 0x44, virtual false, abstract: false, final false
  static inline void MoveGameObjectToScene_Injected(::System::IntPtr go, ::by_ref<::UnityEngine::SceneManagement::Scene> scene);

  /// @brief Method SetActiveScene, addr 0x6af85f8, size 0x80, virtual false, abstract: false, final false
  static inline bool SetActiveScene(::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method SetActiveScene_Injected, addr 0x6af8678, size 0x3c, virtual false, abstract: false, final false
  static inline bool SetActiveScene_Injected(::by_ref<::UnityEngine::SceneManagement::Scene> scene);

  /// @brief Method UnloadSceneAsync, addr 0x6af9704, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::AsyncOperation* UnloadSceneAsync(::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method UnloadSceneAsync, addr 0x6af9760, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method UnloadSceneAsyncInternal, addr 0x6af8928, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method UnloadSceneAsyncInternal_Injected, addr 0x6af89c0, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method add_activeSceneChanged, addr 0x6af9084, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method add_sceneLoaded, addr 0x6af8c64, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method add_sceneUnloaded, addr 0x6af8e74, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method get_sceneCount, addr 0x6af84b0, size 0x28, virtual false, abstract: false, final false
  static inline int32_t get_sceneCount();

  /// @brief Method get_sceneCountInBuildSettings, addr 0x6af84d8, size 0x64, virtual false, abstract: false, final false
  static inline int32_t get_sceneCountInBuildSettings();

  /// @brief Method remove_activeSceneChanged, addr 0x6af918c, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_sceneLoaded, addr 0x6af8d6c, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_sceneUnloaded, addr 0x6af8f7c, size 0x108, virtual false, abstract: false, final false
