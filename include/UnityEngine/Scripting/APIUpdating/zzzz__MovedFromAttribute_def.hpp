...
public:
  ...
  /// @brief Method .ctor, addr 0x69a8660, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(bool autoUpdateAPI, ::StringW sourceNamespace, ::StringW sourceAssembly, ::StringW sourceClassName);

  /// @brief Method .ctor, addr 0x69a8694, size 0x24, virtual false, abstract: false, final false
