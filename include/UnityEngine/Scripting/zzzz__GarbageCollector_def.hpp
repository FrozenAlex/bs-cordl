...
MARK_REF_T(::UnityEngine::Scripting::GarbageCollector*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Scripting::GarbageCollector_Mode, "UnityEngine.Scripting", "GarbageCollector/Mode");
DEFINE_IL2CPP_CLASS(::UnityEngine::Scripting::GarbageCollector*, "UnityEngine.Scripting", "GarbageCollector");
// Dependencies
namespace UnityEngine::Scripting {
// Is value type: true
...
public:
  ...
  /// @brief Method GetMode, addr 0x69a85c0, size 0x28, virtual false, abstract: false, final false
  static inline ::UnityEngine::Scripting::GarbageCollector_Mode GetMode();

  /// @brief Method SetMode, addr 0x69a85e8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_GCMode, addr 0x69a8500, size 0xc0, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::Scripting::GarbageCollector) == 0x10, "Size mismatch!");
