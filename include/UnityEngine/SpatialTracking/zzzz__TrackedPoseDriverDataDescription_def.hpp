...
DEFINE_IL2CPP_CLASS(::UnityEngine::SpatialTracking::TrackedPoseDriverDataDescription_PoseData, "UnityEngine.SpatialTracking", "TrackedPoseDriverDataDescription/PoseData");
// Dependencies
namespace UnityEngine::SpatialTracking {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::SpatialTracking::TrackedPoseDriverDataDescription_PoseData) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6a5f61c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
