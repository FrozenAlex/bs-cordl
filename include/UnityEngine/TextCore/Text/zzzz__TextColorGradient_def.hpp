...
public:
  ...
  /// @brief Method .ctor, addr 0x6aa9ff4, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6aaa094, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Color color);

  /// @brief Method .ctor, addr 0x6aaa100, size 0xa4, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::TextCore::Text::TextColorGradient) == 0x60, "Size mismatch!");
