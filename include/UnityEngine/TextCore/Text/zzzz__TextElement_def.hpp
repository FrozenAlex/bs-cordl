...
public:
  ...
  /// @brief Method .ctor, addr 0x6aa9ec0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_elementType, addr 0x6aab670, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::TextElementType get_elementType();

  /// @brief Method get_glyph, addr 0x6aab680, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Glyph* get_glyph();

  /// @brief Method get_glyphIndex, addr 0x6aa8f98, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_glyphIndex();

  /// @brief Method get_scale, addr 0x6aab690, size 0x8, virtual false, abstract: false, final false
  inline float_t get_scale();

  /// @brief Method get_textAsset, addr 0x6aa7d30, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::TextCore::Text::TextAsset> get_textAsset();

  /// @brief Method get_unicode, addr 0x6aa6c18, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_unicode();

  /// @brief Method set_glyph, addr 0x6aa8fa0, size 0x8, virtual false, abstract: false, final false
  inline void set_glyph(::UnityEngine::TextCore::Glyph* value);

  /// @brief Method set_glyphIndex, addr 0x6aab688, size 0x8, virtual false, abstract: false, final false
  inline void set_glyphIndex(uint32_t value);

  /// @brief Method set_scale, addr 0x6aab698, size 0x8, virtual false, abstract: false, final false
  inline void set_scale(float_t value);

  /// @brief Method set_textAsset, addr 0x6aa8fa8, size 0x8, virtual false, abstract: false, final false
  inline void set_textAsset(::UnityEngine::TextCore::Text::TextAsset* value);

  /// @brief Method set_unicode, addr 0x6aab678, size 0x8, virtual false, abstract: false, final false
