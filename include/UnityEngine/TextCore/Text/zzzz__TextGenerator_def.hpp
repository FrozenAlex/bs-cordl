...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6bfcaac, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bfca40, size 0x6c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6bfcac0, size 0x108, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CalculatePreferredValues, addr 0x6bdcf24, size 0x2360, virtual true, abstract: false, final false
  ...
  /// @brief Method ClearMarkupTagAttributes, addr 0x6bd9878, size 0x64, virtual false, abstract: false, final false
  inline void ClearMarkupTagAttributes();

  /// @brief Method ClearMesh, addr 0x6bcea8c, size 0x20, virtual false, abstract: false, final false
  static inline void ClearMesh(bool updateMesh, ::UnityEngine::TextCore::Text::TextInfo* textInfo);

  /// @brief Method ComputeMarginSize, addr 0x6bdf2c0, size 0x68, virtual false, abstract: false, final false
  inline void ComputeMarginSize(::UnityEngine::Rect rect, ::UnityEngine::Vector4 margins);

  /// @brief Method DoMissingGlyphCallback, addr 0x6be315c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawTextHighlight, addr 0x6bdbf7c, size 0x808, virtual false, abstract: false, final false
  inline void DrawTextHighlight(::UnityEngine::Vector3 start, ::UnityEngine::Vector3 end, ::UnityEngine::Color32 highlightColor,
                                ::UnityEngine::TextCore::Text::TextGenerationSettings* generationSettings, ::UnityEngine::TextCore::Text::TextInfo* textInfo);

  /// @brief Method DrawUnderlineMesh, addr 0x6bdaf50, size 0xf04, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateText, addr 0x6bce3e0, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateTextMesh, addr 0x6bce69c, size 0x3e8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEllipsisSpecialCharacter, addr 0x6be2a58, size 0x2b4, virtual false, abstract: false, final false
  inline bool GetEllipsisSpecialCharacter(::UnityEngine::TextCore::Text::TextGenerationSettings* generationSettings);

  /// @brief Method GetPreferredValues, addr 0x6bdcc88, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreferredValuesInternal, addr 0x6bdcdec, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSpecialCharacters, addr 0x6bdf284, size 0x3c, virtual false, abstract: false, final false
  inline bool GetSpecialCharacters(::UnityEngine::TextCore::Text::TextGenerationSettings* generationSettings);

  /// @brief Method GetTextElement, addr 0x6be2d0c, size 0x450, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUnderlineSpecialCharacter, addr 0x6bdbe54, size 0x128, virtual false, abstract: false, final false
  inline bool GetUnderlineSpecialCharacter(::UnityEngine::TextCore::Text::TextGenerationSettings* generationSettings);

  /// @brief Method InsertNewLine, addr 0x6bdc784, size 0x504, virtual false, abstract: false, final false
  ...
  /// @brief Method LayoutPhase, addr 0x6bd2a10, size 0x29dc, virtual false, abstract: false, final false
  ...
  /// @brief Method ParsingPhase, addr 0x6bceaac, size 0x3f64, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateFontAsset, addr 0x6be1960, size 0x10f8, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateTextBackingArray, addr 0x6bdf328, size 0xd4, virtual false, abstract: false, final false
  inline void PopulateTextBackingArray(::by_ref<::UnityEngine::TextCore::Text::RenderedText> sourceText);

  /// @brief Method PopulateTextProcessingArray, addr 0x6bdf3fc, size 0xce4, virtual false, abstract: false, final false
  inline void PopulateTextProcessingArray(::UnityEngine::TextCore::Text::TextGenerationSettings* generationSettings);

  /// @brief Method Prepare, addr 0x6bce5ac, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method PrepareFontAsset, addr 0x6be18c0, size 0xa0, virtual false, abstract: false, final false
  inline bool PrepareFontAsset(::UnityEngine::TextCore::Text::TextGenerationSettings* generationSettings);

  /// @brief Method RestoreWordWrappingState, addr 0x6bd9b7c, size 0x2a4, virtual false, abstract: false, final false
  ...
  /// @brief Method SaveGlyphVertexInfo, addr 0x6bd9e20, size 0xad4, virtual false, abstract: false, final false
  ...
  /// @brief Method SaveSpriteVertexInfo, addr 0x6bda8f4, size 0x65c, virtual false, abstract: false, final false
  ...
  /// @brief Method SaveWordWrappingState, addr 0x6bd98dc, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetArraySizes, addr 0x6be00e0, size 0x17e0, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateHtmlTag, addr 0x6bd53ec, size 0x448c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6be31fc, size 0x6c4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_IsExecutingJob, addr 0x6bce340, size 0x4c, virtual false, abstract: false, final false
  static inline bool get_IsExecutingJob();

  /// @brief Method get_isTextTruncated, addr 0x6bcea84, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsExecutingJob, addr 0x6bce38c, size 0x54, virtual false, abstract: false, final false
