...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::TextInputSource, "UnityEngine.TextCore.Text", "TextInputSource");
// Dependencies
namespace UnityEngine::TextCore::Text {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::TextCore::Text::TextInputSource) == 0x4, "Size mismatch!");
