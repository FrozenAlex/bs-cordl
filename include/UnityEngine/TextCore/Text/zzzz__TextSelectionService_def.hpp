...
public:
  // Declarations
  /// @brief Method GetCharacterHeightFromIndex, addr 0x6c05aa0, size 0x44, virtual false, abstract: false, final false
  static inline float_t GetCharacterHeightFromIndex(::System::IntPtr textGenerationInfo, int32_t index);

  /// @brief Method GetCursorLogicalIndexFromPosition, addr 0x6c05758, size 0x48, virtual false, abstract: false, final false
  static inline int32_t GetCursorLogicalIndexFromPosition(::System::IntPtr textGenerationInfo, ::UnityEngine::Vector2 position);

  /// @brief Method GetCursorLogicalIndexFromPosition_Injected, addr 0x6c057a0, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCursorPositionFromLogicalIndex, addr 0x6c057e4, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCursorPositionFromLogicalIndex_Injected, addr 0x6c05840, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEndOfPreviousWord, addr 0x6c05b28, size 0x44, virtual false, abstract: false, final false
  static inline int32_t GetEndOfPreviousWord(::System::IntPtr textGenerationInfo, int32_t currentIndex);

  /// @brief Method GetFirstCharacterIndexOnLine, addr 0x6c05b6c, size 0x44, virtual false, abstract: false, final false
  static inline int32_t GetFirstCharacterIndexOnLine(::System::IntPtr textGenerationInfo, int32_t currentIndex);

  /// @brief Method GetHighlightRectangles, addr 0x6c0591c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHighlightRectangles_Injected, addr 0x6c05a44, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLastCharacterIndexOnLine, addr 0x6c05bb0, size 0x44, virtual false, abstract: false, final false
  static inline int32_t GetLastCharacterIndexOnLine(::System::IntPtr textGenerationInfo, int32_t currentIndex);

  /// @brief Method GetLineHeight, addr 0x6c05bf4, size 0x44, virtual false, abstract: false, final false
  static inline float_t GetLineHeight(::System::IntPtr textGenerationInfo, int32_t lineIndex);

  /// @brief Method GetLineNumber, addr 0x6c05c38, size 0x44, virtual false, abstract: false, final false
  static inline int32_t GetLineNumber(::System::IntPtr textGenerationInfo, int32_t logicalIndex);

  /// @brief Method GetStartOfNextWord, addr 0x6c05ae4, size 0x44, virtual false, abstract: false, final false
  static inline int32_t GetStartOfNextWord(::System::IntPtr textGenerationInfo, int32_t currentIndex);

  /// @brief Method LineDownCharacterPosition, addr 0x6c058d8, size 0x44, virtual false, abstract: false, final false
  static inline int32_t LineDownCharacterPosition(::System::IntPtr textGenerationInfo, int32_t originalPos);

  /// @brief Method LineUpCharacterPosition, addr 0x6c05894, size 0x44, virtual false, abstract: false, final false
  static inline int32_t LineUpCharacterPosition(::System::IntPtr textGenerationInfo, int32_t originalPos);

  /// @brief Method NextCodePointIndex, addr 0x6c05714, size 0x44, virtual false, abstract: false, final false
  static inline int32_t NextCodePointIndex(::System::IntPtr textGenerationInfo, int32_t currentIndex);

  /// @brief Method PreviousCodePointIndex, addr 0x6c056d0, size 0x44, virtual false, abstract: false, final false
  static inline int32_t PreviousCodePointIndex(::System::IntPtr textGenerationInfo, int32_t currentIndex);

  /// @brief Method SelectCurrentParagraph, addr 0x6c05d8c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method SelectCurrentWord, addr 0x6c05674, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method SelectToEndOfParagraph, addr 0x6c05d04, size 0x44, virtual false, abstract: false, final false
  static inline void SelectToEndOfParagraph(::System::IntPtr textGenerationInfo, ::by_ref<int32_t> cursorIndex);

  /// @brief Method SelectToNextParagraph, addr 0x6c05d48, size 0x44, virtual false, abstract: false, final false
  static inline void SelectToNextParagraph(::System::IntPtr textGenerationInfo, ::by_ref<int32_t> cursorIndex);

  /// @brief Method SelectToPreviousParagraph, addr 0x6c05c7c, size 0x44, virtual false, abstract: false, final false
  static inline void SelectToPreviousParagraph(::System::IntPtr textGenerationInfo, ::by_ref<int32_t> cursorIndex);

  /// @brief Method SelectToStartOfParagraph, addr 0x6c05cc0, size 0x44, virtual false, abstract: false, final false
  static inline void SelectToStartOfParagraph(::System::IntPtr textGenerationInfo, ::by_ref<int32_t> cursorIndex);

  /// @brief Method Substring, addr 0x6c05538, size 0xe0, virtual false, abstract: false, final false
  static inline ::StringW Substring(::System::IntPtr textGenerationInfo, int32_t startIndex, int32_t endIndex);

  /// @brief Method Substring_Injected, addr 0x6c05618, size 0x5c, virtual false, abstract: false, final false
