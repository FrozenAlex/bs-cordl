...
public:
  // Declarations
  /// @brief Method GetHashCodeCaseInSensitive, addr 0x6c0bc90, size 0x70, virtual false, abstract: false, final false
  static inline int32_t GetHashCodeCaseInSensitive(::StringW s);

  /// @brief Method GetTextFontWeightIndex, addr 0x6c0d268, size 0x94, virtual false, abstract: false, final false
  static inline int32_t GetTextFontWeightIndex(::UnityEngine::TextCore::Text::TextFontWeight fontWeight);

  /// @brief Method ToUpperFast, addr 0x6c0d1e8, size 0x80, virtual false, abstract: false, final false
