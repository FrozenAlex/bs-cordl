...
public:
  ...
  /// @brief Method Equals, addr 0x6bb4844, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6bb48bc, size 0x9c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::TextCore::GlyphMetrics other);

  /// @brief Method GetHashCode, addr 0x6bb47d8, size 0x6c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x6bb47c8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(float_t width, float_t height, float_t bearingX, float_t bearingY, float_t advance);

  /// @brief Method get_height, addr 0x6bb47a8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_height();

  /// @brief Method get_horizontalAdvance, addr 0x6bb47c0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_horizontalAdvance();

  /// @brief Method get_horizontalBearingX, addr 0x6bb47b0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_horizontalBearingX();

  /// @brief Method get_horizontalBearingY, addr 0x6bb47b8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_horizontalBearingY();

  /// @brief Method get_width, addr 0x6bb47a0, size 0x8, virtual false, abstract: false, final false
