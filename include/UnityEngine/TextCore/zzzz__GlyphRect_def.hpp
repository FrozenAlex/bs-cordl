...
public:
  ...
  /// @brief Method Equals, addr 0x6a64d9c, size 0x70, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6a64e0c, size 0x8c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::TextCore::GlyphRect other);

  /// @brief Method GetHashCode, addr 0x6a64d38, size 0x64, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x6a64d2c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_height, addr 0x6a64cc8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_height();

  /// @brief Method get_width, addr 0x6a64cc0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_width();

  /// @brief Method get_x, addr 0x6a64cb0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_x();

  /// @brief Method get_y, addr 0x6a64cb8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_y();

  /// @brief Method get_zero, addr 0x6a64cd0, size 0x5c, virtual false, abstract: false, final false
