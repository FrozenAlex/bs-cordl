...
DEFINE_IL2CPP_CLASS(::UnityEngine::Timeline::AnimationOutputWeightProcessor_WeightInfo, "UnityEngine.Timeline", "AnimationOutputWeightProcessor/WeightInfo");
...
static_assert(sizeof(::UnityEngine::Timeline::AnimationOutputWeightProcessor_WeightInfo) == 0x28, "Size mismatch!");
...
public:
  ...
  /// @brief Method Evaluate, addr 0x6868d0c, size 0x1ac, virtual true, abstract: false, final true
  inline void Evaluate();

  /// @brief Method FindMixers, addr 0x686892c, size 0xfc, virtual false, abstract: false, final false
  inline void FindMixers();

  /// @brief Method FindMixers, addr 0x6868a28, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6868874, size 0xb8, virtual false, abstract: false, final false
