...
// Write type traits
MARK_REF_T(::UnityEngine::Timeline::AnimationPreviewUpdateCallback*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Timeline::AnimationPreviewUpdateCallback*, "UnityEngine.Timeline", "AnimationPreviewUpdateCallback");
...
public:
  ...
  /// @brief Method Evaluate, addr 0x686a034, size 0x1c0, virtual true, abstract: false, final true
  inline void Evaluate();

  /// @brief Method FetchPreviewComponents, addr 0x686a1f4, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6869f74, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Timeline::AnimationPreviewUpdateCallback) == 0x38, "Size mismatch!");
