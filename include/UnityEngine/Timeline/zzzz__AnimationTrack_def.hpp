...
public:
  // Declarations
  /// @brief Method ConvertInfiniteTrack, addr 0x69aae08, size 0x1c, virtual false, abstract: false, final false
  static inline void ConvertInfiniteTrack(::UnityEngine::Timeline::AnimationTrack* track);

  /// @brief Method ConvertRootMotion, addr 0x69aad80, size 0x88, virtual false, abstract: false, final false
  static inline void ConvertRootMotion(::UnityEngine::Timeline::AnimationTrack* track);

  /// @brief Method ConvertRotationsToEuler, addr 0x69aacec, size 0x94, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x69ab064, size 0x80, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::Timeline::AnimationTrack__get_outputs_d__49* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.Playables.PlayableBinding>.GetEnumerator, addr 0x69ab190, size 0x98, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.Playables.PlayableBinding>.get_Current, addr 0x69ab0e4, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x69ab228, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x69ab0f4, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x69ab12c, size 0x64, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x69ab060, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x69a6f34, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AnimatesRootTransform, addr 0x69a80a8, size 0x3b4, virtual false, abstract: false, final false
  inline bool AnimatesRootTransform();

  /// @brief Method ApplyTrackOffset, addr 0x69a845c, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method AssignAnimationClip, addr 0x69a7250, size 0x218, virtual false, abstract: false, final false
  inline void AssignAnimationClip(::UnityEngine::Timeline::TimelineClip* clip, ::UnityEngine::AnimationClip* animClip);

  /// @brief Method AttachDefaultBlend, addr 0x69a9ae0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method AttachOffsetPlayable, addr 0x69a9af4, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateItemsHash, addr 0x69a7a64, size 0x84, virtual true, abstract: false, final false
  inline int32_t CalculateItemsHash();

  /// @brief Method CanCompileClips, addr 0x69a6dfc, size 0xc8, virtual true, abstract: false, final false
  inline bool CanCompileClips();

  /// @brief Method CompileTrackPlayable, addr 0x69a7c90, size 0x414, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateClip, addr 0x69a71a0, size 0xb0, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateClip(::UnityEngine::AnimationClip* clip);

  /// @brief Method CreateGroupMixer, addr 0x69a95bc, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateInfiniteClip, addr 0x69a7468, size 0x11c, virtual false, abstract: false, final false
  inline void CreateInfiniteClip(::StringW infiniteClipName);

  /// @brief Method CreateInfiniteTrackPlayable, addr 0x69a9634, size 0x394, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateMixerPlayableGraph, addr 0x69a8684, size 0x9c8, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRecordableClip, addr 0x69a7584, size 0x148, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateRecordableClip(::StringW animClipName);

  /// @brief Method FindInHierarchyBreadthFirst, addr 0x69aaa30, size 0x1e4, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Transform> FindInHierarchyBreadthFirst(::UnityEngine::Transform* t, ::StringW name);

  /// @brief Method GatherProperties, addr 0x69aa4d8, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAnimationClips, addr 0x69aa4dc, size 0x554, virtual false, abstract: false, final false
  inline void GetAnimationClips(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::AnimationClip>>* animClips);

  /// @brief Method GetBinding, addr 0x69a9c58, size 0x1f4, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Animator> GetBinding(::UnityEngine::Playables::PlayableDirector* director);

  /// @brief Method GetDefaultBlendCount, addr 0x69a95b4, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetDefaultBlendCount();

  /// @brief Method GetEvaluationTime, addr 0x69a9f7c, size 0xa0, virtual true, abstract: false, final false
  inline void GetEvaluationTime(::by_ref<double_t> outStart, ::by_ref<double_t> outDuration);

  /// @brief Method GetGenericRootNode, addr 0x69a904c, size 0x1d4, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> GetGenericRootNode(::UnityEngine::GameObject* gameObject);

  /// @brief Method GetOffsetMode, addr 0x69a94a0, size 0x114, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::AppliedOffsetMode GetOffsetMode(::UnityEngine::GameObject* go, bool animatesRootTransform);

  /// @brief Method GetSequenceTime, addr 0x69aa244, size 0x10c, virtual true, abstract: false, final false
  inline void GetSequenceTime(::by_ref<double_t> outStart, ::by_ref<double_t> outDuration);

  /// @brief Method HasController, addr 0x69a9e4c, size 0x128, virtual false, abstract: false, final false
  inline bool HasController(::UnityEngine::GameObject* gameObject);

  /// @brief Method IsRootTransformDisabledByMask, addr 0x69a9220, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method OnCreateClip, addr 0x69a78a4, size 0x4c, virtual true, abstract: false, final false
  inline void OnCreateClip(::UnityEngine::Timeline::TimelineClip* clip);

  /// @brief Method OnUpgradeFromVersion, addr 0x69aac9c, size 0x50, virtual true, abstract: false, final false
  inline void OnUpgradeFromVersion(int32_t oldVersion);

  /// @brief Method RequiresMotionXPlayable, addr 0x69a99c8, size 0x118, virtual false, abstract: false, final false
  inline bool RequiresMotionXPlayable(::UnityEngine::Timeline::AppliedOffsetMode mode, ::UnityEngine::GameObject* gameObject);

  /// @brief Method ResetOffsets, addr 0x69a712c, size 0x70, virtual false, abstract: false, final false
  inline void ResetOffsets();

  /// @brief Method UnityEngine.Timeline.ILayerable.CreateLayerMixer, addr 0x69a8630, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method UpdateClipOffsets, addr 0x69a719c, size 0x4, virtual false, abstract: false, final false
  inline void UpdateClipOffsets();

  /// @brief Method UsesAbsoluteMotion, addr 0x69a9ae4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69aae24, size 0x1a8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Collections::Generic::Queue_1<::UnityW<::UnityEngine::Transform>>* getStaticF_s_CachedQueue();

  /// @brief Method get_applyAvatarMask, addr 0x69a6dec, size 0x8, virtual false, abstract: false, final false
  inline bool get_applyAvatarMask();

  /// @brief Method get_applyOffsets, addr 0x69a6d24, size 0x8, virtual false, abstract: false, final false
  inline bool get_applyOffsets();

  /// @brief Method get_avatarMask, addr 0x69a6ddc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::AvatarMask> get_avatarMask();

  /// @brief Method get_eulerAngles, addr 0x69a6d0c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_eulerAngles();

  /// @brief Method get_inClipMode, addr 0x69a6f54, size 0x34, virtual false, abstract: false, final false
  inline bool get_inClipMode();

  /// @brief Method get_infiniteClip, addr 0x69a6dbc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::AnimationClip> get_infiniteClip();

  /// @brief Method get_infiniteClipApplyFootIK, addr 0x69a70dc, size 0x8, virtual false, abstract: false, final false
  inline bool get_infiniteClipApplyFootIK();

  /// @brief Method get_infiniteClipLoop, addr 0x69a711c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::AnimationPlayableAsset_LoopMode get_infiniteClipLoop();

  /// @brief Method get_infiniteClipOffsetEulerAngles, addr 0x69a70c4, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_infiniteClipOffsetEulerAngles();

  /// @brief Method get_infiniteClipOffsetPosition, addr 0x69a7040, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_infiniteClipOffsetPosition();

  /// @brief Method get_infiniteClipOffsetRotation, addr 0x69a7058, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_infiniteClipOffsetRotation();

  /// @brief Method get_infiniteClipPostExtrapolation, addr 0x69a710c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip_ClipExtrapolation get_infiniteClipPostExtrapolation();

  /// @brief Method get_infiniteClipPreExtrapolation, addr 0x69a70fc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip_ClipExtrapolation get_infiniteClipPreExtrapolation();

  /// @brief Method get_infiniteClipRemoveOffset, addr 0x69a6dcc, size 0x8, virtual false, abstract: false, final false
  inline bool get_infiniteClipRemoveOffset();

  /// @brief Method get_infiniteClipTimeOffset, addr 0x69a70ec, size 0x8, virtual false, abstract: false, final false
  inline double_t get_infiniteClipTimeOffset();

  /// @brief Method get_matchTargetFields, addr 0x69a6d40, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::MatchTargetFields get_matchTargetFields();

  /// @brief Method get_openClipOffsetEulerAngles, addr 0x69aac64, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_openClipOffsetEulerAngles();

  /// @brief Method get_openClipOffsetPosition, addr 0x69aac18, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_openClipOffsetPosition();

  /// @brief Method get_openClipOffsetRotation, addr 0x69aac30, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_openClipOffsetRotation();

  /// @brief Method get_openClipPostExtrapolation, addr 0x69aac8c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip_ClipExtrapolation get_openClipPostExtrapolation();

  /// @brief Method get_openClipPreExtrapolation, addr 0x69aac7c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip_ClipExtrapolation get_openClipPreExtrapolation();

  /// @brief Method get_outputs, addr 0x69a6ec4, size 0x70, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Playables::PlayableBinding>* get_outputs();

  /// @brief Method get_position, addr 0x69a6c88, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_position();

  /// @brief Method get_rotation, addr 0x69a6ca0, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_rotation();

  /// @brief Method get_trackOffset, addr 0x69a6d30, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_applyAvatarMask, addr 0x69a6df4, size 0x8, virtual false, abstract: false, final false
  inline void set_applyAvatarMask(bool value);

  /// @brief Method set_applyOffsets, addr 0x69a6d2c, size 0x4, virtual false, abstract: false, final false
  inline void set_applyOffsets(bool value);

  /// @brief Method set_avatarMask, addr 0x69a6de4, size 0x8, virtual false, abstract: false, final false
  inline void set_avatarMask(::UnityEngine::AvatarMask* value);

  /// @brief Method set_eulerAngles, addr 0x69a6d18, size 0xc, virtual false, abstract: false, final false
  inline void set_eulerAngles(::UnityEngine::Vector3 value);

  /// @brief Method set_infiniteClip, addr 0x69a6dc4, size 0x8, virtual false, abstract: false, final false
  inline void set_infiniteClip(::UnityEngine::AnimationClip* value);

  /// @brief Method set_infiniteClipApplyFootIK, addr 0x69a70e4, size 0x8, virtual false, abstract: false, final false
  inline void set_infiniteClipApplyFootIK(bool value);

  /// @brief Method set_infiniteClipLoop, addr 0x69a7124, size 0x8, virtual false, abstract: false, final false
  inline void set_infiniteClipLoop(::UnityEngine::Timeline::AnimationPlayableAsset_LoopMode value);

  /// @brief Method set_infiniteClipOffsetEulerAngles, addr 0x69a70d0, size 0xc, virtual false, abstract: false, final false
  inline void set_infiniteClipOffsetEulerAngles(::UnityEngine::Vector3 value);

  /// @brief Method set_infiniteClipOffsetPosition, addr 0x69a704c, size 0xc, virtual false, abstract: false, final false
  inline void set_infiniteClipOffsetPosition(::UnityEngine::Vector3 value);

  /// @brief Method set_infiniteClipOffsetRotation, addr 0x69a7088, size 0x3c, virtual false, abstract: false, final false
  inline void set_infiniteClipOffsetRotation(::UnityEngine::Quaternion value);

  /// @brief Method set_infiniteClipPostExtrapolation, addr 0x69a7114, size 0x8, virtual false, abstract: false, final false
  inline void set_infiniteClipPostExtrapolation(::UnityEngine::Timeline::TimelineClip_ClipExtrapolation value);

  /// @brief Method set_infiniteClipPreExtrapolation, addr 0x69a7104, size 0x8, virtual false, abstract: false, final false
  inline void set_infiniteClipPreExtrapolation(::UnityEngine::Timeline::TimelineClip_ClipExtrapolation value);

  /// @brief Method set_infiniteClipRemoveOffset, addr 0x69a6dd4, size 0x8, virtual false, abstract: false, final false
  inline void set_infiniteClipRemoveOffset(bool value);

  /// @brief Method set_infiniteClipTimeOffset, addr 0x69a70f4, size 0x8, virtual false, abstract: false, final false
  inline void set_infiniteClipTimeOffset(double_t value);

  /// @brief Method set_matchTargetFields, addr 0x69a6d48, size 0x74, virtual false, abstract: false, final false
  inline void set_matchTargetFields(::UnityEngine::Timeline::MatchTargetFields value);

  /// @brief Method set_openClipOffsetEulerAngles, addr 0x69aac70, size 0xc, virtual false, abstract: false, final false
  inline void set_openClipOffsetEulerAngles(::UnityEngine::Vector3 value);

  /// @brief Method set_openClipOffsetPosition, addr 0x69aac24, size 0xc, virtual false, abstract: false, final false
  inline void set_openClipOffsetPosition(::UnityEngine::Vector3 value);

  /// @brief Method set_openClipOffsetRotation, addr 0x69aac60, size 0x4, virtual false, abstract: false, final false
  inline void set_openClipOffsetRotation(::UnityEngine::Quaternion value);

  /// @brief Method set_openClipPostExtrapolation, addr 0x69aac94, size 0x8, virtual false, abstract: false, final false
  inline void set_openClipPostExtrapolation(::UnityEngine::Timeline::TimelineClip_ClipExtrapolation value);

  /// @brief Method set_openClipPreExtrapolation, addr 0x69aac84, size 0x8, virtual false, abstract: false, final false
  inline void set_openClipPreExtrapolation(::UnityEngine::Timeline::TimelineClip_ClipExtrapolation value);

  /// @brief Method set_position, addr 0x69a6c94, size 0xc, virtual false, abstract: false, final false
  inline void set_position(::UnityEngine::Vector3 value);

  /// @brief Method set_rotation, addr 0x69a6cd0, size 0x3c, virtual false, abstract: false, final false
  inline void set_rotation(::UnityEngine::Quaternion value);

  /// @brief Method set_trackOffset, addr 0x69a6d38, size 0x8, virtual false, abstract: false, final false
