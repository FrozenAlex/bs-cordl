...
DEFINE_IL2CPP_CLASS(::UnityEngine::Timeline::AppliedOffsetMode, "UnityEngine.Timeline", "AppliedOffsetMode");
// Dependencies
namespace UnityEngine::Timeline {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Timeline::AppliedOffsetMode) == 0x4, "Size mismatch!");
