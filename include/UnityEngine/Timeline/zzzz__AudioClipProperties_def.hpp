...
// Write type traits
MARK_REF_T(::UnityEngine::Timeline::AudioClipProperties*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Timeline::AudioClipProperties*, "UnityEngine.Timeline", "AudioClipProperties");
...
public:
  ...
  /// @brief Method .ctor, addr 0x69b79bc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::Timeline::AudioClipProperties) == 0x18, "Size mismatch!");
