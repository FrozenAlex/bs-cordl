...
public:
  // Declarations
  /// @brief Method CombineHash, addr 0x69c5d74, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t CombineHash(int32_t h1, int32_t h2);

  /// @brief Method CombineHash, addr 0x69c5d90, size 0x2c, virtual false, abstract: false, final false
  static inline int32_t CombineHash(int32_t h1, int32_t h2, int32_t h3);

  /// @brief Method CombineHash, addr 0x69c5dbc, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t CombineHash(int32_t h1, int32_t h2, int32_t h3, int32_t h4);

  /// @brief Method CombineHash, addr 0x69c5df8, size 0x4c, virtual false, abstract: false, final false
  static inline int32_t CombineHash(int32_t h1, int32_t h2, int32_t h3, int32_t h4, int32_t h5);

  /// @brief Method CombineHash, addr 0x69c5e44, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t CombineHash(int32_t h1, int32_t h2, int32_t h3, int32_t h4, int32_t h5, int32_t h6);

  /// @brief Method CombineHash, addr 0x69c5ea0, size 0x2c, virtual false, abstract: false, final false
  static inline int32_t CombineHash(int32_t h1, int32_t h2, int32_t h3, int32_t h4, int32_t h5, int32_t h6, int32_t h7);

  /// @brief Method CombineHash, addr 0x69c5ecc, size 0x6c, virtual false, abstract: false, final false
