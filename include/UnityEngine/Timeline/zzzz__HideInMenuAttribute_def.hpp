...
// Write type traits
MARK_REF_T(::UnityEngine::Timeline::HideInMenuAttribute*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Timeline::HideInMenuAttribute*, "UnityEngine.Timeline", "HideInMenuAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6887158, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::Timeline::HideInMenuAttribute) == 0x10, "Size mismatch!");
