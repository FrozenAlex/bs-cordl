...
// Write type traits
MARK_REF_T(::UnityEngine::Timeline::InfiniteRuntimeClip*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Timeline::InfiniteRuntimeClip*, "UnityEngine.Timeline", "InfiniteRuntimeClip");
...
public:
  ...
  /// @brief Method DisableAt, addr 0x6880fb0, size 0x70, virtual true, abstract: false, final false
  inline void DisableAt(double_t localTime, double_t rootDuration, ::UnityEngine::Playables::FrameData frameData);

  /// @brief Method EvaluateAt, addr 0x6880f54, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x686d6f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Playables::Playable playable);

  static inline int64_t getStaticF_kIntervalEnd();

  /// @brief Method get_intervalEnd, addr 0x6880e70, size 0x5c, virtual true, abstract: false, final false
  inline int64_t get_intervalEnd();

  /// @brief Method get_intervalStart, addr 0x6880e68, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_intervalStart();

  static inline void setStaticF_kIntervalEnd(int64_t value);

  /// @brief Method set_enable, addr 0x6880ecc, size 0x88, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Timeline::InfiniteRuntimeClip) == 0x28, "Size mismatch!");
