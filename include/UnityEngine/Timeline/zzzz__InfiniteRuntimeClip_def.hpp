...
public:
  ...
  /// @brief Method DisableAt, addr 0x69bd830, size 0x70, virtual true, abstract: false, final false
  inline void DisableAt(double_t localTime, double_t rootDuration, ::UnityEngine::Playables::FrameData frameData);

  /// @brief Method EvaluateAt, addr 0x69bd7d4, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69a9f74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Playables::Playable playable);

  static inline int64_t getStaticF_kIntervalEnd();

  /// @brief Method get_intervalEnd, addr 0x69bd6f0, size 0x5c, virtual true, abstract: false, final false
  inline int64_t get_intervalEnd();

  /// @brief Method get_intervalStart, addr 0x69bd6e8, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_intervalStart();

  static inline void setStaticF_kIntervalEnd(int64_t value);

  /// @brief Method set_enable, addr 0x69bd74c, size 0x88, virtual true, abstract: false, final false
