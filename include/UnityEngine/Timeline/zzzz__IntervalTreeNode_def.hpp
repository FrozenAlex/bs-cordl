...
DEFINE_IL2CPP_CLASS(::UnityEngine::Timeline::IntervalTreeNode, "UnityEngine.Timeline", "IntervalTreeNode");
// Dependencies
namespace UnityEngine::Timeline {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Timeline::IntervalTreeNode) == 0x18, "Size mismatch!");
