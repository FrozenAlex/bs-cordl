...
// Write type traits
MARK_REF_T(::UnityEngine::Timeline::MenuCategoryAttribute*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Timeline::MenuCategoryAttribute*, "UnityEngine.Timeline", "MenuCategoryAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x69c39e4, size 0x28, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Timeline::MenuCategoryAttribute) == 0x18, "Size mismatch!");
