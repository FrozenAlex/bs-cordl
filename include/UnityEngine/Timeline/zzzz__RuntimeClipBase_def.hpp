...
// Write type traits
MARK_REF_T(::UnityEngine::Timeline::RuntimeClipBase*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Timeline::RuntimeClipBase*, "UnityEngine.Timeline", "RuntimeClipBase");
...
static_assert(sizeof(::UnityEngine::Timeline::RuntimeClipBase) == 0x18, "Size mismatch!");
