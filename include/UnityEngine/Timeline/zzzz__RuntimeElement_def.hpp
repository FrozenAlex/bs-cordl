...
public:
  ...
  /// @brief Method .ctor, addr 0x6880e64, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_intervalBit, addr 0x688181c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_intervalBit, addr 0x6881824, size 0x8, virtual false, abstract: false, final false
