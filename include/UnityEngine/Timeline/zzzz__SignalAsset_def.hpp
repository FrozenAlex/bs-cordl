...
public:
  ...
  /// @brief Method OnEnable, addr 0x68826e8, size 0x70, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method .ctor, addr 0x6882758, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_OnEnableCallback, addr 0x6882528, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_OnEnableCallback, addr 0x6882608, size 0xe0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Timeline::SignalAsset) == 0x18, "Size mismatch!");
