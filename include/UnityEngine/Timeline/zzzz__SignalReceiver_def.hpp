...
public:
  ...
  /// @brief Method Append, addr 0x69bf404, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x69bfb0c, size 0xa8, virtual false, abstract: false, final false
  inline void Remove(int32_t idx);

  /// @brief Method Remove, addr 0x69bf670, size 0xf0, virtual false, abstract: false, final false
  inline void Remove(::UnityEngine::Timeline::SignalAsset* key);

  /// @brief Method TryGetValue, addr 0x69bf1f0, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69bfe74, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_events, addr 0x69bff38, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::Events::UnityEvent*>* get_events();

  /// @brief Method get_signals, addr 0x69bff30, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddEmptyReaction, addr 0x69bf52c, size 0x7c, virtual false, abstract: false, final false
  inline int32_t AddEmptyReaction(::UnityEngine::Events::UnityEvent* reaction);

  /// @brief Method AddReaction, addr 0x69bf2c4, size 0x140, virtual false, abstract: false, final false
  inline void AddReaction(::UnityEngine::Timeline::SignalAsset* asset, ::UnityEngine::Events::UnityEvent* reaction);

  /// @brief Method ChangeReactionAtIndex, addr 0x69bfbb4, size 0xd0, virtual false, abstract: false, final false
  inline void ChangeReactionAtIndex(int32_t idx, ::UnityEngine::Events::UnityEvent* reaction);

  /// @brief Method ChangeSignalAtIndex, addr 0x69bf7fc, size 0x264, virtual false, abstract: false, final false
  inline void ChangeSignalAtIndex(int32_t idx, ::UnityEngine::Timeline::SignalAsset* newKey);

  /// @brief Method Count, addr 0x69bf7a4, size 0x58, virtual false, abstract: false, final false
  inline int32_t Count();

  /// @brief Method GetReaction, addr 0x69bf778, size 0x2c, virtual false, abstract: false, final false
  inline ::UnityEngine::Events::UnityEvent* GetReaction(::UnityEngine::Timeline::SignalAsset* key);

  /// @brief Method GetReactionAtIndex, addr 0x69bfc84, size 0xc8, virtual false, abstract: false, final false
  inline ::UnityEngine::Events::UnityEvent* GetReactionAtIndex(int32_t idx);

  /// @brief Method GetRegisteredSignals, addr 0x69bf760, size 0x18, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::Timeline::SignalAsset>>* GetRegisteredSignals();

  /// @brief Method GetSignalAssetAtIndex, addr 0x69bfd4c, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x69bfe14, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnNotify, addr 0x69bf0c4, size 0x12c, virtual true, abstract: false, final true
  ...
  /// @brief Method Remove, addr 0x69bf5a8, size 0xc8, virtual false, abstract: false, final false
  inline void Remove(::UnityEngine::Timeline::SignalAsset* asset);

  /// @brief Method RemoveAtIndex, addr 0x69bfa60, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69bfe18, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
