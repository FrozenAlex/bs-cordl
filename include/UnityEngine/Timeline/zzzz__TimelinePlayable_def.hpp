...
public:
  ...
  /// @brief Method CacheTrack, addr 0x68886a8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Compile, addr 0x68873b0, size 0x2c0, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileTrackList, addr 0x6887670, size 0x378, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x688718c, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTrackOutput, addr 0x6887e00, size 0x6c8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTrackPlayable, addr 0x68879e8, size 0x418, virtual false, abstract: false, final false
  ...
  /// @brief Method Evaluate, addr 0x6888760, size 0x520, virtual false, abstract: false, final false
  inline void Evaluate(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData frameData);

  /// @brief Method EvaluateAnimationPreviewUpdateCallback, addr 0x68885b8, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method EvaluateWeightsForAnimationPlayableOutput, addr 0x68884c8, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ForAOTCompilationOnly, addr 0x6888c80, size 0x64, virtual false, abstract: false, final false
  static inline void ForAOTCompilationOnly();

  static inline ::UnityEngine::Timeline::TimelinePlayable* New_ctor();

  /// @brief Method PrepareFrame, addr 0x6888734, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6888ce4, size 0x170, virtual false, abstract: false, final false
  inline void _ctor();
