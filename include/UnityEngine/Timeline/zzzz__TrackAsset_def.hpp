...
public:
  // Declarations
  /// @brief Method Clear, addr 0x69b4f04, size 0xf8, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Create, addr 0x69b741c, size 0x114, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <SortClips>b__121_0, addr 0x69b7588, size 0x74, virtual false, abstract: false, final false
  inline int32_t _SortClips_b__121_0(::UnityEngine::Timeline::TimelineClip* clip1, ::UnityEngine::Timeline::TimelineClip* clip2);

  /// @brief Method .ctor, addr 0x69b7584, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x69b7600, size 0x250, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::Timeline::TrackAsset__get_outputs_d__65* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.Playables.PlayableBinding>.GetEnumerator, addr 0x69b78fc, size 0x98, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.Playables.PlayableBinding>.get_Current, addr 0x69b7850, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x69b7994, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x69b7860, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x69b7898, size 0x64, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x69b75fc, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x69b1fc0, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddChild, addr 0x69b064c, size 0x104, virtual false, abstract: false, final false
  inline void AddChild(::UnityEngine::Timeline::TrackAsset* child);

  /// @brief Method AddClip, addr 0x69abb9c, size 0xe0, virtual false, abstract: false, final false
  inline void AddClip(::UnityEngine::Timeline::TimelineClip* newClip);

  /// @brief Method AddMarker, addr 0x69b3e18, size 0x8, virtual false, abstract: false, final false
  inline void AddMarker(::UnityEngine::ScriptableObject* e);

  /// @brief Method CalculateItemsHash, addr 0x69a7be8, size 0xa8, virtual true, abstract: false, final false
  inline int32_t CalculateItemsHash();

  /// @brief Method CanCompileClips, addr 0x69a4b48, size 0x64, virtual true, abstract: false, final false
  inline bool CanCompileClips();

  /// @brief Method CanCompileNotifications, addr 0x69b593c, size 0x34, virtual false, abstract: false, final false
  inline bool CanCompileNotifications();

  /// @brief Method CanCreateMixerRecursive, addr 0x69b4c10, size 0x2f4, virtual false, abstract: false, final false
  inline bool CanCreateMixerRecursive();

  /// @brief Method CanCreateTrackMixer, addr 0x69b6e54, size 0x10, virtual true, abstract: false, final false
  inline bool CanCreateTrackMixer();

  /// @brief Method ClearClipsInternal, addr 0x69b609c, size 0x78, virtual false, abstract: false, final false
  inline void ClearClipsInternal();

  /// @brief Method ClearMarkers, addr 0x69b3d98, size 0x8, virtual false, abstract: false, final false
  inline void ClearMarkers();

  /// @brief Method ClearSubTracksInternal, addr 0x69b6114, size 0x78, virtual false, abstract: false, final false
  inline void ClearSubTracksInternal();

  /// @brief Method CompileClips, addr 0x69b4ffc, size 0x434, virtual true, abstract: false, final false
  ...
  /// @brief Method ConfigureTrackAnimation, addr 0x69b5430, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateAndAddNewClipOfType, addr 0x69b2a0c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateClip, addr 0x69b3138, size 0x110, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateClip(::System::Type* requestedType);

  /// @brief Method CreateClipFromAsset, addr 0x69b3690, size 0x280, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateClipFromAsset(::UnityEngine::ScriptableObject* playableAsset);

  /// @brief Method CreateClipFromPlayableAsset, addr 0x69b3910, size 0x260, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateClipFromPlayableAsset(::UnityEngine::Playables::IPlayableAsset* asset);

  /// @brief Method CreateClipOfType, addr 0x69b34c0, size 0x1d0, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateClipOfType(::System::Type* requestedType);

  /// @brief Method CreateCurves, addr 0x69b25c4, size 0xb8, virtual true, abstract: false, final true
  inline void CreateCurves(::StringW curvesClipName);

  /// @brief Method CreateDefaultClip, addr 0x69b2744, size 0x2c8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateDefaultClip();

  /// @brief Method CreateMarker, addr 0x69b2b60, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateMixerPlayableGraph, addr 0x69b5970, size 0x5fc, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateNewClipContainerInternal, addr 0x69b3b70, size 0x220, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateNewClipContainerInternal();

  /// @brief Method CreateNotificationsPlayable, addr 0x69b42b0, size 0x320, virtual false, abstract: false, final false
  ...
  /// @brief Method CreatePlayable, addr 0x69b6b84, size 0x2d0, virtual true, abstract: false, final false
  ...
  /// @brief Method CreatePlayable, addr 0x69b26f0, size 0x54, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::Playable CreatePlayable(::UnityEngine::Playables::PlayableGraph graph, ::UnityEngine::GameObject* go);

  /// @brief Method CreatePlayableGraph, addr 0x69b493c, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTrackMixer, addr 0x69b267c, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method DeleteClip, addr 0x69b2a3c, size 0x124, virtual false, abstract: false, final false
  inline bool DeleteClip(::UnityEngine::Timeline::TimelineClip* clip);

  /// @brief Method DeleteMarker, addr 0x69b2e64, size 0x8, virtual false, abstract: false, final false
  inline bool DeleteMarker(::UnityEngine::Timeline::IMarker* marker);

  /// @brief Method DeleteMarkerRaw, addr 0x69b3f10, size 0x30, virtual false, abstract: false, final false
  inline bool DeleteMarkerRaw(::UnityEngine::ScriptableObject* marker);

  /// @brief Method GatherCompilableTracks, addr 0x69b558c, size 0x3b0, virtual false, abstract: false, final false
  inline void GatherCompilableTracks(::System::Collections::Generic::IList_1<::UnityW<::UnityEngine::Timeline::TrackAsset>>* tracks);

  /// @brief Method GatherNotifications, addr 0x69b45d0, size 0x36c, virtual false, abstract: false, final false
  inline void GatherNotifications(::System::Collections::Generic::List_1<::UnityEngine::Timeline::IMarker*>* markers);

  /// @brief Method GatherProperties, addr 0x69b63b4, size 0x6ac, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAnimationClipHash, addr 0x69a7ae8, size 0x100, virtual false, abstract: false, final false
  static inline int32_t GetAnimationClipHash(::UnityEngine::AnimationClip* clip);

  /// @brief Method GetChildTracks, addr 0x69a9488, size 0x18, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::Timeline::TrackAsset>>* GetChildTracks();

  /// @brief Method GetClips, addr 0x69aac14, size 0x4, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Timeline::TimelineClip*>* GetClips();

  /// @brief Method GetClipsHash, addr 0x69b6a60, size 0x124, virtual false, abstract: false, final false
  inline int32_t GetClipsHash();

  /// @brief Method GetEvaluationTime, addr 0x69aa01c, size 0x228, virtual true, abstract: false, final false
  inline void GetEvaluationTime(::by_ref<double_t> outStart, ::by_ref<double_t> outDuration);

  /// @brief Method GetGameObjectBinding, addr 0x69a4dfc, size 0x184, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> GetGameObjectBinding(::UnityEngine::Playables::PlayableDirector* director);

  /// @brief Method GetMarker, addr 0x69b30c4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::IMarker* GetMarker(int32_t idx);

  /// @brief Method GetMarkerCount, addr 0x69b1f48, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetMarkerCount();

  /// @brief Method GetMarkers, addr 0x69b1804, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Timeline::IMarker*>* GetMarkers();

  /// @brief Method GetMarkersRaw, addr 0x69b3d90, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::ScriptableObject>>* GetMarkersRaw();

  /// @brief Method GetNotificationDuration, addr 0x69aa360, size 0x178, virtual false, abstract: false, final false
  inline double_t GetNotificationDuration();

  /// @brief Method GetSequenceTime, addr 0x69aa350, size 0x10, virtual true, abstract: false, final false
  inline void GetSequenceTime(::by_ref<double_t> outStart, ::by_ref<double_t> outDuration);

  /// @brief Method GetTimeRangeHash, addr 0x69b400c, size 0x2a4, virtual false, abstract: false, final false
  inline int32_t GetTimeRangeHash();

  /// @brief Method HasNotifications, addr 0x69b6398, size 0x1c, virtual false, abstract: false, final false
  inline bool HasNotifications();

  /// @brief Method Hash, addr 0x69b71e4, size 0x38, virtual true, abstract: false, final false
  inline int32_t Hash();

  /// @brief Method Invalidate, addr 0x69b1774, size 0x8c, virtual false, abstract: false, final false
  inline void Invalidate();

  /// @brief Method IsCompilable, addr 0x69b6e64, size 0x380, virtual false, abstract: false, final false
  inline bool IsCompilable();

  /// @brief Method MoveLastTrackBefore, addr 0x69b618c, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnAfterTrackDeserialize, addr 0x69b1274, size 0x4, virtual true, abstract: false, final false
  inline void OnAfterTrackDeserialize();

  /// @brief Method OnBeforeTrackSerialize, addr 0x69b1270, size 0x4, virtual true, abstract: false, final false
  inline void OnBeforeTrackSerialize();

  /// @brief Method OnClipMove, addr 0x69ab7ec, size 0x8, virtual false, abstract: false, final false
  inline void OnClipMove();

  /// @brief Method OnCreateClip, addr 0x69a4fd4, size 0x4, virtual true, abstract: false, final false
  inline void OnCreateClip(::UnityEngine::Timeline::TimelineClip* clip);

  /// @brief Method OnUpgradeFromVersion, addr 0x69b1278, size 0x4, virtual true, abstract: false, final false
  inline void OnUpgradeFromVersion(int32_t oldVersion);

  /// @brief Method RemoveClip, addr 0x69abb30, size 0x6c, virtual false, abstract: false, final false
  inline void RemoveClip(::UnityEngine::Timeline::TimelineClip* clip);

  /// @brief Method RemoveSubTrack, addr 0x69ae844, size 0x84, virtual false, abstract: false, final false
  inline bool RemoveSubTrack(::UnityEngine::Timeline::TrackAsset* child);

  /// @brief Method SortClips, addr 0x69b5f6c, size 0x130, virtual false, abstract: false, final false
  inline void SortClips();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x69b13f0, size 0x384, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x69b127c, size 0x174, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnBeforeSerialize();

  /// @brief Method UnityEngine.Timeline.ICurvesOwner.get_asset, addr 0x69b2268, size 0x4, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Object> UnityEngine_Timeline_ICurvesOwner_get_asset();

  /// @brief Method UnityEngine.Timeline.ICurvesOwner.get_assetOwner, addr 0x69b226c, size 0x4, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Object> UnityEngine_Timeline_ICurvesOwner_get_assetOwner();

  /// @brief Method UnityEngine.Timeline.ICurvesOwner.get_defaultCurvesName, addr 0x69b2224, size 0x44, virtual true, abstract: false, final true
  inline ::StringW UnityEngine_Timeline_ICurvesOwner_get_defaultCurvesName();

  /// @brief Method UnityEngine.Timeline.ICurvesOwner.get_targetTrack, addr 0x69b2270, size 0x4, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Timeline::TrackAsset> UnityEngine_Timeline_ICurvesOwner_get_targetTrack();

  /// @brief Method UpdateChildTrackCache, addr 0x69b1fe0, size 0x224, virtual false, abstract: false, final false
  inline void UpdateChildTrackCache();

  /// @brief Method UpdateDuration, addr 0x69b1ca4, size 0x114, virtual false, abstract: false, final false
  inline void UpdateDuration();

  /// @brief Method UpgradeToLatestVersion, addr 0x69b1800, size 0x4, virtual false, abstract: false, final false
  inline void UpgradeToLatestVersion();

  /// @brief Method ValidateClipType, addr 0x69b3248, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method __internalAwake, addr 0x69b24f4, size 0xd0, virtual false, abstract: false, final false
  inline void __internalAwake();

  /// @brief Method .ctor, addr 0x69a5038, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_OnClipPlayableCreate, addr 0x69b1820, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method add_OnTrackAnimationPlayableCreate, addr 0x69b1a30, size 0x108, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method get_clips, addr 0x69a6f88, size 0xb8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Timeline::TimelineClip*> get_clips();

  /// @brief Method get_curves, addr 0x69b2214, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::AnimationClip> get_curves();

  /// @brief Method get_customPlayableTypename, addr 0x69b2204, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_customPlayableTypename();

  /// @brief Method get_duration, addr 0x69b1db8, size 0x64, virtual true, abstract: false, final true
  inline double_t get_duration();

  /// @brief Method get_end, addr 0x69af33c, size 0x64, virtual false, abstract: false, final false
  inline double_t get_end();

  /// @brief Method get_hasClips, addr 0x69a4aec, size 0x5c, virtual false, abstract: false, final false
  inline bool get_hasClips();

  /// @brief Method get_hasCurves, addr 0x69b1eb8, size 0x90, virtual true, abstract: false, final true
  inline bool get_hasCurves();

  /// @brief Method get_isEmpty, addr 0x69b1e44, size 0x74, virtual true, abstract: false, final false
  inline bool get_isEmpty();

  /// @brief Method get_isSubTrack, addr 0x69a78f0, size 0x10c, virtual false, abstract: false, final false
  inline bool get_isSubTrack();

  /// @brief Method get_locked, addr 0x69b227c, size 0x8, virtual false, abstract: false, final false
  inline bool get_locked();

  /// @brief Method get_lockedInHierarchy, addr 0x69b228c, size 0x1c0, virtual false, abstract: false, final false
  inline bool get_lockedInHierarchy();

  /// @brief Method get_muted, addr 0x69b1e24, size 0x8, virtual false, abstract: false, final false
  inline bool get_muted();

  /// @brief Method get_mutedInHierarchy, addr 0x69aef44, size 0x1c0, virtual false, abstract: false, final false
  inline bool get_mutedInHierarchy();

  /// @brief Method get_outputs, addr 0x69b1f50, size 0x70, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Playables::PlayableBinding>* get_outputs();

  /// @brief Method get_parent, addr 0x69b1e34, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Playables::PlayableAsset> get_parent();

  /// @brief Method get_start, addr 0x69b1c40, size 0x64, virtual false, abstract: false, final false
  inline double_t get_start();

  /// @brief Method get_subTracksObjects, addr 0x69b2274, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::ScriptableObject>>* get_subTracksObjects();

  /// @brief Method get_supportsNotifications, addr 0x69b244c, size 0xa8, virtual false, abstract: false, final false
  inline bool get_supportsNotifications();

  /// @brief Method get_timelineAsset, addr 0x69af6f4, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_OnClipPlayableCreate, addr 0x69b1928, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_OnTrackAnimationPlayableCreate, addr 0x69b1b38, size 0x108, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method set_curves, addr 0x69b221c, size 0x8, virtual false, abstract: false, final false
  inline void set_curves(::UnityEngine::AnimationClip* value);

  /// @brief Method set_customPlayableTypename, addr 0x69b220c, size 0x8, virtual false, abstract: false, final false
  inline void set_customPlayableTypename(::StringW value);

  /// @brief Method set_locked, addr 0x69b2284, size 0x8, virtual false, abstract: false, final false
  inline void set_locked(bool value);

  /// @brief Method set_muted, addr 0x69b1e2c, size 0x8, virtual false, abstract: false, final false
  inline void set_muted(bool value);

  /// @brief Method set_parent, addr 0x69b1e3c, size 0x8, virtual false, abstract: false, final false
