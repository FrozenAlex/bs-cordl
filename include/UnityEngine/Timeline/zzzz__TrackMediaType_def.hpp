...
public:
  ...
  /// @brief Method .ctor, addr 0x69c396c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Timeline::TrackMediaType) == 0x18, "Size mismatch!");
