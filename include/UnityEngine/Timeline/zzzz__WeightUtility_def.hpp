...
// Write type traits
MARK_REF_T(::UnityEngine::Timeline::WeightUtility*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Timeline::WeightUtility*, "UnityEngine.Timeline", "WeightUtility");
...
public:
  // Declarations
  /// @brief Method NormalizeMixer, addr 0x69c9820, size 0x198, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Timeline::WeightUtility) == 0x10, "Size mismatch!");
