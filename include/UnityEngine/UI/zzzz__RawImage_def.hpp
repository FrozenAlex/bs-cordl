...
public:
  ...
  /// @brief Method OnDidApplyAnimationProperties, addr 0x6dfb1c0, size 0x3c, virtual true, abstract: false, final false
  inline void OnDidApplyAnimationProperties();

  /// @brief Method OnPopulateMesh, addr 0x6dfaae8, size 0x2cc, virtual true, abstract: false, final false
  inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper* vh);

  /// @brief Method SetNativeSize, addr 0x6dfa828, size 0x2c0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6dfa590, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mainTexture, addr 0x6dfa5b8, size 0x160, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture> get_mainTexture();

  /// @brief Method get_texture, addr 0x6dfa718, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture> get_texture();

  /// @brief Method get_uvRect, addr 0x6dfa7d0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_uvRect();

  /// @brief Method set_texture, addr 0x6dfa720, size 0xb0, virtual false, abstract: false, final false
  inline void set_texture(::UnityEngine::Texture* value);

  /// @brief Method set_uvRect, addr 0x6dfa7dc, size 0x4c, virtual false, abstract: false, final false
