...
public:
  ...
  /// @brief Method .ctor, addr 0x6dfc900, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x6dfe308, size 0x110, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::UI::Scrollbar__ClickRepeat_d__59* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x6dfe418, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x6dfe420, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x6dfe458, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x6dfe304, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6dfda38, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ClickRepeat, addr 0x6dfd9f8, size 0x40, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* ClickRepeat(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method ClickRepeat, addr 0x6dfd980, size 0x78, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* ClickRepeat(::UnityEngine::Vector2 screenPosition, ::UnityEngine::Camera* camera);

  /// @brief Method DoUpdateDrag, addr 0x6dfd494, size 0x70, virtual false, abstract: false, final false
  inline void DoUpdateDrag(::UnityEngine::Vector2 handleCorner, float_t remainingSize);

  /// @brief Method FindSelectableOnDown, addr 0x6dfe064, size 0x24, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnDown();

  /// @brief Method FindSelectableOnLeft, addr 0x6dfdd64, size 0x24, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnLeft();

  /// @brief Method FindSelectableOnRight, addr 0x6dfde64, size 0x24, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnRight();

  /// @brief Method FindSelectableOnUp, addr 0x6dfdf64, size 0x24, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnUp();

  /// @brief Method GraphicUpdateComplete, addr 0x6dfcd58, size 0x4, virtual true, abstract: false, final false
  inline void GraphicUpdateComplete();

  /// @brief Method LayoutComplete, addr 0x6dfcd54, size 0x4, virtual true, abstract: false, final false
  inline void LayoutComplete();

  /// @brief Method MayDrag, addr 0x6dfd504, size 0x64, virtual false, abstract: false, final false
  inline bool MayDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  static inline ::UnityEngine::UI::Scrollbar* New_ctor();

  /// @brief Method OnBeginDrag, addr 0x6dfd568, size 0x1c0, virtual true, abstract: false, final false
  inline void OnBeginDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnDisable, addr 0x6dfd048, size 0x4, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnDrag, addr 0x6dfd728, size 0xa0, virtual true, abstract: false, final false
  inline void OnDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnEnable, addr 0x6dfcd5c, size 0x30, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnInitializePotentialDrag, addr 0x6dfe164, size 0x14, virtual true, abstract: false, final false
  inline void OnInitializePotentialDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnMove, addr 0x6dfda78, size 0x254, virtual true, abstract: false, final false
  inline void OnMove(::UnityEngine::EventSystems::AxisEventData* eventData);

  /// @brief Method OnPointerDown, addr 0x6dfd7c8, size 0x80, virtual true, abstract: false, final false
  inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerUp, addr 0x6dfda40, size 0x18, virtual true, abstract: false, final false
  inline void OnPointerUp(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnRectTransformDimensionsChange, addr 0x6dfd17c, size 0x2c, virtual true, abstract: false, final false
  inline void OnRectTransformDimensionsChange();

  /// @brief Method Rebuild, addr 0x6dfcd50, size 0x4, virtual true, abstract: false, final false
  inline void Rebuild(::UnityEngine::UI::CanvasUpdate executing);

  /// @brief Method Set, addr 0x6dfcb10, size 0xd8, virtual false, abstract: false, final false
  inline void Set(float_t input, bool sendCallback);

  /// @brief Method SetDirection, addr 0x6dfe178, size 0x184, virtual false, abstract: false, final false
  inline void SetDirection(::UnityEngine::UI::Scrollbar_Direction direction, bool includeRectLayouts);

  /// @brief Method SetValueWithoutNotify, addr 0x6dfcbe8, size 0x8, virtual true, abstract: false, final false
  inline void SetValueWithoutNotify(float_t input);

  /// @brief Method UnityEngine.UI.ICanvasElement.get_transform, addr 0x6dfe2fc, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Transform> UnityEngine_UI_ICanvasElement_get_transform();

  /// @brief Method Update, addr 0x6dfd168, size 0x14, virtual true, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateCachedReferences, addr 0x6dfc514, size 0xe8, virtual false, abstract: false, final false
  inline void UpdateCachedReferences();

  /// @brief Method UpdateDrag, addr 0x6dfd2e8, size 0x1ac, virtual false, abstract: false, final false
  inline void UpdateDrag(::UnityEngine::RectTransform* containerRect, ::UnityEngine::Vector2 position, ::UnityEngine::Camera* camera);

  /// @brief Method UpdateDrag, addr 0x6dfd1cc, size 0x11c, virtual false, abstract: false, final false
  inline void UpdateDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method UpdateVisuals, addr 0x6dfc5fc, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6dfc834, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_axis, addr 0x6dfd1a8, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::Scrollbar_Axis get_axis();

  /// @brief Method get_direction, addr 0x6dfc7b4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::Scrollbar_Direction get_direction();

  /// @brief Method get_handleRect, addr 0x6dfc47c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_handleRect();

  /// @brief Method get_numberOfSteps, addr 0x6dfcc84, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_numberOfSteps();

  /// @brief Method get_onValueChanged, addr 0x6dfcd14, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::Scrollbar_ScrollEvent* get_onValueChanged();

  /// @brief Method get_reverseValue, addr 0x6dfd1b8, size 0x14, virtual false, abstract: false, final false
  inline bool get_reverseValue();

  /// @brief Method get_size, addr 0x6dfcbf0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_size();

  /// @brief Method get_stepSize, addr 0x6dfcd24, size 0x2c, virtual false, abstract: false, final false
  inline float_t get_stepSize();

  /// @brief Method get_value, addr 0x6dfca60, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_direction, addr 0x6dfc7bc, size 0x78, virtual false, abstract: false, final false
  inline void set_direction(::UnityEngine::UI::Scrollbar_Direction value);

  /// @brief Method set_handleRect, addr 0x6dfc484, size 0x90, virtual false, abstract: false, final false
  inline void set_handleRect(::UnityEngine::RectTransform* value);

  /// @brief Method set_numberOfSteps, addr 0x6dfcc8c, size 0x88, virtual false, abstract: false, final false
  inline void set_numberOfSteps(int32_t value);

  /// @brief Method set_onValueChanged, addr 0x6dfcd1c, size 0x8, virtual false, abstract: false, final false
  inline void set_onValueChanged(::UnityEngine::UI::Scrollbar_ScrollEvent* value);

  /// @brief Method set_size, addr 0x6dfcbf8, size 0x8c, virtual false, abstract: false, final false
  inline void set_size(float_t value);

  /// @brief Method set_value, addr 0x6dfcb08, size 0x8, virtual false, abstract: false, final false
