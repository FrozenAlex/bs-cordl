...
public:
  ...
  /// @brief Method Dispose, addr 0x6bc76c0, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x6bc76bc, size 0x4, virtual false, abstract: false, final false
