...
public:
  ...
  /// @brief Method Apply, addr 0x6d21200, size 0x338, virtual false, abstract: false, final false
  ...
  /// @brief Method Save, addr 0x6d21538, size 0x684, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d22280, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6d1f11c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_control, addr 0x6d2233c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Internal::MultiColumnHeaderColumn* get_control();

  /// @brief Method get_resizeHandle, addr 0x6d2234c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizeHandle* get_resizeHandle();

  /// @brief Method set_control, addr 0x6d22344, size 0x8, virtual false, abstract: false, final false
  inline void set_control(::UnityEngine::UIElements::Internal::MultiColumnHeaderColumn* value);

  /// @brief Method set_resizeHandle, addr 0x6d22354, size 0x8, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6d1e16c, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <OnContextualMenuManipulator>b__1, addr 0x6d2235c, size 0x24, virtual false, abstract: false, final false
  inline void _OnContextualMenuManipulator_b__1(::UnityEngine::UIElements::DropdownMenuAction* a);

  /// @brief Method <OnContextualMenuManipulator>b__2, addr 0x6d22380, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d2062c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <UpdateSortColumnDescriptionsOnClick>b__0, addr 0x6d223f0, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d20f68, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ApplyColumnSorting, addr 0x6d1f400, size 0x850, virtual false, abstract: false, final false
  inline void ApplyColumnSorting();

  /// @brief Method CleanupColumnData, addr 0x6d1f1e8, size 0x1bc, virtual false, abstract: false, final false
  inline void CleanupColumnData(::UnityEngine::UIElements::Internal::MultiColumnCollectionHeader_ColumnData* data);

  /// @brief Method Dispose, addr 0x6d21d4c, size 0x41c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DoLayout, addr 0x6d207a4, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method OnColumnAdded, addr 0x6d1dcb8, size 0x350, virtual false, abstract: false, final false
  inline void OnColumnAdded(::UnityEngine::UIElements::Column* column);

  /// @brief Method OnColumnAdded, addr 0x6d1e948, size 0x4, virtual false, abstract: false, final false
  inline void OnColumnAdded(::UnityEngine::UIElements::Column* column, int32_t index);

  /// @brief Method OnColumnChanged, addr 0x6d1f3a4, size 0x5c, virtual false, abstract: false, final false
  inline void OnColumnChanged(::UnityEngine::UIElements::Column* column, ::UnityEngine::UIElements::ColumnDataType type);

  /// @brief Method OnColumnClicked, addr 0x6d20adc, size 0x224, virtual false, abstract: false, final false
  inline void OnColumnClicked(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method OnColumnControlGeometryChanged, addr 0x6d207e4, size 0x1f8, virtual false, abstract: false, final false
  inline void OnColumnControlGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent* evt);

  /// @brief Method OnColumnRemoved, addr 0x6d1f120, size 0xc8, virtual false, abstract: false, final false
  inline void OnColumnRemoved(::UnityEngine::UIElements::Column* column);

  /// @brief Method OnColumnReordered, addr 0x6d1fc50, size 0x18c, virtual false, abstract: false, final false
  inline void OnColumnReordered(::UnityEngine::UIElements::Column* column, int32_t from, int32_t to);

  /// @brief Method OnColumnResized, addr 0x6d1fddc, size 0x4, virtual false, abstract: false, final false
  inline void OnColumnResized(::UnityEngine::UIElements::Column* column);

  /// @brief Method OnContextualMenuManipulator, addr 0x6d1fde0, size 0x84c, virtual false, abstract: false, final false
  inline void OnContextualMenuManipulator(::UnityEngine::UIElements::ContextualMenuPopulateEvent* evt);

  /// @brief Method OnGeometryChanged, addr 0x6d20724, size 0x80, virtual false, abstract: false, final false
  inline void OnGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent* e);

  /// @brief Method OnMoveManipulatorActivated, addr 0x6d20630, size 0xf4, virtual false, abstract: false, final false
  inline void OnMoveManipulatorActivated(::UnityEngine::UIElements::Internal::ColumnMover* mover);

  /// @brief Method OnViewDataReady, addr 0x6d21114, size 0xec, virtual true, abstract: false, final false
  inline void OnViewDataReady();

  /// @brief Method RaiseColumnResized, addr 0x6d209dc, size 0x100, virtual false, abstract: false, final false
  inline void RaiseColumnResized(int32_t columnIndex);

  /// @brief Method RaiseColumnSortingChanged, addr 0x6d1e1ac, size 0x38, virtual false, abstract: false, final false
  inline void RaiseColumnSortingChanged();

  /// @brief Method ResizeToFit, addr 0x6d1e140, size 0x2c, virtual false, abstract: false, final false
  inline void ResizeToFit();

  /// @brief Method SaveViewState, addr 0x6d1e178, size 0x34, virtual false, abstract: false, final false
  inline void SaveViewState();

  /// @brief Method ScheduleDoLayout, addr 0x6d1e008, size 0x138, virtual false, abstract: false, final false
  inline void ScheduleDoLayout();

  /// @brief Method ScrollHorizontally, addr 0x6d20f6c, size 0x17c, virtual false, abstract: false, final false
  inline void ScrollHorizontally(float_t horizontalOffset);

  /// @brief Method UpdateColumnControls, addr 0x6d1e1e4, size 0x764, virtual false, abstract: false, final false
  inline void UpdateColumnControls();

  /// @brief Method UpdateSortColumnDescriptionsOnClick, addr 0x6d20d00, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateSortedColumns, addr 0x6d1c200, size 0x658, virtual false, abstract: false, final false
  inline void UpdateSortedColumns();

  /// @brief Method UpdateSortingStatus, addr 0x6d1c898, size 0x608, virtual false, abstract: false, final false
  inline void UpdateSortingStatus();

  /// @brief Method <OnContextualMenuManipulator>b__67_0, addr 0x6d2227c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d1d450, size 0x868, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::Columns* columns, ::UnityEngine::UIElements::SortColumnDescriptions* sortDescriptions,
                    ::System::Collections::Generic::List_1<::UnityEngine::UIElements::SortColumnDescription*>* sortedColumns);

  /// @brief Method add_columnResized, addr 0x6d1cea0, size 0xc0, virtual false, abstract: false, final false
  inline void add_columnResized(::System::Action_2<int32_t, float_t>* value);

  /// @brief Method add_columnSortingChanged, addr 0x6d1d020, size 0xac, virtual false, abstract: false, final false
  inline void add_columnSortingChanged(::System::Action* value);

  /// @brief Method add_contextMenuPopulateEvent, addr 0x6d1d178, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_viewDataRestored, addr 0x6d1d2f8, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_columnContainer, addr 0x6d1c134, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_columnContainer();

  /// @brief Method get_columnDataMap, addr 0x6d1c124, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_columnLayout, addr 0x6d1c12c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ColumnLayout* get_columnLayout();

  /// @brief Method get_columns, addr 0x6d1c858, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Columns* get_columns();

  /// @brief Method get_isApplyingViewState, addr 0x6d1c11c, size 0x8, virtual false, abstract: false, final false
  inline bool get_isApplyingViewState();

  /// @brief Method get_resizeHandleContainer, addr 0x6d1c13c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_resizeHandleContainer();

  /// @brief Method get_sortDescriptions, addr 0x6d1c154, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::SortColumnDescriptions* get_sortDescriptions();

  /// @brief Method get_sortedColumnReadonly, addr 0x6d1c14c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::UnityEngine::UIElements::SortColumnDescription*>* get_sortedColumnReadonly();

  /// @brief Method get_sortedColumns, addr 0x6d1c144, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::SortColumnDescription*>* get_sortedColumns();

  /// @brief Method get_sortingEnabled, addr 0x6d1c860, size 0x8, virtual false, abstract: false, final false
  inline bool get_sortingEnabled();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method remove_columnResized, addr 0x6d1cf60, size 0xc0, virtual false, abstract: false, final false
  inline void remove_columnResized(::System::Action_2<int32_t, float_t>* value);

  /// @brief Method remove_columnSortingChanged, addr 0x6d1d0cc, size 0xac, virtual false, abstract: false, final false
  inline void remove_columnSortingChanged(::System::Action* value);

  /// @brief Method remove_contextMenuPopulateEvent, addr 0x6d1d238, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_viewDataRestored, addr 0x6d1d3a4, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method set_sortDescriptions, addr 0x6d1c15c, size 0xa4, virtual false, abstract: false, final false
  inline void set_sortDescriptions(::UnityEngine::UIElements::SortColumnDescriptions* value);

  /// @brief Method set_sortingEnabled, addr 0x6d1c868, size 0x30, virtual false, abstract: false, final false
