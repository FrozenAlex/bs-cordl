...
public:
  ...
  /// @brief Method .ctor, addr 0x6d1f020, size 0xfc, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_dragArea, addr 0x6d23fe8, size 0x8, virtual false, abstract: false, final false
