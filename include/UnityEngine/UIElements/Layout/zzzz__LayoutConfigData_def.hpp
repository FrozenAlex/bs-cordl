...
public:
  // Declarations
  /// @brief Method get_Default, addr 0x6cf749c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::Layout::LayoutConfigData) == 0x8, "Size mismatch!");
