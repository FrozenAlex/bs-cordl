...
public:
  ...
  /// @brief Method UnityEngine.UIElements.Layout.ILayoutProcessor.CalculateLayout, addr 0x6cfc440, size 0x130, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6cfa9c4, size 0x34, virtual false, abstract: false, final false
  inline void _ctor();
