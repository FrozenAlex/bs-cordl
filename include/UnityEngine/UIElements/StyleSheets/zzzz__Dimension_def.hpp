...
public:
  ...
  /// @brief Method Equals, addr 0x6d0a8e4, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6d0a8c4, size 0x20, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::StyleSheets::Dimension other);

  /// @brief Method GetHashCode, addr 0x6d0a970, size 0x30, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToAngle, addr 0x6d0a878, size 0x2c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Angle ToAngle();

  /// @brief Method ToLength, addr 0x6d0a830, size 0x34, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Length ToLength();

  /// @brief Method ToString, addr 0x6d0a9a0, size 0x15c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToTime, addr 0x6d0a864, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TimeValue ToTime();

  /// @brief Method .ctor, addr 0x6d0a824, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x6d0a8a4, size 0x20, virtual false, abstract: false, final false
