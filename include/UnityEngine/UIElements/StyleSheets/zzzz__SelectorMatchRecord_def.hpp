...
public:
  // Declarations
  /// @brief Method Compare, addr 0x6d0f264, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d0f250, size 0x14, virtual false, abstract: false, final false
