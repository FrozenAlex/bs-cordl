...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6bbf974, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bbf82c, size 0x148, virtual false, abstract: false, final false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_m_PropertyIds, put = __cordl_internal_set_m_PropertyIds)) ::ArrayW<::UnityEngine::UIElements::StyleSheets::StylePropertyId> m_PropertyIds;
  ...
  /// @brief Method GetValue, addr 0x6bbbc40, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleSheets::StylePropertyValue GetValue(int32_t index);

  /// @brief Method GetValueType, addr 0x6bbbca8, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleValueType GetValueType(int32_t index);

  /// @brief Method IsKeyword, addr 0x6bbbd90, size 0x80, virtual false, abstract: false, final false
  inline bool IsKeyword(int32_t index, ::UnityEngine::UIElements::StyleValueKeyword keyword);

  /// @brief Method IsValueType, addr 0x6bbbd18, size 0x78, virtual false, abstract: false, final false
  inline bool IsValueType(int32_t index, ::UnityEngine::UIElements::StyleValueType type);

  /// @brief Method LoadProperties, addr 0x6bbb780, size 0x3cc, virtual false, abstract: false, final false
  inline void LoadProperties();

  /// @brief Method MoveNextProperty, addr 0x6bbbb5c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAngle, addr 0x6bbf61c, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::Angle ReadAngle(::UnityEngine::UIElements::StyleSheets::StylePropertyValue value);

  /// @brief Method ReadAsString, addr 0x6bbbe10, size 0x6c, virtual false, abstract: false, final false
  inline ::StringW ReadAsString(int32_t index);

  /// @brief Method ReadBackground, addr 0x6bbdad0, size 0x270, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Background ReadBackground(int32_t index);

  /// @brief Method ReadBackgroundPosition, addr 0x6bbe91c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadBackgroundPosition, addr 0x6bbea08, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadBackgroundPositionX, addr 0x6bbe904, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BackgroundPosition ReadBackgroundPositionX(int32_t index);

  /// @brief Method ReadBackgroundPositionY, addr 0x6bbe9f0, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BackgroundPosition ReadBackgroundPositionY(int32_t index);

  /// @brief Method ReadBackgroundRepeat, addr 0x6bbeafc, size 0xbc, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BackgroundRepeat ReadBackgroundRepeat(int32_t index);

  /// @brief Method ReadBackgroundRepeat, addr 0x6bbebb8, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadBackgroundSize, addr 0x6bbec7c, size 0xf0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BackgroundSize ReadBackgroundSize(int32_t index);

  /// @brief Method ReadBackgroundSize, addr 0x6bbed6c, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadColor, addr 0x6bbcf98, size 0xe4, virtual false, abstract: false, final false
  inline ::UnityEngine::Color ReadColor(int32_t index);

  /// @brief Method ReadCursor, addr 0x6bbe3f0, size 0x2a4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Cursor ReadCursor(int32_t index);

  /// @brief Method ReadEnum, addr 0x6bbd164, size 0xe8, virtual false, abstract: false, final false
  inline int32_t ReadEnum(::UnityEngine::UIElements::StyleSheets::StyleEnumType enumType, int32_t index);

  /// @brief Method ReadEnum, addr 0x6bbf55c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadFloat, addr 0x6bbce94, size 0x74, virtual false, abstract: false, final false
  inline float_t ReadFloat(int32_t index);

  /// @brief Method ReadFont, addr 0x6bbd788, size 0x348, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Font> ReadFont(int32_t index);

  /// @brief Method ReadFontDefinition, addr 0x6bbd24c, size 0x53c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::FontDefinition ReadFontDefinition(int32_t index);

  /// @brief Method ReadInt, addr 0x6bbcf08, size 0x90, virtual false, abstract: false, final false
  inline int32_t ReadInt(int32_t index);

  /// @brief Method ReadLength, addr 0x6bbc1c0, size 0xd0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Length ReadLength(int32_t index);

  /// @brief Method ReadListEasingFunction, addr 0x6bbef7c, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadListStylePropertyName, addr 0x6bbf288, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadListTimeValue, addr 0x6bbf124, size 0x164, virtual false, abstract: false, final false
  inline void ReadListTimeValue(::System::Collections::Generic::List_1<::UnityEngine::UIElements::TimeValue>* list, int32_t index);

  /// @brief Method ReadRotate, addr 0x6bbc8d0, size 0x188, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Rotate ReadRotate(int32_t index);

  /// @brief Method ReadRotate, addr 0x6bbca58, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadScale, addr 0x6bbcc18, size 0x104, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Scale ReadScale(int32_t index);

  /// @brief Method ReadScale, addr 0x6bbcd1c, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadTextShadow, addr 0x6bbe694, size 0x270, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TextShadow ReadTextShadow(int32_t index);

  /// @brief Method ReadTimeValue, addr 0x6bbc290, size 0x84, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TimeValue ReadTimeValue(int32_t index);

  /// @brief Method ReadTransformOrigin, addr 0x6bbc654, size 0x138, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TransformOrigin ReadTransformOrigin(int32_t index);

  /// @brief Method ReadTransformOrigin, addr 0x6bbc78c, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadTransformOriginEnum, addr 0x6bbf418, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadTranslate, addr 0x6bbc314, size 0x134, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Translate ReadTranslate(int32_t index);

  /// @brief Method ReadTranslate, addr 0x6bbc448, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetContext, addr 0x6bbb4d8, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCurrentProperty, addr 0x6bbbb8c, size 0xb4, virtual false, abstract: false, final false
  inline void SetCurrentProperty();

  /// @brief Method SetInlineContext, addr 0x6bbbb4c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetImageSourceFromValue, addr 0x6bbdd40, size 0x6b0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryReadEnum, addr 0x6bbf688, size 0xb8, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityEngine::UIElements::StyleSheets::StylePropertyId> const& __cordl_internal_get_m_PropertyIds() const;

  constexpr ::ArrayW<::UnityEngine::UIElements::StyleSheets::StylePropertyId>& __cordl_internal_get_m_PropertyIds();
  ...
  constexpr void __cordl_internal_set_m_PropertyIds(::ArrayW<::UnityEngine::UIElements::StyleSheets::StylePropertyId> value);
  ...
  /// @brief Method .ctor, addr 0x6bbf740, size 0xec, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::UIElements::StyleSheets::StylePropertyReader_GetCursorIdFunction* getStaticF_getCursorIdFunc();

  /// @brief Method get_dpiScaling, addr 0x6bbb4c8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_dpiScaling();

  /// @brief Method get_property, addr 0x6bbb498, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleProperty* get_property();

  /// @brief Method get_propertyId, addr 0x6bbb4a8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleSheets::StylePropertyId get_propertyId();

  /// @brief Method get_valueCount, addr 0x6bbb4b8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_dpiScaling, addr 0x6bbb4d0, size 0x8, virtual false, abstract: false, final false
  inline void set_dpiScaling(float_t value);

  /// @brief Method set_property, addr 0x6bbb4a0, size 0x8, virtual false, abstract: false, final false
  inline void set_property(::UnityEngine::UIElements::StyleProperty* value);

  /// @brief Method set_propertyId, addr 0x6bbb4b0, size 0x8, virtual false, abstract: false, final false
  inline void set_propertyId(::UnityEngine::UIElements::StyleSheets::StylePropertyId value);

  /// @brief Method set_valueCount, addr 0x6bbb4c0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::UnityEngine::UIElements::StyleSheets::StylePropertyId> ___m_PropertyIds;
...
static_assert(sizeof(::UnityEngine::UIElements::StyleSheets::StylePropertyReader) == 0x60, "Size mismatch!");
