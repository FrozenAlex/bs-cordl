...
public:
  ...
  /// @brief Method .ctor, addr 0x6b7caf8, size 0x78, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Create, addr 0x6b7cb70, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x6b7cc24, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b7cbe8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6b7c7d8, size 0x110, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BuildAreas, addr 0x6b7beec, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildRowArray, addr 0x6b7c254, size 0xa0, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::UIElements::UIR::Allocator2D_Row*> BuildRowArray(int32_t maxRowHeight, int32_t rowHeightBias);

  /// @brief Method ComputeMaxAllocSize, addr 0x6b7c118, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method Free, addr 0x6b7c8e8, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method TryAllocate, addr 0x6b7c2f4, size 0x4e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b7bcdc, size 0x210, virtual false, abstract: false, final false
