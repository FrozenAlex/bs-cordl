...
public:
  ...
  /// @brief Method Dispose, addr 0x6cf3a80, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6cf4824, size 0xa0, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);
  ...
  /// @brief Method .ctor, addr 0x6cf46dc, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(uint32_t vertexMaxCount, uint32_t indexMaxCount, uint32_t maxQueuedFrameCount, bool mockPage);

  /// @brief Method get_disposed, addr 0x6cf4814, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method get_isEmpty, addr 0x6cf48c4, size 0x48, virtual false, abstract: false, final false
  inline bool get_isEmpty();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_disposed, addr 0x6cf481c, size 0x8, virtual false, abstract: false, final false
  inline void set_disposed(bool value);
