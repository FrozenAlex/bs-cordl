...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::State, "UnityEngine.UIElements.UIR", "State");
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::State) == 0x18, "Size mismatch!");
