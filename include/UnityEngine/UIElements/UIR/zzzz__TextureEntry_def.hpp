...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::TextureEntry, "UnityEngine.UIElements.UIR", "TextureEntry");
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::TextureEntry) == 0x10, "Size mismatch!");
