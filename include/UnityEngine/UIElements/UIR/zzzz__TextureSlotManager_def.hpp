...
public:
  ...
  /// @brief Method Bind, addr 0x6b9c7a8, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method FindOldestSlot, addr 0x6b9c6dc, size 0xcc, virtual false, abstract: false, final false
  inline int32_t FindOldestSlot();

  /// @brief Method IndexOf, addr 0x6b9c588, size 0xec, virtual false, abstract: false, final false
  inline int32_t IndexOf(::UnityEngine::UIElements::TextureId id);

  /// @brief Method MarkUsed, addr 0x6b9c674, size 0x58, virtual false, abstract: false, final false
  inline void MarkUsed(int32_t slotIndex);

  static inline ::UnityEngine::UIElements::UIR::TextureSlotManager* New_ctor();

  /// @brief Method Reset, addr 0x6b9c2c0, size 0x128, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SetGpuData, addr 0x6b9c3e8, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method StartNewBatch, addr 0x6b9c518, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b9c140, size 0x180, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_FreeSlots, addr 0x6b9c6cc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_FreeSlots, addr 0x6b9c6d4, size 0x8, virtual false, abstract: false, final false
