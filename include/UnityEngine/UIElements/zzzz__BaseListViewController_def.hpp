...
public:
  ...
  /// @brief Method AddItems, addr 0x6c4499c, size 0x6cc, virtual true, abstract: false, final false
  inline void AddItems(int32_t itemCount);

  /// @brief Method AddToArray, addr 0x6c451dc, size 0xf0, virtual false, abstract: false, final false
  static inline ::System::Array* AddToArray(::System::Array* source, int32_t itemCount);

  /// @brief Method ClearItems, addr 0x6c45ef0, size 0x1b4, virtual true, abstract: false, final false
  inline void ClearItems();

  /// @brief Method EnsureItemSourceCanBeResized, addr 0x6c45068, size 0x174, virtual false, abstract: false, final false
  inline void EnsureItemSourceCanBeResized();

  /// @brief Method InvokeBindItem, addr 0x6c44670, size 0xf0, virtual true, abstract: false, final false
  inline void InvokeBindItem(::UnityEngine::UIElements::ReusableCollectionItem* reusableItem, int32_t index);

  /// @brief Method InvokeMakeItem, addr 0x6c43fe4, size 0xf4, virtual true, abstract: false, final false
  inline void InvokeMakeItem(::UnityEngine::UIElements::ReusableCollectionItem* reusableItem);

  /// @brief Method Move, addr 0x6c45304, size 0x178, virtual true, abstract: false, final false
  inline void Move(int32_t index, int32_t newIndex);

  /// @brief Method NeedsDragHandle, addr 0x6c44994, size 0x8, virtual true, abstract: false, final false
  inline bool NeedsDragHandle(int32_t index);

  static inline ::UnityEngine::UIElements::BaseListViewController* New_ctor();

  /// @brief Method PostInitRegistration, addr 0x6c4419c, size 0x3d0, virtual false, abstract: false, final false
  inline void PostInitRegistration(::UnityEngine::UIElements::ReusableListViewItem* listItem);

  /// @brief Method RaiseItemsAdded, addr 0x6c452cc, size 0x1c, virtual false, abstract: false, final false
  inline void RaiseItemsAdded(::System::Collections::Generic::IEnumerable_1<int32_t>* indices);

  /// @brief Method RaiseItemsRemoved, addr 0x6c45b20, size 0x1c, virtual false, abstract: false, final false
  inline void RaiseItemsRemoved(::System::Collections::Generic::IEnumerable_1<int32_t>* indices);

  /// @brief Method RaiseOnSizeChanged, addr 0x6c452e8, size 0x1c, virtual false, abstract: false, final false
  inline void RaiseOnSizeChanged();

  /// @brief Method RemoveFromArray, addr 0x6c45b3c, size 0x1c4, virtual false, abstract: false, final false
  static inline ::System::Array* RemoveFromArray(::System::Array* source, ::System::Collections::Generic::List_1<int32_t>* indicesToRemove);

  /// @brief Method RemoveItem, addr 0x6c456dc, size 0x1ac, virtual true, abstract: false, final false
  inline void RemoveItem(int32_t index);

  /// @brief Method RemoveItems, addr 0x6c45888, size 0x298, virtual true, abstract: false, final false
  inline void RemoveItems(::System::Collections::Generic::List_1<int32_t>* indices);

  /// @brief Method RemoveItems, addr 0x6c45d00, size 0x1f0, virtual true, abstract: false, final false
  inline void RemoveItems(int32_t itemCount);

  /// @brief Method SetBindingContext, addr 0x6c4456c, size 0xf0, virtual true, abstract: false, final false
  inline void SetBindingContext(::UnityEngine::UIElements::ReusableCollectionItem* reusableItem, int32_t index);

  /// @brief Method Swap, addr 0x6c4547c, size 0x244, virtual false, abstract: false, final false
  inline void Swap(int32_t lhs, int32_t rhs);

  /// @brief Method <AddItems>g__IsGenericList|19_0, addr 0x6c460ac, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c460a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_itemsAdded, addr 0x6c43c64, size 0xc0, virtual false, abstract: false, final false
  inline void add_itemsAdded(::System::Action_1<::System::Collections::Generic::IEnumerable_1<int32_t>*>* value);

  /// @brief Method add_itemsRemoved, addr 0x6c43de4, size 0xc0, virtual false, abstract: false, final false
  inline void add_itemsRemoved(::System::Action_1<::System::Collections::Generic::IEnumerable_1<int32_t>*>* value);

  /// @brief Method add_itemsSourceSizeChanged, addr 0x6c43b0c, size 0xac, virtual false, abstract: false, final false
  inline void add_itemsSourceSizeChanged(::System::Action* value);

  /// @brief Method get_baseListView, addr 0x6c43f64, size 0x80, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BaseListView* get_baseListView();

  /// @brief Method remove_itemsAdded, addr 0x6c43d24, size 0xc0, virtual false, abstract: false, final false
  inline void remove_itemsAdded(::System::Action_1<::System::Collections::Generic::IEnumerable_1<int32_t>*>* value);

  /// @brief Method remove_itemsRemoved, addr 0x6c43ea4, size 0xc0, virtual false, abstract: false, final false
  inline void remove_itemsRemoved(::System::Action_1<::System::Collections::Generic::IEnumerable_1<int32_t>*>* value);

  /// @brief Method remove_itemsSourceSizeChanged, addr 0x6c43bb8, size 0xac, virtual false, abstract: false, final false
