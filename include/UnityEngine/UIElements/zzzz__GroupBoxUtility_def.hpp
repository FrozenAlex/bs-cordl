...
public:
  ...
  /// @brief Method FindOrCreateGroupManager, addr 0x6da9010, size 0x498, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::IGroupManager* FindOrCreateGroupManager(::UnityEngine::UIElements::IGroupBox* groupBox);

  /// @brief Method OnGroupBoxDetachedFromPanel, addr 0x6da95dc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnPanelDestroyed, addr 0x6da969c, size 0xe4, virtual false, abstract: false, final false
