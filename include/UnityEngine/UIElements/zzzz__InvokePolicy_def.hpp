...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::InvokePolicy, "UnityEngine.UIElements", "InvokePolicy");
// Dependencies
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::InvokePolicy) == 0x4, "Size mismatch!");
