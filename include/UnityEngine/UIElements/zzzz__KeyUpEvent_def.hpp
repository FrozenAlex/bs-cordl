...
public:
  ...
  /// @brief Method <.cctor>b__0_0, addr 0x6d96acc, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::KeyUpEvent* __cctor_b__0_0();

  /// @brief Method .ctor, addr 0x6d96ac8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6d96a28, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::KeyUpEvent) == 0x70, "Size mismatch!");
