...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6c61538, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c614b8, size 0x80, virtual false, abstract: false, final false
