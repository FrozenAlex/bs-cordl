...
public:
  ...
  /// @brief Method Equals, addr 0x6dae69c, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6dae738, size 0x34, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::ManipulatorActivationFilter other);

  /// @brief Method GetHashCode, addr 0x6dae76c, size 0x2c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method HasModifiers, addr 0x6dae8ec, size 0x1f8, virtual false, abstract: false, final false
  inline bool HasModifiers(::UnityEngine::UIElements::IPointerEvent* e);

  /// @brief Method MatchModifiers, addr 0x6daeae4, size 0x54, virtual false, abstract: false, final false
  inline bool MatchModifiers(bool alt, bool ctrl, bool shift, bool command);

  /// @brief Method Matches, addr 0x6dae798, size 0x154, virtual false, abstract: false, final false
  inline bool Matches(::UnityEngine::UIElements::IPointerEvent* e);

  /// @brief Method get_button, addr 0x6dae674, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::MouseButton get_button();

  /// @brief Method get_clickCount, addr 0x6dae694, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_clickCount();

  /// @brief Method get_modifiers, addr 0x6dae684, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_button, addr 0x6dae67c, size 0x8, virtual false, abstract: false, final false
  inline void set_button(::UnityEngine::UIElements::MouseButton value);

  /// @brief Method set_modifiers, addr 0x6dae68c, size 0x8, virtual false, abstract: false, final false
