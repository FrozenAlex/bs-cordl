...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::MouseMoveEvent___c::*)()>(&::UnityEngine::UIElements::MouseMoveEvent___c::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x6c47f50;
...
inline void UnityEngine::UIElements::MouseMoveEvent___c::setStaticF___9(::UnityEngine::UIElements::MouseMoveEvent___c* value) {
  ::cordl_internals::setStaticField<::UnityEngine::UIElements::MouseMoveEvent___c*, "<>9", ::UnityEngine::UIElements::MouseMoveEvent___c*>(
      std::forward<::UnityEngine::UIElements::MouseMoveEvent___c*>(value));
}
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::MouseMoveEvent::*)()>(&::UnityEngine::UIElements::MouseMoveEvent::Init)> {
  ...
  constexpr static std::size_t addrs = 0x6c47df4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::UIElements::MouseMoveEvent*>(), { ::i2c::class_of<::UnityEngine::UIElements::MouseMoveEvent*>(), 13 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::MouseMoveEvent::*)()>(&::UnityEngine::UIElements::MouseMoveEvent::LocalInit)> {
  ...
  constexpr static std::size_t addrs = 0x6c47e4c;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::MouseMoveEvent::*)()>(&::UnityEngine::UIElements::MouseMoveEvent::_ctor)> {
  constexpr static std::size_t size = 0x58;
  constexpr static std::size_t addrs = 0x6c47e58;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::UIElements::MouseMoveEvent* (*)(::UnityEngine::UIElements::PointerMoveEvent*)>(
  ...
  constexpr static std::size_t addrs = 0x6c47eb0;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{},
                     (::i2c::find_method(::i2c::class_of<::UnityEngine::UIElements::MouseMoveEvent*>(), { "GetPooled", {}, { ::i2c::type_of<::UnityEngine::UIElements::PointerMoveEvent*>() } })));
    return ___internal_method;
  }
};
inline void UnityEngine::UIElements::MouseMoveEvent::Init() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::UIElements::MouseMoveEvent*>(), 13 })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
...
inline ::UnityEngine::UIElements::MouseMoveEvent* UnityEngine::UIElements::MouseMoveEvent::GetPooled(::UnityEngine::UIElements::PointerMoveEvent* pointerEvent) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::UIElements::MouseMoveEvent*>(), { "GetPooled", {}, { ::i2c::type_of<::UnityEngine::UIElements::PointerMoveEvent*>() } })));
