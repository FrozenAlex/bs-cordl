...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::PointerLeaveEvent___c::*)()>(&::UnityEngine::UIElements::PointerLeaveEvent___c::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x6c4e718;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::UIElements::PointerLeaveEvent* (::UnityEngine::UIElements::PointerLeaveEvent___c::*)()>(
  ...
  constexpr static std::size_t addrs = 0x6c4e71c;
...
inline void UnityEngine::UIElements::PointerLeaveEvent___c::setStaticF___9(::UnityEngine::UIElements::PointerLeaveEvent___c* value) {
  ::cordl_internals::setStaticField<::UnityEngine::UIElements::PointerLeaveEvent___c*, "<>9", ::UnityEngine::UIElements::PointerLeaveEvent___c*>(
...
inline ::UnityEngine::UIElements::PointerLeaveEvent___c* UnityEngine::UIElements::PointerLeaveEvent___c::getStaticF___9() {
  return ::cordl_internals::getStaticField<::UnityEngine::UIElements::PointerLeaveEvent___c*, "<>9", ::UnityEngine::UIElements::PointerLeaveEvent___c*>();
}
...
inline ::UnityEngine::UIElements::PointerLeaveEvent* UnityEngine::UIElements::PointerLeaveEvent___c::__cctor_b__0_0() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::UIElements::PointerLeaveEvent___c*>(), { "<.cctor>b__0_0", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<::UnityEngine::UIElements::PointerLeaveEvent*>(this, ___internal_method);
}
inline ::UnityEngine::UIElements::PointerLeaveEvent___c* UnityEngine::UIElements::PointerLeaveEvent___c::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::UnityEngine::UIElements::PointerLeaveEvent___c*>());
}
// Ctor Parameters []
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::PointerLeaveEvent::*)()>(&::UnityEngine::UIElements::PointerLeaveEvent::Init)> {
  ...
  constexpr static std::size_t addrs = 0x6c4e568;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::UIElements::PointerLeaveEvent*>(), { ::i2c::class_of<::UnityEngine::UIElements::PointerLeaveEvent*>(), 13 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::PointerLeaveEvent::*)()>(&::UnityEngine::UIElements::PointerLeaveEvent::LocalInit)> {
  ...
  constexpr static std::size_t addrs = 0x6c4e5c0;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::PointerLeaveEvent::*)()>(&::UnityEngine::UIElements::PointerLeaveEvent::_ctor)> {
  constexpr static std::size_t size = 0x58;
  constexpr static std::size_t addrs = 0x6c4e5cc;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::PointerLeaveEvent::*)(::UnityEngine::UIElements::BaseVisualElementPanel*)>(
  ...
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x6c4e624;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::UIElements::PointerLeaveEvent*>(), { ::i2c::class_of<::UnityEngine::UIElements::PointerLeaveEvent*>(), 10 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::PointerLeaveEvent::*)(::UnityEngine::UIElements::IPanel*)>(
  ...
  constexpr static std::size_t addrs = 0x6c4e628;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::UIElements::PointerLeaveEvent*>(), { ::i2c::class_of<::UnityEngine::UIElements::PointerLeaveEvent*>(), 7 }));
    return ___internal_method;
  }
};
inline void UnityEngine::UIElements::PointerLeaveEvent::Init() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::UIElements::PointerLeaveEvent*>(), 13 })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
...
inline void UnityEngine::UIElements::PointerLeaveEvent::Dispatch(::UnityEngine::UIElements::BaseVisualElementPanel* panel) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::UIElements::PointerLeaveEvent*>(), 10 })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, panel);
}
inline void UnityEngine::UIElements::PointerLeaveEvent::PreDispatch(::UnityEngine::UIElements::IPanel* panel) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::UIElements::PointerLeaveEvent*>(), 7 })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, panel);
}
inline ::UnityEngine::UIElements::PointerLeaveEvent* UnityEngine::UIElements::PointerLeaveEvent::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::UnityEngine::UIElements::PointerLeaveEvent*>());
}
// Ctor Parameters []
