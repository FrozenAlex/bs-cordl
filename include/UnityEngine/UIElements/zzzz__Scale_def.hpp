...
public:
  ...
  /// @brief Method Equals, addr 0x6b3ab3c, size 0xb4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6b3aaf0, size 0x4c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::Scale other);

  /// @brief Method GetHashCode, addr 0x6b3838c, size 0x54, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Initial, addr 0x6b3aa1c, size 0x50, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::Scale Initial();

  /// @brief Method None, addr 0x6b3aa6c, size 0x18, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::Scale None();

  /// @brief Method ToString, addr 0x6b3abf0, size 0x10, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x6b3aa0c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector3 scale);

  /// @brief Method get_value, addr 0x6b3aa84, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x6b38044, size 0x54, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::UIElements::Scale lhs, ::UnityEngine::UIElements::Scale rhs);

  /// @brief Method op_Inequality, addr 0x6b3aa9c, size 0x54, virtual false, abstract: false, final false
  static inline bool op_Inequality(::UnityEngine::UIElements::Scale lhs, ::UnityEngine::UIElements::Scale rhs);

  /// @brief Method set_value, addr 0x6b3aa90, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetValue, addr 0x6b3ad38, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x6b3ad44, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b3acc4, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6b3ad30, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6b3ad28, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x6b3ac00, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();
