...
public:
  ...
  /// @brief Method <.cctor>b__25_0, addr 0x6dd1e0c, size 0x8, virtual false, abstract: false, final false
  inline bool __cctor_b__25_0();

  /// @brief Method <.cctor>b__25_1, addr 0x6dd1e14, size 0x8, virtual false, abstract: false, final false
  inline bool __cctor_b__25_1();

  /// @brief Method .ctor, addr 0x6dd1e08, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method OnItemUnscheduled, addr 0x6dd1c70, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method ResetStartTime, addr 0x6dd1c10, size 0x60, virtual false, abstract: false, final false
  inline void ResetStartTime();

  /// @brief Method ShouldUnschedule, addr 0x6dd1c74, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6dd1ba4, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_delayMs, addr 0x6dd1b7c, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_delayMs();

  /// @brief Method get_endTimeMs, addr 0x6dd1b9c, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_endTimeMs();

  /// @brief Method get_intervalMs, addr 0x6dd1b8c, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_intervalMs();

  /// @brief Method get_startMs, addr 0x6dd1b6c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_delayMs, addr 0x6dd1b84, size 0x8, virtual false, abstract: false, final false
  inline void set_delayMs(int64_t value);

  /// @brief Method set_intervalMs, addr 0x6dd1b94, size 0x8, virtual false, abstract: false, final false
  inline void set_intervalMs(int64_t value);

  /// @brief Method set_startMs, addr 0x6dd1b74, size 0x8, virtual false, abstract: false, final false
