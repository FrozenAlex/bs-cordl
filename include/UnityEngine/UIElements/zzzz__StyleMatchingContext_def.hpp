...
public:
  ...
  /// @brief Method AddStyleSheet, addr 0x6b783c0, size 0xf0, virtual false, abstract: false, final false
  inline void AddStyleSheet(::UnityEngine::UIElements::StyleSheet* sheet);

  /// @brief Method GetStyleSheetAt, addr 0x6b7851c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveStyleSheetRange, addr 0x6b784b0, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b782d4, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method get_styleSheetCount, addr 0x6b78284, size 0x50, virtual false, abstract: false, final false
