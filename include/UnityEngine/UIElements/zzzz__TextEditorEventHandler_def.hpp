...
public:
  ...
  /// @brief Method HandleEventBubbleUp, addr 0x6d4289c, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method RegisterCallbacksOnTarget, addr 0x6d43920, size 0x4, virtual true, abstract: false, final false
  inline void RegisterCallbacksOnTarget(::UnityEngine::UIElements::VisualElement* target);

  /// @brief Method UnregisterCallbacksFromTarget, addr 0x6d43924, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d42590, size 0x8, virtual false, abstract: false, final false
