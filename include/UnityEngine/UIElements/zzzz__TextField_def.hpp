...
public:
  ...
  /// @brief Method .ctor, addr 0x6d4480c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6d44874, size 0x1cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d44a40, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method StringToValue, addr 0x6d44c64, size 0x8, virtual true, abstract: false, final false
  inline ::StringW StringToValue(::StringW str);

  /// @brief Method .ctor, addr 0x6d440ac, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_multiline, addr 0x6d439d0, size 0xb8, virtual false, abstract: false, final false
  inline bool get_multiline();

  /// @brief Method get_parentTextField, addr 0x6d44be8, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TextField* get_parentTextField();

  /// @brief Method set_multiline, addr 0x6d43b44, size 0x2d0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method HandleEventBubbleUp, addr 0x6d44444, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method OnViewDataReady, addr 0x6d445c4, size 0xa8, virtual true, abstract: false, final false
  inline void OnViewDataReady();

  /// @brief Method SetValueWithoutNotify, addr 0x6d44280, size 0x170, virtual true, abstract: false, final false
  inline void SetValueWithoutNotify(::StringW newValue);

  /// @brief Method StringToValue, addr 0x6d44674, size 0x8, virtual true, abstract: false, final false
  inline ::StringW StringToValue(::StringW str);

  /// @brief Method UpdateTextFromValue, addr 0x6d443f0, size 0x54, virtual true, abstract: false, final false
  inline void UpdateTextFromValue();

  /// @brief Method ValueToString, addr 0x6d4466c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW ValueToString(::StringW value);

  /// @brief Method .ctor, addr 0x6d43e14, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6d43e2c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::StringW label);

  /// @brief Method .ctor, addr 0x6d43e40, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_multiline, addr 0x6d439b8, size 0x18, virtual false, abstract: false, final false
  inline bool get_multiline();

  /// @brief Method get_textInput, addr 0x6d43928, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TextField_TextInput* get_textInput();

  /// @brief Method get_value, addr 0x6d44120, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method set_multiline, addr 0x6d43a88, size 0xbc, virtual false, abstract: false, final false
  inline void set_multiline(bool value);

  /// @brief Method set_value, addr 0x6d44164, size 0x11c, virtual true, abstract: false, final false
