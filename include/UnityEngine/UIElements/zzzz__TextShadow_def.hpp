...
public:
  ...
  /// @brief Method Equals, addr 0x6b5ba2c, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6b5bac0, size 0x7c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::TextShadow other);

  /// @brief Method GetHashCode, addr 0x6b5bb3c, size 0xcc, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method LerpUnclamped, addr 0x6b5bd80, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x6b5bc80, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x6b5bc08, size 0x30, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::UIElements::TextShadow style1, ::UnityEngine::UIElements::TextShadow style2);

  /// @brief Method op_Inequality, addr 0x6b5bc38, size 0x48, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetValue, addr 0x6b5c070, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x6b5c078, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b5bf34, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6b5c068, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6b5c060, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method GetValue, addr 0x6b5c090, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x6b5c098, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b5bf98, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6b5c088, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6b5c080, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();
...
public:
  ...
  /// @brief Method GetValue, addr 0x6b5c0b0, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x6b5c0bc, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b5bffc, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6b5c0a8, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6b5c0a0, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6b5bdd0, size 0x164, virtual false, abstract: false, final false
  inline void _ctor();
