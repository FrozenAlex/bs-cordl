...
public:
  ...
  /// @brief Method Equals, addr 0x6c821bc, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6c82248, size 0x24, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::TimerState other);

  /// @brief Method GetHashCode, addr 0x6c8226c, size 0x44, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method get_deltaTime, addr 0x6c821b0, size 0xc, virtual false, abstract: false, final false
  inline int64_t get_deltaTime();

  /// @brief Method get_now, addr 0x6c821a0, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_now();

  /// @brief Method get_start, addr 0x6c82190, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_now, addr 0x6c821a8, size 0x8, virtual false, abstract: false, final false
  inline void set_now(int64_t value);

  /// @brief Method set_start, addr 0x6c82198, size 0x8, virtual false, abstract: false, final false
