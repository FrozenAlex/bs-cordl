...
public:
  ...
  /// @brief Method Copy, addr 0x6c876d8, size 0x10, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::TransformData Copy();

  /// @brief Method CopyFrom, addr 0x6c876e8, size 0x8, virtual true, abstract: false, final true
  inline void CopyFrom(::by_ref<::UnityEngine::UIElements::TransformData> other);

  /// @brief Method Equals, addr 0x6c87a84, size 0xa4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6c87a40, size 0x44, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::TransformData other);

  /// @brief Method GetHashCode, addr 0x6c87b28, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x6c876f0, size 0x194, virtual false, abstract: false, final false
