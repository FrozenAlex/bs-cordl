...
public:
  ...
  /// @brief Method .ctor, addr 0x6d7a5c8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6d7a630, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ApplyInputDeviceDelta, addr 0x6d7a754, size 0x25c, virtual true, abstract: false, final false
  inline void ApplyInputDeviceDelta(::UnityEngine::Vector3 delta, ::UnityEngine::UIElements::DeltaSpeed speed, uint64_t startValue);

  /// @brief Method ClampToMinMaxULongValue, addr 0x6d7a9b0, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method StringToValue, addr 0x6d7aa8c, size 0xa0, virtual true, abstract: false, final false
  inline uint64_t StringToValue(::StringW str);

  /// @brief Method ValueToString, addr 0x6d7aa30, size 0x5c, virtual true, abstract: false, final false
  inline ::StringW ValueToString(uint64_t v);

  /// @brief Method .ctor, addr 0x6d7a3cc, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_allowedCharacters, addr 0x6d7a6f8, size 0x5c, virtual true, abstract: false, final false
  inline ::StringW get_allowedCharacters();

  /// @brief Method get_parentUnsignedLongField, addr 0x6d7a67c, size 0x7c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ApplyInputDeviceDelta, addr 0x6d7a488, size 0x64, virtual true, abstract: false, final false
  inline void ApplyInputDeviceDelta(::UnityEngine::Vector3 delta, ::UnityEngine::UIElements::DeltaSpeed speed, uint64_t startValue);

  /// @brief Method CanTryParse, addr 0x6d7a468, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method StringToValue, addr 0x6d7a160, size 0xe0, virtual true, abstract: false, final false
  inline uint64_t StringToValue(::StringW str);

  /// @brief Method ValueToString, addr 0x6d7a0a0, size 0xc0, virtual true, abstract: false, final false
  inline ::StringW ValueToString(uint64_t v);

  /// @brief Method .ctor, addr 0x6d7a240, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6d7a24c, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method get_unsignedLongInput, addr 0x6d7a010, size 0x90, virtual false, abstract: false, final false
