...
public:
  ...
  /// @brief Method <GetValueFromBag>b__3_0, addr 0x6b66fb4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW _GetValueFromBag_b__3_0(::StringW s, ::StringW t);

  /// @brief Method <TryGetValueFromBag>b__4_0, addr 0x6b66fbc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW _TryGetValueFromBag_b__4_0(::StringW s, ::StringW t);

  /// @brief Method .ctor, addr 0x6b66fb0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetValueFromBag, addr 0x6b66c18, size 0x198, virtual true, abstract: false, final false
  ...
  /// @brief Method TryGetValueFromBag, addr 0x6b66db0, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b5b3f4, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor();
