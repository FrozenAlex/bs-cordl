...
public:
  ...
  /// @brief Method .ctor, addr 0x6be65b0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6be6618, size 0x1c8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6be67e0, size 0x11c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <DescribeFields>b__0_0, addr 0x6be6954, size 0x8, virtual false, abstract: false, final false
  inline int32_t _DescribeFields_b__0_0(::UnityEngine::Vector3Int r);

  /// @brief Method <DescribeFields>b__0_1, addr 0x6be695c, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_1(::by_ref<::UnityEngine::Vector3Int> r, int32_t v);

  /// @brief Method <DescribeFields>b__0_2, addr 0x6be6964, size 0x8, virtual false, abstract: false, final false
  inline int32_t _DescribeFields_b__0_2(::UnityEngine::Vector3Int r);

  /// @brief Method <DescribeFields>b__0_3, addr 0x6be696c, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_3(::by_ref<::UnityEngine::Vector3Int> r, int32_t v);

  /// @brief Method <DescribeFields>b__0_4, addr 0x6be6974, size 0x8, virtual false, abstract: false, final false
  inline int32_t _DescribeFields_b__0_4(::UnityEngine::Vector3Int r);

  /// @brief Method <DescribeFields>b__0_5, addr 0x6be697c, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_5(::by_ref<::UnityEngine::Vector3Int> r, int32_t v);

  /// @brief Method .ctor, addr 0x6be6950, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DescribeFields, addr 0x6be603c, size 0x490, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6be64cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6be03c8, size 0x12c, virtual false, abstract: false, final false
