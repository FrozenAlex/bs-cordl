...
public:
  ...
  /// @brief Method .ctor, addr 0x6b756a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BuildRingForScopeRecursive, addr 0x6b7470c, size 0x2bc, virtual false, abstract: false, final false
  ...
  /// @brief Method DoUpdate, addr 0x6b74618, size 0xf4, virtual false, abstract: false, final false
  inline void DoUpdate();

  /// @brief Method FocusRingAutoIndexSort, addr 0x6b7420c, size 0x318, virtual false, abstract: false, final false
  ...
  /// @brief Method FocusRingSort, addr 0x6b74524, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFocusChangeDirection, addr 0x6b74ce4, size 0x378, virtual true, abstract: false, final true
  ...
  /// @brief Method GetFocusableInternalIndex, addr 0x6b74c30, size 0xb4, virtual false, abstract: false, final false
  inline int32_t GetFocusableInternalIndex(::UnityEngine::UIElements::Focusable* f);

  /// @brief Method GetNextFocusable, addr 0x6b7505c, size 0x4d8, virtual true, abstract: false, final true
  ...
  /// @brief Method GetNextFocusableInTree, addr 0x6b75534, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousFocusableInTree, addr 0x6b755c8, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method SortAndFlattenScopeLists, addr 0x6b749c8, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b74150, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_defaultFocusOrder, addr 0x6b741fc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElementFocusRing_DefaultFocusOrder get_defaultFocusOrder();

  /// @brief Method get_focusController, addr 0x6b741dc, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method set_defaultFocusOrder, addr 0x6b74204, size 0x8, virtual false, abstract: false, final false
