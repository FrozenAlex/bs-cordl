...
public:
  ...
  /// @brief Method ApplyStyles, addr 0x6cc7384, size 0xe0, virtual false, abstract: false, final false
  inline void ApplyStyles();

  /// @brief Method Dispose, addr 0x6cc777c, size 0x34, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  static inline ::UnityEngine::UIElements::VisualTreeStyleUpdater* New_ctor();

  /// @brief Method OnVersionChanged, addr 0x6cc6fb0, size 0xe8, virtual true, abstract: false, final false
  inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::VersionChangeType versionChangeType);

  /// @brief Method Update, addr 0x6cc7128, size 0x25c, virtual true, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x6cc77dc, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_disposed, addr 0x6cc776c, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method get_profilerMarker, addr 0x6cc6f54, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method set_disposed, addr 0x6cc7774, size 0x8, virtual false, abstract: false, final false
