...
CORDL_MODULE_EXPORT(VFXPreviousPositionBinder)
...
namespace UnityEngine::VFX::Utility {
class VFXPreviousPositionBinder;
}
// Write type traits
...
namespace UnityEngine::VFX::Utility {
// Is value type: false
// CS Name: UnityEngine.VFX.Utility.VFXPreviousPositionBinder
class CORDL_TYPE VFXPreviousPositionBinder : public ::UnityEngine::VFX::Utility::VFXSpaceableBinder {
public:
  // Declarations
  ...
  constexpr ::UnityEngine::Vector3 const& __cordl_internal_get_oldPosition() const;

  constexpr ::UnityEngine::Vector3& __cordl_internal_get_oldPosition();
...
public:
  ...
  /// @brief Field oldPosition, offset: 0x40, size: 0xc, def value: None
  ::UnityEngine::Vector3 ___oldPosition;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::UnityEngine::VFX::Utility::VFXPreviousPositionBinder, ___m_Property) == 0x30, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::VFX::Utility::VFXPreviousPositionBinder, ___Target) == 0x38, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::VFX::Utility::VFXPreviousPositionBinder, ___oldPosition) == 0x40, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::VFX::Utility::VFXPreviousPositionBinder) == 0x50, "Size mismatch!");
