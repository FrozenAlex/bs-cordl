...
public:
  ...
  /// @brief Method CreateExpressionValuesWrapper, addr 0x6cd4964, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cd4960, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
