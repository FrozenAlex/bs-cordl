...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::API::UnityXRDepthTextureFormat, "UnityEngine.XR.OpenXR.API", "UnityXRDepthTextureFormat");
// Dependencies
namespace UnityEngine::XR::OpenXR::API {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::API::UnityXRDepthTextureFormat) == 0x4, "Size mismatch!");
