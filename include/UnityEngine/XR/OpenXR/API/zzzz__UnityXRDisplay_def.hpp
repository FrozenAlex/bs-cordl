...
// Write type traits
MARK_REF_T(::UnityEngine::XR::OpenXR::API::UnityXRDisplay*);
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::API::UnityXRDisplay*, "UnityEngine.XR.OpenXR.API", "UnityXRDisplay");
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::API::UnityXRDisplay) == 0x10, "Size mismatch!");
