...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::API::UnityXRRenderTextureDesc, "UnityEngine.XR.OpenXR.API", "UnityXRRenderTextureDesc");
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::API::UnityXRRenderTextureDesc) == 0x58, "Size mismatch!");
