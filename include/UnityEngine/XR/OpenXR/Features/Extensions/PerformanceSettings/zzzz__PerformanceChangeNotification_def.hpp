...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceChangeNotification, "UnityEngine.XR.OpenXR.Features.Extensions.PerformanceSettings",
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceChangeNotification) == 0x10, "Size mismatch!");
