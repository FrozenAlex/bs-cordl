...
// Write type traits
MARK_REF_T(::UnityEngine::XR::OpenXR::Features::Interactions::EyeGazeInteraction*);
...
public:
  ...
  /// @brief Method FinishSetup, addr 0x68a286c, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68a28e4, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_pose, addr 0x68a285c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::OpenXR::Input::PoseControl* get_pose();

  /// @brief Method set_pose, addr 0x68a2864, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::Features::Interactions::EyeGazeInteraction_EyeGazeDevice) == 0x190, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetDeviceLayoutName, addr 0x68a2274, size 0x44, virtual true, abstract: false, final false
  inline ::StringW GetDeviceLayoutName();

  /// @brief Method GetInteractionProfileType, addr 0x68a21c0, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnInstanceCreate, addr 0x68a1f84, size 0x6c, virtual true, abstract: false, final false
  inline bool OnInstanceCreate(uint64_t instance);

  /// @brief Method RegisterActionMapsWithRuntime, addr 0x68a22b8, size 0x548, virtual true, abstract: false, final false
  inline void RegisterActionMapsWithRuntime();

  /// @brief Method RegisterDeviceLayout, addr 0x68a1ff0, size 0x160, virtual true, abstract: false, final false
  inline void RegisterDeviceLayout();

  /// @brief Method UnregisterDeviceLayout, addr 0x68a2150, size 0x70, virtual true, abstract: false, final false
  inline void UnregisterDeviceLayout();

  /// @brief Method .ctor, addr 0x68a2800, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::XR::OpenXR::Features::Interactions::EyeGazeInteraction) == 0x50, "Size mismatch!");
