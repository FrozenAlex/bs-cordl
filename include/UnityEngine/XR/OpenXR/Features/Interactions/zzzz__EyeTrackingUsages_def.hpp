...
// Write type traits
MARK_REF_T(::UnityEngine::XR::OpenXR::Features::Interactions::EyeTrackingUsages*);
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::Features::Interactions::EyeTrackingUsages*, "UnityEngine.XR.OpenXR.Features.Interactions", "EyeTrackingUsages");
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::Features::Interactions::EyeTrackingUsages) == 0x10, "Size mismatch!");
