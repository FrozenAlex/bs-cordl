...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::Features::MetaQuestSupport::MetaQuestFeature_TargetDevice, "UnityEngine.XR.OpenXR.Features.MetaQuestSupport", "MetaQuestFeature/TargetDevice");
// Dependencies
namespace UnityEngine::XR::OpenXR::Features::MetaQuestSupport {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::Features::MetaQuestSupport::MetaQuestFeature_TargetDevice) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x68b055c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
