...
public:
  // Declarations
  /// @brief Method HookGetInstanceProcAddr, addr 0x689edac, size 0x8, virtual true, abstract: false, final false
  inline ::System::IntPtr HookGetInstanceProcAddr(::System::IntPtr func);

  /// @brief Method Internal_Unity_GetUseFoveatedRenderingLegacyMode, addr 0x689ee30, size 0x6c, virtual false, abstract: false, final false
  static inline bool Internal_Unity_GetUseFoveatedRenderingLegacyMode();

  /// @brief Method Internal_Unity_SetUseFoveatedRenderingLegacyMode, addr 0x689ed28, size 0x7c, virtual false, abstract: false, final false
  static inline void Internal_Unity_SetUseFoveatedRenderingLegacyMode(bool value);

  /// @brief Method Internal_Unity_intercept_xrGetInstanceProcAddr, addr 0x689edb4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnInstanceCreate, addr 0x689ec84, size 0xa4, virtual true, abstract: false, final false
  inline bool OnInstanceCreate(uint64_t instance);

  /// @brief Method .ctor, addr 0x689ee9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::Features::FoveatedRenderingFeature) == 0x50, "Size mismatch!");
