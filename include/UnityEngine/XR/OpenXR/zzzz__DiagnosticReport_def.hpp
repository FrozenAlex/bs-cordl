...
public:
  ...
  /// @brief Method AddEventEntry, addr 0x689253c, size 0xac, virtual false, abstract: false, final false
  static inline void AddEventEntry(::StringW eventName, ::StringW eventData);

  /// @brief Method AddSectionBreak, addr 0x68924c8, size 0x74, virtual false, abstract: false, final false
  static inline void AddSectionBreak(uint64_t sectionHandle);

  /// @brief Method AddSectionEntry, addr 0x689240c, size 0xbc, virtual false, abstract: false, final false
  static inline void AddSectionEntry(uint64_t sectionHandle, ::StringW sectionEntry, ::StringW sectionBody);

  /// @brief Method DumpReport, addr 0x689284c, size 0x4, virtual false, abstract: false, final false
  static inline void DumpReport(::StringW reason);

  /// @brief Method GenerateReport, addr 0x68927bc, size 0x90, virtual false, abstract: false, final false
  static inline ::StringW GenerateReport();

  /// @brief Method GetSection, addr 0x689237c, size 0x90, virtual false, abstract: false, final false
  static inline uint64_t GetSection(::StringW sectionName);

  /// @brief Method Internal_DumpReport, addr 0x68925e8, size 0x64, virtual false, abstract: false, final false
  static inline void Internal_DumpReport();

  /// @brief Method Internal_DumpReport, addr 0x689264c, size 0x90, virtual false, abstract: false, final false
  static inline void Internal_DumpReport(::StringW reason);

  /// @brief Method Internal_GenerateReport, addr 0x68926dc, size 0x64, virtual false, abstract: false, final false
  static inline ::System::IntPtr Internal_GenerateReport();

  /// @brief Method Internal_ReleaseReport, addr 0x6892740, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method StartReport, addr 0x6892318, size 0x64, virtual false, abstract: false, final false
  static inline void StartReport();

  /// @brief Method .ctor, addr 0x6892850, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
