...
// Write type traits
MARK_REF_T(::UnityEngine::XR::OpenXR::OpenXRLoader*);
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::OpenXRLoader*, "UnityEngine.XR.OpenXR", "OpenXRLoader");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6892854, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::OpenXRLoader) == 0x78, "Size mismatch!");
