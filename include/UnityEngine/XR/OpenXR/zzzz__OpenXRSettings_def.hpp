...
public:
  ...
  /// @brief Method .ctor, addr 0x6891480, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <ApplyRenderSettings>b__44_0, addr 0x689153c, size 0x8, virtual false, abstract: false, final false
  inline int32_t _ApplyRenderSettings_b__44_0(::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup e);

  /// @brief Method .ctor, addr 0x6891528, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_colorSubmissionModes>b__25_0, addr 0x689152c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup _get_colorSubmissionModes_b__25_0(int32_t i);

  /// @brief Method <set_colorSubmissionModes>b__26_0, addr 0x6891534, size 0x8, virtual false, abstract: false, final false
...
// UnityEngine.XR.OpenXR.OpenXRSettings::ColorSubmissionModeGroup, UnityEngine.XR.OpenXR.OpenXRSettings::DepthSubmissionMode, UnityEngine.XR.OpenXR.OpenXRSettings::RenderMode,
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_m_eyeTrackingPermissionsToRequest, put = __cordl_internal_set_m_eyeTrackingPermissionsToRequest)) ::ArrayW<::StringW>
  ...
  /// @brief Method ApplyRenderSettings, addr 0x68906bc, size 0x2b0, virtual false, abstract: false, final false
  inline void ApplyRenderSettings();

  /// @brief Method ApplySettings, addr 0x6891158, size 0x4, virtual false, abstract: false, final false
  inline void ApplySettings();

  /// @brief Method Awake, addr 0x6891108, size 0x50, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method GetFeature, addr 0x688f030, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFeatures, addr 0x688f3a0, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFeatures, addr 0x688f0bc, size 0x17c, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::UnityEngine::XR::OpenXR::Features::OpenXRFeature>> GetFeatures(::System::Type* featureType);

  /// @brief Method GetFeatures, addr 0x688f238, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFeatures, addr 0x688f430, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x688fe68, size 0xb4, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::XR::OpenXR::OpenXRSettings> GetInstance(bool useActiveBuildTarget);

  /// @brief Method Internal_GetAllowRecentering, addr 0x6891268, size 0x6c, virtual false, abstract: false, final false
  static inline bool Internal_GetAllowRecentering();

  /// @brief Method Internal_GetColorSubmissionModes, addr 0x688fa74, size 0xe8, virtual false, abstract: false, final false
  static inline int32_t Internal_GetColorSubmissionModes(::by_ref<::ArrayW<int32_t>> colorSubmissionMode, int32_t arraySize);

  /// @brief Method Internal_GetDepthSubmissionMode, addr 0x689008c, size 0x64, virtual false, abstract: false, final false
  static inline ::UnityEngine::XR::OpenXR::OpenXRSettings_DepthSubmissionMode Internal_GetDepthSubmissionMode();

  /// @brief Method Internal_GetFloorOffset, addr 0x68912d8, size 0x64, virtual false, abstract: false, final false
  static inline float_t Internal_GetFloorOffset();

  /// @brief Method Internal_GetHasEyeTrackingPermissions, addr 0x6890fac, size 0x6c, virtual false, abstract: false, final false
  static inline bool Internal_GetHasEyeTrackingPermissions();

  /// @brief Method Internal_GetIsUsingLegacyXRDisplay, addr 0x689109c, size 0x6c, virtual false, abstract: false, final false
  static inline bool Internal_GetIsUsingLegacyXRDisplay();

  /// @brief Method Internal_GetRenderMode, addr 0x688f5f4, size 0x64, virtual false, abstract: false, final false
  static inline ::UnityEngine::XR::OpenXR::OpenXRSettings_RenderMode Internal_GetRenderMode();

  /// @brief Method Internal_GetSpaceWarpMotionVectorTextureFormat, addr 0x689035c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetUsedFoveatedRenderingApi, addr 0x6890dd0, size 0x64, virtual false, abstract: false, final false
  static inline ::UnityEngine::XR::OpenXR::OpenXRSettings_BackendFovationApi Internal_GetUsedFoveatedRenderingApi();

  /// @brief Method Internal_HasRequestedEyeTrackingPermissions, addr 0x6890a64, size 0x6c, virtual false, abstract: false, final false
  static inline bool Internal_HasRequestedEyeTrackingPermissions();

  /// @brief Method Internal_RegenerateTrackingOrigin, addr 0x6891200, size 0x64, virtual false, abstract: false, final false
  static inline void Internal_RegenerateTrackingOrigin();

  /// @brief Method Internal_SetAllowRecentering, addr 0x6891170, size 0x8c, virtual false, abstract: false, final false
  static inline void Internal_SetAllowRecentering(bool active, float_t height);

  /// @brief Method Internal_SetColorSubmissionMode, addr 0x6891018, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_SetColorSubmissionModes, addr 0x688fd58, size 0x8c, virtual false, abstract: false, final false
  static inline void Internal_SetColorSubmissionModes(::ArrayW<int32_t> colorSubmissionMode, int32_t arraySize);

  /// @brief Method Internal_SetDepthSubmissionMode, addr 0x68901ec, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_SetHasEyeTrackingPermissions, addr 0x688ff1c, size 0x7c, virtual false, abstract: false, final false
  static inline void Internal_SetHasEyeTrackingPermissions(bool value);

  /// @brief Method Internal_SetOptimizeBufferDiscards, addr 0x6890640, size 0x7c, virtual false, abstract: false, final false
  static inline void Internal_SetOptimizeBufferDiscards(bool enabled);

  /// @brief Method Internal_SetOptimizeMultiviewRenderRegions, addr 0x6890f30, size 0x7c, virtual false, abstract: false, final false
  static inline void Internal_SetOptimizeMultiviewRenderRegions(bool enabled);

  /// @brief Method Internal_SetRenderMode, addr 0x688f754, size 0x7c, virtual false, abstract: false, final false
  static inline void Internal_SetRenderMode(::UnityEngine::XR::OpenXR::OpenXRSettings_RenderMode renderMode);

  /// @brief Method Internal_SetSpaceWarpMotionVectorTextureFormat, addr 0x68904bc, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_SetSymmetricProjection, addr 0x689096c, size 0x7c, virtual false, abstract: false, final false
  static inline void Internal_SetSymmetricProjection(bool enabled);

  /// @brief Method Internal_SetUsedFoveatedRenderingApi, addr 0x68909e8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method PermissionGrantedCallback, addr 0x688fde4, size 0x84, virtual false, abstract: false, final false
  static inline void PermissionGrantedCallback(::StringW permissionName);

  /// @brief Method RefreshRecenterSpace, addr 0x68911fc, size 0x4, virtual false, abstract: false, final false
  static inline void RefreshRecenterSpace();

  /// @brief Method SetAllowRecentering, addr 0x689116c, size 0x4, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::StringW> const& __cordl_internal_get_m_eyeTrackingPermissionsToRequest() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get_m_eyeTrackingPermissionsToRequest();
  ...
  constexpr void __cordl_internal_set_m_eyeTrackingPermissionsToRequest(::ArrayW<::StringW> value);
  ...
  /// @brief Method .ctor, addr 0x689133c, size 0x144, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ActiveBuildTargetInstance, addr 0x689115c, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::XR::OpenXR::OpenXRSettings> get_ActiveBuildTargetInstance();

  /// @brief Method get_AllowRecentering, addr 0x6891264, size 0x4, virtual false, abstract: false, final false
  static inline bool get_AllowRecentering();

  /// @brief Method get_FloorOffset, addr 0x68912d4, size 0x4, virtual false, abstract: false, final false
  static inline float_t get_FloorOffset();

  /// @brief Method get_Instance, addr 0x6891164, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::XR::OpenXR::OpenXRSettings> get_Instance();

  /// @brief Method get_autoColorSubmissionMode, addr 0x688f7d0, size 0x8, virtual false, abstract: false, final false
  inline bool get_autoColorSubmissionMode();

  /// @brief Method get_colorSubmissionModes, addr 0x688f7e0, size 0x294, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup> get_colorSubmissionModes();

  /// @brief Method get_depthSubmissionMode, addr 0x688ff98, size 0xf4, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::OpenXR::OpenXRSettings_DepthSubmissionMode get_depthSubmissionMode();

  /// @brief Method get_featureCount, addr 0x688f018, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_featureCount();

  /// @brief Method get_foveatedRenderingApi, addr 0x6890cdc, size 0xf4, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::OpenXR::OpenXRSettings_BackendFovationApi get_foveatedRenderingApi();

  /// @brief Method get_optimizeBufferDiscards, addr 0x6890538, size 0x8, virtual false, abstract: false, final false
  inline bool get_optimizeBufferDiscards();

  /// @brief Method get_renderMode, addr 0x688f500, size 0xf4, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::OpenXR::OpenXRSettings_RenderMode get_renderMode();

  /// @brief Method get_spacewarpMotionVectorTextureFormat, addr 0x6890268, size 0xf4, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::OpenXR::OpenXRSettings_SpaceWarpMotionVectorTextureFormat get_spacewarpMotionVectorTextureFormat();

  /// @brief Method get_symmetricProjection, addr 0x6890bd4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_autoColorSubmissionMode, addr 0x688f7d8, size 0x8, virtual false, abstract: false, final false
  inline void set_autoColorSubmissionMode(bool value);

  /// @brief Method set_colorSubmissionModes, addr 0x688fb5c, size 0x1fc, virtual false, abstract: false, final false
  inline void set_colorSubmissionModes(::ArrayW<::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup> value);

  /// @brief Method set_depthSubmissionMode, addr 0x68900f0, size 0xfc, virtual false, abstract: false, final false
  inline void set_depthSubmissionMode(::UnityEngine::XR::OpenXR::OpenXRSettings_DepthSubmissionMode value);

  /// @brief Method set_foveatedRenderingApi, addr 0x6890e34, size 0xfc, virtual false, abstract: false, final false
  inline void set_foveatedRenderingApi(::UnityEngine::XR::OpenXR::OpenXRSettings_BackendFovationApi value);

  /// @brief Method set_optimizeBufferDiscards, addr 0x6890540, size 0x100, virtual false, abstract: false, final false
  inline void set_optimizeBufferDiscards(bool value);

  /// @brief Method set_renderMode, addr 0x688f658, size 0xfc, virtual false, abstract: false, final false
  inline void set_renderMode(::UnityEngine::XR::OpenXR::OpenXRSettings_RenderMode value);

  /// @brief Method set_spacewarpMotionVectorTextureFormat, addr 0x68903c0, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_symmetricProjection, addr 0x6890bdc, size 0x100, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::OpenXRSettings) == 0x48, "Size mismatch!");
