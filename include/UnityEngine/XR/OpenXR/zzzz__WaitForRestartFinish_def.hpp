...
// Write type traits
MARK_REF_T(::UnityEngine::XR::OpenXR::WaitForRestartFinish*);
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::WaitForRestartFinish*, "UnityEngine.XR.OpenXR", "WaitForRestartFinish");
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::WaitForRestartFinish) == 0x18, "Size mismatch!");
