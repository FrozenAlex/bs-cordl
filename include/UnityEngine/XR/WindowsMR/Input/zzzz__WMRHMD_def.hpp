...
public:
  ...
  /// @brief Method FinishSetup, addr 0x6390388, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6390404, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_userPresence, addr 0x6390378, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_userPresence();

  /// @brief Method set_userPresence, addr 0x6390380, size 0x8, virtual false, abstract: false, final false
