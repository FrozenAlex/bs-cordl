...
public:
  ...
  /// @brief Method Equals, addr 0x6cdf298, size 0xc0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6cdf358, size 0x24, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::XR::MeshId other);

  /// @brief Method GetHashCode, addr 0x6cdf280, size 0x18, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x6cdf1c0, size 0xc0, virtual true, abstract: false, final false
