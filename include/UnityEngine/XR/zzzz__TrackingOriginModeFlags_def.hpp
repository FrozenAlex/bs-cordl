...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::TrackingOriginModeFlags, "UnityEngine.XR", "TrackingOriginModeFlags");
// Dependencies
namespace UnityEngine::XR {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::XR::TrackingOriginModeFlags) == 0x4, "Size mismatch!");
