...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6a3e4dc, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();
  ...
  /// @brief Method .ctor, addr 0x6a3e474, size 0x68, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ApplyOverrides, addr 0x6a3e228, size 0x224, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method Internal_Create, addr 0x6a3df4c, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_Create_Injected, addr 0x6a3dfdc, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method OnInvalidateOverrideController, addr 0x6a3e44c, size 0x28, virtual false, abstract: false, final false
  static inline void OnInvalidateOverrideController(::UnityEngine::AnimatorOverrideController* controller);

  /// @brief Method SendNotification, addr 0x6a3e16c, size 0x80, virtual false, abstract: false, final false
  inline void SendNotification();

  /// @brief Method SendNotification_Injected, addr 0x6a3e1ec, size 0x3c, virtual false, abstract: false, final false
  static inline void SendNotification_Injected(::System::IntPtr _unity_self);

  /// @brief Method SetClip, addr 0x6a3e020, size 0xf0, virtual false, abstract: false, final false
  inline void SetClip(::UnityEngine::AnimationClip* originalClip, ::UnityEngine::AnimationClip* overrideClip, bool notify);

  /// @brief Method SetClip_Injected, addr 0x6a3e110, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a3dec4, size 0x30, virtual false, abstract: false, final false
