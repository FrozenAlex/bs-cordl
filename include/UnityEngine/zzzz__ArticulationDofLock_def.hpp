...
DEFINE_IL2CPP_CLASS(::UnityEngine::ArticulationDofLock, "UnityEngine", "ArticulationDofLock");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ArticulationDofLock) == 0x4, "Size mismatch!");
