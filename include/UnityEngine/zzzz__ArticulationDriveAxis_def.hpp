...
DEFINE_IL2CPP_CLASS(::UnityEngine::ArticulationDriveAxis, "UnityEngine", "ArticulationDriveAxis");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ArticulationDriveAxis) == 0x4, "Size mismatch!");
