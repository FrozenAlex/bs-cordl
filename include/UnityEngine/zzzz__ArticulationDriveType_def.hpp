...
DEFINE_IL2CPP_CLASS(::UnityEngine::ArticulationDriveType, "UnityEngine", "ArticulationDriveType");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ArticulationDriveType) == 0x4, "Size mismatch!");
