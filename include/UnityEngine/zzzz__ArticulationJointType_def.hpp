...
DEFINE_IL2CPP_CLASS(::UnityEngine::ArticulationJointType, "UnityEngine", "ArticulationJointType");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ArticulationJointType) == 0x4, "Size mismatch!");
