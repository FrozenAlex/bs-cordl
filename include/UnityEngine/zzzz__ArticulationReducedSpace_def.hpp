...
public:
  ...
  /// @brief Method .ctor, addr 0x6a1b4c0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(float_t a);

  /// @brief Method .ctor, addr 0x6a1b4d0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(float_t a, float_t b);

  /// @brief Method .ctor, addr 0x6a1b4e0, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(float_t a, float_t b, float_t c);

  /// @brief Method get_Item, addr 0x6a1b420, size 0x50, virtual false, abstract: false, final false
  inline float_t get_Item(int32_t i);

  /// @brief Method set_Item, addr 0x6a1b470, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ArticulationReducedSpace) == 0x10, "Size mismatch!");
