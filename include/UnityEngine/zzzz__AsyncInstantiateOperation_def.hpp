...
public:
  ...
  /// @brief Method CreateResultArray, addr 0x69834fc, size 0x60, virtual true, abstract: false, final false
  inline ::ArrayW<::UnityW<::UnityEngine::Object>> CreateResultArray(int32_t size);

  /// @brief Method IsCancellationRequested, addr 0x6983488, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x698342c, size 0x5c, virtual false, abstract: false, final false
