...
MARK_REF_T(::UnityEngine::AudioSettings_Mobile*);
...
DEFINE_IL2CPP_CLASS(::UnityEngine::AudioSettings_Mobile*, "UnityEngine", "AudioSettings/Mobile");
...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x68f0374, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68f0308, size 0x6c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InvokeIsStopAudioOutputOnMuteEnabled, addr 0x68f0684, size 0x4c, virtual false, abstract: false, final false
  static inline bool InvokeIsStopAudioOutputOnMuteEnabled();

  /// @brief Method InvokeOnMuteStateChanged, addr 0x68f0474, size 0x1c0, virtual false, abstract: false, final false
  static inline void InvokeOnMuteStateChanged(bool mute);

  /// @brief Method StartAudioOutput, addr 0x68f065c, size 0x28, virtual false, abstract: false, final false
  static inline void StartAudioOutput();

  /// @brief Method StopAudioOutput, addr 0x68f0634, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_muteState, addr 0x68f0388, size 0x4c, virtual false, abstract: false, final false
  static inline bool get_muteState();

  /// @brief Method get_stopAudioOutputOnMute, addr 0x68f0428, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_muteState, addr 0x68f03d4, size 0x54, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::AudioSettings_Mobile) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetConfiguration, addr 0x68efef4, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityEngine::AudioConfiguration GetConfiguration();

  /// @brief Method GetConfiguration_Injected, addr 0x68eff54, size 0x3c, virtual false, abstract: false, final false
  static inline void GetConfiguration_Injected(::by_ref<::UnityEngine::AudioConfiguration> ret);

  /// @brief Method GetSampleRate, addr 0x68efd7c, size 0x28, virtual false, abstract: false, final false
  static inline int32_t GetSampleRate();

  /// @brief Method GetSpatializerPluginName, addr 0x68efdf4, size 0xc4, virtual false, abstract: false, final false
  static inline ::StringW GetSpatializerPluginName();

  /// @brief Method GetSpatializerPluginName_Injected, addr 0x68efeb8, size 0x3c, virtual false, abstract: false, final false
  static inline void GetSpatializerPluginName_Injected(::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper> ret);

  /// @brief Method InvokeOnAudioConfigurationChanged, addr 0x68f0178, size 0x70, virtual false, abstract: false, final false
  static inline void InvokeOnAudioConfigurationChanged(bool deviceWasChanged);

  /// @brief Method InvokeOnAudioSystemShuttingDown, addr 0x68f01e8, size 0x68, virtual false, abstract: false, final false
  static inline void InvokeOnAudioSystemShuttingDown();

  /// @brief Method InvokeOnAudioSystemStartedUp, addr 0x68f0250, size 0x68, virtual false, abstract: false, final false
  static inline void InvokeOnAudioSystemStartedUp();

  /// @brief Method Reset, addr 0x68eff90, size 0x50, virtual false, abstract: false, final false
  static inline bool Reset(::UnityEngine::AudioConfiguration config);

  /// @brief Method SetConfiguration, addr 0x68efd04, size 0x3c, virtual false, abstract: false, final false
  static inline bool SetConfiguration(::UnityEngine::AudioConfiguration config);

  /// @brief Method SetConfiguration_Injected, addr 0x68efd40, size 0x3c, virtual false, abstract: false, final false
  static inline bool SetConfiguration_Injected(::by_ref<::UnityEngine::AudioConfiguration> config);

  /// @brief Method StartAudioOutput, addr 0x68f02b8, size 0x28, virtual false, abstract: false, final false
  static inline bool StartAudioOutput();

  /// @brief Method StopAudioOutput, addr 0x68f02e0, size 0x28, virtual false, abstract: false, final false
  static inline bool StopAudioOutput();

  /// @brief Method add_OnAudioConfigurationChanged, addr 0x68effe0, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_dspTime, addr 0x68efda4, size 0x28, virtual false, abstract: false, final false
  static inline double_t get_dspTime();

  /// @brief Method get_outputSampleRate, addr 0x68efdcc, size 0x28, virtual false, abstract: false, final false
  static inline int32_t get_outputSampleRate();

  /// @brief Method remove_OnAudioConfigurationChanged, addr 0x68f00ac, size 0xcc, virtual false, abstract: false, final false
