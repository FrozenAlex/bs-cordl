...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6a44f60, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a44ef4, size 0x6c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InvokeIsStopAudioOutputOnMuteEnabled, addr 0x6a45270, size 0x4c, virtual false, abstract: false, final false
  static inline bool InvokeIsStopAudioOutputOnMuteEnabled();

  /// @brief Method InvokeOnMuteStateChanged, addr 0x6a45060, size 0x1c0, virtual false, abstract: false, final false
  static inline void InvokeOnMuteStateChanged(bool mute);

  /// @brief Method StartAudioOutput, addr 0x6a45248, size 0x28, virtual false, abstract: false, final false
  static inline void StartAudioOutput();

  /// @brief Method StopAudioOutput, addr 0x6a45220, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_muteState, addr 0x6a44f74, size 0x4c, virtual false, abstract: false, final false
  static inline bool get_muteState();

  /// @brief Method get_stopAudioOutputOnMute, addr 0x6a45014, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_muteState, addr 0x6a44fc0, size 0x54, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetConfiguration, addr 0x6a44b30, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityEngine::AudioConfiguration GetConfiguration();

  /// @brief Method GetConfiguration_Injected, addr 0x6a44b90, size 0x3c, virtual false, abstract: false, final false
  static inline void GetConfiguration_Injected(::by_ref<::UnityEngine::AudioConfiguration> ret);

  /// @brief Method GetSampleRate, addr 0x6a449b8, size 0x28, virtual false, abstract: false, final false
  static inline int32_t GetSampleRate();

  /// @brief Method GetSpatializerPluginName, addr 0x6a44a30, size 0xc4, virtual false, abstract: false, final false
  static inline ::StringW GetSpatializerPluginName();

  /// @brief Method GetSpatializerPluginName_Injected, addr 0x6a44af4, size 0x3c, virtual false, abstract: false, final false
  static inline void GetSpatializerPluginName_Injected(::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper> ret);

  /// @brief Method InvokeOnAudioConfigurationChanged, addr 0x6a44d64, size 0x70, virtual false, abstract: false, final false
  static inline void InvokeOnAudioConfigurationChanged(bool deviceWasChanged);

  /// @brief Method InvokeOnAudioSystemShuttingDown, addr 0x6a44dd4, size 0x68, virtual false, abstract: false, final false
  static inline void InvokeOnAudioSystemShuttingDown();

  /// @brief Method InvokeOnAudioSystemStartedUp, addr 0x6a44e3c, size 0x68, virtual false, abstract: false, final false
  static inline void InvokeOnAudioSystemStartedUp();

  /// @brief Method StartAudioOutput, addr 0x6a44ea4, size 0x28, virtual false, abstract: false, final false
  static inline bool StartAudioOutput();

  /// @brief Method StopAudioOutput, addr 0x6a44ecc, size 0x28, virtual false, abstract: false, final false
  static inline bool StopAudioOutput();

  /// @brief Method add_OnAudioConfigurationChanged, addr 0x6a44bcc, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_dspTime, addr 0x6a449e0, size 0x28, virtual false, abstract: false, final false
  static inline double_t get_dspTime();

  /// @brief Method get_outputSampleRate, addr 0x6a44a08, size 0x28, virtual false, abstract: false, final false
  static inline int32_t get_outputSampleRate();

  /// @brief Method remove_OnAudioConfigurationChanged, addr 0x6a44c98, size 0xcc, virtual false, abstract: false, final false
