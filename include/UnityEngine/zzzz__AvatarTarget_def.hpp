...
DEFINE_IL2CPP_CLASS(::UnityEngine::AvatarTarget, "UnityEngine", "AvatarTarget");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
public:
  ...
  /// @brief Field LeftFoot value: I32(2)
...
static_assert(sizeof(::UnityEngine::AvatarTarget) == 0x4, "Size mismatch!");
