...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::AwaitableCompletionSource_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::AwaitableCompletionSource_1, "UnityEngine", "AwaitableCompletionSource`1");
