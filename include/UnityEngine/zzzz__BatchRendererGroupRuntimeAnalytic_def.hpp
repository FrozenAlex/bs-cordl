...
public:
  ...
  /// @brief Method CreateBatchRendererGroupRuntimeAnalytic, addr 0x6911d04, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6911c8c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::BatchRendererGroupRuntimeAnalytic) == 0x30, "Size mismatch!");
