...
public:
  ...
  /// @brief Method CreateBatchRendererGroupRuntimeAnalytic, addr 0x6a62e48, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a62dd0, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
