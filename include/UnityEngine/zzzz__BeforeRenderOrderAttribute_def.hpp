...
public:
  ...
  /// @brief Method .ctor, addr 0x692abcc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t order);

  /// @brief Method get_order, addr 0x692abbc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_order();

  /// @brief Method set_order, addr 0x692abc4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::BeforeRenderOrderAttribute) == 0x18, "Size mismatch!");
