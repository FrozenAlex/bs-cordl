...
public:
  ...
  /// @brief Method get_firstVertex, addr 0x6aa9f8c, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_firstVertex();

  /// @brief Method get_vertexCount, addr 0x6aa9f9c, size 0x8, virtual false, abstract: false, final false
