...
DEFINE_IL2CPP_CLASS(::UnityEngine::ClothSkinningCoefficient, "UnityEngine", "ClothSkinningCoefficient");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ClothSkinningCoefficient) == 0x8, "Size mismatch!");
