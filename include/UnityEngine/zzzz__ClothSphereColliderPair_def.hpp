...
DEFINE_IL2CPP_CLASS(::UnityEngine::ClothSphereColliderPair, "UnityEngine", "ClothSphereColliderPair");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ClothSphereColliderPair) == 0x10, "Size mismatch!");
