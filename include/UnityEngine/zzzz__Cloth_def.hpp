...
public:
  ...
  __declspec(property(get = get_capsuleColliders, put = set_capsuleColliders)) ::ArrayW<::UnityW<::UnityEngine::CapsuleCollider>> capsuleColliders;

  __declspec(property(get = get_clothSolverFrequency, put = set_clothSolverFrequency)) float_t clothSolverFrequency;

  __declspec(property(get = get_coefficients, put = set_coefficients)) ::ArrayW<::UnityEngine::ClothSkinningCoefficient> coefficients;
  ...
  __declspec(property(get = get_normals)) ::ArrayW<::UnityEngine::Vector3> normals;
  ...
  __declspec(property(get = get_sphereColliders, put = set_sphereColliders)) ::ArrayW<::UnityEngine::ClothSphereColliderPair> sphereColliders;
  ...
  __declspec(property(get = get_vertices)) ::ArrayW<::UnityEngine::Vector3> vertices;
  ...
  static inline void GetSelfAndInterCollisionIndices_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Bindings::BlittableListWrapper> indices);
  ...
  static inline void GetVirtualParticleIndices_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Bindings::BlittableListWrapper> indicesOutList);
  ...
  static inline void GetVirtualParticleWeights_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Bindings::BlittableListWrapper> weightsOutList);
  ...
  static inline void SetSelfAndInterCollisionIndices_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Bindings::BlittableListWrapper> indices);
  ...
  static inline void SetVirtualParticleIndices_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Bindings::BlittableListWrapper> indicesIn);
  ...
  static inline void SetVirtualParticleWeights_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Bindings::BlittableListWrapper> weights);
  ...
  inline ::ArrayW<::UnityW<::UnityEngine::CapsuleCollider>> get_capsuleColliders();

  /// @brief Method get_capsuleColliders_Injected, addr 0x68ff770, size 0x3c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityW<::UnityEngine::CapsuleCollider>> get_capsuleColliders_Injected(::System::IntPtr _unity_self);
  ...
  inline ::ArrayW<::UnityEngine::ClothSkinningCoefficient> get_coefficients();

  /// @brief Method get_coefficients_Injected, addr 0x68ff564, size 0x44, virtual false, abstract: false, final false
  static inline void get_coefficients_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Bindings::BlittableArrayWrapper> ret);
  ...
  static inline void get_externalAcceleration_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Vector3> ret);
  ...
  static inline void get_normals_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Bindings::BlittableArrayWrapper> ret);
  ...
  static inline void get_randomAcceleration_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Vector3> ret);
  ...
  inline ::ArrayW<::UnityEngine::ClothSphereColliderPair> get_sphereColliders();

  /// @brief Method get_sphereColliders_Injected, addr 0x68ff900, size 0x3c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::ClothSphereColliderPair> get_sphereColliders_Injected(::System::IntPtr _unity_self);
  ...
  static inline void get_vertices_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Bindings::BlittableArrayWrapper> ret);
  ...
  inline void set_capsuleColliders(::ArrayW<::UnityEngine::CapsuleCollider*> value);

  /// @brief Method set_capsuleColliders_Injected, addr 0x68ff83c, size 0x44, virtual false, abstract: false, final false
  static inline void set_capsuleColliders_Injected(::System::IntPtr _unity_self, ::ArrayW<::UnityEngine::CapsuleCollider*> value);
  ...
  inline void set_coefficients(::ArrayW<::UnityEngine::ClothSkinningCoefficient> value);

  /// @brief Method set_coefficients_Injected, addr 0x68ff6ac, size 0x44, virtual false, abstract: false, final false
  static inline void set_coefficients_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper> value);
  ...
  static inline void set_randomAcceleration_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Vector3> value);
  ...
  inline void set_sphereColliders(::ArrayW<::UnityEngine::ClothSphereColliderPair> value);

  /// @brief Method set_sphereColliders_Injected, addr 0x68ff9cc, size 0x44, virtual false, abstract: false, final false
  static inline void set_sphereColliders_Injected(::System::IntPtr _unity_self, ::ArrayW<::UnityEngine::ClothSphereColliderPair> value);
