...
DEFINE_IL2CPP_CLASS(::UnityEngine::ColliderHit, "UnityEngine", "ColliderHit");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
public:
  ...
  /// @brief Method get_collider, addr 0x6a3ee4c, size 0xb4, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Collider> get_collider();

  /// @brief Method get_instanceID, addr 0x6a3ee44, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ColliderHit) == 0x4, "Size mismatch!");
