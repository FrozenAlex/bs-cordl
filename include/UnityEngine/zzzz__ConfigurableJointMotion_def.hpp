...
DEFINE_IL2CPP_CLASS(::UnityEngine::ConfigurableJointMotion, "UnityEngine", "ConfigurableJointMotion");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ConfigurableJointMotion) == 0x4, "Size mismatch!");
