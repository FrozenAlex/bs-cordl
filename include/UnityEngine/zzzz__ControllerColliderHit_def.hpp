...
public:
  ...
  /// @brief Method .ctor, addr 0x6a25078, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_collider, addr 0x6a24e88, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Collider> get_collider();

  /// @brief Method get_controller, addr 0x6a24e80, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::CharacterController> get_controller();

  /// @brief Method get_gameObject, addr 0x6a24ff4, size 0x18, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_gameObject();

  /// @brief Method get_moveDirection, addr 0x6a2503c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_moveDirection();

  /// @brief Method get_moveLength, addr 0x6a25048, size 0x8, virtual false, abstract: false, final false
  inline float_t get_moveLength();

  /// @brief Method get_normal, addr 0x6a25030, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_normal();

  /// @brief Method get_point, addr 0x6a25024, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_point();

  /// @brief Method get_push, addr 0x6a25050, size 0x10, virtual false, abstract: false, final false
  inline bool get_push();

  /// @brief Method get_rigidbody, addr 0x6a24e90, size 0x14, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rigidbody> get_rigidbody();

  /// @brief Method get_transform, addr 0x6a2500c, size 0x18, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_transform();

  /// @brief Method set_push, addr 0x6a25060, size 0x18, virtual false, abstract: false, final false
