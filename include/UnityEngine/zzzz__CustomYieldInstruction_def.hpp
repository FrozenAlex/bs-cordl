...
public:
  ...
  /// @brief Method MoveNext, addr 0x6ad6c40, size 0xc, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::CustomYieldInstruction* New_ctor();

  /// @brief Method Reset, addr 0x6ad6c4c, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method .ctor, addr 0x6ad6c50, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Current, addr 0x6ad6c38, size 0x8, virtual true, abstract: false, final true
