...
public:
  ...
  /// @brief Method .ctor, addr 0x6ad3180, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t order);

  /// @brief Method get_order, addr 0x6ad2fa8, size 0x8, virtual false, abstract: false, final false
