...
DEFINE_IL2CPP_CLASS(::UnityEngine::DisableBatchingType, "UnityEngine", "DisableBatchingType");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::DisableBatchingType) == 0x4, "Size mismatch!");
