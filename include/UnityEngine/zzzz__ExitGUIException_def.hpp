...
public:
  ...
  /// @brief Method .ctor, addr 0x69f6204, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x69efefc, size 0xdc, virtual false, abstract: false, final false
