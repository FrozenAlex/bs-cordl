...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6ac1418, size 0x180, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::UnityEngine::Font_FontTextureRebuildCallback* New_ctor(::System::Object* object, ::System::IntPtr method);

  /// @brief Method .ctor, addr 0x6ac13b0, size 0x68, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateDynamicFontFromOSFont, addr 0x6ac0bb0, size 0xac, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Font> CreateDynamicFontFromOSFont(::StringW fontname, int32_t size);

  /// @brief Method CreateDynamicFontFromOSFont, addr 0x6ac0c5c, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Font> CreateDynamicFontFromOSFont(::ArrayW<::StringW> fontnames, int32_t size);

  /// @brief Method GetCharacterInfo, addr 0x6ac11b0, size 0xc, virtual false, abstract: false, final false
  inline bool GetCharacterInfo(char16_t ch, ::by_ref<::UnityEngine::CharacterInfo> info);

  /// @brief Method GetCharacterInfo, addr 0x6ac11a8, size 0x8, virtual false, abstract: false, final false
  inline bool GetCharacterInfo(char16_t ch, ::by_ref<::UnityEngine::CharacterInfo> info, int32_t size);

  /// @brief Method GetCharacterInfo, addr 0x6ac108c, size 0xb0, virtual false, abstract: false, final false
  inline bool GetCharacterInfo(char16_t ch, ::by_ref<::UnityEngine::CharacterInfo> info, int32_t size, ::UnityEngine::FontStyle style);

  /// @brief Method GetCharacterInfo_Injected, addr 0x6ac113c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDefault, addr 0x6ac0d74, size 0x114, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Font> GetDefault();

  /// @brief Method GetDefault_Injected, addr 0x6ac0e88, size 0x28, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetDefault_Injected();

  /// @brief Method GetMaxVertsForString, addr 0x6ac0d58, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t GetMaxVertsForString(::StringW str);

  /// @brief Method GetOSFallbacks, addr 0x6ac0fdc, size 0x28, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW> GetOSFallbacks();

  /// @brief Method GetOSInstalledFontNames, addr 0x6ac0f8c, size 0x28, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW> GetOSInstalledFontNames();

  /// @brief Method GetPathsToOSFonts, addr 0x6ac0fb4, size 0x28, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW> GetPathsToOSFonts();

  /// @brief Method HasCharacter, addr 0x6ac0eb0, size 0x8, virtual false, abstract: false, final false
  inline bool HasCharacter(char16_t c);

  /// @brief Method HasCharacter, addr 0x6ac0eb8, size 0x90, virtual false, abstract: false, final false
  inline bool HasCharacter(int32_t c);

  /// @brief Method HasCharacter_Injected, addr 0x6ac0f48, size 0x44, virtual false, abstract: false, final false
  static inline bool HasCharacter_Injected(::System::IntPtr _unity_self, int32_t c);

  /// @brief Method Internal_CreateDynamicFont, addr 0x6ac0b5c, size 0x54, virtual false, abstract: false, final false
  static inline void Internal_CreateDynamicFont(::UnityEngine::Font* self, ::ArrayW<::StringW> _names, int32_t size);

  /// @brief Method Internal_CreateFont, addr 0x6ac0798, size 0x134, virtual false, abstract: false, final false
  static inline void Internal_CreateFont(::UnityEngine::Font* self, ::StringW name);

  /// @brief Method Internal_CreateFontFromPath, addr 0x6ac0998, size 0x134, virtual false, abstract: false, final false
  static inline void Internal_CreateFontFromPath(::UnityEngine::Font* self, ::StringW fontPath);

  /// @brief Method Internal_CreateFontFromPath_Injected, addr 0x6ac1048, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_CreateFont_Injected, addr 0x6ac1004, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeTextureRebuilt_Internal, addr 0x6ac0cc8, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method RequestCharactersInTexture, addr 0x6ac13a4, size 0xc, virtual false, abstract: false, final false
  inline void RequestCharactersInTexture(::StringW characters);

  /// @brief Method RequestCharactersInTexture, addr 0x6ac139c, size 0x8, virtual false, abstract: false, final false
  inline void RequestCharactersInTexture(::StringW characters, int32_t size);

  /// @brief Method RequestCharactersInTexture, addr 0x6ac11bc, size 0x184, virtual false, abstract: false, final false
  inline void RequestCharactersInTexture(::StringW characters, int32_t size, ::UnityEngine::FontStyle style);

  /// @brief Method RequestCharactersInTexture_Injected, addr 0x6ac1340, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ac073c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6ac08cc, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x6ac0acc, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::StringW> names, int32_t size);

  /// @brief Method add_m_FontTextureRebuildCallback, addr 0x6abfc58, size 0xac, virtual false, abstract: false, final false
  inline void add_m_FontTextureRebuildCallback(::UnityEngine::Font_FontTextureRebuildCallback* value);

  /// @brief Method add_textureRebuilt, addr 0x6abfa98, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ascent, addr 0x6ac020c, size 0x80, virtual false, abstract: false, final false
  inline int32_t get_ascent();

  /// @brief Method get_ascent_Injected, addr 0x6ac028c, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t get_ascent_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_characterInfo, addr 0x6ac0384, size 0x160, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::CharacterInfo> get_characterInfo();

  /// @brief Method get_characterInfo_Injected, addr 0x6ac04e4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method get_dynamic, addr 0x6abe78c, size 0x80, virtual false, abstract: false, final false
  inline bool get_dynamic();

  /// @brief Method get_dynamic_Injected, addr 0x6ac01d0, size 0x3c, virtual false, abstract: false, final false
  static inline bool get_dynamic_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_fontNames, addr 0x6ac0040, size 0x80, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW> get_fontNames();

  /// @brief Method get_fontNames_Injected, addr 0x6ac00c0, size 0x3c, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW> get_fontNames_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_fontSize, addr 0x6ac02c8, size 0x80, virtual false, abstract: false, final false
  inline int32_t get_fontSize();

  /// @brief Method get_fontSize_Injected, addr 0x6ac0348, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t get_fontSize_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_lineHeight, addr 0x6ac0670, size 0x80, virtual false, abstract: false, final false
  inline int32_t get_lineHeight();

  /// @brief Method get_lineHeight_Injected, addr 0x6ac06f0, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t get_lineHeight_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_material, addr 0x6abfdb0, size 0x150, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_material();

  /// @brief Method get_material_Injected, addr 0x6abff00, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr get_material_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_textureRebuildCallback, addr 0x6ac072c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Font_FontTextureRebuildCallback* get_textureRebuildCallback();

  /// @brief Method remove_m_FontTextureRebuildCallback, addr 0x6abfd04, size 0xac, virtual false, abstract: false, final false
  inline void remove_m_FontTextureRebuildCallback(::UnityEngine::Font_FontTextureRebuildCallback* value);

  /// @brief Method remove_textureRebuilt, addr 0x6abfb78, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_characterInfo, addr 0x6ac0528, size 0x104, virtual false, abstract: false, final false
  inline void set_characterInfo(::ArrayW<::UnityEngine::CharacterInfo> value);

  /// @brief Method set_characterInfo_Injected, addr 0x6ac062c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method set_fontNames, addr 0x6ac00fc, size 0x90, virtual false, abstract: false, final false
  inline void set_fontNames(::ArrayW<::StringW> value);

  /// @brief Method set_fontNames_Injected, addr 0x6ac018c, size 0x44, virtual false, abstract: false, final false
  static inline void set_fontNames_Injected(::System::IntPtr _unity_self, ::ArrayW<::StringW> value);

  /// @brief Method set_material, addr 0x6abff3c, size 0xc0, virtual false, abstract: false, final false
  inline void set_material(::UnityEngine::Material* value);

  /// @brief Method set_material_Injected, addr 0x6abfffc, size 0x44, virtual false, abstract: false, final false
  static inline void set_material_Injected(::System::IntPtr _unity_self, ::System::IntPtr value);

  /// @brief Method set_textureRebuildCallback, addr 0x6ac0734, size 0x8, virtual false, abstract: false, final false
