...
DEFINE_IL2CPP_CLASS(::UnityEngine::JointProjectionMode, "UnityEngine", "JointProjectionMode");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
public:
  ...
  /// @brief Field PositionAndRotation value: I32(1)
...
static_assert(sizeof(::UnityEngine::JointProjectionMode) == 0x4, "Size mismatch!");
