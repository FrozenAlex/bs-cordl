...
public:
  ...
  /// @brief Method Internal_Create, addr 0x6a770e0, size 0x3c, virtual false, abstract: false, final false
  static inline void Internal_Create(::UnityEngine::LightingSettings* self);

  /// @brief Method LightingSettingsDontStripMe, addr 0x6a77064, size 0x4, virtual false, abstract: false, final false
  inline void LightingSettingsDontStripMe();

  static inline ::UnityEngine::LightingSettings* New_ctor();

  /// @brief Method .ctor, addr 0x6a77068, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bakedGI, addr 0x6a7711c, size 0x80, virtual false, abstract: false, final false
  inline bool get_bakedGI();

  /// @brief Method get_bakedGI_Injected, addr 0x6a7719c, size 0x3c, virtual false, abstract: false, final false
  static inline bool get_bakedGI_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_realtimeEnvironmentLighting, addr 0x6a7743c, size 0x80, virtual false, abstract: false, final false
  inline bool get_realtimeEnvironmentLighting();

  /// @brief Method get_realtimeEnvironmentLighting_Injected, addr 0x6a774bc, size 0x3c, virtual false, abstract: false, final false
  static inline bool get_realtimeEnvironmentLighting_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_realtimeGI, addr 0x6a772ac, size 0x80, virtual false, abstract: false, final false
  inline bool get_realtimeGI();

  /// @brief Method get_realtimeGI_Injected, addr 0x6a7732c, size 0x3c, virtual false, abstract: false, final false
  static inline bool get_realtimeGI_Injected(::System::IntPtr _unity_self);

  /// @brief Method set_bakedGI, addr 0x6a771d8, size 0x90, virtual false, abstract: false, final false
  inline void set_bakedGI(bool value);

  /// @brief Method set_bakedGI_Injected, addr 0x6a77268, size 0x44, virtual false, abstract: false, final false
  static inline void set_bakedGI_Injected(::System::IntPtr _unity_self, bool value);

  /// @brief Method set_realtimeEnvironmentLighting, addr 0x6a774f8, size 0x90, virtual false, abstract: false, final false
  inline void set_realtimeEnvironmentLighting(bool value);

  /// @brief Method set_realtimeEnvironmentLighting_Injected, addr 0x6a77588, size 0x44, virtual false, abstract: false, final false
  static inline void set_realtimeEnvironmentLighting_Injected(::System::IntPtr _unity_self, bool value);

  /// @brief Method set_realtimeGI, addr 0x6a77368, size 0x90, virtual false, abstract: false, final false
  inline void set_realtimeGI(bool value);

  /// @brief Method set_realtimeGI_Injected, addr 0x6a773f8, size 0x44, virtual false, abstract: false, final false
