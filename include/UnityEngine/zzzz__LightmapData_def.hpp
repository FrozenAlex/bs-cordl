...
// Write type traits
MARK_REF_T(::UnityEngine::LightmapData*);
DEFINE_IL2CPP_CLASS(::UnityEngine::LightmapData*, "UnityEngine", "LightmapData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6930d74, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::LightmapData) == 0x28, "Size mismatch!");
