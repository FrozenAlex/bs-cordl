...
DEFINE_IL2CPP_CLASS(::UnityEngine::LightmapsModeLegacy, "UnityEngine", "LightmapsModeLegacy");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::LightmapsModeLegacy) == 0x4, "Size mismatch!");
