...
DEFINE_IL2CPP_CLASS(::UnityEngine::MaterialPropertyType, "UnityEngine", "MaterialPropertyType");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::MaterialPropertyType) == 0x4, "Size mismatch!");
