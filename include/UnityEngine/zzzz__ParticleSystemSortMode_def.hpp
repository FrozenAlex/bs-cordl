...
DEFINE_IL2CPP_CLASS(::UnityEngine::ParticleSystemSortMode, "UnityEngine", "ParticleSystemSortMode");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ParticleSystemSortMode) == 0x4, "Size mismatch!");
