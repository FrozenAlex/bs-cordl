...
DEFINE_IL2CPP_CLASS(::UnityEngine::PhysicsMaterialCombine, "UnityEngine", "PhysicsMaterialCombine");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::PhysicsMaterialCombine) == 0x4, "Size mismatch!");
