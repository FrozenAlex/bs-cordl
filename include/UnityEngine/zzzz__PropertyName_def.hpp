...
public:
  ...
  /// @brief Method Equals, addr 0x6981bd8, size 0x7c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method Equals, addr 0x6981c54, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::PropertyName other);

  /// @brief Method GetHashCode, addr 0x6981bd0, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsNullOrEmpty, addr 0x6981bb8, size 0xc, virtual false, abstract: false, final false
  static inline bool IsNullOrEmpty(::UnityEngine::PropertyName prop);

  /// @brief Method ToString, addr 0x6981c68, size 0x98, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x6981b94, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x6981bb0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x6981bc4, size 0xc, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::PropertyName lhs, ::UnityEngine::PropertyName rhs);

  /// @brief Method op_Implicit, addr 0x6981c64, size 0x4, virtual false, abstract: false, final false
