...
public:
  ...
  /// @brief Method CalculateRaycastTexCoord, addr 0x6b90f64, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateRaycastTexCoord_Injected, addr 0x6b90fe4, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method get_articulationBody, addr 0x6b91210, size 0x9c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ArticulationBody> get_articulationBody();

  /// @brief Method get_barycentricCoordinate, addr 0x6b90f30, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_barycentricCoordinate();

  /// @brief Method get_collider, addr 0x6b90e44, size 0xb4, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Collider> get_collider();

  /// @brief Method get_colliderInstanceID, addr 0x6b90ef8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_colliderInstanceID();

  /// @brief Method get_distance, addr 0x6b90f4c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_distance();

  /// @brief Method get_lightmapCoord, addr 0x6b912ac, size 0x104, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_lightmapCoord();

  /// @brief Method get_normal, addr 0x6b90f18, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_normal();

  /// @brief Method get_point, addr 0x6b90f00, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_point();

  /// @brief Method get_rigidbody, addr 0x6b91174, size 0x9c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rigidbody> get_rigidbody();

  /// @brief Method get_textureCoord, addr 0x6b91058, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_textureCoord();

  /// @brief Method get_textureCoord1, addr 0x6b913b0, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_textureCoord1();

  /// @brief Method get_textureCoord2, addr 0x6b91078, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_textureCoord2();

  /// @brief Method get_transform, addr 0x6b91098, size 0xdc, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_transform();

  /// @brief Method get_triangleIndex, addr 0x6b90f5c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_triangleIndex();

  /// @brief Method set_barycentricCoordinate, addr 0x6b90f44, size 0x8, virtual false, abstract: false, final false
  inline void set_barycentricCoordinate(::UnityEngine::Vector3 value);

  /// @brief Method set_distance, addr 0x6b90f54, size 0x8, virtual false, abstract: false, final false
  inline void set_distance(float_t value);

  /// @brief Method set_normal, addr 0x6b90f24, size 0xc, virtual false, abstract: false, final false
  inline void set_normal(::UnityEngine::Vector3 value);

  /// @brief Method set_point, addr 0x6b90f0c, size 0xc, virtual false, abstract: false, final false
