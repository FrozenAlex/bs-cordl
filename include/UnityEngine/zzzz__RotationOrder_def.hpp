...
DEFINE_IL2CPP_CLASS(::UnityEngine::RotationOrder, "UnityEngine", "RotationOrder");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::RotationOrder) == 0x4, "Size mismatch!");
