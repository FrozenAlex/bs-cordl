...
public:
  ...
  /// @brief Method GetFontShader, addr 0x69faa74, size 0x54, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> GetFontShader();

  /// @brief Method GetStaticFallbackOSFontAsset, addr 0x69faac8, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method SetStaticFallbackOSFontAsset, addr 0x69fab14, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69fab64, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_defaultTextSettings, addr 0x69fa9b4, size 0xc0, virtual false, abstract: false, final false
