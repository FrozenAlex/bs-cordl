...
public:
  ...
  /// @brief Method IsManagedCodeWorking, addr 0x698fb60, size 0x8, virtual false, abstract: false, final false
  static inline bool IsManagedCodeWorking();

  /// @brief Method SetupCallbacks, addr 0x698fb68, size 0x4, virtual false, abstract: false, final false
