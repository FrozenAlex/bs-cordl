...
public:
  ...
  /// @brief Method ScheduleBatch, addr 0x6b8ec9c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleBatch, addr 0x6b8ea54, size 0x1ac, virtual false, abstract: false, final false
  static inline ::Unity::Jobs::JobHandle ScheduleBatch(::Unity::Collections::NativeArray_1<::UnityEngine::SpherecastCommand> commands,
                                                       ::Unity::Collections::NativeArray_1<::UnityEngine::RaycastHit> results, int32_t minCommandsPerJob, int32_t maxHits,
                                                       ::Unity::Jobs::JobHandle dependsOn);

  /// @brief Method ScheduleSpherecastBatch, addr 0x6b8ec00, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleSpherecastBatch_Injected, addr 0x6b8ecc0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b8ed4c, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b8e908, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b8ee20, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b8e9d4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_direction, addr 0x6b8ea1c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_direction();

  /// @brief Method get_distance, addr 0x6b8ea34, size 0x8, virtual false, abstract: false, final false
  inline float_t get_distance();

  /// @brief Method get_layerMask, addr 0x6b8ee44, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_layerMask();

  /// @brief Method get_origin, addr 0x6b8e9f4, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_origin();

  /// @brief Method get_physicsScene, addr 0x6b8ea44, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::PhysicsScene get_physicsScene();

  /// @brief Method get_radius, addr 0x6b8ea0c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_radius();

  /// @brief Method set_direction, addr 0x6b8ea28, size 0xc, virtual false, abstract: false, final false
  inline void set_direction(::UnityEngine::Vector3 value);

  /// @brief Method set_distance, addr 0x6b8ea3c, size 0x8, virtual false, abstract: false, final false
  inline void set_distance(float_t value);

  /// @brief Method set_layerMask, addr 0x6b8ee18, size 0x8, virtual false, abstract: false, final false
  inline void set_layerMask(int32_t value);

  /// @brief Method set_origin, addr 0x6b8ea00, size 0xc, virtual false, abstract: false, final false
  inline void set_origin(::UnityEngine::Vector3 value);

  /// @brief Method set_physicsScene, addr 0x6b8ea4c, size 0x8, virtual false, abstract: false, final false
  inline void set_physicsScene(::UnityEngine::PhysicsScene value);

  /// @brief Method set_radius, addr 0x6b8ea14, size 0x8, virtual false, abstract: false, final false
