...
public:
  ...
  /// @brief Method .ctor, addr 0x6ad0658, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6ad0668, size 0xc, virtual false, abstract: false, final false
