...
public:
  ...
  /// @brief Method .ctor, addr 0x69819c0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x69819d0, size 0xc, virtual false, abstract: false, final false
