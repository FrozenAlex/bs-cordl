...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6c0ee68, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Finalize, addr 0x6c0dbfc, size 0xd0, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetCharacters, addr 0x6c0e0d0, size 0x4, virtual false, abstract: false, final false
  inline void GetCharacters(::System::Collections::Generic::List_1<::UnityEngine::UICharInfo>* characters);

  /// @brief Method GetCharactersInternal, addr 0x6c0e0d4, size 0x58, virtual false, abstract: false, final false
  inline void GetCharactersInternal(::System::Object* characters);

  /// @brief Method GetCharactersInternal_Injected, addr 0x6c0ede0, size 0x44, virtual false, abstract: false, final false
  static inline void GetCharactersInternal_Injected(::System::IntPtr _unity_self, ::System::Object* characters);

  /// @brief Method GetLines, addr 0x6c0e12c, size 0x4, virtual false, abstract: false, final false
  inline void GetLines(::System::Collections::Generic::List_1<::UnityEngine::UILineInfo>* lines);

  /// @brief Method GetLinesInternal, addr 0x6c0e130, size 0x58, virtual false, abstract: false, final false
  inline void GetLinesInternal(::System::Object* lines);

  /// @brief Method GetLinesInternal_Injected, addr 0x6c0ee24, size 0x44, virtual false, abstract: false, final false
  static inline void GetLinesInternal_Injected(::System::IntPtr _unity_self, ::System::Object* lines);

  /// @brief Method GetPreferredHeight, addr 0x6c0e2fc, size 0x5c, virtual false, abstract: false, final false
  inline float_t GetPreferredHeight(::StringW str, ::UnityEngine::TextGenerationSettings settings);

  /// @brief Method GetPreferredWidth, addr 0x6c0e1e4, size 0x60, virtual false, abstract: false, final false
  inline float_t GetPreferredWidth(::StringW str, ::UnityEngine::TextGenerationSettings settings);

  /// @brief Method GetVertices, addr 0x6c0e188, size 0x4, virtual false, abstract: false, final false
  inline void GetVertices(::System::Collections::Generic::List_1<::UnityEngine::UIVertex>* vertices);

  /// @brief Method GetVerticesInternal, addr 0x6c0e18c, size 0x58, virtual false, abstract: false, final false
  inline void GetVerticesInternal(::System::Object* vertices);

  /// @brief Method GetVerticesInternal_Injected, addr 0x6c0ed9c, size 0x44, virtual false, abstract: false, final false
  static inline void GetVerticesInternal_Injected(::System::IntPtr _unity_self, ::System::Object* vertices);

  /// @brief Method Internal_Create, addr 0x6c0dbd4, size 0x28, virtual false, abstract: false, final false
  static inline ::System::IntPtr Internal_Create();

  /// @brief Method Internal_Destroy, addr 0x6c0dd18, size 0x3c, virtual false, abstract: false, final false
  static inline void Internal_Destroy(::System::IntPtr ptr);

  /// @brief Method Invalidate, addr 0x6c0e0c8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Populate, addr 0x6c0e244, size 0x4c, virtual false, abstract: false, final false
  inline bool Populate(::StringW str, ::UnityEngine::TextGenerationSettings settings);

  /// @brief Method PopulateAlways, addr 0x6c0e5a8, size 0x108, virtual false, abstract: false, final false
  inline ::UnityEngine::TextGenerationError PopulateAlways(::StringW str, ::UnityEngine::TextGenerationSettings settings);

  /// @brief Method PopulateWithError, addr 0x6c0e51c, size 0x8c, virtual false, abstract: false, final false
  inline ::UnityEngine::TextGenerationError PopulateWithError(::StringW str, ::UnityEngine::TextGenerationSettings settings);

  /// @brief Method PopulateWithErrors, addr 0x6c0e358, size 0x1c4, virtual false, abstract: false, final false
  inline bool PopulateWithErrors(::StringW str, ::UnityEngine::TextGenerationSettings settings, ::UnityEngine::GameObject* context);

  /// @brief Method Populate_Internal, addr 0x6c0e6b0, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method Populate_Internal, addr 0x6c0e9f8, size 0x270, virtual false, abstract: false, final false
  inline bool Populate_Internal(::StringW str, ::UnityEngine::Font* font, ::UnityEngine::Color color, int32_t fontSize, float_t scaleFactor, float_t lineSpacing, ::UnityEngine::FontStyle style,
  ...
  /// @brief Method Populate_Internal_Injected, addr 0x6c0ec68, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method System.IDisposable.Dispose, addr 0x6c0dccc, size 0x4c, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method ValidatedSettings, addr 0x6c0ddb8, size 0x290, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c0da84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6c0da8c, size 0x148, virtual false, abstract: false, final false
  inline void _ctor(int32_t initialCapacity);

  /// @brief Method get_characterCount, addr 0x6c0dd68, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_characterCount();

  /// @brief Method get_characterCountVisible, addr 0x6c0dd54, size 0x14, virtual false, abstract: false, final false
  inline int32_t get_characterCountVisible();

  /// @brief Method get_characterCount_Injected, addr 0x6c0e930, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t get_characterCount_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_characters, addr 0x6c0e88c, size 0x30, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::UnityEngine::UICharInfo>* get_characters();

  /// @brief Method get_lineCount, addr 0x6c0e96c, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_lineCount();

  /// @brief Method get_lineCount_Injected, addr 0x6c0e9bc, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t get_lineCount_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_lines, addr 0x6c0e8bc, size 0x30, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::UnityEngine::UILineInfo>* get_lines();

  /// @brief Method get_rectExtents, addr 0x6c0e290, size 0x6c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_rectExtents();

  /// @brief Method get_rectExtents_Injected, addr 0x6c0e8ec, size 0x44, virtual false, abstract: false, final false
  static inline void get_rectExtents_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Rect> ret);

  /// @brief Method get_verts, addr 0x6c0e85c, size 0x30, virtual false, abstract: false, final false
