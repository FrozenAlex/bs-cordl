...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UnhandledExceptionHandler___c::*)()>(&::UnityEngine::UnhandledExceptionHandler___c::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x6991ba0;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UnhandledExceptionHandler___c::*)(::System::Object*, ::System::UnhandledExceptionEventArgs*)>(
  ...
  constexpr static std::size_t addrs = 0x6991ba4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::UnhandledExceptionHandler___c*>(),
...
inline void UnityEngine::UnhandledExceptionHandler___c::setStaticF___9(::UnityEngine::UnhandledExceptionHandler___c* value) {
  ::cordl_internals::setStaticField<::UnityEngine::UnhandledExceptionHandler___c*, "<>9", ::UnityEngine::UnhandledExceptionHandler___c*>(
      std::forward<::UnityEngine::UnhandledExceptionHandler___c*>(value));
}
...
inline void UnityEngine::UnhandledExceptionHandler___c::setStaticF___9__0_0(::System::UnhandledExceptionEventHandler* value) {
  ::cordl_internals::setStaticField<::System::UnhandledExceptionEventHandler*, "<>9__0_0", ::UnityEngine::UnhandledExceptionHandler___c*>(
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (*)()>(&::UnityEngine::UnhandledExceptionHandler::RegisterUECatcher)> {
  ...
  constexpr static std::size_t addrs = 0x6991a50;
