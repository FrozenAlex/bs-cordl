...
public:
  ...
  /// @brief Method Init, addr 0x6ac2944, size 0xc8, virtual false, abstract: false, final false
  static inline void Init();

  static inline ::UnityEngine::UnityLogWriter* New_ctor();

  /// @brief Method Write, addr 0x6ac2abc, size 0x1c, virtual true, abstract: false, final false
  inline void Write(::ArrayW<char16_t> buffer, int32_t index, int32_t count);

  /// @brief Method Write, addr 0x6ac2aac, size 0x10, virtual true, abstract: false, final false
  inline void Write(::StringW s);

  /// @brief Method Write, addr 0x6ac2a70, size 0x3c, virtual true, abstract: false, final false
  inline void Write(char16_t value);

  /// @brief Method WriteStringToUnityLog, addr 0x6ac27d8, size 0xc, virtual false, abstract: false, final false
  static inline void WriteStringToUnityLog(::StringW s);

  /// @brief Method WriteStringToUnityLogImpl, addr 0x6ac27e4, size 0x124, virtual false, abstract: false, final false
  static inline void WriteStringToUnityLogImpl(::StringW s);

  /// @brief Method WriteStringToUnityLogImpl_Injected, addr 0x6ac2908, size 0x3c, virtual false, abstract: false, final false
  static inline void WriteStringToUnityLogImpl_Injected(::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper> s);

  /// @brief Method .ctor, addr 0x6ac2a0c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Encoding, addr 0x6ac2a68, size 0x8, virtual true, abstract: false, final false
