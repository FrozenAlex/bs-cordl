...
public:
  ...
  /// @brief Method Box, addr 0x68d1e84, size 0x8dc, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertToJNIArray, addr 0x68c3564, size 0xcb4, virtual false, abstract: false, final false
  static inline ::System::IntPtr ConvertToJNIArray(::System::Array* array);

  /// @brief Method CreateJNIArgArray, addr 0x68c42e0, size 0x510, virtual false, abstract: false, final false
  static inline void CreateJNIArgArray(::ArrayW<::System::Object*> args, ::System::Span_1<::UnityEngine::jvalue> ret);

  /// @brief Method CreateJavaProxy, addr 0x68c3480, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateJavaRunnable, addr 0x68c32c8, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::IntPtr CreateJavaRunnable(::UnityEngine::AndroidJavaRunnable* jrunnable);

  /// @brief Method DeleteJNIArgArray, addr 0x68c49b8, size 0x170, virtual false, abstract: false, final false
  static inline void DeleteJNIArgArray(::ArrayW<::System::Object*> args, ::System::Span_1<::UnityEngine::jvalue> jniArgs);

  /// @brief Method GetConstructorID, addr 0x68c4c00, size 0x70, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetConstructorID(::System::IntPtr jclass, ::ArrayW<::System::Object*> args);

  /// @brief Method GetConstructorID, addr 0x68c29c0, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFieldID, addr 0x68c2fb4, size 0x2bc, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetFieldID(::System::IntPtr jclass, ::StringW fieldName, ::StringW signature, bool isStatic);

  /// @brief Method GetMethodID, addr 0x68c4cf0, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMethodID, addr 0x68c2ca4, size 0x228, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetMethodID(::System::IntPtr jclass, ::StringW methodName, ::StringW signature, bool isStatic);

  /// @brief Method GetMethodIDFallback, addr 0x68d6664, size 0x98, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetMethodIDFallback(::System::IntPtr jclass, ::StringW methodName, ::StringW signature, bool isStatic);

  /// @brief Method GetSignature, addr 0x68c5c34, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSignature, addr 0x68c4dd0, size 0xe0c, virtual false, abstract: false, final false
  static inline ::StringW GetSignature(::System::Object* obj);

  /// @brief Method InvokeJavaProxyMethod, addr 0x68d5d10, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method Unbox, addr 0x68d2b5c, size 0xa14, virtual false, abstract: false, final false
  static inline ::System::Object* Unbox(::UnityEngine::AndroidJavaObject* obj);

  /// @brief Method UnboxArray, addr 0x68d5e00, size 0x864, virtual false, abstract: false, final false
  static inline ::System::Object* UnboxArray(::UnityEngine::AndroidJavaObject* obj);

  /// @brief Method .ctor, addr 0x68d66fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
