...
DEFINE_IL2CPP_CLASS(::UnityEngineInternal::Input::NativeInputEventType, "UnityEngineInternal.Input", "NativeInputEventType");
// Dependencies
namespace UnityEngineInternal::Input {
// Is value type: true
...
static_assert(sizeof(::UnityEngineInternal::Input::NativeInputEventType) == 0x4, "Size mismatch!");
