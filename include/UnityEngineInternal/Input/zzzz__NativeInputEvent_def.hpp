...
DEFINE_IL2CPP_CLASS(::UnityEngineInternal::Input::NativeInputEvent, "UnityEngineInternal.Input", "NativeInputEvent");
...
static_assert(sizeof(::UnityEngineInternal::Input::NativeInputEvent) == 0x14, "Size mismatch!");
