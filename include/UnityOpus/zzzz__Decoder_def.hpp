...
// Write type traits
MARK_REF_T(::UnityOpus::Decoder*);
DEFINE_IL2CPP_CLASS(::UnityOpus::Decoder*, "UnityOpus", "Decoder");
// Dependencies System.IntPtr, System.Object, UnityOpus.NumChannels
namespace UnityOpus {
// Is value type: false
...
public:
  ...
  /// @brief Method Decode, addr 0x5754654, size 0x68, virtual false, abstract: false, final false
  inline int32_t Decode(::ArrayW<uint8_t> data, int32_t dataLength, ::ArrayW<float_t> pcm, int32_t decodeFec);

  /// @brief Method Dispose, addr 0x575492c, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x575482c, size 0x34, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x57548dc, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5754490, size 0x130, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityOpus::Decoder) == 0x30, "Size mismatch!");
