...
// Write type traits
MARK_REF_T(::UnityOpus::Encoder*);
DEFINE_IL2CPP_CLASS(::UnityOpus::Encoder*, "UnityOpus", "Encoder");
...
public:
  ...
  inline int32_t Encode(::ArrayW<float_t> pcm, int32_t count, ::ArrayW<uint8_t> output);
...
static_assert(sizeof(::UnityOpus::Encoder) == 0x30, "Size mismatch!");
