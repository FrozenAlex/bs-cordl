...
// Write type traits
MARK_REF_T(::Utility::DateTimeExtensions*);
DEFINE_IL2CPP_CLASS(::Utility::DateTimeExtensions*, "Utility", "DateTimeExtensions");
...
public:
  ...
  /// @brief Method GetSecondsSinceEpoch, addr 0x5dfc9dc, size 0x10c, virtual false, abstract: false, final false
  static inline int32_t GetSecondsSinceEpoch();

  /// @brief Method UnixTimestampToUniversalDateTime, addr 0x5dfcae8, size 0xa0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Utility::DateTimeExtensions) == 0x10, "Size mismatch!");
