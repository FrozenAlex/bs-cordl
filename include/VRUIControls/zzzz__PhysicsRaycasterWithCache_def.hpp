...
// Write type traits
MARK_REF_T(::VRUIControls::PhysicsRaycasterWithCache*);
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6ce0928, size 0x3c, virtual false, abstract: false, final false
...
static_assert(sizeof(::VRUIControls::PhysicsRaycasterWithCache_CachedRaycast) == 0x50, "Size mismatch!");
...
public:
  ...
  /// @brief Method Raycast, addr 0x6ce045c, size 0x4cc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ce0964, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::VRUIControls::PhysicsRaycasterWithCache) == 0x20, "Size mismatch!");
