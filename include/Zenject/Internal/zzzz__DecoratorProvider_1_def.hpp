...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::Internal::DecoratorProvider_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::Internal::DecoratorProvider_1, "Zenject.Internal", "DecoratorProvider`1");
