...
// Write type traits
MARK_REF_T(::Zenject::AddToNewGameObjectComponentProvider*);
DEFINE_IL2CPP_CLASS(::Zenject::AddToNewGameObjectComponentProvider*, "Zenject", "AddToNewGameObjectComponentProvider");
...
public:
  ...
  /// @brief Method GetGameObject, addr 0x6d2e000, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d2dfcc, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ShouldToggleActive, addr 0x6d2dff8, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Zenject::AddToNewGameObjectComponentProvider) == 0x40, "Size mismatch!");
