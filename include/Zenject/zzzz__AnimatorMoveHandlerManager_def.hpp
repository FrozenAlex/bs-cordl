...
// Write type traits
MARK_REF_T(::Zenject::AnimatorMoveHandlerManager*);
DEFINE_IL2CPP_CLASS(::Zenject::AnimatorMoveHandlerManager*, "Zenject", "AnimatorMoveHandlerManager");
...
public:
  ...
  /// @brief Method Construct, addr 0x6d35a38, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnAnimatorMove, addr 0x6d35a40, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6d35ca0, size 0x2d8, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method __zenInjectMethod0, addr 0x6d35bb4, size 0xec, virtual false, abstract: false, final false
  static inline void __zenInjectMethod0(::System::Object* P_0, ::ArrayW<::System::Object*> P_1);

  /// @brief Method .ctor, addr 0x6d35bb0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Zenject::AnimatorMoveHandlerManager) == 0x28, "Size mismatch!");
