...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Zenject::BindInfo::*)()>(&::Zenject::BindInfo::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x6e58278;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Zenject::BindInfo::*)()>(&::Zenject::BindInfo::Dispose)> {
  ...
  constexpr static std::size_t addrs = 0x6e58464;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Zenject::BindInfo::*)(::StringW)>(&::Zenject::BindInfo::SetContextInfo)> {
  ...
  constexpr static std::size_t addrs = 0x6e584c0;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Zenject::BindInfo::*)()>(&::Zenject::BindInfo::Reset)> {
  ...
  constexpr static std::size_t addrs = 0x6e58358;
...
constexpr ::System::Object* const& Zenject::BindInfo::__cordl_internal_get_ConcreteIdentifier() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___ConcreteIdentifier;
}
constexpr void Zenject::BindInfo::__cordl_internal_set_ConcreteIdentifier(::System::Object* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->___ConcreteIdentifier = value;
}
...
constexpr ::System::Object* const& Zenject::BindInfo::__cordl_internal_get_Identifier() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___Identifier;
}
...
constexpr ::System::Collections::Generic::List_1<::System::Type*>* const& Zenject::BindInfo::__cordl_internal_get_ContractTypes() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___ContractTypes;
}
constexpr void Zenject::BindInfo::__cordl_internal_set_ContractTypes(::System::Collections::Generic::List_1<::System::Type*>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->___ContractTypes = value;
}
...
constexpr ::Zenject::BindingCondition* const& Zenject::BindInfo::__cordl_internal_get_Condition() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___Condition;
}
...
constexpr ::System::Collections::Generic::List_1<::System::Type*>* const& Zenject::BindInfo::__cordl_internal_get_ToTypes() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___ToTypes;
}
constexpr void Zenject::BindInfo::__cordl_internal_set_ToTypes(::System::Collections::Generic::List_1<::System::Type*>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->___ToTypes = value;
}
...
constexpr ::System::Collections::Generic::List_1<::Zenject::TypeValuePair>* const& Zenject::BindInfo::__cordl_internal_get_Arguments() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___Arguments;
}
...
constexpr ::System::Action_2<::Zenject::InjectContext*, ::System::Object*>* const& Zenject::BindInfo::__cordl_internal_get_InstantiatedCallback() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___InstantiatedCallback;
}
constexpr void Zenject::BindInfo::__cordl_internal_set_InstantiatedCallback(::System::Action_2<::Zenject::InjectContext*, ::System::Object*>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->___InstantiatedCallback = value;
}
...
inline void Zenject::BindInfo::SetContextInfo(::StringW contextInfo) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::BindInfo*>(), { "SetContextInfo", {}, { ::i2c::type_of<::StringW>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, contextInfo);
}
...
inline ::Zenject::BindInfo* Zenject::BindInfo::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Zenject::BindInfo*>());
}
