...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::BindSignalFromBinder_2);
MARK_GEN_REF_T_PTR(::Zenject::BindSignalFromBinder_2___c);
MARK_GEN_REF_T_PTR(::Zenject::BindSignalFromBinder_2___c__DisplayClass8_0);
