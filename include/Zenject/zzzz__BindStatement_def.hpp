...
// Write type traits
MARK_REF_T(::Zenject::BindStatement*);
DEFINE_IL2CPP_CLASS(::Zenject::BindStatement*, "Zenject", "BindStatement");
...
public:
  ...
  /// @brief Method AddDisposable, addr 0x6e58798, size 0xb4, virtual false, abstract: false, final false
  inline void AddDisposable(::System::IDisposable* disposable);

  /// @brief Method AssertHasFinalizer, addr 0x6e58740, size 0x40, virtual false, abstract: false, final false
  inline void AssertHasFinalizer();

  /// @brief Method Dispose, addr 0x6e5897c, size 0x5c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method FinalizeBinding, addr 0x6e588bc, size 0xc0, virtual false, abstract: false, final false
  inline void FinalizeBinding(::Zenject::DiContainer* container);

  static inline ::Zenject::BindStatement* New_ctor();

  /// @brief Method Reset, addr 0x6e58540, size 0x154, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SetFinalizer, addr 0x6e58790, size 0x8, virtual false, abstract: false, final false
  inline void SetFinalizer(::Zenject::IBindingFinalizer* bindingFinalizer);

  /// @brief Method SpawnBindInfo, addr 0x6e5884c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e584c8, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BindingInheritanceMethod, addr 0x6e58694, size 0xac, virtual false, abstract: false, final false
  inline ::Zenject::BindingInheritanceMethods get_BindingInheritanceMethod();

  /// @brief Method get_HasFinalizer, addr 0x6e58780, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::BindStatement) == 0x20, "Size mismatch!");
