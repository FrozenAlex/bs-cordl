...
// Write type traits
MARK_REF_T(::Zenject::CachedProvider*);
DEFINE_IL2CPP_CLASS(::Zenject::CachedProvider*, "Zenject", "CachedProvider");
...
public:
  ...
  /// @brief Method ClearCache, addr 0x6d2cd2c, size 0x8, virtual false, abstract: false, final false
  inline void ClearCache();

  /// @brief Method GetAllInstancesWithInjectSplit, addr 0x6d2c7b0, size 0x26c, virtual true, abstract: false, final true
  ...
  /// @brief Method GetInstanceType, addr 0x6d2cd34, size 0xb8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6d2c7a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::IProvider* creator);

  /// @brief Method get_IsCached, addr 0x6d2ccfc, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsCached();

  /// @brief Method get_NumInstances, addr 0x6d2cad0, size 0x54, virtual false, abstract: false, final false
  inline int32_t get_NumInstances();

  /// @brief Method get_TypeVariesBasedOnMemberType, addr 0x6d2cd04, size 0x28, virtual true, abstract: false, final true
...
static_assert(sizeof(::Zenject::CachedProvider) == 0x28, "Size mismatch!");
