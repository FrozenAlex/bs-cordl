...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::ConcreteIdBinderGeneric_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::ConcreteIdBinderGeneric_1, "Zenject", "ConcreteIdBinderGeneric`1");
// Dependencies Zenject.ConcreteBinderGeneric`1<TContract>
namespace Zenject {
// cpp template
