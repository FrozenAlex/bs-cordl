...
public:
  ...
  /// @brief Method .ctor, addr 0x6e67000, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <set_NormalInstallerTypes>b__16_0, addr 0x6e67004, size 0xa0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddNormalInstaller, addr 0x6e654b4, size 0xb4, virtual false, abstract: false, final false
  inline void AddNormalInstaller(::Zenject::InstallerBase* installer);

  /// @brief Method AddNormalInstallerType, addr 0x6e6539c, size 0x118, virtual false, abstract: false, final false
  inline void AddNormalInstallerType(::System::Type* installerType);

  /// @brief Method CheckInstallerPrefabTypes, addr 0x6e65568, size 0x3dc, virtual false, abstract: false, final false
  ...
  /// @brief Method InstallInstallers, addr 0x6e65944, size 0x10, virtual true, abstract: false, final false
  inline void InstallInstallers();

  /// @brief Method InstallInstallers, addr 0x6e65954, size 0x674, virtual false, abstract: false, final false
  ...
  /// @brief Method InstallSceneBindings, addr 0x6e6609c, size 0x53c, virtual false, abstract: false, final false
  ...
  /// @brief Method InstallZenjectBinding, addr 0x6e665d8, size 0x68c, virtual false, abstract: false, final false
  ...
  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6e66e64, size 0x148, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x6e66cf4, size 0x170, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_InstallerPrefabs, addr 0x6e64fb0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::Zenject::MonoInstaller>>* get_InstallerPrefabs();

  /// @brief Method get_Installers, addr 0x6e64eec, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::Zenject::MonoInstaller>>* get_Installers();

  /// @brief Method get_NormalInstallerTypes, addr 0x6e65138, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::System::Type*>* get_NormalInstallerTypes();

  /// @brief Method get_NormalInstallers, addr 0x6e652d8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::Zenject::InstallerBase*>* get_NormalInstallers();

  /// @brief Method get_ScriptableObjectInstallers, addr 0x6e65074, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::Zenject::ScriptableObjectInstaller>>* get_ScriptableObjectInstallers();

  /// @brief Method set_InstallerPrefabs, addr 0x6e64fb8, size 0xbc, virtual false, abstract: false, final false
  inline void set_InstallerPrefabs(::System::Collections::Generic::IEnumerable_1<::UnityW<::Zenject::MonoInstaller>>* value);

  /// @brief Method set_Installers, addr 0x6e64ef4, size 0xbc, virtual false, abstract: false, final false
  inline void set_Installers(::System::Collections::Generic::IEnumerable_1<::UnityW<::Zenject::MonoInstaller>>* value);

  /// @brief Method set_NormalInstallerTypes, addr 0x6e65140, size 0x198, virtual false, abstract: false, final false
  inline void set_NormalInstallerTypes(::System::Collections::Generic::IEnumerable_1<::System::Type*>* value);

  /// @brief Method set_NormalInstallers, addr 0x6e652e0, size 0xbc, virtual false, abstract: false, final false
  inline void set_NormalInstallers(::System::Collections::Generic::IEnumerable_1<::Zenject::InstallerBase*>* value);

  /// @brief Method set_ScriptableObjectInstallers, addr 0x6e6507c, size 0xbc, virtual false, abstract: false, final false
