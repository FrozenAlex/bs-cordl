...
public:
  ...
  /// @brief Method <FromAssembliesContaining>b__8_0, addr 0x6cf4250, size 0x24, virtual false, abstract: false, final false
  inline ::System::Reflection::Assembly* _FromAssembliesContaining_b__8_0(::System::Type* t);

  /// @brief Method __zenCreate, addr 0x6cf4274, size 0x44, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6cf42b8, size 0x194, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x6cf424c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <FromAssemblies>b__0, addr 0x6cf444c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method __zenCreate, addr 0x6cf44a8, size 0x44, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6cf44ec, size 0x194, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x6cf412c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method FromAllAssemblies, addr 0x6cf3dd8, size 0x4, virtual false, abstract: false, final false
  inline void FromAllAssemblies();

  /// @brief Method FromAssemblies, addr 0x6cf4084, size 0x4, virtual false, abstract: false, final false
  inline void FromAssemblies(::ArrayW<::System::Reflection::Assembly*> assemblies);

  /// @brief Method FromAssemblies, addr 0x6cf3f18, size 0xc4, virtual false, abstract: false, final false
  inline void FromAssemblies(::System::Collections::Generic::IEnumerable_1<::System::Reflection::Assembly*>* assemblies);

  /// @brief Method FromAssembliesContaining, addr 0x6cf3ddc, size 0x4, virtual false, abstract: false, final false
  inline void FromAssembliesContaining(::ArrayW<::System::Type*> types);

  /// @brief Method FromAssembliesContaining, addr 0x6cf3de0, size 0x138, virtual false, abstract: false, final false
  inline void FromAssembliesContaining(::System::Collections::Generic::IEnumerable_1<::System::Type*>* types);

  /// @brief Method FromAssembliesWhere, addr 0x6cf41e4, size 0x14, virtual false, abstract: false, final false
  inline void FromAssembliesWhere(::System::Func_2<::System::Reflection::Assembly*, bool>* predicate);

  /// @brief Method FromAssembly, addr 0x6cf4088, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method FromThisAssembly, addr 0x6cf3fdc, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cf3dc0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::ConventionBindInfo* bindInfo);

  /// @brief Method get_BindInfo, addr 0x6cf3dc8, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::ConventionBindInfo* get_BindInfo();

  /// @brief Method set_BindInfo, addr 0x6cf3dd0, size 0x8, virtual false, abstract: false, final false
