...
// Write type traits
MARK_REF_T(::Zenject::DeclareSignalIdRequireHandlerAsyncTickPriorityCopyBinder*);
DEFINE_IL2CPP_CLASS(::Zenject::DeclareSignalIdRequireHandlerAsyncTickPriorityCopyBinder*, "Zenject", "DeclareSignalIdRequireHandlerAsyncTickPriorityCopyBinder");
...
public:
  ...
  /// @brief Method WithId, addr 0x6e3e59c, size 0x18, virtual false, abstract: false, final false
  inline ::Zenject::DeclareSignalRequireHandlerAsyncTickPriorityCopyBinder* WithId(::System::Object* identifier);

  /// @brief Method .ctor, addr 0x6e3e554, size 0x24, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::DeclareSignalIdRequireHandlerAsyncTickPriorityCopyBinder) == 0x20, "Size mismatch!");
