...
public:
  ...
  /// @brief Method GetAllInstancesWithInjectSplit, addr 0x6e7f060, size 0x10c, virtual true, abstract: false, final true
  ...
  /// @brief Method GetInstanceType, addr 0x6e7f000, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6e7efe8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::DiContainer* container, ::Zenject::GameObjectCreationParameters* gameObjectBindInfo);

  /// @brief Method get_IsCached, addr 0x6e7eff0, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsCached();

  /// @brief Method get_TypeVariesBasedOnMemberType, addr 0x6e7eff8, size 0x8, virtual true, abstract: false, final true
