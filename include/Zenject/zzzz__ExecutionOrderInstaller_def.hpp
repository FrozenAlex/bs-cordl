...
// Write type traits
MARK_REF_T(::Zenject::ExecutionOrderInstaller*);
DEFINE_IL2CPP_CLASS(::Zenject::ExecutionOrderInstaller*, "Zenject", "ExecutionOrderInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x6d444b8, size 0x12c, virtual true, abstract: false, final false
  ...
  /// @brief Method __zenCreate, addr 0x6d445e4, size 0xf0, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6d446d4, size 0x248, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x6d44468, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::ExecutionOrderInstaller) == 0x20, "Size mismatch!");
