...
namespace Zenject {
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TContract, typename TSubFactory> class FactoryFromBinder_5___c__2_1;
}
namespace Zenject {
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TContract> class FactoryFromBinder_5___c__DisplayClass1_0;
}
namespace Zenject {
...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::FactoryFromBinder_5);
MARK_GEN_REF_T_PTR(::Zenject::FactoryFromBinder_5___c__2_1);
MARK_GEN_REF_T_PTR(::Zenject::FactoryFromBinder_5___c__DisplayClass1_0);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactoryFromBinder_5, "Zenject", "FactoryFromBinder`5");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactoryFromBinder_5___c__2_1, "Zenject", "FactoryFromBinder`5/<>c__2`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactoryFromBinder_5___c__DisplayClass1_0, "Zenject", "FactoryFromBinder`5/<>c__DisplayClass1_0");
...
// Is value type: false
// CS Name: Zenject.FactoryFromBinder`5/<>c__2`1<TParam1,TParam2,TParam3,TParam4,TContract,TSubFactory>
class CORDL_TYPE FactoryFromBinder_5___c__2_1 : public ::System::Object {
public:
  // Declarations
  /// @brief Field <>9, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF___9, put = setStaticF___9)) ::Zenject::FactoryFromBinder_5___c__2_1<TParam1, TParam2, TParam3, TParam4, TContract, TSubFactory>* __9;
  ...
  static inline ::Zenject::FactoryFromBinder_5___c__2_1<TParam1, TParam2, TParam3, TParam4, TContract, TSubFactory>* New_ctor();
  ...
  static inline ::Zenject::FactoryFromBinder_5___c__2_1<TParam1, TParam2, TParam3, TParam4, TContract, TSubFactory>* getStaticF___9();
  ...
  static inline void setStaticF___9(::Zenject::FactoryFromBinder_5___c__2_1<TParam1, TParam2, TParam3, TParam4, TContract, TSubFactory>* value);
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr FactoryFromBinder_5___c__2_1();

public:
  // Ctor Parameters [CppParam { name: "", ty: "FactoryFromBinder_5___c__2_1", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FactoryFromBinder_5___c__2_1(FactoryFromBinder_5___c__2_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FactoryFromBinder_5___c__2_1", modifiers: "const&", def_value: None }]
...
// Is value type: false
// CS Name: Zenject.FactoryFromBinder`5/<>c__DisplayClass1_0<TParam1,TParam2,TParam3,TParam4,TContract>
class CORDL_TYPE FactoryFromBinder_5___c__DisplayClass1_0 : public ::System::Object {
public:
  // Declarations
  /// @brief Field method, offset 0x10, size 0x8
  __declspec(property(get = __cordl_internal_get_method, put = __cordl_internal_set_method)) ::System::Func_6<::Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TContract>* method;

  static inline ::Zenject::FactoryFromBinder_5___c__DisplayClass1_0<TParam1, TParam2, TParam3, TParam4, TContract>* New_ctor();
  ...
  constexpr ::System::Func_6<::Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TContract>* const& __cordl_internal_get_method() const;

  constexpr ::System::Func_6<::Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TContract>*& __cordl_internal_get_method();

  constexpr void __cordl_internal_set_method(::System::Func_6<::Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TContract>* value);
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr FactoryFromBinder_5___c__DisplayClass1_0();

public:
  // Ctor Parameters [CppParam { name: "", ty: "FactoryFromBinder_5___c__DisplayClass1_0", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FactoryFromBinder_5___c__DisplayClass1_0(FactoryFromBinder_5___c__DisplayClass1_0&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FactoryFromBinder_5___c__DisplayClass1_0", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
...
public:
  // Declarations
  template <typename TSubFactory> using __c__2_1 = ::Zenject::FactoryFromBinder_5___c__2_1<TParam1, TParam2, TParam3, TParam4, TContract, TSubFactory>;

  using __c__DisplayClass1_0 = ::Zenject::FactoryFromBinder_5___c__DisplayClass1_0<TParam1, TParam2, TParam3, TParam4, TContract>;
