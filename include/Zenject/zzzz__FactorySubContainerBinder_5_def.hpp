...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::FactorySubContainerBinder_5);
MARK_GEN_REF_T_PTR(::Zenject::FactorySubContainerBinder_5___c__DisplayClass1_0);
MARK_GEN_REF_T_PTR(::Zenject::FactorySubContainerBinder_5___c__DisplayClass2_0);
MARK_GEN_REF_T_PTR(::Zenject::FactorySubContainerBinder_5___c__DisplayClass3_0);
MARK_GEN_REF_T_PTR(::Zenject::FactorySubContainerBinder_5___c__DisplayClass4_0);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactorySubContainerBinder_5, "Zenject", "FactorySubContainerBinder`5");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactorySubContainerBinder_5___c__DisplayClass1_0, "Zenject", "FactorySubContainerBinder`5/<>c__DisplayClass1_0");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactorySubContainerBinder_5___c__DisplayClass2_0, "Zenject", "FactorySubContainerBinder`5/<>c__DisplayClass2_0");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactorySubContainerBinder_5___c__DisplayClass3_0, "Zenject", "FactorySubContainerBinder`5/<>c__DisplayClass3_0");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactorySubContainerBinder_5___c__DisplayClass4_0, "Zenject", "FactorySubContainerBinder`5/<>c__DisplayClass4_0");
