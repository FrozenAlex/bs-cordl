...
inline void Zenject::FactoryToChoiceBinder_2<TParam1, TContract>::_ctor(::Zenject::DiContainer* bindContainer, ::Zenject::BindInfo* bindInfo, ::Zenject::FactoryBindInfo* factoryBindInfo) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::FactoryToChoiceBinder_2<TParam1, TContract>*>(),
...
template <typename TParam1, typename TContract> inline ::Zenject::FactoryFromBinder_2<TParam1, TContract>* Zenject::FactoryToChoiceBinder_2<TParam1, TContract>::ToSelf() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::FactoryToChoiceBinder_2<TParam1, TContract>*>(), { "ToSelf", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<::Zenject::FactoryFromBinder_2<TParam1, TContract>*>(this, ___internal_method);
}
template <typename TParam1, typename TContract> template <typename TConcrete> inline ::Zenject::FactoryFromBinder_2<TParam1, TConcrete>* Zenject::FactoryToChoiceBinder_2<TParam1, TContract>::To() {
  static auto* ___internal_method_base =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::FactoryToChoiceBinder_2<TParam1, TContract>*>(), { "To", { ::i2c::class_of<TConcrete>() }, {} })));
  ...
  return ::cordl_internals::RunMethodRethrow<::Zenject::FactoryFromBinder_2<TParam1, TConcrete>*>(this, ___internal_method);
}
template <typename TParam1, typename TContract>
inline ::Zenject::FactoryToChoiceBinder_2<TParam1, TContract>* Zenject::FactoryToChoiceBinder_2<TParam1, TContract>::New_ctor(::Zenject::DiContainer* bindContainer, ::Zenject::BindInfo* bindInfo,
  ...
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Zenject::FactoryToChoiceBinder_2<TParam1, TContract>*>(bindContainer, bindInfo, factoryBindInfo));
}
// Ctor Parameters []
