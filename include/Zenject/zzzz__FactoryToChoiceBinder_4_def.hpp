...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::FactoryToChoiceBinder_4);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactoryToChoiceBinder_4, "Zenject", "FactoryToChoiceBinder`4");
// Dependencies Zenject.FactoryFromBinder`4<TParam1, TParam2, TParam3, TContract>
namespace Zenject {
// cpp template
