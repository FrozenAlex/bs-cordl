...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::FactoryToChoiceIdBinder_11);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactoryToChoiceIdBinder_11, "Zenject", "FactoryToChoiceIdBinder`11");
