...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Zenject::FixedTickablesTaskUpdater::*)(::Zenject::IFixedTickable*)>(&::Zenject::FixedTickablesTaskUpdater::UpdateItem)> {
  ...
  constexpr static std::size_t addrs = 0x6d3f990;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Zenject::FixedTickablesTaskUpdater*>(), { ::i2c::class_of<::Zenject::FixedTickablesTaskUpdater*>(), 4 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Zenject::FixedTickablesTaskUpdater::*)()>(&::Zenject::FixedTickablesTaskUpdater::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x6d3fa30;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Object* (*)(::ArrayW<::System::Object*>)>(&::Zenject::FixedTickablesTaskUpdater::__zenCreate)> {
  ...
  constexpr static std::size_t addrs = 0x6d3fa7c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::FixedTickablesTaskUpdater*>(), { "__zenCreate", {}, { ::i2c::type_of<::ArrayW<::System::Object*>>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::Zenject::InjectTypeInfo* (*)()>(&::Zenject::FixedTickablesTaskUpdater::__zenCreateInjectTypeInfo)> {
  ...
  constexpr static std::size_t addrs = 0x6d3fad0;
...
inline void Zenject::FixedTickablesTaskUpdater::UpdateItem(::Zenject::IFixedTickable* task) {
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Zenject::FixedTickablesTaskUpdater*>(), 4 })));
...
inline ::System::Object* Zenject::FixedTickablesTaskUpdater::__zenCreate(::ArrayW<::System::Object*> P_0) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::FixedTickablesTaskUpdater*>(), { "__zenCreate", {}, { ::i2c::type_of<::ArrayW<::System::Object*>>() } })));
...
inline ::Zenject::FixedTickablesTaskUpdater* Zenject::FixedTickablesTaskUpdater::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Zenject::FixedTickablesTaskUpdater*>());
}
// Ctor Parameters []
