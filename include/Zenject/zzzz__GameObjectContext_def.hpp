...
// Write type traits
MARK_REF_T(::Zenject::GameObjectContext*);
DEFINE_IL2CPP_CLASS(::Zenject::GameObjectContext*, "Zenject", "GameObjectContext");
...
public:
  ...
  /// @brief Method Construct, addr 0x6e67864, size 0x48, virtual false, abstract: false, final false
  inline void Construct(::Zenject::DiContainer* parentContainer);

  /// @brief Method GetInjectableMonoBehaviours, addr 0x6e67f9c, size 0x248, virtual true, abstract: false, final false
  ...
  /// @brief Method GetRootGameObjects, addr 0x6e677e4, size 0x80, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::GameObject>>* GetRootGameObjects();

  /// @brief Method InstallBindings, addr 0x6e67d08, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method RunInternal, addr 0x6e67954, size 0x39c, virtual true, abstract: false, final false
  ...
  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6e68358, size 0x2cc, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method __zenInjectMethod0, addr 0x6e68260, size 0xf8, virtual false, abstract: false, final false
  static inline void __zenInjectMethod0(::System::Object* P_0, ::ArrayW<::System::Object*> P_1);

  /// @brief Method .ctor, addr 0x6e681f4, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_PostInstall, addr 0x6e673d4, size 0xac, virtual false, abstract: false, final false
  inline void add_PostInstall(::System::Action* value);

  /// @brief Method add_PostResolve, addr 0x6e67684, size 0xac, virtual false, abstract: false, final false
  inline void add_PostResolve(::System::Action* value);

  /// @brief Method add_PreInstall, addr 0x6e6727c, size 0xac, virtual false, abstract: false, final false
  inline void add_PreInstall(::System::Action* value);

  /// @brief Method add_PreResolve, addr 0x6e6752c, size 0xac, virtual false, abstract: false, final false
  inline void add_PreResolve(::System::Action* value);

  /// @brief Method get_Container, addr 0x6e677dc, size 0x8, virtual true, abstract: false, final false
  inline ::Zenject::DiContainer* get_Container();

  /// @brief Method remove_PostInstall, addr 0x6e67480, size 0xac, virtual false, abstract: false, final false
  inline void remove_PostInstall(::System::Action* value);

  /// @brief Method remove_PostResolve, addr 0x6e67730, size 0xac, virtual false, abstract: false, final false
  inline void remove_PostResolve(::System::Action* value);

  /// @brief Method remove_PreInstall, addr 0x6e67328, size 0xac, virtual false, abstract: false, final false
  inline void remove_PreInstall(::System::Action* value);

  /// @brief Method remove_PreResolve, addr 0x6e675d8, size 0xac, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::GameObjectContext) == 0x80, "Size mismatch!");
