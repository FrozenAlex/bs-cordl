...
// Write type traits
MARK_REF_T(::Zenject::GetFromGameObjectGetterComponentProvider*);
DEFINE_IL2CPP_CLASS(::Zenject::GetFromGameObjectGetterComponentProvider*, "Zenject", "GetFromGameObjectGetterComponentProvider");
...
public:
  ...
  /// @brief Method GetAllInstancesWithInjectSplit, addr 0x6e7e89c, size 0x280, virtual true, abstract: false, final true
  ...
  /// @brief Method GetInstanceType, addr 0x6e7e894, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6e7e878, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsCached, addr 0x6e7e884, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsCached();

  /// @brief Method get_TypeVariesBasedOnMemberType, addr 0x6e7e88c, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::Zenject::GetFromGameObjectGetterComponentProvider) == 0x28, "Size mismatch!");
