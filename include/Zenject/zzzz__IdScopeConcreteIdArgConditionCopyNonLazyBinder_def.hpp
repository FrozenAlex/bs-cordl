...
// Write type traits
MARK_REF_T(::Zenject::IdScopeConcreteIdArgConditionCopyNonLazyBinder*);
DEFINE_IL2CPP_CLASS(::Zenject::IdScopeConcreteIdArgConditionCopyNonLazyBinder*, "Zenject", "IdScopeConcreteIdArgConditionCopyNonLazyBinder");
...
public:
  ...
  /// @brief Method WithId, addr 0x6e550c4, size 0x18, virtual false, abstract: false, final false
  inline ::Zenject::ScopeConcreteIdArgConditionCopyNonLazyBinder* WithId(::System::Object* identifier);

  /// @brief Method .ctor, addr 0x6e550bc, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::IdScopeConcreteIdArgConditionCopyNonLazyBinder) == 0x20, "Size mismatch!");
