...
// Write type traits
MARK_REF_T(::Zenject::InjectLocalAttribute*);
DEFINE_IL2CPP_CLASS(::Zenject::InjectLocalAttribute*, "Zenject", "InjectLocalAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce5eec, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Zenject::InjectLocalAttribute) == 0x28, "Size mismatch!");
