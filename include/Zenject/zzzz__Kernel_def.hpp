...
public:
  ...
  /// @brief Method Dispose, addr 0x6e8baa4, size 0x14, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method FixedTick, addr 0x6e8bc54, size 0x14, virtual true, abstract: false, final false
  inline void FixedTick();

  /// @brief Method Initialize, addr 0x6e8ba90, size 0x14, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method LateDispose, addr 0x6e8bab8, size 0x14, virtual true, abstract: false, final false
  inline void LateDispose();

  /// @brief Method LateTick, addr 0x6e8bb90, size 0x14, virtual true, abstract: false, final false
  inline void LateTick();

  static inline ::Zenject::Kernel* New_ctor();

  /// @brief Method Tick, addr 0x6e8bacc, size 0x14, virtual true, abstract: false, final false
  inline void Tick();
  ...
  /// @brief Method __zenCreate, addr 0x6e8bd1c, size 0x44, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6e8c0cc, size 0x478, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method __zenFieldSetter0, addr 0x6e8bd60, size 0x124, virtual false, abstract: false, final false
  static inline void __zenFieldSetter0(::System::Object* P_0, ::System::Object* P_1);

  /// @brief Method __zenFieldSetter1, addr 0x6e8be84, size 0x124, virtual false, abstract: false, final false
  static inline void __zenFieldSetter1(::System::Object* P_0, ::System::Object* P_1);

  /// @brief Method __zenFieldSetter2, addr 0x6e8bfa8, size 0x124, virtual false, abstract: false, final false
  static inline void __zenFieldSetter2(::System::Object* P_0, ::System::Object* P_1);

  /// @brief Method .ctor, addr 0x6e8bd18, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Zenject::Kernel) == 0x28, "Size mismatch!");
