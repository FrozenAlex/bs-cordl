...
public:
  ...
  /// @brief Method .ctor, addr 0x6d08f24, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ExpandMethod, addr 0x6d08f4c, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::PoolExpandMethods get_ExpandMethod();

  /// @brief Method get_InitialSize, addr 0x6d08f5c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_InitialSize();

  /// @brief Method get_MaxSize, addr 0x6d08f6c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MaxSize();

  /// @brief Method get_ShowExpandWarning, addr 0x6d08f3c, size 0x8, virtual false, abstract: false, final false
  inline bool get_ShowExpandWarning();

  /// @brief Method set_ExpandMethod, addr 0x6d08f54, size 0x8, virtual false, abstract: false, final false
  inline void set_ExpandMethod(::Zenject::PoolExpandMethods value);

  /// @brief Method set_InitialSize, addr 0x6d08f64, size 0x8, virtual false, abstract: false, final false
  inline void set_InitialSize(int32_t value);

  /// @brief Method set_MaxSize, addr 0x6d08f74, size 0x8, virtual false, abstract: false, final false
  inline void set_MaxSize(int32_t value);

  /// @brief Method set_ShowExpandWarning, addr 0x6d08f44, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::MemoryPoolBindInfo) == 0x20, "Size mismatch!");
