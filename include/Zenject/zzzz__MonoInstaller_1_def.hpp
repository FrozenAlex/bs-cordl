...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::MonoInstaller_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::MonoInstaller_1, "Zenject", "MonoInstaller`1");
...
public:
  ...
  /// @brief Method InstallFromResource, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  static inline TDerived InstallFromResource(::Zenject::DiContainer* container, ::ArrayW<::System::Object*> extraArgs);

  /// @brief Method InstallFromResource, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  static inline TDerived InstallFromResource(::StringW resourcePath, ::Zenject::DiContainer* container);

  /// @brief Method InstallFromResource, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  static inline TDerived InstallFromResource(::StringW resourcePath, ::Zenject::DiContainer* container, ::ArrayW<::System::Object*> extraArgs);
