...
// Write type traits
MARK_REF_T(::Zenject::MonoKernel*);
DEFINE_IL2CPP_CLASS(::Zenject::MonoKernel*, "Zenject", "MonoKernel");
...
public:
  ...
  /// @brief Method FixedUpdate, addr 0x6e8c58c, size 0x10, virtual true, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method Initialize, addr 0x6e8c550, size 0x2c, virtual false, abstract: false, final false
  inline void Initialize();

  /// @brief Method LateUpdate, addr 0x6e8c59c, size 0x10, virtual true, abstract: false, final false
  inline void LateUpdate();

  static inline ::Zenject::MonoKernel* New_ctor();

  /// @brief Method OnDestroy, addr 0x6e8c5ac, size 0x54, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x6e8c54c, size 0x4, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x6e8c57c, size 0x10, virtual true, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6e8c96c, size 0x42c, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method __zenFieldSetter0, addr 0x6e8c600, size 0x124, virtual false, abstract: false, final false
  static inline void __zenFieldSetter0(::System::Object* P_0, ::System::Object* P_1);

  /// @brief Method __zenFieldSetter1, addr 0x6e8c724, size 0x124, virtual false, abstract: false, final false
  static inline void __zenFieldSetter1(::System::Object* P_0, ::System::Object* P_1);

  /// @brief Method __zenFieldSetter2, addr 0x6e8c848, size 0x124, virtual false, abstract: false, final false
  static inline void __zenFieldSetter2(::System::Object* P_0, ::System::Object* P_1);

  /// @brief Method .ctor, addr 0x6e8b944, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsDestroyed, addr 0x6e8c544, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::MonoKernel) == 0x40, "Size mismatch!");
