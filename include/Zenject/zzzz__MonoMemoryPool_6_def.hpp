...
CORDL_MODULE_EXPORT(MonoMemoryPool_6)
namespace System {
class Object;
}
...
namespace Zenject {
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TParam5, typename TValue> class MonoMemoryPool_6;
}
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::MonoMemoryPool_6);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::MonoMemoryPool_6, "Zenject", "MonoMemoryPool`6");
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr MonoMemoryPool_6();

public:
  // Ctor Parameters [CppParam { name: "", ty: "MonoMemoryPool_6", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MonoMemoryPool_6(MonoMemoryPool_6&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MonoMemoryPool_6", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MonoMemoryPool_6(MonoMemoryPool_6 const&) = delete;
