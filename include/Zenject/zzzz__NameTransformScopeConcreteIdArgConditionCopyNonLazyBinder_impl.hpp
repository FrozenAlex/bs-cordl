...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder::*)(::Zenject::BindInfo*, ::Zenject::GameObjectCreationParameters*)>(
  ...
  constexpr static std::size_t addrs = 0x6d04fb4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder*>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::Zenject::TransformScopeConcreteIdArgConditionCopyNonLazyBinder* (
  ...
  constexpr static std::size_t addrs = 0x6d04fcc;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{},
                     (::i2c::find_method(::i2c::class_of<::Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder*>(), { "WithGameObjectName", {}, { ::i2c::type_of<::StringW>() } })));
    return ___internal_method;
  }
};
...
inline ::Zenject::TransformScopeConcreteIdArgConditionCopyNonLazyBinder* Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder::WithGameObjectName(::StringW gameObjectName) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{},
                   (::i2c::find_method(::i2c::class_of<::Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder*>(), { "WithGameObjectName", {}, { ::i2c::type_of<::StringW>() } })));
  return ::cordl_internals::RunMethodRethrow<::Zenject::TransformScopeConcreteIdArgConditionCopyNonLazyBinder*>(this, ___internal_method, gameObjectName);
}
...
Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder::New_ctor(::Zenject::BindInfo* bindInfo, ::Zenject::GameObjectCreationParameters* gameObjectInfo) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder*>(bindInfo, gameObjectInfo));
}
// Ctor Parameters []
