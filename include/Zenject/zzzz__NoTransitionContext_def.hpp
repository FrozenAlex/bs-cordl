...
// Write type traits
MARK_REF_T(::Zenject::NoTransitionContext*);
DEFINE_IL2CPP_CLASS(::Zenject::NoTransitionContext*, "Zenject", "NoTransitionContext");
...
static_assert(sizeof(::Zenject::NoTransitionContext) == 0x28, "Size mismatch!");
