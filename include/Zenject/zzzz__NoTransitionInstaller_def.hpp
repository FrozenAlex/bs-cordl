...
// Write type traits
MARK_REF_T(::Zenject::NoTransitionInstaller*);
DEFINE_IL2CPP_CLASS(::Zenject::NoTransitionInstaller*, "Zenject", "NoTransitionInstaller");
...
static_assert(sizeof(::Zenject::NoTransitionInstaller) == 0x20, "Size mismatch!");
