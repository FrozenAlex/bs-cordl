...
// Write type traits
MARK_REF_T(::Zenject::NullBindingFinalizer*);
DEFINE_IL2CPP_CLASS(::Zenject::NullBindingFinalizer*, "Zenject", "NullBindingFinalizer");
...
public:
  ...
  /// @brief Method FinalizeBinding, addr 0x6d0b618, size 0x4, virtual true, abstract: false, final true
  inline void FinalizeBinding(::Zenject::DiContainer* container);

  static inline ::Zenject::NullBindingFinalizer* New_ctor();

  /// @brief Method .ctor, addr 0x6d0b61c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BindingInheritanceMethod, addr 0x6d0b610, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::Zenject::NullBindingFinalizer) == 0x10, "Size mismatch!");
