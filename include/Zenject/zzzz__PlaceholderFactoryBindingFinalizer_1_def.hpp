...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::PlaceholderFactoryBindingFinalizer_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PlaceholderFactoryBindingFinalizer_1, "Zenject", "PlaceholderFactoryBindingFinalizer`1");
