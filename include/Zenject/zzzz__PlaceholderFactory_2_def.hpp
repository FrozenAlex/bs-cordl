...
namespace Zenject {
template <typename TParam1, typename TValue> class PlaceholderFactory_2__get_ParamTypes_d__2;
}
// Forward declare root types
namespace Zenject {
template <typename TParam1, typename TValue> class PlaceholderFactory_2;
}
namespace Zenject {
template <typename TParam1, typename TValue> class PlaceholderFactory_2__get_ParamTypes_d__2;
}
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::PlaceholderFactory_2);
MARK_GEN_REF_T_PTR(::Zenject::PlaceholderFactory_2__get_ParamTypes_d__2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PlaceholderFactory_2, "Zenject", "PlaceholderFactory`2");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PlaceholderFactory_2__get_ParamTypes_d__2, "Zenject", "PlaceholderFactory`2/<get_ParamTypes>d__2");
// Dependencies System.Object
namespace Zenject {
// cpp template
template <typename TParam1, typename TValue>
// Is value type: false
// CS Name: Zenject.PlaceholderFactory`2/<get_ParamTypes>d__2<TParam1,TValue>
class CORDL_TYPE PlaceholderFactory_2__get_ParamTypes_d__2 : public ::System::Object {
public:
  // Declarations
  ...
  static inline ::Zenject::PlaceholderFactory_2__get_ParamTypes_d__2<TParam1, TValue>* New_ctor(int32_t __1__state);
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr PlaceholderFactory_2__get_ParamTypes_d__2();

public:
  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_2__get_ParamTypes_d__2", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlaceholderFactory_2__get_ParamTypes_d__2(PlaceholderFactory_2__get_ParamTypes_d__2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_2__get_ParamTypes_d__2", modifiers: "const&", def_value: None }]
...
public:
  // Declarations
  using _get_ParamTypes_d__2 = ::Zenject::PlaceholderFactory_2__get_ParamTypes_d__2<TParam1, TValue>;
