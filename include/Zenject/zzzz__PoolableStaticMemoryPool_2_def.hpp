...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::PoolableStaticMemoryPool_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PoolableStaticMemoryPool_2, "Zenject", "PoolableStaticMemoryPool`2");
