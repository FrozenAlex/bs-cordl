...
// Write type traits
MARK_REF_T(::Zenject::PrefabProviderResource*);
DEFINE_IL2CPP_CLASS(::Zenject::PrefabProviderResource*, "Zenject", "PrefabProviderResource");
...
public:
  ...
  /// @brief Method GetPrefab, addr 0x6d30ebc, size 0xd8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6d30eb4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::PrefabProviderResource) == 0x18, "Size mismatch!");
