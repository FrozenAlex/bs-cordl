...
CORDL_MODULE_EXPORT(PrefabResourceFactory_4)
namespace System {
class Object;
}
namespace Zenject {
...
namespace Zenject {
template <typename P1, typename P2, typename P3, typename T> class PrefabResourceFactory_4;
}
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::PrefabResourceFactory_4);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PrefabResourceFactory_4, "Zenject", "PrefabResourceFactory`4");
// Dependencies System.Object
namespace Zenject {
// cpp template
template <typename P1, typename P2, typename P3, typename T>
// Is value type: false
// CS Name: Zenject.PrefabResourceFactory`4<P1,P2,P3,T>
class CORDL_TYPE PrefabResourceFactory_4 : public ::System::Object {
public:
  // Declarations
  ...
  constexpr operator ::Zenject::IFactory_5<::StringW, P1, P2, P3, T>*() noexcept;

  /// @brief Method Create, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
  inline T Create(::StringW prefabResourceName, P1 param, P2 param2, P3 param3);

  static inline ::Zenject::PrefabResourceFactory_4<P1, P2, P3, T>* New_ctor();
  ...
  constexpr ::Zenject::IFactory_5<::StringW, P1, P2, P3, T>* i___Zenject__IFactory_5___StringW_P1_P2_P3_T_() noexcept;

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr PrefabResourceFactory_4();

public:
  // Ctor Parameters [CppParam { name: "", ty: "PrefabResourceFactory_4", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PrefabResourceFactory_4(PrefabResourceFactory_4&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PrefabResourceFactory_4", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PrefabResourceFactory_4(PrefabResourceFactory_4 const&) = delete;
