...
DEFINE_IL2CPP_CLASS(::Zenject::ReflectionBakingCoverageModes, "Zenject", "ReflectionBakingCoverageModes");
// Dependencies
namespace Zenject {
// Is value type: true
...
static_assert(sizeof(::Zenject::ReflectionBakingCoverageModes) == 0x4, "Size mismatch!");
