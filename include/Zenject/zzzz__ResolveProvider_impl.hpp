...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Zenject::ResolveProvider::*)(::System::Type*, ::Zenject::DiContainer*, ::System::Object*, bool, ::Zenject::InjectSources, bool)>(
    &::Zenject::ResolveProvider::_ctor)> {
  constexpr static std::size_t size = 0x18;
  constexpr static std::size_t addrs = 0x6e81720;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{},
        (::i2c::find_method(::i2c::class_of<::Zenject::ResolveProvider*>(), { ".ctor",
                                                                              {},
                                                                              { ::i2c::type_of<::System::Type*>(), ::i2c::type_of<::Zenject::DiContainer*>(), ::i2c::type_of<::System::Object*>(),
                                                                                ::i2c::type_of<bool>(), ::i2c::type_of<::Zenject::InjectSources>(), ::i2c::type_of<bool>() } })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::Zenject::ResolveProvider::*)()>(&::Zenject::ResolveProvider::get_IsCached)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6e81738;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::ResolveProvider*>(), { "get_IsCached", {}, {} })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::Zenject::ResolveProvider::*)()>(&::Zenject::ResolveProvider::get_TypeVariesBasedOnMemberType)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6e81740;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::ResolveProvider*>(), { "get_TypeVariesBasedOnMemberType", {}, {} })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Type* (::Zenject::ResolveProvider::*)(::Zenject::InjectContext*)>(&::Zenject::ResolveProvider::GetInstanceType)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6e81748;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::ResolveProvider*>(), { "GetInstanceType", {}, { ::i2c::type_of<::Zenject::InjectContext*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Zenject::ResolveProvider::*)(::Zenject::InjectContext*, ::System::Collections::Generic::List_1<::Zenject::TypeValuePair>*,
  ...
  constexpr static std::size_t addrs = 0x6e81750;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::ResolveProvider*>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::Zenject::InjectContext* (::Zenject::ResolveProvider::*)(::Zenject::InjectContext*)>(&::Zenject::ResolveProvider::GetSubContext)> {
  constexpr static std::size_t size = 0x44;
  constexpr static std::size_t addrs = 0x6e818f0;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::ResolveProvider*>(), { "GetSubContext", {}, { ::i2c::type_of<::Zenject::InjectContext*>() } })));
    return ___internal_method;
  }
};
...
constexpr ::System::Object* const& Zenject::ResolveProvider::__cordl_internal_get__identifier() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____identifier;
}
...
constexpr ::Zenject::DiContainer* const& Zenject::ResolveProvider::__cordl_internal_get__container() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____container;
}
...
constexpr ::System::Type* const& Zenject::ResolveProvider::__cordl_internal_get__contractType() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____contractType;
}
constexpr void Zenject::ResolveProvider::__cordl_internal_set__contractType(::System::Type* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____contractType = value;
}
...
inline void Zenject::ResolveProvider::_ctor(::System::Type* contractType, ::Zenject::DiContainer* container, ::System::Object* identifier, bool isOptional, ::Zenject::InjectSources source,
  ...
  static auto* ___internal_method = THROW_UNLESS(
      ...
      (::i2c::find_method(::i2c::class_of<::Zenject::ResolveProvider*>(), { ".ctor",
                                                                            ...
                                                                            { ::i2c::type_of<::System::Type*>(), ::i2c::type_of<::Zenject::DiContainer*>(), ::i2c::type_of<::System::Object*>(),
                                                                              ::i2c::type_of<bool>(), ::i2c::type_of<::Zenject::InjectSources>(), ::i2c::type_of<bool>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, contractType, container, identifier, isOptional, source, matchAll);
}
...
inline ::Zenject::ResolveProvider* Zenject::ResolveProvider::New_ctor(::System::Type* contractType, ::Zenject::DiContainer* container, ::System::Object* identifier, bool isOptional,
  ...
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Zenject::ResolveProvider*>(contractType, container, identifier, isOptional, source, matchAll));
}
