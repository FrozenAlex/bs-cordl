...
// Write type traits
MARK_REF_T(::Zenject::SceneKernel*);
DEFINE_IL2CPP_CLASS(::Zenject::SceneKernel*, "Zenject", "SceneKernel");
...
public:
  ...
  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6d3d3c4, size 0x148, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x6d3d3c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Zenject::SceneKernel) == 0x40, "Size mismatch!");
