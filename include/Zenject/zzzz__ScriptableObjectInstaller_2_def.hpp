...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::ScriptableObjectInstaller_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::ScriptableObjectInstaller_2, "Zenject", "ScriptableObjectInstaller`2");
