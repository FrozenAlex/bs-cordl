...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::ScriptableObjectInstaller_3);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::ScriptableObjectInstaller_3, "Zenject", "ScriptableObjectInstaller`3");
