...
public:
  ...
  /// @brief Method .ctor, addr 0x6e3e62c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* signalType);

  /// @brief Method get_Identifier, addr 0x6e3e634, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_Identifier();

  /// @brief Method get_MissingHandlerResponse, addr 0x6e3e674, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::SignalMissingHandlerResponses get_MissingHandlerResponse();

  /// @brief Method get_RunAsync, addr 0x6e3e654, size 0x8, virtual false, abstract: false, final false
  inline bool get_RunAsync();

  /// @brief Method get_SignalType, addr 0x6e3e644, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_SignalType();

  /// @brief Method get_TickPriority, addr 0x6e3e664, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_TickPriority();

  /// @brief Method set_Identifier, addr 0x6e3e63c, size 0x8, virtual false, abstract: false, final false
  inline void set_Identifier(::System::Object* value);

  /// @brief Method set_MissingHandlerResponse, addr 0x6e3e67c, size 0x8, virtual false, abstract: false, final false
  inline void set_MissingHandlerResponse(::Zenject::SignalMissingHandlerResponses value);

  /// @brief Method set_RunAsync, addr 0x6e3e65c, size 0x8, virtual false, abstract: false, final false
  inline void set_RunAsync(bool value);

  /// @brief Method set_SignalType, addr 0x6e3e64c, size 0x8, virtual false, abstract: false, final false
  inline void set_SignalType(::System::Type* value);

  /// @brief Method set_TickPriority, addr 0x6e3e66c, size 0x8, virtual false, abstract: false, final false
