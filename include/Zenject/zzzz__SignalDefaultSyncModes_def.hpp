...
DEFINE_IL2CPP_CLASS(::Zenject::SignalDefaultSyncModes, "Zenject", "SignalDefaultSyncModes");
// Dependencies
namespace Zenject {
// Is value type: true
...
static_assert(sizeof(::Zenject::SignalDefaultSyncModes) == 0x4, "Size mismatch!");
