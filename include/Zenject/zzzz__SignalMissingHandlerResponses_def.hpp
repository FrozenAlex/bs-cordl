...
DEFINE_IL2CPP_CLASS(::Zenject::SignalMissingHandlerResponses, "Zenject", "SignalMissingHandlerResponses");
// Dependencies
namespace Zenject {
// Is value type: true
...
static_assert(sizeof(::Zenject::SignalMissingHandlerResponses) == 0x4, "Size mismatch!");
