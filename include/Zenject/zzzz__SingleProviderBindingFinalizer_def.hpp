...
static_assert(offsetof(::Zenject::SingleProviderBindingFinalizer, ____providerFactory) == 0x20, "Offset mismatch!");

static_assert(sizeof(::Zenject::SingleProviderBindingFinalizer) == 0x28, "Size mismatch!");
