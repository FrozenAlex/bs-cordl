...
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::StaticMemoryPool_7, "Zenject", "StaticMemoryPool`7");
...
public:
  ...
  constexpr ::System::Action_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>* const& __cordl_internal_get__onSpawnMethod() const;
