...
// Write type traits
MARK_REF_T(::Zenject::SubContainerCreatorByInstaller*);
DEFINE_IL2CPP_CLASS(::Zenject::SubContainerCreatorByInstaller*, "Zenject", "SubContainerCreatorByInstaller");
...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x6d323d0, size 0x18c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6d32330, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d32240, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::DiContainer* container, ::Zenject::SubContainerCreatorBindInfo* containerBindInfo, ::System::Type* installerType,
                    ::System::Collections::Generic::IEnumerable_1<::Zenject::TypeValuePair>* extraArgs);
...
static_assert(sizeof(::Zenject::SubContainerCreatorByInstaller) == 0x30, "Size mismatch!");
