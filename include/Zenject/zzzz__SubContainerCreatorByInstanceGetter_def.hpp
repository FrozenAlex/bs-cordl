...
// Write type traits
MARK_REF_T(::Zenject::SubContainerCreatorByInstanceGetter*);
DEFINE_IL2CPP_CLASS(::Zenject::SubContainerCreatorByInstanceGetter*, "Zenject", "SubContainerCreatorByInstanceGetter");
...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x6e82fbc, size 0x88, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6e82fb4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::SubContainerCreatorByInstanceGetter) == 0x18, "Size mismatch!");
