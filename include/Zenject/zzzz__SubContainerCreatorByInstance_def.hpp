...
// Write type traits
MARK_REF_T(::Zenject::SubContainerCreatorByInstance*);
DEFINE_IL2CPP_CLASS(::Zenject::SubContainerCreatorByInstance*, "Zenject", "SubContainerCreatorByInstance");
...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x6e82f48, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6e82f40, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::SubContainerCreatorByInstance) == 0x18, "Size mismatch!");
