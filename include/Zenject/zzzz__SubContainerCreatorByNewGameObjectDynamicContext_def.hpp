...
// Write type traits
MARK_REF_T(::Zenject::SubContainerCreatorByNewGameObjectDynamicContext*);
DEFINE_IL2CPP_CLASS(::Zenject::SubContainerCreatorByNewGameObjectDynamicContext*, "Zenject", "SubContainerCreatorByNewGameObjectDynamicContext");
...
public:
  ...
  /// @brief Method CreateGameObject, addr 0x6d32a7c, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d32a6c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::SubContainerCreatorByNewGameObjectDynamicContext) == 0x20, "Size mismatch!");
