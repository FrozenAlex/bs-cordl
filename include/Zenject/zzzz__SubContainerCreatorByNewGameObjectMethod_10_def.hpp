...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::SubContainerCreatorByNewGameObjectMethod_10);
MARK_GEN_REF_T_PTR(::Zenject::SubContainerCreatorByNewGameObjectMethod_10___c__DisplayClass2_0);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::SubContainerCreatorByNewGameObjectMethod_10, "Zenject", "SubContainerCreatorByNewGameObjectMethod`10");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::SubContainerCreatorByNewGameObjectMethod_10___c__DisplayClass2_0, "Zenject", "SubContainerCreatorByNewGameObjectMethod`10/<>c__DisplayClass2_0");
