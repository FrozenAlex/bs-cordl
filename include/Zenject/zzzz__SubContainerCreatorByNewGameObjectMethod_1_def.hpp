#pragma once
// IWYU pragma private; include "Zenject/SubContainerCreatorByNewGameObjectMethod_1.hpp"
...
namespace Zenject {
template <typename TParam1> class SubContainerCreatorByNewGameObjectMethod_1___c__DisplayClass2_0;
}
namespace Zenject {
...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::SubContainerCreatorByNewGameObjectMethod_1);
MARK_GEN_REF_T_PTR(::Zenject::SubContainerCreatorByNewGameObjectMethod_1___c__DisplayClass2_0);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::SubContainerCreatorByNewGameObjectMethod_1, "Zenject", "SubContainerCreatorByNewGameObjectMethod`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::SubContainerCreatorByNewGameObjectMethod_1___c__DisplayClass2_0, "Zenject", "SubContainerCreatorByNewGameObjectMethod`1/<>c__DisplayClass2_0");
// Dependencies System.Object
namespace Zenject {
// cpp template
template <typename TParam1>
// Is value type: false
// CS Name: Zenject.SubContainerCreatorByNewGameObjectMethod`1/<>c__DisplayClass2_0<TParam1>
class CORDL_TYPE SubContainerCreatorByNewGameObjectMethod_1___c__DisplayClass2_0 : public ::System::Object {
public:
  // Declarations
  /// @brief Field <>4__this, offset 0x10, size 0x8
  __declspec(property(get = __cordl_internal_get___4__this, put = __cordl_internal_set___4__this)) ::Zenject::SubContainerCreatorByNewGameObjectMethod_1<TParam1>* __4__this;
  ...
  static inline ::Zenject::SubContainerCreatorByNewGameObjectMethod_1___c__DisplayClass2_0<TParam1>* New_ctor();
  ...
  constexpr ::Zenject::SubContainerCreatorByNewGameObjectMethod_1<TParam1>* const& __cordl_internal_get___4__this() const;

  constexpr ::Zenject::SubContainerCreatorByNewGameObjectMethod_1<TParam1>*& __cordl_internal_get___4__this();
  ...
  constexpr void __cordl_internal_set___4__this(::Zenject::SubContainerCreatorByNewGameObjectMethod_1<TParam1>* value);
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr SubContainerCreatorByNewGameObjectMethod_1___c__DisplayClass2_0();

public:
  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByNewGameObjectMethod_1___c__DisplayClass2_0", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubContainerCreatorByNewGameObjectMethod_1___c__DisplayClass2_0(SubContainerCreatorByNewGameObjectMethod_1___c__DisplayClass2_0&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByNewGameObjectMethod_1___c__DisplayClass2_0", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubContainerCreatorByNewGameObjectMethod_1___c__DisplayClass2_0(SubContainerCreatorByNewGameObjectMethod_1___c__DisplayClass2_0 const&) = delete;
...
public:
  // Declarations
  using __c__DisplayClass2_0 = ::Zenject::SubContainerCreatorByNewGameObjectMethod_1___c__DisplayClass2_0<TParam1>;
