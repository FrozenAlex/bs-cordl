...
namespace Zenject {
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TParam5> class SubContainerCreatorByNewGameObjectMethod_5___c__DisplayClass2_0;
}
namespace Zenject {
...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::SubContainerCreatorByNewGameObjectMethod_5);
...
// Is value type: false
// CS Name: Zenject.SubContainerCreatorByNewGameObjectMethod`5/<>c__DisplayClass2_0<TParam1,TParam2,TParam3,TParam4,TParam5>
class CORDL_TYPE SubContainerCreatorByNewGameObjectMethod_5___c__DisplayClass2_0 : public ::System::Object {
public:
  // Declarations
  /// @brief Field <>4__this, offset 0x10, size 0x8
  __declspec(property(get = __cordl_internal_get___4__this,
                      put = __cordl_internal_set___4__this)) ::Zenject::SubContainerCreatorByNewGameObjectMethod_5<TParam1, TParam2, TParam3, TParam4, TParam5>* __4__this;
  ...
  static inline ::Zenject::SubContainerCreatorByNewGameObjectMethod_5___c__DisplayClass2_0<TParam1, TParam2, TParam3, TParam4, TParam5>* New_ctor();
  ...
  constexpr ::Zenject::SubContainerCreatorByNewGameObjectMethod_5<TParam1, TParam2, TParam3, TParam4, TParam5>* const& __cordl_internal_get___4__this() const;

  constexpr ::Zenject::SubContainerCreatorByNewGameObjectMethod_5<TParam1, TParam2, TParam3, TParam4, TParam5>*& __cordl_internal_get___4__this();
  ...
  constexpr void __cordl_internal_set___4__this(::Zenject::SubContainerCreatorByNewGameObjectMethod_5<TParam1, TParam2, TParam3, TParam4, TParam5>* value);
...
public:
  // Declarations
  using __c__DisplayClass2_0 = ::Zenject::SubContainerCreatorByNewGameObjectMethod_5___c__DisplayClass2_0<TParam1, TParam2, TParam3, TParam4, TParam5>;
