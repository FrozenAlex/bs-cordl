...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::SubContainerCreatorByNewPrefabMethod_1);
MARK_GEN_REF_T_PTR(::Zenject::SubContainerCreatorByNewPrefabMethod_1___c__DisplayClass2_0);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::SubContainerCreatorByNewPrefabMethod_1, "Zenject", "SubContainerCreatorByNewPrefabMethod`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::SubContainerCreatorByNewPrefabMethod_1___c__DisplayClass2_0, "Zenject", "SubContainerCreatorByNewPrefabMethod`1/<>c__DisplayClass2_0");
