#pragma once
// IWYU pragma private; include "Zenject/SubContainerCreatorByNewPrefabMethod_4.hpp"
...
namespace Zenject {
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4> class SubContainerCreatorByNewPrefabMethod_4___c__DisplayClass2_0;
}
namespace Zenject {
...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::SubContainerCreatorByNewPrefabMethod_4);
MARK_GEN_REF_T_PTR(::Zenject::SubContainerCreatorByNewPrefabMethod_4___c__DisplayClass2_0);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::SubContainerCreatorByNewPrefabMethod_4, "Zenject", "SubContainerCreatorByNewPrefabMethod`4");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::SubContainerCreatorByNewPrefabMethod_4___c__DisplayClass2_0, "Zenject", "SubContainerCreatorByNewPrefabMethod`4/<>c__DisplayClass2_0");
// Dependencies System.Object
namespace Zenject {
// cpp template
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4>
// Is value type: false
// CS Name: Zenject.SubContainerCreatorByNewPrefabMethod`4/<>c__DisplayClass2_0<TParam1,TParam2,TParam3,TParam4>
class CORDL_TYPE SubContainerCreatorByNewPrefabMethod_4___c__DisplayClass2_0 : public ::System::Object {
public:
  // Declarations
  ...
  static inline ::Zenject::SubContainerCreatorByNewPrefabMethod_4___c__DisplayClass2_0<TParam1, TParam2, TParam3, TParam4>* New_ctor();
  ...
  constexpr ::Zenject::SubContainerCreatorByNewPrefabMethod_4<TParam1, TParam2, TParam3, TParam4>* const& __cordl_internal_get___4__this() const;
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr SubContainerCreatorByNewPrefabMethod_4___c__DisplayClass2_0();

public:
  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByNewPrefabMethod_4___c__DisplayClass2_0", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubContainerCreatorByNewPrefabMethod_4___c__DisplayClass2_0(SubContainerCreatorByNewPrefabMethod_4___c__DisplayClass2_0&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByNewPrefabMethod_4___c__DisplayClass2_0", modifiers: "const&", def_value: None }]
...
public:
  // Declarations
  using __c__DisplayClass2_0 = ::Zenject::SubContainerCreatorByNewPrefabMethod_4___c__DisplayClass2_0<TParam1, TParam2, TParam3, TParam4>;
