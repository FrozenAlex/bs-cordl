...
// Write type traits
MARK_REF_T(::Zenject::SubContainerCreatorByNewPrefabMethod*);
DEFINE_IL2CPP_CLASS(::Zenject::SubContainerCreatorByNewPrefabMethod*, "Zenject", "SubContainerCreatorByNewPrefabMethod");
...
public:
  ...
  /// @brief Method AddInstallers, addr 0x6e840b8, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e840ac, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::SubContainerCreatorByNewPrefabMethod) == 0x30, "Size mismatch!");
