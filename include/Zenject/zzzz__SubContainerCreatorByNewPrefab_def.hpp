...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x6d33124, size 0x1b4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6d33118, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::SubContainerCreatorByNewPrefab) == 0x28, "Size mismatch!");
