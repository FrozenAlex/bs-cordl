...
DEFINE_IL2CPP_CLASS(::Zenject::ValidationErrorResponses, "Zenject", "ValidationErrorResponses");
// Dependencies
namespace Zenject {
// Is value type: true
...
static_assert(sizeof(::Zenject::ValidationErrorResponses) == 0x4, "Size mismatch!");
