...
public:
  ...
  /// @brief Method WithKernel, addr 0x6d081dc, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d055f0, size 0xc, virtual false, abstract: false, final false
