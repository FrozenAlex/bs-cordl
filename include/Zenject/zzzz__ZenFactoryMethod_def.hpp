...
// Write type traits
MARK_REF_T(::Zenject::ZenFactoryMethod*);
DEFINE_IL2CPP_CLASS(::Zenject::ZenFactoryMethod*, "Zenject", "ZenFactoryMethod");
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x6e35ef4, size 0x20, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::ArrayW<::System::Object*> args, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x6e35f14, size 0xc, virtual true, abstract: false, final false
  inline ::System::Object* EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x6e35ee0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e35d9c, size 0x144, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::ZenFactoryMethod) == 0x80, "Size mismatch!");
