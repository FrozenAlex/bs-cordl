...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x6e95264, size 0x1c, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x6e95280, size 0xc, virtual true, abstract: false, final false
  inline ::Zenject::InjectTypeInfo* EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x6e95250, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e951e8, size 0x68, virtual false, abstract: false, final false
