...
public:
  // Declarations
  /// @brief Method InstallBindings, addr 0x6e6f010, size 0x1b0, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::Zenject::ZenjectManagersInstaller* New_ctor();

  /// @brief Method __zenCreate, addr 0x6e6f1fc, size 0x78, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6e6f274, size 0x194, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x6e6f1c0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
