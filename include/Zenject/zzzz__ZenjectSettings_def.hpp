...
// Write type traits
MARK_REF_T(::Zenject::ZenjectSettings*);
MARK_REF_T(::Zenject::ZenjectSettings_SignalSettings*);
DEFINE_IL2CPP_CLASS(::Zenject::ZenjectSettings*, "Zenject", "ZenjectSettings");
DEFINE_IL2CPP_CLASS(::Zenject::ZenjectSettings_SignalSettings*, "Zenject", "ZenjectSettings/SignalSettings");
...
public:
  ...
  /// @brief Method SignalSettingsNoDomainReloadInit, addr 0x6e7c5c8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method __zenCreate, addr 0x6e7c700, size 0x60, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6e7c760, size 0x194, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x6e7c648, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6e7c664, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DefaultAsyncTickPriority, addr 0x6e7c674, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_DefaultAsyncTickPriority();

  /// @brief Method get_DefaultSyncMode, addr 0x6e7c67c, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::SignalDefaultSyncModes get_DefaultSyncMode();

  /// @brief Method get_MissingHandlerDefaultResponse, addr 0x6e7c684, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::SignalMissingHandlerResponses get_MissingHandlerDefaultResponse();

  /// @brief Method get_RequireStrictUnsubscribe, addr 0x6e7c68c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method NoDomainReloadInit, addr 0x6e7c3f8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e7c478, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6e7c490, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DisplayWarningWhenResolvingDuringInstall, addr 0x6e7c548, size 0x8, virtual false, abstract: false, final false
  inline bool get_DisplayWarningWhenResolvingDuringInstall();

  /// @brief Method get_EnsureDeterministicDestructionOrderOnApplicationQuit, addr 0x6e7c550, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnsureDeterministicDestructionOrderOnApplicationQuit();

  /// @brief Method get_Signals, addr 0x6e7c530, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::ZenjectSettings_SignalSettings* get_Signals();

  /// @brief Method get_ValidationErrorResponse, addr 0x6e7c538, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::ValidationErrorResponses get_ValidationErrorResponse();

  /// @brief Method get_ValidationRootResolveMethod, addr 0x6e7c540, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::ZenjectSettings) == 0x28, "Size mismatch!");
